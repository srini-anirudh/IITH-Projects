; ModuleID = 'POJ-104-source/1/1-1008.cpp'
source_filename = "POJ-104-source/1/1-1008.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_1008.cpp, i8* null }]
...
11:                                               ; preds = %7
  ...
  %14 = call i32 @_Z2stii(i32 2, i32 %13)
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z2stii(i32 %0, i32 %1) #0 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
...
25:                                               ; preds = %20
  ...
  %29 = sdiv i32 %27, %28
  %30 = call i32 @_Z2stii(i32 %26, i32 %29)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_1008.cpp() #0 section ".text.startup" {
