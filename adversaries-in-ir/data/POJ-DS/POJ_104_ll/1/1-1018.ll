; ModuleID = 'POJ-104-source/1/1-1018.cpp'
source_filename = "POJ-104-source/1/1-1018.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_1018.cpp, i8* null }]
...
11:                                               ; preds = %7
  ...
  %20 = call i32 @_Z1fii(i32 2, i32 %19)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_1018.cpp() #0 section ".text.startup" {
