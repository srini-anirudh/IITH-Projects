; ModuleID = 'POJ-104-source/1/1-1027.cpp'
source_filename = "POJ-104-source/1/1-1027.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_1027.cpp, i8* null }]
...
16:                                               ; preds = %11
  ...
  %22 = sdiv i32 %20, %21
  call void @_Z1fii(i32 %19, i32 %22)
  br label %23
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_1027.cpp() #0 section ".text.startup" {
