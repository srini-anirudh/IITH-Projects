; ModuleID = 'POJ-104-source/1/1-1049.cpp'
source_filename = "POJ-104-source/1/1-1049.cpp"
...
@sum = dso_local global [50 x i32] zeroinitializer, align 16
@i = dso_local global i32 0, align 4
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_1049.cpp, i8* null }]
...
47:                                               ; preds = %36
  ...
  %65 = sdiv i32 %60, %64
  call void @_Z5diguiii(i32 %56, i32 %65)
  br label %66
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5diguiii(i32 %0, i32 %1) #0 {
...
18:                                               ; preds = %13
  ...
  %27 = sdiv i32 %25, %26
  call void @_Z5diguiii(i32 %24, i32 %27)
  br label %28
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_1049.cpp() #0 section ".text.startup" {
