; ModuleID = 'POJ-104-source/1/1-1140.cpp'
source_filename = "POJ-104-source/1/1-1140.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_1140.cpp, i8* null }]
...
7:                                                ; preds = %27, %2
  ...
  %12 = call float @_ZSt4sqrtf(float %11)
...
19:                                               ; preds = %14
  ...
  %25 = sdiv i32 %23, %24
  call void @_Z4findii(i32 %22, i32 %25)
  br label %26
...
25:                                               ; preds = %20
  ...
  %31 = sdiv i32 %29, %30
  call void @_Z4findii(i32 %28, i32 %31)
  br label %32
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_1140.cpp() #0 section ".text.startup" {
