; ModuleID = 'POJ-104-source/1/1-1144.cpp'
source_filename = "POJ-104-source/1/1-1144.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_1144.cpp, i8* null }]
...
36:                                               ; preds = %29
  ...
  %42 = call i32 @_Z5countii(i32 %40, i32 %41)
...
31:                                               ; preds = %28
  ...
  %36 = call i32 @_Z5countii(i32 %34, i32 %35)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_1144.cpp() #0 section ".text.startup" {
