; ModuleID = 'POJ-104-source/1/1-1160.cpp'
source_filename = "POJ-104-source/1/1-1160.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_1160.cpp, i8* null }]
...
22:                                               ; preds = %17
  ...
  %27 = call i32 @_Z6fenjieii(i32 %25, i32 %26)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_1160.cpp() #0 section ".text.startup" {
