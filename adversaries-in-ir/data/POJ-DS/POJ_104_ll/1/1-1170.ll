; ModuleID = 'POJ-104-source/1/1-1170.cpp'
source_filename = "POJ-104-source/1/1-1170.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_1170.cpp, i8* null }]
...
26:                                               ; preds = %21
  ...
  %32 = call i32 @_Z4turnii(i32 %30, i32 %31)
...
11:                                               ; preds = %7
  ...
  %20 = call i32 @_Z4turnii(i32 %19, i32 2)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_1170.cpp() #0 section ".text.startup" {
