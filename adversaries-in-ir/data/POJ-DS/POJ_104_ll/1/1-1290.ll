; ModuleID = 'POJ-104-source/1/1-1290.cpp'
source_filename = "POJ-104-source/1/1-1290.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_1290.cpp, i8* null }]
...
17:                                               ; preds = %12
  ...
  %22 = call i32 @_Z9factorizeii(i32 %20, i32 %21)
...
23:                                               ; preds = %19
  ...
  %28 = call i32 @_Z9factorizeii(i32 %27, i32 2)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_1290.cpp() #0 section ".text.startup" {
