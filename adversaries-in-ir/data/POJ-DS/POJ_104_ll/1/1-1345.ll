; ModuleID = 'POJ-104-source/1/1-1345.cpp'
source_filename = "POJ-104-source/1/1-1345.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_1345.cpp, i8* null }]
...
define dso_local i32 @_Z3trui(i32 %0) #4 {
...
24:                                               ; preds = %19
  ...
  %30 = call i32 @_Z5countii(i32 %28, i32 %29)
...
23:                                               ; preds = %19
  ...
  %28 = call i32 @_Z5countii(i32 %27, i32 2)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_1345.cpp() #0 section ".text.startup" {
