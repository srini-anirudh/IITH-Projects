; ModuleID = 'POJ-104-source/1/1-14.cpp'
source_filename = "POJ-104-source/1/1-14.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_14.cpp, i8* null }]
...
24:                                               ; preds = %20
  ...
  %29 = call i32 @_Z1fii(i32 1, i32 %28)
  %30 = add nsw i32 %29, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_14.cpp() #0 section ".text.startup" {
