; ModuleID = 'POJ-104-source/1/1-1544.cpp'
source_filename = "POJ-104-source/1/1-1544.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_1544.cpp, i8* null }]
...
10:                                               ; preds = %6
  ...
  %13 = call i32 @_Z3fibii(i32 %12, i32 2)
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z3fibii(i32 %0, i32 %1) #0 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
...
26:                                               ; preds = %21
  ...
  %33 = call i32 @_Z3fibii(i32 %31, i32 %32)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_1544.cpp() #0 section ".text.startup" {
