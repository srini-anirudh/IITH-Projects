; ModuleID = 'POJ-104-source/1/1-1565.cpp'
source_filename = "POJ-104-source/1/1-1565.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_1565.cpp, i8* null }]
...
11:                                               ; preds = %6
  ...
  %15 = call i32 @_Z3numii(i32 %14, i32 2)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_1565.cpp() #0 section ".text.startup" {
