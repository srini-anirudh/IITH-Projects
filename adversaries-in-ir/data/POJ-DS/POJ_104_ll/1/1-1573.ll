; ModuleID = 'POJ-104-source/1/1-1573.cpp'
source_filename = "POJ-104-source/1/1-1573.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_1573.cpp, i8* null }]
...
10:                                               ; preds = %6
  ...
  %19 = call i32 @_Z6factorii(i32 %18, i32 2)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_1573.cpp() #0 section ".text.startup" {
