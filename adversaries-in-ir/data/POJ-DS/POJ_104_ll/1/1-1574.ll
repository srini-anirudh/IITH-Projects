; ModuleID = 'POJ-104-source/1/1-1574.cpp'
source_filename = "POJ-104-source/1/1-1574.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_1574.cpp, i8* null }]
...
19:                                               ; preds = %15
  ...
  %28 = call i32 @_Z1fii(i32 %27, i32 2)
  %29 = add nsw i32 1, %28
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_1574.cpp() #0 section ".text.startup" {
