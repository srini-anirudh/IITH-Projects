; ModuleID = 'POJ-104-source/1/1-1580.cpp'
source_filename = "POJ-104-source/1/1-1580.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_1580.cpp, i8* null }]
...
13:                                               ; preds = %9
  ...
  %16 = call i32 @_Z4minfii(i32 %15, i32 2)
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z4minfii(i32 %0, i32 %1) #0 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
...
19:                                               ; preds = %14
  ...
  %24 = call i32 @_Z4minfii(i32 %22, i32 %23)
  %25 = add nsw i32 %24, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_1580.cpp() #0 section ".text.startup" {
