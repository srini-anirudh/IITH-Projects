; ModuleID = 'POJ-104-source/1/1-1609.cpp'
source_filename = "POJ-104-source/1/1-1609.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_1609.cpp, i8* null }]
...
23:                                               ; preds = %18
  ...
  %28 = call i32 @_Z2ysii(i32 %26, i32 %27)
...
24:                                               ; preds = %20
  ...
  %29 = call i32 @_Z2ysii(i32 %28, i32 2)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_1609.cpp() #0 section ".text.startup" {
