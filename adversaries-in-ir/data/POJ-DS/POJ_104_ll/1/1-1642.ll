; ModuleID = 'POJ-104-source/1/1-1642.cpp'
source_filename = "POJ-104-source/1/1-1642.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_1642.cpp, i8* null }]
...
26:                                               ; preds = %21
  ...
  %32 = sdiv i32 %30, %31
  call void @_Z3shuii(i32 %29, i32 %32)
  br label %33
...
19:                                               ; preds = %14
  ...
  %25 = sdiv i32 %23, %24
  call void @_Z3shuii(i32 %22, i32 %25)
  br label %26
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_1642.cpp() #0 section ".text.startup" {
