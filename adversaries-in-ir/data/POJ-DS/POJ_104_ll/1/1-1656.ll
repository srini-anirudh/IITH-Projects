; ModuleID = 'POJ-104-source/1/1-1656.cpp'
source_filename = "POJ-104-source/1/1-1656.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_1656.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z5meideii(i32 %0, i32 %1) #0 {
...
20:                                               ; preds = %15
  ...
  %26 = call i32 @_Z5meideii(i32 %24, i32 %25)
...
14:                                               ; preds = %10
  ...
  %16 = call i32 @_Z5meideii(i32 %15, i32 2)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_1656.cpp() #0 section ".text.startup" {
