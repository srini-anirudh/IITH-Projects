; ModuleID = 'POJ-104-source/1/1-1687.cpp'
source_filename = "POJ-104-source/1/1-1687.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_1687.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z6factoriii(i32 %0, i32 %1, i32 %2) #0 {
...
23:                                               ; preds = %19
  ...
  %31 = add nsw i32 %30, 1
  call void @_Z6factoriii(i32 %26, i32 %29, i32 %31)
  br label %32
...
39:                                               ; preds = %34
  ...
  %45 = sdiv i32 %43, %44
  call void @_Z6factoriii(i32 %42, i32 %45, i32 2)
  br label %46
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_1687.cpp() #0 section ".text.startup" {
