; ModuleID = 'POJ-104-source/1/1-1705.cpp'
source_filename = "POJ-104-source/1/1-1705.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_1705.cpp, i8* null }]
...
26:                                               ; preds = %21
  ...
  %35 = sdiv i32 %33, %34
  call void @_Z4calcii(i32 %32, i32 %35)
  br label %36
...
6:                                                ; preds = %3
  %7 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* @m)
  store i32 0, i32* @ans, align 4
  %8 = load i32, i32* @m, align 4
  call void @_Z4calcii(i32 1, i32 %8)
  %9 = load i32, i32* @ans, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_1705.cpp() #0 section ".text.startup" {
