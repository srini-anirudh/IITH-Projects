; ModuleID = 'POJ-104-source/1/1-1778.cpp'
source_filename = "POJ-104-source/1/1-1778.cpp"
...
@__const._Z7reslovei.c = private unnamed_addr constant [15 x i32] [i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1], align 16
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_1778.cpp, i8* null }]
...
define dso_local void @_Z4nextPii(i32* %0, i32 %1) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z7reslovei(i32 %0) #4 {
  %2 = alloca i32, align 4
  %3 = alloca [15 x i32], align 16
  %4 = alloca i32, align 4
  store i32 %0, i32* %2, align 4
  %5 = bitcast [15 x i32]* %3 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %5, i8* align 16 bitcast ([15 x i32]* @__const._Z7reslovei.c to i8*), i64 60, i1 false)
...
103:                                              ; preds = %100, %53
  ...
  call void @_Z4nextPii(i32* %104, i32 %105)
  br label %6
...
11:                                               ; preds = %6
  ...
  %14 = call i32 @_Z7reslovei(i32 %13)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_1778.cpp() #0 section ".text.startup" {
