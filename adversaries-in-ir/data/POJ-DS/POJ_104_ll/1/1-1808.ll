; ModuleID = 'POJ-104-source/1/1-1808.cpp'
source_filename = "POJ-104-source/1/1-1808.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_1808.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z4fuckii(i32 %0, i32 %1) #0 {
...
27:                                               ; preds = %22
  ...
  %32 = call i32 @_Z4fuckii(i32 %30, i32 %31)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_1808.cpp() #0 section ".text.startup" {
