; ModuleID = 'POJ-104-source/1/1-1923.cpp'
source_filename = "POJ-104-source/1/1-1923.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_1923.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z5diguiiii(i32 %0, i32 %1, i32 %2) #0 {
...
31:                                               ; preds = %26
  ...
  %37 = call i32 @_Z5diguiiii(i32 %34, i32 %35, i32 %36)
...
9:                                                ; preds = %5
  ...
  %12 = call i32 @_Z5diguiiii(i32 %11, i32 2, i32 0)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_1923.cpp() #0 section ".text.startup" {
