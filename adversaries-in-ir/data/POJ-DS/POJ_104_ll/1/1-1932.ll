; ModuleID = 'POJ-104-source/1/1-1932.cpp'
source_filename = "POJ-104-source/1/1-1932.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_1932.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z3sdwii(i32 %0, i32 %1) #0 {
...
24:                                               ; preds = %18
  ...
  %28 = sdiv i32 %26, %27
  %29 = call i32 @_Z3sdwii(i32 %25, i32 %28)
...
25:                                               ; preds = %21
  ...
  %31 = call i32 @_Z3sdwii(i32 2, i32 %30)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_1932.cpp() #0 section ".text.startup" {
