; ModuleID = 'POJ-104-source/1/1-1969.cpp'
source_filename = "POJ-104-source/1/1-1969.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_1969.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z5zhengii(i32 %0, i32 %1) #0 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
24:                                               ; preds = %18
  ...
  %30 = call i32 @_Z5zhengii(i32 %28, i32 %29)
...
35:                                               ; preds = %28
  ...
  %40 = call i32 @_Z5zhengii(i32 %39, i32 2)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_1969.cpp() #0 section ".text.startup" {
