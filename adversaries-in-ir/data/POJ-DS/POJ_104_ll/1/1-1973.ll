; ModuleID = 'POJ-104-source/1/1-1973.cpp'
source_filename = "POJ-104-source/1/1-1973.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_1973.cpp, i8* null }]
...
25:                                               ; preds = %21
  ...
  %30 = call i32 @_Z2fjii(i32 2, i32 %29)
...
32:                                               ; preds = %27
  ...
  %37 = sdiv i32 %35, %36
  %38 = call i32 @_Z2fjii(i32 %34, i32 %37)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_1973.cpp() #0 section ".text.startup" {
