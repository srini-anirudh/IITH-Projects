; ModuleID = 'POJ-104-source/1/1-2023.cpp'
source_filename = "POJ-104-source/1/1-2023.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_2023.cpp, i8* null }]
...
20:                                               ; preds = %15
  ...
  %28 = call i32 @_Z3funiii(i32 %23, i32 %26, i32 %27)
...
25:                                               ; preds = %20
  ...
  %33 = call i32 @_Z3funiii(i32 %28, i32 %31, i32 %32)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_2023.cpp() #0 section ".text.startup" {
