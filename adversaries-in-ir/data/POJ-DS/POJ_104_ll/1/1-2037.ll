; ModuleID = 'POJ-104-source/1/1-2037.cpp'
source_filename = "POJ-104-source/1/1-2037.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_2037.cpp, i8* null }]
...
52:                                               ; preds = %47
  ...
  %57 = sdiv i32 %55, %56
  %58 = call i32 @_Z1fii(i32 %54, i32 %57)
...
12:                                               ; preds = %8
  ...
  %15 = call i32 @_Z1fii(i32 2, i32 %14)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_2037.cpp() #0 section ".text.startup" {
