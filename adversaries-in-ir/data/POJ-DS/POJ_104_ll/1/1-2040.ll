; ModuleID = 'POJ-104-source/1/1-2040.cpp'
source_filename = "POJ-104-source/1/1-2040.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_2040.cpp, i8* null }]
...
22:                                               ; preds = %17
  ...
  call void @_Z6fenjieii(i32 %25, i32 %26)
  br label %27
...
33:                                               ; preds = %25
  ...
  call void @_Z6fenjieii(i32 %39, i32 %40)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_2040.cpp() #0 section ".text.startup" {
