; ModuleID = 'POJ-104-source/1/1-2053.cpp'
source_filename = "POJ-104-source/1/1-2053.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_2053.cpp, i8* null }]
...
11:                                               ; preds = %6
  ...
  call void @_Z6factorii(i32 %13, i32 2)
...
29:                                               ; preds = %23
  ...
  call void @_Z6factorii(i32 %34, i32 %35)
  br label %36
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_2053.cpp() #0 section ".text.startup" {
