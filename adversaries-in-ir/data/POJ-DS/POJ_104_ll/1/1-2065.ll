; ModuleID = 'POJ-104-source/1/1-2065.cpp'
source_filename = "POJ-104-source/1/1-2065.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_2065.cpp, i8* null }]
...
18:                                               ; preds = %13
  ...
  call void @_Z6fenjieii(i32 %21, i32 %22)
  br label %23
...
27:                                               ; preds = %7
  ...
  %29 = add nsw i32 %28, 1
  store i32 %29, i32* @times, align 4
  ret void
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_2065.cpp() #0 section ".text.startup" {
