; ModuleID = 'POJ-104-source/1/1-2078.cpp'
source_filename = "POJ-104-source/1/1-2078.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_2078.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z3shii(i32 %0) #0 {
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z3shuii(i32 %0, i32 %1) #0 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
...
33:                                               ; preds = %25
  ...
  %38 = call i32 @_Z3shuii(i32 %36, i32 %37)
  %39 = sub nsw i32 %38, 1
...
11:                                               ; preds = %7
  ...
  %14 = call i32 @_Z3shuii(i32 %13, i32 2)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_2078.cpp() #0 section ".text.startup" {
