; ModuleID = 'POJ-104-source/1/1-2145.cpp'
source_filename = "POJ-104-source/1/1-2145.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_2145.cpp, i8* null }]
...
23:                                               ; preds = %19
  ...
  %28 = call i32 @_Z3yinii(i32 %27, i32 2)
...
66:                                               ; preds = %62
  ...
  %77 = call i32 @_Z3yinii(i32 %71, i32 %76)
...
define dso_local i32 @_Z3zhii(i32 %0) #5 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_2145.cpp() #0 section ".text.startup" {
