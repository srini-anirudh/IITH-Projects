; ModuleID = 'POJ-104-source/1/1-2211.cpp'
source_filename = "POJ-104-source/1/1-2211.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_2211.cpp, i8* null }]
...
20:                                               ; preds = %15
  ...
  %24 = getelementptr inbounds [40000 x i32], [40000 x i32]* @a, i64 0, i64 %23
  ...
  call void @_Z3funiii(i32 %29, i32 %30, i32 %31)
  br label %32
...
24:                                               ; preds = %20
  ...
  call void @_Z3funiii(i32 %28, i32 2, i32 %29)
  br label %30
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_2211.cpp() #0 section ".text.startup" {
