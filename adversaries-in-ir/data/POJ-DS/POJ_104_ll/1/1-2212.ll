; ModuleID = 'POJ-104-source/1/1-2212.cpp'
source_filename = "POJ-104-source/1/1-2212.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_2212.cpp, i8* null }]
...
23:                                               ; preds = %18
  ...
  %29 = call i32 @_Z6fenjieii(i32 %27, i32 %28)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_2212.cpp() #0 section ".text.startup" {
