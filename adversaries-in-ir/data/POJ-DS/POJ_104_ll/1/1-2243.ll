; ModuleID = 'POJ-104-source/1/1-2243.cpp'
source_filename = "POJ-104-source/1/1-2243.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_2243.cpp, i8* null }]
...
21:                                               ; preds = %16
  ...
  %27 = call i32 @_Z6devideii(i32 %25, i32 %26)
...
17:                                               ; preds = %10
  ...
  %22 = call i32 @_Z6devideii(i32 %21, i32 2)
...
24:                                               ; preds = %10
  ...
  %29 = call i32 @_Z6devideii(i32 %28, i32 2)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_2243.cpp() #0 section ".text.startup" {
