; ModuleID = 'POJ-104-source/1/1-2246.cpp'
source_filename = "POJ-104-source/1/1-2246.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_2246.cpp, i8* null }]
...
define dso_local i32 @_Z1fii(i32 %0, i32 %1) #0 {
  ...
  %9 = call i32 @_Z5checkii(i32 %8, i32 2)
  %10 = icmp eq i32 %9, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_2246.cpp() #0 section ".text.startup" {
