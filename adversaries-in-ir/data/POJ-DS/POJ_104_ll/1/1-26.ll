; ModuleID = 'POJ-104-source/1/1-26.cpp'
source_filename = "POJ-104-source/1/1-26.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_26.cpp, i8* null }]
...
36:                                               ; preds = %16
  ...
  %38 = sub nsw i32 %37, 1
  %39 = call i32 @_Z3fffii(i32 %38, i32 1)
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z3fffii(i32 %0, i32 %1) #0 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
39:                                               ; preds = %36
  ...
  %42 = call i32 @_Z3fffii(i32 %40, i32 %41)
  br label %43
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_26.cpp() #0 section ".text.startup" {
