; ModuleID = 'POJ-104-source/1/1-31.cpp'
source_filename = "POJ-104-source/1/1-31.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_31.cpp, i8* null }]
...
10:                                               ; preds = %6
  ...
  %13 = call i32 @_Z4calcii(i32 2, i32 %12)
...
19:                                               ; preds = %14
  ...
  %24 = sdiv i32 %22, %23
  %25 = call i32 @_Z4calcii(i32 %21, i32 %24)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_31.cpp() #0 section ".text.startup" {
