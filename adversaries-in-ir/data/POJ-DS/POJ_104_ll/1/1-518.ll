; ModuleID = 'POJ-104-source/1/1-518.cpp'
source_filename = "POJ-104-source/1/1-518.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_518.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z5primeii(i32 %0, i32 %1) #0 {
...
23:                                               ; preds = %18
  ...
  %28 = call i32 @_Z5primeii(i32 %26, i32 %27)
...
12:                                               ; preds = %7
  ...
  %15 = call i32 @_Z5primeii(i32 %14, i32 2)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_518.cpp() #0 section ".text.startup" {
