; ModuleID = 'POJ-104-source/1/1-544.cpp'
source_filename = "POJ-104-source/1/1-544.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_544.cpp, i8* null }]
...
24:                                               ; preds = %20
  ...
  %29 = call i32 @_Z1fii(i32 2, i32 %28)
  %30 = add nsw i32 %29, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_544.cpp() #0 section ".text.startup" {
