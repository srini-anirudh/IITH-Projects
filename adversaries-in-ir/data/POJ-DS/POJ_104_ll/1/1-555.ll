; ModuleID = 'POJ-104-source/1/1-555.cpp'
source_filename = "POJ-104-source/1/1-555.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_555.cpp, i8* null }]
...
17:                                               ; preds = %12
  ...
  call void @_Z1fii(i32 %22, i32 %23)
  br label %24
...
24:                                               ; preds = %17, %12
  ...
  %27 = add nsw i32 %26, 1
  call void @_Z1fii(i32 %25, i32 %27)
  br label %28
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_555.cpp() #0 section ".text.startup" {
