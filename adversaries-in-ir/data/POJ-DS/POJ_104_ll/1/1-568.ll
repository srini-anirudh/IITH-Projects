; ModuleID = 'POJ-104-source/1/1-568.cpp'
source_filename = "POJ-104-source/1/1-568.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_568.cpp, i8* null }]
...
24:                                               ; preds = %20
  ...
  %29 = call i32 @_Z3facii(i32 %28, i32 2)
...
22:                                               ; preds = %17
  ...
  %28 = call i32 @_Z3facii(i32 %26, i32 %27)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_568.cpp() #0 section ".text.startup" {
