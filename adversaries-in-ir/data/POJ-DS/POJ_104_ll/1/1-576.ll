; ModuleID = 'POJ-104-source/1/1-576.cpp'
source_filename = "POJ-104-source/1/1-576.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_576.cpp, i8* null }]
...
23:                                               ; preds = %19
  ...
  %28 = call i32 @_Z1fiii(i32 2, i32 %27, i32 1)
...
39:                                               ; preds = %22
  ...
  %53 = call i32 @_Z1fiii(i32 %45, i32 %51, i32 %52)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_576.cpp() #0 section ".text.startup" {
