; ModuleID = 'POJ-104-source/1/1-609.cpp'
source_filename = "POJ-104-source/1/1-609.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_609.cpp, i8* null }]
...
9:                                                ; preds = %5
  ...
  %12 = call i32 @_Z3funii(i32 %11, i32 2)
...
19:                                               ; preds = %14
  ...
  %24 = call i32 @_Z3funii(i32 %22, i32 %23)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_609.cpp() #0 section ".text.startup" {
