; ModuleID = 'POJ-104-source/1/1-671.cpp'
source_filename = "POJ-104-source/1/1-671.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_671.cpp, i8* null }]
...
12:                                               ; preds = %8
  ...
  %15 = call i32 @_Z1fii(i32 %14, i32 1)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_671.cpp() #0 section ".text.startup" {
