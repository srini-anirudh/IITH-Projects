; ModuleID = 'POJ-104-source/1/1-718.cpp'
source_filename = "POJ-104-source/1/1-718.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_718.cpp, i8* null }]
...
22:                                               ; preds = %18
  ...
  call void @_Z2sbii(i32 %26, i32 2)
...
; Function Attrs: noinline uwtable
define dso_local void @_Z2sbii(i32 %0, i32 %1) #0 {
...
18:                                               ; preds = %13
  ...
  %21 = getelementptr inbounds [100 x i32], [100 x i32]* @m, i64 0, i64 %20
  ...
  call void @_Z2sbii(i32 %26, i32 %27)
  br label %28
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_718.cpp() #0 section ".text.startup" {
