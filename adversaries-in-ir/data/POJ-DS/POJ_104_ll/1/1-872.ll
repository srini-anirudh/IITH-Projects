; ModuleID = 'POJ-104-source/1/1-872.cpp'
source_filename = "POJ-104-source/1/1-872.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_872.cpp, i8* null }]
...
29:                                               ; preds = %24
  ...
  %33 = sdiv i32 %31, %32
  %34 = call i32 @_Z3chuii(i32 %30, i32 %33)
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z3chuii(i32 %0, i32 %1) #0 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
...
21:                                               ; preds = %16
  ...
  %25 = sdiv i32 %23, %24
  %26 = call i32 @_Z3chuii(i32 %22, i32 %25)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_872.cpp() #0 section ".text.startup" {
