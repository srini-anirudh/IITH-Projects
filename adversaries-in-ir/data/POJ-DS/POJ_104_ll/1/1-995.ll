; ModuleID = 'POJ-104-source/1/1-995.cpp'
source_filename = "POJ-104-source/1/1-995.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_1_995.cpp, i8* null }]
...
24:                                               ; preds = %19
  ...
  %30 = sdiv i32 %28, %29
  call void @_Z5countii(i32 %27, i32 %30)
  br label %31
...
20:                                               ; preds = %15
  ...
  %26 = sdiv i32 %24, %25
  call void @_Z5countii(i32 %23, i32 %26)
  br label %27
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_1_995.cpp() #0 section ".text.startup" {
