; ModuleID = 'POJ-104-source/10/10-1049.cpp'
source_filename = "POJ-104-source/10/10-1049.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_1049.cpp, i8* null }]
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z4hahaPiS_i(i32* %0, i32* %1, i32 %2) #4 {
...
67:                                               ; preds = %64
  ...
  %74 = call i32 @_Z3maxii(i32 %68, i32 %73)
...
20:                                               ; preds = %8
  ...
  %24 = call i32 @_Z4hahaPiS_i(i32* %21, i32* %22, i32 %23)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_1049.cpp() #0 section ".text.startup" {
