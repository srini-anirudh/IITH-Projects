; ModuleID = 'POJ-104-source/10/10-1085.cpp'
source_filename = "POJ-104-source/10/10-1085.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_1085.cpp, i8* null }]
...
67:                                               ; preds = %39
  ...
  %70 = call i32 @_Z3MaxPii(i32* %68, i32 %69)
  %71 = add nsw i32 %70, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_1085.cpp() #0 section ".text.startup" {
