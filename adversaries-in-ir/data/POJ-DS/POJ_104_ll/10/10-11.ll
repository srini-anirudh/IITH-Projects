; ModuleID = 'POJ-104-source/10/10-11.cpp'
source_filename = "POJ-104-source/10/10-11.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_11.cpp, i8* null }]
...
40:                                               ; preds = %36
  ...
  %44 = getelementptr inbounds [25 x i32], [25 x i32]* @num, i64 0, i64 %43
...
define dso_local i32 @_Z6searchii(i32 %0, i32 %1) #5 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_11.cpp() #0 section ".text.startup" {
