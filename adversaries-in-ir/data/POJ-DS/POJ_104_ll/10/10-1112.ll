; ModuleID = 'POJ-104-source/10/10-1112.cpp'
source_filename = "POJ-104-source/10/10-1112.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_1112.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z7changdui(i32 %0) #0 {
...
27:                                               ; preds = %17
  ...
  %29 = call i32 @_Z7changdui(i32 %28)
...
32:                                               ; preds = %27
  ...
  %34 = call i32 @_Z7changdui(i32 %33)
...
22:                                               ; preds = %18
  ...
  %24 = call i32 @_Z7changdui(i32 %23)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_1112.cpp() #0 section ".text.startup" {
