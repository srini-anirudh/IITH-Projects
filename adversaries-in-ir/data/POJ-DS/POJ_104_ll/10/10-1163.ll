; ModuleID = 'POJ-104-source/10/10-1163.cpp'
source_filename = "POJ-104-source/10/10-1163.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_1163.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z1fiPiS_(i32 %0, i32* %1, i32* %2) #0 {
...
102:                                              ; preds = %80
  ...
  call void @_Z1fiPiS_(i32 %104, i32* %105, i32* %106)
  br label %107
...
108:                                              ; preds = %77
  ...
  call void @_Z1fiPiS_(i32 1, i32* %109, i32* %110)
  br label %111
...
define dso_local i32 @main() #4 {
  ...
  %5 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* @k)
...
18:                                               ; preds = %6
  ...
  call void @_Z1fiPiS_(i32 0, i32* %19, i32* %20)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_1163.cpp() #0 section ".text.startup" {
