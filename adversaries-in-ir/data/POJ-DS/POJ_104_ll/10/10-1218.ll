; ModuleID = 'POJ-104-source/10/10-1218.cpp'
source_filename = "POJ-104-source/10/10-1218.cpp"
...
@sum = dso_local global [26 x i32] zeroinitializer, align 16
@imax = dso_local global [26 x i32] zeroinitializer, align 16
@c = dso_local global i32 0, align 4
@j = dso_local global i32 0, align 4
@.str = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
@.str.1 = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_1218.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %3 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* @c)
...
16:                                               ; preds = %4
  %17 = call i32 @_Z4findii(i32 10000, i32 1)
...
29:                                               ; preds = %19
  ...
  %35 = add nsw i32 %34, 1
  %36 = call i32 @_Z4findii(i32 %33, i32 %35)
  %37 = add nsw i32 1, %36
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_1218.cpp() #0 section ".text.startup" {
