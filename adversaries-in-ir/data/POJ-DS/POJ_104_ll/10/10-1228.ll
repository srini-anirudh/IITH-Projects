; ModuleID = 'POJ-104-source/10/10-1228.cpp'
source_filename = "POJ-104-source/10/10-1228.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_1228.cpp, i8* null }]
...
71:                                               ; preds = %26
  %72 = getelementptr inbounds [25 x i32], [25 x i32]* %4, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_1228.cpp() #0 section ".text.startup" {
