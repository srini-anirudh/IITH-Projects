; ModuleID = 'POJ-104-source/10/10-1250.cpp'
source_filename = "POJ-104-source/10/10-1250.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_1250.cpp, i8* null }]
...
define dso_local i32 @_Z5countPiS_i(i32* %0, i32* %1, i32 %2) #4 {
...
27:                                               ; preds = %23
  ...
  %31 = call i32 @_Z5countPiS_i(i32* %28, i32* %29, i32 %30)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_1250.cpp() #0 section ".text.startup" {
