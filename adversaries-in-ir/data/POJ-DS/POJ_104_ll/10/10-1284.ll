; ModuleID = 'POJ-104-source/10/10-1284.cpp'
source_filename = "POJ-104-source/10/10-1284.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_1284.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %22 = getelementptr inbounds [25 x i32], [25 x i32]* %8, i64 0, i64 %21
...
78:                                               ; preds = %29
  %79 = getelementptr inbounds [25 x i32], [25 x i32]* %8, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_1284.cpp() #0 section ".text.startup" {
