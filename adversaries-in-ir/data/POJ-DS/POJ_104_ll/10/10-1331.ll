; ModuleID = 'POJ-104-source/10/10-1331.cpp'
source_filename = "POJ-104-source/10/10-1331.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_1331.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z3maxi(i32 %0) #0 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_1331.cpp() #0 section ".text.startup" {
