; ModuleID = 'POJ-104-source/10/10-1332.cpp'
source_filename = "POJ-104-source/10/10-1332.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_1332.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z1fiPii(i32 %0, i32* %1, i32 %2) #0 {
...
35:                                               ; preds = %23
  ...
  %39 = call i32 @_Z1fiPii(i32 %36, i32* %37, i32 %38)
...
42:                                               ; preds = %35
  ...
  %46 = call i32 @_Z1fiPii(i32 %43, i32* %44, i32 %45)
...
28:                                               ; preds = %23
  ...
  %32 = call i32 @_Z1fiPii(i32 %29, i32* %30, i32 %31)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_1332.cpp() #0 section ".text.startup" {
