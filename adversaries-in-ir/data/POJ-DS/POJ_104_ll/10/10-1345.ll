; ModuleID = 'POJ-104-source/10/10-1345.cpp'
source_filename = "POJ-104-source/10/10-1345.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_1345.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %10 = bitcast i8* %9 to <{ i32, [25 x i32] }>*
  %11 = getelementptr inbounds <{ i32, [25 x i32] }>, <{ i32, [25 x i32] }>* %10, i32 0, i32 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_1345.cpp() #0 section ".text.startup" {
