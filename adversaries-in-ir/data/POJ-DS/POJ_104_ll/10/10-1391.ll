; ModuleID = 'POJ-104-source/10/10-1391.cpp'
source_filename = "POJ-104-source/10/10-1391.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_1391.cpp, i8* null }]
...
16:                                               ; preds = %4
  call void @_Z5shootiii(i32 1, i32 32767, i32 0)
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5shootiii(i32 %0, i32 %1, i32 %2) #0 {
...
27:                                               ; preds = %3
  ...
  call void @_Z5shootiii(i32 %29, i32 %30, i32 %31)
...
38:                                               ; preds = %27
  ...
  %46 = add nsw i32 %45, 1
  call void @_Z5shootiii(i32 %40, i32 %44, i32 %46)
  br label %47
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_1391.cpp() #0 section ".text.startup" {
