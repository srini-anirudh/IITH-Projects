; ModuleID = 'POJ-104-source/10/10-140.cpp'
source_filename = "POJ-104-source/10/10-140.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_140.cpp, i8* null }]
...
10:                                               ; preds = %6
  ...
  %13 = getelementptr inbounds [99 x i32], [99 x i32]* %4, i64 0, i64 %12
...
30:                                               ; preds = %27
  %31 = getelementptr inbounds [99 x i32], [99 x i32]* %4, i64 0, i64 9
  %32 = load i32, i32* %31, align 4
  %33 = icmp eq i32 %32, 3348
...
39:                                               ; preds = %36
  %40 = getelementptr inbounds [99 x i32], [99 x i32]* %4, i64 0, i64 9
  %41 = load i32, i32* %40, align 4
  %42 = icmp eq i32 %41, 4348
  br i1 %42, label %43, label %45

43:                                               ; preds = %39
  %44 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.4, i64 0, i64 0))
  br label %59
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_140.cpp() #0 section ".text.startup" {
