; ModuleID = 'POJ-104-source/10/10-1409.cpp'
source_filename = "POJ-104-source/10/10-1409.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_1409.cpp, i8* null }]
...
26:                                               ; preds = %19
  ...
  %29 = add nsw i32 %28, 1
  %30 = call i32 @_Z2goii(i32 %27, i32 %29)
  ...
  %37 = add nsw i32 %36, 1
  %38 = call i32 @_Z2goii(i32 %35, i32 %37)
  %39 = add nsw i32 1, %38
...
18:                                               ; preds = %6
  ...
  %22 = call i32 @_Z2goii(i32 65535, i32 0)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_1409.cpp() #0 section ".text.startup" {
