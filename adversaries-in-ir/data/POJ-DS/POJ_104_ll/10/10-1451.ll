; ModuleID = 'POJ-104-source/10/10-1451.cpp'
source_filename = "POJ-104-source/10/10-1451.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_1451.cpp, i8* null }]
...
114:                                              ; preds = %103
  ...
  %127 = getelementptr inbounds [25 x i32], [25 x i32]* %7, i64 0, i64 %126
...
140:                                              ; preds = %90
  ...
  %144 = getelementptr inbounds [25 x i32], [25 x i32]* %7, i64 0, i64 %143
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_1451.cpp() #0 section ".text.startup" {
