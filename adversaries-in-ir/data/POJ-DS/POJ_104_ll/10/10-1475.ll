; ModuleID = 'POJ-104-source/10/10-1475.cpp'
source_filename = "POJ-104-source/10/10-1475.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_1475.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z4hackii(i32 %0, i32 %1) #0 {
...
21:                                               ; preds = %2
  ...
  %25 = call i32 @_Z4hackii(i32 %23, i32 %24)
...
32:                                               ; preds = %21
  ...
  %39 = call i32 @_Z4hackii(i32 %34, i32 %38)
  %40 = add nsw i32 1, %39
...
29:                                               ; preds = %5
  ...
  %31 = call i32 @_Z4hackii(i32 0, i32 %30)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_1475.cpp() #0 section ".text.startup" {
