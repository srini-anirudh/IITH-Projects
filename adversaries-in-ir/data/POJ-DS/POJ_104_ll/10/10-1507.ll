; ModuleID = 'POJ-104-source/10/10-1507.cpp'
source_filename = "POJ-104-source/10/10-1507.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_1507.cpp, i8* null }]
...
define dso_local i32 @_Z13findFirstLessi(i32 %0) #4 {
...
55:                                               ; preds = %45
  ...
  %64 = call i32 @_Z13findFirstLessi(i32 %63)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_1507.cpp() #0 section ".text.startup" {
