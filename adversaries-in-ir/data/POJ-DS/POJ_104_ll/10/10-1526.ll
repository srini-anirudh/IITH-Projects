; ModuleID = 'POJ-104-source/10/10-1526.cpp'
source_filename = "POJ-104-source/10/10-1526.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_1526.cpp, i8* null }]
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z7destroyPii(i32* %0, i32 %1) #4 {
...
63:                                               ; preds = %13
  %64 = getelementptr inbounds [25 x i32], [25 x i32]* %5, i64 0, i64 0
  %65 = call i32 @_Z3maxPi(i32* %64)
  %66 = add nsw i32 %65, 1
  ret i32 %66
}
...
20:                                               ; preds = %7
  ...
  %23 = sub nsw i32 %22, 1
  %24 = call i32 @_Z7destroyPii(i32* %21, i32 %23)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_1526.cpp() #0 section ".text.startup" {
