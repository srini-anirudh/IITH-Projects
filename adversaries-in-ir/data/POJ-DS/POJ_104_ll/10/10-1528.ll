; ModuleID = 'POJ-104-source/10/10-1528.cpp'
source_filename = "POJ-104-source/10/10-1528.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_1528.cpp, i8* null }]
...
26:                                               ; preds = %14
  ...
  %38 = add nsw i32 %37, 1
  %39 = call i32 @_Z3maxii(i32 %30, i32 %38)
...
7:                                                ; preds = %3
  ...
  %9 = sext i32 %8 to i64
  %10 = getelementptr inbounds [26 x i32], [26 x i32]* @h, i64 0, i64 %9
...
15:                                               ; preds = %3
  ...
  %17 = call i32 @_Z1fii(i32 %16, i32 0)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_1528.cpp() #0 section ".text.startup" {
