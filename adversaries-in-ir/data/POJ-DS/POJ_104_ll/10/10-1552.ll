; ModuleID = 'POJ-104-source/10/10-1552.cpp'
source_filename = "POJ-104-source/10/10-1552.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_1552.cpp, i8* null }]
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z7nextmaxP6daodanii(%struct.daodan* %0, i32 %1, i32 %2) #4 {
...
51:                                               ; preds = %48
  ...
  %55 = call i32 @_Z7nextmaxP6daodanii(%struct.daodan* %52, i32 %53, i32 %54)
  %56 = add nsw i32 %55, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_1552.cpp() #0 section ".text.startup" {
