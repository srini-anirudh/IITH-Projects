; ModuleID = 'POJ-104-source/10/10-1575.cpp'
source_filename = "POJ-104-source/10/10-1575.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_1575.cpp, i8* null }]
...
19:                                               ; preds = %7
  ...
  %22 = call i32 @_Z1fPii(i32* %20, i32 %21)
...
64:                                               ; preds = %61
  ...
  %68 = sub nsw i32 %67, 1
  %69 = call i32 @_Z1fPii(i32* %66, i32 %68)
  %70 = add nsw i32 %69, 1
...
105:                                              ; preds = %76
  ...
  %110 = call i32 @_Z1fPii(i32* %107, i32 %109)
  %111 = getelementptr inbounds [25 x i32], [25 x i32]* %7, i64 0, i64 0
  %112 = load i32, i32* %8, align 4
  %113 = call i32 @_Z1fPii(i32* %111, i32 %112)
...
115:                                              ; preds = %105
  ...
  %120 = call i32 @_Z1fPii(i32* %117, i32 %119)
  br label %125

121:                                              ; preds = %105
  %122 = getelementptr inbounds [25 x i32], [25 x i32]* %7, i64 0, i64 0
  %123 = load i32, i32* %8, align 4
  %124 = call i32 @_Z1fPii(i32* %122, i32 %123)
  br label %125
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_1575.cpp() #0 section ".text.startup" {
