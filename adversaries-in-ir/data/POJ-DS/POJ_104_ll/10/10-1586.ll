; ModuleID = 'POJ-104-source/10/10-1586.cpp'
source_filename = "POJ-104-source/10/10-1586.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_1586.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5QsortPiii(i32* %0, i32 %1, i32 %2) #0 {
...
62:                                               ; preds = %61
  ...
  %81 = sub nsw i32 %80, 1
  call void @_Z5QsortPiii(i32* %78, i32 %79, i32 %81)
  %82 = load i32*, i32** %4, align 8
  %83 = load i32, i32* %8, align 4
  %84 = add nsw i32 %83, 1
  %85 = load i32, i32* %6, align 4
  call void @_Z5QsortPiii(i32* %82, i32 %84, i32 %85)
  br label %86
...
35:                                               ; preds = %23
  ...
  %39 = call i32 @_Z3numPiii(i32* %36, i32 %37, i32 %38)
...
49:                                               ; preds = %19
  ...
  call void @_Z5QsortPiii(i32* %50, i32 0, i32 25)
...
36:                                               ; preds = %32
  ...
  %39 = sub nsw i32 %38, 1
  %40 = call i32 @_Z3numPiii(i32* %15, i32 %37, i32 %39)
...
47:                                               ; preds = %32
  ...
  %49 = sub nsw i32 %48, 1
  call void @_Z5QsortPiii(i32* %18, i32 0, i32 %49)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_1586.cpp() #0 section ".text.startup" {
