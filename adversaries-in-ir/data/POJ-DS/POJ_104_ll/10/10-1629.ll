; ModuleID = 'POJ-104-source/10/10-1629.cpp'
source_filename = "POJ-104-source/10/10-1629.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_1629.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z7measureiii(i32 %0, i32 %1, i32 %2) #0 {
...
33:                                               ; preds = %25
  ...
  call void @_Z7measureiii(i32 %34, i32 %36, i32 %41)
  br label %42
...
46:                                               ; preds = %21
  ...
  call void @_Z7measureiii(i32 %47, i32 %48, i32 %49)
  br label %50
...
16:                                               ; preds = %4
  call void @_Z7measureiii(i32 0, i32 0, i32 10000)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_1629.cpp() #0 section ".text.startup" {
