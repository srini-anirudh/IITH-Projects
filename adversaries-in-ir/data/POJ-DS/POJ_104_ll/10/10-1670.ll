; ModuleID = 'POJ-104-source/10/10-1670.cpp'
source_filename = "POJ-104-source/10/10-1670.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_1670.cpp, i8* null }]
...
22:                                               ; preds = %10
  ...
  %26 = getelementptr inbounds [25 x i32], [25 x i32]* %6, i64 0, i64 %25
...
32:                                               ; preds = %29
  ...
  %42 = call i32 @_Z4dertii(i32 %36, i32 %41)
...
55:                                               ; preds = %49
  ...
  %67 = call i32 @_Z4dertii(i32 %60, i32 %66)
...
76:                                               ; preds = %55
  ...
  %87 = call i32 @_Z4dertii(i32 %80, i32 %86)
...
define dso_local i32 @_Z4dertii(i32 %0, i32 %1) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_1670.cpp() #0 section ".text.startup" {
