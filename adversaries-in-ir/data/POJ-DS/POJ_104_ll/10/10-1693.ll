; ModuleID = 'POJ-104-source/10/10-1693.cpp'
source_filename = "POJ-104-source/10/10-1693.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_1693.cpp, i8* null }]
...
48:                                               ; preds = %38
  ...
  %58 = call i32 @_Z3Maxii(i32 %53, i32 %57)
...
75:                                               ; preds = %71
  ...
  %81 = call i32 @_Z3Maxii(i32 %76, i32 %80)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_1693.cpp() #0 section ".text.startup" {
