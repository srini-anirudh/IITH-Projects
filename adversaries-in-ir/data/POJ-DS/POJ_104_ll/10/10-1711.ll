; ModuleID = 'POJ-104-source/10/10-1711.cpp'
source_filename = "POJ-104-source/10/10-1711.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_1711.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z3calPiii(i32* %0, i32 %1, i32 %2) #0 {
...
35:                                               ; preds = %23
  ...
  %43 = call i32 @_Z3calPiii(i32* %36, i32 %37, i32 %42)
...
23:                                               ; preds = %9
  ...
  %26 = add nsw i32 %25, 1
  %27 = call i32 @_Z3calPiii(i32* %24, i32 0, i32 %26)
  %28 = sub nsw i32 %27, 2
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_1711.cpp() #0 section ".text.startup" {
