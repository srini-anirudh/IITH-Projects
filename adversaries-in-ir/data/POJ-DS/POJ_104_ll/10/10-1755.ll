; ModuleID = 'POJ-104-source/10/10-1755.cpp'
source_filename = "POJ-104-source/10/10-1755.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_1755.cpp, i8* null }]
...
28:                                               ; preds = %25
  ...
  %33 = call i32 @_Z7analysePiS_ii(i32* %29, i32* %30, i32 %31, i32 %32)
...
define dso_local i32 @_Z7analysePiS_ii(i32* %0, i32* %1, i32 %2, i32 %3) #6 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_1755.cpp() #0 section ".text.startup" {
