; ModuleID = 'POJ-104-source/10/10-1761.cpp'
source_filename = "POJ-104-source/10/10-1761.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_1761.cpp, i8* null }]
...
18:                                               ; preds = %6
  ...
  %21 = call i32 @_Z1fPii(i32* %19, i32 %20)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_1761.cpp() #0 section ".text.startup" {
