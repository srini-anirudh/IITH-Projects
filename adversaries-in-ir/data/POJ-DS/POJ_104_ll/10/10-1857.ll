; ModuleID = 'POJ-104-source/10/10-1857.cpp'
source_filename = "POJ-104-source/10/10-1857.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_1857.cpp, i8* null }]
...
37:                                               ; preds = %34
  ...
  %40 = getelementptr inbounds [25 x i32], [25 x i32]* %7, i64 0, i64 %39
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_1857.cpp() #0 section ".text.startup" {
