; ModuleID = 'POJ-104-source/10/10-1878.cpp'
source_filename = "POJ-104-source/10/10-1878.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_1878.cpp, i8* null }]
...
define dso_local i32 @_Z6maxnumPii(i32* %0, i32 %1) #4 {
...
19:                                               ; preds = %6
  ...
  %22 = call i32 @_Z6maxnumPii(i32* %20, i32 %21)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_1878.cpp() #0 section ".text.startup" {
