; ModuleID = 'POJ-104-source/10/10-1934.cpp'
source_filename = "POJ-104-source/10/10-1934.cpp"
...
@x = dso_local global [26 x i32] zeroinitializer, align 16
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_1934.cpp, i8* null }]
...
44:                                               ; preds = %34
  %45 = call i32 @_Z3xxxii(i32 999999, i32 0)
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z3xxxii(i32 %0, i32 %1) #0 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  store i32 %0, i32* %4, align 4
...
26:                                               ; preds = %19
  ...
  %29 = add nsw i32 %28, 1
  %30 = call i32 @_Z3xxxii(i32 %27, i32 %29)
...
31:                                               ; preds = %19
  ...
  %37 = add nsw i32 %36, 1
  %38 = call i32 @_Z3xxxii(i32 %35, i32 %37)
  %39 = add nsw i32 1, %38
  %40 = load i32, i32* %4, align 4
  %41 = load i32, i32* %5, align 4
  %42 = add nsw i32 %41, 1
  %43 = call i32 @_Z3xxxii(i32 %40, i32 %42)
  %44 = call i32 @_Z3maxii(i32 %39, i32 %43)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_1934.cpp() #0 section ".text.startup" {
