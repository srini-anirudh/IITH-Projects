; ModuleID = 'POJ-104-source/10/10-1939.cpp'
source_filename = "POJ-104-source/10/10-1939.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_1939.cpp, i8* null }]
...
define dso_local i32 @main() #5 {
  ...
  %11 = bitcast i8* %10 to <{ i32, [29 x i32] }>*
  %12 = getelementptr inbounds <{ i32, [29 x i32] }>, <{ i32, [29 x i32] }>* %11, i32 0, i32 0
...
49:                                               ; preds = %39
  ...
  %58 = call dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* dereferenceable(4) %9, i32* dereferenceable(4) %57)
...
71:                                               ; preds = %29
  %72 = getelementptr inbounds [30 x i32], [30 x i32]* %5, i64 0, i64 0
  %73 = bitcast i32* %72 to i8*
  call void @qsort(i8* %73, i64 30, i64 4, i32 (i8*, i8*)* @_Z3comPKvS0_)
  %74 = getelementptr inbounds [30 x i32], [30 x i32]* %5, i64 0, i64 29
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_1939.cpp() #0 section ".text.startup" {
