; ModuleID = 'POJ-104-source/10/10-1940.cpp'
source_filename = "POJ-104-source/10/10-1940.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_1940.cpp, i8* null }]
...
58:                                               ; preds = %48
  ...
  %67 = call dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* dereferenceable(4) %10, i32* dereferenceable(4) %66)
...
80:                                               ; preds = %38
  %81 = getelementptr inbounds [30 x i32], [30 x i32]* %5, i64 0, i64 0
  %82 = bitcast i32* %81 to i8*
  call void @qsort(i8* %82, i64 30, i64 4, i32 (i8*, i8*)* @_Z3comPKvS0_)
  %83 = getelementptr inbounds [30 x i32], [30 x i32]* %5, i64 0, i64 29
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_1940.cpp() #0 section ".text.startup" {
