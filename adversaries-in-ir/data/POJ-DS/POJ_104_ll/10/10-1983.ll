; ModuleID = 'POJ-104-source/10/10-1983.cpp'
source_filename = "POJ-104-source/10/10-1983.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_1983.cpp, i8* null }]
...
10:                                               ; preds = %6
  ...
  %13 = getelementptr inbounds [26 x i32], [26 x i32]* @s, i64 0, i64 %12
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_1983.cpp() #0 section ".text.startup" {
