; ModuleID = 'POJ-104-source/10/10-200.cpp'
source_filename = "POJ-104-source/10/10-200.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_200.cpp, i8* null }]
...
22:                                               ; preds = %10
  %23 = getelementptr inbounds [25 x i32], [25 x i32]* %3, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_200.cpp() #0 section ".text.startup" {
