; ModuleID = 'POJ-104-source/10/10-2018.cpp'
source_filename = "POJ-104-source/10/10-2018.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_2018.cpp, i8* null }]
...
53:                                               ; preds = %43
  ...
  %62 = add nsw i32 %61, 1
  %63 = call i32 @_Z3maxii(i32 %57, i32 %62)
...
80:                                               ; preds = %76
  ...
  %86 = call i32 @_Z3maxii(i32 %81, i32 %85)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_2018.cpp() #0 section ".text.startup" {
