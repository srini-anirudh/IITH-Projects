; ModuleID = 'POJ-104-source/10/10-205.cpp'
source_filename = "POJ-104-source/10/10-205.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_205.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z9Interceptii(i32 %0, i32 %1) #0 {
...
34:                                               ; preds = %24
  ...
  %37 = call i32 @_Z9Interceptii(i32 %35, i32 %36)
  %38 = add nsw i32 %37, 1
...
11:                                               ; preds = %7
  ...
  %14 = getelementptr inbounds [25 x i32], [25 x i32]* @missle, i64 0, i64 %13
...
31:                                               ; preds = %27
  ...
  %34 = getelementptr inbounds [25 x i32], [25 x i32]* @missle, i64 0, i64 %33
...
41:                                               ; preds = %31
  ...
  %44 = call i32 @_Z9Interceptii(i32 %42, i32 %43)
  %45 = add nsw i32 %44, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_205.cpp() #0 section ".text.startup" {
