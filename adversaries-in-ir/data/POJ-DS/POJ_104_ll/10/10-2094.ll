; ModuleID = 'POJ-104-source/10/10-2094.cpp'
source_filename = "POJ-104-source/10/10-2094.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_2094.cpp, i8* null }]
...
17:                                               ; preds = %5
  %18 = call i32 @_Z3maxii(i32 50000, i32 0)
...
24:                                               ; preds = %19
  ...
  %27 = add nsw i32 %26, 1
  %28 = call i32 @_Z3maxii(i32 %25, i32 %27)
  ...
  %35 = add nsw i32 %34, 1
  %36 = call i32 @_Z3maxii(i32 %33, i32 %35)
  %37 = add nsw i32 1, %36
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_2094.cpp() #0 section ".text.startup" {
