; ModuleID = 'POJ-104-source/10/10-2130.cpp'
source_filename = "POJ-104-source/10/10-2130.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_2130.cpp, i8* null }]
...
46:                                               ; preds = %36
  ...
  %55 = add nsw i32 %54, 1
  %56 = call i32 @_Z3maxii(i32 %50, i32 %55)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_2130.cpp() #0 section ".text.startup" {
