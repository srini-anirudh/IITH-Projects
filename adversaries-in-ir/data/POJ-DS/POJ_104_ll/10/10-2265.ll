; ModuleID = 'POJ-104-source/10/10-2265.cpp'
source_filename = "POJ-104-source/10/10-2265.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_2265.cpp, i8* null }]
...
45:                                               ; preds = %35
  ...
  %54 = call dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* dereferenceable(4) %48, i32* dereferenceable(4) %8)
...
63:                                               ; preds = %31
  ...
  %67 = call dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* dereferenceable(4) %3, i32* dereferenceable(4) %66)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_2265.cpp() #0 section ".text.startup" {
