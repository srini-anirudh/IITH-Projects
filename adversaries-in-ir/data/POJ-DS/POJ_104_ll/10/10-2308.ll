; ModuleID = 'POJ-104-source/10/10-2308.cpp'
source_filename = "POJ-104-source/10/10-2308.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_2308.cpp, i8* null }]
...
define dso_local i32 @_Z3abcPKvS0_(i8* %0, i8* %1) #4 {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
...
83:                                               ; preds = %27
  ...
  call void @qsort(i8* %86, i64 %88, i64 4, i32 (i8*, i8*)* @_Z3abcPKvS0_)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_2308.cpp() #0 section ".text.startup" {
