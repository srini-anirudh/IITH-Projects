; ModuleID = 'POJ-104-source/10/10-2310.cpp'
source_filename = "POJ-104-source/10/10-2310.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_2310.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z4shotii(i32 %0, i32 %1) #0 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  store i32 %0, i32* %4, align 4
...
25:                                               ; preds = %18
  ...
  %29 = call i32 @_Z4shotii(i32 %27, i32 %28)
...
30:                                               ; preds = %18
  ...
  %34 = call i32 @_Z4shotii(i32 %32, i32 %33)
  ...
  %41 = call i32 @_Z4shotii(i32 %36, i32 %40)
  %42 = add nsw i32 %41, 1
  %43 = call i32 @_Z3maxii(i32 %34, i32 %42)
...
17:                                               ; preds = %5
  %18 = call i32 @_Z4shotii(i32 1, i32 9999)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_2310.cpp() #0 section ".text.startup" {
