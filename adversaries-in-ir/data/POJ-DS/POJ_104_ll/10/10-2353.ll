; ModuleID = 'POJ-104-source/10/10-2353.cpp'
source_filename = "POJ-104-source/10/10-2353.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_2353.cpp, i8* null }]
...
20:                                               ; preds = %7
  ...
  call void @_Z4dealiPA2_i(i32 %21, [2 x i32]* %22)
  store i32 0, i32* %3, align 4
  br label %23
...
define dso_local void @_Z4dealiPA2_i(i32 %0, [2 x i32]* %1) #5 {
  %3 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_2353.cpp() #0 section ".text.startup" {
