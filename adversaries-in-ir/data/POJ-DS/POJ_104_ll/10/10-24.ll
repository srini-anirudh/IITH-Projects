; ModuleID = 'POJ-104-source/10/10-24.cpp'
source_filename = "POJ-104-source/10/10-24.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_24.cpp, i8* null }]
...
47:                                               ; preds = %37
  ...
  %56 = call dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* dereferenceable(4) %50, i32* dereferenceable(4) %8)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_24.cpp() #0 section ".text.startup" {
