; ModuleID = 'POJ-104-source/10/10-254.cpp'
source_filename = "POJ-104-source/10/10-254.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_254.cpp, i8* null }]
...
79:                                               ; preds = %48
  ...
  %82 = call i32 @_Z3maxPii(i32* %80, i32 %81)
  %83 = add nsw i32 %82, 1
...
91:                                               ; preds = %42
  ...
  %94 = call i32 @_Z3maxPii(i32* %92, i32 %93)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_254.cpp() #0 section ".text.startup" {
