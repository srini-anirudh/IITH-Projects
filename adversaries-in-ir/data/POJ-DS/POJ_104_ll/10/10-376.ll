; ModuleID = 'POJ-104-source/10/10-376.cpp'
source_filename = "POJ-104-source/10/10-376.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_376.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %8 = bitcast [25 x i32]* %7 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %8, i8* align 16 bitcast ([25 x i32]* @__const.main.b to i8*), i64 100, i1 false)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_376.cpp() #0 section ".text.startup" {
