; ModuleID = 'POJ-104-source/10/10-423.cpp'
source_filename = "POJ-104-source/10/10-423.cpp"
...
@memo = dso_local global [40 x [40 x i32]] zeroinitializer, align 16
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_423.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z2dpii(i32 %0, i32 %1) #0 {
...
43:                                               ; preds = %33
  ...
  %47 = call i32 @_Z2dpii(i32 %45, i32 %46)
...
48:                                               ; preds = %33, %30
  ...
  %57 = call i32 @_Z2dpii(i32 %55, i32 %56)
...
40:                                               ; preds = %28
  %41 = call i32 @_Z2dpii(i32 0, i32 30)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_423.cpp() #0 section ".text.startup" {
