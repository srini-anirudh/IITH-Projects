; ModuleID = 'POJ-104-source/10/10-495.cpp'
source_filename = "POJ-104-source/10/10-495.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_495.cpp, i8* null }]
...
70:                                               ; preds = %24
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* %71, i32* %75)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_495.cpp() #0 section ".text.startup" {
