; ModuleID = 'POJ-104-source/10/10-573.cpp'
source_filename = "POJ-104-source/10/10-573.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_573.cpp, i8* null }]
...
79:                                               ; preds = %75
  %80 = getelementptr inbounds [25 x i32], [25 x i32]* %5, i64 0, i64 0
...
87:                                               ; preds = %79
  ...
  %92 = getelementptr inbounds [25 x i32], [25 x i32]* %5, i64 0, i64 0
...
97:                                               ; preds = %75
  %98 = getelementptr inbounds [25 x i32], [25 x i32]* %5, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_573.cpp() #0 section ".text.startup" {
