; ModuleID = 'POJ-104-source/10/10-577.cpp'
source_filename = "POJ-104-source/10/10-577.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_577.cpp, i8* null }]
...
89:                                               ; preds = %40
  %90 = getelementptr inbounds [25 x i32], [25 x i32]* %7, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_577.cpp() #0 section ".text.startup" {
