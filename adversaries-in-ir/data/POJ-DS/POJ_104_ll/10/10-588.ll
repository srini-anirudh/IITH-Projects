; ModuleID = 'POJ-104-source/10/10-588.cpp'
source_filename = "POJ-104-source/10/10-588.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_588.cpp, i8* null }]
...
30:                                               ; preds = %26
  ...
  %34 = call i32 @_Z2ljPiii(i32* %31, i32 %32, i32 %33)
  %35 = load i32, i32* %4, align 4
  %36 = sext i32 %35 to i64
  %37 = getelementptr inbounds [25 x i32], [25 x i32]* %11, i64 0, i64 %36
...
46:                                               ; preds = %42
  ...
  %50 = getelementptr inbounds [25 x i32], [25 x i32]* %11, i64 0, i64 %49
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z2ljPiii(i32* %0, i32 %1, i32 %2) #0 {
  %4 = alloca i32, align 4
...
48:                                               ; preds = %36
  ...
  %52 = call i32 @_Z2ljPiii(i32* %49, i32 %50, i32 %51)
...
60:                                               ; preds = %32
  ...
  %64 = getelementptr inbounds [25 x i32], [25 x i32]* %12, i64 0, i64 %63
...
72:                                               ; preds = %68
  ...
  %76 = getelementptr inbounds [25 x i32], [25 x i32]* %12, i64 0, i64 %75
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_588.cpp() #0 section ".text.startup" {
