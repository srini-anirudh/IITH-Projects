; ModuleID = 'POJ-104-source/10/10-610.cpp'
source_filename = "POJ-104-source/10/10-610.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_610.cpp, i8* null }]
...
73:                                               ; preds = %46
  ...
  call void @qsort(i8* %75, i64 %77, i64 4, i32 (i8*, i8*)* @_Z7comparePKvS0_)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_610.cpp() #0 section ".text.startup" {
