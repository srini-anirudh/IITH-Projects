; ModuleID = 'POJ-104-source/10/10-703.cpp'
source_filename = "POJ-104-source/10/10-703.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_703.cpp, i8* null }]
...
95:                                               ; preds = %59
  %96 = getelementptr inbounds [26 x i32], [26 x i32]* %9, i64 0, i64 0
...
147:                                              ; preds = %111
  %148 = getelementptr inbounds [26 x i32], [26 x i32]* %8, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_703.cpp() #0 section ".text.startup" {
