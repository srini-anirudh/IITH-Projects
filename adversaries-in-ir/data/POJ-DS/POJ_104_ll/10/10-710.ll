; ModuleID = 'POJ-104-source/10/10-710.cpp'
source_filename = "POJ-104-source/10/10-710.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_710.cpp, i8* null }]
...
define dso_local void @_Z1fPiS_i(i32* %0, i32* %1, i32 %2) #4 {
...
25:                                               ; preds = %21
  ...
  call void @_Z1fPiS_i(i32* %26, i32* %27, i32 %28)
  br label %29
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_710.cpp() #0 section ".text.startup" {
