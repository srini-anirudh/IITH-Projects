; ModuleID = 'POJ-104-source/10/10-794.cpp'
source_filename = "POJ-104-source/10/10-794.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_794.cpp, i8* null }]
...
define dso_local i32 @_Z2xuPiii(i32* %0, i32 %1, i32 %2) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z4maxdPii(i32* %0, i32 %1) #4 {
  %3 = alloca i32*, align 8
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z4shaiPii(i32* %0, i32 %1) #0 {
  %3 = alloca i32*, align 8
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
13:                                               ; preds = %9
  ...
  %17 = call i32 @_Z2xuPiii(i32* %14, i32 %15, i32 %16)
...
24:                                               ; preds = %9
  %25 = getelementptr inbounds [30 x i32], [30 x i32]* %7, i64 0, i64 0
  %26 = load i32, i32* %4, align 4
  %27 = call i32 @_Z4maxdPii(i32* %25, i32 %26)
  %28 = icmp eq i32 %27, 0
...
53:                                               ; preds = %35
  ...
  %56 = sub nsw i32 %55, 1
  %57 = call i32 @_Z4shaiPii(i32* %54, i32 %56)
  br label %58
...
20:                                               ; preds = %8
  ...
  %23 = call i32 @_Z4shaiPii(i32* %21, i32 %22)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_794.cpp() #0 section ".text.startup" {
