; ModuleID = 'POJ-104-source/10/10-89.cpp'
source_filename = "POJ-104-source/10/10-89.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_89.cpp, i8* null }]
...
19:                                               ; preds = %6
  ...
  %23 = call i32 @_Z1fiiPi(i32 %20, i32 %21, i32* %22)
  %24 = sub nsw i32 %23, 1
...
32:                                               ; preds = %20
  ...
  %36 = call i32 @_Z1fiiPi(i32 %33, i32 %34, i32* %35)
...
39:                                               ; preds = %32
  ...
  %43 = call i32 @_Z1fiiPi(i32 %40, i32 %41, i32* %42)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_89.cpp() #0 section ".text.startup" {
