; ModuleID = 'POJ-104-source/10/10-979.cpp'
source_filename = "POJ-104-source/10/10-979.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_10_979.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z3daoii(i32 %0, i32 %1) #0 {
...
20:                                               ; preds = %13
  ...
  call void @_Z3daoii(i32 %26, i32 %27)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_10_979.cpp() #0 section ".text.startup" {
