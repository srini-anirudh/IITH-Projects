; ModuleID = 'POJ-104-source/100/100-1033.cpp'
source_filename = "POJ-104-source/100/100-1033.cpp"
...
@__const.main.letter = private unnamed_addr constant <{ [26 x i8], [274 x i8] }> <{ [26 x i8] c"abcdefghijklmnopqrstuvwxyz", [274 x i8] zeroinitializer }>, align 16
@.str = private unnamed_addr constant [3 x i8] c"%s\00", align 1
@.str.1 = private unnamed_addr constant [7 x i8] c"%c=%d\0A\00", align 1
@.str.2 = private unnamed_addr constant [4 x i8] c"No\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_100_1033.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %9, i8* align 16 getelementptr inbounds (<{ [26 x i8], [274 x i8] }>, <{ [26 x i8], [274 x i8] }>* @__const.main.letter, i32 0, i32 0, i32 0), i64 300, i1 false)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_100_1033.cpp() #0 section ".text.startup" {
