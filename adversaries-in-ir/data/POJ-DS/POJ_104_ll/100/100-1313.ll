; ModuleID = 'POJ-104-source/100/100-1313.cpp'
source_filename = "POJ-104-source/100/100-1313.cpp"
...
@freq = dso_local global [26 x i32] zeroinitializer, align 16
@.str = private unnamed_addr constant [3 x i8] c"%s\00", align 1
@.str.1 = private unnamed_addr constant [7 x i8] c"%c=%d\0A\00", align 1
@.str.2 = private unnamed_addr constant [3 x i8] c"No\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_100_1313.cpp, i8* null }]
...
53:                                               ; preds = %50
  ...
  %56 = getelementptr inbounds [26 x i32], [26 x i32]* @freq, i64 0, i64 %55
...
59:                                               ; preds = %53
  ...
  %67 = getelementptr inbounds [26 x i32], [26 x i32]* @freq, i64 0, i64 %66
  %68 = load i32, i32* %67, align 4
  %69 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32 %64, i32 %68)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_100_1313.cpp() #0 section ".text.startup" {
