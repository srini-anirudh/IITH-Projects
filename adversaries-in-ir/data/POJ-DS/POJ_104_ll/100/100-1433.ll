; ModuleID = 'POJ-104-source/100/100-1433.cpp'
source_filename = "POJ-104-source/100/100-1433.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_100_1433.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z13main_h5_1_ptrv() #0 {
  %1 = alloca i8*, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_100_1433.cpp() #0 section ".text.startup" {
