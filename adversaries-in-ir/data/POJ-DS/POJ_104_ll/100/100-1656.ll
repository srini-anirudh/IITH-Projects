; ModuleID = 'POJ-104-source/100/100-1656.cpp'
source_filename = "POJ-104-source/100/100-1656.cpp"
...
@__const.main.g = private unnamed_addr constant <{ [52 x i8], [8 x i8] }> <{ [52 x i8] c"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz", [8 x i8] zeroinitializer }>, align 16
@.str.1 = private unnamed_addr constant [7 x i8] c"%c=%d\0A\00", align 1
@.str.2 = private unnamed_addr constant [4 x i8] c"No\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_100_1656.cpp, i8* null }]
...
491:                                              ; preds = %14
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %492, i8* align 16 getelementptr inbounds (<{ [52 x i8], [8 x i8] }>, <{ [52 x i8], [8 x i8] }>* @__const.main.g, i32 0, i32 0, i32 0), i64 60, i1 false)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_100_1656.cpp() #0 section ".text.startup" {
