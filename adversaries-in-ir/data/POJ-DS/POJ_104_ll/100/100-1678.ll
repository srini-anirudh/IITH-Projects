; ModuleID = 'POJ-104-source/100/100-1678.cpp'
source_filename = "POJ-104-source/100/100-1678.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_100_1678.cpp, i8* null }]
...
67:                                               ; preds = %16
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %68, i8* align 16 getelementptr inbounds (<{ [52 x i8], [8 x i8] }>, <{ [52 x i8], [8 x i8] }>* @__const.main.g, i32 0, i32 0, i32 0), i64 60, i1 false)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_100_1678.cpp() #0 section ".text.startup" {
