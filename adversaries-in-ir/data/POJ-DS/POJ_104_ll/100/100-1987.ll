; ModuleID = 'POJ-104-source/100/100-1987.cpp'
source_filename = "POJ-104-source/100/100-1987.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_100_1987.cpp, i8* null }]
...
94:                                               ; preds = %89
  ...
  %97 = getelementptr inbounds [50 x i8], [50 x i8]* %7, i64 0, i64 %96
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_100_1987.cpp() #0 section ".text.startup" {
