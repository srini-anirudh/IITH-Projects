; ModuleID = 'POJ-104-source/100/100-2164.cpp'
source_filename = "POJ-104-source/100/100-2164.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_100_2164.cpp, i8* null }]
...
135:                                              ; preds = %129
  ...
  %140 = getelementptr inbounds [26 x i32], [26 x i32]* %10, i64 0, i64 %139
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_100_2164.cpp() #0 section ".text.startup" {
