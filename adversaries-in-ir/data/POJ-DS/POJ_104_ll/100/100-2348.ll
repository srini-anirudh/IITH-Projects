; ModuleID = 'POJ-104-source/100/100-2348.cpp'
source_filename = "POJ-104-source/100/100-2348.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_100_2348.cpp, i8* null }]
...
58:                                               ; preds = %55
  ...
  %61 = getelementptr inbounds [52 x i32], [52 x i32]* %3, i64 0, i64 %60
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_100_2348.cpp() #0 section ".text.startup" {
