; ModuleID = 'POJ-104-source/100/100-2377.cpp'
source_filename = "POJ-104-source/100/100-2377.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_100_2377.cpp, i8* null }]
...
86:                                               ; preds = %80
  ...
  %93 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32 %88, i32 %92)
  store i32 0, i32* %7, align 4
  br label %94
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_100_2377.cpp() #0 section ".text.startup" {
