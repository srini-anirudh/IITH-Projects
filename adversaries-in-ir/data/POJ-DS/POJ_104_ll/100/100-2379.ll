; ModuleID = 'POJ-104-source/100/100-2379.cpp'
source_filename = "POJ-104-source/100/100-2379.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_100_2379.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %2 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([10000 x i8], [10000 x i8]* @a, i64 0, i64 0))
...
3:                                                ; preds = %46, %0
  ...
  %5 = sext i32 %4 to i64
  %6 = call i64 @strlen(i8* getelementptr inbounds ([10000 x i8], [10000 x i8]* @a, i64 0, i64 0)) #7
  %7 = icmp ult i64 %5, %6
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_100_2379.cpp() #0 section ".text.startup" {
