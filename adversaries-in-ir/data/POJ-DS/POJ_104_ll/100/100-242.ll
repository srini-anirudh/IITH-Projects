; ModuleID = 'POJ-104-source/100/100-242.cpp'
source_filename = "POJ-104-source/100/100-242.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_100_242.cpp, i8* null }]
...
93:                                               ; preds = %121, %87
  ...
  %96 = getelementptr inbounds [300 x i8], [300 x i8]* %2, i64 0, i64 0
...
130:                                              ; preds = %162, %129
  ...
  %133 = getelementptr inbounds [300 x i8], [300 x i8]* %2, i64 0, i64 0
...
150:                                              ; preds = %143
  ...
  %160 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32 %155, i32 %159)
  br label %161

161:                                              ; preds = %150, %143, %136
  br label %162
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_100_242.cpp() #0 section ".text.startup" {
