; ModuleID = 'POJ-104-source/100/100-2423.cpp'
source_filename = "POJ-104-source/100/100-2423.cpp"
...
@w = dso_local global [52 x %struct.word] zeroinitializer, align 16
@tmp = dso_local global %struct.word zeroinitializer, align 4
@.str = private unnamed_addr constant [3 x i8] c"%s\00", align 1
@.str.1 = private unnamed_addr constant [3 x i8] c"No\00", align 1
@.str.2 = private unnamed_addr constant [7 x i8] c"%c=%d\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_100_2423.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_100_2423.cpp() #0 section ".text.startup" {
