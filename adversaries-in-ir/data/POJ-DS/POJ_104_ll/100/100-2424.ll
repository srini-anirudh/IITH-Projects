; ModuleID = 'POJ-104-source/100/100-2424.cpp'
source_filename = "POJ-104-source/100/100-2424.cpp"
...
@B = dso_local global [300 x %struct.zimu] zeroinitializer, align 16
@temp = dso_local global %struct.zimu zeroinitializer, align 4
@.str = private unnamed_addr constant [3 x i8] c"%s\00", align 1
@.str.1 = private unnamed_addr constant [3 x i8] c"No\00", align 1
@.str.2 = private unnamed_addr constant [7 x i8] c"%c=%d\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_100_2424.cpp, i8* null }]
...
162:                                              ; preds = %147
  ...
  %170 = getelementptr inbounds [300 x %struct.zimu], [300 x %struct.zimu]* @B, i64 0, i64 %169
  %171 = load i32, i32* %5, align 4
  %172 = add nsw i32 %171, 1
  %173 = sext i32 %172 to i64
  %174 = getelementptr inbounds [300 x %struct.zimu], [300 x %struct.zimu]* @B, i64 0, i64 %173
  %175 = bitcast %struct.zimu* %174 to i8*
  %176 = bitcast %struct.zimu* %170 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_100_2424.cpp() #0 section ".text.startup" {
