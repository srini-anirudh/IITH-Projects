; ModuleID = 'POJ-104-source/100/100-2443.cpp'
source_filename = "POJ-104-source/100/100-2443.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_100_2443.cpp, i8* null }]
...
184:                                              ; preds = %170
  ...
  %196 = bitcast %struct.c* %195 to i8*
  %197 = bitcast %struct.c* %192 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_100_2443.cpp() #0 section ".text.startup" {
