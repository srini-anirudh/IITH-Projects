; ModuleID = 'POJ-104-source/100/100-284.cpp'
source_filename = "POJ-104-source/100/100-284.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_100_284.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %12 = bitcast i8* %11 to <{ i32, [299 x i32] }>*
  %13 = getelementptr inbounds <{ i32, [299 x i32] }>, <{ i32, [299 x i32] }>* %12, i32 0, i32 0
...
165:                                              ; preds = %159
  ...
  %175 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0), i32 %170, i32 %174)
  br label %176
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_100_284.cpp() #0 section ".text.startup" {
