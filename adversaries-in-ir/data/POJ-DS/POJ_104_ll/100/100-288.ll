; ModuleID = 'POJ-104-source/100/100-288.cpp'
source_filename = "POJ-104-source/100/100-288.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_100_288.cpp, i8* null }]
...
66:                                               ; preds = %60
  ...
  %69 = getelementptr inbounds [26 x i8], [26 x i8]* %3, i64 0, i64 %68
  ...
  %76 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0), i32 %71, i32 %75)
  br label %77
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_100_288.cpp() #0 section ".text.startup" {
