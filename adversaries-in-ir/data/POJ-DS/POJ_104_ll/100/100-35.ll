; ModuleID = 'POJ-104-source/100/100-35.cpp'
source_filename = "POJ-104-source/100/100-35.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_100_35.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5countPc(i8* %0) #0 {
  %2 = alloca i8*, align 8
...
define dso_local i32 @main() #5 {
  ...
  %4 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i8* %3)
  %5 = getelementptr inbounds [300 x i8], [300 x i8]* %1, i64 0, i64 0
  call void @_Z5countPc(i8* %5)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_100_35.cpp() #0 section ".text.startup" {
