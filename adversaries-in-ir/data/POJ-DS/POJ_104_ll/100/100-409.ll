; ModuleID = 'POJ-104-source/100/100-409.cpp'
source_filename = "POJ-104-source/100/100-409.cpp"
...
@__const.main.w = private unnamed_addr constant <{ [26 x i8], [29 x i8] }> <{ [26 x i8] c"abcdefghijklmnopqrstuvwxyz", [29 x i8] zeroinitializer }>, align 16
@.str = private unnamed_addr constant [3 x i8] c"%s\00", align 1
@.str.1 = private unnamed_addr constant [6 x i8] c"%c=%d\00", align 1
@.str.2 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@.str.3 = private unnamed_addr constant [4 x i8] c"No\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_100_409.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %7, i8* align 16 getelementptr inbounds (<{ [26 x i8], [29 x i8] }>, <{ [26 x i8], [29 x i8] }>* @__const.main.w, i32 0, i32 0, i32 0), i64 55, i1 false)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_100_409.cpp() #0 section ".text.startup" {
