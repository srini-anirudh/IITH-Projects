; ModuleID = 'POJ-104-source/100/100-584.cpp'
source_filename = "POJ-104-source/100/100-584.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_100_584.cpp, i8* null }]
...
32:                                               ; preds = %25
  ...
  %40 = getelementptr inbounds [26 x i8], [26 x i8]* %3, i64 0, i64 %39
...
57:                                               ; preds = %51
  ...
  %65 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32 %59, i32 %64)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_100_584.cpp() #0 section ".text.startup" {
