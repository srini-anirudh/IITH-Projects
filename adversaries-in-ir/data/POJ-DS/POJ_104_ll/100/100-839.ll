; ModuleID = 'POJ-104-source/100/100-839.cpp'
source_filename = "POJ-104-source/100/100-839.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_100_839.cpp, i8* null }]
...
95:                                               ; preds = %89
  ...
  %102 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32 %97, i32 %101)
  br label %103
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_100_839.cpp() #0 section ".text.startup" {
