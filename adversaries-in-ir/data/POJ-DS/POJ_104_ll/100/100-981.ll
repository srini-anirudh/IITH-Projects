; ModuleID = 'POJ-104-source/100/100-981.cpp'
source_filename = "POJ-104-source/100/100-981.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_100_981.cpp, i8* null }]
...
362:                                              ; preds = %360, %357
  %363 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i32* %4)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_100_981.cpp() #0 section ".text.startup" {
