; ModuleID = 'POJ-104-source/101/101-1168.cpp'
source_filename = "POJ-104-source/101/101-1168.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_101_1168.cpp, i8* null }]
...
182:                                              ; preds = %178
  %183 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.4, i64 0, i64 0))
  br label %184
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_101_1168.cpp() #0 section ".text.startup" {
