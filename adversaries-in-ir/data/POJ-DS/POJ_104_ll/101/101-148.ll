; ModuleID = 'POJ-104-source/101/101-148.cpp'
source_filename = "POJ-104-source/101/101-148.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_101_148.cpp, i8* null }]
...
142:                                              ; preds = %133
  ...
  %145 = getelementptr inbounds [3 x i8], [3 x i8]* %12, i64 0, i64 %144
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_101_148.cpp() #0 section ".text.startup" {
