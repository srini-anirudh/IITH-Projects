; ModuleID = 'POJ-104-source/101/101-172.cpp'
source_filename = "POJ-104-source/101/101-172.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_101_172.cpp, i8* null }]
...
148:                                              ; preds = %144, %128, %112, %96, %80, %64
  ...
  %154 = getelementptr inbounds [3 x i8], [3 x i8]* %9, i64 0, i64 %153
  store i8 66, i8* %154, align 1
  %155 = load i32, i32* %4, align 4
  %156 = sext i32 %155 to i64
  %157 = getelementptr inbounds [3 x i8], [3 x i8]* %9, i64 0, i64 %156
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_101_172.cpp() #0 section ".text.startup" {
