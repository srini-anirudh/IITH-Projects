; ModuleID = 'POJ-104-source/101/101-34.cpp'
source_filename = "POJ-104-source/101/101-34.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_101_34.cpp, i8* null }]
...
74:                                               ; preds = %70
  ...
  %84 = getelementptr inbounds [3 x i8], [3 x i8]* %8, i64 0, i64 0
  ...
  %90 = getelementptr inbounds [3 x i8], [3 x i8]* %8, i64 0, i64 2
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_101_34.cpp() #0 section ".text.startup" {
