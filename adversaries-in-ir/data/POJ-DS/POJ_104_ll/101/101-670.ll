; ModuleID = 'POJ-104-source/101/101-670.cpp'
source_filename = "POJ-104-source/101/101-670.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_101_670.cpp, i8* null }]
...
117:                                              ; preds = %9
  %118 = getelementptr inbounds [4 x i8], [4 x i8]* %8, i64 0, i64 1
  ...
  %121 = getelementptr inbounds [4 x i8], [4 x i8]* %8, i64 0, i64 2
  ...
  %124 = getelementptr inbounds [4 x i8], [4 x i8]* %8, i64 0, i64 3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_101_670.cpp() #0 section ".text.startup" {
