; ModuleID = 'POJ-104-source/101/101-919.cpp'
source_filename = "POJ-104-source/101/101-919.cpp"
...
@b = dso_local global [3 x i32] zeroinitializer, align 4
@c = dso_local global [3 x i32] zeroinitializer, align 4
@d = dso_local global [3 x i32] zeroinitializer, align 4
@p = dso_local global i32 0, align 4
@q = dso_local global i32 0, align 4
@.str = private unnamed_addr constant [8 x i8] c"%c%c%c\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_101_919.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_101_919.cpp() #0 section ".text.startup" {
