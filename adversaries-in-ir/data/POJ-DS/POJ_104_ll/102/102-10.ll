; ModuleID = 'POJ-104-source/102/102-10.cpp'
source_filename = "POJ-104-source/102/102-10.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_10.cpp, i8* null }]
...
43:                                               ; preds = %35
  ...
  %46 = getelementptr inbounds [40 x %struct.point], [40 x %struct.point]* %7, i64 0, i64 %45
...
54:                                               ; preds = %43, %35
  ...
  %60 = call i32 @strcmp(i8* %59, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i64 0, i64 0)) #7
  %61 = icmp eq i32 %60, 0
...
62:                                               ; preds = %54
  ...
  %65 = getelementptr inbounds [40 x %struct.point], [40 x %struct.point]* %7, i64 0, i64 %64
  %66 = load i32, i32* %4, align 4
  %67 = sext i32 %66 to i64
  %68 = getelementptr inbounds [40 x %struct.point], [40 x %struct.point]* %9, i64 0, i64 %67
...
102:                                              ; preds = %89
  ...
  %111 = getelementptr inbounds [40 x %struct.point], [40 x %struct.point]* %8, i64 0, i64 %110
  ...
  %116 = bitcast %struct.point* %111 to i8*
...
156:                                              ; preds = %143
  ...
  %170 = bitcast %struct.point* %165 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_10.cpp() #0 section ".text.startup" {
