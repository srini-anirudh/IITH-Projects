; ModuleID = 'POJ-104-source/102/102-1002.cpp'
source_filename = "POJ-104-source/102/102-1002.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_1002.cpp, i8* null }]
...
17:                                               ; preds = %13
  ...
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %21, float* %24)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_1002.cpp() #0 section ".text.startup" {
