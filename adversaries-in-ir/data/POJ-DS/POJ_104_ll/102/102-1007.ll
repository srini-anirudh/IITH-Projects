; ModuleID = 'POJ-104-source/102/102-1007.cpp'
source_filename = "POJ-104-source/102/102-1007.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_1007.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %13 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), double* %7)
...
35:                                               ; preds = %30
  ...
  %43 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i8* %39, double* %42)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_1007.cpp() #0 section ".text.startup" {
