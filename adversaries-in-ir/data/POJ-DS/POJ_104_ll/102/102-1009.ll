; ModuleID = 'POJ-104-source/102/102-1009.cpp'
source_filename = "POJ-104-source/102/102-1009.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_1009.cpp, i8* null }]
...
12:                                               ; preds = %8
  ...
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i8* %17, double* %21)
  br label %23
...
38:                                               ; preds = %32
  ...
  %44 = call i32 @strcmp(i8* %43, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #7
  %45 = icmp eq i32 %44, 0
...
46:                                               ; preds = %38
  ...
  %58 = call i32 @strcmp(i8* %51, i8* %57) #7
  %59 = icmp eq i32 %58, 0
...
96:                                               ; preds = %38
  ...
  %102 = call i32 @strcmp(i8* %101, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i64 0, i64 0)) #7
...
104:                                              ; preds = %96
  ...
  %116 = call i32 @strcmp(i8* %109, i8* %115) #7
...
131:                                              ; preds = %118
  ...
  %140 = getelementptr inbounds [41 x %struct.student], [41 x %struct.student]* %5, i64 0, i64 %139
  ...
  %145 = bitcast %struct.student* %140 to i8*
...
153:                                              ; preds = %104
  ...
  %167 = bitcast %struct.student* %162 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_1009.cpp() #0 section ".text.startup" {
