; ModuleID = 'POJ-104-source/102/102-1034.cpp'
source_filename = "POJ-104-source/102/102-1034.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_1034.cpp, i8* null }]
...
24:                                               ; preds = %17
  ...
  %28 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), double* %27)
...
31:                                               ; preds = %17
  ...
  %35 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), double* %34)
...
42:                                               ; preds = %12
  ...
  %44 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* %43)
...
49:                                               ; preds = %42
  ...
  %53 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i64 0, i64 0), double* %52)
...
56:                                               ; preds = %42
  ...
  %60 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i64 0, i64 0), double* %59)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_1034.cpp() #0 section ".text.startup" {
