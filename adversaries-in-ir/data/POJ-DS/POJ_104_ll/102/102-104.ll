; ModuleID = 'POJ-104-source/102/102-104.cpp'
source_filename = "POJ-104-source/102/102-104.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_104.cpp, i8* null }]
...
22:                                               ; preds = %16
  ...
  %27 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i64 0, i64 0), double* %26)
  br label %34
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_104.cpp() #0 section ".text.startup" {
