; ModuleID = 'POJ-104-source/102/102-1042.cpp'
source_filename = "POJ-104-source/102/102-1042.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_1042.cpp, i8* null }]
...
19:                                               ; preds = %15
  ...
  %30 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), double* %29)
  br label %31
...
39:                                               ; preds = %35
  ...
  %45 = call i32 @strcmp(i8* %44, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0)) #6
  %46 = icmp eq i32 %45, 0
...
62:                                               ; preds = %58
  ...
  %68 = call i32 @strcmp(i8* %67, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0)) #6
  %69 = icmp eq i32 %68, 0
...
139:                                              ; preds = %135
  ...
  %145 = call i32 @strcmp(i8* %144, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.4, i64 0, i64 0)) #6
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_1042.cpp() #0 section ".text.startup" {
