; ModuleID = 'POJ-104-source/102/102-1059.cpp'
source_filename = "POJ-104-source/102/102-1059.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_1059.cpp, i8* null }]
...
19:                                               ; preds = %15
  ...
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i64 0, i64 0), i8* %20, double* %23)
  %25 = getelementptr inbounds [41 x i8], [41 x i8]* %13, i64 0, i64 0
  %26 = call i32 @strcmp(i8* %25, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #6
  %27 = icmp eq i32 %26, 0
...
39:                                               ; preds = %28, %19
  ...
  %41 = call i32 @strcmp(i8* %40, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i64 0, i64 0)) #6
  %42 = icmp eq i32 %41, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_1059.cpp() #0 section ".text.startup" {
