; ModuleID = 'POJ-104-source/102/102-1089.cpp'
source_filename = "POJ-104-source/102/102-1089.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_1089.cpp, i8* null }]
...
18:                                               ; preds = %14
  ...
  %22 = call i32 @strcmp(i8* %21, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #6
  store i32 %22, i32* %7, align 4
  %23 = getelementptr inbounds [7 x i8], [7 x i8]* %12, i64 0, i64 0
  %24 = call i32 @strcmp(i8* %23, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i64 0, i64 0)) #6
...
27:                                               ; preds = %18
  ...
  %31 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.4, i64 0, i64 0), double* %30)
...
37:                                               ; preds = %34
  ...
  %41 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.4, i64 0, i64 0), double* %40)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_1089.cpp() #0 section ".text.startup" {
