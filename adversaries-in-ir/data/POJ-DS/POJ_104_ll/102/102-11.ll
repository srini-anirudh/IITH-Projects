; ModuleID = 'POJ-104-source/102/102-11.cpp'
source_filename = "POJ-104-source/102/102-11.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_11.cpp, i8* null }]
...
16:                                               ; preds = %12
  ...
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i8* %17, float* %9)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_11.cpp() #0 section ".text.startup" {
