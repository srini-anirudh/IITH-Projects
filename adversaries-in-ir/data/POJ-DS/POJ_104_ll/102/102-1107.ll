; ModuleID = 'POJ-104-source/102/102-1107.cpp'
source_filename = "POJ-104-source/102/102-1107.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_1107.cpp, i8* null }]
...
114:                                              ; preds = %110
  ...
  %120 = call i32 @strcmp(i8* %119, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #6
...
140:                                              ; preds = %136
  ...
  %146 = call i32 @strcmp(i8* %145, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #6
...
165:                                              ; preds = %162
  ...
  %171 = call i32 @strcmp(i8* %170, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.5, i64 0, i64 0)) #6
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_1107.cpp() #0 section ".text.startup" {
