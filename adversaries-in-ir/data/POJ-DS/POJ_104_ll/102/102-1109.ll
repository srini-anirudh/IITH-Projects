; ModuleID = 'POJ-104-source/102/102-1109.cpp'
source_filename = "POJ-104-source/102/102-1109.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_1109.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %16 = call i8* @strcpy(i8* %15, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0)) #3
  %17 = getelementptr inbounds [1 x [7 x i8]], [1 x [7 x i8]]* %13, i64 0, i64 0
  %18 = getelementptr inbounds [7 x i8], [7 x i8]* %17, i64 0, i64 0
  %19 = call i8* @strcpy(i8* %18, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0)) #3
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i32* %2)
...
25:                                               ; preds = %21
  ...
  %33 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.3, i64 0, i64 0), i8* %29, double* %32)
  ...
  %40 = call i32 @strcmp(i8* %35, i8* %39) #6
  %41 = icmp ne i32 %40, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_1109.cpp() #0 section ".text.startup" {
