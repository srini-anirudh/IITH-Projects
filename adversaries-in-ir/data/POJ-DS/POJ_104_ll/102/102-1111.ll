; ModuleID = 'POJ-104-source/102/102-1111.cpp'
source_filename = "POJ-104-source/102/102-1111.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_1111.cpp, i8* null }]
...
28:                                               ; preds = %24
  ...
  %36 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %32, double* %35)
  br label %37
...
280:                                              ; preds = %267
  %281 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %2)
  store i32 0, i32* %1, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_1111.cpp() #0 section ".text.startup" {
