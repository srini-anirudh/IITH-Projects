; ModuleID = 'POJ-104-source/102/102-1142.cpp'
source_filename = "POJ-104-source/102/102-1142.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_1142.cpp, i8* null }]
...
19:                                               ; preds = %15
  ...
  %23 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), [40 x i8]* %13, double* %22)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_1142.cpp() #0 section ".text.startup" {
