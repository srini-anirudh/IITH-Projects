; ModuleID = 'POJ-104-source/102/102-1159.cpp'
source_filename = "POJ-104-source/102/102-1159.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_1159.cpp, i8* null }]
...
36:                                               ; preds = %32
  ...
  %41 = call i32 @strcmp(i8* %40, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0)) #6
  %42 = icmp eq i32 %41, 0
...
53:                                               ; preds = %36
  ...
  %58 = call i32 @strcmp(i8* %57, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.4, i64 0, i64 0)) #6
  %59 = icmp eq i32 %58, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_1159.cpp() #0 section ".text.startup" {
