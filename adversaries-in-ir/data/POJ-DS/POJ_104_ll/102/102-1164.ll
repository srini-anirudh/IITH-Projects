; ModuleID = 'POJ-104-source/102/102-1164.cpp'
source_filename = "POJ-104-source/102/102-1164.cpp"
...
@m = dso_local global [39 x %struct.data] zeroinitializer, align 16
@f = dso_local global [39 x %struct.data] zeroinitializer, align 16
@temp = dso_local global %struct.data zeroinitializer, align 4
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [5 x i8] c"%s%f\00", align 1
@.str.2 = private unnamed_addr constant [6 x i8] c"%.2f \00", align 1
@.str.3 = private unnamed_addr constant [6 x i8] c"%.2f\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_1164.cpp, i8* null }]
...
12:                                               ; preds = %8
  ...
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i8* %17, float* %21)
  br label %23
...
51:                                               ; preds = %31
  ...
  %54 = getelementptr inbounds [40 x %struct.data], [40 x %struct.data]* @stu, i64 0, i64 %53
  %55 = load i32, i32* %6, align 4
  %56 = sext i32 %55 to i64
  %57 = getelementptr inbounds [39 x %struct.data], [39 x %struct.data]* @f, i64 0, i64 %56
  %58 = bitcast %struct.data* %57 to i8*
  %59 = bitcast %struct.data* %54 to i8*
...
93:                                               ; preds = %80
  ...
  %101 = getelementptr inbounds [39 x %struct.data], [39 x %struct.data]* @m, i64 0, i64 %100
  ...
  %107 = bitcast %struct.data* %101 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_1164.cpp() #0 section ".text.startup" {
