; ModuleID = 'POJ-104-source/102/102-1176.cpp'
source_filename = "POJ-104-source/102/102-1176.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_1176.cpp, i8* null }]
...
17:                                               ; preds = %13
  ...
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %21, double* %24)
  ...
  %30 = call i32 @strcmp(i8* %29, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #6
  %31 = icmp eq i32 %30, 0
...
42:                                               ; preds = %17
  ...
  %47 = call i32 @strcmp(i8* %46, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i64 0, i64 0)) #6
  %48 = icmp eq i32 %47, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_1176.cpp() #0 section ".text.startup" {
