; ModuleID = 'POJ-104-source/102/102-1204.cpp'
source_filename = "POJ-104-source/102/102-1204.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_1204.cpp, i8* null }]
...
23:                                               ; preds = %19
  ...
  %33 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %28, double* %32)
  br label %34
...
60:                                               ; preds = %47
  ...
  %63 = getelementptr inbounds %struct.ppp, %struct.ppp* %18, i64 %62
  %64 = getelementptr inbounds %struct.ppp, %struct.ppp* %18, i64 0
  %65 = bitcast %struct.ppp* %64 to i8*
  %66 = bitcast %struct.ppp* %63 to i8*
  ...
  %74 = bitcast %struct.ppp* %73 to i8*
  %75 = bitcast %struct.ppp* %70 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %74, i8* align 16 %75, i64 16, i1 false)
  %76 = getelementptr inbounds %struct.ppp, %struct.ppp* %18, i64 0
  %77 = load i32, i32* %6, align 4
  %78 = add nsw i32 %77, 1
  %79 = sext i32 %78 to i64
  %80 = getelementptr inbounds %struct.ppp, %struct.ppp* %18, i64 %79
  %81 = bitcast %struct.ppp* %80 to i8*
  %82 = bitcast %struct.ppp* %76 to i8*
...
98:                                               ; preds = %94
  ...
  %104 = call i32 @strcmp(i8* %103, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #7
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_1204.cpp() #0 section ".text.startup" {
