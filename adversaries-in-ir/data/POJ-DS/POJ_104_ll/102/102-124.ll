; ModuleID = 'POJ-104-source/102/102-124.cpp'
source_filename = "POJ-104-source/102/102-124.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_124.cpp, i8* null }]
...
17:                                               ; preds = %13
  ...
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), [10 x i8]* %20, float* %23)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_124.cpp() #0 section ".text.startup" {
