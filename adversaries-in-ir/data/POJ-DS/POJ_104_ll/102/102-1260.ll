; ModuleID = 'POJ-104-source/102/102-1260.cpp'
source_filename = "POJ-104-source/102/102-1260.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_1260.cpp, i8* null }]
...
59:                                               ; preds = %16
  ...
  call void @_ZSt4sortIPdEvT_S1_(double* %61, double* %66)
  ...
  call void @_ZSt4sortIPdEvT_S1_(double* %68, double* %73)
  store i32 1, i32* %5, align 4
  br label %74
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_1260.cpp() #0 section ".text.startup" {
