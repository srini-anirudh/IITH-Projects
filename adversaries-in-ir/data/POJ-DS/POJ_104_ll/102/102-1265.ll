; ModuleID = 'POJ-104-source/102/102-1265.cpp'
source_filename = "POJ-104-source/102/102-1265.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_1265.cpp, i8* null }]
...
19:                                               ; preds = %15
  ...
  %27 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %23, float* %26)
  br label %28
...
110:                                              ; preds = %106
  ...
  %116 = call i32 @strcmp(i8* %114, i8* %115) #7
...
137:                                              ; preds = %133
  ...
  %143 = call i32 @strcmp(i8* %141, i8* %142) #7
...
162:                                              ; preds = %159
  ...
  %168 = call i32 @strcmp(i8* %166, i8* %167) #7
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_1265.cpp() #0 section ".text.startup" {
