; ModuleID = 'POJ-104-source/102/102-1268.cpp'
source_filename = "POJ-104-source/102/102-1268.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_1268.cpp, i8* null }]
...
16:                                               ; preds = %12
  ...
  %20 = call i32 @strcmp(i8* %19, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #6
  %21 = icmp eq i32 %20, 0
...
22:                                               ; preds = %16
  ...
  %26 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i64 0, i64 0), double* %25)
...
29:                                               ; preds = %16
  ...
  %33 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i64 0, i64 0), double* %32)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_1268.cpp() #0 section ".text.startup" {
