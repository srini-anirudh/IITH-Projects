; ModuleID = 'POJ-104-source/102/102-1271.cpp'
source_filename = "POJ-104-source/102/102-1271.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_1271.cpp, i8* null }]
...
17:                                               ; preds = %13
  ...
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i8* %21, float* %24)
  br label %26
...
34:                                               ; preds = %30
  ...
  %37 = getelementptr inbounds [40 x [9 x i8]], [40 x [9 x i8]]* %7, i64 0, i64 %36
  %38 = getelementptr inbounds [9 x i8], [9 x i8]* %37, i64 0, i64 0
  %39 = call i32 @strcmp(i8* %38, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #6
  %40 = icmp eq i32 %39, 0
...
159:                                              ; preds = %113
  %160 = getelementptr inbounds [40 x float], [40 x float]* %10, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_1271.cpp() #0 section ".text.startup" {
