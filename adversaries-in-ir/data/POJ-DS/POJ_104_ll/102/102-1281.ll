; ModuleID = 'POJ-104-source/102/102-1281.cpp'
source_filename = "POJ-104-source/102/102-1281.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_1281.cpp, i8* null }]
...
define dso_local void @_Z9big_smallPfi(float* %0, i32 %1) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z9small_bigPfi(float* %0, i32 %1) #4 {
  %3 = alloca float*, align 8
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
26:                                               ; preds = %14
  ...
  %30 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), float* %29)
...
44:                                               ; preds = %10
  ...
  call void @_Z9small_bigPfi(float* %45, i32 %46)
  %47 = getelementptr inbounds [40 x float], [40 x float]* %8, i64 0, i64 0
  %48 = load i32, i32* %6, align 4
  call void @_Z9big_smallPfi(float* %47, i32 %48)
  store i32 1, i32* %4, align 4
  br label %49
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_1281.cpp() #0 section ".text.startup" {
