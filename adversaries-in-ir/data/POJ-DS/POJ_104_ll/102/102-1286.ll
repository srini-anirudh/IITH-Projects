; ModuleID = 'POJ-104-source/102/102-1286.cpp'
source_filename = "POJ-104-source/102/102-1286.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_1286.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), [10 x i8]* %19, float* %23)
  br label %25
...
68:                                               ; preds = %29
  ...
  call void @_Z4lineiPf(i32 %69, float* %70)
  %71 = load i32, i32* %6, align 4
  %72 = getelementptr inbounds [45 x float], [45 x float]* %9, i64 0, i64 0
  call void @_Z4lineiPf(i32 %71, float* %72)
  store i32 0, i32* %4, align 4
  br label %73
...
define dso_local void @_Z4lineiPf(i32 %0, float* %1) #5 {
  %3 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_1286.cpp() #0 section ".text.startup" {
