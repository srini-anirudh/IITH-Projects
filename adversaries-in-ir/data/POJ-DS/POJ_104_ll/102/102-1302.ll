; ModuleID = 'POJ-104-source/102/102-1302.cpp'
source_filename = "POJ-104-source/102/102-1302.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_1302.cpp, i8* null }]
...
19:                                               ; preds = %15
  ...
  %29 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %24, float* %28)
  br label %30
...
122:                                              ; preds = %108
  ...
  %137 = bitcast %struct.student* %132 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_1302.cpp() #0 section ".text.startup" {
