; ModuleID = 'POJ-104-source/102/102-1317.cpp'
source_filename = "POJ-104-source/102/102-1317.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_1317.cpp, i8* null }]
...
18:                                               ; preds = %14
  ...
  %28 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %23, double* %27)
  br label %29
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_1317.cpp() #0 section ".text.startup" {
