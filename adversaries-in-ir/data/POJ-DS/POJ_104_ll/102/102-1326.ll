; ModuleID = 'POJ-104-source/102/102-1326.cpp'
source_filename = "POJ-104-source/102/102-1326.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_1326.cpp, i8* null }]
...
define dso_local void @_Z4sortPfS_i(float* %0, float* %1, i32 %2) #4 {
...
30:                                               ; preds = %26
  ...
  %32 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %31, float* %6)
  %33 = getelementptr inbounds [7 x i8], [7 x i8]* %7, i64 0, i64 0
  %34 = call i32 @strcmp(i8* %33, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0)) #7
  %35 = icmp eq i32 %34, 0
...
73:                                               ; preds = %69
  ...
  call void @_Z4sortPfS_i(float* %77, float* %81, i32 1)
  br label %82
...
106:                                              ; preds = %100
  ...
  call void @_Z4sortPfS_i(float* %110, float* %114, i32 -1)
  br label %115
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_1326.cpp() #0 section ".text.startup" {
