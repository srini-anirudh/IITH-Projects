; ModuleID = 'POJ-104-source/102/102-133.cpp'
source_filename = "POJ-104-source/102/102-133.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_133.cpp, i8* null }]
...
44:                                               ; preds = %12
  ...
  call void @_ZSt4sortIPdEvT_S1_(double* %45, double* %49)
  ...
  call void @_ZSt4sortIPdEvT_S1_(double* %50, double* %54)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_133.cpp() #0 section ".text.startup" {
