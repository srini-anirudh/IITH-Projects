; ModuleID = 'POJ-104-source/102/102-1341.cpp'
source_filename = "POJ-104-source/102/102-1341.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_1341.cpp, i8* null }]
...
17:                                               ; preds = %13
  ...
  %26 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), [6 x i8]* %21, float* %25)
  br label %27
...
35:                                               ; preds = %31
  ...
  %41 = call i32 @strcmp(i8* %40, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #7
  %42 = icmp eq i32 %41, 0
...
43:                                               ; preds = %35
  ...
  %49 = getelementptr inbounds [50 x %struct.anon], [50 x %struct.anon]* %3, i64 0, i64 %48
  %50 = bitcast %struct.anon* %49 to i8*
  %51 = bitcast %struct.anon* %46 to i8*
...
54:                                               ; preds = %35
  ...
  %57 = getelementptr inbounds [50 x %struct.anon], [50 x %struct.anon]* %2, i64 0, i64 %56
  %58 = load i32, i32* %9, align 4
  %59 = sext i32 %58 to i64
  %60 = getelementptr inbounds [50 x %struct.anon], [50 x %struct.anon]* %4, i64 0, i64 %59
  %61 = bitcast %struct.anon* %60 to i8*
  %62 = bitcast %struct.anon* %57 to i8*
...
150:                                              ; preds = %137
  ...
  %159 = getelementptr inbounds [50 x %struct.anon], [50 x %struct.anon]* %4, i64 0, i64 %158
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_1341.cpp() #0 section ".text.startup" {
