; ModuleID = 'POJ-104-source/102/102-1345.cpp'
source_filename = "POJ-104-source/102/102-1345.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_1345.cpp, i8* null }]
...
24:                                               ; preds = %20
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), [7 x i8]* %7)
...
31:                                               ; preds = %24
  ...
  %35 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), float* %34)
...
38:                                               ; preds = %24
  ...
  %42 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), float* %41)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_1345.cpp() #0 section ".text.startup" {
