; ModuleID = 'POJ-104-source/102/102-136.cpp'
source_filename = "POJ-104-source/102/102-136.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_136.cpp, i8* null }]
...
define dso_local i32 @_Z6nancomPKvS0_(i8* %0, i8* %1) #4 {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z5nvcomPKvS0_(i8* %0, i8* %1) #4 {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
  store i8* %0, i8** %3, align 8
  store i8* %1, i8** %4, align 8
...
20:                                               ; preds = %16
  ...
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i8* %21, double* %4)
...
45:                                               ; preds = %16
  ...
  call void @qsort(i8* %47, i64 %49, i64 4, i32 (i8*, i8*)* @_Z6nancomPKvS0_)
  %50 = getelementptr inbounds [40 x i32], [40 x i32]* %3, i64 0, i64 0
  %51 = bitcast i32* %50 to i8*
  %52 = load i32, i32* %11, align 4
  %53 = sext i32 %52 to i64
  call void @qsort(i8* %51, i64 %53, i64 4, i32 (i8*, i8*)* @_Z5nvcomPKvS0_)
  store i32 0, i32* %7, align 4
  br label %54
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_136.cpp() #0 section ".text.startup" {
