; ModuleID = 'POJ-104-source/102/102-1360.cpp'
source_filename = "POJ-104-source/102/102-1360.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_1360.cpp, i8* null }]
...
22:                                               ; preds = %18
  ...
  %26 = call i32 @strcmp(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), i8* %25) #7
  %27 = icmp eq i32 %26, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_1360.cpp() #0 section ".text.startup" {
