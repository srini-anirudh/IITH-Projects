; ModuleID = 'POJ-104-source/102/102-1377.cpp'
source_filename = "POJ-104-source/102/102-1377.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_1377.cpp, i8* null }]
...
19:                                               ; preds = %14
  ...
  %26 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), [7 x i8]* %22, float* %25)
  br label %27
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_1377.cpp() #0 section ".text.startup" {
