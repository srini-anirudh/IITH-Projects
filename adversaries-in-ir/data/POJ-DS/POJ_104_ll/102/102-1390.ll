; ModuleID = 'POJ-104-source/102/102-1390.cpp'
source_filename = "POJ-104-source/102/102-1390.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_1390.cpp, i8* null }]
...
define dso_local float @_Z3cmpPfi(float* %0, i32 %1) #4 {
...
17:                                               ; preds = %13
  ...
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %18, float* %11)
...
41:                                               ; preds = %13
  ...
  %44 = call float @_Z3cmpPfi(float* %42, i32 %43)
  %45 = getelementptr inbounds [40 x float], [40 x float]* %10, i64 0, i64 0
  %46 = load i32, i32* %7, align 4
  %47 = call float @_Z3cmpPfi(float* %45, i32 %46)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_1390.cpp() #0 section ".text.startup" {
