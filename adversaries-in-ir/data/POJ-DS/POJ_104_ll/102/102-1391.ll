; ModuleID = 'POJ-104-source/102/102-1391.cpp'
source_filename = "POJ-104-source/102/102-1391.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_1391.cpp, i8* null }]
...
41:                                               ; preds = %12
  ...
  call void @_ZSt4sortIPdEvT_S1_(double* %42, double* %46)
  ...
  call void @_ZSt4sortIPdEvT_S1_(double* %47, double* %51)
  store i32 0, i32* %9, align 4
  br label %52
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_1391.cpp() #0 section ".text.startup" {
