; ModuleID = 'POJ-104-source/102/102-1396.cpp'
source_filename = "POJ-104-source/102/102-1396.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_1396.cpp, i8* null }]
...
18:                                               ; preds = %13
  ...
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i8* %23)
  ...
  %29 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), float* %28)
  br label %30
...
39:                                               ; preds = %34
  ...
  %45 = call i32 @strcmp(i8* %44, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0)) #8
  %46 = icmp eq i32 %45, 0
...
58:                                               ; preds = %47, %39
  ...
  %64 = call i32 @strcmp(i8* %63, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.4, i64 0, i64 0)) #8
  %65 = icmp eq i32 %64, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_1396.cpp() #0 section ".text.startup" {
