; ModuleID = 'POJ-104-source/102/102-14.cpp'
source_filename = "POJ-104-source/102/102-14.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_14.cpp, i8* null }]
...
17:                                               ; preds = %13
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), [1000 x i8]* %2, double* %5)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_14.cpp() #0 section ".text.startup" {
