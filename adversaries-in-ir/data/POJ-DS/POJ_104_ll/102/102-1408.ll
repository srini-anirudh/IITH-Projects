; ModuleID = 'POJ-104-source/102/102-1408.cpp'
source_filename = "POJ-104-source/102/102-1408.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_1408.cpp, i8* null }]
...
72:                                               ; preds = %62
  ...
  %79 = getelementptr inbounds [100 x float], [100 x float]* %3, i64 0, i64 %78
...
142:                                              ; preds = %97
  ...
  %146 = getelementptr inbounds %"struct.std::_Setprecision", %"struct.std::_Setprecision"* %16, i32 0, i32 0
  ...
  %149 = getelementptr inbounds [100 x float], [100 x float]* %3, i64 0, i64 0
...
156:                                              ; preds = %152
  ...
  %162 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEf(%"class.std::basic_ostream"* %157, float %161)
  br label %163
...
171:                                              ; preds = %167
  ...
  %177 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEf(%"class.std::basic_ostream"* %172, float %176)
  br label %178
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_1408.cpp() #0 section ".text.startup" {
