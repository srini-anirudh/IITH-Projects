; ModuleID = 'POJ-104-source/102/102-149.cpp'
source_filename = "POJ-104-source/102/102-149.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_149.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %19 = call i32 @strcmp(i8* %18, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0)) #9
  %20 = icmp eq i32 %19, 0
...
31:                                               ; preds = %21, %15
  ...
  %33 = call i32 @strcmp(i8* %32, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0)) #9
  %34 = icmp eq i32 %33, 0
  br i1 %34, label %35, label %45

35:                                               ; preds = %31
  %36 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), float* %5)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_149.cpp() #0 section ".text.startup" {
