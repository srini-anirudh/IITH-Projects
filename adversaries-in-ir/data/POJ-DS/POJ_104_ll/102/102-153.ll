; ModuleID = 'POJ-104-source/102/102-153.cpp'
source_filename = "POJ-104-source/102/102-153.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_153.cpp, i8* null }]
...
14:                                               ; preds = %10
  ...
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), float* %8)
  %18 = getelementptr inbounds [10 x i8], [10 x i8]* %7, i64 0, i64 0
  %19 = call i32 @strcmp(i8* %18, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i64 0, i64 0)) #7
  %20 = icmp eq i32 %19, 0
...
39:                                               ; preds = %10
  ...
  call void @qsort(i8* bitcast ([40 x float]* @man to i8*), i64 %41, i64 4, i32 (i8*, i8*)* @_Z8compare1PKvS0_)
  %42 = load i32, i32* %3, align 4
  %43 = sext i32 %42 to i64
  call void @qsort(i8* bitcast ([40 x float]* @woman to i8*), i64 %43, i64 4, i32 (i8*, i8*)* @_Z8compare2PKvS0_)
  store i32 0, i32* %2, align 4
  br label %44
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_153.cpp() #0 section ".text.startup" {
