; ModuleID = 'POJ-104-source/102/102-155.cpp'
source_filename = "POJ-104-source/102/102-155.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_155.cpp, i8* null }]
...
12:                                               ; preds = %8
  ...
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i8* %13, float* %17)
...
54:                                               ; preds = %8
  ...
  call void @qsort(i8* bitcast ([41 x float]* @male to i8*), i64 %56, i64 4, i32 (i8*, i8*)* @_Z3cmpPKvS0_)
  %57 = load i32, i32* %6, align 4
  %58 = sext i32 %57 to i64
  call void @qsort(i8* bitcast ([41 x float]* @female to i8*), i64 %58, i64 4, i32 (i8*, i8*)* @_Z3cmpPKvS0_)
  store i32 0, i32* %3, align 4
  br label %59
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_155.cpp() #0 section ".text.startup" {
