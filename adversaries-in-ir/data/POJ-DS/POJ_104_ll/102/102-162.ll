; ModuleID = 'POJ-104-source/102/102-162.cpp'
source_filename = "POJ-104-source/102/102-162.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_162.cpp, i8* null }]
...
26:                                               ; preds = %14
  ...
  %31 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), float* %30)
  br label %32
...
36:                                               ; preds = %10
  ...
  call void @qsort(i8* %42, i64 %44, i64 4, i32 (i8*, i8*)* @_Z7comparePKvS0_)
  store i32 0, i32* %8, align 4
  br label %45
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_162.cpp() #0 section ".text.startup" {
