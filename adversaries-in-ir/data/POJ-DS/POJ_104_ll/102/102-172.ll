; ModuleID = 'POJ-104-source/102/102-172.cpp'
source_filename = "POJ-104-source/102/102-172.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_172.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i8* %16, double* %4)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_172.cpp() #0 section ".text.startup" {
