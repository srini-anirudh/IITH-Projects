; ModuleID = 'POJ-104-source/102/102-178.cpp'
source_filename = "POJ-104-source/102/102-178.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_178.cpp, i8* null }]
...
define dso_local i32 @_Z8cmp_malePKvS0_(i8* %0, i8* %1) #4 {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z10cmp_femalePKvS0_(i8* %0, i8* %1) #4 {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
  store i8* %0, i8** %3, align 8
  store i8* %1, i8** %4, align 8
...
13:                                               ; preds = %9
  %14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), [10 x i8]* %7, double* %6)
...
37:                                               ; preds = %9
  ...
  call void @_ZSt4sortIPdEvT_S1_(double* getelementptr inbounds ([41 x double], [41 x double]* @male, i64 0, i64 0), double* %40)
  %41 = load i32, i32* %5, align 4
  %42 = sext i32 %41 to i64
  %43 = getelementptr inbounds double, double* getelementptr inbounds ([41 x double], [41 x double]* @female, i64 0, i64 0), i64 %42
  call void @_ZSt4sortIPdEvT_S1_(double* getelementptr inbounds ([41 x double], [41 x double]* @female, i64 0, i64 0), double* %43)
  store i32 0, i32* %3, align 4
  br label %44
...
48:                                               ; preds = %44
  ...
  %51 = getelementptr inbounds [41 x double], [41 x double]* @male, i64 0, i64 %50
...
66:                                               ; preds = %63
  ...
  %69 = getelementptr inbounds [41 x double], [41 x double]* @female, i64 0, i64 %68
...
72:                                               ; preds = %63
  ...
  %75 = getelementptr inbounds [41 x double], [41 x double]* @female, i64 0, i64 %74
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_178.cpp() #0 section ".text.startup" {
