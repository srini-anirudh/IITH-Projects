; ModuleID = 'POJ-104-source/102/102-187.cpp'
source_filename = "POJ-104-source/102/102-187.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_187.cpp, i8* null }]
...
13:                                               ; preds = %9
  ...
  %15 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i8* %14, double* %7)
...
38:                                               ; preds = %9
  ...
  call void @qsort(i8* bitcast ([41 x double]* @male to i8*), i64 %40, i64 8, i32 (i8*, i8*)* @_Z7comparePKvS0_)
  %41 = load i32, i32* %4, align 4
  %42 = sext i32 %41 to i64
  call void @qsort(i8* bitcast ([41 x double]* @female to i8*), i64 %42, i64 8, i32 (i8*, i8*)* @_Z7comparePKvS0_)
  store i32 0, i32* %3, align 4
  br label %43
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_187.cpp() #0 section ".text.startup" {
