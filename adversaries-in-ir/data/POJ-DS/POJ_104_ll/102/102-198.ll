; ModuleID = 'POJ-104-source/102/102-198.cpp'
source_filename = "POJ-104-source/102/102-198.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_198.cpp, i8* null }]
...
define dso_local i32 @_Z2sfPKvS0_(i8* %0, i8* %1) #4 {
...
37:                                               ; preds = %10
  ...
  call void @qsort(i8* %39, i64 %41, i64 8, i32 (i8*, i8*)* @_Z2sfPKvS0_)
  %42 = getelementptr inbounds [40 x double], [40 x double]* %5, i64 0, i64 0
  %43 = bitcast double* %42 to i8*
  %44 = load i32, i32* %7, align 4
  %45 = sext i32 %44 to i64
  call void @qsort(i8* %43, i64 %45, i64 8, i32 (i8*, i8*)* @_Z2sfPKvS0_)
  store i32 0, i32* %2, align 4
  br label %46
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_198.cpp() #0 section ".text.startup" {
