; ModuleID = 'POJ-104-source/102/102-217.cpp'
source_filename = "POJ-104-source/102/102-217.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_217.cpp, i8* null }]
...
33:                                               ; preds = %29
  ...
  %39 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), double* %38)
  %40 = call i32 @getchar()
  br label %57
...
50:                                               ; preds = %42
  ...
  %55 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), double* %54)
  %56 = call i32 @getchar()
  br label %57
...
61:                                               ; preds = %15
  ...
  call void @qsort(i8* %63, i64 %65, i64 8, i32 (i8*, i8*)* @_Z3comPKvS0_)
  %66 = getelementptr inbounds [200 x double], [200 x double]* %12, i64 0, i64 0
  %67 = bitcast double* %66 to i8*
  %68 = load i32, i32* %9, align 4
  %69 = sext i32 %68 to i64
  call void @qsort(i8* %67, i64 %69, i64 8, i32 (i8*, i8*)* @_Z3comPKvS0_)
  store i32 0, i32* %2, align 4
  br label %70
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_217.cpp() #0 section ".text.startup" {
