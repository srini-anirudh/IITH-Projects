; ModuleID = 'POJ-104-source/102/102-229.cpp'
source_filename = "POJ-104-source/102/102-229.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_229.cpp, i8* null }]
...
define dso_local i32 @_Z4mycpPKvS0_(i8* %0, i8* %1) #4 {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z5mycp1PKvS0_(i8* %0, i8* %1) #4 {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
  store i8* %0, i8** %3, align 8
  store i8* %1, i8** %4, align 8
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z5mycp2PKvS0_(i8* %0, i8* %1) #4 {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
  store i8* %0, i8** %3, align 8
  store i8* %1, i8** %4, align 8
...
22:                                               ; preds = %18
  ...
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %23, float* %9)
...
86:                                               ; preds = %69
  ...
  call void @qsort(i8* %88, i64 %90, i64 4, i32 (i8*, i8*)* @_Z5mycp1PKvS0_)
  %91 = getelementptr inbounds [40 x i32], [40 x i32]* %6, i64 0, i64 0
  %92 = bitcast i32* %91 to i8*
  %93 = load i32, i32* %8, align 4
  %94 = sext i32 %93 to i64
  call void @qsort(i8* %92, i64 %94, i64 4, i32 (i8*, i8*)* @_Z5mycp2PKvS0_)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_229.cpp() #0 section ".text.startup" {
