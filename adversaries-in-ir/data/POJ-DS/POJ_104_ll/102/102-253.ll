; ModuleID = 'POJ-104-source/102/102-253.cpp'
source_filename = "POJ-104-source/102/102-253.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_253.cpp, i8* null }]
...
47:                                               ; preds = %20
  ...
  %56 = getelementptr inbounds [41 x float], [41 x float]* %9, i64 0, i64 %55
...
74:                                               ; preds = %68
  ...
  %77 = getelementptr inbounds [41 x float], [41 x float]* %8, i64 0, i64 %76
...
124:                                              ; preds = %118
  ...
  %132 = getelementptr inbounds [41 x float], [41 x float]* %9, i64 0, i64 %131
...
161:                                              ; preds = %112
  ...
  %168 = getelementptr inbounds [41 x float], [41 x float]* %8, i64 0, i64 1
...
195:                                              ; preds = %191
  ...
  %204 = getelementptr inbounds [41 x float], [41 x float]* %9, i64 0, i64 %203
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_253.cpp() #0 section ".text.startup" {
