; ModuleID = 'POJ-104-source/102/102-280.cpp'
source_filename = "POJ-104-source/102/102-280.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_280.cpp, i8* null }]
...
21:                                               ; preds = %17
  %22 = getelementptr inbounds [7 x i8], [7 x i8]* %2, i64 0, i64 0
...
99:                                               ; preds = %94
  ...
  %110 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEf(%"class.std::basic_ostream"* %105, float %109)
...
169:                                              ; preds = %164
  ...
  %179 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEf(%"class.std::basic_ostream"* %174, float %178)
...
184:                                              ; preds = %164
  ...
  %195 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEf(%"class.std::basic_ostream"* %189, float %194)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_280.cpp() #0 section ".text.startup" {
