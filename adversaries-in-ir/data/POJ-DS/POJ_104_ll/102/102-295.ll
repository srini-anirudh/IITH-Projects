; ModuleID = 'POJ-104-source/102/102-295.cpp'
source_filename = "POJ-104-source/102/102-295.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_295.cpp, i8* null }]
...
14:                                               ; preds = %10
  ...
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %18, double* %21)
  br label %23
...
38:                                               ; preds = %32
  ...
  %43 = call i32 @strcmp(i8* %42, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0)) #6
  %44 = icmp eq i32 %43, 0
...
45:                                               ; preds = %38
  ...
  %51 = call i32 @strcmp(i8* %50, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0)) #6
  %52 = icmp eq i32 %51, 0
...
53:                                               ; preds = %45, %38
  ...
  %58 = call i32 @strcmp(i8* %57, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0)) #6
  %59 = icmp eq i32 %58, 0
...
60:                                               ; preds = %53
  ...
  %66 = call i32 @strcmp(i8* %65, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0)) #6
  %67 = icmp eq i32 %66, 0
...
79:                                               ; preds = %68, %60, %53
  ...
  %84 = call i32 @strcmp(i8* %83, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0)) #6
  %85 = icmp eq i32 %84, 0
...
86:                                               ; preds = %79
  ...
  %92 = call i32 @strcmp(i8* %91, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0)) #6
  %93 = icmp eq i32 %92, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_295.cpp() #0 section ".text.startup" {
