; ModuleID = 'POJ-104-source/102/102-337.cpp'
source_filename = "POJ-104-source/102/102-337.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_337.cpp, i8* null }]
...
define dso_local i32 @_Z4cmpfPKvS0_(i8* %0, i8* %1) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z4cmpmPKvS0_(i8* %0, i8* %1) #4 {
  %3 = alloca i32, align 4
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca double, align 8
...
21:                                               ; preds = %14
  ...
  %26 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), double* %25)
  br label %33
...
27:                                               ; preds = %14
  ...
  %32 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), double* %31)
  br label %33
...
37:                                               ; preds = %10
  ...
  call void @qsort(i8* %39, i64 %41, i64 8, i32 (i8*, i8*)* @_Z4cmpfPKvS0_)
  %42 = getelementptr inbounds [40 x double], [40 x double]* %5, i64 0, i64 0
  %43 = bitcast double* %42 to i8*
  %44 = load i32, i32* %7, align 4
  %45 = sext i32 %44 to i64
  call void @qsort(i8* %43, i64 %45, i64 8, i32 (i8*, i8*)* @_Z4cmpmPKvS0_)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_337.cpp() #0 section ".text.startup" {
