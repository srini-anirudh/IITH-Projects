; ModuleID = 'POJ-104-source/102/102-35.cpp'
source_filename = "POJ-104-source/102/102-35.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_35.cpp, i8* null }]
...
13:                                               ; preds = %9
  ...
  %17 = call i32 @strcmp(i8* %16, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #6
  %18 = icmp eq i32 %17, 0
...
29:                                               ; preds = %24, %19
  ...
  %34 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i64 0, i64 0), double* %33)
  br label %35
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_35.cpp() #0 section ".text.startup" {
