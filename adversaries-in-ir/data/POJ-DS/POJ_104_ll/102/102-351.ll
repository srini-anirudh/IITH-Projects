; ModuleID = 'POJ-104-source/102/102-351.cpp'
source_filename = "POJ-104-source/102/102-351.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_351.cpp, i8* null }]
...
25:                                               ; preds = %21
  ...
  %27 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %26, float* %9)
...
79:                                               ; preds = %67
  ...
  call void @qsort(i8* %81, i64 %83, i64 4, i32 (i8*, i8*)* @_Z4com1PKvS0_)
  %84 = load float*, float** %7, align 8
  %85 = bitcast float* %84 to i8*
  %86 = load i32, i32* %5, align 4
  %87 = sext i32 %86 to i64
  call void @qsort(i8* %85, i64 %87, i64 4, i32 (i8*, i8*)* @_Z4com2PKvS0_)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_351.cpp() #0 section ".text.startup" {
