; ModuleID = 'POJ-104-source/102/102-370.cpp'
source_filename = "POJ-104-source/102/102-370.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_370.cpp, i8* null }]
...
define dso_local i32 @_Z4com1PKvS0_(i8* %0, i8* %1) #4 {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z4com2PKvS0_(i8* %0, i8* %1) #4 {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
  store i8* %0, i8** %3, align 8
  store i8* %1, i8** %4, align 8
...
14:                                               ; preds = %10
  ...
  %23 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), [10 x i8]* %18, float* %22)
...
43:                                               ; preds = %14
  ...
  %46 = getelementptr inbounds [40 x %struct.people], [40 x %struct.people]* %2, i64 0, i64 %45
...
58:                                               ; preds = %10
  ...
  call void @qsort(i8* %60, i64 %62, i64 4, i32 (i8*, i8*)* @_Z4com1PKvS0_)
  %63 = getelementptr inbounds [40 x float], [40 x float]* %8, i64 0, i64 0
  %64 = bitcast float* %63 to i8*
  %65 = load i32, i32* %6, align 4
  %66 = sext i32 %65 to i64
  call void @qsort(i8* %64, i64 %66, i64 4, i32 (i8*, i8*)* @_Z4com2PKvS0_)
  store i32 0, i32* %4, align 4
  br label %67
...
97:                                               ; preds = %82
  ...
  %104 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0), double %103)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_370.cpp() #0 section ".text.startup" {
