; ModuleID = 'POJ-104-source/102/102-374.cpp'
source_filename = "POJ-104-source/102/102-374.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_374.cpp, i8* null }]
...
define dso_local i32 @_Z4cprxPKvS0_(i8* %0, i8* %1) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z4cprdPKvS0_(i8* %0, i8* %1) #4 {
  %3 = alloca i32, align 4
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca float*, align 8
...
15:                                               ; preds = %11
  ...
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %16, float* %4)
...
38:                                               ; preds = %11
  ...
  call void @qsort(i8* %40, i64 %42, i64 4, i32 (i8*, i8*)* @_Z4cprxPKvS0_)
  %43 = getelementptr inbounds [40 x float], [40 x float]* %3, i64 0, i64 0
  %44 = bitcast float* %43 to i8*
  %45 = load i32, i32* %6, align 4
  %46 = sext i32 %45 to i64
  call void @qsort(i8* %44, i64 %46, i64 4, i32 (i8*, i8*)* @_Z4cprdPKvS0_)
  store i32 0, i32* %8, align 4
  br label %47
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_374.cpp() #0 section ".text.startup" {
