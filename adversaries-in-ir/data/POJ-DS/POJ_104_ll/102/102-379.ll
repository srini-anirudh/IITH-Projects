; ModuleID = 'POJ-104-source/102/102-379.cpp'
source_filename = "POJ-104-source/102/102-379.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_379.cpp, i8* null }]
...
14:                                               ; preds = %10
  ...
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i8* %19, float* %23)
  br label %25
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_379.cpp() #0 section ".text.startup" {
