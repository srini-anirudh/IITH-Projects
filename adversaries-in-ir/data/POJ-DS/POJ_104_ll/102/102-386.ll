; ModuleID = 'POJ-104-source/102/102-386.cpp'
source_filename = "POJ-104-source/102/102-386.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_386.cpp, i8* null }]
...
define dso_local i32 @_Z9pfComparePKvS0_(i8* %0, i8* %1) #4 {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
...
18:                                               ; preds = %14
  ...
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %19, float* %8)
...
43:                                               ; preds = %14
  ...
  call void @qsort(i8* %45, i64 %47, i64 4, i32 (i8*, i8*)* @_Z9pfComparePKvS0_)
  %48 = getelementptr inbounds [40 x float], [40 x float]* %10, i64 0, i64 0
  %49 = bitcast float* %48 to i8*
  %50 = load i32, i32* %6, align 4
  %51 = sext i32 %50 to i64
  call void @qsort(i8* %49, i64 %51, i64 4, i32 (i8*, i8*)* @_Z9pfComparePKvS0_)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_386.cpp() #0 section ".text.startup" {
