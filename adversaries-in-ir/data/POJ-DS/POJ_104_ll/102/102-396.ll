; ModuleID = 'POJ-104-source/102/102-396.cpp'
source_filename = "POJ-104-source/102/102-396.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_396.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %8 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %2)
...
18:                                               ; preds = %14
  ...
  %30 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), i8* %24, float* %29)
  br label %31
...
47:                                               ; preds = %43
  ...
  %60 = call i32 @strcmp(i8* %53, i8* %59) #7
...
62:                                               ; preds = %47
  ...
  %77 = bitcast %struct.people* %76 to i8*
  %78 = bitcast %struct.people* %72 to i8*
...
99:                                               ; preds = %85
  ...
  %107 = call i32 @strcmp(i8* %105, i8* %106) #7
...
109:                                              ; preds = %99
  ...
  %117 = call i32 @strcmp(i8* %115, i8* %116) #7
...
119:                                              ; preds = %109
  ...
  %134 = bitcast %struct.people* %133 to i8*
  %135 = bitcast %struct.people* %129 to i8*
...
156:                                              ; preds = %142
  ...
  %164 = call i32 @strcmp(i8* %162, i8* %163) #7
...
166:                                              ; preds = %156
  ...
  %174 = call i32 @strcmp(i8* %172, i8* %173) #7
...
176:                                              ; preds = %166
  ...
  %191 = bitcast %struct.people* %190 to i8*
  %192 = bitcast %struct.people* %186 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_396.cpp() #0 section ".text.startup" {
