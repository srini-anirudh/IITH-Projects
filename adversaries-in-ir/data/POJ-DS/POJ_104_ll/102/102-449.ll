; ModuleID = 'POJ-104-source/102/102-449.cpp'
source_filename = "POJ-104-source/102/102-449.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_449.cpp, i8* null }]
...
17:                                               ; preds = %13
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), [10 x i8]* %11, double* %7)
  %19 = getelementptr inbounds [10 x i8], [10 x i8]* %11, i64 0, i64 0
  %20 = call i32 @strcmp(i8* %19, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0)) #6
  %21 = icmp eq i32 %20, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_449.cpp() #0 section ".text.startup" {
