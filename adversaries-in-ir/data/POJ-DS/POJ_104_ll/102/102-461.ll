; ModuleID = 'POJ-104-source/102/102-461.cpp'
source_filename = "POJ-104-source/102/102-461.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_461.cpp, i8* null }]
...
19:                                               ; preds = %15
  ...
  %36 = call i32 @strcmp(i8* %35, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0)) #6
  %37 = icmp eq i32 %36, 0
...
49:                                               ; preds = %38, %19
  ...
  %55 = call i32 @strcmp(i8* %54, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.4, i64 0, i64 0)) #6
  %56 = icmp eq i32 %55, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_461.cpp() #0 section ".text.startup" {
