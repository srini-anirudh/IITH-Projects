; ModuleID = 'POJ-104-source/102/102-467.cpp'
source_filename = "POJ-104-source/102/102-467.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_467.cpp, i8* null }]
...
16:                                               ; preds = %12
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), [10 x i8]* %2)
...
22:                                               ; preds = %16
  ...
  %26 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), float* %25)
...
34:                                               ; preds = %29
  ...
  %38 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), float* %37)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_467.cpp() #0 section ".text.startup" {
