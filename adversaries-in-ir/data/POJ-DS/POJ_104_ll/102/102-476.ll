; ModuleID = 'POJ-104-source/102/102-476.cpp'
source_filename = "POJ-104-source/102/102-476.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_476.cpp, i8* null }]
...
34:                                               ; preds = %30
  ...
  %39 = call i32 @strcmp(i8* %38, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.2, i64 0, i64 0)) #6
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_476.cpp() #0 section ".text.startup" {
