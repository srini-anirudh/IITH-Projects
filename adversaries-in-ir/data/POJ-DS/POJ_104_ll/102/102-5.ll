; ModuleID = 'POJ-104-source/102/102-5.cpp'
source_filename = "POJ-104-source/102/102-5.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_5.cpp, i8* null }]
...
define dso_local void @_Z10insertSortPfl(float* %0, i64 %1) #4 {
...
15:                                               ; preds = %11
  ...
  %19 = call i32 @strcmp(i8* %18, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #7
  %20 = icmp eq i32 %19, 0
...
21:                                               ; preds = %15
  ...
  %26 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), float* %25)
  br label %33
...
27:                                               ; preds = %15
  ...
  %32 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), float* %31)
  br label %33
...
37:                                               ; preds = %11
  ...
  call void @_Z10insertSortPfl(float* %38, i64 %40)
  %41 = getelementptr inbounds [40 x float], [40 x float]* %4, i64 0, i64 0
  %42 = load i32, i32* %6, align 4
  %43 = sext i32 %42 to i64
  call void @_Z10insertSortPfl(float* %41, i64 %43)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_5.cpp() #0 section ".text.startup" {
