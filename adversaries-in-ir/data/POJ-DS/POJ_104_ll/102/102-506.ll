; ModuleID = 'POJ-104-source/102/102-506.cpp'
source_filename = "POJ-104-source/102/102-506.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_506.cpp, i8* null }]
...
18:                                               ; preds = %14
  ...
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), double* %23)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_506.cpp() #0 section ".text.startup" {
