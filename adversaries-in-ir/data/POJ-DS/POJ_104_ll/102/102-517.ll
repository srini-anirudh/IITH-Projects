; ModuleID = 'POJ-104-source/102/102-517.cpp'
source_filename = "POJ-104-source/102/102-517.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_517.cpp, i8* null }]
...
17:                                               ; preds = %13
  ...
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), [7 x i8]* %20, double* %23)
  br label %25
...
33:                                               ; preds = %29
  ...
  %36 = getelementptr inbounds [40 x [7 x i8]], [40 x [7 x i8]]* %3, i64 0, i64 %35
...
192:                                              ; preds = %180
  %193 = getelementptr inbounds [40 x double], [40 x double]* %8, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_517.cpp() #0 section ".text.startup" {
