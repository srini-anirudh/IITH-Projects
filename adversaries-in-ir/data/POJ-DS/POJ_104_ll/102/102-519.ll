; ModuleID = 'POJ-104-source/102/102-519.cpp'
source_filename = "POJ-104-source/102/102-519.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_519.cpp, i8* null }]
...
18:                                               ; preds = %14
  ...
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i8* %19, double* %7)
...
35:                                               ; preds = %18
  ...
  %37 = call i32 @strcmp(i8* %36, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i64 0, i64 0)) #6
  %38 = icmp eq i32 %37, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_519.cpp() #0 section ".text.startup" {
