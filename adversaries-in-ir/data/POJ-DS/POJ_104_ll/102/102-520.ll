; ModuleID = 'POJ-104-source/102/102-520.cpp'
source_filename = "POJ-104-source/102/102-520.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_520.cpp, i8* null }]
...
24:                                               ; preds = %20
  ...
  %32 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i8* %28, double* %31)
  br label %33
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_520.cpp() #0 section ".text.startup" {
