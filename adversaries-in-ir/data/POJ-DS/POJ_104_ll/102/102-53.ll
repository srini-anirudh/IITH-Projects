; ModuleID = 'POJ-104-source/102/102-53.cpp'
source_filename = "POJ-104-source/102/102-53.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_53.cpp, i8* null }]
...
34:                                               ; preds = %30
  ...
  %39 = call i32 @strcmp(i8* %38, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0)) #6
  %40 = icmp eq i32 %39, 0
...
51:                                               ; preds = %41, %34
  ...
  %56 = call i32 @strcmp(i8* %55, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0)) #6
  %57 = icmp eq i32 %56, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_53.cpp() #0 section ".text.startup" {
