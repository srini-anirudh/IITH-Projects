; ModuleID = 'POJ-104-source/102/102-531.cpp'
source_filename = "POJ-104-source/102/102-531.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_531.cpp, i8* null }]
...
46:                                               ; preds = %19
  ...
  %50 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), double* %49)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_531.cpp() #0 section ".text.startup" {
