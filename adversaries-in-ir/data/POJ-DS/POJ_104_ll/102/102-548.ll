; ModuleID = 'POJ-104-source/102/102-548.cpp'
source_filename = "POJ-104-source/102/102-548.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_548.cpp, i8* null }]
...
18:                                               ; preds = %14
  ...
  %31 = call i32 @strcmp(i8* %30, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0)) #6
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_548.cpp() #0 section ".text.startup" {
