; ModuleID = 'POJ-104-source/102/102-57.cpp'
source_filename = "POJ-104-source/102/102-57.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_57.cpp, i8* null }]
...
20:                                               ; preds = %16
  ...
  %23 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), double* %9)
...
53:                                               ; preds = %44
  ...
  %59 = getelementptr inbounds [40 x %struct.anon], [40 x %struct.anon]* %12, i64 0, i64 %58
  %60 = bitcast %struct.anon* %59 to i8*
  %61 = bitcast %struct.anon* %56 to i8*
...
64:                                               ; preds = %44
  ...
  %70 = getelementptr inbounds [40 x %struct.anon], [40 x %struct.anon]* %11, i64 0, i64 %69
...
104:                                              ; preds = %91
  ...
  %113 = getelementptr inbounds [40 x %struct.anon], [40 x %struct.anon]* %11, i64 0, i64 %112
  %114 = load i32, i32* %6, align 4
  %115 = sext i32 %114 to i64
  %116 = getelementptr inbounds [40 x %struct.anon], [40 x %struct.anon]* %11, i64 0, i64 %115
  %117 = bitcast %struct.anon* %116 to i8*
  %118 = bitcast %struct.anon* %113 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_57.cpp() #0 section ".text.startup" {
