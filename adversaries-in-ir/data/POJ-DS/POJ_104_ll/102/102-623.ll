; ModuleID = 'POJ-104-source/102/102-623.cpp'
source_filename = "POJ-104-source/102/102-623.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_623.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i8* %16, double* %3)
  %18 = getelementptr inbounds [10 x i8], [10 x i8]* %2, i64 0, i64 0
  %19 = call i32 @strcmp(i8* %18, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0)) #7
  %20 = icmp eq i32 %19, 0
...
39:                                               ; preds = %11
  ...
  call void @_Z2pxPdi(double* %40, i32 %41)
  %42 = getelementptr inbounds [40 x double], [40 x double]* %5, i64 0, i64 0
  %43 = load i32, i32* %7, align 4
  call void @_Z2pxPdi(double* %42, i32 %43)
...
define dso_local void @_Z2pxPdi(double* %0, i32 %1) #6 {
  %3 = alloca double*, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_623.cpp() #0 section ".text.startup" {
