; ModuleID = 'POJ-104-source/102/102-631.cpp'
source_filename = "POJ-104-source/102/102-631.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_631.cpp, i8* null }]
...
53:                                               ; preds = %36
  ...
  %58 = call i32 @strcmp(i8* %57, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i64 0, i64 0)) #6
  %59 = icmp eq i32 %58, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_631.cpp() #0 section ".text.startup" {
