; ModuleID = 'POJ-104-source/102/102-66.cpp'
source_filename = "POJ-104-source/102/102-66.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_66.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %2, i8* %6)
...
38:                                               ; preds = %24
  ...
  %42 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), double* %41)
...
45:                                               ; preds = %24
  ...
  %49 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), double* %48)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_66.cpp() #0 section ".text.startup" {
