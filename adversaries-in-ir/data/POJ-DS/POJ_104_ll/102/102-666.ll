; ModuleID = 'POJ-104-source/102/102-666.cpp'
source_filename = "POJ-104-source/102/102-666.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_666.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i8* %20, double* %24)
  br label %26
...
34:                                               ; preds = %30
  ...
  %40 = call i32 @strcmp(i8* %39, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #6
  %41 = icmp eq i32 %40, 0
...
128:                                              ; preds = %124
  ...
  %134 = call i32 @strcmp(i8* %133, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.5, i64 0, i64 0)) #6
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_666.cpp() #0 section ".text.startup" {
