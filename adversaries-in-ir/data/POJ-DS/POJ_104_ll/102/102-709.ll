; ModuleID = 'POJ-104-source/102/102-709.cpp'
source_filename = "POJ-104-source/102/102-709.cpp"
...
@cnt0 = dso_local global i32 0, align 4
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_709.cpp, i8* null }]
...
8:                                                ; preds = %84, %0
  %9 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* @n)
  %10 = icmp eq i32 %9, 1
...
16:                                               ; preds = %12
  ...
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %17, double* %4)
...
39:                                               ; preds = %12
  ...
  call void @_ZSt4sortIPdEvT_S1_(double* getelementptr inbounds ([100 x double], [100 x double]* @d0, i64 0, i64 0), double* %42)
  %43 = load i32, i32* @cnt1, align 4
  %44 = sext i32 %43 to i64
  %45 = getelementptr inbounds double, double* getelementptr inbounds ([100 x double], [100 x double]* @d1, i64 0, i64 0), i64 %44
  call void @_ZSt4sortIPdEvT_S1_(double* getelementptr inbounds ([100 x double], [100 x double]* @d1, i64 0, i64 0), double* %45)
...
55:                                               ; preds = %53, %50
  ...
  %58 = getelementptr inbounds [100 x double], [100 x double]* @d0, i64 0, i64 %57
...
75:                                               ; preds = %73, %70
  ...
  %78 = getelementptr inbounds [100 x double], [100 x double]* @d1, i64 0, i64 %77
...
84:                                               ; preds = %67
  %85 = call i32 @puts(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.3, i64 0, i64 0))
  br label %8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_709.cpp() #0 section ".text.startup" {
