; ModuleID = 'POJ-104-source/102/102-713.cpp'
source_filename = "POJ-104-source/102/102-713.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_713.cpp, i8* null }]
...
8:                                                ; preds = %89, %0
  %9 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i8* %7)
  %10 = icmp ne i32 %9, -1
...
31:                                               ; preds = %16
  ...
  %36 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), double* %35)
...
40:                                               ; preds = %12
  ...
  call void @_ZSt4sortIPdEvT_S1_(double* getelementptr inbounds ([105 x double], [105 x double]* @a, i64 0, i64 0), double* %44)
  %45 = load i8, i8* %4, align 1
  %46 = sext i8 %45 to i32
  %47 = sext i32 %46 to i64
  %48 = getelementptr inbounds double, double* getelementptr inbounds ([105 x double], [105 x double]* @b, i64 0, i64 0), i64 %47
  call void @_ZSt4sortIPdEvT_S1_(double* getelementptr inbounds ([105 x double], [105 x double]* @b, i64 0, i64 0), double* %48)
...
55:                                               ; preds = %49
  ...
  %60 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i64 0, i64 0), double %59)
  br label %61
...
73:                                               ; preds = %69
  ...
  %76 = getelementptr inbounds [105 x double], [105 x double]* @b, i64 0, i64 %75
...
83:                                               ; preds = %73
  %84 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i64 0, i64 0))
  br label %85
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_713.cpp() #0 section ".text.startup" {
