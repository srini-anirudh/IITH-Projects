; ModuleID = 'POJ-104-source/102/102-714.cpp'
source_filename = "POJ-104-source/102/102-714.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_714.cpp, i8* null }]
...
12:                                               ; preds = %8
  %13 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), [10 x i8]* @a, float* %3)
...
33:                                               ; preds = %8
  ...
  call void @_ZSt4sortIPfEvT_S1_(float* getelementptr inbounds ([100 x float], [100 x float]* @man, i64 0, i64 1), float* %36)
  %37 = load i32, i32* @l2, align 4
  %38 = sext i32 %37 to i64
  %39 = getelementptr inbounds float, float* getelementptr inbounds ([100 x float], [100 x float]* @woman, i64 0, i64 0), i64 %38
  call void @_ZSt4sortIPfEvT_S1_(float* getelementptr inbounds ([100 x float], [100 x float]* @woman, i64 0, i64 1), float* %39)
  %40 = load float, float* getelementptr inbounds ([100 x float], [100 x float]* @man, i64 0, i64 1), align 4
  %41 = fpext float %40 to double
  %42 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), double %41)
...
47:                                               ; preds = %43
  ...
  %50 = getelementptr inbounds [100 x float], [100 x float]* @man, i64 0, i64 %49
...
63:                                               ; preds = %60
  ...
  %66 = getelementptr inbounds [100 x float], [100 x float]* @woman, i64 0, i64 %65
...
73:                                               ; preds = %60
  %74 = call i32 @puts(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.4, i64 0, i64 0))
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_714.cpp() #0 section ".text.startup" {
