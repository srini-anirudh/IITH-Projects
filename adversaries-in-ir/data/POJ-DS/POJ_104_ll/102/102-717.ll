; ModuleID = 'POJ-104-source/102/102-717.cpp'
source_filename = "POJ-104-source/102/102-717.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_717.cpp, i8* null }]
...
10:                                               ; preds = %6
  %11 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @sex, i64 0, i64 0))
  %12 = call i32 @strcmp(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @sex, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0)) #9
  %13 = icmp eq i32 %12, 0
...
30:                                               ; preds = %6
  ...
  call void @_ZSt4sortIPdEvT_S1_(double* getelementptr inbounds ([50 x double], [50 x double]* @male, i64 0, i64 0), double* %33)
  ...
  call void @_ZSt4sortIPdEvT_S1_(double* getelementptr inbounds ([50 x double], [50 x double]* @female, i64 0, i64 0), double* %36)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_717.cpp() #0 section ".text.startup" {
