; ModuleID = 'POJ-104-source/102/102-72.cpp'
source_filename = "POJ-104-source/102/102-72.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_72.cpp, i8* null }]
...
22:                                               ; preds = %18
  ...
  %30 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i8* %26, double* %29)
  ...
  %35 = call i32 @strcmp(i8* %34, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #7
  %36 = icmp eq i32 %35, 0
...
47:                                               ; preds = %37, %22
  ...
  %52 = call i32 @strcmp(i8* %51, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i64 0, i64 0)) #7
  %53 = icmp eq i32 %52, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_72.cpp() #0 section ".text.startup" {
