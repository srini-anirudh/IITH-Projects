; ModuleID = 'POJ-104-source/102/102-722.cpp'
source_filename = "POJ-104-source/102/102-722.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_722.cpp, i8* null }]
...
13:                                               ; preds = %9
  ...
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @str, i64 0, i64 0), float* %16)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_722.cpp() #0 section ".text.startup" {
