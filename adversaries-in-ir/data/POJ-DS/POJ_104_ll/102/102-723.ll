; ModuleID = 'POJ-104-source/102/102-723.cpp'
source_filename = "POJ-104-source/102/102-723.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_723.cpp, i8* null }]
...
11:                                               ; preds = %7
  ...
  %14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), double* %5)
...
37:                                               ; preds = %7
  ...
  call void @_ZSt4sortIPdEvT_S1_(double* getelementptr inbounds ([42 x double], [42 x double]* @male, i64 0, i64 0), double* %40)
  %41 = load i32, i32* @f, align 4
  %42 = sext i32 %41 to i64
  %43 = getelementptr inbounds double, double* getelementptr inbounds ([42 x double], [42 x double]* @female, i64 0, i64 0), i64 %42
  call void @_ZSt4sortIPdEvT_S1_(double* getelementptr inbounds ([42 x double], [42 x double]* @female, i64 0, i64 0), double* %43)
  %44 = load i32, i32* @f, align 4
  %45 = sext i32 %44 to i64
  %46 = getelementptr inbounds double, double* getelementptr inbounds ([42 x double], [42 x double]* @female, i64 0, i64 0), i64 %45
  call void @_ZSt7reverseIPdEvT_S1_(double* getelementptr inbounds ([42 x double], [42 x double]* @female, i64 0, i64 0), double* %46)
  store i32 0, i32* %3, align 4
  br label %47
...
51:                                               ; preds = %47
  ...
  %54 = getelementptr inbounds [42 x double], [42 x double]* @male, i64 0, i64 %53
...
66:                                               ; preds = %61
  ...
  %69 = getelementptr inbounds [42 x double], [42 x double]* @female, i64 0, i64 %68
...
75:                                               ; preds = %61
  ...
  %78 = getelementptr inbounds [42 x double], [42 x double]* @female, i64 0, i64 %77
  %79 = load double, double* %78, align 8
  %80 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.4, i64 0, i64 0), double %79)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define linkonce_odr dso_local void @_ZSt7reverseIPdEvT_S1_(double* %0, double* %1) #0 comdat {
  %3 = alloca double*, align 8
  %4 = alloca double*, align 8
  ...
  call void @_ZSt9__reverseIPdEvT_S1_St26random_access_iterator_tag(double* %7, double* %8)
  ret void
}
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZSt9__reverseIPdEvT_S1_St26random_access_iterator_tag(double* %0, double* %1) #5 comdat {
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZSt19__iterator_categoryIPdENSt15iterator_traitsIT_E17iterator_categoryERKS2_(double** dereferenceable(8) %0) #5 comdat {
  %2 = alloca double**, align 8
  store double** %0, double*** %2, align 8
  ret void
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_723.cpp() #0 section ".text.startup" {
