; ModuleID = 'POJ-104-source/102/102-735.cpp'
source_filename = "POJ-104-source/102/102-735.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_735.cpp, i8* null }]
...
define dso_local void @_Z11bubblesort1Pfi(float* %0, i32 %1) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z11bubblesort2Pfi(float* %0, i32 %1) #4 {
  %3 = alloca float*, align 8
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
16:                                               ; preds = %12
  ...
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %17, float* %4)
...
38:                                               ; preds = %12
  ...
  call void @_Z11bubblesort1Pfi(float* %39, i32 %40)
  %41 = getelementptr inbounds [40 x float], [40 x float]* %6, i64 0, i64 0
  %42 = load i32, i32* %8, align 4
  call void @_Z11bubblesort2Pfi(float* %41, i32 %42)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_735.cpp() #0 section ".text.startup" {
