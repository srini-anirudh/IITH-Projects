; ModuleID = 'POJ-104-source/102/102-739.cpp'
source_filename = "POJ-104-source/102/102-739.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_739.cpp, i8* null }]
...
19:                                               ; preds = %15
  ...
  %25 = call i32 @strcmp(i8* %23, i8* %24) #9
  %26 = icmp eq i32 %25, 0
...
45:                                               ; preds = %15
  ...
  call void @_ZSt4sortIPfEvT_S1_(float* %46, float* %49)
  ...
  call void @_ZSt4sortIPfEvT_S1_(float* %50, float* %53)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_739.cpp() #0 section ".text.startup" {
