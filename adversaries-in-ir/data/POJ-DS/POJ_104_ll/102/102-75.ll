; ModuleID = 'POJ-104-source/102/102-75.cpp'
source_filename = "POJ-104-source/102/102-75.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_75.cpp, i8* null }]
...
13:                                               ; preds = %9
  ...
  %23 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %18, double* %22)
  br label %24
...
86:                                               ; preds = %82
  ...
  %92 = call i32 @strcmp(i8* %91, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #7
  %93 = icmp eq i32 %92, 0
...
111:                                              ; preds = %108
  ...
  %117 = call i32 @strcmp(i8* %116, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.4, i64 0, i64 0)) #7
...
137:                                              ; preds = %134
  ...
  %143 = call i32 @strcmp(i8* %142, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.4, i64 0, i64 0)) #7
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_75.cpp() #0 section ".text.startup" {
