; ModuleID = 'POJ-104-source/102/102-757.cpp'
source_filename = "POJ-104-source/102/102-757.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_757.cpp, i8* null }]
...
9:                                                ; preds = %5
  ...
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), [8 x i8]* %13, float* %17)
  br label %19
...
22:                                               ; preds = %5
  ...
  call void @qsort(i8* getelementptr inbounds ([100 x %struct.area], [100 x %struct.area]* @a, i32 0, i32 0, i32 0, i32 0), i64 %24, i64 12, i32 (i8*, i8*)* @_Z3cmpPKvS0_)
  store i32 0, i32* %3, align 4
  br label %25
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_757.cpp() #0 section ".text.startup" {
