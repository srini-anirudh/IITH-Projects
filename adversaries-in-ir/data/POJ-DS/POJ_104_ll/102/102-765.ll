; ModuleID = 'POJ-104-source/102/102-765.cpp'
source_filename = "POJ-104-source/102/102-765.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_765.cpp, i8* null }]
...
19:                                               ; preds = %15
  ...
  %23 = call i32 @strcmp(i8* %22, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #7
  %24 = icmp ne i32 %23, 0
  br i1 %24, label %33, label %25

25:                                               ; preds = %19
  %26 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), float* %13)
...
33:                                               ; preds = %19
  %34 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), float* %13)
...
45:                                               ; preds = %15
  ...
  call void @qsort(i8* %47, i64 %49, i64 4, i32 (i8*, i8*)* @_Z8compare1PKvS0_)
  %50 = getelementptr inbounds [40 x float], [40 x float]* %11, i64 0, i64 0
  %51 = bitcast float* %50 to i8*
  %52 = load i32, i32* %7, align 4
  %53 = sext i32 %52 to i64
  call void @qsort(i8* %51, i64 %53, i64 4, i32 (i8*, i8*)* @_Z8compare2PKvS0_)
  store i32 0, i32* %9, align 4
  br label %54
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_765.cpp() #0 section ".text.startup" {
