; ModuleID = 'POJ-104-source/102/102-77.cpp'
source_filename = "POJ-104-source/102/102-77.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_77.cpp, i8* null }]
...
18:                                               ; preds = %14
  ...
  %23 = call i32 @strcmp(i8* %21, i8* %22) #7
  %24 = icmp ne i32 %23, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_77.cpp() #0 section ".text.startup" {
