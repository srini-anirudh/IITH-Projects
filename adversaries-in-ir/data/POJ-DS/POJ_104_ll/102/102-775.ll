; ModuleID = 'POJ-104-source/102/102-775.cpp'
source_filename = "POJ-104-source/102/102-775.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_775.cpp, i8* null }]
...
11:                                               ; preds = %7
  ...
  %13 = call i32 @strcmp(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @sex, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0)) #9
  %14 = icmp eq i32 %13, 0
...
31:                                               ; preds = %7
  ...
  call void @_ZSt4sortIPdEvT_S1_(double* getelementptr inbounds ([45 x double], [45 x double]* @a, i64 0, i64 0), double* %34)
  ...
  call void @_ZSt4sortIPdEvT_S1_(double* getelementptr inbounds ([45 x double], [45 x double]* @b, i64 0, i64 0), double* %37)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_775.cpp() #0 section ".text.startup" {
