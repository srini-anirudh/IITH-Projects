; ModuleID = 'POJ-104-source/102/102-780.cpp'
source_filename = "POJ-104-source/102/102-780.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_780.cpp, i8* null }]
...
define dso_local void @_Z7mysort1Pfi(float* %0, i32 %1) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z7mysort2Pfi(float* %0, i32 %1) #4 {
  %3 = alloca float*, align 8
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
16:                                               ; preds = %12
  ...
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i8* %17, float* %10)
  %19 = getelementptr inbounds [8 x i8], [8 x i8]* %9, i64 0, i64 0
  %20 = call i32 @strcmp(i8* %19, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #7
  %21 = icmp eq i32 %20, 0
...
40:                                               ; preds = %12
  ...
  call void @_Z7mysort1Pfi(float* %41, i32 %42)
  %43 = getelementptr inbounds [40 x float], [40 x float]* %8, i64 0, i64 0
  %44 = load i32, i32* %4, align 4
  call void @_Z7mysort2Pfi(float* %43, i32 %44)
  store i32 0, i32* %6, align 4
  br label %45
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_780.cpp() #0 section ".text.startup" {
