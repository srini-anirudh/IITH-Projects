; ModuleID = 'POJ-104-source/102/102-782.cpp'
source_filename = "POJ-104-source/102/102-782.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_782.cpp, i8* null }]
...
define dso_local void @_Z1xPfi(float* %0, i32 %1) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z2x1Pfi(float* %0, i32 %1) #4 {
  %3 = alloca float*, align 8
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
12:                                               ; preds = %8
  ...
  %21 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), float* %20)
...
29:                                               ; preds = %25
  ...
  %34 = call i32 @strcmp(i8* %33, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0)) #7
  %35 = icmp ne i32 %34, 0
...
50:                                               ; preds = %25
  ...
  call void @_Z1xPfi(float* getelementptr inbounds ([50 x float], [50 x float]* @sort1, i64 0, i64 0), i32 %51)
  store i32 0, i32* %4, align 4
  br label %52
...
71:                                               ; preds = %67
  ...
  %76 = call i32 @strcmp(i8* %75, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.5, i64 0, i64 0)) #7
  %77 = icmp ne i32 %76, 0
...
92:                                               ; preds = %67
  ...
  call void @_Z2x1Pfi(float* getelementptr inbounds ([50 x float], [50 x float]* @sort2, i64 0, i64 0), i32 %93)
  store i32 0, i32* %4, align 4
  br label %94
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_782.cpp() #0 section ".text.startup" {
