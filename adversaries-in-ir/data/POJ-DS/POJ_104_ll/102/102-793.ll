; ModuleID = 'POJ-104-source/102/102-793.cpp'
source_filename = "POJ-104-source/102/102-793.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_793.cpp, i8* null }]
...
36:                                               ; preds = %32
  ...
  %41 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i8* %37, float* %40)
  %42 = getelementptr inbounds [10 x i8], [10 x i8]* %6, i64 0, i64 0
  %43 = call i32 @strcmp(i8* %42, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #6
  %44 = icmp ne i32 %43, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_793.cpp() #0 section ".text.startup" {
