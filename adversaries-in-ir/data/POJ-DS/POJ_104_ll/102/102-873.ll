; ModuleID = 'POJ-104-source/102/102-873.cpp'
source_filename = "POJ-104-source/102/102-873.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_873.cpp, i8* null }]
...
18:                                               ; preds = %14
  ...
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), [10 x i8]* %21, double* %24)
  br label %26
...
60:                                               ; preds = %56
  ...
  %65 = call i32 @strcmp(i8* %64, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i64 0, i64 0)) #6
  %66 = icmp eq i32 %65, 0
...
206:                                              ; preds = %194
  ...
  %210 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %3)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_873.cpp() #0 section ".text.startup" {
