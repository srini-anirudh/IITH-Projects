; ModuleID = 'POJ-104-source/102/102-875.cpp'
source_filename = "POJ-104-source/102/102-875.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_875.cpp, i8* null }]
...
63:                                               ; preds = %57
  ...
  %73 = call i32 @strcmp(i8* %67, i8* %72) #6
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_875.cpp() #0 section ".text.startup" {
