; ModuleID = 'POJ-104-source/102/102-88.cpp'
source_filename = "POJ-104-source/102/102-88.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_88.cpp, i8* null }]
...
37:                                               ; preds = %11
  ...
  call void @_ZSt4sortIPdEvT_S1_(double* %38, double* %42)
  ...
  call void @_ZSt4sortIPdEvT_S1_(double* %43, double* %47)
  store i32 0, i32* %5, align 4
  br label %48
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_88.cpp() #0 section ".text.startup" {
