; ModuleID = 'POJ-104-source/102/102-880.cpp'
source_filename = "POJ-104-source/102/102-880.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_880.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %31 = call i32 @strcmp(i8* %30, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #6
  %32 = icmp eq i32 %31, 0
...
51:                                               ; preds = %47
  ...
  %62 = call i32 @strcmp(i8* %56, i8* %61) #6
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_880.cpp() #0 section ".text.startup" {
