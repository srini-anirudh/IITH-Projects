; ModuleID = 'POJ-104-source/102/102-884.cpp'
source_filename = "POJ-104-source/102/102-884.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_884.cpp, i8* null }]
...
284:                                              ; preds = %275
  ...
  %318 = call i8* @strcpy(i8* %313, i8* %317) #3
  ...
  %324 = call i8* @strcpy(i8* %322, i8* %323) #3
  br label %364
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_884.cpp() #0 section ".text.startup" {
