; ModuleID = 'POJ-104-source/102/102-889.cpp'
source_filename = "POJ-104-source/102/102-889.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_889.cpp, i8* null }]
...
14:                                               ; preds = %10
  ...
  %23 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), float* %22)
  br label %24
...
190:                                              ; preds = %176
  %191 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %2)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_889.cpp() #0 section ".text.startup" {
