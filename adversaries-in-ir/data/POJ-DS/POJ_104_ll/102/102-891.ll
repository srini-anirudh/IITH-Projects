; ModuleID = 'POJ-104-source/102/102-891.cpp'
source_filename = "POJ-104-source/102/102-891.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_891.cpp, i8* null }]
...
12:                                               ; preds = %8
  ...
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %17, float* %21)
  br label %23
...
72:                                               ; preds = %59
  ...
  %81 = getelementptr inbounds [40 x %struct.photo], [40 x %struct.photo]* %3, i64 0, i64 %80
  %82 = load i32, i32* %6, align 4
  %83 = sext i32 %82 to i64
  %84 = getelementptr inbounds [40 x %struct.photo], [40 x %struct.photo]* %3, i64 0, i64 %83
  %85 = bitcast %struct.photo* %84 to i8*
  %86 = bitcast %struct.photo* %81 to i8*
...
125:                                              ; preds = %112
  ...
  %138 = bitcast %struct.photo* %137 to i8*
  %139 = bitcast %struct.photo* %134 to i8*
...
165:                                              ; preds = %155
  ...
  %174 = getelementptr inbounds [40 x %struct.photo], [40 x %struct.photo]* %3, i64 0, i64 %173
  %175 = load i32, i32* %6, align 4
  %176 = sext i32 %175 to i64
  %177 = getelementptr inbounds [40 x %struct.photo], [40 x %struct.photo]* %3, i64 0, i64 %176
  %178 = bitcast %struct.photo* %177 to i8*
  %179 = bitcast %struct.photo* %174 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_891.cpp() #0 section ".text.startup" {
