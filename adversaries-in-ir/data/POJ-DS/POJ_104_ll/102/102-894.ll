; ModuleID = 'POJ-104-source/102/102-894.cpp'
source_filename = "POJ-104-source/102/102-894.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_894.cpp, i8* null }]
...
19:                                               ; preds = %15
  ...
  %28 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), double* %3)
...
183:                                              ; preds = %180
  ...
  %188 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.3, i64 0, i64 0), double %187)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_894.cpp() #0 section ".text.startup" {
