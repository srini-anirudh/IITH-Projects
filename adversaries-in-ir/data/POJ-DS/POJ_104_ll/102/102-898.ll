; ModuleID = 'POJ-104-source/102/102-898.cpp'
source_filename = "POJ-104-source/102/102-898.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_898.cpp, i8* null }]
...
18:                                               ; preds = %14
  ...
  %26 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i8* %22, double* %25)
  br label %27
...
108:                                              ; preds = %105
  ...
  %113 = call i32 @strcmp(i8* %112, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #7
...
142:                                              ; preds = %138
  ...
  %147 = call i32 @strcmp(i8* %146, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.5, i64 0, i64 0)) #7
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_898.cpp() #0 section ".text.startup" {
