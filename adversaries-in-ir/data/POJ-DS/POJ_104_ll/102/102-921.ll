; ModuleID = 'POJ-104-source/102/102-921.cpp'
source_filename = "POJ-104-source/102/102-921.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_921.cpp, i8* null }]
...
21:                                               ; preds = %17
  ...
  %29 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i8* %25, float* %28)
  br label %30
...
38:                                               ; preds = %34
  ...
  %43 = call i32 @strcmp(i8* %42, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0)) #6
  %44 = icmp eq i32 %43, 0
...
55:                                               ; preds = %45, %38
  ...
  %60 = call i32 @strcmp(i8* %59, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.3, i64 0, i64 0)) #6
  %61 = icmp eq i32 %60, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_921.cpp() #0 section ".text.startup" {
