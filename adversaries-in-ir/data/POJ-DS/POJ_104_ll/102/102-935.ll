; ModuleID = 'POJ-104-source/102/102-935.cpp'
source_filename = "POJ-104-source/102/102-935.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_935.cpp, i8* null }]
...
35:                                               ; preds = %31
  ...
  %41 = call i32 @strcmp(i8* %40, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #6
  %42 = icmp eq i32 %41, 0
...
55:                                               ; preds = %51
  ...
  %61 = call i32 @strcmp(i8* %60, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #6
  %62 = icmp eq i32 %61, 0
...
146:                                              ; preds = %142
  ...
  %152 = call i32 @strcmp(i8* %151, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.4, i64 0, i64 0)) #6
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_935.cpp() #0 section ".text.startup" {
