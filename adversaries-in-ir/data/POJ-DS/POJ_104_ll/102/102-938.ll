; ModuleID = 'POJ-104-source/102/102-938.cpp'
source_filename = "POJ-104-source/102/102-938.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_938.cpp, i8* null }]
...
17:                                               ; preds = %13
  ...
  %27 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %22, double* %26)
  br label %28
...
36:                                               ; preds = %32
  ...
  %42 = call i32 @strcmp(i8* %41, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #6
  %43 = icmp eq i32 %42, 0
...
64:                                               ; preds = %60
  ...
  %70 = call i32 @strcmp(i8* %69, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i64 0, i64 0)) #6
  %71 = icmp eq i32 %70, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_938.cpp() #0 section ".text.startup" {
