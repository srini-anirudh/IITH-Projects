; ModuleID = 'POJ-104-source/102/102-939.cpp'
source_filename = "POJ-104-source/102/102-939.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_939.cpp, i8* null }]
...
16:                                               ; preds = %12
  ...
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), [7 x i8]* %19)
...
43:                                               ; preds = %35
  ...
  %47 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), double* %46)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_939.cpp() #0 section ".text.startup" {
