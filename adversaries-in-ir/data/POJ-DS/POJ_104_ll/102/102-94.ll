; ModuleID = 'POJ-104-source/102/102-94.cpp'
source_filename = "POJ-104-source/102/102-94.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_94.cpp, i8* null }]
...
13:                                               ; preds = %9
  ...
  %18 = call i32 @strcmp(i8* %17, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0)) #9
  %19 = icmp eq i32 %18, 0
...
33:                                               ; preds = %9
  ...
  call void @_ZSt4sortIPdEvT_S1_(double* getelementptr inbounds ([100 x double], [100 x double]* @f, i64 0, i64 0), double* %36)
  %37 = load i32, i32* %3, align 4
  %38 = sext i32 %37 to i64
  %39 = getelementptr inbounds double, double* getelementptr inbounds ([100 x double], [100 x double]* @g, i64 0, i64 0), i64 %38
  call void @_ZSt4sortIPdEvT_S1_(double* getelementptr inbounds ([100 x double], [100 x double]* @g, i64 0, i64 0), double* %39)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_94.cpp() #0 section ".text.startup" {
