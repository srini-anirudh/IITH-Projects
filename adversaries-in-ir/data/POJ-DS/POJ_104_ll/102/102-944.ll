; ModuleID = 'POJ-104-source/102/102-944.cpp'
source_filename = "POJ-104-source/102/102-944.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_944.cpp, i8* null }]
...
20:                                               ; preds = %16
  ...
  %30 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %25, double* %29)
  ...
  %36 = call i32 @strcmp(i8* %35, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #6
  %37 = icmp eq i32 %36, 0
...
49:                                               ; preds = %38, %20
  ...
  %55 = call i32 @strcmp(i8* %54, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i64 0, i64 0)) #6
  %56 = icmp eq i32 %55, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_944.cpp() #0 section ".text.startup" {
