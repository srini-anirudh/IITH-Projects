; ModuleID = 'POJ-104-source/102/102-949.cpp'
source_filename = "POJ-104-source/102/102-949.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_949.cpp, i8* null }]
...
27:                                               ; preds = %14
  %28 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %3)
  store i32 0, i32* %2, align 4
  br label %29
...
33:                                               ; preds = %29
  ...
  %41 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %37, double* %40)
  ...
  %46 = call i32 @strcmp(i8* %45, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #6
...
178:                                              ; preds = %174
  ...
  %183 = call i32 @strcmp(i8* %182, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #6
...
201:                                              ; preds = %197
  ...
  %206 = call i32 @strcmp(i8* %205, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #6
...
226:                                              ; preds = %222
  ...
  %231 = call i32 @strcmp(i8* %230, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.5, i64 0, i64 0)) #6
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_949.cpp() #0 section ".text.startup" {
