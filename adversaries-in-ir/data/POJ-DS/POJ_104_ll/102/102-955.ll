; ModuleID = 'POJ-104-source/102/102-955.cpp'
source_filename = "POJ-104-source/102/102-955.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_955.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %20 = call i32 @strcmp(i8* %19, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0)) #9
  %21 = icmp eq i32 %20, 0
...
38:                                               ; preds = %11
  ...
  call void @_ZSt4sortIPdEvT_S1_(double* %39, double* %43)
  ...
  call void @_ZSt4sortIPdEvT_S1_(double* %44, double* %48)
  store i32 0, i32* %5, align 4
  br label %49
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_955.cpp() #0 section ".text.startup" {
