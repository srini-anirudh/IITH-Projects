; ModuleID = 'POJ-104-source/102/102-958.cpp'
source_filename = "POJ-104-source/102/102-958.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_958.cpp, i8* null }]
...
21:                                               ; preds = %17
  ...
  %23 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i8* %22)
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), double* %2)
  %25 = getelementptr inbounds [10 x i8], [10 x i8]* %11, i64 0, i64 0
  %26 = getelementptr inbounds [5 x i8], [5 x i8]* %12, i64 0, i64 0
  %27 = call i32 @strcmp(i8* %25, i8* %26) #7
  %28 = icmp eq i32 %27, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_958.cpp() #0 section ".text.startup" {
