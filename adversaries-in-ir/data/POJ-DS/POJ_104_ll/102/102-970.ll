; ModuleID = 'POJ-104-source/102/102-970.cpp'
source_filename = "POJ-104-source/102/102-970.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_970.cpp, i8* null }]
...
23:                                               ; preds = %19
  ...
  %31 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %30, double* %9)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_970.cpp() #0 section ".text.startup" {
