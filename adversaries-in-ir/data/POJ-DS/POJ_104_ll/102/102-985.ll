; ModuleID = 'POJ-104-source/102/102-985.cpp'
source_filename = "POJ-104-source/102/102-985.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_985.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* %5)
...
23:                                               ; preds = %19
  ...
  %33 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i64 0, i64 0), i8* %28, double* %32)
  br label %34
...
71:                                               ; preds = %67
  ...
  %78 = call i32 @strcmp(i8* %76, i8* %77) #7
  %79 = icmp eq i32 %78, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_985.cpp() #0 section ".text.startup" {
