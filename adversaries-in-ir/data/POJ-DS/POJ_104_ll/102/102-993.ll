; ModuleID = 'POJ-104-source/102/102-993.cpp'
source_filename = "POJ-104-source/102/102-993.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_993.cpp, i8* null }]
...
18:                                               ; preds = %14
  ...
  %23 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i8* %19, double* %22)
  %24 = getelementptr inbounds [100 x i8], [100 x i8]* %12, i64 0, i64 0
  %25 = call i32 @strcmp(i8* %24, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #6
  %26 = icmp eq i32 %25, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_993.cpp() #0 section ".text.startup" {
