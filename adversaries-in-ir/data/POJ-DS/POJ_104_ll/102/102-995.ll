; ModuleID = 'POJ-104-source/102/102-995.cpp'
source_filename = "POJ-104-source/102/102-995.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_102_995.cpp, i8* null }]
...
41:                                               ; preds = %37
  ...
  %47 = call i32 @strcmp(i8* %46, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #6
  %48 = icmp eq i32 %47, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_102_995.cpp() #0 section ".text.startup" {
