; ModuleID = 'POJ-104-source/103/103-1070.cpp'
source_filename = "POJ-104-source/103/103-1070.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_103_1070.cpp, i8* null }]
...
134:                                              ; preds = %130
  ...
  %144 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i64 0, i64 0), i32 %139, i32 %143)
  br label %145
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_103_1070.cpp() #0 section ".text.startup" {
