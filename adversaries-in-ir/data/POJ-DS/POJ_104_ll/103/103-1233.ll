; ModuleID = 'POJ-104-source/103/103-1233.cpp'
source_filename = "POJ-104-source/103/103-1233.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_103_1233.cpp, i8* null }]
...
22:                                               ; preds = %14
  ...
  call void @_Z6changePci(i8* %23, i32 %24)
...
define dso_local void @_Z6changePci(i8* %0, i32 %1) #5 {
  %3 = alloca i8*, align 8
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_103_1233.cpp() #0 section ".text.startup" {
