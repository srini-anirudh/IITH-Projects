; ModuleID = 'POJ-104-source/103/103-194.cpp'
source_filename = "POJ-104-source/103/103-194.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_103_194.cpp, i8* null }]
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z1hii(i32 %0, i32 %1) #4 {
  %3 = alloca i32, align 4
...
33:                                               ; preds = %29
  ...
  %39 = call i32 @_Z1gc(i8 signext %38)
  ...
  %45 = call i32 @_Z1gc(i8 signext %44)
...
57:                                               ; preds = %33
  ...
  %68 = call i32 @_Z1gc(i8 signext %67)
...
83:                                               ; preds = %80
  ...
  %85 = call i32 @_Z1hii(i32 10, i32 %84)
...
104:                                              ; preds = %100
  ...
  %109 = call i32 @_Z1hii(i32 10, i32 %108)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_103_194.cpp() #0 section ".text.startup" {
