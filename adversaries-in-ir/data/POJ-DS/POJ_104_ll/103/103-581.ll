; ModuleID = 'POJ-104-source/103/103-581.cpp'
source_filename = "POJ-104-source/103/103-581.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_103_581.cpp, i8* null }]
...
define dso_local i32 @main() #5 {
  ...
  %10 = call signext i8 @_Z1fc(i8 signext %9)
...
18:                                               ; preds = %12
  ...
  %24 = call signext i8 @_Z1fc(i8 signext %23)
...
30:                                               ; preds = %18
  ...
  %38 = call signext i8 @_Z1fc(i8 signext %37)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_103_581.cpp() #0 section ".text.startup" {
