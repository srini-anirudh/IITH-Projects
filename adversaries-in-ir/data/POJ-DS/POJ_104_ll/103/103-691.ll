; ModuleID = 'POJ-104-source/103/103-691.cpp'
source_filename = "POJ-104-source/103/103-691.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_103_691.cpp, i8* null }]
...
123:                                              ; preds = %116
  ...
  %133 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i64 0, i64 0), i32 %128, i32 %132)
  br label %134
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_103_691.cpp() #0 section ".text.startup" {
