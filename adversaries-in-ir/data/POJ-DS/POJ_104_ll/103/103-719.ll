; ModuleID = 'POJ-104-source/103/103-719.cpp'
source_filename = "POJ-104-source/103/103-719.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_103_719.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %5 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), [1000 x i8]* %2)
...
87:                                               ; preds = %74
  ...
  %94 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i64 0, i64 0), i32 %92, i32 %93)
  store i32 1, i32* %4, align 4
  br label %95
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_103_719.cpp() #0 section ".text.startup" {
