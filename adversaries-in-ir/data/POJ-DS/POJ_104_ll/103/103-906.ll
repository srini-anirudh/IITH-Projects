; ModuleID = 'POJ-104-source/103/103-906.cpp'
source_filename = "POJ-104-source/103/103-906.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_103_906.cpp, i8* null }]
...
102:                                              ; preds = %12
  ...
  %106 = getelementptr inbounds [1005 x i8], [1005 x i8]* %2, i64 0, i64 %105
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_103_906.cpp() #0 section ".text.startup" {
