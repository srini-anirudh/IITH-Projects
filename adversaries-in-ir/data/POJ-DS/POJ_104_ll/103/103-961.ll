; ModuleID = 'POJ-104-source/103/103-961.cpp'
source_filename = "POJ-104-source/103/103-961.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_103_961.cpp, i8* null }]
...
48:                                               ; preds = %82, %47
  ...
  %51 = getelementptr inbounds [2000 x i8], [2000 x i8]* %2, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_103_961.cpp() #0 section ".text.startup" {
