; ModuleID = 'POJ-104-source/103/103-981.cpp'
source_filename = "POJ-104-source/103/103-981.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_103_981.cpp, i8* null }]
...
73:                                               ; preds = %66, %61
  ...
  %83 = sub i64 %81, %82
  %84 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEl(%"class.std::basic_ostream"* %78, i64 %83)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_103_981.cpp() #0 section ".text.startup" {
