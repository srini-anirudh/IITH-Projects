; ModuleID = 'POJ-104-source/104/104-1162.cpp'
source_filename = "POJ-104-source/104/104-1162.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_104_1162.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %7 = call i32 @_Z4backii(i32 %5, i32 %6)
...
define dso_local i32 @_Z4backii(i32 %0, i32 %1) #5 {
  %3 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_104_1162.cpp() #0 section ".text.startup" {
