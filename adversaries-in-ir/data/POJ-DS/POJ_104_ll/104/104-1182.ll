; ModuleID = 'POJ-104-source/104/104-1182.cpp'
source_filename = "POJ-104-source/104/104-1182.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_104_1182.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %15 = call i32 @_Z5leveli(i32 %14)
  store i32 %15, i32* %4, align 4
  %16 = load i32, i32* %3, align 4
  %17 = call i32 @_Z5leveli(i32 %16)
...
define dso_local i32 @_Z5leveli(i32 %0) #6 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_104_1182.cpp() #0 section ".text.startup" {
