; ModuleID = 'POJ-104-source/104/104-1273.cpp'
source_filename = "POJ-104-source/104/104-1273.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_104_1273.cpp, i8* null }]
...
42:                                               ; preds = %37
  ...
  call void @_Z4zhaoiiPi(i32 %44, i32 %45, i32* %46)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define dso_local void @_Z4zhaoiiPi(i32 %0, i32 %1, i32* %2) #0 {
...
35:                                               ; preds = %32
  ...
  call void @_Z4zhaoiiPi(i32 %36, i32 %38, i32* %39)
  br label %40
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_104_1273.cpp() #0 section ".text.startup" {
