; ModuleID = 'POJ-104-source/104/104-128.cpp'
source_filename = "POJ-104-source/104/104-128.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_104_128.cpp, i8* null }]
...
85:                                               ; preds = %75
  ...
  %88 = getelementptr inbounds [11 x i32], [11 x i32]* %2, i64 0, i64 %87
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_104_128.cpp() #0 section ".text.startup" {
