; ModuleID = 'POJ-104-source/104/104-1305.cpp'
source_filename = "POJ-104-source/104/104-1305.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_104_1305.cpp, i8* null }]
...
18:                                               ; preds = %6
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %4)
  br label %20
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_104_1305.cpp() #0 section ".text.startup" {
