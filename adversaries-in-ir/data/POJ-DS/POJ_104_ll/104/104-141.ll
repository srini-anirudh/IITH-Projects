; ModuleID = 'POJ-104-source/104/104-141.cpp'
source_filename = "POJ-104-source/104/104-141.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_104_141.cpp, i8* null }]
...
define dso_local i32 @_Z8erchashuPii(i32* %0, i32 %1) #4 {
...
define dso_local i32 @main() #5 {
  ...
  %13 = call i32 @_Z8erchashuPii(i32* %11, i32 %12)
  store i32 %13, i32* %6, align 4
  %14 = getelementptr inbounds [1000 x i32], [1000 x i32]* %5, i64 0, i64 0
  %15 = load i32, i32* %3, align 4
  %16 = call i32 @_Z8erchashuPii(i32* %14, i32 %15)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_104_141.cpp() #0 section ".text.startup" {
