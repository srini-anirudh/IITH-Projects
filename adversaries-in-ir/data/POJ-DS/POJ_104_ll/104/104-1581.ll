; ModuleID = 'POJ-104-source/104/104-1581.cpp'
source_filename = "POJ-104-source/104/104-1581.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_104_1581.cpp, i8* null }]
...
37:                                               ; preds = %26
  ...
  call void @qsort(i8* %39, i64 %41, i64 4, i32 (i8*, i8*)* @_Z4compPKvS0_)
  %42 = getelementptr inbounds [1001 x i32], [1001 x i32]* %10, i64 0, i64 0
  %43 = bitcast i32* %42 to i8*
  %44 = load i32, i32* %3, align 4
  %45 = sext i32 %44 to i64
  call void @qsort(i8* %43, i64 %45, i64 4, i32 (i8*, i8*)* @_Z4compPKvS0_)
  store i32 0, i32* %2, align 4
  br label %46
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_104_1581.cpp() #0 section ".text.startup" {
