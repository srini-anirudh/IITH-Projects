; ModuleID = 'POJ-104-source/104/104-166.cpp'
source_filename = "POJ-104-source/104/104-166.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_104_166.cpp, i8* null }]
...
define dso_local i32 @_Z4findiPi(i32 %0, i32* %1) #4 {
...
17:                                               ; preds = %0
  ...
  %20 = call i32 @_Z4findiPi(i32 %18, i32* %19)
  store i32 %20, i32* %6, align 4
  %21 = load i32, i32* %5, align 4
  %22 = getelementptr inbounds [1000 x i32], [1000 x i32]* %3, i64 0, i64 0
  %23 = call i32 @_Z4findiPi(i32 %21, i32* %22)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_104_166.cpp() #0 section ".text.startup" {
