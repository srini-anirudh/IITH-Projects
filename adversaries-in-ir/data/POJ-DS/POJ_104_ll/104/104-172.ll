; ModuleID = 'POJ-104-source/104/104-172.cpp'
source_filename = "POJ-104-source/104/104-172.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_104_172.cpp, i8* null }]
...
134:                                              ; preds = %85
  %135 = getelementptr inbounds [500 x i32], [500 x i32]* %6, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_104_172.cpp() #0 section ".text.startup" {
