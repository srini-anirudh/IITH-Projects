; ModuleID = 'POJ-104-source/104/104-45.cpp'
source_filename = "POJ-104-source/104/104-45.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_104_45.cpp, i8* null }]
...
46:                                               ; preds = %32
  ...
  %52 = call i32 @_Z5judgePiS_(i32* %50, i32* %51)
...
define dso_local i32 @_Z5judgePiS_(i32* %0, i32* %1) #6 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_104_45.cpp() #0 section ".text.startup" {
