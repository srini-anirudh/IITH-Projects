; ModuleID = 'POJ-104-source/104/104-521.cpp'
source_filename = "POJ-104-source/104/104-521.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_104_521.cpp, i8* null }]
...
define dso_local i32 @_Z6shuliePi(i32* %0) #4 {
...
15:                                               ; preds = %0
  %16 = getelementptr inbounds [11 x i32], [11 x i32]* %3, i64 0, i64 10
...
21:                                               ; preds = %15
  %22 = getelementptr inbounds [11 x i32], [11 x i32]* %2, i64 0, i64 0
  %23 = call i32 @_Z6shuliePi(i32* %22)
  store i32 %23, i32* %5, align 4
  %24 = getelementptr inbounds [11 x i32], [11 x i32]* %3, i64 0, i64 0
  %25 = call i32 @_Z6shuliePi(i32* %24)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_104_521.cpp() #0 section ".text.startup" {
