; ModuleID = 'POJ-104-source/104/104-553.cpp'
source_filename = "POJ-104-source/104/104-553.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_104_553.cpp, i8* null }]
...
define dso_local i32 @_Z8erchashuii(i32 %0, i32 %1) #4 {
...
define dso_local i32 @main() #5 {
  ...
  %6 = call i32 @_Z8erchashuii(i32 %4, i32 %5)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_104_553.cpp() #0 section ".text.startup" {
