; ModuleID = 'POJ-104-source/104/104-565.cpp'
source_filename = "POJ-104-source/104/104-565.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_104_565.cpp, i8* null }]
...
define dso_local void @_Z5erchaPi(i32* %0) #4 {
...
20:                                               ; preds = %17
  ...
  %25 = getelementptr inbounds [11 x i32], [11 x i32]* %3, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_104_565.cpp() #0 section ".text.startup" {
