; ModuleID = 'POJ-104-source/104/104-724.cpp'
source_filename = "POJ-104-source/104/104-724.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_104_724.cpp, i8* null }]
...
20:                                               ; preds = %8
  ...
  call void @llvm.memset.p0i8.i64(i8* align 16 %24, i8 0, i64 4004, i1 false)
  %25 = getelementptr inbounds [1001 x i32], [1001 x i32]* %2, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_104_724.cpp() #0 section ".text.startup" {
