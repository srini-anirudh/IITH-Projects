; ModuleID = 'POJ-104-source/104/104-917.cpp'
source_filename = "POJ-104-source/104/104-917.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_104_917.cpp, i8* null }]
...
21:                                               ; preds = %17, %0
  %22 = getelementptr inbounds [1000 x i32], [1000 x i32]* %11, i64 0, i64 0
...
38:                                               ; preds = %27
  %39 = getelementptr inbounds [1000 x i32], [1000 x i32]* %12, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_104_917.cpp() #0 section ".text.startup" {
