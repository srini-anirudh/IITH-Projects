; ModuleID = 'POJ-104-source/104/104-951.cpp'
source_filename = "POJ-104-source/104/104-951.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_104_951.cpp, i8* null }]
...
define dso_local i32* @_Z6count1i(i32 %0) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32* @_Z6count2i(i32 %0) #4 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z7comparev() #4 {
...
define dso_local i32 @main() #5 {
  ...
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %3, i32* %4)
  %7 = load i32, i32* %3, align 4
  %8 = call i32* @_Z6count1i(i32 %7)
  store i32* %8, i32** @p, align 8
  %9 = load i32, i32* %4, align 4
  %10 = call i32* @_Z6count2i(i32 %9)
  store i32* %10, i32** @q, align 8
  %11 = call i32 @_Z7comparev()
  store i32 %11, i32* %5, align 4
  %12 = load i32, i32* %5, align 4
  %13 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i32 %12)
  %14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i32* %5)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_104_951.cpp() #0 section ".text.startup" {
