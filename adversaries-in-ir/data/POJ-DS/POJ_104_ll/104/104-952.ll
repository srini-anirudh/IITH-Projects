; ModuleID = 'POJ-104-source/104/104-952.cpp'
source_filename = "POJ-104-source/104/104-952.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_104_952.cpp, i8* null }]
...
42:                                               ; preds = %24
  ...
  %45 = call i32 @_Z4stepii(i32 %43, i32 %44)
  br label %50

46:                                               ; preds = %24
  %47 = load i32, i32* %4, align 4
  %48 = load i32, i32* %3, align 4
  %49 = call i32 @_Z4stepii(i32 %47, i32 %48)
  br label %50
...
8:                                                ; preds = %0
  ...
  %11 = call i32 @_Z4stepii(i32 %9, i32 %10)
...
13:                                               ; preds = %0
  ...
  %16 = call i32 @_Z4stepii(i32 %14, i32 %15)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_104_952.cpp() #0 section ".text.startup" {
