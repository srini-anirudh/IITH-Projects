; ModuleID = 'POJ-104-source/104/104-956.cpp'
source_filename = "POJ-104-source/104/104-956.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_104_956.cpp, i8* null }]
...
85:                                               ; preds = %120, %84
  ...
  %89 = call i32 @_Z3minii(i32 %87, i32 %88)
...
define dso_local i32 @_Z3puti(i32 %0) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_104_956.cpp() #0 section ".text.startup" {
