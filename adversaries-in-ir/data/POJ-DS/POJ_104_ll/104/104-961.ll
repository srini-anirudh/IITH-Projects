; ModuleID = 'POJ-104-source/104/104-961.cpp'
source_filename = "POJ-104-source/104/104-961.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_104_961.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z4treeiiPi(i32 %0, i32 %1, i32* %2) #0 {
...
19:                                               ; preds = %3
  ...
  call void @_Z4treeiiPi(i32 %25, i32 %27, i32* %28)
  br label %29
...
define dso_local i32 @main() #4 {
  ...
  call void @_Z4treeiiPi(i32 %11, i32 0, i32* %12)
  %13 = load i32, i32* %3, align 4
  %14 = getelementptr inbounds [12 x i32], [12 x i32]* %7, i64 0, i64 0
  call void @_Z4treeiiPi(i32 %13, i32 0, i32* %14)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_104_961.cpp() #0 section ".text.startup" {
