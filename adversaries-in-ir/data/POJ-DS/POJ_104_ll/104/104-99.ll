; ModuleID = 'POJ-104-source/104/104-99.cpp'
source_filename = "POJ-104-source/104/104-99.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_104_99.cpp, i8* null }]
...
define dso_local i32 @_Z5changPi(i32* %0) #6 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_104_99.cpp() #0 section ".text.startup" {
