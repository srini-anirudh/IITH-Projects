; ModuleID = 'POJ-104-source/11/11-220.cpp'
source_filename = "POJ-104-source/11/11-220.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_11_220.cpp, i8* null }]
...
define dso_local i32 @_Z7sum_dayii(i32 %0, i32 %1) #4 {
...
10:                                               ; preds = %7
  ...
  %14 = call i32 @_Z7sum_dayii(i32 %12, i32 %13)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_11_220.cpp() #0 section ".text.startup" {
