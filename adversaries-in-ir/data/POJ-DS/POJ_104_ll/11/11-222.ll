; ModuleID = 'POJ-104-source/11/11-222.cpp'
source_filename = "POJ-104-source/11/11-222.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_11_222.cpp, i8* null }]
...
12:                                               ; preds = %9
  ...
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i32* %15, i32* %18, i32* %21)
  br label %23
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_11_222.cpp() #0 section ".text.startup" {
