; ModuleID = 'POJ-104-source/11/11-235.cpp'
source_filename = "POJ-104-source/11/11-235.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_11_235.cpp, i8* null }]
...
10:                                               ; preds = %7
  ...
  %15 = call i32 @_Z5countiii(i32 %12, i32 %13, i32 %14)
...
21:                                               ; preds = %7
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i32* %5)
  ret i32 0
}
...
define dso_local i32 @_Z5countiii(i32 %0, i32 %1, i32 %2) #5 {
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_11_235.cpp() #0 section ".text.startup" {
