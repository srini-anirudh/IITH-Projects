; ModuleID = 'POJ-104-source/11/11-243.cpp'
source_filename = "POJ-104-source/11/11-243.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_11_243.cpp, i8* null }]
...
12:                                               ; preds = %8
  %13 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i32* %2, i16* %3, i16* %4)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_11_243.cpp() #0 section ".text.startup" {
