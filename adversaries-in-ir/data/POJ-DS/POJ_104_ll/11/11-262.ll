; ModuleID = 'POJ-104-source/11/11-262.cpp'
source_filename = "POJ-104-source/11/11-262.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_11_262.cpp, i8* null }]
...
10:                                               ; preds = %7
  ...
  %13 = getelementptr inbounds [5 x i64], [5 x i64]* %3, i64 0, i64 %12
  ...
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i64 0, i64 0), i64* %13, i32* %16, i32* %19)
...
107:                                              ; preds = %27
  %108 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0))
  br label %109

109:                                              ; preds = %107, %101
  %110 = load i32, i32* %2, align 4
  %111 = sext i32 %110 to i64
  %112 = getelementptr inbounds [5 x i64], [5 x i64]* %3, i64 0, i64 %111
...
116:                                              ; preds = %109
  ...
  %119 = getelementptr inbounds [5 x i64], [5 x i64]* %3, i64 0, i64 %118
...
123:                                              ; preds = %116, %109
  ...
  %126 = getelementptr inbounds [5 x i64], [5 x i64]* %3, i64 0, i64 %125
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_11_262.cpp() #0 section ".text.startup" {
