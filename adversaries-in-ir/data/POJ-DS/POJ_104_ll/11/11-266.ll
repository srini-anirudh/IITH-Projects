; ModuleID = 'POJ-104-source/11/11-266.cpp'
source_filename = "POJ-104-source/11/11-266.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_11_266.cpp, i8* null }]
...
26:                                               ; preds = %22, %18
  %27 = bitcast [12 x i32]* %8 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %27, i8* align 16 bitcast ([12 x i32]* @__const.main.days to i8*), i64 48, i1 false)
...
47:                                               ; preds = %22
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %48, i8* align 16 bitcast ([12 x i32]* @__const.main.days.1 to i8*), i64 48, i1 false)
  store i32 0, i32* %6, align 4
  br label %49
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_11_266.cpp() #0 section ".text.startup" {
