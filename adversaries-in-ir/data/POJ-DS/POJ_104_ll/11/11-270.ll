; ModuleID = 'POJ-104-source/11/11-270.cpp'
source_filename = "POJ-104-source/11/11-270.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_11_270.cpp, i8* null }]
...
14:                                               ; preds = %11
  ...
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str, i64 0, i64 0), i64* %17, i64* %20, i64* %23)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_11_270.cpp() #0 section ".text.startup" {
