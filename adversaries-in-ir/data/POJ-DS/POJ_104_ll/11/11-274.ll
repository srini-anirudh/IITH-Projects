; ModuleID = 'POJ-104-source/11/11-274.cpp'
source_filename = "POJ-104-source/11/11-274.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_11_274.cpp, i8* null }]
...
25:                                               ; preds = %22
  %26 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i64 0, i64 0), i32* %3, i32* %4, i32* %5)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_11_274.cpp() #0 section ".text.startup" {
