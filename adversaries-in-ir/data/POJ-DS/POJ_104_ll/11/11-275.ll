; ModuleID = 'POJ-104-source/11/11-275.cpp'
source_filename = "POJ-104-source/11/11-275.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_11_275.cpp, i8* null }]
...
9:                                                ; preds = %6
  ...
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i32* %12, i32* %15, i32* %18)
  br label %20
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_11_275.cpp() #0 section ".text.startup" {
