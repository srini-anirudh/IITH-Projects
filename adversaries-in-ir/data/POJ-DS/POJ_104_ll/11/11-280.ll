; ModuleID = 'POJ-104-source/11/11-280.cpp'
source_filename = "POJ-104-source/11/11-280.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_11_280.cpp, i8* null }]
...
10:                                               ; preds = %7
  ...
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str, i64 0, i64 0), i64* %12, i64* %14, i64* %16)
  br label %18
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_11_280.cpp() #0 section ".text.startup" {
