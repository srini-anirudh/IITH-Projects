; ModuleID = 'POJ-104-source/11/11-7.cpp'
source_filename = "POJ-104-source/11/11-7.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_11_7.cpp, i8* null }]
...
21:                                               ; preds = %15
  %22 = getelementptr inbounds %struct.date, %struct.date* %2, i32 0, i32 3
...
33:                                               ; preds = %15
  ...
  %39 = getelementptr inbounds %struct.date, %struct.date* %2, i32 0, i32 3
  store i32 %38, i32* %39, align 4
  br label %44

40:                                               ; preds = %0
  %41 = getelementptr inbounds %struct.date, %struct.date* %2, i32 0, i32 2
  %42 = load i32, i32* %41, align 4
  %43 = getelementptr inbounds %struct.date, %struct.date* %2, i32 0, i32 3
  store i32 %42, i32* %43, align 4
  br label %44

44:                                               ; preds = %40, %33
  %45 = getelementptr inbounds %struct.date, %struct.date* %2, i32 0, i32 3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_11_7.cpp() #0 section ".text.startup" {
