; ModuleID = 'POJ-104-source/11/11-735.cpp'
source_filename = "POJ-104-source/11/11-735.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_11_735.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %7 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32* %3, i32* %4, i32* %5)
  %8 = load i32, i32* %3, align 4
  %9 = call i32 @_Z4leapi(i32 %8)
...
12:                                               ; preds = %0
  ...
  %15 = call i32 @_Z3calii(i32 %13, i32 %14)
...
19:                                               ; preds = %16
  ...
  %22 = call i32 @_Z4callii(i32 %20, i32 %21)
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z3calii(i32 %0, i32 %1) #5 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  store i32 %0, i32* %3, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z4callii(i32 %0, i32 %1) #5 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  store i32 %0, i32* %3, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_11_735.cpp() #0 section ".text.startup" {
