; ModuleID = 'POJ-104-source/11/11-793.cpp'
source_filename = "POJ-104-source/11/11-793.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_11_793.cpp, i8* null }]
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z2f2i(i32 %0) #4 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  store i32 %0, i32* %2, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_11_793.cpp() #0 section ".text.startup" {
