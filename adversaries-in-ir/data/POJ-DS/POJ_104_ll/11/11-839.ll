; ModuleID = 'POJ-104-source/11/11-839.cpp'
source_filename = "POJ-104-source/11/11-839.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_11_839.cpp, i8* null }]
...
21:                                               ; preds = %18
  ...
  %23 = call i32 @_Z9isrunniani(i32 %22)
  %24 = icmp ne i32 %23, 0
...
37:                                               ; preds = %34
  ...
  %39 = call i32 @_Z9isrunniani(i32 %38)
  %40 = icmp ne i32 %39, 0
...
69:                                               ; preds = %66
  ...
  %71 = call i32 @_Z9isrunniani(i32 %70)
  %72 = icmp ne i32 %71, 0
...
85:                                               ; preds = %82
  ...
  %87 = call i32 @_Z9isrunniani(i32 %86)
  %88 = icmp ne i32 %87, 0
...
101:                                              ; preds = %98
  ...
  %103 = call i32 @_Z9isrunniani(i32 %102)
...
117:                                              ; preds = %114
  ...
  %119 = call i32 @_Z9isrunniani(i32 %118)
...
133:                                              ; preds = %130
  ...
  %135 = call i32 @_Z9isrunniani(i32 %134)
...
149:                                              ; preds = %146
  ...
  %151 = call i32 @_Z9isrunniani(i32 %150)
...
165:                                              ; preds = %162
  ...
  %167 = call i32 @_Z9isrunniani(i32 %166)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_11_839.cpp() #0 section ".text.startup" {
