; ModuleID = 'POJ-104-source/11/11-859.cpp'
source_filename = "POJ-104-source/11/11-859.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_11_859.cpp, i8* null }]
...
22:                                               ; preds = %14
  ...
  %24 = call i32 @_Z9isrunniani(i32 %23)
  %25 = icmp ne i32 %24, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_11_859.cpp() #0 section ".text.startup" {
