; ModuleID = 'POJ-104-source/12/12-1033.cpp'
source_filename = "POJ-104-source/12/12-1033.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_12_1033.cpp, i8* null }]
...
10:                                               ; preds = %29, %9
  ...
  %15 = getelementptr inbounds [16 x i32], [16 x i32]* %3, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_12_1033.cpp() #0 section ".text.startup" {
