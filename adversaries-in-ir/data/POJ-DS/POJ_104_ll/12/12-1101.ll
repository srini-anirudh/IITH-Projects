; ModuleID = 'POJ-104-source/12/12-1101.cpp'
source_filename = "POJ-104-source/12/12-1101.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_12_1101.cpp, i8* null }]
...
39:                                               ; preds = %34
  ...
  %47 = getelementptr inbounds [16 x i32], [16 x i32]* %6, i64 0, i64 %46
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_12_1101.cpp() #0 section ".text.startup" {
