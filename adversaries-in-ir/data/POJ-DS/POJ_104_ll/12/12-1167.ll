; ModuleID = 'POJ-104-source/12/12-1167.cpp'
source_filename = "POJ-104-source/12/12-1167.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_12_1167.cpp, i8* null }]
...
19:                                               ; preds = %15
  ...
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %23, i8* %7)
  br label %15
...
71:                                               ; preds = %28
  ...
  %75 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %74, i8* %7)
  br label %10
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_12_1167.cpp() #0 section ".text.startup" {
