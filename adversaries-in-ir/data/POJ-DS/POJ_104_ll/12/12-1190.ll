; ModuleID = 'POJ-104-source/12/12-1190.cpp'
source_filename = "POJ-104-source/12/12-1190.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_12_1190.cpp, i8* null }]
...
18:                                               ; preds = %24, %12
  ...
  %21 = getelementptr inbounds [16 x i32], [16 x i32]* %3, i64 0, i64 %20
...
77:                                               ; preds = %32
  ...
  %80 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %2)
  br label %9
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_12_1190.cpp() #0 section ".text.startup" {
