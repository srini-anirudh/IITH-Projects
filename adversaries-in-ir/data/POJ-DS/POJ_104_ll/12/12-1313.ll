; ModuleID = 'POJ-104-source/12/12-1313.cpp'
source_filename = "POJ-104-source/12/12-1313.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_12_1313.cpp, i8* null }]
...
23:                                               ; preds = %19
  ...
  %25 = getelementptr inbounds [15 x i32], [15 x i32]* %3, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_12_1313.cpp() #0 section ".text.startup" {
