; ModuleID = 'POJ-104-source/12/12-150.cpp'
source_filename = "POJ-104-source/12/12-150.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_12_150.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %9 = bitcast i8* %8 to <{ i32, [14 x i32] }>*
  %10 = getelementptr inbounds <{ i32, [14 x i32] }>, <{ i32, [14 x i32] }>* %9, i32 0, i32 0
...
17:                                               ; preds = %13
  ...
  %18 = getelementptr inbounds [15 x i32], [15 x i32]* %2, i64 0, i64 1
...
115:                                              ; preds = %82
  ...
  %118 = getelementptr inbounds [15 x i32], [15 x i32]* %2, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_12_150.cpp() #0 section ".text.startup" {
