; ModuleID = 'POJ-104-source/12/12-155.cpp'
source_filename = "POJ-104-source/12/12-155.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_12_155.cpp, i8* null }]
...
22:                                               ; preds = %15
  ...
  %30 = getelementptr inbounds [20 x i32], [20 x i32]* %26, i64 0, i64 %29
...
33:                                               ; preds = %22, %54
  ...
  %44 = getelementptr inbounds [20 x i32], [20 x i32]* %40, i64 0, i64 %43
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_12_155.cpp() #0 section ".text.startup" {
