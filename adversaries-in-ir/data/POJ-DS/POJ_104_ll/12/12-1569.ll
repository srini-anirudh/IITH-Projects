; ModuleID = 'POJ-104-source/12/12-1569.cpp'
source_filename = "POJ-104-source/12/12-1569.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_12_1569.cpp, i8* null }]
...
61:                                               ; preds = %32
  ...
  %67 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i64 0, i64 0), i32* %66)
  store i32 0, i32* %6, align 4
  store i32 0, i32* %4, align 4
  br label %11
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_12_1569.cpp() #0 section ".text.startup" {
