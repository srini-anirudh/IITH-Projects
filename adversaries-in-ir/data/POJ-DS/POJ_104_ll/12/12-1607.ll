; ModuleID = 'POJ-104-source/12/12-1607.cpp'
source_filename = "POJ-104-source/12/12-1607.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_12_1607.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z4findPiiii(i32* %0, i32 %1, i32 %2, i32 %3) #0 {
  %5 = alloca i32, align 4
...
36:                                               ; preds = %28
  ...
  %41 = sub nsw i32 %40, 1
  %42 = call i32 @_Z4findPiiii(i32* %37, i32 %38, i32 %39, i32 %41)
...
43:                                               ; preds = %28
  ...
  %49 = call i32 @_Z4findPiiii(i32* %44, i32 %45, i32 %47, i32 %48)
...
40:                                               ; preds = %38
  ...
  call void @_Z4swapPiS_(i32* %43, i32* %47)
  br label %48
...
57:                                               ; preds = %53
  ...
  %67 = call i32 @_Z4findPiiii(i32* %58, i32 %63, i32 %65, i32 %66)
  %68 = icmp ne i32 %67, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_12_1607.cpp() #0 section ".text.startup" {
