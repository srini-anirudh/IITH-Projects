; ModuleID = 'POJ-104-source/12/12-186.cpp'
source_filename = "POJ-104-source/12/12-186.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_12_186.cpp, i8* null }]
...
17:                                               ; preds = %14
  ...
  %22 = getelementptr inbounds [20 x i32], [20 x i32]* %8, i64 0, i64 0
...
26:                                               ; preds = %17
  %27 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* %9)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_12_186.cpp() #0 section ".text.startup" {
