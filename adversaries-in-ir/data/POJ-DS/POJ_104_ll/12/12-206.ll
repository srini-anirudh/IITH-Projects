; ModuleID = 'POJ-104-source/12/12-206.cpp'
source_filename = "POJ-104-source/12/12-206.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_12_206.cpp, i8* null }]
...
8:                                                ; preds = %0, %64
  store i32 0, i32* %6, align 4
  %9 = getelementptr inbounds [20 x i32], [20 x i32]* %7, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_12_206.cpp() #0 section ".text.startup" {
