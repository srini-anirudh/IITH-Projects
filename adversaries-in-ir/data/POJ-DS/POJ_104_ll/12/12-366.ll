; ModuleID = 'POJ-104-source/12/12-366.cpp'
source_filename = "POJ-104-source/12/12-366.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_12_366.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %9 = bitcast [100 x [16 x i32]]* %2 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_12_366.cpp() #0 section ".text.startup" {
