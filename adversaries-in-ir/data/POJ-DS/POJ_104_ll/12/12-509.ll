; ModuleID = 'POJ-104-source/12/12-509.cpp'
source_filename = "POJ-104-source/12/12-509.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_12_509.cpp, i8* null }]
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z5countPii(i32* %0, i32 %1) #4 {
...
11:                                               ; preds = %7
  ...
  %18 = load i32, i32* %17, align 4
  %19 = mul nsw i32 2, %18
  %20 = call i32 @_Z4findPiii(i32* %12, i32 %13, i32 %19)
...
28:                                               ; preds = %15
  ...
  %31 = call i32 @_Z5countPii(i32* %29, i32 %30)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_12_509.cpp() #0 section ".text.startup" {
