; ModuleID = 'POJ-104-source/12/12-721.cpp'
source_filename = "POJ-104-source/12/12-721.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_12_721.cpp, i8* null }]
...
10:                                               ; preds = %105, %0
  ...
  %13 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %8, i64 0, i64 %12
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_12_721.cpp() #0 section ".text.startup" {
