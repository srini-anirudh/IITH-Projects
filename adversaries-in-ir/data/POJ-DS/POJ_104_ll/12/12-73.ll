; ModuleID = 'POJ-104-source/12/12-73.cpp'
source_filename = "POJ-104-source/12/12-73.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_12_73.cpp, i8* null }]
...
19:                                               ; preds = %16
  ...
  %23 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), float* %22)
...
27:                                               ; preds = %19
  %28 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.1, i64 0, i64 0))
  %29 = icmp ne i32 %28, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_12_73.cpp() #0 section ".text.startup" {
