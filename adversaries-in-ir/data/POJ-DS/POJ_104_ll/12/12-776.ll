; ModuleID = 'POJ-104-source/12/12-776.cpp'
source_filename = "POJ-104-source/12/12-776.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_12_776.cpp, i8* null }]
...
11:                                               ; preds = %26, %10
  ...
  %15 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), float* %14)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_12_776.cpp() #0 section ".text.startup" {
