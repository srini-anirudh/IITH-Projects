; ModuleID = 'POJ-104-source/12/12-838.cpp'
source_filename = "POJ-104-source/12/12-838.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_12_838.cpp, i8* null }]
...
36:                                               ; preds = %31, %18
  %37 = getelementptr inbounds [16 x i32], [16 x i32]* %3, i64 0, i64 0
  %38 = load i32, i32* %5, align 4
  %39 = call i32 @_Z3cntPii(i32* %37, i32 %38)
...
define dso_local i32 @_Z3cntPii(i32* %0, i32 %1) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_12_838.cpp() #0 section ".text.startup" {
