; ModuleID = 'POJ-104-source/12/12-861.cpp'
source_filename = "POJ-104-source/12/12-861.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_12_861.cpp, i8* null }]
...
57:                                               ; preds = %24
  ...
  %60 = getelementptr inbounds [16 x i32], [16 x i32]* %5, i64 0, i64 1
  %61 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %60)
  br label %62

62:                                               ; preds = %57
  %63 = getelementptr inbounds [16 x i32], [16 x i32]* %5, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_12_861.cpp() #0 section ".text.startup" {
