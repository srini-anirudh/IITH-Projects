; ModuleID = 'POJ-104-source/12/12-862.cpp'
source_filename = "POJ-104-source/12/12-862.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_12_862.cpp, i8* null }]
...
37:                                               ; preds = %21
  ...
  %40 = getelementptr inbounds [100 x [16 x i32]], [100 x [16 x i32]]* %2, i64 0, i64 %39
...
110:                                              ; preds = %93
  ...
  %113 = getelementptr inbounds [100 x [16 x i32]], [100 x [16 x i32]]* %2, i64 0, i64 %112
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_12_862.cpp() #0 section ".text.startup" {
