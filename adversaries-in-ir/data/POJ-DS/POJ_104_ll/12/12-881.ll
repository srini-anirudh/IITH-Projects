; ModuleID = 'POJ-104-source/12/12-881.cpp'
source_filename = "POJ-104-source/12/12-881.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_12_881.cpp, i8* null }]
...
63:                                               ; preds = %56
  %64 = getelementptr inbounds [20 x i32], [20 x i32]* %2, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_12_881.cpp() #0 section ".text.startup" {
