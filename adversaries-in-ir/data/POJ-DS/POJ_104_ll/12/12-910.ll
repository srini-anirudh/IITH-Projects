; ModuleID = 'POJ-104-source/12/12-910.cpp'
source_filename = "POJ-104-source/12/12-910.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_12_910.cpp, i8* null }]
...
9:                                                ; preds = %96, %0
  ...
  %12 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %6, i64 0, i64 %11
  ...
  %17 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %6, i64 0, i64 %16
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_12_910.cpp() #0 section ".text.startup" {
