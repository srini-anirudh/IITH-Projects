; ModuleID = 'POJ-104-source/12/12-918.cpp'
source_filename = "POJ-104-source/12/12-918.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_12_918.cpp, i8* null }]
...
113:                                              ; preds = %79
  ...
  store i32 0, i32* %4, align 4
  %116 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i32* %5)
  br label %10
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_12_918.cpp() #0 section ".text.startup" {
