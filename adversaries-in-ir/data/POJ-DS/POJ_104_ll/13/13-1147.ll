; ModuleID = 'POJ-104-source/13/13-1147.cpp'
source_filename = "POJ-104-source/13/13-1147.cpp"
...
@stat = dso_local global [115 x i32] zeroinitializer, align 16
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_13_1147.cpp, i8* null }]
...
12:                                               ; preds = %2
  %13 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* @n)
  store i32 0, i32* @i, align 4
  br label %14
...
18:                                               ; preds = %14
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* @k)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_13_1147.cpp() #0 section ".text.startup" {
