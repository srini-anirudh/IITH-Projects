; ModuleID = 'POJ-104-source/13/13-1390.cpp'
source_filename = "POJ-104-source/13/13-1390.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_13_1390.cpp, i8* null }]
...
21:                                               ; preds = %11
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %9)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_13_1390.cpp() #0 section ".text.startup" {
