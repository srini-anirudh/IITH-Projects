; ModuleID = 'POJ-104-source/13/13-1877.cpp'
source_filename = "POJ-104-source/13/13-1877.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_13_1877.cpp, i8* null }]
...
69:                                               ; preds = %26
  ...
  %72 = getelementptr inbounds [20000 x i32], [20000 x i32]* %3, i64 0, i64 1
...
93:                                               ; preds = %80
  %94 = getelementptr inbounds [20000 x i32], [20000 x i32]* %6, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_13_1877.cpp() #0 section ".text.startup" {
