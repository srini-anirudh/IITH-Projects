; ModuleID = 'POJ-104-source/13/13-2008.cpp'
source_filename = "POJ-104-source/13/13-2008.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_13_2008.cpp, i8* null }]
...
12:                                               ; preds = %8
  ...
  %16 = getelementptr inbounds [110 x i32], [110 x i32]* %5, i64 0, i64 %15
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_13_2008.cpp() #0 section ".text.startup" {
