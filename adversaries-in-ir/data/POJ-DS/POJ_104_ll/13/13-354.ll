; ModuleID = 'POJ-104-source/13/13-354.cpp'
source_filename = "POJ-104-source/13/13-354.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_13_354.cpp, i8* null }]
...
20:                                               ; preds = %8
  %21 = getelementptr inbounds [100000 x i32], [100000 x i32]* %4, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_13_354.cpp() #0 section ".text.startup" {
