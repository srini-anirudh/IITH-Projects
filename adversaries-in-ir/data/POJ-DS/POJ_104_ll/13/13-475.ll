; ModuleID = 'POJ-104-source/13/13-475.cpp'
source_filename = "POJ-104-source/13/13-475.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_13_475.cpp, i8* null }]
...
79:                                               ; preds = %76
  %80 = getelementptr inbounds i32, i32* %14, i64 0
...
109:                                              ; preds = %97
  %110 = getelementptr inbounds i32, i32* %17, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_13_475.cpp() #0 section ".text.startup" {
