; ModuleID = 'POJ-104-source/13/13-476.cpp'
source_filename = "POJ-104-source/13/13-476.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_13_476.cpp, i8* null }]
...
77:                                               ; preds = %33
  %78 = getelementptr inbounds i32, i32* %14, i64 0
...
96:                                               ; preds = %84
  %97 = getelementptr inbounds i32, i32* %17, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_13_476.cpp() #0 section ".text.startup" {
