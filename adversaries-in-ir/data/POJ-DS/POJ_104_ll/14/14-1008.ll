; ModuleID = 'POJ-104-source/14/14-1008.cpp'
source_filename = "POJ-104-source/14/14-1008.cpp"
...
@temp = dso_local global %struct.statistics zeroinitializer, align 4
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [9 x i8] c"%d %d %d\00", align 1
@.str.2 = private unnamed_addr constant [7 x i8] c"%d %d\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_1008.cpp, i8* null }]
...
11:                                               ; preds = %7
  ...
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32* %15, i32* %19, i32* %23)
...
84:                                               ; preds = %80
  ...
  %95 = bitcast %struct.statistics* %94 to i8*
  %96 = bitcast %struct.statistics* %91 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_1008.cpp() #0 section ".text.startup" {
