; ModuleID = 'POJ-104-source/14/14-103.cpp'
source_filename = "POJ-104-source/14/14-103.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_103.cpp, i8* null }]
...
134:                                              ; preds = %100
  ...
  %146 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0), i32 %140, i32 %145)
  %147 = getelementptr inbounds [3 x i32], [3 x i32]* %5, i64 0, i64 1
  ...
  %158 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0), i32 %152, i32 %157)
  ...
  %168 = getelementptr inbounds [100000 x i32], [100000 x i32]* %4, i64 0, i64 %167
  %169 = load i32, i32* %168, align 4
  %170 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.3, i64 0, i64 0), i32 %164, i32 %169)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_103.cpp() #0 section ".text.startup" {
