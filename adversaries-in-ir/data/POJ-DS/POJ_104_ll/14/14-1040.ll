; ModuleID = 'POJ-104-source/14/14-1040.cpp'
source_filename = "POJ-104-source/14/14-1040.cpp"
...
@p = dso_local global %struct.Top* null, align 8
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_1040.cpp, i8* null }]
...
define dso_local void @_Z6maopaoi(i32 %0) #4 {
...
28:                                               ; preds = %19
  ...
  %34 = bitcast %struct.Top* %33 to i8*
  %35 = bitcast %struct.Top* %32 to i8*
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z4sortfi(float %0, i32 %1) #4 {
...
14:                                               ; preds = %10
  %15 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32* %4, float* %5, float* %6)
  ...
  call void @_Z4sortfi(float %19, i32 %20)
  br label %21
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_1040.cpp() #0 section ".text.startup" {
