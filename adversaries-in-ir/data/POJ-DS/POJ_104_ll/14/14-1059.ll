; ModuleID = 'POJ-104-source/14/14-1059.cpp'
source_filename = "POJ-104-source/14/14-1059.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_1059.cpp, i8* null }]
...
define dso_local %struct.student* @_Z5creati(i32 %0) #0 {
  ...
  %14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i32* %9, i32* %11, i32* %13)
...
40:                                               ; preds = %36, %34
  ...
  %50 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i32* %45, i32* %47, i32* %49)
...
; Function Attrs: noinline uwtable
define dso_local void @_Z3delP7studenti(%struct.student* %0, i32 %1) #0 {
  %3 = alloca %struct.student*, align 8
...
33:                                               ; preds = %14
  ...
  call void @_Z3delP7studenti(%struct.student* %34, i32 %35)
  br label %36
...
define dso_local i32 @main() #4 {
  ...
  %2 = alloca %struct.student*, align 8
  %3 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i32* %1)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_1059.cpp() #0 section ".text.startup" {
