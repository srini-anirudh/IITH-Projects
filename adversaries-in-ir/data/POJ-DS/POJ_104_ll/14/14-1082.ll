; ModuleID = 'POJ-104-source/14/14-1082.cpp'
source_filename = "POJ-104-source/14/14-1082.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_1082.cpp, i8* null }]
...
64:                                               ; preds = %51
  ...
  %76 = bitcast %struct.mark* %75 to i8*
  %77 = bitcast %struct.mark* %72 to i8*
...
106:                                              ; preds = %93
  ...
  %114 = getelementptr inbounds [100000 x %struct.mark], [100000 x %struct.mark]* @stu, i64 0, i64 %113
  %115 = load i32, i32* %6, align 4
  %116 = sext i32 %115 to i64
  %117 = getelementptr inbounds [100000 x %struct.mark], [100000 x %struct.mark]* @stu, i64 0, i64 %116
  %118 = bitcast %struct.mark* %117 to i8*
  %119 = bitcast %struct.mark* %114 to i8*
...
148:                                              ; preds = %135
  ...
  %160 = bitcast %struct.mark* %159 to i8*
  %161 = bitcast %struct.mark* %156 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_1082.cpp() #0 section ".text.startup" {
