; ModuleID = 'POJ-104-source/14/14-1133.cpp'
source_filename = "POJ-104-source/14/14-1133.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_1133.cpp, i8* null }]
...
9:                                                ; preds = %5
  ...
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i64* %13, i32* %15, i32* %17)
...
define dso_local %struct.stu* @_Z8BigthreeP3stu(%struct.stu* %0) #4 {
...
; Function Attrs: noinline uwtable
define dso_local void @_Z6outputP3stu(%struct.stu* %0) #0 {
  %2 = alloca %struct.stu*, align 8
  %3 = alloca %struct.stu*, align 8
  store %struct.stu* %0, %struct.stu** %2, align 8
...
define dso_local i32 @main() #5 {
  ...
  %5 = call %struct.stu* @_Z5creati(i32 %4)
  store %struct.stu* %5, %struct.stu** %2, align 8
  %6 = load %struct.stu*, %struct.stu** %2, align 8
  %7 = call %struct.stu* @_Z8BigthreeP3stu(%struct.stu* %6)
  store %struct.stu* %7, %struct.stu** %2, align 8
  %8 = load %struct.stu*, %struct.stu** %2, align 8
  call void @_Z6outputP3stu(%struct.stu* %8)
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_1133.cpp() #0 section ".text.startup" {
