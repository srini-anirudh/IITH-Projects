; ModuleID = 'POJ-104-source/14/14-1138.cpp'
source_filename = "POJ-104-source/14/14-1138.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_1138.cpp, i8* null }]
...
51:                                               ; preds = %28
  ...
  call void @qsort(i8* %53, i64 %54, i64 8, i32 (i8*, i8*)* @_Z4compPKvS0_)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_1138.cpp() #0 section ".text.startup" {
