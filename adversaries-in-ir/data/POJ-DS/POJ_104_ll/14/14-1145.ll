; ModuleID = 'POJ-104-source/14/14-1145.cpp'
source_filename = "POJ-104-source/14/14-1145.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_1145.cpp, i8* null }]
...
126:                                              ; preds = %122
  ...
  %133 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32* %128, i32* %130, i32* %132)
...
150:                                              ; preds = %126
  %151 = getelementptr inbounds [4 x %struct.a], [4 x %struct.a]* %10, i64 0, i64 1
  %152 = getelementptr inbounds [4 x %struct.a], [4 x %struct.a]* %10, i64 0, i64 2
  %153 = bitcast %struct.a* %152 to i8*
  %154 = bitcast %struct.a* %151 to i8*
  ...
  %156 = getelementptr inbounds [4 x %struct.a], [4 x %struct.a]* %10, i64 0, i64 1
  %157 = bitcast %struct.a* %156 to i8*
  %158 = bitcast %struct.a* %155 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %157, i8* align 16 %158, i64 16, i1 false)
  %159 = getelementptr inbounds [4 x %struct.a], [4 x %struct.a]* %10, i64 0, i64 3
  %160 = getelementptr inbounds [4 x %struct.a], [4 x %struct.a]* %10, i64 0, i64 0
  %161 = bitcast %struct.a* %160 to i8*
  %162 = bitcast %struct.a* %159 to i8*
...
171:                                              ; preds = %163
  %172 = getelementptr inbounds [4 x %struct.a], [4 x %struct.a]* %10, i64 0, i64 1
  %173 = getelementptr inbounds [4 x %struct.a], [4 x %struct.a]* %10, i64 0, i64 2
  %174 = bitcast %struct.a* %173 to i8*
  %175 = bitcast %struct.a* %172 to i8*
  ...
  %178 = bitcast %struct.a* %177 to i8*
  %179 = bitcast %struct.a* %176 to i8*
...
188:                                              ; preds = %180
  %189 = getelementptr inbounds [4 x %struct.a], [4 x %struct.a]* %10, i64 0, i64 3
  %190 = getelementptr inbounds [4 x %struct.a], [4 x %struct.a]* %10, i64 0, i64 2
  %191 = bitcast %struct.a* %190 to i8*
  %192 = bitcast %struct.a* %189 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_1145.cpp() #0 section ".text.startup" {
