; ModuleID = 'POJ-104-source/14/14-1153.cpp'
source_filename = "POJ-104-source/14/14-1153.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_1153.cpp, i8* null }]
...
17:                                               ; preds = %0
  ...
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i8* %20, i32* %22, i32* %24)
...
40:                                               ; preds = %37
  ...
  %48 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i8* %43, i32* %45, i32* %47)
  ...
  %56 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i8* %51, i32* %53, i32* %55)
...
127:                                              ; preds = %123
  ...
  %141 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i8* %132, i32* %136, i32* %140)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_1153.cpp() #0 section ".text.startup" {
