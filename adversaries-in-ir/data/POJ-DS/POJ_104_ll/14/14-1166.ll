; ModuleID = 'POJ-104-source/14/14-1166.cpp'
source_filename = "POJ-104-source/14/14-1166.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_1166.cpp, i8* null }]
...
23:                                               ; preds = %19
  ...
  %27 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32* %24, i32* %25, i32* %26)
...
40:                                               ; preds = %23
  %41 = getelementptr inbounds [4 x %struct.student], [4 x %struct.student]* %2, i64 0, i64 2
  %42 = getelementptr inbounds [4 x %struct.student], [4 x %struct.student]* %2, i64 0, i64 3
...
59:                                               ; preds = %52
  ...
  %63 = bitcast %struct.student* %60 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_1166.cpp() #0 section ".text.startup" {
