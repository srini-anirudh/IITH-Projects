; ModuleID = 'POJ-104-source/14/14-1204.cpp'
source_filename = "POJ-104-source/14/14-1204.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_1204.cpp, i8* null }]
...
68:                                               ; preds = %55
  ...
  %72 = getelementptr inbounds [100001 x %struct.student], [100001 x %struct.student]* %6, i64 0, i64 %71
  %73 = getelementptr inbounds [100001 x %struct.student], [100001 x %struct.student]* %6, i64 0, i64 100000
  ...
  %78 = getelementptr inbounds [100001 x %struct.student], [100001 x %struct.student]* %6, i64 0, i64 %77
  ...
  %84 = bitcast %struct.student* %78 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %83, i8* align 16 %84, i64 16, i1 false)
  %85 = getelementptr inbounds [100001 x %struct.student], [100001 x %struct.student]* %6, i64 0, i64 100000
  %86 = load i32, i32* %5, align 4
  %87 = sext i32 %86 to i64
  %88 = getelementptr inbounds [100001 x %struct.student], [100001 x %struct.student]* %6, i64 0, i64 %87
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_1204.cpp() #0 section ".text.startup" {
