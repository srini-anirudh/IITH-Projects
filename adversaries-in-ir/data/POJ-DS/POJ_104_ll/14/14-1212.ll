; ModuleID = 'POJ-104-source/14/14-1212.cpp'
source_filename = "POJ-104-source/14/14-1212.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_1212.cpp, i8* null }]
...
123:                                              ; preds = %94
  ...
  %151 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.2, i64 0, i64 0), i32 %128, i32 %132, i32 %137, i32 %141, i32 %146, i32 %150)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_1212.cpp() #0 section ".text.startup" {
