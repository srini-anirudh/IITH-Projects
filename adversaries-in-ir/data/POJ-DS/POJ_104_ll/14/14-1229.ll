; ModuleID = 'POJ-104-source/14/14-1229.cpp'
source_filename = "POJ-104-source/14/14-1229.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_1229.cpp, i8* null }]
...
28:                                               ; preds = %20, %16
  ...
  %36 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i8* %31, i32* %33, i32* %35)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_1229.cpp() #0 section ".text.startup" {
