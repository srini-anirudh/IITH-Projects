; ModuleID = 'POJ-104-source/14/14-124.cpp'
source_filename = "POJ-104-source/14/14-124.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_124.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %9 = call noalias i8* @malloc(i64 4000000) #3
...
215:                                              ; preds = %212
  ...
  %218 = getelementptr inbounds [1000000 x %struct.student], [1000000 x %struct.student]* @stu, i64 0, i64 %217
  %219 = getelementptr inbounds %struct.student, %struct.student* %218, i32 0, i32 0
  %220 = load i32, i32* %219, align 4
  %221 = load i32, i32* %7, align 4
  %222 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0), i32 %220, i32 %221)
  %223 = load i32, i32* %8, align 4
  %224 = add nsw i32 %223, 1
  store i32 %224, i32* %8, align 4
  br label %225

225:                                              ; preds = %215, %212, %204
  br label %226
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_124.cpp() #0 section ".text.startup" {
