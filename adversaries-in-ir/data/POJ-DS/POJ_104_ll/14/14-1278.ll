; ModuleID = 'POJ-104-source/14/14-1278.cpp'
source_filename = "POJ-104-source/14/14-1278.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_1278.cpp, i8* null }]
...
76:                                               ; preds = %66
  ...
  %103 = bitcast %struct.a* %102 to i8*
  %104 = bitcast %struct.a* %99 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_1278.cpp() #0 section ".text.startup" {
