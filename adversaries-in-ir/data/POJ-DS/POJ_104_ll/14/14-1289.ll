; ModuleID = 'POJ-104-source/14/14-1289.cpp'
source_filename = "POJ-104-source/14/14-1289.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_1289.cpp, i8* null }]
...
12:                                               ; preds = %8
  ...
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i32* %20, i32* %22, i32* %24)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_1289.cpp() #0 section ".text.startup" {
