; ModuleID = 'POJ-104-source/14/14-1290.cpp'
source_filename = "POJ-104-source/14/14-1290.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_1290.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %8 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i64* @n)
  ...
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i64 0, i64 0), i64* %12, i32* %14, i32* %16)
  ...
  %37 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i64 0, i64 0), i64* %32, i32* %34, i32* %36)
...
64:                                               ; preds = %59, %54
  ...
  %73 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i64 0, i64 0), i64* %68, i32* %70, i32* %72)
...
145:                                              ; preds = %140
  ...
  %154 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i64 0, i64 0), i64* %149, i32* %151, i32* %153)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_1290.cpp() #0 section ".text.startup" {
