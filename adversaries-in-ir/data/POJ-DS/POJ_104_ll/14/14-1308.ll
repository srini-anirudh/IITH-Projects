; ModuleID = 'POJ-104-source/14/14-1308.cpp'
source_filename = "POJ-104-source/14/14-1308.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_1308.cpp, i8* null }]
...
16:                                               ; preds = %12
  ...
  %21 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i8* %18, i32* %19, i32* %20)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_1308.cpp() #0 section ".text.startup" {
