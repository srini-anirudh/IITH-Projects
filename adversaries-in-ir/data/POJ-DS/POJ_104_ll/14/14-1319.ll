; ModuleID = 'POJ-104-source/14/14-1319.cpp'
source_filename = "POJ-104-source/14/14-1319.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_1319.cpp, i8* null }]
...
31:                                               ; preds = %26, %23
  ...
  %38 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i64 0, i64 0), i64* %33, i64* %35, i64* %37)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_1319.cpp() #0 section ".text.startup" {
