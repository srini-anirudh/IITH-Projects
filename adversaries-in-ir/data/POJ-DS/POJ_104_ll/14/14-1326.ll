; ModuleID = 'POJ-104-source/14/14-1326.cpp'
source_filename = "POJ-104-source/14/14-1326.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_1326.cpp, i8* null }]
...
14:                                               ; preds = %10
  ...
  %21 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32* %16, i32* %18, i32* %20)
...
76:                                               ; preds = %68
  ...
  %80 = getelementptr inbounds [4 x %struct.student], [4 x %struct.student]* %2, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_1326.cpp() #0 section ".text.startup" {
