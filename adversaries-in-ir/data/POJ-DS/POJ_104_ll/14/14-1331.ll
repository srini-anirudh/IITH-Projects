; ModuleID = 'POJ-104-source/14/14-1331.cpp'
source_filename = "POJ-104-source/14/14-1331.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_1331.cpp, i8* null }]
...
21:                                               ; preds = %17
  ...
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32* %22, i32* %23, i32* %24)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_1331.cpp() #0 section ".text.startup" {
