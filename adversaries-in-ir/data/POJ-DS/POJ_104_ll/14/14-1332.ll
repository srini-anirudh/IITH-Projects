; ModuleID = 'POJ-104-source/14/14-1332.cpp'
source_filename = "POJ-104-source/14/14-1332.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_1332.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local %struct.info* @_Z6createi(i32 %0) #0 {
...
20:                                               ; preds = %38, %1
  ...
  %29 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i32* %24, i32* %26, i32* %28)
...
; Function Attrs: noinline uwtable
define dso_local void @_Z7arrangeP4info(%struct.info* %0) #0 {
...
define dso_local i32 @main() #4 {
  ...
  %5 = call %struct.info* @_Z6createi(i32 %4)
  store %struct.info* %5, %struct.info** %2, align 8
  %6 = load %struct.info*, %struct.info** %2, align 8
  call void @_Z7arrangeP4info(%struct.info* %6)
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_1332.cpp() #0 section ".text.startup" {
