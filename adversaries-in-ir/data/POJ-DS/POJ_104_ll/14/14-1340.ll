; ModuleID = 'POJ-104-source/14/14-1340.cpp'
source_filename = "POJ-104-source/14/14-1340.cpp"
...
@a = dso_local global %struct.stu* null, align 8
@b = dso_local global %struct.stu* null, align 8
@c = dso_local global %struct.stu* null, align 8
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_1340.cpp, i8* null }]
...
define dso_local %struct.stu* @_Z5creatv() #0 {
  ...
  %13 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32* %8, i32* %10, i32* %12)
...
29:                                               ; preds = %25
  ...
  %42 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32* %37, i32* %39, i32* %41)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_1340.cpp() #0 section ".text.startup" {
