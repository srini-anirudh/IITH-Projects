; ModuleID = 'POJ-104-source/14/14-1342.cpp'
source_filename = "POJ-104-source/14/14-1342.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_1342.cpp, i8* null }]
...
10:                                               ; preds = %6
  ...
  %23 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32* %14, i32* %18, i32* %22)
...
46:                                               ; preds = %43
  ...
  call void @_Z3maxP7studenti(%struct.student* getelementptr inbounds ([100000 x %struct.student], [100000 x %struct.student]* @stu, i64 0, i64 0), i32 %47)
...
; Function Attrs: noinline uwtable
define dso_local void @_Z3maxP7studenti(%struct.student* %0, i32 %1) #0 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_1342.cpp() #0 section ".text.startup" {
