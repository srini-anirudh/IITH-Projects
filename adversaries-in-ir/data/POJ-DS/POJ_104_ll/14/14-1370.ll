; ModuleID = 'POJ-104-source/14/14-1370.cpp'
source_filename = "POJ-104-source/14/14-1370.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_1370.cpp, i8* null }]
...
22:                                               ; preds = %18
  ...
  %29 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32* %24, i32* %26, i32* %28)
...
46:                                               ; preds = %22
  %47 = getelementptr inbounds [5 x %struct.score], [5 x %struct.score]* %2, i64 0, i64 2
  %48 = getelementptr inbounds [5 x %struct.score], [5 x %struct.score]* %2, i64 0, i64 3
  %49 = bitcast %struct.score* %48 to i8*
  %50 = bitcast %struct.score* %47 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %49, i8* align 16 %50, i64 16, i1 false)
  %51 = getelementptr inbounds [5 x %struct.score], [5 x %struct.score]* %2, i64 0, i64 1
  %52 = getelementptr inbounds [5 x %struct.score], [5 x %struct.score]* %2, i64 0, i64 2
  %53 = bitcast %struct.score* %52 to i8*
  %54 = bitcast %struct.score* %51 to i8*
  ...
  %56 = getelementptr inbounds [5 x %struct.score], [5 x %struct.score]* %2, i64 0, i64 1
  %57 = bitcast %struct.score* %56 to i8*
  %58 = bitcast %struct.score* %55 to i8*
...
67:                                               ; preds = %59
  %68 = getelementptr inbounds [5 x %struct.score], [5 x %struct.score]* %2, i64 0, i64 2
  %69 = getelementptr inbounds [5 x %struct.score], [5 x %struct.score]* %2, i64 0, i64 3
  %70 = bitcast %struct.score* %69 to i8*
  %71 = bitcast %struct.score* %68 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %70, i8* align 16 %71, i64 16, i1 false)
  %72 = getelementptr inbounds [5 x %struct.score], [5 x %struct.score]* %2, i64 0, i64 4
  %73 = getelementptr inbounds [5 x %struct.score], [5 x %struct.score]* %2, i64 0, i64 2
  %74 = bitcast %struct.score* %73 to i8*
  %75 = bitcast %struct.score* %72 to i8*
...
84:                                               ; preds = %76
  %85 = getelementptr inbounds [5 x %struct.score], [5 x %struct.score]* %2, i64 0, i64 4
  %86 = getelementptr inbounds [5 x %struct.score], [5 x %struct.score]* %2, i64 0, i64 3
  %87 = bitcast %struct.score* %86 to i8*
  %88 = bitcast %struct.score* %85 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_1370.cpp() #0 section ".text.startup" {
