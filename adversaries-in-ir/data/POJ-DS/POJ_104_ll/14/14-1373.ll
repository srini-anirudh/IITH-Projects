; ModuleID = 'POJ-104-source/14/14-1373.cpp'
source_filename = "POJ-104-source/14/14-1373.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_1373.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i64* %3)
...
20:                                               ; preds = %15
  ...
  %33 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i64* %24, i32* %28, i32* %32)
...
82:                                               ; preds = %15
  ...
  %89 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.2, i64 0, i64 0), i32 %83, i32 %84, i32 %85, i32 %86, i32 %87, i32 %88)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_1373.cpp() #0 section ".text.startup" {
