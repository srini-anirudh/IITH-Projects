; ModuleID = 'POJ-104-source/14/14-1388.cpp'
source_filename = "POJ-104-source/14/14-1388.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_1388.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local %struct.data* @_Z5creatl(i64 %0) #0 {
  ...
  %15 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i64 0, i64 0), i64* %10, i32* %12, i32* %14)
...
40:                                               ; preds = %36, %34
  ...
  %50 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i64 0, i64 0), i64* %45, i32* %47, i32* %49)
...
define dso_local %struct.data* @_Z3maxP4data(%struct.data* %0) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local %struct.data* @_Z3delP4dataS0_(%struct.data* %0, %struct.data* %1) #4 {
  %3 = alloca %struct.data*, align 8
  %4 = alloca %struct.data*, align 8
  %5 = alloca %struct.data*, align 8
  %6 = alloca %struct.data*, align 8
...
define dso_local i32 @main() #5 {
  ...
  %6 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i64* %5)
  %7 = load i64, i64* %5, align 8
  %8 = call %struct.data* @_Z5creatl(i64 %7)
  store %struct.data* %8, %struct.data** %4, align 8
  %9 = load %struct.data*, %struct.data** %4, align 8
  %10 = call %struct.data* @_Z3maxP4data(%struct.data* %9)
  ...
  %20 = call %struct.data* @_Z3delP4dataS0_(%struct.data* %18, %struct.data* %19)
  store %struct.data* %20, %struct.data** %4, align 8
  %21 = load %struct.data*, %struct.data** %4, align 8
  %22 = call %struct.data* @_Z3maxP4data(%struct.data* %21)
  ...
  %32 = call %struct.data* @_Z3delP4dataS0_(%struct.data* %30, %struct.data* %31)
  %33 = call %struct.data* @_Z3maxP4data(%struct.data* %32)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_1388.cpp() #0 section ".text.startup" {
