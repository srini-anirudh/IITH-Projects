; ModuleID = 'POJ-104-source/14/14-1435.cpp'
source_filename = "POJ-104-source/14/14-1435.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_1435.cpp, i8* null }]
...
59:                                               ; preds = %52
  ...
  %69 = add nsw i32 %68, 1
  %70 = call i32 @_Z3maxii(i32 %67, i32 %69)
  store i32 %70, i32* %9, align 4
  %71 = load i32, i32* %8, align 4
  %72 = load i32, i32* %4, align 4
  %73 = add nsw i32 %72, 1
  %74 = call i32 @_Z3minii(i32 %71, i32 %73)
...
108:                                              ; preds = %101
  ...
  %117 = call i32 @_Z3maxii(i32 %114, i32 %116)
  store i32 %117, i32* %10, align 4
  %118 = load i32, i32* %9, align 4
  %119 = load i32, i32* %4, align 4
  %120 = add nsw i32 %119, 1
  %121 = call i32 @_Z3minii(i32 %118, i32 %120)
...
153:                                              ; preds = %146
  ...
  %161 = call i32 @_Z3minii(i32 %159, i32 %160)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_1435.cpp() #0 section ".text.startup" {
