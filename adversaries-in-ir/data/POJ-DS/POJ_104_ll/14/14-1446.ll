; ModuleID = 'POJ-104-source/14/14-1446.cpp'
source_filename = "POJ-104-source/14/14-1446.cpp"
...
@a = internal global [100010 x %struct.anon] zeroinitializer, align 16
@t = internal global %struct.anon zeroinitializer, align 4
@.str.2 = private unnamed_addr constant [7 x i8] c"%d %d\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_1446.cpp, i8* null }]
...
66:                                               ; preds = %53
  ...
  %79 = bitcast %struct.anon* %74 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_1446.cpp() #0 section ".text.startup" {
