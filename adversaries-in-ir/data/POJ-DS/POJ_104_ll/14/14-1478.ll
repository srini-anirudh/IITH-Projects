; ModuleID = 'POJ-104-source/14/14-1478.cpp'
source_filename = "POJ-104-source/14/14-1478.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_1478.cpp, i8* null }]
...
24:                                               ; preds = %20
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32* %11, i32* %12, i32* %13)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_1478.cpp() #0 section ".text.startup" {
