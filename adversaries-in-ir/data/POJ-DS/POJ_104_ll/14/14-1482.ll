; ModuleID = 'POJ-104-source/14/14-1482.cpp'
source_filename = "POJ-104-source/14/14-1482.cpp"
...
@s = dso_local global %struct.grade zeroinitializer, align 4
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [9 x i8] c"%d %d %d\00", align 1
@.str.2 = private unnamed_addr constant [7 x i8] c"%d %d\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_1482.cpp, i8* null }]
...
65:                                               ; preds = %53
  ...
  %76 = bitcast %struct.grade* %75 to i8*
  %77 = bitcast %struct.grade* %72 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_1482.cpp() #0 section ".text.startup" {
