; ModuleID = 'POJ-104-source/14/14-149.cpp'
source_filename = "POJ-104-source/14/14-149.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_149.cpp, i8* null }]
...
57:                                               ; preds = %37
  ...
  %63 = getelementptr inbounds [100000 x %struct.student], [100000 x %struct.student]* %3, i64 0, i64 %62
...
112:                                              ; preds = %92
  ...
  %119 = getelementptr inbounds [100000 x %struct.student], [100000 x %struct.student]* %3, i64 0, i64 1
...
167:                                              ; preds = %147
  ...
  %173 = getelementptr inbounds [100000 x %struct.student], [100000 x %struct.student]* %3, i64 0, i64 %172
  %174 = getelementptr inbounds [100000 x %struct.student], [100000 x %struct.student]* %3, i64 0, i64 2
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_149.cpp() #0 section ".text.startup" {
