; ModuleID = 'POJ-104-source/14/14-150.cpp'
source_filename = "POJ-104-source/14/14-150.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_150.cpp, i8* null }]
...
55:                                               ; preds = %35
  ...
  %62 = getelementptr inbounds [100000 x %struct.student], [100000 x %struct.student]* %3, i64 0, i64 0
...
110:                                              ; preds = %90
  ...
  %116 = getelementptr inbounds [100000 x %struct.student], [100000 x %struct.student]* %3, i64 0, i64 %115
  ...
  %119 = bitcast %struct.student* %116 to i8*
...
165:                                              ; preds = %145
  ...
  %171 = getelementptr inbounds [100000 x %struct.student], [100000 x %struct.student]* %3, i64 0, i64 %170
  ...
  %174 = bitcast %struct.student* %171 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_150.cpp() #0 section ".text.startup" {
