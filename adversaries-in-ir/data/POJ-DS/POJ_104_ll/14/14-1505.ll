; ModuleID = 'POJ-104-source/14/14-1505.cpp'
source_filename = "POJ-104-source/14/14-1505.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_1505.cpp, i8* null }]
...
30:                                               ; preds = %26
  ...
  %46 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32* %41, i32* %43, i32* %45)
  br label %47
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_1505.cpp() #0 section ".text.startup" {
