; ModuleID = 'POJ-104-source/14/14-1511.cpp'
source_filename = "POJ-104-source/14/14-1511.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_1511.cpp, i8* null }]
...
13:                                               ; preds = %9
  ...
  %16 = getelementptr inbounds [100000 x %struct.stu], [100000 x %struct.stu]* @stu, i64 0, i64 %15
  ...
  %26 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i64 0, i64 0), i32* %17, i32* %21, i32* %25)
  br label %27
...
79:                                               ; preds = %58
  ...
  %82 = getelementptr inbounds [100000 x %struct.stu], [100000 x %struct.stu]* @stu, i64 0, i64 %81
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_1511.cpp() #0 section ".text.startup" {
