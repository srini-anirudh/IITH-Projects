; ModuleID = 'POJ-104-source/14/14-1514.cpp'
source_filename = "POJ-104-source/14/14-1514.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_1514.cpp, i8* null }]
...
58:                                               ; preds = %55
  ...
  %59 = getelementptr inbounds [100000 x %struct.student], [100000 x %struct.student]* %2, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_1514.cpp() #0 section ".text.startup" {
