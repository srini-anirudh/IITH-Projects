; ModuleID = 'POJ-104-source/14/14-1526.cpp'
source_filename = "POJ-104-source/14/14-1526.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_1526.cpp, i8* null }]
...
define dso_local %struct.student* @_Z5creatv() #0 {
  ...
  %5 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* @student_num)
...
25:                                               ; preds = %22, %17
  ...
  %32 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32* %27, i32* %29, i32* %31)
...
define dso_local i32 @main() #4 {
  ...
  %12 = call %struct.student* @_Z5creatv()
...
14:                                               ; preds = %81, %0
  ...
  %16 = load i32, i32* @student_num, align 4
...
84:                                               ; preds = %14
  ...
  %91 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.2, i64 0, i64 0), i32 %85, i32 %86, i32 %87, i32 %88, i32 %89, i32 %90)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_1526.cpp() #0 section ".text.startup" {
