; ModuleID = 'POJ-104-source/14/14-2.cpp'
source_filename = "POJ-104-source/14/14-2.cpp"
...
@first = dso_local global [3 x i32] zeroinitializer, align 4
@firsti = dso_local global [3 x i32] zeroinitializer, align 4
@p1 = dso_local global %struct.stu* null, align 8
@p2 = dso_local global %struct.stu* null, align 8
@.str = private unnamed_addr constant [9 x i8] c"%d %d %d\00", align 1
@.str.1 = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.2 = private unnamed_addr constant [7 x i8] c"%d %d\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_2.cpp, i8* null }]
...
10:                                               ; preds = %6
  ...
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i32* %12, i32* %14, i32* %16)
...
define dso_local %struct.stu* @_Z3sumP3stui(%struct.stu* %0, i32 %1) #4 {
  %3 = alloca %struct.stu*, align 8
...
define dso_local i32 @main() #5 {
  ...
  %11 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %2)
  %12 = load i32, i32* %2, align 4
  %13 = call %struct.stu* @_Z5creati(i32 %12)
  store %struct.stu* %13, %struct.stu** %5, align 8
  %14 = load %struct.stu*, %struct.stu** %5, align 8
  %15 = load i32, i32* %2, align 4
  %16 = call %struct.stu* @_Z3sumP3stui(%struct.stu* %14, i32 %15)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_2.cpp() #0 section ".text.startup" {
