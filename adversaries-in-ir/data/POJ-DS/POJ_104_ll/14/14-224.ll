; ModuleID = 'POJ-104-source/14/14-224.cpp'
source_filename = "POJ-104-source/14/14-224.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_224.cpp, i8* null }]
...
12:                                               ; preds = %8
  ...
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32* %16, i8* %20, i8* %24)
  br label %26
...
68:                                               ; preds = %60
  ...
  %77 = getelementptr inbounds [2 x %struct.student], [2 x %struct.student]* %3, i64 0, i64 0
...
114:                                              ; preds = %104
  ...
  %123 = getelementptr inbounds [2 x %struct.student], [2 x %struct.student]* %3, i64 0, i64 1
...
170:                                              ; preds = %160
  ...
  %179 = getelementptr inbounds [2 x %struct.student], [2 x %struct.student]* %3, i64 0, i64 2
  %180 = bitcast %struct.student* %179 to i8*
  %181 = bitcast %struct.student* %178 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_224.cpp() #0 section ".text.startup" {
