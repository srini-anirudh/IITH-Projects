; ModuleID = 'POJ-104-source/14/14-226.cpp'
source_filename = "POJ-104-source/14/14-226.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_226.cpp, i8* null }]
...
146:                                              ; preds = %136
  ...
  %169 = getelementptr inbounds [2 x %struct.student], [2 x %struct.student]* %3, i64 0, i64 %168
  %170 = bitcast %struct.student* %169 to i8*
  %171 = bitcast %struct.student* %166 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_226.cpp() #0 section ".text.startup" {
