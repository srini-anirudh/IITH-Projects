; ModuleID = 'POJ-104-source/14/14-24.cpp'
source_filename = "POJ-104-source/14/14-24.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_24.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local %struct.stu* @_Z4scanv() #0 {
  ...
  %8 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i64* %1)
...
define dso_local %struct.stu* @_Z3delP3stui(%struct.stu* %0, i32 %1) #4 {
  %3 = alloca %struct.stu*, align 8
...
39:                                               ; preds = %34
  ...
  %43 = call %struct.stu* @_Z3delP3stui(%struct.stu* %41, i32 %42)
...
47:                                               ; preds = %44
  ...
  %51 = call %struct.stu* @_Z3delP3stui(%struct.stu* %49, i32 %50)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_24.cpp() #0 section ".text.startup" {
