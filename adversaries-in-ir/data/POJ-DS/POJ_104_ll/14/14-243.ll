; ModuleID = 'POJ-104-source/14/14-243.cpp'
source_filename = "POJ-104-source/14/14-243.cpp"
...
@xueshen = dso_local global %struct.xue zeroinitializer, align 4
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [7 x i8] c"%d%d%d\00", align 1
@.str.2 = private unnamed_addr constant [7 x i8] c"%d %d\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_243.cpp, i8* null }]
...
16:                                               ; preds = %12
  ...
  %32 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32* %21, i32* %26, i32* %31)
...
80:                                               ; preds = %65
  ...
  %90 = getelementptr inbounds %struct.xue, %struct.xue* %87, i64 %89
  %91 = load %struct.xue*, %struct.xue** %5, align 8
  %92 = load i32, i32* %4, align 4
  %93 = add nsw i32 %92, 1
  %94 = sext i32 %93 to i64
  %95 = getelementptr inbounds %struct.xue, %struct.xue* %91, i64 %94
  %96 = bitcast %struct.xue* %95 to i8*
  %97 = bitcast %struct.xue* %90 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_243.cpp() #0 section ".text.startup" {
