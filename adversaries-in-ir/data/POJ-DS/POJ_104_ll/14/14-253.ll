; ModuleID = 'POJ-104-source/14/14-253.cpp'
source_filename = "POJ-104-source/14/14-253.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_253.cpp, i8* null }]
...
117:                                              ; preds = %91
  ...
  %131 = bitcast %struct.student* %126 to i8*
...
174:                                              ; preds = %148
  ...
  %183 = getelementptr inbounds [100000 x %struct.student], [100000 x %struct.student]* %4, i64 0, i64 %182
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_253.cpp() #0 section ".text.startup" {
