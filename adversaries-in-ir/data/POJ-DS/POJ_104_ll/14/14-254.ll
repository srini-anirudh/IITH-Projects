; ModuleID = 'POJ-104-source/14/14-254.cpp'
source_filename = "POJ-104-source/14/14-254.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_254.cpp, i8* null }]
...
65:                                               ; preds = %54
  ...
  call void @_Z3funPiS_(i32* %68, i32* %72)
  ...
  call void @_Z3funPiS_(i32* %77, i32* %81)
  ...
  call void @_Z3funPiS_(i32* %86, i32* %90)
  ...
  call void @_Z3funPiS_(i32* %95, i32* %99)
  br label %100
...
define dso_local void @_Z3funPiS_(i32* %0, i32* %1) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_254.cpp() #0 section ".text.startup" {
