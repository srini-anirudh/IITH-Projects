; ModuleID = 'POJ-104-source/14/14-270.cpp'
source_filename = "POJ-104-source/14/14-270.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_270.cpp, i8* null }]
...
65:                                               ; preds = %61, %53
  %66 = getelementptr inbounds %struct.Student, %struct.Student* %13, i64 1
  %67 = getelementptr inbounds %struct.Student, %struct.Student* %13, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_270.cpp() #0 section ".text.startup" {
