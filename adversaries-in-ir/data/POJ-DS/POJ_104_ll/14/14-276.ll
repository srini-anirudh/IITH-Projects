; ModuleID = 'POJ-104-source/14/14-276.cpp'
source_filename = "POJ-104-source/14/14-276.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_276.cpp, i8* null }]
...
13:                                               ; preds = %9
  ...
  %32 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i8* %21, i32* %26, i32* %31)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_276.cpp() #0 section ".text.startup" {
