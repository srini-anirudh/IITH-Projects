; ModuleID = 'POJ-104-source/14/14-298.cpp'
source_filename = "POJ-104-source/14/14-298.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_298.cpp, i8* null }]
...
14:                                               ; preds = %10
  ...
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i64* %17, i64* %20, i64* %23)
  br label %25
...
49:                                               ; preds = %29
  ...
  call void @qsort(i8* %51, i64 %52, i64 8, i32 (i8*, i8*)* @_Z9pfComparePKvS0_)
  store i64 0, i64* %3, align 8
  br label %53
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_298.cpp() #0 section ".text.startup" {
