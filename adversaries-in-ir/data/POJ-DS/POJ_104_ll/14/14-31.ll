; ModuleID = 'POJ-104-source/14/14-31.cpp'
source_filename = "POJ-104-source/14/14-31.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_31.cpp, i8* null }]
...
define dso_local i32 @_Z9myComparePK6recordS1_(%struct.record* %0, %struct.record* %1) #6 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local %struct.YyxNode* @_Z6SearchP7YyxLinkPK6record(%struct.YyxLink* %0, %struct.record* %1) #6 {
  %3 = alloca %struct.YyxLink*, align 8
  %4 = alloca %struct.record*, align 8
  %5 = alloca %struct.YyxNode*, align 8
  store %struct.YyxLink* %0, %struct.YyxLink** %3, align 8
...
12:                                               ; preds = %9
  ...
  %16 = call i32 @_Z9myComparePK6recordS1_(%struct.record* %14, %struct.record* %15)
  %17 = icmp ne i32 %16, 0
  br label %18
...
define dso_local i32 @main() #7 {
  ...
  %10 = call %struct.YyxLink* @_Z13CreateNewLinkv()
  store %struct.YyxLink* %10, %struct.YyxLink** %2, align 8
  %11 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i32* %4)
...
16:                                               ; preds = %12
  ...
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.3, i64 0, i64 0), i32* %17, i16* %18, i16* %19)
  ...
  %31 = call %struct.YyxLink* @_Z7AddNodeP7YyxLinkPK6record(%struct.YyxLink* %30, %struct.record* %3)
  br label %32
...
162:                                              ; preds = %130
  ...
  %188 = call %struct.YyxLink* @_Z9ClearLinkP7YyxLink(%struct.YyxLink* %187)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_31.cpp() #0 section ".text.startup" {
