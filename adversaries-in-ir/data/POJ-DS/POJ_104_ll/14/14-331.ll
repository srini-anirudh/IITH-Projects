; ModuleID = 'POJ-104-source/14/14-331.cpp'
source_filename = "POJ-104-source/14/14-331.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_331.cpp, i8* null }]
...
32:                                               ; preds = %28
  ...
  %42 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32* %35, i32* %38, i32* %41)
...
65:                                               ; preds = %28
  ...
  call void @qsort(i8* %66, i64 %68, i64 4, i32 (i8*, i8*)* @_Z9pfComparePKvS0_)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_331.cpp() #0 section ".text.startup" {
