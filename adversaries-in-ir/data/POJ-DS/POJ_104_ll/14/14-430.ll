; ModuleID = 'POJ-104-source/14/14-430.cpp'
source_filename = "POJ-104-source/14/14-430.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_430.cpp, i8* null }]
...
17:                                               ; preds = %10
  ...
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32* %19, i32* %21, i32* %23)
...
65:                                               ; preds = %57
  ...
  %72 = bitcast %struct.stu* %69 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_430.cpp() #0 section ".text.startup" {
