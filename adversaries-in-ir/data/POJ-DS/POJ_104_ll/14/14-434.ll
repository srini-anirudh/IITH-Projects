; ModuleID = 'POJ-104-source/14/14-434.cpp'
source_filename = "POJ-104-source/14/14-434.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_434.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %13 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %9)
...
91:                                               ; preds = %90, %64
  ...
  %100 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32* %95, i32* %97, i32* %99)
  br label %30
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_434.cpp() #0 section ".text.startup" {
