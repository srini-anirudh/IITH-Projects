; ModuleID = 'POJ-104-source/14/14-438.cpp'
source_filename = "POJ-104-source/14/14-438.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_438.cpp, i8* null }]
...
21:                                               ; preds = %18
  ...
  %52 = getelementptr inbounds [4 x %struct.stu], [4 x %struct.stu]* %6, i64 0, i64 %51
  %53 = load i32, i32* %3, align 4
  %54 = sext i32 %53 to i64
  %55 = getelementptr inbounds [4 x %struct.stu], [4 x %struct.stu]* %7, i64 0, i64 %54
  %56 = bitcast %struct.stu* %55 to i8*
  %57 = bitcast %struct.stu* %52 to i8*
...
58:                                               ; preds = %18
  ...
  %65 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32* %60, i32* %62, i32* %64)
  ...
  %76 = getelementptr inbounds [4 x %struct.stu], [4 x %struct.stu]* %7, i64 0, i64 3
  %77 = bitcast %struct.stu* %76 to i8*
  %78 = bitcast %struct.stu* %75 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_438.cpp() #0 section ".text.startup" {
