; ModuleID = 'POJ-104-source/14/14-444.cpp'
source_filename = "POJ-104-source/14/14-444.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_444.cpp, i8* null }]
...
17:                                               ; preds = %13
  ...
  %30 = getelementptr inbounds [100000 x %struct.stu], [100000 x %struct.stu]* %2, i64 0, i64 %29
  ...
  %35 = getelementptr inbounds [100000 x %struct.stu], [100000 x %struct.stu]* %2, i64 0, i64 %34
...
50:                                               ; preds = %13
  %51 = getelementptr inbounds [100000 x i32], [100000 x i32]* %11, i64 0, i64 0
  %52 = load i32, i32* %51, align 16
  store i32 %52, i32* %5, align 4
  %53 = getelementptr inbounds [100000 x %struct.stu], [100000 x %struct.stu]* %2, i64 0, i64 0
...
81:                                               ; preds = %56
  ...
  %85 = getelementptr inbounds [100000 x i32], [100000 x i32]* %11, i64 0, i64 0
  %86 = load i32, i32* %85, align 16
  store i32 %86, i32* %6, align 4
  %87 = getelementptr inbounds [100000 x %struct.stu], [100000 x %struct.stu]* %2, i64 0, i64 0
...
106:                                              ; preds = %101
  ...
  %113 = getelementptr inbounds [100000 x %struct.stu], [100000 x %struct.stu]* %2, i64 0, i64 %112
  %114 = getelementptr inbounds %struct.stu, %struct.stu* %113, i32 0, i32 0
  %115 = load i32, i32* %114, align 4
  store i32 %115, i32* %9, align 4
  br label %116

116:                                              ; preds = %106, %101, %94
  br label %117
...
120:                                              ; preds = %90
  ...
  %123 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32 %121, i32 %122)
  %124 = getelementptr inbounds [100000 x i32], [100000 x i32]* %11, i64 0, i64 0
  %125 = load i32, i32* %124, align 16
  store i32 %125, i32* %7, align 4
  %126 = getelementptr inbounds [100000 x %struct.stu], [100000 x %struct.stu]* %2, i64 0, i64 0
...
150:                                              ; preds = %145
  ...
  %157 = getelementptr inbounds [100000 x %struct.stu], [100000 x %struct.stu]* %2, i64 0, i64 %156
  %158 = getelementptr inbounds %struct.stu, %struct.stu* %157, i32 0, i32 0
  %159 = load i32, i32* %158, align 4
  store i32 %159, i32* %10, align 4
  br label %160

160:                                              ; preds = %150, %145, %140, %133
  br label %161
...
164:                                              ; preds = %129
  ...
  %167 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32 %165, i32 %166)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_444.cpp() #0 section ".text.startup" {
