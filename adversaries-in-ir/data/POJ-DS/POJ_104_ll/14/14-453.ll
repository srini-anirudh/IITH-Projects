; ModuleID = 'POJ-104-source/14/14-453.cpp'
source_filename = "POJ-104-source/14/14-453.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_453.cpp, i8* null }]
...
14:                                               ; preds = %11
  ...
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32* %18, i32* %6, i32* %7)
...
36:                                               ; preds = %31
  ...
  %41 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32* %40, i32* %6, i32* %7)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_453.cpp() #0 section ".text.startup" {
