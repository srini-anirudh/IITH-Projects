; ModuleID = 'POJ-104-source/14/14-454.cpp'
source_filename = "POJ-104-source/14/14-454.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_454.cpp, i8* null }]
...
100:                                              ; preds = %96
  ...
  %107 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32* %102, i32* %104, i32* %106)
...
124:                                              ; preds = %100
  %125 = getelementptr inbounds [4 x %struct.Student], [4 x %struct.Student]* %2, i64 0, i64 1
  %126 = getelementptr inbounds [4 x %struct.Student], [4 x %struct.Student]* %2, i64 0, i64 2
  %127 = bitcast %struct.Student* %126 to i8*
  %128 = bitcast %struct.Student* %125 to i8*
  ...
  %130 = getelementptr inbounds [4 x %struct.Student], [4 x %struct.Student]* %2, i64 0, i64 1
  %131 = bitcast %struct.Student* %130 to i8*
  %132 = bitcast %struct.Student* %129 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %131, i8* align 16 %132, i64 16, i1 false)
  %133 = getelementptr inbounds [4 x %struct.Student], [4 x %struct.Student]* %2, i64 0, i64 3
  %134 = getelementptr inbounds [4 x %struct.Student], [4 x %struct.Student]* %2, i64 0, i64 0
...
162:                                              ; preds = %154
  %163 = getelementptr inbounds [4 x %struct.Student], [4 x %struct.Student]* %2, i64 0, i64 3
  %164 = getelementptr inbounds [4 x %struct.Student], [4 x %struct.Student]* %2, i64 0, i64 2
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_454.cpp() #0 section ".text.startup" {
