; ModuleID = 'POJ-104-source/14/14-484.cpp'
source_filename = "POJ-104-source/14/14-484.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_484.cpp, i8* null }]
...
16:                                               ; preds = %13
  ...
  %31 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32* %20, i32* %25, i32* %30)
...
58:                                               ; preds = %53
  ...
  %67 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32* %60, i32* %63, i32* %66)
...
134:                                              ; preds = %124
  %135 = getelementptr inbounds [5 x %struct.Stu], [5 x %struct.Stu]* %2, i64 0, i64 3
  %136 = load i32, i32* %7, align 4
  %137 = sext i32 %136 to i64
  %138 = getelementptr inbounds [5 x %struct.Stu], [5 x %struct.Stu]* %2, i64 0, i64 %137
  %139 = bitcast %struct.Stu* %138 to i8*
  %140 = bitcast %struct.Stu* %135 to i8*
...
168:                                              ; preds = %156
  ...
  %180 = bitcast %struct.Stu* %179 to i8*
  %181 = bitcast %struct.Stu* %176 to i8*
...
217:                                              ; preds = %205
  ...
  %230 = bitcast %struct.Stu* %225 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_484.cpp() #0 section ".text.startup" {
