; ModuleID = 'POJ-104-source/14/14-508.cpp'
source_filename = "POJ-104-source/14/14-508.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_508.cpp, i8* null }]
...
define dso_local void @_Z6bubbleP7Studenti(%struct.Student* %0, i32 %1) #4 {
...
49:                                               ; preds = %45
  ...
  %56 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32* %51, i32* %53, i32* %55)
  ...
  call void @_Z6bubbleP7Studenti(%struct.Student* %66, i32 4)
  br label %67
...
76:                                               ; preds = %72
  ...
  %89 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32* %80, i32* %84, i32* %88)
...
114:                                              ; preds = %72
  ...
  call void @_Z6bubbleP7Studenti(%struct.Student* %115, i32 %116)
  br label %117
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_508.cpp() #0 section ".text.startup" {
