; ModuleID = 'POJ-104-source/14/14-521.cpp'
source_filename = "POJ-104-source/14/14-521.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_521.cpp, i8* null }]
...
50:                                               ; preds = %20
  ...
  %61 = getelementptr inbounds %struct.student, %struct.student* %57, i64 %60
  ...
  %67 = bitcast %struct.student* %61 to i8*
...
27:                                               ; preds = %6
  ...
  call void @_Z6bubbleP7studenti(%struct.student* getelementptr inbounds ([100000 x %struct.student], [100000 x %struct.student]* @stu, i64 0, i64 0), i32 %28)
...
32:                                               ; preds = %29
  ...
  %50 = select i1 %48, i8 0, i8 10
  %51 = sext i8 %50 to i32
  %52 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.2, i64 0, i64 0), i32 %35, i32 %42, i32 %51)
  br label %53
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_521.cpp() #0 section ".text.startup" {
