; ModuleID = 'POJ-104-source/14/14-522.cpp'
source_filename = "POJ-104-source/14/14-522.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_522.cpp, i8* null }]
...
97:                                               ; preds = %45
  ...
  %113 = getelementptr inbounds [100000 x %struct.student], [100000 x %struct.student]* %2, i64 0, i64 2
  %114 = getelementptr inbounds %struct.student, %struct.student* %113, i32 0, i32 3
  %115 = load i32, i32* %114, align 4
  %116 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.2, i64 0, i64 0), i32 %100, i32 %103, i32 %106, i32 %109, i32 %112, i32 %115)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_522.cpp() #0 section ".text.startup" {
