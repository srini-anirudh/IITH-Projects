; ModuleID = 'POJ-104-source/14/14-640.cpp'
source_filename = "POJ-104-source/14/14-640.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_640.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %28 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i64 0, i64 0), i64* %19, i32* %23, i32* %27)
...
95:                                               ; preds = %48
  %96 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0))
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_640.cpp() #0 section ".text.startup" {
