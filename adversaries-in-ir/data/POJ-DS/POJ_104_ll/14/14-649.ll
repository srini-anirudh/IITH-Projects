; ModuleID = 'POJ-104-source/14/14-649.cpp'
source_filename = "POJ-104-source/14/14-649.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_649.cpp, i8* null }]
...
38:                                               ; preds = %34
  ...
  %51 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32* %42, i32* %46, i32* %50)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_649.cpp() #0 section ".text.startup" {
