; ModuleID = 'POJ-104-source/14/14-658.cpp'
source_filename = "POJ-104-source/14/14-658.cpp"
...
@tmp = dso_local global %struct.inf zeroinitializer, align 4
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [7 x i8] c"%d%d%d\00", align 1
@.str.2 = private unnamed_addr constant [7 x i8] c"%d %d\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_658.cpp, i8* null }]
...
14:                                               ; preds = %10
  ...
  %35 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32* %24, i32* %29, i32* %34)
...
93:                                               ; preds = %70
  ...
  %104 = bitcast %struct.inf* %103 to i8*
  %105 = bitcast %struct.inf* %100 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_658.cpp() #0 section ".text.startup" {
