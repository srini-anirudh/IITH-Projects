; ModuleID = 'POJ-104-source/14/14-678.cpp'
source_filename = "POJ-104-source/14/14-678.cpp"
...
@b = dso_local global %struct.stu zeroinitializer, align 8
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [7 x i8] c"%d%d%d\00", align 1
@.str.2 = private unnamed_addr constant [7 x i8] c"%d %d\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_678.cpp, i8* null }]
...
define dso_local i32 @main() #5 {
  ...
  %4 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i64* @n)
...
10:                                               ; preds = %5
  ...
  %23 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i64* %14, i64* %18, i64* %22)
...
42:                                               ; preds = %5
  ...
  call void @qsort(i8* bitcast ([100000 x %struct.stu]* @a to i8*), i64 %43, i64 32, i32 (i8*, i8*)* @_Z4compPKvS0_)
  store i32 0, i32* %2, align 4
  br label %44
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_678.cpp() #0 section ".text.startup" {
