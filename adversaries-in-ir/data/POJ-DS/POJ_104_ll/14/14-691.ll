; ModuleID = 'POJ-104-source/14/14-691.cpp'
source_filename = "POJ-104-source/14/14-691.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_691.cpp, i8* null }]
...
11:                                               ; preds = %7
  ...
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32* %15, i32* %4, i32* %5)
...
27:                                               ; preds = %7
  ...
  call void @qsort(i8* bitcast ([100000 x %struct.st]* @s to i8*), i64 %29, i64 8, i32 (i8*, i8*)* @_Z4compPKvS0_)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_691.cpp() #0 section ".text.startup" {
