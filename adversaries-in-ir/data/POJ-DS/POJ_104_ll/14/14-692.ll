; ModuleID = 'POJ-104-source/14/14-692.cpp'
source_filename = "POJ-104-source/14/14-692.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_692.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %8 = getelementptr inbounds %struct.Student, %struct.Student* %5, i32 0, i32 3
...
16:                                               ; preds = %12
  ...
  %19 = getelementptr inbounds %struct.Student, %struct.Student* %2, i32 0, i32 2
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32* %17, i32* %18, i32* %19)
  %21 = getelementptr inbounds %struct.Student, %struct.Student* %2, i32 0, i32 1
  %22 = load i32, i32* %21, align 4
  %23 = getelementptr inbounds %struct.Student, %struct.Student* %2, i32 0, i32 2
  %24 = load i32, i32* %23, align 4
  %25 = add nsw i32 %22, %24
  %26 = getelementptr inbounds %struct.Student, %struct.Student* %2, i32 0, i32 3
  store i32 %25, i32* %26, align 4
  %27 = getelementptr inbounds %struct.Student, %struct.Student* %2, i32 0, i32 3
...
39:                                               ; preds = %16
  ...
  %42 = getelementptr inbounds %struct.Student, %struct.Student* %4, i32 0, i32 3
...
45:                                               ; preds = %39
  ...
  %48 = bitcast %struct.Student* %4 to i8*
  %49 = bitcast %struct.Student* %2 to i8*
...
50:                                               ; preds = %39
  ...
  %53 = getelementptr inbounds %struct.Student, %struct.Student* %5, i32 0, i32 3
  %54 = load i32, i32* %53, align 4
  %55 = icmp sgt i32 %52, %54
  br i1 %55, label %56, label %59

56:                                               ; preds = %50
  %57 = bitcast %struct.Student* %5 to i8*
...
65:                                               ; preds = %12
  %66 = getelementptr inbounds %struct.Student, %struct.Student* %3, i32 0, i32 0
  %67 = load i32, i32* %66, align 4
  %68 = getelementptr inbounds %struct.Student, %struct.Student* %3, i32 0, i32 3
  %69 = load i32, i32* %68, align 4
  %70 = getelementptr inbounds %struct.Student, %struct.Student* %4, i32 0, i32 0
  %71 = load i32, i32* %70, align 4
  %72 = getelementptr inbounds %struct.Student, %struct.Student* %4, i32 0, i32 3
  %73 = load i32, i32* %72, align 4
  %74 = getelementptr inbounds %struct.Student, %struct.Student* %5, i32 0, i32 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_692.cpp() #0 section ".text.startup" {
