; ModuleID = 'POJ-104-source/14/14-718.cpp'
source_filename = "POJ-104-source/14/14-718.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_718.cpp, i8* null }]
...
17:                                               ; preds = %13
  ...
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i8* %19, i32* %20, i32* %21)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_718.cpp() #0 section ".text.startup" {
