; ModuleID = 'POJ-104-source/14/14-73.cpp'
source_filename = "POJ-104-source/14/14-73.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_73.cpp, i8* null }]
...
59:                                               ; preds = %49
  ...
  %63 = getelementptr inbounds [3 x %struct.student], [3 x %struct.student]* %3, i64 0, i64 1
  %64 = bitcast %struct.student* %63 to i8*
  %65 = bitcast %struct.student* %62 to i8*
...
105:                                              ; preds = %95
  ...
  %109 = getelementptr inbounds [3 x %struct.student], [3 x %struct.student]* %3, i64 0, i64 2
  %110 = bitcast %struct.student* %109 to i8*
  %111 = bitcast %struct.student* %108 to i8*
...
161:                                              ; preds = %151
  ...
  %165 = getelementptr inbounds [3 x %struct.student], [3 x %struct.student]* %3, i64 0, i64 3
  %166 = bitcast %struct.student* %165 to i8*
  %167 = bitcast %struct.student* %164 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_73.cpp() #0 section ".text.startup" {
