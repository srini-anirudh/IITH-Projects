; ModuleID = 'POJ-104-source/14/14-775.cpp'
source_filename = "POJ-104-source/14/14-775.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_775.cpp, i8* null }]
...
79:                                               ; preds = %28
  ...
  %105 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32* %100, i32* %102, i32* %104)
...
113:                                              ; preds = %109
  ...
  %126 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32* %117, i32* %121, i32* %125)
...
160:                                              ; preds = %109
  ...
  %186 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32* %181, i32* %183, i32* %185)
...
194:                                              ; preds = %190
  ...
  %207 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32* %198, i32* %202, i32* %206)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_775.cpp() #0 section ".text.startup" {
