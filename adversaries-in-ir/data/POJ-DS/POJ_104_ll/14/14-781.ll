; ModuleID = 'POJ-104-source/14/14-781.cpp'
source_filename = "POJ-104-source/14/14-781.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_781.cpp, i8* null }]
...
21:                                               ; preds = %17
  ...
  %37 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32* %26, i32* %31, i32* %36)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_781.cpp() #0 section ".text.startup" {
