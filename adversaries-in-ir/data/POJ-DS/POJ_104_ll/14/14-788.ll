; ModuleID = 'POJ-104-source/14/14-788.cpp'
source_filename = "POJ-104-source/14/14-788.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_788.cpp, i8* null }]
...
define dso_local i32 @main(i32 %0, i8** %1) #4 {
  ...
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i64* %7)
...
22:                                               ; preds = %17
  ...
  %35 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32* %26, i32* %30, i32* %34)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_788.cpp() #0 section ".text.startup" {
