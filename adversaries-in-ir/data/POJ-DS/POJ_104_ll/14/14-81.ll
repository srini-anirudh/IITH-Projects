; ModuleID = 'POJ-104-source/14/14-81.cpp'
source_filename = "POJ-104-source/14/14-81.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_81.cpp, i8* null }]
...
136:                                              ; preds = %133
  ...
  %147 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32 %141, i32 %146)
  br label %148
...
151:                                              ; preds = %133
  %152 = load i32, i32* getelementptr inbounds ([100000 x %struct.student], [100000 x %struct.student]* @stu, i64 0, i64 2, i32 0), align 16
  %153 = load i32, i32* getelementptr inbounds ([100000 x %struct.student], [100000 x %struct.student]* @stu, i64 0, i64 2, i32 3), align 4
  %154 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), i32 %152, i32 %153)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_81.cpp() #0 section ".text.startup" {
