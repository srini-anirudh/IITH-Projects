; ModuleID = 'POJ-104-source/14/14-823.cpp'
source_filename = "POJ-104-source/14/14-823.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_823.cpp, i8* null }]
...
define dso_local %struct.student* @_Z5creati(i32 %0) #0 {
  ...
  %14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32* %9, i32* %11, i32* %13)
...
30:                                               ; preds = %26, %24
  ...
  %40 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32* %35, i32* %37, i32* %39)
  br label %15
...
define dso_local %struct.student* @_Z3delP7studenti(%struct.student* %0, i32 %1) #4 {
  %3 = alloca %struct.student*, align 8
...
define dso_local i32 @main() #5 {
  ...
  store i32 0, i32* %2, align 4
  %8 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %3)
  %9 = load i32, i32* %3, align 4
  %10 = call %struct.student* @_Z5creati(i32 %9)
...
45:                                               ; preds = %17
  ...
  %61 = call %struct.student* @_Z3delP7studenti(%struct.student* %57, i32 %60)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_823.cpp() #0 section ".text.startup" {
