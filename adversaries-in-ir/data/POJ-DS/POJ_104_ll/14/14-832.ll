; ModuleID = 'POJ-104-source/14/14-832.cpp'
source_filename = "POJ-104-source/14/14-832.cpp"
...
@s3 = dso_local global %struct.s zeroinitializer, align 4
@A = dso_local global %struct.s zeroinitializer, align 4
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [9 x i8] c"%d %d %d\00", align 1
@.str.2 = private unnamed_addr constant [7 x i8] c"%d %d\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_832.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_832.cpp() #0 section ".text.startup" {
