; ModuleID = 'POJ-104-source/14/14-86.cpp'
source_filename = "POJ-104-source/14/14-86.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_86.cpp, i8* null }]
...
83:                                               ; preds = %76
  ...
  %86 = getelementptr inbounds [100000 x %struct.stu], [100000 x %struct.stu]* @stu, i64 0, i64 %85
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_86.cpp() #0 section ".text.startup" {
