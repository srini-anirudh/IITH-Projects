; ModuleID = 'POJ-104-source/14/14-89.cpp'
source_filename = "POJ-104-source/14/14-89.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_89.cpp, i8* null }]
...
168:                                              ; preds = %165
  ...
  %175 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0), i32 %173, i32 %174)
  %176 = load i32, i32* %9, align 4
  %177 = add nsw i32 %176, 1
  store i32 %177, i32* %9, align 4
  br label %178

178:                                              ; preds = %168, %165, %150
  br label %179
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_89.cpp() #0 section ".text.startup" {
