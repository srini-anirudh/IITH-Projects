; ModuleID = 'POJ-104-source/14/14-935.cpp'
source_filename = "POJ-104-source/14/14-935.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_935.cpp, i8* null }]
...
69:                                               ; preds = %56
  ...
  %78 = getelementptr inbounds [100000 x %struct.student], [100000 x %struct.student]* %3, i64 0, i64 %77
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_935.cpp() #0 section ".text.startup" {
