; ModuleID = 'POJ-104-source/14/14-992.cpp'
source_filename = "POJ-104-source/14/14-992.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_14_992.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local %struct.stud* @_Z5creatv() #0 {
...
12:                                               ; preds = %8
  ...
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32* %14, i32* %16, i32* %18)
...
38:                                               ; preds = %8
  ...
  %45 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32* %40, i32* %42, i32* %44)
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z3maxP4studii(%struct.stud* %0, i32 %1, i32 %2) #0 {
...
define dso_local i32 @main() #4 {
  ...
  %4 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i32* @tol)
  %5 = call %struct.stud* @_Z5creatv()
  store %struct.stud* %5, %struct.stud** %1, align 8
  %6 = load %struct.stud*, %struct.stud** %1, align 8
  %7 = call i32 @_Z3maxP4studii(%struct.stud* %6, i32 0, i32 0)
  store i32 %7, i32* %2, align 4
  %8 = load %struct.stud*, %struct.stud** %1, align 8
  %9 = load i32, i32* %2, align 4
  %10 = call i32 @_Z3maxP4studii(%struct.stud* %8, i32 %9, i32 0)
  store i32 %10, i32* %3, align 4
  %11 = load %struct.stud*, %struct.stud** %1, align 8
  %12 = load i32, i32* %2, align 4
  %13 = load i32, i32* %3, align 4
  %14 = call i32 @_Z3maxP4studii(%struct.stud* %11, i32 %12, i32 %13)
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_14_992.cpp() #0 section ".text.startup" {
