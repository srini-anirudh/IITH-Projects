; ModuleID = 'POJ-104-source/15/15-2045.cpp'
source_filename = "POJ-104-source/15/15-2045.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_15_2045.cpp, i8* null }]
...
141:                                              ; preds = %131
  ...
  %144 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %14, i64 0, i64 %143
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_15_2045.cpp() #0 section ".text.startup" {
