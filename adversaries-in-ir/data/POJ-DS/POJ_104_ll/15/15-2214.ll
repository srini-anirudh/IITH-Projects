; ModuleID = 'POJ-104-source/15/15-2214.cpp'
source_filename = "POJ-104-source/15/15-2214.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_15_2214.cpp, i8* null }]
...
47:                                               ; preds = %43
  ...
  %50 = getelementptr inbounds [500 x [500 x i32]], [500 x [500 x i32]]* %6, i64 0, i64 %49
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_15_2214.cpp() #0 section ".text.startup" {
