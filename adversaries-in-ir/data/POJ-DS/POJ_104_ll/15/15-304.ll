; ModuleID = 'POJ-104-source/15/15-304.cpp'
source_filename = "POJ-104-source/15/15-304.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_15_304.cpp, i8* null }]
...
71:                                               ; preds = %68
  ...
  %74 = getelementptr inbounds [500 x [500 x i32]], [500 x [500 x i32]]* %10, i64 0, i64 %73
...
130:                                              ; preds = %123
  ...
  %133 = getelementptr inbounds [500 x [500 x i32]], [500 x [500 x i32]]* %10, i64 0, i64 %132
...
142:                                              ; preds = %130
  ...
  %145 = getelementptr inbounds [500 x [500 x i32]], [500 x [500 x i32]]* %10, i64 0, i64 %144
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_15_304.cpp() #0 section ".text.startup" {
