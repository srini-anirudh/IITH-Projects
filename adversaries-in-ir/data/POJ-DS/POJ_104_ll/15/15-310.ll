; ModuleID = 'POJ-104-source/15/15-310.cpp'
source_filename = "POJ-104-source/15/15-310.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_15_310.cpp, i8* null }]
...
48:                                               ; preds = %43
  ...
  %56 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i32* %55)
  br label %57
...
60:                                               ; preds = %43
  ...
  %69 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i32* %68)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_15_310.cpp() #0 section ".text.startup" {
