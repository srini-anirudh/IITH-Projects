; ModuleID = 'POJ-104-source/15/15-362.cpp'
source_filename = "POJ-104-source/15/15-362.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_15_362.cpp, i8* null }]
...
55:                                               ; preds = %46
  ...
  %62 = getelementptr inbounds [30 x i32], [30 x i32]* %58, i64 0, i64 %61
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_15_362.cpp() #0 section ".text.startup" {
