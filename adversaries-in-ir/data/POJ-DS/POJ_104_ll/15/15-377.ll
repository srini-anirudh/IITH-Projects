; ModuleID = 'POJ-104-source/15/15-377.cpp'
source_filename = "POJ-104-source/15/15-377.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_15_377.cpp, i8* null }]
...
61:                                               ; preds = %54
  ...
  %63 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %62)
...
91:                                               ; preds = %84
  ...
  %93 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %92)
  br label %94
...
109:                                              ; preds = %102
  ...
  %111 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %110)
  br label %112
...
143:                                              ; preds = %134
  ...
  %145 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %144)
  br label %146
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_15_377.cpp() #0 section ".text.startup" {
