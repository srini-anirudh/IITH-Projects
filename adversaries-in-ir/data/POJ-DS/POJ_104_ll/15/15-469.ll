; ModuleID = 'POJ-104-source/15/15-469.cpp'
source_filename = "POJ-104-source/15/15-469.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_15_469.cpp, i8* null }]
...
36:                                               ; preds = %21
  %37 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0))
  br label %38
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_15_469.cpp() #0 section ".text.startup" {
