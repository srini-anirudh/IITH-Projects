; ModuleID = 'POJ-104-source/15/15-470.cpp'
source_filename = "POJ-104-source/15/15-470.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_15_470.cpp, i8* null }]
...
124:                                              ; preds = %121, %111, %101, %92, %89, %86
  br label %125
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_15_470.cpp() #0 section ".text.startup" {
