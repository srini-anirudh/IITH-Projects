; ModuleID = 'POJ-104-source/15/15-608.cpp'
source_filename = "POJ-104-source/15/15-608.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_15_608.cpp, i8* null }]
...
102:                                              ; preds = %98
  ...
  %105 = getelementptr inbounds [1000 x [1000 x i32]], [1000 x [1000 x i32]]* %9, i64 0, i64 %104
...
111:                                              ; preds = %102
  ...
  %115 = getelementptr inbounds [1000 x [1000 x i32]], [1000 x [1000 x i32]]* %9, i64 0, i64 %114
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_15_608.cpp() #0 section ".text.startup" {
