; ModuleID = 'POJ-104-source/15/15-671.cpp'
source_filename = "POJ-104-source/15/15-671.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_15_671.cpp, i8* null }]
...
21:                                               ; preds = %17
  ...
  %24 = getelementptr inbounds [1000 x [1000 x i32]], [1000 x [1000 x i32]]* @cancer, i64 0, i64 %23
...
46:                                               ; preds = %42
  ...
  %49 = getelementptr inbounds [1000 x [1000 x i32]], [1000 x [1000 x i32]]* @cancer, i64 0, i64 %48
...
82:                                               ; preds = %79
  ...
  %85 = getelementptr inbounds [1000 x [1000 x i32]], [1000 x [1000 x i32]]* @cancer, i64 0, i64 %84
...
118:                                              ; preds = %114
  ...
  %121 = getelementptr inbounds [1000 x [1000 x i32]], [1000 x [1000 x i32]]* @cancer, i64 0, i64 %120
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_15_671.cpp() #0 section ".text.startup" {
