; ModuleID = 'POJ-104-source/15/15-919.cpp'
source_filename = "POJ-104-source/15/15-919.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_15_919.cpp, i8* null }]
...
46:                                               ; preds = %42
  ...
  %49 = getelementptr inbounds [1000 x [1000 x i32]], [1000 x [1000 x i32]]* @xiangsu, i64 0, i64 %48
...
63:                                               ; preds = %58, %55, %46
  ...
  %66 = getelementptr inbounds [1000 x [1000 x i32]], [1000 x [1000 x i32]]* @xiangsu, i64 0, i64 %65
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_15_919.cpp() #0 section ".text.startup" {
