; ModuleID = 'POJ-104-source/16/16-1031.cpp'
source_filename = "POJ-104-source/16/16-1031.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_16_1031.cpp, i8* null }]
...
define dso_local i32 @_Z13MyInverseitoaiPci(i32 %0, i8* %1, i32 %2) #4 {
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z6MyatoiPci(i8* %0, i32 %1) #0 {
  %3 = alloca i8*, align 8
  %4 = alloca i32, align 4
...
13:                                               ; preds = %0
  ...
  %16 = call i32 @_Z13MyInverseitoaiPci(i32 %14, i8* %15, i32 10)
  store i32 %16, i32* %4, align 4
  %17 = getelementptr inbounds [12 x i8], [12 x i8]* %5, i64 0, i64 0
  %18 = load i32, i32* %4, align 4
  %19 = call i32 @_Z6MyatoiPci(i8* %17, i32 %18)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_16_1031.cpp() #0 section ".text.startup" {
