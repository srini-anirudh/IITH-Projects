; ModuleID = 'POJ-104-source/16/16-1204.cpp'
source_filename = "POJ-104-source/16/16-1204.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_16_1204.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_16_1204.cpp() #0 section ".text.startup" {
