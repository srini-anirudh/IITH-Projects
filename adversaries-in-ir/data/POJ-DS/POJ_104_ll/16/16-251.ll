; ModuleID = 'POJ-104-source/16/16-251.cpp'
source_filename = "POJ-104-source/16/16-251.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_16_251.cpp, i8* null }]
...
17:                                               ; preds = %13
  ...
  %35 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i64 0, i64 0), i32 %31, i32 %32, i32 %33, i32 %34)
  br label %72
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_16_251.cpp() #0 section ".text.startup" {
