; ModuleID = 'POJ-104-source/16/16-3.cpp'
source_filename = "POJ-104-source/16/16-3.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_16_3.cpp, i8* null }]
...
12:                                               ; preds = %2
  ...
  %17 = sub nsw i32 %16, 1
  call void @_Z1fii(i32 %15, i32 %17)
  br label %18
...
define dso_local i32 @main() #5 {
  ...
  %5 = call double @_ZSt3logIiEN9__gnu_cxx11__enable_ifIXsr12__is_integerIT_EE7__valueEdE6__typeES2_(i32 %4)
  %6 = call double @_ZSt3logIiEN9__gnu_cxx11__enable_ifIXsr12__is_integerIT_EE7__valueEdE6__typeES2_(i32 10)
  %7 = fdiv double %5, %6
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_16_3.cpp() #0 section ".text.startup" {
