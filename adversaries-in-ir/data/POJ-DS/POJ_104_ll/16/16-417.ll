; ModuleID = 'POJ-104-source/16/16-417.cpp'
source_filename = "POJ-104-source/16/16-417.cpp"
...
@digit = dso_local global [5 x i64] zeroinitializer, align 16
@.str = private unnamed_addr constant [4 x i8] c"%ld\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_16_417.cpp, i8* null }]
...
5:                                                ; preds = %13, %0
  %6 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i64* @num)
  br label %7
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_16_417.cpp() #0 section ".text.startup" {
