; ModuleID = 'POJ-104-source/16/16-43.cpp'
source_filename = "POJ-104-source/16/16-43.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_16_43.cpp, i8* null }]
...
56:                                               ; preds = %52
  ...
  %67 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i64 0, i64 0), i32 %58, i32 %60, i32 %62, i32 %64, i32 %66)
  br label %78
...
68:                                               ; preds = %52, %46
  ...
  %77 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32 %70, i32 %72, i32 %74, i32 %76)
  br label %78
...
88:                                               ; preds = %32, %26
  ...
  %93 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0), i32 %90, i32 %92)
  br label %94
...
100:                                              ; preds = %12, %0
  %101 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.5, i64 0, i64 0))
  br label %102
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_16_43.cpp() #0 section ".text.startup" {
