; ModuleID = 'POJ-104-source/16/16-9.cpp'
source_filename = "POJ-104-source/16/16-9.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_16_9.cpp, i8* null }]
...
27:                                               ; preds = %23
  ...
  %30 = getelementptr inbounds [5 x i32], [5 x i32]* %5, i64 0, i64 3
  ...
  %38 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i64 0, i64 0), i32 %29, i32 %31, i32 %33, i32 %35, i32 %37)
  br label %82
...
43:                                               ; preds = %39
  ...
  %52 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i64 0, i64 0), i32 %45, i32 %47, i32 %49, i32 %51)
  br label %81
...
57:                                               ; preds = %53
  ...
  %64 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i64 0, i64 0), i32 %59, i32 %61, i32 %63)
  br label %80
...
69:                                               ; preds = %65
  ...
  %72 = getelementptr inbounds [5 x i32], [5 x i32]* %5, i64 0, i64 3
  %73 = load i32, i32* %72, align 4
  %74 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.4, i64 0, i64 0), i32 %71, i32 %73)
  br label %79

75:                                               ; preds = %65
  %76 = getelementptr inbounds [5 x i32], [5 x i32]* %5, i64 0, i64 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_16_9.cpp() #0 section ".text.startup" {
