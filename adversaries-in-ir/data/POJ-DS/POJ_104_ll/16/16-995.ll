; ModuleID = 'POJ-104-source/16/16-995.cpp'
source_filename = "POJ-104-source/16/16-995.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_16_995.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @llvm.memset.p0i8.i64(i8* align 1 %5, i8 32, i64 5, i1 false)
...
81:                                               ; preds = %74, %67, %60, %53, %46, %39, %32, %25, %18, %11
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_16_995.cpp() #0 section ".text.startup" {
