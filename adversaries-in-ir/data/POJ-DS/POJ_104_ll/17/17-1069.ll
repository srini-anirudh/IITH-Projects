; ModuleID = 'POJ-104-source/17/17-1069.cpp'
source_filename = "POJ-104-source/17/17-1069.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_17_1069.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  call void @_Z6coursePci(i8* %21, i32 %22)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_17_1069.cpp() #0 section ".text.startup" {
