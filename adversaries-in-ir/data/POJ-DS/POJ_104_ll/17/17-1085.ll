; ModuleID = 'POJ-104-source/17/17-1085.cpp'
source_filename = "POJ-104-source/17/17-1085.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_17_1085.cpp, i8* null }]
...
83:                                               ; preds = %76
  ...
  %86 = getelementptr inbounds [200 x i8], [200 x i8]* %6, i64 0, i64 %85
...
107:                                              ; preds = %72
  %108 = getelementptr inbounds [200 x i8], [200 x i8]* %7, i64 0, i64 0
  %109 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i8* %108)
  %110 = getelementptr inbounds [200 x i8], [200 x i8]* %6, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_17_1085.cpp() #0 section ".text.startup" {
