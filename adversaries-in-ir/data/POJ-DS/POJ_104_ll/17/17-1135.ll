; ModuleID = 'POJ-104-source/17/17-1135.cpp'
source_filename = "POJ-104-source/17/17-1135.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_17_1135.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @llvm.memset.p0i8.i64(i8* align 16 %10, i8 2, i64 1000, i1 false)
  br label %11
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_17_1135.cpp() #0 section ".text.startup" {
