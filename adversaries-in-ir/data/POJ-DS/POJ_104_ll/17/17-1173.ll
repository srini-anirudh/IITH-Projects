; ModuleID = 'POJ-104-source/17/17-1173.cpp'
source_filename = "POJ-104-source/17/17-1173.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_17_1173.cpp, i8* null }]
...
31:                                               ; preds = %18
  ...
  %33 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i8* %32)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_17_1173.cpp() #0 section ".text.startup" {
