; ModuleID = 'POJ-104-source/17/17-1250.cpp'
source_filename = "POJ-104-source/17/17-1250.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_17_1250.cpp, i8* null }]
...
113:                                              ; preds = %104
  %114 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.5, i64 0, i64 0))
  br label %115
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_17_1250.cpp() #0 section ".text.startup" {
