; ModuleID = 'POJ-104-source/17/17-1271.cpp'
source_filename = "POJ-104-source/17/17-1271.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_17_1271.cpp, i8* null }]
...
define dso_local i32 @_Z4zuokPcii(i8* %0, i32 %1, i32 %2) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z4youkPcii(i8* %0, i32 %1, i32 %2) #4 {
  %4 = alloca i32, align 4
  %5 = alloca i8*, align 8
  %6 = alloca i32, align 4
  %7 = alloca i32, align 4
...
34:                                               ; preds = %27
  ...
  %38 = call i32 @_Z4zuokPcii(i8* %35, i32 %36, i32 %37)
  %39 = icmp ne i32 %38, 0
...
52:                                               ; preds = %45
  ...
  %56 = call i32 @_Z4youkPcii(i8* %53, i32 %54, i32 %55)
  %57 = icmp ne i32 %56, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_17_1271.cpp() #0 section ".text.startup" {
