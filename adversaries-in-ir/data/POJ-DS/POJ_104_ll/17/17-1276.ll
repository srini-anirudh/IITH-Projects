; ModuleID = 'POJ-104-source/17/17-1276.cpp'
source_filename = "POJ-104-source/17/17-1276.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_17_1276.cpp, i8* null }]
...
13:                                               ; preds = %110, %2
  %14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), [110 x i8]* %6)
  %15 = icmp eq i32 %14, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_17_1276.cpp() #0 section ".text.startup" {
