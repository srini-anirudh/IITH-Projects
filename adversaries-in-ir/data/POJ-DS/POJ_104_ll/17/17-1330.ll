; ModuleID = 'POJ-104-source/17/17-1330.cpp'
source_filename = "POJ-104-source/17/17-1330.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_17_1330.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z2DOPci(i8* %0, i32 %1) #0 {
...
44:                                               ; preds = %37
  ...
  %49 = call i32 @_Z2DOPci(i8* %47, i32 %48)
...
66:                                               ; preds = %16
  ...
  %69 = call i32 @_Z2DOPci(i8* %67, i32 %68)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_17_1330.cpp() #0 section ".text.startup" {
