; ModuleID = 'POJ-104-source/17/17-1379.cpp'
source_filename = "POJ-104-source/17/17-1379.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_17_1379.cpp, i8* null }]
...
define dso_local i32 @_Z4ghusPc(i8* %0) #5 {
  %2 = alloca i8*, align 8
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
...
38:                                               ; preds = %6
  ...
  %41 = call i32 @_Z3minii(i32 %39, i32 %40)
  ret i32 %41
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z6noghusPc(i8* %0) #5 {
  %2 = alloca i8*, align 8
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  store i8* %0, i8** %2, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_17_1379.cpp() #0 section ".text.startup" {
