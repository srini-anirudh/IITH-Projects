; ModuleID = 'POJ-104-source/17/17-1440.cpp'
source_filename = "POJ-104-source/17/17-1440.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_17_1440.cpp, i8* null }]
...
12:                                               ; preds = %139, %2
  %13 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), [100 x i8]* %6)
  %14 = icmp ne i32 %13, -1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_17_1440.cpp() #0 section ".text.startup" {
