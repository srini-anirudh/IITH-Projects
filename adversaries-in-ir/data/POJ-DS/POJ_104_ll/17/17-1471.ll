; ModuleID = 'POJ-104-source/17/17-1471.cpp'
source_filename = "POJ-104-source/17/17-1471.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_17_1471.cpp, i8* null }]
...
define dso_local void @_Z6coursePci(i8* %0, i32 %1) #4 {
  %3 = alloca i8*, align 8
...
8:                                                ; preds = %4
  ...
  call void @_Z6coursePci(i8* %14, i32 %15)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_17_1471.cpp() #0 section ".text.startup" {
