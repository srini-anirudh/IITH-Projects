; ModuleID = 'POJ-104-source/17/17-199.cpp'
source_filename = "POJ-104-source/17/17-199.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_17_199.cpp, i8* null }]
...
136:                                              ; preds = %103
  ...
  %140 = getelementptr inbounds [101 x i8], [101 x i8]* %2, i64 0, i64 0
  ...
  %143 = getelementptr inbounds [101 x i8], [101 x i8]* %3, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_17_199.cpp() #0 section ".text.startup" {
