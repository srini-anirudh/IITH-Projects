; ModuleID = 'POJ-104-source/17/17-262.cpp'
source_filename = "POJ-104-source/17/17-262.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_17_262.cpp, i8* null }]
...
48:                                               ; preds = %43, %39
  ...
  %51 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i8* %8)
  br label %15
...
157:                                              ; preds = %127
  ...
  %162 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i8* %8)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_17_262.cpp() #0 section ".text.startup" {
