; ModuleID = 'POJ-104-source/17/17-287.cpp'
source_filename = "POJ-104-source/17/17-287.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_17_287.cpp, i8* null }]
...
48:                                               ; preds = %11
  ...
  %55 = call i8* @strcpy(i8* %54, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0)) #3
  br label %5
...
define dso_local void @_Z4funcPc(i8* %0) #6 {
  %2 = alloca i8*, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_17_287.cpp() #0 section ".text.startup" {
