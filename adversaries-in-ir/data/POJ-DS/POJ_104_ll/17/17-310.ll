; ModuleID = 'POJ-104-source/17/17-310.cpp'
source_filename = "POJ-104-source/17/17-310.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_17_310.cpp, i8* null }]
...
7:                                                ; preds = %62, %50, %45, %27, %16, %0
  %8 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i8* %3)
  %9 = icmp eq i32 %8, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_17_310.cpp() #0 section ".text.startup" {
