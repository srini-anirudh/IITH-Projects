; ModuleID = 'POJ-104-source/17/17-507.cpp'
source_filename = "POJ-104-source/17/17-507.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_17_507.cpp, i8* null }]
...
26:                                               ; preds = %14
  ...
  %27 = bitcast [110 x i32]* %6 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 16 %27, i8 0, i64 440, i1 false)
  %28 = bitcast [110 x i8]* %7 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 16 %28, i8 0, i64 110, i1 false)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_17_507.cpp() #0 section ".text.startup" {
