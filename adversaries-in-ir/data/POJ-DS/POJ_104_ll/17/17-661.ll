; ModuleID = 'POJ-104-source/17/17-661.cpp'
source_filename = "POJ-104-source/17/17-661.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_17_661.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %10 = getelementptr inbounds [105 x i8], [105 x i8]* %3, i64 0, i64 0
...
100:                                              ; preds = %93
  ...
  %103 = getelementptr inbounds [105 x i8], [105 x i8]* %4, i64 0, i64 %102
...
113:                                              ; preds = %78
  %114 = getelementptr inbounds [105 x i8], [105 x i8]* %4, i64 0, i64 0
...
119:                                              ; preds = %116
  ...
  %125 = getelementptr inbounds [105 x i8], [105 x i8]* %4, i64 0, i64 %124
...
129:                                              ; preds = %116
  %130 = getelementptr inbounds [105 x i8], [105 x i8]* %3, i64 0, i64 0
  %131 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSi7getlineEPclc(%"class.std::basic_istream"* @_ZSt3cin, i8* %130, i64 101, i8 signext 10)
  %132 = getelementptr inbounds [105 x i8], [105 x i8]* %3, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_17_661.cpp() #0 section ".text.startup" {
