; ModuleID = 'POJ-104-source/17/17-739.cpp'
source_filename = "POJ-104-source/17/17-739.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_17_739.cpp, i8* null }]
...
define dso_local void @_Z5matchPcS_i(i8* %0, i8* %1, i32 %2) #4 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
...
; Function Attrs: noinline uwtable
define dso_local void @_Z9outresultPcS_(i8* %0, i8* %1) #0 {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_17_739.cpp() #0 section ".text.startup" {
