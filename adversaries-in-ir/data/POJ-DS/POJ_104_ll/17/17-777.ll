; ModuleID = 'POJ-104-source/17/17-777.cpp'
source_filename = "POJ-104-source/17/17-777.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_17_777.cpp, i8* null }]
...
2:                                                ; preds = %5, %0
  %3 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([101 x i8], [101 x i8]* @s, i64 0, i64 0))
  %4 = icmp ne i32 %3, -1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_17_777.cpp() #0 section ".text.startup" {
