; ModuleID = 'POJ-104-source/17/17-808.cpp'
source_filename = "POJ-104-source/17/17-808.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_17_808.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %10 = bitcast i8* %9 to <{ i8, [100 x i8] }>*
  %11 = getelementptr inbounds <{ i8, [100 x i8] }>, <{ i8, [100 x i8] }>* %10, i32 0, i32 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_17_808.cpp() #0 section ".text.startup" {
