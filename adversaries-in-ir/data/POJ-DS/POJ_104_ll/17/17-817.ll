; ModuleID = 'POJ-104-source/17/17-817.cpp'
source_filename = "POJ-104-source/17/17-817.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_17_817.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z7zhengliPc(i8* %0) #0 {
  %2 = alloca i8*, align 8
...
define dso_local void @_Z7panduanPc(i8* %0) #5 {
  %2 = alloca i8*, align 8
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
...
83:                                               ; preds = %14
  ...
  %85 = getelementptr inbounds [110 x i8], [110 x i8]* %7, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_17_817.cpp() #0 section ".text.startup" {
