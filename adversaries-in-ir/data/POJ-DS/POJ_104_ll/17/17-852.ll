; ModuleID = 'POJ-104-source/17/17-852.cpp'
source_filename = "POJ-104-source/17/17-852.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_17_852.cpp, i8* null }]
...
define dso_local i32 @_Z6amountcPc(i8 signext %0, i8* %1) #4 {
  %3 = alloca i8, align 1
  %4 = alloca i8*, align 8
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5matchPc(i8* %0) #0 {
  %2 = alloca i8*, align 8
  ...
  %8 = call i32 @_Z6amountcPc(i8 signext 40, i8* %7)
  store i32 %8, i32* %5, align 4
  %9 = load i8*, i8** %2, align 8
  %10 = call i32 @_Z6amountcPc(i8 signext 41, i8* %9)
...
74:                                               ; preds = %11
  ...
  %76 = call i32 @_Z6amountcPc(i8 signext 40, i8* %75)
...
79:                                               ; preds = %74
  ...
  %81 = call i32 @_Z6amountcPc(i8 signext 41, i8* %80)
...
4:                                                ; preds = %44, %0
  ...
  %6 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i8* %5)
  %7 = icmp ne i32 %6, -1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_17_852.cpp() #0 section ".text.startup" {
