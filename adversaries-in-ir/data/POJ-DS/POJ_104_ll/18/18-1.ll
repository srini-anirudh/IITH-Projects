; ModuleID = 'POJ-104-source/18/18-1.cpp'
source_filename = "POJ-104-source/18/18-1.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_18_1.cpp, i8* null }]
...
define dso_local i32 @_Z3rndii(i32 %0, i32 %1) #5 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  store i32 %0, i32* %3, align 4
  store i32 %1, i32* %4, align 4
...
21:                                               ; preds = %17
  ...
  %25 = call i32 @_Z3rndii(i32 1, i32 %24)
...
31:                                               ; preds = %27
  ...
  %35 = call i32 @_Z3rndii(i32 1, i32 %34)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_18_1.cpp() #0 section ".text.startup" {
