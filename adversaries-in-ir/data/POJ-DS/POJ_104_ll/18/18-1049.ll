; ModuleID = 'POJ-104-source/18/18-1049.cpp'
source_filename = "POJ-104-source/18/18-1049.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_18_1049.cpp, i8* null }]
...
37:                                               ; preds = %13
  ...
  %40 = call i32 @_Z6changePA100_ii([100 x i32]* %38, i32 %39)
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z6changePA100_ii([100 x i32]* %0, i32 %1) #0 {
...
233:                                              ; preds = %200
  ...
  %238 = call i32 @_Z6changePA100_ii([100 x i32]* %235, i32 %237)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_18_1049.cpp() #0 section ".text.startup" {
