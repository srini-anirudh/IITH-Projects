; ModuleID = 'POJ-104-source/18/18-1085.cpp'
source_filename = "POJ-104-source/18/18-1085.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_18_1085.cpp, i8* null }]
...
167:                                              ; preds = %109
  %168 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %5, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_18_1085.cpp() #0 section ".text.startup" {
