; ModuleID = 'POJ-104-source/18/18-1119.cpp'
source_filename = "POJ-104-source/18/18-1119.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_18_1119.cpp, i8* null }]
...
define dso_local void @_Z4jianPA100_ii([100 x i32]* %0, i32 %1) #4 {
...
85:                                               ; preds = %81
  ...
  %90 = getelementptr inbounds [100 x i32], [100 x i32]* %86, i64 %89
...
45:                                               ; preds = %42
  ...
  call void @_Z4jianPA100_ii([100 x i32]* %46, i32 %47)
  %48 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %6, i64 0, i64 1
  ...
  call void @_Z4movePA100_ii([100 x i32]* %53, i32 %54)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_18_1119.cpp() #0 section ".text.startup" {
