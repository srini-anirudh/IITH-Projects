; ModuleID = 'POJ-104-source/18/18-1413.cpp'
source_filename = "POJ-104-source/18/18-1413.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_18_1413.cpp, i8* null }]
...
74:                                               ; preds = %70
  ...
  %77 = call i32 @_Z3minPii(i32* %75, i32 %76)
...
122:                                              ; preds = %118
  ...
  %125 = call i32 @_Z3minPii(i32* %123, i32 %124)
...
define dso_local i32 @_Z3minPii(i32* %0, i32 %1) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_18_1413.cpp() #0 section ".text.startup" {
