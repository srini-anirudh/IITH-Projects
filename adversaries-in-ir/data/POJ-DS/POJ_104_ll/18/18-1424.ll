; ModuleID = 'POJ-104-source/18/18-1424.cpp'
source_filename = "POJ-104-source/18/18-1424.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_18_1424.cpp, i8* null }]
...
43:                                               ; preds = %40
  ...
  call void @_Z7guilingPA101_ii([101 x i32]* %44, i32 %45)
  ...
  call void @_Z8xiaojianPA101_ii([101 x i32]* %51, i32 %52)
  br label %53
...
13:                                               ; preds = %9
  ...
  %20 = call i32 @_Z2mlPii(i32* %18, i32 %19)
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z2mlPii(i32* %0, i32 %1) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_18_1424.cpp() #0 section ".text.startup" {
