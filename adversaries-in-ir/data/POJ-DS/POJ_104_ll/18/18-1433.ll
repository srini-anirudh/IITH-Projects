; ModuleID = 'POJ-104-source/18/18-1433.cpp'
source_filename = "POJ-104-source/18/18-1433.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_18_1433.cpp, i8* null }]
...
define dso_local i32 @_Z2glPA102_ii([102 x i32]* %0, i32 %1) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z2xjPA102_ii([102 x i32]* %0, i32 %1) #4 {
  %3 = alloca [102 x i32]*, align 8
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
45:                                               ; preds = %40
  ...
  %50 = call i32 @_Z2glPA102_ii([102 x i32]* %46, i32 %49)
  ...
  %57 = sub nsw i32 %55, %56
  call void @_Z2xjPA102_ii([102 x i32]* %54, i32 %57)
  br label %58
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_18_1433.cpp() #0 section ".text.startup" {
