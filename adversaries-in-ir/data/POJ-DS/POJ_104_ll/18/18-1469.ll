; ModuleID = 'POJ-104-source/18/18-1469.cpp'
source_filename = "POJ-104-source/18/18-1469.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_18_1469.cpp, i8* null }]
...
define dso_local i32 @_Z3minPi(i32* %0) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z3cutPA50_ii([50 x i32]* %0, i32 %1) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z8xiaojianPA50_ii([50 x i32]* %0, i32 %1) #4 {
  %3 = alloca [50 x i32]*, align 8
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  store [50 x i32]* %0, [50 x i32]** %3, align 8
...
46:                                               ; preds = %42
  ...
  call void @_Z3cutPA50_ii([50 x i32]* %50, i32 %51)
  ...
  call void @_Z8xiaojianPA50_ii([50 x i32]* %67, i32 %68)
  br label %69
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_18_1469.cpp() #0 section ".text.startup" {
