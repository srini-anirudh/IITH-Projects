; ModuleID = 'POJ-104-source/18/18-1473.cpp'
source_filename = "POJ-104-source/18/18-1473.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_18_1473.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z3calPA120_ii([120 x i32]* %0, i32 %1) #0 {
...
216:                                              ; preds = %181
  ...
  %221 = call i32 @_Z3calPA120_ii([120 x i32]* %218, i32 %220)
...
37:                                               ; preds = %13
  ...
  %40 = call i32 @_Z3calPA120_ii([120 x i32]* %38, i32 %39)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_18_1473.cpp() #0 section ".text.startup" {
