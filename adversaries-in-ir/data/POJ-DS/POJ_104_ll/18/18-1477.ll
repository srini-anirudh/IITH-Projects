; ModuleID = 'POJ-104-source/18/18-1477.cpp'
source_filename = "POJ-104-source/18/18-1477.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_18_1477.cpp, i8* null }]
...
define dso_local void @_Z4xiaoPA100_ii([100 x i32]* %0, i32 %1) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z4movePA100_ii([100 x i32]* %0, i32 %1) #4 {
  %3 = alloca [100 x i32]*, align 8
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z5countPA100_iii([100 x i32]* %0, i32 %1, i32 %2) #0 {
  %4 = alloca i32, align 4
...
12:                                               ; preds = %3
  ...
  %14 = load i32, i32* %6, align 4
  call void @_Z4xiaoPA100_ii([100 x i32]* %13, i32 %14)
  ...
  call void @_Z4movePA100_ii([100 x i32]* %21, i32 %22)
  %23 = load [100 x i32]*, [100 x i32]** %5, align 8
  %24 = load i32, i32* %6, align 4
  %25 = sub nsw i32 %24, 1
  %26 = load i32, i32* %7, align 4
  %27 = call i32 @_Z5countPA100_iii([100 x i32]* %23, i32 %25, i32 %26)
...
38:                                               ; preds = %14
  ...
  %42 = call i32 @_Z5countPA100_iii([100 x i32]* %39, i32 %40, i32 %41)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_18_1477.cpp() #0 section ".text.startup" {
