; ModuleID = 'POJ-104-source/18/18-1650.cpp'
source_filename = "POJ-104-source/18/18-1650.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_18_1650.cpp, i8* null }]
...
39:                                               ; preds = %13
  ...
  call void @_Z11SubtractionPA100_ii([100 x i32]* %40, i32 %41)
...
; Function Attrs: noinline uwtable
define dso_local void @_Z11SubtractionPA100_ii([100 x i32]* %0, i32 %1) #0 {
...
150:                                              ; preds = %85
  ...
  %153 = getelementptr inbounds [100 x i32], [100 x i32]* %152, i64 0, i64 1
...
206:                                              ; preds = %157
  %207 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %13, i64 0, i64 0
  %208 = load i32, i32* %4, align 4
  %209 = sub nsw i32 %208, 1
  call void @_Z11SubtractionPA100_ii([100 x i32]* %207, i32 %209)
  br label %210
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_18_1650.cpp() #0 section ".text.startup" {
