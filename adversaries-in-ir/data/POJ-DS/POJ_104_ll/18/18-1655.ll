; ModuleID = 'POJ-104-source/18/18-1655.cpp'
source_filename = "POJ-104-source/18/18-1655.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_18_1655.cpp, i8* null }]
...
140:                                              ; preds = %136
  %141 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %13, i64 0, i64 0
...
221:                                              ; preds = %186
  ...
  %223 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %13, i64 0, i64 1
...
231:                                              ; preds = %227
  %232 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %13, i64 0, i64 0
  %233 = load i32, i32* %6, align 4
  %234 = sext i32 %233 to i64
  %235 = getelementptr inbounds [100 x i32], [100 x i32]* %232, i64 0, i64 %234
  %236 = load i32, i32* %235, align 4
  %237 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %13, i64 0, i64 0
  ...
  store i32 %246, i32* %251, align 16
  br label %252
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_18_1655.cpp() #0 section ".text.startup" {
