; ModuleID = 'POJ-104-source/18/18-1762.cpp'
source_filename = "POJ-104-source/18/18-1762.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_18_1762.cpp, i8* null }]
...
75:                                               ; preds = %71
  ...
  %97 = call i32* @_ZSt11min_elementIPiET_S1_S1_(i32* %84, i32* %96)
...
; Function Attrs: noinline uwtable
define linkonce_odr dso_local i32* @_ZSt11min_elementIPiET_S1_S1_(i32* %0, i32* %1) #0 comdat {
...
; Function Attrs: noinline uwtable
define linkonce_odr dso_local i32* @_ZSt13__min_elementIPiN9__gnu_cxx5__ops15_Iter_less_iterEET_S4_S4_T0_(i32* %0, i32* %1) #0 comdat {
  %3 = alloca i32*, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_18_1762.cpp() #0 section ".text.startup" {
