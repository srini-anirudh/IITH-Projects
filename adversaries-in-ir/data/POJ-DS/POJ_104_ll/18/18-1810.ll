; ModuleID = 'POJ-104-source/18/18-1810.cpp'
source_filename = "POJ-104-source/18/18-1810.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_18_1810.cpp, i8* null }]
...
122:                                              ; preds = %116
  ...
  %129 = call dereferenceable(4) i32* @_ZSt3minIiERKT_S2_S2_(i32* dereferenceable(4) %4, i32* dereferenceable(4) %128)
...
158:                                              ; preds = %109
  %159 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %3, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_18_1810.cpp() #0 section ".text.startup" {
