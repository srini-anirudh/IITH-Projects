; ModuleID = 'POJ-104-source/18/18-1817.cpp'
source_filename = "POJ-104-source/18/18-1817.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_18_1817.cpp, i8* null }]
...
78:                                               ; preds = %65
  ...
  %81 = getelementptr inbounds [100 x [100 x [100 x i32]]], [100 x [100 x [100 x i32]]]* %9, i64 0, i64 %80
...
169:                                              ; preds = %163
  ...
  %173 = getelementptr inbounds [100 x [100 x [100 x i32]]], [100 x [100 x [100 x i32]]]* %9, i64 0, i64 %172
...
189:                                              ; preds = %121
  %190 = getelementptr inbounds [100 x [100 x [100 x i32]]], [100 x [100 x [100 x i32]]]* %9, i64 0, i64 1
  %191 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %190, i64 0, i64 1
...
213:                                              ; preds = %206
  ...
  %216 = getelementptr inbounds [100 x [100 x [100 x i32]]], [100 x [100 x [100 x i32]]]* %9, i64 0, i64 %215
  ...
  %227 = getelementptr inbounds [100 x [100 x [100 x i32]]], [100 x [100 x [100 x i32]]]* %9, i64 0, i64 %226
...
254:                                              ; preds = %247
  ...
  %258 = getelementptr inbounds [100 x [100 x [100 x i32]]], [100 x [100 x [100 x i32]]]* %9, i64 0, i64 %257
  ...
  %268 = getelementptr inbounds [100 x [100 x [100 x i32]]], [100 x [100 x [100 x i32]]]* %9, i64 0, i64 %267
...
290:                                              ; preds = %13
  ...
  %292 = getelementptr inbounds [100 x i32], [100 x i32]* %8, i64 0, i64 0
  call void @_Z5ccoutiPi(i32 %291, i32* %292)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5ccoutiPi(i32 %0, i32* %1) #0 {
  %3 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_18_1817.cpp() #0 section ".text.startup" {
