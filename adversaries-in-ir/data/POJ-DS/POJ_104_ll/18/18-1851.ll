; ModuleID = 'POJ-104-source/18/18-1851.cpp'
source_filename = "POJ-104-source/18/18-1851.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_18_1851.cpp, i8* null }]
...
define dso_local i32 @_Z5minihiPi(i32 %0, i32* %1) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z5miniliPi(i32 %0, i32* %1) #4 {
  %3 = alloca i32, align 4
  %4 = alloca i32*, align 8
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
61:                                               ; preds = %57
  ...
  %69 = call i32 @_Z5minihiPi(i32 %62, i32* %68)
...
100:                                              ; preds = %96
  ...
  %107 = call i32 @_Z5miniliPi(i32 %101, i32* %106)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_18_1851.cpp() #0 section ".text.startup" {
