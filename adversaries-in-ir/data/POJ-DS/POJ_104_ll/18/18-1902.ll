; ModuleID = 'POJ-104-source/18/18-1902.cpp'
source_filename = "POJ-104-source/18/18-1902.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_18_1902.cpp, i8* null }]
...
define dso_local void @_Z8diminishPA105_ii([105 x i32]* %0, i32 %1) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z10lowerstairPA105_ii([105 x i32]* %0, i32 %1) #4 {
  %3 = alloca [105 x i32]*, align 8
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z4dealPA105_ii([105 x i32]* %0, i32 %1) #4 {
  %3 = alloca [105 x i32]*, align 8
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  store [105 x i32]* %0, [105 x i32]** %3, align 8
...
9:                                                ; preds = %6
  ...
  call void @_Z8diminishPA105_ii([105 x i32]* %10, i32 %11)
  ...
  call void @_Z10lowerstairPA105_ii([105 x i32]* %18, i32 %19)
...
25:                                               ; preds = %21
  ...
  %28 = getelementptr inbounds [105 x [105 x i32]], [105 x [105 x i32]]* %8, i64 0, i64 %27
...
40:                                               ; preds = %16
  ...
  %43 = call i32 @_Z4dealPA105_ii([105 x i32]* %41, i32 %42)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_18_1902.cpp() #0 section ".text.startup" {
