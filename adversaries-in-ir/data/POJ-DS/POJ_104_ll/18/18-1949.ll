; ModuleID = 'POJ-104-source/18/18-1949.cpp'
source_filename = "POJ-104-source/18/18-1949.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_18_1949.cpp, i8* null }]
...
22:                                               ; preds = %4
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([101 x i32], [101 x i32]* @min01, i64 0, i64 0), i32* %25)
...
22:                                               ; preds = %4
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([101 x i32], [101 x i32]* @min02, i64 0, i64 0), i32* %25)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_18_1949.cpp() #0 section ".text.startup" {
