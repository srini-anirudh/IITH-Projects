; ModuleID = 'POJ-104-source/18/18-2000.cpp'
source_filename = "POJ-104-source/18/18-2000.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_18_2000.cpp, i8* null }]
...
38:                                               ; preds = %35
  ...
  %42 = call i32 @_Z1gi(i32 %41)
  %43 = load i32, i32* @i, align 4
  %44 = call i32 @_Z1hi(i32 %43)
  br label %45
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_18_2000.cpp() #0 section ".text.startup" {
