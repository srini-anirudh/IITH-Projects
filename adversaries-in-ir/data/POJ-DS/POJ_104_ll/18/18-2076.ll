; ModuleID = 'POJ-104-source/18/18-2076.cpp'
source_filename = "POJ-104-source/18/18-2076.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_18_2076.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z5checkv() #0 {
  %1 = alloca i8*, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_18_2076.cpp() #0 section ".text.startup" {
