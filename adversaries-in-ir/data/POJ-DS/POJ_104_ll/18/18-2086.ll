; ModuleID = 'POJ-104-source/18/18-2086.cpp'
source_filename = "POJ-104-source/18/18-2086.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_18_2086.cpp, i8* null }]
...
47:                                               ; preds = %44
  ...
  call void @_Z2m1iPA100_i(i32 %49, [100 x i32]* %50)
  %51 = load i32, i32* %4, align 4
  %52 = add nsw i32 %51, 1
  %53 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %3, i64 0, i64 0
  call void @_Z2m2iPA100_i(i32 %52, [100 x i32]* %53)
  ...
  call void @_Z4dealiPA100_i(i32 %60, [100 x i32]* %61)
...
define dso_local void @_Z2m1iPA100_i(i32 %0, [100 x i32]* %1) #6 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z2m2iPA100_i(i32 %0, [100 x i32]* %1) #6 {
  %3 = alloca i32, align 4
  %4 = alloca [100 x i32]*, align 8
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z4dealiPA100_i(i32 %0, [100 x i32]* %1) #6 {
  %3 = alloca i32, align 4
  %4 = alloca [100 x i32]*, align 8
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_18_2086.cpp() #0 section ".text.startup" {
