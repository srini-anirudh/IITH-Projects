; ModuleID = 'POJ-104-source/18/18-2102.cpp'
source_filename = "POJ-104-source/18/18-2102.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_18_2102.cpp, i8* null }]
...
define dso_local i32 @_Z6minrowPA100_iii([100 x i32]* %0, i32 %1, i32 %2) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z9mincolumnPA100_iii([100 x i32]* %0, i32 %1, i32 %2) #4 {
  %4 = alloca [100 x i32]*, align 8
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
  %7 = alloca i32, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z3rowPA100_ii([100 x i32]* %0, i32 %1) #4 {
...
12:                                               ; preds = %8
  ...
  %16 = call i32 @_Z6minrowPA100_iii([100 x i32]* %13, i32 %14, i32 %15)
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z6columnPA100_ii([100 x i32]* %0, i32 %1) #4 {
  %3 = alloca [100 x i32]*, align 8
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
12:                                               ; preds = %8
  ...
  %15 = load i32, i32* %4, align 4
  %16 = call i32 @_Z9mincolumnPA100_iii([100 x i32]* %13, i32 %14, i32 %15)
  store i32 %16, i32* %7, align 4
  store i32 0, i32* %5, align 4
  br label %17
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z3delPA100_ii([100 x i32]* %0, i32 %1) #4 {
  %3 = alloca [100 x i32]*, align 8
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5printPA100_ii([100 x i32]* %0, i32 %1) #0 {
  %3 = alloca [100 x i32]*, align 8
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
define dso_local i32 @main() #5 {
  ...
  %10 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i32* %2)
...
25:                                               ; preds = %21
  ...
  %32 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i32* %31)
  br label %33
...
47:                                               ; preds = %42
  ...
  call void @_Z3rowPA100_ii([100 x i32]* %48, i32 %49)
  %50 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %6, i64 0, i64 0
  %51 = load i32, i32* %7, align 4
  call void @_Z6columnPA100_ii([100 x i32]* %50, i32 %51)
  ...
  call void @_Z3delPA100_ii([100 x i32]* %57, i32 %58)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_18_2102.cpp() #0 section ".text.startup" {
