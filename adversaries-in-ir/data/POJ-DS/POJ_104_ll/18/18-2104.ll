; ModuleID = 'POJ-104-source/18/18-2104.cpp'
source_filename = "POJ-104-source/18/18-2104.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_18_2104.cpp, i8* null }]
...
define dso_local void @_Z13minus_row_coli(i32 %0) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z14delete_row_coli(i32 %0) #4 {
  %2 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_18_2104.cpp() #0 section ".text.startup" {
