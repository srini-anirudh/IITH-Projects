; ModuleID = 'POJ-104-source/18/18-2115.cpp'
source_filename = "POJ-104-source/18/18-2115.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_18_2115.cpp, i8* null }]
...
189:                                              ; preds = %119
  %190 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %3, i64 0, i64 1
...
202:                                              ; preds = %195
  ...
  %209 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %3, i64 0, i64 0
...
223:                                              ; preds = %217
  ...
  store i32 %229, i32* %233, align 16
  br label %234
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_18_2115.cpp() #0 section ".text.startup" {
