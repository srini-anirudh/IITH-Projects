; ModuleID = 'POJ-104-source/18/18-2137.cpp'
source_filename = "POJ-104-source/18/18-2137.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_18_2137.cpp, i8* null }]
...
define dso_local i32 @_Z3rowPA100_iii([100 x i32]* %0, i32 %1, i32 %2) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z4linePA100_iii([100 x i32]* %0, i32 %1, i32 %2) #4 {
  %4 = alloca [100 x i32]*, align 8
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
  %7 = alloca i32, align 4
...
56:                                               ; preds = %51
  ...
  %60 = call i32 @_Z3rowPA100_iii([100 x i32]* %57, i32 %58, i32 %59)
...
95:                                               ; preds = %90
  ...
  %99 = call i32 @_Z4linePA100_iii([100 x i32]* %96, i32 %97, i32 %98)
...
128:                                              ; preds = %90
  ...
  call void @_Z4movePA100_ii([100 x i32]* %134, i32 %135)
  br label %136
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_18_2137.cpp() #0 section ".text.startup" {
