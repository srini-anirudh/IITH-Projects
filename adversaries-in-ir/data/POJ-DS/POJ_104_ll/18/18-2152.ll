; ModuleID = 'POJ-104-source/18/18-2152.cpp'
source_filename = "POJ-104-source/18/18-2152.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_18_2152.cpp, i8* null }]
...
define dso_local void @_Z5down1PA100_ii([100 x i32]* %0, i32 %1) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z5down2PA100_ii([100 x i32]* %0, i32 %1) #4 {
  %3 = alloca [100 x i32]*, align 8
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
45:                                               ; preds = %40
  ...
  %48 = sub nsw i32 %47, 1
  call void @_Z5down1PA100_ii([100 x i32]* %46, i32 %48)
  %49 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %6, i64 0, i64 0
  %50 = load i32, i32* %2, align 4
  %51 = sub nsw i32 %50, 1
  call void @_Z5down2PA100_ii([100 x i32]* %49, i32 %51)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_18_2152.cpp() #0 section ".text.startup" {
