; ModuleID = 'POJ-104-source/18/18-2170.cpp'
source_filename = "POJ-104-source/18/18-2170.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_18_2170.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z10reduce_miniiii(i32 %0, i32 %1, i32 %2, i32 %3) #0 {
...
35:                                               ; preds = %27, %17
  ...
  call void @_Z10reduce_miniiii(i32 %38, i32 %41, i32 %42, i32 %43)
...
define dso_local void @_Z6reducev() #4 {
...
47:                                               ; preds = %42
  ...
  %68 = sdiv i32 %66, %67
  %69 = sub nsw i32 1, %68
  call void @_Z10reduce_miniiii(i32 %55, i32 %62, i32 %65, i32 %69)
  br label %70
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_18_2170.cpp() #0 section ".text.startup" {
