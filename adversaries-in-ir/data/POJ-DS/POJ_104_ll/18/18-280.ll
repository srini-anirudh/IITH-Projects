; ModuleID = 'POJ-104-source/18/18-280.cpp'
source_filename = "POJ-104-source/18/18-280.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_18_280.cpp, i8* null }]
...
define dso_local i32 @_Z7findminPiii(i32* %0, i32 %1, i32 %2) #4 {
...
50:                                               ; preds = %46
  ...
  %56 = call i32 @_Z7findminPiii(i32* %54, i32 %55, i32 1)
...
83:                                               ; preds = %79
  ...
  %89 = call i32 @_Z7findminPiii(i32* %87, i32 %88, i32 100)
...
111:                                              ; preds = %79
  %112 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %4, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_18_280.cpp() #0 section ".text.startup" {
