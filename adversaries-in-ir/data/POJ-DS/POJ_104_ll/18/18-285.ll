; ModuleID = 'POJ-104-source/18/18-285.cpp'
source_filename = "POJ-104-source/18/18-285.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_18_285.cpp, i8* null }]
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z7shanchuPA100_ii([100 x i32]* %0, i32 %1) #4 {
  %3 = alloca [100 x i32]*, align 8
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
56:                                               ; preds = %53
  ...
  call void @_Z7guilingPA100_ii([100 x i32]* %60, i32 %61)
  ...
  call void @_Z7shanchuPA100_ii([100 x i32]* %73, i32 %74)
  br label %75
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_18_285.cpp() #0 section ".text.startup" {
