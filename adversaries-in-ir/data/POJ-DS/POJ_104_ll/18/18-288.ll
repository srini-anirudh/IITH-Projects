; ModuleID = 'POJ-104-source/18/18-288.cpp'
source_filename = "POJ-104-source/18/18-288.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_18_288.cpp, i8* null }]
...
252:                                              ; preds = %216
  ...
  %257 = call i32 @_Z1fPA100_ii([100 x i32]* %254, i32 %256)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_18_288.cpp() #0 section ".text.startup" {
