; ModuleID = 'POJ-104-source/18/18-298.cpp'
source_filename = "POJ-104-source/18/18-298.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_18_298.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z3calPA101_ii([101 x i32]* %0, i32 %1) #0 {
...
222:                                              ; preds = %189
  ...
  %227 = call i32 @_Z3calPA101_ii([101 x i32]* %224, i32 %226)
...
define dso_local i32 @main() #5 {
  ...
  %6 = alloca i32, align 4
  %7 = alloca i32, align 4
  %8 = alloca [100 x [101 x i32]], align 16
  %9 = alloca i32, align 4
  store i32 0, i32* %1, align 4
  %10 = bitcast [100 x [101 x i32]]* %8 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 16 %10, i8 0, i64 40400, i1 false)
...
26:                                               ; preds = %22
  ...
  %29 = getelementptr inbounds [100 x [101 x i32]], [100 x [101 x i32]]* %8, i64 0, i64 %28
...
41:                                               ; preds = %17
  %42 = getelementptr inbounds [100 x [101 x i32]], [100 x [101 x i32]]* %8, i64 0, i64 0
  %43 = load i32, i32* %2, align 4
  %44 = call i32 @_Z3calPA101_ii([101 x i32]* %42, i32 %43)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_18_298.cpp() #0 section ".text.startup" {
