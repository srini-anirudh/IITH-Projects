; ModuleID = 'POJ-104-source/18/18-310.cpp'
source_filename = "POJ-104-source/18/18-310.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_18_310.cpp, i8* null }]
...
116:                                              ; preds = %112
  %117 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %10, i64 0, i64 0
...
176:                                              ; preds = %112
  ...
  %178 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %10, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_18_310.cpp() #0 section ".text.startup" {
