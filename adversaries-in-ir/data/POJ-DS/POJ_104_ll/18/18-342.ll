; ModuleID = 'POJ-104-source/18/18-342.cpp'
source_filename = "POJ-104-source/18/18-342.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_18_342.cpp, i8* null }]
...
define dso_local void @_Z7guilingPA100_ii([100 x i32]* %0, i32 %1) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z8xiaojianPA100_ii([100 x i32]* %0, i32 %1) #4 {
  %3 = alloca [100 x i32]*, align 8
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
43:                                               ; preds = %40
  ...
  call void @_Z7guilingPA100_ii([100 x i32]* %44, i32 %45)
  %46 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %3, i64 0, i64 0
  %47 = load i32, i32* %7, align 4
  call void @_Z8xiaojianPA100_ii([100 x i32]* %46, i32 %47)
  br label %48
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_18_342.cpp() #0 section ".text.startup" {
