; ModuleID = 'POJ-104-source/18/18-356.cpp'
source_filename = "POJ-104-source/18/18-356.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_18_356.cpp, i8* null }]
...
14:                                               ; preds = %10
  ...
  %15 = bitcast [200 x [200 x i32]]* %8 to i8*
...
40:                                               ; preds = %16
  %41 = getelementptr inbounds [200 x [200 x i32]], [200 x [200 x i32]]* %8, i64 0, i64 0
  %42 = load i32, i32* %2, align 4
  %43 = call i32 @_Z2glPA200_ii([200 x i32]* %41, i32 %42)
...
define dso_local i32 @_Z2glPA200_ii([200 x i32]* %0, i32 %1) #6 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_18_356.cpp() #0 section ".text.startup" {
