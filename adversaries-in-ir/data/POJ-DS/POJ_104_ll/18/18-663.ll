; ModuleID = 'POJ-104-source/18/18-663.cpp'
source_filename = "POJ-104-source/18/18-663.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_18_663.cpp, i8* null }]
...
180:                                              ; preds = %176
  ...
  store i32 99999, i32* %186, align 4
  br label %187
...
195:                                              ; preds = %191
  ...
  store i32 99999, i32* %201, align 4
  br label %202
...
205:                                              ; preds = %191
  ...
  store i32 9999, i32* %211, align 4
  br label %212
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_18_663.cpp() #0 section ".text.startup" {
