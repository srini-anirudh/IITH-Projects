; ModuleID = 'POJ-104-source/18/18-673.cpp'
source_filename = "POJ-104-source/18/18-673.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_18_673.cpp, i8* null }]
...
180:                                              ; preds = %116
  ...
  %182 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %4, i64 0, i64 1
  %183 = getelementptr inbounds [100 x i32], [100 x i32]* %182, i64 0, i64 1
  %184 = load i32, i32* %183, align 4
  %185 = add nsw i32 %181, %184
  store i32 %185, i32* %10, align 4
  store i32 0, i32* %11, align 4
  %186 = getelementptr inbounds [10000 x i32], [10000 x i32]* %5, i64 0, i64 0
  %187 = bitcast i32* %186 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 16 %187, i8 0, i64 40000, i1 false)
  store i32 0, i32* %7, align 4
  br label %188
...
224:                                              ; preds = %188
  ...
  %227 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %4, i64 0, i64 0
  %228 = bitcast [100 x i32]* %227 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 16 %228, i8 0, i64 40000, i1 false)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_18_673.cpp() #0 section ".text.startup" {
