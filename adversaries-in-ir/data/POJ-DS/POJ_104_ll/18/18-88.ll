; ModuleID = 'POJ-104-source/18/18-88.cpp'
source_filename = "POJ-104-source/18/18-88.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_18_88.cpp, i8* null }]
...
66:                                               ; preds = %58
  ...
  %72 = call i32 @_Z3MinPii(i32* %70, i32 %71)
...
131:                                              ; preds = %127
  ...
  %137 = call i32 @_Z3MinPii(i32* %135, i32 %136)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_18_88.cpp() #0 section ".text.startup" {
