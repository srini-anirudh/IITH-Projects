; ModuleID = 'POJ-104-source/18/18-892.cpp'
source_filename = "POJ-104-source/18/18-892.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_18_892.cpp, i8* null }]
...
72:                                               ; preds = %59
  %73 = load [100 x i32]*, [100 x i32]** %10, align 8
...
104:                                              ; preds = %100
  %105 = load [100 x i32]*, [100 x i32]** %10, align 8
  ...
  %116 = load [100 x i32]*, [100 x i32]** %10, align 8
...
154:                                              ; preds = %141
  %155 = load [100 x i32]*, [100 x i32]** %10, align 8
...
166:                                              ; preds = %154
  %167 = load [100 x i32]*, [100 x i32]** %10, align 8
...
186:                                              ; preds = %182
  %187 = load [100 x i32]*, [100 x i32]** %10, align 8
  ...
  %198 = load [100 x i32]*, [100 x i32]** %10, align 8
...
213:                                              ; preds = %132
  %214 = load [100 x i32]*, [100 x i32]** %10, align 8
...
226:                                              ; preds = %221
  ...
  %235 = load [100 x i32]*, [100 x i32]** %10, align 8
  %236 = getelementptr inbounds [100 x i32], [100 x i32]* %235, i64 0
...
250:                                              ; preds = %245
  %251 = load [100 x i32]*, [100 x i32]** %10, align 8
  ...
  %259 = load [100 x i32]*, [100 x i32]** %10, align 8
...
280:                                              ; preds = %275
  %281 = load [100 x i32]*, [100 x i32]** %10, align 8
  ...
  %292 = load [100 x i32]*, [100 x i32]** %10, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_18_892.cpp() #0 section ".text.startup" {
