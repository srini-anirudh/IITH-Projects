; ModuleID = 'POJ-104-source/18/18-894.cpp'
source_filename = "POJ-104-source/18/18-894.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_18_894.cpp, i8* null }]
...
52:                                               ; preds = %49
  ...
  call void @_Z7zerorowi(i32 %53)
  %54 = load i32, i32* @k, align 4
  call void @_Z7zerocoli(i32 %54)
  %55 = load i32, i32* getelementptr inbounds ([101 x [101 x i32]], [101 x [101 x i32]]* @a, i64 0, i64 1, i64 1), align 4
  %56 = load i32, i32* @sum, align 4
  %57 = add nsw i32 %56, %55
  store i32 %57, i32* @sum, align 4
  %58 = load i32, i32* @k, align 4
  call void @_Z4jiani(i32 %58)
  br label %59
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_18_894.cpp() #0 section ".text.startup" {
