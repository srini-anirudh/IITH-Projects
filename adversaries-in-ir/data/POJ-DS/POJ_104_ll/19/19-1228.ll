; ModuleID = 'POJ-104-source/19/19-1228.cpp'
source_filename = "POJ-104-source/19/19-1228.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_19_1228.cpp, i8* null }]
...
57:                                               ; preds = %20
  ...
  %70 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i8* %68, i8* %69)
  store i32 0, i32* %5, align 4
  br label %71
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_19_1228.cpp() #0 section ".text.startup" {
