; ModuleID = 'POJ-104-source/19/19-1231.cpp'
source_filename = "POJ-104-source/19/19-1231.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_19_1231.cpp, i8* null }]
...
7:                                                ; preds = %21, %0
  %8 = call noalias i8* @calloc(i64 1, i64 100) #3
...
24:                                               ; preds = %19
  ...
  %26 = call noalias i8* @calloc(i64 1, i64 100) #3
  store i8* %26, i8** %3, align 8
  %27 = call noalias i8* @calloc(i64 1, i64 100) #3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_19_1231.cpp() #0 section ".text.startup" {
