; ModuleID = 'POJ-104-source/19/19-1287.cpp'
source_filename = "POJ-104-source/19/19-1287.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_19_1287.cpp, i8* null }]
...
32:                                               ; preds = %27
  ...
  %44 = call i32 @strcmp(i8* %37, i8* %43) #6
  %45 = icmp eq i32 %44, 0
...
46:                                               ; preds = %32
  ...
  %58 = call i8* @strcpy(i8* %51, i8* %57) #3
  br label %59
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_19_1287.cpp() #0 section ".text.startup" {
