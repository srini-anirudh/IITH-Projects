; ModuleID = 'POJ-104-source/19/19-1302.cpp'
source_filename = "POJ-104-source/19/19-1302.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_19_1302.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %5 = call noalias i8* @calloc(i64 101, i64 1) #3
...
14:                                               ; preds = %7
  ...
  %17 = call noalias i8* @calloc(i64 101, i64 1) #3
...
27:                                               ; preds = %22
  ...
  %37 = call i32 @strcmp(i8* %31, i8* %36) #6
  %38 = icmp eq i32 %37, 0
...
56:                                               ; preds = %22
  ...
  %66 = call i32 @strcmp(i8* %60, i8* %65) #6
  %67 = icmp eq i32 %66, 0
...
68:                                               ; preds = %56
  ...
  %72 = getelementptr inbounds [1024 x i8*], [1024 x i8*]* %2, i64 0, i64 %71
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_19_1302.cpp() #0 section ".text.startup" {
