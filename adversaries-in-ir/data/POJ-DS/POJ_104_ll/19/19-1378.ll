; ModuleID = 'POJ-104-source/19/19-1378.cpp'
source_filename = "POJ-104-source/19/19-1378.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_19_1378.cpp, i8* null }]
...
36:                                               ; preds = %32
  ...
  %42 = call i32 @strcmp(i8* %37, i8* %41) #6
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_19_1378.cpp() #0 section ".text.startup" {
