; ModuleID = 'POJ-104-source/19/19-1881.cpp'
source_filename = "POJ-104-source/19/19-1881.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_19_1881.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %29 = call i8* @_ZSt6strstrPcPKc(i8* %27, i8* %28)
...
80:                                               ; preds = %45, %38
  ...
  %107 = call i8* @_ZSt6strstrPcPKc(i8* %105, i8* %106)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_19_1881.cpp() #0 section ".text.startup" {
