; ModuleID = 'POJ-104-source/19/19-1882.cpp'
source_filename = "POJ-104-source/19/19-1882.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_19_1882.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %20 = call i8* @_ZSt6strstrPcPKc(i8* %18, i8* %19)
...
45:                                               ; preds = %36
  ...
  %57 = call i8* @_ZSt6strstrPcPKc(i8* %55, i8* %56)
...
58:                                               ; preds = %36, %29
  ...
  %79 = call i8* @_ZSt6strstrPcPKc(i8* %77, i8* %78)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_19_1882.cpp() #0 section ".text.startup" {
