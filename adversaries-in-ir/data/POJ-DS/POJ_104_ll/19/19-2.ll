; ModuleID = 'POJ-104-source/19/19-2.cpp'
source_filename = "POJ-104-source/19/19-2.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_19_2.cpp, i8* null }]
...
24:                                               ; preds = %8
  ...
  %28 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i8* %27)
...
33:                                               ; preds = %29
  ...
  %39 = call i32 @strcmp(i8* %34, i8* %38) #6
  %40 = icmp eq i32 %39, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_19_2.cpp() #0 section ".text.startup" {
