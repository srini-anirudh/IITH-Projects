; ModuleID = 'POJ-104-source/19/19-2669.cpp'
source_filename = "POJ-104-source/19/19-2669.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_19_2669.cpp, i8* null }]
...
24:                                               ; preds = %22, %8
  ...
  %27 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), i8* %25, i8* %26)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_19_2669.cpp() #0 section ".text.startup" {
