; ModuleID = 'POJ-104-source/19/19-3038.cpp'
source_filename = "POJ-104-source/19/19-3038.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_19_3038.cpp, i8* null }]
...
59:                                               ; preds = %28
  %60 = getelementptr inbounds [100 x [100 x i8]], [100 x [100 x i8]]* %5, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_19_3038.cpp() #0 section ".text.startup" {
