; ModuleID = 'POJ-104-source/19/19-3062.cpp'
source_filename = "POJ-104-source/19/19-3062.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_19_3062.cpp, i8* null }]
...
38:                                               ; preds = %36, %33
  ...
  %47 = call i32 @strcmp(i8* %42, i8* %46) #6
  %48 = icmp eq i32 %47, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_19_3062.cpp() #0 section ".text.startup" {
