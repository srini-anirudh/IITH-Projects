; ModuleID = 'POJ-104-source/19/19-3074.cpp'
source_filename = "POJ-104-source/19/19-3074.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_19_3074.cpp, i8* null }]
...
131:                                              ; preds = %126
  ...
  %134 = getelementptr inbounds [100 x [100 x i8]], [100 x [100 x i8]]* %9, i64 0, i64 %133
...
222:                                              ; preds = %215
  ...
  %225 = getelementptr inbounds [100 x [100 x i8]], [100 x [100 x i8]]* %9, i64 0, i64 %224
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_19_3074.cpp() #0 section ".text.startup" {
