; ModuleID = 'POJ-104-source/19/19-3182.cpp'
source_filename = "POJ-104-source/19/19-3182.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_19_3182.cpp, i8* null }]
...
36:                                               ; preds = %34, %31
  ...
  %41 = call i32 @strcmp(i8* %40, i8* getelementptr inbounds ([100 x i8], [100 x i8]* @a, i64 0, i64 0)) #7
  %42 = icmp eq i32 %41, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_19_3182.cpp() #0 section ".text.startup" {
