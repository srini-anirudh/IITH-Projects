; ModuleID = 'POJ-104-source/19/19-35.cpp'
source_filename = "POJ-104-source/19/19-35.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_19_35.cpp, i8* null }]
...
34:                                               ; preds = %31
  ...
  %44 = call i32 @strcmp(i8* %38, i8* %43) #7
  %45 = icmp eq i32 %44, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_19_35.cpp() #0 section ".text.startup" {
