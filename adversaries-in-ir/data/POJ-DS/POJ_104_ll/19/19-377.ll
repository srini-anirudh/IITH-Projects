; ModuleID = 'POJ-104-source/19/19-377.cpp'
source_filename = "POJ-104-source/19/19-377.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_19_377.cpp, i8* null }]
...
116:                                              ; preds = %90
  ...
  %120 = call i32 @strcmp(i8* %118, i8* %119) #7
...
140:                                              ; preds = %130
  ...
  %147 = call i32 @strcmp(i8* %145, i8* %146) #7
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_19_377.cpp() #0 section ".text.startup" {
