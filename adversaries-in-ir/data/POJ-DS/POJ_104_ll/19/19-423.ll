; ModuleID = 'POJ-104-source/19/19-423.cpp'
source_filename = "POJ-104-source/19/19-423.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_19_423.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %10 = bitcast [30 x [20 x i8]]* %2 to i8*
...
16:                                               ; preds = %13
  %17 = getelementptr inbounds [30 x [20 x i8]], [30 x [20 x i8]]* %2, i64 0, i64 0
...
50:                                               ; preds = %35
  ...
  %53 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i8* %51, i8* %52)
  store i32 0, i32* %8, align 4
  br label %54
...
67:                                               ; preds = %58
  %68 = getelementptr inbounds [30 x i8*], [30 x i8*]* %5, i64 0, i64 0
...
79:                                               ; preds = %54
  %80 = getelementptr inbounds [30 x i8*], [30 x i8*]* %5, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_19_423.cpp() #0 section ".text.startup" {
