; ModuleID = 'POJ-104-source/19/19-509.cpp'
source_filename = "POJ-104-source/19/19-509.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_19_509.cpp, i8* null }]
...
28:                                               ; preds = %23
  ...
  %34 = call i32 @strcmp(i8* %32, i8* %33) #6
  %35 = icmp eq i32 %34, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_19_509.cpp() #0 section ".text.startup" {
