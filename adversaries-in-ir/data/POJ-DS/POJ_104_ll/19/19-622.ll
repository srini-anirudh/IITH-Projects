; ModuleID = 'POJ-104-source/19/19-622.cpp'
source_filename = "POJ-104-source/19/19-622.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_19_622.cpp, i8* null }]
...
3:                                                ; preds = %8, %0
  ...
  %5 = call i32 @feof(%struct._IO_FILE* %4) #3
  %6 = icmp ne i32 %5, 0
  %7 = xor i1 %6, true
...
23:                                               ; preds = %18
  ...
  %33 = call i32 @strcmp(i8* %27, i8* %32) #6
  %34 = icmp eq i32 %33, 0
...
52:                                               ; preds = %18
  ...
  %63 = call i32 @strcmp(i8* %57, i8* %62) #6
  %64 = icmp eq i32 %63, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_19_622.cpp() #0 section ".text.startup" {
