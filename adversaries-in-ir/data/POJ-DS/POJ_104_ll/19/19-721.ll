; ModuleID = 'POJ-104-source/19/19-721.cpp'
source_filename = "POJ-104-source/19/19-721.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_19_721.cpp, i8* null }]
...
26:                                               ; preds = %21
  ...
  %30 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i8* %29)
  store i32 0, i32* %6, align 4
  br label %31
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_19_721.cpp() #0 section ".text.startup" {
