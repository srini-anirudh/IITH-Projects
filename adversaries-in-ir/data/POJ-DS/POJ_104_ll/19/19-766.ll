; ModuleID = 'POJ-104-source/19/19-766.cpp'
source_filename = "POJ-104-source/19/19-766.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_19_766.cpp, i8* null }]
...
34:                                               ; preds = %27, %10
  ...
  %36 = call i8* @strcpy(i8* %35, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0)) #3
  %37 = load i8*, i8** %4, align 8
  %38 = call i8* @strcpy(i8* %37, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0)) #3
...
47:                                               ; preds = %43
  ...
  %53 = call i32 @strcmp(i8* %48, i8* %52) #6
  %54 = icmp eq i32 %53, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_19_766.cpp() #0 section ".text.startup" {
