; ModuleID = 'POJ-104-source/19/19-89.cpp'
source_filename = "POJ-104-source/19/19-89.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_19_89.cpp, i8* null }]
...
32:                                               ; preds = %29
  ...
  %42 = call i32 @strcmp(i8* %36, i8* %41) #6
  %43 = icmp eq i32 %42, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_19_89.cpp() #0 section ".text.startup" {
