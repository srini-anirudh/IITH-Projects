; ModuleID = 'POJ-104-source/2/2-1008.cpp'
source_filename = "POJ-104-source/2/2-1008.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_1008.cpp, i8* null }]
...
27:                                               ; preds = %22
  ...
  %30 = getelementptr inbounds [1000 x %struct.data], [1000 x %struct.data]* %9, i64 0, i64 %29
  %31 = getelementptr inbounds %struct.data, %struct.data* %30, i32 0, i32 0
  %32 = load i32, i32* %3, align 4
  %33 = sext i32 %32 to i64
  %34 = getelementptr inbounds [1000 x %struct.data], [1000 x %struct.data]* %9, i64 0, i64 %33
...
50:                                               ; preds = %45
  ...
  %53 = getelementptr inbounds [1000 x %struct.data], [1000 x %struct.data]* %9, i64 0, i64 %52
...
103:                                              ; preds = %98
  ...
  %106 = getelementptr inbounds [1000 x %struct.data], [1000 x %struct.data]* %9, i64 0, i64 %105
...
116:                                              ; preds = %111
  ...
  %119 = getelementptr inbounds [1000 x %struct.data], [1000 x %struct.data]* %9, i64 0, i64 %118
...
129:                                              ; preds = %116
  ...
  %132 = getelementptr inbounds [1000 x %struct.data], [1000 x %struct.data]* %9, i64 0, i64 %131
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_1008.cpp() #0 section ".text.startup" {
