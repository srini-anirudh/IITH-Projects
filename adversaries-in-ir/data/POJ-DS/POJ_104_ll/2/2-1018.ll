; ModuleID = 'POJ-104-source/2/2-1018.cpp'
source_filename = "POJ-104-source/2/2-1018.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_1018.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local signext i8 @_Z7maxbookPi(i32* %0) #0 {
...
define dso_local i32 @_Z7containPcc(i8* %0, i8 signext %1) #4 {
  %3 = alloca i32, align 4
  %4 = alloca i8*, align 8
  %5 = alloca i8, align 1
  %6 = alloca i8*, align 8
...
56:                                               ; preds = %11
  %57 = getelementptr inbounds [26 x i32], [26 x i32]* %8, i64 0, i64 0
  %58 = call signext i8 @_Z7maxbookPi(i32* %57)
...
63:                                               ; preds = %59
  ...
  %66 = getelementptr inbounds [1000 x %struct.BOOK], [1000 x %struct.BOOK]* %2, i64 0, i64 %65
  %67 = getelementptr inbounds %struct.BOOK, %struct.BOOK* %66, i32 0, i32 1
  %68 = getelementptr inbounds [26 x i8], [26 x i8]* %67, i64 0, i64 0
  %69 = load i8, i8* %7, align 1
  %70 = call i32 @_Z7containPcc(i8* %68, i8 signext %69)
  %71 = icmp ne i32 %70, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_1018.cpp() #0 section ".text.startup" {
