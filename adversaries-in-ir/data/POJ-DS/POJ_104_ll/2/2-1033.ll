; ModuleID = 'POJ-104-source/2/2-1033.cpp'
source_filename = "POJ-104-source/2/2-1033.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_1033.cpp, i8* null }]
...
21:                                               ; preds = %17
  ...
  %29 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %24, i8* %28)
...
118:                                              ; preds = %106
  ...
  %123 = call i8* @strcpy(i8* %122, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i64 0, i64 0)) #3
  br label %128
...
137:                                              ; preds = %133
  ...
  %142 = call i32 @strcmp(i8* %141, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i64 0, i64 0)) #7
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_1033.cpp() #0 section ".text.startup" {
