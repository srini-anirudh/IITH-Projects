; ModuleID = 'POJ-104-source/2/2-1049.cpp'
source_filename = "POJ-104-source/2/2-1049.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_1049.cpp, i8* null }]
...
42:                                               ; preds = %38
  ...
  %48 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), [30 x i8]* %12)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_1049.cpp() #0 section ".text.startup" {
