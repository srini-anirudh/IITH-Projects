; ModuleID = 'POJ-104-source/2/2-1052.cpp'
source_filename = "POJ-104-source/2/2-1052.cpp"
...
@a = dso_local global [26 x %struct.author] zeroinitializer, align 16
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [5 x i8] c"%d%s\00", align 1
@.str.2 = private unnamed_addr constant [7 x i8] c"%c\0A%d\0A\00", align 1
@.str.3 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_1052.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %5, i8* %16)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_1052.cpp() #0 section ".text.startup" {
