; ModuleID = 'POJ-104-source/2/2-1076.cpp'
source_filename = "POJ-104-source/2/2-1076.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_1076.cpp, i8* null }]
...
14:                                               ; preds = %10
  ...
  %17 = getelementptr inbounds [999 x %struct.books], [999 x %struct.books]* @book, i64 0, i64 %16
...
33:                                               ; preds = %29
  ...
  %36 = call i32 @_Z1fP5booksic(%struct.books* getelementptr inbounds ([999 x %struct.books], [999 x %struct.books]* @book, i64 0, i64 0), i32 %34, i8 signext %35)
...
78:                                               ; preds = %110, %77
  ...
  %81 = getelementptr inbounds [999 x %struct.books], [999 x %struct.books]* @book, i64 0, i64 %80
  %82 = getelementptr inbounds %struct.books, %struct.books* %81, i32 0, i32 1
...
89:                                               ; preds = %78
  ...
  %92 = getelementptr inbounds [999 x %struct.books], [999 x %struct.books]* @book, i64 0, i64 %91
  %93 = getelementptr inbounds %struct.books, %struct.books* %92, i32 0, i32 1
...
define dso_local i32 @_Z1fP5booksic(%struct.books* %0, i32 %1, i8 signext %2) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_1076.cpp() #0 section ".text.startup" {
