; ModuleID = 'POJ-104-source/2/2-1095.cpp'
source_filename = "POJ-104-source/2/2-1095.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_1095.cpp, i8* null }]
...
16:                                               ; preds = %12
  ...
  %19 = getelementptr inbounds [100 x %struct.book], [100 x %struct.book]* %9, i64 0, i64 %18
  %20 = getelementptr inbounds %struct.book, %struct.book* %19, i32 0, i32 0
  %21 = load i32, i32* %2, align 4
  %22 = sext i32 %21 to i64
  %23 = getelementptr inbounds [100 x %struct.book], [100 x %struct.book]* %9, i64 0, i64 %22
  %24 = getelementptr inbounds %struct.book, %struct.book* %23, i32 0, i32 1
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %20, [20 x i8]* %24)
  br label %26
...
35:                                               ; preds = %62, %34
  ...
  %38 = getelementptr inbounds [100 x %struct.book], [100 x %struct.book]* %9, i64 0, i64 %37
...
46:                                               ; preds = %35
  ...
  %49 = getelementptr inbounds [100 x %struct.book], [100 x %struct.book]* %9, i64 0, i64 %48
...
111:                                              ; preds = %100
  ...
  %114 = getelementptr inbounds [100 x %struct.book], [100 x %struct.book]* %9, i64 0, i64 %113
...
126:                                              ; preds = %111
  ...
  %129 = getelementptr inbounds [100 x %struct.book], [100 x %struct.book]* %9, i64 0, i64 %128
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_1095.cpp() #0 section ".text.startup" {
