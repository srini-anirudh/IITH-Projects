; ModuleID = 'POJ-104-source/2/2-11.cpp'
source_filename = "POJ-104-source/2/2-11.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_11.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %10 = alloca [999 x %struct.books], align 16
...
27:                                               ; preds = %23
  ...
  %30 = getelementptr inbounds [999 x %struct.books], [999 x %struct.books]* %10, i64 0, i64 %29
  %31 = getelementptr inbounds %struct.books, %struct.books* %30, i32 0, i32 0
  %32 = load i32, i32* %4, align 4
  %33 = sext i32 %32 to i64
  %34 = getelementptr inbounds [999 x %struct.books], [999 x %struct.books]* %10, i64 0, i64 %33
  ...
  %37 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %31, i8* %36)
  br label %38
...
47:                                               ; preds = %72, %46
  ...
  %52 = getelementptr inbounds [999 x %struct.books], [999 x %struct.books]* %10, i64 0, i64 %51
...
57:                                               ; preds = %47
  ...
  %60 = getelementptr inbounds [999 x %struct.books], [999 x %struct.books]* %10, i64 0, i64 %59
...
110:                                              ; preds = %141, %109
  ...
  %115 = getelementptr inbounds [999 x %struct.books], [999 x %struct.books]* %10, i64 0, i64 %114
...
120:                                              ; preds = %110
  ...
  %123 = getelementptr inbounds [999 x %struct.books], [999 x %struct.books]* %10, i64 0, i64 %122
  %124 = getelementptr inbounds %struct.books, %struct.books* %123, i32 0, i32 1
...
133:                                              ; preds = %120
  ...
  %136 = getelementptr inbounds [999 x %struct.books], [999 x %struct.books]* %10, i64 0, i64 %135
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_11.cpp() #0 section ".text.startup" {
