; ModuleID = 'POJ-104-source/2/2-1108.cpp'
source_filename = "POJ-104-source/2/2-1108.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_1108.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %13 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %2)
  %14 = load i32, i32* %2, align 4
  %15 = call %struct.book* @_Z5creati(i32 %14)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_1108.cpp() #0 section ".text.startup" {
