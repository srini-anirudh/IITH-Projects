; ModuleID = 'POJ-104-source/2/2-1138.cpp'
source_filename = "POJ-104-source/2/2-1138.cpp"
...
@c = dso_local global [26 x i32] zeroinitializer, align 16
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_1138.cpp, i8* null }]
...
18:                                               ; preds = %14
  ...
  %26 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %21, i8* %25)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_1138.cpp() #0 section ".text.startup" {
