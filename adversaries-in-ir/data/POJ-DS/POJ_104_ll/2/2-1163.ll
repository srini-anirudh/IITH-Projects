; ModuleID = 'POJ-104-source/2/2-1163.cpp'
source_filename = "POJ-104-source/2/2-1163.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_1163.cpp, i8* null }]
...
73:                                               ; preds = %30
  %74 = getelementptr inbounds [26 x i32], [26 x i32]* %7, i64 0, i64 0
  %75 = call i32 @_Z3maxPi(i32* %74)
...
104:                                              ; preds = %91
  ...
  %107 = getelementptr inbounds [999 x %struct.book], [999 x %struct.book]* %8, i64 0, i64 %106
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_1163.cpp() #0 section ".text.startup" {
