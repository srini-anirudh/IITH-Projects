; ModuleID = 'POJ-104-source/2/2-1190.cpp'
source_filename = "POJ-104-source/2/2-1190.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_1190.cpp, i8* null }]
...
103:                                              ; preds = %99
  ...
  %106 = getelementptr inbounds [999 x %struct.Book], [999 x %struct.Book]* %8, i64 0, i64 %105
...
116:                                              ; preds = %103
  ...
  %119 = getelementptr inbounds [999 x %struct.Book], [999 x %struct.Book]* %8, i64 0, i64 %118
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_1190.cpp() #0 section ".text.startup" {
