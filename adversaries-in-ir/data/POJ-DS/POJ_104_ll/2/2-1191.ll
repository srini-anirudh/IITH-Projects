; ModuleID = 'POJ-104-source/2/2-1191.cpp'
source_filename = "POJ-104-source/2/2-1191.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_1191.cpp, i8* null }]
...
define dso_local %struct.info* @_Z6createi(i32 %0) #0 {
  ...
  %14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %10, i8* %13)
...
23:                                               ; preds = %19
  ...
  %31 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %27, i8* %30)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_1191.cpp() #0 section ".text.startup" {
