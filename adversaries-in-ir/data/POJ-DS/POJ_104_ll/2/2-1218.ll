; ModuleID = 'POJ-104-source/2/2-1218.cpp'
source_filename = "POJ-104-source/2/2-1218.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_1218.cpp, i8* null }]
...
25:                                               ; preds = %21
  ...
  %35 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %29, i8* %34)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_1218.cpp() #0 section ".text.startup" {
