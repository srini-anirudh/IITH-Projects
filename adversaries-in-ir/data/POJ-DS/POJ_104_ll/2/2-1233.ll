; ModuleID = 'POJ-104-source/2/2-1233.cpp'
source_filename = "POJ-104-source/2/2-1233.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_1233.cpp, i8* null }]
...
18:                                               ; preds = %14
  ...
  %28 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %22, i8* %27)
  br label %29
...
41:                                               ; preds = %37
  ...
  %48 = call i32 @_Z5judgePci(i8* %46, i32 %47)
  %49 = icmp eq i32 %48, 1
...
99:                                               ; preds = %95
  ...
  %106 = call i32 @_Z5judgePci(i8* %104, i32 %105)
...
define dso_local i32 @_Z5judgePci(i8* %0, i32 %1) #6 {
  %3 = alloca i32, align 4
  %4 = alloca i8*, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_1233.cpp() #0 section ".text.startup" {
