; ModuleID = 'POJ-104-source/2/2-1240.cpp'
source_filename = "POJ-104-source/2/2-1240.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_1240.cpp, i8* null }]
...
9:                                                ; preds = %1
  %10 = call noalias i8* @malloc(i64 40) #3
  ...
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %13, i8* %16)
...
29:                                               ; preds = %25
  ...
  %37 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %33, i8* %36)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_1240.cpp() #0 section ".text.startup" {
