; ModuleID = 'POJ-104-source/2/2-1250.cpp'
source_filename = "POJ-104-source/2/2-1250.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_1250.cpp, i8* null }]
...
108:                                              ; preds = %98
  ...
  %111 = getelementptr inbounds [999 x %struct.book], [999 x %struct.book]* %2, i64 0, i64 %110
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_1250.cpp() #0 section ".text.startup" {
