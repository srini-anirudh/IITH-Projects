; ModuleID = 'POJ-104-source/2/2-1253.cpp'
source_filename = "POJ-104-source/2/2-1253.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_1253.cpp, i8* null }]
...
define dso_local %struct.book* @_Z5creati(i32 %0) #0 {
  ...
  %8 = call noalias i8* @malloc(i64 112) #3
  ...
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %14, i8* %17)
...
23:                                               ; preds = %12
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %6)
  %25 = load i32, i32* %6, align 4
  %26 = call %struct.book* @_Z5creati(i32 %25)
...
104:                                              ; preds = %101
  ...
  %111 = call i8* @_ZSt6strchrPci(i8* %108, i32 %110)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_1253.cpp() #0 section ".text.startup" {
