; ModuleID = 'POJ-104-source/2/2-1286.cpp'
source_filename = "POJ-104-source/2/2-1286.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_1286.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local %struct.zuozhe* @_Z2apv() #0 {
...
4:                                                ; preds = %31, %0
  ...
  %12 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %8, i8* %11)
...
define dso_local i32 @main() #4 {
  ...
  %12 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* @m)
  %13 = call %struct.zuozhe* @_Z2apv()
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_1286.cpp() #0 section ".text.startup" {
