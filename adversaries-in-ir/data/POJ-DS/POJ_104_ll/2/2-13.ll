; ModuleID = 'POJ-104-source/2/2-13.cpp'
source_filename = "POJ-104-source/2/2-13.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_13.cpp, i8* null }]
...
96:                                               ; preds = %92
  ...
  %104 = call i8* @_ZSt6strchrPci(i8* %101, i32 %103)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_13.cpp() #0 section ".text.startup" {
