; ModuleID = 'POJ-104-source/2/2-1313.cpp'
source_filename = "POJ-104-source/2/2-1313.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_1313.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %8 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* @m)
...
18:                                               ; preds = %14
  ...
  %30 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %23, i8* %29)
  br label %31
...
34:                                               ; preds = %14
  ...
  %35 = call noalias i8* @malloc(i64 600) #3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_1313.cpp() #0 section ".text.startup" {
