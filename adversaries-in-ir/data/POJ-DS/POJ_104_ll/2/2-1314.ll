; ModuleID = 'POJ-104-source/2/2-1314.cpp'
source_filename = "POJ-104-source/2/2-1314.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_1314.cpp, i8* null }]
...
18:                                               ; preds = %14
  ...
  %21 = getelementptr inbounds [1000 x %struct.book], [1000 x %struct.book]* %2, i64 0, i64 %20
...
32:                                               ; preds = %14
  %33 = getelementptr inbounds [1000 x %struct.book], [1000 x %struct.book]* %2, i64 0, i64 0
  ...
  %37 = getelementptr inbounds [27 x i8], [27 x i8]* %11, i64 0, i64 0
  store i8 %36, i8* %37, align 16
  store i32 1, i32* %7, align 4
  %38 = getelementptr inbounds [1000 x i32], [1000 x i32]* %10, i64 0, i64 0
...
93:                                               ; preds = %90
  ...
  %98 = getelementptr inbounds [1000 x %struct.book], [1000 x %struct.book]* %2, i64 0, i64 %97
  ...
  %107 = getelementptr inbounds [27 x i8], [27 x i8]* %11, i64 0, i64 %106
...
120:                                              ; preds = %39
  %121 = getelementptr inbounds [1000 x i32], [1000 x i32]* %10, i64 0, i64 0
...
144:                                              ; preds = %123
  ...
  %147 = getelementptr inbounds [27 x i8], [27 x i8]* %11, i64 0, i64 %146
...
157:                                              ; preds = %192, %156
  ...
  %160 = getelementptr inbounds [1000 x %struct.book], [1000 x %struct.book]* %2, i64 0, i64 %159
...
168:                                              ; preds = %157
  ...
  %171 = getelementptr inbounds [1000 x %struct.book], [1000 x %struct.book]* %2, i64 0, i64 %170
...
184:                                              ; preds = %168
  ...
  %187 = getelementptr inbounds [1000 x %struct.book], [1000 x %struct.book]* %2, i64 0, i64 %186
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_1314.cpp() #0 section ".text.startup" {
