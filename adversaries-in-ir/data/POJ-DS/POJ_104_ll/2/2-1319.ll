; ModuleID = 'POJ-104-source/2/2-1319.cpp'
source_filename = "POJ-104-source/2/2-1319.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_1319.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %2 = alloca [400 x %struct.book], align 16
...
17:                                               ; preds = %13
  ...
  %20 = getelementptr inbounds [400 x %struct.book], [400 x %struct.book]* %2, i64 0, i64 %19
  %21 = getelementptr inbounds %struct.book, %struct.book* %20, i32 0, i32 0
  %22 = load i32, i32* %3, align 4
  %23 = sext i32 %22 to i64
  %24 = getelementptr inbounds [400 x %struct.book], [400 x %struct.book]* %2, i64 0, i64 %23
  ...
  %30 = getelementptr inbounds [400 x %struct.book], [400 x %struct.book]* %2, i64 0, i64 %29
  ...
  %37 = getelementptr inbounds [400 x i32], [400 x i32]* %9, i64 0, i64 %36
...
48:                                               ; preds = %116, %47
  ...
  %52 = getelementptr inbounds [400 x i32], [400 x i32]* %9, i64 0, i64 %51
...
63:                                               ; preds = %94, %62
  ...
  %67 = getelementptr inbounds [400 x i32], [400 x i32]* %9, i64 0, i64 %66
...
70:                                               ; preds = %63
  ...
  %73 = getelementptr inbounds [400 x %struct.book], [400 x %struct.book]* %2, i64 0, i64 %72
  ...
  %82 = getelementptr inbounds [400 x %struct.book], [400 x %struct.book]* %2, i64 0, i64 %81
...
105:                                              ; preds = %101
  ...
  %109 = getelementptr inbounds [400 x %struct.book], [400 x %struct.book]* %2, i64 0, i64 %108
...
140:                                              ; preds = %133
  ...
  %145 = getelementptr inbounds [400 x %struct.book], [400 x %struct.book]* %2, i64 0, i64 %144
...
153:                                              ; preds = %140
  ...
  %156 = getelementptr inbounds [400 x %struct.book], [400 x %struct.book]* %2, i64 0, i64 %155
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_1319.cpp() #0 section ".text.startup" {
