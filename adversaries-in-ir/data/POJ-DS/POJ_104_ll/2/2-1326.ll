; ModuleID = 'POJ-104-source/2/2-1326.cpp'
source_filename = "POJ-104-source/2/2-1326.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_1326.cpp, i8* null }]
...
32:                                               ; preds = %27
  ...
  %44 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %37, i8* %43)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_1326.cpp() #0 section ".text.startup" {
