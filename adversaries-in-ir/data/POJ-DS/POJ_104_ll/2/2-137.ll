; ModuleID = 'POJ-104-source/2/2-137.cpp'
source_filename = "POJ-104-source/2/2-137.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_137.cpp, i8* null }]
...
18:                                               ; preds = %14
  ...
  %28 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %22, i8* %27)
  br label %29
...
49:                                               ; preds = %45
  ...
  %52 = getelementptr inbounds [999 x %struct.book], [999 x %struct.book]* @b, i64 0, i64 %51
...
104:                                              ; preds = %100
  ...
  %107 = getelementptr inbounds [999 x %struct.book], [999 x %struct.book]* @b, i64 0, i64 %106
...
116:                                              ; preds = %112
  ...
  %119 = getelementptr inbounds [999 x %struct.book], [999 x %struct.book]* @b, i64 0, i64 %118
...
129:                                              ; preds = %116
  ...
  %132 = getelementptr inbounds [999 x i32], [999 x i32]* %10, i64 0, i64 %131
...
146:                                              ; preds = %142
  ...
  %149 = getelementptr inbounds [999 x i32], [999 x i32]* %10, i64 0, i64 %148
...
152:                                              ; preds = %146
  ...
  %155 = getelementptr inbounds [999 x %struct.book], [999 x %struct.book]* @b, i64 0, i64 %154
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_137.cpp() #0 section ".text.startup" {
