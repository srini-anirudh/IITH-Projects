; ModuleID = 'POJ-104-source/2/2-141.cpp'
source_filename = "POJ-104-source/2/2-141.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_141.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %10, i8* align 16 getelementptr inbounds ([26 x i8], [26 x i8]* @__const.main.a, i32 0, i32 0), i64 26, i1 false)
...
37:                                               ; preds = %78, %36
  ...
  %42 = getelementptr inbounds [1000 x %struct.book], [1000 x %struct.book]* @bk, i64 0, i64 %41
...
51:                                               ; preds = %48
  ...
  %59 = getelementptr inbounds [1000 x %struct.book], [1000 x %struct.book]* @bk, i64 0, i64 %58
...
122:                                              ; preds = %156, %121
  ...
  %127 = getelementptr inbounds [1000 x %struct.book], [1000 x %struct.book]* @bk, i64 0, i64 %126
...
132:                                              ; preds = %122
  ...
  %135 = getelementptr inbounds [1000 x %struct.book], [1000 x %struct.book]* @bk, i64 0, i64 %134
...
148:                                              ; preds = %132
  ...
  %151 = getelementptr inbounds [1000 x %struct.book], [1000 x %struct.book]* @bk, i64 0, i64 %150
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_141.cpp() #0 section ".text.startup" {
