; ModuleID = 'POJ-104-source/2/2-147.cpp'
source_filename = "POJ-104-source/2/2-147.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_147.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %18 = getelementptr inbounds [999 x %struct.book], [999 x %struct.book]* %8, i64 0, i64 %17
  %19 = getelementptr inbounds %struct.book, %struct.book* %18, i32 0, i32 0
  %20 = load i32, i32* %3, align 4
  %21 = sext i32 %20 to i64
  %22 = getelementptr inbounds [999 x %struct.book], [999 x %struct.book]* %8, i64 0, i64 %21
...
37:                                               ; preds = %34
  ...
  %40 = getelementptr inbounds [999 x %struct.book], [999 x %struct.book]* %8, i64 0, i64 %39
...
94:                                               ; preds = %91
  ...
  %97 = getelementptr inbounds [999 x %struct.book], [999 x %struct.book]* %8, i64 0, i64 %96
...
107:                                              ; preds = %94
  ...
  %110 = getelementptr inbounds [999 x %struct.book], [999 x %struct.book]* %8, i64 0, i64 %109
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_147.cpp() #0 section ".text.startup" {
