; ModuleID = 'POJ-104-source/2/2-149.cpp'
source_filename = "POJ-104-source/2/2-149.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_149.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %13 = bitcast [999 x i32]* %10 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 16 %13, i8 0, i64 3996, i1 false)
...
19:                                               ; preds = %15
  ...
  %26 = getelementptr inbounds [999 x %struct.book], [999 x %struct.book]* %2, i64 0, i64 %25
  %27 = getelementptr inbounds %struct.book, %struct.book* %26, i32 0, i32 1
  %28 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %23, [20 x i8]* %27)
  ...
  %42 = call i8* @strcpy(i8* %36, i8* %41) #3
...
47:                                               ; preds = %43
  ...
  %53 = getelementptr inbounds [999 x i32], [999 x i32]* %10, i64 0, i64 %52
  ...
  %61 = getelementptr inbounds [999 x i32], [999 x i32]* %10, i64 0, i64 %60
...
73:                                               ; preds = %70
  ...
  %76 = getelementptr inbounds [999 x i32], [999 x i32]* %10, i64 0, i64 %75
...
80:                                               ; preds = %73
  ...
  %83 = getelementptr inbounds [999 x i32], [999 x i32]* %10, i64 0, i64 %82
...
99:                                               ; preds = %95
  %100 = getelementptr inbounds [20 x i8], [20 x i8]* %12, i64 0, i64 0
  %101 = load i32, i32* %4, align 4
  %102 = sext i32 %101 to i64
  %103 = getelementptr inbounds [999 x %struct.book], [999 x %struct.book]* %2, i64 0, i64 %102
  ...
  %109 = getelementptr inbounds [999 x %struct.book], [999 x %struct.book]* %2, i64 0, i64 %108
...
118:                                              ; preds = %114
  ...
  %121 = getelementptr inbounds [20 x i8], [20 x i8]* %12, i64 0, i64 %120
...
126:                                              ; preds = %118
  ...
  %129 = getelementptr inbounds [999 x %struct.book], [999 x %struct.book]* %2, i64 0, i64 %128
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_149.cpp() #0 section ".text.startup" {
