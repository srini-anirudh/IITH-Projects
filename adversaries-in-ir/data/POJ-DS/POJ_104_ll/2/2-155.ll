; ModuleID = 'POJ-104-source/2/2-155.cpp'
source_filename = "POJ-104-source/2/2-155.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_155.cpp, i8* null }]
...
14:                                               ; preds = %10
  ...
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32* %18, i8* %23)
  br label %25
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_155.cpp() #0 section ".text.startup" {
