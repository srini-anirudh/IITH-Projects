; ModuleID = 'POJ-104-source/2/2-17.cpp'
source_filename = "POJ-104-source/2/2-17.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_17.cpp, i8* null }]
...
19:                                               ; preds = %15
  ...
  %29 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %23, i8* %28)
  br label %30
...
39:                                               ; preds = %77, %38
  ...
  %42 = getelementptr inbounds [1000 x %struct.anon], [1000 x %struct.anon]* %12, i64 0, i64 %41
...
53:                                               ; preds = %50
  ...
  %56 = getelementptr inbounds [1000 x %struct.anon], [1000 x %struct.anon]* %12, i64 0, i64 %55
...
119:                                              ; preds = %154, %118
  ...
  %122 = getelementptr inbounds [1000 x %struct.anon], [1000 x %struct.anon]* %12, i64 0, i64 %121
...
129:                                              ; preds = %119
  ...
  %132 = getelementptr inbounds [1000 x %struct.anon], [1000 x %struct.anon]* %12, i64 0, i64 %131
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_17.cpp() #0 section ".text.startup" {
