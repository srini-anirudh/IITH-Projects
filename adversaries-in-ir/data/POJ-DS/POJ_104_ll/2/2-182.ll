; ModuleID = 'POJ-104-source/2/2-182.cpp'
source_filename = "POJ-104-source/2/2-182.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_182.cpp, i8* null }]
...
16:                                               ; preds = %12
  ...
  %19 = getelementptr inbounds [999 x %struct.author], [999 x %struct.author]* @a, i64 0, i64 %18
  ...
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %20, [27 x i8]* %24)
  %26 = load i32, i32* %3, align 4
  %27 = sext i32 %26 to i64
  %28 = getelementptr inbounds [999 x %struct.author], [999 x %struct.author]* @a, i64 0, i64 %27
...
37:                                               ; preds = %33
  ...
  %40 = getelementptr inbounds [999 x %struct.author], [999 x %struct.author]* @a, i64 0, i64 %39
...
81:                                               ; preds = %61
  ...
  call void @_Z6searchP6authoric(%struct.author* getelementptr inbounds ([999 x %struct.author], [999 x %struct.author]* @a, i64 0, i64 0), i32 %88, i8 signext %91)
...
; Function Attrs: noinline uwtable
define dso_local void @_Z6searchP6authoric(%struct.author* %0, i32 %1, i8 signext %2) #0 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_182.cpp() #0 section ".text.startup" {
