; ModuleID = 'POJ-104-source/2/2-183.cpp'
source_filename = "POJ-104-source/2/2-183.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_183.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %14 = alloca %struct.book, i64 %12, align 16
...
19:                                               ; preds = %15
  ...
  %22 = getelementptr inbounds %struct.book, %struct.book* %14, i64 %21
  %23 = getelementptr inbounds %struct.book, %struct.book* %22, i32 0, i32 0
  %24 = load i32, i32* %3, align 4
  %25 = sext i32 %24 to i64
  %26 = getelementptr inbounds %struct.book, %struct.book* %14, i64 %25
...
39:                                               ; preds = %64, %38
  ...
  %44 = getelementptr inbounds %struct.book, %struct.book* %14, i64 %43
...
49:                                               ; preds = %39
  ...
  %52 = getelementptr inbounds %struct.book, %struct.book* %14, i64 %51
...
104:                                              ; preds = %135, %103
  ...
  %109 = getelementptr inbounds %struct.book, %struct.book* %14, i64 %108
...
114:                                              ; preds = %104
  ...
  %117 = getelementptr inbounds %struct.book, %struct.book* %14, i64 %116
...
127:                                              ; preds = %114
  ...
  %130 = getelementptr inbounds %struct.book, %struct.book* %14, i64 %129
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_183.cpp() #0 section ".text.startup" {
