; ModuleID = 'POJ-104-source/2/2-186.cpp'
source_filename = "POJ-104-source/2/2-186.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_186.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %19, [27 x i8]* %23)
  br label %25
...
28:                                               ; preds = %11
  ...
  call void @_Z15number_of_booksiPiP4book(i32 %29, i32* %30, %struct.book* %31)
  %32 = load i32, i32* %6, align 4
  %33 = load i32*, i32** %2, align 8
  %34 = getelementptr inbounds [1000 x %struct.book], [1000 x %struct.book]* %5, i64 0, i64 0
  %35 = call signext i8 @_Z3maxiPiP4book(i32 %32, i32* %33, %struct.book* %34)
  ...
  call void @_Z12name_of_bookiPiP4booki(i32 %45, i32* %46, %struct.book* %47, i32 %49)
  ret i32 0
}
...
define dso_local void @_Z15number_of_booksiPiP4book(i32 %0, i32* %1, %struct.book* %2) #5 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local signext i8 @_Z3maxiPiP4book(i32 %0, i32* %1, %struct.book* %2) #5 {
  %4 = alloca i32, align 4
  %5 = alloca i32*, align 8
  %6 = alloca %struct.book*, align 8
  %7 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define dso_local void @_Z12name_of_bookiPiP4booki(i32 %0, i32* %1, %struct.book* %2, i32 %3) #0 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_186.cpp() #0 section ".text.startup" {
