; ModuleID = 'POJ-104-source/2/2-200.cpp'
source_filename = "POJ-104-source/2/2-200.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_200.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %12 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* %7)
...
17:                                               ; preds = %13
  ...
  %28 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %22, i8* %27)
...
40:                                               ; preds = %36
  ...
  %43 = getelementptr inbounds [1000 x %struct.book], [1000 x %struct.book]* %2, i64 0, i64 %42
...
92:                                               ; preds = %88
  ...
  %95 = getelementptr inbounds [1000 x %struct.book], [1000 x %struct.book]* %2, i64 0, i64 %94
...
104:                                              ; preds = %100
  ...
  %107 = getelementptr inbounds [1000 x %struct.book], [1000 x %struct.book]* %2, i64 0, i64 %106
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_200.cpp() #0 section ".text.startup" {
