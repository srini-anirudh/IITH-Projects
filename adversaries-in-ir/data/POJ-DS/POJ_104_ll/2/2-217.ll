; ModuleID = 'POJ-104-source/2/2-217.cpp'
source_filename = "POJ-104-source/2/2-217.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_217.cpp, i8* null }]
...
30:                                               ; preds = %26
  ...
  %42 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %35, i8* %41)
  br label %43
...
69:                                               ; preds = %65
  ...
  %73 = getelementptr inbounds %struct.book, %struct.book* %70, i64 %72
...
83:                                               ; preds = %69
  ...
  %87 = getelementptr inbounds %struct.book, %struct.book* %84, i64 %86
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_217.cpp() #0 section ".text.startup" {
