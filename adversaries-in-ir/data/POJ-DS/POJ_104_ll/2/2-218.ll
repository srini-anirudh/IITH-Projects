; ModuleID = 'POJ-104-source/2/2-218.cpp'
source_filename = "POJ-104-source/2/2-218.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_218.cpp, i8* null }]
...
24:                                               ; preds = %20
  %25 = load %struct.book*, %struct.book** %10, align 8
  %26 = load i32, i32* %3, align 4
  %27 = sext i32 %26 to i64
  %28 = getelementptr inbounds %struct.book, %struct.book* %25, i64 %27
  ...
  %36 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %29, i8* %35)
...
49:                                               ; preds = %37
  ...
  %53 = getelementptr inbounds %struct.book, %struct.book* %50, i64 %52
...
74:                                               ; preds = %71
  ...
  %78 = getelementptr inbounds [150 x i32], [150 x i32]* %6, i64 0, i64 %77
...
81:                                               ; preds = %74
  ...
  %84 = getelementptr inbounds [150 x i32], [150 x i32]* %6, i64 0, i64 %83
...
101:                                              ; preds = %128, %100
  %102 = load %struct.book*, %struct.book** %10, align 8
  %103 = load i32, i32* %3, align 4
  %104 = sext i32 %103 to i64
  %105 = getelementptr inbounds %struct.book, %struct.book* %102, i64 %104
...
113:                                              ; preds = %101
  ...
  %117 = getelementptr inbounds %struct.book, %struct.book* %114, i64 %116
...
134:                                              ; preds = %131
  %135 = load %struct.book*, %struct.book** %10, align 8
  %136 = load i32, i32* %3, align 4
  %137 = sext i32 %136 to i64
  %138 = getelementptr inbounds %struct.book, %struct.book* %135, i64 %137
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_218.cpp() #0 section ".text.startup" {
