; ModuleID = 'POJ-104-source/2/2-224.cpp'
source_filename = "POJ-104-source/2/2-224.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_224.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %7 = alloca i8, align 1
  %8 = alloca [999 x %struct.st], align 16
  ...
  %14 = getelementptr inbounds [999 x %struct.st], [999 x %struct.st]* %8, i64 0, i64 0
  store %struct.st* %14, %struct.st** %9, align 8
  br label %15

15:                                               ; preds = %29, %0
  %16 = load %struct.st*, %struct.st** %9, align 8
  %17 = getelementptr inbounds [999 x %struct.st], [999 x %struct.st]* %8, i64 0, i64 0
  %18 = load i32, i32* %2, align 4
  %19 = sext i32 %18 to i64
  %20 = getelementptr inbounds %struct.st, %struct.st* %17, i64 %19
  %21 = icmp ult %struct.st* %16, %20
  br i1 %21, label %22, label %32

22:                                               ; preds = %15
  %23 = load %struct.st*, %struct.st** %9, align 8
  %24 = getelementptr inbounds %struct.st, %struct.st* %23, i32 0, i32 0
  %25 = load %struct.st*, %struct.st** %9, align 8
  %26 = getelementptr inbounds %struct.st, %struct.st* %25, i32 0, i32 1
  %27 = getelementptr inbounds [27 x i8], [27 x i8]* %26, i64 0, i64 0
  %28 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %24, i8* %27)
  br label %29

29:                                               ; preds = %22
  %30 = load %struct.st*, %struct.st** %9, align 8
  %31 = getelementptr inbounds %struct.st, %struct.st* %30, i32 1
  store %struct.st* %31, %struct.st** %9, align 8
  br label %15
...
38:                                               ; preds = %60, %37
  ...
  %41 = getelementptr inbounds [999 x %struct.st], [999 x %struct.st]* %8, i64 0, i64 %40
...
101:                                              ; preds = %128, %100
  ...
  %104 = getelementptr inbounds [999 x %struct.st], [999 x %struct.st]* %8, i64 0, i64 %103
...
115:                                              ; preds = %101
  ...
  %118 = getelementptr inbounds [999 x %struct.st], [999 x %struct.st]* %8, i64 0, i64 %117
  %119 = getelementptr inbounds %struct.st, %struct.st* %118, i32 0, i32 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_224.cpp() #0 section ".text.startup" {
