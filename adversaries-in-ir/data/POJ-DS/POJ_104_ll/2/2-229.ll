; ModuleID = 'POJ-104-source/2/2-229.cpp'
source_filename = "POJ-104-source/2/2-229.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_229.cpp, i8* null }]
...
17:                                               ; preds = %13
  ...
  %26 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %21, [10 x i8]* %25)
  br label %27
...
36:                                               ; preds = %63, %35
  ...
  %39 = getelementptr inbounds [1000 x %struct.book], [1000 x %struct.book]* %2, i64 0, i64 %38
...
106:                                              ; preds = %138, %105
  ...
  %109 = getelementptr inbounds [1000 x %struct.book], [1000 x %struct.book]* %2, i64 0, i64 %108
...
117:                                              ; preds = %106
  ...
  %120 = getelementptr inbounds [1000 x %struct.book], [1000 x %struct.book]* %2, i64 0, i64 %119
...
130:                                              ; preds = %117
  ...
  %133 = getelementptr inbounds [1000 x %struct.book], [1000 x %struct.book]* %2, i64 0, i64 %132
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_229.cpp() #0 section ".text.startup" {
