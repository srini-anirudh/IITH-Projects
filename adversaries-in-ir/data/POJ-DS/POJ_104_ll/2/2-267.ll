; ModuleID = 'POJ-104-source/2/2-267.cpp'
source_filename = "POJ-104-source/2/2-267.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_267.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %18 = getelementptr inbounds [1000 x %struct.book], [1000 x %struct.book]* %9, i64 0, i64 %17
...
46:                                               ; preds = %42
  ...
  %49 = getelementptr inbounds [1000 x %struct.book], [1000 x %struct.book]* %9, i64 0, i64 %48
...
130:                                              ; preds = %126
  ...
  %133 = getelementptr inbounds [1000 x %struct.book], [1000 x %struct.book]* %9, i64 0, i64 %132
  %134 = getelementptr inbounds %struct.book, %struct.book* %133, i32 0, i32 1
  %135 = getelementptr inbounds [27 x i8], [27 x i8]* %134, i64 0, i64 0
...
142:                                              ; preds = %138
  ...
  %145 = getelementptr inbounds [1000 x %struct.book], [1000 x %struct.book]* %9, i64 0, i64 %144
...
154:                                              ; preds = %142
  ...
  %157 = getelementptr inbounds [1000 x %struct.book], [1000 x %struct.book]* %9, i64 0, i64 %156
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_267.cpp() #0 section ".text.startup" {
