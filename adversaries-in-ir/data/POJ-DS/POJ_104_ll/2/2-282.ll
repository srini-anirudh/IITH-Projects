; ModuleID = 'POJ-104-source/2/2-282.cpp'
source_filename = "POJ-104-source/2/2-282.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_282.cpp, i8* null }]
...
define dso_local i32 @_Z3maxP6author(%struct.author* %0) #4 {
...
14:                                               ; preds = %11
  ...
  %20 = getelementptr inbounds [26 x %struct.author], [26 x %struct.author]* @aut, i64 0, i64 %19
...
34:                                               ; preds = %30
  ...
  %40 = getelementptr inbounds [1000 x [27 x i8]], [1000 x [27 x i8]]* %9, i64 0, i64 %39
  %41 = getelementptr inbounds [27 x i8], [27 x i8]* %40, i64 0, i64 0
  %42 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %37, i8* %41)
  %43 = load i32, i32* %4, align 4
  %44 = sext i32 %43 to i64
  %45 = getelementptr inbounds [1000 x [27 x i8]], [1000 x [27 x i8]]* %9, i64 0, i64 %44
...
63:                                               ; preds = %56
  ...
  %66 = getelementptr inbounds [1000 x [27 x i8]], [1000 x [27 x i8]]* %9, i64 0, i64 %65
  ...
  %74 = getelementptr inbounds [26 x %struct.author], [26 x %struct.author]* @aut, i64 0, i64 %73
  %75 = getelementptr inbounds %struct.author, %struct.author* %74, i32 0, i32 0
...
79:                                               ; preds = %63
  ...
  %82 = getelementptr inbounds [26 x %struct.author], [26 x %struct.author]* @aut, i64 0, i64 %81
  %83 = getelementptr inbounds %struct.author, %struct.author* %82, i32 0, i32 1
...
102:                                              ; preds = %99
  ...
  %105 = getelementptr inbounds [26 x %struct.author], [26 x %struct.author]* @aut, i64 0, i64 %104
  %106 = getelementptr inbounds %struct.author, %struct.author* %105, i32 0, i32 1
  %107 = load i32, i32* %106, align 4
  %108 = call i32 @_Z3maxP6author(%struct.author* getelementptr inbounds ([26 x %struct.author], [26 x %struct.author]* @aut, i64 0, i64 0))
...
110:                                              ; preds = %102
  ...
  %113 = getelementptr inbounds [26 x %struct.author], [26 x %struct.author]* @aut, i64 0, i64 %112
...
123:                                              ; preds = %99
  %124 = call i32 @_Z3maxP6author(%struct.author* getelementptr inbounds ([26 x %struct.author], [26 x %struct.author]* @aut, i64 0, i64 0))
...
130:                                              ; preds = %126
  ...
  %133 = getelementptr inbounds [1000 x [27 x i8]], [1000 x [27 x i8]]* %9, i64 0, i64 %132
...
147:                                              ; preds = %140
  ...
  %150 = getelementptr inbounds [1000 x [27 x i8]], [1000 x [27 x i8]]* %9, i64 0, i64 %149
  ...
  %158 = getelementptr inbounds [26 x %struct.author], [26 x %struct.author]* @aut, i64 0, i64 %157
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_282.cpp() #0 section ".text.startup" {
