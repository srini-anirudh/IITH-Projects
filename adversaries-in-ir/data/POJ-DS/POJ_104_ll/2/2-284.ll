; ModuleID = 'POJ-104-source/2/2-284.cpp'
source_filename = "POJ-104-source/2/2-284.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_284.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i64* %19)
  ...
  %26 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i8* %25)
  br label %27
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_284.cpp() #0 section ".text.startup" {
