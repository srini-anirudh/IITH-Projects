; ModuleID = 'POJ-104-source/2/2-301.cpp'
source_filename = "POJ-104-source/2/2-301.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_301.cpp, i8* null }]
...
13:                                               ; preds = %9
  ...
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i16* %17, [27 x i8]* %21)
  br label %23
...
26:                                               ; preds = %9
  ...
  %30 = call signext i8 @_Z10findoutmaxP4infoiPi(%struct.info* %27, i32 %28, i32* %29)
  ...
  call void @_Z6detectP4infoci(%struct.info* %35, i8 signext %36, i32 %37)
  ret i32 0
}
...
define dso_local signext i8 @_Z10findoutmaxP4infoiPi(%struct.info* %0, i32 %1, i32* %2) #5 {
...
; Function Attrs: noinline uwtable
define dso_local void @_Z6detectP4infoci(%struct.info* %0, i8 signext %1, i32 %2) #0 {
  %4 = alloca %struct.info*, align 8
  %5 = alloca i8, align 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_301.cpp() #0 section ".text.startup" {
