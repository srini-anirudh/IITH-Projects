; ModuleID = 'POJ-104-source/2/2-315.cpp'
source_filename = "POJ-104-source/2/2-315.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_315.cpp, i8* null }]
...
69:                                               ; preds = %57
  ...
  %77 = getelementptr inbounds [27 x i32], [27 x i32]* %4, i64 0, i64 %76
...
114:                                              ; preds = %111
  ...
  %117 = getelementptr inbounds [27 x i32], [27 x i32]* %4, i64 0, i64 %116
...
121:                                              ; preds = %114
  ...
  %127 = getelementptr inbounds [27 x i32], [27 x i32]* %4, i64 0, i64 %126
...
142:                                              ; preds = %135
  ...
  %145 = getelementptr inbounds [1000 x [100 x i8]], [1000 x [100 x i8]]* %2, i64 0, i64 %144
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_315.cpp() #0 section ".text.startup" {
