; ModuleID = 'POJ-104-source/2/2-329.cpp'
source_filename = "POJ-104-source/2/2-329.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_329.cpp, i8* null }]
...
16:                                               ; preds = %12
  ...
  %22 = getelementptr inbounds [1000 x [30 x i8]], [1000 x [30 x i8]]* %3, i64 0, i64 %21
...
38:                                               ; preds = %34
  ...
  %45 = call i8* @_ZSt6strchrPci(i8* %42, i32 %44)
...
96:                                               ; preds = %92
  ...
  %99 = getelementptr inbounds [1000 x [30 x i8]], [1000 x [30 x i8]]* %3, i64 0, i64 %98
  %100 = getelementptr inbounds [30 x i8], [30 x i8]* %99, i64 0, i64 0
  %101 = load i8, i8* %4, align 1
  %102 = sext i8 %101 to i32
  %103 = call i8* @_ZSt6strchrPci(i8* %100, i32 %102)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_329.cpp() #0 section ".text.startup" {
