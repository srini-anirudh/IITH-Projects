; ModuleID = 'POJ-104-source/2/2-342.cpp'
source_filename = "POJ-104-source/2/2-342.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_342.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %9 = alloca [100 x %struct.book], align 16
  ...
  %12 = bitcast [100 x %struct.book]* %9 to i8*
...
17:                                               ; preds = %13
  ...
  %20 = getelementptr inbounds [100 x %struct.book], [100 x %struct.book]* %9, i64 0, i64 %19
  %21 = getelementptr inbounds %struct.book, %struct.book* %20, i32 0, i32 0
  %22 = load i32, i32* %3, align 4
  %23 = sext i32 %22 to i64
  %24 = getelementptr inbounds [100 x %struct.book], [100 x %struct.book]* %9, i64 0, i64 %23
  %25 = getelementptr inbounds %struct.book, %struct.book* %24, i32 0, i32 1
  %26 = getelementptr inbounds [26 x i8], [26 x i8]* %25, i64 0, i64 0
  %27 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %21, i8* %26)
  br label %28
...
36:                                               ; preds = %32
  ...
  %39 = getelementptr inbounds [100 x %struct.book], [100 x %struct.book]* %9, i64 0, i64 %38
...
48:                                               ; preds = %44
  ...
  %51 = getelementptr inbounds [100 x %struct.book], [100 x %struct.book]* %9, i64 0, i64 %50
...
100:                                              ; preds = %96
  ...
  %103 = getelementptr inbounds [100 x %struct.book], [100 x %struct.book]* %9, i64 0, i64 %102
...
112:                                              ; preds = %108
  ...
  %115 = getelementptr inbounds [100 x %struct.book], [100 x %struct.book]* %9, i64 0, i64 %114
...
125:                                              ; preds = %112
  ...
  %128 = getelementptr inbounds [100 x %struct.book], [100 x %struct.book]* %9, i64 0, i64 %127
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_342.cpp() #0 section ".text.startup" {
