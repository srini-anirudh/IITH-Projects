; ModuleID = 'POJ-104-source/2/2-35.cpp'
source_filename = "POJ-104-source/2/2-35.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_35.cpp, i8* null }]
...
17:                                               ; preds = %13
  ...
  %20 = getelementptr inbounds [1000 x %struct.data], [1000 x %struct.data]* %2, i64 0, i64 %19
  ...
  %25 = getelementptr inbounds [1000 x %struct.data], [1000 x %struct.data]* %2, i64 0, i64 %24
  ...
  %31 = getelementptr inbounds [1000 x %struct.data], [1000 x %struct.data]* %2, i64 0, i64 %30
...
55:                                               ; preds = %48
  ...
  %58 = getelementptr inbounds [1000 x %struct.data], [1000 x %struct.data]* %2, i64 0, i64 %57
  ...
  %72 = getelementptr inbounds [1000 x %struct.data], [1000 x %struct.data]* %2, i64 0, i64 %71
...
89:                                               ; preds = %43
  %90 = getelementptr inbounds [26 x i32], [26 x i32]* %7, i64 0, i64 0
...
133:                                              ; preds = %126
  ...
  %136 = getelementptr inbounds [1000 x %struct.data], [1000 x %struct.data]* %2, i64 0, i64 %135
...
146:                                              ; preds = %133
  ...
  %149 = getelementptr inbounds [1000 x %struct.data], [1000 x %struct.data]* %2, i64 0, i64 %148
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_35.cpp() #0 section ".text.startup" {
