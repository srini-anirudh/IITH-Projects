; ModuleID = 'POJ-104-source/2/2-354.cpp'
source_filename = "POJ-104-source/2/2-354.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_354.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %12 = bitcast [30 x i8]* %2 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %12, i8* align 16 getelementptr inbounds ([30 x i8], [30 x i8]* @__const.main.name, i32 0, i32 0), i64 30, i1 false)
...
19:                                               ; preds = %15
  ...
  %26 = getelementptr inbounds [1000 x [100 x i8]], [1000 x [100 x i8]]* %3, i64 0, i64 %25
...
38:                                               ; preds = %82, %37
  ...
  %41 = getelementptr inbounds [1000 x [100 x i8]], [1000 x [100 x i8]]* %3, i64 0, i64 %40
...
56:                                               ; preds = %49
  ...
  %64 = getelementptr inbounds [1000 x [100 x i8]], [1000 x [100 x i8]]* %3, i64 0, i64 %63
...
114:                                              ; preds = %90
  ...
  %124 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i64 0, i64 0), i32 %119, i32 %123)
  store i32 0, i32* %7, align 4
  br label %125
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_354.cpp() #0 section ".text.startup" {
