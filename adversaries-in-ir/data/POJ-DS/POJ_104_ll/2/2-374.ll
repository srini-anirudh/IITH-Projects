; ModuleID = 'POJ-104-source/2/2-374.cpp'
source_filename = "POJ-104-source/2/2-374.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_374.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @llvm.memset.p0i8.i64(i8* align 16 %12, i8 0, i64 108000, i1 false)
...
23:                                               ; preds = %29, %17
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* %5)
...
29:                                               ; preds = %23
  ...
  %34 = getelementptr inbounds [27 x i32], [27 x i32]* %6, i64 0, i64 %33
  ...
  %41 = getelementptr inbounds [27 x [1000 x i32]], [27 x [1000 x i32]]* %7, i64 0, i64 %40
...
53:                                               ; preds = %50
  ...
  %56 = getelementptr inbounds [27 x i32], [27 x i32]* %6, i64 0, i64 %55
...
78:                                               ; preds = %75
  ...
  %81 = getelementptr inbounds [27 x [1000 x i32]], [27 x [1000 x i32]]* %7, i64 0, i64 %80
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_374.cpp() #0 section ".text.startup" {
