; ModuleID = 'POJ-104-source/2/2-375.cpp'
source_filename = "POJ-104-source/2/2-375.cpp"
...
@cishu = dso_local global [26 x i32] zeroinitializer, align 16
@.str = private unnamed_addr constant [6 x i8] c"%d %s\00", align 1
@.str.1 = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.2 = private unnamed_addr constant [7 x i8] c"%c\0A%d\0A\00", align 1
@.str.3 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_375.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local %struct.shu* @_Z3appi(i32 %0) #0 {
...
13:                                               ; preds = %9
  ...
  %21 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %17, i8* %20)
...
define dso_local i32 @_Z3maxv() #5 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z6cunzaiPci(i8* %0, i32 %1) #5 {
  %3 = alloca i32, align 4
  %4 = alloca i8*, align 8
  %5 = alloca i32, align 4
...
define dso_local i32 @main() #6 {
  ...
  %8 = call %struct.shu* @_Z3appi(i32 %7)
...
21:                                               ; preds = %18
  ...
  %24 = getelementptr inbounds [26 x i8], [26 x i8]* %23, i64 0, i64 0
  %25 = load i32, i32* %3, align 4
  %26 = call i32 @_Z6cunzaiPci(i8* %24, i32 %25)
  %27 = icmp ne i32 %26, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_375.cpp() #0 section ".text.startup" {
