; ModuleID = 'POJ-104-source/2/2-377.cpp'
source_filename = "POJ-104-source/2/2-377.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_377.cpp, i8* null }]
...
19:                                               ; preds = %15
  %20 = call noalias i8* @malloc(i64 40) #3
...
24:                                               ; preds = %19
  ...
  %32 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %28, i8* %31)
...
63:                                               ; preds = %19
  ...
  %73 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %69, i8* %72)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_377.cpp() #0 section ".text.startup" {
