; ModuleID = 'POJ-104-source/2/2-379.cpp'
source_filename = "POJ-104-source/2/2-379.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_379.cpp, i8* null }]
...
12:                                               ; preds = %8
  ...
  %21 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %16, [27 x i8]* %20)
  br label %22
...
25:                                               ; preds = %8
  ...
  call void @_Z5jishuP5tushuPii(%struct.tushu* %26, i32* %27, i32 %28)
  %29 = getelementptr inbounds [26 x i32], [26 x i32]* %5, i64 0, i64 0
  %30 = call i32 @_Z3maxPi(i32* %29)
  store i32 %30, i32* %4, align 4
  %31 = load %struct.tushu*, %struct.tushu** %6, align 8
  %32 = load i32, i32* %4, align 4
  %33 = load i32, i32* %2, align 4
  call void @_Z3shuP5tushuii(%struct.tushu* %31, i32 %32, i32 %33)
  ret i32 0
}
...
define dso_local void @_Z5jishuP5tushuPii(%struct.tushu* %0, i32* %1, i32 %2) #5 {
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z3maxPi(i32* %0) #0 {
...
; Function Attrs: noinline uwtable
define dso_local void @_Z3shuP5tushuii(%struct.tushu* %0, i32 %1, i32 %2) #0 {
  %4 = alloca %struct.tushu*, align 8
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
  %7 = alloca i8, align 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_379.cpp() #0 section ".text.startup" {
