; ModuleID = 'POJ-104-source/2/2-383.cpp'
source_filename = "POJ-104-source/2/2-383.cpp"
...
@b = dso_local global [26 x %struct.aut] zeroinitializer, align 16
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [3 x i8] c"%s\00", align 1
@.str.2 = private unnamed_addr constant [7 x i8] c"%c\0A%d\0A\00", align 1
@.str.3 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_383.cpp, i8* null }]
...
27:                                               ; preds = %9
  %28 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %2)
  store i32 0, i32* %3, align 4
  br label %29
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_383.cpp() #0 section ".text.startup" {
