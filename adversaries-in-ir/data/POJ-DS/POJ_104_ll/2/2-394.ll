; ModuleID = 'POJ-104-source/2/2-394.cpp'
source_filename = "POJ-104-source/2/2-394.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_394.cpp, i8* null }]
...
25:                                               ; preds = %21
  ...
  %38 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %31, i8* %37)
  br label %39
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_394.cpp() #0 section ".text.startup" {
