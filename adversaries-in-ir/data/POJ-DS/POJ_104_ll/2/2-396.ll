; ModuleID = 'POJ-104-source/2/2-396.cpp'
source_filename = "POJ-104-source/2/2-396.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_396.cpp, i8* null }]
...
21:                                               ; preds = %17
  ...
  %27 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %23, i8* %26)
  br label %28
...
46:                                               ; preds = %42
  ...
  %52 = call i8* @_ZSt6strchrPci(i8* %49, i32 %51)
...
103:                                              ; preds = %99
  ...
  %109 = call i8* @_ZSt6strchrPci(i8* %106, i32 %108)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_396.cpp() #0 section ".text.startup" {
