; ModuleID = 'POJ-104-source/2/2-428.cpp'
source_filename = "POJ-104-source/2/2-428.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_428.cpp, i8* null }]
...
94:                                               ; preds = %90
  ...
  %102 = call i8* @_ZSt6strchrPci(i8* %99, i32 %101)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_428.cpp() #0 section ".text.startup" {
