; ModuleID = 'POJ-104-source/2/2-43.cpp'
source_filename = "POJ-104-source/2/2-43.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_43.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %18 = getelementptr inbounds [999 x %struct.book], [999 x %struct.book]* @b, i64 0, i64 %17
...
29:                                               ; preds = %11
  %30 = bitcast [26 x i8]* %7 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %30, i8* align 16 getelementptr inbounds ([26 x i8], [26 x i8]* @__const.main.a, i32 0, i32 0), i64 26, i1 false)
...
40:                                               ; preds = %36
  ...
  %43 = getelementptr inbounds [999 x %struct.book], [999 x %struct.book]* @b, i64 0, i64 %42
...
52:                                               ; preds = %48
  ...
  %55 = getelementptr inbounds [999 x %struct.book], [999 x %struct.book]* @b, i64 0, i64 %54
  ...
  %64 = getelementptr inbounds [26 x i8], [26 x i8]* %7, i64 0, i64 %63
...
122:                                              ; preds = %118
  ...
  %125 = getelementptr inbounds [999 x %struct.book], [999 x %struct.book]* @b, i64 0, i64 %124
  %126 = getelementptr inbounds %struct.book, %struct.book* %125, i32 0, i32 1
  %127 = getelementptr inbounds [26 x i8], [26 x i8]* %126, i64 0, i64 0
...
134:                                              ; preds = %130
  ...
  %137 = getelementptr inbounds [999 x %struct.book], [999 x %struct.book]* @b, i64 0, i64 %136
  ...
  %146 = getelementptr inbounds [26 x i8], [26 x i8]* %7, i64 0, i64 %145
...
150:                                              ; preds = %134
  ...
  %153 = getelementptr inbounds [999 x %struct.book], [999 x %struct.book]* @b, i64 0, i64 %152
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_43.cpp() #0 section ".text.startup" {
