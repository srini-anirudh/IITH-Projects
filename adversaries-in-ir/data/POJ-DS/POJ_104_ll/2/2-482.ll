; ModuleID = 'POJ-104-source/2/2-482.cpp'
source_filename = "POJ-104-source/2/2-482.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_482.cpp, i8* null }]
...
17:                                               ; preds = %13
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i32* %4)
  br label %19

19:                                               ; preds = %46, %17
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i8* %2)
...
29:                                               ; preds = %24
  ...
  %35 = getelementptr inbounds [26 x [1000 x i32]], [26 x [1000 x i32]]* %7, i64 0, i64 %34
...
55:                                               ; preds = %52
  ...
  %58 = getelementptr inbounds [27 x i32], [27 x i32]* %8, i64 0, i64 %57
...
62:                                               ; preds = %55
  ...
  %65 = getelementptr inbounds [27 x i32], [27 x i32]* %8, i64 0, i64 %64
...
85:                                               ; preds = %82
  ...
  %89 = getelementptr inbounds [26 x [1000 x i32]], [26 x [1000 x i32]]* %7, i64 0, i64 %88
...
95:                                               ; preds = %85
  ...
  %99 = getelementptr inbounds [26 x [1000 x i32]], [26 x [1000 x i32]]* %7, i64 0, i64 %98
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_482.cpp() #0 section ".text.startup" {
