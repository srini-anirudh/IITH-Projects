; ModuleID = 'POJ-104-source/2/2-501.cpp'
source_filename = "POJ-104-source/2/2-501.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_501.cpp, i8* null }]
...
119:                                              ; preds = %106
  ...
  %122 = getelementptr inbounds [27 x %struct.b], [27 x %struct.b]* %8, i64 0, i64 %121
  %123 = load i32, i32* %4, align 4
  %124 = add nsw i32 %123, 1
  %125 = sext i32 %124 to i64
  %126 = getelementptr inbounds [27 x %struct.b], [27 x %struct.b]* %8, i64 0, i64 %125
  %127 = bitcast %struct.b* %126 to i8*
  %128 = bitcast %struct.b* %122 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_501.cpp() #0 section ".text.startup" {
