; ModuleID = 'POJ-104-source/2/2-504.cpp'
source_filename = "POJ-104-source/2/2-504.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_504.cpp, i8* null }]
...
29:                                               ; preds = %11
  %30 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %7)
  store i32 0, i32* %5, align 4
  br label %31
...
35:                                               ; preds = %31
  ...
  %39 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %36, i8* %38)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_504.cpp() #0 section ".text.startup" {
