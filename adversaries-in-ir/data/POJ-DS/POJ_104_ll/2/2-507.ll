; ModuleID = 'POJ-104-source/2/2-507.cpp'
source_filename = "POJ-104-source/2/2-507.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_507.cpp, i8* null }]
...
29:                                               ; preds = %19
  ...
  %31 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %5, i8* %30)
  store i32 0, i32* %2, align 4
  br label %32
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_507.cpp() #0 section ".text.startup" {
