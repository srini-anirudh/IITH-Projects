; ModuleID = 'POJ-104-source/2/2-519.cpp'
source_filename = "POJ-104-source/2/2-519.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_519.cpp, i8* null }]
...
107:                                              ; preds = %103
  ...
  %115 = call i8* @_ZSt6strchrPci(i8* %112, i32 %114)
...
define linkonce_odr dso_local i8* @_ZSt6strchrPci(i8* %0, i32 %1) #7 comdat {
  %3 = alloca i8*, align 8
  %4 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_519.cpp() #0 section ".text.startup" {
