; ModuleID = 'POJ-104-source/2/2-527.cpp'
source_filename = "POJ-104-source/2/2-527.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_527.cpp, i8* null }]
...
14:                                               ; preds = %11
  ...
  %17 = getelementptr inbounds [26 x i32], [26 x i32]* %8, i64 0, i64 %16
...
26:                                               ; preds = %22
  ...
  %32 = getelementptr inbounds [1000 x [26 x i8]], [1000 x [26 x i8]]* %9, i64 0, i64 %31
  %33 = getelementptr inbounds [26 x i8], [26 x i8]* %32, i64 0, i64 0
  %34 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %29, i8* %33)
...
44:                                               ; preds = %35
  ...
  %47 = getelementptr inbounds [1000 x [26 x i8]], [1000 x [26 x i8]]* %9, i64 0, i64 %46
...
98:                                               ; preds = %126, %97
  ...
  %103 = getelementptr inbounds [1000 x [26 x i8]], [1000 x [26 x i8]]* %9, i64 0, i64 %102
...
107:                                              ; preds = %98
  ...
  %110 = getelementptr inbounds [1000 x [26 x i8]], [1000 x [26 x i8]]* %9, i64 0, i64 %109
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_527.cpp() #0 section ".text.startup" {
