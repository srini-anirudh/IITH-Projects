; ModuleID = 'POJ-104-source/2/2-59.cpp'
source_filename = "POJ-104-source/2/2-59.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_59.cpp, i8* null }]
...
50:                                               ; preds = %39
  ...
  %53 = getelementptr inbounds [999 x %struct.book], [999 x %struct.book]* %2, i64 0, i64 %52
...
153:                                              ; preds = %148
  ...
  %156 = getelementptr inbounds [999 x %struct.book], [999 x %struct.book]* %2, i64 0, i64 %155
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_59.cpp() #0 section ".text.startup" {
