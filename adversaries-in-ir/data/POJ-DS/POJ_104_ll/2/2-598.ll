; ModuleID = 'POJ-104-source/2/2-598.cpp'
source_filename = "POJ-104-source/2/2-598.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_598.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %12 = bitcast [1000 x %struct.book]* %2 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 16 %12, i8 0, i64 36000, i1 false)
...
20:                                               ; preds = %16
  ...
  %29 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %24, [30 x i8]* %28)
  br label %30
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_598.cpp() #0 section ".text.startup" {
