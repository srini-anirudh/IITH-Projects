; ModuleID = 'POJ-104-source/2/2-688.cpp'
source_filename = "POJ-104-source/2/2-688.cpp"
...
@__const._Z5transc.a = private unnamed_addr constant [26 x i8] c"ABCDEFGHIJKLMNOPQRSTUVWXYZ", align 16
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [6 x i8] c"%d %s\00", align 1
@.str.2 = private unnamed_addr constant [7 x i8] c"%c\0A%d\0A\00", align 1
@.str.3 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_688.cpp, i8* null }]
...
define dso_local i32 @_Z5transc(i8 signext %0) #4 {
  ...
  %5 = bitcast [26 x i8]* %4 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %5, i8* align 16 getelementptr inbounds ([26 x i8], [26 x i8]* @__const._Z5transc.a, i32 0, i32 0), i64 26, i1 false)
...
9:                                                ; preds = %6
  ...
  %14 = getelementptr inbounds [26 x i8], [26 x i8]* %4, i64 0, i64 %13
...
22:                                               ; preds = %18
  ...
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %6, i8* %23)
...
61:                                               ; preds = %49
  ...
  %71 = call i32 @_Z5transc(i8 signext %70)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_688.cpp() #0 section ".text.startup" {
