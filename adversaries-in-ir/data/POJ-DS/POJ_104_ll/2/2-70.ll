; ModuleID = 'POJ-104-source/2/2-70.cpp'
source_filename = "POJ-104-source/2/2-70.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_70.cpp, i8* null }]
...
29:                                               ; preds = %25
  ...
  %31 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %10, i8* %30)
  store i32 0, i32* %7, align 4
  br label %32
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_70.cpp() #0 section ".text.startup" {
