; ModuleID = 'POJ-104-source/2/2-705.cpp'
source_filename = "POJ-104-source/2/2-705.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_705.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %19, [26 x i8]* %23)
...
93:                                               ; preds = %80
  ...
  %102 = getelementptr inbounds [26 x %struct.writer], [26 x %struct.writer]* %3, i64 0, i64 %101
  %103 = load i32, i32* %5, align 4
  %104 = sub nsw i32 %103, 1
  %105 = sext i32 %104 to i64
  %106 = getelementptr inbounds [26 x %struct.writer], [26 x %struct.writer]* %3, i64 0, i64 %105
  %107 = bitcast %struct.writer* %106 to i8*
  %108 = bitcast %struct.writer* %102 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_705.cpp() #0 section ".text.startup" {
