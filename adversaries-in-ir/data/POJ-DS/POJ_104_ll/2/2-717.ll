; ModuleID = 'POJ-104-source/2/2-717.cpp'
source_filename = "POJ-104-source/2/2-717.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_717.cpp, i8* null }]
...
12:                                               ; preds = %8
  ...
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %16, i8* %21)
...
80:                                               ; preds = %76
  ...
  %88 = call i8* @_ZSt6strchrPci(i8* %85, i32 %87)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_717.cpp() #0 section ".text.startup" {
