; ModuleID = 'POJ-104-source/2/2-72.cpp'
source_filename = "POJ-104-source/2/2-72.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_72.cpp, i8* null }]
...
53:                                               ; preds = %49
  ...
  %61 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %56, i8* %60)
  br label %62
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_72.cpp() #0 section ".text.startup" {
