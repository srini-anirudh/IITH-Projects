; ModuleID = 'POJ-104-source/2/2-744.cpp'
source_filename = "POJ-104-source/2/2-744.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_744.cpp, i8* null }]
...
31:                                               ; preds = %27
  ...
  %41 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %35, i8* %40)
  br label %42
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_744.cpp() #0 section ".text.startup" {
