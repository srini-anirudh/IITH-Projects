; ModuleID = 'POJ-104-source/2/2-753.cpp'
source_filename = "POJ-104-source/2/2-753.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_753.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local %struct.worker* @_Z5creati(i32 %0) #0 {
...
21:                                               ; preds = %16
  ...
  %29 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %25, i8* %28)
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5printP6worker(%struct.worker* %0) #0 {
...
; Function Attrs: noinline uwtable
define dso_local void @_Z4mostP6worker(%struct.worker* %0) #0 {
  %2 = alloca %struct.worker*, align 8
  %3 = alloca %struct.worker*, align 8
  %4 = alloca %struct.worker*, align 8
...
define dso_local i32 @main() #5 {
  ...
  %5 = alloca i8, align 1
  %6 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.4, i64 0, i64 0), i32* %4)
  %7 = load i32, i32* %4, align 4
  %8 = call %struct.worker* @_Z5creati(i32 %7)
  ...
  call void @_Z4mostP6worker(%struct.worker* %10)
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_753.cpp() #0 section ".text.startup" {
