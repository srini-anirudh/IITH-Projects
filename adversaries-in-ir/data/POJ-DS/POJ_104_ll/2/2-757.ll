; ModuleID = 'POJ-104-source/2/2-757.cpp'
source_filename = "POJ-104-source/2/2-757.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_757.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %19, [20 x i8]* %21)
...
28:                                               ; preds = %23
  ...
  %35 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %32, [20 x i8]* %34)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_757.cpp() #0 section ".text.startup" {
