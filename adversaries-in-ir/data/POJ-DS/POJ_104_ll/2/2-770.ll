; ModuleID = 'POJ-104-source/2/2-770.cpp'
source_filename = "POJ-104-source/2/2-770.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_770.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %8 = alloca i8, align 1
  %9 = alloca [1024 x %struct.book], align 16
  ...
  %13 = getelementptr inbounds [1024 x %struct.book], [1024 x %struct.book]* %9, i64 0, i64 0
...
21:                                               ; preds = %17
  ...
  %24 = getelementptr inbounds [1024 x %struct.book], [1024 x %struct.book]* %9, i64 0, i64 %23
  %25 = getelementptr inbounds %struct.book, %struct.book* %24, i32 0, i32 0
  %26 = load i32, i32* %4, align 4
  %27 = sext i32 %26 to i64
  %28 = getelementptr inbounds [1024 x %struct.book], [1024 x %struct.book]* %9, i64 0, i64 %27
  %29 = getelementptr inbounds %struct.book, %struct.book* %28, i32 0, i32 1
  %30 = getelementptr inbounds [26 x i8], [26 x i8]* %29, i64 0, i64 0
  %31 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %25, i8* %30)
  br label %32
...
40:                                               ; preds = %36
  ...
  %43 = getelementptr inbounds [1024 x %struct.book], [1024 x %struct.book]* %9, i64 0, i64 %42
...
100:                                              ; preds = %96
  ...
  %103 = getelementptr inbounds [1024 x %struct.book], [1024 x %struct.book]* %9, i64 0, i64 %102
...
118:                                              ; preds = %111
  ...
  %121 = getelementptr inbounds [1024 x %struct.book], [1024 x %struct.book]* %9, i64 0, i64 %120
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_770.cpp() #0 section ".text.startup" {
