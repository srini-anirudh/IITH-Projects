; ModuleID = 'POJ-104-source/2/2-781.cpp'
source_filename = "POJ-104-source/2/2-781.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_781.cpp, i8* null }]
...
89:                                               ; preds = %82
  ...
  %92 = getelementptr inbounds [27 x i32], [27 x i32]* %9, i64 0, i64 %91
...
102:                                              ; preds = %99
  ...
  %105 = getelementptr inbounds [27 x i32], [27 x i32]* %9, i64 0, i64 %104
...
109:                                              ; preds = %102
  ...
  %117 = getelementptr inbounds [27 x i32], [27 x i32]* %9, i64 0, i64 %116
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_781.cpp() #0 section ".text.startup" {
