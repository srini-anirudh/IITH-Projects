; ModuleID = 'POJ-104-source/2/2-782.cpp'
source_filename = "POJ-104-source/2/2-782.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_782.cpp, i8* null }]
...
16:                                               ; preds = %12
  %17 = getelementptr inbounds [27 x i8], [27 x i8]* %9, i64 0, i64 0
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %7, i8* %17)
...
19:                                               ; preds = %56, %16
  ...
  %22 = getelementptr inbounds [27 x i8], [27 x i8]* %9, i64 0, i64 0
...
25:                                               ; preds = %19
  ...
  %34 = getelementptr inbounds [26 x [999 x i32]], [26 x [999 x i32]]* %5, i64 0, i64 %33
  ...
  %45 = getelementptr inbounds [999 x i32], [999 x i32]* %34, i64 0, i64 %44
...
98:                                               ; preds = %91
  ...
  %101 = getelementptr inbounds [26 x [999 x i32]], [26 x [999 x i32]]* %5, i64 0, i64 %100
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_782.cpp() #0 section ".text.startup" {
