; ModuleID = 'POJ-104-source/2/2-788.cpp'
source_filename = "POJ-104-source/2/2-788.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_788.cpp, i8* null }]
...
define dso_local i32 @_Z5ismaxPii(i32* %0, i32 %1) #4 {
...
15:                                               ; preds = %11
  ...
  %18 = getelementptr inbounds [999 x %struct.shu], [999 x %struct.shu]* %8, i64 0, i64 %17
  %19 = getelementptr inbounds %struct.shu, %struct.shu* %18, i32 0, i32 0
  %20 = load i32, i32* %2, align 4
  %21 = sext i32 %20 to i64
  %22 = getelementptr inbounds [999 x %struct.shu], [999 x %struct.shu]* %8, i64 0, i64 %21
...
42:                                               ; preds = %39
  ...
  %45 = getelementptr inbounds [999 x %struct.shu], [999 x %struct.shu]* %8, i64 0, i64 %44
  %46 = getelementptr inbounds %struct.shu, %struct.shu* %45, i32 0, i32 1
...
77:                                               ; preds = %74
  ...
  %80 = call i32 @_Z5ismaxPii(i32* %78, i32 %79)
  %81 = icmp eq i32 %80, 1
...
104:                                              ; preds = %101
  ...
  %107 = getelementptr inbounds [999 x %struct.shu], [999 x %struct.shu]* %8, i64 0, i64 %106
...
117:                                              ; preds = %104
  ...
  %120 = getelementptr inbounds [999 x %struct.shu], [999 x %struct.shu]* %8, i64 0, i64 %119
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_788.cpp() #0 section ".text.startup" {
