; ModuleID = 'POJ-104-source/2/2-807.cpp'
source_filename = "POJ-104-source/2/2-807.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_807.cpp, i8* null }]
...
124:                                              ; preds = %114
  ...
  %127 = getelementptr inbounds [1000 x %struct.book], [1000 x %struct.book]* %2, i64 0, i64 %126
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_807.cpp() #0 section ".text.startup" {
