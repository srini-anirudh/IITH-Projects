; ModuleID = 'POJ-104-source/2/2-817.cpp'
source_filename = "POJ-104-source/2/2-817.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_817.cpp, i8* null }]
...
define dso_local void @_Z4zimuPc(i8* %0) #4 {
  %2 = alloca i8*, align 8
...
13:                                               ; preds = %9
  ...
  %19 = getelementptr inbounds [300 x [20 x i8]], [300 x [20 x i8]]* %2, i64 0, i64 %18
  %20 = getelementptr inbounds [20 x i8], [20 x i8]* %19, i64 0, i64 0
  %21 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %16, i8* %20)
  br label %22
...
30:                                               ; preds = %26
  ...
  %33 = getelementptr inbounds [300 x [20 x i8]], [300 x [20 x i8]]* %2, i64 0, i64 %32
  %34 = getelementptr inbounds [20 x i8], [20 x i8]* %33, i64 0, i64 0
  call void @_Z4zimuPc(i8* %34)
  br label %35
...
38:                                               ; preds = %26
  %39 = call i32 @_Z3maxPi(i32* getelementptr inbounds ([26 x i32], [26 x i32]* @w, i64 0, i64 0))
  ...
  %44 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i64 0, i64 0), i32 %43)
  store i32 0, i32* %5, align 4
  br label %45
...
59:                                               ; preds = %50
  ...
  %62 = getelementptr inbounds [300 x [20 x i8]], [300 x [20 x i8]]* %2, i64 0, i64 %61
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_817.cpp() #0 section ".text.startup" {
