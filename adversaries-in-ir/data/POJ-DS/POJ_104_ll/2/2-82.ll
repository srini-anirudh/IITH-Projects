; ModuleID = 'POJ-104-source/2/2-82.cpp'
source_filename = "POJ-104-source/2/2-82.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_82.cpp, i8* null }]
...
53:                                               ; preds = %43
  ...
  %56 = getelementptr inbounds [1000 x [27 x i8]], [1000 x [27 x i8]]* %8, i64 0, i64 %55
  ...
  %69 = getelementptr inbounds [1000 x [27 x i8]], [1000 x [27 x i8]]* %8, i64 0, i64 %68
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_82.cpp() #0 section ".text.startup" {
