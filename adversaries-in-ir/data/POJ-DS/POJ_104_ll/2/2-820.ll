; ModuleID = 'POJ-104-source/2/2-820.cpp'
source_filename = "POJ-104-source/2/2-820.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_820.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %11 = alloca [100 x %struct.book], align 16
...
28:                                               ; preds = %24
  ...
  %31 = getelementptr inbounds [100 x %struct.book], [100 x %struct.book]* %11, i64 0, i64 %30
  ...
  %36 = getelementptr inbounds [100 x %struct.book], [100 x %struct.book]* %11, i64 0, i64 %35
...
48:                                               ; preds = %44
  ...
  %51 = getelementptr inbounds [100 x %struct.book], [100 x %struct.book]* %11, i64 0, i64 %50
...
66:                                               ; preds = %59
  ...
  %69 = getelementptr inbounds [100 x %struct.book], [100 x %struct.book]* %11, i64 0, i64 %68
...
134:                                              ; preds = %127
  ...
  %137 = getelementptr inbounds [100 x %struct.book], [100 x %struct.book]* %11, i64 0, i64 %136
...
161:                                              ; preds = %155
  ...
  %164 = getelementptr inbounds [100 x %struct.book], [100 x %struct.book]* %11, i64 0, i64 %163
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_820.cpp() #0 section ".text.startup" {
