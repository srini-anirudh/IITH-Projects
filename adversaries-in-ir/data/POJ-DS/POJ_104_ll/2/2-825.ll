; ModuleID = 'POJ-104-source/2/2-825.cpp'
source_filename = "POJ-104-source/2/2-825.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_825.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %15 = bitcast [1000 x [30 x i8]]* %11 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 16 %15, i8 0, i64 30000, i1 false)
...
21:                                               ; preds = %17
  ...
  %27 = getelementptr inbounds [1000 x [30 x i8]], [1000 x [30 x i8]]* %11, i64 0, i64 %26
...
46:                                               ; preds = %43
  ...
  %49 = getelementptr inbounds [1000 x [30 x i8]], [1000 x [30 x i8]]* %11, i64 0, i64 %48
...
58:                                               ; preds = %46
  ...
  %66 = getelementptr inbounds [27 x i32], [27 x i32]* %4, i64 0, i64 %65
...
79:                                               ; preds = %34
  %80 = getelementptr inbounds [27 x i32], [27 x i32]* %4, i64 0, i64 1
...
111:                                              ; preds = %108
  ...
  %114 = getelementptr inbounds [1000 x [30 x i8]], [1000 x [30 x i8]]* %11, i64 0, i64 %113
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_825.cpp() #0 section ".text.startup" {
