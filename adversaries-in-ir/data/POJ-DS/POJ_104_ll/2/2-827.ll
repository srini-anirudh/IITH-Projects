; ModuleID = 'POJ-104-source/2/2-827.cpp'
source_filename = "POJ-104-source/2/2-827.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_827.cpp, i8* null }]
...
14:                                               ; preds = %11
  ...
  %17 = getelementptr inbounds [26 x i32], [26 x i32]* %10, i64 0, i64 %16
...
27:                                               ; preds = %23
  ...
  %33 = getelementptr inbounds [1000 x [30 x i8]], [1000 x [30 x i8]]* %9, i64 0, i64 %32
  %34 = getelementptr inbounds [30 x i8], [30 x i8]* %33, i64 0, i64 0
  %35 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %30, i8* %34)
...
36:                                               ; preds = %70, %27
  ...
  %41 = getelementptr inbounds [1000 x [30 x i8]], [1000 x [30 x i8]]* %9, i64 0, i64 %40
...
111:                                              ; preds = %140, %110
  ...
  %116 = getelementptr inbounds [1000 x [30 x i8]], [1000 x [30 x i8]]* %9, i64 0, i64 %115
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_827.cpp() #0 section ".text.startup" {
