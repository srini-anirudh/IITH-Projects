; ModuleID = 'POJ-104-source/2/2-838.cpp'
source_filename = "POJ-104-source/2/2-838.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_838.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %12 = bitcast [100 x [30 x i8]]* %2 to i8*
...
20:                                               ; preds = %16
  ...
  %26 = getelementptr inbounds [100 x [30 x i8]], [100 x [30 x i8]]* %2, i64 0, i64 %25
  %27 = getelementptr inbounds [30 x i8], [30 x i8]* %26, i64 0, i64 0
  %28 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %23, i8* %27)
...
33:                                               ; preds = %29
  ...
  %40 = call i8* @_ZSt6strchrPci(i8* %37, i32 %39)
...
93:                                               ; preds = %89
  ...
  %100 = call i8* @_ZSt6strchrPci(i8* %97, i32 %99)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_838.cpp() #0 section ".text.startup" {
