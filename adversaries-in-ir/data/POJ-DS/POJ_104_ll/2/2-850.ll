; ModuleID = 'POJ-104-source/2/2-850.cpp'
source_filename = "POJ-104-source/2/2-850.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_850.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %2 = alloca [999 x %struct.books], align 16
...
17:                                               ; preds = %13
  ...
  %20 = getelementptr inbounds [999 x %struct.books], [999 x %struct.books]* %2, i64 0, i64 %19
  %21 = getelementptr inbounds %struct.books, %struct.books* %20, i32 0, i32 0
  %22 = load i32, i32* %6, align 4
  %23 = sext i32 %22 to i64
  %24 = getelementptr inbounds [999 x %struct.books], [999 x %struct.books]* %2, i64 0, i64 %23
...
36:                                               ; preds = %32
  ...
  %39 = getelementptr inbounds [999 x %struct.books], [999 x %struct.books]* %2, i64 0, i64 %38
...
52:                                               ; preds = %49
  ...
  %55 = getelementptr inbounds [999 x %struct.books], [999 x %struct.books]* %2, i64 0, i64 %54
...
83:                                               ; preds = %32
  %84 = getelementptr inbounds [26 x i32], [26 x i32]* %4, i64 0, i64 0
...
106:                                              ; preds = %86
  ...
  %113 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0), i32 %108, i32 %112)
  store i32 0, i32* %6, align 4
  br label %114
...
118:                                              ; preds = %114
  ...
  %121 = getelementptr inbounds [999 x %struct.books], [999 x %struct.books]* %2, i64 0, i64 %120
  %122 = getelementptr inbounds %struct.books, %struct.books* %121, i32 0, i32 1
  %123 = getelementptr inbounds [26 x i8], [26 x i8]* %122, i64 0, i64 0
...
130:                                              ; preds = %126
  ...
  %133 = getelementptr inbounds [999 x %struct.books], [999 x %struct.books]* %2, i64 0, i64 %132
...
143:                                              ; preds = %130
  ...
  %146 = getelementptr inbounds [999 x %struct.books], [999 x %struct.books]* %2, i64 0, i64 %145
  %147 = getelementptr inbounds %struct.books, %struct.books* %146, i32 0, i32 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_850.cpp() #0 section ".text.startup" {
