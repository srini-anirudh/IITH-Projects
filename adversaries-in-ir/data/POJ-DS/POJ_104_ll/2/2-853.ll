; ModuleID = 'POJ-104-source/2/2-853.cpp'
source_filename = "POJ-104-source/2/2-853.cpp"
...
@p = dso_local global [26 x %struct.person] zeroinitializer, align 16
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_853.cpp, i8* null }]
...
7:                                                ; preds = %3
  %8 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* @m, i8* getelementptr inbounds ([30 x i8], [30 x i8]* @str, i64 0, i64 0))
  %9 = call i64 @strlen(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @str, i64 0, i64 0)) #7
  %10 = sub i64 %9, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_853.cpp() #0 section ".text.startup" {
