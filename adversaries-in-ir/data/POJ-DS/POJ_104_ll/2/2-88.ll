; ModuleID = 'POJ-104-source/2/2-88.cpp'
source_filename = "POJ-104-source/2/2-88.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_88.cpp, i8* null }]
...
26:                                               ; preds = %22
  ...
  %28 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %2, i8* %27)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_88.cpp() #0 section ".text.startup" {
