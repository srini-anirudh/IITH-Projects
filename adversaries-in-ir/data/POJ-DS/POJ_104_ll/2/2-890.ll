; ModuleID = 'POJ-104-source/2/2-890.cpp'
source_filename = "POJ-104-source/2/2-890.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_890.cpp, i8* null }]
...
96:                                               ; preds = %37
  ...
  %99 = call signext i8 @_Z3maxPi(i32* %98)
  %100 = sext i8 %99 to i32
  %101 = load i32*, i32** %9, align 8
  %102 = call signext i8 @_Z3maxPi(i32* %101)
...
125:                                              ; preds = %114
  ...
  %127 = call signext i8 @_Z3maxPi(i32* %126)
...
define dso_local signext i8 @_Z3maxPi(i32* %0) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_890.cpp() #0 section ".text.startup" {
