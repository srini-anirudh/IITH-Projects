; ModuleID = 'POJ-104-source/2/2-903.cpp'
source_filename = "POJ-104-source/2/2-903.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_903.cpp, i8* null }]
...
9:                                                ; preds = %6
  ...
  %14 = getelementptr inbounds [26 x i8], [26 x i8]* %3, i64 0, i64 %13
...
29:                                               ; preds = %25
  ...
  %39 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %33, i8* %38)
  br label %40
...
60:                                               ; preds = %56
  ...
  %69 = call i32 @_Z5transc(i8 signext %68)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_903.cpp() #0 section ".text.startup" {
