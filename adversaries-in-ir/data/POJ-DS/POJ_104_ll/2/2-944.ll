; ModuleID = 'POJ-104-source/2/2-944.cpp'
source_filename = "POJ-104-source/2/2-944.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_944.cpp, i8* null }]
...
12:                                               ; preds = %8
  ...
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %16, i8* %19)
...
define dso_local signext i8 @_Z4bestP4book(%struct.book* %0) #4 {
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5printcP4book(i8 signext %0, %struct.book* %1) #0 {
  %3 = alloca i8, align 1
  %4 = alloca %struct.book*, align 8
...
define dso_local i32 @main(i32 %0, i8** %1) #5 {
  ...
  %8 = call %struct.book* @_Z5creatv()
  store %struct.book* %8, %struct.book** %7, align 8
  %9 = load %struct.book*, %struct.book** %7, align 8
  %10 = call signext i8 @_Z4bestP4book(%struct.book* %9)
  store i8 %10, i8* %6, align 1
  %11 = load i8, i8* %6, align 1
  %12 = load %struct.book*, %struct.book** %7, align 8
  call void @_Z5printcP4book(i8 signext %11, %struct.book* %12)
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_944.cpp() #0 section ".text.startup" {
