; ModuleID = 'POJ-104-source/2/2-962.cpp'
source_filename = "POJ-104-source/2/2-962.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_962.cpp, i8* null }]
...
25:                                               ; preds = %21
  ...
  %30 = call noalias i8* @malloc(i64 26) #3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_962.cpp() #0 section ".text.startup" {
