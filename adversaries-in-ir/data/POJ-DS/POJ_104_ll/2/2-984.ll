; ModuleID = 'POJ-104-source/2/2-984.cpp'
source_filename = "POJ-104-source/2/2-984.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_984.cpp, i8* null }]
...
21:                                               ; preds = %17
  ...
  %34 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i8* %27, i8* %33)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_984.cpp() #0 section ".text.startup" {
