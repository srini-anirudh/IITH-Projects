; ModuleID = 'POJ-104-source/2/2-986.cpp'
source_filename = "POJ-104-source/2/2-986.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_986.cpp, i8* null }]
...
47:                                               ; preds = %43
  ...
  %50 = getelementptr inbounds [999 x %struct.anon], [999 x %struct.anon]* %11, i64 0, i64 %49
...
59:                                               ; preds = %55
  ...
  %62 = getelementptr inbounds [999 x %struct.anon], [999 x %struct.anon]* %11, i64 0, i64 %61
...
127:                                              ; preds = %123
  ...
  %130 = getelementptr inbounds [999 x %struct.anon], [999 x %struct.anon]* %11, i64 0, i64 %129
...
140:                                              ; preds = %127
  ...
  %143 = getelementptr inbounds [999 x %struct.anon], [999 x %struct.anon]* %11, i64 0, i64 %142
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_986.cpp() #0 section ".text.startup" {
