; ModuleID = 'POJ-104-source/2/2-995.cpp'
source_filename = "POJ-104-source/2/2-995.cpp"
...
@head = dso_local global %struct.book* null, align 8
@times = dso_local global [26 x i32] zeroinitializer, align 16
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [3 x i8] c"%s\00", align 1
@.str.2 = private unnamed_addr constant [4 x i8] c"%c\0A\00", align 1
@.str.3 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2_995.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z6createi(i32 %0) #0 {
...
define dso_local i32 @_Z5countv() #4 {
...
21:                                               ; preds = %18
  ...
  %31 = call i8* @strcpy(i8* %27, i8* %30) #3
  store i32 0, i32* %3, align 4
  br label %32
...
16:                                               ; preds = %13
  ...
  %21 = call i8* @strcpy(i8* %17, i8* %20) #3
...
define dso_local i32 @main() #6 {
  ...
  call void @_Z6createi(i32 %4)
  %5 = call i32 @_Z5countv()
  store i32 %5, i32* %1, align 4
  %6 = load i32, i32* %1, align 4
  call void @_Z5printi(i32 %6)
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2_995.cpp() #0 section ".text.startup" {
