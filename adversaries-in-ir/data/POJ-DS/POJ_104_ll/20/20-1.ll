; ModuleID = 'POJ-104-source/20/20-1.cpp'
source_filename = "POJ-104-source/20/20-1.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_1.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %5 = bitcast [100 x [11 x i8]]* %2 to i8*
...
10:                                               ; preds = %6
  ...
  %13 = getelementptr inbounds [100 x [11 x i8]], [100 x [11 x i8]]* %2, i64 0, i64 %12
  %14 = getelementptr inbounds [11 x i8], [11 x i8]* %13, i64 0, i64 0
  %15 = getelementptr inbounds [3 x i8], [3 x i8]* %3, i64 0, i64 0
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %14, i8* %15)
  ...
  call void @_Z1fPcS_(i8* %20, i8* %21)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_1.cpp() #0 section ".text.startup" {
