; ModuleID = 'POJ-104-source/20/20-1065.cpp'
source_filename = "POJ-104-source/20/20-1065.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_1065.cpp, i8* null }]
...
9:                                                ; preds = %20, %0
  ...
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i8* %13, i8* %17)
  %19 = icmp ne i32 %18, -1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_1065.cpp() #0 section ".text.startup" {
