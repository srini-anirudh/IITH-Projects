; ModuleID = 'POJ-104-source/20/20-1138.cpp'
source_filename = "POJ-104-source/20/20-1138.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_1138.cpp, i8* null }]
...
15:                                               ; preds = %10
  ...
  %21 = call i32 @_Z7findmaxPci(i8* %19, i32 %20)
...
define dso_local i32 @_Z7findmaxPci(i8* %0, i32 %1) #7 {
  %3 = alloca i8*, align 8
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i8, align 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_1138.cpp() #0 section ".text.startup" {
