; ModuleID = 'POJ-104-source/20/20-114.cpp'
source_filename = "POJ-104-source/20/20-114.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_114.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5charuv() #0 {
...
69:                                               ; preds = %56
  ...
  %81 = getelementptr inbounds [11 x i8], [11 x i8]* %4, i64 0, i64 %80
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_114.cpp() #0 section ".text.startup" {
