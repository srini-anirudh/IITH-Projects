; ModuleID = 'POJ-104-source/20/20-1145.cpp'
source_filename = "POJ-104-source/20/20-1145.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_1145.cpp, i8* null }]
...
15:                                               ; preds = %38, %12
  ...
  %18 = getelementptr inbounds [14 x i8], [14 x i8]* %2, i64 0, i64 %17
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_1145.cpp() #0 section ".text.startup" {
