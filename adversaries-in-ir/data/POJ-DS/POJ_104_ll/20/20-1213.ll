; ModuleID = 'POJ-104-source/20/20-1213.cpp'
source_filename = "POJ-104-source/20/20-1213.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_1213.cpp, i8* null }]
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z3caoPcS_(i8* %0, i8* %1) #4 {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
...
12:                                               ; preds = %7
  ...
  call void @_Z3caoPcS_(i8* %13, i8* %14)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_1213.cpp() #0 section ".text.startup" {
