; ModuleID = 'POJ-104-source/20/20-1257.cpp'
source_filename = "POJ-104-source/20/20-1257.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_1257.cpp, i8* null }]
...
20:                                               ; preds = %16
  ...
  %23 = getelementptr inbounds [14 x i8], [14 x i8]* %2, i64 0, i64 %22
...
76:                                               ; preds = %59
  ...
  %81 = getelementptr inbounds [14 x i8], [14 x i8]* %2, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_1257.cpp() #0 section ".text.startup" {
