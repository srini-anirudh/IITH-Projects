; ModuleID = 'POJ-104-source/20/20-1261.cpp'
source_filename = "POJ-104-source/20/20-1261.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_1261.cpp, i8* null }]
...
15:                                               ; preds = %12
  ...
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i8* %19, i8* %23)
  %25 = icmp ne i32 %24, -1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_1261.cpp() #0 section ".text.startup" {
