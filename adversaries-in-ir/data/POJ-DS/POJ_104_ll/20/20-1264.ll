; ModuleID = 'POJ-104-source/20/20-1264.cpp'
source_filename = "POJ-104-source/20/20-1264.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_1264.cpp, i8* null }]
...
10:                                               ; preds = %21, %0
  ...
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i8* %14, i8* %18)
  %20 = icmp ne i32 %19, -1
...
59:                                               ; preds = %47
  ...
  %62 = getelementptr inbounds [100 x [10 x i8]], [100 x [10 x i8]]* %2, i64 0, i64 %61
...
77:                                               ; preds = %73
  ...
  %80 = getelementptr inbounds [100 x [10 x i8]], [100 x [10 x i8]]* %2, i64 0, i64 %79
...
94:                                               ; preds = %91
  ...
  %97 = getelementptr inbounds [100 x [3 x i8]], [100 x [3 x i8]]* %3, i64 0, i64 %96
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_1264.cpp() #0 section ".text.startup" {
