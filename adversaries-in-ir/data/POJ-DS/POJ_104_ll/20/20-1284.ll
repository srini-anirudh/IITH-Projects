; ModuleID = 'POJ-104-source/20/20-1284.cpp'
source_filename = "POJ-104-source/20/20-1284.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_1284.cpp, i8* null }]
...
68:                                               ; preds = %51
  ...
  %81 = call i8* @strcat(i8* %79, i8* %80) #3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_1284.cpp() #0 section ".text.startup" {
