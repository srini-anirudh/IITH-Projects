; ModuleID = 'POJ-104-source/20/20-1289.cpp'
source_filename = "POJ-104-source/20/20-1289.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_1289.cpp, i8* null }]
...
82:                                               ; preds = %79
  ...
  %92 = getelementptr inbounds [50 x i8], [50 x i8]* %8, i64 0, i64 %91
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_1289.cpp() #0 section ".text.startup" {
