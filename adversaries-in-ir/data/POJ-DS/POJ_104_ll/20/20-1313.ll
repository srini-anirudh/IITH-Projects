; ModuleID = 'POJ-104-source/20/20-1313.cpp'
source_filename = "POJ-104-source/20/20-1313.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_1313.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z1hPcS_(i8* %0, i8* %1) #0 {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
  %5 = alloca i8, align 1
...
9:                                                ; preds = %6
  ...
  %12 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), i8* %10, i8* %11)
  %13 = icmp eq i32 %12, -1
...
15:                                               ; preds = %9
  ...
  %18 = call i32 @_Z1hPcS_(i8* %16, i8* %17)
  br label %19
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_1313.cpp() #0 section ".text.startup" {
