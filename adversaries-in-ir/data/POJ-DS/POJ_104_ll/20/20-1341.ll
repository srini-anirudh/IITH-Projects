; ModuleID = 'POJ-104-source/20/20-1341.cpp'
source_filename = "POJ-104-source/20/20-1341.cpp"
...
@__const._Z4plugPcS_.a = private unnamed_addr constant [11 x i32] [i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 0], align 16
@.str = private unnamed_addr constant [3 x i8] c"%c\00", align 1
@.str.1 = private unnamed_addr constant [3 x i8] c"%s\00", align 1
@.str.2 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@.str.3 = private unnamed_addr constant [5 x i8] c"%s%s\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_1341.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z4plugPcS_(i8* %0, i8* %1) #0 {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %13, i8* align 16 bitcast ([11 x i32]* @__const._Z4plugPcS_.a to i8*), i64 44, i1 false)
...
4:                                                ; preds = %9, %0
  ...
  %7 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0), i8* %5, i8* %6)
  %8 = icmp ne i32 %7, -1
...
9:                                                ; preds = %4
  ...
  %12 = call i32 @_Z4plugPcS_(i8* %10, i8* %11)
  br label %4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_1341.cpp() #0 section ".text.startup" {
