; ModuleID = 'POJ-104-source/20/20-152.cpp'
source_filename = "POJ-104-source/20/20-152.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_152.cpp, i8* null }]
...
58:                                               ; preds = %43
  ...
  %63 = getelementptr inbounds [14 x i8], [14 x i8]* %4, i64 0, i64 0
...
89:                                               ; preds = %76
  ...
  %93 = getelementptr inbounds [14 x i8], [14 x i8]* %4, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_152.cpp() #0 section ".text.startup" {
