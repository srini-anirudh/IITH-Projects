; ModuleID = 'POJ-104-source/20/20-162.cpp'
source_filename = "POJ-104-source/20/20-162.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_162.cpp, i8* null }]
...
61:                                               ; preds = %45
  ...
  %68 = getelementptr inbounds [4 x i8], [4 x i8]* %3, i64 0, i64 1
  ...
  %74 = getelementptr inbounds [4 x i8], [4 x i8]* %3, i64 0, i64 2
  ...
  %84 = getelementptr inbounds [15 x i8], [15 x i8]* %2, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_162.cpp() #0 section ".text.startup" {
