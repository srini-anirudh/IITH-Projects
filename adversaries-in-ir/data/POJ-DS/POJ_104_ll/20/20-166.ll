; ModuleID = 'POJ-104-source/20/20-166.cpp'
source_filename = "POJ-104-source/20/20-166.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_166.cpp, i8* null }]
...
9:                                                ; preds = %99, %0
  %10 = getelementptr inbounds [13 x i8], [13 x i8]* %2, i64 0, i64 0
...
14:                                               ; preds = %9
  %15 = getelementptr inbounds [13 x i8], [13 x i8]* %2, i64 0, i64 0
...
34:                                               ; preds = %26
  ...
  %37 = getelementptr inbounds [13 x i8], [13 x i8]* %2, i64 0, i64 %36
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_166.cpp() #0 section ".text.startup" {
