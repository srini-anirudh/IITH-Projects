; ModuleID = 'POJ-104-source/20/20-199.cpp'
source_filename = "POJ-104-source/20/20-199.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_199.cpp, i8* null }]
...
82:                                               ; preds = %81, %55
  ...
  %95 = call signext i8 @_Z3maxPc(i8* %94)
...
define dso_local signext i8 @_Z3maxPc(i8* %0) #7 {
  %2 = alloca i8*, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_199.cpp() #0 section ".text.startup" {
