; ModuleID = 'POJ-104-source/20/20-210.cpp'
source_filename = "POJ-104-source/20/20-210.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_210.cpp, i8* null }]
...
12:                                               ; preds = %31, %0
  ...
  %21 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i8* %16, i8* %20)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_210.cpp() #0 section ".text.startup" {
