; ModuleID = 'POJ-104-source/20/20-222.cpp'
source_filename = "POJ-104-source/20/20-222.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_222.cpp, i8* null }]
...
85:                                               ; preds = %66
  ...
  %90 = getelementptr inbounds [15 x i8], [15 x i8]* %2, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_222.cpp() #0 section ".text.startup" {
