; ModuleID = 'POJ-104-source/20/20-235.cpp'
source_filename = "POJ-104-source/20/20-235.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_235.cpp, i8* null }]
...
define dso_local i8* @_Z9strInsertPciPKc(i8* %0, i32 %1, i8* %2) #4 {
  %4 = alloca i8*, align 8
...
41:                                               ; preds = %17
  ...
  %45 = call i8* @_Z9strInsertPciPKc(i8* %42, i32 %43, i8* %44)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_235.cpp() #0 section ".text.startup" {
