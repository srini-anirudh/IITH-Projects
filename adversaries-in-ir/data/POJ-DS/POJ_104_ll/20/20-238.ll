; ModuleID = 'POJ-104-source/20/20-238.cpp'
source_filename = "POJ-104-source/20/20-238.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_238.cpp, i8* null }]
...
65:                                               ; preds = %62
  ...
  %68 = getelementptr inbounds [4 x i8], [4 x i8]* %3, i64 0, i64 %67
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_238.cpp() #0 section ".text.startup" {
