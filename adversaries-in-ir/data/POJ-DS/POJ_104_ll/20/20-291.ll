; ModuleID = 'POJ-104-source/20/20-291.cpp'
source_filename = "POJ-104-source/20/20-291.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_291.cpp, i8* null }]
...
11:                                               ; preds = %115, %0
  %12 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), [10 x i8]* %7, [3 x i8]* %8)
...
23:                                               ; preds = %19
  ...
  %27 = getelementptr inbounds [10 x i8], [10 x i8]* %7, i64 0, i64 %26
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_291.cpp() #0 section ".text.startup" {
