; ModuleID = 'POJ-104-source/20/20-293.cpp'
source_filename = "POJ-104-source/20/20-293.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_293.cpp, i8* null }]
...
123:                                              ; preds = %113
  %124 = getelementptr inbounds [30 x i8], [30 x i8]* %2, i64 0, i64 0
  %125 = getelementptr inbounds [4 x i8], [4 x i8]* %3, i64 0, i64 0
  %126 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i8* %124, i8* %125)
  br label %11
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_293.cpp() #0 section ".text.startup" {
