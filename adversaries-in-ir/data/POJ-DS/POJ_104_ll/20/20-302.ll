; ModuleID = 'POJ-104-source/20/20-302.cpp'
source_filename = "POJ-104-source/20/20-302.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_302.cpp, i8* null }]
...
67:                                               ; preds = %62
  ...
  %70 = getelementptr inbounds [3 x i8], [3 x i8]* %3, i64 0, i64 %69
...
80:                                               ; preds = %62
  ...
  %85 = getelementptr inbounds [20 x i8], [20 x i8]* %2, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_302.cpp() #0 section ".text.startup" {
