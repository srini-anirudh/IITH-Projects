; ModuleID = 'POJ-104-source/20/20-304.cpp'
source_filename = "POJ-104-source/20/20-304.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_304.cpp, i8* null }]
...
83:                                               ; preds = %80
  ...
  %86 = getelementptr inbounds [3 x i8], [3 x i8]* %3, i64 0, i64 %85
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_304.cpp() #0 section ".text.startup" {
