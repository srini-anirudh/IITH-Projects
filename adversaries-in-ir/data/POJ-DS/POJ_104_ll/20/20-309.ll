; ModuleID = 'POJ-104-source/20/20-309.cpp'
source_filename = "POJ-104-source/20/20-309.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_309.cpp, i8* null }]
...
9:                                                ; preds = %20, %0
  ...
  %16 = getelementptr inbounds [50 x [50 x i8]], [50 x [50 x i8]]* %3, i64 0, i64 %15
...
88:                                               ; preds = %75
  ...
  %91 = getelementptr inbounds [50 x [50 x i8]], [50 x [50 x i8]]* %3, i64 0, i64 %90
...
109:                                              ; preds = %127, %108
  ...
  %121 = getelementptr inbounds [50 x [50 x i8]], [50 x [50 x i8]]* %4, i64 0, i64 %120
...
141:                                              ; preds = %137
  ...
  %146 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i8* %145)
  br label %153
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_309.cpp() #0 section ".text.startup" {
