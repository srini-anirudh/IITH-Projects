; ModuleID = 'POJ-104-source/20/20-314.cpp'
source_filename = "POJ-104-source/20/20-314.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_314.cpp, i8* null }]
...
18:                                               ; preds = %31, %14
  ...
  %22 = call i32 @_Z3MAXPci(i8* %20, i32 %21)
...
34:                                               ; preds = %18
  ...
  %39 = call i32 @_Z3MAXPci(i8* %37, i32 %38)
  %40 = add nsw i32 %39, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_314.cpp() #0 section ".text.startup" {
