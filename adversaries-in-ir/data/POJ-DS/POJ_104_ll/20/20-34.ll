; ModuleID = 'POJ-104-source/20/20-34.cpp'
source_filename = "POJ-104-source/20/20-34.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_34.cpp, i8* null }]
...
73:                                               ; preds = %45
  ...
  %76 = call i8* @strcat(i8* %74, i8* %75) #3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_34.cpp() #0 section ".text.startup" {
