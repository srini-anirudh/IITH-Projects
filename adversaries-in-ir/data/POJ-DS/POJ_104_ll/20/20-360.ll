; ModuleID = 'POJ-104-source/20/20-360.cpp'
source_filename = "POJ-104-source/20/20-360.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_360.cpp, i8* null }]
...
53:                                               ; preds = %25
  %54 = getelementptr inbounds [11 x i8], [11 x i8]* %4, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_360.cpp() #0 section ".text.startup" {
