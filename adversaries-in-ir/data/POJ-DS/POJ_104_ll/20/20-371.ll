; ModuleID = 'POJ-104-source/20/20-371.cpp'
source_filename = "POJ-104-source/20/20-371.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_371.cpp, i8* null }]
...
38:                                               ; preds = %32
  ...
  %41 = getelementptr inbounds [10 x i8], [10 x i8]* %4, i64 0, i64 %40
...
51:                                               ; preds = %38
  ...
  %70 = getelementptr inbounds [10 x i8], [10 x i8]* %4, i64 0, i64 %69
...
84:                                               ; preds = %80
  ...
  %93 = getelementptr inbounds [10 x i8], [10 x i8]* %4, i64 0, i64 %92
...
118:                                              ; preds = %104
  %119 = getelementptr inbounds [4 x i8], [4 x i8]* %3, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_371.cpp() #0 section ".text.startup" {
