; ModuleID = 'POJ-104-source/20/20-374.cpp'
source_filename = "POJ-104-source/20/20-374.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_374.cpp, i8* null }]
...
13:                                               ; preds = %35, %12
  ...
  %16 = getelementptr inbounds [12 x i8], [12 x i8]* %2, i64 0, i64 %15
...
20:                                               ; preds = %13
  ...
  %28 = getelementptr inbounds [12 x i8], [12 x i8]* %2, i64 0, i64 %27
...
44:                                               ; preds = %39
  ...
  %47 = getelementptr inbounds [12 x i8], [12 x i8]* %2, i64 0, i64 %46
...
54:                                               ; preds = %39
  ...
  %60 = add nsw i32 %59, 1
  call void @_Z1fPcS_i(i8* %57, i8* %58, i32 %60)
  %61 = getelementptr inbounds [10 x i8], [10 x i8]* %3, i64 0, i64 0
...
define dso_local void @_Z1fPcS_i(i8* %0, i8* %1, i32 %2) #5 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_374.cpp() #0 section ".text.startup" {
