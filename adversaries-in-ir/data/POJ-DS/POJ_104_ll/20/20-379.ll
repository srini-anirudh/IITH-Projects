; ModuleID = 'POJ-104-source/20/20-379.cpp'
source_filename = "POJ-104-source/20/20-379.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_379.cpp, i8* null }]
...
62:                                               ; preds = %48
  %63 = getelementptr inbounds [10 x i8], [10 x i8]* %3, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_379.cpp() #0 section ".text.startup" {
