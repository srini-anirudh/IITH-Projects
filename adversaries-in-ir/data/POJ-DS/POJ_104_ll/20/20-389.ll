; ModuleID = 'POJ-104-source/20/20-389.cpp'
source_filename = "POJ-104-source/20/20-389.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_389.cpp, i8* null }]
...
52:                                               ; preds = %68, %49
  %53 = getelementptr inbounds [11 x i8], [11 x i8]* %2, i64 0, i64 0
...
define dso_local i32 @_Z1fPc(i8* %0) #5 {
  %2 = alloca i8*, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_389.cpp() #0 section ".text.startup" {
