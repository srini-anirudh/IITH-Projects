; ModuleID = 'POJ-104-source/20/20-390.cpp'
source_filename = "POJ-104-source/20/20-390.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_390.cpp, i8* null }]
...
43:                                               ; preds = %17
  %44 = getelementptr inbounds [15 x i8], [15 x i8]* %2, i64 0, i64 0
  %45 = load i32, i32* %5, align 4
  %46 = getelementptr inbounds [4 x i8], [4 x i8]* %3, i64 0, i64 0
  %47 = call i8* @_Z9strInsertPciPKc(i8* %44, i32 %45, i8* %46)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_390.cpp() #0 section ".text.startup" {
