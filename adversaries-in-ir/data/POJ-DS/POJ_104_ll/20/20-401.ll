; ModuleID = 'POJ-104-source/20/20-401.cpp'
source_filename = "POJ-104-source/20/20-401.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_401.cpp, i8* null }]
...
10:                                               ; preds = %92, %0
  %11 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), [10 x i8]* %2, [5 x i8]* %3)
  %12 = icmp ne i32 %11, -1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_401.cpp() #0 section ".text.startup" {
