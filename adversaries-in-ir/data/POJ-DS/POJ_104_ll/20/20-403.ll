; ModuleID = 'POJ-104-source/20/20-403.cpp'
source_filename = "POJ-104-source/20/20-403.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_403.cpp, i8* null }]
...
define dso_local void @_Z1sPcS_(i8* %0, i8* %1) #4 {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
...
12:                                               ; preds = %7
  ...
  call void @_Z1sPcS_(i8* %13, i8* %14)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_403.cpp() #0 section ".text.startup" {
