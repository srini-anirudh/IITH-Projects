; ModuleID = 'POJ-104-source/20/20-422.cpp'
source_filename = "POJ-104-source/20/20-422.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_422.cpp, i8* null }]
...
39:                                               ; preds = %29
  ...
  %43 = getelementptr inbounds [20 x i8], [20 x i8]* %9, i64 0, i64 %42
...
101:                                              ; preds = %97
  ...
  %108 = getelementptr inbounds [20 x i8], [20 x i8]* %9, i64 0, i64 %107
...
133:                                              ; preds = %131
  ...
  %135 = getelementptr inbounds [4 x i8], [4 x i8]* %10, i64 0, i64 0
  %136 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i8* %134, i8* %135)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_422.cpp() #0 section ".text.startup" {
