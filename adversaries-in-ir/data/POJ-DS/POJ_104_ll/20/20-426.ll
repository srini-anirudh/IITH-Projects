; ModuleID = 'POJ-104-source/20/20-426.cpp'
source_filename = "POJ-104-source/20/20-426.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_426.cpp, i8* null }]
...
12:                                               ; preds = %34, %11
  ...
  %15 = getelementptr inbounds [14 x i8], [14 x i8]* %4, i64 0, i64 %14
...
19:                                               ; preds = %12
  ...
  %22 = getelementptr inbounds [14 x i8], [14 x i8]* %4, i64 0, i64 %21
...
77:                                               ; preds = %58
  %78 = getelementptr inbounds [14 x i8], [14 x i8]* %4, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_426.cpp() #0 section ".text.startup" {
