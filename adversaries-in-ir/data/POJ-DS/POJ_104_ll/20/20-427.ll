; ModuleID = 'POJ-104-source/20/20-427.cpp'
source_filename = "POJ-104-source/20/20-427.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_427.cpp, i8* null }]
...
61:                                               ; preds = %44
  ...
  %68 = getelementptr inbounds [5 x i8], [5 x i8]* %6, i64 0, i64 1
  ...
  %74 = getelementptr inbounds [5 x i8], [5 x i8]* %6, i64 0, i64 2
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_427.cpp() #0 section ".text.startup" {
