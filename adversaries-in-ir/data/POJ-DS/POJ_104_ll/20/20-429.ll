; ModuleID = 'POJ-104-source/20/20-429.cpp'
source_filename = "POJ-104-source/20/20-429.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_429.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z2ddPcS_(i8* %0, i8* %1) #0 {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
...
9:                                                ; preds = %4
  ...
  call void @_Z2ddPcS_(i8* %10, i8* %11)
  br label %4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_429.cpp() #0 section ".text.startup" {
