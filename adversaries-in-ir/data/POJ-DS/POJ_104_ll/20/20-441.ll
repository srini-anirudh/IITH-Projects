; ModuleID = 'POJ-104-source/20/20-441.cpp'
source_filename = "POJ-104-source/20/20-441.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_441.cpp, i8* null }]
...
41:                                               ; preds = %16
  ...
  %58 = call i8* @strcat(i8* %52, i8* %57) #3
  %59 = getelementptr inbounds [14 x i8], [14 x i8]* %6, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_441.cpp() #0 section ".text.startup" {
