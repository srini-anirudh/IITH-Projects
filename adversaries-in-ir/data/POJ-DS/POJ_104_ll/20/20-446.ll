; ModuleID = 'POJ-104-source/20/20-446.cpp'
source_filename = "POJ-104-source/20/20-446.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_446.cpp, i8* null }]
...
29:                                               ; preds = %21
  ...
  %32 = getelementptr inbounds [14 x i8], [14 x i8]* %2, i64 0, i64 %31
...
94:                                               ; preds = %89
  ...
  %100 = getelementptr inbounds [4 x i8], [4 x i8]* %3, i64 0, i64 %99
...
108:                                              ; preds = %89
  %109 = getelementptr inbounds [14 x i8], [14 x i8]* %2, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_446.cpp() #0 section ".text.startup" {
