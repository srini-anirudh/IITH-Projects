; ModuleID = 'POJ-104-source/20/20-465.cpp'
source_filename = "POJ-104-source/20/20-465.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_465.cpp, i8* null }]
...
24:                                               ; preds = %20
  ...
  %31 = getelementptr inbounds [14 x i8], [14 x i8]* %4, i64 0, i64 %30
...
76:                                               ; preds = %59
  %77 = getelementptr inbounds [14 x i8], [14 x i8]* %4, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_465.cpp() #0 section ".text.startup" {
