; ModuleID = 'POJ-104-source/20/20-467.cpp'
source_filename = "POJ-104-source/20/20-467.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_467.cpp, i8* null }]
...
45:                                               ; preds = %19
  ...
  %54 = getelementptr inbounds [20 x i8], [20 x i8]* %9, i64 0, i64 0
...
79:                                               ; preds = %65
  ...
  %87 = getelementptr inbounds [20 x i8], [20 x i8]* %9, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_467.cpp() #0 section ".text.startup" {
