; ModuleID = 'POJ-104-source/20/20-475.cpp'
source_filename = "POJ-104-source/20/20-475.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_475.cpp, i8* null }]
...
14:                                               ; preds = %116, %0
  ...
  %21 = getelementptr inbounds [100 x [3 x i8]], [100 x [3 x i8]]* %3, i64 0, i64 %20
  %22 = getelementptr inbounds [3 x i8], [3 x i8]* %21, i64 0, i64 0
  %23 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i8* %18, i8* %22)
  %24 = icmp ne i32 %23, -1
...
41:                                               ; preds = %37
  ...
  %44 = getelementptr inbounds [100 x [10 x i8]], [100 x [10 x i8]]* %2, i64 0, i64 %43
...
71:                                               ; preds = %67
  ...
  %81 = getelementptr inbounds [100 x [30 x i8]], [100 x [30 x i8]]* %5, i64 0, i64 %80
...
97:                                               ; preds = %93
  ...
  %100 = getelementptr inbounds [100 x [10 x i8]], [100 x [10 x i8]]* %2, i64 0, i64 %99
...
116:                                              ; preds = %93
  ...
  %119 = getelementptr inbounds [100 x [30 x i8]], [100 x [30 x i8]]* %5, i64 0, i64 %118
  ...
  %128 = getelementptr inbounds [100 x [30 x i8]], [100 x [30 x i8]]* %5, i64 0, i64 %127
  ...
  %134 = call i8* @strcat(i8* %129, i8* %133) #3
  %135 = load i32, i32* %8, align 4
  %136 = sext i32 %135 to i64
  %137 = getelementptr inbounds [100 x [30 x i8]], [100 x [30 x i8]]* %5, i64 0, i64 %136
  %138 = getelementptr inbounds [30 x i8], [30 x i8]* %137, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_475.cpp() #0 section ".text.startup" {
