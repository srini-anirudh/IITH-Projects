; ModuleID = 'POJ-104-source/20/20-477.cpp'
source_filename = "POJ-104-source/20/20-477.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_477.cpp, i8* null }]
...
14:                                               ; preds = %9
  ...
  %22 = load i32, i32* %5, align 4
  call void @_Z4swapPci(i8* %21, i32 %22)
  store i32 0, i32* %6, align 4
  br label %23
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_477.cpp() #0 section ".text.startup" {
