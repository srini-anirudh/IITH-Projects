; ModuleID = 'POJ-104-source/20/20-484.cpp'
source_filename = "POJ-104-source/20/20-484.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_484.cpp, i8* null }]
...
define dso_local signext i8 @_Z3maxPci(i8* %0, i32 %1) #4 {
  %3 = alloca i8*, align 8
...
13:                                               ; preds = %8
  ...
  %22 = call signext i8 @_Z3maxPci(i8* %20, i32 %21)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_484.cpp() #0 section ".text.startup" {
