; ModuleID = 'POJ-104-source/20/20-489.cpp'
source_filename = "POJ-104-source/20/20-489.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_489.cpp, i8* null }]
...
66:                                               ; preds = %45
  %67 = getelementptr inbounds [10 x i8], [10 x i8]* %2, i64 0, i64 0
  %68 = getelementptr inbounds [30 x i8], [30 x i8]* %3, i64 0, i64 0
  %69 = call i8* @strcat(i8* %67, i8* %68) #3
  %70 = getelementptr inbounds [10 x i8], [10 x i8]* %2, i64 0, i64 0
  %71 = getelementptr inbounds [30 x i8], [30 x i8]* %8, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_489.cpp() #0 section ".text.startup" {
