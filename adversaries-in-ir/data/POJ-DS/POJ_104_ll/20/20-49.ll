; ModuleID = 'POJ-104-source/20/20-49.cpp'
source_filename = "POJ-104-source/20/20-49.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_49.cpp, i8* null }]
...
54:                                               ; preds = %40
  %55 = getelementptr inbounds [4 x i8], [4 x i8]* %5, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_49.cpp() #0 section ".text.startup" {
