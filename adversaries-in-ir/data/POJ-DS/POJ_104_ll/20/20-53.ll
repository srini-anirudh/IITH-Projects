; ModuleID = 'POJ-104-source/20/20-53.cpp'
source_filename = "POJ-104-source/20/20-53.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_53.cpp, i8* null }]
...
20:                                               ; preds = %14
  ...
  %23 = getelementptr inbounds [11 x i8], [11 x i8]* %6, i64 0, i64 %22
...
71:                                               ; preds = %84, %68
  ...
  %74 = getelementptr inbounds [11 x i8], [11 x i8]* %6, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_53.cpp() #0 section ".text.startup" {
