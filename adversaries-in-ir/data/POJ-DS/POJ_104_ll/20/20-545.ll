; ModuleID = 'POJ-104-source/20/20-545.cpp'
source_filename = "POJ-104-source/20/20-545.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_545.cpp, i8* null }]
...
13:                                               ; preds = %8
  ...
  call void @_Z6insertPcS_iS_(i8* %19, i8* %20, i32 %21, i8* %22)
...
define dso_local i32 @_Z3maxPc(i8* %0) #7 {
  %2 = alloca i8*, align 8
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z6insertPcS_iS_(i8* %0, i8* %1, i32 %2, i8* %3) #7 {
  %5 = alloca i8*, align 8
  %6 = alloca i8*, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_545.cpp() #0 section ".text.startup" {
