; ModuleID = 'POJ-104-source/20/20-554.cpp'
source_filename = "POJ-104-source/20/20-554.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_554.cpp, i8* null }]
...
define dso_local i32 @_Z8MaxIndexPc(i8* %0) #4 {
  %2 = alloca i8*, align 8
  %3 = alloca i8, align 1
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z3funPcS_(i8* %0, i8* %1) #4 {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
  %5 = alloca i32, align 4
  %6 = alloca i8*, align 8
...
13:                                               ; preds = %8
  ...
  call void @_Z3funPcS_(i8* %14, i8* %15)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_554.cpp() #0 section ".text.startup" {
