; ModuleID = 'POJ-104-source/20/20-56.cpp'
source_filename = "POJ-104-source/20/20-56.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_56.cpp, i8* null }]
...
31:                                               ; preds = %16
  %32 = getelementptr inbounds [3 x i8], [3 x i8]* %6, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_56.cpp() #0 section ".text.startup" {
