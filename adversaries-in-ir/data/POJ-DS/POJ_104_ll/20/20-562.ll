; ModuleID = 'POJ-104-source/20/20-562.cpp'
source_filename = "POJ-104-source/20/20-562.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_562.cpp, i8* null }]
...
define dso_local i32 @_Z3maxPc(i8* %0) #5 {
  %2 = alloca i8*, align 8
...
; Function Attrs: noinline uwtable
define dso_local void @_Z3cutPciS_(i8* %0, i32 %1, i8* %2) #0 {
  %4 = alloca i8*, align 8
  %5 = alloca i32, align 4
  %6 = alloca i8*, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_562.cpp() #0 section ".text.startup" {
