; ModuleID = 'POJ-104-source/20/20-57.cpp'
source_filename = "POJ-104-source/20/20-57.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_57.cpp, i8* null }]
...
21:                                               ; preds = %17
  ...
  %29 = getelementptr inbounds [15 x i8], [15 x i8]* %6, i64 0, i64 %28
...
86:                                               ; preds = %81
  ...
  %89 = getelementptr inbounds [15 x i8], [15 x i8]* %6, i64 0, i64 %88
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_57.cpp() #0 section ".text.startup" {
