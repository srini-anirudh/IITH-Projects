; ModuleID = 'POJ-104-source/20/20-576.cpp'
source_filename = "POJ-104-source/20/20-576.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_576.cpp, i8* null }]
...
7:                                                ; preds = %64, %0
  %8 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), [100 x i8]* %5, [5 x i8]* %6)
  %9 = icmp ne i32 %8, -1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_576.cpp() #0 section ".text.startup" {
