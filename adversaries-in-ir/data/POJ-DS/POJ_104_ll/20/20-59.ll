; ModuleID = 'POJ-104-source/20/20-59.cpp'
source_filename = "POJ-104-source/20/20-59.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_59.cpp, i8* null }]
...
14:                                               ; preds = %11
  ...
  %21 = getelementptr inbounds [100 x [4 x i8]], [100 x [4 x i8]]* %3, i64 0, i64 %20
...
99:                                               ; preds = %94
  ...
  %102 = getelementptr inbounds [100 x [4 x i8]], [100 x [4 x i8]]* %3, i64 0, i64 %101
  %103 = load i32, i32* %9, align 4
  %104 = load i32, i32* %7, align 4
  %105 = sub nsw i32 %103, %104
  %106 = sext i32 %105 to i64
  %107 = getelementptr inbounds [4 x i8], [4 x i8]* %102, i64 0, i64 %106
...
144:                                              ; preds = %121
  ...
  %149 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i8* %148)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_59.cpp() #0 section ".text.startup" {
