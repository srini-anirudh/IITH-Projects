; ModuleID = 'POJ-104-source/20/20-593.cpp'
source_filename = "POJ-104-source/20/20-593.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_593.cpp, i8* null }]
...
define dso_local signext i8 @_Z5zuidaPc(i8* %0) #4 {
  %2 = alloca i8*, align 8
  %3 = alloca i8, align 1
...
13:                                               ; preds = %8
  ...
  %21 = call signext i8 @_Z5zuidaPc(i8* %20)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_593.cpp() #0 section ".text.startup" {
