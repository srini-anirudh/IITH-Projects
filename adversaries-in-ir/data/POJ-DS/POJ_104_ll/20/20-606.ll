; ModuleID = 'POJ-104-source/20/20-606.cpp'
source_filename = "POJ-104-source/20/20-606.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_606.cpp, i8* null }]
...
69:                                               ; preds = %65
  ...
  %72 = getelementptr inbounds [10 x i8], [10 x i8]* %11, i64 0, i64 %71
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_606.cpp() #0 section ".text.startup" {
