; ModuleID = 'POJ-104-source/20/20-610.cpp'
source_filename = "POJ-104-source/20/20-610.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_610.cpp, i8* null }]
...
68:                                               ; preds = %62
  ...
  %81 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i64 0, i64 0), i32 %71, i32 %74, i32 %77, i32 %80)
  br label %82
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_610.cpp() #0 section ".text.startup" {
