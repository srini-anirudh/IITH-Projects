; ModuleID = 'POJ-104-source/20/20-621.cpp'
source_filename = "POJ-104-source/20/20-621.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_621.cpp, i8* null }]
...
40:                                               ; preds = %18
  %41 = getelementptr inbounds [16 x i8], [16 x i8]* %2, i64 0, i64 0
...
91:                                               ; preds = %109, %90
  ...
  %94 = getelementptr inbounds [16 x i8], [16 x i8]* %2, i64 0, i64 0
...
100:                                              ; preds = %91
  ...
  %104 = getelementptr inbounds [16 x i8], [16 x i8]* %2, i64 0, i64 %103
...
115:                                              ; preds = %131, %114
  ...
  %118 = getelementptr inbounds [16 x i8], [16 x i8]* %2, i64 0, i64 0
  %119 = call i64 @strlen(i8* %118) #6
  %120 = getelementptr inbounds [4 x i8], [4 x i8]* %3, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_621.cpp() #0 section ".text.startup" {
