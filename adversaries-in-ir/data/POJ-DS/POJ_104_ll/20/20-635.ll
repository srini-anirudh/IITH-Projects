; ModuleID = 'POJ-104-source/20/20-635.cpp'
source_filename = "POJ-104-source/20/20-635.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_635.cpp, i8* null }]
...
58:                                               ; preds = %45
  ...
  %67 = getelementptr inbounds [20 x i8], [20 x i8]* %4, i64 0, i64 %66
...
92:                                               ; preds = %87
  ...
  %98 = getelementptr inbounds [20 x i8], [20 x i8]* %4, i64 0, i64 0
...
127:                                              ; preds = %124
  ...
  %130 = getelementptr inbounds [10 x i8], [10 x i8]* %3, i64 0, i64 %129
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_635.cpp() #0 section ".text.startup" {
