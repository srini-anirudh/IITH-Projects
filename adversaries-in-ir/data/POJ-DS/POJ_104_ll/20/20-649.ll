; ModuleID = 'POJ-104-source/20/20-649.cpp'
source_filename = "POJ-104-source/20/20-649.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_649.cpp, i8* null }]
...
8:                                                ; preds = %5
  ...
  %13 = call noalias i8* @malloc(i64 5) #3
...
20:                                               ; preds = %5
  ...
  call void @_Z2scPPcS0_(i8** %21, i8** %22)
...
; Function Attrs: noinline uwtable
define dso_local void @_Z2scPPcS0_(i8** %0, i8** %1) #0 {
  %3 = alloca i8**, align 8
  %4 = alloca i8**, align 8
...
11:                                               ; preds = %179, %2
  ...
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i8* %16, i8* %21)
  %23 = icmp ne i32 %22, -1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_649.cpp() #0 section ".text.startup" {
