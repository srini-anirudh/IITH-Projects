; ModuleID = 'POJ-104-source/20/20-655.cpp'
source_filename = "POJ-104-source/20/20-655.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_655.cpp, i8* null }]
...
8:                                                ; preds = %75, %0
  %9 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), [15 x i8]* %2, [5 x i8]* %3)
  %10 = icmp ne i32 %9, -1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_655.cpp() #0 section ".text.startup" {
