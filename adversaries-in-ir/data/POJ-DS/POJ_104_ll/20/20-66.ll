; ModuleID = 'POJ-104-source/20/20-66.cpp'
source_filename = "POJ-104-source/20/20-66.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_66.cpp, i8* null }]
...
8:                                                ; preds = %81, %0
  store i8 0, i8* %7, align 1
  %9 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), [10 x i8]* %5, [3 x i8]* %6)
  %10 = icmp eq i32 %9, -1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_66.cpp() #0 section ".text.startup" {
