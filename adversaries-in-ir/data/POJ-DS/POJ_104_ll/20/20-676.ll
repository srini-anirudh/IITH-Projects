; ModuleID = 'POJ-104-source/20/20-676.cpp'
source_filename = "POJ-104-source/20/20-676.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_676.cpp, i8* null }]
...
define dso_local i32 @_Z4findPci(i8* %0, i32 %1) #4 {
  %3 = alloca i8*, align 8
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z6insertPcS_ii(i8* %0, i8* %1, i32 %2, i32 %3) #4 {
  %5 = alloca i8*, align 8
  %6 = alloca i8*, align 8
  %7 = alloca i32, align 4
...
11:                                               ; preds = %6
  ...
  %17 = call i32 @_Z4findPci(i8* %15, i32 %16)
  ...
  call void @_Z6insertPcS_ii(i8* %18, i8* %19, i32 %20, i32 %21)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_676.cpp() #0 section ".text.startup" {
