; ModuleID = 'POJ-104-source/20/20-692.cpp'
source_filename = "POJ-104-source/20/20-692.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_692.cpp, i8* null }]
...
94:                                               ; preds = %88
  ...
  %99 = getelementptr inbounds [11 x i8], [11 x i8]* %6, i64 0, i64 %98
  %100 = load i8, i8* %99, align 1
  %101 = load i32, i32* %2, align 4
  %102 = sext i32 %101 to i64
  %103 = getelementptr inbounds [15 x i8], [15 x i8]* %8, i64 0, i64 %102
...
107:                                              ; preds = %88
  ...
  %113 = getelementptr inbounds [15 x i8], [15 x i8]* %8, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_692.cpp() #0 section ".text.startup" {
