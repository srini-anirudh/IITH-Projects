; ModuleID = 'POJ-104-source/20/20-696.cpp'
source_filename = "POJ-104-source/20/20-696.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_696.cpp, i8* null }]
...
define dso_local i32 @_Z7findmaxPci(i8* %0, i32 %1) #4 {
  %3 = alloca i8*, align 8
...
12:                                               ; preds = %7
  ...
  %17 = call i32 @_Z7findmaxPci(i8* %13, i32 %16)
  ...
  %27 = getelementptr inbounds [11 x i8], [11 x i8]* %3, i64 0, i64 0
  %28 = getelementptr inbounds [4 x i8], [4 x i8]* %4, i64 0, i64 0
  %29 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i8* %27, i8* %28)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_696.cpp() #0 section ".text.startup" {
