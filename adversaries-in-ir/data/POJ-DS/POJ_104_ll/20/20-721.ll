; ModuleID = 'POJ-104-source/20/20-721.cpp'
source_filename = "POJ-104-source/20/20-721.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_721.cpp, i8* null }]
...
21:                                               ; preds = %17
  ...
  %24 = getelementptr inbounds [13 x i8], [13 x i8]* %2, i64 0, i64 %23
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_721.cpp() #0 section ".text.startup" {
