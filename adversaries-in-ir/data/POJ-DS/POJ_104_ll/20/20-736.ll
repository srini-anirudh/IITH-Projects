; ModuleID = 'POJ-104-source/20/20-736.cpp'
source_filename = "POJ-104-source/20/20-736.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_736.cpp, i8* null }]
...
10:                                               ; preds = %19, %0
  ...
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), [15 x i8]* %13, [4 x i8]* %16)
  %18 = icmp ne i32 %17, -1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_736.cpp() #0 section ".text.startup" {
