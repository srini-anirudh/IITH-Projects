; ModuleID = 'POJ-104-source/20/20-753.cpp'
source_filename = "POJ-104-source/20/20-753.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_753.cpp, i8* null }]
...
8:                                                ; preds = %106, %0
  ...
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i8* %12, i8* %16)
  %18 = icmp ne i32 %17, -1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_753.cpp() #0 section ".text.startup" {
