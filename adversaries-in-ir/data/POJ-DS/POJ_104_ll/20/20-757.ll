; ModuleID = 'POJ-104-source/20/20-757.cpp'
source_filename = "POJ-104-source/20/20-757.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_757.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5printiiPc(i32 %0, i32 %1, i8* %2) #0 {
...
define dso_local i32 @_Z7arrangePc(i8* %0) #4 {
  %2 = alloca i8*, align 8
...
7:                                                ; preds = %12, %0
  ...
  %10 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i8* %8, i8* %9)
  %11 = icmp ne i32 %10, -1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_757.cpp() #0 section ".text.startup" {
