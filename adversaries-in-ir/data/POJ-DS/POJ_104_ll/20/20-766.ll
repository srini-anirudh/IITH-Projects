; ModuleID = 'POJ-104-source/20/20-766.cpp'
source_filename = "POJ-104-source/20/20-766.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_766.cpp, i8* null }]
...
13:                                               ; preds = %24, %0
  ...
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i8* %17, i8* %21)
  %23 = icmp ne i32 %22, -1
  br i1 %23, label %24, label %28

24:                                               ; preds = %13
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0))
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_766.cpp() #0 section ".text.startup" {
