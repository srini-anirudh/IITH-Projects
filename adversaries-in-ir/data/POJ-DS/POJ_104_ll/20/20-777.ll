; ModuleID = 'POJ-104-source/20/20-777.cpp'
source_filename = "POJ-104-source/20/20-777.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_777.cpp, i8* null }]
...
51:                                               ; preds = %43
  ...
  %56 = getelementptr inbounds [20 x i32], [20 x i32]* %8, i64 0, i64 0
...
61:                                               ; preds = %38
  %62 = getelementptr inbounds [20 x i32], [20 x i32]* %8, i64 0, i64 0
...
105:                                              ; preds = %88
  ...
  %118 = getelementptr inbounds [100 x i8], [100 x i8]* %3, i64 0, i64 2
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_777.cpp() #0 section ".text.startup" {
