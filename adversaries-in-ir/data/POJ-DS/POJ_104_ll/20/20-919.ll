; ModuleID = 'POJ-104-source/20/20-919.cpp'
source_filename = "POJ-104-source/20/20-919.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_919.cpp, i8* null }]
...
25:                                               ; preds = %11
  ...
  %29 = getelementptr inbounds [5 x i8], [5 x i8]* %3, i64 0, i64 0
...
105:                                              ; preds = %98
  ...
  %110 = getelementptr inbounds [5 x i8], [5 x i8]* %3, i64 0, i64 %109
...
118:                                              ; preds = %98
  %119 = getelementptr inbounds [20 x i8], [20 x i8]* %2, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_919.cpp() #0 section ".text.startup" {
