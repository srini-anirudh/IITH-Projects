; ModuleID = 'POJ-104-source/20/20-921.cpp'
source_filename = "POJ-104-source/20/20-921.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_921.cpp, i8* null }]
...
define dso_local i32 @_Z4posiPc(i8* %0) #4 {
  %2 = alloca i8*, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_921.cpp() #0 section ".text.startup" {
