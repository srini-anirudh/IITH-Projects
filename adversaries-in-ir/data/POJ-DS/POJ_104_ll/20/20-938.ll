; ModuleID = 'POJ-104-source/20/20-938.cpp'
source_filename = "POJ-104-source/20/20-938.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_938.cpp, i8* null }]
...
59:                                               ; preds = %42
  %60 = getelementptr inbounds [5 x i8], [5 x i8]* %7, i64 0, i64 0
  ...
  %66 = getelementptr inbounds [5 x i8], [5 x i8]* %7, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_938.cpp() #0 section ".text.startup" {
