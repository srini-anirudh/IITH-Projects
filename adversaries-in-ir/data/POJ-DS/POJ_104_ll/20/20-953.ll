; ModuleID = 'POJ-104-source/20/20-953.cpp'
source_filename = "POJ-104-source/20/20-953.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_953.cpp, i8* null }]
...
37:                                               ; preds = %27
  ...
  %41 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSi7getlineEPclc(%"class.std::basic_istream"* @_ZSt3cin, i8* %40, i64 4, i8 signext 10)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_953.cpp() #0 section ".text.startup" {
