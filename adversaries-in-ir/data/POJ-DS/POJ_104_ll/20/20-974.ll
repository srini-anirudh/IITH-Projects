; ModuleID = 'POJ-104-source/20/20-974.cpp'
source_filename = "POJ-104-source/20/20-974.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_20_974.cpp, i8* null }]
...
41:                                               ; preds = %16
  ...
  %47 = call i8* @strncpy(i8* %42, i8* %43, i64 %46) #3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_20_974.cpp() #0 section ".text.startup" {
