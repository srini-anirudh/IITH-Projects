; ModuleID = 'POJ-104-source/21/21-1083.cpp'
source_filename = "POJ-104-source/21/21-1083.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_1083.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %9 = alloca [400 x double], align 16
...
56:                                               ; preds = %48
  ...
  %66 = getelementptr inbounds [400 x double], [400 x double]* %9, i64 0, i64 %65
...
67:                                               ; preds = %48
  ...
  %77 = getelementptr inbounds [400 x double], [400 x double]* %9, i64 0, i64 %76
...
78:                                               ; preds = %67, %56
  ...
  %81 = getelementptr inbounds [400 x double], [400 x double]* %9, i64 0, i64 %80
...
85:                                               ; preds = %78
  ...
  %88 = getelementptr inbounds [400 x double], [400 x double]* %9, i64 0, i64 %87
...
99:                                               ; preds = %95
  ...
  %102 = getelementptr inbounds [400 x double], [400 x double]* %9, i64 0, i64 %101
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_1083.cpp() #0 section ".text.startup" {
