; ModuleID = 'POJ-104-source/21/21-114.cpp'
source_filename = "POJ-104-source/21/21-114.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_114.cpp, i8* null }]
...
126:                                              ; preds = %122
  ...
  %131 = getelementptr inbounds [300 x double], [300 x double]* %9, i64 0, i64 0
...
134:                                              ; preds = %126
  ...
  %150 = select i1 %148, i8 44, i8 10
  %151 = sext i8 %150 to i32
  %152 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32 %138, i32 %151)
  br label %153
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_114.cpp() #0 section ".text.startup" {
