; ModuleID = 'POJ-104-source/21/21-1163.cpp'
source_filename = "POJ-104-source/21/21-1163.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_1163.cpp, i8* null }]
...
define dso_local void @_Z2bbiPi(i32 %0, i32* %1) #4 {
...
34:                                               ; preds = %20
  ...
  call void @_Z2bbiPi(i32 %35, i32* %36)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_1163.cpp() #0 section ".text.startup" {
