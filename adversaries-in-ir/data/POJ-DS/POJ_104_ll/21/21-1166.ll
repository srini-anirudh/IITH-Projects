; ModuleID = 'POJ-104-source/21/21-1166.cpp'
source_filename = "POJ-104-source/21/21-1166.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_1166.cpp, i8* null }]
...
define dso_local double @_Z5absssd(double %0) #4 {
...
33:                                               ; preds = %14
  ...
  %43 = call double @_Z5absssd(double %42)
...
48:                                               ; preds = %44
  ...
  %56 = call double @_Z5absssd(double %55)
...
59:                                               ; preds = %48
  ...
  %67 = call double @_Z5absssd(double %66)
...
88:                                               ; preds = %77
  ...
  %96 = call double @_Z5absssd(double %95)
...
106:                                              ; preds = %102
  ...
  %114 = call double @_Z5absssd(double %113)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_1166.cpp() #0 section ".text.startup" {
