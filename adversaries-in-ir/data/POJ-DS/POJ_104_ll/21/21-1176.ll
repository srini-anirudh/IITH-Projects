; ModuleID = 'POJ-104-source/21/21-1176.cpp'
source_filename = "POJ-104-source/21/21-1176.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_1176.cpp, i8* null }]
...
23:                                               ; preds = %10
  ...
  call void @_Z5arrayPii(i32* %24, i32 %25)
...
define dso_local void @_Z5arrayPii(i32* %0, i32 %1) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_1176.cpp() #0 section ".text.startup" {
