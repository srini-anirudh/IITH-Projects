; ModuleID = 'POJ-104-source/21/21-1184.cpp'
source_filename = "POJ-104-source/21/21-1184.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_1184.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %18 = getelementptr inbounds [300 x double], [300 x double]* %5, i64 0, i64 %17
...
28:                                               ; preds = %24
  ...
  %31 = getelementptr inbounds [300 x double], [300 x double]* %5, i64 0, i64 %30
...
54:                                               ; preds = %47
  ...
  %63 = getelementptr inbounds [300 x double], [300 x double]* %6, i64 0, i64 %62
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_1184.cpp() #0 section ".text.startup" {
