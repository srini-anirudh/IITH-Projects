; ModuleID = 'POJ-104-source/21/21-1186.cpp'
source_filename = "POJ-104-source/21/21-1186.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_1186.cpp, i8* null }]
...
define dso_local float @_Z6jueduif(float %0) #4 {
...
53:                                               ; preds = %49
  ...
  %62 = fsub float %60, %61
  %63 = call float @_Z6jueduif(float %62)
...
65:                                               ; preds = %53
  ...
  %73 = fsub float %71, %72
  %74 = call float @_Z6jueduif(float %73)
...
85:                                               ; preds = %81
  ...
  %93 = fsub float %91, %92
  %94 = call float @_Z6jueduif(float %93)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_1186.cpp() #0 section ".text.startup" {
