; ModuleID = 'POJ-104-source/21/21-1326.cpp'
source_filename = "POJ-104-source/21/21-1326.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_1326.cpp, i8* null }]
...
166:                                              ; preds = %162
  ...
  %169 = getelementptr inbounds [300 x double], [300 x double]* %9, i64 0, i64 %168
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_1326.cpp() #0 section ".text.startup" {
