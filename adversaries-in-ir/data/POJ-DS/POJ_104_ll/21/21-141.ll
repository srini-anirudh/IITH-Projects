; ModuleID = 'POJ-104-source/21/21-141.cpp'
source_filename = "POJ-104-source/21/21-141.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_141.cpp, i8* null }]
...
67:                                               ; preds = %63
  ...
  %74 = getelementptr inbounds [300 x float], [300 x float]* %9, i64 0, i64 %73
...
77:                                               ; preds = %67
  ...
  %109 = getelementptr inbounds [300 x float], [300 x float]* %9, i64 0, i64 %108
...
118:                                              ; preds = %55
  %119 = getelementptr inbounds [300 x i32], [300 x i32]* %5, i64 0, i64 0
...
126:                                              ; preds = %122
  ...
  %131 = getelementptr inbounds [300 x float], [300 x float]* %9, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_141.cpp() #0 section ".text.startup" {
