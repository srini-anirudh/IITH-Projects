; ModuleID = 'POJ-104-source/21/21-1463.cpp'
source_filename = "POJ-104-source/21/21-1463.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_1463.cpp, i8* null }]
...
52:                                               ; preds = %43
  ...
  %64 = getelementptr inbounds [300 x float], [300 x float]* %5, i64 0, i64 %63
...
65:                                               ; preds = %43
  ...
  %77 = getelementptr inbounds [300 x float], [300 x float]* %5, i64 0, i64 %76
...
82:                                               ; preds = %39
  %83 = getelementptr inbounds [300 x float], [300 x float]* %5, i64 0, i64 0
...
110:                                              ; preds = %106
  ...
  %113 = getelementptr inbounds [300 x float], [300 x float]* %5, i64 0, i64 %112
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_1463.cpp() #0 section ".text.startup" {
