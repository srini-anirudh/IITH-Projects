; ModuleID = 'POJ-104-source/21/21-1481.cpp'
source_filename = "POJ-104-source/21/21-1481.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_1481.cpp, i8* null }]
...
53:                                               ; preds = %34
  %54 = getelementptr inbounds [100 x float], [100 x float]* %8, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_1481.cpp() #0 section ".text.startup" {
