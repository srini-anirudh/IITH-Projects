; ModuleID = 'POJ-104-source/21/21-1507.cpp'
source_filename = "POJ-104-source/21/21-1507.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_1507.cpp, i8* null }]
...
20:                                               ; preds = %13
  ...
  %31 = getelementptr inbounds [310 x i32], [310 x i32]* %2, i64 0, i64 %30
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_1507.cpp() #0 section ".text.startup" {
