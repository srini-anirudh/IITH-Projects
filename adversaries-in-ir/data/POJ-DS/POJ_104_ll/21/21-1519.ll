; ModuleID = 'POJ-104-source/21/21-1519.cpp'
source_filename = "POJ-104-source/21/21-1519.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_1519.cpp, i8* null }]
...
121:                                              ; preds = %72
  ...
  %136 = getelementptr inbounds [300 x i32], [300 x i32]* %4, i64 0, i64 1
...
176:                                              ; preds = %173, %165, %139
  %177 = load i32, i32* %9, align 4
  %178 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32 %177)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_1519.cpp() #0 section ".text.startup" {
