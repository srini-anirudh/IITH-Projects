; ModuleID = 'POJ-104-source/21/21-1534.cpp'
source_filename = "POJ-104-source/21/21-1534.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_1534.cpp, i8* null }]
...
58:                                               ; preds = %51
  ...
  %61 = getelementptr inbounds [300 x i32], [300 x i32]* %10, i64 0, i64 %60
...
112:                                              ; preds = %95
  ...
  %120 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 %114, i32 %119)
  br label %137
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_1534.cpp() #0 section ".text.startup" {
