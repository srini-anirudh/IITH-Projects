; ModuleID = 'POJ-104-source/21/21-1535.cpp'
source_filename = "POJ-104-source/21/21-1535.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_1535.cpp, i8* null }]
...
24:                                               ; preds = %10
  ...
  call void @_Z6bubblePii(i32* %25, i32 %26)
  store i32 0, i32* %4, align 4
  br label %27
...
76:                                               ; preds = %72
  ...
  %84 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 %78, i32 %83)
  br label %92
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_1535.cpp() #0 section ".text.startup" {
