; ModuleID = 'POJ-104-source/21/21-1563.cpp'
source_filename = "POJ-104-source/21/21-1563.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_1563.cpp, i8* null }]
...
define dso_local float @_Z3gapif(i32 %0, float %1) #4 {
...
38:                                               ; preds = %33
  ...
  %44 = call float @_Z3gapif(i32 %42, float %43)
  ...
  %51 = call float @_Z3gapif(i32 %49, float %50)
...
53:                                               ; preds = %38
  ...
  %60 = call float @_Z3gapif(i32 %58, float %59)
...
63:                                               ; preds = %53
  ...
  %70 = call float @_Z3gapif(i32 %68, float %69)
...
71:                                               ; preds = %63, %53, %38
  ...
  %77 = call float @_Z3gapif(i32 %75, float %76)
  ...
  %84 = call float @_Z3gapif(i32 %82, float %83)
...
86:                                               ; preds = %71
  ...
  %92 = call float @_Z3gapif(i32 %90, float %91)
...
95:                                               ; preds = %86
  ...
  %101 = call float @_Z3gapif(i32 %99, float %100)
...
111:                                              ; preds = %107
  ...
  %117 = call float @_Z3gapif(i32 %115, float %116)
...
138:                                              ; preds = %134
  ...
  %144 = call float @_Z3gapif(i32 %142, float %143)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_1563.cpp() #0 section ".text.startup" {
