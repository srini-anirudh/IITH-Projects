; ModuleID = 'POJ-104-source/21/21-1565.cpp'
source_filename = "POJ-104-source/21/21-1565.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_1565.cpp, i8* null }]
...
90:                                               ; preds = %43
  ...
  %92 = getelementptr inbounds [301 x i32], [301 x i32]* %5, i64 0, i64 1
...
104:                                              ; preds = %90
  %105 = getelementptr inbounds [301 x i32], [301 x i32]* %5, i64 0, i64 1
...
128:                                              ; preds = %108
  %129 = getelementptr inbounds [301 x i32], [301 x i32]* %5, i64 0, i64 1
  %130 = load i32, i32* %129, align 4
  %131 = load i32, i32* %2, align 4
  %132 = sext i32 %131 to i64
  %133 = getelementptr inbounds [301 x i32], [301 x i32]* %5, i64 0, i64 %132
  %134 = load i32, i32* %133, align 4
  %135 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 %130, i32 %134)
  br label %136
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_1565.cpp() #0 section ".text.startup" {
