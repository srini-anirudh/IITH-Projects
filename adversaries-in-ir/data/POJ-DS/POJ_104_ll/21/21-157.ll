; ModuleID = 'POJ-104-source/21/21-157.cpp'
source_filename = "POJ-104-source/21/21-157.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_157.cpp, i8* null }]
...
define dso_local float @_Z3juef(float %0) #4 {
...
33:                                               ; preds = %14
  ...
  %42 = fsub float %40, %41
  %43 = call float @_Z3juef(float %42)
...
48:                                               ; preds = %44
  ...
  %55 = fsub float %53, %54
  %56 = call float @_Z3juef(float %55)
...
71:                                               ; preds = %67
  ...
  %78 = fsub float %76, %77
  %79 = call float @_Z3juef(float %78)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_157.cpp() #0 section ".text.startup" {
