; ModuleID = 'POJ-104-source/21/21-1573.cpp'
source_filename = "POJ-104-source/21/21-1573.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_1573.cpp, i8* null }]
...
109:                                              ; preds = %96
  ...
  %118 = getelementptr inbounds [300 x %struct.point], [300 x %struct.point]* %2, i64 0, i64 %117
  ...
  %123 = bitcast %struct.point* %118 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_1573.cpp() #0 section ".text.startup" {
