; ModuleID = 'POJ-104-source/21/21-1594.cpp'
source_filename = "POJ-104-source/21/21-1594.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_1594.cpp, i8* null }]
...
define dso_local float @_Z2ccif(i32 %0, float %1) #4 {
...
15:                                               ; preds = %11
  ...
  %18 = getelementptr inbounds [301 x i32], [301 x i32]* %8, i64 0, i64 %17
...
39:                                               ; preds = %35
  ...
  %45 = call float @_Z2ccif(i32 %43, float %44)
...
48:                                               ; preds = %39
  ...
  %54 = call float @_Z2ccif(i32 %52, float %53)
...
64:                                               ; preds = %60
  ...
  %70 = call float @_Z2ccif(i32 %68, float %69)
...
73:                                               ; preds = %64
  ...
  %82 = getelementptr inbounds [301 x i32], [301 x i32]* %9, i64 0, i64 %81
...
99:                                               ; preds = %93
  ...
  %102 = getelementptr inbounds [301 x i32], [301 x i32]* %9, i64 0, i64 %101
  %103 = load i32, i32* %102, align 4
  %104 = load i32, i32* %5, align 4
  %105 = add nsw i32 %104, 1
  %106 = sext i32 %105 to i64
  %107 = getelementptr inbounds [301 x i32], [301 x i32]* %9, i64 0, i64 %106
...
110:                                              ; preds = %99
  ...
  %129 = getelementptr inbounds [301 x i32], [301 x i32]* %9, i64 0, i64 %128
...
141:                                              ; preds = %138
  %142 = getelementptr inbounds [301 x i32], [301 x i32]* %9, i64 0, i64 1
  %143 = load i32, i32* %142, align 4
  %144 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32 %143)
  br label %163

145:                                              ; preds = %138
  %146 = getelementptr inbounds [301 x i32], [301 x i32]* %9, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_1594.cpp() #0 section ".text.startup" {
