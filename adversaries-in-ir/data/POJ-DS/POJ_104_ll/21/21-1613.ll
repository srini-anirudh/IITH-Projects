; ModuleID = 'POJ-104-source/21/21-1613.cpp'
source_filename = "POJ-104-source/21/21-1613.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_1613.cpp, i8* null }]
...
13:                                               ; preds = %9
  ...
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), double* %16)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_1613.cpp() #0 section ".text.startup" {
