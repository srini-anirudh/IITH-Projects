; ModuleID = 'POJ-104-source/21/21-1656.cpp'
source_filename = "POJ-104-source/21/21-1656.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_1656.cpp, i8* null }]
...
82:                                               ; preds = %78
  ...
  %90 = fsub double %89, 1.000000e-03
...
106:                                              ; preds = %102
  ...
  %114 = fsub double %113, 1.000000e-03
...
146:                                              ; preds = %142
  ...
  %154 = fsub double %153, 1.000000e-03
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_1656.cpp() #0 section ".text.startup" {
