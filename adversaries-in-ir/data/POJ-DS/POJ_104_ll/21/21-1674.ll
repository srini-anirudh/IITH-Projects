; ModuleID = 'POJ-104-source/21/21-1674.cpp'
source_filename = "POJ-104-source/21/21-1674.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_1674.cpp, i8* null }]
...
22:                                               ; preds = %10
  ...
  %23 = getelementptr inbounds [301 x i32], [301 x i32]* %5, i64 0, i64 0
  %24 = load i32, i32* %23, align 16
  store i32 %24, i32* %7, align 4
  %25 = getelementptr inbounds [301 x i32], [301 x i32]* %5, i64 0, i64 0
...
105:                                              ; preds = %97
  ...
  %112 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 %108, i32 %111)
  br label %113
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_1674.cpp() #0 section ".text.startup" {
