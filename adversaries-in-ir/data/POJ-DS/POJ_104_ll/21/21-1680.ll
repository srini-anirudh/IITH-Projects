; ModuleID = 'POJ-104-source/21/21-1680.cpp'
source_filename = "POJ-104-source/21/21-1680.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_1680.cpp, i8* null }]
...
define dso_local void @_Z7averagePiPf(i32* %0, float* %1) #4 {
...
; Function Attrs: noinline uwtable
define dso_local float @_Z3maxPfi(float* %0, i32 %1) #0 {
...
11:                                               ; preds = %7
  ...
  %17 = call float @_ZSt4fabsf(float %16)
...
23:                                               ; preds = %11
  ...
  %25 = getelementptr inbounds [300 x float], [300 x float]* %6, i64 0, i64 0
  call void @_Z7averagePiPf(i32* %24, float* %25)
  %26 = getelementptr inbounds [300 x float], [300 x float]* %6, i64 0, i64 0
  %27 = load i32, i32* %2, align 4
  %28 = call float @_Z3maxPfi(float* %26, i32 %27)
...
33:                                               ; preds = %29
  ...
  %36 = getelementptr inbounds [300 x float], [300 x float]* %6, i64 0, i64 %35
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_1680.cpp() #0 section ".text.startup" {
