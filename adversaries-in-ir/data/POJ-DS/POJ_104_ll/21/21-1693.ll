; ModuleID = 'POJ-104-source/21/21-1693.cpp'
source_filename = "POJ-104-source/21/21-1693.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_1693.cpp, i8* null }]
...
18:                                               ; preds = %14
  ...
  %32 = getelementptr inbounds [300 x float], [300 x float]* %11, i64 0, i64 %31
...
104:                                              ; preds = %93
  ...
  %109 = getelementptr inbounds [300 x i32], [300 x i32]* %5, i64 0, i64 0
...
129:                                              ; preds = %78
  %130 = getelementptr inbounds [300 x float], [300 x float]* %11, i64 0, i64 0
  ...
  %134 = getelementptr inbounds [300 x i32], [300 x i32]* %5, i64 0, i64 0
...
189:                                              ; preds = %140
  %190 = getelementptr inbounds [300 x i32], [300 x i32]* %5, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_1693.cpp() #0 section ".text.startup" {
