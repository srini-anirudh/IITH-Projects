; ModuleID = 'POJ-104-source/21/21-1710.cpp'
source_filename = "POJ-104-source/21/21-1710.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_1710.cpp, i8* null }]
...
89:                                               ; preds = %47
  %90 = getelementptr inbounds [300 x double], [300 x double]* %10, i64 0, i64 0
...
117:                                              ; preds = %113
  ...
  %120 = getelementptr inbounds [300 x double], [300 x double]* %10, i64 0, i64 %119
...
141:                                              ; preds = %138
  %142 = getelementptr inbounds [300 x i32], [300 x i32]* %6, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_1710.cpp() #0 section ".text.startup" {
