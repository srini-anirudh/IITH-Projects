; ModuleID = 'POJ-104-source/21/21-1745.cpp'
source_filename = "POJ-104-source/21/21-1745.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_1745.cpp, i8* null }]
...
108:                                              ; preds = %104
  ...
  %113 = getelementptr inbounds [400 x i32], [400 x i32]* %2, i64 0, i64 0
...
152:                                              ; preds = %143
  %153 = getelementptr inbounds [400 x i32], [400 x i32]* %2, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_1745.cpp() #0 section ".text.startup" {
