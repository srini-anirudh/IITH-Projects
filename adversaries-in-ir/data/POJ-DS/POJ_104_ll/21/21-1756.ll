; ModuleID = 'POJ-104-source/21/21-1756.cpp'
source_filename = "POJ-104-source/21/21-1756.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_1756.cpp, i8* null }]
...
24:                                               ; preds = %12
  ...
  %27 = call float @_Z7averagePii(i32* %25, i32 %26)
...
101:                                              ; preds = %98
  ...
  %104 = getelementptr inbounds [2 x i32], [2 x i32]* %3, i64 0, i64 1
...
define dso_local float @_Z7averagePii(i32* %0, i32 %1) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_1756.cpp() #0 section ".text.startup" {
