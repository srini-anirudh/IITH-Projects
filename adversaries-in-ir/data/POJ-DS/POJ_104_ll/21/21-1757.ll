; ModuleID = 'POJ-104-source/21/21-1757.cpp'
source_filename = "POJ-104-source/21/21-1757.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_1757.cpp, i8* null }]
...
51:                                               ; preds = %47
  ...
  %61 = getelementptr inbounds [300 x float], [300 x float]* %9, i64 0, i64 %60
...
65:                                               ; preds = %47
  %66 = getelementptr inbounds [300 x float], [300 x float]* %9, i64 0, i64 0
...
79:                                               ; preds = %72
  ...
  %82 = getelementptr inbounds [300 x float], [300 x float]* %9, i64 0, i64 %81
...
85:                                               ; preds = %79, %72
  %86 = getelementptr inbounds [300 x float], [300 x float]* %9, i64 0, i64 0
...
130:                                              ; preds = %113
  ...
  %137 = getelementptr inbounds [300 x float], [300 x float]* %9, i64 0, i64 %136
...
147:                                              ; preds = %130
  ...
  %156 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), i32 %151, i32 %155)
  br label %157
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_1757.cpp() #0 section ".text.startup" {
