; ModuleID = 'POJ-104-source/21/21-1805.cpp'
source_filename = "POJ-104-source/21/21-1805.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_1805.cpp, i8* null }]
...
89:                                               ; preds = %75
  ...
  %109 = fcmp oeq float %100, %108
  br i1 %109, label %110, label %118

110:                                              ; preds = %89
  %111 = getelementptr inbounds [300 x i32], [300 x i32]* %3, i64 0, i64 1
  %112 = load i32, i32* %111, align 4
  %113 = load i32, i32* %2, align 4
  %114 = sext i32 %113 to i64
  %115 = getelementptr inbounds [300 x i32], [300 x i32]* %3, i64 0, i64 %114
  %116 = load i32, i32* %115, align 4
  %117 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 %112, i32 %116)
  br label %145

118:                                              ; preds = %89
  %119 = getelementptr inbounds [300 x i32], [300 x i32]* %3, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_1805.cpp() #0 section ".text.startup" {
