; ModuleID = 'POJ-104-source/21/21-1816.cpp'
source_filename = "POJ-104-source/21/21-1816.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_1816.cpp, i8* null }]
...
102:                                              ; preds = %86
  ...
  %113 = call float @_ZSt4fabsf(float %112)
  ...
  %123 = call float @_ZSt4fabsf(float %122)
...
131:                                              ; preds = %102
  ...
  %138 = call float @_ZSt4fabsf(float %137)
...
159:                                              ; preds = %131
  ...
  %169 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 %162, i32 %168)
  br label %170
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_1816.cpp() #0 section ".text.startup" {
