; ModuleID = 'POJ-104-source/21/21-1840.cpp'
source_filename = "POJ-104-source/21/21-1840.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_1840.cpp, i8* null }]
...
94:                                               ; preds = %73
  ...
  %102 = call float @_ZSt4fabsf(float %101)
  ...
  %112 = call float @_ZSt4fabsf(float %111)
...
125:                                              ; preds = %94
  ...
  %128 = getelementptr inbounds [20 x i32], [20 x i32]* %3, i64 0, i64 %127
...
167:                                              ; preds = %149
  ...
  %170 = getelementptr inbounds [20 x i32], [20 x i32]* %3, i64 0, i64 %169
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_1840.cpp() #0 section ".text.startup" {
