; ModuleID = 'POJ-104-source/21/21-1849.cpp'
source_filename = "POJ-104-source/21/21-1849.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_1849.cpp, i8* null }]
...
define dso_local float @_Z1kf(float %0) #4 {
...
29:                                               ; preds = %11
  ...
  store i32 0, i32* %8, align 4
  %35 = getelementptr inbounds [400 x i32], [400 x i32]* %3, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_1849.cpp() #0 section ".text.startup" {
