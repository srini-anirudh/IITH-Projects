; ModuleID = 'POJ-104-source/21/21-1852.cpp'
source_filename = "POJ-104-source/21/21-1852.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_1852.cpp, i8* null }]
...
14:                                               ; preds = %10
  ...
  %17 = getelementptr inbounds [1000 x float], [1000 x float]* %3, i64 0, i64 %16
...
22:                                               ; preds = %10
  %23 = getelementptr inbounds [1000 x float], [1000 x float]* %3, i64 0, i64 0
  %24 = load i32, i32* %2, align 4
  call void @_Z2f1Pfi(float* %23, i32 %24)
  store i32 0, i32* %8, align 4
  br label %25
...
39:                                               ; preds = %25
  ...
  %44 = getelementptr inbounds [1000 x float], [1000 x float]* %3, i64 0, i64 0
...
58:                                               ; preds = %39
  ...
  %65 = getelementptr inbounds [1000 x float], [1000 x float]* %3, i64 0, i64 0
  %66 = load float, float* %65, align 16
  %67 = fpext float %66 to double
  %68 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.2, i64 0, i64 0), double %64, double %67)
  br label %87
...
73:                                               ; preds = %69
  %74 = getelementptr inbounds [1000 x float], [1000 x float]* %3, i64 0, i64 0
  %75 = load float, float* %74, align 16
  %76 = fpext float %75 to double
  %77 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0), double %76)
  br label %86
...
78:                                               ; preds = %69
  ...
  %85 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0), double %84)
  br label %86
...
define dso_local void @_Z2f1Pfi(float* %0, i32 %1) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_1852.cpp() #0 section ".text.startup" {
