; ModuleID = 'POJ-104-source/21/21-1895.cpp'
source_filename = "POJ-104-source/21/21-1895.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_1895.cpp, i8* null }]
...
25:                                               ; preds = %6
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([501 x i32], [501 x i32]* @a, i64 0, i64 1), i32* %33)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_1895.cpp() #0 section ".text.startup" {
