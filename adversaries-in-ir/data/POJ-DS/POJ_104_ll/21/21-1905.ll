; ModuleID = 'POJ-104-source/21/21-1905.cpp'
source_filename = "POJ-104-source/21/21-1905.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_1905.cpp, i8* null }]
...
define dso_local float @_Z6my_absf(float %0) #4 {
...
44:                                               ; preds = %40
  ...
  %50 = fsub float %48, %49
  %51 = call float @_Z6my_absf(float %50)
...
132:                                              ; preds = %128
  ...
  %142 = select i1 %140, i8 10, i8 44
  %143 = sext i8 %142 to i32
  %144 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), i32 %136, i32 %143)
  br label %145
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_1905.cpp() #0 section ".text.startup" {
