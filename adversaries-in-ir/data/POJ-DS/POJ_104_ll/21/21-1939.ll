; ModuleID = 'POJ-104-source/21/21-1939.cpp'
source_filename = "POJ-104-source/21/21-1939.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_1939.cpp, i8* null }]
...
145:                                              ; preds = %141
  ...
  %150 = getelementptr inbounds [300 x float], [300 x float]* %9, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_1939.cpp() #0 section ".text.startup" {
