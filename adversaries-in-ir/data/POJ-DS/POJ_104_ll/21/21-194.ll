; ModuleID = 'POJ-104-source/21/21-194.cpp'
source_filename = "POJ-104-source/21/21-194.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_194.cpp, i8* null }]
...
68:                                               ; preds = %64, %36
  ...
  %86 = fcmp oeq double %75, %85
  br i1 %86, label %87, label %96

87:                                               ; preds = %68
  %88 = getelementptr inbounds [1000 x i32], [1000 x i32]* %3, i64 0, i64 0
  ...
  %95 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 %89, i32 %94)
  br label %96
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_194.cpp() #0 section ".text.startup" {
