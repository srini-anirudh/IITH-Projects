; ModuleID = 'POJ-104-source/21/21-2016.cpp'
source_filename = "POJ-104-source/21/21-2016.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_2016.cpp, i8* null }]
...
108:                                              ; preds = %89
  %109 = getelementptr inbounds [100 x float], [100 x float]* %10, i64 0, i64 0
...
122:                                              ; preds = %115
  ...
  %125 = getelementptr inbounds [100 x float], [100 x float]* %10, i64 0, i64 %124
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_2016.cpp() #0 section ".text.startup" {
