; ModuleID = 'POJ-104-source/21/21-2029.cpp'
source_filename = "POJ-104-source/21/21-2029.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_2029.cpp, i8* null }]
...
116:                                              ; preds = %106
  ...
  %125 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 %120, i32 %124)
  br label %153
...
142:                                              ; preds = %126
  ...
  %151 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 %146, i32 %150)
  br label %152
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_2029.cpp() #0 section ".text.startup" {
