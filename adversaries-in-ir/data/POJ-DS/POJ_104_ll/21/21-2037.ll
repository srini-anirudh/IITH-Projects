; ModuleID = 'POJ-104-source/21/21-2037.cpp'
source_filename = "POJ-104-source/21/21-2037.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_2037.cpp, i8* null }]
...
14:                                               ; preds = %10
  ...
  %17 = getelementptr inbounds [300 x float], [300 x float]* %7, i64 0, i64 %16
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), float* %17)
  %19 = load float, float* %5, align 4
  %20 = load i32, i32* %3, align 4
  %21 = sext i32 %20 to i64
  %22 = getelementptr inbounds [300 x float], [300 x float]* %7, i64 0, i64 %21
...
44:                                               ; preds = %37
  ...
  %47 = getelementptr inbounds [300 x float], [300 x float]* %7, i64 0, i64 %46
...
68:                                               ; preds = %33
  %69 = getelementptr inbounds [300 x float], [300 x float]* %8, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_2037.cpp() #0 section ".text.startup" {
