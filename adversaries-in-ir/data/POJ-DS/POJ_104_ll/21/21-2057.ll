; ModuleID = 'POJ-104-source/21/21-2057.cpp'
source_filename = "POJ-104-source/21/21-2057.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_2057.cpp, i8* null }]
...
82:                                               ; preds = %78
  ...
  %89 = getelementptr inbounds [300 x float], [300 x float]* %10, i64 0, i64 %88
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_2057.cpp() #0 section ".text.startup" {
