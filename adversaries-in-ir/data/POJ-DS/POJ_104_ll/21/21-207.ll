; ModuleID = 'POJ-104-source/21/21-207.cpp'
source_filename = "POJ-104-source/21/21-207.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_207.cpp, i8* null }]
...
101:                                              ; preds = %97
  ...
  %106 = getelementptr inbounds [300 x i32], [300 x i32]* %5, i64 0, i64 0
...
109:                                              ; preds = %101
  ...
  %115 = getelementptr inbounds [300 x i32], [300 x i32]* %5, i64 0, i64 0
...
136:                                              ; preds = %135, %81
  ...
  %139 = getelementptr inbounds [300 x i32], [300 x i32]* %5, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_207.cpp() #0 section ".text.startup" {
