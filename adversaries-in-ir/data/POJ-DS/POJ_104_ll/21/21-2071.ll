; ModuleID = 'POJ-104-source/21/21-2071.cpp'
source_filename = "POJ-104-source/21/21-2071.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_2071.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %11 = getelementptr inbounds [301 x i32], [301 x i32]* %5, i64 0, i64 0
  %12 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %11)
  %13 = getelementptr inbounds [301 x i32], [301 x i32]* %5, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_2071.cpp() #0 section ".text.startup" {
