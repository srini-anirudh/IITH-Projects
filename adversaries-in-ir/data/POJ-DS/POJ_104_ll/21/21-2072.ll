; ModuleID = 'POJ-104-source/21/21-2072.cpp'
source_filename = "POJ-104-source/21/21-2072.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_2072.cpp, i8* null }]
...
33:                                               ; preds = %15
  ...
  %35 = getelementptr inbounds [301 x i32], [301 x i32]* %5, i64 0, i64 0
...
40:                                               ; preds = %33
  %41 = getelementptr inbounds [301 x i32], [301 x i32]* %5, i64 0, i64 0
...
47:                                               ; preds = %33
  ...
  %49 = getelementptr inbounds [301 x i32], [301 x i32]* %5, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_2072.cpp() #0 section ".text.startup" {
