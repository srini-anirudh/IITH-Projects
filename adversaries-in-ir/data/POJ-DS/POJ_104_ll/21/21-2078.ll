; ModuleID = 'POJ-104-source/21/21-2078.cpp'
source_filename = "POJ-104-source/21/21-2078.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_2078.cpp, i8* null }]
...
109:                                              ; preds = %84
  ...
  call void @_ZSt4sortIPdEvT_S1_(double* %110, double* %115)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_2078.cpp() #0 section ".text.startup" {
