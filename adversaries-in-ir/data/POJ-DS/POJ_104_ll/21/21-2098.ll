; ModuleID = 'POJ-104-source/21/21-2098.cpp'
source_filename = "POJ-104-source/21/21-2098.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_2098.cpp, i8* null }]
...
91:                                               ; preds = %87
  ...
  %98 = fsub float %96, %97
  %99 = call float @_ZSt4fabsf(float %98)
...
102:                                              ; preds = %91
  ...
  %110 = call float @_ZSt4fabsf(float %109)
...
120:                                              ; preds = %116
  ...
  %128 = call float @_ZSt4fabsf(float %127)
  %129 = load float, float* %11, align 4
  %130 = fsub float %128, %129
  %131 = call float @_ZSt4fabsf(float %130)
...
162:                                              ; preds = %149
  ...
  %165 = getelementptr inbounds [400 x i32], [400 x i32]* %9, i64 0, i64 %164
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_2098.cpp() #0 section ".text.startup" {
