; ModuleID = 'POJ-104-source/21/21-214.cpp'
source_filename = "POJ-104-source/21/21-214.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_214.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %18 = getelementptr inbounds [300 x float], [300 x float]* %7, i64 0, i64 %17
...
91:                                               ; preds = %87
  ...
  %99 = getelementptr inbounds [300 x float], [300 x float]* %7, i64 0, i64 0
...
125:                                              ; preds = %121
  ...
  %132 = getelementptr inbounds [300 x float], [300 x float]* %7, i64 0, i64 %131
...
135:                                              ; preds = %125
  ...
  %146 = getelementptr inbounds [300 x float], [300 x float]* %7, i64 0, i64 %145
...
159:                                              ; preds = %113
  %160 = getelementptr inbounds [300 x float], [300 x float]* %7, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_214.cpp() #0 section ".text.startup" {
