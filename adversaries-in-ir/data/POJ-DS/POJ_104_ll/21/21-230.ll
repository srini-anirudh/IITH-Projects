; ModuleID = 'POJ-104-source/21/21-230.cpp'
source_filename = "POJ-104-source/21/21-230.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_230.cpp, i8* null }]
...
116:                                              ; preds = %109
  ...
  %119 = getelementptr inbounds [300 x double], [300 x double]* %8, i64 0, i64 %118
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_230.cpp() #0 section ".text.startup" {
