; ModuleID = 'POJ-104-source/21/21-242.cpp'
source_filename = "POJ-104-source/21/21-242.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_242.cpp, i8* null }]
...
71:                                               ; preds = %67
  ...
  %84 = fcmp ole double %83, 1.000000e-03
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_242.cpp() #0 section ".text.startup" {
