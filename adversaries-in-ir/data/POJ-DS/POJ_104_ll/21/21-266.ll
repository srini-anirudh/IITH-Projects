; ModuleID = 'POJ-104-source/21/21-266.cpp'
source_filename = "POJ-104-source/21/21-266.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_266.cpp, i8* null }]
...
92:                                               ; preds = %88
  ...
  %104 = fcmp ole double %103, 0x3EB0C6F7A0B5ED8D
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_266.cpp() #0 section ".text.startup" {
