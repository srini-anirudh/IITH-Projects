; ModuleID = 'POJ-104-source/21/21-270.cpp'
source_filename = "POJ-104-source/21/21-270.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_270.cpp, i8* null }]
...
113:                                              ; preds = %103
  ...
  %122 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 %117, i32 %121)
  br label %123
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_270.cpp() #0 section ".text.startup" {
