; ModuleID = 'POJ-104-source/21/21-288.cpp'
source_filename = "POJ-104-source/21/21-288.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_288.cpp, i8* null }]
...
17:                                               ; preds = %13
  ...
  %20 = getelementptr inbounds [400 x i32], [400 x i32]* %8, i64 0, i64 %19
  %21 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %20)
  %22 = load i32, i32* %3, align 4
  %23 = load i32, i32* %5, align 4
  %24 = sext i32 %23 to i64
  %25 = getelementptr inbounds [400 x i32], [400 x i32]* %8, i64 0, i64 %24
...
51:                                               ; preds = %44
  ...
  %54 = getelementptr inbounds [400 x i32], [400 x i32]* %8, i64 0, i64 %53
...
88:                                               ; preds = %38
  %89 = getelementptr inbounds [400 x i32], [400 x i32]* %8, i64 0, i64 0
...
109:                                              ; preds = %88
  ...
  %117 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 %111, i32 %116)
  br label %140
...
118:                                              ; preds = %88
  ...
  %126 = call float @_ZSt4fabsf(float %125)
  %127 = fcmp ogt float %122, %126
  br i1 %127, label %128, label %132

128:                                              ; preds = %118
  %129 = getelementptr inbounds [400 x i32], [400 x i32]* %8, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_288.cpp() #0 section ".text.startup" {
