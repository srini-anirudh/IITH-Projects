; ModuleID = 'POJ-104-source/21/21-293.cpp'
source_filename = "POJ-104-source/21/21-293.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_293.cpp, i8* null }]
...
78:                                               ; preds = %65
  ...
  %95 = getelementptr inbounds [300 x i32], [300 x i32]* %12, i64 0, i64 %94
...
129:                                              ; preds = %125
  ...
  %134 = call i32 @abs(i32 %133) #6
  %135 = getelementptr inbounds [300 x i32], [300 x i32]* %12, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_293.cpp() #0 section ".text.startup" {
