; ModuleID = 'POJ-104-source/21/21-304.cpp'
source_filename = "POJ-104-source/21/21-304.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_304.cpp, i8* null }]
...
136:                                              ; preds = %132
  ...
  %146 = select i1 %144, i8 44, i8 10
  %147 = sext i8 %146 to i32
  %148 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32 %140, i32 %147)
  br label %149
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_304.cpp() #0 section ".text.startup" {
