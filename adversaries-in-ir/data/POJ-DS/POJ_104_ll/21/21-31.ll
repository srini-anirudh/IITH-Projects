; ModuleID = 'POJ-104-source/21/21-31.cpp'
source_filename = "POJ-104-source/21/21-31.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_31.cpp, i8* null }]
...
define dso_local i32 @_Z1sPii(i32* %0, i32 %1) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z3disiii(i32 %0, i32 %1, i32 %2) #4 {
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z5max_dPiii(i32* %0, i32 %1, i32 %2) #4 {
...
23:                                               ; preds = %11
  ...
  %26 = call i32 @_Z1sPii(i32* %24, i32 %25)
...
31:                                               ; preds = %27
  ...
  %38 = call i32 @_Z3disiii(i32 %35, i32 %36, i32 %37)
...
45:                                               ; preds = %27
  %46 = getelementptr inbounds [300 x i32], [300 x i32]* %8, i64 0, i64 0
  %47 = load i32, i32* %4, align 4
  %48 = load i32, i32* %5, align 4
  %49 = call i32 @_Z5max_dPiii(i32* %46, i32 %47, i32 %48)
...
119:                                              ; preds = %85
  %120 = getelementptr inbounds [300 x i32], [300 x i32]* %9, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_31.cpp() #0 section ".text.startup" {
