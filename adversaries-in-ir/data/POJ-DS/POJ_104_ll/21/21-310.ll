; ModuleID = 'POJ-104-source/21/21-310.cpp'
source_filename = "POJ-104-source/21/21-310.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_310.cpp, i8* null }]
...
124:                                              ; preds = %120
  ...
  %131 = getelementptr inbounds [100 x float], [100 x float]* %10, i64 0, i64 %130
...
140:                                              ; preds = %120
  ...
  %148 = getelementptr inbounds [100 x float], [100 x float]* %10, i64 0, i64 %147
...
157:                                              ; preds = %153
  ...
  %164 = call float @_ZSt4fabsf(float %163)
  %165 = fpext float %164 to double
  %166 = fcmp ole double %165, 0x3E7AD7F29ABCAF48
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_310.cpp() #0 section ".text.startup" {
