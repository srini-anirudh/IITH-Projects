; ModuleID = 'POJ-104-source/21/21-331.cpp'
source_filename = "POJ-104-source/21/21-331.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_331.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %11 = bitcast [300 x double]* %9 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_331.cpp() #0 section ".text.startup" {
