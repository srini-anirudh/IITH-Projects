; ModuleID = 'POJ-104-source/21/21-351.cpp'
source_filename = "POJ-104-source/21/21-351.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_351.cpp, i8* null }]
...
103:                                              ; preds = %92
  ...
  %106 = getelementptr inbounds [400 x i32], [400 x i32]* %5, i64 0, i64 %105
...
122:                                              ; preds = %117
  ...
  %135 = fcmp ole double %134, 1.000000e-05
...
145:                                              ; preds = %136
  ...
  %148 = getelementptr inbounds [400 x i32], [400 x i32]* %5, i64 0, i64 %147
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_351.cpp() #0 section ".text.startup" {
