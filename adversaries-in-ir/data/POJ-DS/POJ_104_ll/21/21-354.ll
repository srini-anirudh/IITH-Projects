; ModuleID = 'POJ-104-source/21/21-354.cpp'
source_filename = "POJ-104-source/21/21-354.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_354.cpp, i8* null }]
...
define dso_local i32 @_Z11bubble_sortPA2_fS0_i([2 x float]* %0, [2 x float]* %1, i32 %2) #4 {
...
77:                                               ; preds = %36
  ...
  %81 = call i32 @_Z11bubble_sortPA2_fS0_i([2 x float]* %78, [2 x float]* %79, i32 %80)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_354.cpp() #0 section ".text.startup" {
