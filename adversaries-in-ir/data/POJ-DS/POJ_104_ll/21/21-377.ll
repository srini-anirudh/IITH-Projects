; ModuleID = 'POJ-104-source/21/21-377.cpp'
source_filename = "POJ-104-source/21/21-377.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_377.cpp, i8* null }]
...
30:                                               ; preds = %11
  ...
  %41 = getelementptr inbounds [300 x float], [300 x float]* %7, i64 0, i64 0
  store float %40, float* %41, align 16
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_377.cpp() #0 section ".text.startup" {
