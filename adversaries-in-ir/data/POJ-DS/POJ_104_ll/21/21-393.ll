; ModuleID = 'POJ-104-source/21/21-393.cpp'
source_filename = "POJ-104-source/21/21-393.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_393.cpp, i8* null }]
...
44:                                               ; preds = %39
  ...
  %55 = getelementptr inbounds [300 x float], [300 x float]* %11, i64 0, i64 %54
...
65:                                               ; preds = %60
  ...
  %68 = getelementptr inbounds [300 x float], [300 x float]* %11, i64 0, i64 %67
...
158:                                              ; preds = %111
  %159 = getelementptr inbounds [300 x i32], [300 x i32]* %8, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_393.cpp() #0 section ".text.startup" {
