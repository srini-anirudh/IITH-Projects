; ModuleID = 'POJ-104-source/21/21-467.cpp'
source_filename = "POJ-104-source/21/21-467.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_467.cpp, i8* null }]
...
88:                                               ; preds = %82
  ...
  %96 = getelementptr inbounds [300 x float], [300 x float]* %10, i64 0, i64 %95
...
99:                                               ; preds = %88
  ...
  %102 = getelementptr inbounds [300 x float], [300 x float]* %10, i64 0, i64 %101
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_467.cpp() #0 section ".text.startup" {
