; ModuleID = 'POJ-104-source/21/21-469.cpp'
source_filename = "POJ-104-source/21/21-469.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_469.cpp, i8* null }]
...
52:                                               ; preds = %44
  ...
  %62 = getelementptr inbounds [300 x float], [300 x float]* %11, i64 0, i64 %61
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_469.cpp() #0 section ".text.startup" {
