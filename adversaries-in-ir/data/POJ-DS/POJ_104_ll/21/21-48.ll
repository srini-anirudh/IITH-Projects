; ModuleID = 'POJ-104-source/21/21-48.cpp'
source_filename = "POJ-104-source/21/21-48.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_48.cpp, i8* null }]
...
define dso_local float @_Z4absdf(float %0) #4 {
...
40:                                               ; preds = %25
  ...
  %45 = getelementptr inbounds [300 x i32], [300 x i32]* %9, i64 0, i64 0
  %46 = load i32, i32* %45, align 16
  %47 = sitofp i32 %46 to float
  %48 = load float, float* %2, align 4
  %49 = fsub float %47, %48
  %50 = call float @_Z4absdf(float %49)
  store float %50, float* %3, align 4
  %51 = getelementptr inbounds [300 x i32], [300 x i32]* %9, i64 0, i64 0
...
57:                                               ; preds = %53
  ...
  %64 = fsub float %58, %63
  %65 = call float @_Z4absdf(float %64)
...
68:                                               ; preds = %57
  ...
  %75 = fsub float %69, %74
  %76 = call float @_Z4absdf(float %75)
...
81:                                               ; preds = %57
  ...
  %88 = fsub float %82, %87
  %89 = call float @_Z4absdf(float %88)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_48.cpp() #0 section ".text.startup" {
