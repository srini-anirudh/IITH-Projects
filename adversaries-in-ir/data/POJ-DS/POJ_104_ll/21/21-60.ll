; ModuleID = 'POJ-104-source/21/21-60.cpp'
source_filename = "POJ-104-source/21/21-60.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_60.cpp, i8* null }]
...
61:                                               ; preds = %52
  ...
  %71 = getelementptr inbounds [300 x float], [300 x float]* %13, i64 0, i64 %70
...
72:                                               ; preds = %52
  ...
  %82 = getelementptr inbounds [300 x float], [300 x float]* %13, i64 0, i64 %81
...
87:                                               ; preds = %48
  %88 = getelementptr inbounds [300 x float], [300 x float]* %13, i64 0, i64 0
...
94:                                               ; preds = %90
  ...
  %97 = getelementptr inbounds [300 x float], [300 x float]* %13, i64 0, i64 %96
...
101:                                              ; preds = %94
  ...
  %104 = getelementptr inbounds [300 x float], [300 x float]* %13, i64 0, i64 %103
...
115:                                              ; preds = %111
  ...
  %118 = getelementptr inbounds [300 x float], [300 x float]* %13, i64 0, i64 %117
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_60.cpp() #0 section ".text.startup" {
