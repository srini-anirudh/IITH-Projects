; ModuleID = 'POJ-104-source/21/21-66.cpp'
source_filename = "POJ-104-source/21/21-66.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_66.cpp, i8* null }]
...
69:                                               ; preds = %49
  %70 = getelementptr inbounds [300 x double], [300 x double]* %10, i64 0, i64 0
...
118:                                              ; preds = %93
  %119 = getelementptr inbounds [100 x i32], [100 x i32]* %7, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_66.cpp() #0 section ".text.startup" {
