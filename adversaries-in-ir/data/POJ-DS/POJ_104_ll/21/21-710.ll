; ModuleID = 'POJ-104-source/21/21-710.cpp'
source_filename = "POJ-104-source/21/21-710.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_710.cpp, i8* null }]
...
169:                                              ; preds = %165
  ...
  %179 = select i1 %177, i8 10, i8 44
  %180 = sext i8 %179 to i32
  %181 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32 %173, i32 %180)
  br label %182
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_710.cpp() #0 section ".text.startup" {
