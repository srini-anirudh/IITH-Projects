; ModuleID = 'POJ-104-source/21/21-719.cpp'
source_filename = "POJ-104-source/21/21-719.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_719.cpp, i8* null }]
...
119:                                              ; preds = %115
  ...
  %130 = fcmp olt double %129, 1.000000e-09
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_719.cpp() #0 section ".text.startup" {
