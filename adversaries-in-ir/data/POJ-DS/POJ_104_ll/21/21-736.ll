; ModuleID = 'POJ-104-source/21/21-736.cpp'
source_filename = "POJ-104-source/21/21-736.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_736.cpp, i8* null }]
...
98:                                               ; preds = %85
  ...
  %107 = getelementptr inbounds [300 x %struct.student], [300 x %struct.student]* %2, i64 0, i64 %106
  ...
  %112 = bitcast %struct.student* %107 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_736.cpp() #0 section ".text.startup" {
