; ModuleID = 'POJ-104-source/21/21-738.cpp'
source_filename = "POJ-104-source/21/21-738.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_738.cpp, i8* null }]
...
define dso_local float @_Z3absfi(float %0, i32 %1) #4 {
...
14:                                               ; preds = %10
  ...
  %17 = getelementptr inbounds [310 x i32], [310 x i32]* %3, i64 0, i64 %16
  ...
  %22 = getelementptr inbounds [310 x i32], [310 x i32]* %3, i64 0, i64 %21
...
29:                                               ; preds = %10
  %30 = getelementptr inbounds [310 x i32], [310 x i32]* %3, i64 0, i64 0
  %31 = load i32, i32* %2, align 4
  call void @_Z6bubblePii(i32* %30, i32 %31)
...
40:                                               ; preds = %36
  ...
  %46 = call float @_Z3absfi(float %41, i32 %45)
...
49:                                               ; preds = %40
  ...
  %55 = call float @_Z3absfi(float %50, i32 %54)
...
65:                                               ; preds = %61
  ...
  %69 = getelementptr inbounds [310 x i32], [310 x i32]* %3, i64 0, i64 %68
  %70 = load i32, i32* %69, align 4
  %71 = call float @_Z3absfi(float %66, i32 %70)
...
83:                                               ; preds = %74, %65
  ...
  %89 = call float @_Z3absfi(float %84, i32 %88)
...
95:                                               ; preds = %92
  ...
  %98 = getelementptr inbounds [310 x i32], [310 x i32]* %3, i64 0, i64 %97
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_738.cpp() #0 section ".text.startup" {
