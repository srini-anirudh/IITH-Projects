; ModuleID = 'POJ-104-source/21/21-872.cpp'
source_filename = "POJ-104-source/21/21-872.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_872.cpp, i8* null }]
...
91:                                               ; preds = %77
  ...
  %98 = getelementptr inbounds [300 x i32], [300 x i32]* %10, i64 0, i64 0
...
124:                                              ; preds = %120
  %125 = getelementptr inbounds [300 x i32], [300 x i32]* %10, i64 0, i64 0
...
132:                                              ; preds = %128
  %133 = getelementptr inbounds [300 x i32], [300 x i32]* %10, i64 0, i64 0
  ...
  %140 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), i32 %134, i32 %139)
  br label %141
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_872.cpp() #0 section ".text.startup" {
