; ModuleID = 'POJ-104-source/21/21-877.cpp'
source_filename = "POJ-104-source/21/21-877.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_877.cpp, i8* null }]
...
98:                                               ; preds = %86
  ...
  %103 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.2, i64 0, i64 0), double %100, double %102)
  br label %104
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_877.cpp() #0 section ".text.startup" {
