; ModuleID = 'POJ-104-source/21/21-908.cpp'
source_filename = "POJ-104-source/21/21-908.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_908.cpp, i8* null }]
...
103:                                              ; preds = %90
  ...
  %112 = getelementptr inbounds [1000 x %struct.data1], [1000 x %struct.data1]* %2, i64 0, i64 %111
  %113 = load i32, i32* %6, align 4
  %114 = sext i32 %113 to i64
  %115 = getelementptr inbounds [1000 x %struct.data1], [1000 x %struct.data1]* %2, i64 0, i64 %114
  %116 = bitcast %struct.data1* %115 to i8*
  %117 = bitcast %struct.data1* %112 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_908.cpp() #0 section ".text.startup" {
