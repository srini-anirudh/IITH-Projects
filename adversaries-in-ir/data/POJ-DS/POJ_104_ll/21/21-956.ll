; ModuleID = 'POJ-104-source/21/21-956.cpp'
source_filename = "POJ-104-source/21/21-956.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_956.cpp, i8* null }]
...
193:                                              ; preds = %180
  ...
  %202 = getelementptr inbounds [300 x %struct.num], [300 x %struct.num]* %7, i64 0, i64 %201
  %203 = load i32, i32* %4, align 4
  %204 = sext i32 %203 to i64
  %205 = getelementptr inbounds [300 x %struct.num], [300 x %struct.num]* %7, i64 0, i64 %204
  %206 = bitcast %struct.num* %205 to i8*
  %207 = bitcast %struct.num* %202 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %206, i8* align 8 %207, i64 8, i1 false)
  %208 = load i32, i32* %4, align 4
  %209 = sext i32 %208 to i64
  %210 = getelementptr inbounds [300 x %struct.num], [300 x %struct.num]* %7, i64 0, i64 %209
  %211 = load i32, i32* %4, align 4
  %212 = add nsw i32 %211, 1
  %213 = sext i32 %212 to i64
  %214 = getelementptr inbounds [300 x %struct.num], [300 x %struct.num]* %7, i64 0, i64 %213
  %215 = bitcast %struct.num* %214 to i8*
  %216 = bitcast %struct.num* %210 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_956.cpp() #0 section ".text.startup" {
