; ModuleID = 'POJ-104-source/21/21-969.cpp'
source_filename = "POJ-104-source/21/21-969.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_21_969.cpp, i8* null }]
...
18:                                               ; preds = %14
  ...
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), double* %21)
...
55:                                               ; preds = %37
  ...
  call void @_Z3paiPdiS_(double* %56, i32 %57, double* %58)
  store i32 0, i32* %6, align 4
  br label %59
...
82:                                               ; preds = %77, %59
  ...
  call void @_Z3paiPdiS_(double* %83, i32 %84, double* %85)
...
define dso_local void @_Z3paiPdiS_(double* %0, i32 %1, double* %2) #7 {
  %4 = alloca double*, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_21_969.cpp() #0 section ".text.startup" {
