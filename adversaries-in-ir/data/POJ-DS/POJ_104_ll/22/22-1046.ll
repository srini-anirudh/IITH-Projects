; ModuleID = 'POJ-104-source/22/22-1046.cpp'
source_filename = "POJ-104-source/22/22-1046.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_1046.cpp, i8* null }]
...
39:                                               ; preds = %38, %21
  %40 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %2)
  %41 = call i32 @getchar()
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_1046.cpp() #0 section ".text.startup" {
