; ModuleID = 'POJ-104-source/22/22-1076.cpp'
source_filename = "POJ-104-source/22/22-1076.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_1076.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %7 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([3000 x i8], [3000 x i8]* @s, i64 0, i64 0))
...
8:                                                ; preds = %59, %0
  ...
  %11 = call i64 @strlen(i8* getelementptr inbounds ([3000 x i8], [3000 x i8]* @s, i64 0, i64 0)) #6
...
43:                                               ; preds = %37, %27
  ...
  %46 = call i64 @strlen(i8* getelementptr inbounds ([3000 x i8], [3000 x i8]* @s, i64 0, i64 0)) #6
  %47 = sub i64 %46, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_1076.cpp() #0 section ".text.startup" {
