; ModuleID = 'POJ-104-source/22/22-1087.cpp'
source_filename = "POJ-104-source/22/22-1087.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_1087.cpp, i8* null }]
...
define dso_local i32 @_Z4turnPc(i8* %0) #4 {
  %2 = alloca i8*, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_1087.cpp() #0 section ".text.startup" {
