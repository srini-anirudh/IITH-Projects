; ModuleID = 'POJ-104-source/22/22-139.cpp'
source_filename = "POJ-104-source/22/22-139.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_139.cpp, i8* null }]
...
98:                                               ; preds = %93
  %99 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0))
  br label %100
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_139.cpp() #0 section ".text.startup" {
