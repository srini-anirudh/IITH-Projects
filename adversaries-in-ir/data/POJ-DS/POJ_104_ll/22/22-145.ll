; ModuleID = 'POJ-104-source/22/22-145.cpp'
source_filename = "POJ-104-source/22/22-145.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_145.cpp, i8* null }]
...
95:                                               ; preds = %70
  %96 = getelementptr inbounds [1000 x i32], [1000 x i32]* %9, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_145.cpp() #0 section ".text.startup" {
