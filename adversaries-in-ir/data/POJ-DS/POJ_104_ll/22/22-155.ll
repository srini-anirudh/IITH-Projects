; ModuleID = 'POJ-104-source/22/22-155.cpp'
source_filename = "POJ-104-source/22/22-155.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_155.cpp, i8* null }]
...
9:                                                ; preds = %19, %0
  ...
  %12 = getelementptr inbounds [50 x i32], [50 x i32]* %4, i64 0, i64 %11
...
27:                                               ; preds = %19
  %28 = getelementptr inbounds [50 x i32], [50 x i32]* %4, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_155.cpp() #0 section ".text.startup" {
