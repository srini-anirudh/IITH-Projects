; ModuleID = 'POJ-104-source/22/22-166.cpp'
source_filename = "POJ-104-source/22/22-166.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_166.cpp, i8* null }]
...
70:                                               ; preds = %21
  %71 = getelementptr inbounds [300 x i32], [300 x i32]* %6, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_166.cpp() #0 section ".text.startup" {
