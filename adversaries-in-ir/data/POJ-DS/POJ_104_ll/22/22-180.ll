; ModuleID = 'POJ-104-source/22/22-180.cpp'
source_filename = "POJ-104-source/22/22-180.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_180.cpp, i8* null }]
...
9:                                                ; preds = %30, %0
  ...
  %13 = getelementptr inbounds [300 x i8], [300 x i8]* %8, i64 0, i64 %12
...
22:                                               ; preds = %20
  ...
  %29 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %25, i8* %28)
  br label %30
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_180.cpp() #0 section ".text.startup" {
