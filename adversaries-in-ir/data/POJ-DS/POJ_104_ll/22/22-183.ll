; ModuleID = 'POJ-104-source/22/22-183.cpp'
source_filename = "POJ-104-source/22/22-183.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_183.cpp, i8* null }]
...
165:                                              ; preds = %162
  %166 = getelementptr inbounds [100 x i32], [100 x i32]* %10, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_183.cpp() #0 section ".text.startup" {
