; ModuleID = 'POJ-104-source/22/22-185.cpp'
source_filename = "POJ-104-source/22/22-185.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_185.cpp, i8* null }]
...
86:                                               ; preds = %82
  ...
  %91 = getelementptr inbounds [300 x i32], [300 x i32]* %6, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_185.cpp() #0 section ".text.startup" {
