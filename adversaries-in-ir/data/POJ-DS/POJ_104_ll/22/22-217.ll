; ModuleID = 'POJ-104-source/22/22-217.cpp'
source_filename = "POJ-104-source/22/22-217.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_217.cpp, i8* null }]
...
108:                                              ; preds = %105, %102
  %109 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0))
  br label %113
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_217.cpp() #0 section ".text.startup" {
