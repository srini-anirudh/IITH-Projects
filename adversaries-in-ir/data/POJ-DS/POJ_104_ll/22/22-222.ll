; ModuleID = 'POJ-104-source/22/22-222.cpp'
source_filename = "POJ-104-source/22/22-222.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_222.cpp, i8* null }]
...
67:                                               ; preds = %19
  %68 = getelementptr inbounds [200 x i32], [200 x i32]* %3, i64 0, i64 0
...
90:                                               ; preds = %86
  %91 = call i32 @puts(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0))
  br label %92
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_222.cpp() #0 section ".text.startup" {
