; ModuleID = 'POJ-104-source/22/22-224.cpp'
source_filename = "POJ-104-source/22/22-224.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_224.cpp, i8* null }]
...
64:                                               ; preds = %62, %57
  ...
  %67 = call i32 @_Z3maxPii(i32* %65, i32 %66)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_224.cpp() #0 section ".text.startup" {
