; ModuleID = 'POJ-104-source/22/22-230.cpp'
source_filename = "POJ-104-source/22/22-230.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_230.cpp, i8* null }]
...
9:                                                ; preds = %18, %0
  ...
  %12 = getelementptr inbounds [300 x i32], [300 x i32]* %5, i64 0, i64 %11
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_230.cpp() #0 section ".text.startup" {
