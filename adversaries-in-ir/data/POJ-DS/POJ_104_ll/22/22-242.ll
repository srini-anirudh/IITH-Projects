; ModuleID = 'POJ-104-source/22/22-242.cpp'
source_filename = "POJ-104-source/22/22-242.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_242.cpp, i8* null }]
...
31:                                               ; preds = %24
  ...
  %34 = call i32 @_Z1fPii(i32* %32, i32 %33)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_242.cpp() #0 section ".text.startup" {
