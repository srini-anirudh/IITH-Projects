; ModuleID = 'POJ-104-source/22/22-253.cpp'
source_filename = "POJ-104-source/22/22-253.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_253.cpp, i8* null }]
...
20:                                               ; preds = %9
  %21 = getelementptr inbounds [50 x i32], [50 x i32]* %2, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_253.cpp() #0 section ".text.startup" {
