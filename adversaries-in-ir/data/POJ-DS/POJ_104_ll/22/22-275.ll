; ModuleID = 'POJ-104-source/22/22-275.cpp'
source_filename = "POJ-104-source/22/22-275.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_275.cpp, i8* null }]
...
8:                                                ; preds = %14, %0
  ...
  %11 = getelementptr inbounds [999 x i32], [999 x i32]* %2, i64 0, i64 %10
...
17:                                               ; preds = %8
  %18 = getelementptr inbounds [999 x i32], [999 x i32]* %2, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_275.cpp() #0 section ".text.startup" {
