; ModuleID = 'POJ-104-source/22/22-276.cpp'
source_filename = "POJ-104-source/22/22-276.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_276.cpp, i8* null }]
...
187:                                              ; preds = %165
  store i32 0, i32* %3, align 4
  %188 = getelementptr inbounds [300 x i32], [300 x i32]* %4, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_276.cpp() #0 section ".text.startup" {
