; ModuleID = 'POJ-104-source/22/22-28.cpp'
source_filename = "POJ-104-source/22/22-28.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_28.cpp, i8* null }]
...
34:                                               ; preds = %30
  ...
  %40 = call i32 @_Z3MAXii(i32 %35, i32 %39)
...
56:                                               ; preds = %49
  ...
  %62 = call i32 @_Z3MAXii(i32 %57, i32 %61)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_28.cpp() #0 section ".text.startup" {
