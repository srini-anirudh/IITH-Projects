; ModuleID = 'POJ-104-source/22/22-298.cpp'
source_filename = "POJ-104-source/22/22-298.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_298.cpp, i8* null }]
...
9:                                                ; preds = %16, %0
  ...
  %12 = getelementptr inbounds [1000 x i32], [1000 x i32]* %8, i64 0, i64 %11
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_298.cpp() #0 section ".text.startup" {
