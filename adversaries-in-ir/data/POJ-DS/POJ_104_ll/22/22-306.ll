; ModuleID = 'POJ-104-source/22/22-306.cpp'
source_filename = "POJ-104-source/22/22-306.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_306.cpp, i8* null }]
...
40:                                               ; preds = %10
  ...
  call void @qsort(i8* %42, i64 %45, i64 4, i32 (i8*, i8*)* @_Z3cmpPKvS0_)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_306.cpp() #0 section ".text.startup" {
