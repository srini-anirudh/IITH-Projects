; ModuleID = 'POJ-104-source/22/22-345.cpp'
source_filename = "POJ-104-source/22/22-345.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_345.cpp, i8* null }]
...
84:                                               ; preds = %81
  ...
  %87 = getelementptr inbounds [310 x i32], [310 x i32]* %2, i64 0, i64 %86
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_345.cpp() #0 section ".text.startup" {
