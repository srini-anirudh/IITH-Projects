; ModuleID = 'POJ-104-source/22/22-359.cpp'
source_filename = "POJ-104-source/22/22-359.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_359.cpp, i8* null }]
...
97:                                               ; preds = %94, %90
  %98 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0))
  br label %102
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_359.cpp() #0 section ".text.startup" {
