; ModuleID = 'POJ-104-source/22/22-376.cpp'
source_filename = "POJ-104-source/22/22-376.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_376.cpp, i8* null }]
...
12:                                               ; preds = %62, %0
  ...
  %15 = getelementptr inbounds [350 x i8], [350 x i8]* %2, i64 0, i64 0
...
48:                                               ; preds = %41
  ...
  %51 = getelementptr inbounds [350 x i8], [350 x i8]* %2, i64 0, i64 %50
...
70:                                               ; preds = %66
  ...
  %75 = getelementptr inbounds [110 x i32], [110 x i32]* %3, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_376.cpp() #0 section ".text.startup" {
