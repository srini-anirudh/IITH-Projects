; ModuleID = 'POJ-104-source/22/22-38.cpp'
source_filename = "POJ-104-source/22/22-38.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_38.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %9 = getelementptr inbounds [1600 x i8], [1600 x i8]* %2, i64 0, i64 0
...
11:                                               ; preds = %45, %0
  ...
  %14 = getelementptr inbounds [1600 x i8], [1600 x i8]* %2, i64 0, i64 %13
...
18:                                               ; preds = %11
  ...
  %21 = getelementptr inbounds [1600 x i8], [1600 x i8]* %2, i64 0, i64 %20
...
25:                                               ; preds = %18
  ...
  %33 = getelementptr inbounds [1600 x i8], [1600 x i8]* %2, i64 0, i64 %32
...
106:                                              ; preds = %102
  %107 = getelementptr inbounds [301 x i32], [301 x i32]* %3, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_38.cpp() #0 section ".text.startup" {
