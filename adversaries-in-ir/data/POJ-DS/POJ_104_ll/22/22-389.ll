; ModuleID = 'POJ-104-source/22/22-389.cpp'
source_filename = "POJ-104-source/22/22-389.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_389.cpp, i8* null }]
...
62:                                               ; preds = %58
  ...
  %68 = call i32 @_Z3maxii(i32 %63, i32 %67)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_389.cpp() #0 section ".text.startup" {
