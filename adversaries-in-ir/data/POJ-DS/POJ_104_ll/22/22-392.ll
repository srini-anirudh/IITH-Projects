; ModuleID = 'POJ-104-source/22/22-392.cpp'
source_filename = "POJ-104-source/22/22-392.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_392.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %6 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* getelementptr inbounds ([300 x i32], [300 x i32]* @n, i64 0, i64 0))
  br label %7
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_392.cpp() #0 section ".text.startup" {
