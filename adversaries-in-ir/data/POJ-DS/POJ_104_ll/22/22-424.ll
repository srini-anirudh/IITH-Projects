; ModuleID = 'POJ-104-source/22/22-424.cpp'
source_filename = "POJ-104-source/22/22-424.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_424.cpp, i8* null }]
...
9:                                                ; preds = %26, %0
  ...
  %13 = getelementptr inbounds [300 x i8], [300 x i8]* %7, i64 0, i64 %12
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_424.cpp() #0 section ".text.startup" {
