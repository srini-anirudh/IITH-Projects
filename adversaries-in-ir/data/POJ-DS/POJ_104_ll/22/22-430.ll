; ModuleID = 'POJ-104-source/22/22-430.cpp'
source_filename = "POJ-104-source/22/22-430.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_430.cpp, i8* null }]
...
5:                                                ; preds = %2
  ...
  %9 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %8, i8* @c)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_430.cpp() #0 section ".text.startup" {
