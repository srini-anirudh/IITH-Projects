; ModuleID = 'POJ-104-source/22/22-436.cpp'
source_filename = "POJ-104-source/22/22-436.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_436.cpp, i8* null }]
...
41:                                               ; preds = %38
  ...
  %46 = getelementptr inbounds [300 x i32], [300 x i32]* %6, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_436.cpp() #0 section ".text.startup" {
