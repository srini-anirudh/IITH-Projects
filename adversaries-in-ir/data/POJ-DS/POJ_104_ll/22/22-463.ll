; ModuleID = 'POJ-104-source/22/22-463.cpp'
source_filename = "POJ-104-source/22/22-463.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_463.cpp, i8* null }]
...
27:                                               ; preds = %17
  %28 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* getelementptr inbounds ([301 x i32], [301 x i32]* @a, i64 0, i64 0))
  store i32 0, i32* %2, align 4
  br label %29
...
62:                                               ; preds = %56, %29
  %63 = call i64 @strlen(i8* getelementptr inbounds ([301 x i8], [301 x i8]* @b, i64 0, i64 0)) #6
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_463.cpp() #0 section ".text.startup" {
