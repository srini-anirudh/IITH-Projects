; ModuleID = 'POJ-104-source/22/22-466.cpp'
source_filename = "POJ-104-source/22/22-466.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_466.cpp, i8* null }]
...
17:                                               ; preds = %13
  ...
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* %7)
  br label %13
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_466.cpp() #0 section ".text.startup" {
