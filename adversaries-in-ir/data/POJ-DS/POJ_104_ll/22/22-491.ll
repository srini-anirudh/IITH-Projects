; ModuleID = 'POJ-104-source/22/22-491.cpp'
source_filename = "POJ-104-source/22/22-491.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_491.cpp, i8* null }]
...
define dso_local i32 @_Z7maxaaaaii(i32 %0, i32 %1) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z7minaaaaii(i32 %0, i32 %1) #4 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  store i32 %0, i32* %3, align 4
...
41:                                               ; preds = %36
  ...
  %51 = call i32 @_Z7minaaaaii(i32 %45, i32 %50)
  ...
  %61 = call i32 @_Z7maxaaaaii(i32 %55, i32 %60)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_491.cpp() #0 section ".text.startup" {
