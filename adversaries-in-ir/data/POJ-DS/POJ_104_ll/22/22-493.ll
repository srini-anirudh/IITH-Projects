; ModuleID = 'POJ-104-source/22/22-493.cpp'
source_filename = "POJ-104-source/22/22-493.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_493.cpp, i8* null }]
...
9:                                                ; preds = %21, %0
  ...
  %15 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* %8)
...
38:                                               ; preds = %33
  ...
  %49 = call i32 @_Z3maxii(i32 %43, i32 %48)
  ...
  %60 = call i32 @_Z3minii(i32 %54, i32 %59)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_493.cpp() #0 section ".text.startup" {
