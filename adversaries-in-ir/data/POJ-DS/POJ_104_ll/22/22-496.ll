; ModuleID = 'POJ-104-source/22/22-496.cpp'
source_filename = "POJ-104-source/22/22-496.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_496.cpp, i8* null }]
...
define dso_local void @_Z13selectionsortPiii(i32* %0, i32 %1, i32 %2) #4 {
...
15:                                               ; preds = %7
  ...
  call void @_Z13selectionsortPiii(i32* %20, i32 0, i32 %21)
  br label %22
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_496.cpp() #0 section ".text.startup" {
