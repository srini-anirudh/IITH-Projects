; ModuleID = 'POJ-104-source/22/22-499.cpp'
source_filename = "POJ-104-source/22/22-499.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_499.cpp, i8* null }]
...
8:                                                ; preds = %17, %0
  ...
  %11 = getelementptr inbounds [300 x i32], [300 x i32]* %7, i64 0, i64 %10
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_499.cpp() #0 section ".text.startup" {
