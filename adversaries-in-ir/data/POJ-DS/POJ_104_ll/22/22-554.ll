; ModuleID = 'POJ-104-source/22/22-554.cpp'
source_filename = "POJ-104-source/22/22-554.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_554.cpp, i8* null }]
...
define dso_local i32 @_Z4swapii(i32 %0, i32 %1) #6 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  store i32 %0, i32* %3, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_554.cpp() #0 section ".text.startup" {
