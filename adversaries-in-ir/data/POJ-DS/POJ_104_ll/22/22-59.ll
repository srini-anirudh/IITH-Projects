; ModuleID = 'POJ-104-source/22/22-59.cpp'
source_filename = "POJ-104-source/22/22-59.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_59.cpp, i8* null }]
...
44:                                               ; preds = %34
  ...
  %48 = call i32 @_Z6choosePii(i32* %46, i32 %47)
...
68:                                               ; preds = %49
  ...
  %71 = call i32 @_Z6choosePii(i32* %69, i32 %70)
...
define dso_local i32 @_Z6choosePii(i32* %0, i32 %1) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_59.cpp() #0 section ".text.startup" {
