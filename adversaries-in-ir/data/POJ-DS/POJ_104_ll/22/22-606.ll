; ModuleID = 'POJ-104-source/22/22-606.cpp'
source_filename = "POJ-104-source/22/22-606.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_606.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %12, i8* %15)
  br label %17
...
24:                                               ; preds = %17
  ...
  %33 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %29, i8* %32)
  br label %17
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_606.cpp() #0 section ".text.startup" {
