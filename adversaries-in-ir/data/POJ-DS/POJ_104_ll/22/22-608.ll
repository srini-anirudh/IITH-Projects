; ModuleID = 'POJ-104-source/22/22-608.cpp'
source_filename = "POJ-104-source/22/22-608.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_608.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %8 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %4, i8* %2)
  br label %9
...
13:                                               ; preds = %9
  ...
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %4, i8* %2)
  br label %9
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_608.cpp() #0 section ".text.startup" {
