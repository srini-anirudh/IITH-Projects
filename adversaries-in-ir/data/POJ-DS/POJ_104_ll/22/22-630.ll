; ModuleID = 'POJ-104-source/22/22-630.cpp'
source_filename = "POJ-104-source/22/22-630.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_630.cpp, i8* null }]
...
64:                                               ; preds = %53
  ...
  call void @_Z5transPiS_(i32* %69, i32* %73)
  br label %74
...
define dso_local void @_Z5transPiS_(i32* %0, i32* %1) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_630.cpp() #0 section ".text.startup" {
