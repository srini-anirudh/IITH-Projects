; ModuleID = 'POJ-104-source/22/22-655.cpp'
source_filename = "POJ-104-source/22/22-655.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_655.cpp, i8* null }]
...
13:                                               ; preds = %10
  ...
  %16 = getelementptr inbounds [1000 x i32], [1000 x i32]* %8, i64 0, i64 %15
...
89:                                               ; preds = %44
  %90 = getelementptr inbounds [1000 x i32], [1000 x i32]* %8, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_655.cpp() #0 section ".text.startup" {
