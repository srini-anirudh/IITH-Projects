; ModuleID = 'POJ-104-source/22/22-666.cpp'
source_filename = "POJ-104-source/22/22-666.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_666.cpp, i8* null }]
...
8:                                                ; preds = %0, %19
  ...
  %12 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %11, i8* %3)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_666.cpp() #0 section ".text.startup" {
