; ModuleID = 'POJ-104-source/22/22-687.cpp'
source_filename = "POJ-104-source/22/22-687.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_687.cpp, i8* null }]
...
define dso_local i32 @_Z3maxv() #4 {
...
define dso_local i32 @main() #5 {
  ...
  %2 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* getelementptr inbounds ([300 x i32], [300 x i32]* @a, i64 0, i64 0))
  br label %3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_687.cpp() #0 section ".text.startup" {
