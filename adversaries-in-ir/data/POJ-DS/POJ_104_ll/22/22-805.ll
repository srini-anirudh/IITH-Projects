; ModuleID = 'POJ-104-source/22/22-805.cpp'
source_filename = "POJ-104-source/22/22-805.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_805.cpp, i8* null }]
...
97:                                               ; preds = %93
  ...
  %102 = getelementptr inbounds [301 x i32], [301 x i32]* %2, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_805.cpp() #0 section ".text.startup" {
