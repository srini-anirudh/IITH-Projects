; ModuleID = 'POJ-104-source/22/22-827.cpp'
source_filename = "POJ-104-source/22/22-827.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_827.cpp, i8* null }]
...
59:                                               ; preds = %47
  ...
  %62 = call i32 @_Z3minii(i32 %60, i32 %61)
...
63:                                               ; preds = %47
  ...
  %68 = call i32 @_Z3maxii(i32 %64, i32 %67)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_827.cpp() #0 section ".text.startup" {
