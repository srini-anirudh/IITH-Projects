; ModuleID = 'POJ-104-source/22/22-840.cpp'
source_filename = "POJ-104-source/22/22-840.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_840.cpp, i8* null }]
...
33:                                               ; preds = %28
  ...
  %36 = getelementptr inbounds [300 x i32], [300 x i32]* %4, i64 0, i64 1
...
39:                                               ; preds = %33
  ...
  %42 = getelementptr inbounds [300 x i32], [300 x i32]* %4, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_840.cpp() #0 section ".text.startup" {
