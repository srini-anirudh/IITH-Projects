; ModuleID = 'POJ-104-source/22/22-843.cpp'
source_filename = "POJ-104-source/22/22-843.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_843.cpp, i8* null }]
...
12:                                               ; preds = %8
  ...
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %15, i8* %5)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_843.cpp() #0 section ".text.startup" {
