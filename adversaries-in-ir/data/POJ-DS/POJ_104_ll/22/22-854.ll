; ModuleID = 'POJ-104-source/22/22-854.cpp'
source_filename = "POJ-104-source/22/22-854.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_854.cpp, i8* null }]
...
9:                                                ; preds = %0, %21
  ...
  %13 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %12, i8* %6)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_854.cpp() #0 section ".text.startup" {
