; ModuleID = 'POJ-104-source/22/22-878.cpp'
source_filename = "POJ-104-source/22/22-878.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_878.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %9 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %8, i8* %7)
  br label %10
...
14:                                               ; preds = %10
  ...
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %19, i8* %7)
  br label %10
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_878.cpp() #0 section ".text.startup" {
