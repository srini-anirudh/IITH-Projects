; ModuleID = 'POJ-104-source/22/22-89.cpp'
source_filename = "POJ-104-source/22/22-89.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_89.cpp, i8* null }]
...
150:                                              ; preds = %145
  %151 = getelementptr inbounds [300 x i32], [300 x i32]* %9, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_89.cpp() #0 section ".text.startup" {
