; ModuleID = 'POJ-104-source/22/22-908.cpp'
source_filename = "POJ-104-source/22/22-908.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_908.cpp, i8* null }]
...
19:                                               ; preds = %12
  ...
  %31 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %26, i8* %30)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_908.cpp() #0 section ".text.startup" {
