; ModuleID = 'POJ-104-source/22/22-94.cpp'
source_filename = "POJ-104-source/22/22-94.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_94.cpp, i8* null }]
...
79:                                               ; preds = %75
  %80 = getelementptr inbounds [300 x i32], [300 x i32]* %9, i64 0, i64 0
...
99:                                               ; preds = %93
  store i32 0, i32* %4, align 4
  %100 = getelementptr inbounds [300 x i32], [300 x i32]* %9, i64 0, i64 0
...
122:                                              ; preds = %102
  store i32 0, i32* %4, align 4
  %123 = getelementptr inbounds [300 x i32], [300 x i32]* %9, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_94.cpp() #0 section ".text.startup" {
