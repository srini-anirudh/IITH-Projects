; ModuleID = 'POJ-104-source/22/22-944.cpp'
source_filename = "POJ-104-source/22/22-944.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_944.cpp, i8* null }]
...
9:                                                ; preds = %15, %0
  ...
  %14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %13, i8* %7)
  br label %15
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_944.cpp() #0 section ".text.startup" {
