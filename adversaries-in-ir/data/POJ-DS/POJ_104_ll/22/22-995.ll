; ModuleID = 'POJ-104-source/22/22-995.cpp'
source_filename = "POJ-104-source/22/22-995.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_22_995.cpp, i8* null }]
...
21:                                               ; preds = %19
  ...
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %24, i8* %10)
  br label %26
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_22_995.cpp() #0 section ".text.startup" {
