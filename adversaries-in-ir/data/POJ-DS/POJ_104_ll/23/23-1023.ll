; ModuleID = 'POJ-104-source/23/23-1023.cpp'
source_filename = "POJ-104-source/23/23-1023.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_23_1023.cpp, i8* null }]
...
16:                                               ; preds = %9
  ...
  %19 = call noalias i8* @malloc(i64 30) #3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_23_1023.cpp() #0 section ".text.startup" {
