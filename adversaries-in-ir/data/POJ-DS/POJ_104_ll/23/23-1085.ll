; ModuleID = 'POJ-104-source/23/23-1085.cpp'
source_filename = "POJ-104-source/23/23-1085.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_23_1085.cpp, i8* null }]
...
17:                                               ; preds = %13
  ...
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i8* %2)
  br label %38
...
21:                                               ; preds = %13
  ...
  %36 = getelementptr inbounds [101 x i8], [101 x i8]* %30, i64 0, i64 %35
  store i8 %27, i8* %36, align 1
  %37 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i8* %2)
  br label %38
...
71:                                               ; preds = %86, %70
  ...
  %73 = getelementptr inbounds [101 x i32], [101 x i32]* %4, i64 0, i64 1
...
76:                                               ; preds = %71
  ...
  %79 = getelementptr inbounds [101 x [101 x i8]], [101 x [101 x i8]]* %3, i64 0, i64 %78
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_23_1085.cpp() #0 section ".text.startup" {
