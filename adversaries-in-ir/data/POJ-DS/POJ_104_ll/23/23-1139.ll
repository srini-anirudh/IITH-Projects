; ModuleID = 'POJ-104-source/23/23-1139.cpp'
source_filename = "POJ-104-source/23/23-1139.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_23_1139.cpp, i8* null }]
...
23:                                               ; preds = %18
  ...
  %28 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i8* %27)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_23_1139.cpp() #0 section ".text.startup" {
