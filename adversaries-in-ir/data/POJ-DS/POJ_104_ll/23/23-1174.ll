; ModuleID = 'POJ-104-source/23/23-1174.cpp'
source_filename = "POJ-104-source/23/23-1174.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_23_1174.cpp, i8* null }]
...
41:                                               ; preds = %29
  %42 = getelementptr inbounds [50 x [100 x i8]], [50 x [100 x i8]]* %2, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_23_1174.cpp() #0 section ".text.startup" {
