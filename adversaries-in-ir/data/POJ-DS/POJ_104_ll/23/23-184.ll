; ModuleID = 'POJ-104-source/23/23-184.cpp'
source_filename = "POJ-104-source/23/23-184.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_23_184.cpp, i8* null }]
...
5:                                                ; preds = %12, %0
  ...
  %7 = sext i32 %6 to i64
  %8 = getelementptr inbounds [20 x [20 x i8]], [20 x [20 x i8]]* %2, i64 0, i64 %7
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_23_184.cpp() #0 section ".text.startup" {
