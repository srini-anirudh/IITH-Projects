; ModuleID = 'POJ-104-source/23/23-444.cpp'
source_filename = "POJ-104-source/23/23-444.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_23_444.cpp, i8* null }]
...
26:                                               ; preds = %23
  ...
  %30 = getelementptr inbounds [101 x [101 x i8]], [101 x [101 x i8]]* @a, i64 0, i64 %29
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_23_444.cpp() #0 section ".text.startup" {
