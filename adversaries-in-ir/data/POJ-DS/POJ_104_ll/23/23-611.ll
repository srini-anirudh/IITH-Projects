; ModuleID = 'POJ-104-source/23/23-611.cpp'
source_filename = "POJ-104-source/23/23-611.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_23_611.cpp, i8* null }]
...
5:                                                ; preds = %16, %0
  ...
  %10 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i8* %9, i8* %4)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_23_611.cpp() #0 section ".text.startup" {
