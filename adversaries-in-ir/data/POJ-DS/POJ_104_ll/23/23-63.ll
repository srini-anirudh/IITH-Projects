; ModuleID = 'POJ-104-source/23/23-63.cpp'
source_filename = "POJ-104-source/23/23-63.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_23_63.cpp, i8* null }]
...
41:                                               ; preds = %29
  %42 = getelementptr inbounds [100 x [100 x i8]], [100 x [100 x i8]]* %4, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_23_63.cpp() #0 section ".text.startup" {
