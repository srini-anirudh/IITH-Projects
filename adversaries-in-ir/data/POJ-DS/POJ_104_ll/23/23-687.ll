; ModuleID = 'POJ-104-source/23/23-687.cpp'
source_filename = "POJ-104-source/23/23-687.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_23_687.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @llvm.memset.p0i8.i64(i8* align 16 %18, i8 0, i64 204, i1 false)
...
79:                                               ; preds = %90, %78
  ...
  %81 = getelementptr inbounds [51 x i32], [51 x i32]* %4, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_23_687.cpp() #0 section ".text.startup" {
