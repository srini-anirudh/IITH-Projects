; ModuleID = 'POJ-104-source/23/23-766.cpp'
source_filename = "POJ-104-source/23/23-766.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_23_766.cpp, i8* null }]
...
6:                                                ; preds = %15, %0
  ...
  %10 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), [100 x i8]* %9)
  %11 = call i32 @getchar()
...
18:                                               ; preds = %13
  ...
  %23 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i8* %22)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_23_766.cpp() #0 section ".text.startup" {
