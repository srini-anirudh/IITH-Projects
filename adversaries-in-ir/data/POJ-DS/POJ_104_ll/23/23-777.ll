; ModuleID = 'POJ-104-source/23/23-777.cpp'
source_filename = "POJ-104-source/23/23-777.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_23_777.cpp, i8* null }]
...
43:                                               ; preds = %26
  %44 = getelementptr inbounds [100 x [10 x i8]], [100 x [10 x i8]]* %5, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_23_777.cpp() #0 section ".text.startup" {
