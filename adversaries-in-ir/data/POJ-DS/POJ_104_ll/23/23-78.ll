; ModuleID = 'POJ-104-source/23/23-78.cpp'
source_filename = "POJ-104-source/23/23-78.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_23_78.cpp, i8* null }]
...
5:                                                ; preds = %14, %0
  ...
  %9 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), [100 x i8]* %8)
  %10 = call i32 @getchar()
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_23_78.cpp() #0 section ".text.startup" {
