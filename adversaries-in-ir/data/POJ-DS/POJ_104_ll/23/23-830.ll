; ModuleID = 'POJ-104-source/23/23-830.cpp'
source_filename = "POJ-104-source/23/23-830.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_23_830.cpp, i8* null }]
...
5:                                                ; preds = %11, %0
  ...
  %9 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), [110 x i8]* %8)
  %10 = icmp ne i32 %9, -1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_23_830.cpp() #0 section ".text.startup" {
