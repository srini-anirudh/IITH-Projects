; ModuleID = 'POJ-104-source/23/23-867.cpp'
source_filename = "POJ-104-source/23/23-867.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_23_867.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %6 = getelementptr inbounds [50 x [20 x i8]], [50 x [20 x i8]]* %2, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_23_867.cpp() #0 section ".text.startup" {
