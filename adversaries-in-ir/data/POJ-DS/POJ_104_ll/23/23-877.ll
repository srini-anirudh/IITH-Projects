; ModuleID = 'POJ-104-source/23/23-877.cpp'
source_filename = "POJ-104-source/23/23-877.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_23_877.cpp, i8* null }]
...
4:                                                ; preds = %18, %0
  %5 = call noalias i8* @calloc(i64 1, i64 20) #3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_23_877.cpp() #0 section ".text.startup" {
