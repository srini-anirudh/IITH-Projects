; ModuleID = 'POJ-104-source/23/23-974.cpp'
source_filename = "POJ-104-source/23/23-974.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_23_974.cpp, i8* null }]
...
4:                                                ; preds = %11, %0
  ...
  %6 = sext i32 %5 to i64
  %7 = getelementptr inbounds [100 x [100 x i8]], [100 x [100 x i8]]* %3, i64 0, i64 %6
...
29:                                               ; preds = %17
  %30 = getelementptr inbounds [100 x [100 x i8]], [100 x [100 x i8]]* %3, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_23_974.cpp() #0 section ".text.startup" {
