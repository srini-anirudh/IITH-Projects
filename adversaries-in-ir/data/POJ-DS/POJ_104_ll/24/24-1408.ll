; ModuleID = 'POJ-104-source/24/24-1408.cpp'
source_filename = "POJ-104-source/24/24-1408.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_24_1408.cpp, i8* null }]
...
27:                                               ; preds = %22, %8
  ...
  %31 = call i8* @strcpy(i8* %28, i8* %30) #3
  store i32 0, i32* %2, align 4
  br label %32
...
56:                                               ; preds = %32
  ...
  %60 = call i8* @strcpy(i8* %57, i8* %59) #3
  store i32 0, i32* %2, align 4
  br label %61
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_24_1408.cpp() #0 section ".text.startup" {
