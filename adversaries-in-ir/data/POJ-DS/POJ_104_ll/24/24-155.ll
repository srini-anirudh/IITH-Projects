; ModuleID = 'POJ-104-source/24/24-155.cpp'
source_filename = "POJ-104-source/24/24-155.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_24_155.cpp, i8* null }]
...
12:                                               ; preds = %0, %20
  ...
  %15 = getelementptr inbounds [50 x [20 x i8]], [50 x [20 x i8]]* %10, i64 0, i64 %14
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), [20 x i8]* %15)
  %17 = call i32 @getchar()
...
28:                                               ; preds = %24
  ...
  %31 = getelementptr inbounds [50 x [20 x i8]], [50 x [20 x i8]]* %10, i64 0, i64 %30
...
79:                                               ; preds = %45
  ...
  %82 = getelementptr inbounds [50 x [20 x i8]], [50 x [20 x i8]]* %10, i64 0, i64 %81
  ...
  %87 = getelementptr inbounds [50 x [20 x i8]], [50 x [20 x i8]]* %10, i64 0, i64 %86
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_24_155.cpp() #0 section ".text.startup" {
