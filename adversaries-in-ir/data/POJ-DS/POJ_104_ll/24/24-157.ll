; ModuleID = 'POJ-104-source/24/24-157.cpp'
source_filename = "POJ-104-source/24/24-157.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_24_157.cpp, i8* null }]
...
37:                                               ; preds = %29
  ...
  %39 = call i8* @strtok(i8* %38, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0)) #3
...
64:                                               ; preds = %59, %55
  %65 = call i8* @strtok(i8* null, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0)) #3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_24_157.cpp() #0 section ".text.startup" {
