; ModuleID = 'POJ-104-source/24/24-165.cpp'
source_filename = "POJ-104-source/24/24-165.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_24_165.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %9, i8* align 16 getelementptr inbounds ([20 x i8], [20 x i8]* @__const.main.min, i32 0, i32 0), i64 20, i1 false)
  br label %10
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_24_165.cpp() #0 section ".text.startup" {
