; ModuleID = 'POJ-104-source/24/24-2174.cpp'
source_filename = "POJ-104-source/24/24-2174.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_24_2174.cpp, i8* null }]
...
11:                                               ; preds = %20, %0
  ...
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* %3)
  br label %20
...
68:                                               ; preds = %25
  ...
  %77 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0), i8* %72, i8* %76)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_24_2174.cpp() #0 section ".text.startup" {
