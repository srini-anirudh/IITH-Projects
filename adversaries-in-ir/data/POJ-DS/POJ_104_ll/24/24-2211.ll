; ModuleID = 'POJ-104-source/24/24-2211.cpp'
source_filename = "POJ-104-source/24/24-2211.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_24_2211.cpp, i8* null }]
...
70:                                               ; preds = %15
  ...
  %82 = call i8* @strcpy(i8* %79, i8* %81) #3
  ...
  %86 = call i8* @strcpy(i8* %83, i8* %85) #3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_24_2211.cpp() #0 section ".text.startup" {
