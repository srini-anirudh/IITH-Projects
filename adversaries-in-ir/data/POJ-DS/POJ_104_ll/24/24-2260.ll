; ModuleID = 'POJ-104-source/24/24-2260.cpp'
source_filename = "POJ-104-source/24/24-2260.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_24_2260.cpp, i8* null }]
...
47:                                               ; preds = %44
  ...
  %53 = call i32 @_Z3maxii(i32 %48, i32 %52)
  ...
  %59 = call i32 @_Z3minii(i32 %54, i32 %58)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_24_2260.cpp() #0 section ".text.startup" {
