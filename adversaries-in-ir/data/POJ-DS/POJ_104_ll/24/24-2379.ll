; ModuleID = 'POJ-104-source/24/24-2379.cpp'
source_filename = "POJ-104-source/24/24-2379.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_24_2379.cpp, i8* null }]
...
161:                                              ; preds = %155
  ...
  %164 = getelementptr inbounds [600 x i8], [600 x i8]* %2, i64 0, i64 %163
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_24_2379.cpp() #0 section ".text.startup" {
