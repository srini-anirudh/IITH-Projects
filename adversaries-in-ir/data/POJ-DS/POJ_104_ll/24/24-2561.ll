; ModuleID = 'POJ-104-source/24/24-2561.cpp'
source_filename = "POJ-104-source/24/24-2561.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_24_2561.cpp, i8* null }]
...
76:                                               ; preds = %69
  ...
  %79 = getelementptr inbounds [200 x [20 x i8]], [200 x [20 x i8]]* %2, i64 0, i64 %78
...
98:                                               ; preds = %91
  ...
  %101 = getelementptr inbounds [200 x [20 x i8]], [200 x [20 x i8]]* %2, i64 0, i64 %100
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_24_2561.cpp() #0 section ".text.startup" {
