; ModuleID = 'POJ-104-source/24/24-2634.cpp'
source_filename = "POJ-104-source/24/24-2634.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_24_2634.cpp, i8* null }]
...
85:                                               ; preds = %81
  ...
  %88 = getelementptr inbounds [1000 x [50 x i8]], [1000 x [50 x i8]]* %6, i64 0, i64 %87
...
99:                                               ; preds = %85
  ...
  %102 = getelementptr inbounds [1000 x [50 x i8]], [1000 x [50 x i8]]* %6, i64 0, i64 %101
...
114:                                              ; preds = %110
  ...
  %117 = getelementptr inbounds [1000 x [50 x i8]], [1000 x [50 x i8]]* %6, i64 0, i64 %116
  %118 = getelementptr inbounds [50 x i8], [50 x i8]* %117, i64 0, i64 0
  %119 = call i64 @strlen(i8* %118) #6
  %120 = trunc i64 %119 to i32
  store i32 %120, i32* %5, align 4
  %121 = load i32, i32* %5, align 4
  %122 = getelementptr inbounds [1000 x i32], [1000 x i32]* %7, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_24_2634.cpp() #0 section ".text.startup" {
