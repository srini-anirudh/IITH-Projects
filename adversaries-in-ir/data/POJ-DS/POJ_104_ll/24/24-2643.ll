; ModuleID = 'POJ-104-source/24/24-2643.cpp'
source_filename = "POJ-104-source/24/24-2643.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_24_2643.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %10 = bitcast [200 x [100 x i8]]* %2 to i8*
...
17:                                               ; preds = %13
  %18 = getelementptr inbounds [200 x [100 x i8]], [200 x [100 x i8]]* %2, i64 0, i64 0
...
32:                                               ; preds = %28
  %33 = getelementptr inbounds [200 x [100 x i8]], [200 x [100 x i8]]* %2, i64 0, i64 0
...
59:                                               ; preds = %51
  %60 = getelementptr inbounds [200 x i32], [200 x i32]* %7, i64 0, i64 0
...
73:                                               ; preds = %65
  %74 = getelementptr inbounds [200 x i32], [200 x i32]* %7, i64 0, i64 0
...
95:                                               ; preds = %88
  ...
  %98 = getelementptr inbounds [200 x [100 x i8]], [200 x [100 x i8]]* %2, i64 0, i64 %97
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_24_2643.cpp() #0 section ".text.startup" {
