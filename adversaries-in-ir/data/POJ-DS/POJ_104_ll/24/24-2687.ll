; ModuleID = 'POJ-104-source/24/24-2687.cpp'
source_filename = "POJ-104-source/24/24-2687.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_24_2687.cpp, i8* null }]
...
35:                                               ; preds = %31
  ...
  %42 = call i32 @_Z3maxPii(i32* %40, i32 %41)
...
59:                                               ; preds = %55
  ...
  %66 = call i32 @_Z3minPii(i32* %64, i32 %65)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_24_2687.cpp() #0 section ".text.startup" {
