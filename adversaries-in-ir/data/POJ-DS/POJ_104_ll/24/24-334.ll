; ModuleID = 'POJ-104-source/24/24-334.cpp'
source_filename = "POJ-104-source/24/24-334.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_24_334.cpp, i8* null }]
...
26:                                               ; preds = %11
  ...
  %28 = getelementptr inbounds [50 x [20 x i8]], [50 x [20 x i8]]* %2, i64 0, i64 1
...
75:                                               ; preds = %32
  ...
  %84 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %79, i8* %83)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_24_334.cpp() #0 section ".text.startup" {
