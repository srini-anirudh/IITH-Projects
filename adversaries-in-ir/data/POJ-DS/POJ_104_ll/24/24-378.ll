; ModuleID = 'POJ-104-source/24/24-378.cpp'
source_filename = "POJ-104-source/24/24-378.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_24_378.cpp, i8* null }]
...
28:                                               ; preds = %9
  ...
  %29 = getelementptr inbounds [50 x i32], [50 x i32]* %4, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_24_378.cpp() #0 section ".text.startup" {
