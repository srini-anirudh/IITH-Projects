; ModuleID = 'POJ-104-source/24/24-455.cpp'
source_filename = "POJ-104-source/24/24-455.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_24_455.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %12 = bitcast [100 x [20 x i8]]* %10 to i8*
...
22:                                               ; preds = %18
  ...
  %26 = getelementptr inbounds [100 x [20 x i8]], [100 x [20 x i8]]* %10, i64 0, i64 %25
...
41:                                               ; preds = %37
  ...
  %44 = getelementptr inbounds [100 x [20 x i8]], [100 x [20 x i8]]* %10, i64 0, i64 %43
...
65:                                               ; preds = %37
  ...
  %73 = getelementptr inbounds [100 x [20 x i8]], [100 x [20 x i8]]* %10, i64 0, i64 %72
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_24_455.cpp() #0 section ".text.startup" {
