; ModuleID = 'POJ-104-source/24/24-47.cpp'
source_filename = "POJ-104-source/24/24-47.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_24_47.cpp, i8* null }]
...
15:                                               ; preds = %20, %0
  ...
  %17 = call i32 @feof(%struct._IO_FILE* %16) #3
  %18 = icmp ne i32 %17, 0
  %19 = xor i1 %18, true
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_24_47.cpp() #0 section ".text.startup" {
