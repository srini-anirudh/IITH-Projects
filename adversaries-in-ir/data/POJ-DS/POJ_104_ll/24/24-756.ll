; ModuleID = 'POJ-104-source/24/24-756.cpp'
source_filename = "POJ-104-source/24/24-756.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_24_756.cpp, i8* null }]
...
9:                                                ; preds = %60, %0
  ...
  %12 = getelementptr inbounds [50 x [20 x i8]], [50 x [20 x i8]]* %5, i64 0, i64 %11
...
49:                                               ; preds = %42
  %50 = getelementptr inbounds [20 x i8], [20 x i8]* %8, i64 0, i64 0
...
63:                                               ; preds = %9
  %64 = getelementptr inbounds [20 x i8], [20 x i8]* %7, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_24_756.cpp() #0 section ".text.startup" {
