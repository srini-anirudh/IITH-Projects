; ModuleID = 'POJ-104-source/24/24-770.cpp'
source_filename = "POJ-104-source/24/24-770.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_24_770.cpp, i8* null }]
...
82:                                               ; preds = %48
  ...
  %91 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %86, i8* %90)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_24_770.cpp() #0 section ".text.startup" {
