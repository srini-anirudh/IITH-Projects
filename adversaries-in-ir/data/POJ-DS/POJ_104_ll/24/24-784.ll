; ModuleID = 'POJ-104-source/24/24-784.cpp'
source_filename = "POJ-104-source/24/24-784.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_24_784.cpp, i8* null }]
...
93:                                               ; preds = %60
  ...
  %102 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i8* %97, i8* %101)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_24_784.cpp() #0 section ".text.startup" {
