; ModuleID = 'POJ-104-source/24/24-793.cpp'
source_filename = "POJ-104-source/24/24-793.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_24_793.cpp, i8* null }]
...
95:                                               ; preds = %62
  ...
  %104 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i8* %99, i8* %103)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_24_793.cpp() #0 section ".text.startup" {
