; ModuleID = 'POJ-104-source/24/24-798.cpp'
source_filename = "POJ-104-source/24/24-798.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_24_798.cpp, i8* null }]
...
36:                                               ; preds = %19
  ...
  %39 = call i32 @_Z6choosePii(i32* %37, i32 %38)
...
define dso_local i32 @_Z6choosePii(i32* %0, i32 %1) #6 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_24_798.cpp() #0 section ".text.startup" {
