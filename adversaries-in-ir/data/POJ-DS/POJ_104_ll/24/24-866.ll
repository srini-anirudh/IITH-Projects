; ModuleID = 'POJ-104-source/24/24-866.cpp'
source_filename = "POJ-104-source/24/24-866.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_24_866.cpp, i8* null }]
...
13:                                               ; preds = %10
  ...
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), [50 x i8]* %16)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_24_866.cpp() #0 section ".text.startup" {
