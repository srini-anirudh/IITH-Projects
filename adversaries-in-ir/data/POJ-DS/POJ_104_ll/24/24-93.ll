; ModuleID = 'POJ-104-source/24/24-93.cpp'
source_filename = "POJ-104-source/24/24-93.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_24_93.cpp, i8* null }]
...
9:                                                ; preds = %16, %0
  ...
  %12 = getelementptr inbounds [50 x [20 x i8]], [50 x [20 x i8]]* %2, i64 0, i64 %11
...
26:                                               ; preds = %21
  ...
  %34 = getelementptr inbounds [50 x [20 x i8]], [50 x [20 x i8]]* %2, i64 0, i64 %33
...
58:                                               ; preds = %21
  ...
  %67 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %62, i8* %66)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_24_93.cpp() #0 section ".text.startup" {
