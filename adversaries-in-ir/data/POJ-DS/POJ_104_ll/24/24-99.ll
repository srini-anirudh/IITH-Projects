; ModuleID = 'POJ-104-source/24/24-99.cpp'
source_filename = "POJ-104-source/24/24-99.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_24_99.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %9 = getelementptr inbounds [50 x [100 x i8]], [50 x [100 x i8]]* %2, i64 0, i64 0
  ...
  %12 = getelementptr inbounds [50 x [100 x i8]], [50 x [100 x i8]]* %2, i64 0, i64 0
...
47:                                               ; preds = %16
  ...
  %56 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %51, i8* %55)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_24_99.cpp() #0 section ".text.startup" {
