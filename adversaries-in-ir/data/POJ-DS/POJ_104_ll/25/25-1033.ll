; ModuleID = 'POJ-104-source/25/25-1033.cpp'
source_filename = "POJ-104-source/25/25-1033.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_25_1033.cpp, i8* null }]
...
define dso_local void @_Z2cfPc(i8* %0) #4 {
  %2 = alloca i8*, align 8
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z5strrePc(i8* %0) #4 {
  %2 = alloca i8*, align 8
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_25_1033.cpp() #0 section ".text.startup" {
