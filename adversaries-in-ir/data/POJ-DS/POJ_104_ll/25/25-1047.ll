; ModuleID = 'POJ-104-source/25/25-1047.cpp'
source_filename = "POJ-104-source/25/25-1047.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_25_1047.cpp, i8* null }]
...
define dso_local void @_Z11everydoublePi(i32* %0) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z9moveaheadPi(i32* %0) #4 {
  %2 = alloca i32*, align 8
  %3 = alloca i32, align 4
  store i32* %0, i32** %2, align 8
  store i32 0, i32* %3, align 4
...
28:                                               ; preds = %23
  ...
  call void @_Z11everydoublePi(i32* %29)
  %30 = getelementptr inbounds [100 x i32], [100 x i32]* %9, i64 0, i64 0
  call void @_Z9moveaheadPi(i32* %30)
  br label %31
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_25_1047.cpp() #0 section ".text.startup" {
