; ModuleID = 'POJ-104-source/25/25-1189.cpp'
source_filename = "POJ-104-source/25/25-1189.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_25_1189.cpp, i8* null }]
...
65:                                               ; preds = %60, %55, %51
  %66 = phi i1 [ true, %55 ], [ true, %51 ], [ %64, %60 ]
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_25_1189.cpp() #0 section ".text.startup" {
