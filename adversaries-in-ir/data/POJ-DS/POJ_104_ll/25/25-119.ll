; ModuleID = 'POJ-104-source/25/25-119.cpp'
source_filename = "POJ-104-source/25/25-119.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_25_119.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %5 = bitcast i8* %4 to <{ i32, [99 x i32] }>*
  %6 = getelementptr inbounds <{ i32, [99 x i32] }>, <{ i32, [99 x i32] }>* %5, i32 0, i32 0
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5chengPiii(i32* %0, i32 %1, i32 %2) #0 {
...
140:                                              ; preds = %124
  ...
  call void @_Z5chengPiii(i32* %143, i32 %144, i32 %145)
  br label %146
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_25_119.cpp() #0 section ".text.startup" {
