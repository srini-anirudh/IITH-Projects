; ModuleID = 'POJ-104-source/25/25-315.cpp'
source_filename = "POJ-104-source/25/25-315.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_25_315.cpp, i8* null }]
...
define dso_local signext i8 @_Z10multiply_2Pc(i8* %0) #4 {
  %2 = alloca i8*, align 8
...
53:                                               ; preds = %41
  ...
  %57 = getelementptr inbounds [110 x i32], [110 x i32]* %5, i64 0, i64 %56
...
74:                                               ; preds = %41
  ...
  %87 = getelementptr inbounds [110 x i32], [110 x i32]* %4, i64 0, i64 %86
...
136:                                              ; preds = %115
  ...
  %138 = getelementptr inbounds i8, i8* %137, i64 110
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_25_315.cpp() #0 section ".text.startup" {
