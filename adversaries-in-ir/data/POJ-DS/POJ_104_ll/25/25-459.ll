; ModuleID = 'POJ-104-source/25/25-459.cpp'
source_filename = "POJ-104-source/25/25-459.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_25_459.cpp, i8* null }]
...
define dso_local void @_Z4chenv() #5 {
  %1 = alloca i32, align 4
  %2 = alloca i32, align 4
  store i32 0, i32* %1, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_25_459.cpp() #0 section ".text.startup" {
