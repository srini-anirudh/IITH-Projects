; ModuleID = 'POJ-104-source/25/25-509.cpp'
source_filename = "POJ-104-source/25/25-509.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_25_509.cpp, i8* null }]
...
define dso_local i32 @_Z1fPiS_(i32* %0, i32* %1) #4 {
...
29:                                               ; preds = %25
  ...
  %32 = call i32 @_Z1fPiS_(i32* %30, i32* %31)
  store i32 0, i32* %5, align 4
  br label %33
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_25_509.cpp() #0 section ".text.startup" {
