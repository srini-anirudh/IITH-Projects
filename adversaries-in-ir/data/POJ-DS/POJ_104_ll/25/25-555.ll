; ModuleID = 'POJ-104-source/25/25-555.cpp'
source_filename = "POJ-104-source/25/25-555.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_25_555.cpp, i8* null }]
...
define dso_local void @_Z5chengPiS_(i32* %0, i32* %1) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z4copyPiS_(i32* %0, i32* %1) #4 {
  %3 = alloca i32*, align 8
  %4 = alloca i32*, align 8
  %5 = alloca i32, align 4
  store i32* %0, i32** %3, align 8
...
26:                                               ; preds = %0
  call void @llvm.memset.p0i8.i64(i8* align 16 bitcast ([1000 x i32]* @aa to i8*), i8 0, i64 4000, i1 false)
  call void @llvm.memset.p0i8.i64(i8* align 16 bitcast ([1000 x i32]* @ab to i8*), i8 0, i64 4000, i1 false)
...
49:                                               ; preds = %46
  ...
  %52 = getelementptr inbounds [1000 x i32], [1000 x i32]* @aa, i64 0, i64 %51
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_25_555.cpp() #0 section ".text.startup" {
