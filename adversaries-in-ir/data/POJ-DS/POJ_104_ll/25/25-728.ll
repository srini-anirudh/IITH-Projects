; ModuleID = 'POJ-104-source/25/25-728.cpp'
source_filename = "POJ-104-source/25/25-728.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_25_728.cpp, i8* null }]
...
define dso_local void @_Z8bigmultiPcS_S_(i8* %0, i8* %1, i8* %2) #4 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca i8*, align 8
...
define dso_local i32 @main() #7 {
  ...
  %7 = bitcast i8* %6 to <{ i8, [999 x i8] }>*
  %8 = getelementptr inbounds <{ i8, [999 x i8] }>, <{ i8, [999 x i8] }>* %7, i32 0, i32 0
...
14:                                               ; preds = %10
  ...
  call void @_Z8bigmultiPcS_S_(i8* %15, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0), i8* %16)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_25_728.cpp() #0 section ".text.startup" {
