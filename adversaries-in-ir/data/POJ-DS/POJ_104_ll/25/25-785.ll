; ModuleID = 'POJ-104-source/25/25-785.cpp'
source_filename = "POJ-104-source/25/25-785.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_25_785.cpp, i8* null }]
...
65:                                               ; preds = %55
  ...
  %80 = sub nsw i32 %79, 1
  call void @_Z1fii(i32 %78, i32 %80)
  br label %81
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_25_785.cpp() #0 section ".text.startup" {
