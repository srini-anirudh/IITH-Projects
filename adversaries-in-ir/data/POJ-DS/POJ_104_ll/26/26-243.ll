; ModuleID = 'POJ-104-source/26/26-243.cpp'
source_filename = "POJ-104-source/26/26-243.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_26_243.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z6filterPc(i8* %0) #0 {
  %2 = alloca i8*, align 8
  %3 = alloca i8*, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_26_243.cpp() #0 section ".text.startup" {
