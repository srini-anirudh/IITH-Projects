; ModuleID = 'POJ-104-source/27/27-1220.cpp'
source_filename = "POJ-104-source/27/27-1220.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_27_1220.cpp, i8* null }]
...
define dso_local i32 @main(i32 %0, i8** %1) #4 {
  ...
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %6)
...
22:                                               ; preds = %19
  %23 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i64 0, i64 0), double* %7, double* %8, double* %9)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_27_1220.cpp() #0 section ".text.startup" {
