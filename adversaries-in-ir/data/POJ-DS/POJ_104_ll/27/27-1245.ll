; ModuleID = 'POJ-104-source/27/27-1245.cpp'
source_filename = "POJ-104-source/27/27-1245.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_27_1245.cpp, i8* null }]
...
23:                                               ; preds = %19
  ...
  %36 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i64 0, i64 0), double* %27, double* %31, double* %35)
  br label %37
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_27_1245.cpp() #0 section ".text.startup" {
