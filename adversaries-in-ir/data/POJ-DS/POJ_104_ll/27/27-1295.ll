; ModuleID = 'POJ-104-source/27/27-1295.cpp'
source_filename = "POJ-104-source/27/27-1295.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_27_1295.cpp, i8* null }]
...
18:                                               ; preds = %14
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), float* %4, float* %5, float* %6)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_27_1295.cpp() #0 section ".text.startup" {
