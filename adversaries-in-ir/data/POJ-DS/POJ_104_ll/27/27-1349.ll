; ModuleID = 'POJ-104-source/27/27-1349.cpp'
source_filename = "POJ-104-source/27/27-1349.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_27_1349.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local double @_Z9fangchengddd(double %0, double %1, double %2) #0 {
...
define dso_local i32 @main() #4 {
  ...
  %6 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i32* %2)
  br label %7
...
10:                                               ; preds = %7
  %11 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.4, i64 0, i64 0), double* %3, double* %4, double* %5)
  ...
  %17 = call double @_Z9fangchengddd(double %14, double %15, double %16)
  br label %7
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_27_1349.cpp() #0 section ".text.startup" {
