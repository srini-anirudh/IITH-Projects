; ModuleID = 'POJ-104-source/27/27-137.cpp'
source_filename = "POJ-104-source/27/27-137.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_27_137.cpp, i8* null }]
...
17:                                               ; preds = %13
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i64 0, i64 0), double* %4, double* %5, double* %6)
...
49:                                               ; preds = %17
  ...
  %52 = fcmp ole double %51, 0x3E7AD7F29ABCAF48
...
57:                                               ; preds = %49
  ...
  %59 = fcmp olt double %58, 0xBE7AD7F29ABCAF48
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_27_137.cpp() #0 section ".text.startup" {
