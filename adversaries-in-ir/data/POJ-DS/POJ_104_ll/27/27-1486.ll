; ModuleID = 'POJ-104-source/27/27-1486.cpp'
source_filename = "POJ-104-source/27/27-1486.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_27_1486.cpp, i8* null }]
...
27:                                               ; preds = %23
  ...
  %37 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i64 0, i64 0), double* %30, double* %33, double* %36)
  br label %38
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_27_1486.cpp() #0 section ".text.startup" {
