; ModuleID = 'POJ-104-source/27/27-149.cpp'
source_filename = "POJ-104-source/27/27-149.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_27_149.cpp, i8* null }]
...
55:                                               ; preds = %33
  ...
  %124 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.2, i64 0, i64 0), double %122, double %123)
  br label %207
...
147:                                              ; preds = %125
  ...
  %160 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.3, i64 0, i64 0), double %159)
  br label %206
...
161:                                              ; preds = %125
  ...
  %205 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.4, i64 0, i64 0), double %201, double %202, double %203, double %204)
  br label %206
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_27_149.cpp() #0 section ".text.startup" {
