; ModuleID = 'POJ-104-source/27/27-152.cpp'
source_filename = "POJ-104-source/27/27-152.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_27_152.cpp, i8* null }]
...
68:                                               ; preds = %65
  ...
  %84 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.4, i64 0, i64 0), double %80, double %81, double %82, double %83)
  br label %85
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_27_152.cpp() #0 section ".text.startup" {
