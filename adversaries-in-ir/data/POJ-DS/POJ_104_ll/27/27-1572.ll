; ModuleID = 'POJ-104-source/27/27-1572.cpp'
source_filename = "POJ-104-source/27/27-1572.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_27_1572.cpp, i8* null }]
...
25:                                               ; preds = %21
  %26 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i64 0, i64 0), double* %8, double* %9, double* %10)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_27_1572.cpp() #0 section ".text.startup" {
