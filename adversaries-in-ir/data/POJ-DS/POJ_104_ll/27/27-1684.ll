; ModuleID = 'POJ-104-source/27/27-1684.cpp'
source_filename = "POJ-104-source/27/27-1684.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_27_1684.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i64 0, i64 0), double* %18, double* %21, double* %24)
  br label %26
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_27_1684.cpp() #0 section ".text.startup" {
