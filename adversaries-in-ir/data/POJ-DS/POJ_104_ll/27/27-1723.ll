; ModuleID = 'POJ-104-source/27/27-1723.cpp'
source_filename = "POJ-104-source/27/27-1723.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_27_1723.cpp, i8* null }]
...
29:                                               ; preds = %25
  ...
  %39 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), float* %32, float* %35, float* %38)
  br label %40
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_27_1723.cpp() #0 section ".text.startup" {
