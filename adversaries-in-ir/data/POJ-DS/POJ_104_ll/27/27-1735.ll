; ModuleID = 'POJ-104-source/27/27-1735.cpp'
source_filename = "POJ-104-source/27/27-1735.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_27_1735.cpp, i8* null }]
...
define dso_local double @_Z4testd(double %0) #4 {
...
; Function Attrs: noinline uwtable
define dso_local void @_Z4doitv() #0 {
  %1 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str, i64 0, i64 0), double* @a, double* @b, double* @c)
  ...
  %11 = call double @_Z4testd(double %10)
...
19:                                               ; preds = %15
  ...
  %26 = call double @_Z4testd(double %25)
...
32:                                               ; preds = %29
  ...
  %42 = call double @_Z4testd(double %41)
...
57:                                               ; preds = %54
  ...
  %64 = call double @_Z4testd(double %63)
...
define dso_local i32 @main() #5 {
  ...
  %2 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.4, i64 0, i64 0), i32* @n)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_27_1735.cpp() #0 section ".text.startup" {
