; ModuleID = 'POJ-104-source/27/27-1758.cpp'
source_filename = "POJ-104-source/27/27-1758.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_27_1758.cpp, i8* null }]
...
15:                                               ; preds = %11
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), float* %2, float* %3, float* %4)
...
27:                                               ; preds = %15
  ...
  %47 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.2, i64 0, i64 0), double %37, double %46)
  %48 = add nsw i32 %47, 0
  br label %94
...
61:                                               ; preds = %49
  ...
  %91 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.4, i64 0, i64 0), double %68, double %76, double %83, double %90)
  %92 = add nsw i32 %91, 0
  br label %93
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_27_1758.cpp() #0 section ".text.startup" {
