; ModuleID = 'POJ-104-source/27/27-1780.cpp'
source_filename = "POJ-104-source/27/27-1780.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_27_1780.cpp, i8* null }]
...
28:                                               ; preds = %23
  ...
  %41 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i64 0, i64 0), double* %32, double* %36, double* %40)
  br label %42
...
51:                                               ; preds = %46
  ...
  call void @_Z3genddd(double %56, double %61, double %66)
  br label %67
...
; Function Attrs: noinline uwtable
define dso_local void @_Z3genddd(double %0, double %1, double %2) #0 {
  %4 = alloca double, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_27_1780.cpp() #0 section ".text.startup" {
