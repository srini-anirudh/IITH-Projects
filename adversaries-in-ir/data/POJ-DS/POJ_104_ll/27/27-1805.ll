; ModuleID = 'POJ-104-source/27/27-1805.cpp'
source_filename = "POJ-104-source/27/27-1805.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_27_1805.cpp, i8* null }]
...
define dso_local double @_Z2x1ddd(double %0, double %1, double %2) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local double @_Z2x2ddd(double %0, double %1, double %2) #4 {
  %4 = alloca double, align 8
  %5 = alloca double, align 8
  %6 = alloca double, align 8
  %7 = alloca double, align 8
...
13:                                               ; preds = %9
  ...
  %23 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i64 0, i64 0), double* %16, double* %19, double* %22)
  br label %24
...
55:                                               ; preds = %32
  ...
  %68 = call double @_Z2x1ddd(double %59, double %63, double %67)
  ...
  %81 = call double @_Z2x2ddd(double %72, double %76, double %80)
...
83:                                               ; preds = %55
  ...
  %96 = call double @_Z2x1ddd(double %87, double %91, double %95)
  ...
  %109 = call double @_Z2x2ddd(double %100, double %104, double %108)
...
114:                                              ; preds = %111
  ...
  %127 = call double @_Z2x1ddd(double %118, double %122, double %126)
...
135:                                              ; preds = %129
  ...
  %159 = call double @_Z2x1ddd(double %150, double %154, double %158)
  ...
  %183 = call double @_Z2x2ddd(double %174, double %178, double %182)
...
185:                                              ; preds = %129
  ...
  %208 = call double @_Z2x1ddd(double %199, double %203, double %207)
  ...
  %231 = call double @_Z2x2ddd(double %222, double %226, double %230)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_27_1805.cpp() #0 section ".text.startup" {
