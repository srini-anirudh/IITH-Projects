; ModuleID = 'POJ-104-source/27/27-1808.cpp'
source_filename = "POJ-104-source/27/27-1808.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_27_1808.cpp, i8* null }]
...
79:                                               ; preds = %76
  ...
  %81 = call float @_ZSt4sqrtf(float %80)
  ...
  %98 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.3, i64 0, i64 0), double %95, double %97)
  br label %138
...
115:                                              ; preds = %99
  ...
  %126 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.4, i64 0, i64 0), double %119, double %121, double %123, double %125)
  br label %137
...
127:                                              ; preds = %99
  ...
  %136 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.4, i64 0, i64 0), double %129, double %131, double %133, double %135)
  br label %137
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_27_1808.cpp() #0 section ".text.startup" {
