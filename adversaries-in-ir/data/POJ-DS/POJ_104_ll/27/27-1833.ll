; ModuleID = 'POJ-104-source/27/27-1833.cpp'
source_filename = "POJ-104-source/27/27-1833.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_27_1833.cpp, i8* null }]
...
define dso_local double @_Z5fuhaod(double %0) #4 {
...
89:                                               ; preds = %83
  ...
  %107 = call double @_Z5fuhaod(double %106)
  ...
  %125 = call double @_Z5fuhaod(double %124)
...
133:                                              ; preds = %127
  ...
  %145 = call double @_Z5fuhaod(double %144)
...
147:                                              ; preds = %127
  ...
  %159 = call double @_Z5fuhaod(double %158)
  ...
  %183 = call double @_Z5fuhaod(double %182)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_27_1833.cpp() #0 section ".text.startup" {
