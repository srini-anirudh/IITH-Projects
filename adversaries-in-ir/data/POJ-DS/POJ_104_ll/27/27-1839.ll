; ModuleID = 'POJ-104-source/27/27-1839.cpp'
source_filename = "POJ-104-source/27/27-1839.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_27_1839.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %14 = call double @_ZSt4sqrtIiEN9__gnu_cxx11__enable_ifIXsr12__is_integerIT_EE7__valueEdE6__typeES2_(i32 -1)
...
20:                                               ; preds = %15
  ...
  %33 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i64 0, i64 0), double* %24, double* %28, double* %32)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_27_1839.cpp() #0 section ".text.startup" {
