; ModuleID = 'POJ-104-source/27/27-1882.cpp'
source_filename = "POJ-104-source/27/27-1882.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_27_1882.cpp, i8* null }]
...
12:                                               ; preds = %8
  ...
  call void @_Z1dddd(double %14, double %15, double %16)
  br label %17
...
; Function Attrs: noinline uwtable
define dso_local void @_Z1dddd(double %0, double %1, double %2) #0 {
  %4 = alloca double, align 8
  %5 = alloca double, align 8
  %6 = alloca double, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_27_1882.cpp() #0 section ".text.startup" {
