; ModuleID = 'POJ-104-source/27/27-1895.cpp'
source_filename = "POJ-104-source/27/27-1895.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_27_1895.cpp, i8* null }]
...
define dso_local i8* @_Z7solve_xifff(i32 %0, float %1, float %2, float %3) #4 {
...
51:                                               ; preds = %40, %29
  ...
  %54 = call i32 (i8*, i8*, ...) @sprintf(i8* %52, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), double %53) #3
  %55 = load i8*, i8** %11, align 8
  %56 = call i32 @strcmp(i8* %55, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0)) #7
  %57 = icmp ne i32 %56, 0
...
62:                                               ; preds = %4
  ...
  %78 = call i32 (i8*, i8*, ...) @sprintf(i8* %76, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), double %77) #3
  %79 = load i8*, i8** %11, align 8
  %80 = call i32 @strcmp(i8* %79, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0)) #7
  %81 = icmp ne i32 %80, 0
...
88:                                               ; preds = %85
  ...
  %94 = call i32 (i8*, i8*, ...) @sprintf(i8* %92, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.2, i64 0, i64 0), double %93) #3
  br label %102
...
95:                                               ; preds = %85
  ...
  %101 = call i32 (i8*, i8*, ...) @sprintf(i8* %99, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.3, i64 0, i64 0), double %100) #3
  br label %102
...
define dso_local i32 @main() #6 {
  ...
  %8 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.4, i64 0, i64 0), i32* %2)
  br label %9
...
13:                                               ; preds = %9
  %14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.5, i64 0, i64 0), double* %3, double* %4, double* %5)
  ...
  %21 = call i8* @_Z7solve_xifff(i32 1, float %16, float %18, float %20)
  ...
  %28 = call i8* @_Z7solve_xifff(i32 2, float %23, float %25, float %27)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_27_1895.cpp() #0 section ".text.startup" {
