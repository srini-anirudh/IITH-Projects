; ModuleID = 'POJ-104-source/27/27-1935.cpp'
source_filename = "POJ-104-source/27/27-1935.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_27_1935.cpp, i8* null }]
...
43:                                               ; preds = %39
  ...
  %53 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i64 0, i64 0), double* %46, double* %49, double* %52)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_27_1935.cpp() #0 section ".text.startup" {
