; ModuleID = 'POJ-104-source/27/27-1937.cpp'
source_filename = "POJ-104-source/27/27-1937.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_27_1937.cpp, i8* null }]
...
17:                                               ; preds = %13
  ...
  %27 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i64 0, i64 0), double* %20, double* %23, double* %26)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_27_1937.cpp() #0 section ".text.startup" {
