; ModuleID = 'POJ-104-source/27/27-1956.cpp'
source_filename = "POJ-104-source/27/27-1956.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_27_1956.cpp, i8* null }]
...
51:                                               ; preds = %48
  ...
  %58 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.3, i64 0, i64 0), double %57)
  br label %59
...
62:                                               ; preds = %59
  ...
  %82 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.4, i64 0, i64 0), double %69, double %73, double %77, double %81)
  br label %83
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_27_1956.cpp() #0 section ".text.startup" {
