; ModuleID = 'POJ-104-source/27/27-2137.cpp'
source_filename = "POJ-104-source/27/27-2137.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_27_2137.cpp, i8* null }]
...
20:                                               ; preds = %16
  %21 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i64 0, i64 0), double* %12, double* %13, double* %14)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_27_2137.cpp() #0 section ".text.startup" {
