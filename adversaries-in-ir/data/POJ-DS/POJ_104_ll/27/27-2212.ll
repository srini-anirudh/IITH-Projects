; ModuleID = 'POJ-104-source/27/27-2212.cpp'
source_filename = "POJ-104-source/27/27-2212.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_27_2212.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), float* %18, float* %21, float* %24)
  br label %26
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_27_2212.cpp() #0 section ".text.startup" {
