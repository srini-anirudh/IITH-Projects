; ModuleID = 'POJ-104-source/27/27-31.cpp'
source_filename = "POJ-104-source/27/27-31.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_27_31.cpp, i8* null }]
...
39:                                               ; preds = %35
  ...
  %61 = call double @_ZSt3powIiiEN9__gnu_cxx11__promote_2IT_T0_NS0_9__promoteIS2_Xsr3std12__is_integerIS2_EE7__valueEE6__typeENS4_IS3_Xsr3std12__is_integerIS3_EE7__valueEE6__typeEE6__typeES2_S3_(i32 10, i32 -8)
...
63:                                               ; preds = %39
  ...
  %82 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.2, i64 0, i64 0), double %80, double %81)
  br label %121

83:                                               ; preds = %39
  %84 = load double, double* %7, align 8
  %85 = call double @llvm.fabs.f64(double %84)
  %86 = call double @_ZSt3powIiiEN9__gnu_cxx11__promote_2IT_T0_NS0_9__promoteIS2_Xsr3std12__is_integerIS2_EE7__valueEE6__typeENS4_IS3_Xsr3std12__is_integerIS3_EE7__valueEE6__typeEE6__typeES2_S3_(i32 10, i32 -8)
...
88:                                               ; preds = %83
  ...
  %96 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.3, i64 0, i64 0), double %94, double %95)
  br label %120
...
108:                                              ; preds = %105, %97
  ...
  %119 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.4, i64 0, i64 0), double %115, double %116, double %117, double %118)
  br label %120
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_27_31.cpp() #0 section ".text.startup" {
