; ModuleID = 'POJ-104-source/27/27-438.cpp'
source_filename = "POJ-104-source/27/27-438.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_27_438.cpp, i8* null }]
...
21:                                               ; preds = %17
  ...
  %31 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i64 0, i64 0), double* %24, double* %27, double* %30)
...
174:                                              ; preds = %128
  ...
  %179 = call double @_ZSt3powIiiEN9__gnu_cxx11__promote_2IT_T0_NS0_9__promoteIS2_Xsr3std12__is_integerIS2_EE7__valueEE6__typeENS4_IS3_Xsr3std12__is_integerIS3_EE7__valueEE6__typeEE6__typeES2_S3_(i32 10, i32 -8)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_27_438.cpp() #0 section ".text.startup" {
