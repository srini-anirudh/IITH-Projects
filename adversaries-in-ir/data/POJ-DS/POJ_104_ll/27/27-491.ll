; ModuleID = 'POJ-104-source/27/27-491.cpp'
source_filename = "POJ-104-source/27/27-491.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_27_491.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z3jiefff(float %0, float %1, float %2) #0 {
...
46:                                               ; preds = %43
  ...
  %48 = call float @_ZSt4sqrtf(float %47)
  ...
  %62 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.1, i64 0, i64 0), double %59, double %61)
  br label %79
...
63:                                               ; preds = %43
  ...
  %78 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.2, i64 0, i64 0), double %71, double %73, double %75, double %77)
  br label %79
...
define dso_local i32 @main() #5 {
  ...
  %7 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i32* %5)
...
27:                                               ; preds = %23
  ...
  %40 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.4, i64 0, i64 0), float* %31, float* %35, float* %39)
  br label %41
...
49:                                               ; preds = %45
  ...
  call void @_Z3jiefff(float %54, float %59, float %64)
  br label %65
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_27_491.cpp() #0 section ".text.startup" {
