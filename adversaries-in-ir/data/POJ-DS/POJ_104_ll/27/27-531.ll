; ModuleID = 'POJ-104-source/27/27-531.cpp'
source_filename = "POJ-104-source/27/27-531.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_27_531.cpp, i8* null }]
...
define dso_local double @_Z2f5d(double %0) #4 {
...
18:                                               ; preds = %14
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i64 0, i64 0), double* %4, double* %5, double* %6)
...
51:                                               ; preds = %48
  ...
  %57 = call double @_Z2f5d(double %56)
  %58 = load double, double* %8, align 8
  %59 = load double, double* %9, align 8
  %60 = fsub double %58, %59
  %61 = load double, double* %12, align 8
  %62 = fdiv double %60, %61
  %63 = call double @_Z2f5d(double %62)
...
68:                                               ; preds = %65
  ...
  %70 = call double @_Z2f5d(double %69)
  %71 = load double, double* %11, align 8
  %72 = load double, double* %10, align 8
  %73 = call double @_Z2f5d(double %72)
...
76:                                               ; preds = %65
  ...
  %78 = call double @_Z2f5d(double %77)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_27_531.cpp() #0 section ".text.startup" {
