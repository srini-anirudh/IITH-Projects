; ModuleID = 'POJ-104-source/27/27-653.cpp'
source_filename = "POJ-104-source/27/27-653.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_27_653.cpp, i8* null }]
...
110:                                              ; preds = %109, %89
  ...
  %115 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.2, i64 0, i64 0), double %111, double %112, double %113, double %114)
  br label %117

116:                                              ; preds = %79
  br label %117

117:                                              ; preds = %116, %110, %71, %27
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_27_653.cpp() #0 section ".text.startup" {
