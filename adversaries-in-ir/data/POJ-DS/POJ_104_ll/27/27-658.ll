; ModuleID = 'POJ-104-source/27/27-658.cpp'
source_filename = "POJ-104-source/27/27-658.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_27_658.cpp, i8* null }]
...
88:                                               ; preds = %87, %73
  ...
  %93 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.2, i64 0, i64 0), double %89, double %90, double %91, double %92)
  br label %94
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_27_658.cpp() #0 section ".text.startup" {
