; ModuleID = 'POJ-104-source/27/27-71.cpp'
source_filename = "POJ-104-source/27/27-71.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_27_71.cpp, i8* null }]
...
15:                                               ; preds = %11
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i64 0, i64 0), double* %2, double* %3, double* %4)
...
58:                                               ; preds = %47
  ...
  %80 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.4, i64 0, i64 0), double %76, double %77, double %78, double %79)
  br label %81
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_27_71.cpp() #0 section ".text.startup" {
