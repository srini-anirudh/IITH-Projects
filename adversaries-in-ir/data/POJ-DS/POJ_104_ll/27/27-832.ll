; ModuleID = 'POJ-104-source/27/27-832.cpp'
source_filename = "POJ-104-source/27/27-832.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_27_832.cpp, i8* null }]
...
132:                                              ; preds = %60
  ...
  %134 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.2, i64 0, i64 0), double %133)
  br label %139

135:                                              ; preds = %60
  %136 = load double, double* %7, align 8
  %137 = load double, double* %8, align 8
  %138 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.3, i64 0, i64 0), double %136, double %137)
  br label %139
...
140:                                              ; preds = %36
  ...
  %146 = getelementptr inbounds [100 x float], [100 x float]* %4, i64 0, i64 %145
...
157:                                              ; preds = %140
  ...
  %160 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.4, i64 0, i64 0), double %158, double %159)
  br label %179

161:                                              ; preds = %140
  %162 = load i32, i32* %3, align 4
  %163 = sext i32 %162 to i64
  %164 = getelementptr inbounds [100 x float], [100 x float]* %5, i64 0, i64 %163
  ...
  %178 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.5, i64 0, i64 0), double %174, double %175, double %176, double %177)
  br label %179
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_27_832.cpp() #0 section ".text.startup" {
