; ModuleID = 'POJ-104-source/27/27-86.cpp'
source_filename = "POJ-104-source/27/27-86.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_27_86.cpp, i8* null }]
...
17:                                               ; preds = %14
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i64 0, i64 0), double* %3, double* %4, double* %5)
  ...
  %28 = call i32 @_Z4zerod(double %27)
  %29 = icmp eq i32 %28, 1
...
50:                                               ; preds = %17
  ...
  %52 = call i32 @_Z4zerod(double %51)
  %53 = icmp eq i32 %52, 0
...
define dso_local i32 @_Z4zerod(double %0) #5 {
  %2 = alloca i32, align 4
  %3 = alloca double, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_27_86.cpp() #0 section ".text.startup" {
