; ModuleID = 'POJ-104-source/27/27-91.cpp'
source_filename = "POJ-104-source/27/27-91.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_27_91.cpp, i8* null }]
...
17:                                               ; preds = %13
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i64 0, i64 0), double* %9, double* %10, double* %11)
...
34:                                               ; preds = %17
  ...
  %55 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.2, i64 0, i64 0), double %53, double %54)
  br label %86
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_27_91.cpp() #0 section ".text.startup" {
