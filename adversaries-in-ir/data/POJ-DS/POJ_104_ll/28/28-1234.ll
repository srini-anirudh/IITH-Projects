; ModuleID = 'POJ-104-source/28/28-1234.cpp'
source_filename = "POJ-104-source/28/28-1234.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_28_1234.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %21 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i8* %3)
  br label %22
...
26:                                               ; preds = %22
  ...
  %42 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i8* %3)
  br label %22
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_28_1234.cpp() #0 section ".text.startup" {
