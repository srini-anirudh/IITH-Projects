; ModuleID = 'POJ-104-source/28/28-1394.cpp'
source_filename = "POJ-104-source/28/28-1394.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_28_1394.cpp, i8* null }]
...
21:                                               ; preds = %18
  ...
  %36 = call i32 @strcmp(i8* %35, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0)) #6
...
44:                                               ; preds = %38, %21
  ...
  %50 = call i32 @strcmp(i8* %49, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0)) #6
  %51 = icmp eq i32 %50, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_28_1394.cpp() #0 section ".text.startup" {
