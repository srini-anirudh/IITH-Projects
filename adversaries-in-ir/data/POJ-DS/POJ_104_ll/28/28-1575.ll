; ModuleID = 'POJ-104-source/28/28-1575.cpp'
source_filename = "POJ-104-source/28/28-1575.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_28_1575.cpp, i8* null }]
...
9:                                                ; preds = %6
  ...
  %14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i8* %13, i8* %3)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_28_1575.cpp() #0 section ".text.startup" {
