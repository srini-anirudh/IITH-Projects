; ModuleID = 'POJ-104-source/28/28-1751.cpp'
source_filename = "POJ-104-source/28/28-1751.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_28_1751.cpp, i8* null }]
...
28:                                               ; preds = %26
  %29 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i8* %3)
  br label %10
...
38:                                               ; preds = %80, %30
  %39 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i8* %3)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_28_1751.cpp() #0 section ".text.startup" {
