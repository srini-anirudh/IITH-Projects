; ModuleID = 'POJ-104-source/28/28-18.cpp'
source_filename = "POJ-104-source/28/28-18.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_28_18.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %5 = alloca [400 x [40 x i8]], align 16
...
6:                                                ; preds = %14, %0
  ...
  %8 = sext i32 %7 to i64
  %9 = getelementptr inbounds [400 x [40 x i8]], [400 x [40 x i8]]* %5, i64 0, i64 %8
...
23:                                               ; preds = %19
  ...
  %26 = getelementptr inbounds [400 x [40 x i8]], [400 x [40 x i8]]* %5, i64 0, i64 %25
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_28_18.cpp() #0 section ".text.startup" {
