; ModuleID = 'POJ-104-source/28/28-1847.cpp'
source_filename = "POJ-104-source/28/28-1847.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_28_1847.cpp, i8* null }]
...
15:                                               ; preds = %30, %0
  ...
  %18 = getelementptr inbounds [300 x [100 x i8]], [300 x [100 x i8]]* %3, i64 0, i64 %17
...
23:                                               ; preds = %15
  ...
  %26 = getelementptr inbounds [300 x [100 x i8]], [300 x [100 x i8]]* %3, i64 0, i64 %25
  %27 = getelementptr inbounds [100 x i8], [100 x i8]* %26, i64 0, i64 0
  %28 = call i64 @strlen(i8* %27) #6
  %29 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i64 %28)
  br label %30
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_28_1847.cpp() #0 section ".text.startup" {
