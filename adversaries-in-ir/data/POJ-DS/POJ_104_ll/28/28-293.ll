; ModuleID = 'POJ-104-source/28/28-293.cpp'
source_filename = "POJ-104-source/28/28-293.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_28_293.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %2 = alloca [300 x [1000 x i8]], align 16
...
7:                                                ; preds = %17, %0
  ...
  %9 = sext i32 %8 to i64
  %10 = getelementptr inbounds [300 x [1000 x i8]], [300 x [1000 x i8]]* %2, i64 0, i64 %9
...
25:                                               ; preds = %21
  ...
  %28 = getelementptr inbounds [300 x [1000 x i8]], [300 x [1000 x i8]]* %2, i64 0, i64 %27
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_28_293.cpp() #0 section ".text.startup" {
