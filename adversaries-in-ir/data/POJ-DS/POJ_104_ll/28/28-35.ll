; ModuleID = 'POJ-104-source/28/28-35.cpp'
source_filename = "POJ-104-source/28/28-35.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_28_35.cpp, i8* null }]
...
6:                                                ; preds = %25, %0
  ...
  %8 = sext i32 %7 to i64
  %9 = getelementptr inbounds [200 x [40 x i8]], [200 x [40 x i8]]* %2, i64 0, i64 %8
  ...
  %14 = getelementptr inbounds [200 x [40 x i8]], [200 x [40 x i8]]* %2, i64 0, i64 %13
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_28_35.cpp() #0 section ".text.startup" {
