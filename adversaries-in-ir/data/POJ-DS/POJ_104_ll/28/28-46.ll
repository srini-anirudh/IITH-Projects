; ModuleID = 'POJ-104-source/28/28-46.cpp'
source_filename = "POJ-104-source/28/28-46.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_28_46.cpp, i8* null }]
...
45:                                               ; preds = %18
  %46 = getelementptr inbounds [300 x i32], [300 x i32]* %3, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_28_46.cpp() #0 section ".text.startup" {
