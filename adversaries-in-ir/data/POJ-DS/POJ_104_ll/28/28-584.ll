; ModuleID = 'POJ-104-source/28/28-584.cpp'
source_filename = "POJ-104-source/28/28-584.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_28_584.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %6 = sext i32 %5 to i64
  %7 = getelementptr inbounds [300 x [100 x i8]], [300 x [100 x i8]]* %2, i64 0, i64 %6
  ...
  %12 = getelementptr inbounds [300 x [100 x i8]], [300 x [100 x i8]]* %2, i64 0, i64 %11
...
18:                                               ; preds = %25, %0
  ...
  %21 = getelementptr inbounds [300 x [100 x i8]], [300 x [100 x i8]]* %2, i64 0, i64 %20
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_28_584.cpp() #0 section ".text.startup" {
