; ModuleID = 'POJ-104-source/28/28-593.cpp'
source_filename = "POJ-104-source/28/28-593.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_28_593.cpp, i8* null }]
...
12:                                               ; preds = %8
  ...
  %15 = getelementptr inbounds [300 x [50 x i8]], [300 x [50 x i8]]* %2, i64 0, i64 %14
  ...
  %22 = getelementptr inbounds [300 x [50 x i8]], [300 x [50 x i8]]* %2, i64 0, i64 %21
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_28_593.cpp() #0 section ".text.startup" {
