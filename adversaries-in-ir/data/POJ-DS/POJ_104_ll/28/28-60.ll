; ModuleID = 'POJ-104-source/28/28-60.cpp'
source_filename = "POJ-104-source/28/28-60.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_28_60.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %2 = alloca [500 x [60 x i8]], align 16
...
9:                                                ; preds = %16, %0
  ...
  %12 = getelementptr inbounds [500 x [60 x i8]], [500 x [60 x i8]]* %2, i64 0, i64 %11
  %13 = getelementptr inbounds [60 x i8], [60 x i8]* %12, i64 0, i64 0
...
24:                                               ; preds = %20
  ...
  %27 = getelementptr inbounds [500 x [60 x i8]], [500 x [60 x i8]]* %2, i64 0, i64 %26
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_28_60.cpp() #0 section ".text.startup" {
