; ModuleID = 'POJ-104-source/28/28-62.cpp'
source_filename = "POJ-104-source/28/28-62.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_28_62.cpp, i8* null }]
...
8:                                                ; preds = %15, %0
  ...
  %11 = getelementptr inbounds [300 x [20 x i8]], [300 x [20 x i8]]* %2, i64 0, i64 %10
  %12 = getelementptr inbounds [20 x i8], [20 x i8]* %11, i64 0, i64 0
  %13 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i8* %12)
  %14 = icmp ne i32 %13, -1
...
23:                                               ; preds = %19
  ...
  %26 = getelementptr inbounds [300 x [20 x i8]], [300 x [20 x i8]]* %2, i64 0, i64 %25
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_28_62.cpp() #0 section ".text.startup" {
