; ModuleID = 'POJ-104-source/28/28-70.cpp'
source_filename = "POJ-104-source/28/28-70.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_28_70.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %6 = bitcast [300 x [100 x i8]]* %2 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 16 %6, i8 0, i64 30000, i1 false)
...
32:                                               ; preds = %29
  %33 = getelementptr inbounds [300 x [100 x i8]], [300 x [100 x i8]]* %2, i64 0, i64 0
...
55:                                               ; preds = %52
  %56 = getelementptr inbounds [300 x [100 x i8]], [300 x [100 x i8]]* %2, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_28_70.cpp() #0 section ".text.startup" {
