; ModuleID = 'POJ-104-source/28/28-721.cpp'
source_filename = "POJ-104-source/28/28-721.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_28_721.cpp, i8* null }]
...
24:                                               ; preds = %45, %23
  %25 = getelementptr inbounds [30 x i8], [30 x i8]* %2, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_28_721.cpp() #0 section ".text.startup" {
