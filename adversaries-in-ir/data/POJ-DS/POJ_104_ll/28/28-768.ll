; ModuleID = 'POJ-104-source/28/28-768.cpp'
source_filename = "POJ-104-source/28/28-768.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_28_768.cpp, i8* null }]
...
22:                                               ; preds = %18
  ...
  %25 = getelementptr inbounds [300 x [50 x i8]], [300 x [50 x i8]]* %2, i64 0, i64 %24
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_28_768.cpp() #0 section ".text.startup" {
