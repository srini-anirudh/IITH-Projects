; ModuleID = 'POJ-104-source/28/28-77.cpp'
source_filename = "POJ-104-source/28/28-77.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_28_77.cpp, i8* null }]
...
10:                                               ; preds = %7
  ...
  %13 = getelementptr inbounds [301 x i32], [301 x i32]* %5, i64 0, i64 %12
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_28_77.cpp() #0 section ".text.startup" {
