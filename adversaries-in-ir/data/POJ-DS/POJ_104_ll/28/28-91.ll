; ModuleID = 'POJ-104-source/28/28-91.cpp'
source_filename = "POJ-104-source/28/28-91.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_28_91.cpp, i8* null }]
...
37:                                               ; preds = %29
  %38 = getelementptr inbounds [300 x i32], [300 x i32]* %4, i64 0, i64 0
  %39 = load i32, i32* %38, align 16
  %40 = getelementptr inbounds [300 x i32], [300 x i32]* %4, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_28_91.cpp() #0 section ".text.startup" {
