; ModuleID = 'POJ-104-source/29/29-1101.cpp'
source_filename = "POJ-104-source/29/29-1101.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_29_1101.cpp, i8* null }]
...
17:                                               ; preds = %50, %0
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i32* %5)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_29_1101.cpp() #0 section ".text.startup" {
