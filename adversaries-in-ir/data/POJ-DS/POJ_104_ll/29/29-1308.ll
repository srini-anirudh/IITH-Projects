; ModuleID = 'POJ-104-source/29/29-1308.cpp'
source_filename = "POJ-104-source/29/29-1308.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_29_1308.cpp, i8* null }]
...
12:                                               ; preds = %8
  ...
  %13 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), double* %5)
...
19:                                               ; preds = %14
  ...
  %23 = call double @_Z1Fd(double %22)
  %24 = load i32, i32* %6, align 4
  %25 = sitofp i32 %24 to double
  %26 = call double @_Z1fd(double %25)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_29_1308.cpp() #0 section ".text.startup" {
