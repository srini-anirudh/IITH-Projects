; ModuleID = 'POJ-104-source/29/29-1396.cpp'
source_filename = "POJ-104-source/29/29-1396.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_29_1396.cpp, i8* null }]
...
42:                                               ; preds = %35
  ...
  %44 = add nsw i32 %43, 1
  %45 = call i32 @_Z9feibonaqii(i32 %44)
  %46 = sitofp i32 %45 to double
  %47 = fmul double %46, 1.000000e+00
  %48 = load i32, i32* %4, align 4
  %49 = call i32 @_Z9feibonaqii(i32 %48)
...
define dso_local i32 @_Z9feibonaqii(i32 %0) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_29_1396.cpp() #0 section ".text.startup" {
