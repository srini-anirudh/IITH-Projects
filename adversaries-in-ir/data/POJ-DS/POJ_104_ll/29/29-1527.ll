; ModuleID = 'POJ-104-source/29/29-1527.cpp'
source_filename = "POJ-104-source/29/29-1527.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_29_1527.cpp, i8* null }]
...
define dso_local i32 @_Z2fbi(i32 %0) #4 {
...
18:                                               ; preds = %14
  ...
  %20 = add nsw i32 %19, 1
  %21 = call i32 @_Z2fbi(i32 %20)
  %22 = sitofp i32 %21 to double
  %23 = fmul double 1.000000e+00, %22
  %24 = load i32, i32* %6, align 4
  %25 = call i32 @_Z2fbi(i32 %24)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_29_1527.cpp() #0 section ".text.startup" {
