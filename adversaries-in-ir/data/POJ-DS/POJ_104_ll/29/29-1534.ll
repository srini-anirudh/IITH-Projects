; ModuleID = 'POJ-104-source/29/29-1534.cpp'
source_filename = "POJ-104-source/29/29-1534.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_29_1534.cpp, i8* null }]
...
78:                                               ; preds = %75
  ...
  call void @clearerr(%struct._IO_FILE* %79) #3
  %80 = call i32 @getchar()
  store i32 0, i32* %1, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_29_1534.cpp() #0 section ".text.startup" {
