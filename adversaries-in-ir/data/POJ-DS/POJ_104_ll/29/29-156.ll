; ModuleID = 'POJ-104-source/29/29-156.cpp'
source_filename = "POJ-104-source/29/29-156.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_29_156.cpp, i8* null }]
...
35:                                               ; preds = %28
  ...
  %41 = add nsw i32 %40, 1
  %42 = call i32 @_Z4fbnqi(i32 %41)
  %43 = sitofp i32 %42 to float
  %44 = load i32, i32* %5, align 4
  %45 = call i32 @_Z4fbnqi(i32 %44)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_29_156.cpp() #0 section ".text.startup" {
