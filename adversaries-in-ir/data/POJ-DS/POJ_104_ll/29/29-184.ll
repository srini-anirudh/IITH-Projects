; ModuleID = 'POJ-104-source/29/29-184.cpp'
source_filename = "POJ-104-source/29/29-184.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_29_184.cpp, i8* null }]
...
69:                                               ; preds = %65
  store double 0.000000e+00, double* %6, align 8
  %70 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %2)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_29_184.cpp() #0 section ".text.startup" {
