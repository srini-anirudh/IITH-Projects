; ModuleID = 'POJ-104-source/29/29-1882.cpp'
source_filename = "POJ-104-source/29/29-1882.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_29_1882.cpp, i8* null }]
...
60:                                               ; preds = %40
  %61 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %2)
  br label %62
...
66:                                               ; preds = %62
  %67 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %3)
  store double 0.000000e+00, double* %8, align 8
  store i32 0, i32* %7, align 4
  br label %68
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_29_1882.cpp() #0 section ".text.startup" {
