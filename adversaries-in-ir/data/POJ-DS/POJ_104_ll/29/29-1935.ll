; ModuleID = 'POJ-104-source/29/29-1935.cpp'
source_filename = "POJ-104-source/29/29-1935.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_29_1935.cpp, i8* null }]
...
73:                                               ; preds = %39
  ...
  store i32 2, i32* %6, align 4
  store i32 1, i32* %7, align 4
  %78 = getelementptr inbounds [100 x double], [100 x double]* %8, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_29_1935.cpp() #0 section ".text.startup" {
