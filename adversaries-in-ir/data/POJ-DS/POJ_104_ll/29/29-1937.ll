; ModuleID = 'POJ-104-source/29/29-1937.cpp'
source_filename = "POJ-104-source/29/29-1937.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_29_1937.cpp, i8* null }]
...
21:                                               ; preds = %17
  ...
  %23 = add nsw i32 %22, 2
  %24 = call i32 @_Z9fibonaccii(i32 %23)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_29_1937.cpp() #0 section ".text.startup" {
