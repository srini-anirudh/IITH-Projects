; ModuleID = 'POJ-104-source/29/29-1952.cpp'
source_filename = "POJ-104-source/29/29-1952.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_29_1952.cpp, i8* null }]
...
define dso_local double @_Z5dosumi(i32 %0) #4 {
...
18:                                               ; preds = %12
  ...
  %20 = call double @_Z5dosumi(i32 %19)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_29_1952.cpp() #0 section ".text.startup" {
