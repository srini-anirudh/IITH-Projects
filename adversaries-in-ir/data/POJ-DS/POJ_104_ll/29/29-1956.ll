; ModuleID = 'POJ-104-source/29/29-1956.cpp'
source_filename = "POJ-104-source/29/29-1956.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_29_1956.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z4feiii(i32 %0) #0 {
...
28:                                               ; preds = %21
  ...
  %30 = sub nsw i32 %29, 1
  %31 = call i32 @_Z4feiii(i32 %30)
  %32 = load i32, i32* %3, align 4
  %33 = sub nsw i32 %32, 2
  %34 = call i32 @_Z4feiii(i32 %33)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_29_1956.cpp() #0 section ".text.startup" {
