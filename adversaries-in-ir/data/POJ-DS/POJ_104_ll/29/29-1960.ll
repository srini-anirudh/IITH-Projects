; ModuleID = 'POJ-104-source/29/29-1960.cpp'
source_filename = "POJ-104-source/29/29-1960.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_29_1960.cpp, i8* null }]
...
define dso_local void @_Z7jisuanbPdiS_(double* %0, i32 %1, double* %2) #4 {
...
29:                                               ; preds = %25
  ...
  call void @_Z7jisuanbPdiS_(double* %30, i32 %34, double* %35)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_29_1960.cpp() #0 section ".text.startup" {
