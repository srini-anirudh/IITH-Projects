; ModuleID = 'POJ-104-source/29/29-227.cpp'
source_filename = "POJ-104-source/29/29-227.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_29_227.cpp, i8* null }]
...
72:                                               ; preds = %50
  %73 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %6)
...
78:                                               ; preds = %74
  ...
  %85 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %84)
  store i32 0, i32* %4, align 4
  br label %86
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_29_227.cpp() #0 section ".text.startup" {
