; ModuleID = 'POJ-104-source/29/29-25.cpp'
source_filename = "POJ-104-source/29/29-25.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_29_25.cpp, i8* null }]
...
35:                                               ; preds = %28
  ...
  %37 = add nsw i32 %36, 1
  %38 = call i32 @_Z4fbnqi(i32 %37)
  %39 = sitofp i32 %38 to double
  %40 = load i32, i32* %3, align 4
  %41 = call i32 @_Z4fbnqi(i32 %40)
...
define dso_local i32 @_Z4fbnqi(i32 %0) #6 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_29_25.cpp() #0 section ".text.startup" {
