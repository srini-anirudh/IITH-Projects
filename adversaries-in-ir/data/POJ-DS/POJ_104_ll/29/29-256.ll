; ModuleID = 'POJ-104-source/29/29-256.cpp'
source_filename = "POJ-104-source/29/29-256.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_29_256.cpp, i8* null }]
...
26:                                               ; preds = %18
  ...
  %28 = add nsw i32 %27, 1
  %29 = call i32 @_Z4fbnqi(i32 %28)
  %30 = sitofp i32 %29 to float
  %31 = load i32, i32* %6, align 4
  %32 = call i32 @_Z4fbnqi(i32 %31)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_29_256.cpp() #0 section ".text.startup" {
