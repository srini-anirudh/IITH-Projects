; ModuleID = 'POJ-104-source/29/29-356.cpp'
source_filename = "POJ-104-source/29/29-356.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_29_356.cpp, i8* null }]
...
47:                                               ; preds = %30
  %48 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i64* %2)
  store i64 1, i64* %3, align 8
  br label %49
...
53:                                               ; preds = %49
  ...
  %56 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i64* %55)
  br label %57
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_29_356.cpp() #0 section ".text.startup" {
