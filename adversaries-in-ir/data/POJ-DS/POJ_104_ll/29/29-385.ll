; ModuleID = 'POJ-104-source/29/29-385.cpp'
source_filename = "POJ-104-source/29/29-385.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_29_385.cpp, i8* null }]
...
60:                                               ; preds = %56
  %61 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %5)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_29_385.cpp() #0 section ".text.startup" {
