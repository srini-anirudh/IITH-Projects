; ModuleID = 'POJ-104-source/29/29-434.cpp'
source_filename = "POJ-104-source/29/29-434.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_29_434.cpp, i8* null }]
...
22:                                               ; preds = %10
  ...
  %32 = getelementptr inbounds [100 x double], [100 x double]* %8, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_29_434.cpp() #0 section ".text.startup" {
