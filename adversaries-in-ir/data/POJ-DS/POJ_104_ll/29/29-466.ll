; ModuleID = 'POJ-104-source/29/29-466.cpp'
source_filename = "POJ-104-source/29/29-466.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_29_466.cpp, i8* null }]
...
10:                                               ; preds = %6
  ...
  %15 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), double* %14)
  ...
  %21 = call double @_Z1fd(double %20)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_29_466.cpp() #0 section ".text.startup" {
