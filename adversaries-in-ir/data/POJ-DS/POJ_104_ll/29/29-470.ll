; ModuleID = 'POJ-104-source/29/29-470.cpp'
source_filename = "POJ-104-source/29/29-470.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_29_470.cpp, i8* null }]
...
67:                                               ; preds = %44
  %68 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %2)
  store i32 0, i32* %7, align 4
  br label %69
...
73:                                               ; preds = %69
  %74 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %3)
...
101:                                              ; preds = %97
  ...
  %106 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), double %105)
  br label %107
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_29_470.cpp() #0 section ".text.startup" {
