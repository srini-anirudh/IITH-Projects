; ModuleID = 'POJ-104-source/29/29-484.cpp'
source_filename = "POJ-104-source/29/29-484.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_29_484.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %9 = call i32 @_Z1fi(i32 1)
  store i32 %9, i32* %4, align 4
  %10 = call i32 @_Z1fi(i32 2)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_29_484.cpp() #0 section ".text.startup" {
