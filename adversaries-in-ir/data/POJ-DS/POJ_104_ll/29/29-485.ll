; ModuleID = 'POJ-104-source/29/29-485.cpp'
source_filename = "POJ-104-source/29/29-485.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_29_485.cpp, i8* null }]
...
55:                                               ; preds = %50
  %56 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %5)
...
88:                                               ; preds = %50
  %89 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %5)
  store float 0.000000e+00, float* %8, align 4
  store i32 0, i32* %7, align 4
  br label %90
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_29_485.cpp() #0 section ".text.startup" {
