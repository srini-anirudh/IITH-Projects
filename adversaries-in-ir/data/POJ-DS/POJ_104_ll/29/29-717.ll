; ModuleID = 'POJ-104-source/29/29-717.cpp'
source_filename = "POJ-104-source/29/29-717.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_29_717.cpp, i8* null }]
...
12:                                               ; preds = %8
  ...
  %14 = sub nsw i32 %13, 1
  %15 = call float @_Z1fi(i32 %14)
  %16 = load i32, i32* %3, align 4
  %17 = sub nsw i32 %16, 2
  %18 = call float @_Z1fi(i32 %17)
  %19 = fadd float %15, %18
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_29_717.cpp() #0 section ".text.startup" {
