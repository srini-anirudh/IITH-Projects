; ModuleID = 'POJ-104-source/29/29-727.cpp'
source_filename = "POJ-104-source/29/29-727.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_29_727.cpp, i8* null }]
...
37:                                               ; preds = %31
  %38 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0))
  br label %39
...
80:                                               ; preds = %54
  ...
  %82 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i64 0, i64 0), double %81)
  br label %83
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_29_727.cpp() #0 section ".text.startup" {
