; ModuleID = 'POJ-104-source/29/29-859.cpp'
source_filename = "POJ-104-source/29/29-859.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_29_859.cpp, i8* null }]
...
18:                                               ; preds = %14
  ...
  %20 = add nsw i32 %19, 1
  %21 = call i32 @_Z6shuliei(i32 %20)
  %22 = sitofp i32 %21 to double
  %23 = load i32, i32* %3, align 4
  %24 = call i32 @_Z6shuliei(i32 %23)
...
define dso_local i32 @_Z6shuliei(i32 %0) #5 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_29_859.cpp() #0 section ".text.startup" {
