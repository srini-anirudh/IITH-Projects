; ModuleID = 'POJ-104-source/29/29-879.cpp'
source_filename = "POJ-104-source/29/29-879.cpp"
...
@c = dso_local global [10000 x double] zeroinitializer, align 16
@p = dso_local global [10000 x double] zeroinitializer, align 16
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [7 x i8] c"%.3lf\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_29_879.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_29_879.cpp() #0 section ".text.startup" {
