; ModuleID = 'POJ-104-source/3/3-2069.cpp'
source_filename = "POJ-104-source/3/3-2069.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_3_2069.cpp, i8* null }]
...
54:                                               ; preds = %21
  ...
  %56 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %2, i32* %3)
  store i32 0, i32* %1, align 4
  br label %57
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_3_2069.cpp() #0 section ".text.startup" {
