; ModuleID = 'POJ-104-source/3/3-2076.cpp'
source_filename = "POJ-104-source/3/3-2076.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_3_2076.cpp, i8* null }]
...
71:                                               ; preds = %69, %66
  %72 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.4, i64 0, i64 0), i32* %2)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_3_2076.cpp() #0 section ".text.startup" {
