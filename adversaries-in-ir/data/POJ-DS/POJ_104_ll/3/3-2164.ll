; ModuleID = 'POJ-104-source/3/3-2164.cpp'
source_filename = "POJ-104-source/3/3-2164.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_3_2164.cpp, i8* null }]
...
define dso_local i32 @_Z10bubblesortPii(i32* %0, i32 %1) #4 {
...
23:                                               ; preds = %11
  ...
  %26 = call i32 @_Z10bubblesortPii(i32* %24, i32 %25)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_3_2164.cpp() #0 section ".text.startup" {
