; ModuleID = 'POJ-104-source/3/3-2253.cpp'
source_filename = "POJ-104-source/3/3-2253.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_3_2253.cpp, i8* null }]
...
define dso_local i32 @_Z5checkiiPi(i32 %0, i32 %1, i32* %2) #4 {
...
19:                                               ; preds = %7
  ...
  %23 = call i32 @_Z5checkiiPi(i32 %20, i32 %21, i32* %22)
  %24 = icmp ne i32 %23, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_3_2253.cpp() #0 section ".text.startup" {
