; ModuleID = 'POJ-104-source/3/3-2550.cpp'
source_filename = "POJ-104-source/3/3-2550.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_3_2550.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %2 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* @n, i32* @p)
...
7:                                                ; preds = %3
  ...
  %11 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i32* %10)
  br label %12
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_3_2550.cpp() #0 section ".text.startup" {
