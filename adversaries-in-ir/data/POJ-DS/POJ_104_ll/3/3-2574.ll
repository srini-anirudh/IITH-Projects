; ModuleID = 'POJ-104-source/3/3-2574.cpp'
source_filename = "POJ-104-source/3/3-2574.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_3_2574.cpp, i8* null }]
...
define dso_local i32 @_Z2exPiS_(i32* %0, i32* %1) #4 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_3_2574.cpp() #0 section ".text.startup" {
