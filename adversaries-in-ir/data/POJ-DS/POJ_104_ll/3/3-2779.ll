; ModuleID = 'POJ-104-source/3/3-2779.cpp'
source_filename = "POJ-104-source/3/3-2779.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_3_2779.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_3_2779.cpp() #0 section ".text.startup" {
