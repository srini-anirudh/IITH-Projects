; ModuleID = 'POJ-104-source/3/3-3181.cpp'
source_filename = "POJ-104-source/3/3-3181.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_3_3181.cpp, i8* null }]
...
define dso_local i32 @_Z2bjPKvS0_(i8* %0, i8* %1) #4 {
...
21:                                               ; preds = %9
  ...
  call void @qsort(i8* %23, i64 %25, i64 4, i32 (i8*, i8*)* @_Z2bjPKvS0_)
  store i32 0, i32* %4, align 4
  br label %26
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_3_3181.cpp() #0 section ".text.startup" {
