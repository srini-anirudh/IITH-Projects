; ModuleID = 'POJ-104-source/3/3-53.cpp'
source_filename = "POJ-104-source/3/3-53.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_3_53.cpp, i8* null }]
...
19:                                               ; preds = %9
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %2, i32* %4)
  store i32 0, i32* %3, align 4
  br label %21
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_3_53.cpp() #0 section ".text.startup" {
