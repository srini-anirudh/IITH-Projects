; ModuleID = 'POJ-104-source/3/3-809.cpp'
source_filename = "POJ-104-source/3/3-809.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_3_809.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %11 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %5, i32* %8)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_3_809.cpp() #0 section ".text.startup" {
