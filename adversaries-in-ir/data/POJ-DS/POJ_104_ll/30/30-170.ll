; ModuleID = 'POJ-104-source/30/30-170.cpp'
source_filename = "POJ-104-source/30/30-170.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_30_170.cpp, i8* null }]
...
define dso_local i32 @_Z3Deci(i32 %0) #4 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_30_170.cpp() #0 section ".text.startup" {
