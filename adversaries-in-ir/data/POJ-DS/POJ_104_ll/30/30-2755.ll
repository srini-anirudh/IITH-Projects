; ModuleID = 'POJ-104-source/30/30-2755.cpp'
source_filename = "POJ-104-source/30/30-2755.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_30_2755.cpp, i8* null }]
...
28:                                               ; preds = %24
  ...
  %33 = getelementptr inbounds [3 x i32], [3 x i32]* %9, i64 0, i64 %32
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_30_2755.cpp() #0 section ".text.startup" {
