; ModuleID = 'POJ-104-source/30/30-2827.cpp'
source_filename = "POJ-104-source/30/30-2827.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_30_2827.cpp, i8* null }]
...
33:                                               ; preds = %25
  ...
  %39 = sdiv i32 %38, 10
  %40 = call double @_ZSt5floorIiEN9__gnu_cxx11__enable_ifIXsr12__is_integerIT_EE7__valueEdE6__typeES2_(i32 %39)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_30_2827.cpp() #0 section ".text.startup" {
