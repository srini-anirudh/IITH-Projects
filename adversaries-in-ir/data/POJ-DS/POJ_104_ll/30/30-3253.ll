; ModuleID = 'POJ-104-source/30/30-3253.cpp'
source_filename = "POJ-104-source/30/30-3253.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_30_3253.cpp, i8* null }]
...
128:                                              ; preds = %122, %116, %110, %104, %98, %92, %86, %80, %74, %68, %62, %56, %50, %44, %38, %32, %25
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_30_3253.cpp() #0 section ".text.startup" {
