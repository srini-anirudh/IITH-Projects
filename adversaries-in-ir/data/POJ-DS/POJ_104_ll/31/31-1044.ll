; ModuleID = 'POJ-104-source/31/31-1044.cpp'
source_filename = "POJ-104-source/31/31-1044.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_1044.cpp, i8* null }]
...
21:                                               ; preds = %12
  ...
  %44 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), [20 x i8]* %43)
  %45 = call i32 @getchar()
  ...
  %62 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i8* %61)
  %63 = call i32 @getchar()
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_1044.cpp() #0 section ".text.startup" {
