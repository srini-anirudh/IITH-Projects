; ModuleID = 'POJ-104-source/31/31-1049.cpp'
source_filename = "POJ-104-source/31/31-1049.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_1049.cpp, i8* null }]
...
27:                                               ; preds = %20
  ...
  %41 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i64 0, i64 0), i8* %30, i8* %33, i32* %35, float* %37, i8* %40)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_1049.cpp() #0 section ".text.startup" {
