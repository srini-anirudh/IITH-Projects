; ModuleID = 'POJ-104-source/31/31-1064.cpp'
source_filename = "POJ-104-source/31/31-1064.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_1064.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %21 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i64 0, i64 0), i8* %7, i8* %10, i8* %12, i32* %14, i8* %17, i8* %20)
...
30:                                               ; preds = %29, %47
  ...
  %38 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* %37)
...
47:                                               ; preds = %30
  ...
  %71 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.2, i64 0, i64 0), i8* %52, i8* %56, i32* %60, i8* %65, i8* %70)
  br label %30
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_1064.cpp() #0 section ".text.startup" {
