; ModuleID = 'POJ-104-source/31/31-1065.cpp'
source_filename = "POJ-104-source/31/31-1065.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_1065.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %6 = call noalias i8* @malloc(i64 88) #3
...
21:                                               ; preds = %14
  ...
  %35 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i64 0, i64 0), i8* %24, i8* %26, i32* %28, i8* %31, i8* %34)
  %36 = load %struct.student*, %struct.student** %2, align 8
  store %struct.student* %36, %struct.student** %3, align 8
  %37 = call noalias i8* @malloc(i64 88) #3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_1065.cpp() #0 section ".text.startup" {
