; ModuleID = 'POJ-104-source/31/31-1069.cpp'
source_filename = "POJ-104-source/31/31-1069.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_1069.cpp, i8* null }]
...
19:                                               ; preds = %12
  ...
  %33 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i64 0, i64 0), i8* %22, i8* %25, i32* %27, float* %29, i8* %32)
  ...
  %43 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i8* %42)
  br label %12
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_1069.cpp() #0 section ".text.startup" {
