; ModuleID = 'POJ-104-source/31/31-1087.cpp'
source_filename = "POJ-104-source/31/31-1087.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_1087.cpp, i8* null }]
...
4:                                                ; preds = %49, %0
  ...
  %10 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i8* %9)
...
20:                                               ; preds = %4
  ...
  %45 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i64 0, i64 0), i8* %25, i8* %29, i8* %34, i8* %39, i8* %44)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_1087.cpp() #0 section ".text.startup" {
