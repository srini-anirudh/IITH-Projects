; ModuleID = 'POJ-104-source/31/31-1108.cpp'
source_filename = "POJ-104-source/31/31-1108.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_1108.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i64 0, i64 0), i8* %10, i8* %13, i8* %15, i32* %17, i8* %20, i8* %23)
  br label %25
...
25:                                               ; preds = %0, %56
  ...
  %48 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i64 0, i64 0), i8* %34, i8* %37, i8* %39, i32* %41, i8* %44, i8* %47)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_1108.cpp() #0 section ".text.startup" {
