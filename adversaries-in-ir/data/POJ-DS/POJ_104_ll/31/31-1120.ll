; ModuleID = 'POJ-104-source/31/31-1120.cpp'
source_filename = "POJ-104-source/31/31-1120.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_1120.cpp, i8* null }]
...
19:                                               ; preds = %3
  ...
  %44 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i64 0, i64 0), i8* %24, i8* %28, i8* %33, i8* %38, i8* %43)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_1120.cpp() #0 section ".text.startup" {
