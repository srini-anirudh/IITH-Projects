; ModuleID = 'POJ-104-source/31/31-113.cpp'
source_filename = "POJ-104-source/31/31-113.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_113.cpp, i8* null }]
...
8:                                                ; preds = %0, %40
  ...
  %16 = call i32 @strcmp(i8* %15, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0)) #6
  %17 = icmp ne i32 %16, 0
...
18:                                               ; preds = %8
  ...
  %33 = call noalias i8* @malloc(i64 96) #3
...
50:                                               ; preds = %45
  ...
  %70 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.3, i64 0, i64 0), i8* %53, i8* %56, i32 %60, i32 %63, i8* %66, i8* %69)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_113.cpp() #0 section ".text.startup" {
