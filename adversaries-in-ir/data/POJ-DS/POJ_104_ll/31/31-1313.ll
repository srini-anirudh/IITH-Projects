; ModuleID = 'POJ-104-source/31/31-1313.cpp'
source_filename = "POJ-104-source/31/31-1313.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_1313.cpp, i8* null }]
...
define dso_local %struct.student* @_Z5creatv() #0 {
  ...
  %9 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), [20 x i8]* %8)
  br label %10
...
17:                                               ; preds = %10
  ...
  %30 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i64 0, i64 0), [20 x i8]* %21, i8* %23, i32* %25, [20 x i8]* %27, [20 x i8]* %29)
...
41:                                               ; preds = %38, %33
  ...
  %46 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), [20 x i8]* %45)
  br label %10
...
define dso_local i32 @main() #4 {
  %1 = alloca %struct.student*, align 8
  %2 = call %struct.student* @_Z5creatv()
  store %struct.student* %2, %struct.student** %1, align 8
  %3 = load %struct.student*, %struct.student** %1, align 8
  call void @_Z5printP7student(%struct.student* %3)
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_1313.cpp() #0 section ".text.startup" {
