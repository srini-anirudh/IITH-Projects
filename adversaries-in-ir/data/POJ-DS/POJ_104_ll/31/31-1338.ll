; ModuleID = 'POJ-104-source/31/31-1338.cpp'
source_filename = "POJ-104-source/31/31-1338.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_1338.cpp, i8* null }]
...
43:                                               ; preds = %33, %24, %9
  ...
  %66 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i64 0, i64 0), i8* %48, i8* %52, i32* %56, float* %60, i8* %65)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_1338.cpp() #0 section ".text.startup" {
