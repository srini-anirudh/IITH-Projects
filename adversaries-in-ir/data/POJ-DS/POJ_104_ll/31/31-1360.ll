; ModuleID = 'POJ-104-source/31/31-1360.cpp'
source_filename = "POJ-104-source/31/31-1360.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_1360.cpp, i8* null }]
...
define dso_local void @_Z8add_nodePcS_ciS_S_(i8* %0, i8* %1, i8 signext %2, i32 %3, i8* %4, i8* %5) #4 {
  %7 = alloca i8*, align 8
  %8 = alloca i8*, align 8
  %9 = alloca i8, align 1
...
16:                                               ; preds = %6
  %17 = call noalias i8* @malloc(i64 288) #3
...
23:                                               ; preds = %6
  ...
  %25 = call noalias i8* @malloc(i64 288) #3
...
10:                                               ; preds = %14, %0
  ...
  %12 = call i32 @strcmp(i8* %11, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0)) #7
  %13 = icmp ne i32 %12, 0
...
14:                                               ; preds = %10
  ...
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.3, i64 0, i64 0), i8* %15, i8* %4, i32* %5, i8* %16, i8* %17)
  ...
  call void @_Z8add_nodePcS_ciS_S_(i8* %19, i8* %20, i8 signext %21, i32 %22, i8* %23, i8* %24)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_1360.cpp() #0 section ".text.startup" {
