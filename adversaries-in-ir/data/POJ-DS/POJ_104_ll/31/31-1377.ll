; ModuleID = 'POJ-104-source/31/31-1377.cpp'
source_filename = "POJ-104-source/31/31-1377.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_1377.cpp, i8* null }]
...
21:                                               ; preds = %14
  ...
  %34 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i64 0, i64 0), i8* %24, i8* %26, i32* %28, float* %30, i8* %33)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_1377.cpp() #0 section ".text.startup" {
