; ModuleID = 'POJ-104-source/31/31-1381.cpp'
source_filename = "POJ-104-source/31/31-1381.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_1381.cpp, i8* null }]
...
23:                                               ; preds = %9
  ...
  %37 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i64 0, i64 0), i8* %26, i8* %28, i32* %30, i8* %33, i8* %36)
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5printP4stud(%struct.stud* %0) #0 {
  %2 = alloca %struct.stud*, align 8
  %3 = alloca %struct.stud*, align 8
...
define dso_local i32 @main() #4 {
  %1 = alloca %struct.stud*, align 8
  %2 = call %struct.stud* @_Z5creatv()
  store %struct.stud* %2, %struct.stud** %1, align 8
  %3 = load %struct.stud*, %struct.stud** %1, align 8
  call void @_Z5printP4stud(%struct.stud* %3)
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_1381.cpp() #0 section ".text.startup" {
