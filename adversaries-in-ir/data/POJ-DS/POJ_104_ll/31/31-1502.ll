; ModuleID = 'POJ-104-source/31/31-1502.cpp'
source_filename = "POJ-104-source/31/31-1502.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_1502.cpp, i8* null }]
...
21:                                               ; preds = %10
  ...
  %34 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.2, i64 0, i64 0), i8* %24, i8* %26, float* %28, float* %30, i8* %33)
  %35 = call noalias i8* @malloc(i64 120) #3
  ...
  store %struct.student* %39, %struct.student** %43, align 8
...
57:                                               ; preds = %54
  ...
  %79 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.3, i64 0, i64 0), i8* %60, i8* %63, i32 %67, double %71, double %75, i8* %78)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_1502.cpp() #0 section ".text.startup" {
