; ModuleID = 'POJ-104-source/31/31-1505.cpp'
source_filename = "POJ-104-source/31/31-1505.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_1505.cpp, i8* null }]
...
28:                                               ; preds = %12
  ...
  %42 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i64 0, i64 0), i8* %31, i8* %33, i32* %35, i8* %38, i8* %41)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_1505.cpp() #0 section ".text.startup" {
