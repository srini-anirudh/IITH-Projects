; ModuleID = 'POJ-104-source/31/31-1511.cpp'
source_filename = "POJ-104-source/31/31-1511.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_1511.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %7 = call noalias i8* @malloc(i64 88) #3
...
16:                                               ; preds = %0
  ...
  %29 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i64 0, i64 0), [20 x i8]* %18, [20 x i8]* %20, i8* %22, i32* %24, float* %26, [20 x i8]* %28)
...
33:                                               ; preds = %30
  %34 = call noalias i8* @malloc(i64 88) #3
  ...
  %58 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.2, i64 0, i64 0), [20 x i8]* %47, [20 x i8]* %49, i8* %51, i32* %53, float* %55, [20 x i8]* %57)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_1511.cpp() #0 section ".text.startup" {
