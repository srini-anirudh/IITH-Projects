; ModuleID = 'POJ-104-source/31/31-1537.cpp'
source_filename = "POJ-104-source/31/31-1537.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_1537.cpp, i8* null }]
...
14:                                               ; preds = %8
  ...
  %17 = call noalias i8* @malloc(i64 424) #3
  ...
  %41 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.2, i64 0, i64 0), i8* %30, i8* %32, i32* %34, i8* %37, i8* %40)
...
60:                                               ; preds = %57
  ...
  %80 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.3, i64 0, i64 0), i8* %63, i8* %66, i32 %70, i32 %73, i8* %76, i8* %79)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_1537.cpp() #0 section ".text.startup" {
