; ModuleID = 'POJ-104-source/31/31-1570.cpp'
source_filename = "POJ-104-source/31/31-1570.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_1570.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z6createv() #0 {
...
18:                                               ; preds = %0
  ...
  %34 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i64 0, i64 0), i8* %21, i8* %24, i8* %27, i8* %30, i8* %33)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_1570.cpp() #0 section ".text.startup" {
