; ModuleID = 'POJ-104-source/31/31-1609.cpp'
source_filename = "POJ-104-source/31/31-1609.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_1609.cpp, i8* null }]
...
9:                                                ; preds = %69, %2
  ...
  %21 = call i32 @strcmp(i8* %20, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0)) #6
  %22 = icmp eq i32 %21, 0
...
24:                                               ; preds = %9
  ...
  %48 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.2, i64 0, i64 0), i8* %29, i8* %33, i32* %37, i8* %42, i8* %47)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_1609.cpp() #0 section ".text.startup" {
