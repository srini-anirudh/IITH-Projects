; ModuleID = 'POJ-104-source/31/31-1642.cpp'
source_filename = "POJ-104-source/31/31-1642.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_1642.cpp, i8* null }]
...
34:                                               ; preds = %15
  ...
  %48 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i64 0, i64 0), i8* %37, i8* %39, i32* %41, i8* %44, i8* %47)
...
68:                                               ; preds = %65
  ...
  %88 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.2, i64 0, i64 0), i8* %71, i8* %74, i32 %78, i32 %81, i8* %84, i8* %87)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_1642.cpp() #0 section ".text.startup" {
