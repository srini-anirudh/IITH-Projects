; ModuleID = 'POJ-104-source/31/31-1643.cpp'
source_filename = "POJ-104-source/31/31-1643.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_1643.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %5 = call noalias i8* @malloc(i64 104) #3
...
12:                                               ; preds = %27, %0
  ...
  %24 = call i32 @strcmp(i8* %23, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0)) #6
  %25 = icmp eq i32 %24, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_1643.cpp() #0 section ".text.startup" {
