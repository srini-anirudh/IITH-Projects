; ModuleID = 'POJ-104-source/31/31-1669.cpp'
source_filename = "POJ-104-source/31/31-1669.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_1669.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %5 = call noalias i8* @malloc(i64 176) #3
  ...
  %23 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i64 0, i64 0), i8* %10, i8* %13, [1 x i8]* %15, i32* %17, float* %19, i8* %22)
...
26:                                               ; preds = %45, %0
  ...
  %30 = call i32 @strcmp(i8* %29, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0)) #6
  %31 = icmp ne i32 %30, 0
  br i1 %31, label %32, label %64

32:                                               ; preds = %26
  %33 = call noalias i8* @malloc(i64 176) #3
  ...
  %42 = call i32 @strcmp(i8* %41, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0)) #6
  %43 = icmp eq i32 %42, 0
...
45:                                               ; preds = %32
  ...
  %58 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.3, i64 0, i64 0), i8* %48, [1 x i8]* %50, i32* %52, float* %54, i8* %57)
...
69:                                               ; preds = %66
  ...
  %89 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.4, i64 0, i64 0), i8* %72, i8* %75, i8* %78, i32 %81, double %85, i8* %88)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_1669.cpp() #0 section ".text.startup" {
