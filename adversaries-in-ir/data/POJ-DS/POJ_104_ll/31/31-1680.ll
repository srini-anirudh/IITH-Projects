; ModuleID = 'POJ-104-source/31/31-1680.cpp'
source_filename = "POJ-104-source/31/31-1680.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_1680.cpp, i8* null }]
...
16:                                               ; preds = %3
  ...
  %30 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.2, i64 0, i64 0), i8* %19, i8* %21, i32* %23, i8* %26, i8* %29)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_1680.cpp() #0 section ".text.startup" {
