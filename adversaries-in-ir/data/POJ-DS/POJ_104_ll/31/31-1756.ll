; ModuleID = 'POJ-104-source/31/31-1756.cpp'
source_filename = "POJ-104-source/31/31-1756.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_1756.cpp, i8* null }]
...
5:                                                ; preds = %50, %0
  %6 = call noalias i8* @malloc(i64 288) #3
...
34:                                               ; preds = %26
  ...
  %48 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.2, i64 0, i64 0), i8* %37, i8* %39, i32* %41, i8* %44, i8* %47)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_1756.cpp() #0 section ".text.startup" {
