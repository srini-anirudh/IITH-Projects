; ModuleID = 'POJ-104-source/31/31-180.cpp'
source_filename = "POJ-104-source/31/31-180.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_180.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local %struct.data* @_Z5creatv() #0 {
...
23:                                               ; preds = %5
  ...
  %37 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i64 0, i64 0), i8* %26, i8* %28, i32* %30, i8* %33, i8* %36)
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5printP4data(%struct.data* %0) #0 {
  %2 = alloca %struct.data*, align 8
  %3 = alloca %struct.data*, align 8
...
define dso_local i32 @main() #4 {
  ...
  %3 = call %struct.data* @_Z5creatv()
  store %struct.data* %3, %struct.data** %2, align 8
  %4 = load %struct.data*, %struct.data** %2, align 8
  call void @_Z5printP4data(%struct.data* %4)
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_180.cpp() #0 section ".text.startup" {
