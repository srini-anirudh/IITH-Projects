; ModuleID = 'POJ-104-source/31/31-1802.cpp'
source_filename = "POJ-104-source/31/31-1802.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_1802.cpp, i8* null }]
...
19:                                               ; preds = %4
  ...
  %32 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.1, i64 0, i64 0), i8* %22, i8* %24, i32* %26, float* %28, i8* %31)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_1802.cpp() #0 section ".text.startup" {
