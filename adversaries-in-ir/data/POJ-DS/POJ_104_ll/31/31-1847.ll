; ModuleID = 'POJ-104-source/31/31-1847.cpp'
source_filename = "POJ-104-source/31/31-1847.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_1847.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local %struct.student* @_Z8ANewNodev() #0 {
...
4:                                                ; preds = %53, %0
  %5 = call noalias i8* @malloc(i64 112) #3
...
21:                                               ; preds = %20
  ...
  %34 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.2, i64 0, i64 0), i8* %24, i8* %26, i32* %28, float* %30, i8* %33)
...
53:                                               ; preds = %49
  ...
  %57 = call i32 @strcmp(i8* %56, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0)) #6
  %58 = icmp ne i32 %57, 0
...
define dso_local i32 @main() #5 {
  ...
  %4 = call %struct.student* @_Z8ANewNodev()
...
34:                                               ; preds = %31
  %35 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.5, i64 0, i64 0), i32* @n)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_1847.cpp() #0 section ".text.startup" {
