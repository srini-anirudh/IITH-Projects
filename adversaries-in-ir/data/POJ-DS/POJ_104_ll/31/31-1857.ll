; ModuleID = 'POJ-104-source/31/31-1857.cpp'
source_filename = "POJ-104-source/31/31-1857.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_1857.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %21 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i64 0, i64 0), [20 x i8]* %12, [20 x i8]* %14, [5 x i8]* %16, [5 x i8]* %18, [10 x i8]* %20)
...
58:                                               ; preds = %51
  ...
  %66 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), [20 x i8]* %65)
...
74:                                               ; preds = %58
  ...
  %85 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i64 0, i64 0), [20 x i8]* %76, [5 x i8]* %78, [5 x i8]* %80, [10 x i8]* %82, [10 x i8]* %84)
  store i32 0, i32* %7, align 4
  br label %86
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_1857.cpp() #0 section ".text.startup" {
