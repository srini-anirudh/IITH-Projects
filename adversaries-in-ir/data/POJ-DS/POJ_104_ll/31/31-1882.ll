; ModuleID = 'POJ-104-source/31/31-1882.cpp'
source_filename = "POJ-104-source/31/31-1882.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_1882.cpp, i8* null }]
...
30:                                               ; preds = %8
  ...
  %46 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i64 0, i64 0), i8* %33, i8* %36, i8* %39, i8* %42, i8* %45)
  br label %8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_1882.cpp() #0 section ".text.startup" {
