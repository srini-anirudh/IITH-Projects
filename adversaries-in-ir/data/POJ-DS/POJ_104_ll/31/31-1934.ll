; ModuleID = 'POJ-104-source/31/31-1934.cpp'
source_filename = "POJ-104-source/31/31-1934.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_1934.cpp, i8* null }]
...
27:                                               ; preds = %10
  ...
  %40 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i64 0, i64 0), i8* %30, i8* %32, i32* %34, [8 x i8]* %36, i8* %39)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_1934.cpp() #0 section ".text.startup" {
