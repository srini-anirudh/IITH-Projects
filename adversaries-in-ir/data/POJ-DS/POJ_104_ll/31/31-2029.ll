; ModuleID = 'POJ-104-source/31/31-2029.cpp'
source_filename = "POJ-104-source/31/31-2029.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_2029.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local %struct.student* @_Z6appendv() #0 {
...
5:                                                ; preds = %36, %0
  ...
  %10 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), [20 x i8]* %9)
...
19:                                               ; preds = %5
  ...
  %30 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i64 0, i64 0), [20 x i8]* %21, i8* %23, i32* %25, float* %27, [30 x i8]* %29)
...
define dso_local i32 @main() #4 {
  ...
  %3 = call %struct.student* @_Z6appendv()
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_2029.cpp() #0 section ".text.startup" {
