; ModuleID = 'POJ-104-source/31/31-2037.cpp'
source_filename = "POJ-104-source/31/31-2037.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_2037.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %6 = call noalias i8* @malloc(i64 424) #3
...
13:                                               ; preds = %45, %0
  %14 = call noalias i8* @malloc(i64 424) #3
  ...
  %33 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i64 0, i64 0), i8* %23, i8* %25, i32* %27, [100 x i8]* %29, i8* %32)
  ...
  %44 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i8* %43)
  br label %45
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_2037.cpp() #0 section ".text.startup" {
