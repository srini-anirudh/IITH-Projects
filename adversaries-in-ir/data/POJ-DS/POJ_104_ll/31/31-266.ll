; ModuleID = 'POJ-104-source/31/31-266.cpp'
source_filename = "POJ-104-source/31/31-266.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_266.cpp, i8* null }]
...
define dso_local %struct.student* @_Z5creatv() #0 {
  ...
  %9 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), [10 x i8]* %8)
  br label %10
...
10:                                               ; preds = %44, %0
  ...
  %21 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i64 0, i64 0), [30 x i8]* %12, i8* %14, [3 x i8]* %16, [6 x i8]* %18, [15 x i8]* %20)
...
38:                                               ; preds = %30, %26
  ...
  %43 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), [10 x i8]* %42)
  br label %44
...
define dso_local i32 @main() #4 {
  ...
  %3 = call %struct.student* @_Z5creatv()
...
4:                                                ; preds = %28, %0
  ...
  %24 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.3, i64 0, i64 0), i8* %7, i8* %10, i32 %14, i8* %17, i8* %20, i8* %23)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_266.cpp() #0 section ".text.startup" {
