; ModuleID = 'POJ-104-source/31/31-369.cpp'
source_filename = "POJ-104-source/31/31-369.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_369.cpp, i8* null }]
...
79:                                               ; preds = %76
  ...
  %87 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i8* %86)
...
109:                                              ; preds = %98, %76
  ...
  %114 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i8* %113)
  ...
  %120 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %119)
...
125:                                              ; preds = %122
  ...
  %133 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i8* %132)
...
159:                                              ; preds = %156
  ...
  %167 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i8* %166)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_369.cpp() #0 section ".text.startup" {
