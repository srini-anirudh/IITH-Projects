; ModuleID = 'POJ-104-source/31/31-45.cpp'
source_filename = "POJ-104-source/31/31-45.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_45.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %6 = call noalias i8* @malloc(i64 104) #3
  ...
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i64 0, i64 0), i8* %10, i8* %13, i8* %16, i32* %18, i8* %21, i8* %24)
...
28:                                               ; preds = %60, %0
  %29 = call noalias i8* @malloc(i64 104) #3
...
41:                                               ; preds = %28
  ...
  %55 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.3, i64 0, i64 0), i8* %44, i8* %47, i32* %49, [30 x i8]* %51, i8* %54)
...
60:                                               ; preds = %41
  ...
  %64 = call i32 @strcmp(i8* %63, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0)) #6
  %65 = icmp ne i32 %64, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_45.cpp() #0 section ".text.startup" {
