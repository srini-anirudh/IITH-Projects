; ModuleID = 'POJ-104-source/31/31-501.cpp'
source_filename = "POJ-104-source/31/31-501.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_501.cpp, i8* null }]
...
18:                                               ; preds = %46, %17
  ...
  %32 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i64 0, i64 0), i8* %21, i8* %24, i32* %26, float* %28, i8* %31)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_501.cpp() #0 section ".text.startup" {
