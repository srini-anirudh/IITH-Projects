; ModuleID = 'POJ-104-source/31/31-556.cpp'
source_filename = "POJ-104-source/31/31-556.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_556.cpp, i8* null }]
...
5:                                                ; preds = %65, %0
  ...
  %17 = call i32 @strcmp(i8* %16, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0)) #6
  %18 = icmp eq i32 %17, 0
...
20:                                               ; preds = %5
  ...
  %44 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.2, i64 0, i64 0), i8* %25, i8* %29, i32* %33, i8* %38, i8* %43)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_556.cpp() #0 section ".text.startup" {
