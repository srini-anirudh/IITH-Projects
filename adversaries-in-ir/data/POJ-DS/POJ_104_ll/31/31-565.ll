; ModuleID = 'POJ-104-source/31/31-565.cpp'
source_filename = "POJ-104-source/31/31-565.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_565.cpp, i8* null }]
...
26:                                               ; preds = %10
  ...
  %50 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i64 0, i64 0), i8* %31, i8* %35, i32* %39, i8* %44, i8* %49)
  br label %51
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_565.cpp() #0 section ".text.startup" {
