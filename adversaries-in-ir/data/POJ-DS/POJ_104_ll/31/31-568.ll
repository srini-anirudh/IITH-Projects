; ModuleID = 'POJ-104-source/31/31-568.cpp'
source_filename = "POJ-104-source/31/31-568.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_568.cpp, i8* null }]
...
19:                                               ; preds = %10
  ...
  %43 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i64 0, i64 0), i8* %24, i8* %28, i32* %32, i8* %37, i8* %42)
  ...
  %53 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i8* %52)
  br label %10
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_568.cpp() #0 section ".text.startup" {
