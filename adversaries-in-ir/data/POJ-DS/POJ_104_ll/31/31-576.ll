; ModuleID = 'POJ-104-source/31/31-576.cpp'
source_filename = "POJ-104-source/31/31-576.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_576.cpp, i8* null }]
...
7:                                                ; preds = %48, %0
  ...
  %36 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i64 0, i64 0), i8* %12, i8* %17, i8* %21, i32* %25, float* %30, i8* %35)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_576.cpp() #0 section ".text.startup" {
