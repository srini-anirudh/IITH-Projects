; ModuleID = 'POJ-104-source/31/31-577.cpp'
source_filename = "POJ-104-source/31/31-577.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_577.cpp, i8* null }]
...
7:                                                ; preds = %47, %2
  ...
  %19 = call i32 @strcmp(i8* %18, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0)) #6
  %20 = icmp eq i32 %19, 0
...
22:                                               ; preds = %7
  ...
  %46 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.2, i64 0, i64 0), i8* %27, i8* %31, i32* %35, i8* %40, i8* %45)
  br label %47
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_577.cpp() #0 section ".text.startup" {
