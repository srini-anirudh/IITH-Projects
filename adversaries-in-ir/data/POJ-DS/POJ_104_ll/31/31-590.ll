; ModuleID = 'POJ-104-source/31/31-590.cpp'
source_filename = "POJ-104-source/31/31-590.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_590.cpp, i8* null }]
...
18:                                               ; preds = %4
  ...
  %31 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.2, i64 0, i64 0), i8* %21, i8* %23, i32* %25, float* %27, i8* %30)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_590.cpp() #0 section ".text.startup" {
