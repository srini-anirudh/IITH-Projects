; ModuleID = 'POJ-104-source/31/31-599.cpp'
source_filename = "POJ-104-source/31/31-599.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_599.cpp, i8* null }]
...
17:                                               ; preds = %4
  ...
  %30 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i64 0, i64 0), i8* %20, i8* %22, i32* %24, float* %26, i8* %29)
...
4:                                                ; preds = %29, %0
  ...
  %25 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.2, i64 0, i64 0), i8* %7, i8* %10, i32 %14, i32 %17, double %21, i8* %24)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_599.cpp() #0 section ".text.startup" {
