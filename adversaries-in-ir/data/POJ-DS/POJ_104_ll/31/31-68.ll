; ModuleID = 'POJ-104-source/31/31-68.cpp'
source_filename = "POJ-104-source/31/31-68.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_68.cpp, i8* null }]
...
7:                                                ; preds = %40, %0
  ...
  %11 = call i32 @strcmp(i8* %10, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0)) #6
  %12 = icmp ne i32 %11, 0
...
22:                                               ; preds = %13
  ...
  %24 = call noalias i8* @malloc(i64 88) #3
...
29:                                               ; preds = %22, %18
  ...
  %32 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), [10 x i8]* %31)
  ...
  %36 = call i32 @strcmp(i8* %35, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0)) #6
  %37 = icmp eq i32 %36, 0
...
40:                                               ; preds = %29
  ...
  %51 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.2, i64 0, i64 0), [20 x i8]* %42, i8* %44, i32* %46, [20 x i8]* %48, [20 x i8]* %50)
  br label %7
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5printP3stu(%struct.stu* %0) #0 {
  %2 = alloca %struct.stu*, align 8
  %3 = alloca %struct.stu*, align 8
...
define dso_local i32 @main() #5 {
  %1 = alloca %struct.stu*, align 8
  %2 = call %struct.stu* @_Z5creatv()
  store %struct.stu* %2, %struct.stu** %1, align 8
  %3 = load %struct.stu*, %struct.stu** %1, align 8
  call void @_Z5printP3stu(%struct.stu* %3)
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_68.cpp() #0 section ".text.startup" {
