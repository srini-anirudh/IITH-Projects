; ModuleID = 'POJ-104-source/31/31-736.cpp'
source_filename = "POJ-104-source/31/31-736.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_736.cpp, i8* null }]
...
21:                                               ; preds = %15
  ...
  %33 = getelementptr inbounds [150 x i8], [150 x i8]* %32, i64 0, i64 0
...
53:                                               ; preds = %48
  ...
  %77 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.3, i64 0, i64 0), i8* %59, i8* %62, i32 %66, i32 %69, double %73, i8* %76)
  br label %48
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_736.cpp() #0 section ".text.startup" {
