; ModuleID = 'POJ-104-source/31/31-757.cpp'
source_filename = "POJ-104-source/31/31-757.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_757.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local %struct.s* @_Z1Av() #0 {
  ...
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), i8* %8, i8* %11, i8* %13, i32* %15, i8* %18, i8* %21)
...
26:                                               ; preds = %54, %0
  ...
  %32 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i8* %31)
  ...
  %36 = call i32 @strcmp(i8* %35, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i64 0, i64 0)) #6
  %37 = icmp ne i32 %36, 0
...
38:                                               ; preds = %26
  ...
  %52 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.4, i64 0, i64 0), i8* %41, i8* %43, i32* %45, i8* %48, i8* %51)
  br label %54
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_757.cpp() #0 section ".text.startup" {
