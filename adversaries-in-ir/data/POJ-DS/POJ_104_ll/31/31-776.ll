; ModuleID = 'POJ-104-source/31/31-776.cpp'
source_filename = "POJ-104-source/31/31-776.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_776.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local %struct.student* @_Z5buildv() #0 {
...
18:                                               ; preds = %11
  ...
  %29 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i64 0, i64 0), [20 x i8]* %20, i8* %22, i32* %24, float* %26, [12 x i8]* %28)
  ...
  %39 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i8* %38)
  br label %11
...
define dso_local i32 @main() #4 {
  ...
  %3 = call %struct.student* @_Z5buildv()
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_776.cpp() #0 section ".text.startup" {
