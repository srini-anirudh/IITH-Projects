; ModuleID = 'POJ-104-source/31/31-823.cpp'
source_filename = "POJ-104-source/31/31-823.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_823.cpp, i8* null }]
...
34:                                               ; preds = %11
  ...
  %56 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i64 0, i64 0), i8* %44, i8* %46, i8* %49, i8* %52, i8* %55)
  br label %11
...
57:                                               ; preds = %24
  ...
  %77 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.2, i64 0, i64 0), i8* %60, i8* %63, i32 %67, i8* %70, i8* %73, i8* %76)
...
82:                                               ; preds = %127, %57
  ...
  %114 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.2, i64 0, i64 0), i8* %87, i8* %92, i32 %98, i8* %103, i8* %108, i8* %113)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_823.cpp() #0 section ".text.startup" {
