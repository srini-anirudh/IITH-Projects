; ModuleID = 'POJ-104-source/31/31-830.cpp'
source_filename = "POJ-104-source/31/31-830.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_830.cpp, i8* null }]
...
36:                                               ; preds = %12
  ...
  %56 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i64 0, i64 0), i8* %46, i8* %48, i32* %50, [20 x i8]* %52, i8* %55)
  br label %12
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_830.cpp() #0 section ".text.startup" {
