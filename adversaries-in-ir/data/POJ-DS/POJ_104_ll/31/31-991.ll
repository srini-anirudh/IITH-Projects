; ModuleID = 'POJ-104-source/31/31-991.cpp'
source_filename = "POJ-104-source/31/31-991.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_31_991.cpp, i8* null }]
...
30:                                               ; preds = %21
  ...
  %41 = call dereferenceable(280) %"class.std::basic_istream"* @_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_RS3_(%"class.std::basic_istream"* dereferenceable(280) %36, i8* dereferenceable(1) %40)
  ...
  %57 = call dereferenceable(280) %"class.std::basic_istream"* @_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_(%"class.std::basic_istream"* dereferenceable(280) %51, i8* %56)
  br label %58
...
68:                                               ; preds = %65
  ...
  %92 = getelementptr inbounds [1000 x %struct.student], [1000 x %struct.student]* %2, i64 0, i64 %91
  ...
  %99 = getelementptr inbounds [1000 x %struct.student], [1000 x %struct.student]* %2, i64 0, i64 %98
  ...
  %106 = getelementptr inbounds [1000 x %struct.student], [1000 x %struct.student]* %2, i64 0, i64 %105
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_31_991.cpp() #0 section ".text.startup" {
