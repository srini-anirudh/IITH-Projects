; ModuleID = 'POJ-104-source/32/32-1035.cpp'
source_filename = "POJ-104-source/32/32-1035.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_1035.cpp, i8* null }]
...
143:                                              ; preds = %140
  ...
  %146 = getelementptr inbounds i32, i32* %72, i64 %145
  %147 = load i32, i32* %146, align 4
  %148 = load i32, i32* %6, align 4
  %149 = load i32, i32* %5, align 4
  %150 = sub nsw i32 %148, %149
  %151 = sext i32 %150 to i64
  %152 = getelementptr inbounds i32, i32* %72, i64 %151
...
163:                                              ; preds = %157
  ...
  %166 = getelementptr inbounds i32, i32* %72, i64 %165
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_1035.cpp() #0 section ".text.startup" {
