; ModuleID = 'POJ-104-source/32/32-11.cpp'
source_filename = "POJ-104-source/32/32-11.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_11.cpp, i8* null }]
...
define dso_local i32 @main() #5 {
  ...
  %17 = bitcast [100 x [100 x i8]]* %5 to i8*
  ...
  %19 = bitcast [10 x [100 x i8]]* %9 to i8*
  ...
  %24 = getelementptr inbounds [10 x [100 x i8]], [10 x [100 x i8]]* %8, i64 0, i64 0
  %25 = getelementptr inbounds [100 x i8], [100 x i8]* %24, i64 0, i64 0
  %26 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i8* %25)
  %27 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %6)
...
32:                                               ; preds = %28
  ...
  %35 = getelementptr inbounds [10 x [100 x i8]], [10 x [100 x i8]]* %8, i64 0, i64 %34
  ...
  %40 = getelementptr inbounds [10 x [100 x i8]], [10 x [100 x i8]]* %9, i64 0, i64 %39
  %41 = getelementptr inbounds [100 x i8], [100 x i8]* %40, i64 0, i64 0
  %42 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i8* %41)
  br label %43
...
51:                                               ; preds = %47
  ...
  %58 = getelementptr inbounds [10 x [100 x i8]], [10 x [100 x i8]]* %9, i64 0, i64 %57
  %59 = getelementptr inbounds [100 x i8], [100 x i8]* %58, i64 0, i64 0
  call void @_Z1fPcS_(i8* %55, i8* %59)
  br label %60
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_11.cpp() #0 section ".text.startup" {
