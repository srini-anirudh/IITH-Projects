; ModuleID = 'POJ-104-source/32/32-1100.cpp'
source_filename = "POJ-104-source/32/32-1100.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_1100.cpp, i8* null }]
...
18:                                               ; preds = %14
  ...
  %27 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %25, i8* %26)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_1100.cpp() #0 section ".text.startup" {
