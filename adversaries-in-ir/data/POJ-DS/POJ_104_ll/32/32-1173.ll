; ModuleID = 'POJ-104-source/32/32-1173.cpp'
source_filename = "POJ-104-source/32/32-1173.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_1173.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z4leapPii(i32* %0, i32 %1) #0 {
...
14:                                               ; preds = %9
  ...
  %18 = sub nsw i32 %17, 1
  %19 = call i32 @_Z4leapPii(i32* %16, i32 %18)
  %20 = add nsw i32 %19, 1
...
19:                                               ; preds = %15
  ...
  %23 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %21, i8* %22)
...
154:                                              ; preds = %118
  ...
  %157 = call i32 @_Z4leapPii(i32* %155, i32 %156)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_1173.cpp() #0 section ".text.startup" {
