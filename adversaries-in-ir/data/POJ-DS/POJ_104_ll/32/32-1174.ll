; ModuleID = 'POJ-104-source/32/32-1174.cpp'
source_filename = "POJ-104-source/32/32-1174.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_1174.cpp, i8* null }]
...
17:                                               ; preds = %13
  ...
  %21 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %19, i8* %20)
...
102:                                              ; preds = %66
  ...
  %105 = call i32 @_Z4leapPii(i32* %103, i32 %104)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_1174.cpp() #0 section ".text.startup" {
