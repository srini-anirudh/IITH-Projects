; ModuleID = 'POJ-104-source/32/32-139.cpp'
source_filename = "POJ-104-source/32/32-139.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_139.cpp, i8* null }]
...
30:                                               ; preds = %17
  ...
  %32 = getelementptr inbounds [200 x i8], [200 x i8]* %5, i64 0, i64 99
...
176:                                              ; preds = %153, %141
  ...
  %184 = getelementptr inbounds [200 x i8], [200 x i8]* %4, i64 0, i64 %183
...
205:                                              ; preds = %201
  ...
  %208 = getelementptr inbounds [200 x i8], [200 x i8]* %5, i64 0, i64 %207
...
225:                                              ; preds = %232, %224
  ...
  %228 = getelementptr inbounds [200 x i8], [200 x i8]* %5, i64 0, i64 %227
...
232:                                              ; preds = %225
  ...
  %236 = getelementptr inbounds [200 x i8], [200 x i8]* %5, i64 0, i64 %235
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_139.cpp() #0 section ".text.startup" {
