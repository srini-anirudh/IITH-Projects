; ModuleID = 'POJ-104-source/32/32-1410.cpp'
source_filename = "POJ-104-source/32/32-1410.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_1410.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z1cPciS_i(i8* %0, i32 %1, i8* %2, i32 %3) #0 {
  %5 = alloca i8*, align 8
...
define dso_local i32 @main() #4 {
  ...
  %8 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i32* %4)
...
13:                                               ; preds = %9
  ...
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.3, i64 0, i64 0), i8* %14, i8* %15)
...
26:                                               ; preds = %13
  ...
  call void @_Z1cPciS_i(i8* %27, i32 %28, i8* %29, i32 %30)
  br label %41
...
35:                                               ; preds = %31
  ...
  call void @_Z1cPciS_i(i8* %36, i32 %37, i8* %38, i32 %39)
  br label %40
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_1410.cpp() #0 section ".text.startup" {
