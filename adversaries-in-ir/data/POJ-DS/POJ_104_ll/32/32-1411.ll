; ModuleID = 'POJ-104-source/32/32-1411.cpp'
source_filename = "POJ-104-source/32/32-1411.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_1411.cpp, i8* null }]
...
191:                                              ; preds = %110
  ...
  %194 = call i32 @_Z3maxii(i32 %192, i32 %193)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_1411.cpp() #0 section ".text.startup" {
