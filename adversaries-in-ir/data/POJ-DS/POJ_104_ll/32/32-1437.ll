; ModuleID = 'POJ-104-source/32/32-1437.cpp'
source_filename = "POJ-104-source/32/32-1437.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_1437.cpp, i8* null }]
...
34:                                               ; preds = %30
  ...
  %49 = getelementptr inbounds [100 x [100 x i8]], [100 x [100 x i8]]* %9, i64 0, i64 %48
...
56:                                               ; preds = %53
  ...
  %71 = getelementptr inbounds [100 x i8], [100 x i8]* %66, i64 0, i64 %70
...
220:                                              ; preds = %107
  ...
  %229 = getelementptr inbounds [100 x i8], [100 x i8]* %223, i64 0, i64 %228
...
238:                                              ; preds = %234
  ...
  %243 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i8* %242)
  br label %244
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_1437.cpp() #0 section ".text.startup" {
