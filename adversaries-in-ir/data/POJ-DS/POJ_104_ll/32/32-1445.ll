; ModuleID = 'POJ-104-source/32/32-1445.cpp'
source_filename = "POJ-104-source/32/32-1445.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_1445.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z4moinPA100_cS0_i([100 x i8]* %0, [100 x i8]* %1, i32 %2) #0 {
...
12:                                               ; preds = %7
  ...
  %21 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0), i8* %16, i8* %20)
...
32:                                               ; preds = %27
  ...
  call void @_Z4moinPA100_cS0_i([100 x i8]* %33, [100 x i8]* %34, i32 %35)
  br label %36
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_1445.cpp() #0 section ".text.startup" {
