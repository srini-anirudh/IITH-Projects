; ModuleID = 'POJ-104-source/32/32-1560.cpp'
source_filename = "POJ-104-source/32/32-1560.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_1560.cpp, i8* null }]
...
22:                                               ; preds = %13
  ...
  call void @_Z5minusPcS_(i8* %25, i8* %26)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_1560.cpp() #0 section ".text.startup" {
