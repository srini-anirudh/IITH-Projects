; ModuleID = 'POJ-104-source/32/32-1564.cpp'
source_filename = "POJ-104-source/32/32-1564.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_1564.cpp, i8* null }]
...
11:                                               ; preds = %7
  ...
  call void @_Z5minusPcS_(i8* %15, i8* %16)
...
define dso_local void @_Z5minusPcS_(i8* %0, i8* %1) #5 {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
  %5 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_1564.cpp() #0 section ".text.startup" {
