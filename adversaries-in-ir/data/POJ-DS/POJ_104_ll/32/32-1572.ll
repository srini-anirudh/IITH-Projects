; ModuleID = 'POJ-104-source/32/32-1572.cpp'
source_filename = "POJ-104-source/32/32-1572.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_1572.cpp, i8* null }]
...
140:                                              ; preds = %156, %139
  ...
  %143 = getelementptr inbounds [101 x i8], [101 x i8]* %2, i64 0, i64 0
...
166:                                              ; preds = %179, %164
  ...
  %169 = getelementptr inbounds [101 x i8], [101 x i8]* %2, i64 0, i64 0
...
182:                                              ; preds = %166
  ...
  %184 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i8* %4)
  br label %185
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_1572.cpp() #0 section ".text.startup" {
