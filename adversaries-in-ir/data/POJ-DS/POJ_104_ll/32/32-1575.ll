; ModuleID = 'POJ-104-source/32/32-1575.cpp'
source_filename = "POJ-104-source/32/32-1575.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_1575.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5chuliPcS_(i8* %0, i8* %1) #0 {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
...
define dso_local i32 @main() #5 {
  ...
  %7 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %5)
...
12:                                               ; preds = %8
  ...
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i8* %16)
  ...
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i8* %21)
  br label %23
...
31:                                               ; preds = %27
  ...
  call void @_Z5chuliPcS_(i8* %35, i8* %39)
  br label %40
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_1575.cpp() #0 section ".text.startup" {
