; ModuleID = 'POJ-104-source/32/32-1578.cpp'
source_filename = "POJ-104-source/32/32-1578.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_1578.cpp, i8* null }]
...
41:                                               ; preds = %37
  ...
  %59 = getelementptr inbounds [100 x i8], [100 x i8]* %54, i64 0, i64 %58
...
94:                                               ; preds = %41
  ...
  %113 = getelementptr inbounds [100 x i8], [100 x i8]* %108, i64 0, i64 %112
  ...
  %125 = getelementptr inbounds [100 x i8], [100 x i8]* %120, i64 0, i64 %124
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_1578.cpp() #0 section ".text.startup" {
