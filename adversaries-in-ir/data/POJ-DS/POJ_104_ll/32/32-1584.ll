; ModuleID = 'POJ-104-source/32/32-1584.cpp'
source_filename = "POJ-104-source/32/32-1584.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_1584.cpp, i8* null }]
...
88:                                               ; preds = %60
  ...
  %99 = getelementptr inbounds [100 x i8], [100 x i8]* %91, i64 0, i64 %98
  ...
  %128 = getelementptr inbounds [100 x i8], [100 x i8]* %120, i64 0, i64 %127
...
129:                                              ; preds = %60
  ...
  %141 = getelementptr inbounds [100 x i8], [100 x i8]* %132, i64 0, i64 %140
  ...
  %157 = getelementptr inbounds [100 x i8], [100 x i8]* %148, i64 0, i64 %156
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_1584.cpp() #0 section ".text.startup" {
