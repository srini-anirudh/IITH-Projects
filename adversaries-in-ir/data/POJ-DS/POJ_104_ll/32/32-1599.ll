; ModuleID = 'POJ-104-source/32/32-1599.cpp'
source_filename = "POJ-104-source/32/32-1599.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_1599.cpp, i8* null }]
...
238:                                              ; preds = %251, %237
  ...
  %241 = getelementptr inbounds [100 x i8], [100 x i8]* %9, i64 0, i64 0
...
244:                                              ; preds = %238
  ...
  %247 = getelementptr inbounds [100 x i8], [100 x i8]* %9, i64 0, i64 %246
  %248 = load i8, i8* %247, align 1
  %249 = sext i8 %248 to i32
  %250 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i32 %249)
  br label %251
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_1599.cpp() #0 section ".text.startup" {
