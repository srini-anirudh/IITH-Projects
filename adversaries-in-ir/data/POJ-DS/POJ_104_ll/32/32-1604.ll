; ModuleID = 'POJ-104-source/32/32-1604.cpp'
source_filename = "POJ-104-source/32/32-1604.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_1604.cpp, i8* null }]
...
158:                                              ; preds = %154
  ...
  %161 = getelementptr inbounds [200 x i8], [200 x i8]* %11, i64 0, i64 %160
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_1604.cpp() #0 section ".text.startup" {
