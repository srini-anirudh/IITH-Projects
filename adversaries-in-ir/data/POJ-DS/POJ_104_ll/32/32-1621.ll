; ModuleID = 'POJ-104-source/32/32-1621.cpp'
source_filename = "POJ-104-source/32/32-1621.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_1621.cpp, i8* null }]
...
270:                                              ; preds = %245
  ...
  %275 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i8* %274)
  br label %276
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_1621.cpp() #0 section ".text.startup" {
