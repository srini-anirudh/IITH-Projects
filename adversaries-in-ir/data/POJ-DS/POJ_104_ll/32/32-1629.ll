; ModuleID = 'POJ-104-source/32/32-1629.cpp'
source_filename = "POJ-104-source/32/32-1629.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_1629.cpp, i8* null }]
...
define dso_local void @_Z9stringrevPcS_(i8* %0, i8* %1) #4 {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z6jianfaPcS_S_(i8* %0, i8* %1, i8* %2) #4 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca i8*, align 8
  %7 = alloca i32, align 4
  ...
  call void @_Z9stringrevPcS_(i8* %19, i8* %20)
  %21 = load i8*, i8** %5, align 8
  %22 = getelementptr inbounds [101 x i8], [101 x i8]* %13, i64 0, i64 0
  call void @_Z9stringrevPcS_(i8* %21, i8* %22)
...
121:                                              ; preds = %116, %102
  ...
  call void @_Z9stringrevPcS_(i8* %122, i8* %123)
  ret void
}
...
15:                                               ; preds = %11
  ...
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %16, i8* %17)
  ...
  call void @_Z6jianfaPcS_S_(i8* %19, i8* %20, i8* %21)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_1629.cpp() #0 section ".text.startup" {
