; ModuleID = 'POJ-104-source/32/32-1718.cpp'
source_filename = "POJ-104-source/32/32-1718.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_1718.cpp, i8* null }]
...
define dso_local void @_Z8subtractPcS_S_(i8* %0, i8* %1, i8* %2) #4 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca i8*, align 8
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z5alignPc(i8* %0) #4 {
  %2 = alloca i8*, align 8
...
31:                                               ; preds = %15
  ...
  call void @_Z8subtractPcS_S_(i8* %44, i8* %45, i8* %46)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_1718.cpp() #0 section ".text.startup" {
