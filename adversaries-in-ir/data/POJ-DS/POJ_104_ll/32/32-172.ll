; ModuleID = 'POJ-104-source/32/32-172.cpp'
source_filename = "POJ-104-source/32/32-172.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_172.cpp, i8* null }]
...
92:                                               ; preds = %73
  ...
  %134 = getelementptr inbounds [1000 x i8], [1000 x i8]* %7, i64 0, i64 %133
...
140:                                              ; preds = %24
  %141 = getelementptr inbounds [1000 x i8], [1000 x i8]* %7, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_172.cpp() #0 section ".text.startup" {
