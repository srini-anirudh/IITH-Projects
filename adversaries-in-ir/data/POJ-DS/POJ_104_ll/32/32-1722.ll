; ModuleID = 'POJ-104-source/32/32-1722.cpp'
source_filename = "POJ-104-source/32/32-1722.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_1722.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %16)
...
23:                                               ; preds = %19
  ...
  %32 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i8* %27, i8* %31)
...
66:                                               ; preds = %50
  ...
  %81 = call i8* @strcat(i8* %76, i8* %80) #3
...
113:                                              ; preds = %97
  ...
  %128 = call i8* @strcat(i8* %123, i8* %127) #3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_1722.cpp() #0 section ".text.startup" {
