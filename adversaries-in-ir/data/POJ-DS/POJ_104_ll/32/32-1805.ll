; ModuleID = 'POJ-104-source/32/32-1805.cpp'
source_filename = "POJ-104-source/32/32-1805.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_1805.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %17 = bitcast [100 x [100 x i8]]* %12 to i8*
...
82:                                               ; preds = %64
  ...
  %93 = getelementptr inbounds [100 x [100 x i8]], [100 x [100 x i8]]* %12, i64 0, i64 %92
...
269:                                              ; preds = %262
  ...
  %272 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %10, i64 0, i64 %271
...
281:                                              ; preds = %262
  %282 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0))
  br label %283
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_1805.cpp() #0 section ".text.startup" {
