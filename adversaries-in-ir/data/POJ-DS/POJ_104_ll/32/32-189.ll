; ModuleID = 'POJ-104-source/32/32-189.cpp'
source_filename = "POJ-104-source/32/32-189.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_189.cpp, i8* null }]
...
16:                                               ; preds = %12
  ...
  %24 = getelementptr inbounds [1000 x i8], [1000 x i8]* %9, i64 0, i64 0
...
147:                                              ; preds = %143
  ...
  %150 = getelementptr inbounds [1000 x i8], [1000 x i8]* %10, i64 0, i64 %149
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_189.cpp() #0 section ".text.startup" {
