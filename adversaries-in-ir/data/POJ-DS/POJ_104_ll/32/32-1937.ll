; ModuleID = 'POJ-104-source/32/32-1937.cpp'
source_filename = "POJ-104-source/32/32-1937.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_1937.cpp, i8* null }]
...
define dso_local void @_Z5putccPcS_(i8* %0, i8* %1) #4 {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
...
25:                                               ; preds = %23, %14
  ...
  call void @_Z5putccPcS_(i8* %29, i8* %30)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_1937.cpp() #0 section ".text.startup" {
