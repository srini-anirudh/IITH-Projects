; ModuleID = 'POJ-104-source/32/32-1978.cpp'
source_filename = "POJ-104-source/32/32-1978.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_1978.cpp, i8* null }]
...
14:                                               ; preds = %11
  ...
  %15 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), [100 x i8]* %3, [100 x i8]* %4)
  br label %16
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_1978.cpp() #0 section ".text.startup" {
