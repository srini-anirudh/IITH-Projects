; ModuleID = 'POJ-104-source/32/32-2052.cpp'
source_filename = "POJ-104-source/32/32-2052.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_2052.cpp, i8* null }]
...
21:                                               ; preds = %17
  ...
  %24 = getelementptr inbounds [100 x [100 x i8]], [100 x [100 x i8]]* %12, i64 0, i64 %23
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), [100 x i8]* %24)
  %26 = load i32, i32* %4, align 4
  %27 = sext i32 %26 to i64
  %28 = getelementptr inbounds [100 x [100 x i8]], [100 x [100 x i8]]* %13, i64 0, i64 %27
  %29 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), [100 x i8]* %28)
  br label %30
...
102:                                              ; preds = %94
  ...
  %105 = getelementptr inbounds [100 x [100 x i8]], [100 x [100 x i8]]* %13, i64 0, i64 %104
  ...
  %115 = getelementptr inbounds [100 x i8], [100 x i8]* %105, i64 0, i64 %114
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_2052.cpp() #0 section ".text.startup" {
