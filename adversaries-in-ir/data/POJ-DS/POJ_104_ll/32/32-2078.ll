; ModuleID = 'POJ-104-source/32/32-2078.cpp'
source_filename = "POJ-104-source/32/32-2078.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_2078.cpp, i8* null }]
...
128:                                              ; preds = %33
  %129 = getelementptr inbounds [100 x i8], [100 x i8]* %9, i64 0, i64 0
  %130 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i8* %129)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_2078.cpp() #0 section ".text.startup" {
