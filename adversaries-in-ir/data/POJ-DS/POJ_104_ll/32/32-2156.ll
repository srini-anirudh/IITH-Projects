; ModuleID = 'POJ-104-source/32/32-2156.cpp'
source_filename = "POJ-104-source/32/32-2156.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_2156.cpp, i8* null }]
...
172:                                              ; preds = %161
  ...
  %177 = getelementptr inbounds [100 x i8], [100 x i8]* %4, i64 0, i64 0
...
199:                                              ; preds = %182
  ...
  %203 = getelementptr inbounds [100 x i8], [100 x i8]* %5, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_2156.cpp() #0 section ".text.startup" {
