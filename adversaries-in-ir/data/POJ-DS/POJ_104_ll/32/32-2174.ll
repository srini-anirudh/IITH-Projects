; ModuleID = 'POJ-104-source/32/32-2174.cpp'
source_filename = "POJ-104-source/32/32-2174.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_2174.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %11 = bitcast [100 x [100 x i8]]* %8 to i8*
...
17:                                               ; preds = %13
  ...
  %26 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %21, i8* %25)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_2174.cpp() #0 section ".text.startup" {
