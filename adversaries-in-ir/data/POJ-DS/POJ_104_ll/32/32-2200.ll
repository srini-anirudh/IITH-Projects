; ModuleID = 'POJ-104-source/32/32-2200.cpp'
source_filename = "POJ-104-source/32/32-2200.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_2200.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), [100 x i8]* %18, [100 x i8]* %21)
  br label %23
...
66:                                               ; preds = %62
  ...
  %86 = getelementptr inbounds [100 x i8], [100 x i8]* %81, i64 0, i64 %85
...
125:                                              ; preds = %66
  ...
  %158 = getelementptr inbounds [100 x i8], [100 x i8]* %153, i64 0, i64 %157
...
163:                                              ; preds = %62
  ...
  %172 = getelementptr inbounds [100 x i8], [100 x i8]* %167, i64 0, i64 %171
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_2200.cpp() #0 section ".text.startup" {
