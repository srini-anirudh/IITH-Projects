; ModuleID = 'POJ-104-source/32/32-2214.cpp'
source_filename = "POJ-104-source/32/32-2214.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_2214.cpp, i8* null }]
...
21:                                               ; preds = %17
  ...
  %24 = getelementptr inbounds [100 x i8], [100 x i8]* %15, i64 0, i64 0
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* %24)
  %26 = getelementptr inbounds [100 x i8], [100 x i8]* %14, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_2214.cpp() #0 section ".text.startup" {
