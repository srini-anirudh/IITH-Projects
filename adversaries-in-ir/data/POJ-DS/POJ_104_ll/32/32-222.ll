; ModuleID = 'POJ-104-source/32/32-222.cpp'
source_filename = "POJ-104-source/32/32-222.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_222.cpp, i8* null }]
...
16:                                               ; preds = %11
  ...
  %26 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i8* %25)
  br label %27
...
30:                                               ; preds = %11
  ...
  %41 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0), i8* %35, i8* %40)
  store i32 0, i32* %3, align 4
  br label %42
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_222.cpp() #0 section ".text.startup" {
