; ModuleID = 'POJ-104-source/32/32-2222.cpp'
source_filename = "POJ-104-source/32/32-2222.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_2222.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %23 = getelementptr inbounds [105 x i8], [105 x i8]* %3, i64 0, i64 0
...
113:                                              ; preds = %30
  ...
  %114 = getelementptr inbounds [105 x i8], [105 x i8]* %2, i64 0, i64 0
...
123:                                              ; preds = %119
  ...
  %126 = getelementptr inbounds [105 x i8], [105 x i8]* %2, i64 0, i64 %125
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_2222.cpp() #0 section ".text.startup" {
