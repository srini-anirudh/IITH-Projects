; ModuleID = 'POJ-104-source/32/32-230.cpp'
source_filename = "POJ-104-source/32/32-230.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_230.cpp, i8* null }]
...
14:                                               ; preds = %10
  ...
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i8* %23)
  br label %25
...
60:                                               ; preds = %56
  ...
  %69 = getelementptr inbounds [100 x i8], [100 x i8]* %63, i64 0, i64 %68
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_230.cpp() #0 section ".text.startup" {
