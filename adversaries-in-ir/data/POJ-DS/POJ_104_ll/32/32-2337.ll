; ModuleID = 'POJ-104-source/32/32-2337.cpp'
source_filename = "POJ-104-source/32/32-2337.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_2337.cpp, i8* null }]
...
12:                                               ; preds = %6
  ...
  %15 = getelementptr inbounds [100 x [101 x i8]], [100 x [101 x i8]]* %2, i64 0, i64 %14
...
35:                                               ; preds = %29
  ...
  call void @_Z4funcPcS_(i8* %39, i8* %44)
  br label %45
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_2337.cpp() #0 section ".text.startup" {
