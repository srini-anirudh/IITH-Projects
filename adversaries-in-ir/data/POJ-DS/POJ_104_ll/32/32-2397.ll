; ModuleID = 'POJ-104-source/32/32-2397.cpp'
source_filename = "POJ-104-source/32/32-2397.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_2397.cpp, i8* null }]
...
define dso_local void @_Z3swiiPc(i32 %0, i8* %1) #4 {
...
19:                                               ; preds = %15
  ...
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %20, i8* %21)
...
37:                                               ; preds = %33
  ...
  %40 = call i32 @strcmp(i8* %38, i8* %39) #7
...
61:                                               ; preds = %47, %44
  ...
  call void @_Z3swiiPc(i32 %62, i8* %63)
  %64 = load i32, i32* %10, align 4
  %65 = getelementptr inbounds [200 x i8], [200 x i8]* %3, i64 0, i64 0
  call void @_Z3swiiPc(i32 %64, i8* %65)
...
182:                                              ; preds = %171
  ...
  call void @_Z3swiiPc(i32 %184, i8* %185)
  store i32 0, i32* %6, align 4
  br label %186
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_2397.cpp() #0 section ".text.startup" {
