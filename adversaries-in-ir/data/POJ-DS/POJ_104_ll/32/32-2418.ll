; ModuleID = 'POJ-104-source/32/32-2418.cpp'
source_filename = "POJ-104-source/32/32-2418.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_2418.cpp, i8* null }]
...
18:                                               ; preds = %14
  ...
  %37 = call i32 @_Z6maxlenii(i32 %35, i32 %36)
...
define dso_local i32 @_Z6maxlenii(i32 %0, i32 %1) #7 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_2418.cpp() #0 section ".text.startup" {
