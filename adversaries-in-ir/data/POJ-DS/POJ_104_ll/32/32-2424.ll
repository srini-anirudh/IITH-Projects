; ModuleID = 'POJ-104-source/32/32-2424.cpp'
source_filename = "POJ-104-source/32/32-2424.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_2424.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z3subPcS_(i8* %0, i8* %1) #0 {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
...
define dso_local i32 @main() #5 {
  ...
  %6 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i32* %4)
...
16:                                               ; preds = %14, %11
  ...
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.4, i64 0, i64 0), i8* %17, i8* %18)
  %20 = getelementptr inbounds [100 x i8], [100 x i8]* %2, i64 0, i64 0
  %21 = getelementptr inbounds [100 x i8], [100 x i8]* %3, i64 0, i64 0
  call void @_Z3subPcS_(i8* %20, i8* %21)
  br label %22
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_2424.cpp() #0 section ".text.startup" {
