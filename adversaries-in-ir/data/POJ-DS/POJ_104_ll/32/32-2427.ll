; ModuleID = 'POJ-104-source/32/32-2427.cpp'
source_filename = "POJ-104-source/32/32-2427.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_2427.cpp, i8* null }]
...
180:                                              ; preds = %174
  ...
  %187 = getelementptr inbounds [10000 x i8], [10000 x i8]* %4, i64 0, i64 %186
...
196:                                              ; preds = %192
  ...
  %199 = getelementptr inbounds [10000 x i8], [10000 x i8]* %4, i64 0, i64 %198
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_2427.cpp() #0 section ".text.startup" {
