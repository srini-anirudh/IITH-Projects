; ModuleID = 'POJ-104-source/32/32-2453.cpp'
source_filename = "POJ-104-source/32/32-2453.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_2453.cpp, i8* null }]
...
14:                                               ; preds = %11
  ...
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), [101 x i8]* %8)
...
171:                                              ; preds = %168
  ...
  %174 = getelementptr inbounds [101 x i8], [101 x i8]* %7, i64 0, i64 %173
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_2453.cpp() #0 section ".text.startup" {
