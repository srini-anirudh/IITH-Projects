; ModuleID = 'POJ-104-source/32/32-309.cpp'
source_filename = "POJ-104-source/32/32-309.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_309.cpp, i8* null }]
...
define dso_local void @_Z8exchangePiPc(i32* %0, i8* %1) #6 {
...
; Function Attrs: noinline uwtable
define dso_local void @_Z9calculatePiS_(i32* %0, i32* %1) #0 {
  %3 = alloca i32*, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_309.cpp() #0 section ".text.startup" {
