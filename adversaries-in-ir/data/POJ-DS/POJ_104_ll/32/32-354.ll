; ModuleID = 'POJ-104-source/32/32-354.cpp'
source_filename = "POJ-104-source/32/32-354.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_354.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* %2)
...
31:                                               ; preds = %22
  %32 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0))
  br label %33
...
40:                                               ; preds = %107, %33
  ...
  %44 = call i32 @_Z7compareii(i32 %42, i32 %43)
...
110:                                              ; preds = %40
  ...
  %113 = call i32 @_Z7compareii(i32 %111, i32 %112)
...
171:                                              ; preds = %198, %170
  ...
  %175 = call i32 @_Z7compareii(i32 %173, i32 %174)
...
define dso_local i32 @_Z7compareii(i32 %0, i32 %1) #7 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_354.cpp() #0 section ".text.startup" {
