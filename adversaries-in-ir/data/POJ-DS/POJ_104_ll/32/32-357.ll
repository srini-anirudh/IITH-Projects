; ModuleID = 'POJ-104-source/32/32-357.cpp'
source_filename = "POJ-104-source/32/32-357.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_357.cpp, i8* null }]
...
31:                                               ; preds = %28
  ...
  %50 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i8* %49)
  %51 = load i32, i32* %5, align 4
  %52 = icmp eq i32 %51, 0
  br i1 %52, label %53, label %55

53:                                               ; preds = %31
  %54 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0))
  br label %67
...
64:                                               ; preds = %58, %55
  %65 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0))
  br label %66
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_357.cpp() #0 section ".text.startup" {
