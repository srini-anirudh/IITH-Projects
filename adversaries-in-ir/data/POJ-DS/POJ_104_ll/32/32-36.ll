; ModuleID = 'POJ-104-source/32/32-36.cpp'
source_filename = "POJ-104-source/32/32-36.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_36.cpp, i8* null }]
...
32:                                               ; preds = %28
  ...
  call void @_Z5minusPcS_(i8* %36, i8* %40)
  br label %41
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_36.cpp() #0 section ".text.startup" {
