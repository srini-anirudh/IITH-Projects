; ModuleID = 'POJ-104-source/32/32-369.cpp'
source_filename = "POJ-104-source/32/32-369.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_369.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z2jfPciS_i(i8* %0, i32 %1, i8* %2, i32 %3) #0 {
  %5 = alloca i8*, align 8
...
18:                                               ; preds = %14
  %19 = call noalias i8* @malloc(i64 101) #3
...
37:                                               ; preds = %33
  %38 = call noalias i8* @malloc(i64 101) #3
...
52:                                               ; preds = %47
  ...
  %64 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i8* %63)
...
69:                                               ; preds = %47
  ...
  %76 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i8* %75)
  ...
  %83 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i8* %82)
...
129:                                              ; preds = %125
  ...
  call void @_Z2jfPciS_i(i8* %134, i32 %139, i8* %144, i32 %149)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_369.cpp() #0 section ".text.startup" {
