; ModuleID = 'POJ-104-source/32/32-377.cpp'
source_filename = "POJ-104-source/32/32-377.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_377.cpp, i8* null }]
...
24:                                               ; preds = %20
  %25 = call noalias i8* @malloc(i64 101) #3
...
267:                                              ; preds = %222
  ...
  %273 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i8* %272)
  br label %274
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_377.cpp() #0 section ".text.startup" {
