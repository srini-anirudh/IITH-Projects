; ModuleID = 'POJ-104-source/32/32-388.cpp'
source_filename = "POJ-104-source/32/32-388.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_388.cpp, i8* null }]
...
29:                                               ; preds = %26
  %30 = call noalias i8* @malloc(i64 101) #3
...
55:                                               ; preds = %52
  ...
  %65 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* %64)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_388.cpp() #0 section ".text.startup" {
