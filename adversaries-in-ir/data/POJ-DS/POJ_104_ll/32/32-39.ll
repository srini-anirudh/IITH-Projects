; ModuleID = 'POJ-104-source/32/32-39.cpp'
source_filename = "POJ-104-source/32/32-39.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_39.cpp, i8* null }]
...
108:                                              ; preds = %65
  ...
  %148 = getelementptr inbounds [100 x [100 x i8]], [100 x [100 x i8]]* %9, i64 0, i64 %147
...
195:                                              ; preds = %185
  ...
  %209 = getelementptr inbounds [100 x [100 x i8]], [100 x [100 x i8]]* %7, i64 0, i64 %208
...
250:                                              ; preds = %279, %249
  ...
  %255 = getelementptr inbounds [100 x [100 x i8]], [100 x [100 x i8]]* %7, i64 0, i64 %254
  %256 = getelementptr inbounds [100 x i8], [100 x i8]* %255, i64 0, i64 0
  ...
  %262 = call i64 @strlen(i8* %261) #7
  %263 = sub i64 %257, %262
  %264 = icmp ult i64 %252, %263
...
282:                                              ; preds = %250
  ...
  %289 = getelementptr inbounds [100 x i8], [100 x i8]* %288, i64 0, i64 0
  ...
  %295 = getelementptr inbounds [100 x i8], [100 x i8]* %294, i64 0, i64 0
  %296 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i64 0, i64 0), i8* %295)
  br label %297
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_39.cpp() #0 section ".text.startup" {
