; ModuleID = 'POJ-104-source/32/32-423.cpp'
source_filename = "POJ-104-source/32/32-423.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_423.cpp, i8* null }]
...
110:                                              ; preds = %80
  %111 = getelementptr inbounds [101 x i8], [101 x i8]* %8, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_423.cpp() #0 section ".text.startup" {
