; ModuleID = 'POJ-104-source/32/32-454.cpp'
source_filename = "POJ-104-source/32/32-454.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_454.cpp, i8* null }]
...
17:                                               ; preds = %13
  ...
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), [100 x i8]* %20, [100 x i8]* %23)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_454.cpp() #0 section ".text.startup" {
