; ModuleID = 'POJ-104-source/32/32-57.cpp'
source_filename = "POJ-104-source/32/32-57.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_57.cpp, i8* null }]
...
24:                                               ; preds = %20
  ...
  call void @_Z4gui0Pci(i8* %25, i32 101)
  %26 = getelementptr inbounds [101 x i8], [101 x i8]* %4, i64 0, i64 0
  call void @_Z4gui0Pci(i8* %26, i32 101)
...
111:                                              ; preds = %106, %41
  %112 = call noalias i8* @malloc(i64 101) #3
...
define dso_local void @_Z4gui0Pci(i8* %0, i32 %1) #5 {
  %3 = alloca i8*, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_57.cpp() #0 section ".text.startup" {
