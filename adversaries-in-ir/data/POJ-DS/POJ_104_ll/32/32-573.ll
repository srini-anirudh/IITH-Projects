; ModuleID = 'POJ-104-source/32/32-573.cpp'
source_filename = "POJ-104-source/32/32-573.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_573.cpp, i8* null }]
...
122:                                              ; preds = %115
  ...
  %125 = getelementptr inbounds [101 x i8], [101 x i8]* %9, i64 0, i64 %124
...
149:                                              ; preds = %112
  %150 = getelementptr inbounds [101 x i8], [101 x i8]* %9, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_573.cpp() #0 section ".text.startup" {
