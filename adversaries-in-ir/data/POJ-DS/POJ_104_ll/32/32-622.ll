; ModuleID = 'POJ-104-source/32/32-622.cpp'
source_filename = "POJ-104-source/32/32-622.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_622.cpp, i8* null }]
...
134:                                              ; preds = %127
  ...
  %141 = getelementptr inbounds [101 x [101 x i8]], [101 x [101 x i8]]* %12, i64 0, i64 %140
...
154:                                              ; preds = %150
  ...
  %157 = getelementptr inbounds [101 x i8], [101 x i8]* %10, i64 0, i64 %156
...
170:                                              ; preds = %150
  ...
  %173 = getelementptr inbounds [101 x [101 x i8]], [101 x [101 x i8]]* %12, i64 0, i64 %172
...
185:                                              ; preds = %181
  ...
  %188 = getelementptr inbounds [101 x [101 x i8]], [101 x [101 x i8]]* %12, i64 0, i64 %187
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_622.cpp() #0 section ".text.startup" {
