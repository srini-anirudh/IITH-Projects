; ModuleID = 'POJ-104-source/32/32-637.cpp'
source_filename = "POJ-104-source/32/32-637.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_637.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %4 = alloca [10 x %struct.num], align 16
...
11:                                               ; preds = %6
  ...
  %14 = getelementptr inbounds [10 x %struct.num], [10 x %struct.num]* %4, i64 0, i64 %13
  ...
  %20 = getelementptr inbounds [10 x %struct.num], [10 x %struct.num]* %4, i64 0, i64 %19
...
34:                                               ; preds = %29
  ...
  %37 = getelementptr inbounds [10 x %struct.num], [10 x %struct.num]* %4, i64 0, i64 %36
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_637.cpp() #0 section ".text.startup" {
