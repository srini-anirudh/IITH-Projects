; ModuleID = 'POJ-104-source/32/32-705.cpp'
source_filename = "POJ-104-source/32/32-705.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_705.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  call void @llvm.memset.p0i8.i64(i8* align 16 %17, i8 48, i64 102, i1 false)
  %18 = getelementptr inbounds [102 x i8], [102 x i8]* %4, i64 0, i64 0
  call void @llvm.memset.p0i8.i64(i8* align 16 %18, i8 48, i64 102, i1 false)
  ...
  %26 = getelementptr inbounds [102 x i8], [102 x i8]* %4, i64 0, i64 0
...
66:                                               ; preds = %37
  ...
  %75 = getelementptr inbounds [102 x i8], [102 x i8]* %4, i64 0, i64 %74
...
114:                                              ; preds = %110
  ...
  %117 = getelementptr inbounds [102 x i8], [102 x i8]* %3, i64 0, i64 %116
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_705.cpp() #0 section ".text.startup" {
