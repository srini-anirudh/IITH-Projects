; ModuleID = 'POJ-104-source/32/32-827.cpp'
source_filename = "POJ-104-source/32/32-827.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_827.cpp, i8* null }]
...
176:                                              ; preds = %164
  %177 = getelementptr inbounds [100 x i32], [100 x i32]* %11, i64 0, i64 99
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_827.cpp() #0 section ".text.startup" {
