; ModuleID = 'POJ-104-source/32/32-946.cpp'
source_filename = "POJ-104-source/32/32-946.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_32_946.cpp, i8* null }]
...
37:                                               ; preds = %18
  ...
  %40 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %38, i8* %39)
...
101:                                              ; preds = %97, %52, %93, %89, %85, %81, %77, %73, %69, %65, %61
  br label %102
...
160:                                              ; preds = %156, %111, %152, %148, %144, %140, %136, %132, %128, %124, %120
  br label %161
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_32_946.cpp() #0 section ".text.startup" {
