; ModuleID = 'POJ-104-source/33/33-1533.cpp'
source_filename = "POJ-104-source/33/33-1533.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_33_1533.cpp, i8* null }]
...
define dso_local signext i8 @_Z6peiduic(i8 signext %0) #4 {
  %2 = alloca i8, align 1
  %3 = alloca i8, align 1
...
22:                                               ; preds = %18
  ...
  %27 = call signext i8 @_Z6peiduic(i8 signext %26)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_33_1533.cpp() #0 section ".text.startup" {
