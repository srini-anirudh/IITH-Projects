; ModuleID = 'POJ-104-source/33/33-158.cpp'
source_filename = "POJ-104-source/33/33-158.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_33_158.cpp, i8* null }]
...
define dso_local signext i8 @_Z2hbc(i8 signext %0) #4 {
  %2 = alloca i8, align 1
...
23:                                               ; preds = %19
  ...
  %28 = call signext i8 @_Z2hbc(i8 signext %27)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_33_158.cpp() #0 section ".text.startup" {
