; ModuleID = 'POJ-104-source/33/33-217.cpp'
source_filename = "POJ-104-source/33/33-217.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_33_217.cpp, i8* null }]
...
11:                                               ; preds = %7
  ...
  %15 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), [1000 x i8]* %14)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_33_217.cpp() #0 section ".text.startup" {
