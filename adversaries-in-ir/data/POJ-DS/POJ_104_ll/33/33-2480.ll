; ModuleID = 'POJ-104-source/33/33-2480.cpp'
source_filename = "POJ-104-source/33/33-2480.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_33_2480.cpp, i8* null }]
...
20:                                               ; preds = %14
  ...
  %25 = call signext i8 @_Z1bc(i8 signext %24)
...
define dso_local signext i8 @_Z1bc(i8 signext %0) #5 {
  %2 = alloca i8, align 1
  %3 = alloca i8, align 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_33_2480.cpp() #0 section ".text.startup" {
