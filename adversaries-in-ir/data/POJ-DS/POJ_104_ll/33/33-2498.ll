; ModuleID = 'POJ-104-source/33/33-2498.cpp'
source_filename = "POJ-104-source/33/33-2498.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_33_2498.cpp, i8* null }]
...
define dso_local void @_Z10complementPc(i8* %0) #4 {
  %2 = alloca i8*, align 8
...
11:                                               ; preds = %7
  ...
  call void @_Z10complementPc(i8* %14)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_33_2498.cpp() #0 section ".text.startup" {
