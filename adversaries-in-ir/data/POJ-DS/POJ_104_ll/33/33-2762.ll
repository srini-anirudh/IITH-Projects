; ModuleID = 'POJ-104-source/33/33-2762.cpp'
source_filename = "POJ-104-source/33/33-2762.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_33_2762.cpp, i8* null }]
...
define dso_local signext i8 @_Z2fyc(i8 signext %0) #4 {
  %2 = alloca i8, align 1
  %3 = alloca i8, align 1
...
define dso_local i32 @main(i32 %0, i8** %1) #5 {
  ...
  %13 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* %9)
...
53:                                               ; preds = %49
  ...
  %58 = call signext i8 @_Z2fyc(i8 signext %57)
...
65:                                               ; preds = %49
  ...
  %70 = call signext i8 @_Z2fyc(i8 signext %69)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_33_2762.cpp() #0 section ".text.startup" {
