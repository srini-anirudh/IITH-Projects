; ModuleID = 'POJ-104-source/33/33-2933.cpp'
source_filename = "POJ-104-source/33/33-2933.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_33_2933.cpp, i8* null }]
...
21:                                               ; preds = %17
  ...
  call void @_Z5matchc(i8 signext %25)
  br label %26
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_33_2933.cpp() #0 section ".text.startup" {
