; ModuleID = 'POJ-104-source/33/33-2950.cpp'
source_filename = "POJ-104-source/33/33-2950.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_33_2950.cpp, i8* null }]
...
69:                                               ; preds = %62
  ...
  %78 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i32 %77)
  br label %97
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_33_2950.cpp() #0 section ".text.startup" {
