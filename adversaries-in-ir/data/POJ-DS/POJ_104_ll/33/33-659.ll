; ModuleID = 'POJ-104-source/33/33-659.cpp'
source_filename = "POJ-104-source/33/33-659.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_33_659.cpp, i8* null }]
...
27:                                               ; preds = %22
  ...
  %29 = call i8* @strcat(i8* %28, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0)) #3
  br label %51
...
35:                                               ; preds = %30
  ...
  %37 = call i8* @strcat(i8* %36, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0)) #3
  br label %50
...
43:                                               ; preds = %38
  ...
  %45 = call i8* @strcat(i8* %44, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i64 0, i64 0)) #3
  br label %49

46:                                               ; preds = %38
  %47 = getelementptr inbounds [256 x i8], [256 x i8]* %6, i64 0, i64 0
  %48 = call i8* @strcat(i8* %47, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.5, i64 0, i64 0)) #3
  br label %49
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_33_659.cpp() #0 section ".text.startup" {
