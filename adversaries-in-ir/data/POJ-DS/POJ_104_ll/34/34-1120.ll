; ModuleID = 'POJ-104-source/34/34-1120.cpp'
source_filename = "POJ-104-source/34/34-1120.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_34_1120.cpp, i8* null }]
...
25:                                               ; preds = %17
  ...
  %45 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.2, i64 0, i64 0), i32 %40, i32 %44)
  br label %46
...
54:                                               ; preds = %46
  ...
  %73 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.3, i64 0, i64 0), i32 %68, i32 %72)
  br label %74
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_34_1120.cpp() #0 section ".text.startup" {
