; ModuleID = 'POJ-104-source/34/34-2740.cpp'
source_filename = "POJ-104-source/34/34-2740.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_34_2740.cpp, i8* null }]
...
14:                                               ; preds = %10
  ...
  %20 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.2, i64 0, i64 0), i32 %18, i32 %19)
...
27:                                               ; preds = %23
  ...
  %32 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.4, i64 0, i64 0), i32 %30, i32 %31)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_34_2740.cpp() #0 section ".text.startup" {
