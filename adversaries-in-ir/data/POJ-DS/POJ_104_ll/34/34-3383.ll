; ModuleID = 'POJ-104-source/34/34-3383.cpp'
source_filename = "POJ-104-source/34/34-3383.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_34_3383.cpp, i8* null }]
...
13:                                               ; preds = %7
  ...
  %18 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32 %17)
  br label %24
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_34_3383.cpp() #0 section ".text.startup" {
