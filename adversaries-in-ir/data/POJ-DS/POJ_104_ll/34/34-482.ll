; ModuleID = 'POJ-104-source/34/34-482.cpp'
source_filename = "POJ-104-source/34/34-482.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_34_482.cpp, i8* null }]
...
define dso_local i32 @_Z1ji(i32 %0) #5 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  store i32 %0, i32* %2, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_34_482.cpp() #0 section ".text.startup" {
