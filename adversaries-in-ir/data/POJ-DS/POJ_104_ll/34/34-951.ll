; ModuleID = 'POJ-104-source/34/34-951.cpp'
source_filename = "POJ-104-source/34/34-951.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_34_951.cpp, i8* null }]
...
26:                                               ; preds = %19
  ...
  %46 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.2, i64 0, i64 0), i32 %40, i32 %45)
  br label %67
...
47:                                               ; preds = %19
  ...
  %66 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.3, i64 0, i64 0), i32 %60, i32 %65)
  br label %67
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_34_951.cpp() #0 section ".text.startup" {
