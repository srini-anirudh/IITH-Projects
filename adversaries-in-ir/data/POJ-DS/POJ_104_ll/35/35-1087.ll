; ModuleID = 'POJ-104-source/35/35-1087.cpp'
source_filename = "POJ-104-source/35/35-1087.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_1087.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* %7)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_1087.cpp() #0 section ".text.startup" {
