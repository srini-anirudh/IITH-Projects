; ModuleID = 'POJ-104-source/35/35-1112.cpp'
source_filename = "POJ-104-source/35/35-1112.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_1112.cpp, i8* null }]
...
173:                                              ; preds = %171, %168
  %174 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %11)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_1112.cpp() #0 section ".text.startup" {
