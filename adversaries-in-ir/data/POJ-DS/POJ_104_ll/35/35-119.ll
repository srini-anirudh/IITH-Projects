; ModuleID = 'POJ-104-source/35/35-119.cpp'
source_filename = "POJ-104-source/35/35-119.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_119.cpp, i8* null }]
...
23:                                               ; preds = %19
  ...
  %26 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* %7, i64 0, i64 %25
...
43:                                               ; preds = %39
  ...
  %46 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* %7, i64 0, i64 %45
...
81:                                               ; preds = %77
  ...
  %85 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* %7, i64 0, i64 %84
...
120:                                              ; preds = %100
  ...
  %123 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), i32 %121, i32 %122)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_119.cpp() #0 section ".text.startup" {
