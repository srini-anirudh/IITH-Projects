; ModuleID = 'POJ-104-source/35/35-1322.cpp'
source_filename = "POJ-104-source/35/35-1322.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_1322.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %3, i32* %4)
...
39:                                               ; preds = %23
  ...
  %47 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i32* %46)
  br label %48
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_1322.cpp() #0 section ".text.startup" {
