; ModuleID = 'POJ-104-source/35/35-1345.cpp'
source_filename = "POJ-104-source/35/35-1345.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_1345.cpp, i8* null }]
...
187:                                              ; preds = %177
  ...
  %196 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), i32 %191, i32 %195)
  br label %197
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_1345.cpp() #0 section ".text.startup" {
