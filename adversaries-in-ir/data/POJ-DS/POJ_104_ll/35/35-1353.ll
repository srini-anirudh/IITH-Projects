; ModuleID = 'POJ-104-source/35/35-1353.cpp'
source_filename = "POJ-104-source/35/35-1353.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_1353.cpp, i8* null }]
...
161:                                              ; preds = %151
  ...
  %170 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), i32 %165, i32 %169)
  br label %174
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_1353.cpp() #0 section ".text.startup" {
