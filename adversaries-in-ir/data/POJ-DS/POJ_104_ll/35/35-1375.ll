; ModuleID = 'POJ-104-source/35/35-1375.cpp'
source_filename = "POJ-104-source/35/35-1375.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_1375.cpp, i8* null }]
...
27:                                               ; preds = %23
  ...
  %34 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i32* %33)
  br label %35
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_1375.cpp() #0 section ".text.startup" {
