; ModuleID = 'POJ-104-source/35/35-1379.cpp'
source_filename = "POJ-104-source/35/35-1379.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_1379.cpp, i8* null }]
...
36:                                               ; preds = %25
  ...
  %43 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i32* %42)
  br label %44
...
52:                                               ; preds = %16
  ...
  %54 = bitcast [9 x i32]* %8 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 16 %54, i8 0, i64 36, i1 false)
...
72:                                               ; preds = %68
  ...
  %75 = getelementptr inbounds [9 x i32], [9 x i32]* %7, i64 0, i64 %74
...
101:                                              ; preds = %68
  ...
  %108 = getelementptr inbounds [9 x i32], [9 x i32]* %8, i64 0, i64 %107
...
113:                                              ; preds = %109
  ...
  %116 = getelementptr inbounds [9 x i32], [9 x i32]* %8, i64 0, i64 %115
...
126:                                              ; preds = %113
  ...
  %136 = getelementptr inbounds [9 x i32], [9 x i32]* %8, i64 0, i64 %135
...
161:                                              ; preds = %156
  %162 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.4, i64 0, i64 0))
  br label %163
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_1379.cpp() #0 section ".text.startup" {
