; ModuleID = 'POJ-104-source/35/35-141.cpp'
source_filename = "POJ-104-source/35/35-141.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_141.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z6andianii(i32 %0, i32 %1) #0 {
...
define dso_local i32 @main() #4 {
  ...
  store i32 0, i32* %3, align 4
  %7 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* @a, i32* @b)
...
19:                                               ; preds = %14
  ...
  %22 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* @t, i64 0, i64 %21
...
46:                                               ; preds = %41
  ...
  %49 = call i32 @_Z6andianii(i32 %47, i32 %48)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_141.cpp() #0 section ".text.startup" {
