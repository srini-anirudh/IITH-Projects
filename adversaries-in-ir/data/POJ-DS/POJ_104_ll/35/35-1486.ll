; ModuleID = 'POJ-104-source/35/35-1486.cpp'
source_filename = "POJ-104-source/35/35-1486.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_1486.cpp, i8* null }]
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z3minPA10_iii([10 x i32]* %0, i32 %1, i32 %2) #4 {
...
42:                                               ; preds = %38
  ...
  %48 = call i32 @_Z3maxPii(i32* %46, i32 %47)
  store i32 %48, i32* %4, align 4
  %49 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* %8, i64 0, i64 0
  %50 = load i32, i32* %6, align 4
  %51 = load i32, i32* %4, align 4
  %52 = call i32 @_Z3minPA10_iii([10 x i32]* %49, i32 %50, i32 %51)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_1486.cpp() #0 section ".text.startup" {
