; ModuleID = 'POJ-104-source/35/35-1542.cpp'
source_filename = "POJ-104-source/35/35-1542.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_1542.cpp, i8* null }]
...
141:                                              ; preds = %131
  ...
  %145 = getelementptr inbounds [8 x i32], [8 x i32]* %6, i64 0, i64 %144
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_1542.cpp() #0 section ".text.startup" {
