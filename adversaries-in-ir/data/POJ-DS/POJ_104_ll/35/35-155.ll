; ModuleID = 'POJ-104-source/35/35-155.cpp'
source_filename = "POJ-104-source/35/35-155.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_155.cpp, i8* null }]
...
38:                                               ; preds = %34
  ...
  %47 = getelementptr inbounds [8 x i32], [8 x i32]* %41, i64 0, i64 %46
...
80:                                               ; preds = %76
  ...
  %89 = getelementptr inbounds [8 x i32], [8 x i32]* %83, i64 0, i64 %88
  ...
  %99 = getelementptr inbounds [8 x i32], [8 x i32]* %93, i64 0, i64 %98
...
111:                                              ; preds = %107
  ...
  %117 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), i32 %112, i32 %116)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_155.cpp() #0 section ".text.startup" {
