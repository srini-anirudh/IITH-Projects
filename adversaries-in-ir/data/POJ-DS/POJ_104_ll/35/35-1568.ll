; ModuleID = 'POJ-104-source/35/35-1568.cpp'
source_filename = "POJ-104-source/35/35-1568.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_1568.cpp, i8* null }]
...
34:                                               ; preds = %10
  ...
  %39 = call i32 @_Z1aPA8_iiiPi([8 x i32]* %35, i32 %36, i32 %37, i32* %38)
  %40 = icmp ne i32 %39, 0
...
define dso_local i32 @_Z1aPA8_iiiPi([8 x i32]* %0, i32 %1, i32 %2, i32* %3) #6 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_1568.cpp() #0 section ".text.startup" {
