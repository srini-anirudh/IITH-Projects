; ModuleID = 'POJ-104-source/35/35-1574.cpp'
source_filename = "POJ-104-source/35/35-1574.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_1574.cpp, i8* null }]
...
26:                                               ; preds = %22
  ...
  %29 = getelementptr inbounds [9 x [9 x i32]], [9 x [9 x i32]]* %7, i64 0, i64 %28
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_1574.cpp() #0 section ".text.startup" {
