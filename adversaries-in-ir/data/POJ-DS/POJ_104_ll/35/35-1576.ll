; ModuleID = 'POJ-104-source/35/35-1576.cpp'
source_filename = "POJ-104-source/35/35-1576.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_1576.cpp, i8* null }]
...
57:                                               ; preds = %53
  %58 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* %2, i64 0, i64 0
...
163:                                              ; preds = %159
  ...
  %170 = getelementptr inbounds [8 x i32], [8 x i32]* %4, i64 0, i64 %169
...
173:                                              ; preds = %163
  ...
  %176 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), i32 %174, i32 %175)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_1576.cpp() #0 section ".text.startup" {
