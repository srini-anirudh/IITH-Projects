; ModuleID = 'POJ-104-source/35/35-165.cpp'
source_filename = "POJ-104-source/35/35-165.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_165.cpp, i8* null }]
...
20:                                               ; preds = %16
  ...
  %23 = getelementptr inbounds [9 x [9 x i32]], [9 x [9 x i32]]* %4, i64 0, i64 %22
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_165.cpp() #0 section ".text.startup" {
