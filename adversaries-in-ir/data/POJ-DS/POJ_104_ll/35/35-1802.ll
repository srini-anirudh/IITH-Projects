; ModuleID = 'POJ-104-source/35/35-1802.cpp'
source_filename = "POJ-104-source/35/35-1802.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_1802.cpp, i8* null }]
...
51:                                               ; preds = %46
  ...
  %64 = call i32 @_Z7panduanPiiiiii(i32* %52, i32 %59, i32 %60, i32 %61, i32 %62, i32 %63)
...
define dso_local i32 @_Z7panduanPiiiiii(i32* %0, i32 %1, i32 %2, i32 %3, i32 %4, i32 %5) #5 {
  %7 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_1802.cpp() #0 section ".text.startup" {
