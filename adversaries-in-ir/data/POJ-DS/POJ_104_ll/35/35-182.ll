; ModuleID = 'POJ-104-source/35/35-182.cpp'
source_filename = "POJ-104-source/35/35-182.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_182.cpp, i8* null }]
...
128:                                              ; preds = %125
  ...
  %134 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), i32 %129, i32 %133)
  br label %137
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_182.cpp() #0 section ".text.startup" {
