; ModuleID = 'POJ-104-source/35/35-1840.cpp'
source_filename = "POJ-104-source/35/35-1840.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_1840.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z3miniiiPA8_ii(i32 %0, i32 %1, i32 %2, [8 x i32]* %3, i32 %4) #0 {
...
define dso_local i32 @main() #4 {
  ...
  %12 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %2, i32* %3)
...
22:                                               ; preds = %18
  ...
  %29 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i32* %28)
  br label %30
...
76:                                               ; preds = %49
  ...
  %83 = call i32 @_Z3miniiiPA8_ii(i32 %78, i32 %79, i32 %80, [8 x i32]* %81, i32 %82)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_1840.cpp() #0 section ".text.startup" {
