; ModuleID = 'POJ-104-source/35/35-1864.cpp'
source_filename = "POJ-104-source/35/35-1864.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_1864.cpp, i8* null }]
...
define dso_local i32 @_Z4maxhPA8_iii([8 x i32]* %0, i32 %1, i32 %2) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z4minlPA8_iii([8 x i32]* %0, i32 %1, i32 %2) #4 {
  %4 = alloca [8 x i32]*, align 8
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
  %7 = alloca i32, align 4
...
45:                                               ; preds = %41
  ...
  %56 = call i32 @_Z4minlPA8_iii([8 x i32]* %53, i32 %54, i32 %55)
...
58:                                               ; preds = %45
  ...
  %69 = call i32 @_Z4maxhPA8_iii([8 x i32]* %66, i32 %67, i32 %68)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_1864.cpp() #0 section ".text.startup" {
