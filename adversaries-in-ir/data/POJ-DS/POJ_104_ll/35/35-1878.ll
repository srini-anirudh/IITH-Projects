; ModuleID = 'POJ-104-source/35/35-1878.cpp'
source_filename = "POJ-104-source/35/35-1878.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_1878.cpp, i8* null }]
...
define dso_local i32 @_Z4maxhi(i32 %0) #4 {
...
36:                                               ; preds = %32
  ...
  %38 = call i32 @_Z4maxhi(i32 %37)
  store i32 %38, i32* %4, align 4
  %39 = load i32, i32* %4, align 4
  %40 = call i32 @_Z3mini(i32 %39)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_1878.cpp() #0 section ".text.startup" {
