; ModuleID = 'POJ-104-source/35/35-1879.cpp'
source_filename = "POJ-104-source/35/35-1879.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_1879.cpp, i8* null }]
...
139:                                              ; preds = %134, %42
  ...
  %143 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* %4, i64 0, i64 %142
...
184:                                              ; preds = %174
  ...
  %187 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), i32 %185, i32 %186)
  br label %190
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_1879.cpp() #0 section ".text.startup" {
