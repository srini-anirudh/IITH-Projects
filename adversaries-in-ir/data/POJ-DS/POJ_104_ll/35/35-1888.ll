; ModuleID = 'POJ-104-source/35/35-1888.cpp'
source_filename = "POJ-104-source/35/35-1888.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_1888.cpp, i8* null }]
...
define dso_local i32 @_Z4hangi(i32 %0) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z3liei(i32 %0) #4 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
...
define dso_local i32 @main() #5 {
  ...
  %4 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* @m, i32* @n)
  store i32 0, i32* %2, align 4
  br label %5
...
34:                                               ; preds = %30
  ...
  %36 = call i32 @_Z4hangi(i32 %35)
  %37 = call i32 @_Z3liei(i32 %36)
...
40:                                               ; preds = %34
  ...
  %43 = call i32 @_Z4hangi(i32 %42)
  %44 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), i32 %41, i32 %43)
  br label %49
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_1888.cpp() #0 section ".text.startup" {
