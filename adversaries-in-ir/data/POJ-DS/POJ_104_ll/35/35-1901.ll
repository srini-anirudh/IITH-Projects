; ModuleID = 'POJ-104-source/35/35-1901.cpp'
source_filename = "POJ-104-source/35/35-1901.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_1901.cpp, i8* null }]
...
99:                                               ; preds = %95
  ...
  %110 = getelementptr inbounds [8 x i32], [8 x i32]* %9, i64 0, i64 %109
...
156:                                              ; preds = %152
  ...
  %163 = getelementptr inbounds [8 x i32], [8 x i32]* %9, i64 0, i64 %162
...
166:                                              ; preds = %156
  ...
  %172 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0), i32 %167, i32 %171)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_1901.cpp() #0 section ".text.startup" {
