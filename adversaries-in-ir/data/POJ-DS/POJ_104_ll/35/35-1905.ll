; ModuleID = 'POJ-104-source/35/35-1905.cpp'
source_filename = "POJ-104-source/35/35-1905.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_1905.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %4, i32* %5)
...
100:                                              ; preds = %96
  %101 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* %9, i64 0, i64 0
  ...
  %108 = getelementptr inbounds [10 x i32], [10 x i32]* %12, i64 0, i64 %107
  store i32 0, i32* %108, align 4
  %109 = load i32, i32* %3, align 4
  %110 = load i32, i32* %3, align 4
  %111 = sext i32 %110 to i64
  %112 = getelementptr inbounds [10 x i32], [10 x i32]* %13, i64 0, i64 %111
...
127:                                              ; preds = %117
  ...
  %130 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* %9, i64 0, i64 %129
...
181:                                              ; preds = %171
  ...
  %190 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0), i32 %185, i32 %189)
  br label %191

191:                                              ; preds = %181, %171, %161
  br label %192
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_1905.cpp() #0 section ".text.startup" {
