; ModuleID = 'POJ-104-source/35/35-1906.cpp'
source_filename = "POJ-104-source/35/35-1906.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_1906.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %11, i8* align 16 bitcast ([8 x i32]* @__const.main.hang to i8*), i64 32, i1 false)
...
35:                                               ; preds = %14
  %36 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %6, i32* %7)
  store i32 0, i32* %5, align 4
  br label %37
...
163:                                              ; preds = %159
  ...
  %166 = getelementptr inbounds [8 x i32], [8 x i32]* %10, i64 0, i64 %165
...
171:                                              ; preds = %163
  ...
  %175 = getelementptr inbounds [8 x i32], [8 x i32]* %3, i64 0, i64 %174
  %176 = load i32, i32* %175, align 4
  %177 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0), i32 %172, i32 %176)
  br label %181
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_1906.cpp() #0 section ".text.startup" {
