; ModuleID = 'POJ-104-source/35/35-1923.cpp'
source_filename = "POJ-104-source/35/35-1923.cpp"
...
@xx = dso_local global [10 x i32] zeroinitializer, align 16
@yy = dso_local global [10 x i32] zeroinitializer, align 16
@.str = private unnamed_addr constant [6 x i8] c"%d,%d\00", align 1
@.str.1 = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.2 = private unnamed_addr constant [7 x i8] c"%d+%d\0A\00", align 1
@.str.3 = private unnamed_addr constant [4 x i8] c"No\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_1923.cpp, i8* null }]
...
define dso_local i32 @_Z4hangii(i32 %0, i32 %1) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z3lieii(i32 %0, i32 %1) #4 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
define dso_local i32 @main() #5 {
  ...
  %9 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %3, i32* %2)
...
39:                                               ; preds = %35
  ...
  %42 = call i32 @_Z4hangii(i32 %40, i32 %41)
...
54:                                               ; preds = %50
  ...
  %57 = call i32 @_Z3lieii(i32 %55, i32 %56)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_1923.cpp() #0 section ".text.startup" {
