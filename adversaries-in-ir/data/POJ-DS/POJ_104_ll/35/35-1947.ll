; ModuleID = 'POJ-104-source/35/35-1947.cpp'
source_filename = "POJ-104-source/35/35-1947.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_1947.cpp, i8* null }]
...
22:                                               ; preds = %12
  %23 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %8, i32* %9)
  store i32 0, i32* %6, align 4
  br label %24
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_1947.cpp() #0 section ".text.startup" {
