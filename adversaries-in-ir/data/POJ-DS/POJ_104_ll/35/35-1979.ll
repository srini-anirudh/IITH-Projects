; ModuleID = 'POJ-104-source/35/35-1979.cpp'
source_filename = "POJ-104-source/35/35-1979.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_1979.cpp, i8* null }]
...
42:                                               ; preds = %38
  %43 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* %2, i64 0, i64 0
  ...
  %55 = call i32 @_Z3rowPA8_iiiiii([8 x i32]* %43, i32 %50, i32 %51, i32 %52, i32 %53, i32 %54)
  %56 = icmp eq i32 %55, 1
...
define dso_local i32 @_Z3rowPA8_iiiiii([8 x i32]* %0, i32 %1, i32 %2, i32 %3, i32 %4, i32 %5) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_1979.cpp() #0 section ".text.startup" {
