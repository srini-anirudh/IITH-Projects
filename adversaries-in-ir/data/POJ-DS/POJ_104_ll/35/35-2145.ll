; ModuleID = 'POJ-104-source/35/35-2145.cpp'
source_filename = "POJ-104-source/35/35-2145.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_2145.cpp, i8* null }]
...
142:                                              ; preds = %138
  ...
  %154 = call i32 @_Z9hangzuidaii(i32 %149, i32 %153)
...
156:                                              ; preds = %142
  ...
  %168 = call i32 @_Z10liezuixiaoii(i32 %163, i32 %167)
...
define dso_local i32 @_Z9hangzuidaii(i32 %0, i32 %1) #6 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z10liezuixiaoii(i32 %0, i32 %1) #6 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  store i32 %0, i32* %4, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_2145.cpp() #0 section ".text.startup" {
