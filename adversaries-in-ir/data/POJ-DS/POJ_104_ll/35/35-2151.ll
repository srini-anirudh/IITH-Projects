; ModuleID = 'POJ-104-source/35/35-2151.cpp'
source_filename = "POJ-104-source/35/35-2151.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_2151.cpp, i8* null }]
...
131:                                              ; preds = %126
  ...
  %138 = getelementptr inbounds [8 x i32], [8 x i32]* %10, i64 0, i64 %137
  %139 = load i32, i32* %138, align 4
  %140 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i64 0, i64 0), i32 %135, i32 %139)
  br label %141
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_2151.cpp() #0 section ".text.startup" {
