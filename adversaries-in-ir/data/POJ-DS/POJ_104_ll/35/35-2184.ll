; ModuleID = 'POJ-104-source/35/35-2184.cpp'
source_filename = "POJ-104-source/35/35-2184.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_2184.cpp, i8* null }]
...
define dso_local i32 @_Z6judge1ii(i32 %0, i32 %1) #4 {
...
12:                                               ; preds = %7
  ...
  %15 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* @a, i64 0, i64 %14
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z6judge2ii(i32 %0, i32 %1) #4 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
define dso_local i32 @main() #5 {
  ...
  %5 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* @m, i32* @n)
...
44:                                               ; preds = %39
  ...
  %47 = call i32 @_Z6judge1ii(i32 %45, i32 %46)
  %48 = icmp eq i32 %47, 1
...
49:                                               ; preds = %44
  ...
  %52 = call i32 @_Z6judge2ii(i32 %50, i32 %51)
  %53 = icmp eq i32 %52, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_2184.cpp() #0 section ".text.startup" {
