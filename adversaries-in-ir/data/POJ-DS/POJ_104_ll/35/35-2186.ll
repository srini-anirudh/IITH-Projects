; ModuleID = 'POJ-104-source/35/35-2186.cpp'
source_filename = "POJ-104-source/35/35-2186.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_2186.cpp, i8* null }]
...
define dso_local i32 @_Z1fPii(i32* %0, i32 %1) #4 {
...
40:                                               ; preds = %36
  ...
  %46 = call i32 @_Z1fPii(i32* %44, i32 %45)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_2186.cpp() #0 section ".text.startup" {
