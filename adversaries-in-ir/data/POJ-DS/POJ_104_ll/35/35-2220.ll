; ModuleID = 'POJ-104-source/35/35-2220.cpp'
source_filename = "POJ-104-source/35/35-2220.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_2220.cpp, i8* null }]
...
define dso_local i32 @_Z3maxiPA8_iii(i32 %0, [8 x i32]* %1, i32 %2, i32 %3) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z3miniPA8_iii(i32 %0, [8 x i32]* %1, i32 %2, i32 %3) #4 {
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
  %7 = alloca [8 x i32]*, align 8
  %8 = alloca i32, align 4
...
48:                                               ; preds = %44
  ...
  %59 = call i32 @_Z3maxiPA8_iii(i32 %55, [8 x i32]* %56, i32 %57, i32 %58)
  ...
  %70 = call i32 @_Z3miniPA8_iii(i32 %66, [8 x i32]* %67, i32 %68, i32 %69)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_2220.cpp() #0 section ".text.startup" {
