; ModuleID = 'POJ-104-source/35/35-225.cpp'
source_filename = "POJ-104-source/35/35-225.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_225.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %3, i32* %4)
...
44:                                               ; preds = %40
  ...
  %48 = getelementptr inbounds [9 x i32], [9 x i32]* %47, i64 0, i64 1
...
77:                                               ; preds = %50
  %78 = getelementptr inbounds [9 x [9 x i32]], [9 x [9 x i32]]* %2, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_225.cpp() #0 section ".text.startup" {
