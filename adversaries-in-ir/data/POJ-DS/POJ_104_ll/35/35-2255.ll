; ModuleID = 'POJ-104-source/35/35-2255.cpp'
source_filename = "POJ-104-source/35/35-2255.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_2255.cpp, i8* null }]
...
define dso_local i32 @main() #5 {
  ...
  store i32 0, i32* %4, align 4
  %5 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* @row, i32* @line)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_2255.cpp() #0 section ".text.startup" {
