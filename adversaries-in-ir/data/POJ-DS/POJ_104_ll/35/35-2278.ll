; ModuleID = 'POJ-104-source/35/35-2278.cpp'
source_filename = "POJ-104-source/35/35-2278.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_2278.cpp, i8* null }]
...
88:                                               ; preds = %57
  ...
  %92 = getelementptr inbounds [5 x i32], [5 x i32]* %11, i64 0, i64 %91
...
146:                                              ; preds = %115
  ...
  %150 = getelementptr inbounds [5 x i32], [5 x i32]* %12, i64 0, i64 %149
...
164:                                              ; preds = %159
  ...
  %167 = getelementptr inbounds [5 x i32], [5 x i32]* %13, i64 0, i64 %166
...
174:                                              ; preds = %164
  ...
  %178 = getelementptr inbounds [5 x i32], [5 x i32]* %13, i64 0, i64 %177
...
190:                                              ; preds = %187
  %191 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i64 0, i64 0))
  br label %192
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_2278.cpp() #0 section ".text.startup" {
