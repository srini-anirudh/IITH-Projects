; ModuleID = 'POJ-104-source/35/35-230.cpp'
source_filename = "POJ-104-source/35/35-230.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_230.cpp, i8* null }]
...
91:                                               ; preds = %87
  %92 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* %6, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_230.cpp() #0 section ".text.startup" {
