; ModuleID = 'POJ-104-source/35/35-2314.cpp'
source_filename = "POJ-104-source/35/35-2314.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_2314.cpp, i8* null }]
...
76:                                               ; preds = %72
  ...
  %79 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* %9, i64 0, i64 %78
...
100:                                              ; preds = %97
  ...
  %105 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), i32 %102, i32 %104)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_2314.cpp() #0 section ".text.startup" {
