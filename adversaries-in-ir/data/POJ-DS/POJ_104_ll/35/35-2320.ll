; ModuleID = 'POJ-104-source/35/35-2320.cpp'
source_filename = "POJ-104-source/35/35-2320.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_2320.cpp, i8* null }]
...
define dso_local i32 @_Z4testPA8_iiii([8 x i32]* %0, i32 %1, i32 %2, i32 %3) #4 {
...
75:                                               ; preds = %48
  ...
  %80 = call i32 @_Z4testPA8_iiii([8 x i32]* %76, i32 %77, i32 %78, i32 %79)
  %81 = icmp ne i32 %80, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_2320.cpp() #0 section ".text.startup" {
