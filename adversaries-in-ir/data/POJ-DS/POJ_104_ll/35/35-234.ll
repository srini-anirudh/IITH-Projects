; ModuleID = 'POJ-104-source/35/35-234.cpp'
source_filename = "POJ-104-source/35/35-234.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_234.cpp, i8* null }]
...
101:                                              ; preds = %97
  ...
  %107 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), i32 %102, i32 %106)
  br label %112
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_234.cpp() #0 section ".text.startup" {
