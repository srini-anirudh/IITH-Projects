; ModuleID = 'POJ-104-source/35/35-2366.cpp'
source_filename = "POJ-104-source/35/35-2366.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_2366.cpp, i8* null }]
...
define dso_local i32 @_Z5find1ii(i32 %0, i32 %1) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z5find2ii(i32 %0, i32 %1) #4 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
define dso_local i32 @main() #5 {
  ...
  %4 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* @h, i32* @l)
...
39:                                               ; preds = %35
  ...
  %42 = call i32 @_Z5find1ii(i32 %40, i32 %41)
  %43 = load i32, i32* %2, align 4
  %44 = load i32, i32* %3, align 4
  %45 = call i32 @_Z5find2ii(i32 %43, i32 %44)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_2366.cpp() #0 section ".text.startup" {
