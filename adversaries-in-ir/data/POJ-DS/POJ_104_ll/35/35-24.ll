; ModuleID = 'POJ-104-source/35/35-24.cpp'
source_filename = "POJ-104-source/35/35-24.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_24.cpp, i8* null }]
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z3minPiii(i32* %0, i32 %1, i32 %2) #4 {
  %4 = alloca i32, align 4
...
39:                                               ; preds = %35
  ...
  %46 = call i32 @_Z3maxPii(i32* %44, i32 %45)
  store i32 %46, i32* %7, align 4
  %47 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* %2, i64 0, i64 0
  ...
  %56 = call i32 @_Z3minPiii(i32* %54, i32 8, i32 %55)
  %57 = icmp eq i32 %56, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_24.cpp() #0 section ".text.startup" {
