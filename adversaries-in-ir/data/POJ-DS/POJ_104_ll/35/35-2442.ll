; ModuleID = 'POJ-104-source/35/35-2442.cpp'
source_filename = "POJ-104-source/35/35-2442.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_2442.cpp, i8* null }]
...
78:                                               ; preds = %67, %46
  ...
  %81 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* %10, i64 0, i64 %80
...
102:                                              ; preds = %98
  %103 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* %7, i64 0, i64 0
...
165:                                              ; preds = %152
  ...
  %168 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* %10, i64 0, i64 %167
...
187:                                              ; preds = %174
  ...
  %190 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* %10, i64 0, i64 %189
...
214:                                              ; preds = %210
  ...
  %217 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* %10, i64 0, i64 %216
...
240:                                              ; preds = %237
  %241 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0))
  br label %242
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_2442.cpp() #0 section ".text.startup" {
