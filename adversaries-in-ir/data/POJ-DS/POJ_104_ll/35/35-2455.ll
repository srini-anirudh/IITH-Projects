; ModuleID = 'POJ-104-source/35/35-2455.cpp'
source_filename = "POJ-104-source/35/35-2455.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_2455.cpp, i8* null }]
...
78:                                               ; preds = %74
  ...
  %81 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* %11, i64 0, i64 %80
  ...
  %88 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* %11, i64 0, i64 %87
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_2455.cpp() #0 section ".text.startup" {
