; ModuleID = 'POJ-104-source/35/35-310.cpp'
source_filename = "POJ-104-source/35/35-310.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_310.cpp, i8* null }]
...
105:                                              ; preds = %101
  ...
  %108 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* %7, i64 0, i64 %107
  %109 = load i32, i32* %2, align 4
  %110 = sext i32 %109 to i64
  %111 = getelementptr inbounds [8 x i32], [8 x i32]* %10, i64 0, i64 %110
...
139:                                              ; preds = %136
  ...
  %146 = getelementptr inbounds [8 x i32], [8 x i32]* %10, i64 0, i64 %145
  %147 = load i32, i32* %146, align 4
  %148 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), i32 %143, i32 %147)
  br label %153
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_310.cpp() #0 section ".text.startup" {
