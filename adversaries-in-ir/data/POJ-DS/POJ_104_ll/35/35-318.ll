; ModuleID = 'POJ-104-source/35/35-318.cpp'
source_filename = "POJ-104-source/35/35-318.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_318.cpp, i8* null }]
...
39:                                               ; preds = %35
  ...
  %54 = getelementptr inbounds [9 x [9 x i32]], [9 x [9 x i32]]* %4, i64 0, i64 0
  %55 = load i32, i32* %2, align 4
  %56 = call i32 @_Z3miniiPA9_ii(i32 %52, i32 %53, [9 x i32]* %54, i32 %55)
  %57 = icmp eq i32 %56, 1
...
58:                                               ; preds = %39
  ...
  %61 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), i32 %59, i32 %60)
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z3miniiPA9_ii(i32 %0, i32 %1, [9 x i32]* %2, i32 %3) #5 {
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
  %7 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_318.cpp() #0 section ".text.startup" {
