; ModuleID = 'POJ-104-source/35/35-369.cpp'
source_filename = "POJ-104-source/35/35-369.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_369.cpp, i8* null }]
...
73:                                               ; preds = %69
  ...
  %76 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* %9, i64 0, i64 %75
...
109:                                              ; preds = %104
  ...
  %112 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i64 0, i64 0), i32 %110, i32 %111)
  br label %113
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_369.cpp() #0 section ".text.startup" {
