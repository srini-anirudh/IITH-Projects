; ModuleID = 'POJ-104-source/35/35-45.cpp'
source_filename = "POJ-104-source/35/35-45.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_45.cpp, i8* null }]
...
85:                                               ; preds = %68
  ...
  %99 = getelementptr inbounds [8 x i32], [8 x i32]* %95, i64 0, i64 %98
...
128:                                              ; preds = %124
  ...
  %131 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* %8, i64 0, i64 %130
...
168:                                              ; preds = %164
  ...
  %171 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* %7, i64 0, i64 %170
  ...
  %182 = getelementptr inbounds [8 x i32], [8 x i32]* %9, i64 0, i64 %181
...
196:                                              ; preds = %193
  ...
  %202 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), i32 %197, i32 %201)
  br label %207
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_45.cpp() #0 section ".text.startup" {
