; ModuleID = 'POJ-104-source/35/35-46.cpp'
source_filename = "POJ-104-source/35/35-46.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_46.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z4findPA8_iii([8 x i32]* %0, i32 %1, i32 %2) #0 {
...
define dso_local i32 @main() #4 {
  ...
  %7 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), i32* %3, i32* %4)
...
17:                                               ; preds = %13
  ...
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i32* %23)
  br label %25
...
32:                                               ; preds = %8
  ...
  call void @_Z4findPA8_iii([8 x i32]* %33, i32 %34, i32 %35)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_46.cpp() #0 section ".text.startup" {
