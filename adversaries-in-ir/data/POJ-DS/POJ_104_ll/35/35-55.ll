; ModuleID = 'POJ-104-source/35/35-55.cpp'
source_filename = "POJ-104-source/35/35-55.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_55.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %11 = bitcast [10 x [10 x i32]]* %2 to i8*
...
118:                                              ; preds = %114
  ...
  %131 = getelementptr inbounds [10 x i32], [10 x i32]* %125, i64 0, i64 %130
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_55.cpp() #0 section ".text.startup" {
