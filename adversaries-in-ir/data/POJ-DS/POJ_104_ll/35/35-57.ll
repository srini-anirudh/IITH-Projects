; ModuleID = 'POJ-104-source/35/35-57.cpp'
source_filename = "POJ-104-source/35/35-57.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_57.cpp, i8* null }]
...
75:                                               ; preds = %48
  %76 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* %2, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_57.cpp() #0 section ".text.startup" {
