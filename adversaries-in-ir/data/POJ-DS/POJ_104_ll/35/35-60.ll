; ModuleID = 'POJ-104-source/35/35-60.cpp'
source_filename = "POJ-104-source/35/35-60.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_60.cpp, i8* null }]
...
120:                                              ; preds = %91
  ...
  %130 = getelementptr inbounds [8 x i32], [8 x i32]* %4, i64 0, i64 %129
...
144:                                              ; preds = %140
  ...
  %147 = getelementptr inbounds [8 x i32], [8 x i32]* %3, i64 0, i64 %146
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_60.cpp() #0 section ".text.startup" {
