; ModuleID = 'POJ-104-source/35/35-653.cpp'
source_filename = "POJ-104-source/35/35-653.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_653.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %7, i32* %8)
...
63:                                               ; preds = %53
  ...
  %78 = getelementptr inbounds [8 x i32], [8 x i32]* %4, i64 0, i64 %77
...
109:                                              ; preds = %99
  ...
  %120 = getelementptr inbounds [8 x i32], [8 x i32]* %5, i64 0, i64 %119
...
145:                                              ; preds = %141
  ...
  %152 = getelementptr inbounds [8 x i32], [8 x i32]* %5, i64 0, i64 %151
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_653.cpp() #0 section ".text.startup" {
