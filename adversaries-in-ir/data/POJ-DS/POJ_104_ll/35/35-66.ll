; ModuleID = 'POJ-104-source/35/35-66.cpp'
source_filename = "POJ-104-source/35/35-66.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_66.cpp, i8* null }]
...
110:                                              ; preds = %109, %97
  ...
  %113 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.3, i64 0, i64 0), i32 %111, i32 %112)
  br label %114
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_66.cpp() #0 section ".text.startup" {
