; ModuleID = 'POJ-104-source/35/35-702.cpp'
source_filename = "POJ-104-source/35/35-702.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_702.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %12 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %3, i32* %4)
...
76:                                               ; preds = %63
  ...
  %86 = getelementptr inbounds [8 x i32], [8 x i32]* %10, i64 0, i64 %85
...
87:                                               ; preds = %76, %63
  ...
  %97 = getelementptr inbounds [8 x i32], [8 x i32]* %11, i64 0, i64 %96
...
129:                                              ; preds = %125
  ...
  %132 = getelementptr inbounds [8 x i32], [8 x i32]* %10, i64 0, i64 %131
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_702.cpp() #0 section ".text.startup" {
