; ModuleID = 'POJ-104-source/35/35-77.cpp'
source_filename = "POJ-104-source/35/35-77.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_77.cpp, i8* null }]
...
define dso_local i32 @main() #5 {
  ...
  %11 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* @m, i32* @n)
...
64:                                               ; preds = %48
  %65 = getelementptr inbounds [8 x i32], [8 x i32]* %5, i64 0, i64 0
  %66 = call i32 @_Z3minPi(i32* %65)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_77.cpp() #0 section ".text.startup" {
