; ModuleID = 'POJ-104-source/35/35-886.cpp'
source_filename = "POJ-104-source/35/35-886.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_886.cpp, i8* null }]
...
101:                                              ; preds = %97
  ...
  %104 = getelementptr inbounds [8 x i32], [8 x i32]* %10, i64 0, i64 %103
  %105 = load i32, i32* %104, align 4
  store i32 %105, i32* %5, align 4
  %106 = load i32, i32* %4, align 4
  %107 = sext i32 %106 to i64
  %108 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* %9, i64 0, i64 %107
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_886.cpp() #0 section ".text.startup" {
