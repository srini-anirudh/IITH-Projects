; ModuleID = 'POJ-104-source/35/35-89.cpp'
source_filename = "POJ-104-source/35/35-89.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_89.cpp, i8* null }]
...
18:                                               ; preds = %15
  ...
  %21 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* %2, i64 0, i64 %20
...
32:                                               ; preds = %11
  %33 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %3, i32* %4)
...
44:                                               ; preds = %40
  ...
  %51 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i32* %50)
  br label %52
...
135:                                              ; preds = %130
  ...
  %138 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.4, i64 0, i64 0), i32 %136, i32 %137)
  br label %139
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_89.cpp() #0 section ".text.startup" {
