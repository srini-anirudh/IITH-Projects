; ModuleID = 'POJ-104-source/35/35-891.cpp'
source_filename = "POJ-104-source/35/35-891.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_891.cpp, i8* null }]
...
72:                                               ; preds = %59
  ...
  %82 = getelementptr inbounds [7 x i32], [7 x i32]* %7, i64 0, i64 %81
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_891.cpp() #0 section ".text.startup" {
