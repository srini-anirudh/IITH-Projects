; ModuleID = 'POJ-104-source/35/35-908.cpp'
source_filename = "POJ-104-source/35/35-908.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_908.cpp, i8* null }]
...
42:                                               ; preds = %38
  ...
  %45 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* %8, i64 0, i64 %44
...
65:                                               ; preds = %55
  ...
  %74 = getelementptr inbounds [2 x i32], [2 x i32]* %10, i64 0, i64 1
...
121:                                              ; preds = %116
  ...
  %124 = getelementptr inbounds [2 x i32], [2 x i32]* %10, i64 0, i64 1
  %125 = load i32, i32* %124, align 4
  %126 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), i32 %123, i32 %125)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_908.cpp() #0 section ".text.startup" {
