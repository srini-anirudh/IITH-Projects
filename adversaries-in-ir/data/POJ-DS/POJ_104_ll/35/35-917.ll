; ModuleID = 'POJ-104-source/35/35-917.cpp'
source_filename = "POJ-104-source/35/35-917.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_917.cpp, i8* null }]
...
90:                                               ; preds = %86
  ...
  %93 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* %10, i64 0, i64 %92
...
108:                                              ; preds = %104
  ...
  %111 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* %10, i64 0, i64 %110
  ...
  %118 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* %10, i64 0, i64 %117
...
144:                                              ; preds = %137
  ...
  %147 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), i32 %145, i32 %146)
  br label %153
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_917.cpp() #0 section ".text.startup" {
