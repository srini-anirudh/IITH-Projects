; ModuleID = 'POJ-104-source/35/35-93.cpp'
source_filename = "POJ-104-source/35/35-93.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_93.cpp, i8* null }]
...
96:                                               ; preds = %92
  %97 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* %7, i64 0, i64 0
...
122:                                              ; preds = %109
  ...
  %126 = getelementptr inbounds [8 x [8 x i32]], [8 x [8 x i32]]* %7, i64 0, i64 %125
...
161:                                              ; preds = %151
  ...
  %167 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), i32 %162, i32 %166)
  br label %172
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_93.cpp() #0 section ".text.startup" {
