; ModuleID = 'POJ-104-source/35/35-949.cpp'
source_filename = "POJ-104-source/35/35-949.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_35_949.cpp, i8* null }]
...
99:                                               ; preds = %95
  %100 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* %6, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_35_949.cpp() #0 section ".text.startup" {
