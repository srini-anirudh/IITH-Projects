; ModuleID = 'POJ-104-source/36/36-1001.cpp'
source_filename = "POJ-104-source/36/36-1001.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_1001.cpp, i8* null }]
...
define dso_local i32 @_Z9rearrangePcS_(i8* %0, i8* %1) #4 {
...
define dso_local i32 @main() #7 {
  ...
  %16 = call i32 @_Z9rearrangePcS_(i8* %14, i8* %15)
  %17 = icmp ne i32 %16, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_1001.cpp() #0 section ".text.startup" {
