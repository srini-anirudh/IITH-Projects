; ModuleID = 'POJ-104-source/36/36-1034.cpp'
source_filename = "POJ-104-source/36/36-1034.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_1034.cpp, i8* null }]
...
29:                                               ; preds = %25
  ...
  %36 = call i8* @_ZSt6strchrPci(i8* %30, i32 %35)
...
40:                                               ; preds = %29
  ...
  %47 = call i8* @_ZSt6strchrPci(i8* %41, i32 %46)
...
define linkonce_odr dso_local i8* @_ZSt6strchrPci(i8* %0, i32 %1) #8 comdat {
  %3 = alloca i8*, align 8
  %4 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_1034.cpp() #0 section ".text.startup" {
