; ModuleID = 'POJ-104-source/36/36-1036.cpp'
source_filename = "POJ-104-source/36/36-1036.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_1036.cpp, i8* null }]
...
36:                                               ; preds = %17
  ...
  %39 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i8* %37, i8* %38)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_1036.cpp() #0 section ".text.startup" {
