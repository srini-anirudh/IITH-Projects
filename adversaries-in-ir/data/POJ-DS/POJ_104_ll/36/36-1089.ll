; ModuleID = 'POJ-104-source/36/36-1089.cpp'
source_filename = "POJ-104-source/36/36-1089.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_1089.cpp, i8* null }]
...
define dso_local i32 @_Z5countPcPii(i8* %0, i32* %1, i32 %2) #4 {
  %4 = alloca i8*, align 8
...
define dso_local i32 @main() #5 {
  ...
  %32 = call i32 @_Z5countPcPii(i8* %29, i32* %30, i32 %31)
  %33 = load i8*, i8** %11, align 8
  %34 = load i32*, i32** %13, align 8
  %35 = load i32, i32* %7, align 4
  %36 = call i32 @_Z5countPcPii(i8* %33, i32* %34, i32 %35)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_1089.cpp() #0 section ".text.startup" {
