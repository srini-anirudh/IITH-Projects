; ModuleID = 'POJ-104-source/36/36-1162.cpp'
source_filename = "POJ-104-source/36/36-1162.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_1162.cpp, i8* null }]
...
define dso_local i32 @main(i32 %0, i8** %1) #4 {
  ...
  %15 = call i32 @_Z5judgePcS_(i8* %13, i8* %14)
  %16 = icmp eq i32 %15, 1
...
define dso_local i32 @_Z5judgePcS_(i8* %0, i8* %1) #6 {
  %3 = alloca i32, align 4
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_1162.cpp() #0 section ".text.startup" {
