; ModuleID = 'POJ-104-source/36/36-1216.cpp'
source_filename = "POJ-104-source/36/36-1216.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_1216.cpp, i8* null }]
...
107:                                              ; preds = %105, %103
  %108 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i32* %7)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_1216.cpp() #0 section ".text.startup" {
