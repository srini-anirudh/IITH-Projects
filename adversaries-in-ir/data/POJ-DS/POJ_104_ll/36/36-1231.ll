; ModuleID = 'POJ-104-source/36/36-1231.cpp'
source_filename = "POJ-104-source/36/36-1231.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_1231.cpp, i8* null }]
...
64:                                               ; preds = %59
  ...
  %71 = getelementptr inbounds [2 x [100 x i8]], [2 x [100 x i8]]* %2, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_1231.cpp() #0 section ".text.startup" {
