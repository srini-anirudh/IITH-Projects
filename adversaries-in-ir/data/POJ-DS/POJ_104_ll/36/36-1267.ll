; ModuleID = 'POJ-104-source/36/36-1267.cpp'
source_filename = "POJ-104-source/36/36-1267.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_1267.cpp, i8* null }]
...
136:                                              ; preds = %83
  ...
  %139 = call i32 @strcmp(i8* %137, i8* %138) #7
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_1267.cpp() #0 section ".text.startup" {
