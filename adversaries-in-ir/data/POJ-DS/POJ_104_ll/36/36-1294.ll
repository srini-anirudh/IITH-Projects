; ModuleID = 'POJ-104-source/36/36-1294.cpp'
source_filename = "POJ-104-source/36/36-1294.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_1294.cpp, i8* null }]
...
21:                                               ; preds = %0
  ...
  call void @qsort(i8* %22, i64 %24, i64 1, i32 (i8*, i8*)* @_Z7comparePKvS0_)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_1294.cpp() #0 section ".text.startup" {
