; ModuleID = 'POJ-104-source/36/36-133.cpp'
source_filename = "POJ-104-source/36/36-133.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_133.cpp, i8* null }]
...
22:                                               ; preds = %15
  ...
  %35 = getelementptr inbounds [256 x i32], [256 x i32]* %4, i64 0, i64 %34
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_133.cpp() #0 section ".text.startup" {
