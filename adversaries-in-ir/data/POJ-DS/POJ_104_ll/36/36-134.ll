; ModuleID = 'POJ-104-source/36/36-134.cpp'
source_filename = "POJ-104-source/36/36-134.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_134.cpp, i8* null }]
...
28:                                               ; preds = %21
  ...
  %34 = getelementptr inbounds [130 x i32], [130 x i32]* %4, i64 0, i64 %33
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_134.cpp() #0 section ".text.startup" {
