; ModuleID = 'POJ-104-source/36/36-137.cpp'
source_filename = "POJ-104-source/36/36-137.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_137.cpp, i8* null }]
...
99:                                               ; preds = %92
  ...
  %108 = getelementptr inbounds [52 x i32], [52 x i32]* %5, i64 0, i64 %107
...
144:                                              ; preds = %141
  ...
  %147 = getelementptr inbounds [52 x i32], [52 x i32]* %4, i64 0, i64 %146
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_137.cpp() #0 section ".text.startup" {
