; ModuleID = 'POJ-104-source/36/36-1376.cpp'
source_filename = "POJ-104-source/36/36-1376.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_1376.cpp, i8* null }]
...
define dso_local void @_Z1fPci(i8* %0, i32 %1) #4 {
  %3 = alloca i8*, align 8
...
23:                                               ; preds = %0
  ...
  call void @_Z1fPci(i8* %24, i32 %25)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_1376.cpp() #0 section ".text.startup" {
