; ModuleID = 'POJ-104-source/36/36-1535.cpp'
source_filename = "POJ-104-source/36/36-1535.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_1535.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @llvm.memset.p0i8.i64(i8* align 16 %16, i8 0, i64 600, i1 false)
  store i32 0, i32* %7, align 4
  %17 = getelementptr inbounds [100 x i8], [100 x i8]* %2, i64 0, i64 0
  %18 = getelementptr inbounds [100 x i8], [100 x i8]* %3, i64 0, i64 0
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i8* %17, i8* %18)
...
48:                                               ; preds = %40
  ...
  %51 = getelementptr inbounds [150 x i32], [150 x i32]* %5, i64 0, i64 %50
...
79:                                               ; preds = %71
  ...
  %82 = getelementptr inbounds [150 x i32], [150 x i32]* %6, i64 0, i64 %81
...
97:                                               ; preds = %94
  ...
  %100 = getelementptr inbounds [150 x i32], [150 x i32]* %5, i64 0, i64 %99
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_1535.cpp() #0 section ".text.startup" {
