; ModuleID = 'POJ-104-source/36/36-1576.cpp'
source_filename = "POJ-104-source/36/36-1576.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_1576.cpp, i8* null }]
...
define dso_local i32 @_Z3staPci(i8* %0, i32 %1) #4 {
  %3 = alloca i8*, align 8
...
19:                                               ; preds = %16
  ...
  %23 = call i32 @_Z3staPci(i8* %20, i32 %22)
  ...
  %30 = call i32 @_Z3staPci(i8* %27, i32 %29)
  ...
  %38 = call i32 @_Z3staPci(i8* %35, i32 %37)
  ...
  %45 = call i32 @_Z3staPci(i8* %42, i32 %44)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_1576.cpp() #0 section ".text.startup" {
