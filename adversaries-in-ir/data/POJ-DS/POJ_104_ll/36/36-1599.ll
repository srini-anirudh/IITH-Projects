; ModuleID = 'POJ-104-source/36/36-1599.cpp'
source_filename = "POJ-104-source/36/36-1599.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_1599.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z5orderPci(i8* %0, i32 %1) #0 {
...
60:                                               ; preds = %12
  ...
  %63 = sub nsw i32 %62, 1
  %64 = call i32 @_Z5orderPci(i8* %61, i32 %63)
...
42:                                               ; preds = %29
  ...
  %46 = call i32 @_Z5orderPci(i8* %44, i32 %45)
  %47 = load i8*, i8** %6, align 8
  %48 = load i32, i32* %9, align 4
  %49 = call i32 @_Z5orderPci(i8* %47, i32 %48)
  store i32 0, i32* %7, align 4
  br label %50
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_1599.cpp() #0 section ".text.startup" {
