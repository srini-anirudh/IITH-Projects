; ModuleID = 'POJ-104-source/36/36-1631.cpp'
source_filename = "POJ-104-source/36/36-1631.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_1631.cpp, i8* null }]
...
define dso_local void @_Z4turnPcPii(i8* %0, i32* %1, i32 %2) #4 {
  %4 = alloca i8*, align 8
...
36:                                               ; preds = %43, %35
  ...
  %40 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i8* %39)
...
76:                                               ; preds = %72
  ...
  call void @_Z4turnPcPii(i8* %77, i32* %78, i32 %79)
  ...
  call void @_Z4turnPcPii(i8* %80, i32* %81, i32 %82)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_1631.cpp() #0 section ".text.startup" {
