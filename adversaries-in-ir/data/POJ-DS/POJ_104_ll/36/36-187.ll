; ModuleID = 'POJ-104-source/36/36-187.cpp'
source_filename = "POJ-104-source/36/36-187.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_187.cpp, i8* null }]
...
define dso_local i32 @_Z2tjPcc(i8* %0, i8 signext %1) #4 {
  %3 = alloca i8*, align 8
  %4 = alloca i8, align 1
...
23:                                               ; preds = %19
  ...
  %29 = call i32 @_Z2tjPcc(i8* %24, i8 signext %28)
  ...
  %35 = call i32 @_Z2tjPcc(i8* %30, i8 signext %34)
...
46:                                               ; preds = %43
  %47 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0))
  br label %50
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_187.cpp() #0 section ".text.startup" {
