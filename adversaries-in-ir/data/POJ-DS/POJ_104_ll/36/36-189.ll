; ModuleID = 'POJ-104-source/36/36-189.cpp'
source_filename = "POJ-104-source/36/36-189.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_189.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @_Z7arrangePc(i8* %9)
  %10 = getelementptr inbounds [20 x i8], [20 x i8]* %3, i64 0, i64 0
  call void @_Z7arrangePc(i8* %10)
...
define dso_local void @_Z7arrangePc(i8* %0) #6 {
  %2 = alloca i8*, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_189.cpp() #0 section ".text.startup" {
