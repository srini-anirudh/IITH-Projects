; ModuleID = 'POJ-104-source/36/36-198.cpp'
source_filename = "POJ-104-source/36/36-198.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_198.cpp, i8* null }]
...
define dso_local i32 @_Z7comparecPcS_(i8 signext %0, i8* %1, i8* %2) #4 {
  %4 = alloca i8, align 1
  %5 = alloca i8*, align 8
  %6 = alloca i8*, align 8
...
28:                                               ; preds = %24
  ...
  %32 = call i32 @_Z7comparecPcS_(i8 signext %29, i8* %30, i8* %31)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_198.cpp() #0 section ".text.startup" {
