; ModuleID = 'POJ-104-source/36/36-218.cpp'
source_filename = "POJ-104-source/36/36-218.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_218.cpp, i8* null }]
...
34:                                               ; preds = %30
  ...
  %37 = getelementptr inbounds [200 x i8], [200 x i8]* %8, i64 0, i64 %36
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_218.cpp() #0 section ".text.startup" {
