; ModuleID = 'POJ-104-source/36/36-234.cpp'
source_filename = "POJ-104-source/36/36-234.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_234.cpp, i8* null }]
...
23:                                               ; preds = %0
  ...
  call void @_Z3arnPci(i8* %24, i32 %25)
  %26 = getelementptr inbounds [50 x i8], [50 x i8]* %3, i64 0, i64 0
  %27 = load i32, i32* %5, align 4
  call void @_Z3arnPci(i8* %26, i32 %27)
...
define dso_local void @_Z3arnPci(i8* %0, i32 %1) #7 {
  %3 = alloca i8*, align 8
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_234.cpp() #0 section ".text.startup" {
