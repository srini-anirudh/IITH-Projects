; ModuleID = 'POJ-104-source/36/36-25.cpp'
source_filename = "POJ-104-source/36/36-25.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_25.cpp, i8* null }]
...
33:                                               ; preds = %29
  ...
  %36 = getelementptr inbounds [100 x i8], [100 x i8]* %14, i64 0, i64 %35
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_25.cpp() #0 section ".text.startup" {
