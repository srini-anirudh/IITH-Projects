; ModuleID = 'POJ-104-source/36/36-271.cpp'
source_filename = "POJ-104-source/36/36-271.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_271.cpp, i8* null }]
...
75:                                               ; preds = %116, %74
  ...
  %78 = getelementptr inbounds [20 x i8], [20 x i8]* %3, i64 0, i64 0
...
97:                                               ; preds = %84
  ...
  %109 = getelementptr inbounds [20 x i8], [20 x i8]* %3, i64 0, i64 %108
...
124:                                              ; preds = %144, %123
  ...
  %127 = getelementptr inbounds [20 x i8], [20 x i8]* %2, i64 0, i64 0
...
130:                                              ; preds = %124
  ...
  %133 = getelementptr inbounds [20 x i8], [20 x i8]* %2, i64 0, i64 %132
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_271.cpp() #0 section ".text.startup" {
