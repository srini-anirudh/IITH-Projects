; ModuleID = 'POJ-104-source/36/36-331.cpp'
source_filename = "POJ-104-source/36/36-331.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_331.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z3minPcS_(i8* %0, i8* %1) #0 {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
  %5 = alloca i8, align 1
...
135:                                              ; preds = %72
  ...
  %138 = call i32 @strcmp(i8* %136, i8* %137) #7
...
define dso_local i32 @main() #5 {
  ...
  %7 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), i8* %5, i8* %6)
  %8 = getelementptr inbounds [1000 x i8], [1000 x i8]* %1, i64 0, i64 0
  %9 = getelementptr inbounds [1000 x i8], [1000 x i8]* %2, i64 0, i64 0
  call void @_Z3minPcS_(i8* %8, i8* %9)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_331.cpp() #0 section ".text.startup" {
