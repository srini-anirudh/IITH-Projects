; ModuleID = 'POJ-104-source/36/36-350.cpp'
source_filename = "POJ-104-source/36/36-350.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_350.cpp, i8* null }]
...
define dso_local void @_Z4sortPc(i8* %0) #6 {
  %2 = alloca i8*, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_350.cpp() #0 section ".text.startup" {
