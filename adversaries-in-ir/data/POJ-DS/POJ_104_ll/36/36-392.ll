; ModuleID = 'POJ-104-source/36/36-392.cpp'
source_filename = "POJ-104-source/36/36-392.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_392.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @_Z6numberPcPii(i8* %21, i32* %22, i32 %23)
  ...
  call void @_Z6numberPcPii(i8* %24, i32* %25, i32 %26)
...
30:                                               ; preds = %27
  ...
  %37 = getelementptr inbounds [256 x i32], [256 x i32]* %9, i64 0, i64 %36
...
define dso_local void @_Z6numberPcPii(i8* %0, i32* %1, i32 %2) #7 {
  %4 = alloca i8*, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_392.cpp() #0 section ".text.startup" {
