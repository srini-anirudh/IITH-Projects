; ModuleID = 'POJ-104-source/36/36-394.cpp'
source_filename = "POJ-104-source/36/36-394.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_394.cpp, i8* null }]
...
22:                                               ; preds = %0
  ...
  call void @_Z3paiPci(i8* %23, i32 %24)
  %25 = getelementptr inbounds [100 x i8], [100 x i8]* %3, i64 0, i64 0
  %26 = load i32, i32* %4, align 4
  call void @_Z3paiPci(i8* %25, i32 %26)
...
define dso_local void @_Z3paiPci(i8* %0, i32 %1) #6 {
  %3 = alloca i8*, align 8
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_394.cpp() #0 section ".text.startup" {
