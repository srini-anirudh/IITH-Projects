; ModuleID = 'POJ-104-source/36/36-400.cpp'
source_filename = "POJ-104-source/36/36-400.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_400.cpp, i8* null }]
...
16:                                               ; preds = %0
  ...
  %19 = call i32 @_Z3cmpPcS_i(i8* %17, i8* %18, i32 0)
  %20 = icmp eq i32 %19, 1
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z3cmpPcS_i(i8* %0, i8* %1, i32 %2) #0 {
...
48:                                               ; preds = %41
  ...
  %56 = add nsw i32 %55, 1
  %57 = call i32 @_Z3cmpPcS_i(i8* %53, i8* %54, i32 %56)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_400.cpp() #0 section ".text.startup" {
