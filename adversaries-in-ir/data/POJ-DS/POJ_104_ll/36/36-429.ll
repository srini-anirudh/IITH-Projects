; ModuleID = 'POJ-104-source/36/36-429.cpp'
source_filename = "POJ-104-source/36/36-429.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_429.cpp, i8* null }]
...
define dso_local void @_Z1fPcPi(i8* %0, i32* %1) #6 {
  %3 = alloca i8*, align 8
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z1gPiS_i(i32* %0, i32* %1, i32 %2) #0 {
...
32:                                               ; preds = %20
  ...
  %36 = add nsw i32 %35, 1
  %37 = call i32 @_Z1gPiS_i(i32* %33, i32* %34, i32 %36)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_429.cpp() #0 section ".text.startup" {
