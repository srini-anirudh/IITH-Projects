; ModuleID = 'POJ-104-source/36/36-438.cpp'
source_filename = "POJ-104-source/36/36-438.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_438.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @_Z4sortPci(i8* %16, i32 %17)
  %18 = getelementptr inbounds [50 x i8], [50 x i8]* %6, i64 0, i64 0
  %19 = load i32, i32* %3, align 4
  call void @_Z4sortPci(i8* %18, i32 %19)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_438.cpp() #0 section ".text.startup" {
