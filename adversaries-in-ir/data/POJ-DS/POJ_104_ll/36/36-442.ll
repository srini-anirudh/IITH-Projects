; ModuleID = 'POJ-104-source/36/36-442.cpp'
source_filename = "POJ-104-source/36/36-442.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_442.cpp, i8* null }]
...
define dso_local i32 @_Z6searchPcS_ii(i8* %0, i8* %1, i32 %2, i32 %3) #4 {
...
34:                                               ; preds = %29
  ...
  %39 = call i32 @_Z6searchPcS_ii(i8* %35, i8* %36, i32 %37, i32 %38)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_442.cpp() #0 section ".text.startup" {
