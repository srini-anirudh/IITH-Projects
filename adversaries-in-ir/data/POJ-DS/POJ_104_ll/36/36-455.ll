; ModuleID = 'POJ-104-source/36/36-455.cpp'
source_filename = "POJ-104-source/36/36-455.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_455.cpp, i8* null }]
...
define dso_local i32 @_Z4dealPciS_i(i8* %0, i32 %1, i8* %2, i32 %3) #4 {
...
261:                                              ; preds = %210
  ...
  %264 = call i32 @strcmp(i8* %262, i8* %263) #7
...
20:                                               ; preds = %0
  ...
  %25 = call i32 @_Z4dealPciS_i(i8* %21, i32 %22, i8* %23, i32 %24)
  %26 = icmp ne i32 %25, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_455.cpp() #0 section ".text.startup" {
