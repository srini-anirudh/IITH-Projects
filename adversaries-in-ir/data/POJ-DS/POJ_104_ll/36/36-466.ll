; ModuleID = 'POJ-104-source/36/36-466.cpp'
source_filename = "POJ-104-source/36/36-466.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_466.cpp, i8* null }]
...
104:                                              ; preds = %127, %103
  ...
  %107 = getelementptr inbounds [300 x i8], [300 x i8]* %3, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_466.cpp() #0 section ".text.startup" {
