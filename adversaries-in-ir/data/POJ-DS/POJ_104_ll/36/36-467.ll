; ModuleID = 'POJ-104-source/36/36-467.cpp'
source_filename = "POJ-104-source/36/36-467.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_467.cpp, i8* null }]
...
define dso_local void @_Z4rankPc(i8* %0) #5 {
  %2 = alloca i8*, align 8
  %3 = alloca i8, align 1
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_467.cpp() #0 section ".text.startup" {
