; ModuleID = 'POJ-104-source/36/36-5.cpp'
source_filename = "POJ-104-source/36/36-5.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_5.cpp, i8* null }]
...
44:                                               ; preds = %39
  ...
  %52 = getelementptr inbounds [128 x i32], [128 x i32]* %8, i64 0, i64 %51
...
82:                                               ; preds = %79
  ...
  %89 = getelementptr inbounds [128 x i32], [128 x i32]* %9, i64 0, i64 %88
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_5.cpp() #0 section ".text.startup" {
