; ModuleID = 'POJ-104-source/36/36-509.cpp'
source_filename = "POJ-104-source/36/36-509.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_509.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %10 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i8* %7, i8* %9)
...
28:                                               ; preds = %23
  ...
  %35 = call i32 @_Z3maxcPA50_ci(i8 signext %32, [50 x i8]* %33, i32 %34)
  %36 = icmp eq i32 %35, 0
...
define dso_local i32 @_Z3maxcPA50_ci(i8 signext %0, [50 x i8]* %1, i32 %2) #7 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_509.cpp() #0 section ".text.startup" {
