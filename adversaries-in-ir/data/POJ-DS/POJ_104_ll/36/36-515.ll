; ModuleID = 'POJ-104-source/36/36-515.cpp'
source_filename = "POJ-104-source/36/36-515.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_515.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5orderPci(i8* %0, i32 %1) #0 {
  %3 = alloca i8*, align 8
...
57:                                               ; preds = %11
  ...
  %60 = sub nsw i32 %59, 1
  call void @_Z5orderPci(i8* %58, i32 %60)
  br label %61
...
20:                                               ; preds = %0
  ...
  call void @_Z5orderPci(i8* %21, i32 %22)
  %23 = getelementptr inbounds [100 x i8], [100 x i8]* %3, i64 0, i64 0
  %24 = load i32, i32* %4, align 4
  call void @_Z5orderPci(i8* %23, i32 %24)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_515.cpp() #0 section ".text.startup" {
