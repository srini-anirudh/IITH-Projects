; ModuleID = 'POJ-104-source/36/36-542.cpp'
source_filename = "POJ-104-source/36/36-542.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_542.cpp, i8* null }]
...
define dso_local i32 @_Z4thanPcS_(i8* %0, i8* %1) #4 {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
...
21:                                               ; preds = %0
  ...
  %24 = call i32 @_Z4thanPcS_(i8* %22, i8* %23)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_542.cpp() #0 section ".text.startup" {
