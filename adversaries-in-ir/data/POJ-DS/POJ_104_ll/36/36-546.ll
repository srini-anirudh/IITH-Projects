; ModuleID = 'POJ-104-source/36/36-546.cpp'
source_filename = "POJ-104-source/36/36-546.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_546.cpp, i8* null }]
...
define dso_local void @_Z7arrangePci(i8* %0, i32 %1) #4 {
  %3 = alloca i8*, align 8
...
define dso_local i32 @main() #5 {
  ...
  call void @_Z7arrangePci(i8* %15, i32 %16)
  %17 = getelementptr inbounds [100 x i8], [100 x i8]* %3, i64 0, i64 0
  %18 = load i32, i32* %5, align 4
  call void @_Z7arrangePci(i8* %17, i32 %18)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_546.cpp() #0 section ".text.startup" {
