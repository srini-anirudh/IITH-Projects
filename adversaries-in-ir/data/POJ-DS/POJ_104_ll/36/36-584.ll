; ModuleID = 'POJ-104-source/36/36-584.cpp'
source_filename = "POJ-104-source/36/36-584.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_584.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5paixuPci(i8* %0, i32 %1) #0 {
  %3 = alloca i8*, align 8
...
define dso_local i32 @main() #4 {
  ...
  %7 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %5, i8* %6)
  %8 = getelementptr inbounds [100 x i8], [100 x i8]* %2, i64 0, i64 0
  %9 = getelementptr inbounds [100 x i8], [100 x i8]* %2, i64 0, i64 0
  %10 = call i64 @strlen(i8* %9) #6
  %11 = trunc i64 %10 to i32
  call void @_Z5paixuPci(i8* %8, i32 %11)
  ...
  call void @_Z5paixuPci(i8* %12, i32 %15)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_584.cpp() #0 section ".text.startup" {
