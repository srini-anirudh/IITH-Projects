; ModuleID = 'POJ-104-source/36/36-616.cpp'
source_filename = "POJ-104-source/36/36-616.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_616.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %17 = bitcast [58 x i32]* %12 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 16 %17, i8 0, i64 232, i1 false)
...
64:                                               ; preds = %52
  ...
  %73 = getelementptr inbounds [58 x i32], [58 x i32]* %12, i64 0, i64 %72
...
88:                                               ; preds = %76
  ...
  %97 = getelementptr inbounds [58 x i32], [58 x i32]* %12, i64 0, i64 %96
...
116:                                              ; preds = %113
  ...
  %119 = getelementptr inbounds [58 x i32], [58 x i32]* %12, i64 0, i64 %118
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_616.cpp() #0 section ".text.startup" {
