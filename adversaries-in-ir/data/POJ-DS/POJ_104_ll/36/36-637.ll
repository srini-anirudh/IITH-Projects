; ModuleID = 'POJ-104-source/36/36-637.cpp'
source_filename = "POJ-104-source/36/36-637.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_637.cpp, i8* null }]
...
122:                                              ; preds = %119
  ...
  %125 = getelementptr inbounds [30 x i32], [30 x i32]* %4, i64 0, i64 %124
...
132:                                              ; preds = %122
  ...
  %135 = getelementptr inbounds [30 x i32], [30 x i32]* %5, i64 0, i64 %134
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_637.cpp() #0 section ".text.startup" {
