; ModuleID = 'POJ-104-source/36/36-645.cpp'
source_filename = "POJ-104-source/36/36-645.cpp"
...
@leta = dso_local global [57 x %struct.letter] zeroinitializer, align 16
@letb = dso_local global [57 x %struct.letter] zeroinitializer, align 16
@.str = private unnamed_addr constant [6 x i8] c"%s %s\00", align 1
@.str.1 = private unnamed_addr constant [3 x i8] c"NO\00", align 1
@.str.2 = private unnamed_addr constant [4 x i8] c"YES\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_645.cpp, i8* null }]
...
39:                                               ; preds = %10
  ...
  %42 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i8* %40, i8* %41)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_645.cpp() #0 section ".text.startup" {
