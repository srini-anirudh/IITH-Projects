; ModuleID = 'POJ-104-source/36/36-659.cpp'
source_filename = "POJ-104-source/36/36-659.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_659.cpp, i8* null }]
...
define dso_local void @_Z5countPciPi(i8* %0, i32 %1, i32* %2) #4 {
  %4 = alloca i8*, align 8
...
; Function Attrs: noinline uwtable
define dso_local void @_Z7comparePiS_(i32* %0, i32* %1) #0 {
...
define dso_local i32 @main() #5 {
  ...
  %12 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), i8* %10, i8* %11)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_659.cpp() #0 section ".text.startup" {
