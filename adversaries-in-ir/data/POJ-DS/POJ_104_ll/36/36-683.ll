; ModuleID = 'POJ-104-source/36/36-683.cpp'
source_filename = "POJ-104-source/36/36-683.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_683.cpp, i8* null }]
...
59:                                               ; preds = %56
  ...
  %62 = getelementptr inbounds [128 x i32], [128 x i32]* %2, i64 0, i64 %61
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_683.cpp() #0 section ".text.startup" {
