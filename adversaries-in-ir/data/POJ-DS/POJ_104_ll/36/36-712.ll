; ModuleID = 'POJ-104-source/36/36-712.cpp'
source_filename = "POJ-104-source/36/36-712.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_712.cpp, i8* null }]
...
20:                                               ; preds = %10
  ...
  %23 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i8* %21, i8* %22)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_712.cpp() #0 section ".text.startup" {
