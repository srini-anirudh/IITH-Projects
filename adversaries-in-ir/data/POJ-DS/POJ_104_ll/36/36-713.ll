; ModuleID = 'POJ-104-source/36/36-713.cpp'
source_filename = "POJ-104-source/36/36-713.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_713.cpp, i8* null }]
...
define dso_local void @_Z3numPcPiS0_i(i8* %0, i32* %1, i32* %2, i32 %3) #4 {
  %5 = alloca i8*, align 8
...
define dso_local i32 @main() #5 {
  ...
  call void @_Z3numPcPiS0_i(i8* %23, i32* %25, i32* %27, i32 %28)
  ...
  call void @_Z3numPcPiS0_i(i8* %29, i32* %31, i32* %33, i32 %34)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_713.cpp() #0 section ".text.startup" {
