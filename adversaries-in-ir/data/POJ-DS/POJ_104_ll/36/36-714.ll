; ModuleID = 'POJ-104-source/36/36-714.cpp'
source_filename = "POJ-104-source/36/36-714.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_714.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @_Z6changePci(i8* %11, i32 %12)
  %13 = getelementptr inbounds [100 x i8], [100 x i8]* %4, i64 0, i64 0
  %14 = load i32, i32* %2, align 4
  call void @_Z6changePci(i8* %13, i32 %14)
...
define dso_local void @_Z6changePci(i8* %0, i32 %1) #6 {
  %3 = alloca i8*, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_714.cpp() #0 section ".text.startup" {
