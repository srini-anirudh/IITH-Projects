; ModuleID = 'POJ-104-source/36/36-723.cpp'
source_filename = "POJ-104-source/36/36-723.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_723.cpp, i8* null }]
...
21:                                               ; preds = %0
  ...
  call void @_Z4sortPci(i8* %22, i32 %23)
  %24 = getelementptr inbounds [100 x i8], [100 x i8]* %3, i64 0, i64 0
  %25 = load i32, i32* %5, align 4
  call void @_Z4sortPci(i8* %24, i32 %25)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_723.cpp() #0 section ".text.startup" {
