; ModuleID = 'POJ-104-source/36/36-802.cpp'
source_filename = "POJ-104-source/36/36-802.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_802.cpp, i8* null }]
...
109:                                              ; preds = %64
  ...
  %112 = call i32 @strcmp(i8* %110, i8* %111) #6
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_802.cpp() #0 section ".text.startup" {
