; ModuleID = 'POJ-104-source/36/36-835.cpp'
source_filename = "POJ-104-source/36/36-835.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_835.cpp, i8* null }]
...
21:                                               ; preds = %0
  ...
  %24 = call i32 @_Z5checkPcS_(i8* %22, i8* %23)
...
define dso_local i32 @_Z5checkPcS_(i8* %0, i8* %1) #6 {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_835.cpp() #0 section ".text.startup" {
