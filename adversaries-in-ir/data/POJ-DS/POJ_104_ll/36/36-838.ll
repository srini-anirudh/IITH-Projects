; ModuleID = 'POJ-104-source/36/36-838.cpp'
source_filename = "POJ-104-source/36/36-838.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_838.cpp, i8* null }]
...
21:                                               ; preds = %19, %0
  ...
  call void @qsort(i8* %22, i64 %24, i64 1, i32 (i8*, i8*)* @_Z3cmpPKvS0_)
  %25 = getelementptr inbounds [1000 x i8], [1000 x i8]* %3, i64 0, i64 0
  %26 = load i32, i32* %5, align 4
  %27 = sext i32 %26 to i64
  call void @qsort(i8* %25, i64 %27, i64 1, i32 (i8*, i8*)* @_Z3cmpPKvS0_)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_838.cpp() #0 section ".text.startup" {
