; ModuleID = 'POJ-104-source/36/36-84.cpp'
source_filename = "POJ-104-source/36/36-84.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_84.cpp, i8* null }]
...
define dso_local void @_Z4findPiPc(i32* %0, i8* %1) #4 {
...
define dso_local i32 @main() #5 {
  ...
  %11 = getelementptr inbounds [52 x i32], [52 x i32]* %5, i64 0, i64 0
  ...
  call void @_Z4findPiPc(i32* %15, i8* %16)
  %17 = getelementptr inbounds [52 x i32], [52 x i32]* %5, i64 0, i64 0
  %18 = getelementptr inbounds [100 x i8], [100 x i8]* %3, i64 0, i64 0
  call void @_Z4findPiPc(i32* %17, i8* %18)
  store i32 0, i32* %6, align 4
  br label %19
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_84.cpp() #0 section ".text.startup" {
