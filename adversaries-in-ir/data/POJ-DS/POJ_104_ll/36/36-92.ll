; ModuleID = 'POJ-104-source/36/36-92.cpp'
source_filename = "POJ-104-source/36/36-92.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_92.cpp, i8* null }]
...
18:                                               ; preds = %0
  ...
  %20 = call i32 @_Z6changePc(i8* %19)
  %21 = getelementptr inbounds [100 x i8], [100 x i8]* %3, i64 0, i64 0
  %22 = call i32 @_Z6changePc(i8* %21)
...
define dso_local i32 @_Z6changePc(i8* %0) #7 {
  %2 = alloca i8*, align 8
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
  %5 = alloca i8, align 1
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z5judgePiiS_(i32* %0, i32 %1, i32* %2) #7 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_92.cpp() #0 section ".text.startup" {
