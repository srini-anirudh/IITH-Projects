; ModuleID = 'POJ-104-source/36/36-956.cpp'
source_filename = "POJ-104-source/36/36-956.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_956.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %10 = call i32 @_Z9rearrangePcS_(i8* %8, i8* %9)
...
define dso_local i32 @_Z9rearrangePcS_(i8* %0, i8* %1) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_956.cpp() #0 section ".text.startup" {
