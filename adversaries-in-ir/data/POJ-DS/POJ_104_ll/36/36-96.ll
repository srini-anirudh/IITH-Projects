; ModuleID = 'POJ-104-source/36/36-96.cpp'
source_filename = "POJ-104-source/36/36-96.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_96.cpp, i8* null }]
...
68:                                               ; preds = %30
  ...
  %70 = getelementptr inbounds [20 x i8], [20 x i8]* %4, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_96.cpp() #0 section ".text.startup" {
