; ModuleID = 'POJ-104-source/36/36-986.cpp'
source_filename = "POJ-104-source/36/36-986.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_986.cpp, i8* null }]
...
121:                                              ; preds = %71
  ...
  %124 = call i32 @strcmp(i8* %122, i8* %123) #7
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_986.cpp() #0 section ".text.startup" {
