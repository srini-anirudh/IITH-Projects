; ModuleID = 'POJ-104-source/36/36-991.cpp'
source_filename = "POJ-104-source/36/36-991.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_991.cpp, i8* null }]
...
define dso_local void @_Z3delPcc(i8* %0, i8 signext %1) #4 {
  %3 = alloca i8*, align 8
  %4 = alloca i8, align 1
...
30:                                               ; preds = %26
  ...
  call void @_Z3delPcc(i8* %31, i8 signext %35)
  br label %36
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_991.cpp() #0 section ".text.startup" {
