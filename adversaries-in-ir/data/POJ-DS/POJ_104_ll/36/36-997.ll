; ModuleID = 'POJ-104-source/36/36-997.cpp'
source_filename = "POJ-104-source/36/36-997.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_36_997.cpp, i8* null }]
...
191:                                              ; preds = %186
  %192 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0))
  br label %193
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_36_997.cpp() #0 section ".text.startup" {
