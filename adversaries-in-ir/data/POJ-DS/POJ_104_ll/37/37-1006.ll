; ModuleID = 'POJ-104-source/37/37-1006.cpp'
source_filename = "POJ-104-source/37/37-1006.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_37_1006.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %11 = call noalias i8* @malloc(i64 100000) #3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_37_1006.cpp() #0 section ".text.startup" {
