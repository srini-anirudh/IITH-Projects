; ModuleID = 'POJ-104-source/37/37-1122.cpp'
source_filename = "POJ-104-source/37/37-1122.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_37_1122.cpp, i8* null }]
...
17:                                               ; preds = %13
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), [100001 x i8]* %5)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_37_1122.cpp() #0 section ".text.startup" {
