; ModuleID = 'POJ-104-source/37/37-1204.cpp'
source_filename = "POJ-104-source/37/37-1204.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_37_1204.cpp, i8* null }]
...
10:                                               ; preds = %6
  %11 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([100000 x i8], [100000 x i8]* @sz, i64 0, i64 0))
  %12 = call i32 @_Z2zdPc(i8* getelementptr inbounds ([100000 x i8], [100000 x i8]* @sz, i64 0, i64 0))
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z2zdPc(i8* %0) #0 {
  %2 = alloca i32, align 4
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_37_1204.cpp() #0 section ".text.startup" {
