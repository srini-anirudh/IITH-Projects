; ModuleID = 'POJ-104-source/37/37-1408.cpp'
source_filename = "POJ-104-source/37/37-1408.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_37_1408.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z3prov() #0 {
...
define dso_local i32 @main() #6 {
  ...
  %4 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i32* %3)
  store i32 0, i32* %2, align 4
  br label %5
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_37_1408.cpp() #0 section ".text.startup" {
