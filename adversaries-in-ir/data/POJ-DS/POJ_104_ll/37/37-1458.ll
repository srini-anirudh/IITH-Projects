; ModuleID = 'POJ-104-source/37/37-1458.cpp'
source_filename = "POJ-104-source/37/37-1458.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_37_1458.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %11 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* %8)
...
16:                                               ; preds = %12
  store i32 0, i32* %6, align 4
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* %8)
  br label %18
...
38:                                               ; preds = %30, %22
  ...
  %46 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* %8)
  br label %18
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_37_1458.cpp() #0 section ".text.startup" {
