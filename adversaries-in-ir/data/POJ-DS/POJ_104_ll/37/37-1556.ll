; ModuleID = 'POJ-104-source/37/37-1556.cpp'
source_filename = "POJ-104-source/37/37-1556.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_37_1556.cpp, i8* null }]
...
11:                                               ; preds = %7
  ...
  %21 = call signext i8 @_Z5checkPc(i8* %20)
...
define dso_local signext i8 @_Z5checkPc(i8* %0) #5 {
  %2 = alloca i8, align 1
  %3 = alloca i8*, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_37_1556.cpp() #0 section ".text.startup" {
