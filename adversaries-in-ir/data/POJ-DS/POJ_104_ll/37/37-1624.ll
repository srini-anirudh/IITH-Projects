; ModuleID = 'POJ-104-source/37/37-1624.cpp'
source_filename = "POJ-104-source/37/37-1624.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_37_1624.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z6searchv() #0 {
  %1 = alloca i32, align 4
  %2 = alloca i32, align 4
...
20:                                               ; preds = %16
  ...
  %28 = getelementptr inbounds [27 x i32], [27 x i32]* %5, i64 0, i64 %27
...
40:                                               ; preds = %37
  ...
  %43 = getelementptr inbounds [27 x i32], [27 x i32]* %5, i64 0, i64 %42
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_37_1624.cpp() #0 section ".text.startup" {
