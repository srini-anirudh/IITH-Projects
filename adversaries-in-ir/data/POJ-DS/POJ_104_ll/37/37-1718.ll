; ModuleID = 'POJ-104-source/37/37-1718.cpp'
source_filename = "POJ-104-source/37/37-1718.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_37_1718.cpp, i8* null }]
...
16:                                               ; preds = %12
  ...
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), [100000 x i8]* %9)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_37_1718.cpp() #0 section ".text.startup" {
