; ModuleID = 'POJ-104-source/37/37-1790.cpp'
source_filename = "POJ-104-source/37/37-1790.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_37_1790.cpp, i8* null }]
...
24:                                               ; preds = %14
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([100000 x i8], [100000 x i8]* @in, i64 0, i64 0))
  store i32 0, i32* %4, align 4
  br label %26
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_37_1790.cpp() #0 section ".text.startup" {
