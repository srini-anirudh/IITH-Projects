; ModuleID = 'POJ-104-source/37/37-284.cpp'
source_filename = "POJ-104-source/37/37-284.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_37_284.cpp, i8* null }]
...
38:                                               ; preds = %28
  store i32 0, i32* %7, align 4
  %39 = getelementptr inbounds [100001 x i8], [100001 x i8]* %2, i64 0, i64 0
  %40 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSi7getlineEPclc(%"class.std::basic_istream"* @_ZSt3cin, i8* %39, i64 100001, i8 signext 10)
...
48:                                               ; preds = %44
  ...
  %57 = getelementptr inbounds [27 x i32], [27 x i32]* %9, i64 0, i64 %56
...
67:                                               ; preds = %64
  ...
  %70 = getelementptr inbounds [27 x i32], [27 x i32]* %9, i64 0, i64 %69
...
88:                                               ; preds = %84
  ...
  %97 = getelementptr inbounds [27 x i32], [27 x i32]* %9, i64 0, i64 %96
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_37_284.cpp() #0 section ".text.startup" {
