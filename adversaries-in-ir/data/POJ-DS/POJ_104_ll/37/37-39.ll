; ModuleID = 'POJ-104-source/37/37-39.cpp'
source_filename = "POJ-104-source/37/37-39.cpp"
...
@bucket = dso_local global [26 x i32] zeroinitializer, align 16
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_37_39.cpp, i8* null }]
...
18:                                               ; preds = %8
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([100001 x i8], [100001 x i8]* @s, i64 0, i64 0))
  br label %20
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_37_39.cpp() #0 section ".text.startup" {
