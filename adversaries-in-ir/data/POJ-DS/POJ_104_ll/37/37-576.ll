; ModuleID = 'POJ-104-source/37/37-576.cpp'
source_filename = "POJ-104-source/37/37-576.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_37_576.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @llvm.memset.p0i8.i64(i8* align 16 %10, i8 0, i64 100001, i1 false)
...
35:                                               ; preds = %18
  %36 = getelementptr inbounds [100001 x i8], [100001 x i8]* %2, i64 0, i64 0
...
55:                                               ; preds = %48
  ...
  %64 = getelementptr inbounds [27 x i32], [27 x i32]* %4, i64 0, i64 %63
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_37_576.cpp() #0 section ".text.startup" {
