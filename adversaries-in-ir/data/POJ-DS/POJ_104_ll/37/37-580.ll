; ModuleID = 'POJ-104-source/37/37-580.cpp'
source_filename = "POJ-104-source/37/37-580.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_37_580.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  call void @llvm.memset.p0i8.i64(i8* align 16 %21, i8 0, i64 108, i1 false)
...
32:                                               ; preds = %28
  ...
  %44 = getelementptr inbounds [27 x i32], [27 x i32]* %7, i64 0, i64 %43
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_37_580.cpp() #0 section ".text.startup" {
