; ModuleID = 'POJ-104-source/37/37-98.cpp'
source_filename = "POJ-104-source/37/37-98.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_37_98.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %12 = bitcast [100000 x i8]* %10 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_37_98.cpp() #0 section ".text.startup" {
