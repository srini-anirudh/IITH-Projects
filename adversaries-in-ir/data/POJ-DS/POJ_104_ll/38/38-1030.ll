; ModuleID = 'POJ-104-source/38/38-1030.cpp'
source_filename = "POJ-104-source/38/38-1030.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_38_1030.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), double* %6)
...
22:                                               ; preds = %17
  ...
  %35 = getelementptr inbounds [101 x double*], [101 x double*]* %5, i64 0, i64 %34
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_38_1030.cpp() #0 section ".text.startup" {
