; ModuleID = 'POJ-104-source/38/38-1166.cpp'
source_filename = "POJ-104-source/38/38-1166.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_38_1166.cpp, i8* null }]
...
define dso_local double @_Z1fiPPd(i32 %0, double** %1) #4 {
...
51:                                               ; preds = %37
  ...
  %54 = call double @_Z1fiPPd(i32 %52, double** %53)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_38_1166.cpp() #0 section ".text.startup" {
