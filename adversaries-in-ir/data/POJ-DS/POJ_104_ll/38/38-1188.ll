; ModuleID = 'POJ-104-source/38/38-1188.cpp'
source_filename = "POJ-104-source/38/38-1188.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_38_1188.cpp, i8* null }]
...
68:                                               ; preds = %43
  ...
  %75 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEPFRSt8ios_baseS0_E(%"class.std::basic_ostream"* %74, %"class.std::ios_base"* (%"class.std::ios_base"*)* @_ZSt9showpointRSt8ios_base)
...
; Function Attrs: noinline uwtable
define linkonce_odr dso_local dereferenceable(216) %"class.std::ios_base"* @_ZSt9showpointRSt8ios_base(%"class.std::ios_base"* dereferenceable(216) %0) #0 comdat {
  %2 = alloca %"class.std::ios_base"*, align 8
  store %"class.std::ios_base"* %0, %"class.std::ios_base"** %2, align 8
  %3 = load %"class.std::ios_base"*, %"class.std::ios_base"** %2, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_38_1188.cpp() #0 section ".text.startup" {
