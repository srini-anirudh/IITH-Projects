; ModuleID = 'POJ-104-source/38/38-1219.cpp'
source_filename = "POJ-104-source/38/38-1219.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_38_1219.cpp, i8* null }]
...
13:                                               ; preds = %10
  ...
  %16 = getelementptr inbounds [1000 x double*], [1000 x double*]* %9, i64 0, i64 0
...
37:                                               ; preds = %32
  %38 = getelementptr inbounds [1000 x double*], [1000 x double*]* %9, i64 0, i64 0
  %39 = load i32, i32* %3, align 4
  %40 = sext i32 %39 to i64
  %41 = getelementptr inbounds double*, double** %38, i64 %40
  %42 = load double*, double** %41, align 8
  %43 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), double* %42)
  br label %44
...
53:                                               ; preds = %48
  ...
  %55 = getelementptr inbounds [1000 x double*], [1000 x double*]* %9, i64 0, i64 0
...
75:                                               ; preds = %70
  ...
  %77 = getelementptr inbounds [1000 x double*], [1000 x double*]* %9, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_38_1219.cpp() #0 section ".text.startup" {
