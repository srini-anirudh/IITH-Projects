; ModuleID = 'POJ-104-source/38/38-124.cpp'
source_filename = "POJ-104-source/38/38-124.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_38_124.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z1fPdd(double* %0, double %1) #0 {
...
12:                                               ; preds = %8
  ...
  call void @_Z1fPdd(double* %16, double %17)
  br label %18
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_38_124.cpp() #0 section ".text.startup" {
