; ModuleID = 'POJ-104-source/38/38-1256.cpp'
source_filename = "POJ-104-source/38/38-1256.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_38_1256.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local double @_Z7fangchaPdi(double* %0, i32 %1) #0 {
...
12:                                               ; preds = %8
  %13 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i32* %3)
...
28:                                               ; preds = %16
  ...
  %32 = call double @_Z7fangchaPdi(double* %30, i32 %31)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_38_1256.cpp() #0 section ".text.startup" {
