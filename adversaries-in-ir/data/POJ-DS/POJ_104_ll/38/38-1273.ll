; ModuleID = 'POJ-104-source/38/38-1273.cpp'
source_filename = "POJ-104-source/38/38-1273.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_38_1273.cpp, i8* null }]
...
28:                                               ; preds = %12
  %29 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %4)
...
34:                                               ; preds = %30
  %35 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %5)
...
40:                                               ; preds = %36
  ...
  %44 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), double* %43)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_38_1273.cpp() #0 section ".text.startup" {
