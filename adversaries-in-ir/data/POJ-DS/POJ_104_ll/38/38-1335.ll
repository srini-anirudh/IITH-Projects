; ModuleID = 'POJ-104-source/38/38-1335.cpp'
source_filename = "POJ-104-source/38/38-1335.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_38_1335.cpp, i8* null }]
...
41:                                               ; preds = %37
  ...
  %49 = getelementptr inbounds [100 x double*], [100 x double*]* %7, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_38_1335.cpp() #0 section ".text.startup" {
