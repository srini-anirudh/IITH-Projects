; ModuleID = 'POJ-104-source/38/38-1345.cpp'
source_filename = "POJ-104-source/38/38-1345.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_38_1345.cpp, i8* null }]
...
define dso_local double @_Z4averiPd(i32 %0, double* %1) #4 {
...
; Function Attrs: noinline uwtable
define dso_local double @_Z1siPd(i32 %0, double* %1) #0 {
  %3 = alloca i32, align 4
  %4 = alloca double*, align 8
  %5 = alloca i32, align 4
  %6 = alloca double, align 8
  ...
  %11 = call double @_Z4averiPd(i32 %9, double* %10)
...
27:                                               ; preds = %15
  ...
  %30 = call double @_Z1siPd(i32 %28, double* %29)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_38_1345.cpp() #0 section ".text.startup" {
