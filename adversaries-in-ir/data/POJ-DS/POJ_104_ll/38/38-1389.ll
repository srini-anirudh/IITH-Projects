; ModuleID = 'POJ-104-source/38/38-1389.cpp'
source_filename = "POJ-104-source/38/38-1389.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_38_1389.cpp, i8* null }]
...
35:                                               ; preds = %31
  ...
  %42 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), double* %41)
  br label %43
...
145:                                              ; preds = %132
  %146 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %11)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_38_1389.cpp() #0 section ".text.startup" {
