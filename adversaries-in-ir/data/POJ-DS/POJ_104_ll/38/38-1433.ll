; ModuleID = 'POJ-104-source/38/38-1433.cpp'
source_filename = "POJ-104-source/38/38-1433.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_38_1433.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %17 = call noalias i8* @calloc(i64 150, i64 8) #3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_38_1433.cpp() #0 section ".text.startup" {
