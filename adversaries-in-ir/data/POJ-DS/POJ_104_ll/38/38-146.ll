; ModuleID = 'POJ-104-source/38/38-146.cpp'
source_filename = "POJ-104-source/38/38-146.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_38_146.cpp, i8* null }]
...
8:                                                ; preds = %4
  ...
  %11 = getelementptr inbounds double, double* getelementptr inbounds ([1001 x double], [1001 x double]* @x, i64 0, i64 0), i64 %10
  %12 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), double* %11)
  %13 = load i32, i32* %3, align 4
  %14 = sext i32 %13 to i64
  %15 = getelementptr inbounds double, double* getelementptr inbounds ([1001 x double], [1001 x double]* @x, i64 0, i64 0), i64 %14
...
27:                                               ; preds = %23
  ...
  %30 = getelementptr inbounds double, double* getelementptr inbounds ([1001 x double], [1001 x double]* @x, i64 0, i64 0), i64 %29
...
43:                                               ; preds = %23
  ...
  store double %47, double* @S, align 8
  %48 = load double, double* @S, align 8
  %49 = call double @sqrt(double %48) #3
  store double %49, double* @S, align 8
  call void @llvm.trap()
  unreachable
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_38_146.cpp() #0 section ".text.startup" {
