; ModuleID = 'POJ-104-source/38/38-1462.cpp'
source_filename = "POJ-104-source/38/38-1462.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_38_1462.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local double @_Z1sPddiS_(double* %0, double %1, i32 %2, double* %3) #0 {
...
10:                                               ; preds = %27, %4
  ...
  %16 = call double @_ZSt3powIdiEN9__gnu_cxx11__promote_2IT_T0_NS0_9__promoteIS2_Xsr3std12__is_integerIS2_EE7__valueEE6__typeENS4_IS3_Xsr3std12__is_integerIS3_EE7__valueEE6__typeEE6__typeES2_S3_(double %15, i32 2)
...
18:                                               ; preds = %14
  ...
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %5)
...
47:                                               ; preds = %45
  ...
  %57 = call double @_Z1sPddiS_(double* %53, double %54, i32 %55, double* %56)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_38_1462.cpp() #0 section ".text.startup" {
