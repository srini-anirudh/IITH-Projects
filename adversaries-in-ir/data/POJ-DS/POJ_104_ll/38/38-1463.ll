; ModuleID = 'POJ-104-source/38/38-1463.cpp'
source_filename = "POJ-104-source/38/38-1463.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_38_1463.cpp, i8* null }]
...
19:                                               ; preds = %15
  %20 = getelementptr inbounds [1000 x double], [1000 x double]* %13, i64 0, i64 0
...
38:                                               ; preds = %22
  ...
  %43 = getelementptr inbounds [1000 x double], [1000 x double]* %13, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_38_1463.cpp() #0 section ".text.startup" {
