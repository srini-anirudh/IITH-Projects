; ModuleID = 'POJ-104-source/38/38-1478.cpp'
source_filename = "POJ-104-source/38/38-1478.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_38_1478.cpp, i8* null }]
...
18:                                               ; preds = %14
  store double 0.000000e+00, double* %7, align 8
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i32* %2)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_38_1478.cpp() #0 section ".text.startup" {
