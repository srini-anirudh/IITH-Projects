; ModuleID = 'POJ-104-source/38/38-1481.cpp'
source_filename = "POJ-104-source/38/38-1481.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_38_1481.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %3)
...
33:                                               ; preds = %26
  ...
  %36 = getelementptr inbounds [100 x [1000 x double]], [100 x [1000 x double]]* %2, i64 0, i64 %35
...
61:                                               ; preds = %54
  ...
  %64 = getelementptr inbounds [100 x [1000 x double]], [100 x [1000 x double]]* %2, i64 0, i64 %63
...
98:                                               ; preds = %91
  ...
  %101 = getelementptr inbounds [100 x [1000 x double]], [100 x [1000 x double]]* %2, i64 0, i64 %100
  ...
  %111 = call double @_ZSt3powIdiEN9__gnu_cxx11__promote_2IT_T0_NS0_9__promoteIS2_Xsr3std12__is_integerIS2_EE7__valueEE6__typeENS4_IS3_Xsr3std12__is_integerIS3_EE7__valueEE6__typeEE6__typeES2_S3_(double %110, i32 2)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_38_1481.cpp() #0 section ".text.startup" {
