; ModuleID = 'POJ-104-source/38/38-1514.cpp'
source_filename = "POJ-104-source/38/38-1514.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_38_1514.cpp, i8* null }]
...
16:                                               ; preds = %12
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i32* %4)
...
22:                                               ; preds = %18
  ...
  %26 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), double* %25)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_38_1514.cpp() #0 section ".text.startup" {
