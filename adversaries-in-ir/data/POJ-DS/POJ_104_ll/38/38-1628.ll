; ModuleID = 'POJ-104-source/38/38-1628.cpp'
source_filename = "POJ-104-source/38/38-1628.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_38_1628.cpp, i8* null }]
...
37:                                               ; preds = %29
  ...
  %44 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), double* %43)
  br label %45
...
48:                                               ; preds = %29
  ...
  %59 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), double* %58)
  br label %60
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_38_1628.cpp() #0 section ".text.startup" {
