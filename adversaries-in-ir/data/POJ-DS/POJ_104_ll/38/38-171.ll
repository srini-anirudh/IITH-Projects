; ModuleID = 'POJ-104-source/38/38-171.cpp'
source_filename = "POJ-104-source/38/38-171.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_38_171.cpp, i8* null }]
...
46:                                               ; preds = %42
  ...
  %56 = call double @_Z7fangchaPdi(double* %51, i32 %55)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_38_171.cpp() #0 section ".text.startup" {
