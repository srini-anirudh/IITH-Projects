; ModuleID = 'POJ-104-source/38/38-1717.cpp'
source_filename = "POJ-104-source/38/38-1717.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_38_1717.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %17 = call noalias i8* @malloc(i64 8000) #3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_38_1717.cpp() #0 section ".text.startup" {
