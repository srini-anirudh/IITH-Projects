; ModuleID = 'POJ-104-source/38/38-1739.cpp'
source_filename = "POJ-104-source/38/38-1739.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_38_1739.cpp, i8* null }]
...
28:                                               ; preds = %16
  ...
  %31 = call double @_Z5equalPdi(double* %29, i32 %30)
...
define dso_local double @_Z5equalPdi(double* %0, i32 %1) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_38_1739.cpp() #0 section ".text.startup" {
