; ModuleID = 'POJ-104-source/38/38-177.cpp'
source_filename = "POJ-104-source/38/38-177.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_38_177.cpp, i8* null }]
...
define dso_local void @_Z1fPdid(double* %0, i32 %1, double %2) #4 {
...
33:                                               ; preds = %15
  ...
  call void @_Z1fPdid(double* %38, i32 %39, double %40)
  store double 0.000000e+00, double* %7, align 8
  store i32 0, i32* %5, align 4
  br label %41
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_38_177.cpp() #0 section ".text.startup" {
