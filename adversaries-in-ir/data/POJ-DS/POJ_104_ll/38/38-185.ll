; ModuleID = 'POJ-104-source/38/38-185.cpp'
source_filename = "POJ-104-source/38/38-185.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_38_185.cpp, i8* null }]
...
34:                                               ; preds = %32, %28
  ...
  %38 = call double @_Z7fangchaPdid(double* %35, i32 %36, double %37)
...
define dso_local double @_Z7fangchaPdid(double* %0, i32 %1, double %2) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_38_185.cpp() #0 section ".text.startup" {
