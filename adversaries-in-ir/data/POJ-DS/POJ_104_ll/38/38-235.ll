; ModuleID = 'POJ-104-source/38/38-235.cpp'
source_filename = "POJ-104-source/38/38-235.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_38_235.cpp, i8* null }]
...
23:                                               ; preds = %19
  %24 = getelementptr inbounds [1010 x double], [1010 x double]* %4, i64 0, i64 0
  ...
  %30 = getelementptr inbounds [1010 x double], [1010 x double]* %4, i64 0, i64 0
...
48:                                               ; preds = %44
  ...
  %50 = getelementptr inbounds [1010 x double], [1010 x double]* %4, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_38_235.cpp() #0 section ".text.startup" {
