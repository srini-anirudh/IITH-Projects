; ModuleID = 'POJ-104-source/38/38-27.cpp'
source_filename = "POJ-104-source/38/38-27.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_38_27.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %11 = getelementptr inbounds [1000 x double], [1000 x double]* %6, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_38_27.cpp() #0 section ".text.startup" {
