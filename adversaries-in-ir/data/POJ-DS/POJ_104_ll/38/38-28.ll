; ModuleID = 'POJ-104-source/38/38-28.cpp'
source_filename = "POJ-104-source/38/38-28.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_38_28.cpp, i8* null }]
...
45:                                               ; preds = %41
  ...
  %54 = call double @_Z1fPdi(double* %49, i32 %53)
...
; Function Attrs: noinline uwtable
define dso_local double @_Z1fPdi(double* %0, i32 %1) #0 {
  ...
  %10 = call double @_Z3sumPdi(double* %8, i32 %9)
...
define dso_local double @_Z3sumPdi(double* %0, i32 %1) #5 {
  %3 = alloca double*, align 8
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca double, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_38_28.cpp() #0 section ".text.startup" {
