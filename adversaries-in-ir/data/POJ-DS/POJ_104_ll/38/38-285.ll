; ModuleID = 'POJ-104-source/38/38-285.cpp'
source_filename = "POJ-104-source/38/38-285.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_38_285.cpp, i8* null }]
...
36:                                               ; preds = %28
  ...
  %40 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), double* %39)
  br label %41
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_38_285.cpp() #0 section ".text.startup" {
