; ModuleID = 'POJ-104-source/38/38-552.cpp'
source_filename = "POJ-104-source/38/38-552.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_38_552.cpp, i8* null }]
...
51:                                               ; preds = %47
  ...
  %57 = fsub float %55, %56
  %58 = call double @_ZSt3powIfiEN9__gnu_cxx11__promote_2IT_T0_NS0_9__promoteIS2_Xsr3std12__is_integerIS2_EE7__valueEE6__typeENS4_IS3_Xsr3std12__is_integerIS3_EE7__valueEE6__typeEE6__typeES2_S3_(float %57, i32 2)
...
64:                                               ; preds = %47
  ...
  %70 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.2, i64 0, i64 0), double %69)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_38_552.cpp() #0 section ".text.startup" {
