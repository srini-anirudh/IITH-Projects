; ModuleID = 'POJ-104-source/38/38-599.cpp'
source_filename = "POJ-104-source/38/38-599.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_38_599.cpp, i8* null }]
...
20:                                               ; preds = %16
  ...
  %27 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), double* %26)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_38_599.cpp() #0 section ".text.startup" {
