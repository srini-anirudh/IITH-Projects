; ModuleID = 'POJ-104-source/38/38-605.cpp'
source_filename = "POJ-104-source/38/38-605.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_38_605.cpp, i8* null }]
...
18:                                               ; preds = %14
  ...
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i32* %3)
...
24:                                               ; preds = %20
  ...
  %31 = getelementptr inbounds [1000 x float], [1000 x float]* %7, i64 0, i64 %30
...
88:                                               ; preds = %84
  ...
  %93 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i64 0, i64 0), double %92)
  br label %94
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_38_605.cpp() #0 section ".text.startup" {
