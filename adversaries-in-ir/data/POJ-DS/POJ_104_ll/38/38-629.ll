; ModuleID = 'POJ-104-source/38/38-629.cpp'
source_filename = "POJ-104-source/38/38-629.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_38_629.cpp, i8* null }]
...
70:                                               ; preds = %66
  %71 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %3)
  store i32 0, i32* %5, align 4
  br label %72
...
76:                                               ; preds = %72
  ...
  %83 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), double* %82)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_38_629.cpp() #0 section ".text.startup" {
