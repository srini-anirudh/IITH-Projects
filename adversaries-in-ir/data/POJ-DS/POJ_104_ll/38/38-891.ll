; ModuleID = 'POJ-104-source/38/38-891.cpp'
source_filename = "POJ-104-source/38/38-891.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_38_891.cpp, i8* null }]
...
16:                                               ; preds = %12
  ...
  %18 = call noalias i8* @calloc(i64 100, i64 8) #3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_38_891.cpp() #0 section ".text.startup" {
