; ModuleID = 'POJ-104-source/38/38-983.cpp'
source_filename = "POJ-104-source/38/38-983.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_38_983.cpp, i8* null }]
...
define dso_local double @_Z7averageiPd(i32 %0, double* %1) #4 {
...
; Function Attrs: noinline uwtable
define dso_local double @_Z7fangchaiPd(i32 %0, double* %1) #0 {
  %3 = alloca i32, align 4
  %4 = alloca double*, align 8
  %5 = alloca double*, align 8
  %6 = alloca double, align 8
...
15:                                               ; preds = %8
  ...
  %20 = call double @_Z7averageiPd(i32 %18, double* %19)
...
33:                                               ; preds = %20
  ...
  %36 = call double @_Z7fangchaiPd(i32 %34, double* %35)
  %37 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0), double %36)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_38_983.cpp() #0 section ".text.startup" {
