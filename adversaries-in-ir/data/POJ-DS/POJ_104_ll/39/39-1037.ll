; ModuleID = 'POJ-104-source/39/39-1037.cpp'
source_filename = "POJ-104-source/39/39-1037.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1037.cpp, i8* null }]
...
18:                                               ; preds = %14
  ...
  %26 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), i8* %25, i32* %4, i32* %5, i8* %10, i8* %11, i32* %6)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1037.cpp() #0 section ".text.startup" {
