; ModuleID = 'POJ-104-source/39/39-104.cpp'
source_filename = "POJ-104-source/39/39-104.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_104.cpp, i8* null }]
...
155:                                              ; preds = %43
  %156 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %7, i64 0, i64 0
...
198:                                              ; preds = %183
  ...
  %206 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %7, i64 0, i64 %205
  %207 = getelementptr inbounds %struct.student, %struct.student* %206, i32 0, i32 6
  %208 = load i32, i32* %207, align 4
  %209 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0), i8* %203, i32 %208)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_104.cpp() #0 section ".text.startup" {
