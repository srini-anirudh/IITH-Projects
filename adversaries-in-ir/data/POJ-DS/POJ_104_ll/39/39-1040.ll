; ModuleID = 'POJ-104-source/39/39-1040.cpp'
source_filename = "POJ-104-source/39/39-1040.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1040.cpp, i8* null }]
...
19:                                               ; preds = %15
  ...
  %23 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i64 0, i64 0), i8* %20, i32* %7, i32* %8, i8* %21, i8* %22, i32* %9)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1040.cpp() #0 section ".text.startup" {
