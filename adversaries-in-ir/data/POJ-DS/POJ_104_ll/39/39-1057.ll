; ModuleID = 'POJ-104-source/39/39-1057.cpp'
source_filename = "POJ-104-source/39/39-1057.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1057.cpp, i8* null }]
...
20:                                               ; preds = %16
  ...
  %45 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), [50 x i8]* %24, i32* %28, i32* %32, i8* %36, i8* %40, i32* %44)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1057.cpp() #0 section ".text.startup" {
