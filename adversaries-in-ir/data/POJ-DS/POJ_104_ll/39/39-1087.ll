; ModuleID = 'POJ-104-source/39/39-1087.cpp'
source_filename = "POJ-104-source/39/39-1087.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1087.cpp, i8* null }]
...
14:                                               ; preds = %10
  ...
  %39 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i64 0, i64 0), [20 x i8]* %18, i32* %22, i32* %26, i8* %30, i8* %34, i32* %38)
  br label %40
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1087.cpp() #0 section ".text.startup" {
