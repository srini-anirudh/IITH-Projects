; ModuleID = 'POJ-104-source/39/39-1103.cpp'
source_filename = "POJ-104-source/39/39-1103.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1103.cpp, i8* null }]
...
41:                                               ; preds = %37
  ...
  %60 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i64 0, i64 0), [30 x i8]* %44, i32* %47, i32* %50, [10 x i8]* %53, [10 x i8]* %56, i32* %59)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1103.cpp() #0 section ".text.startup" {
