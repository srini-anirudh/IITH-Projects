; ModuleID = 'POJ-104-source/39/39-1107.cpp'
source_filename = "POJ-104-source/39/39-1107.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1107.cpp, i8* null }]
...
13:                                               ; preds = %9
  ...
  %45 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i64 0, i64 0), i8* %22, i32* %26, i32* %30, i8* %35, i8* %40, i32* %44)
...
192:                                              ; preds = %179
  ...
  %201 = getelementptr inbounds [100 x %struct.anon], [100 x %struct.anon]* %2, i64 0, i64 %200
  %202 = load i32, i32* %6, align 4
  %203 = sext i32 %202 to i64
  %204 = getelementptr inbounds [100 x %struct.anon], [100 x %struct.anon]* %2, i64 0, i64 %203
  %205 = bitcast %struct.anon* %204 to i8*
  %206 = bitcast %struct.anon* %201 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1107.cpp() #0 section ".text.startup" {
