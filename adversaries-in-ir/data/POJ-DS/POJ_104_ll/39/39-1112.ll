; ModuleID = 'POJ-104-source/39/39-1112.cpp'
source_filename = "POJ-104-source/39/39-1112.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1112.cpp, i8* null }]
...
23:                                               ; preds = %19
  ...
  %45 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i64 0, i64 0), i8* %27, i32* %30, i32* %33, i8* %37, i8* %41, i32* %44)
  br label %46
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1112.cpp() #0 section ".text.startup" {
