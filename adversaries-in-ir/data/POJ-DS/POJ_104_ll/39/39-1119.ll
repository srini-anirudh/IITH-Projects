; ModuleID = 'POJ-104-source/39/39-1119.cpp'
source_filename = "POJ-104-source/39/39-1119.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1119.cpp, i8* null }]
...
define dso_local i32 @main(i32 %0, i8** %1) #4 {
  ...
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %12)
...
24:                                               ; preds = %20
  ...
  %31 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i64 0, i64 0), i8* %28, i32* %9, i32* %10, i8* %29, i8* %30, i32* %11)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1119.cpp() #0 section ".text.startup" {
