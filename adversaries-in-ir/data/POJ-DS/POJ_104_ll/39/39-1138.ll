; ModuleID = 'POJ-104-source/39/39-1138.cpp'
source_filename = "POJ-104-source/39/39-1138.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1138.cpp, i8* null }]
...
33:                                               ; preds = %29
  ...
  %58 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), [20 x i8]* %37, i32* %41, i32* %45, i8* %49, i8* %53, i32* %57)
  br label %59
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1138.cpp() #0 section ".text.startup" {
