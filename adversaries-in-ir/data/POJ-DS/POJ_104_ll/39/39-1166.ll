; ModuleID = 'POJ-104-source/39/39-1166.cpp'
source_filename = "POJ-104-source/39/39-1166.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1166.cpp, i8* null }]
...
19:                                               ; preds = %15
  ...
  %38 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), [21 x i8]* %22, i32* %25, i32* %28, i8* %31, i8* %34, i32* %37)
  br label %39
...
152:                                              ; preds = %145
  ...
  %162 = call i8* @strcpy(i8* %157, i8* %161) #3
  br label %163
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1166.cpp() #0 section ".text.startup" {
