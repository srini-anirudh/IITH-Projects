; ModuleID = 'POJ-104-source/39/39-1210.cpp'
source_filename = "POJ-104-source/39/39-1210.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1210.cpp, i8* null }]
...
22:                                               ; preds = %18
  ...
  %28 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.2, i64 0, i64 0), i32* %5, i32* %6, i8* %3, i8* %4, i32* %7)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1210.cpp() #0 section ".text.startup" {
