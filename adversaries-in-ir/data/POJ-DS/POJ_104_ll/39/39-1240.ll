; ModuleID = 'POJ-104-source/39/39-1240.cpp'
source_filename = "POJ-104-source/39/39-1240.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1240.cpp, i8* null }]
...
define dso_local i32 @_Z5awardP7student(%struct.student* %0) #4 {
...
14:                                               ; preds = %10
  ...
  %50 = call i32 @_Z5awardP7student(%struct.student* %49)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1240.cpp() #0 section ".text.startup" {
