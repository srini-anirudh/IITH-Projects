; ModuleID = 'POJ-104-source/39/39-1256.cpp'
source_filename = "POJ-104-source/39/39-1256.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1256.cpp, i8* null }]
...
15:                                               ; preds = %76, %0
  ...
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), i8* %16, i32* %4, i32* %5, i8* %12, i8* %13, i32* %6)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1256.cpp() #0 section ".text.startup" {
