; ModuleID = 'POJ-104-source/39/39-128.cpp'
source_filename = "POJ-104-source/39/39-128.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_128.cpp, i8* null }]
...
21:                                               ; preds = %17
  ...
  %26 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), i8* %25, i32* %10, i32* %11, i8* %3, i8* %4, i32* %15)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_128.cpp() #0 section ".text.startup" {
