; ModuleID = 'POJ-104-source/39/39-1287.cpp'
source_filename = "POJ-104-source/39/39-1287.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1287.cpp, i8* null }]
...
17:                                               ; preds = %13
  ...
  %46 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i64 0, i64 0), [21 x i8]* %25, i32* %29, i32* %33, i8* %37, i8* %41, i32* %45)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1287.cpp() #0 section ".text.startup" {
