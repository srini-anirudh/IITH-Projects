; ModuleID = 'POJ-104-source/39/39-1302.cpp'
source_filename = "POJ-104-source/39/39-1302.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1302.cpp, i8* null }]
...
23:                                               ; preds = %19
  ...
  %35 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), i32* %31, i32* %34)
  ...
  %42 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.3, i64 0, i64 0), i8* %38, i8* %41)
  %43 = load i32, i32* %7, align 4
  %44 = sext i32 %43 to i64
  %45 = getelementptr inbounds [100 x i32], [100 x i32]* %12, i64 0, i64 %44
  %46 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.4, i64 0, i64 0), i32* %45)
  br label %47
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1302.cpp() #0 section ".text.startup" {
