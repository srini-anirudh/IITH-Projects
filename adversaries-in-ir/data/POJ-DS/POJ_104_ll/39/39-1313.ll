; ModuleID = 'POJ-104-source/39/39-1313.cpp'
source_filename = "POJ-104-source/39/39-1313.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1313.cpp, i8* null }]
...
20:                                               ; preds = %16
  ...
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i64 0, i64 0), [20 x i8]* %23, i32* %7, i32* %8, [2 x i8]* %9, [2 x i8]* %10, i32* %11)
...
60:                                               ; preds = %57
  ...
  %62 = call i32 @strcmp(i8* %61, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0)) #7
  %63 = icmp eq i32 %62, 0
...
73:                                               ; preds = %70
  ...
  %75 = call i32 @strcmp(i8* %74, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0)) #7
  %76 = icmp eq i32 %75, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1313.cpp() #0 section ".text.startup" {
