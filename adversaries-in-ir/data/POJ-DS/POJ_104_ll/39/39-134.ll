; ModuleID = 'POJ-104-source/39/39-134.cpp'
source_filename = "POJ-104-source/39/39-134.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_134.cpp, i8* null }]
...
190:                                              ; preds = %179
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 getelementptr inbounds (%struct.student, %struct.student* @t, i32 0, i32 0, i32 0), i8* align 4 %194, i64 36, i1 false)
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %202, i8* align 4 %203, i64 36, i1 false)
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %208, i8* align 4 getelementptr inbounds (%struct.student, %struct.student* @t, i32 0, i32 0, i32 0), i64 36, i1 false)
...
234:                                              ; preds = %166
  ...
  %237 = getelementptr inbounds [20 x i8], [20 x i8]* %9, i64 0, i64 0
  %238 = call i8* @strcpy(i8* %237, i8* getelementptr inbounds ([100 x %struct.student], [100 x %struct.student]* @stu, i64 0, i64 0, i32 0, i64 0)) #3
  store i32 0, i32* %3, align 4
  br label %239
...
253:                                              ; preds = %239
  ...
  %255 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i8* %254)
  %256 = load i32, i32* %5, align 4
  %257 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i64 0, i64 0), i32 %256)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_134.cpp() #0 section ".text.startup" {
