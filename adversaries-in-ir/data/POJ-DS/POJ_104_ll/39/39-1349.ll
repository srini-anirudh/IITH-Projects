; ModuleID = 'POJ-104-source/39/39-1349.cpp'
source_filename = "POJ-104-source/39/39-1349.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1349.cpp, i8* null }]
...
176:                                              ; preds = %43
  store i32 0, i32* %3, align 4
  %177 = load i32, i32* getelementptr inbounds ([100 x %struct.student], [100 x %struct.student]* @stu, i64 0, i64 0, i32 6), align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1349.cpp() #0 section ".text.startup" {
