; ModuleID = 'POJ-104-source/39/39-139.cpp'
source_filename = "POJ-104-source/39/39-139.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_139.cpp, i8* null }]
...
112:                                              ; preds = %105
  ...
  %115 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %7, i64 0, i64 %114
...
138:                                              ; preds = %131
  ...
  %141 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %7, i64 0, i64 %140
...
172:                                              ; preds = %157
  ...
  %178 = getelementptr inbounds [20 x i8], [20 x i8]* %6, i64 0, i64 0
...
189:                                              ; preds = %9
  %190 = getelementptr inbounds [20 x i8], [20 x i8]* %6, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_139.cpp() #0 section ".text.startup" {
