; ModuleID = 'POJ-104-source/39/39-140.cpp'
source_filename = "POJ-104-source/39/39-140.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_140.cpp, i8* null }]
...
40:                                               ; preds = %27
  ...
  %68 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i64 0, i64 0), i32* %51, i32* %55, i8* %59, i8* %63, i32* %67)
...
211:                                              ; preds = %197
  ...
  %245 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.2, i64 0, i64 0), i32* %224, i32* %229, i8* %234, i8* %239, i32* %244)
...
374:                                              ; preds = %363, %354, %346
  ...
  %390 = call i8* @strcpy(i8* %383, i8* %389) #3
...
410:                                              ; preds = %402
  ...
  %418 = call i8* @strcpy(i8* %412, i8* %417) #3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_140.cpp() #0 section ".text.startup" {
