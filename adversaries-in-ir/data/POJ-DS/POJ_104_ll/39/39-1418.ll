; ModuleID = 'POJ-104-source/39/39-1418.cpp'
source_filename = "POJ-104-source/39/39-1418.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1418.cpp, i8* null }]
...
13:                                               ; preds = %9
  ...
  %39 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i64 0, i64 0), i8* %18, i32* %22, i32* %26, i8* %30, i8* %34, i32* %38)
...
109:                                              ; preds = %102
  ...
  %115 = fadd float %114, 2.000000e+03
...
135:                                              ; preds = %127
  ...
  %141 = fadd float %140, 1.000000e+03
...
161:                                              ; preds = %153
  ...
  %167 = fadd float %166, 8.500000e+02
  %168 = load i32, i32* %3, align 4
  %169 = sext i32 %168 to i64
  %170 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %7, i64 0, i64 %169
...
190:                                              ; preds = %187
  ...
  %197 = fcmp oge float %195, %196
  br i1 %197, label %198, label %205

198:                                              ; preds = %190
  %199 = load i32, i32* %3, align 4
  %200 = sext i32 %199 to i64
  %201 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %7, i64 0, i64 %200
...
225:                                              ; preds = %210
  ...
  %233 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %7, i64 0, i64 %232
  %234 = getelementptr inbounds %struct.student, %struct.student* %233, i32 0, i32 6
  %235 = load float, float* %234, align 4
  %236 = fpext float %235 to double
  %237 = load float, float* %5, align 4
  %238 = fpext float %237 to double
  %239 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.2, i64 0, i64 0), i8* %230, double %236, double %238)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1418.cpp() #0 section ".text.startup" {
