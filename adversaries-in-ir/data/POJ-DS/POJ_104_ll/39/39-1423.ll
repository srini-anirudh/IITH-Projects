; ModuleID = 'POJ-104-source/39/39-1423.cpp'
source_filename = "POJ-104-source/39/39-1423.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1423.cpp, i8* null }]
...
define dso_local i32 @_Z11scholarship7student(%struct.student* byval(%struct.student) align 8 %0) #4 {
...
50:                                               ; preds = %46
  ...
  %54 = bitcast %struct.student* %9 to i8*
  %55 = bitcast %struct.student* %53 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %54, i8* align 4 %55, i64 36, i1 false)
  %56 = call i32 @_Z11scholarship7student(%struct.student* byval(%struct.student) align 8 %9)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1423.cpp() #0 section ".text.startup" {
