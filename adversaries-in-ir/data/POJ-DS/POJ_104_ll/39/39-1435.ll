; ModuleID = 'POJ-104-source/39/39-1435.cpp'
source_filename = "POJ-104-source/39/39-1435.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1435.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %18 = bitcast [100 x [21 x i8]]* %11 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 16 %18, i8 0, i64 2100, i1 false)
...
24:                                               ; preds = %20
  ...
  %27 = getelementptr inbounds [100 x [21 x i8]], [100 x [21 x i8]]* %11, i64 0, i64 %26
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1435.cpp() #0 section ".text.startup" {
