; ModuleID = 'POJ-104-source/39/39-1439.cpp'
source_filename = "POJ-104-source/39/39-1439.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1439.cpp, i8* null }]
...
define dso_local i64 @_Z1f7student(%struct.student* byval(%struct.student) align 8 %0) #4 {
...
17:                                               ; preds = %13
  ...
  %42 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), [20 x i8]* %21, i32* %25, i32* %29, i8* %33, i8* %37, i32* %41)
  br label %43
...
46:                                               ; preds = %13
  %47 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %6, i64 0, i64 0
  %48 = bitcast %struct.student* %7 to i8*
  %49 = bitcast %struct.student* %47 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %48, i8* align 16 %49, i64 36, i1 false)
  %50 = call i64 @_Z1f7student(%struct.student* byval(%struct.student) align 8 %7)
...
55:                                               ; preds = %51
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %60, i8* align 4 %61, i64 36, i1 false)
  %62 = call i64 @_Z1f7student(%struct.student* byval(%struct.student) align 8 %8)
...
64:                                               ; preds = %55
  ...
  %68 = bitcast %struct.student* %9 to i8*
  %69 = bitcast %struct.student* %67 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %68, i8* align 4 %69, i64 36, i1 false)
  %70 = call i64 @_Z1f7student(%struct.student* byval(%struct.student) align 8 %9)
...
71:                                               ; preds = %64, %55
  ...
  %75 = bitcast %struct.student* %10 to i8*
  %76 = bitcast %struct.student* %74 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %75, i8* align 4 %76, i64 36, i1 false)
  %77 = call i64 @_Z1f7student(%struct.student* byval(%struct.student) align 8 %10)
...
88:                                               ; preds = %84
  ...
  %92 = bitcast %struct.student* %11 to i8*
  %93 = bitcast %struct.student* %91 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %92, i8* align 4 %93, i64 36, i1 false)
  %94 = call i64 @_Z1f7student(%struct.student* byval(%struct.student) align 8 %11)
...
97:                                               ; preds = %88
  ...
  %105 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0), i64 %104)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1439.cpp() #0 section ".text.startup" {
