; ModuleID = 'POJ-104-source/39/39-1461.cpp'
source_filename = "POJ-104-source/39/39-1461.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1461.cpp, i8* null }]
...
181:                                              ; preds = %168
  ...
  %192 = getelementptr inbounds %struct.student, %struct.student* %191, i64 1
  ...
  %198 = bitcast %struct.student* %192 to i8*
...
230:                                              ; preds = %215
  ...
  %241 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i32 %240)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1461.cpp() #0 section ".text.startup" {
