; ModuleID = 'POJ-104-source/39/39-1475.cpp'
source_filename = "POJ-104-source/39/39-1475.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1475.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %7 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* %5)
...
12:                                               ; preds = %8
  ...
  %38 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i64 0, i64 0), i8* %17, i32* %21, i32* %25, i8* %29, i8* %33, i32* %37)
...
197:                                              ; preds = %167
  ...
  %205 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i64 0, i64 0), i8* %202, i32 %203, i32 %204)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1475.cpp() #0 section ".text.startup" {
