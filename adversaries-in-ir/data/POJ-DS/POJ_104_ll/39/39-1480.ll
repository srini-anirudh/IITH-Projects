; ModuleID = 'POJ-104-source/39/39-1480.cpp'
source_filename = "POJ-104-source/39/39-1480.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1480.cpp, i8* null }]
...
33:                                               ; preds = %29
  ...
  %65 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), i8* %39, i32* %44, i32* %49, i8* %54, i8* %59, i32* %64)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1480.cpp() #0 section ".text.startup" {
