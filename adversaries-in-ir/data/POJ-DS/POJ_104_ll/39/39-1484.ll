; ModuleID = 'POJ-104-source/39/39-1484.cpp'
source_filename = "POJ-104-source/39/39-1484.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1484.cpp, i8* null }]
...
32:                                               ; preds = %9
  %33 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %3)
...
38:                                               ; preds = %34
  ...
  %64 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i64 0, i64 0), i8* %43, i32* %47, i32* %51, i8* %55, i8* %59, i32* %63)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1484.cpp() #0 section ".text.startup" {
