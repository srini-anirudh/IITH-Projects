; ModuleID = 'POJ-104-source/39/39-1519.cpp'
source_filename = "POJ-104-source/39/39-1519.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1519.cpp, i8* null }]
...
20:                                               ; preds = %16
  ...
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), i8* %21, i32* %5, i32* %6, i8* %11, i8* %12, i32* %7)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1519.cpp() #0 section ".text.startup" {
