; ModuleID = 'POJ-104-source/39/39-1572.cpp'
source_filename = "POJ-104-source/39/39-1572.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1572.cpp, i8* null }]
...
23:                                               ; preds = %16
  ...
  %31 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.2, i64 0, i64 0), i32* %8, i32* %10, i8* %11, i8* %12, i32* %9)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1572.cpp() #0 section ".text.startup" {
