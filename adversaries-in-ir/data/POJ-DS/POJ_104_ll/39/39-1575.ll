; ModuleID = 'POJ-104-source/39/39-1575.cpp'
source_filename = "POJ-104-source/39/39-1575.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1575.cpp, i8* null }]
...
220:                                              ; preds = %206
  ...
  %228 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.2, i64 0, i64 0), i8* %225, i32 %226, i32 %227)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1575.cpp() #0 section ".text.startup" {
