; ModuleID = 'POJ-104-source/39/39-1584.cpp'
source_filename = "POJ-104-source/39/39-1584.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1584.cpp, i8* null }]
...
51:                                               ; preds = %47
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %55, i8* align 4 %56, i64 36, i1 false)
  %57 = call i32 @_Z1f7student(%struct.student* byval(%struct.student) align 8 %10)
...
define dso_local i32 @_Z1f7student(%struct.student* byval(%struct.student) align 8 %0) #5 {
  %2 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1584.cpp() #0 section ".text.startup" {
