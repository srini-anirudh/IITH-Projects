; ModuleID = 'POJ-104-source/39/39-1587.cpp'
source_filename = "POJ-104-source/39/39-1587.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1587.cpp, i8* null }]
...
13:                                               ; preds = %9
  ...
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), [21 x i8]* %17)
  ...
  %27 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0), i32* %22, i32* %26)
  ...
  %36 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i64 0, i64 0), i8* %31, i8* %35)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1587.cpp() #0 section ".text.startup" {
