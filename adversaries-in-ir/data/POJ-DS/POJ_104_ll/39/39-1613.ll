; ModuleID = 'POJ-104-source/39/39-1613.cpp'
source_filename = "POJ-104-source/39/39-1613.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1613.cpp, i8* null }]
...
define dso_local %struct.info* @_Z6createi(i32 %0) #0 {
  ...
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i64 0, i64 0), i8* %11, i32* %13, i32* %15, i8* %17, i8* %19, i32* %21)
...
31:                                               ; preds = %27
  ...
  %47 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i64 0, i64 0), i8* %36, i32* %38, i32* %40, i8* %42, i8* %44, i32* %46)
...
define dso_local i32 @main() #4 {
  ...
  %12 = call %struct.info* @_Z6createi(i32 %11)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1613.cpp() #0 section ".text.startup" {
