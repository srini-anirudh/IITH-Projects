; ModuleID = 'POJ-104-source/39/39-1643.cpp'
source_filename = "POJ-104-source/39/39-1643.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1643.cpp, i8* null }]
...
14:                                               ; preds = %10
  ...
  %66 = call i32 @_Z6jiangjiicci(i32 %45, i32 %50, i8 signext %55, i8 signext %60, i32 %65)
...
101:                                              ; preds = %74
  ...
  %112 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i64 0, i64 0), i8* %106, i32 %110, i32 %111)
...
define dso_local i32 @_Z6jiangjiicci(i32 %0, i32 %1, i8 signext %2, i8 signext %3, i32 %4) #5 {
  %6 = alloca i32, align 4
  %7 = alloca i32, align 4
  %8 = alloca i8, align 1
  %9 = alloca i8, align 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1643.cpp() #0 section ".text.startup" {
