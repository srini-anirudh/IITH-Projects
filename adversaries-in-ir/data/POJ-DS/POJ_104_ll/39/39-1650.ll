; ModuleID = 'POJ-104-source/39/39-1650.cpp'
source_filename = "POJ-104-source/39/39-1650.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1650.cpp, i8* null }]
...
147:                                              ; preds = %9
  ...
  %148 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %2, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1650.cpp() #0 section ".text.startup" {
