; ModuleID = 'POJ-104-source/39/39-1651.cpp'
source_filename = "POJ-104-source/39/39-1651.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1651.cpp, i8* null }]
...
19:                                               ; preds = %15
  ...
  %33 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i64 0, i64 0), i8* %26, i32* %29, i32* %32, i8* %8, i8* %9, i32* %6)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1651.cpp() #0 section ".text.startup" {
