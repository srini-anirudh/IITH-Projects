; ModuleID = 'POJ-104-source/39/39-1653.cpp'
source_filename = "POJ-104-source/39/39-1653.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1653.cpp, i8* null }]
...
define dso_local i32 @main(i32 %0, i8** %1) #4 {
  ...
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %6)
  store i32 0, i32* %13, align 4
  br label %20
...
24:                                               ; preds = %20
  ...
  %44 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i64 0, i64 0), i8* %28, i32* %31, i32* %34, i8* %37, i8* %40, i32* %43)
  br label %45
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1653.cpp() #0 section ".text.startup" {
