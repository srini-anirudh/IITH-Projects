; ModuleID = 'POJ-104-source/39/39-1654.cpp'
source_filename = "POJ-104-source/39/39-1654.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1654.cpp, i8* null }]
...
222:                                              ; preds = %208
  ...
  %227 = getelementptr inbounds [30 x i8], [30 x i8]* %226, i64 0, i64 0
  %228 = load i32, i32* %8, align 4
  %229 = load i32, i32* %10, align 4
  %230 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i64 0, i64 0), i8* %227, i32 %228, i32 %229)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1654.cpp() #0 section ".text.startup" {
