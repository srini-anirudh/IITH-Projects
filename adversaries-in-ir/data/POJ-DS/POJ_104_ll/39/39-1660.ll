; ModuleID = 'POJ-104-source/39/39-1660.cpp'
source_filename = "POJ-104-source/39/39-1660.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1660.cpp, i8* null }]
...
13:                                               ; preds = %9
  ...
  %41 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), [21 x i8]* %20, i32* %24, i32* %28, i8* %32, i8* %36, i32* %40)
...
101:                                              ; preds = %94
  ...
  %104 = getelementptr inbounds [101 x %struct.student], [101 x %struct.student]* @stu, i64 0, i64 %103
...
115:                                              ; preds = %109, %101, %94
  ...
  %118 = getelementptr inbounds [101 x %struct.student], [101 x %struct.student]* @stu, i64 0, i64 %117
...
122:                                              ; preds = %115
  ...
  %125 = getelementptr inbounds [101 x %struct.student], [101 x %struct.student]* @stu, i64 0, i64 %124
...
158:                                              ; preds = %9
  ...
  %161 = getelementptr inbounds [101 x %struct.student], [101 x %struct.student]* @stu, i64 0, i64 %160
  ...
  %169 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.2, i64 0, i64 0), i8* %163, i32 %167, i32 %168)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1660.cpp() #0 section ".text.startup" {
