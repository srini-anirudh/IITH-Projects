; ModuleID = 'POJ-104-source/39/39-1665.cpp'
source_filename = "POJ-104-source/39/39-1665.cpp"
...
@name = dso_local global [200 x [21 x i8]] zeroinitializer, align 16
@qmg = dso_local global [200 x i32] zeroinitializer, align 16
@cg = dso_local global [200 x i32] zeroinitializer, align 16
@gb = dso_local global [200 x i8] zeroinitializer, align 16
@xb = dso_local global [200 x i8] zeroinitializer, align 16
@lw = dso_local global [200 x i32] zeroinitializer, align 16
@schsum = dso_local global [200 x i32] zeroinitializer, align 16
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [18 x i8] c"%s %d %d %c %c %d\00", align 1
@.str.2 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1665.cpp, i8* null }]
...
19:                                               ; preds = %15
  ...
  %21 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), i8* %20, i32* %11, i32* %12, i8* %9, i8* %10, i32* %13)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1665.cpp() #0 section ".text.startup" {
