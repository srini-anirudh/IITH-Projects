; ModuleID = 'POJ-104-source/39/39-1680.cpp'
source_filename = "POJ-104-source/39/39-1680.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1680.cpp, i8* null }]
...
18:                                               ; preds = %14
  ...
  %52 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i64 0, i64 0), i8* %24, i32* %29, i32* %34, i8* %40, i8* %46, i32* %51)
  br label %53
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1680.cpp() #0 section ".text.startup" {
