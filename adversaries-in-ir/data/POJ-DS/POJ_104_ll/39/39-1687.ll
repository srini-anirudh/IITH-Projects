; ModuleID = 'POJ-104-source/39/39-1687.cpp'
source_filename = "POJ-104-source/39/39-1687.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1687.cpp, i8* null }]
...
define dso_local i32 @_Z4suanP7student(%struct.student* %0) #4 {
...
18:                                               ; preds = %13
  ...
  %50 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i64 0, i64 0), i8* %24, i32* %29, i32* %34, i8* %5, i8* %39, i8* %5, i8* %44, i32* %49)
  ...
  %55 = call i32 @_Z4suanP7student(%struct.student* %54)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1687.cpp() #0 section ".text.startup" {
