; ModuleID = 'POJ-104-source/39/39-1692.cpp'
source_filename = "POJ-104-source/39/39-1692.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1692.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %15 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i64* %2)
...
20:                                               ; preds = %16
  ...
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i64 0, i64 0), i8* %23, i64* %4, i64* %5, i8* %12, i8* %13, i64* %6)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1692.cpp() #0 section ".text.startup" {
