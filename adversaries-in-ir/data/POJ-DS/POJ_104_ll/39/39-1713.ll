; ModuleID = 'POJ-104-source/39/39-1713.cpp'
source_filename = "POJ-104-source/39/39-1713.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1713.cpp, i8* null }]
...
12:                                               ; preds = %8
  ...
  %39 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.2, i64 0, i64 0), i32* %22, i32* %26, i8* %30, i8* %34, i32* %38)
  br label %40
...
173:                                              ; preds = %165
  ...
  %179 = getelementptr inbounds [20 x i8], [20 x i8]* %6, i64 0, i64 0
...
190:                                              ; preds = %161
  %191 = getelementptr inbounds [20 x i8], [20 x i8]* %6, i64 0, i64 0
  %192 = load i32, i32* %5, align 4
  %193 = load i32, i32* %4, align 4
  %194 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.3, i64 0, i64 0), i8* %191, i32 %192, i32 %193)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1713.cpp() #0 section ".text.startup" {
