; ModuleID = 'POJ-104-source/39/39-1715.cpp'
source_filename = "POJ-104-source/39/39-1715.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1715.cpp, i8* null }]
...
25:                                               ; preds = %18
  %26 = load %struct.stu*, %struct.stu** %12, align 8
...
27:                                               ; preds = %25, %18
  ...
  %30 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), [21 x i8]* %29, i32* %5, i32* %6, i8* %9, i8* %10, i32* %7)
...
109:                                              ; preds = %96
  ...
  store %struct.stu* %110, %struct.stu** %11, align 8
  br label %111
...
115:                                              ; preds = %14
  ...
  %123 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.2, i64 0, i64 0), i8* %118, i32 %121, i32 %122)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1715.cpp() #0 section ".text.startup" {
