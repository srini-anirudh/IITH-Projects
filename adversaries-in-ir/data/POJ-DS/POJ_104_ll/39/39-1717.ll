; ModuleID = 'POJ-104-source/39/39-1717.cpp'
source_filename = "POJ-104-source/39/39-1717.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1717.cpp, i8* null }]
...
23:                                               ; preds = %19
  ...
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i64 0, i64 0), i8* %24, i32* %13, i32* %14, i8* %15, i8* %16, i32* %17)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1717.cpp() #0 section ".text.startup" {
