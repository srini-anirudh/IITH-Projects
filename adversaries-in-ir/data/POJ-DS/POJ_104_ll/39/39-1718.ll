; ModuleID = 'POJ-104-source/39/39-1718.cpp'
source_filename = "POJ-104-source/39/39-1718.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1718.cpp, i8* null }]
...
22:                                               ; preds = %18
  ...
  %48 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), i8* %27, i32* %31, i32* %35, i8* %39, i8* %43, i32* %47)
...
170:                                              ; preds = %18
  ...
  %173 = call i32 @_Z3maxPii(i32* %171, i32 %172)
...
define dso_local i32 @_Z3maxPii(i32* %0, i32 %1) #6 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1718.cpp() #0 section ".text.startup" {
