; ModuleID = 'POJ-104-source/39/39-1722.cpp'
source_filename = "POJ-104-source/39/39-1722.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1722.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %13 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i64* %4)
...
18:                                               ; preds = %14
  ...
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i64 0, i64 0), i8* %19, i64* %5, i64* %6, i8* %10, i8* %11, i64* %7)
  ...
  %29 = call i32 @_Z5moneyiicci(i32 %22, i32 %24, i8 signext %25, i8 signext %26, i32 %28)
...
33:                                               ; preds = %18
  ...
  %42 = call i32 @_Z5moneyiicci(i32 %35, i32 %37, i8 signext %38, i8 signext %39, i32 %41)
...
47:                                               ; preds = %33, %18
  ...
  %56 = call i32 @_Z5moneyiicci(i32 %49, i32 %51, i8 signext %52, i8 signext %53, i32 %55)
...
define dso_local i32 @_Z5moneyiicci(i32 %0, i32 %1, i8 signext %2, i8 signext %3, i32 %4) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1722.cpp() #0 section ".text.startup" {
