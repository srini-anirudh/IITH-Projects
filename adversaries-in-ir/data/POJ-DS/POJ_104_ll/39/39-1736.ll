; ModuleID = 'POJ-104-source/39/39-1736.cpp'
source_filename = "POJ-104-source/39/39-1736.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1736.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %24 = getelementptr inbounds [100 x %struct.s], [100 x %struct.s]* %2, i64 0, i64 %23
  ...
  %29 = getelementptr inbounds [100 x %struct.s], [100 x %struct.s]* %2, i64 0, i64 %28
  ...
  %42 = getelementptr inbounds %struct.s, %struct.s* %41, i32 0, i32 4
  %43 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i8* %42)
  %44 = load i32, i32* %5, align 4
  %45 = sext i32 %44 to i64
  %46 = getelementptr inbounds [100 x %struct.s], [100 x %struct.s]* %2, i64 0, i64 %45
  ...
  %51 = getelementptr inbounds [100 x %struct.s], [100 x %struct.s]* %2, i64 0, i64 %50
...
55:                                               ; preds = %15
  ...
  %58 = getelementptr inbounds [100 x %struct.s], [100 x %struct.s]* %2, i64 0, i64 %57
...
78:                                               ; preds = %71
  ...
  %82 = getelementptr inbounds %struct.s, %struct.s* %81, i32 0, i32 2
...
94:                                               ; preds = %85, %78, %71
  ...
  %97 = getelementptr inbounds [100 x %struct.s], [100 x %struct.s]* %2, i64 0, i64 %96
...
134:                                              ; preds = %125, %117, %110
  ...
  %137 = getelementptr inbounds [100 x %struct.s], [100 x %struct.s]* %2, i64 0, i64 %136
  %138 = getelementptr inbounds %struct.s, %struct.s* %137, i32 0, i32 2
...
141:                                              ; preds = %134
  ...
  %144 = getelementptr inbounds [100 x %struct.s], [100 x %struct.s]* %2, i64 0, i64 %143
...
182:                                              ; preds = %11
  ...
  %190 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.3, i64 0, i64 0), i8* %187, i32 %188, i64 %189)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1736.cpp() #0 section ".text.startup" {
