; ModuleID = 'POJ-104-source/39/39-1750.cpp'
source_filename = "POJ-104-source/39/39-1750.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1750.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), i8* %9, i32* %11, i32* %13, i8* %15, i8* %17, i32* %19)
...
112:                                              ; preds = %108
  ...
  %126 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), i8* %115, i32* %117, i32* %119, i8* %121, i8* %123, i32* %125)
...
223:                                              ; preds = %210
  %224 = getelementptr inbounds [2 x %struct.student], [2 x %struct.student]* %2, i64 0, i64 1
  %225 = getelementptr inbounds [2 x %struct.student], [2 x %struct.student]* %2, i64 0, i64 0
  %226 = bitcast %struct.student* %225 to i8*
  %227 = bitcast %struct.student* %224 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1750.cpp() #0 section ".text.startup" {
