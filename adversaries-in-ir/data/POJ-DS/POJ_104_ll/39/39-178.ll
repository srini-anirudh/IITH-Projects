; ModuleID = 'POJ-104-source/39/39-178.cpp'
source_filename = "POJ-104-source/39/39-178.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_178.cpp, i8* null }]
...
12:                                               ; preds = %8
  ...
  %40 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), i8* %17, i32* %22, i32* %27, i8* %31, i8* %35, i32* %39)
...
161:                                              ; preds = %8
  %162 = load i32, i32* getelementptr inbounds ([100 x %struct.student], [100 x %struct.student]* @stu, i64 0, i64 0, i32 5), align 4
...
186:                                              ; preds = %163
  ...
  %195 = getelementptr inbounds %struct.student, %struct.student* %194, i32 0, i32 5
  %196 = load i32, i32* %195, align 4
  %197 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0), i8* %191, i32 %196)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_178.cpp() #0 section ".text.startup" {
