; ModuleID = 'POJ-104-source/39/39-1807.cpp'
source_filename = "POJ-104-source/39/39-1807.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1807.cpp, i8* null }]
...
22:                                               ; preds = %18
  ...
  %41 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), [20 x i8]* %25, i32* %28, i32* %31, [2 x i8]* %34, [2 x i8]* %37, i32* %40)
  br label %42
...
116:                                              ; preds = %110
  ...
  %121 = call i32 @strcmp(i8* %120, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0)) #6
...
138:                                              ; preds = %132
  ...
  %143 = call i32 @strcmp(i8* %142, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0)) #6
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1807.cpp() #0 section ".text.startup" {
