; ModuleID = 'POJ-104-source/39/39-1810.cpp'
source_filename = "POJ-104-source/39/39-1810.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1810.cpp, i8* null }]
...
161:                                              ; preds = %10
  ...
  %172 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i64 0, i64 0), i8* %166, i32 %170, i32 %171)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1810.cpp() #0 section ".text.startup" {
