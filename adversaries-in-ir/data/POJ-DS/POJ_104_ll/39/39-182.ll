; ModuleID = 'POJ-104-source/39/39-182.cpp'
source_filename = "POJ-104-source/39/39-182.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_182.cpp, i8* null }]
...
172:                                              ; preds = %160
  ...
  %176 = bitcast %struct.student* %3 to i8*
  %177 = bitcast %struct.student* %175 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %176, i8* align 8 %177, i64 40, i1 false)
  ...
  %185 = bitcast %struct.student* %180 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %184, i8* align 8 %185, i64 40, i1 false)
  ...
  %190 = bitcast %struct.student* %3 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %189, i8* align 4 %190, i64 40, i1 false)
  br label %191
...
215:                                              ; preds = %200
  %216 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %2, i64 0, i64 0
  ...
  %219 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %2, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_182.cpp() #0 section ".text.startup" {
