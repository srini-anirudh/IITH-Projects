; ModuleID = 'POJ-104-source/39/39-1839.cpp'
source_filename = "POJ-104-source/39/39-1839.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1839.cpp, i8* null }]
...
191:                                              ; preds = %176
  ...
  %192 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %2, i64 0, i64 0
  store %struct.student* %192, %struct.student** %7, align 8
  br label %193
...
207:                                              ; preds = %197
  ...
  store %struct.student* %211, %struct.student** %7, align 8
  br label %212
...
216:                                              ; preds = %193
  ...
  %220 = load %struct.student*, %struct.student** %7, align 8
  %221 = getelementptr inbounds %struct.student, %struct.student* %220, i32 0, i32 6
  %222 = load i32, i32* %221, align 4
  %223 = load i32, i32* %5, align 4
  %224 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.2, i64 0, i64 0), i8* %219, i32 %222, i32 %223)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1839.cpp() #0 section ".text.startup" {
