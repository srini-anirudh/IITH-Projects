; ModuleID = 'POJ-104-source/39/39-1852.cpp'
source_filename = "POJ-104-source/39/39-1852.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1852.cpp, i8* null }]
...
22:                                               ; preds = %18
  ...
  %59 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), i8* %33, i32* %38, i32* %43, i8* %48, i8* %53, i32* %58)
  br label %60
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1852.cpp() #0 section ".text.startup" {
