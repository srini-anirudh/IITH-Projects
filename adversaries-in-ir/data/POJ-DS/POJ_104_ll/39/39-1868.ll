; ModuleID = 'POJ-104-source/39/39-1868.cpp'
source_filename = "POJ-104-source/39/39-1868.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1868.cpp, i8* null }]
...
14:                                               ; preds = %10
  ...
  %21 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %8, i64 0, i64 %20
...
137:                                              ; preds = %126, %118, %111
  ...
  %140 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %8, i64 0, i64 %139
...
152:                                              ; preds = %144
  ...
  %155 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %8, i64 0, i64 %154
  %156 = getelementptr inbounds %struct.student, %struct.student* %155, i32 0, i32 6
  %157 = load i32, i32* %156, align 4
  %158 = add nsw i32 %157, 850
  %159 = load i32, i32* %2, align 4
  %160 = sext i32 %159 to i64
  %161 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %8, i64 0, i64 %160
...
179:                                              ; preds = %175
  ...
  %182 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %8, i64 0, i64 %181
...
202:                                              ; preds = %198
  ...
  %205 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %8, i64 0, i64 %204
...
210:                                              ; preds = %202
  ...
  %213 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %8, i64 0, i64 %212
  ...
  %218 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i64 0, i64 0), i8* %215, i32 %216, i32 %217)
  br label %223
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1868.cpp() #0 section ".text.startup" {
