; ModuleID = 'POJ-104-source/39/39-189.cpp'
source_filename = "POJ-104-source/39/39-189.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_189.cpp, i8* null }]
...
181:                                              ; preds = %168
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %185, i8* align 4 %186, i64 44, i1 false)
...
227:                                              ; preds = %211
  %228 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %6, i64 0, i64 0
  %229 = getelementptr inbounds %struct.student, %struct.student* %228, i32 0, i32 0
  %230 = getelementptr inbounds [21 x i8], [21 x i8]* %229, i64 0, i64 0
  %231 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i8* %230)
  ...
  %235 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0), i32 %234)
  %236 = load i64, i64* %5, align 8
  %237 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i64 %236)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_189.cpp() #0 section ".text.startup" {
