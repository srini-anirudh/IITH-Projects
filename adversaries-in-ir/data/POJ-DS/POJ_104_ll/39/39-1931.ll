; ModuleID = 'POJ-104-source/39/39-1931.cpp'
source_filename = "POJ-104-source/39/39-1931.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1931.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %10 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %2, i64 0, i64 0
  store %struct.student* %10, %struct.student** %3, align 8
  %11 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* %6)
  br label %12
...
16:                                               ; preds = %12
  ...
  %33 = call i32 @_Z7processP7student(%struct.student* %31)
...
48:                                               ; preds = %12
  ...
  %54 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i64 0, i64 0), i8* %51, i32 %52, i32 %53)
...
define dso_local i32 @_Z7processP7student(%struct.student* %0) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1931.cpp() #0 section ".text.startup" {
