; ModuleID = 'POJ-104-source/39/39-1935.cpp'
source_filename = "POJ-104-source/39/39-1935.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1935.cpp, i8* null }]
...
12:                                               ; preds = %8
  ...
  %37 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i64 0, i64 0), [20 x i8]* %16, i32* %20, i32* %24, i8* %28, i8* %32, i32* %36)
  br label %38
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1935.cpp() #0 section ".text.startup" {
