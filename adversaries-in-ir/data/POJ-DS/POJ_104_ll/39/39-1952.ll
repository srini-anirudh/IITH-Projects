; ModuleID = 'POJ-104-source/39/39-1952.cpp'
source_filename = "POJ-104-source/39/39-1952.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1952.cpp, i8* null }]
...
define dso_local i32 @main(i32 %0, i8** %1) #4 {
  ...
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %13)
...
24:                                               ; preds = %20
  ...
  %26 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), i8* %25, i32* %10, i32* %11, i8* %8, i8* %9, i32* %12)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1952.cpp() #0 section ".text.startup" {
