; ModuleID = 'POJ-104-source/39/39-1966.cpp'
source_filename = "POJ-104-source/39/39-1966.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1966.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %21 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), i32* %18, i32* %20)
  ...
  %48 = call i32 @_Z3schiiPcS_i(i32 %35, i32 %38, i8* %41, i8* %44, i32 %47)
...
53:                                               ; preds = %49
  ...
  %59 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* %58)
  ...
  %64 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), i32* %61, i32* %63)
  %65 = load %struct.student*, %struct.student** %2, align 8
  %66 = getelementptr inbounds %struct.student, %struct.student* %65, i32 0, i32 3
  %67 = getelementptr inbounds [2 x i8], [2 x i8]* %66, i64 0, i64 0
  %68 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* %67)
  ...
  %72 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* %71)
  %73 = load %struct.student*, %struct.student** %2, align 8
  %74 = getelementptr inbounds %struct.student, %struct.student* %73, i32 0, i32 5
  %75 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %74)
  ...
  %92 = call i32 @_Z3schiiPcS_i(i32 %79, i32 %82, i8* %85, i8* %88, i32 %91)
  ...
  %109 = call i32 @_Z3schiiPcS_i(i32 %96, i32 %99, i8* %102, i8* %105, i32 %108)
...
112:                                              ; preds = %53
  ...
  %128 = call i32 @_Z3schiiPcS_i(i32 %115, i32 %118, i8* %121, i8* %124, i32 %127)
...
138:                                              ; preds = %49
  ...
  %146 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.3, i64 0, i64 0), i8* %143, i32 %144, i32 %145)
...
define dso_local i32 @_Z3schiiPcS_i(i32 %0, i32 %1, i8* %2, i8* %3, i32 %4) #5 {
  %6 = alloca i32, align 4
  %7 = alloca i32, align 4
  %8 = alloca i8*, align 8
  %9 = alloca i8*, align 8
...
38:                                               ; preds = %35
  ...
  %40 = call i32 @strcmp(i8* %39, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i64 0, i64 0)) #7
  %41 = icmp eq i32 %40, 0
...
48:                                               ; preds = %45
  ...
  %50 = call i32 @strcmp(i8* %49, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i64 0, i64 0)) #7
  %51 = icmp eq i32 %50, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1966.cpp() #0 section ".text.startup" {
