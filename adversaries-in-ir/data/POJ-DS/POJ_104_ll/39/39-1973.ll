; ModuleID = 'POJ-104-source/39/39-1973.cpp'
source_filename = "POJ-104-source/39/39-1973.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1973.cpp, i8* null }]
...
define dso_local i32 @main() #5 {
  ...
  %11 = call %struct.Node* @_Z6createv()
...
22:                                               ; preds = %17
  ...
  %35 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), [20 x i8]* %24, i32* %26, i32* %28, i8* %30, i8* %32, i32* %34)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1973.cpp() #0 section ".text.startup" {
