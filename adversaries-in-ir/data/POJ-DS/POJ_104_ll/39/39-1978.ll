; ModuleID = 'POJ-104-source/39/39-1978.cpp'
source_filename = "POJ-104-source/39/39-1978.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1978.cpp, i8* null }]
...
define dso_local i32 @_Z4deal7student(%struct.student* byval(%struct.student) align 8 %0) #4 {
...
14:                                               ; preds = %10
  ...
  %44 = bitcast %struct.student* %8 to i8*
  %45 = bitcast %struct.student* %43 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %44, i8* align 8 %45, i64 40, i1 false)
  %46 = call i32 @_Z4deal7student(%struct.student* byval(%struct.student) align 8 %8)
...
76:                                               ; preds = %10
  ...
  %84 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i64 0, i64 0), i8* %81, i32 %82, i32 %83)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1978.cpp() #0 section ".text.startup" {
