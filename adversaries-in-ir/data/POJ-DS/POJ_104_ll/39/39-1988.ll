; ModuleID = 'POJ-104-source/39/39-1988.cpp'
source_filename = "POJ-104-source/39/39-1988.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_1988.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local %struct.student* @_Z5creati(i32 %0) #0 {
...
14:                                               ; preds = %10
  ...
  %29 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i64 0, i64 0), i8* %18, i32* %20, i32* %22, [2 x i8]* %24, [2 x i8]* %26, i32* %28)
...
82:                                               ; preds = %77
  ...
  %86 = call i32 @strcmp(i8* %85, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0)) #6
  %87 = icmp eq i32 %86, 0
...
100:                                              ; preds = %95
  ...
  %104 = call i32 @strcmp(i8* %103, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0)) #6
...
113:                                              ; preds = %106, %100, %95
  %114 = call noalias i8* @malloc(i64 48) #3
...
; Function Attrs: noinline uwtable
define dso_local void @_Z6print1P7student(%struct.student* %0) #0 {
  %2 = alloca %struct.student*, align 8
  %3 = alloca %struct.student*, align 8
  store %struct.student* %0, %struct.student** %2, align 8
...
define dso_local i32 @main() #5 {
  ...
  %2 = alloca %struct.student*, align 8
  %3 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i32* %1)
  %4 = load i32, i32* %1, align 4
  %5 = call %struct.student* @_Z5creati(i32 %4)
  store %struct.student* %5, %struct.student** %2, align 8
  %6 = load %struct.student*, %struct.student** %2, align 8
  call void @_Z5printP7student(%struct.student* %6)
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_1988.cpp() #0 section ".text.startup" {
