; ModuleID = 'POJ-104-source/39/39-2003.cpp'
source_filename = "POJ-104-source/39/39-2003.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_2003.cpp, i8* null }]
...
14:                                               ; preds = %10
  ...
  %30 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i64 0, i64 0), i8* %17, i32* %19, i32* %21, i8* %24, i8* %27, i32* %29)
...
35:                                               ; preds = %14
  ...
  %39 = call i32 @strcmp(i8* %38, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0)) #7
  %40 = icmp eq i32 %39, 0
...
99:                                               ; preds = %94
  ...
  %103 = call i32 @strcmp(i8* %102, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0)) #7
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_2003.cpp() #0 section ".text.startup" {
