; ModuleID = 'POJ-104-source/39/39-2024.cpp'
source_filename = "POJ-104-source/39/39-2024.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_2024.cpp, i8* null }]
...
12:                                               ; preds = %8
  ...
  %27 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), i32* %22, i32* %26)
  %28 = call i32 @getchar()
  ...
  %33 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i8* %32)
  %34 = call i32 @getchar()
  ...
  %39 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i8* %38)
  %40 = call i32 @getchar()
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_2024.cpp() #0 section ".text.startup" {
