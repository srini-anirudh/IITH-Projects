; ModuleID = 'POJ-104-source/39/39-2047.cpp'
source_filename = "POJ-104-source/39/39-2047.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_2047.cpp, i8* null }]
...
12:                                               ; preds = %8
  ...
  %26 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i8* %17, i32* %21, i32* %25)
  %27 = call i32 @getchar()
  ...
  %42 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0), i8* %37, i32* %41)
  br label %43
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_2047.cpp() #0 section ".text.startup" {
