; ModuleID = 'POJ-104-source/39/39-2057.cpp'
source_filename = "POJ-104-source/39/39-2057.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_2057.cpp, i8* null }]
...
18:                                               ; preds = %14
  ...
  %43 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), [25 x i8]* %22, i32* %26, i32* %30, i8* %34, i8* %38, i32* %42)
  br label %44
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_2057.cpp() #0 section ".text.startup" {
