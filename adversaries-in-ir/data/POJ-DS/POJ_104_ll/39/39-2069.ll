; ModuleID = 'POJ-104-source/39/39-2069.cpp'
source_filename = "POJ-104-source/39/39-2069.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_2069.cpp, i8* null }]
...
20:                                               ; preds = %16
  ...
  %23 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), [20 x i8]* %22)
  ...
  %34 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.2, i64 0, i64 0), i32* %25, i32* %27, i8* %29, i8* %31, i32* %33)
  %35 = call i32 @getchar()
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_2069.cpp() #0 section ".text.startup" {
