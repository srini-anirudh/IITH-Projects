; ModuleID = 'POJ-104-source/39/39-208.cpp'
source_filename = "POJ-104-source/39/39-208.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_208.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %40 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), [100 x i8]* %19, i32* %23, i32* %27, i8* %31, i8* %35, i32* %39)
  br label %41
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_208.cpp() #0 section ".text.startup" {
