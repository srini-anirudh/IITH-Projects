; ModuleID = 'POJ-104-source/39/39-2091.cpp'
source_filename = "POJ-104-source/39/39-2091.cpp"
...
@money = dso_local global [100 x i32] zeroinitializer, align 16
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [13 x i8] c"%s%d%d%s%s%d\00", align 1
@.str.2 = private unnamed_addr constant [10 x i8] c"%s\0A%d\0A%d\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_2091.cpp, i8* null }]
...
19:                                               ; preds = %15
  ...
  %39 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i64 0, i64 0), i8* %23, i32* %26, i32* %29, i8* %32, i8* %35, i32* %38)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_2091.cpp() #0 section ".text.startup" {
