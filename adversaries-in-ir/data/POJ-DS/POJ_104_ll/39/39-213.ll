; ModuleID = 'POJ-104-source/39/39-213.cpp'
source_filename = "POJ-104-source/39/39-213.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_213.cpp, i8* null }]
...
159:                                              ; preds = %155
  %160 = load i32, i32* getelementptr inbounds ([100 x %struct.student], [100 x %struct.student]* @stu, i64 0, i64 0, i32 6), align 4
...
167:                                              ; preds = %159
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 getelementptr inbounds ([100 x %struct.student], [100 x %struct.student]* @stu, i32 0, i32 0, i32 0, i32 0), i8* align 8 %171, i64 40, i1 false)
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %175, i8* align 4 getelementptr inbounds (%struct.student, %struct.student* @temp, i32 0, i32 0, i32 0), i64 40, i1 false)
  br label %176
...
196:                                              ; preds = %181
  %197 = load i32, i32* getelementptr inbounds ([100 x %struct.student], [100 x %struct.student]* @stu, i64 0, i64 0, i32 6), align 4
  %198 = load i32, i32* %5, align 4
  %199 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.2, i64 0, i64 0), i8* getelementptr inbounds ([100 x %struct.student], [100 x %struct.student]* @stu, i64 0, i64 0, i32 0, i64 0), i32 %197, i32 %198)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_213.cpp() #0 section ".text.startup" {
