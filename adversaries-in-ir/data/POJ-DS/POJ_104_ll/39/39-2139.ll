; ModuleID = 'POJ-104-source/39/39-2139.cpp'
source_filename = "POJ-104-source/39/39-2139.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_2139.cpp, i8* null }]
...
13:                                               ; preds = %9
  ...
  %35 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i8* %34)
  %36 = call i32 @getchar()
  ...
  %41 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i8* %40)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_2139.cpp() #0 section ".text.startup" {
