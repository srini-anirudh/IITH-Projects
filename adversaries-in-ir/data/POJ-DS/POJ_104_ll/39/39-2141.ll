; ModuleID = 'POJ-104-source/39/39-2141.cpp'
source_filename = "POJ-104-source/39/39-2141.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_2141.cpp, i8* null }]
...
define dso_local void @_Z10count_dateP7StudentPii(%struct.Student* %0, i32* %1, i32 %2) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z12compare_datePii(i32* %0, i32 %1) #4 {
...
24:                                               ; preds = %20
  ...
  %62 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), i8* %31, i32* %37, i32* %43, i8* %49, i8* %55, i32* %61)
  br label %63
...
66:                                               ; preds = %20
  ...
  call void @_Z10count_dateP7StudentPii(%struct.Student* %67, i32* %68, i32 %69)
  %70 = load i32*, i32** %5, align 8
  %71 = load i32, i32* %2, align 4
  %72 = call i32 @_Z12compare_datePii(i32* %70, i32 %71)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_2141.cpp() #0 section ".text.startup" {
