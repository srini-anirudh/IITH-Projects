; ModuleID = 'POJ-104-source/39/39-2151.cpp'
source_filename = "POJ-104-source/39/39-2151.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_2151.cpp, i8* null }]
...
22:                                               ; preds = %17
  ...
  %42 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.1, i64 0, i64 0), i8* %26, i32* %29, i32* %32, i32* %12, i8* %35, i32* %11, i8* %38, i32* %41)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_2151.cpp() #0 section ".text.startup" {
