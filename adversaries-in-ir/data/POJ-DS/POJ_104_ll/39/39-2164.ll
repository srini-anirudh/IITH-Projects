; ModuleID = 'POJ-104-source/39/39-2164.cpp'
source_filename = "POJ-104-source/39/39-2164.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_2164.cpp, i8* null }]
...
23:                                               ; preds = %19
  ...
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), i8* %24, i32* %15, i32* %16, i8* %12, i8* %13, i32* %17)
  store i32 0, i32* %9, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_2164.cpp() #0 section ".text.startup" {
