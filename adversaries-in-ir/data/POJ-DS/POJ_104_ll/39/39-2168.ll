; ModuleID = 'POJ-104-source/39/39-2168.cpp'
source_filename = "POJ-104-source/39/39-2168.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_2168.cpp, i8* null }]
...
100:                                              ; preds = %93
  ...
  %103 = getelementptr inbounds [100 x %struct.stu], [100 x %struct.stu]* %2, i64 0, i64 %102
...
118:                                              ; preds = %111
  ...
  %121 = getelementptr inbounds [100 x %struct.stu], [100 x %struct.stu]* %2, i64 0, i64 %120
...
174:                                              ; preds = %9
  ...
  %175 = getelementptr inbounds [100 x %struct.stu], [100 x %struct.stu]* %2, i64 0, i64 0
...
190:                                              ; preds = %182
  ...
  %193 = getelementptr inbounds [100 x %struct.stu], [100 x %struct.stu]* %2, i64 0, i64 %192
...
201:                                              ; preds = %178
  ...
  %213 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i64 0, i64 0), i8* %206, i32 %211, i32 %212)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_2168.cpp() #0 section ".text.startup" {
