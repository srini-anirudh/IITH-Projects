; ModuleID = 'POJ-104-source/39/39-217.cpp'
source_filename = "POJ-104-source/39/39-217.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_217.cpp, i8* null }]
...
11:                                               ; preds = %7
  ...
  %36 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), [20 x i8]* %15, i32* %19, i32* %23, i8* %27, i8* %31, i32* %35)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_217.cpp() #0 section ".text.startup" {
