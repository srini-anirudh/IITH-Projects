; ModuleID = 'POJ-104-source/39/39-2170.cpp'
source_filename = "POJ-104-source/39/39-2170.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_2170.cpp, i8* null }]
...
20:                                               ; preds = %16
  ...
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i64 0, i64 0), [20 x i8]* %23, i32* %7, i32* %8, i8* %9, i8* %10, i32* %11)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_2170.cpp() #0 section ".text.startup" {
