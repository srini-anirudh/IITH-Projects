; ModuleID = 'POJ-104-source/39/39-218.cpp'
source_filename = "POJ-104-source/39/39-218.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_218.cpp, i8* null }]
...
144:                                              ; preds = %7
  store i32 0, i32* %3, align 4
  %145 = load i32, i32* getelementptr inbounds ([100 x %struct.student], [100 x %struct.student]* @stu, i64 0, i64 0, i32 6), align 4
...
191:                                              ; preds = %183
  ...
  %206 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i64 0, i64 0), i8* %196, i32 %197, i32 %205)
  br label %211
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_218.cpp() #0 section ".text.startup" {
