; ModuleID = 'POJ-104-source/39/39-2201.cpp'
source_filename = "POJ-104-source/39/39-2201.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_2201.cpp, i8* null }]
...
17:                                               ; preds = %13
  ...
  %44 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.2, i64 0, i64 0), i32* %27, i32* %31, i8* %10, i8* %35, i8* %11, i8* %39, i32* %43)
  br label %45
...
198:                                              ; preds = %188
  ...
  %225 = bitcast %struct.stu* %224 to i8*
  %226 = bitcast %struct.stu* %221 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_2201.cpp() #0 section ".text.startup" {
