; ModuleID = 'POJ-104-source/39/39-2209.cpp'
source_filename = "POJ-104-source/39/39-2209.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_2209.cpp, i8* null }]
...
21:                                               ; preds = %17
  ...
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), [50 x i8]* %24)
  %26 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.2, i64 0, i64 0), i32* %7, i32* %8, i8* %14, i8* %15, i32* %6)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_2209.cpp() #0 section ".text.startup" {
