; ModuleID = 'POJ-104-source/39/39-222.cpp'
source_filename = "POJ-104-source/39/39-222.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_222.cpp, i8* null }]
...
12:                                               ; preds = %8
  ...
  %38 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i64 0, i64 0), i8* %17, i32* %21, i32* %25, i8* %29, i8* %33, i32* %37)
...
186:                                              ; preds = %163
  ...
  %194 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i64 0, i64 0), i8* %191, i32 %192, i32 %193)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_222.cpp() #0 section ".text.startup" {
