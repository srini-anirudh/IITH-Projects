; ModuleID = 'POJ-104-source/39/39-2222.cpp'
source_filename = "POJ-104-source/39/39-2222.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_2222.cpp, i8* null }]
...
24:                                               ; preds = %19
  ...
  %56 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), i8* %30, i32* %35, i32* %40, i8* %45, i8* %50, i32* %55)
...
162:                                              ; preds = %19
  ...
  %165 = call i32 @_Z5max_nPii(i32* %163, i32 %164)
...
define dso_local i32 @_Z5max_nPii(i32* %0, i32 %1) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_2222.cpp() #0 section ".text.startup" {
