; ModuleID = 'POJ-104-source/39/39-2223.cpp'
source_filename = "POJ-104-source/39/39-2223.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_2223.cpp, i8* null }]
...
11:                                               ; preds = %7
  ...
  %14 = getelementptr inbounds [100 x %struct.stu], [100 x %struct.stu]* @student, i64 0, i64 %13
...
24:                                               ; preds = %20
  ...
  %27 = getelementptr inbounds [100 x %struct.stu], [100 x %struct.stu]* @student, i64 0, i64 %26
  ...
  %36 = getelementptr inbounds [100 x %struct.stu], [100 x %struct.stu]* @student, i64 0, i64 %35
  %37 = getelementptr inbounds %struct.stu, %struct.stu* %36, i32 0, i32 2
  %38 = load i32, i32* %3, align 4
  %39 = sext i32 %38 to i64
  %40 = getelementptr inbounds [100 x %struct.stu], [100 x %struct.stu]* @student, i64 0, i64 %39
  ...
  %48 = getelementptr inbounds [100 x %struct.stu], [100 x %struct.stu]* @student, i64 0, i64 %47
  %49 = getelementptr inbounds %struct.stu, %struct.stu* %48, i32 0, i32 5
  %50 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), i8* %29, i32* %33, i32* %37, i8* %41, i8* %45, i32* %49)
...
57:                                               ; preds = %24
  ...
  %60 = getelementptr inbounds [100 x %struct.stu], [100 x %struct.stu]* @student, i64 0, i64 %59
...
64:                                               ; preds = %57
  ...
  %67 = getelementptr inbounds [100 x %struct.stu], [100 x %struct.stu]* @student, i64 0, i64 %66
...
85:                                               ; preds = %78
  ...
  %88 = getelementptr inbounds [100 x %struct.stu], [100 x %struct.stu]* @student, i64 0, i64 %87
...
92:                                               ; preds = %85, %78, %71
  ...
  %95 = getelementptr inbounds [100 x %struct.stu], [100 x %struct.stu]* @student, i64 0, i64 %94
...
99:                                               ; preds = %92
  ...
  %102 = getelementptr inbounds [100 x %struct.stu], [100 x %struct.stu]* @student, i64 0, i64 %101
...
106:                                              ; preds = %99, %92
  ...
  %109 = getelementptr inbounds [100 x %struct.stu], [100 x %struct.stu]* @student, i64 0, i64 %108
...
113:                                              ; preds = %106
  ...
  %116 = getelementptr inbounds [100 x %struct.stu], [100 x %struct.stu]* @student, i64 0, i64 %115
...
121:                                              ; preds = %113
  ...
  %124 = getelementptr inbounds [100 x %struct.stu], [100 x %struct.stu]* @student, i64 0, i64 %123
...
128:                                              ; preds = %121, %113, %106
  ...
  %131 = getelementptr inbounds [100 x %struct.stu], [100 x %struct.stu]* @student, i64 0, i64 %130
...
135:                                              ; preds = %128
  ...
  %138 = getelementptr inbounds [100 x %struct.stu], [100 x %struct.stu]* @student, i64 0, i64 %137
...
143:                                              ; preds = %135
  ...
  %146 = getelementptr inbounds [100 x %struct.stu], [100 x %struct.stu]* @student, i64 0, i64 %145
...
154:                                              ; preds = %20
  %155 = load i32, i32* getelementptr inbounds ([100 x %struct.stu], [100 x %struct.stu]* @student, i64 0, i64 0, i32 6), align 4
...
160:                                              ; preds = %156
  ...
  %163 = getelementptr inbounds [100 x %struct.stu], [100 x %struct.stu]* @student, i64 0, i64 %162
...
168:                                              ; preds = %160
  ...
  %171 = getelementptr inbounds [100 x %struct.stu], [100 x %struct.stu]* @student, i64 0, i64 %170
...
191:                                              ; preds = %183
  ...
  %194 = getelementptr inbounds [100 x %struct.stu], [100 x %struct.stu]* @student, i64 0, i64 %193
  ...
  %199 = getelementptr inbounds [100 x %struct.stu], [100 x %struct.stu]* @student, i64 0, i64 %198
  %200 = getelementptr inbounds %struct.stu, %struct.stu* %199, i32 0, i32 6
  %201 = load i32, i32* %200, align 4
  %202 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0), i8* %196, i32 %201)
  br label %207
...
212:                                              ; preds = %208
  ...
  %215 = getelementptr inbounds [100 x %struct.stu], [100 x %struct.stu]* @student, i64 0, i64 %214
...
223:                                              ; preds = %208
  ...
  %225 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i32 %224)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_2223.cpp() #0 section ".text.startup" {
