; ModuleID = 'POJ-104-source/39/39-2242.cpp'
source_filename = "POJ-104-source/39/39-2242.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_2242.cpp, i8* null }]
...
19:                                               ; preds = %15
  ...
  %27 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), i8* %26, i32* %3, i32* %4, i8* %12, i8* %13, i32* %5)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_2242.cpp() #0 section ".text.startup" {
