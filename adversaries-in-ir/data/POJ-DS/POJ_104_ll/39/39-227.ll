; ModuleID = 'POJ-104-source/39/39-227.cpp'
source_filename = "POJ-104-source/39/39-227.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_227.cpp, i8* null }]
...
12:                                               ; preds = %8
  ...
  %42 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i64 0, i64 0), i8* %21, i32* %25, i32* %29, i8* %33, i8* %37, i32* %41)
...
193:                                              ; preds = %180
  ...
  %197 = bitcast %struct.student* %6 to i8*
  %198 = bitcast %struct.student* %196 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %197, i8* align 8 %198, i64 40, i1 false)
  ...
  %207 = bitcast %struct.student* %202 to i8*
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %212, i8* align 4 %213, i64 40, i1 false)
  br label %214
...
238:                                              ; preds = %223
  %239 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %5, i64 0, i64 0
  ...
  %242 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %5, i64 0, i64 0
  %243 = getelementptr inbounds %struct.student, %struct.student* %242, i32 0, i32 6
  %244 = load i32, i32* %243, align 4
  %245 = load i32, i32* %4, align 4
  %246 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i64 0, i64 0), i8* %241, i32 %244, i32 %245)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_227.cpp() #0 section ".text.startup" {
