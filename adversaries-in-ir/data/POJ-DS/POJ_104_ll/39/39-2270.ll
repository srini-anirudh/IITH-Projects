; ModuleID = 'POJ-104-source/39/39-2270.cpp'
source_filename = "POJ-104-source/39/39-2270.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_2270.cpp, i8* null }]
...
36:                                               ; preds = %26
  ...
  %38 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i64 0, i64 0), i8* %37, i32* %9, i32* %10, i8* %17, i8* %18, i32* %11)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_2270.cpp() #0 section ".text.startup" {
