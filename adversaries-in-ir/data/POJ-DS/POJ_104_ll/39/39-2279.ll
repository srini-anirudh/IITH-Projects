; ModuleID = 'POJ-104-source/39/39-2279.cpp'
source_filename = "POJ-104-source/39/39-2279.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_2279.cpp, i8* null }]
...
22:                                               ; preds = %18
  ...
  %33 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), i8* %23, i32* %26, i32* %29, i8* %3, i8* %4, i32* %32)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_2279.cpp() #0 section ".text.startup" {
