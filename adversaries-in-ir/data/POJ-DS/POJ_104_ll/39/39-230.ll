; ModuleID = 'POJ-104-source/39/39-230.cpp'
source_filename = "POJ-104-source/39/39-230.cpp"
...
@temp = dso_local global %struct.people zeroinitializer, align 4
@.str = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
@.str.1 = private unnamed_addr constant [18 x i8] c"%s %d %d %c %c %d\00", align 1
@.str.2 = private unnamed_addr constant [9 x i8] c"%s\0A%d\0A%d\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_230.cpp, i8* null }]
...
11:                                               ; preds = %7
  ...
  %36 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), [30 x i8]* %15, i32* %19, i32* %23, i8* %27, i8* %31, i32* %35)
...
176:                                              ; preds = %163
  ...
  %184 = getelementptr inbounds [100 x %struct.people], [100 x %struct.people]* @line, i64 0, i64 %183
  %185 = load i32, i32* %4, align 4
  %186 = sext i32 %185 to i64
  %187 = getelementptr inbounds [100 x %struct.people], [100 x %struct.people]* @line, i64 0, i64 %186
  %188 = bitcast %struct.people* %187 to i8*
  %189 = bitcast %struct.people* %184 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_230.cpp() #0 section ".text.startup" {
