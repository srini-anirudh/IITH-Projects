; ModuleID = 'POJ-104-source/39/39-262.cpp'
source_filename = "POJ-104-source/39/39-262.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_262.cpp, i8* null }]
...
define dso_local %struct.student* @_Z5creatv() #0 {
  ...
  %21 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), [35 x i8]* %10, i32* %12, i32* %14, i8* %16, i8* %18, i32* %20)
...
118:                                              ; preds = %113
  ...
  %133 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), [35 x i8]* %122, i32* %124, i32* %126, i8* %128, i8* %130, i32* %132)
...
define dso_local i32 @main() #4 {
  ...
  %7 = call %struct.student* @_Z5creatv()
...
32:                                               ; preds = %9
  ...
  %39 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0), i8* %35, i32 %38)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_262.cpp() #0 section ".text.startup" {
