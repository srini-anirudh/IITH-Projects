; ModuleID = 'POJ-104-source/39/39-310.cpp'
source_filename = "POJ-104-source/39/39-310.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_310.cpp, i8* null }]
...
18:                                               ; preds = %14
  ...
  %55 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), i8* %29, i32* %34, i32* %39, i8* %44, i8* %49, i32* %54)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_310.cpp() #0 section ".text.startup" {
