; ModuleID = 'POJ-104-source/39/39-35.cpp'
source_filename = "POJ-104-source/39/39-35.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_35.cpp, i8* null }]
...
102:                                              ; preds = %95
  ...
  %105 = getelementptr inbounds [100 x %struct.anon], [100 x %struct.anon]* %7, i64 0, i64 %104
...
166:                                              ; preds = %158
  ...
  %172 = getelementptr inbounds [100 x i32], [100 x i32]* %4, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_35.cpp() #0 section ".text.startup" {
