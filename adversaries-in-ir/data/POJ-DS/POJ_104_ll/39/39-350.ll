; ModuleID = 'POJ-104-source/39/39-350.cpp'
source_filename = "POJ-104-source/39/39-350.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_350.cpp, i8* null }]
...
62:                                               ; preds = %55
  ...
  %65 = getelementptr inbounds [100 x i64], [100 x i64]* %7, i64 0, i64 %64
...
85:                                               ; preds = %78
  ...
  %88 = getelementptr inbounds [100 x i64], [100 x i64]* %7, i64 0, i64 %87
...
149:                                              ; preds = %141
  ...
  %157 = getelementptr inbounds [100 x i64], [100 x i64]* %7, i64 0, i64 %156
...
158:                                              ; preds = %149, %141, %134
  ...
  %167 = getelementptr inbounds [100 x i64], [100 x i64]* %7, i64 0, i64 %166
...
181:                                              ; preds = %44
  ...
  %189 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0), i64 %188)
  %190 = load i64, i64* %5, align 8
  %191 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0), i64 %190)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_350.cpp() #0 section ".text.startup" {
