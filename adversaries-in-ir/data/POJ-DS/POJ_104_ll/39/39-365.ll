; ModuleID = 'POJ-104-source/39/39-365.cpp'
source_filename = "POJ-104-source/39/39-365.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_365.cpp, i8* null }]
...
169:                                              ; preds = %152
  ...
  %176 = getelementptr inbounds [30 x i8], [30 x i8]* %7, i64 0, i64 0
...
187:                                              ; preds = %148
  %188 = getelementptr inbounds [30 x i8], [30 x i8]* %7, i64 0, i64 0
  %189 = load i64, i64* %6, align 8
  %190 = load i64, i64* %5, align 8
  %191 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.2, i64 0, i64 0), i8* %188, i64 %189, i64 %190)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_365.cpp() #0 section ".text.startup" {
