; ModuleID = 'POJ-104-source/39/39-394.cpp'
source_filename = "POJ-104-source/39/39-394.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_394.cpp, i8* null }]
...
define dso_local i32 @_Z1fP3stu(%struct.stu* %0) #4 {
...
17:                                               ; preds = %13
  ...
  %54 = call i32 @_Z1fP3stu(%struct.stu* %53)
...
96:                                               ; preds = %72
  ...
  %110 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i64 0, i64 0), i8* %102, i32 %108, i32 %109)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_394.cpp() #0 section ".text.startup" {
