; ModuleID = 'POJ-104-source/39/39-396.cpp'
source_filename = "POJ-104-source/39/39-396.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_396.cpp, i8* null }]
...
define dso_local i32 @_Z4yuanii(i32 %0, i32 %1) #4 {
...
21:                                               ; preds = %17
  ...
  %52 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), [20 x i8]* %26, i32* %31, i32* %36, i8* %41, i8* %46, i32* %51)
  ...
  %70 = call i32 @_Z4yuanii(i32 %63, i32 %69)
  ...
  %83 = call i32 @_Z4wusiii(i32 %76, i32 %82)
  ...
  %103 = call i32 @_Z4xibuic(i32 %96, i8 signext %102)
  ...
  %116 = call i32 @_Z5banjiic(i32 %109, i8 signext %115)
  store i32 %116, i32* %9, align 4
  %117 = load i32, i32* %5, align 4
  %118 = mul nsw i32 8000, %117
  %119 = load i32, i32* %6, align 4
  %120 = mul nsw i32 4000, %119
  %121 = add nsw i32 %118, %120
  %122 = load i32, i32* %7, align 4
  %123 = mul nsw i32 2000, %122
  %124 = add nsw i32 %121, %123
  %125 = load i32, i32* %8, align 4
  %126 = mul nsw i32 1000, %125
  %127 = add nsw i32 %124, %126
  %128 = load i32, i32* %9, align 4
  %129 = mul nsw i32 850, %128
...
152:                                              ; preds = %148
  ...
  %154 = getelementptr inbounds %struct.student, %struct.student* %153, i64 0
...
164:                                              ; preds = %152
  ...
  %170 = getelementptr inbounds %struct.student, %struct.student* %169, i64 0
  %171 = bitcast %struct.student* %170 to i8*
  %172 = bitcast %struct.student* %168 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %171, i8* align 4 %172, i64 40, i1 false)
  br label %173
...
177:                                              ; preds = %148
  ...
  %179 = getelementptr inbounds %struct.student, %struct.student* %178, i64 0
  ...
  %187 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i64 0, i64 0), i8* %181, i32 %185, i32 %186)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_396.cpp() #0 section ".text.startup" {
