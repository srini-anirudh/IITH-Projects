; ModuleID = 'POJ-104-source/39/39-41.cpp'
source_filename = "POJ-104-source/39/39-41.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_41.cpp, i8* null }]
...
14:                                               ; preds = %10
  ...
  %45 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.2, i64 0, i64 0), i32* %28, i32* %32, i8* %36, i8* %40, i32* %44)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_41.cpp() #0 section ".text.startup" {
