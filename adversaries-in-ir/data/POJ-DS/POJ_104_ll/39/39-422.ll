; ModuleID = 'POJ-104-source/39/39-422.cpp'
source_filename = "POJ-104-source/39/39-422.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_422.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %9 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0))
...
14:                                               ; preds = %10
  ...
  %45 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.2, i64 0, i64 0), i8* %24, i32* %28, i32* %32, i8* %36, i8* %40, i32* %44)
...
50:                                               ; preds = %14
  %51 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0))
  br label %52
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_422.cpp() #0 section ".text.startup" {
