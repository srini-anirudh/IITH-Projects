; ModuleID = 'POJ-104-source/39/39-429.cpp'
source_filename = "POJ-104-source/39/39-429.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_429.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %41 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i64 0, i64 0), i8* %20, i32* %24, i32* %28, i8* %32, i8* %36, i32* %40)
  br label %42
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_429.cpp() #0 section ".text.startup" {
