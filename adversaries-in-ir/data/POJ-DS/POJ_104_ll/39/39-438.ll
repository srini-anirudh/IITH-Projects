; ModuleID = 'POJ-104-source/39/39-438.cpp'
source_filename = "POJ-104-source/39/39-438.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_438.cpp, i8* null }]
...
13:                                               ; preds = %9
  ...
  %41 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i64 0, i64 0), i8* %18, i32* %22, i32* %26, i8* %31, i8* %36, i32* %40)
  br label %42
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_438.cpp() #0 section ".text.startup" {
