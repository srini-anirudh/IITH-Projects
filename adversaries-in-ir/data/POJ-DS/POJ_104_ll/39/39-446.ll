; ModuleID = 'POJ-104-source/39/39-446.cpp'
source_filename = "POJ-104-source/39/39-446.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_446.cpp, i8* null }]
...
18:                                               ; preds = %14
  ...
  %43 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i64 0, i64 0), [20 x i8]* %22, i32* %26, i32* %30, [2 x i8]* %34, [2 x i8]* %38, i32* %42)
  br label %44
...
97:                                               ; preds = %90
  ...
  %103 = call i32 @strcmp(i8* %102, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0)) #6
...
113:                                              ; preds = %106
  ...
  %119 = call i32 @strcmp(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0), i8* %118) #6
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_446.cpp() #0 section ".text.startup" {
