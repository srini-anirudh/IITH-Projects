; ModuleID = 'POJ-104-source/39/39-45.cpp'
source_filename = "POJ-104-source/39/39-45.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_45.cpp, i8* null }]
...
19:                                               ; preds = %15
  ...
  %21 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), i8* %20, i32* %5, i32* %6, i8* %12, i8* %13, i32* %4)
...
72:                                               ; preds = %65
  %73 = getelementptr inbounds [20 x i8], [20 x i8]* %11, i64 0, i64 0
  %74 = getelementptr inbounds [20 x i8], [20 x i8]* %10, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_45.cpp() #0 section ".text.startup" {
