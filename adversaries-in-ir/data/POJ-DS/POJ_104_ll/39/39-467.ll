; ModuleID = 'POJ-104-source/39/39-467.cpp'
source_filename = "POJ-104-source/39/39-467.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_467.cpp, i8* null }]
...
20:                                               ; preds = %16
  ...
  %52 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), i8* %26, i32* %31, i32* %36, i8* %41, i8* %46, i32* %51)
  br label %53
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_467.cpp() #0 section ".text.startup" {
