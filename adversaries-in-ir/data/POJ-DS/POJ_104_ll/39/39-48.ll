; ModuleID = 'POJ-104-source/39/39-48.cpp'
source_filename = "POJ-104-source/39/39-48.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_48.cpp, i8* null }]
...
24:                                               ; preds = %20
  ...
  %56 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i64 0, i64 0), i8* %30, i32* %35, i32* %40, i8* %45, i8* %50, i32* %55)
  br label %57
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_48.cpp() #0 section ".text.startup" {
