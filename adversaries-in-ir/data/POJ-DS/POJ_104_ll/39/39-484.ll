; ModuleID = 'POJ-104-source/39/39-484.cpp'
source_filename = "POJ-104-source/39/39-484.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_484.cpp, i8* null }]
...
25:                                               ; preds = %21
  ...
  %47 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), i32* %41, i32* %46)
  ...
  %58 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.3, i64 0, i64 0), [2 x i8]* %52, [2 x i8]* %57)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_484.cpp() #0 section ".text.startup" {
