; ModuleID = 'POJ-104-source/39/39-521.cpp'
source_filename = "POJ-104-source/39/39-521.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_521.cpp, i8* null }]
...
13:                                               ; preds = %9
  ...
  %38 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), [40 x i8]* %17, i32* %21, i32* %25, i32* %29, i32* %33, i32* %37)
  br label %39
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_521.cpp() #0 section ".text.startup" {
