; ModuleID = 'POJ-104-source/39/39-542.cpp'
source_filename = "POJ-104-source/39/39-542.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_542.cpp, i8* null }]
...
12:                                               ; preds = %8
  ...
  %40 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.2, i64 0, i64 0), i32* %27, i8* %31, i8* %35, i32* %39)
  br label %41
...
154:                                              ; preds = %147
  ...
  %157 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %6, i64 0, i64 %156
...
216:                                              ; preds = %201
  ...
  %230 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.4, i64 0, i64 0), i32 %229)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_542.cpp() #0 section ".text.startup" {
