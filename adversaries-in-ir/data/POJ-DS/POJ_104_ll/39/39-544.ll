; ModuleID = 'POJ-104-source/39/39-544.cpp'
source_filename = "POJ-104-source/39/39-544.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_544.cpp, i8* null }]
...
210:                                              ; preds = %206
  ...
  %213 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %7, i64 0, i64 %212
  ...
  %221 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0), i8* %215, i32 %220)
  br label %226
...
231:                                              ; preds = %227
  ...
  %235 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %7, i64 0, i64 %234
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_544.cpp() #0 section ".text.startup" {
