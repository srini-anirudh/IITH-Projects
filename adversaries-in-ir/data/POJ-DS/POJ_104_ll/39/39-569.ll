; ModuleID = 'POJ-104-source/39/39-569.cpp'
source_filename = "POJ-104-source/39/39-569.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_569.cpp, i8* null }]
...
191:                                              ; preds = %180
  ...
  %217 = getelementptr inbounds [200 x %struct.student], [200 x %struct.student]* %2, i64 0, i64 %216
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_569.cpp() #0 section ".text.startup" {
