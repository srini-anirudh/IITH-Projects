; ModuleID = 'POJ-104-source/39/39-583.cpp'
source_filename = "POJ-104-source/39/39-583.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_583.cpp, i8* null }]
...
98:                                               ; preds = %89, %82
  ...
  %101 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %8, i64 0, i64 %100
...
140:                                              ; preds = %132
  ...
  %143 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %8, i64 0, i64 %142
...
192:                                              ; preds = %165
  ...
  %195 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %8, i64 0, i64 %194
  ...
  %203 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i64 0, i64 0), i8* %197, i32 %201, i32 %202)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_583.cpp() #0 section ".text.startup" {
