; ModuleID = 'POJ-104-source/39/39-593.cpp'
source_filename = "POJ-104-source/39/39-593.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_593.cpp, i8* null }]
...
52:                                               ; preds = %47, %27
  ...
  %71 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.2, i64 0, i64 0), i32* %58, i32* %61, i8* %64, i8* %67, i32* %70)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_593.cpp() #0 section ".text.startup" {
