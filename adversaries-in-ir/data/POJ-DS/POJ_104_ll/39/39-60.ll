; ModuleID = 'POJ-104-source/39/39-60.cpp'
source_filename = "POJ-104-source/39/39-60.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_60.cpp, i8* null }]
...
152:                                              ; preds = %7
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %153, i8* align 16 getelementptr inbounds ([100 x %struct.student], [100 x %struct.student]* @stu, i32 0, i32 0, i32 0, i32 0), i64 40, i1 false)
  store i32 0, i32* %3, align 4
  br label %154
...
158:                                              ; preds = %154
  ...
  %164 = getelementptr inbounds %struct.student, %struct.student* %5, i32 0, i32 6
...
177:                                              ; preds = %154
  ...
  %180 = getelementptr inbounds %struct.student, %struct.student* %5, i32 0, i32 6
  %181 = load i32, i32* %180, align 4
  %182 = load i32, i32* %4, align 4
  %183 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i64 0, i64 0), i8* %179, i32 %181, i32 %182)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_60.cpp() #0 section ".text.startup" {
