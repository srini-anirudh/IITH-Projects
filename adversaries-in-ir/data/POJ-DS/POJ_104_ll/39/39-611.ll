; ModuleID = 'POJ-104-source/39/39-611.cpp'
source_filename = "POJ-104-source/39/39-611.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_611.cpp, i8* null }]
...
14:                                               ; preds = %10
  ...
  %17 = getelementptr inbounds [150 x %struct.stu], [150 x %struct.stu]* @a, i64 0, i64 %16
  ...
  %22 = getelementptr inbounds [150 x %struct.stu], [150 x %struct.stu]* @a, i64 0, i64 %21
  ...
  %35 = getelementptr inbounds [150 x %struct.stu], [150 x %struct.stu]* @a, i64 0, i64 %34
  ...
  %40 = getelementptr inbounds [150 x %struct.stu], [150 x %struct.stu]* @a, i64 0, i64 %39
  %41 = getelementptr inbounds %struct.stu, %struct.stu* %40, i32 0, i32 5
  %42 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i64 0, i64 0), i8* %19, i32* %23, i32* %27, i8* %32, i8* %37, i32* %41)
  br label %43
...
51:                                               ; preds = %47
  ...
  %54 = getelementptr inbounds [150 x %struct.stu], [150 x %struct.stu]* @a, i64 0, i64 %53
...
58:                                               ; preds = %51
  ...
  %61 = getelementptr inbounds [150 x %struct.stu], [150 x %struct.stu]* @a, i64 0, i64 %60
...
71:                                               ; preds = %65, %58, %51
  ...
  %74 = getelementptr inbounds [150 x %struct.stu], [150 x %struct.stu]* @a, i64 0, i64 %73
...
85:                                               ; preds = %78
  ...
  %88 = getelementptr inbounds [150 x i32], [150 x i32]* %3, i64 0, i64 %87
...
91:                                               ; preds = %85, %78, %71
  ...
  %94 = getelementptr inbounds [150 x %struct.stu], [150 x %struct.stu]* @a, i64 0, i64 %93
...
98:                                               ; preds = %91
  ...
  %101 = getelementptr inbounds [150 x i32], [150 x i32]* %3, i64 0, i64 %100
...
126:                                              ; preds = %120, %111, %104
  %127 = load i32, i32* %4, align 4
  %128 = sext i32 %127 to i64
  %129 = getelementptr inbounds [150 x %struct.stu], [150 x %struct.stu]* @a, i64 0, i64 %128
...
133:                                              ; preds = %126
  ...
  %136 = getelementptr inbounds [150 x %struct.stu], [150 x %struct.stu]* @a, i64 0, i64 %135
...
157:                                              ; preds = %153
  ...
  %161 = getelementptr inbounds [150 x i32], [150 x i32]* %3, i64 0, i64 %160
...
164:                                              ; preds = %157
  ...
  %167 = getelementptr inbounds [150 x i32], [150 x i32]* %3, i64 0, i64 %166
  %168 = load i32, i32* %167, align 4
  store i32 %168, i32* %6, align 4
  %169 = getelementptr inbounds [25 x i8], [25 x i8]* %7, i64 0, i64 0
  %170 = load i32, i32* %4, align 4
  %171 = sext i32 %170 to i64
  %172 = getelementptr inbounds [150 x %struct.stu], [150 x %struct.stu]* @a, i64 0, i64 %171
  %173 = getelementptr inbounds %struct.stu, %struct.stu* %172, i32 0, i32 0
  %174 = getelementptr inbounds [25 x i8], [25 x i8]* %173, i64 0, i64 0
...
176:                                              ; preds = %164, %157
  ...
  %179 = getelementptr inbounds [150 x i32], [150 x i32]* %3, i64 0, i64 %178
...
186:                                              ; preds = %153
  %187 = getelementptr inbounds [25 x i8], [25 x i8]* %7, i64 0, i64 0
  %188 = load i32, i32* %6, align 4
  %189 = load i32, i32* %5, align 4
  %190 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.2, i64 0, i64 0), i8* %187, i32 %188, i32 %189)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_611.cpp() #0 section ".text.startup" {
