; ModuleID = 'POJ-104-source/39/39-62.cpp'
source_filename = "POJ-104-source/39/39-62.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_62.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i64* %2)
...
20:                                               ; preds = %15
  ...
  %34 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), i8* %23, i64* %25, i64* %27, i8* %29, i8* %31, i64* %33)
  br label %35
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_62.cpp() #0 section ".text.startup" {
