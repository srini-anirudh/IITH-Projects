; ModuleID = 'POJ-104-source/39/39-640.cpp'
source_filename = "POJ-104-source/39/39-640.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_640.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %16 = bitcast [100 x [20 x i8]]* %12 to i8*
...
22:                                               ; preds = %18
  ...
  %25 = getelementptr inbounds [100 x [20 x i8]], [100 x [20 x i8]]* %12, i64 0, i64 %24
  ...
  %43 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.4, i64 0, i64 0), i8* %42)
  %44 = load i32, i32* %3, align 4
  %45 = sext i32 %44 to i64
  %46 = getelementptr inbounds [100 x i32], [100 x i32]* %10, i64 0, i64 %45
  %47 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.5, i64 0, i64 0), i32* %46)
  br label %48
...
239:                                              ; preds = %235
  ...
  %244 = getelementptr inbounds [100 x i32], [100 x i32]* %7, i64 0, i64 0
...
247:                                              ; preds = %239
  ...
  %250 = getelementptr inbounds [100 x [20 x i8]], [100 x [20 x i8]]* %12, i64 0, i64 %249
  ...
  %255 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.6, i64 0, i64 0), i8* %251, i32 %253, i32 %254)
  br label %260
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_640.cpp() #0 section ".text.startup" {
