; ModuleID = 'POJ-104-source/39/39-642.cpp'
source_filename = "POJ-104-source/39/39-642.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_642.cpp, i8* null }]
...
define dso_local void @_Z7yunsuanP7student(%struct.student* %0) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z3maxP7studenti(%struct.student* %0, i32 %1) #4 {
...
11:                                               ; preds = %7
  ...
  %37 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i64 0, i64 0), i8* %16, i32* %20, i32* %24, i8* %28, i8* %32, i32* %36)
  %38 = load i32, i32* %3, align 4
  %39 = sext i32 %38 to i64
  %40 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* @stu, i64 0, i64 %39
  call void @_Z7yunsuanP7student(%struct.student* %40)
...
53:                                               ; preds = %7
  ...
  %55 = call i32 @_Z3maxP7studenti(%struct.student* getelementptr inbounds ([100 x %struct.student], [100 x %struct.student]* @stu, i64 0, i64 0), i32 %54)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_642.cpp() #0 section ".text.startup" {
