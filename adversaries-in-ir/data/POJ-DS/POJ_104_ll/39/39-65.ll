; ModuleID = 'POJ-104-source/39/39-65.cpp'
source_filename = "POJ-104-source/39/39-65.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_65.cpp, i8* null }]
...
20:                                               ; preds = %16
  ...
  %40 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i64 0, i64 0), i8* %24, i32* %27, i32* %30, i8* %33, i8* %36, i32* %39)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_65.cpp() #0 section ".text.startup" {
