; ModuleID = 'POJ-104-source/39/39-655.cpp'
source_filename = "POJ-104-source/39/39-655.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_655.cpp, i8* null }]
...
10:                                               ; preds = %6
  ...
  %35 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), [21 x i8]* %14, i32* %18, i32* %22, i8* %26, i8* %30, i32* %34)
  br label %36
...
39:                                               ; preds = %6
  ...
  call void @_Z7scholarP7studenti(%struct.student* %40, i32 %41)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define dso_local void @_Z7scholarP7studenti(%struct.student* %0, i32 %1) #0 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_655.cpp() #0 section ".text.startup" {
