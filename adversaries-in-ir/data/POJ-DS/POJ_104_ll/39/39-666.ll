; ModuleID = 'POJ-104-source/39/39-666.cpp'
source_filename = "POJ-104-source/39/39-666.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_666.cpp, i8* null }]
...
29:                                               ; preds = %22
  ...
  %43 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), i8* %32, i32* %34, i32* %36, i8* %38, i8* %40, i32* %42)
  br label %44
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_666.cpp() #0 section ".text.startup" {
