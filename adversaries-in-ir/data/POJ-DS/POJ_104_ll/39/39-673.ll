; ModuleID = 'POJ-104-source/39/39-673.cpp'
source_filename = "POJ-104-source/39/39-673.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_673.cpp, i8* null }]
...
51:                                               ; preds = %47
  ...
  %62 = call i32 @_Z2f1ii(i32 %56, i32 %61)
  %63 = icmp eq i32 %62, 1
...
73:                                               ; preds = %64, %51
  ...
  %84 = call i32 @_Z2f2ii(i32 %78, i32 %83)
  %85 = icmp eq i32 %84, 1
...
112:                                              ; preds = %103, %95
  ...
  %123 = call i32 @_Z2f4ic(i32 %117, i8 signext %122)
...
134:                                              ; preds = %125, %112
  ...
  %145 = call i32 @_Z2f5ic(i32 %139, i8 signext %144)
...
define dso_local i32 @_Z2f1ii(i32 %0, i32 %1) #5 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  store i32 %0, i32* %4, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z2f2ii(i32 %0, i32 %1) #5 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  store i32 %0, i32* %4, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z2f3i(i32 %0) #5 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  store i32 %0, i32* %3, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z2f4ic(i32 %0, i8 signext %1) #5 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i8, align 1
  store i32 %0, i32* %4, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z2f5ic(i32 %0, i8 signext %1) #5 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i8, align 1
  store i32 %0, i32* %4, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_673.cpp() #0 section ".text.startup" {
