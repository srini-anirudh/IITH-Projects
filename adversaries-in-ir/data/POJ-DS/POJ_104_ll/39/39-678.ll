; ModuleID = 'POJ-104-source/39/39-678.cpp'
source_filename = "POJ-104-source/39/39-678.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_678.cpp, i8* null }]
...
21:                                               ; preds = %17
  ...
  %53 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), i8* %27, i32* %32, i32* %37, i8* %42, i8* %47, i32* %52)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_678.cpp() #0 section ".text.startup" {
