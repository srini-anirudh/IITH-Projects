; ModuleID = 'POJ-104-source/39/39-70.cpp'
source_filename = "POJ-104-source/39/39-70.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_70.cpp, i8* null }]
...
25:                                               ; preds = %21
  ...
  %50 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), [30 x i8]* %29, i32* %33, i32* %37, i8* %41, i8* %45, i32* %49)
  br label %51
...
228:                                              ; preds = %223, %212
  ...
  %233 = getelementptr inbounds [30 x i8], [30 x i8]* %232, i64 0, i64 0
  %234 = load i32, i32* %4, align 4
  %235 = sext i32 %234 to i64
  %236 = getelementptr inbounds [100 x i32], [100 x i32]* %7, i64 0, i64 %235
  %237 = load i32, i32* %236, align 4
  %238 = load i32, i32* %6, align 4
  %239 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.2, i64 0, i64 0), i8* %233, i32 %237, i32 %238)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_70.cpp() #0 section ".text.startup" {
