; ModuleID = 'POJ-104-source/39/39-705.cpp'
source_filename = "POJ-104-source/39/39-705.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_705.cpp, i8* null }]
...
12:                                               ; preds = %8
  ...
  %37 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), [20 x i8]* %16, i32* %20, i32* %24, i8* %28, i8* %32, i32* %36)
...
176:                                              ; preds = %153
  ...
  %184 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.2, i64 0, i64 0), i8* %181, i32 %182, i32 %183)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_705.cpp() #0 section ".text.startup" {
