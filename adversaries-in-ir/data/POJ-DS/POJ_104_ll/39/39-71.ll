; ModuleID = 'POJ-104-source/39/39-71.cpp'
source_filename = "POJ-104-source/39/39-71.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_71.cpp, i8* null }]
...
72:                                               ; preds = %63, %56, %49
  ...
  %75 = getelementptr inbounds [100 x %struct.stu], [100 x %struct.stu]* %2, i64 0, i64 %74
...
95:                                               ; preds = %86, %79, %72
  ...
  %98 = getelementptr inbounds [100 x %struct.stu], [100 x %struct.stu]* %2, i64 0, i64 %97
...
214:                                              ; preds = %209, %179
  ...
  %220 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i8* %219)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_71.cpp() #0 section ".text.startup" {
