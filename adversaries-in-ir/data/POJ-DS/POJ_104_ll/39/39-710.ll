; ModuleID = 'POJ-104-source/39/39-710.cpp'
source_filename = "POJ-104-source/39/39-710.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_710.cpp, i8* null }]
...
13:                                               ; preds = %9
  ...
  %39 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i64 0, i64 0), i8* %18, i32* %22, i32* %26, i8* %30, i8* %34, i32* %38)
...
126:                                              ; preds = %118
  ...
  %135 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %5, i64 0, i64 %134
...
179:                                              ; preds = %175
  ...
  %185 = getelementptr inbounds %struct.student, %struct.student* %6, i32 0, i32 6
...
188:                                              ; preds = %179
  ...
  %191 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %5, i64 0, i64 %190
  %192 = bitcast %struct.student* %6 to i8*
  %193 = bitcast %struct.student* %191 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %192, i8* align 8 %193, i64 40, i1 false)
  br label %194
...
198:                                              ; preds = %175
  %199 = getelementptr inbounds %struct.student, %struct.student* %6, i32 0, i32 0
  %200 = getelementptr inbounds [20 x i8], [20 x i8]* %199, i64 0, i64 0
  %201 = getelementptr inbounds %struct.student, %struct.student* %6, i32 0, i32 6
  %202 = load i32, i32* %201, align 4
  %203 = load i32, i32* %4, align 4
  %204 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i64 0, i64 0), i8* %200, i32 %202, i32 %203)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_710.cpp() #0 section ".text.startup" {
