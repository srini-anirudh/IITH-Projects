; ModuleID = 'POJ-104-source/39/39-714.cpp'
source_filename = "POJ-104-source/39/39-714.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_714.cpp, i8* null }]
...
21:                                               ; preds = %14
  ...
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i64 0, i64 0), i8* %24, i32* %4, i32* %5, i8* %8, i8* %9, i32* %6)
...
112:                                              ; preds = %99
  ...
  %117 = load %struct.stu*, %struct.stu** %10, align 8
  %118 = bitcast %struct.stu* %117 to i8*
  %119 = bitcast %struct.stu* %116 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_714.cpp() #0 section ".text.startup" {
