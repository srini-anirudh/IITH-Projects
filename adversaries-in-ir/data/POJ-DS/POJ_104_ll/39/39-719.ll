; ModuleID = 'POJ-104-source/39/39-719.cpp'
source_filename = "POJ-104-source/39/39-719.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_719.cpp, i8* null }]
...
12:                                               ; preds = %8
  ...
  %42 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i64 0, i64 0), i8* %21, i32* %25, i32* %29, i8* %33, i8* %37, i32* %41)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_719.cpp() #0 section ".text.startup" {
