; ModuleID = 'POJ-104-source/39/39-727.cpp'
source_filename = "POJ-104-source/39/39-727.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_727.cpp, i8* null }]
...
13:                                               ; preds = %8
  ...
  %38 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i64 0, i64 0), [20 x i8]* %17, i32* %21, i32* %25, [2 x i8]* %29, [2 x i8]* %33, i32* %37)
...
101:                                              ; preds = %94
  ...
  %107 = call i32 @strcmp(i8* %106, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0)) #7
...
123:                                              ; preds = %116
  ...
  %129 = call i32 @strcmp(i8* %128, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0)) #7
...
168:                                              ; preds = %155
  ...
  %171 = getelementptr inbounds [100 x %struct.stu], [100 x %struct.stu]* %5, i64 0, i64 %170
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_727.cpp() #0 section ".text.startup" {
