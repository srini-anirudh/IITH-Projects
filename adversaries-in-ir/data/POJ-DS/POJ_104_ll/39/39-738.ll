; ModuleID = 'POJ-104-source/39/39-738.cpp'
source_filename = "POJ-104-source/39/39-738.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_738.cpp, i8* null }]
...
18:                                               ; preds = %11
  ...
  %33 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), [20 x i8]* %22, i32* %24, i32* %26, i8* %28, i8* %30, i32* %32)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_738.cpp() #0 section ".text.startup" {
