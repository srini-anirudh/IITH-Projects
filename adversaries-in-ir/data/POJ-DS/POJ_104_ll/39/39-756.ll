; ModuleID = 'POJ-104-source/39/39-756.cpp'
source_filename = "POJ-104-source/39/39-756.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_756.cpp, i8* null }]
...
16:                                               ; preds = %12
  ...
  %37 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i64 0, i64 0), i8* %24, i32* %28, i32* %32, i8* %10, i8* %9, i32* %36)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_756.cpp() #0 section ".text.startup" {
