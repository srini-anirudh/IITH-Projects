; ModuleID = 'POJ-104-source/39/39-767.cpp'
source_filename = "POJ-104-source/39/39-767.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_767.cpp, i8* null }]
...
196:                                              ; preds = %179
  ...
  %206 = getelementptr inbounds [101 x %struct.s], [101 x %struct.s]* %5, i64 0, i64 %205
  %207 = getelementptr inbounds [101 x %struct.s], [101 x %struct.s]* %5, i64 0, i64 0
  %208 = bitcast %struct.s* %207 to i8*
  %209 = bitcast %struct.s* %206 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_767.cpp() #0 section ".text.startup" {
