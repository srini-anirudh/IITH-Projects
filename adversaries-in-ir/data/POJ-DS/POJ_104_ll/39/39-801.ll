; ModuleID = 'POJ-104-source/39/39-801.cpp'
source_filename = "POJ-104-source/39/39-801.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_801.cpp, i8* null }]
...
10:                                               ; preds = %6
  ...
  %36 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i64 0, i64 0), i8* %15, i32* %19, i32* %23, i8* %27, i8* %31, i32* %35)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_801.cpp() #0 section ".text.startup" {
