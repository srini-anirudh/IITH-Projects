; ModuleID = 'POJ-104-source/39/39-815.cpp'
source_filename = "POJ-104-source/39/39-815.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_815.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %15 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), i8* %9, i32* %10, i32* %11, i8* %12, i8* %13, i32* %14)
...
81:                                               ; preds = %77
  ...
  %89 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), i8* %83, i32* %84, i32* %85, i8* %86, i8* %87, i32* %88)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_815.cpp() #0 section ".text.startup" {
