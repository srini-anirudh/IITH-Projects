; ModuleID = 'POJ-104-source/39/39-823.cpp'
source_filename = "POJ-104-source/39/39-823.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_823.cpp, i8* null }]
...
13:                                               ; preds = %9
  ...
  %46 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.2, i64 0, i64 0), i32* %27, i32* %31, i8* %36, i8* %41, i32* %45)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_823.cpp() #0 section ".text.startup" {
