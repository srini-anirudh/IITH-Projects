; ModuleID = 'POJ-104-source/39/39-828.cpp'
source_filename = "POJ-104-source/39/39-828.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_828.cpp, i8* null }]
...
13:                                               ; preds = %9
  ...
  %43 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i64 0, i64 0), i8* %18, i32* %22, i32* %26, i8* %7, i8* %30, i8* %34, i8* %38, i32* %42)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_828.cpp() #0 section ".text.startup" {
