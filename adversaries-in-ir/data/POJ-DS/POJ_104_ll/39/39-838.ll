; ModuleID = 'POJ-104-source/39/39-838.cpp'
source_filename = "POJ-104-source/39/39-838.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_838.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @cc, i64 0, i64 1))
...
25:                                               ; preds = %21
  ...
  %41 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.2, i64 0, i64 0), i8* %30, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @cc, i64 0, i64 1), i32* %35, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @cc, i64 0, i64 2), i32* %40)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_838.cpp() #0 section ".text.startup" {
