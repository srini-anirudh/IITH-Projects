; ModuleID = 'POJ-104-source/39/39-860.cpp'
source_filename = "POJ-104-source/39/39-860.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_860.cpp, i8* null }]
...
18:                                               ; preds = %14
  ...
  %44 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i64 0, i64 0), i8* %23, i32* %27, i32* %31, i8* %35, i8* %39, i32* %43)
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %52, i8* align 4 %53, i64 44, i1 false)
  %54 = call i32 @_Z7yuanshi3stu(%struct.stu* byval(%struct.stu) align 8 %8)
  %55 = icmp ne i32 %54, 0
...
63:                                               ; preds = %56, %18
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %67, i8* align 4 %68, i64 44, i1 false)
  %69 = call i32 @_Z4wusi3stu(%struct.stu* byval(%struct.stu) align 8 %9)
  %70 = icmp ne i32 %69, 0
...
78:                                               ; preds = %71, %63
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %82, i8* align 4 %83, i64 44, i1 false)
  %84 = call i32 @_Z5score3stu(%struct.stu* byval(%struct.stu) align 8 %10)
  %85 = icmp ne i32 %84, 0
...
93:                                               ; preds = %86, %78
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %97, i8* align 4 %98, i64 44, i1 false)
  %99 = call i32 @_Z7western3stu(%struct.stu* byval(%struct.stu) align 8 %11)
...
108:                                              ; preds = %101, %93
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %112, i8* align 4 %113, i64 44, i1 false)
  %114 = call i32 @_Z12contribution3stu(%struct.stu* byval(%struct.stu) align 8 %12)
...
define dso_local i32 @_Z7yuanshi3stu(%struct.stu* byval(%struct.stu) align 8 %0) #5 {
  %2 = alloca i32, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z4wusi3stu(%struct.stu* byval(%struct.stu) align 8 %0) #5 {
  %2 = alloca i32, align 4
  %3 = getelementptr inbounds %struct.stu, %struct.stu* %0, i32 0, i32 1
  %4 = load i32, i32* %3, align 8
  %5 = icmp sgt i32 %4, 85
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z5score3stu(%struct.stu* byval(%struct.stu) align 8 %0) #5 {
  %2 = alloca i32, align 4
  %3 = getelementptr inbounds %struct.stu, %struct.stu* %0, i32 0, i32 1
  %4 = load i32, i32* %3, align 8
  %5 = icmp sgt i32 %4, 90
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z7western3stu(%struct.stu* byval(%struct.stu) align 8 %0) #5 {
  %2 = alloca i32, align 4
  %3 = getelementptr inbounds %struct.stu, %struct.stu* %0, i32 0, i32 1
  %4 = load i32, i32* %3, align 8
  %5 = icmp sgt i32 %4, 85
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z12contribution3stu(%struct.stu* byval(%struct.stu) align 8 %0) #5 {
  %2 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_860.cpp() #0 section ".text.startup" {
