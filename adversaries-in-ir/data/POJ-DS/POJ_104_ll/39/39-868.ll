; ModuleID = 'POJ-104-source/39/39-868.cpp'
source_filename = "POJ-104-source/39/39-868.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_868.cpp, i8* null }]
...
96:                                               ; preds = %90
  ...
  %101 = call i32 @strcmp(i8* %100, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0)) #7
...
115:                                              ; preds = %109
  ...
  %120 = call i32 @strcmp(i8* %119, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0)) #7
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_868.cpp() #0 section ".text.startup" {
