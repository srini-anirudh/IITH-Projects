; ModuleID = 'POJ-104-source/39/39-877.cpp'
source_filename = "POJ-104-source/39/39-877.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_877.cpp, i8* null }]
...
46:                                               ; preds = %8
  %47 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %4)
  store i32 0, i32* %3, align 4
  br label %48
...
52:                                               ; preds = %48
  ...
  %58 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* %57)
  ...
  %79 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.2, i64 0, i64 0), i32* %62, i32* %66, i8* %70, i8* %74, i32* %78)
...
214:                                              ; preds = %48
  ...
  call void @_Z3paiP3stuiPi(%struct.stu* %215, i32 %216, i32* getelementptr inbounds ([101 x i32], [101 x i32]* @a, i64 0, i64 0))
...
define dso_local void @_Z3paiP3stuiPi(%struct.stu* %0, i32 %1, i32* %2) #6 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_877.cpp() #0 section ".text.startup" {
