; ModuleID = 'POJ-104-source/39/39-898.cpp'
source_filename = "POJ-104-source/39/39-898.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_898.cpp, i8* null }]
...
23:                                               ; preds = %19
  ...
  %42 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), [20 x i8]* %26, i32* %29, i32* %32, i8* %35, i8* %38, i32* %41)
  br label %43
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_898.cpp() #0 section ".text.startup" {
