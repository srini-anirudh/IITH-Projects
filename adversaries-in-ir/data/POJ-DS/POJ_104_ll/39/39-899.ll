; ModuleID = 'POJ-104-source/39/39-899.cpp'
source_filename = "POJ-104-source/39/39-899.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_899.cpp, i8* null }]
...
68:                                               ; preds = %61
  ...
  %77 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %4, i64 0, i64 %76
...
93:                                               ; preds = %86
  ...
  %102 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %4, i64 0, i64 %101
...
122:                                              ; preds = %111, %104
  ...
  %125 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %4, i64 0, i64 %124
...
129:                                              ; preds = %122
  ...
  %132 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %4, i64 0, i64 %131
...
137:                                              ; preds = %129
  ...
  %140 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %4, i64 0, i64 %139
...
163:                                              ; preds = %155
  ...
  %166 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %4, i64 0, i64 %165
  %167 = getelementptr inbounds %struct.student, %struct.student* %166, i32 0, i32 6
  %168 = load i32, i32* %167, align 4
  %169 = add nsw i32 %168, 850
  %170 = load i32, i32* %5, align 4
  %171 = sext i32 %170 to i64
  %172 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %4, i64 0, i64 %171
...
174:                                              ; preds = %163, %155, %148
  ...
  %178 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %4, i64 0, i64 %177
...
190:                                              ; preds = %186
  ...
  %193 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %4, i64 0, i64 %192
...
198:                                              ; preds = %190
  ...
  %201 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %4, i64 0, i64 %200
...
204:                                              ; preds = %198, %190
  ...
  %208 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %4, i64 0, i64 %207
...
220:                                              ; preds = %216
  ...
  %223 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %4, i64 0, i64 %222
...
228:                                              ; preds = %220
  ...
  %231 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %4, i64 0, i64 %230
  %232 = getelementptr inbounds %struct.student, %struct.student* %231, i32 0, i32 0
  %233 = getelementptr inbounds [25 x i8], [25 x i8]* %232, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_899.cpp() #0 section ".text.startup" {
