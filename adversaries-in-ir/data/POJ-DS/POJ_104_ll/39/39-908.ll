; ModuleID = 'POJ-104-source/39/39-908.cpp'
source_filename = "POJ-104-source/39/39-908.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_908.cpp, i8* null }]
...
14:                                               ; preds = %10
  ...
  %43 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.2, i64 0, i64 0), i32* %26, i32* %30, i8* %34, i8* %38, i32* %42)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_908.cpp() #0 section ".text.startup" {
