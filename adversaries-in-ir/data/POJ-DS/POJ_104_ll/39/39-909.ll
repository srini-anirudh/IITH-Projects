; ModuleID = 'POJ-104-source/39/39-909.cpp'
source_filename = "POJ-104-source/39/39-909.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_909.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %44 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.2, i64 0, i64 0), i32* %27, i32* %31, i8* %35, i8* %39, i32* %43)
...
184:                                              ; preds = %171
  ...
  %198 = bitcast %struct.stu* %193 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_909.cpp() #0 section ".text.startup" {
