; ModuleID = 'POJ-104-source/39/39-912.cpp'
source_filename = "POJ-104-source/39/39-912.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_912.cpp, i8* null }]
...
13:                                               ; preds = %9
  ...
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), [20 x i8]* %21)
  ...
  %38 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i8* %37)
  %39 = call i32 @getchar()
...
211:                                              ; preds = %198
  ...
  %220 = getelementptr inbounds [101 x %struct.bac], [101 x %struct.bac]* %2, i64 0, i64 %219
  %221 = load i32, i32* %5, align 4
  %222 = sext i32 %221 to i64
  %223 = getelementptr inbounds [101 x %struct.bac], [101 x %struct.bac]* %2, i64 0, i64 %222
  %224 = bitcast %struct.bac* %223 to i8*
  %225 = bitcast %struct.bac* %220 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_912.cpp() #0 section ".text.startup" {
