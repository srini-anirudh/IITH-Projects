; ModuleID = 'POJ-104-source/39/39-915.cpp'
source_filename = "POJ-104-source/39/39-915.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_915.cpp, i8* null }]
...
11:                                               ; preds = %7
  ...
  %14 = getelementptr inbounds [102 x %struct.student], [102 x %struct.student]* @stu, i64 0, i64 %13
  ...
  %36 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i64 0, i64 0), [25 x i8]* %15, i32* %19, i32* %23, [2 x i8]* %27, [2 x i8]* %31, i32* %35)
...
43:                                               ; preds = %11
  ...
  %46 = getelementptr inbounds [102 x %struct.student], [102 x %struct.student]* @stu, i64 0, i64 %45
...
50:                                               ; preds = %43
  ...
  %53 = getelementptr inbounds [102 x %struct.student], [102 x %struct.student]* @stu, i64 0, i64 %52
...
61:                                               ; preds = %50, %43, %11
  ...
  %64 = getelementptr inbounds [102 x %struct.student], [102 x %struct.student]* @stu, i64 0, i64 %63
...
68:                                               ; preds = %61
  ...
  %71 = getelementptr inbounds [102 x %struct.student], [102 x %struct.student]* @stu, i64 0, i64 %70
...
75:                                               ; preds = %68
  ...
  %84 = getelementptr inbounds [102 x %struct.student], [102 x %struct.student]* @stu, i64 0, i64 %83
...
86:                                               ; preds = %75, %68, %61
  ...
  %89 = getelementptr inbounds [102 x %struct.student], [102 x %struct.student]* @stu, i64 0, i64 %88
...
93:                                               ; preds = %86
  ...
  %96 = getelementptr inbounds [102 x %struct.student], [102 x %struct.student]* @stu, i64 0, i64 %95
  %97 = getelementptr inbounds %struct.student, %struct.student* %96, i32 0, i32 6
  %98 = load i32, i32* %97, align 4
  %99 = add nsw i32 %98, 2000
  %100 = load i32, i32* %2, align 4
  %101 = sext i32 %100 to i64
  %102 = getelementptr inbounds [102 x %struct.student], [102 x %struct.student]* @stu, i64 0, i64 %101
...
104:                                              ; preds = %93, %86
  ...
  %107 = getelementptr inbounds [102 x %struct.student], [102 x %struct.student]* @stu, i64 0, i64 %106
...
120:                                              ; preds = %111
  ...
  %123 = getelementptr inbounds [102 x %struct.student], [102 x %struct.student]* @stu, i64 0, i64 %122
  %124 = getelementptr inbounds %struct.student, %struct.student* %123, i32 0, i32 6
  %125 = load i32, i32* %124, align 4
  %126 = add nsw i32 %125, 1000
  %127 = load i32, i32* %2, align 4
  %128 = sext i32 %127 to i64
  %129 = getelementptr inbounds [102 x %struct.student], [102 x %struct.student]* @stu, i64 0, i64 %128
  %130 = getelementptr inbounds %struct.student, %struct.student* %129, i32 0, i32 6
  store i32 %126, i32* %130, align 4
  br label %131

131:                                              ; preds = %120, %111, %104
...
138:                                              ; preds = %131
  ...
  %141 = getelementptr inbounds [102 x %struct.student], [102 x %struct.student]* @stu, i64 0, i64 %140
...
147:                                              ; preds = %138
  ...
  %150 = getelementptr inbounds [102 x %struct.student], [102 x %struct.student]* @stu, i64 0, i64 %149
  %151 = getelementptr inbounds %struct.student, %struct.student* %150, i32 0, i32 6
  %152 = load i32, i32* %151, align 4
  %153 = add nsw i32 %152, 850
  %154 = load i32, i32* %2, align 4
  %155 = sext i32 %154 to i64
  %156 = getelementptr inbounds [102 x %struct.student], [102 x %struct.student]* @stu, i64 0, i64 %155
  %157 = getelementptr inbounds %struct.student, %struct.student* %156, i32 0, i32 6
  store i32 %153, i32* %157, align 4
  br label %158

158:                                              ; preds = %147, %138, %131
  br label %159
...
167:                                              ; preds = %163
  ...
  %171 = getelementptr inbounds [102 x %struct.student], [102 x %struct.student]* @stu, i64 0, i64 %170
...
190:                                              ; preds = %184
  ...
  %193 = getelementptr inbounds [102 x %struct.student], [102 x %struct.student]* @stu, i64 0, i64 %192
  %194 = getelementptr inbounds %struct.student, %struct.student* %193, i32 0, i32 6
  %195 = load i32, i32* %194, align 4
  %196 = load i32, i32* %3, align 4
  %197 = add nsw i32 %196, 1
  %198 = sext i32 %197 to i64
  %199 = getelementptr inbounds [102 x %struct.student], [102 x %struct.student]* @stu, i64 0, i64 %198
...
203:                                              ; preds = %190
  ...
  %206 = getelementptr inbounds [102 x %struct.student], [102 x %struct.student]* @stu, i64 0, i64 %205
  %207 = bitcast %struct.student* %206 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 getelementptr inbounds (%struct.student, %struct.student* @temp, i32 0, i32 0, i32 0), i8* align 16 %207, i64 48, i1 false)
  %208 = load i32, i32* %3, align 4
  %209 = add nsw i32 %208, 1
  %210 = sext i32 %209 to i64
  %211 = getelementptr inbounds [102 x %struct.student], [102 x %struct.student]* @stu, i64 0, i64 %210
  %212 = load i32, i32* %3, align 4
  %213 = sext i32 %212 to i64
  %214 = getelementptr inbounds [102 x %struct.student], [102 x %struct.student]* @stu, i64 0, i64 %213
  %215 = bitcast %struct.student* %214 to i8*
  %216 = bitcast %struct.student* %211 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %215, i8* align 16 %216, i64 48, i1 false)
  %217 = load i32, i32* %3, align 4
  %218 = add nsw i32 %217, 1
  %219 = sext i32 %218 to i64
  %220 = getelementptr inbounds [102 x %struct.student], [102 x %struct.student]* @stu, i64 0, i64 %219
  %221 = bitcast %struct.student* %220 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %221, i8* align 4 getelementptr inbounds (%struct.student, %struct.student* @temp, i32 0, i32 0, i32 0), i64 48, i1 false)
  br label %222
...
230:                                              ; preds = %179
  %231 = load i32, i32* getelementptr inbounds ([102 x %struct.student], [102 x %struct.student]* @stu, i64 0, i64 0, i32 6), align 4
  %232 = load i32, i32* %5, align 4
  %233 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.2, i64 0, i64 0), i8* getelementptr inbounds ([102 x %struct.student], [102 x %struct.student]* @stu, i64 0, i64 0, i32 0, i64 0), i32 %231, i32 %232)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_915.cpp() #0 section ".text.startup" {
