; ModuleID = 'POJ-104-source/39/39-920.cpp'
source_filename = "POJ-104-source/39/39-920.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_920.cpp, i8* null }]
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z5banjiic(i32 %0, i8 signext %1) #4 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i8, align 1
  store i32 %0, i32* %4, align 4
...
19:                                               ; preds = %15
  ...
  %39 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), i8* %23, i32* %26, i32* %29, i8* %32, i8* %35, i32* %38)
  ...
  %48 = call i32 @_Z7yuanshiii(i32 %43, i32 %47)
  ...
  %73 = call i32 @_Z4xibuic(i32 %68, i8 signext %72)
  ...
  %83 = call i32 @_Z5banjiic(i32 %78, i8 signext %82)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_920.cpp() #0 section ".text.startup" {
