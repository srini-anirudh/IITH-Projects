; ModuleID = 'POJ-104-source/39/39-931.cpp'
source_filename = "POJ-104-source/39/39-931.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_931.cpp, i8* null }]
...
define dso_local i32 @_Z5money6member(%struct.member* byval(%struct.member) align 8 %0) #4 {
...
15:                                               ; preds = %11
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %45, i8* align 4 %46, i64 116, i1 false)
  %47 = call i32 @_Z5money6member(%struct.member* byval(%struct.member) align 8 %8)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_931.cpp() #0 section ".text.startup" {
