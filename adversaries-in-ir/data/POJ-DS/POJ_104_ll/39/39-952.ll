; ModuleID = 'POJ-104-source/39/39-952.cpp'
source_filename = "POJ-104-source/39/39-952.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_952.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %8)
...
29:                                               ; preds = %25
  ...
  %49 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), i8* %33, i32* %36, i32* %39, i8* %42, i8* %45, i32* %48)
  br label %50
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_952.cpp() #0 section ".text.startup" {
