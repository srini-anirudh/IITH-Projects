; ModuleID = 'POJ-104-source/39/39-953.cpp'
source_filename = "POJ-104-source/39/39-953.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_953.cpp, i8* null }]
...
48:                                               ; preds = %45
  ...
  %62 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), i8* %51, i32* %53, i32* %55, i8* %57, i8* %59, i32* %61)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_953.cpp() #0 section ".text.startup" {
