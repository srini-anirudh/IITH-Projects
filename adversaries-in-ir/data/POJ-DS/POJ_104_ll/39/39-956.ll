; ModuleID = 'POJ-104-source/39/39-956.cpp'
source_filename = "POJ-104-source/39/39-956.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_956.cpp, i8* null }]
...
13:                                               ; preds = %9
  ...
  %41 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.2, i64 0, i64 0), i32* %24, i32* %28, i8* %32, i8* %36, i32* %40)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_956.cpp() #0 section ".text.startup" {
