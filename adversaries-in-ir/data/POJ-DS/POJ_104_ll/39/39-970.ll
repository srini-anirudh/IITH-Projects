; ModuleID = 'POJ-104-source/39/39-970.cpp'
source_filename = "POJ-104-source/39/39-970.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_970.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z3ysji(i32 %0) #0 {
...
25:                                               ; preds = %16, %9, %1
  ...
  call void @_Z3wsji(i32 %26)
  ret void
}

; Function Attrs: noinline uwtable
define dso_local void @_Z3wsji(i32 %0) #0 {
  %2 = alloca i32, align 4
  store i32 %0, i32* %2, align 4
  %3 = load i32, i32* %2, align 4
  %4 = sext i32 %3 to i64
...
25:                                               ; preds = %16, %9, %1
  %26 = load i32, i32* %2, align 4
  call void @_Z3yxji(i32 %26)
  ret void
}

; Function Attrs: noinline uwtable
define dso_local void @_Z3yxji(i32 %0) #0 {
  %2 = alloca i32, align 4
  store i32 %0, i32* %2, align 4
  %3 = load i32, i32* %2, align 4
  %4 = sext i32 %3 to i64
...
18:                                               ; preds = %9, %1
  ...
  call void @_Z3xbji(i32 %19)
  ret void
}

; Function Attrs: noinline uwtable
define dso_local void @_Z3xbji(i32 %0) #0 {
  %2 = alloca i32, align 4
  store i32 %0, i32* %2, align 4
  %3 = load i32, i32* %2, align 4
  %4 = sext i32 %3 to i64
...
26:                                               ; preds = %17, %9, %1
  ...
  call void @_Z3gxji(i32 %27)
  ret void
}

; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z3gxji(i32 %0) #4 {
  %2 = alloca i32, align 4
  store i32 %0, i32* %2, align 4
  %3 = load i32, i32* %2, align 4
  %4 = sext i32 %3 to i64
...
10:                                               ; preds = %6
  ...
  %36 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), i8* %15, i32* %19, i32* %23, i8* %27, i8* %31, i32* %35)
  %37 = load i32, i32* %2, align 4
  call void @_Z3ysji(i32 %37)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_970.cpp() #0 section ".text.startup" {
