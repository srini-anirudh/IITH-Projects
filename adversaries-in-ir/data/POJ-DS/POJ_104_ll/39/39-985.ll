; ModuleID = 'POJ-104-source/39/39-985.cpp'
source_filename = "POJ-104-source/39/39-985.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_39_985.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %29 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i8* %20, i32* %24, i32* %28)
  ...
  %42 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0), [3 x i8]* %33, [3 x i8]* %37, i32* %41)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_39_985.cpp() #0 section ".text.startup" {
