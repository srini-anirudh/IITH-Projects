; ModuleID = 'POJ-104-source/4/4-1049.cpp'
source_filename = "POJ-104-source/4/4-1049.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_4_1049.cpp, i8* null }]
...
55:                                               ; preds = %30
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %56, i8* align 4 bitcast ([3 x i32]* @__const.main.x to i8*), i64 12, i1 false)
  %57 = bitcast [3 x i32]* %11 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %57, i8* align 4 bitcast ([3 x i32]* @__const.main.y to i8*), i64 12, i1 false)
...
92:                                               ; preds = %74
  ...
  %102 = getelementptr inbounds [3 x i32], [3 x i32]* %11, i64 0, i64 %101
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_4_1049.cpp() #0 section ".text.startup" {
