; ModuleID = 'POJ-104-source/4/4-139.cpp'
source_filename = "POJ-104-source/4/4-139.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_4_139.cpp, i8* null }]
...
53:                                               ; preds = %51
  ...
  %58 = getelementptr inbounds [1000 x [1000 x i32]], [1000 x [1000 x i32]]* %7, i64 0, i64 %57
...
95:                                               ; preds = %93
  ...
  %100 = getelementptr inbounds [1000 x [1000 x i32]], [1000 x [1000 x i32]]* %7, i64 0, i64 %99
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_4_139.cpp() #0 section ".text.startup" {
