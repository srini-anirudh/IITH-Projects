; ModuleID = 'POJ-104-source/4/4-147.cpp'
source_filename = "POJ-104-source/4/4-147.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_4_147.cpp, i8* null }]
...
33:                                               ; preds = %9
  ...
  call void @_Z3prtPA100_iii([100 x i32]* %34, i32 %35, i32 %36)
...
; Function Attrs: noinline uwtable
define dso_local void @_Z3prtPA100_iii([100 x i32]* %0, i32 %1, i32 %2) #0 {
...
22:                                               ; preds = %41, %20
  ...
  %26 = sub nsw i32 %25, 1
  %27 = call i32 @_Z3minii(i32 %24, i32 %26)
...
59:                                               ; preds = %80, %55
  ...
  %66 = call i32 @_Z3maxii(i32 0, i32 %65)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_4_147.cpp() #0 section ".text.startup" {
