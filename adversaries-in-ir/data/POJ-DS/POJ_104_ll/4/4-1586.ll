; ModuleID = 'POJ-104-source/4/4-1586.cpp'
source_filename = "POJ-104-source/4/4-1586.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_4_1586.cpp, i8* null }]
...
114:                                              ; preds = %107
  ...
  call void @_Z1fPiS_ii(i32* %115, i32* %120, i32 %121, i32 %122)
  br label %123
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_4_1586.cpp() #0 section ".text.startup" {
