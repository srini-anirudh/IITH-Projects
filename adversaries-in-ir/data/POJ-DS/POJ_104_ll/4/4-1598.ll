; ModuleID = 'POJ-104-source/4/4-1598.cpp'
source_filename = "POJ-104-source/4/4-1598.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_4_1598.cpp, i8* null }]
...
15:                                               ; preds = %12
  ...
  store i32 -32767, i32* %21, align 4
  br label %22
...
29:                                               ; preds = %8
  %30 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %4, i32* %3)
  store i32 0, i32* %6, align 4
  br label %31
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_4_1598.cpp() #0 section ".text.startup" {
