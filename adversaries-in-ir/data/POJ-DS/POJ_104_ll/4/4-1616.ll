; ModuleID = 'POJ-104-source/4/4-1616.cpp'
source_filename = "POJ-104-source/4/4-1616.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_4_1616.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5move1PPiii(i32** %0, i32 %1, i32 %2) #0 {
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5move2PPiii(i32** %0, i32 %1, i32 %2) #0 {
  %4 = alloca i32**, align 8
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
  %7 = alloca i32, align 4
...
37:                                               ; preds = %33
  ...
  %46 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i32* %45)
  br label %47
...
58:                                               ; preds = %54
  ...
  call void @_Z5move1PPiii(i32** %59, i32 %60, i32 %61)
  br label %66
...
62:                                               ; preds = %54
  ...
  call void @_Z5move2PPiii(i32** %63, i32 %64, i32 %65)
  br label %66
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_4_1616.cpp() #0 section ".text.startup" {
