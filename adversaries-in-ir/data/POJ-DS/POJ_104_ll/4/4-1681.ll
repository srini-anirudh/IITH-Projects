; ModuleID = 'POJ-104-source/4/4-1681.cpp'
source_filename = "POJ-104-source/4/4-1681.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_4_1681.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %3 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* @row, i32* @col)
...
35:                                               ; preds = %31
  ...
  call void @_Z3outiii(i32 %36, i32 %37, i32 0)
  br label %38
...
46:                                               ; preds = %42
  ...
  call void @_Z3outiii(i32 %47, i32 %49, i32 %50)
  br label %51
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_4_1681.cpp() #0 section ".text.startup" {
