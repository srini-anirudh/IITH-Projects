; ModuleID = 'POJ-104-source/4/4-1774.cpp'
source_filename = "POJ-104-source/4/4-1774.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_4_1774.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %2 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* @r, i32* @c)
...
; Function Attrs: noinline uwtable
define dso_local void @_Z1xi(i32 %0) #0 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_4_1774.cpp() #0 section ".text.startup" {
