; ModuleID = 'POJ-104-source/4/4-1805.cpp'
source_filename = "POJ-104-source/4/4-1805.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_4_1805.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %8 = call noalias i8* @calloc(i64 100, i64 400) #3
...
98:                                               ; preds = %96
  %99 = load [100 x i32]*, [100 x i32]** %7, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_4_1805.cpp() #0 section ".text.startup" {
