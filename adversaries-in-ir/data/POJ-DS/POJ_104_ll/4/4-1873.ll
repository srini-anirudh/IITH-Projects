; ModuleID = 'POJ-104-source/4/4-1873.cpp'
source_filename = "POJ-104-source/4/4-1873.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_4_1873.cpp, i8* null }]
...
36:                                               ; preds = %12
  ...
  %39 = call i32 @_Z3minii(i32 %37, i32 %38)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_4_1873.cpp() #0 section ".text.startup" {
