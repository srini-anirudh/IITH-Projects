; ModuleID = 'POJ-104-source/4/4-2102.cpp'
source_filename = "POJ-104-source/4/4-2102.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_4_2102.cpp, i8* null }]
...
19:                                               ; preds = %15
  %20 = call noalias i8* @malloc(i64 4) #3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_4_2102.cpp() #0 section ".text.startup" {
