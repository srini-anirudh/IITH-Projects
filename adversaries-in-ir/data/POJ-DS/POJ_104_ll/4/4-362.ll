; ModuleID = 'POJ-104-source/4/4-362.cpp'
source_filename = "POJ-104-source/4/4-362.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_4_362.cpp, i8* null }]
...
43:                                               ; preds = %36
  ...
  %47 = add nsw i32 %46, 1
  %48 = call i32 @_Z3maxii(i32 0, i32 %47)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_4_362.cpp() #0 section ".text.startup" {
