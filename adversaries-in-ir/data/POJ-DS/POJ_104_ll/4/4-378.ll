; ModuleID = 'POJ-104-source/4/4-378.cpp'
source_filename = "POJ-104-source/4/4-378.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_4_378.cpp, i8* null }]
...
30:                                               ; preds = %15
  %31 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0))
  br label %32
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_4_378.cpp() #0 section ".text.startup" {
