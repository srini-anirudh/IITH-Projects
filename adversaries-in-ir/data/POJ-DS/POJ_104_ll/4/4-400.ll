; ModuleID = 'POJ-104-source/4/4-400.cpp'
source_filename = "POJ-104-source/4/4-400.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_4_400.cpp, i8* null }]
...
42:                                               ; preds = %35
  ...
  %46 = add nsw i32 %45, 1
  %47 = call i32 @_Z3maxii(i32 0, i32 %46)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_4_400.cpp() #0 section ".text.startup" {
