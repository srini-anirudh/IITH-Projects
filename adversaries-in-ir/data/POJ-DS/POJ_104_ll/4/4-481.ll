; ModuleID = 'POJ-104-source/4/4-481.cpp'
source_filename = "POJ-104-source/4/4-481.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_4_481.cpp, i8* null }]
...
128:                                              ; preds = %86
  ...
  %130 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32 %129)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_4_481.cpp() #0 section ".text.startup" {
