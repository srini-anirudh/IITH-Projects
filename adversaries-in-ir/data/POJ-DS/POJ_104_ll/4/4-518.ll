; ModuleID = 'POJ-104-source/4/4-518.cpp'
source_filename = "POJ-104-source/4/4-518.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_4_518.cpp, i8* null }]
...
85:                                               ; preds = %106, %79
  ...
  %88 = getelementptr inbounds [99 x [99 x i32]], [99 x [99 x i32]]* %4, i64 0, i64 %87
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_4_518.cpp() #0 section ".text.startup" {
