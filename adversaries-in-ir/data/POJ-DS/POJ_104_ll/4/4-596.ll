; ModuleID = 'POJ-104-source/4/4-596.cpp'
source_filename = "POJ-104-source/4/4-596.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_4_596.cpp, i8* null }]
...
83:                                               ; preds = %81
  ...
  %91 = getelementptr inbounds [1000 x i32], [1000 x i32]* %86, i64 0, i64 %90
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_4_596.cpp() #0 section ".text.startup" {
