; ModuleID = 'POJ-104-source/4/4-661.cpp'
source_filename = "POJ-104-source/4/4-661.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_4_661.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %11 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %8, i32* %9)
...
37:                                               ; preds = %95, %36
  ...
  %40 = getelementptr inbounds [200 x [200 x i32]], [200 x [200 x i32]]* %10, i64 0, i64 %39
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_4_661.cpp() #0 section ".text.startup" {
