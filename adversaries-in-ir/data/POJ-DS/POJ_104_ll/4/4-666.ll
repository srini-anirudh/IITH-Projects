; ModuleID = 'POJ-104-source/4/4-666.cpp'
source_filename = "POJ-104-source/4/4-666.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_4_666.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %16, i32* %4)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_4_666.cpp() #0 section ".text.startup" {
