; ModuleID = 'POJ-104-source/4/4-70.cpp'
source_filename = "POJ-104-source/4/4-70.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_4_70.cpp, i8* null }]
...
16:                                               ; preds = %12
  %17 = call noalias i8* @malloc(i64 400) #3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_4_70.cpp() #0 section ".text.startup" {
