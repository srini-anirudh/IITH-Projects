; ModuleID = 'POJ-104-source/4/4-768.cpp'
source_filename = "POJ-104-source/4/4-768.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_4_768.cpp, i8* null }]
...
33:                                               ; preds = %29
  ...
  call void @_Z6bianliii(i32 0, i32 %34)
  br label %35
...
43:                                               ; preds = %39
  ...
  %46 = sub nsw i32 %45, 1
  call void @_Z6bianliii(i32 %44, i32 %46)
  br label %47
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_4_768.cpp() #0 section ".text.startup" {
