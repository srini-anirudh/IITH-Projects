; ModuleID = 'POJ-104-source/4/4-77.cpp'
source_filename = "POJ-104-source/4/4-77.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_4_77.cpp, i8* null }]
...
38:                                               ; preds = %8
  ...
  call void @_Z5printPPiii(i32** %39, i32 %40, i32 %41)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5printPPiii(i32** %0, i32 %1, i32 %2) #0 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_4_77.cpp() #0 section ".text.startup" {
