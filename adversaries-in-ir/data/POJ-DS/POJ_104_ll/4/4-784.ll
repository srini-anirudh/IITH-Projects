; ModuleID = 'POJ-104-source/4/4-784.cpp'
source_filename = "POJ-104-source/4/4-784.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_4_784.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %11 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %4, i64 0, i64 0
...
77:                                               ; preds = %71
  %78 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %4, i64 0, i64 0
  ...
  %85 = sub i64 0, %84
  %86 = getelementptr inbounds [100 x i32], [100 x i32]* %82, i64 %85
  store [100 x i32]* %86, [100 x i32]** %5, align 8
...
104:                                              ; preds = %62
  ...
  %106 = getelementptr inbounds [100 x i32], [100 x i32]* %105, i32 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_4_784.cpp() #0 section ".text.startup" {
