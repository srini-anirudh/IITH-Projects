; ModuleID = 'POJ-104-source/40/40-1108.cpp'
source_filename = "POJ-104-source/40/40-1108.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_40_1108.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @_Z1Sddddd(double %11, double %12, double %13, double %14, double %15)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define dso_local void @_Z1Sddddd(double %0, double %1, double %2, double %3, double %4) #0 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_40_1108.cpp() #0 section ".text.startup" {
