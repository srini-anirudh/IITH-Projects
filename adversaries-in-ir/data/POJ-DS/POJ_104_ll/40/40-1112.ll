; ModuleID = 'POJ-104-source/40/40-1112.cpp'
source_filename = "POJ-104-source/40/40-1112.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_40_1112.cpp, i8* null }]
...
define dso_local i32 @main() #5 {
  ...
  %10 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str, i64 0, i64 0), double* %2, double* %3, double* %4, double* %5, double* %6)
...
57:                                               ; preds = %0
  ...
  %63 = call double @_Z1fddddd(double %58, double %59, double %60, double %61, double %62)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_40_1112.cpp() #0 section ".text.startup" {
