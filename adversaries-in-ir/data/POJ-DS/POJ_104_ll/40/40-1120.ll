; ModuleID = 'POJ-104-source/40/40-1120.cpp'
source_filename = "POJ-104-source/40/40-1120.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_40_1120.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z3abcv() #0 {
...
define dso_local i32 @main() #4 {
  %1 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.2, i64 0, i64 0), double* @a, double* @b, double* @c, double* @d, double* @f)
  call void @_Z3abcv()
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_40_1120.cpp() #0 section ".text.startup" {
