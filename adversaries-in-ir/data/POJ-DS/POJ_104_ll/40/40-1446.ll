; ModuleID = 'POJ-104-source/40/40-1446.cpp'
source_filename = "POJ-104-source/40/40-1446.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_40_1446.cpp, i8* null }]
...
56:                                               ; preds = %0
  ...
  %62 = call double @_Z4areaddddd(double %57, double %58, double %59, double %60, double %61)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_40_1446.cpp() #0 section ".text.startup" {
