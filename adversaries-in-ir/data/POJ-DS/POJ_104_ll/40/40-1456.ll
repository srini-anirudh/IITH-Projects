; ModuleID = 'POJ-104-source/40/40-1456.cpp'
source_filename = "POJ-104-source/40/40-1456.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_40_1456.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %10 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str, i64 0, i64 0), double* %2, double* %3, double* %4, double* %5, double* %6)
  %11 = load double, double* %2, align 8
  %12 = load double, double* %3, align 8
  %13 = load double, double* %4, align 8
  %14 = load double, double* %5, align 8
  %15 = load double, double* %6, align 8
  %16 = call double @_Z1Sddddd(double %11, double %12, double %13, double %14, double %15)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_40_1456.cpp() #0 section ".text.startup" {
