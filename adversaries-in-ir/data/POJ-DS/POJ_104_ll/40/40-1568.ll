; ModuleID = 'POJ-104-source/40/40-1568.cpp'
source_filename = "POJ-104-source/40/40-1568.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_40_1568.cpp, i8* null }]
...
11:                                               ; preds = %8
  ...
  %15 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), double* %14)
  br label %16
...
19:                                               ; preds = %8
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), double* %3)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_40_1568.cpp() #0 section ".text.startup" {
