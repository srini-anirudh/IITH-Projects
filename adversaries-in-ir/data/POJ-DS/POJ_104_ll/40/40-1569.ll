; ModuleID = 'POJ-104-source/40/40-1569.cpp'
source_filename = "POJ-104-source/40/40-1569.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_40_1569.cpp, i8* null }]
...
define dso_local i32 @main() #5 {
  ...
  %14 = call double @_Z4areaddddd(double %9, double %10, double %11, double %12, double %13)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_40_1569.cpp() #0 section ".text.startup" {
