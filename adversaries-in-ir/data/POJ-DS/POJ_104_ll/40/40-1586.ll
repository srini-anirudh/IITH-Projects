; ModuleID = 'POJ-104-source/40/40-1586.cpp'
source_filename = "POJ-104-source/40/40-1586.cpp"
...
@final = dso_local global double 0.000000e+00, align 8
@.str = private unnamed_addr constant [4 x i8] c"%lf\00", align 1
@.str.1 = private unnamed_addr constant [14 x i8] c"Invalid input\00", align 1
@.str.2 = private unnamed_addr constant [6 x i8] c"%.4lf\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_40_1586.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %6 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), double* %1)
  %7 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), double* %2)
  %8 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), double* %3)
  ...
  call void @_Z4fourdddddd(double %22, double %23, double %24, double %25, double %26, double %27)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define dso_local void @_Z4fourdddddd(double %0, double %1, double %2, double %3, double %4, double %5) #0 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_40_1586.cpp() #0 section ".text.startup" {
