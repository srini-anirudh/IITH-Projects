; ModuleID = 'POJ-104-source/40/40-1589.cpp'
source_filename = "POJ-104-source/40/40-1589.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_40_1589.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %2 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), double* @a)
  %3 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), double* @b)
  %4 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), double* @c)
  %5 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), double* @d)
  %6 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), double* @angle)
  %7 = load double, double* @a, align 8
  %8 = load double, double* @b, align 8
  %9 = load double, double* @c, align 8
  %10 = load double, double* @d, align 8
  %11 = load double, double* @angle, align 8
  %12 = call double @_Z4areaddddd(double %7, double %8, double %9, double %10, double %11)
...
14:                                               ; preds = %0
  ...
  %20 = call double @_Z4areaddddd(double %15, double %16, double %17, double %18, double %19)
...
define dso_local double @_Z4areaddddd(double %0, double %1, double %2, double %3, double %4) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_40_1589.cpp() #0 section ".text.startup" {
