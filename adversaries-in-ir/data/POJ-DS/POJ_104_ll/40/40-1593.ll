; ModuleID = 'POJ-104-source/40/40-1593.cpp'
source_filename = "POJ-104-source/40/40-1593.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_40_1593.cpp, i8* null }]
...
18:                                               ; preds = %7
  ...
  call void @_Z2heddddd(double %25, double %27, double %29, double %31, double %32)
...
; Function Attrs: noinline uwtable
define dso_local void @_Z2heddddd(double %0, double %1, double %2, double %3, double %4) #0 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_40_1593.cpp() #0 section ".text.startup" {
