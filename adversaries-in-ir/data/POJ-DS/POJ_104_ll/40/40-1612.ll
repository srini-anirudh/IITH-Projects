; ModuleID = 'POJ-104-source/40/40-1612.cpp'
source_filename = "POJ-104-source/40/40-1612.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_40_1612.cpp, i8* null }]
...
define dso_local i32 @main() #5 {
  ...
  %18 = call double @_Z1fddddd(double %13, double %14, double %15, double %16, double %17)
...
22:                                               ; preds = %0
  ...
  %28 = call double @_Z1fddddd(double %23, double %24, double %25, double %26, double %27)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_40_1612.cpp() #0 section ".text.startup" {
