; ModuleID = 'POJ-104-source/40/40-1627.cpp'
source_filename = "POJ-104-source/40/40-1627.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_40_1627.cpp, i8* null }]
...
define dso_local i32 @main() #5 {
  ...
  %19 = call double @_Z6mianjiddddd(double %14, double %15, double %16, double %17, double %18)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_40_1627.cpp() #0 section ".text.startup" {
