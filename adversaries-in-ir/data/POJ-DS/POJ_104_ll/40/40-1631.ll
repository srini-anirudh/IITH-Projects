; ModuleID = 'POJ-104-source/40/40-1631.cpp'
source_filename = "POJ-104-source/40/40-1631.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_40_1631.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %14 = call float @_Z1mfffff(float %9, float %10, float %11, float %12, float %13)
...
18:                                               ; preds = %0
  ...
  %24 = call float @_Z1mfffff(float %19, float %20, float %21, float %22, float %23)
...
; Function Attrs: noinline uwtable
define dso_local float @_Z1mfffff(float %0, float %1, float %2, float %3, float %4) #0 {
  %6 = alloca float, align 4
  %7 = alloca float, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_40_1631.cpp() #0 section ".text.startup" {
