; ModuleID = 'POJ-104-source/40/40-1833.cpp'
source_filename = "POJ-104-source/40/40-1833.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_40_1833.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %17 = call double @_Z1sddddd(double %12, double %13, double %14, double %15, double %16)
...
21:                                               ; preds = %0
  ...
  %27 = call double @_Z1sddddd(double %22, double %23, double %24, double %25, double %26)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_40_1833.cpp() #0 section ".text.startup" {
