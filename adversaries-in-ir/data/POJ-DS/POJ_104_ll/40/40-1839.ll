; ModuleID = 'POJ-104-source/40/40-1839.cpp'
source_filename = "POJ-104-source/40/40-1839.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_40_1839.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %15 = call double @_Z2sqddddd(double %10, double %11, double %12, double %13, double %14)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_40_1839.cpp() #0 section ".text.startup" {
