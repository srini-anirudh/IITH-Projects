; ModuleID = 'POJ-104-source/40/40-1877.cpp'
source_filename = "POJ-104-source/40/40-1877.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_40_1877.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %13 = call double @_Z1Sddddd(double %8, double %9, double %10, double %11, double %12)
...
17:                                               ; preds = %0
  ...
  %23 = call double @_Z1Sddddd(double %18, double %19, double %20, double %21, double %22)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_40_1877.cpp() #0 section ".text.startup" {
