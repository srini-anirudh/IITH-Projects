; ModuleID = 'POJ-104-source/40/40-2057.cpp'
source_filename = "POJ-104-source/40/40-2057.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_40_2057.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %14 = call double @_Z4mianddddd(double %9, double %10, double %11, double %12, double %13)
...
define dso_local double @_Z4mianddddd(double %0, double %1, double %2, double %3, double %4) #5 {
  %6 = alloca double, align 8
  %7 = alloca double, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_40_2057.cpp() #0 section ".text.startup" {
