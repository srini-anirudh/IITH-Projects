; ModuleID = 'POJ-104-source/40/40-2151.cpp'
source_filename = "POJ-104-source/40/40-2151.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_40_2151.cpp, i8* null }]
...
5:                                                ; preds = %2
  ...
  %9 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), double* %8)
...
21:                                               ; preds = %2
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), double* @j)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_40_2151.cpp() #0 section ".text.startup" {
