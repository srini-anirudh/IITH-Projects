; ModuleID = 'POJ-104-source/40/40-2209.cpp'
source_filename = "POJ-104-source/40/40-2209.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_40_2209.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %10 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str, i64 0, i64 0), double* %3, double* %4, double* %5, double* %6, double* %7)
  ...
  %23 = call double @_ZSt3powIdiEN9__gnu_cxx11__promote_2IT_T0_NS0_9__promoteIS2_Xsr3std12__is_integerIS2_EE7__valueEE6__typeENS4_IS3_Xsr3std12__is_integerIS3_EE7__valueEE6__typeEE6__typeES2_S3_(double %22, i32 2)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_40_2209.cpp() #0 section ".text.startup" {
