; ModuleID = 'POJ-104-source/40/40-2494.cpp'
source_filename = "POJ-104-source/40/40-2494.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_40_2494.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %12 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str, i64 0, i64 0), double* %2, double* %3, double* %4, double* %5, double* %6)
  ...
  %32 = call double @_Z1Sddddd(double %27, double %28, double %29, double %30, double %31)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define dso_local double @_Z1Sddddd(double %0, double %1, double %2, double %3, double %4) #0 {
  %6 = alloca double, align 8
  %7 = alloca double, align 8
  %8 = alloca double, align 8
  %9 = alloca double, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_40_2494.cpp() #0 section ".text.startup" {
