; ModuleID = 'POJ-104-source/40/40-2706.cpp'
source_filename = "POJ-104-source/40/40-2706.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_40_2706.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %18 = call double @_Z3Squddddd(double %13, double %14, double %15, double %16, double %17)
...
; Function Attrs: noinline uwtable
define dso_local double @_Z3Squddddd(double %0, double %1, double %2, double %3, double %4) #0 {
  %6 = alloca double, align 8
  %7 = alloca double, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_40_2706.cpp() #0 section ".text.startup" {
