; ModuleID = 'POJ-104-source/40/40-2748.cpp'
source_filename = "POJ-104-source/40/40-2748.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_40_2748.cpp, i8* null }]
...
define dso_local i32 @main(i32 %0, i8** %1) #4 {
  ...
  %14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i64 0, i64 0), float* %6, float* %7, float* %8, float* %9, float* %10)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_40_2748.cpp() #0 section ".text.startup" {
