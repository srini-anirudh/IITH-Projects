; ModuleID = 'POJ-104-source/40/40-2794.cpp'
source_filename = "POJ-104-source/40/40-2794.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_40_2794.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local float @_Z4areafffff(float %0, float %1, float %2, float %3, float %4) #0 {
...
define dso_local i32 @main() #5 {
  ...
  %13 = call float @_Z4areafffff(float %8, float %9, float %10, float %11, float %12)
...
17:                                               ; preds = %0
  ...
  %23 = call float @_Z4areafffff(float %18, float %19, float %20, float %21, float %22)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_40_2794.cpp() #0 section ".text.startup" {
