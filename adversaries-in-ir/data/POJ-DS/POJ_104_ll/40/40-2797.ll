; ModuleID = 'POJ-104-source/40/40-2797.cpp'
source_filename = "POJ-104-source/40/40-2797.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_40_2797.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %8 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i64 0, i64 0), float* %2, float* %3, float* %4, float* %5, float* %6)
  %9 = load float, float* %2, align 4
  %10 = load float, float* %3, align 4
  %11 = load float, float* %4, align 4
  %12 = load float, float* %5, align 4
  %13 = load float, float* %6, align 4
  %14 = call float @_Z8functionfffff(float %9, float %10, float %11, float %12, float %13)
...
define dso_local float @_Z8functionfffff(float %0, float %1, float %2, float %3, float %4) #5 {
  %6 = alloca float, align 4
  %7 = alloca float, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_40_2797.cpp() #0 section ".text.startup" {
