; ModuleID = 'POJ-104-source/40/40-2798.cpp'
source_filename = "POJ-104-source/40/40-2798.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_40_2798.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @_Z4areaddddd(double %8, double %9, double %10, double %11, double %12)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define dso_local void @_Z4areaddddd(double %0, double %1, double %2, double %3, double %4) #0 {
  %6 = alloca double, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_40_2798.cpp() #0 section ".text.startup" {
