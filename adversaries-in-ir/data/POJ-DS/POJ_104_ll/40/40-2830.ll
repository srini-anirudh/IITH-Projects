; ModuleID = 'POJ-104-source/40/40-2830.cpp'
source_filename = "POJ-104-source/40/40-2830.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_40_2830.cpp, i8* null }]
...
define dso_local i32 @main(i32 %0, i8** %1) #4 {
  ...
  %17 = call double @_Z3maxdddd(double %13, double %14, double %15, double %16)
...
27:                                               ; preds = %2
  ...
  %37 = call double @_Z1Sddddd(double %32, double %33, double %34, double %35, double %36)
...
define dso_local double @_Z3maxdddd(double %0, double %1, double %2, double %3) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_40_2830.cpp() #0 section ".text.startup" {
