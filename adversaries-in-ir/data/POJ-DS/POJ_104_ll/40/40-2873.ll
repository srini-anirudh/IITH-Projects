; ModuleID = 'POJ-104-source/40/40-2873.cpp'
source_filename = "POJ-104-source/40/40-2873.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_40_2873.cpp, i8* null }]
...
define dso_local i32 @main(i32 %0, i8** %1) #5 {
  ...
  %18 = call double @_Z4areaddddd(double %13, double %14, double %15, double %16, double %17)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_40_2873.cpp() #0 section ".text.startup" {
