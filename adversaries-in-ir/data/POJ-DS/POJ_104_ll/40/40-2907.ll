; ModuleID = 'POJ-104-source/40/40-2907.cpp'
source_filename = "POJ-104-source/40/40-2907.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_40_2907.cpp, i8* null }]
...
define dso_local i32 @main(i32 %0, i8** %1) #4 {
  ...
  %12 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str, i64 0, i64 0), double* %6, double* %7, double* %8, double* %9, double* %10)
  %13 = load double, double* %6, align 8
  %14 = load double, double* %7, align 8
  %15 = load double, double* %8, align 8
  %16 = load double, double* %9, align 8
  %17 = load double, double* %10, align 8
  %18 = call double @_Z6mianjiddddd(double %13, double %14, double %15, double %16, double %17)
...
24:                                               ; preds = %2
  %25 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.2, i64 0, i64 0))
  br label %26
...
define dso_local double @_Z6mianjiddddd(double %0, double %1, double %2, double %3, double %4) #5 {
  %6 = alloca double, align 8
  %7 = alloca double, align 8
  %8 = alloca double, align 8
  %9 = alloca double, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_40_2907.cpp() #0 section ".text.startup" {
