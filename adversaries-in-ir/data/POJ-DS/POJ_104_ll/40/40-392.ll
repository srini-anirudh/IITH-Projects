; ModuleID = 'POJ-104-source/40/40-392.cpp'
source_filename = "POJ-104-source/40/40-392.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_40_392.cpp, i8* null }]
...
56:                                               ; preds = %0
  ...
  %62 = call double @_Z2SSddddd(double %57, double %58, double %59, double %60, double %61)
...
define dso_local double @_Z2SSddddd(double %0, double %1, double %2, double %3, double %4) #5 {
  %6 = alloca double, align 8
  %7 = alloca double, align 8
  %8 = alloca double, align 8
  %9 = alloca double, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_40_392.cpp() #0 section ".text.startup" {
