; ModuleID = 'POJ-104-source/40/40-428.cpp'
source_filename = "POJ-104-source/40/40-428.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_40_428.cpp, i8* null }]
...
define dso_local double @_Z5spaceddddd(double %0, double %1, double %2, double %3, double %4) #4 {
...
define dso_local i32 @main() #5 {
  ...
  %9 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str, i64 0, i64 0), double* %2, double* %3, double* %4, double* %5, double* %6)
...
54:                                               ; preds = %0
  ...
  %60 = call double @_Z5spaceddddd(double %55, double %56, double %57, double %58, double %59)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_40_428.cpp() #0 section ".text.startup" {
