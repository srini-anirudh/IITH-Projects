; ModuleID = 'POJ-104-source/40/40-99.cpp'
source_filename = "POJ-104-source/40/40-99.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_40_99.cpp, i8* null }]
...
86:                                               ; preds = %0
  %87 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.2, i64 0, i64 0))
  br label %88
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_40_99.cpp() #0 section ".text.startup" {
