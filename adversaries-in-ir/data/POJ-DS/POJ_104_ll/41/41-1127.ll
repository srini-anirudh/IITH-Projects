; ModuleID = 'POJ-104-source/41/41-1127.cpp'
source_filename = "POJ-104-source/41/41-1127.cpp"
...
@i = dso_local global %struct.work zeroinitializer, align 4
@j = dso_local global %struct.work zeroinitializer, align 4
@k = dso_local global %struct.work zeroinitializer, align 4
@l = dso_local global %struct.work zeroinitializer, align 4
@m = dso_local global %struct.work zeroinitializer, align 4
@.str = private unnamed_addr constant [15 x i8] c"%d %d %d %d %d\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_41_1127.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_41_1127.cpp() #0 section ".text.startup" {
