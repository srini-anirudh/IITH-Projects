; ModuleID = 'POJ-104-source/41/41-1204.cpp'
source_filename = "POJ-104-source/41/41-1204.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_41_1204.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z3onec(i8 signext %0) #0 {
  %2 = alloca i8, align 1
  %3 = alloca i8, align 1
...
20:                                               ; preds = %16
  ...
  call void @_Z3onec(i8 signext %24)
  br label %25
...
; Function Attrs: noinline uwtable
define dso_local void @_Z3twoc(i8 signext %0) #0 {
  %2 = alloca i8, align 1
  %3 = alloca i8, align 1
  store i8 %0, i8* %2, align 1
  %4 = load i8, i8* %2, align 1
...
41:                                               ; preds = %37
  ...
  call void @_Z3twoc(i8 signext %45)
  br label %46
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5threec(i8 signext %0) #0 {
  %2 = alloca i8, align 1
  %3 = alloca i8, align 1
  store i8 %0, i8* %2, align 1
  %4 = load i8, i8* %2, align 1
...
74:                                               ; preds = %70
  ...
  call void @_Z5threec(i8 signext %78)
  br label %79
...
; Function Attrs: noinline uwtable
define dso_local void @_Z4fourc(i8 signext %0) #0 {
  %2 = alloca i8, align 1
  %3 = alloca i8, align 1
  store i8 %0, i8* %2, align 1
  %4 = load i8, i8* %2, align 1
...
97:                                               ; preds = %93
  ...
  call void @_Z4fourc(i8 signext %101)
  br label %102
...
; Function Attrs: noinline uwtable
define dso_local void @_Z4fivec(i8 signext %0) #0 {
  %2 = alloca i8, align 1
  %3 = alloca i8, align 1
  store i8 %0, i8* %2, align 1
  %4 = load i8, i8* %2, align 1
...
112:                                              ; preds = %108
  ...
  call void @_Z4fivec(i8 signext %116)
  br label %117
...
define dso_local i32 @main() #4 {
  ...
  call void @_Z3onec(i8 signext %3)
  %4 = load i8, i8* %2, align 1
  call void @_Z3twoc(i8 signext %4)
  %5 = load i8, i8* %2, align 1
  call void @_Z5threec(i8 signext %5)
  %6 = load i8, i8* %2, align 1
  call void @_Z4fourc(i8 signext %6)
  %7 = load i8, i8* %2, align 1
  call void @_Z4fivec(i8 signext %7)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_41_1204.cpp() #0 section ".text.startup" {
