; ModuleID = 'POJ-104-source/41/41-1234.cpp'
source_filename = "POJ-104-source/41/41-1234.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_41_1234.cpp, i8* null }]
...
149:                                              ; preds = %130
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* %150, i32* %152)
...
160:                                              ; preds = %156
  %161 = getelementptr inbounds [5 x i32], [5 x i32]* %4, i64 0, i64 2
...
185:                                              ; preds = %173
  ...
  %188 = getelementptr inbounds [5 x i32], [5 x i32]* %2, i64 0, i64 %187
  %189 = load i32, i32* %188, align 4
  %190 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i32 %189)
  br label %191

191:                                              ; preds = %185, %168, %164, %160, %156, %149
  br label %192

192:                                              ; preds = %191, %98, %92, %86, %80, %74, %68, %62, %56, %50, %44, %40, %36
  br label %193
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_41_1234.cpp() #0 section ".text.startup" {
