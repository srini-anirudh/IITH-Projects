; ModuleID = 'POJ-104-source/41/41-494.cpp'
source_filename = "POJ-104-source/41/41-494.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_41_494.cpp, i8* null }]
...
define dso_local i32 @_Z5judgeiiiii(i32 %0, i32 %1, i32 %2, i32 %3, i32 %4) #4 {
...
32:                                               ; preds = %29
  ...
  %38 = call i32 @_Z5judgeiiiii(i32 %33, i32 %34, i32 %35, i32 %36, i32 %37)
  %39 = icmp ne i32 %38, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_41_494.cpp() #0 section ".text.startup" {
