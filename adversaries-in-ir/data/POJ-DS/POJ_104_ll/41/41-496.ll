; ModuleID = 'POJ-104-source/41/41-496.cpp'
source_filename = "POJ-104-source/41/41-496.cpp"
...
@guess = dso_local global [5 x i32] zeroinitializer, align 16
@used = dso_local global [5 x i32] zeroinitializer, align 16
@place = dso_local global [5 x i32] zeroinitializer, align 16
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_41_496.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @_Z4findi(i32 0)
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_41_496.cpp() #0 section ".text.startup" {
