; ModuleID = 'POJ-104-source/41/41-667.cpp'
source_filename = "POJ-104-source/41/41-667.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_41_667.cpp, i8* null }]
...
87:                                               ; preds = %83
  %88 = getelementptr inbounds [10 x i32], [10 x i32]* %7, i64 0, i64 2
...
120:                                              ; preds = %119, %44, %33, %30, %27
  %121 = getelementptr inbounds [10 x i32], [10 x i32]* %7, i64 0, i64 5
  store i32 0, i32* %121, align 4
  %122 = getelementptr inbounds [10 x i32], [10 x i32]* %7, i64 0, i64 4
  store i32 0, i32* %122, align 16
  %123 = getelementptr inbounds [10 x i32], [10 x i32]* %7, i64 0, i64 3
  store i32 0, i32* %123, align 4
  %124 = getelementptr inbounds [10 x i32], [10 x i32]* %7, i64 0, i64 2
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_41_667.cpp() #0 section ".text.startup" {
