; ModuleID = 'POJ-104-source/41/41-709.cpp'
source_filename = "POJ-104-source/41/41-709.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_41_709.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z3panPi(i32* %0) #0 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_41_709.cpp() #0 section ".text.startup" {
