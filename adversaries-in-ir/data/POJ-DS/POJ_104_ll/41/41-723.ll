; ModuleID = 'POJ-104-source/41/41-723.cpp'
source_filename = "POJ-104-source/41/41-723.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_41_723.cpp, i8* null }]
...
define dso_local i32 @_Z5checkPii(i32* %0, i32 %1) #4 {
...
43:                                               ; preds = %41, %40, %34, %33, %27, %26, %20, %19, %13, %12
...
; Function Attrs: noinline uwtable
define dso_local void @_Z3paiPiii(i32* %0, i32 %1, i32 %2) #0 {
  %4 = alloca i32*, align 8
  %5 = alloca i32, align 4
...
44:                                               ; preds = %16
  ...
  %48 = call i32 @_Z5checkPii(i32* %45, i32 %47)
  %49 = icmp ne i32 %48, 0
...
50:                                               ; preds = %44
  ...
  %54 = call i32 @_Z5checkPii(i32* %51, i32 %53)
  %55 = icmp ne i32 %54, 0
...
56:                                               ; preds = %50
  ...
  %60 = call i32 @_Z5checkPii(i32* %57, i32 %59)
  %61 = icmp eq i32 %60, 0
...
62:                                               ; preds = %56
  ...
  %66 = call i32 @_Z5checkPii(i32* %63, i32 %65)
  %67 = icmp eq i32 %66, 0
...
68:                                               ; preds = %62
  ...
  %72 = call i32 @_Z5checkPii(i32* %69, i32 %71)
  %73 = icmp eq i32 %72, 0
...
114:                                              ; preds = %110
  ...
  call void @_Z3paiPiii(i32* %134, i32 %136, i32 %137)
...
define dso_local i32 @main() #6 {
  ...
  call void @_Z3paiPiii(i32* %6, i32 0, i32 4)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_41_723.cpp() #0 section ".text.startup" {
