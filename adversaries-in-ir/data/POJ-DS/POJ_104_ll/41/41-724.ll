; ModuleID = 'POJ-104-source/41/41-724.cpp'
source_filename = "POJ-104-source/41/41-724.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_41_724.cpp, i8* null }]
...
36:                                               ; preds = %33
  ...
  %40 = call i32 @_Z7rankingPi(i32* %39)
  %41 = icmp ne i32 %40, 0
...
define dso_local i32 @_Z7rankingPi(i32* %0) #5 {
  %2 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_41_724.cpp() #0 section ".text.startup" {
