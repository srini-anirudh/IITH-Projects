; ModuleID = 'POJ-104-source/41/41-860.cpp'
source_filename = "POJ-104-source/41/41-860.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_41_860.cpp, i8* null }]
...
define dso_local i32 @_Z4isokiiiii(i32 %0, i32 %1, i32 %2, i32 %3, i32 %4) #4 {
...
103:                                              ; preds = %100
  ...
  %109 = call i32 @_Z4isokiiiii(i32 %104, i32 %105, i32 %106, i32 %107, i32 %108)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_41_860.cpp() #0 section ".text.startup" {
