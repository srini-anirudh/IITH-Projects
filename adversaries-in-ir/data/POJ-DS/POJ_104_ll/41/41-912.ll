; ModuleID = 'POJ-104-source/41/41-912.cpp'
source_filename = "POJ-104-source/41/41-912.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_41_912.cpp, i8* null }]
...
26:                                               ; preds = %23
  %27 = load i32, i32* getelementptr inbounds ([6 x i32], [6 x i32]* @a, i64 0, i64 5), align 4
  %28 = icmp eq i32 %27, 1
...
30:                                               ; preds = %26, %23, %20
  %31 = load i32, i32* getelementptr inbounds ([6 x i32], [6 x i32]* @a, i64 0, i64 2), align 8
  %32 = icmp eq i32 %31, 1
...
37:                                               ; preds = %34
  %38 = load i32, i32* getelementptr inbounds ([6 x i32], [6 x i32]* @a, i64 0, i64 3), align 4
  %39 = icmp eq i32 %38, 2
  br i1 %39, label %40, label %44

40:                                               ; preds = %37, %34
  %41 = load i32, i32* getelementptr inbounds ([6 x i32], [6 x i32]* @a, i64 0, i64 1), align 4
  %42 = icmp ne i32 %41, 5
...
50:                                               ; preds = %47
  %51 = load i32, i32* getelementptr inbounds ([6 x i32], [6 x i32]* @a, i64 0, i64 1), align 4
  %52 = icmp eq i32 %51, 5
...
57:                                               ; preds = %54
  %58 = load i32, i32* getelementptr inbounds ([6 x i32], [6 x i32]* @a, i64 0, i64 4), align 16
  %59 = icmp eq i32 %58, 2
...
64:                                               ; preds = %60, %57
  %65 = load i32, i32* getelementptr inbounds ([6 x i32], [6 x i32]* @a, i64 0, i64 4), align 16
  %66 = icmp ne i32 %65, 1
...
80:                                               ; preds = %77, %74
  %81 = load i32, i32* getelementptr inbounds ([6 x i32], [6 x i32]* @a, i64 0, i64 4), align 16
  %82 = icmp ne i32 %81, 1
...
84:                                               ; preds = %80, %77
  %85 = load i32, i32* getelementptr inbounds ([6 x i32], [6 x i32]* @a, i64 0, i64 5), align 4
  %86 = icmp ne i32 %85, 1
...
98:                                               ; preds = %95
  ...
  %101 = getelementptr inbounds [6 x i32], [6 x i32]* @a, i64 0, i64 %100
...
108:                                              ; preds = %95
  %109 = load i32, i32* getelementptr inbounds ([6 x i32], [6 x i32]* @a, i64 0, i64 5), align 4
  %110 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 %109)
  store i32 0, i32* %1, align 4
  br label %114

111:                                              ; preds = %93, %83, %73, %63, %53, %43, %33, %29, %19, %9
  %112 = call zeroext i1 @_ZSt16next_permutationIPiEbT_S1_(i32* getelementptr inbounds ([6 x i32], [6 x i32]* @a, i64 0, i64 1), i32* getelementptr inbounds (i32, i32* getelementptr inbounds ([6 x i32], [6 x i32]* @a, i64 0, i64 0), i64 6))
  br i1 %112, label %3, label %113
...
; Function Attrs: noinline uwtable
define linkonce_odr dso_local zeroext i1 @_ZSt16next_permutationIPiEbT_S1_(i32* %0, i32* %1) #0 comdat {
...
; Function Attrs: noinline uwtable
define linkonce_odr dso_local zeroext i1 @_ZSt18__next_permutationIPiN9__gnu_cxx5__ops15_Iter_less_iterEEbT_S4_T0_(i32* %0, i32* %1) #0 comdat {
  %3 = alloca i1, align 1
...
55:                                               ; preds = %51
  ...
  call void @_ZSt19__iterator_categoryIPiENSt15iterator_traitsIT_E17iterator_categoryERKS2_(i32** dereferenceable(8) %5)
  call void @_ZSt9__reverseIPiEvT_S1_St26random_access_iterator_tag(i32* %56, i32* %57)
  store i1 false, i1* %3, align 1
  br label %59
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local void @_ZSt9__reverseIPiEvT_S1_St26random_access_iterator_tag(i32* %0, i32* %1) #5 comdat {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_41_912.cpp() #0 section ".text.startup" {
