; ModuleID = 'POJ-104-source/42/42-1256.cpp'
source_filename = "POJ-104-source/42/42-1256.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_42_1256.cpp, i8* null }]
...
30:                                               ; preds = %17
  %31 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %9)
  store i32 0, i32* %8, align 4
  br label %32
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_42_1256.cpp() #0 section ".text.startup" {
