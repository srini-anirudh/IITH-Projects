; ModuleID = 'POJ-104-source/42/42-1533.cpp'
source_filename = "POJ-104-source/42/42-1533.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_42_1533.cpp, i8* null }]
...
102:                                              ; preds = %66
  %103 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32 1)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_42_1533.cpp() #0 section ".text.startup" {
