; ModuleID = 'POJ-104-source/42/42-1534.cpp'
source_filename = "POJ-104-source/42/42-1534.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_42_1534.cpp, i8* null }]
...
13:                                               ; preds = %9
  ...
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i64* %15)
  br label %17
...
20:                                               ; preds = %9
  %21 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i64* %5)
  store i64 0, i64* %3, align 8
  br label %22
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_42_1534.cpp() #0 section ".text.startup" {
