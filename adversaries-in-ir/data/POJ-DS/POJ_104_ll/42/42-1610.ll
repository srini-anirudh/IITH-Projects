; ModuleID = 'POJ-104-source/42/42-1610.cpp'
source_filename = "POJ-104-source/42/42-1610.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_42_1610.cpp, i8* null }]
...
62:                                               ; preds = %48
  ...
  %69 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %2)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_42_1610.cpp() #0 section ".text.startup" {
