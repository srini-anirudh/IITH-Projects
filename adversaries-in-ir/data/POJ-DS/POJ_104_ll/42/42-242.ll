; ModuleID = 'POJ-104-source/42/42-242.cpp'
source_filename = "POJ-104-source/42/42-242.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_42_242.cpp, i8* null }]
...
12:                                               ; preds = %8
  ...
  %15 = getelementptr inbounds [100000 x i64], [100000 x i64]* %6, i64 0, i64 %14
...
20:                                               ; preds = %8
  %21 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i64* %5)
  store i32 0, i32* %2, align 4
  br label %22
...
39:                                               ; preds = %35
  ...
  %47 = getelementptr inbounds [100000 x i64], [100000 x i64]* %6, i64 0, i64 %46
...
60:                                               ; preds = %22
  %61 = getelementptr inbounds [100000 x i64], [100000 x i64]* %6, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_42_242.cpp() #0 section ".text.startup" {
