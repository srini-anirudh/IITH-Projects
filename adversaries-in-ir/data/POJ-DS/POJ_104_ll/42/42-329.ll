; ModuleID = 'POJ-104-source/42/42-329.cpp'
source_filename = "POJ-104-source/42/42-329.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_42_329.cpp, i8* null }]
...
21:                                               ; preds = %9
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %6)
  store i32 0, i32* %4, align 4
  br label %23
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_42_329.cpp() #0 section ".text.startup" {
