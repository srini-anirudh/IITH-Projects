; ModuleID = 'POJ-104-source/42/42-519.cpp'
source_filename = "POJ-104-source/42/42-519.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_42_519.cpp, i8* null }]
...
define dso_local i32 @_Z4swapPiS_(i32* %0, i32* %1) #4 {
...
52:                                               ; preds = %47
  ...
  %55 = call i32 @_Z4swapPiS_(i32* %53, i32* %54)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_42_519.cpp() #0 section ".text.startup" {
