; ModuleID = 'POJ-104-source/42/42-593.cpp'
source_filename = "POJ-104-source/42/42-593.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_42_593.cpp, i8* null }]
...
79:                                               ; preds = %66
  %80 = getelementptr inbounds [100000 x i32], [100000 x i32]* %6, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_42_593.cpp() #0 section ".text.startup" {
