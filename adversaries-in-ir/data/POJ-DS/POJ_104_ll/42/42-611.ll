; ModuleID = 'POJ-104-source/42/42-611.cpp'
source_filename = "POJ-104-source/42/42-611.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_42_611.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %11 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i64* %5)
...
16:                                               ; preds = %12
  ...
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i64* %17)
  br label %20
...
23:                                               ; preds = %12
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), i64* %2)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_42_611.cpp() #0 section ".text.startup" {
