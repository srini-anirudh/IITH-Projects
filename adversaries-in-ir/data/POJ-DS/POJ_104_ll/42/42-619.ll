; ModuleID = 'POJ-104-source/42/42-619.cpp'
source_filename = "POJ-104-source/42/42-619.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_42_619.cpp, i8* null }]
...
81:                                               ; preds = %39
  ...
  %83 = getelementptr inbounds [100001 x i64], [100001 x i64]* %17, i64 0, i64 %82
...
88:                                               ; preds = %100, %81
  ...
  %90 = getelementptr inbounds [100001 x i64], [100001 x i64]* %17, i64 0, i64 %89
...
100:                                              ; preds = %98
  ...
  %102 = getelementptr inbounds [100001 x i64], [100001 x i64]* %17, i64 0, i64 %101
  %103 = load i64, i64* %102, align 8
  %104 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i64 %103)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_42_619.cpp() #0 section ".text.startup" {
