; ModuleID = 'POJ-104-source/42/42-65.cpp'
source_filename = "POJ-104-source/42/42-65.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_42_65.cpp, i8* null }]
...
21:                                               ; preds = %8
  ...
  %23 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %4)
  store i32 0, i32* %3, align 4
  br label %24
...
47:                                               ; preds = %44
  %48 = getelementptr inbounds [100000 x i32], [100000 x i32]* %6, i64 0, i64 0
  %49 = load i32, i32* %48, align 16
  %50 = icmp ne i32 %49, 97
  br i1 %50, label %51, label %55

51:                                               ; preds = %47
  %52 = getelementptr inbounds [100000 x i32], [100000 x i32]* %6, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_42_65.cpp() #0 section ".text.startup" {
