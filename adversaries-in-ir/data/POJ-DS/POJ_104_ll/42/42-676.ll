; ModuleID = 'POJ-104-source/42/42-676.cpp'
source_filename = "POJ-104-source/42/42-676.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_42_676.cpp, i8* null }]
...
11:                                               ; preds = %7
  ...
  %14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i64* %13)
  br label %15
...
18:                                               ; preds = %7
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i64* %4)
  store i64 0, i64* %5, align 8
  br label %20
...
34:                                               ; preds = %30, %20
  ...
  %36 = getelementptr inbounds [100000 x i64], [100000 x i64]* %3, i64 0, i64 %35
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_42_676.cpp() #0 section ".text.startup" {
