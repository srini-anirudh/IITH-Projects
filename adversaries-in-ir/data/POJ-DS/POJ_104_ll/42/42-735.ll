; ModuleID = 'POJ-104-source/42/42-735.cpp'
source_filename = "POJ-104-source/42/42-735.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_42_735.cpp, i8* null }]
...
23:                                               ; preds = %10
  ...
  %28 = call i32 @_Z3delPiii(i32* %25, i32 %26, i32 %27)
...
define dso_local i32 @_Z3delPiii(i32* %0, i32 %1, i32 %2) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_42_735.cpp() #0 section ".text.startup" {
