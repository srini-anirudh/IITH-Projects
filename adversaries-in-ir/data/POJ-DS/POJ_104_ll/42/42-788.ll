; ModuleID = 'POJ-104-source/42/42-788.cpp'
source_filename = "POJ-104-source/42/42-788.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_42_788.cpp, i8* null }]
...
define dso_local i32 @main() #5 {
  ...
  %6 = call %struct.stu* @_Z5creati(i32 %5)
  ...
  %10 = call %struct.stu* @_Z3delP3stui(%struct.stu* %8, i32 %9)
  store %struct.stu* %10, %struct.stu** %1, align 8
  %11 = load %struct.stu*, %struct.stu** %1, align 8
  call void @_Z5printP3stu(%struct.stu* %11)
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_42_788.cpp() #0 section ".text.startup" {
