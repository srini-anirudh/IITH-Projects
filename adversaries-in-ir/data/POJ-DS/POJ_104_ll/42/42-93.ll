; ModuleID = 'POJ-104-source/42/42-93.cpp'
source_filename = "POJ-104-source/42/42-93.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_42_93.cpp, i8* null }]
...
20:                                               ; preds = %8
  %21 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* %5)
  store i32 0, i32* %3, align 4
  br label %22
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_42_93.cpp() #0 section ".text.startup" {
