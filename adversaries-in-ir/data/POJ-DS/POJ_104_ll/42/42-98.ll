; ModuleID = 'POJ-104-source/42/42-98.cpp'
source_filename = "POJ-104-source/42/42-98.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_42_98.cpp, i8* null }]
...
21:                                               ; preds = %9
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* %3)
  %23 = load i32, i32* %3, align 4
  %24 = add nsw i32 %23, 1
  %25 = load i32, i32* %2, align 4
  %26 = sext i32 %25 to i64
  %27 = getelementptr inbounds [100001 x i32], [100001 x i32]* %7, i64 0, i64 %26
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_42_98.cpp() #0 section ".text.startup" {
