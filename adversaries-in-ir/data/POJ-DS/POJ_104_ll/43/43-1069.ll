; ModuleID = 'POJ-104-source/43/43-1069.cpp'
source_filename = "POJ-104-source/43/43-1069.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_43_1069.cpp, i8* null }]
...
54:                                               ; preds = %20
  %55 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %8)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_43_1069.cpp() #0 section ".text.startup" {
