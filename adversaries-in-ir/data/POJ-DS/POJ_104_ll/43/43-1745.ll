; ModuleID = 'POJ-104-source/43/43-1745.cpp'
source_filename = "POJ-104-source/43/43-1745.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_43_1745.cpp, i8* null }]
...
89:                                               ; preds = %85
  ...
  %94 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0), i32 %90, i32 %93)
  br label %95
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_43_1745.cpp() #0 section ".text.startup" {
