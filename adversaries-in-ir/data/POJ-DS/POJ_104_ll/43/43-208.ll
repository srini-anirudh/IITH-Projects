; ModuleID = 'POJ-104-source/43/43-208.cpp'
source_filename = "POJ-104-source/43/43-208.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_43_208.cpp, i8* null }]
...
62:                                               ; preds = %56
  ...
  %67 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 %63, i32 %66)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_43_208.cpp() #0 section ".text.startup" {
