; ModuleID = 'POJ-104-source/43/43-270.cpp'
source_filename = "POJ-104-source/43/43-270.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_43_270.cpp, i8* null }]
...
13:                                               ; preds = %8
  ...
  %15 = call i32 @_Z7issushui(i32 %14)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_43_270.cpp() #0 section ".text.startup" {
