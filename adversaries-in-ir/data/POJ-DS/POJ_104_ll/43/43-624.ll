; ModuleID = 'POJ-104-source/43/43-624.cpp'
source_filename = "POJ-104-source/43/43-624.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_43_624.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local double @_Z3caliid(i32 %0, i32 %1, double %2) #0 {
...
14:                                               ; preds = %3
  ...
  %19 = call double @_Z3caliid(i32 %16, i32 %17, double %18)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_43_624.cpp() #0 section ".text.startup" {
