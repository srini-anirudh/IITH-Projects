; ModuleID = 'POJ-104-source/43/43-96.cpp'
source_filename = "POJ-104-source/43/43-96.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_43_96.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  store i32 (i32)* @_Z1fi, i32 (i32)** %5, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_43_96.cpp() #0 section ".text.startup" {
