; ModuleID = 'POJ-104-source/44/44-1030.cpp'
source_filename = "POJ-104-source/44/44-1030.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_44_1030.cpp, i8* null }]
...
define dso_local i32 @_Z7reversei(i32 %0) #6 {
  %2 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_44_1030.cpp() #0 section ".text.startup" {
