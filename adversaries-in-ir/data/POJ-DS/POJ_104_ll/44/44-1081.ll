; ModuleID = 'POJ-104-source/44/44-1081.cpp'
source_filename = "POJ-104-source/44/44-1081.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_44_1081.cpp, i8* null }]
...
40:                                               ; preds = %28
  ...
  %45 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), i32 %44)
  br label %46
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_44_1081.cpp() #0 section ".text.startup" {
