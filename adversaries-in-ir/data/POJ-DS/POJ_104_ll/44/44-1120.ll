; ModuleID = 'POJ-104-source/44/44-1120.cpp'
source_filename = "POJ-104-source/44/44-1120.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_44_1120.cpp, i8* null }]
...
131:                                              ; preds = %126
  ...
  %142 = call i32 @_Z5counti(i32 %141)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_44_1120.cpp() #0 section ".text.startup" {
