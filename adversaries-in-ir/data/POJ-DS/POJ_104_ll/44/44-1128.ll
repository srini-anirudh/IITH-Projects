; ModuleID = 'POJ-104-source/44/44-1128.cpp'
source_filename = "POJ-104-source/44/44-1128.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_44_1128.cpp, i8* null }]
...
41:                                               ; preds = %40, %31
  ...
  %46 = call double @_ZSt3logIiEN9__gnu_cxx11__enable_ifIXsr12__is_integerIT_EE7__valueEdE6__typeES2_(i32 %45)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_44_1128.cpp() #0 section ".text.startup" {
