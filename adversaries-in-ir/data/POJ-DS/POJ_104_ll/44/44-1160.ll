; ModuleID = 'POJ-104-source/44/44-1160.cpp'
source_filename = "POJ-104-source/44/44-1160.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_44_1160.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z7reversePc(i8* %0) #0 {
  %2 = alloca i8*, align 8
  ...
  %8 = call i32 @strcmp(i8* %7, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0)) #6
  %9 = icmp eq i32 %8, 0
...
12:                                               ; preds = %1
  ...
  %14 = call i32 @strcmp(i8* %13, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0)) #6
  %15 = icmp eq i32 %14, 0
...
9:                                                ; preds = %6
  ...
  %11 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.6, i64 0, i64 0), i8* %10)
  %12 = getelementptr inbounds [10 x i8], [10 x i8]* %5, i64 0, i64 0
  call void @_Z7reversePc(i8* %12)
  br label %13
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_44_1160.cpp() #0 section ".text.startup" {
