; ModuleID = 'POJ-104-source/44/44-1164.cpp'
source_filename = "POJ-104-source/44/44-1164.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_44_1164.cpp, i8* null }]
...
7:                                                ; preds = %4
  ...
  %10 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.4, i64 0, i64 0), i8* %9)
  %11 = load i8*, i8** %3, align 8
  call void @_Z7reversePc(i8* %11)
  br label %12
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_44_1164.cpp() #0 section ".text.startup" {
