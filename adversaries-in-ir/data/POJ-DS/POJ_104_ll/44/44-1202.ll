; ModuleID = 'POJ-104-source/44/44-1202.cpp'
source_filename = "POJ-104-source/44/44-1202.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_44_1202.cpp, i8* null }]
...
8:                                                ; preds = %5
  %9 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i32* %3)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_44_1202.cpp() #0 section ".text.startup" {
