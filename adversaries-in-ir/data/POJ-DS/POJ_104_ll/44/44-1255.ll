; ModuleID = 'POJ-104-source/44/44-1255.cpp'
source_filename = "POJ-104-source/44/44-1255.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_44_1255.cpp, i8* null }]
...
1790:                                             ; preds = %1783, %1779, %1775, %1771, %1767, %1763, %1759, %1755, %1751
  call void @llvm.trap()
  unreachable

1791:                                             ; preds = %1787, %1590, %1390, %1191, %993, %796, %600, %405, %211, %18
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_44_1255.cpp() #0 section ".text.startup" {
