; ModuleID = 'POJ-104-source/44/44-128.cpp'
source_filename = "POJ-104-source/44/44-128.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_44_128.cpp, i8* null }]
...
12:                                               ; preds = %9
  ...
  %19 = call i32 @_Z7reversePc(i8* %18)
...
define dso_local i32 @_Z7reversePc(i8* %0) #6 {
  %2 = alloca i8*, align 8
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_44_128.cpp() #0 section ".text.startup" {
