; ModuleID = 'POJ-104-source/44/44-1286.cpp'
source_filename = "POJ-104-source/44/44-1286.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_44_1286.cpp, i8* null }]
...
29:                                               ; preds = %24
  ...
  %32 = load i32, i32* %2, align 4
  %33 = srem i32 %32, 10
  %34 = getelementptr inbounds [50 x i32], [50 x i32]* %7, i64 0, i64 0
...
74:                                               ; preds = %70
  ...
  %78 = call double @_ZSt3powIiiEN9__gnu_cxx11__promote_2IT_T0_NS0_9__promoteIS2_Xsr3std12__is_integerIS2_EE7__valueEE6__typeENS4_IS3_Xsr3std12__is_integerIS3_EE7__valueEE6__typeEE6__typeES2_S3_(i32 10, i32 %77)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_44_1286.cpp() #0 section ".text.startup" {
