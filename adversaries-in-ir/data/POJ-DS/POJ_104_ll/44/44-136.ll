; ModuleID = 'POJ-104-source/44/44-136.cpp'
source_filename = "POJ-104-source/44/44-136.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_44_136.cpp, i8* null }]
...
273:                                              ; preds = %224, %176, %139, %105, %78, %55, %37, %22, %14
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_44_136.cpp() #0 section ".text.startup" {
