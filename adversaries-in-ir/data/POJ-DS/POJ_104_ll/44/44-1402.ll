; ModuleID = 'POJ-104-source/44/44-1402.cpp'
source_filename = "POJ-104-source/44/44-1402.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_44_1402.cpp, i8* null }]
...
20:                                               ; preds = %17
  ...
  %22 = sub nsw i32 0, %21
  %23 = call i32 @_Z6bianxui(i32 %22)
  %24 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), i32 %23)
  br label %25
...
define dso_local i32 @_Z6bianxui(i32 %0) #5 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_44_1402.cpp() #0 section ".text.startup" {
