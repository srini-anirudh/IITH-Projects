; ModuleID = 'POJ-104-source/44/44-1403.cpp'
source_filename = "POJ-104-source/44/44-1403.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_44_1403.cpp, i8* null }]
...
define dso_local i32 @_Z3fani(i32 %0) #5 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_44_1403.cpp() #0 section ".text.startup" {
