; ModuleID = 'POJ-104-source/44/44-386.cpp'
source_filename = "POJ-104-source/44/44-386.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_44_386.cpp, i8* null }]
...
38:                                               ; preds = %33
  ...
  call void @_Z4swapPiS_(i32* %41, i32* %46)
  br label %47
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_44_386.cpp() #0 section ".text.startup" {
