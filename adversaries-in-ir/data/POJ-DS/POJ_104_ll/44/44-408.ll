; ModuleID = 'POJ-104-source/44/44-408.cpp'
source_filename = "POJ-104-source/44/44-408.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_44_408.cpp, i8* null }]
...
25:                                               ; preds = %19
  %26 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i32 0)
  br label %27
...
46:                                               ; preds = %40
  ...
  %51 = sub nsw i32 0, %50
  %52 = call i32 @_Z7reversei(i32 %51)
  %53 = sub nsw i32 0, %52
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_44_408.cpp() #0 section ".text.startup" {
