; ModuleID = 'POJ-104-source/44/44-412.cpp'
source_filename = "POJ-104-source/44/44-412.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_44_412.cpp, i8* null }]
...
31:                                               ; preds = %27, %24
  ...
  call void @_Z7reverseii(i32 %33, i32 %34)
  br label %35
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_44_412.cpp() #0 section ".text.startup" {
