; ModuleID = 'POJ-104-source/44/44-416.cpp'
source_filename = "POJ-104-source/44/44-416.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_44_416.cpp, i8* null }]
...
define dso_local i32 @_Z2rei(i32 %0) #4 {
...
46:                                               ; preds = %24
  %47 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %3)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_44_416.cpp() #0 section ".text.startup" {
