; ModuleID = 'POJ-104-source/44/44-614.cpp'
source_filename = "POJ-104-source/44/44-614.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_44_614.cpp, i8* null }]
...
40:                                               ; preds = %37
  %41 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8 signext 45)
...
55:                                               ; preds = %52
  ...
  %57 = call i32 @_Z7reversei(i32 %56)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_44_614.cpp() #0 section ".text.startup" {
