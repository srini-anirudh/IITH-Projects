; ModuleID = 'POJ-104-source/44/44-73.cpp'
source_filename = "POJ-104-source/44/44-73.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_44_73.cpp, i8* null }]
...
17:                                               ; preds = %16, %10
  ...
  %19 = call double @_ZSt4fabsIiEN9__gnu_cxx11__enable_ifIXsr12__is_integerIT_EE7__valueEdE6__typeES2_(i32 %18)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_44_73.cpp() #0 section ".text.startup" {
