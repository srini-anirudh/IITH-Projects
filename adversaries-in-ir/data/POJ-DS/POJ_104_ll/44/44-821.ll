; ModuleID = 'POJ-104-source/44/44-821.cpp'
source_filename = "POJ-104-source/44/44-821.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_44_821.cpp, i8* null }]
...
define dso_local i32 @_Z3FANi(i32 %0) #0 {
  ...
  %10 = call double @_ZSt5log10IiEN9__gnu_cxx11__enable_ifIXsr12__is_integerIT_EE7__valueEdE6__typeES2_(i32 %9)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_44_821.cpp() #0 section ".text.startup" {
