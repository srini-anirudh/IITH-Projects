; ModuleID = 'POJ-104-source/44/44-845.cpp'
source_filename = "POJ-104-source/44/44-845.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_44_845.cpp, i8* null }]
...
11:                                               ; preds = %8
  ...
  %13 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i8* %12)
  %14 = getelementptr inbounds [100 x i8], [100 x i8]* %2, i64 0, i64 0
  call void @_Z7reversePc(i8* %14)
  br label %15
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_44_845.cpp() #0 section ".text.startup" {
