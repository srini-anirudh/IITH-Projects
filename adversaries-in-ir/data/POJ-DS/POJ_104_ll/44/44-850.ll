; ModuleID = 'POJ-104-source/44/44-850.cpp'
source_filename = "POJ-104-source/44/44-850.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_44_850.cpp, i8* null }]
...
23:                                               ; preds = %20
  ...
  %28 = call i32 @strcmp(i8* %27, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0)) #7
  %29 = icmp eq i32 %28, 0
...
30:                                               ; preds = %23
  ...
  %35 = call i32 @strcmp(i8* %34, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0)) #7
  %36 = icmp eq i32 %35, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_44_850.cpp() #0 section ".text.startup" {
