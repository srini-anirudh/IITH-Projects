; ModuleID = 'POJ-104-source/44/44-866.cpp'
source_filename = "POJ-104-source/44/44-866.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_44_866.cpp, i8* null }]
...
11:                                               ; preds = %1
  ...
  %14 = call double @_ZSt4fabsIiEN9__gnu_cxx11__enable_ifIXsr12__is_integerIT_EE7__valueEdE6__typeES2_(i32 %13)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_44_866.cpp() #0 section ".text.startup" {
