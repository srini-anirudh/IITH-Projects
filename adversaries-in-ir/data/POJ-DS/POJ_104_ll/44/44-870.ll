; ModuleID = 'POJ-104-source/44/44-870.cpp'
source_filename = "POJ-104-source/44/44-870.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_44_870.cpp, i8* null }]
...
45:                                               ; preds = %33
  %46 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %2)
  ret i32 0
}
...
91:                                               ; preds = %87
  ...
  %102 = call double @_ZSt3powIiiEN9__gnu_cxx11__promote_2IT_T0_NS0_9__promoteIS2_Xsr3std12__is_integerIS2_EE7__valueEE6__typeENS4_IS3_Xsr3std12__is_integerIS3_EE7__valueEE6__typeEE6__typeES2_S3_(i32 10, i32 %101)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_44_870.cpp() #0 section ".text.startup" {
