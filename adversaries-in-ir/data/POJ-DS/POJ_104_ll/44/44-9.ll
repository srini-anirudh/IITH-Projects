; ModuleID = 'POJ-104-source/44/44-9.cpp'
source_filename = "POJ-104-source/44/44-9.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_44_9.cpp, i8* null }]
...
24:                                               ; preds = %21
  ...
  %29 = call i32 @_Z7reversePc(i8* %28)
...
define dso_local i32 @_Z7reversePc(i8* %0) #5 {
  %2 = alloca i8*, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_44_9.cpp() #0 section ".text.startup" {
