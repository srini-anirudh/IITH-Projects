; ModuleID = 'POJ-104-source/44/44-969.cpp'
source_filename = "POJ-104-source/44/44-969.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_44_969.cpp, i8* null }]
...
55:                                               ; preds = %42
  ...
  %60 = sub nsw i32 0, %59
  %61 = call i32 @_Z7reversei(i32 %60)
  %62 = sub nsw i32 0, %61
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_44_969.cpp() #0 section ".text.startup" {
