; ModuleID = 'POJ-104-source/44/44-995.cpp'
source_filename = "POJ-104-source/44/44-995.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_44_995.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z4nixuPc(i8* %0) #0 {
  %2 = alloca i8*, align 8
...
7:                                                ; preds = %4
  ...
  %9 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.4, i64 0, i64 0), i8* %8)
  %10 = getelementptr inbounds [10 x i8], [10 x i8]* %3, i64 0, i64 0
  call void @_Z4nixuPc(i8* %10)
  br label %11
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_44_995.cpp() #0 section ".text.startup" {
