; ModuleID = 'POJ-104-source/45/45-1408.cpp'
source_filename = "POJ-104-source/45/45-1408.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_45_1408.cpp, i8* null }]
...
22:                                               ; preds = %10
  ...
  %26 = call i8* @strcpy(i8* %23, i8* %25) #3
  ...
  %30 = call i8* @strcpy(i8* %27, i8* %29) #3
...
53:                                               ; preds = %41
  ...
  %61 = call i32 @memcmp(i8* %54, i8* %58, i64 %60) #6
  %62 = icmp eq i32 %61, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_45_1408.cpp() #0 section ".text.startup" {
