; ModuleID = 'POJ-104-source/45/45-1411.cpp'
source_filename = "POJ-104-source/45/45-1411.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_45_1411.cpp, i8* null }]
...
51:                                               ; preds = %49, %16
  %52 = getelementptr inbounds [50 x i8], [50 x i8]* %3, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_45_1411.cpp() #0 section ".text.startup" {
