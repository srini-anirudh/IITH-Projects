; ModuleID = 'POJ-104-source/45/45-1580.cpp'
source_filename = "POJ-104-source/45/45-1580.cpp"
...
@p = dso_local global [1000 x [21 x i8]] zeroinitializer, align 16
@.str = private unnamed_addr constant [6 x i8] c"%s %s\00", align 1
@.str.1 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_45_1580.cpp, i8* null }]
...
22:                                               ; preds = %16
  ...
  %26 = call i32 @_Z5judgePcS_i(i8* %23, i8* %24, i32 %25)
  %27 = icmp eq i32 %26, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_45_1580.cpp() #0 section ".text.startup" {
