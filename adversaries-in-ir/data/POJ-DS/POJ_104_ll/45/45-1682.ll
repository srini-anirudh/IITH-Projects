; ModuleID = 'POJ-104-source/45/45-1682.cpp'
source_filename = "POJ-104-source/45/45-1682.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_45_1682.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i8* %16, i8* %17)
...
35:                                               ; preds = %31
  ...
  %38 = getelementptr inbounds [50 x i8], [50 x i8]* %11, i64 0, i64 %37
...
48:                                               ; preds = %31
  ...
  %54 = getelementptr inbounds [50 x i8], [50 x i8]* %12, i64 0, i64 0
  %55 = getelementptr inbounds [50 x i8], [50 x i8]* %10, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_45_1682.cpp() #0 section ".text.startup" {
