; ModuleID = 'POJ-104-source/45/45-198.cpp'
source_filename = "POJ-104-source/45/45-198.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_45_198.cpp, i8* null }]
...
56:                                               ; preds = %53, %49, %37
  %57 = phi i1 [ false, %49 ], [ false, %37 ], [ %55, %53 ]
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_45_198.cpp() #0 section ".text.startup" {
