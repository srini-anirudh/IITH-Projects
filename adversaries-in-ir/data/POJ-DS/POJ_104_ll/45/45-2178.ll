; ModuleID = 'POJ-104-source/45/45-2178.cpp'
source_filename = "POJ-104-source/45/45-2178.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_45_2178.cpp, i8* null }]
...
63:                                               ; preds = %59
  ...
  %69 = call i32 @strcmp(i8* %64, i8* %68) #6
  %70 = icmp eq i32 %69, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_45_2178.cpp() #0 section ".text.startup" {
