; ModuleID = 'POJ-104-source/45/45-2297.cpp'
source_filename = "POJ-104-source/45/45-2297.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_45_2297.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %6 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i8* %4, i8* %5)
  %7 = getelementptr inbounds [50 x i8], [50 x i8]* %3, i64 0, i64 0
  %8 = getelementptr inbounds [50 x i8], [50 x i8]* %2, i64 0, i64 0
  %9 = call i32 @_Z6strposPcS_(i8* %7, i8* %8)
...
define dso_local i32 @_Z6strposPcS_(i8* %0, i8* %1) #5 {
...
23:                                               ; preds = %19
  ...
  %27 = getelementptr inbounds [50 x i32], [50 x i32]* %8, i64 0, i64 %26
...
124:                                              ; preds = %110, %106, %102
  %125 = phi i1 [ false, %106 ], [ false, %102 ], [ %123, %110 ]
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_45_2297.cpp() #0 section ".text.startup" {
