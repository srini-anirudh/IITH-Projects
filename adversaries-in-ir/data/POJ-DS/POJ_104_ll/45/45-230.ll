; ModuleID = 'POJ-104-source/45/45-230.cpp'
source_filename = "POJ-104-source/45/45-230.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_45_230.cpp, i8* null }]
...
define dso_local i32 @_Z8mystrcmpPcS_i(i8* %0, i8* %1, i32 %2) #4 {
...
22:                                               ; preds = %12
  ...
  %29 = call i32 @_Z8mystrcmpPcS_i(i8* %26, i8* %27, i32 %28)
  %30 = icmp ne i32 %29, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_45_230.cpp() #0 section ".text.startup" {
