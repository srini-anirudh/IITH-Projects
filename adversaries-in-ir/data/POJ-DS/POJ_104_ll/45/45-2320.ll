; ModuleID = 'POJ-104-source/45/45-2320.cpp'
source_filename = "POJ-104-source/45/45-2320.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_45_2320.cpp, i8* null }]
...
define dso_local i32 @main() #7 {
  ...
  %11 = call i32 @_Z4FindPcS_(i8* %9, i8* %10)
  %12 = add nsw i32 %11, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_45_2320.cpp() #0 section ".text.startup" {
