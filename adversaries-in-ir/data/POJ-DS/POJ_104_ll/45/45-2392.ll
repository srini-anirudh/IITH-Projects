; ModuleID = 'POJ-104-source/45/45-2392.cpp'
source_filename = "POJ-104-source/45/45-2392.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_45_2392.cpp, i8* null }]
...
define dso_local i32 @_Z3capPcS_i(i8* %0, i8* %1, i32 %2) #4 {
...
22:                                               ; preds = %16
  ...
  %26 = call i32 @_Z3capPcS_i(i8* %23, i8* %24, i32 %25)
  %27 = icmp eq i32 %26, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_45_2392.cpp() #0 section ".text.startup" {
