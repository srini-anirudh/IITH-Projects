; ModuleID = 'POJ-104-source/45/45-2413.cpp'
source_filename = "POJ-104-source/45/45-2413.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_45_2413.cpp, i8* null }]
...
34:                                               ; preds = %24
  ...
  %41 = call i32 @_Z7panduanPcS_i(i8* %35, i8* %39, i32 %40)
  %42 = icmp ne i32 %41, 0
...
define dso_local i32 @_Z7panduanPcS_i(i8* %0, i8* %1, i32 %2) #6 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_45_2413.cpp() #0 section ".text.startup" {
