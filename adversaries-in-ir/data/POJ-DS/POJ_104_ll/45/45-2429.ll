; ModuleID = 'POJ-104-source/45/45-2429.cpp'
source_filename = "POJ-104-source/45/45-2429.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_45_2429.cpp, i8* null }]
...
define dso_local i32 @_Z5checkiPcS_i(i32 %0, i8* %1, i8* %2, i32 %3) #4 {
...
21:                                               ; preds = %17
  ...
  %26 = call i32 @_Z5checkiPcS_i(i32 %22, i8* %23, i8* %24, i32 %25)
  %27 = icmp eq i32 %26, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_45_2429.cpp() #0 section ".text.startup" {
