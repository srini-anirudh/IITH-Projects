; ModuleID = 'POJ-104-source/45/45-2470.cpp'
source_filename = "POJ-104-source/45/45-2470.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_45_2470.cpp, i8* null }]
...
53:                                               ; preds = %34
  ...
  %55 = getelementptr inbounds [50 x i8], [50 x i8]* %4, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_45_2470.cpp() #0 section ".text.startup" {
