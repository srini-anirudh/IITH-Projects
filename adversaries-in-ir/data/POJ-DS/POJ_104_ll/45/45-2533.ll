; ModuleID = 'POJ-104-source/45/45-2533.cpp'
source_filename = "POJ-104-source/45/45-2533.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_45_2533.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i8* @_Z1fPcS_(i8* %0, i8* %1) #0 {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca i8*, align 8
  ...
  %19 = call i8* @_ZSt6strchrPci(i8* %14, i32 %18)
...
62:                                               ; preds = %49
  ...
  %70 = call i8* @_Z1fPcS_(i8* %68, i8* %69)
...
define dso_local i32 @main() #6 {
  ...
  %12 = call i8* @_Z1fPcS_(i8* %10, i8* %11)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_45_2533.cpp() #0 section ".text.startup" {
