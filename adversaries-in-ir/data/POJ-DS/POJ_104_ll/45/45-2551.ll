; ModuleID = 'POJ-104-source/45/45-2551.cpp'
source_filename = "POJ-104-source/45/45-2551.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_45_2551.cpp, i8* null }]
...
define dso_local i32 @_Z5checkPcS_i(i8* %0, i8* %1, i32 %2) #4 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
...
23:                                               ; preds = %20
  ...
  %34 = call i32 @_Z5checkPcS_i(i8* %29, i8* %30, i32 %33)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_45_2551.cpp() #0 section ".text.startup" {
