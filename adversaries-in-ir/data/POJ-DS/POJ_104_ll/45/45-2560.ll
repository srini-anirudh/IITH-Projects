; ModuleID = 'POJ-104-source/45/45-2560.cpp'
source_filename = "POJ-104-source/45/45-2560.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_45_2560.cpp, i8* null }]
...
define dso_local i32 @_Z7isrightPcS_i(i8* %0, i8* %1, i32 %2) #4 {
...
30:                                               ; preds = %10
  ...
  %35 = getelementptr inbounds [50 x i8], [50 x i8]* %8, i64 0, i64 0
...
define dso_local i32 @main() #6 {
  ...
  %7 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i8* %5, i8* %6)
  store i32 0, i32* %4, align 4
  br label %8
...
17:                                               ; preds = %8
  ...
  %21 = call i32 @_Z7isrightPcS_i(i8* %18, i8* %19, i32 %20)
  %22 = icmp ne i32 %21, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_45_2560.cpp() #0 section ".text.startup" {
