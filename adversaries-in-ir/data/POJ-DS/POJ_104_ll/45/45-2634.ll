; ModuleID = 'POJ-104-source/45/45-2634.cpp'
source_filename = "POJ-104-source/45/45-2634.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_45_2634.cpp, i8* null }]
...
define dso_local i32 @_Z7comparei(i32 %0) #4 {
...
55:                                               ; preds = %49
  ...
  %57 = call i32 @_Z7comparei(i32 %56)
  %58 = icmp eq i32 %57, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_45_2634.cpp() #0 section ".text.startup" {
