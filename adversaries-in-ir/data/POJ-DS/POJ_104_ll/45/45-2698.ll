; ModuleID = 'POJ-104-source/45/45-2698.cpp'
source_filename = "POJ-104-source/45/45-2698.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_45_2698.cpp, i8* null }]
...
27:                                               ; preds = %17
  ...
  %31 = call i32 @_Z7comparePcS_i(i8* %28, i8* %29, i32 %30)
  %32 = icmp eq i32 %31, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_45_2698.cpp() #0 section ".text.startup" {
