; ModuleID = 'POJ-104-source/45/45-2877.cpp'
source_filename = "POJ-104-source/45/45-2877.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_45_2877.cpp, i8* null }]
...
57:                                               ; preds = %54
  ...
  %63 = call i32 @strcmp(i8* %58, i8* %62) #6
  %64 = icmp eq i32 %63, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_45_2877.cpp() #0 section ".text.startup" {
