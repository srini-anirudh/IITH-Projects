; ModuleID = 'POJ-104-source/45/45-318.cpp'
source_filename = "POJ-104-source/45/45-318.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_45_318.cpp, i8* null }]
...
20:                                               ; preds = %7
  ...
  %23 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i8* %21, i8* %22)
  store i32 0, i32* %4, align 4
  br label %24
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_45_318.cpp() #0 section ".text.startup" {
