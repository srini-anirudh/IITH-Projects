; ModuleID = 'POJ-104-source/45/45-350.cpp'
source_filename = "POJ-104-source/45/45-350.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_45_350.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %12 = call i8* @_ZSt6strstrPcPKc(i8* %10, i8* %11)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_45_350.cpp() #0 section ".text.startup" {
