; ModuleID = 'POJ-104-source/45/45-392.cpp'
source_filename = "POJ-104-source/45/45-392.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_45_392.cpp, i8* null }]
...
21:                                               ; preds = %16
  %22 = getelementptr inbounds [51 x i8], [51 x i8]* %2, i64 0, i64 0
...
36:                                               ; preds = %28
  ...
  %40 = getelementptr inbounds [51 x i8], [51 x i8]* %3, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_45_392.cpp() #0 section ".text.startup" {
