; ModuleID = 'POJ-104-source/45/45-563.cpp'
source_filename = "POJ-104-source/45/45-563.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_45_563.cpp, i8* null }]
...
define linkonce_odr dso_local i8* @_ZSt6strstrPcPKc(i8* %0, i8* %1) #7 comdat {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_45_563.cpp() #0 section ".text.startup" {
