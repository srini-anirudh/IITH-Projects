; ModuleID = 'POJ-104-source/45/45-673.cpp'
source_filename = "POJ-104-source/45/45-673.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_45_673.cpp, i8* null }]
...
45:                                               ; preds = %28
  %46 = getelementptr inbounds [50 x i8], [50 x i8]* %9, i64 0, i64 0
  %47 = getelementptr inbounds [50 x i8], [50 x i8]* %7, i64 0, i64 0
...
51:                                               ; preds = %45
  ...
  %55 = call i8* @strcpy(i8* %54, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i64 0, i64 0)) #3
  br label %56
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_45_673.cpp() #0 section ".text.startup" {
