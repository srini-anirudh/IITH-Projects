; ModuleID = 'POJ-104-source/45/45-839.cpp'
source_filename = "POJ-104-source/45/45-839.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_45_839.cpp, i8* null }]
...
51:                                               ; preds = %39, %33, %27
  %52 = phi i1 [ false, %33 ], [ false, %27 ], [ %50, %39 ]
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_45_839.cpp() #0 section ".text.startup" {
