; ModuleID = 'POJ-104-source/46/46-1330.cpp'
source_filename = "POJ-104-source/46/46-1330.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_46_1330.cpp, i8* null }]
...
define dso_local i32 @_Z2rePA100_iiiPi([100 x i32]* %0, i32 %1, i32 %2, i32* %3) #4 {
...
34:                                               ; preds = %10
  ...
  %39 = call i32 @_Z2rePA100_iiiPi([100 x i32]* %35, i32 %36, i32 %37, i32* %38)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_46_1330.cpp() #0 section ".text.startup" {
