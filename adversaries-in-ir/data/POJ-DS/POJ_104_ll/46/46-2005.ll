; ModuleID = 'POJ-104-source/46/46-2005.cpp'
source_filename = "POJ-104-source/46/46-2005.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_46_2005.cpp, i8* null }]
...
define dso_local i32 @main(i32 %0, i8** %1) #4 {
  ...
  %15 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %7, i32* %8)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_46_2005.cpp() #0 section ".text.startup" {
