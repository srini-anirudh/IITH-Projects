; ModuleID = 'POJ-104-source/46/46-2052.cpp'
source_filename = "POJ-104-source/46/46-2052.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_46_2052.cpp, i8* null }]
...
32:                                               ; preds = %8
  ...
  call void @_Z3toyPA100_iii([100 x i32]* %33, i32 %34, i32 %35)
...
; Function Attrs: noinline uwtable
define dso_local void @_Z3toyPA100_iii([100 x i32]* %0, i32 %1, i32 %2) #0 {
...
233:                                              ; preds = %197
  ...
  call void @_Z3toyPA100_iii([100 x i32]* %234, i32 %236, i32 %238)
  br label %239
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_46_2052.cpp() #0 section ".text.startup" {
