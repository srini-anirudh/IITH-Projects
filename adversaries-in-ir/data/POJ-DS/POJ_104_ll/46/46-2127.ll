; ModuleID = 'POJ-104-source/46/46-2127.cpp'
source_filename = "POJ-104-source/46/46-2127.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_46_2127.cpp, i8* null }]
...
define dso_local i32 @_Z5timesii(i32 %0, i32 %1) #4 {
...
; Function Attrs: noinline uwtable
define dso_local void @_Z7spinoutPA100_iii([100 x i32]* %0, i32 %1, i32 %2) #0 {
...
11:                                               ; preds = %174, %3
  ...
  %15 = call i32 @_Z5timesii(i32 %13, i32 %14)
...
define dso_local i32 @main() #6 {
  ...
  %7 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %2, i32* %3)
  store i32 0, i32* %4, align 4
  br label %8
...
34:                                               ; preds = %8
  ...
  call void @_Z7spinoutPA100_iii([100 x i32]* %35, i32 %36, i32 %37)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_46_2127.cpp() #0 section ".text.startup" {
