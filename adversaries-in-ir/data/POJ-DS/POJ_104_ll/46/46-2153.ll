; ModuleID = 'POJ-104-source/46/46-2153.cpp'
source_filename = "POJ-104-source/46/46-2153.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_46_2153.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z1fPA100_iiii([100 x i32]* %0, i32 %1, i32 %2, i32 %3) #0 {
...
35:                                               ; preds = %11
  ...
  call void @_Z1fPA100_iiii([100 x i32]* %40, i32 %41, i32 %42, i32 %43)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_46_2153.cpp() #0 section ".text.startup" {
