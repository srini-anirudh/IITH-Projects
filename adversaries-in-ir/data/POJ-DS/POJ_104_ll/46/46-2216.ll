; ModuleID = 'POJ-104-source/46/46-2216.cpp'
source_filename = "POJ-104-source/46/46-2216.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_46_2216.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %7 = sub nsw i32 %6, 1
  call void @_Z5shuruii(i32 %5, i32 %7)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5shuruii(i32 %0, i32 %1) #0 {
...
50:                                               ; preds = %45
  ...
  call void @_Z7huixingPA100_iiii([100 x i32]* %51, i32 %52, i32 %53, i32 %54)
  br label %55
...
; Function Attrs: noinline uwtable
define dso_local void @_Z7huixingPA100_iiii([100 x i32]* %0, i32 %1, i32 %2, i32 %3) #0 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_46_2216.cpp() #0 section ".text.startup" {
