; ModuleID = 'POJ-104-source/46/46-229.cpp'
source_filename = "POJ-104-source/46/46-229.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_46_229.cpp, i8* null }]
...
31:                                               ; preds = %7
  ...
  call void @_Z9transformii(i32 %32, i32 %33)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define dso_local void @_Z9transformii(i32 %0, i32 %1) #0 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_46_229.cpp() #0 section ".text.startup" {
