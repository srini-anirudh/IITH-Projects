; ModuleID = 'POJ-104-source/46/46-2337.cpp'
source_filename = "POJ-104-source/46/46-2337.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_46_2337.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %3, i32* %2)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_46_2337.cpp() #0 section ".text.startup" {
