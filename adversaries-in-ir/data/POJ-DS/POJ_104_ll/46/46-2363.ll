; ModuleID = 'POJ-104-source/46/46-2363.cpp'
source_filename = "POJ-104-source/46/46-2363.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_46_2363.cpp, i8* null }]
...
176:                                              ; preds = %171, %140, %107, %74, %45, %35
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_46_2363.cpp() #0 section ".text.startup" {
