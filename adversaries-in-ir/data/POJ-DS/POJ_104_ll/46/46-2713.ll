; ModuleID = 'POJ-104-source/46/46-2713.cpp'
source_filename = "POJ-104-source/46/46-2713.cpp"
...
@unvis = dso_local global [102 x [102 x i32]] zeroinitializer, align 16
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_46_2713.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_46_2713.cpp() #0 section ".text.startup" {
