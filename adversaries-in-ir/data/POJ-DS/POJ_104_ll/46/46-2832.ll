; ModuleID = 'POJ-104-source/46/46-2832.cpp'
source_filename = "POJ-104-source/46/46-2832.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_46_2832.cpp, i8* null }]
...
33:                                               ; preds = %9
  ...
  %37 = sub nsw i32 %36, 1
  call void @_Z1pciiii(i8 signext 121, i32 0, i32 0, i32 %35, i32 %37)
...
; Function Attrs: noinline uwtable
define dso_local void @_Z1pciiii(i8 signext %0, i32 %1, i32 %2, i32 %3, i32 %4) #0 {
  %6 = alloca i8, align 1
  %7 = alloca i32, align 4
...
40:                                               ; preds = %36
  ...
  call void @_Z1pciiii(i8 signext 120, i32 %41, i32 %43, i32 %44, i32 %45)
  br label %46
...
73:                                               ; preds = %69
  ...
  call void @_Z1pciiii(i8 signext 122, i32 %74, i32 %75, i32 %77, i32 %78)
  br label %79
...
106:                                              ; preds = %102
  ...
  call void @_Z1pciiii(i8 signext 115, i32 %107, i32 %108, i32 %109, i32 %111)
  br label %112
...
139:                                              ; preds = %135
  ...
  call void @_Z1pciiii(i8 signext 121, i32 %141, i32 %142, i32 %143, i32 %144)
  br label %145
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_46_2832.cpp() #0 section ".text.startup" {
