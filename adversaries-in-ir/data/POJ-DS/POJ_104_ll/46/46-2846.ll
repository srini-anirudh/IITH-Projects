; ModuleID = 'POJ-104-source/46/46-2846.cpp'
source_filename = "POJ-104-source/46/46-2846.cpp"
...
@rp = dso_local global i32 0, align 4
@re = dso_local global i32 0, align 4
@lp = dso_local global i32 0, align 4
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_46_2846.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z5printiiiiii(i32 %0, i32 %1, i32 %2, i32 %3, i32 %4, i32 %5) #0 {
...
51:                                               ; preds = %35
  ...
  %60 = call i32 @_Z5printiiiiii(i32 %53, i32 %54, i32 %55, i32 %56, i32 %58, i32 %59)
  store i32 0, i32* %7, align 4
  br label %173
...
88:                                               ; preds = %72
  ...
  %96 = sub nsw i32 %95, 1
  %97 = call i32 @_Z5printiiiiii(i32 %89, i32 %90, i32 %91, i32 %93, i32 %94, i32 %96)
  store i32 0, i32* %7, align 4
  br label %173
...
125:                                              ; preds = %109
  ...
  %134 = call i32 @_Z5printiiiiii(i32 %126, i32 %128, i32 %129, i32 %130, i32 %132, i32 %133)
  store i32 0, i32* %7, align 4
  br label %173
...
162:                                              ; preds = %146
  ...
  %171 = call i32 @_Z5printiiiiii(i32 %163, i32 %164, i32 %166, i32 %167, i32 %168, i32 %170)
  store i32 0, i32* %7, align 4
  br label %173
...
define dso_local i32 @main() #5 {
  ...
  %6 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %2, i32* %3)
...
16:                                               ; preds = %12
  ...
  %23 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i32* %22)
  br label %24
...
31:                                               ; preds = %7
  ...
  %38 = call i32 @_Z5printiiiiii(i32 %34, i32 %35, i32 %36, i32 %37, i32 1, i32 1)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_46_2846.cpp() #0 section ".text.startup" {
