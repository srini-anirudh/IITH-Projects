; ModuleID = 'POJ-104-source/46/46-2949.cpp'
source_filename = "POJ-104-source/46/46-2949.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_46_2949.cpp, i8* null }]
...
define dso_local i32 @_Z3sumiii(i32 %0, i32 %1, i32 %2) #4 {
...
define dso_local i32 @main() #5 {
  ...
  %15 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %4, i32* %5)
  store i32 1, i32* %6, align 4
  br label %16
...
25:                                               ; preds = %21
  ...
  %45 = call i32 @_Z3miniiii(i32 %40, i32 %42, i32 %43, i32 %44)
  store i32 %45, i32* %10, align 4
  %46 = load i32, i32* %4, align 4
  %47 = load i32, i32* %5, align 4
  %48 = load i32, i32* %10, align 4
  %49 = call i32 @_Z3sumiii(i32 %46, i32 %47, i32 %48)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_46_2949.cpp() #0 section ".text.startup" {
