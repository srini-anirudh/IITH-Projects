; ModuleID = 'POJ-104-source/46/46-2961.cpp'
source_filename = "POJ-104-source/46/46-2961.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_46_2961.cpp, i8* null }]
...
78:                                               ; preds = %68
  ...
  store i32 2147483647, i32* %95, align 4
  br label %96
...
147:                                              ; preds = %142
  ...
  %156 = icmp ne i32 %155, 2147483647
...
157:                                              ; preds = %147
  ...
  store i32 2147483647, i32* %174, align 4
  br label %175
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_46_2961.cpp() #0 section ".text.startup" {
