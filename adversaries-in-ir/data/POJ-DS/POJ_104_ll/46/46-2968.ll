; ModuleID = 'POJ-104-source/46/46-2968.cpp'
source_filename = "POJ-104-source/46/46-2968.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_46_2968.cpp, i8* null }]
...
121:                                              ; preds = %117
  ...
  %124 = getelementptr inbounds [200 x [200 x i32]], [200 x [200 x i32]]* %2, i64 0, i64 %123
...
158:                                              ; preds = %154
  ...
  %161 = getelementptr inbounds [200 x [200 x i32]], [200 x [200 x i32]]* %2, i64 0, i64 %160
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_46_2968.cpp() #0 section ".text.startup" {
