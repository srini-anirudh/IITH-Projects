; ModuleID = 'POJ-104-source/46/46-3018.cpp'
source_filename = "POJ-104-source/46/46-3018.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_46_3018.cpp, i8* null }]
...
58:                                               ; preds = %53
  ...
  %61 = getelementptr inbounds [200 x [200 x i32]], [200 x [200 x i32]]* %4, i64 0, i64 %60
...
116:                                              ; preds = %111
  ...
  %119 = getelementptr inbounds [200 x [200 x i32]], [200 x [200 x i32]]* %4, i64 0, i64 %118
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_46_3018.cpp() #0 section ".text.startup" {
