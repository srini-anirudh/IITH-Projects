; ModuleID = 'POJ-104-source/46/46-3207.cpp'
source_filename = "POJ-104-source/46/46-3207.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_46_3207.cpp, i8* null }]
...
73:                                               ; preds = %71
  ...
  %76 = getelementptr inbounds [200 x [200 x i32]], [200 x [200 x i32]]* %10, i64 0, i64 %75
...
105:                                              ; preds = %103
  ...
  %114 = getelementptr inbounds [200 x i32], [200 x i32]* %108, i64 0, i64 %113
...
138:                                              ; preds = %136
  ...
  %144 = getelementptr inbounds [200 x [200 x i32]], [200 x [200 x i32]]* %10, i64 0, i64 %143
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_46_3207.cpp() #0 section ".text.startup" {
