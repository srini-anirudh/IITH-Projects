; ModuleID = 'POJ-104-source/46/46-3355.cpp'
source_filename = "POJ-104-source/46/46-3355.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_46_3355.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5printPA100_iiiiii([100 x i32]* %0, i32 %1, i32 %2, i32 %3, i32 %4, i32 %5) #0 {
...
136:                                              ; preds = %131
  ...
  call void @_Z5printPA100_iiiiii([100 x i32]* %137, i32 %139, i32 %141, i32 %143, i32 %145, i32 %146)
  br label %147
...
define dso_local i32 @main() #4 {
  ...
  %7 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %4, i32* %5)
...
32:                                               ; preds = %8
  ...
  %36 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %6, i64 0, i64 0
  %37 = load i32, i32* %4, align 4
  %38 = load i32, i32* %5, align 4
  call void @_Z5printPA100_iiiiii([100 x i32]* %36, i32 0, i32 0, i32 %37, i32 %38, i32 0)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_46_3355.cpp() #0 section ".text.startup" {
