; ModuleID = 'POJ-104-source/46/46-3474.cpp'
source_filename = "POJ-104-source/46/46-3474.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_46_3474.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z6shuchuiiiii(i32 %0, i32 %1, i32 %2, i32 %3, i32 %4) #0 {
...
177:                                              ; preds = %161
  ...
  call void @_Z6shuchuiiiii(i32 %179, i32 %181, i32 %182, i32 %183, i32 %185)
  br label %186
...
31:                                               ; preds = %7
  ...
  call void @_Z6shuchuiiiii(i32 %32, i32 %33, i32 %34, i32 %35, i32 0)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_46_3474.cpp() #0 section ".text.startup" {
