; ModuleID = 'POJ-104-source/46/46-3493.cpp'
source_filename = "POJ-104-source/46/46-3493.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_46_3493.cpp, i8* null }]
...
35:                                               ; preds = %31
  ...
  %43 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %42)
  br label %44
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_46_3493.cpp() #0 section ".text.startup" {
