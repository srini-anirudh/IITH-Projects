; ModuleID = 'POJ-104-source/46/46-367.cpp'
source_filename = "POJ-104-source/46/46-367.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_46_367.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %17, i32* %18)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_46_367.cpp() #0 section ".text.startup" {
