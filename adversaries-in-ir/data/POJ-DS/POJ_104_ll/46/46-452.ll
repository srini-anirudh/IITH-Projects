; ModuleID = 'POJ-104-source/46/46-452.cpp'
source_filename = "POJ-104-source/46/46-452.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_46_452.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z3outiiii(i32 %0, i32 %1, i32 %2, i32 %3) #0 {
...
110:                                              ; preds = %106
  ...
  %119 = call i32 @_Z3outiiii(i32 %112, i32 %114, i32 %116, i32 %118)
  br label %120
...
define dso_local i32 @main() #4 {
  ...
  %2 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* @row, i32* @col)
...
15:                                               ; preds = %11
  ...
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i32* %21)
  br label %23
...
30:                                               ; preds = %6
  ...
  %33 = call i32 @_Z3outiiii(i32 1, i32 1, i32 %31, i32 %32)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_46_452.cpp() #0 section ".text.startup" {
