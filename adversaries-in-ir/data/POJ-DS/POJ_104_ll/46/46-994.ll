; ModuleID = 'POJ-104-source/46/46-994.cpp'
source_filename = "POJ-104-source/46/46-994.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_46_994.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z6circlePA100_iiiii([100 x i32]* %0, i32 %1, i32 %2, i32 %3, i32 %4) #0 {
...
define dso_local i32 @main() #4 {
  ...
  %11 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %5, i32* %6)
...
21:                                               ; preds = %17
  ...
  %28 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i32* %27)
  br label %29
...
51:                                               ; preds = %49
  ...
  call void @_Z6circlePA100_iiiii([100 x i32]* %52, i32 %53, i32 %54, i32 %55, i32 %56)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_46_994.cpp() #0 section ".text.startup" {
