; ModuleID = 'POJ-104-source/47/47-1722.cpp'
source_filename = "POJ-104-source/47/47-1722.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_47_1722.cpp, i8* null }]
...
18:                                               ; preds = %6
  ...
  call void @_Z3invPii(i32* %19, i32 %20)
  store i32 0, i32* %2, align 4
  br label %21
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_47_1722.cpp() #0 section ".text.startup" {
