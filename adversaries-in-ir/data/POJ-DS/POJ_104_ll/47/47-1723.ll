; ModuleID = 'POJ-104-source/47/47-1723.cpp'
source_filename = "POJ-104-source/47/47-1723.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_47_1723.cpp, i8* null }]
...
define dso_local void @_Z3invPii(i32* %0, i32 %1) #4 {
...
19:                                               ; preds = %8
  ...
  call void @_Z3invPii(i32* %20, i32 %21)
  store i32 0, i32* %2, align 4
  br label %22
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_47_1723.cpp() #0 section ".text.startup" {
