; ModuleID = 'POJ-104-source/47/47-2864.cpp'
source_filename = "POJ-104-source/47/47-2864.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_47_2864.cpp, i8* null }]
...
30:                                               ; preds = %25
  ...
  call void @_Z4swapPiS_(i32* %40, i32* %41)
  br label %42
...
52:                                               ; preds = %47
  ...
  call void @_Z4swapPiS_(i32* %62, i32* %63)
  br label %64
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_47_2864.cpp() #0 section ".text.startup" {
