; ModuleID = 'POJ-104-source/47/47-3549.cpp'
source_filename = "POJ-104-source/47/47-3549.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_47_3549.cpp, i8* null }]
...
17:                                               ; preds = %5
  ...
  call void @_Z6changePii(i32* getelementptr inbounds ([100 x i32], [100 x i32]* @sz, i64 0, i64 0), i32 %18)
  store i32 0, i32* %3, align 4
  br label %19
...
define dso_local void @_Z6changePii(i32* %0, i32 %1) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_47_3549.cpp() #0 section ".text.startup" {
