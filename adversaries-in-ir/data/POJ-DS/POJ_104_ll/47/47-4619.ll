; ModuleID = 'POJ-104-source/47/47-4619.cpp'
source_filename = "POJ-104-source/47/47-4619.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_47_4619.cpp, i8* null }]
...
21:                                               ; preds = %8
  ...
  call void @_Z7reversePii(i32* %22, i32 %23)
  store i32 0, i32* %3, align 4
  br label %24
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_47_4619.cpp() #0 section ".text.startup" {
