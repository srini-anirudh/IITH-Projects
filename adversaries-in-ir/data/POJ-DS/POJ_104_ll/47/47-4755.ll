; ModuleID = 'POJ-104-source/47/47-4755.cpp'
source_filename = "POJ-104-source/47/47-4755.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_47_4755.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %6 = call noalias i8* @calloc(i64 1, i64 400) #3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_47_4755.cpp() #0 section ".text.startup" {
