; ModuleID = 'POJ-104-source/47/47-4947.cpp'
source_filename = "POJ-104-source/47/47-4947.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_47_4947.cpp, i8* null }]
...
20:                                               ; preds = %8
  ...
  call void @_Z6changePii(i32* %23, i32 %24)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_47_4947.cpp() #0 section ".text.startup" {
