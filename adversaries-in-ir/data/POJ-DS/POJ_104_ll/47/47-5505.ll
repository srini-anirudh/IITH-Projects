; ModuleID = 'POJ-104-source/47/47-5505.cpp'
source_filename = "POJ-104-source/47/47-5505.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_47_5505.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z6invertPii(i32* %0, i32 %1) #0 {
...
23:                                               ; preds = %11
  ...
  call void @_Z6invertPii(i32* %10, i32 %24)
  store i32 0, i32* %1, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_47_5505.cpp() #0 section ".text.startup" {
