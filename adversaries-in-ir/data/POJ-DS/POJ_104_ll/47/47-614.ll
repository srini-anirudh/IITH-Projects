; ModuleID = 'POJ-104-source/47/47-614.cpp'
source_filename = "POJ-104-source/47/47-614.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_47_614.cpp, i8* null }]
...
24:                                               ; preds = %19
  ...
  call void @_Z8jiaohuanPiS_(i32* %27, i32* %33)
  br label %34
...
define dso_local void @_Z8jiaohuanPiS_(i32* %0, i32* %1) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_47_614.cpp() #0 section ".text.startup" {
