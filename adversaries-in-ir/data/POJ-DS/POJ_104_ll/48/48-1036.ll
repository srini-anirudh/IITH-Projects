; ModuleID = 'POJ-104-source/48/48-1036.cpp'
source_filename = "POJ-104-source/48/48-1036.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_48_1036.cpp, i8* null }]
...
253:                                              ; preds = %250
  ...
  %256 = getelementptr inbounds [6 x [11 x [11 x i32]]], [6 x [11 x [11 x i32]]]* @s, i64 0, i64 %255
...
269:                                              ; preds = %250
  ...
  %272 = getelementptr inbounds [6 x [11 x [11 x i32]]], [6 x [11 x [11 x i32]]]* @s, i64 0, i64 %271
  %273 = load i32, i32* %5, align 4
  %274 = sext i32 %273 to i64
  %275 = getelementptr inbounds [11 x [11 x i32]], [11 x [11 x i32]]* %272, i64 0, i64 %274
  %276 = getelementptr inbounds [11 x i32], [11 x i32]* %275, i64 0, i64 9
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_48_1036.cpp() #0 section ".text.startup" {
