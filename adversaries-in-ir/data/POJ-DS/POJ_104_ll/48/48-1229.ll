; ModuleID = 'POJ-104-source/48/48-1229.cpp'
source_filename = "POJ-104-source/48/48-1229.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_48_1229.cpp, i8* null }]
...
32:                                               ; preds = %9
  ...
  %35 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i64* %34, i64* %5)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_48_1229.cpp() #0 section ".text.startup" {
