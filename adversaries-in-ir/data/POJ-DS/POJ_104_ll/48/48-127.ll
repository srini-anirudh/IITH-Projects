; ModuleID = 'POJ-104-source/48/48-127.cpp'
source_filename = "POJ-104-source/48/48-127.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_48_127.cpp, i8* null }]
...
38:                                               ; preds = %34
  %39 = getelementptr inbounds [9 x [9 x i32]], [9 x [9 x i32]]* %2, i64 0, i64 0
  call void @_Z6spreadPA9_i([9 x i32]* %39)
  br label %40
...
define dso_local void @_Z6spreadPA9_i([9 x i32]* %0) #5 {
...
70:                                               ; preds = %65
  ...
  %78 = load [9 x i32]*, [9 x i32]** %2, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_48_127.cpp() #0 section ".text.startup" {
