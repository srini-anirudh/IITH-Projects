; ModuleID = 'POJ-104-source/48/48-1309.cpp'
source_filename = "POJ-104-source/48/48-1309.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_48_1309.cpp, i8* null }]
...
32:                                               ; preds = %11
  %33 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %5, i32* %6)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_48_1309.cpp() #0 section ".text.startup" {
