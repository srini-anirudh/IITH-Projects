; ModuleID = 'POJ-104-source/48/48-1317.cpp'
source_filename = "POJ-104-source/48/48-1317.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_48_1317.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z3dayiii(i32 %0, i32 %1, i32 %2) #0 {
...
35:                                               ; preds = %31
  ...
  %39 = sub nsw i32 %38, 1
  %40 = call i32 @_Z3dayiii(i32 %36, i32 %37, i32 %39)
  %41 = mul nsw i32 %40, 2
  ...
  %46 = sub nsw i32 %45, 1
  %47 = call i32 @_Z3dayiii(i32 %43, i32 %44, i32 %46)
  ...
  %53 = sub nsw i32 %52, 1
  %54 = call i32 @_Z3dayiii(i32 %50, i32 %51, i32 %53)
  ...
  %60 = sub nsw i32 %59, 1
  %61 = call i32 @_Z3dayiii(i32 %56, i32 %58, i32 %60)
  ...
  %67 = sub nsw i32 %66, 1
  %68 = call i32 @_Z3dayiii(i32 %63, i32 %65, i32 %67)
  ...
  %83 = sub nsw i32 %82, 1
  %84 = call i32 @_Z3dayiii(i32 %79, i32 %81, i32 %83)
  ...
  %91 = sub nsw i32 %90, 1
  %92 = call i32 @_Z3dayiii(i32 %87, i32 %89, i32 %91)
  ...
  %99 = sub nsw i32 %98, 1
  %100 = call i32 @_Z3dayiii(i32 %95, i32 %97, i32 %99)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_48_1317.cpp() #0 section ".text.startup" {
