; ModuleID = 'POJ-104-source/48/48-14.cpp'
source_filename = "POJ-104-source/48/48-14.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_48_14.cpp, i8* null }]
...
36:                                               ; preds = %9
  %37 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %3, i32* %2)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_48_14.cpp() #0 section ".text.startup" {
