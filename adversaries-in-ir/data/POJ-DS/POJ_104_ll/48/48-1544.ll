; ModuleID = 'POJ-104-source/48/48-1544.cpp'
source_filename = "POJ-104-source/48/48-1544.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_48_1544.cpp, i8* null }]
...
define dso_local void @_Z7nextdayPA11_iS0_([11 x i32]* %0, [11 x i32]* %1) #4 {
...
; Function Attrs: noinline uwtable
define dso_local void @_Z10printarrayPA11_i([11 x i32]* %0) #0 {
...
define dso_local i32 @main() #5 {
  ...
  %7 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.3, i64 0, i64 0), i32* %2, i32* %3)
...
21:                                               ; preds = %17
  ...
  call void @_Z7nextdayPA11_iS0_([11 x i32]* %22, [11 x i32]* %23)
  br label %27
...
24:                                               ; preds = %17
  ...
  call void @_Z7nextdayPA11_iS0_([11 x i32]* %25, [11 x i32]* %26)
  br label %27
...
35:                                               ; preds = %31
  ...
  call void @_Z10printarrayPA11_i([11 x i32]* %36)
  br label %39

37:                                               ; preds = %31
  %38 = getelementptr inbounds [11 x [11 x i32]], [11 x [11 x i32]]* %5, i64 0, i64 0
  call void @_Z10printarrayPA11_i([11 x i32]* %38)
  br label %39
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_48_1544.cpp() #0 section ".text.startup" {
