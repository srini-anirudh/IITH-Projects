; ModuleID = 'POJ-104-source/48/48-1560.cpp'
source_filename = "POJ-104-source/48/48-1560.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_48_1560.cpp, i8* null }]
...
define dso_local void @_Z4workiic(i32 %0, i32 %1, i8 signext %2) #4 {
...
63:                                               ; preds = %54
  ...
  call void @_Z4workiic(i32 %64, i32 %65, i8 signext 98)
  br label %66
...
121:                                              ; preds = %112
  ...
  call void @_Z4workiic(i32 %122, i32 %123, i8 signext 97)
  br label %124
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_48_1560.cpp() #0 section ".text.startup" {
