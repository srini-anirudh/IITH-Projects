; ModuleID = 'POJ-104-source/48/48-1594.cpp'
source_filename = "POJ-104-source/48/48-1594.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_48_1594.cpp, i8* null }]
...
36:                                               ; preds = %9
  %37 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %7, i32* %8)
...
274:                                              ; preds = %259
  ...
  %280 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i32 %279)
  %281 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0))
  br label %282
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_48_1594.cpp() #0 section ".text.startup" {
