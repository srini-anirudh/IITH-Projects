; ModuleID = 'POJ-104-source/48/48-1748.cpp'
source_filename = "POJ-104-source/48/48-1748.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_48_1748.cpp, i8* null }]
...
34:                                               ; preds = %7
  %35 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %3, i32* %2)
...
58:                                               ; preds = %49
  ...
  call void @_Z2scii(i32 %59, i32 %60)
  br label %61
...
define dso_local void @_Z2scii(i32 %0, i32 %1) #5 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_48_1748.cpp() #0 section ".text.startup" {
