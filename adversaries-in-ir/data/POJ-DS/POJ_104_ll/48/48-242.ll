; ModuleID = 'POJ-104-source/48/48-242.cpp'
source_filename = "POJ-104-source/48/48-242.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_48_242.cpp, i8* null }]
...
175:                                              ; preds = %172
  ...
  %178 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* @b, i64 0, i64 %177
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_48_242.cpp() #0 section ".text.startup" {
