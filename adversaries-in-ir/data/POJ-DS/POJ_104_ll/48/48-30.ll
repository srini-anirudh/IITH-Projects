; ModuleID = 'POJ-104-source/48/48-30.cpp'
source_filename = "POJ-104-source/48/48-30.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_48_30.cpp, i8* null }]
...
30:                                               ; preds = %27
  ...
  %122 = getelementptr inbounds [9 x [9 x i32]], [9 x [9 x i32]]* %6, i64 0, i64 %121
...
194:                                              ; preds = %191
  ...
  %210 = getelementptr inbounds [9 x [9 x i32]], [9 x [9 x i32]]* %6, i64 0, i64 %209
...
225:                                              ; preds = %18
  %226 = getelementptr inbounds [9 x [9 x i32]], [9 x [9 x i32]]* %2, i64 0, i64 0
  call void @_Z6outputPA9_i([9 x i32]* %226)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_48_30.cpp() #0 section ".text.startup" {
