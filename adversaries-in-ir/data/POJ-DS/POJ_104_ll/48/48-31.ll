; ModuleID = 'POJ-104-source/48/48-31.cpp'
source_filename = "POJ-104-source/48/48-31.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_48_31.cpp, i8* null }]
...
27:                                               ; preds = %24
  ...
  %105 = getelementptr inbounds [11 x [11 x i32]], [11 x [11 x i32]]* %4, i64 0, i64 %104
...
169:                                              ; preds = %166
  ...
  %172 = getelementptr inbounds [11 x [11 x i32]], [11 x [11 x i32]]* %4, i64 0, i64 %171
...
190:                                              ; preds = %178
  ...
  %198 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i32 %197)
  br label %199
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_48_31.cpp() #0 section ".text.startup" {
