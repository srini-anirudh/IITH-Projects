; ModuleID = 'POJ-104-source/48/48-340.cpp'
source_filename = "POJ-104-source/48/48-340.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_48_340.cpp, i8* null }]
...
define dso_local void @_Z1pPA9_i([9 x i32]* %0) #4 {
...
17:                                               ; preds = %13
  ...
  call void @_Z1pPA9_i([9 x i32]* %18)
  br label %19
...
30:                                               ; preds = %27
  ...
  %41 = select i1 %39, i8 10, i8 32
  %42 = sext i8 %41 to i32
  %43 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32 %37, i32 %42)
  br label %44
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_48_340.cpp() #0 section ".text.startup" {
