; ModuleID = 'POJ-104-source/48/48-606.cpp'
source_filename = "POJ-104-source/48/48-606.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_48_606.cpp, i8* null }]
...
33:                                               ; preds = %28
  ...
  %49 = getelementptr inbounds [5 x [11 x [11 x i32]]], [5 x [11 x [11 x i32]]]* %2, i64 0, i64 %48
  ...
  %143 = getelementptr inbounds [5 x [11 x [11 x i32]]], [5 x [11 x [11 x i32]]]* %2, i64 0, i64 %142
...
178:                                              ; preds = %175
  ...
  %185 = getelementptr inbounds [11 x i32], [11 x i32]* %184, i64 0, i64 1
...
191:                                              ; preds = %188
  ...
  %203 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %192, i32 %202)
  br label %204
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_48_606.cpp() #0 section ".text.startup" {
