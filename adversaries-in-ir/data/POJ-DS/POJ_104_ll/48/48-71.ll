; ModuleID = 'POJ-104-source/48/48-71.cpp'
source_filename = "POJ-104-source/48/48-71.cpp"
...
@a = dso_local global [10 x [10 x [5 x i32]]] zeroinitializer, align 16
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_48_71.cpp, i8* null }]
...
34:                                               ; preds = %2
  %35 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* @n, i32* @k)
...
321:                                              ; preds = %286
  %322 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i32* @n)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_48_71.cpp() #0 section ".text.startup" {
