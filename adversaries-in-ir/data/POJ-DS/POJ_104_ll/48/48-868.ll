; ModuleID = 'POJ-104-source/48/48-868.cpp'
source_filename = "POJ-104-source/48/48-868.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_48_868.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z3infi(i32 %0) #0 {
...
define dso_local i32 @main() #4 {
  ...
  %4 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* getelementptr inbounds ([10 x [10 x i32]], [10 x [10 x i32]]* @a, i64 0, i64 5, i64 5), i32* @n)
  call void @_Z3infi(i32 1)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_48_868.cpp() #0 section ".text.startup" {
