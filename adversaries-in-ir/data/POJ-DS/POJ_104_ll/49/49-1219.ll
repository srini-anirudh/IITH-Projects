; ModuleID = 'POJ-104-source/49/49-1219.cpp'
source_filename = "POJ-104-source/49/49-1219.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_49_1219.cpp, i8* null }]
...
define dso_local void @_Z3subPcS_ii(i8* %0, i8* %1, i32 %2, i32 %3) #4 {
  %5 = alloca i8*, align 8
  %6 = alloca i8*, align 8
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z7comparePci(i8* %0, i32 %1) #4 {
  %3 = alloca i8*, align 8
...
29:                                               ; preds = %19
  ...
  call void @_Z3subPcS_ii(i8* %30, i8* %31, i32 %32, i32 %33)
  %34 = getelementptr inbounds [500 x i8], [500 x i8]* %5, i64 0, i64 0
  %35 = load i32, i32* %3, align 4
  %36 = call i32 @_Z7comparePci(i8* %34, i32 %35)
  %37 = icmp eq i32 %36, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_49_1219.cpp() #0 section ".text.startup" {
