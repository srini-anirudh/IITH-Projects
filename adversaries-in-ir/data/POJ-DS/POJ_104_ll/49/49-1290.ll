; ModuleID = 'POJ-104-source/49/49-1290.cpp'
source_filename = "POJ-104-source/49/49-1290.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_49_1290.cpp, i8* null }]
...
define dso_local i32 @_Z7panduanPci(i8* %0, i32 %1) #4 {
...
55:                                               ; preds = %31
  ...
  %68 = call i32 @_Z7panduanPci(i8* %60, i32 %67)
  %69 = icmp eq i32 %68, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_49_1290.cpp() #0 section ".text.startup" {
