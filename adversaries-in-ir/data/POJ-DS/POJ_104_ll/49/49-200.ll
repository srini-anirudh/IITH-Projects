; ModuleID = 'POJ-104-source/49/49-200.cpp'
source_filename = "POJ-104-source/49/49-200.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_49_200.cpp, i8* null }]
...
102:                                              ; preds = %60
  ...
  %113 = call i32 @strcmp(i8* %111, i8* %112) #7
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_49_200.cpp() #0 section ".text.startup" {
