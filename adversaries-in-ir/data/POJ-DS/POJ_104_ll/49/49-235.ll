; ModuleID = 'POJ-104-source/49/49-235.cpp'
source_filename = "POJ-104-source/49/49-235.cpp"
...
@lenstr = dso_local global i32 0, align 4
@_ZSt3cin = external dso_local global %"class.std::basic_istream", align 8
@_ZSt4cout = external dso_local global %"class.std::basic_ostream", align 8
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_49_235.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  %1 = call dereferenceable(280) %"class.std::basic_istream"* @_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_(%"class.std::basic_istream"* dereferenceable(280) @_ZSt3cin, i8* getelementptr inbounds ([500 x i8], [500 x i8]* @str, i64 0, i64 0))
  %2 = call i64 @strlen(i8* getelementptr inbounds ([500 x i8], [500 x i8]* @str, i64 0, i64 0)) #6
...
39:                                               ; preds = %19
  ...
  %43 = getelementptr inbounds [500 x i8], [500 x i8]* %5, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_49_235.cpp() #0 section ".text.startup" {
