; ModuleID = 'POJ-104-source/49/49-363.cpp'
source_filename = "POJ-104-source/49/49-363.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_49_363.cpp, i8* null }]
...
define dso_local i32 @_Z5checkPcii(i8* %0, i32 %1, i32 %2) #4 {
...
40:                                               ; preds = %34
  ...
  %44 = call i32 @_Z5checkPcii(i8* %41, i32 %42, i32 %43)
  %45 = icmp ne i32 %44, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_49_363.cpp() #0 section ".text.startup" {
