; ModuleID = 'POJ-104-source/49/49-839.cpp'
source_filename = "POJ-104-source/49/49-839.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_49_839.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5pdjscPc(i8* %0) #0 {
  %2 = alloca i8*, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_49_839.cpp() #0 section ".text.startup" {
