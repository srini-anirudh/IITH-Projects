; ModuleID = 'POJ-104-source/49/49-890.cpp'
source_filename = "POJ-104-source/49/49-890.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_49_890.cpp, i8* null }]
...
33:                                               ; preds = %29
  ...
  call void @_Z1fiiPc(i32 %34, i32 %35, i8* %36)
  br label %37
...
15:                                               ; preds = %9
  ...
  call void @_Z1gPcii(i8* %16, i32 %17, i32 %18)
  br label %19
...
; Function Attrs: noinline uwtable
define dso_local void @_Z1gPcii(i8* %0, i32 %1, i32 %2) #0 {
  %4 = alloca i8*, align 8
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
  %7 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_49_890.cpp() #0 section ".text.startup" {
