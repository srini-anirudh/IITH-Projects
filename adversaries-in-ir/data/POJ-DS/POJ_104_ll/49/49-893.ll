; ModuleID = 'POJ-104-source/49/49-893.cpp'
source_filename = "POJ-104-source/49/49-893.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_49_893.cpp, i8* null }]
...
26:                                               ; preds = %19
  ...
  %32 = call i32 @_Z5judgeiiPc(i32 %27, i32 %30, i8* %31)
...
38:                                               ; preds = %35
  ...
  call void @_Z5printiiPc(i32 %39, i32 %42, i8* %43)
...
52:                                               ; preds = %49
  ...
  call void @_Z5printiiPc(i32 %54, i32 %57, i8* %58)
  br label %59
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z5judgeiiPc(i32 %0, i32 %1, i8* %2) #0 {
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
...
41:                                               ; preds = %27
  ...
  %49 = call i32 @_Z5judgeiiPc(i32 %46, i32 %47, i8* %48)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_49_893.cpp() #0 section ".text.startup" {
