; ModuleID = 'POJ-104-source/5/5-1039.cpp'
source_filename = "POJ-104-source/5/5-1039.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_5_1039.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %9 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), [501 x i8]* %3, [501 x i8]* %4)
...
17:                                               ; preds = %81, %16
  ...
  %20 = getelementptr inbounds [501 x i8], [501 x i8]* %3, i64 0, i64 0
...
118:                                              ; preds = %93
  ...
  %122 = getelementptr inbounds [501 x i8], [501 x i8]* %3, i64 0, i64 0
...
130:                                              ; preds = %118
  ...
  %134 = getelementptr inbounds [501 x i8], [501 x i8]* %3, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_5_1039.cpp() #0 section ".text.startup" {
