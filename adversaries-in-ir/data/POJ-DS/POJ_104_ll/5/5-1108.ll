; ModuleID = 'POJ-104-source/5/5-1108.cpp'
source_filename = "POJ-104-source/5/5-1108.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_5_1108.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %11 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %9, i8* %10)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_5_1108.cpp() #0 section ".text.startup" {
