; ModuleID = 'POJ-104-source/5/5-1109.cpp'
source_filename = "POJ-104-source/5/5-1109.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_5_1109.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %12 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str, i64 0, i64 0), double* %4, i8* %6, i8* %10, i8* %7, i8* %11)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_5_1109.cpp() #0 section ".text.startup" {
