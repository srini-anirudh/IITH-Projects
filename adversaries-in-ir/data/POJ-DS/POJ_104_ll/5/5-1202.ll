; ModuleID = 'POJ-104-source/5/5-1202.cpp'
source_filename = "POJ-104-source/5/5-1202.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_5_1202.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %11 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), double* %9)
  %12 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), [501 x i8]* %2)
  %13 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), [501 x i8]* %3)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_5_1202.cpp() #0 section ".text.startup" {
