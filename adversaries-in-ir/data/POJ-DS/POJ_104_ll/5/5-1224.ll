; ModuleID = 'POJ-104-source/5/5-1224.cpp'
source_filename = "POJ-104-source/5/5-1224.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_5_1224.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %10 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), double* %9)
  %11 = getelementptr inbounds [500 x i8], [500 x i8]* %7, i64 0, i64 0
  %12 = getelementptr inbounds [500 x i8], [500 x i8]* %8, i64 0, i64 0
  %13 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i8* %11, i8* %12)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_5_1224.cpp() #0 section ".text.startup" {
