; ModuleID = 'POJ-104-source/5/5-1233.cpp'
source_filename = "POJ-104-source/5/5-1233.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_5_1233.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %12 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), [1000 x i8]* %9)
  %13 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), [1000 x i8]* %10)
...
14:                                               ; preds = %127, %0
  ...
  %23 = getelementptr inbounds [1000 x i8], [1000 x i8]* %10, i64 0, i64 %22
...
105:                                              ; preds = %98
  %106 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0))
  store i32 0, i32* %1, align 4
  br label %145
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_5_1233.cpp() #0 section ".text.startup" {
