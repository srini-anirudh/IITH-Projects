; ModuleID = 'POJ-104-source/5/5-128.cpp'
source_filename = "POJ-104-source/5/5-128.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_5_128.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %9 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), float* %4)
...
23:                                               ; preds = %16
  ...
  %28 = call i32 @_Z2exc(i8 signext %27)
  ...
  %35 = call i32 @_Z2exc(i8 signext %34)
  ...
  %46 = call i32 @_Z3cmpcc(i8 signext %41, i8 signext %45)
...
define dso_local i32 @_Z2exc(i8 signext %0) #6 {
  %2 = alloca i32, align 4
  %3 = alloca i8, align 1
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z3cmpcc(i8 signext %0, i8 signext %1) #6 {
  %3 = alloca i32, align 4
  %4 = alloca i8, align 1
  %5 = alloca i8, align 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_5_128.cpp() #0 section ".text.startup" {
