; ModuleID = 'POJ-104-source/5/5-184.cpp'
source_filename = "POJ-104-source/5/5-184.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_5_184.cpp, i8* null }]
...
139:                                              ; preds = %138, %24
  %140 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.5, i64 0, i64 0), i32* %13)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_5_184.cpp() #0 section ".text.startup" {
