; ModuleID = 'POJ-104-source/5/5-235.cpp'
source_filename = "POJ-104-source/5/5-235.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_5_235.cpp, i8* null }]
...
33:                                               ; preds = %29
  ...
  %42 = call i32 @_Z7comparecc(i8 signext %37, i8 signext %41)
...
define dso_local i32 @_Z7comparecc(i8 signext %0, i8 signext %1) #6 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_5_235.cpp() #0 section ".text.startup" {
