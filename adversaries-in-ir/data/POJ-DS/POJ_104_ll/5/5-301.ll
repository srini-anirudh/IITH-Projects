; ModuleID = 'POJ-104-source/5/5-301.cpp'
source_filename = "POJ-104-source/5/5-301.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_5_301.cpp, i8* null }]
...
define dso_local i32 @_Z1hPc(i8* %0) #4 {
  %2 = alloca i8*, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_5_301.cpp() #0 section ".text.startup" {
