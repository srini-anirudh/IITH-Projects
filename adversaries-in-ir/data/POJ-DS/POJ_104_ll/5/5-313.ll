; ModuleID = 'POJ-104-source/5/5-313.cpp'
source_filename = "POJ-104-source/5/5-313.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_5_313.cpp, i8* null }]
...
143:                                              ; preds = %141, %139
  %144 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.5, i64 0, i64 0), i32* %6)
  store i32 0, i32* %1, align 4
  br label %145
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_5_313.cpp() #0 section ".text.startup" {
