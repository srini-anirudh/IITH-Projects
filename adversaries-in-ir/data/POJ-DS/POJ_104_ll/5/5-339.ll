; ModuleID = 'POJ-104-source/5/5-339.cpp'
source_filename = "POJ-104-source/5/5-339.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_5_339.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %10 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i64 0, i64 0), double* %5, i8* %8, i8* %9)
...
83:                                               ; preds = %74, %67, %60, %53, %46, %39, %32, %25
...
106:                                              ; preds = %103
  ...
  %110 = getelementptr inbounds [501 x i8], [501 x i8]* %6, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_5_339.cpp() #0 section ".text.startup" {
