; ModuleID = 'POJ-104-source/5/5-419.cpp'
source_filename = "POJ-104-source/5/5-419.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_5_419.cpp, i8* null }]
...
define dso_local i32 @_Z1fcc(i8 signext %0, i8 signext %1) #4 {
...
define dso_local i32 @main() #5 {
  ...
  %14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i8* %13)
...
104:                                              ; preds = %97
  ...
  %113 = call i32 @_Z1fcc(i8 signext %108, i8 signext %112)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_5_419.cpp() #0 section ".text.startup" {
