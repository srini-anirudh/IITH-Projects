; ModuleID = 'POJ-104-source/5/5-517.cpp'
source_filename = "POJ-104-source/5/5-517.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_5_517.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %10 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([501 x i8], [501 x i8]* @a, i64 0, i64 0))
  %11 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([501 x i8], [501 x i8]* @b, i64 0, i64 0))
  %12 = call i64 @strlen(i8* getelementptr inbounds ([501 x i8], [501 x i8]* @a, i64 0, i64 0)) #6
  %13 = trunc i64 %12 to i32
  store i32 %13, i32* %7, align 4
  %14 = call i64 @strlen(i8* getelementptr inbounds ([501 x i8], [501 x i8]* @b, i64 0, i64 0)) #6
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_5_517.cpp() #0 section ".text.startup" {
