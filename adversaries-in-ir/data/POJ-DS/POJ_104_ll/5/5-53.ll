; ModuleID = 'POJ-104-source/5/5-53.cpp'
source_filename = "POJ-104-source/5/5-53.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_5_53.cpp, i8* null }]
...
define dso_local i32 @_Z4atgcc(i8 signext %0) #4 {
...
define dso_local i32 @main() #5 {
  ...
  %13 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i64 0, i64 0), double* %2, i8* %11, i8* %12)
...
30:                                               ; preds = %26
  ...
  %35 = call i32 @_Z4atgcc(i8 signext %34)
  %36 = icmp eq i32 %35, 0
...
37:                                               ; preds = %30
  ...
  %42 = call i32 @_Z4atgcc(i8 signext %41)
  %43 = icmp eq i32 %42, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_5_53.cpp() #0 section ".text.startup" {
