; ModuleID = 'POJ-104-source/5/5-530.cpp'
source_filename = "POJ-104-source/5/5-530.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_5_530.cpp, i8* null }]
...
91:                                               ; preds = %84
  ...
  %94 = getelementptr inbounds [501 x i8], [501 x i8]* %4, i64 0, i64 %93
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_5_530.cpp() #0 section ".text.startup" {
