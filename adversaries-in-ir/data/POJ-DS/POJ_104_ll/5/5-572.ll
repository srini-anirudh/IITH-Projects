; ModuleID = 'POJ-104-source/5/5-572.cpp'
source_filename = "POJ-104-source/5/5-572.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_5_572.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %7 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), double* %6)
...
84:                                               ; preds = %77, %49
  ...
  %87 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* %86)
  store i32 0, i32* %1, align 4
  br label %135
...
132:                                              ; preds = %130, %128
  ...
  %134 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* %133)
  store i32 0, i32* %1, align 4
  br label %135
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_5_572.cpp() #0 section ".text.startup" {
