; ModuleID = 'POJ-104-source/5/5-721.cpp'
source_filename = "POJ-104-source/5/5-721.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_5_721.cpp, i8* null }]
...
44:                                               ; preds = %41, %29
  ...
  %49 = call i32 @_Z5judgec(i8 signext %48)
  %50 = icmp ne i32 %49, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_5_721.cpp() #0 section ".text.startup" {
