; ModuleID = 'POJ-104-source/5/5-820.cpp'
source_filename = "POJ-104-source/5/5-820.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_5_820.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %13 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i64 0, i64 0), double* %5, i8* %11, i8* %12)
...
29:                                               ; preds = %25
  ...
  %34 = call i32 @_Z2ync(i8 signext %33)
  %35 = icmp eq i32 %34, 1
...
46:                                               ; preds = %42
  ...
  %51 = call i32 @_Z2ync(i8 signext %50)
  %52 = icmp eq i32 %51, 1
...
define dso_local i32 @_Z2ync(i8 signext %0) #6 {
  %2 = alloca i8, align 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_5_820.cpp() #0 section ".text.startup" {
