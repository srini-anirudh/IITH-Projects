; ModuleID = 'POJ-104-source/5/5-823.cpp'
source_filename = "POJ-104-source/5/5-823.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_5_823.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), float* %12)
  %17 = getelementptr inbounds [500 x i8], [500 x i8]* %13, i64 0, i64 0
  %18 = getelementptr inbounds [500 x i8], [500 x i8]* %14, i64 0, i64 0
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %17, i8* %18)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_5_823.cpp() #0 section ".text.startup" {
