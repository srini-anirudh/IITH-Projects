; ModuleID = 'POJ-104-source/50/50-1560.cpp'
source_filename = "POJ-104-source/50/50-1560.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_50_1560.cpp, i8* null }]
...
76:                                               ; preds = %73
  %77 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.5, i64 0, i64 0))
...
115:                                              ; preds = %111, %108
  ...
  %117 = icmp eq i32 %116, 316
  br i1 %117, label %118, label %122

118:                                              ; preds = %115
  %119 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.11, i64 0, i64 0))
...
122:                                              ; preds = %118, %115
  ...
  %124 = icmp eq i32 %123, 346
  br i1 %124, label %125, label %129

125:                                              ; preds = %122
  %126 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.12, i64 0, i64 0))
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_50_1560.cpp() #0 section ".text.startup" {
