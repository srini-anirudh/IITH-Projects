; ModuleID = 'POJ-104-source/50/50-1750.cpp'
source_filename = "POJ-104-source/50/50-1750.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_50_1750.cpp, i8* null }]
...
159:                                              ; preds = %147
  %160 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %3)
  store i32 0, i32* %2, align 4
  br label %161
...
194:                                              ; preds = %161
  call void @_Z2dyPiS_(i32* getelementptr inbounds ([365 x i32], [365 x i32]* @jh, i64 0, i64 0), i32* getelementptr inbounds ([365 x i32], [365 x i32]* @xqj, i64 0, i64 0))
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define dso_local void @_Z2dyPiS_(i32* %0, i32* %1) #0 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_50_1750.cpp() #0 section ".text.startup" {
