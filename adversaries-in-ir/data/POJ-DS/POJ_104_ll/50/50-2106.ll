; ModuleID = 'POJ-104-source/50/50-2106.cpp'
source_filename = "POJ-104-source/50/50-2106.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_50_2106.cpp, i8* null }]
...
8:                                                ; preds = %5
  ...
  %11 = call i32 @_Z1fiii(i32 %9, i32 13, i32 %10)
  %12 = icmp ne i32 %11, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_50_2106.cpp() #0 section ".text.startup" {
