; ModuleID = 'POJ-104-source/50/50-2198.cpp'
source_filename = "POJ-104-source/50/50-2198.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_50_2198.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %9, i8* align 16 bitcast ([12 x i32]* @__const.main.num to i8*), i64 48, i1 false)
  %10 = bitcast [12 x i32]* %6 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %10, i8* align 16 bitcast ([12 x i32]* @__const.main.tian to i8*), i64 48, i1 false)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_50_2198.cpp() #0 section ".text.startup" {
