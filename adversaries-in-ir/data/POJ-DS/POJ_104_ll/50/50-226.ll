; ModuleID = 'POJ-104-source/50/50-226.cpp'
source_filename = "POJ-104-source/50/50-226.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_50_226.cpp, i8* null }]
...
17:                                               ; preds = %14
  ...
  %21 = getelementptr inbounds [12 x %struct.mounth], [12 x %struct.mounth]* @M, i64 0, i64 %20
  %22 = getelementptr inbounds %struct.mounth, %struct.mounth* %21, i32 0, i32 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_50_226.cpp() #0 section ".text.startup" {
