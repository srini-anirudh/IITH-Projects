; ModuleID = 'POJ-104-source/50/50-242.cpp'
source_filename = "POJ-104-source/50/50-242.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_50_242.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %9, i8* align 16 bitcast ([12 x i32]* @__const.main.c to i8*), i64 48, i1 false)
...
14:                                               ; preds = %11
  ...
  %21 = getelementptr inbounds [365 x i32], [365 x i32]* %3, i64 0, i64 %20
...
36:                                               ; preds = %26
  %37 = getelementptr inbounds [365 x i32], [365 x i32]* %4, i64 0, i64 12
...
55:                                               ; preds = %76, %54
  ...
  %57 = icmp slt i32 %56, 365
  br i1 %57, label %58, label %79

58:                                               ; preds = %55
  %59 = load i32, i32* %6, align 4
  %60 = sext i32 %59 to i64
  %61 = getelementptr inbounds [365 x i32], [365 x i32]* %3, i64 0, i64 %60
...
64:                                               ; preds = %58
  ...
  %67 = getelementptr inbounds [365 x i32], [365 x i32]* %4, i64 0, i64 %66
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_50_242.cpp() #0 section ".text.startup" {
