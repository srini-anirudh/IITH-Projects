; ModuleID = 'POJ-104-source/50/50-2683.cpp'
source_filename = "POJ-104-source/50/50-2683.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_50_2683.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z8weekdaysi(i32 %0) #0 {
...
8:                                                ; preds = %1
  ...
  %10 = sub nsw i32 %9, 7
  %11 = call i32 @_Z8weekdaysi(i32 %10)
...
83:                                               ; preds = %170, %82
  ...
  %87 = sub nsw i32 %86, 1
  %88 = call i32 @_Z8weekdaysi(i32 %87)
...
100:                                              ; preds = %97
  ...
  %109 = call i32 @_Z8weekdaysi(i32 %108)
...
125:                                              ; preds = %122, %119, %116, %113
  ...
  %134 = call i32 @_Z8weekdaysi(i32 %133)
...
159:                                              ; preds = %156, %153, %150, %147, %144, %141, %138
  ...
  %168 = call i32 @_Z8weekdaysi(i32 %167)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_50_2683.cpp() #0 section ".text.startup" {
