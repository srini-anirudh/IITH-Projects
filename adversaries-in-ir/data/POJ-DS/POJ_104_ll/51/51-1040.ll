; ModuleID = 'POJ-104-source/51/51-1040.cpp'
source_filename = "POJ-104-source/51/51-1040.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_1040.cpp, i8* null }]
...
62:                                               ; preds = %24
  ...
  call void @llvm.memset.p0i8.i64(i8* align 16 %63, i8 0, i64 2000, i1 false)
...
85:                                               ; preds = %81
  ...
  %96 = getelementptr inbounds [500 x [500 x i8]], [500 x [500 x i8]]* %5, i64 0, i64 %95
...
168:                                              ; preds = %164
  ...
  %171 = getelementptr inbounds [500 x i32], [500 x i32]* %8, i64 0, i64 %170
...
178:                                              ; preds = %168
  ...
  %181 = getelementptr inbounds [500 x [500 x i8]], [500 x [500 x i8]]* %5, i64 0, i64 %180
  %182 = getelementptr inbounds [500 x i8], [500 x i8]* %181, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_1040.cpp() #0 section ".text.startup" {
