; ModuleID = 'POJ-104-source/51/51-1073.cpp'
source_filename = "POJ-104-source/51/51-1073.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_1073.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), [502 x i8]* %2)
...
76:                                               ; preds = %69
  ...
  %85 = call i32 @strcmp(i8* %80, i8* %84) #7
  %86 = icmp eq i32 %85, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_1073.cpp() #0 section ".text.startup" {
