; ModuleID = 'POJ-104-source/51/51-112.cpp'
source_filename = "POJ-104-source/51/51-112.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_112.cpp, i8* null }]
...
271:                                              ; preds = %265, %153
  %272 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %5)
  store i32 0, i32* %1, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_112.cpp() #0 section ".text.startup" {
