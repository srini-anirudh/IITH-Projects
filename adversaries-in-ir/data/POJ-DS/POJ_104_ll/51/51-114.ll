; ModuleID = 'POJ-104-source/51/51-114.cpp'
source_filename = "POJ-104-source/51/51-114.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_114.cpp, i8* null }]
...
96:                                               ; preds = %86
  ...
  %105 = call i32 @strcmp(i8* %100, i8* %104) #7
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_114.cpp() #0 section ".text.startup" {
