; ModuleID = 'POJ-104-source/51/51-122.cpp'
source_filename = "POJ-104-source/51/51-122.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_122.cpp, i8* null }]
...
29:                                               ; preds = %25
  ...
  %43 = call i32 @strncmp(i8* %33, i8* %40, i64 %42) #7
  %44 = icmp eq i32 %43, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_122.cpp() #0 section ".text.startup" {
