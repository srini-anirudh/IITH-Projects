; ModuleID = 'POJ-104-source/51/51-128.cpp'
source_filename = "POJ-104-source/51/51-128.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_128.cpp, i8* null }]
...
define dso_local i32 @main() #5 {
  ...
  %11 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %5, i8* %10)
...
121:                                              ; preds = %67
  ...
  %129 = sub i64 %126, %128
  call void @qsort(i8* %123, i64 %129, i64 24, i32 (i8*, i8*)* @_Z3cmpPKvS0_)
...
186:                                              ; preds = %182
  ...
  %197 = call i32 @strcmp(i8* %191, i8* %196) #7
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_128.cpp() #0 section ".text.startup" {
