; ModuleID = 'POJ-104-source/51/51-133.cpp'
source_filename = "POJ-104-source/51/51-133.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_133.cpp, i8* null }]
...
49:                                               ; preds = %29
  ...
  %52 = getelementptr inbounds [500 x [6 x i8]], [500 x [6 x i8]]* %3, i64 0, i64 %51
...
129:                                              ; preds = %124
  ...
  %136 = getelementptr inbounds [500 x [6 x i8]], [500 x [6 x i8]]* %3, i64 0, i64 %135
  %137 = getelementptr inbounds [6 x i8], [6 x i8]* %136, i64 0, i64 0
  %138 = call i32 @strcmp(i8* %133, i8* %137) #7
...
140:                                              ; preds = %129
  ...
  %143 = getelementptr inbounds [500 x [6 x i8]], [500 x [6 x i8]]* %3, i64 0, i64 %142
...
161:                                              ; preds = %157
  ...
  %164 = getelementptr inbounds [500 x i32], [500 x i32]* %10, i64 0, i64 %163
...
196:                                              ; preds = %189
  ...
  %199 = getelementptr inbounds [500 x [6 x i8]], [500 x [6 x i8]]* %3, i64 0, i64 %198
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_133.cpp() #0 section ".text.startup" {
