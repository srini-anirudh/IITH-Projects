; ModuleID = 'POJ-104-source/51/51-158.cpp'
source_filename = "POJ-104-source/51/51-158.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_158.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %5, i8* %15)
...
36:                                               ; preds = %32
  ...
  %39 = getelementptr inbounds [500 x [500 x i8]], [500 x [500 x i8]]* %13, i64 0, i64 %38
  ...
  %49 = getelementptr inbounds [500 x i8], [500 x i8]* %12, i64 0, i64 %48
...
93:                                               ; preds = %89
  ...
  %102 = getelementptr inbounds [500 x [500 x i8]], [500 x [500 x i8]]* %13, i64 0, i64 %101
...
141:                                              ; preds = %137
  ...
  %144 = getelementptr inbounds [500 x [500 x i8]], [500 x [500 x i8]]* %13, i64 0, i64 %143
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_158.cpp() #0 section ".text.startup" {
