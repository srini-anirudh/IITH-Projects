; ModuleID = 'POJ-104-source/51/51-161.cpp'
source_filename = "POJ-104-source/51/51-161.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_161.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5ngramPci(i8* %0, i32 %1) #0 {
  %3 = alloca i8*, align 8
...
55:                                               ; preds = %48
  ...
  %64 = call i32 @strcmp(i8* %59, i8* %63) #7
  %65 = icmp eq i32 %64, 0
...
108:                                              ; preds = %101
  ...
  %117 = call i32 @strcmp(i8* %112, i8* %116) #7
...
define dso_local i32 @main() #6 {
  ...
  %4 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0), i32* %1, i8* %3)
  %5 = getelementptr inbounds [500 x i8], [500 x i8]* %2, i64 0, i64 0
  %6 = load i32, i32* %1, align 4
  call void @_Z5ngramPci(i8* %5, i32 %6)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_161.cpp() #0 section ".text.startup" {
