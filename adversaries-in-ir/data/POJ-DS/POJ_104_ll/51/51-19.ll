; ModuleID = 'POJ-104-source/51/51-19.cpp'
source_filename = "POJ-104-source/51/51-19.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_19.cpp, i8* null }]
...
define dso_local i32 @_Z6recordPA6_cPcPii([6 x i8]* %0, i8* %1, i32* %2, i32 %3) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z9sub_countPcPA6_cPii(i8* %0, [6 x i8]* %1, i32* %2, i32 %3) #4 {
  %5 = alloca i8*, align 8
  %6 = alloca [6 x i8]*, align 8
...
42:                                               ; preds = %24
  ...
  %50 = call i32 @_Z6recordPA6_cPcPii([6 x i8]* %46, i8* %47, i32* %48, i32 %49)
...
define dso_local i32 @main() #6 {
  ...
  %3 = alloca [1000 x [6 x i8]], align 16
  ...
  %10 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %6, i8* %9)
  %11 = getelementptr inbounds [1000 x i8], [1000 x i8]* %2, i64 0, i64 0
  %12 = getelementptr inbounds [1000 x [6 x i8]], [1000 x [6 x i8]]* %3, i64 0, i64 0
  %13 = getelementptr inbounds [1000 x i32], [1000 x i32]* %4, i64 0, i64 0
  %14 = load i32, i32* %6, align 4
  %15 = call i32 @_Z9sub_countPcPA6_cPii(i8* %11, [6 x i8]* %12, i32* %13, i32 %14)
...
60:                                               ; preds = %53
  ...
  %63 = getelementptr inbounds [1000 x [6 x i8]], [1000 x [6 x i8]]* %3, i64 0, i64 %62
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_19.cpp() #0 section ".text.startup" {
