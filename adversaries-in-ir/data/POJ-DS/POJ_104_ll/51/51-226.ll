; ModuleID = 'POJ-104-source/51/51-226.cpp'
source_filename = "POJ-104-source/51/51-226.cpp"
...
@temp = dso_local global %struct.group zeroinitializer, align 4
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [3 x i8] c"%s\00", align 1
@.str.2 = private unnamed_addr constant [3 x i8] c"NO\00", align 1
@.str.3 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
@.str.4 = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_226.cpp, i8* null }]
...
37:                                               ; preds = %11
  %38 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %8)
...
114:                                              ; preds = %110
  ...
  %125 = call i32 @strcmp(i8* %119, i8* %124) #7
...
195:                                              ; preds = %182
  ...
  %203 = getelementptr inbounds [500 x %struct.group], [500 x %struct.group]* @G, i64 0, i64 %202
  %204 = load i32, i32* %6, align 4
  %205 = add nsw i32 %204, 1
  %206 = sext i32 %205 to i64
  %207 = getelementptr inbounds [500 x %struct.group], [500 x %struct.group]* @G, i64 0, i64 %206
  %208 = bitcast %struct.group* %207 to i8*
  %209 = bitcast %struct.group* %203 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_226.cpp() #0 section ".text.startup" {
