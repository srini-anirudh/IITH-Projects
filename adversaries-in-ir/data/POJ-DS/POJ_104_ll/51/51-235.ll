; ModuleID = 'POJ-104-source/51/51-235.cpp'
source_filename = "POJ-104-source/51/51-235.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_235.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %2, i8* %15)
...
67:                                               ; preds = %60
  ...
  %72 = call i32 @strcmp(i8* %69, i8* %71) #6
  %73 = icmp eq i32 %72, 0
...
87:                                               ; preds = %83
  ...
  %94 = call i8* @strcpy(i8* %91, i8* %93) #3
  br label %115
...
99:                                               ; preds = %95
  ...
  %104 = call i32 @strcmp(i8* %101, i8* %103) #6
...
106:                                              ; preds = %99
  ...
  %113 = call i8* @strcpy(i8* %110, i8* %112) #3
  br label %114
...
148:                                              ; preds = %144
  ...
  %153 = call i32 @strcmp(i8* %150, i8* %152) #6
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_235.cpp() #0 section ".text.startup" {
