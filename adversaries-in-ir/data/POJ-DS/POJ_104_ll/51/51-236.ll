; ModuleID = 'POJ-104-source/51/51-236.cpp'
source_filename = "POJ-104-source/51/51-236.cpp"
...
@tmp = dso_local global %struct.word zeroinitializer, align 4
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [3 x i8] c"%s\00", align 1
@.str.2 = private unnamed_addr constant [4 x i8] c"NO\0A\00", align 1
@.str.3 = private unnamed_addr constant [7 x i8] c"%d\0A%s\0A\00", align 1
@.str.4 = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_236.cpp, i8* null }]
...
58:                                               ; preds = %54
  ...
  %65 = call i32 @strcmp(i8* %59, i8* %64) #7
  %66 = icmp eq i32 %65, 0
...
123:                                              ; preds = %110
  ...
  %135 = bitcast %struct.word* %134 to i8*
  %136 = bitcast %struct.word* %131 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_236.cpp() #0 section ".text.startup" {
