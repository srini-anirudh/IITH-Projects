; ModuleID = 'POJ-104-source/51/51-247.cpp'
source_filename = "POJ-104-source/51/51-247.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_247.cpp, i8* null }]
...
67:                                               ; preds = %63
  ...
  %78 = call i32 @strcmp(i8* %72, i8* %77) #7
  %79 = icmp eq i32 %78, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_247.cpp() #0 section ".text.startup" {
