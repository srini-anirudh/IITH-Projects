; ModuleID = 'POJ-104-source/51/51-265.cpp'
source_filename = "POJ-104-source/51/51-265.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_265.cpp, i8* null }]
...
65:                                               ; preds = %59
  ...
  %74 = call i32 @strcmp(i8* %69, i8* %73) #7
  %75 = icmp eq i32 %74, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_265.cpp() #0 section ".text.startup" {
