; ModuleID = 'POJ-104-source/51/51-267.cpp'
source_filename = "POJ-104-source/51/51-267.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_267.cpp, i8* null }]
...
56:                                               ; preds = %35
  ...
  %59 = getelementptr inbounds [500 x [6 x i8]], [500 x [6 x i8]]* %3, i64 0, i64 %58
...
175:                                              ; preds = %168
  ...
  %178 = getelementptr inbounds [500 x [6 x i8]], [500 x [6 x i8]]* %3, i64 0, i64 %177
  %179 = getelementptr inbounds [6 x i8], [6 x i8]* %178, i64 0, i64 0
  %180 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.4, i64 0, i64 0), i8* %179)
  br label %181
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_267.cpp() #0 section ".text.startup" {
