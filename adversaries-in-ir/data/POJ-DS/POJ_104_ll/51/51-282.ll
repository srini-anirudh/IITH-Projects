; ModuleID = 'POJ-104-source/51/51-282.cpp'
source_filename = "POJ-104-source/51/51-282.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_282.cpp, i8* null }]
...
define dso_local i32 @_Z2biPcS_(i8* %0, i8* %1) #4 {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
...
48:                                               ; preds = %31
  ...
  %51 = call i32 @_Z2biPcS_(i8* %49, i8* %50)
  %52 = load i32, i32* %7, align 4
...
141:                                              ; preds = %137
  ...
  %150 = call i32 @strcmp(i8* %145, i8* %149) #8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_282.cpp() #0 section ".text.startup" {
