; ModuleID = 'POJ-104-source/51/51-313.cpp'
source_filename = "POJ-104-source/51/51-313.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_313.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %2, i8* %13)
...
86:                                               ; preds = %79
  ...
  %95 = call i32 @strcmp(i8* %90, i8* %94) #7
  %96 = icmp eq i32 %95, 0
...
151:                                              ; preds = %148
  ...
  %160 = call i32 @strcmp(i8* %155, i8* %159) #7
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_313.cpp() #0 section ".text.startup" {
