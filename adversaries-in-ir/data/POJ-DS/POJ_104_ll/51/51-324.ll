; ModuleID = 'POJ-104-source/51/51-324.cpp'
source_filename = "POJ-104-source/51/51-324.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_324.cpp, i8* null }]
...
161:                                              ; preds = %157
  ...
  %170 = call i32 @strcmp(i8* %165, i8* %169) #7
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_324.cpp() #0 section ".text.startup" {
