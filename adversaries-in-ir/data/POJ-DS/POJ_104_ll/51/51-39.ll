; ModuleID = 'POJ-104-source/51/51-39.cpp'
source_filename = "POJ-104-source/51/51-39.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_39.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %2, i8* %13)
...
68:                                               ; preds = %64
  ...
  %73 = call i32 @strcmp(i8* %72, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0)) #7
  %74 = icmp ne i32 %73, 0
...
94:                                               ; preds = %90
  ...
  %104 = call i32 @strcmp(i8* %99, i8* %103) #7
...
106:                                              ; preds = %94
  ...
  %117 = call i8* @strcpy(i8* %116, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0)) #3
  br label %118
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_39.cpp() #0 section ".text.startup" {
