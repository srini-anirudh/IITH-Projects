; ModuleID = 'POJ-104-source/51/51-394.cpp'
source_filename = "POJ-104-source/51/51-394.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_394.cpp, i8* null }]
...
82:                                               ; preds = %14
  ...
  %91 = call i32 @_Z3maxPii(i32* %83, i32 %90)
...
define dso_local i32 @_Z3maxPii(i32* %0, i32 %1) #7 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_394.cpp() #0 section ".text.startup" {
