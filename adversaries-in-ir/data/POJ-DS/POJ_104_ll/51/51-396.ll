; ModuleID = 'POJ-104-source/51/51-396.cpp'
source_filename = "POJ-104-source/51/51-396.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_396.cpp, i8* null }]
...
153:                                              ; preds = %149
  ...
  %162 = call i32 @strcmp(i8* %157, i8* %161) #7
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_396.cpp() #0 section ".text.startup" {
