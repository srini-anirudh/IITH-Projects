; ModuleID = 'POJ-104-source/51/51-441.cpp'
source_filename = "POJ-104-source/51/51-441.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_441.cpp, i8* null }]
...
define dso_local void @_Z3colPcPA5_cii(i8* %0, [5 x i8]* %1, i32 %2, i32 %3) #4 {
  %5 = alloca i8*, align 8
...
define dso_local i32 @main() #5 {
  ...
  call void @_Z3colPcPA5_cii(i8* %18, [5 x i8]* %19, i32 %20, i32 %21)
...
63:                                               ; preds = %57
  ...
  %72 = call i32 @strcmp(i8* %67, i8* %71) #8
  %73 = icmp ne i32 %72, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_441.cpp() #0 section ".text.startup" {
