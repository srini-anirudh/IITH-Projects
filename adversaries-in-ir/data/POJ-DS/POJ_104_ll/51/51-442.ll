; ModuleID = 'POJ-104-source/51/51-442.cpp'
source_filename = "POJ-104-source/51/51-442.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_442.cpp, i8* null }]
...
89:                                               ; preds = %70
  ...
  %92 = call i32 @strcmp(i8* %90, i8* %91) #7
  %93 = icmp eq i32 %92, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_442.cpp() #0 section ".text.startup" {
