; ModuleID = 'POJ-104-source/51/51-444.cpp'
source_filename = "POJ-104-source/51/51-444.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_444.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %2 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([510 x i8], [510 x i8]* @a, i64 0, i64 0))
  call void @_Z2chPcPA5_c(i8* getelementptr inbounds ([510 x i8], [510 x i8]* @a, i64 0, i64 0), [5 x i8]* getelementptr inbounds ([510 x [5 x i8]], [510 x [5 x i8]]* @b, i64 0, i64 0))
  call void @_Z7comparePA5_c([5 x i8]* getelementptr inbounds ([510 x [5 x i8]], [510 x [5 x i8]]* @b, i64 0, i64 0))
  ret i32 0
}
...
define dso_local void @_Z2chPcPA5_c(i8* %0, [5 x i8]* %1) #5 {
  %3 = alloca i8*, align 8
...
; Function Attrs: noinline uwtable
define dso_local void @_Z7comparePA5_c([5 x i8]* %0) #0 {
  ...
  %9 = call i64 @strlen(i8* getelementptr inbounds ([510 x i8], [510 x i8]* @a, i64 0, i64 0)) #7
...
24:                                               ; preds = %18
  ...
  %35 = call i32 @strcmp(i8* %29, i8* %34) #7
  %36 = icmp eq i32 %35, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_444.cpp() #0 section ".text.startup" {
