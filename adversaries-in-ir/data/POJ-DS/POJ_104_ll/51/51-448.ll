; ModuleID = 'POJ-104-source/51/51-448.cpp'
source_filename = "POJ-104-source/51/51-448.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_448.cpp, i8* null }]
...
117:                                              ; preds = %158, %111
  ...
  %120 = getelementptr inbounds [1000 x i8], [1000 x i8]* %7, i64 0, i64 0
  %121 = call i64 @strlen(i8* %120) #7
  %122 = load i32, i32* %6, align 4
  %123 = sext i32 %122 to i64
  %124 = sub i64 %121, %123
  %125 = icmp ule i64 %119, %124
...
145:                                              ; preds = %138
  ...
  %151 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.4, i64 0, i64 0), i32 %150)
  br label %152
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_448.cpp() #0 section ".text.startup" {
