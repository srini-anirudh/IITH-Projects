; ModuleID = 'POJ-104-source/51/51-469.cpp'
source_filename = "POJ-104-source/51/51-469.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_469.cpp, i8* null }]
...
define dso_local i32 @_Z4savePcPA5_cPii(i8* %0, [5 x i8]* %1, i32* %2, i32 %3) #4 {
  %5 = alloca i8*, align 8
...
20:                                               ; preds = %18
  ...
  %27 = call i32 @strcmp(i8* %21, i8* %26) #8
  %28 = icmp eq i32 %27, 0
...
47:                                               ; preds = %30
  ...
  %52 = call i32 @_Z4savePcPA5_cPii(i8* %48, [5 x i8]* %49, i32* %50, i32 %51)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_469.cpp() #0 section ".text.startup" {
