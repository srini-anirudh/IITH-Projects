; ModuleID = 'POJ-104-source/51/51-495.cpp'
source_filename = "POJ-104-source/51/51-495.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_495.cpp, i8* null }]
...
116:                                              ; preds = %112
  ...
  %125 = call i32 @strcmp(i8* %120, i8* %124) #7
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_495.cpp() #0 section ".text.startup" {
