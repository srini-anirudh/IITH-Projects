; ModuleID = 'POJ-104-source/51/51-521.cpp'
source_filename = "POJ-104-source/51/51-521.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_521.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %10 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* @n)
  %11 = call i32 @getchar()
...
80:                                               ; preds = %74
  ...
  %83 = call i32 @_Z2isii(i32 %81, i32 %82)
  %84 = icmp ne i32 %83, 0
...
define dso_local i32 @_Z2isii(i32 %0, i32 %1) #7 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_521.cpp() #0 section ".text.startup" {
