; ModuleID = 'POJ-104-source/51/51-66.cpp'
source_filename = "POJ-104-source/51/51-66.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_66.cpp, i8* null }]
...
93:                                               ; preds = %86
  ...
  %102 = call i32 @strcmp(i8* %97, i8* %101) #6
...
157:                                              ; preds = %153
  ...
  %160 = getelementptr inbounds [500 x [6 x i8]], [500 x [6 x i8]]* %3, i64 0, i64 %159
  %161 = load i32, i32* %6, align 4
  %162 = sext i32 %161 to i64
  %163 = getelementptr inbounds [6 x i8], [6 x i8]* %160, i64 0, i64 %162
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_66.cpp() #0 section ".text.startup" {
