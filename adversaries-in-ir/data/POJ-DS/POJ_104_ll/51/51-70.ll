; ModuleID = 'POJ-104-source/51/51-70.cpp'
source_filename = "POJ-104-source/51/51-70.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_70.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %33 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* %32)
...
290:                                              ; preds = %287
  ...
  %305 = call i32 @strcmp(i8* %297, i8* %304) #6
...
345:                                              ; preds = %344, %215
  %346 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %29)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_70.cpp() #0 section ".text.startup" {
