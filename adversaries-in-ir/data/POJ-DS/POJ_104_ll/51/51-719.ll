; ModuleID = 'POJ-104-source/51/51-719.cpp'
source_filename = "POJ-104-source/51/51-719.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_719.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %10 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([501 x i8], [501 x i8]* @s, i64 0, i64 0))
  %11 = call i64 @strlen(i8* getelementptr inbounds ([501 x i8], [501 x i8]* @s, i64 0, i64 0)) #6
...
138:                                              ; preds = %128
  ...
  %158 = call i8* @strcpy(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @tem, i64 0, i64 0), i8* %157) #3
  ...
  %172 = call i8* @strcpy(i8* %171, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @tem, i64 0, i64 0)) #3
  br label %173
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_719.cpp() #0 section ".text.startup" {
