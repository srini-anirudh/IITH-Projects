; ModuleID = 'POJ-104-source/51/51-773.cpp'
source_filename = "POJ-104-source/51/51-773.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_773.cpp, i8* null }]
...
179:                                              ; preds = %175
  ...
  %188 = call i32 @strcmp(i8* %183, i8* %187) #7
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_773.cpp() #0 section ".text.startup" {
