; ModuleID = 'POJ-104-source/51/51-802.cpp'
source_filename = "POJ-104-source/51/51-802.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_802.cpp, i8* null }]
...
373:                                              ; preds = %367
  ...
  %386 = call i32 @strcmp(i8* %381, i8* %385) #7
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_802.cpp() #0 section ".text.startup" {
