; ModuleID = 'POJ-104-source/51/51-82.cpp'
source_filename = "POJ-104-source/51/51-82.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_82.cpp, i8* null }]
...
61:                                               ; preds = %57
  ...
  %70 = call i32 @strcmp(i8* %65, i8* %69) #6
  %71 = icmp eq i32 %70, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_82.cpp() #0 section ".text.startup" {
