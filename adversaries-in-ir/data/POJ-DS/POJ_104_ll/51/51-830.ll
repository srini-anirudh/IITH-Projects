; ModuleID = 'POJ-104-source/51/51-830.cpp'
source_filename = "POJ-104-source/51/51-830.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_830.cpp, i8* null }]
...
74:                                               ; preds = %68
  ...
  %85 = call i32 @strcmp(i8* %79, i8* %84) #7
  %86 = icmp eq i32 %85, 0
...
144:                                              ; preds = %140
  ...
  %155 = call i32 @strcmp(i8* %149, i8* %154) #7
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_830.cpp() #0 section ".text.startup" {
