; ModuleID = 'POJ-104-source/51/51-832.cpp'
source_filename = "POJ-104-source/51/51-832.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_832.cpp, i8* null }]
...
105:                                              ; preds = %101
  ...
  %114 = call i32 @strcmp(i8* %109, i8* %113) #7
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_832.cpp() #0 section ".text.startup" {
