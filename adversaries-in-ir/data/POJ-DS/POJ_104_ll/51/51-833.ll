; ModuleID = 'POJ-104-source/51/51-833.cpp'
source_filename = "POJ-104-source/51/51-833.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_833.cpp, i8* null }]
...
76:                                               ; preds = %73
  ...
  %87 = call i32 @strcmp(i8* %81, i8* %86) #7
  %88 = icmp eq i32 %87, 0
...
106:                                              ; preds = %102
  ...
  %117 = call i32 @strcmp(i8* %111, i8* %116) #7
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_833.cpp() #0 section ".text.startup" {
