; ModuleID = 'POJ-104-source/51/51-852.cpp'
source_filename = "POJ-104-source/51/51-852.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_852.cpp, i8* null }]
...
78:                                               ; preds = %72
  ...
  %89 = call i32 @strcmp(i8* %83, i8* %88) #7
  %90 = icmp eq i32 %89, 0
...
134:                                              ; preds = %121
  ...
  %143 = getelementptr inbounds [300 x %struct.abb], [300 x %struct.abb]* %8, i64 0, i64 %142
  %144 = load i32, i32* %4, align 4
  %145 = sext i32 %144 to i64
  %146 = getelementptr inbounds [300 x %struct.abb], [300 x %struct.abb]* %8, i64 0, i64 %145
  %147 = bitcast %struct.abb* %146 to i8*
  %148 = bitcast %struct.abb* %143 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_852.cpp() #0 section ".text.startup" {
