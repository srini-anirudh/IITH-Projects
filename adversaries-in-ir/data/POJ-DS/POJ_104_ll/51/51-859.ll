; ModuleID = 'POJ-104-source/51/51-859.cpp'
source_filename = "POJ-104-source/51/51-859.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_859.cpp, i8* null }]
...
define dso_local void @_Z6bubbleP5chaini(%struct.chain* %0, i32 %1) #4 {
...
33:                                               ; preds = %18
  ...
  %44 = getelementptr inbounds %struct.chain, %struct.chain* %40, i64 %43
  %45 = load %struct.chain*, %struct.chain** %3, align 8
  %46 = load i32, i32* %6, align 4
  %47 = sext i32 %46 to i64
  %48 = getelementptr inbounds %struct.chain, %struct.chain* %45, i64 %47
  %49 = bitcast %struct.chain* %48 to i8*
  %50 = bitcast %struct.chain* %44 to i8*
...
20:                                               ; preds = %9
  %21 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %5)
...
87:                                               ; preds = %78
  ...
  %98 = call i32 @strcmp(i8* %92, i8* %97) #8
  %99 = icmp eq i32 %98, 0
...
115:                                              ; preds = %66
  ...
  call void @_Z6bubbleP5chaini(%struct.chain* %116, i32 %122)
...
155:                                              ; preds = %145
  ...
  %167 = call i32 @strcmp(i8* %160, i8* %166) #8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_859.cpp() #0 section ".text.startup" {
