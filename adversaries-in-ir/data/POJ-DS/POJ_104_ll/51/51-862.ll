; ModuleID = 'POJ-104-source/51/51-862.cpp'
source_filename = "POJ-104-source/51/51-862.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_862.cpp, i8* null }]
...
75:                                               ; preds = %69
  ...
  %84 = call i32 @strcmp(i8* %79, i8* %83) #6
  %85 = icmp eq i32 %84, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_862.cpp() #0 section ".text.startup" {
