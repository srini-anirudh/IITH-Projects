; ModuleID = 'POJ-104-source/51/51-866.cpp'
source_filename = "POJ-104-source/51/51-866.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_866.cpp, i8* null }]
...
69:                                               ; preds = %65
  ...
  %76 = call i32 @strcmp(i8* %70, i8* %75) #7
  %77 = icmp eq i32 %76, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_866.cpp() #0 section ".text.startup" {
