; ModuleID = 'POJ-104-source/51/51-876.cpp'
source_filename = "POJ-104-source/51/51-876.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_876.cpp, i8* null }]
...
71:                                               ; preds = %66
  ...
  %81 = call i32 @strcmp(i8* %75, i8* %80) #7
...
120:                                              ; preds = %116
  ...
  %130 = call i32 @strcmp(i8* %124, i8* %129) #7
...
158:                                              ; preds = %154
  ...
  %168 = call i32 @strcmp(i8* %162, i8* %167) #7
...
205:                                              ; preds = %200
  ...
  %211 = call i8* @_ZSt6strstrPcPKc(i8* %206, i8* %210)
  ...
  %218 = call i8* @_ZSt6strstrPcPKc(i8* %212, i8* %217)
...
220:                                              ; preds = %205
  ...
  %236 = call i8* @strcpy(i8* %230, i8* %235) #3
...
define linkonce_odr dso_local i8* @_ZSt6strstrPcPKc(i8* %0, i8* %1) #6 comdat {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_876.cpp() #0 section ".text.startup" {
