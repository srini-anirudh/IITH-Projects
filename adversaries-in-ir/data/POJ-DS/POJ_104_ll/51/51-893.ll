; ModuleID = 'POJ-104-source/51/51-893.cpp'
source_filename = "POJ-104-source/51/51-893.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_893.cpp, i8* null }]
...
81:                                               ; preds = %75
  ...
  %87 = call i32 @strcmp(i8* %82, i8* %86) #7
  %88 = icmp eq i32 %87, 0
...
126:                                              ; preds = %104
  ...
  %128 = bitcast i8* %127 to <{ i8, i8, i8, [97 x i8] }>*
  %129 = getelementptr inbounds <{ i8, i8, i8, [97 x i8] }>, <{ i8, i8, i8, [97 x i8] }>* %128, i32 0, i32 0
  store i8 65, i8* %129, align 16
  %130 = getelementptr inbounds <{ i8, i8, i8, [97 x i8] }>, <{ i8, i8, i8, [97 x i8] }>* %128, i32 0, i32 1
  store i8 77, i8* %130, align 1
  %131 = getelementptr inbounds <{ i8, i8, i8, [97 x i8] }>, <{ i8, i8, i8, [97 x i8] }>* %128, i32 0, i32 2
...
145:                                              ; preds = %139
  ...
  %151 = call i32 @strcmp(i8* %146, i8* %150) #7
...
175:                                              ; preds = %169
  ...
  %184 = call i32 @strcmp(i8* %179, i8* %183) #7
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_893.cpp() #0 section ".text.startup" {
