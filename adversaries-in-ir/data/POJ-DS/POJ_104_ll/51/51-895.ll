; ModuleID = 'POJ-104-source/51/51-895.cpp'
source_filename = "POJ-104-source/51/51-895.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_895.cpp, i8* null }]
...
98:                                               ; preds = %90
  ...
  %107 = call i32 @strcmp(i8* %102, i8* %106) #7
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_895.cpp() #0 section ".text.startup" {
