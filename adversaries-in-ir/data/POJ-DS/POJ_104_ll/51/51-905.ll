; ModuleID = 'POJ-104-source/51/51-905.cpp'
source_filename = "POJ-104-source/51/51-905.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_905.cpp, i8* null }]
...
81:                                               ; preds = %62
  ...
  %84 = call i32 @strcmp(i8* %82, i8* %83) #7
  %85 = icmp eq i32 %84, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_905.cpp() #0 section ".text.startup" {
