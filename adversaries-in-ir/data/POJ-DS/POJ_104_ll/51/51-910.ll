; ModuleID = 'POJ-104-source/51/51-910.cpp'
source_filename = "POJ-104-source/51/51-910.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_910.cpp, i8* null }]
...
define dso_local i32 @_Z6strcmpPcS_i(i8* %0, i8* %1, i32 %2) #4 {
...
36:                                               ; preds = %30
  ...
  %44 = call i32 @_Z6strcmpPcS_i(i8* %39, i8* %42, i32 %43)
  %45 = icmp eq i32 %44, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_910.cpp() #0 section ".text.startup" {
