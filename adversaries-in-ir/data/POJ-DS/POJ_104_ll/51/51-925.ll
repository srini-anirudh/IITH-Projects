; ModuleID = 'POJ-104-source/51/51-925.cpp'
source_filename = "POJ-104-source/51/51-925.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_925.cpp, i8* null }]
...
147:                                              ; preds = %143
  ...
  %156 = call i32 @strcmp(i8* %151, i8* %155) #7
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_925.cpp() #0 section ".text.startup" {
