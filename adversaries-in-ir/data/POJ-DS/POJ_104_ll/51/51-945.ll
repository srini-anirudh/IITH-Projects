; ModuleID = 'POJ-104-source/51/51-945.cpp'
source_filename = "POJ-104-source/51/51-945.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_945.cpp, i8* null }]
...
93:                                               ; preds = %86
  ...
  %106 = call i32 @strcmp(i8* %99, i8* %105) #7
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_945.cpp() #0 section ".text.startup" {
