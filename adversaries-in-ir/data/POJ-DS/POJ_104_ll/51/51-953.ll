; ModuleID = 'POJ-104-source/51/51-953.cpp'
source_filename = "POJ-104-source/51/51-953.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_953.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %18 = getelementptr inbounds [500 x [5 x i8]], [500 x [5 x i8]]* %3, i64 0, i64 0
...
40:                                               ; preds = %33
  ...
  call void @_Z5chuanPA5_cPci([5 x i8]* %41, i8* %42, i32 %43)
  br label %44
...
67:                                               ; preds = %63
  ...
  %76 = call i32 @strcmp(i8* %71, i8* %75) #8
  %77 = icmp eq i32 %76, 0
...
133:                                              ; preds = %126
  ...
  %138 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.4, i64 0, i64 0), i8* %137)
  br label %139
...
define dso_local void @_Z5chuanPA5_cPci([5 x i8]* %0, i8* %1, i32 %2) #6 {
  %4 = alloca [5 x i8]*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca i32, align 4
  %7 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_953.cpp() #0 section ".text.startup" {
