; ModuleID = 'POJ-104-source/51/51-962.cpp'
source_filename = "POJ-104-source/51/51-962.cpp"
...
@tm = dso_local global i32 0, align 4
@tn = dso_local global i32 0, align 4
@tt = dso_local global i32 0, align 4
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_962.cpp, i8* null }]
...
define dso_local i32 @_Z2stii(i32 %0, i32 %1) #4 {
...
define dso_local i32 @main() #5 {
  ...
  %2 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* @n, i8* getelementptr inbounds ([1000 x i8], [1000 x i8]* @c, i64 0, i64 0))
  %3 = call i64 @strlen(i8* getelementptr inbounds ([1000 x i8], [1000 x i8]* @c, i64 0, i64 0)) #7
...
19:                                               ; preds = %13
  ...
  %22 = call i32 @_Z2stii(i32 %20, i32 %21)
  %23 = icmp ne i32 %22, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_962.cpp() #0 section ".text.startup" {
