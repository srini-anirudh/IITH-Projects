; ModuleID = 'POJ-104-source/51/51-964.cpp'
source_filename = "POJ-104-source/51/51-964.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_964.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %12 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %4, i8* %11)
...
77:                                               ; preds = %70
  ...
  %86 = call i32 @strcmp(i8* %81, i8* %85) #6
  %87 = icmp eq i32 %86, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_964.cpp() #0 section ".text.startup" {
