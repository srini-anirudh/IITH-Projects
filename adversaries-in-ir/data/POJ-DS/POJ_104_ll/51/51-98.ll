; ModuleID = 'POJ-104-source/51/51-98.cpp'
source_filename = "POJ-104-source/51/51-98.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_98.cpp, i8* null }]
...
91:                                               ; preds = %84
  ...
  %100 = call i32 @strcmp(i8* %95, i8* %99) #7
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_98.cpp() #0 section ".text.startup" {
