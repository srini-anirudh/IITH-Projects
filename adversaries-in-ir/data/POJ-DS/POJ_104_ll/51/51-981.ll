; ModuleID = 'POJ-104-source/51/51-981.cpp'
source_filename = "POJ-104-source/51/51-981.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_981.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @llvm.memset.p0i8.i64(i8* align 1 %22, i8 0, i64 6, i1 false)
...
41:                                               ; preds = %37
  ...
  %50 = getelementptr inbounds [6 x i8], [6 x i8]* %8, i64 0, i64 %49
...
88:                                               ; preds = %71
  %89 = getelementptr inbounds [6 x i8], [6 x i8]* %8, i64 0, i64 0
  %90 = getelementptr inbounds [6 x i8], [6 x i8]* %9, i64 0, i64 0
  %91 = call i32 @strcmp(i8* %89, i8* %90) #8
  %92 = icmp eq i32 %91, 0
...
120:                                              ; preds = %113
  ...
  %124 = call dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* dereferenceable(4) %12, i32* dereferenceable(4) %123)
...
159:                                              ; preds = %155
  ...
  %164 = getelementptr inbounds [501 x i8], [501 x i8]* %5, i64 0, i64 %163
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_981.cpp() #0 section ".text.startup" {
