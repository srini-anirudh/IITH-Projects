; ModuleID = 'POJ-104-source/51/51-997.cpp'
source_filename = "POJ-104-source/51/51-997.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_51_997.cpp, i8* null }]
...
56:                                               ; preds = %21
  %57 = bitcast [500 x i32]* %9 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 16 %57, i8 0, i64 2000, i1 false)
  store i32 0, i32* %5, align 4
  br label %58
...
117:                                              ; preds = %58
  %118 = getelementptr inbounds [500 x i32], [500 x i32]* %9, i64 0, i64 0
...
145:                                              ; preds = %142
  %146 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0))
...
168:                                              ; preds = %161
  ...
  %171 = getelementptr inbounds [500 x [5 x i8]], [500 x [5 x i8]]* %3, i64 0, i64 %170
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_51_997.cpp() #0 section ".text.startup" {
