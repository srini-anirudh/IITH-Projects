; ModuleID = 'POJ-104-source/52/52-1167.cpp'
source_filename = "POJ-104-source/52/52-1167.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_52_1167.cpp, i8* null }]
...
55:                                               ; preds = %38
  ...
  %61 = getelementptr inbounds [200 x i32], [200 x i32]* %5, i64 0, i64 99
...
75:                                               ; preds = %62
  %76 = getelementptr inbounds [200 x i32], [200 x i32]* %5, i64 0, i64 99
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_52_1167.cpp() #0 section ".text.startup" {
