; ModuleID = 'POJ-104-source/52/52-1210.cpp'
source_filename = "POJ-104-source/52/52-1210.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_52_1210.cpp, i8* null }]
...
19:                                               ; preds = %7
  ...
  call void @_Z1fPiii(i32* %20, i32 %21, i32 %22)
  store i32 0, i32* %5, align 4
  br label %23
...
40:                                               ; preds = %33
  ...
  call void @_Z1fPiii(i32* %41, i32 %42, i32 %43)
  br label %44
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_52_1210.cpp() #0 section ".text.startup" {
