; ModuleID = 'POJ-104-source/52/52-1224.cpp'
source_filename = "POJ-104-source/52/52-1224.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_52_1224.cpp, i8* null }]
...
47:                                               ; preds = %22
  %48 = getelementptr inbounds [200 x i32], [200 x i32]* %2, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_52_1224.cpp() #0 section ".text.startup" {
