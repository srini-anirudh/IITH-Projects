; ModuleID = 'POJ-104-source/52/52-1289.cpp'
source_filename = "POJ-104-source/52/52-1289.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_52_1289.cpp, i8* null }]
...
18:                                               ; preds = %0
  %19 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0))
  br label %20
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_52_1289.cpp() #0 section ".text.startup" {
