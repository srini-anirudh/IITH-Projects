; ModuleID = 'POJ-104-source/52/52-1584.cpp'
source_filename = "POJ-104-source/52/52-1584.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_52_1584.cpp, i8* null }]
...
13:                                               ; preds = %9
  ...
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %14)
  br label %17
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_52_1584.cpp() #0 section ".text.startup" {
