; ModuleID = 'POJ-104-source/52/52-1598.cpp'
source_filename = "POJ-104-source/52/52-1598.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_52_1598.cpp, i8* null }]
...
define dso_local void @_Z3yidPiii(i32* %0, i32 %1, i32 %2) #4 {
...
20:                                               ; preds = %8
  ...
  call void @_Z3yidPiii(i32* %22, i32 %23, i32 %24)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_52_1598.cpp() #0 section ".text.startup" {
