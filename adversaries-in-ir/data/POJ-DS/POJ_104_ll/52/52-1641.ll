; ModuleID = 'POJ-104-source/52/52-1641.cpp'
source_filename = "POJ-104-source/52/52-1641.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_52_1641.cpp, i8* null }]
...
21:                                               ; preds = %8
  ...
  call void @_Z1fPiii(i32* %22, i32 %23, i32 %24)
...
define dso_local void @_Z1fPiii(i32* %0, i32 %1, i32 %2) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_52_1641.cpp() #0 section ".text.startup" {
