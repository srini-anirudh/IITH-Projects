; ModuleID = 'POJ-104-source/52/52-1799.cpp'
source_filename = "POJ-104-source/52/52-1799.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_52_1799.cpp, i8* null }]
...
define dso_local void @_Z4movePiS_ii(i32* %0, i32* %1, i32 %2, i32 %3) #4 {
...
define dso_local i32 @main() #5 {
  ...
  %7 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %3, i32* %2)
...
20:                                               ; preds = %8
  ...
  call void @_Z4movePiS_ii(i32* %22, i32* %23, i32 %24, i32 %25)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_52_1799.cpp() #0 section ".text.startup" {
