; ModuleID = 'POJ-104-source/52/52-1840.cpp'
source_filename = "POJ-104-source/52/52-1840.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_52_1840.cpp, i8* null }]
...
21:                                               ; preds = %9
  ...
  call void @_Z4swapPiii(i32* %22, i32 %23, i32 %24)
  store i32 0, i32* %3, align 4
  br label %25
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_52_1840.cpp() #0 section ".text.startup" {
