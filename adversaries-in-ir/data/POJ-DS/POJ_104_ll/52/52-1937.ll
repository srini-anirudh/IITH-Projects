; ModuleID = 'POJ-104-source/52/52-1937.cpp'
source_filename = "POJ-104-source/52/52-1937.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_52_1937.cpp, i8* null }]
...
20:                                               ; preds = %8
  ...
  call void @_Z6changePiii(i32* %22, i32 %23, i32 %24)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_52_1937.cpp() #0 section ".text.startup" {
