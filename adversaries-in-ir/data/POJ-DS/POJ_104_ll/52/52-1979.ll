; ModuleID = 'POJ-104-source/52/52-1979.cpp'
source_filename = "POJ-104-source/52/52-1979.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_52_1979.cpp, i8* null }]
...
68:                                               ; preds = %64
  ...
  %76 = getelementptr inbounds [201 x i32], [201 x i32]* %6, i64 0, i64 %75
...
80:                                               ; preds = %64
  %81 = getelementptr inbounds [201 x i32], [201 x i32]* %6, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_52_1979.cpp() #0 section ".text.startup" {
