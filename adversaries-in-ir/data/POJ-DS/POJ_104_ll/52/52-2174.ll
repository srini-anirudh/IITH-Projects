; ModuleID = 'POJ-104-source/52/52-2174.cpp'
source_filename = "POJ-104-source/52/52-2174.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_52_2174.cpp, i8* null }]
...
define dso_local void @_Z4MovePii(i32* %0, i32 %1) #4 {
...
25:                                               ; preds = %21
  %26 = getelementptr inbounds [101 x i32], [101 x i32]* %4, i64 0, i64 0
  %27 = load i32, i32* %3, align 4
  call void @_Z4MovePii(i32* %26, i32 %27)
  br label %28
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_52_2174.cpp() #0 section ".text.startup" {
