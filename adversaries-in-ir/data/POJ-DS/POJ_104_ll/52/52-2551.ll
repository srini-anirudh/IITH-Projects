; ModuleID = 'POJ-104-source/52/52-2551.cpp'
source_filename = "POJ-104-source/52/52-2551.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_52_2551.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %6 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32* %3, i32* %2)
...
11:                                               ; preds = %7
  ...
  %15 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i32* %14)
  br label %16
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_52_2551.cpp() #0 section ".text.startup" {
