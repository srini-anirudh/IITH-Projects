; ModuleID = 'POJ-104-source/52/52-304.cpp'
source_filename = "POJ-104-source/52/52-304.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_52_304.cpp, i8* null }]
...
18:                                               ; preds = %6
  ...
  call void @_Z1fPiii(i32* %19, i32 %20, i32 %21)
  store i32* getelementptr inbounds ([100 x i32], [100 x i32]* @a, i64 0, i64 0), i32** %2, align 8
  br label %22
...
; Function Attrs: noinline uwtable
define dso_local void @_Z1fPiii(i32* %0, i32 %1, i32 %2) #0 {
...
33:                                               ; preds = %26
  ...
  call void @_Z1fPiii(i32* %34, i32 %35, i32 %36)
  br label %37
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_52_304.cpp() #0 section ".text.startup" {
