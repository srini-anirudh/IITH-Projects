; ModuleID = 'POJ-104-source/52/52-3674.cpp'
source_filename = "POJ-104-source/52/52-3674.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_52_3674.cpp, i8* null }]
...
define dso_local i32 @main() #5 {
  ...
  store %struct.Node* null, %struct.Node** %4, align 8
  %5 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), i32* %3, i32* %2)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_52_3674.cpp() #0 section ".text.startup" {
