; ModuleID = 'POJ-104-source/52/52-3719.cpp'
source_filename = "POJ-104-source/52/52-3719.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_52_3719.cpp, i8* null }]
...
define dso_local %struct.Node* @_Z6createv() #4 {
...
; Function Attrs: noinline uwtable
define dso_local void @_Z4sortP4Nodei(%struct.Node* %0, i32 %1) #0 {
...
; Function Attrs: noinline uwtable
define dso_local void @_Z10outputdataP4Node(%struct.Node* %0) #0 {
...
; Function Attrs: noinline uwtable
define dso_local %struct.Node* @_Z9inputdatai(i32 %0) #0 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z3delP4Nodei(%struct.Node* %0, i32 %1) #4 {
  %3 = alloca %struct.Node*, align 8
  %4 = alloca i32, align 4
  %5 = alloca %struct.Node*, align 8
  store %struct.Node* %0, %struct.Node** %3, align 8
...
; Function Attrs: noinline uwtable
define dso_local %struct.Node* @_Z10rinputdatai(i32 %0) #0 {
  %2 = alloca i32, align 4
  %3 = alloca %struct.Node*, align 8
  %4 = alloca %struct.Node*, align 8
  %5 = alloca %struct.Node*, align 8
...
; Function Attrs: noinline uwtable
define dso_local void @_Z7outputkP4Nodei(%struct.Node* %0, i32 %1) #0 {
  %3 = alloca %struct.Node*, align 8
  %4 = alloca i32, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z6changeP4Nodeii(%struct.Node* %0, i32 %1, i32 %2) #4 {
  %4 = alloca %struct.Node*, align 8
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5foundP4Nodei(%struct.Node* %0, i32 %1) #0 {
  %3 = alloca %struct.Node*, align 8
  %4 = alloca i32, align 4
  %5 = alloca %struct.Node*, align 8
  %6 = alloca i32, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local %struct.Node* @_Z7arrangeP4Node(%struct.Node* %0) #4 {
  %2 = alloca %struct.Node*, align 8
  %3 = alloca %struct.Node*, align 8
  %4 = alloca %struct.Node*, align 8
  %5 = alloca %struct.Node*, align 8
  ...
  store %struct.Node* null, %struct.Node** %8, align 8
  store %struct.Node* null, %struct.Node** %9, align 8
  %10 = call %struct.Node* @_Z6createv()
...
define dso_local i32 @main() #5 {
  ...
  store %struct.Node* null, %struct.Node** %4, align 8
  %5 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.4, i64 0, i64 0), i32* %3, i32* %2)
  %6 = load i32, i32* %3, align 4
  %7 = call %struct.Node* @_Z9inputdatai(i32 %6)
  store %struct.Node* %7, %struct.Node** %4, align 8
  %8 = load %struct.Node*, %struct.Node** %4, align 8
  %9 = load i32, i32* %3, align 4
  %10 = load i32, i32* %2, align 4
  call void @_Z6changeP4Nodeii(%struct.Node* %8, i32 %9, i32 %10)
  %11 = load %struct.Node*, %struct.Node** %4, align 8
  call void @_Z10outputdataP4Node(%struct.Node* %11)
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_52_3719.cpp() #0 section ".text.startup" {
