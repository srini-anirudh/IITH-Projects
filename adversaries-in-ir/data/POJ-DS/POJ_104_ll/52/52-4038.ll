; ModuleID = 'POJ-104-source/52/52-4038.cpp'
source_filename = "POJ-104-source/52/52-4038.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_52_4038.cpp, i8* null }]
...
25:                                               ; preds = %21
  ...
  call void @_Z7convertiPi(i32 %26, i32* %27)
  br label %28
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_52_4038.cpp() #0 section ".text.startup" {
