; ModuleID = 'POJ-104-source/52/52-4082.cpp'
source_filename = "POJ-104-source/52/52-4082.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_52_4082.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5rangeiiPi(i32 %0, i32 %1, i32* %2) #0 {
...
13:                                               ; preds = %3
  ...
  call void @_Z5rangeiiPi(i32 %16, i32 %17, i32* %18)
...
21:                                               ; preds = %9
  ...
  call void @_Z5rangeiiPi(i32 %22, i32 %23, i32* %24)
  store i32 0, i32* %6, align 4
  br label %25
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_52_4082.cpp() #0 section ".text.startup" {
