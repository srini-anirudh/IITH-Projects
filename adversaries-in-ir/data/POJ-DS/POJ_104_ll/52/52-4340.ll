; ModuleID = 'POJ-104-source/52/52-4340.cpp'
source_filename = "POJ-104-source/52/52-4340.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_52_4340.cpp, i8* null }]
...
51:                                               ; preds = %47
  ...
  %62 = select i1 %60, i8 10, i8 32
  %63 = sext i8 %62 to i32
  %64 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), i32 %56, i32 %63)
  br label %65
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_52_4340.cpp() #0 section ".text.startup" {
