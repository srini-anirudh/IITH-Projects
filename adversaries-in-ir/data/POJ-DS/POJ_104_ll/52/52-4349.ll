; ModuleID = 'POJ-104-source/52/52-4349.cpp'
source_filename = "POJ-104-source/52/52-4349.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_52_4349.cpp, i8* null }]
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z6circlePii(i32* %0, i32 %1) #4 {
...
10:                                               ; preds = %6
  ...
  call void @_Z4swapPiii(i32* %11, i32 0, i32 %12)
  br label %13
...
24:                                               ; preds = %20
  ...
  call void @_Z6circlePii(i32* %25, i32 %26)
  br label %27
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_52_4349.cpp() #0 section ".text.startup" {
