; ModuleID = 'POJ-104-source/52/52-4359.cpp'
source_filename = "POJ-104-source/52/52-4359.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_52_4359.cpp, i8* null }]
...
define dso_local void @_Z4moveiPi(i32 %0, i32* %1) #5 {
  %3 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_52_4359.cpp() #0 section ".text.startup" {
