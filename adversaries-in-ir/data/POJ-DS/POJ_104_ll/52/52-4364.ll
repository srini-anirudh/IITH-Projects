; ModuleID = 'POJ-104-source/52/52-4364.cpp'
source_filename = "POJ-104-source/52/52-4364.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_52_4364.cpp, i8* null }]
...
26:                                               ; preds = %20
  ...
  call void @_Z4loopPii(i32* %27, i32 %28)
  br label %29
...
define dso_local void @_Z4loopPii(i32* %0, i32 %1) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_52_4364.cpp() #0 section ".text.startup" {
