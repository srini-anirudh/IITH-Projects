; ModuleID = 'POJ-104-source/52/52-4371.cpp'
source_filename = "POJ-104-source/52/52-4371.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_52_4371.cpp, i8* null }]
...
19:                                               ; preds = %7
  ...
  call void @_Z5orderiiPi(i32 %20, i32 %21, i32* %22)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5orderiiPi(i32 %0, i32 %1, i32* %2) #0 {
  %4 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_52_4371.cpp() #0 section ".text.startup" {
