; ModuleID = 'POJ-104-source/52/52-4399.cpp'
source_filename = "POJ-104-source/52/52-4399.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_52_4399.cpp, i8* null }]
...
73:                                               ; preds = %69
  ...
  %83 = select i1 %81, i8 10, i8 32
  %84 = sext i8 %83 to i32
  %85 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), i32 %77, i32 %84)
  br label %86
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_52_4399.cpp() #0 section ".text.startup" {
