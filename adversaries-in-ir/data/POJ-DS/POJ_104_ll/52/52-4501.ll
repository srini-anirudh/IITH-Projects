; ModuleID = 'POJ-104-source/52/52-4501.cpp'
source_filename = "POJ-104-source/52/52-4501.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_52_4501.cpp, i8* null }]
...
88:                                               ; preds = %84
  ...
  %99 = select i1 %97, i8 10, i8 32
  %100 = sext i8 %99 to i32
  %101 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), i32 %93, i32 %100)
  br label %102
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_52_4501.cpp() #0 section ".text.startup" {
