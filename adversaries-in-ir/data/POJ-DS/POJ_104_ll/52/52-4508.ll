; ModuleID = 'POJ-104-source/52/52-4508.cpp'
source_filename = "POJ-104-source/52/52-4508.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_52_4508.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %6 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %2, i32* %4)
...
20:                                               ; preds = %7
  ...
  %24 = call i32 @_Z3paiPiii(i32* %21, i32 %22, i32 %23)
  store i32 0, i32* %3, align 4
  br label %25
...
define dso_local i32 @_Z3paiPiii(i32* %0, i32 %1, i32 %2) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_52_4508.cpp() #0 section ".text.startup" {
