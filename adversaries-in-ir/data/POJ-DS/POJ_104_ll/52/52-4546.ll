; ModuleID = 'POJ-104-source/52/52-4546.cpp'
source_filename = "POJ-104-source/52/52-4546.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_52_4546.cpp, i8* null }]
...
22:                                               ; preds = %9
  ...
  call void @_Z4movePiii(i32* %23, i32 %24, i32 %25)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_52_4546.cpp() #0 section ".text.startup" {
