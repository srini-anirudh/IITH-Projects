; ModuleID = 'POJ-104-source/52/52-4689.cpp'
source_filename = "POJ-104-source/52/52-4689.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_52_4689.cpp, i8* null }]
...
20:                                               ; preds = %8
  ...
  call void @_Z6changeiiPi(i32 %21, i32 %22, i32* %23)
  store i32 0, i32* %4, align 4
  br label %24
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_52_4689.cpp() #0 section ".text.startup" {
