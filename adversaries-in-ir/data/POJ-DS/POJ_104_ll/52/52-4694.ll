; ModuleID = 'POJ-104-source/52/52-4694.cpp'
source_filename = "POJ-104-source/52/52-4694.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_52_4694.cpp, i8* null }]
...
14:                                               ; preds = %10
  ...
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i32* %15)
  br label %17
...
22:                                               ; preds = %10
  ...
  call void @_Z6changePiii(i32* %24, i32 %25, i32 %26)
...
; Function Attrs: noinline uwtable
define dso_local void @_Z6changePiii(i32* %0, i32 %1, i32 %2) #0 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_52_4694.cpp() #0 section ".text.startup" {
