; ModuleID = 'POJ-104-source/52/52-4740.cpp'
source_filename = "POJ-104-source/52/52-4740.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_52_4740.cpp, i8* null }]
...
define dso_local i32 @_Z4movePii(i32* %0, i32 %1) #4 {
...
26:                                               ; preds = %22
  ...
  %29 = call i32 @_Z4movePii(i32* %27, i32 %28)
  br label %22
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_52_4740.cpp() #0 section ".text.startup" {
