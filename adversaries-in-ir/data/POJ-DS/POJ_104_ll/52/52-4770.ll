; ModuleID = 'POJ-104-source/52/52-4770.cpp'
source_filename = "POJ-104-source/52/52-4770.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_52_4770.cpp, i8* null }]
...
30:                                               ; preds = %26
  %31 = getelementptr inbounds [101 x i32], [101 x i32]* %10, i64 0, i64 0
...
50:                                               ; preds = %33
  ...
  %55 = getelementptr inbounds [101 x i32], [101 x i32]* %10, i64 0, i64 %54
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_52_4770.cpp() #0 section ".text.startup" {
