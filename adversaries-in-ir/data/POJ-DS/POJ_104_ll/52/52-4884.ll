; ModuleID = 'POJ-104-source/52/52-4884.cpp'
source_filename = "POJ-104-source/52/52-4884.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_52_4884.cpp, i8* null }]
...
20:                                               ; preds = %7
  ...
  call void @_Z2dePiii(i32* %21, i32 %22, i32 %23)
...
define dso_local void @_Z2dePiii(i32* %0, i32 %1, i32 %2) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_52_4884.cpp() #0 section ".text.startup" {
