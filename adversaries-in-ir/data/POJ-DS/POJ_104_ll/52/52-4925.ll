; ModuleID = 'POJ-104-source/52/52-4925.cpp'
source_filename = "POJ-104-source/52/52-4925.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_52_4925.cpp, i8* null }]
...
30:                                               ; preds = %27
  ...
  call void @_Z4swapPii(i32* %31, i32 %32)
  br label %33
...
define dso_local void @_Z4swapPii(i32* %0, i32 %1) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_52_4925.cpp() #0 section ".text.startup" {
