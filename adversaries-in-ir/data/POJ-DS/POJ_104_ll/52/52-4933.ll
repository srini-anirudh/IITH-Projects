; ModuleID = 'POJ-104-source/52/52-4933.cpp'
source_filename = "POJ-104-source/52/52-4933.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_52_4933.cpp, i8* null }]
...
29:                                               ; preds = %24
  ...
  %43 = call i32 @_Z1fiii(i32 %40, i32 %41, i32 %42)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_52_4933.cpp() #0 section ".text.startup" {
