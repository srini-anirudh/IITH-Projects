; ModuleID = 'POJ-104-source/52/52-4983.cpp'
source_filename = "POJ-104-source/52/52-4983.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_52_4983.cpp, i8* null }]
...
23:                                               ; preds = %10
  ...
  call void @_Z3prtPiii(i32* %24, i32 %25, i32 %26)
  store i32 0, i32* %5, align 4
  br label %27
...
define dso_local void @_Z3prtPiii(i32* %0, i32 %1, i32 %2) #6 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_52_4983.cpp() #0 section ".text.startup" {
