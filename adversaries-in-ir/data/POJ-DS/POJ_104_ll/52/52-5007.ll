; ModuleID = 'POJ-104-source/52/52-5007.cpp'
source_filename = "POJ-104-source/52/52-5007.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_52_5007.cpp, i8* null }]
...
define dso_local void @_Z1fPiii(i32* %0, i32 %1, i32 %2) #4 {
...
21:                                               ; preds = %9
  ...
  call void @_Z1fPiii(i32* %23, i32 %24, i32 %25)
  store i32 0, i32* %6, align 4
  br label %26
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_52_5007.cpp() #0 section ".text.startup" {
