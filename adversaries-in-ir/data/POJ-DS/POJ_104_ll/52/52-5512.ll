; ModuleID = 'POJ-104-source/52/52-5512.cpp'
source_filename = "POJ-104-source/52/52-5512.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_52_5512.cpp, i8* null }]
...
define dso_local void @_Z6yidongPii(i32* %0, i32 %1) #4 {
...
26:                                               ; preds = %22
  ...
  call void @_Z6yidongPii(i32* %27, i32 %28)
  br label %29
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_52_5512.cpp() #0 section ".text.startup" {
