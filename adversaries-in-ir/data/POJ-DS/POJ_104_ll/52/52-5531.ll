; ModuleID = 'POJ-104-source/52/52-5531.cpp'
source_filename = "POJ-104-source/52/52-5531.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_52_5531.cpp, i8* null }]
...
define dso_local void @_Z7lunhuanPiii(i32* %0, i32 %1, i32 %2) #4 {
...
20:                                               ; preds = %7
  ...
  call void @_Z7lunhuanPiii(i32* %21, i32 %22, i32 %23)
  store i32 0, i32* %5, align 4
  br label %24
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_52_5531.cpp() #0 section ".text.startup" {
