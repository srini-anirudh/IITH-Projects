; ModuleID = 'POJ-104-source/52/52-5561.cpp'
source_filename = "POJ-104-source/52/52-5561.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_52_5561.cpp, i8* null }]
...
25:                                               ; preds = %21
  ...
  call void @_Z2pxiPi(i32 %27, i32* %28)
  br label %29
...
define dso_local void @_Z2pxiPi(i32 %0, i32* %1) #5 {
  %3 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_52_5561.cpp() #0 section ".text.startup" {
