; ModuleID = 'POJ-104-source/52/52-5568.cpp'
source_filename = "POJ-104-source/52/52-5568.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_52_5568.cpp, i8* null }]
...
24:                                               ; preds = %20
  ...
  call void @_Z4playPii(i32* %25, i32 %26)
  br label %27
...
define dso_local void @_Z4playPii(i32* %0, i32 %1) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_52_5568.cpp() #0 section ".text.startup" {
