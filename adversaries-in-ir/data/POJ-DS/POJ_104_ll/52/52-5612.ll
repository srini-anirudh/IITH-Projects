; ModuleID = 'POJ-104-source/52/52-5612.cpp'
source_filename = "POJ-104-source/52/52-5612.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_52_5612.cpp, i8* null }]
...
define dso_local i32 @_Z7arrangePiii(i32* %0, i32 %1, i32 %2) #4 {
...
define dso_local i32 @main() #5 {
  ...
  %6 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32* %2, i32* %3)
...
19:                                               ; preds = %7
  ...
  %23 = call i32 @_Z7arrangePiii(i32* %20, i32 %21, i32 %22)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_52_5612.cpp() #0 section ".text.startup" {
