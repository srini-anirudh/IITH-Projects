; ModuleID = 'POJ-104-source/52/52-5668.cpp'
source_filename = "POJ-104-source/52/52-5668.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_52_5668.cpp, i8* null }]
...
define dso_local void @_Z4swapiiPi(i32 %0, i32 %1, i32* %2) #4 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_52_5668.cpp() #0 section ".text.startup" {
