; ModuleID = 'POJ-104-source/52/52-5703.cpp'
source_filename = "POJ-104-source/52/52-5703.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_52_5703.cpp, i8* null }]
...
define dso_local void @_Z8jiaohuanPiiii(i32* %0, i32 %1, i32 %2, i32 %3) #4 {
...
26:                                               ; preds = %21
  ...
  call void @_Z8jiaohuanPiiii(i32* %27, i32 %28, i32 %29, i32 %30)
  br label %31
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_52_5703.cpp() #0 section ".text.startup" {
