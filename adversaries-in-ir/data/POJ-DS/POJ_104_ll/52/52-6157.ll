; ModuleID = 'POJ-104-source/52/52-6157.cpp'
source_filename = "POJ-104-source/52/52-6157.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_52_6157.cpp, i8* null }]
...
12:                                               ; preds = %8
  ...
  %15 = getelementptr inbounds [400 x i32], [400 x i32]* %5, i64 0, i64 %14
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_52_6157.cpp() #0 section ".text.startup" {
