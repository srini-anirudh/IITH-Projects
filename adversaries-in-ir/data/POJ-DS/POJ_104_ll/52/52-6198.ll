; ModuleID = 'POJ-104-source/52/52-6198.cpp'
source_filename = "POJ-104-source/52/52-6198.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_52_6198.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %18, i8* %8)
  br label %20
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_52_6198.cpp() #0 section ".text.startup" {
