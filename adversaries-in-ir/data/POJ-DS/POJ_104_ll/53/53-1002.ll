; ModuleID = 'POJ-104-source/53/53-1002.cpp'
source_filename = "POJ-104-source/53/53-1002.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_53_1002.cpp, i8* null }]
...
28:                                               ; preds = %19
  ...
  call void @_Z2pdPii(i32* %29, i32 %30)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_53_1002.cpp() #0 section ".text.startup" {
