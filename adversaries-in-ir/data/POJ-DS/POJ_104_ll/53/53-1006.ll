; ModuleID = 'POJ-104-source/53/53-1006.cpp'
source_filename = "POJ-104-source/53/53-1006.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_53_1006.cpp, i8* null }]
...
define dso_local i32 @_Z7compareiPii(i32 %0, i32* %1, i32 %2) #4 {
...
12:                                               ; preds = %8
  ...
  %23 = call i32 @_Z7compareiPii(i32 %20, i32* %21, i32 %22)
  %24 = icmp eq i32 %23, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_53_1006.cpp() #0 section ".text.startup" {
