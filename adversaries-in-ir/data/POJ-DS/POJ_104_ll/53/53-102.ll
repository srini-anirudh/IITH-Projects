; ModuleID = 'POJ-104-source/53/53-102.cpp'
source_filename = "POJ-104-source/53/53-102.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_53_102.cpp, i8* null }]
...
31:                                               ; preds = %24
  ...
  %35 = call i32 @_Z5judgePiiS_(i32* %32, i32 %33, i32* %34)
  %36 = icmp eq i32 %35, 0
...
define dso_local i32 @_Z5judgePiiS_(i32* %0, i32 %1, i32* %2) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_53_102.cpp() #0 section ".text.startup" {
