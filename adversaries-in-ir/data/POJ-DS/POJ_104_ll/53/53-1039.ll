; ModuleID = 'POJ-104-source/53/53-1039.cpp'
source_filename = "POJ-104-source/53/53-1039.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_53_1039.cpp, i8* null }]
...
118:                                              ; preds = %115
  %119 = getelementptr inbounds [300 x i32], [300 x i32]* %4, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_53_1039.cpp() #0 section ".text.startup" {
