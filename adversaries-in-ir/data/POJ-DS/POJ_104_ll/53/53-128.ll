; ModuleID = 'POJ-104-source/53/53-128.cpp'
source_filename = "POJ-104-source/53/53-128.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_53_128.cpp, i8* null }]
...
79:                                               ; preds = %31
  %80 = getelementptr inbounds [300 x i32], [300 x i32]* %5, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_53_128.cpp() #0 section ".text.startup" {
