; ModuleID = 'POJ-104-source/53/53-1331.cpp'
source_filename = "POJ-104-source/53/53-1331.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_53_1331.cpp, i8* null }]
...
73:                                               ; preds = %70
  %74 = getelementptr inbounds [300 x i32], [300 x i32]* %7, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_53_1331.cpp() #0 section ".text.startup" {
