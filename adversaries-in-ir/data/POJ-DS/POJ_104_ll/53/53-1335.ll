; ModuleID = 'POJ-104-source/53/53-1335.cpp'
source_filename = "POJ-104-source/53/53-1335.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_53_1335.cpp, i8* null }]
...
define dso_local i32 @_Z5judgePiii(i32* %0, i32 %1, i32 %2) #4 {
...
26:                                               ; preds = %22
  ...
  %33 = call i32 @_Z5judgePiii(i32* %27, i32 %31, i32 %32)
  %34 = icmp eq i32 %33, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_53_1335.cpp() #0 section ".text.startup" {
