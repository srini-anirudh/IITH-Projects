; ModuleID = 'POJ-104-source/53/53-1578.cpp'
source_filename = "POJ-104-source/53/53-1578.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_53_1578.cpp, i8* null }]
...
20:                                               ; preds = %16
  ...
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i32* %23)
  br label %25
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_53_1578.cpp() #0 section ".text.startup" {
