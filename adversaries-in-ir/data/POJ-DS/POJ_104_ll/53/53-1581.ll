; ModuleID = 'POJ-104-source/53/53-1581.cpp'
source_filename = "POJ-104-source/53/53-1581.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_53_1581.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z2pdPii(i32* %0, i32 %1) #0 {
...
18:                                               ; preds = %6
  ...
  call void @_Z2pdPii(i32* %22, i32 %23)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_53_1581.cpp() #0 section ".text.startup" {
