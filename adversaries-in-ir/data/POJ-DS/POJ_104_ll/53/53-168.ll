; ModuleID = 'POJ-104-source/53/53-168.cpp'
source_filename = "POJ-104-source/53/53-168.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_53_168.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z3delPii(i32* %0, i32 %1) #0 {
...
18:                                               ; preds = %6
  ...
  call void @_Z3delPii(i32* %19, i32 %20)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_53_168.cpp() #0 section ".text.startup" {
