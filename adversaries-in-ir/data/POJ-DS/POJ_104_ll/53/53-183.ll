; ModuleID = 'POJ-104-source/53/53-183.cpp'
source_filename = "POJ-104-source/53/53-183.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_53_183.cpp, i8* null }]
...
define dso_local void @_Z3delPiii(i32* %0, i32 %1, i32 %2) #4 {
...
12:                                               ; preds = %8
  ...
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i32* %15)
  br label %17
...
25:                                               ; preds = %21
  ...
  call void @_Z3delPiii(i32* %26, i32 %27, i32 %31)
  br label %32
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_53_183.cpp() #0 section ".text.startup" {
