; ModuleID = 'POJ-104-source/53/53-30.cpp'
source_filename = "POJ-104-source/53/53-30.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_53_30.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %10 = bitcast [310 x i32]* %6 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 16 %10, i8 0, i64 1240, i1 false)
...
35:                                               ; preds = %31
  ...
  %38 = getelementptr inbounds [310 x i32], [310 x i32]* %3, i64 0, i64 %37
...
68:                                               ; preds = %26
  %69 = getelementptr inbounds [310 x i32], [310 x i32]* %6, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_53_30.cpp() #0 section ".text.startup" {
