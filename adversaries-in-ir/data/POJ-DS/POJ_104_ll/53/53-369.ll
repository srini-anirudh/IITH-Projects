; ModuleID = 'POJ-104-source/53/53-369.cpp'
source_filename = "POJ-104-source/53/53-369.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_53_369.cpp, i8* null }]
...
61:                                               ; preds = %20
  %62 = getelementptr inbounds [301 x i32], [301 x i32]* %5, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_53_369.cpp() #0 section ".text.startup" {
