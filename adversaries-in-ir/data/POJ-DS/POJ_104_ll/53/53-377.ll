; ModuleID = 'POJ-104-source/53/53-377.cpp'
source_filename = "POJ-104-source/53/53-377.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_53_377.cpp, i8* null }]
...
31:                                               ; preds = %26, %14
  ...
  %35 = getelementptr inbounds [310 x i32], [310 x i32]* %5, i64 0, i64 %34
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_53_377.cpp() #0 section ".text.startup" {
