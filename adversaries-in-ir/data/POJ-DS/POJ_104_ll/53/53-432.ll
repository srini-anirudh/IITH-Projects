; ModuleID = 'POJ-104-source/53/53-432.cpp'
source_filename = "POJ-104-source/53/53-432.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_53_432.cpp, i8* null }]
...
75:                                               ; preds = %28
  %76 = getelementptr inbounds [301 x i32], [301 x i32]* %6, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_53_432.cpp() #0 section ".text.startup" {
