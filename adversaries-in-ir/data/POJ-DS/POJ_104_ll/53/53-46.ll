; ModuleID = 'POJ-104-source/53/53-46.cpp'
source_filename = "POJ-104-source/53/53-46.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_53_46.cpp, i8* null }]
...
65:                                               ; preds = %24
  ...
  %66 = bitcast [300 x i32]* %8 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 16 %66, i8 0, i64 1200, i1 false)
  store i32 0, i32* %5, align 4
  br label %67
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_53_46.cpp() #0 section ".text.startup" {
