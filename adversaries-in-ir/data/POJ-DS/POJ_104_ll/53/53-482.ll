; ModuleID = 'POJ-104-source/53/53-482.cpp'
source_filename = "POJ-104-source/53/53-482.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_53_482.cpp, i8* null }]
...
35:                                               ; preds = %31
  ...
  %38 = getelementptr inbounds [400 x i32], [400 x i32]* %6, i64 0, i64 %37
...
58:                                               ; preds = %21
  %59 = getelementptr inbounds [400 x i32], [400 x i32]* %6, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_53_482.cpp() #0 section ".text.startup" {
