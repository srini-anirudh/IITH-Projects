; ModuleID = 'POJ-104-source/53/53-584.cpp'
source_filename = "POJ-104-source/53/53-584.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_53_584.cpp, i8* null }]
...
46:                                               ; preds = %34
  ...
  store i32 -32000, i32* %50, align 4
  br label %51
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_53_584.cpp() #0 section ".text.startup" {
