; ModuleID = 'POJ-104-source/53/53-585.cpp'
source_filename = "POJ-104-source/53/53-585.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_53_585.cpp, i8* null }]
...
56:                                               ; preds = %53
  ...
  %58 = getelementptr inbounds [300 x i8], [300 x i8]* %6, i64 0, i64 0
  %59 = icmp eq i8* %57, %58
...
68:                                               ; preds = %65
  ...
  %70 = getelementptr inbounds [300 x i8], [300 x i8]* %6, i64 0, i64 0
  %71 = icmp ne i8* %69, %70
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_53_585.cpp() #0 section ".text.startup" {
