; ModuleID = 'POJ-104-source/53/53-606.cpp'
source_filename = "POJ-104-source/53/53-606.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_53_606.cpp, i8* null }]
...
230:                                              ; preds = %213
  ...
  %239 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32 %238)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_53_606.cpp() #0 section ".text.startup" {
