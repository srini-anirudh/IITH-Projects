; ModuleID = 'POJ-104-source/53/53-619.cpp'
source_filename = "POJ-104-source/53/53-619.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_53_619.cpp, i8* null }]
...
21:                                               ; preds = %8
  ...
  %25 = call i32 @_Z1fPiS_i(i32* %22, i32* %23, i32 %24)
...
define dso_local i32 @_Z1fPiS_i(i32* %0, i32* %1, i32 %2) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_53_619.cpp() #0 section ".text.startup" {
