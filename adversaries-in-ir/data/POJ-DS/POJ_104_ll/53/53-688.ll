; ModuleID = 'POJ-104-source/53/53-688.cpp'
source_filename = "POJ-104-source/53/53-688.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_53_688.cpp, i8* null }]
...
20:                                               ; preds = %8
  %21 = getelementptr inbounds [500 x i32], [500 x i32]* %6, i64 0, i64 1
...
46:                                               ; preds = %38
  ...
  %51 = getelementptr inbounds [500 x i32], [500 x i32]* %6, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_53_688.cpp() #0 section ".text.startup" {
