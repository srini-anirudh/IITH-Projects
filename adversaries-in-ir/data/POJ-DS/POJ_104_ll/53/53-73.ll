; ModuleID = 'POJ-104-source/53/53-73.cpp'
source_filename = "POJ-104-source/53/53-73.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_53_73.cpp, i8* null }]
...
define dso_local signext i8 @_Z6belongiPii(i32 %0, i32* %1, i32 %2) #4 {
  %4 = alloca i8, align 1
...
26:                                               ; preds = %22
  ...
  %33 = call signext i8 @_Z6belongiPii(i32 %30, i32* %31, i32 %32)
  %34 = icmp ne i8 %33, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_53_73.cpp() #0 section ".text.startup" {
