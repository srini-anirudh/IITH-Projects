; ModuleID = 'POJ-104-source/53/53-738.cpp'
source_filename = "POJ-104-source/53/53-738.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_53_738.cpp, i8* null }]
...
16:                                               ; preds = %12
  ...
  %18 = getelementptr inbounds [301 x i32], [301 x i32]* %4, i64 0, i64 0
...
44:                                               ; preds = %12
  %45 = getelementptr inbounds [301 x i32], [301 x i32]* %4, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_53_738.cpp() #0 section ".text.startup" {
