; ModuleID = 'POJ-104-source/53/53-746.cpp'
source_filename = "POJ-104-source/53/53-746.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_53_746.cpp, i8* null }]
...
define dso_local i32 @_Z9cross_outPii(i32* %0, i32 %1) #4 {
...
22:                                               ; preds = %9
  ...
  %25 = call i32 @_Z9cross_outPii(i32* %23, i32 %24)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_53_746.cpp() #0 section ".text.startup" {
