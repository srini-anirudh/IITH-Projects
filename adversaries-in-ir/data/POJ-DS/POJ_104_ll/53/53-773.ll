; ModuleID = 'POJ-104-source/53/53-773.cpp'
source_filename = "POJ-104-source/53/53-773.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_53_773.cpp, i8* null }]
...
24:                                               ; preds = %21
  %25 = getelementptr inbounds [500 x i32], [500 x i32]* %7, i64 0, i64 0
  %26 = load i32, i32* %25, align 16
  %27 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32 %26)
  br label %73

28:                                               ; preds = %21
  %29 = getelementptr inbounds [500 x i32], [500 x i32]* %7, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_53_773.cpp() #0 section ".text.startup" {
