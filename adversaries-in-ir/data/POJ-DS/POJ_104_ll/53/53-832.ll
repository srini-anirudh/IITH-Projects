; ModuleID = 'POJ-104-source/53/53-832.cpp'
source_filename = "POJ-104-source/53/53-832.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_53_832.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %9 = bitcast i8* %8 to <{ i32, [300 x i32] }>*
  %10 = getelementptr inbounds <{ i32, [300 x i32] }>, <{ i32, [300 x i32] }>* %9, i32 0, i32 0
  ...
  store i32 32, i32* %13, align 16
  %14 = bitcast [301 x i32]* %7 to i8*
...
28:                                               ; preds = %16
  %29 = getelementptr inbounds [301 x i32], [301 x i32]* %3, i64 0, i64 0
  %30 = load i32, i32* %29, align 16
  %31 = getelementptr inbounds [301 x i32], [301 x i32]* %4, i64 0, i64 0
...
77:                                               ; preds = %32
  %78 = getelementptr inbounds [301 x i32], [301 x i32]* %4, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_53_832.cpp() #0 section ".text.startup" {
