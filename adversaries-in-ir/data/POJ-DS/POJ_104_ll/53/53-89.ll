; ModuleID = 'POJ-104-source/53/53-89.cpp'
source_filename = "POJ-104-source/53/53-89.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_53_89.cpp, i8* null }]
...
13:                                               ; preds = %9
  ...
  %16 = getelementptr inbounds [301 x i32], [301 x i32]* %3, i64 0, i64 %15
...
80:                                               ; preds = %22
  %81 = getelementptr inbounds [301 x i32], [301 x i32]* %3, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_53_89.cpp() #0 section ".text.startup" {
