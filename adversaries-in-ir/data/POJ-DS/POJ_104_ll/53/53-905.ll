; ModuleID = 'POJ-104-source/53/53-905.cpp'
source_filename = "POJ-104-source/53/53-905.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_53_905.cpp, i8* null }]
...
define dso_local i32 @_Z3numPii(i32* %0, i32 %1) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z3cutPii(i32* %0, i32 %1) #4 {
  %3 = alloca i32*, align 8
  %4 = alloca i32, align 4
...
24:                                               ; preds = %40, %20
  ...
  %36 = call i32 @_Z3numPii(i32* %34, i32 %35)
  %37 = icmp eq i32 %36, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_53_905.cpp() #0 section ".text.startup" {
