; ModuleID = 'POJ-104-source/53/53-915.cpp'
source_filename = "POJ-104-source/53/53-915.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_53_915.cpp, i8* null }]
...
33:                                               ; preds = %29
  ...
  %36 = call i32 @_Z4findPii(i32* %34, i32 %35)
  %37 = icmp eq i32 %36, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_53_915.cpp() #0 section ".text.startup" {
