; ModuleID = 'POJ-104-source/53/53-921.cpp'
source_filename = "POJ-104-source/53/53-921.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_53_921.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %6 = alloca [300 x %struct.number], align 16
...
12:                                               ; preds = %8
  ...
  %15 = getelementptr inbounds [300 x %struct.number], [300 x %struct.number]* %6, i64 0, i64 %14
...
26:                                               ; preds = %22
  ...
  %29 = getelementptr inbounds [300 x %struct.number], [300 x %struct.number]* %6, i64 0, i64 %28
...
46:                                               ; preds = %42
  ...
  %49 = getelementptr inbounds [300 x %struct.number], [300 x %struct.number]* %6, i64 0, i64 %48
  %50 = getelementptr inbounds %struct.number, %struct.number* %49, i32 0, i32 0
  %51 = load i32, i32* %50, align 8
  %52 = load i32, i32* %4, align 4
  %53 = sext i32 %52 to i64
  %54 = getelementptr inbounds [300 x %struct.number], [300 x %struct.number]* %6, i64 0, i64 %53
...
58:                                               ; preds = %46
  ...
  %61 = getelementptr inbounds [300 x %struct.number], [300 x %struct.number]* %6, i64 0, i64 %60
...
76:                                               ; preds = %72
  ...
  %79 = getelementptr inbounds [300 x %struct.number], [300 x %struct.number]* %6, i64 0, i64 %78
...
88:                                               ; preds = %86, %83
  ...
  %91 = getelementptr inbounds [300 x %struct.number], [300 x %struct.number]* %6, i64 0, i64 %90
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_53_921.cpp() #0 section ".text.startup" {
