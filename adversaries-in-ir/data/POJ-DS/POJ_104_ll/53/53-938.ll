; ModuleID = 'POJ-104-source/53/53-938.cpp'
source_filename = "POJ-104-source/53/53-938.cpp"
...
@mark = dso_local global [300 x i32] zeroinitializer, align 16
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [4 x i8] c",%d\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_53_938.cpp, i8* null }]
...
41:                                               ; preds = %31
  ...
  %44 = getelementptr inbounds [300 x i32], [300 x i32]* @mark, i64 0, i64 %43
...
61:                                               ; preds = %57
  ...
  %64 = getelementptr inbounds [300 x i32], [300 x i32]* @mark, i64 0, i64 %63
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_53_938.cpp() #0 section ".text.startup" {
