; ModuleID = 'POJ-104-source/53/53-985.cpp'
source_filename = "POJ-104-source/53/53-985.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_53_985.cpp, i8* null }]
...
25:                                               ; preds = %21
  ...
  %32 = call i32 @_Z3evaiiPi(i32 %29, i32 %30, i32* %31)
  %33 = icmp ne i32 %32, 0
...
define dso_local i32 @_Z3evaiiPi(i32 %0, i32 %1, i32* %2) #5 {
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_53_985.cpp() #0 section ".text.startup" {
