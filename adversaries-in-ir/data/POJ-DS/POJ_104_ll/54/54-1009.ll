; ModuleID = 'POJ-104-source/54/54-1009.cpp'
source_filename = "POJ-104-source/54/54-1009.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_54_1009.cpp, i8* null }]
...
define dso_local i32 @main() #5 {
  ...
  call void @_Z6monkeyii(i32 %6, i32 %7)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_54_1009.cpp() #0 section ".text.startup" {
