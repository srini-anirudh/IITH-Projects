; ModuleID = 'POJ-104-source/54/54-1064.cpp'
source_filename = "POJ-104-source/54/54-1064.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_54_1064.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %8 = call i32 @_Z3calii(i32 %6, i32 %7)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_54_1064.cpp() #0 section ".text.startup" {
