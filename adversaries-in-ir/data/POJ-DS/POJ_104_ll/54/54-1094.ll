; ModuleID = 'POJ-104-source/54/54-1094.cpp'
source_filename = "POJ-104-source/54/54-1094.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_54_1094.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %7 = call i32 @_Z9calculateii(i32 %5, i32 %6)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_54_1094.cpp() #0 section ".text.startup" {
