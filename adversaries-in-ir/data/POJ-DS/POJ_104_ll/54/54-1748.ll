; ModuleID = 'POJ-104-source/54/54-1748.cpp'
source_filename = "POJ-104-source/54/54-1748.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_54_1748.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z7vampireiii(i32 %0, i32 %1, i32 %2) #0 {
...
75:                                               ; preds = %72
  %76 = load i64, i64* getelementptr inbounds ([1000 x i64], [1000 x i64]* @a, i64 0, i64 1), align 8
...
100:                                              ; preds = %95
  ...
  %104 = call i32 @_Z7vampireiii(i32 %101, i32 %102, i32 %103)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_54_1748.cpp() #0 section ".text.startup" {
