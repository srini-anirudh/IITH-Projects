; ModuleID = 'POJ-104-source/54/54-383.cpp'
source_filename = "POJ-104-source/54/54-383.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_54_383.cpp, i8* null }]
...
54:                                               ; preds = %51
  %55 = getelementptr inbounds [300 x i32], [300 x i32]* %4, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_54_383.cpp() #0 section ".text.startup" {
