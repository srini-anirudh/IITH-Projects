; ModuleID = 'POJ-104-source/54/54-79.cpp'
source_filename = "POJ-104-source/54/54-79.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_54_79.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %8 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %3, i32* %5)
...
65:                                               ; preds = %60, %27
  %66 = getelementptr inbounds [100 x i32], [100 x i32]* %7, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_54_79.cpp() #0 section ".text.startup" {
