; ModuleID = 'POJ-104-source/55/55-1059.cpp'
source_filename = "POJ-104-source/55/55-1059.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_1059.cpp, i8* null }]
...
84:                                               ; preds = %54
  ...
  %98 = call double @pow(double %92, double %97) #3
...
150:                                              ; preds = %118
  ...
  %154 = getelementptr inbounds [100 x i8], [100 x i8]* %14, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_1059.cpp() #0 section ".text.startup" {
