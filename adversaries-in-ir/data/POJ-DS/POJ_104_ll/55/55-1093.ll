; ModuleID = 'POJ-104-source/55/55-1093.cpp'
source_filename = "POJ-104-source/55/55-1093.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_1093.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %12 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i64* %2, i8* %11, i64* %3)
  store i32 0, i32* %6, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_1093.cpp() #0 section ".text.startup" {
