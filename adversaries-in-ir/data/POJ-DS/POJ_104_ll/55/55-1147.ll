; ModuleID = 'POJ-104-source/55/55-1147.cpp'
source_filename = "POJ-104-source/55/55-1147.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_1147.cpp, i8* null }]
...
113:                                              ; preds = %110
  ...
  %122 = call i32 @_Z3powii(i32 %119, i32 %121)
...
220:                                              ; preds = %158
  ...
  %224 = getelementptr inbounds [100 x i8], [100 x i8]* %11, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_1147.cpp() #0 section ".text.startup" {
