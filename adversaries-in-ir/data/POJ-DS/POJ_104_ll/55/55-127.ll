; ModuleID = 'POJ-104-source/55/55-127.cpp'
source_filename = "POJ-104-source/55/55-127.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_127.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %12 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i32* %6, i8* %11, i32* %7)
...
50:                                               ; preds = %16
  ...
  %54 = call i32 @_Z4stonPcii(i8* %51, i32 %52, i32 %53)
  store i32 %54, i32* %5, align 4
  %55 = getelementptr inbounds [100 x i8], [100 x i8]* %3, i64 0, i64 0
  %56 = load i32, i32* %7, align 4
  %57 = load i32, i32* %5, align 4
  call void @_Z4ntosPcii(i8* %55, i32 %56, i32 %57)
  store i32 0, i32* %4, align 4
  br label %58
...
define dso_local i32 @_Z4stonPcii(i8* %0, i32 %1, i32 %2) #7 {
  %4 = alloca i8*, align 8
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
  %7 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define dso_local void @_Z4ntosPcii(i8* %0, i32 %1, i32 %2) #0 {
  %4 = alloca i8*, align 8
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
  store i8* %0, i8** %4, align 8
...
16:                                               ; preds = %3
  ...
  %21 = sdiv i32 %19, %20
  call void @_Z4ntosPcii(i8* %17, i32 %18, i32 %21)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_127.cpp() #0 section ".text.startup" {
