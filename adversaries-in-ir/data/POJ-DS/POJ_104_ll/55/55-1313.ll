; ModuleID = 'POJ-104-source/55/55-1313.cpp'
source_filename = "POJ-104-source/55/55-1313.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_1313.cpp, i8* null }]
...
define dso_local i32 @_Z8convert1c(i8 signext %0) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local signext i8 @_Z8convert2i(i32 %0) #4 {
  %2 = alloca i8, align 1
...
24:                                               ; preds = %21
  ...
  %31 = call i32 @_Z8convert1c(i8 signext %30)
...
72:                                               ; preds = %69
  ...
  %77 = call signext i8 @_Z8convert2i(i32 %76)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_1313.cpp() #0 section ".text.startup" {
