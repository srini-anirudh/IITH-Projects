; ModuleID = 'POJ-104-source/55/55-1345.cpp'
source_filename = "POJ-104-source/55/55-1345.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_1345.cpp, i8* null }]
...
define dso_local i32 @_Z6atoDeciPc(i32 %0, i8* %1) #4 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_1345.cpp() #0 section ".text.startup" {
