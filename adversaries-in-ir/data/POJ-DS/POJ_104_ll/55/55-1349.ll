; ModuleID = 'POJ-104-source/55/55-1349.cpp'
source_filename = "POJ-104-source/55/55-1349.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_1349.cpp, i8* null }]
...
define dso_local i64 @_Z7change1Pci(i8* %0, i32 %1) #4 {
  %3 = alloca i8*, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_1349.cpp() #0 section ".text.startup" {
