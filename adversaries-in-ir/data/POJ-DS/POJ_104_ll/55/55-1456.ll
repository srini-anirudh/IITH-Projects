; ModuleID = 'POJ-104-source/55/55-1456.cpp'
source_filename = "POJ-104-source/55/55-1456.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_1456.cpp, i8* null }]
...
57:                                               ; preds = %44
  ...
  %59 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32* %2, i8* %58, i32* %3)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_1456.cpp() #0 section ".text.startup" {
