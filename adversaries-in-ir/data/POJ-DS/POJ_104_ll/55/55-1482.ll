; ModuleID = 'POJ-104-source/55/55-1482.cpp'
source_filename = "POJ-104-source/55/55-1482.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_1482.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %13 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i64* %2, [1000 x i8]* %12, i64* %3)
...
89:                                               ; preds = %88, %35
  ...
  %98 = call i64 @_Z5mizhiii(i32 %93, i32 %97)
...
130:                                              ; preds = %126
  ...
  %137 = call i64 @_Z5mizhiii(i32 %133, i32 %136)
...
140:                                              ; preds = %130
  ...
  %147 = call i64 @_Z5mizhiii(i32 %143, i32 %146)
  ...
  %156 = call i64 @_Z5mizhiii(i32 %152, i32 %155)
...
158:                                              ; preds = %130
  ...
  %165 = call i64 @_Z5mizhiii(i32 %161, i32 %164)
  ...
  %175 = call i64 @_Z5mizhiii(i32 %171, i32 %174)
...
define dso_local i64 @_Z5mizhiii(i32 %0, i32 %1) #6 {
  %3 = alloca i64, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_1482.cpp() #0 section ".text.startup" {
