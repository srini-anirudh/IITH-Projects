; ModuleID = 'POJ-104-source/55/55-1486.cpp'
source_filename = "POJ-104-source/55/55-1486.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_1486.cpp, i8* null }]
...
21:                                               ; preds = %18
  ...
  %26 = call i32 @_Z1fc(i8 signext %25)
...
63:                                               ; preds = %60
  ...
  %68 = call signext i8 @_Z1gi(i32 %67)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_1486.cpp() #0 section ".text.startup" {
