; ModuleID = 'POJ-104-source/55/55-152.cpp'
source_filename = "POJ-104-source/55/55-152.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_152.cpp, i8* null }]
...
define dso_local i32 @main(i32 %0, i8** %1) #4 {
  ...
  %23 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i8* %20, i8* %21, i8* %22)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_152.cpp() #0 section ".text.startup" {
