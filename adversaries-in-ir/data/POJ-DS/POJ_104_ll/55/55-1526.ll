; ModuleID = 'POJ-104-source/55/55-1526.cpp'
source_filename = "POJ-104-source/55/55-1526.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_1526.cpp, i8* null }]
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z2cfii(i32 %0, i32 %1) #4 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
...
define dso_local i32 @main() #5 {
  ...
  %11 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32* %2, i8* %10, i32* %3)
...
81:                                               ; preds = %78
  ...
  %84 = srem i32 %82, %83
  %85 = call signext i8 @_Z3fzhi(i32 %84)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_1526.cpp() #0 section ".text.startup" {
