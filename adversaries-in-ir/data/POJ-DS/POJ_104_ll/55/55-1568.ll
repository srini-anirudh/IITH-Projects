; ModuleID = 'POJ-104-source/55/55-1568.cpp'
source_filename = "POJ-104-source/55/55-1568.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_1568.cpp, i8* null }]
...
define dso_local i32 @main(i32 %0, i8** %1) #4 {
  ...
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32* %12, i8* %17, i32* %13)
...
85:                                               ; preds = %84, %47
  ...
  %92 = sub nsw i32 %91, 1
  %93 = call double @_ZSt3powIiiEN9__gnu_cxx11__promote_2IT_T0_NS0_9__promoteIS2_Xsr3std12__is_integerIS2_EE7__valueEE6__typeENS4_IS3_Xsr3std12__is_integerIS3_EE7__valueEE6__typeEE6__typeES2_S3_(i32 %88, i32 %92)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_1568.cpp() #0 section ".text.startup" {
