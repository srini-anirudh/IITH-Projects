; ModuleID = 'POJ-104-source/55/55-1586.cpp'
source_filename = "POJ-104-source/55/55-1586.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_1586.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %11 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i32* %4, i8* %10, i32* %5)
...
19:                                               ; preds = %15
  ...
  %24 = call i32 @_Z6changec(i8 signext %23)
...
61:                                               ; preds = %58
  ...
  %66 = call signext i8 @_Z5transi(i32 %65)
...
define dso_local i32 @_Z6changec(i8 signext %0) #6 {
  %2 = alloca i8, align 1
...
; Function Attrs: noinline nounwind uwtable
define dso_local signext i8 @_Z5transi(i32 %0) #6 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_1586.cpp() #0 section ".text.startup" {
