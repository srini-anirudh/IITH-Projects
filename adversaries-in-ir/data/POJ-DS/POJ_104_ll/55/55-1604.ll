; ModuleID = 'POJ-104-source/55/55-1604.cpp'
source_filename = "POJ-104-source/55/55-1604.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_1604.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %10 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i64* %4)
  br label %11
...
44:                                               ; preds = %36
  ...
  %47 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), i64* %5)
...
53:                                               ; preds = %50
  ...
  %60 = call signext i8 @_Z7change1c(i8 signext %59)
...
74:                                               ; preds = %71
  ...
  %79 = call signext i8 @_Z7change2c(i8 signext %78)
...
define dso_local signext i8 @_Z7change1c(i8 signext %0) #5 {
  %2 = alloca i8, align 1
...
; Function Attrs: noinline nounwind uwtable
define dso_local signext i8 @_Z7change2c(i8 signext %0) #5 {
  %2 = alloca i8, align 1
  store i8 %0, i8* %2, align 1
  %3 = load i8, i8* %2, align 1
  %4 = sext i8 %3 to i32
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_1604.cpp() #0 section ".text.startup" {
