; ModuleID = 'POJ-104-source/55/55-1606.cpp'
source_filename = "POJ-104-source/55/55-1606.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_1606.cpp, i8* null }]
...
define dso_local i64 @_Z7decimalPcl(i8* %0, i64 %1) #4 {
  %3 = alloca i8*, align 8
...
define dso_local i32 @main() #5 {
  ...
  %12 = getelementptr inbounds [65 x i8], [65 x i8]* %5, i64 0, i64 0
  ...
  %15 = getelementptr inbounds [65 x i8], [65 x i8]* %5, i64 0, i64 0
...
35:                                               ; preds = %31, %28
  ...
  %40 = getelementptr inbounds [65 x i8], [65 x i8]* %5, i64 0, i64 %39
...
60:                                               ; preds = %57
  ...
  %63 = getelementptr inbounds [65 x i8], [65 x i8]* %5, i64 0, i64 %62
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_1606.cpp() #0 section ".text.startup" {
