; ModuleID = 'POJ-104-source/55/55-1610.cpp'
source_filename = "POJ-104-source/55/55-1610.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_1610.cpp, i8* null }]
...
define dso_local i32 @_Z5toDecPci(i8* %0, i32 %1) #4 {
  %3 = alloca i8*, align 8
...
; Function Attrs: noinline uwtable
define dso_local void @_Z7convertPcii(i8* %0, i32 %1, i32 %2) #0 {
  %4 = alloca i8*, align 8
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
  %7 = alloca i32, align 4
  ...
  %13 = call i32 @_Z5toDecPci(i8* %11, i32 %12)
...
36:                                               ; preds = %33, %29
  %37 = call i64 @strlen(i8* getelementptr inbounds ([128 x i8], [128 x i8]* @output, i64 0, i64 0)) #8
  %38 = getelementptr inbounds i8, i8* getelementptr inbounds ([128 x i8], [128 x i8]* @output, i64 0, i64 0), i64 %37
  %39 = load i32, i32* %8, align 4
  %40 = call i32 (i8*, i8*, ...) @sprintf(i8* %38, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32 %39) #3
...
44:                                               ; preds = %20
  %45 = call i64 @strlen(i8* getelementptr inbounds ([128 x i8], [128 x i8]* @output, i64 0, i64 0)) #8
...
define dso_local i32 @main() #7 {
  ...
  %6 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i64 0, i64 0), i32* %1, i8* %5, i32* %2)
  %7 = getelementptr inbounds [1001 x i8], [1001 x i8]* %3, i64 0, i64 0
  %8 = load i32, i32* %1, align 4
  %9 = load i32, i32* %2, align 4
  call void @_Z7convertPcii(i8* %7, i32 %8, i32 %9)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_1610.cpp() #0 section ".text.startup" {
