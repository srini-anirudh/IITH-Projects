; ModuleID = 'POJ-104-source/55/55-1651.cpp'
source_filename = "POJ-104-source/55/55-1651.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_1651.cpp, i8* null }]
...
125:                                              ; preds = %120
  ...
  %133 = getelementptr inbounds [120 x i8], [120 x i8]* %9, i64 0, i64 %132
...
134:                                              ; preds = %120
  ...
  %143 = getelementptr inbounds [120 x i8], [120 x i8]* %9, i64 0, i64 %142
...
157:                                              ; preds = %154
  ...
  %161 = getelementptr inbounds [120 x i8], [120 x i8]* %9, i64 0, i64 %160
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_1651.cpp() #0 section ".text.startup" {
