; ModuleID = 'POJ-104-source/55/55-1656.cpp'
source_filename = "POJ-104-source/55/55-1656.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_1656.cpp, i8* null }]
...
56:                                               ; preds = %43
  ...
  %58 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32* %4, i8* %57, i32* %6)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_1656.cpp() #0 section ".text.startup" {
