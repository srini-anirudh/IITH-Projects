; ModuleID = 'POJ-104-source/55/55-1676.cpp'
source_filename = "POJ-104-source/55/55-1676.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_1676.cpp, i8* null }]
...
3:                                                ; preds = %115, %63, %0
  %4 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i64 0, i64 0), i32* @a, i8* getelementptr inbounds ([100 x i8], [100 x i8]* @str, i64 0, i64 0), i32* @b)
  %5 = icmp ne i32 %4, -1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_1676.cpp() #0 section ".text.startup" {
