; ModuleID = 'POJ-104-source/55/55-18.cpp'
source_filename = "POJ-104-source/55/55-18.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_18.cpp, i8* null }]
...
define dso_local i32 @_Z11char_to_numc(i8 signext %0) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local signext i8 @_Z11num_to_chari(i32 %0) #4 {
  %2 = alloca i8, align 1
...
define dso_local i32 @main() #6 {
  ...
  %10 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i32* %2, i8* %9, i32* %3)
...
19:                                               ; preds = %16
  ...
  %25 = call i32 @_Z11char_to_numc(i8 signext %24)
...
41:                                               ; preds = %38
  ...
  %47 = call signext i8 @_Z11num_to_chari(i32 %46)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_18.cpp() #0 section ".text.startup" {
