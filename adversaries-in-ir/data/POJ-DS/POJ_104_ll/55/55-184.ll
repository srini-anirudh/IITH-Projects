; ModuleID = 'POJ-104-source/55/55-184.cpp'
source_filename = "POJ-104-source/55/55-184.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_184.cpp, i8* null }]
...
define dso_local signext i8 @_Z2chc(i8 signext %0) #4 {
  %2 = alloca i8, align 1
  %3 = alloca i8, align 1
...
16:                                               ; preds = %13
  ...
  %23 = getelementptr inbounds [32 x i8], [32 x i8]* %7, i64 0, i64 %22
...
32:                                               ; preds = %27, %13
  %33 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i32* %3)
...
38:                                               ; preds = %34
  ...
  %53 = call signext i8 @_Z2chc(i8 signext %52)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_184.cpp() #0 section ".text.startup" {
