; ModuleID = 'POJ-104-source/55/55-193.cpp'
source_filename = "POJ-104-source/55/55-193.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_193.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z13convertorto10Pcii(i8* %0, i32 %1, i32 %2) #0 {
...
16:                                               ; preds = %3
  ...
  %28 = sub nsw i32 %27, 1
  %29 = call i32 @_Z13convertorto10Pcii(i8* %25, i32 %26, i32 %28)
...
define dso_local i32 @main() #4 {
  ...
  %13 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i64 0, i64 0), i32* %2, i8* %12, i32* %3)
...
77:                                               ; preds = %17
  ...
  %81 = sub nsw i32 %80, 1
  %82 = call i32 @_Z13convertorto10Pcii(i8* %78, i32 %79, i32 %81)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_193.cpp() #0 section ".text.startup" {
