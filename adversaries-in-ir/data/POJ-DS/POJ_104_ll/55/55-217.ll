; ModuleID = 'POJ-104-source/55/55-217.cpp'
source_filename = "POJ-104-source/55/55-217.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_217.cpp, i8* null }]
...
130:                                              ; preds = %127
  ...
  %138 = getelementptr inbounds [50 x i8], [50 x i8]* %4, i64 0, i64 %137
...
173:                                              ; preds = %220, %171
  ...
  %175 = icmp sle i32 %174, 49
  br i1 %175, label %176, label %223

176:                                              ; preds = %173
  %177 = load i32, i32* %9, align 4
  %178 = sext i32 %177 to i64
  %179 = getelementptr inbounds [50 x i8], [50 x i8]* %4, i64 0, i64 %178
...
183:                                              ; preds = %176
  ...
  %186 = getelementptr inbounds [50 x i8], [50 x i8]* %4, i64 0, i64 %185
...
202:                                              ; preds = %183, %176
  ...
  %212 = getelementptr inbounds [50 x i8], [50 x i8]* %4, i64 0, i64 %211
...
213:                                              ; preds = %202, %190
  ...
  %216 = getelementptr inbounds [50 x i8], [50 x i8]* %4, i64 0, i64 %215
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_217.cpp() #0 section ".text.startup" {
