; ModuleID = 'POJ-104-source/55/55-230.cpp'
source_filename = "POJ-104-source/55/55-230.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_230.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %8 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i32* %2, i8* %7, i32* @b)
...
; Function Attrs: noinline uwtable
define dso_local void @_Z2PFi(i32 %0) #0 {
  %2 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_230.cpp() #0 section ".text.startup" {
