; ModuleID = 'POJ-104-source/55/55-24.cpp'
source_filename = "POJ-104-source/55/55-24.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_24.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %10 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i32* %2, i8* getelementptr inbounds ([32 x i8], [32 x i8]* @a, i64 0, i64 0), i32* %3)
  %11 = call i64 @strlen(i8* getelementptr inbounds ([32 x i8], [32 x i8]* @a, i64 0, i64 0)) #6
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_24.cpp() #0 section ".text.startup" {
