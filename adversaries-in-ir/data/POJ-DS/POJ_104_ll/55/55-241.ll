; ModuleID = 'POJ-104-source/55/55-241.cpp'
source_filename = "POJ-104-source/55/55-241.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_241.cpp, i8* null }]
...
44:                                               ; preds = %37
  ...
  %56 = sub nsw i32 %55, 1
  %57 = call i32 @_Z1fii(i32 %52, i32 %56)
...
104:                                              ; preds = %97
  ...
  %117 = call i32 @_Z1fii(i32 %112, i32 %116)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_241.cpp() #0 section ".text.startup" {
