; ModuleID = 'POJ-104-source/55/55-257.cpp'
source_filename = "POJ-104-source/55/55-257.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_257.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %12 = bitcast i8* %11 to <{ i8, [254 x i8] }>*
  %13 = getelementptr inbounds <{ i8, [254 x i8] }>, <{ i8, [254 x i8] }>* %12, i32 0, i32 0
...
58:                                               ; preds = %44
  ...
  %60 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32* %2, i8* %59, i32* %3)
  store i32 0, i32* %4, align 4
  br label %61
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_257.cpp() #0 section ".text.startup" {
