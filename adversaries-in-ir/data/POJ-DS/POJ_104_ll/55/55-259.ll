; ModuleID = 'POJ-104-source/55/55-259.cpp'
source_filename = "POJ-104-source/55/55-259.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_259.cpp, i8* null }]
...
define dso_local i32 @main(i32 %0, i8** %1) #4 {
  ...
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i32* %10, [20 x i8]* %15, i32* %9)
...
107:                                              ; preds = %103
  ...
  %120 = call double @_ZSt3powIiiEN9__gnu_cxx11__promote_2IT_T0_NS0_9__promoteIS2_Xsr3std12__is_integerIS2_EE7__valueEE6__typeENS4_IS3_Xsr3std12__is_integerIS3_EE7__valueEE6__typeEE6__typeES2_S3_(i32 %115, i32 %119)
...
152:                                              ; preds = %148
  ...
  %158 = getelementptr inbounds [20 x i32], [20 x i32]* %12, i64 0, i64 %157
  ...
  %164 = getelementptr inbounds [20 x i32], [20 x i32]* %12, i64 0, i64 %163
...
176:                                              ; preds = %152
  ...
  %179 = getelementptr inbounds [20 x i32], [20 x i32]* %12, i64 0, i64 %178
...
182:                                              ; preds = %176
  ...
  %187 = add nsw i32 %186, 55
  %188 = load i32, i32* %6, align 4
  %189 = sext i32 %188 to i64
  %190 = getelementptr inbounds [20 x i32], [20 x i32]* %12, i64 0, i64 %189
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_259.cpp() #0 section ".text.startup" {
