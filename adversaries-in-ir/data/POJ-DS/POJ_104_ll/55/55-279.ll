; ModuleID = 'POJ-104-source/55/55-279.cpp'
source_filename = "POJ-104-source/55/55-279.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_279.cpp, i8* null }]
...
define dso_local i32 @main(i32 %0, i8** %1) #4 {
  ...
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i64* %6, i8* %18, i64* %8)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_279.cpp() #0 section ".text.startup" {
