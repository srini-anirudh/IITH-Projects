; ModuleID = 'POJ-104-source/55/55-309.cpp'
source_filename = "POJ-104-source/55/55-309.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_309.cpp, i8* null }]
...
define dso_local i32 @main(i32 %0, i8** %1) #4 {
  ...
  %16 = bitcast i8* %15 to <{ i8, [254 x i8] }>*
  %17 = getelementptr inbounds <{ i8, [254 x i8] }>, <{ i8, [254 x i8] }>* %16, i32 0, i32 0
  store i8 48, i8* %17, align 16
  %18 = getelementptr inbounds [255 x i8], [255 x i8]* %11, i64 0, i64 0
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32* %6, i8* %18, i32* %7)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_309.cpp() #0 section ".text.startup" {
