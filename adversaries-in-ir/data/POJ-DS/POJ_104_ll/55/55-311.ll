; ModuleID = 'POJ-104-source/55/55-311.cpp'
source_filename = "POJ-104-source/55/55-311.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_311.cpp, i8* null }]
...
56:                                               ; preds = %43
  ...
  %59 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32* %9, i8* %58, i32* %10)
...
102:                                              ; preds = %99
  ...
  %107 = getelementptr inbounds [37 x i8], [37 x i8]* %8, i64 0, i64 %106
...
142:                                              ; preds = %129
  %143 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i32* %7)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_311.cpp() #0 section ".text.startup" {
