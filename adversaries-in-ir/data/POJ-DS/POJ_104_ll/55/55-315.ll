; ModuleID = 'POJ-104-source/55/55-315.cpp'
source_filename = "POJ-104-source/55/55-315.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_315.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %13 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32* %4, i8* %12, i32* %5)
...
76:                                               ; preds = %55
  ...
  %78 = bitcast i8* %77 to <{ i8, [254 x i8] }>*
  %79 = getelementptr inbounds <{ i8, [254 x i8] }>, <{ i8, [254 x i8] }>* %78, i32 0, i32 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_315.cpp() #0 section ".text.startup" {
