; ModuleID = 'POJ-104-source/55/55-354.cpp'
source_filename = "POJ-104-source/55/55-354.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_354.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %12 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i64* %6, i8* getelementptr inbounds ([10000 x i8], [10000 x i8]* @a, i64 0, i64 0), i64* %9)
  %13 = call i64 @strlen(i8* getelementptr inbounds ([10000 x i8], [10000 x i8]* @a, i64 0, i64 0)) #7
...
91:                                               ; preds = %88
  ...
  %104 = call i64 @_Z3hhhii(i32 %98, i32 %103)
...
define dso_local i64 @_Z3hhhii(i32 %0, i32 %1) #6 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_354.cpp() #0 section ".text.startup" {
