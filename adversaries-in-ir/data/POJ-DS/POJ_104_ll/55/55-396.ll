; ModuleID = 'POJ-104-source/55/55-396.cpp'
source_filename = "POJ-104-source/55/55-396.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_396.cpp, i8* null }]
...
102:                                              ; preds = %131, %101
  ...
  %108 = icmp sgt i64 %107, 9
  br i1 %108, label %109, label %117

109:                                              ; preds = %102
  %110 = load i64, i64* %10, align 8
  %111 = sub nsw i64 %110, 10
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_396.cpp() #0 section ".text.startup" {
