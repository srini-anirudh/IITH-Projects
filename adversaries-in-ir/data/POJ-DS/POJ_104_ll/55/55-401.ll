; ModuleID = 'POJ-104-source/55/55-401.cpp'
source_filename = "POJ-104-source/55/55-401.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_401.cpp, i8* null }]
...
24:                                               ; preds = %19
  ...
  %30 = call i32 @_Z5zhuanc(i8 signext %29)
...
36:                                               ; preds = %19
  ...
  %42 = call i32 @_Z5zhuanc(i8 signext %41)
...
define dso_local i32 @_Z5zhuanc(i8 signext %0) #6 {
  %2 = alloca i8, align 1
  %3 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_401.cpp() #0 section ".text.startup" {
