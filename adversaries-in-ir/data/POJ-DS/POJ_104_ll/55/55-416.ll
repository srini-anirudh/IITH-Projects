; ModuleID = 'POJ-104-source/55/55-416.cpp'
source_filename = "POJ-104-source/55/55-416.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_416.cpp, i8* null }]
...
167:                                              ; preds = %163
  ...
  %170 = getelementptr inbounds [1000 x i8], [1000 x i8]* %11, i64 0, i64 %169
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_416.cpp() #0 section ".text.startup" {
