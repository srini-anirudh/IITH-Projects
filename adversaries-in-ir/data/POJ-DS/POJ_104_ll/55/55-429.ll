; ModuleID = 'POJ-104-source/55/55-429.cpp'
source_filename = "POJ-104-source/55/55-429.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_429.cpp, i8* null }]
...
define dso_local void @_Z8MyStruprPc(i8* %0) #4 {
  %2 = alloca i8*, align 8
...
57:                                               ; preds = %47, %37
  ...
  %65 = call double @_ZSt3powIiiEN9__gnu_cxx11__promote_2IT_T0_NS0_9__promoteIS2_Xsr3std12__is_integerIS2_EE7__valueEE6__typeENS4_IS3_Xsr3std12__is_integerIS3_EE7__valueEE6__typeEE6__typeES2_S3_(i32 %60, i32 %64)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_429.cpp() #0 section ".text.startup" {
