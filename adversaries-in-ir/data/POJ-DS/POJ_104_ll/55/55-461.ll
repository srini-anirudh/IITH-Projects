; ModuleID = 'POJ-104-source/55/55-461.cpp'
source_filename = "POJ-104-source/55/55-461.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_461.cpp, i8* null }]
...
15:                                               ; preds = %97, %0
  ...
  %18 = getelementptr inbounds [20 x i8], [20 x i8]* %6, i64 0, i64 %17
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_461.cpp() #0 section ".text.startup" {
