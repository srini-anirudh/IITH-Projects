; ModuleID = 'POJ-104-source/55/55-466.cpp'
source_filename = "POJ-104-source/55/55-466.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_466.cpp, i8* null }]
...
125:                                              ; preds = %109
  ...
  %134 = getelementptr inbounds [50 x i8], [50 x i8]* %8, i64 0, i64 %133
...
149:                                              ; preds = %146
  ...
  %152 = getelementptr inbounds [50 x i8], [50 x i8]* %8, i64 0, i64 %151
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_466.cpp() #0 section ".text.startup" {
