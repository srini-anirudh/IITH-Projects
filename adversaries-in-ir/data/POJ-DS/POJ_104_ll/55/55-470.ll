; ModuleID = 'POJ-104-source/55/55-470.cpp'
source_filename = "POJ-104-source/55/55-470.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_470.cpp, i8* null }]
...
191:                                              ; preds = %184
  ...
  %208 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i32 %207)
  br label %209
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_470.cpp() #0 section ".text.startup" {
