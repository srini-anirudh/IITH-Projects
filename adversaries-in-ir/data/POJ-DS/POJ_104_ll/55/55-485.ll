; ModuleID = 'POJ-104-source/55/55-485.cpp'
source_filename = "POJ-104-source/55/55-485.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_485.cpp, i8* null }]
...
120:                                              ; preds = %106, %96, %86
  ...
  %132 = call double @pow(double %129, double %131) #3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_485.cpp() #0 section ".text.startup" {
