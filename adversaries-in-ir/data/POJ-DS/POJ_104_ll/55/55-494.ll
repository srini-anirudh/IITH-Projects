; ModuleID = 'POJ-104-source/55/55-494.cpp'
source_filename = "POJ-104-source/55/55-494.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_494.cpp, i8* null }]
...
define dso_local i64 @_Z6cifangii(i32 %0, i32 %1) #4 {
...
46:                                               ; preds = %39
  ...
  %59 = sub nsw i32 %58, 1
  %60 = call i64 @_Z6cifangii(i32 %55, i32 %59)
...
77:                                               ; preds = %70
  ...
  %90 = sub nsw i32 %89, 1
  %91 = call i64 @_Z6cifangii(i32 %86, i32 %90)
...
94:                                               ; preds = %70, %63
  ...
  %97 = getelementptr inbounds [10 x i8], [10 x i8]* %7, i64 0, i64 %96
...
101:                                              ; preds = %94
  ...
  %104 = getelementptr inbounds [10 x i8], [10 x i8]* %7, i64 0, i64 %103
...
108:                                              ; preds = %101
  ...
  %122 = call i64 @_Z6cifangii(i32 %117, i32 %121)
  %123 = mul nsw i64 %116, %122
  %124 = add nsw i64 %109, %123
  store i64 %124, i64* %8, align 8
  br label %125

125:                                              ; preds = %108, %101, %94
  br label %126
...
184:                                              ; preds = %178
  ...
  %187 = getelementptr inbounds [50 x i32], [50 x i32]* %6, i64 0, i64 %186
  %188 = load i32, i32* %187, align 4
  %189 = add nsw i32 %188, 55
  %190 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i32 %189)
  br label %191
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_494.cpp() #0 section ".text.startup" {
