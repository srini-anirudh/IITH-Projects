; ModuleID = 'POJ-104-source/55/55-518.cpp'
source_filename = "POJ-104-source/55/55-518.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_518.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %13 = bitcast i8* %12 to <{ i8, [99 x i8] }>*
  %14 = getelementptr inbounds <{ i8, [99 x i8] }>, <{ i8, [99 x i8] }>* %13, i32 0, i32 0
  ...
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i32* %2, i8* %21, i32* %3)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_518.cpp() #0 section ".text.startup" {
