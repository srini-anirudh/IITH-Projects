; ModuleID = 'POJ-104-source/55/55-530.cpp'
source_filename = "POJ-104-source/55/55-530.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_530.cpp, i8* null }]
...
87:                                               ; preds = %86, %37
  ...
  %99 = call i32 @_Z1fii(i32 %97, i32 %98)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_530.cpp() #0 section ".text.startup" {
