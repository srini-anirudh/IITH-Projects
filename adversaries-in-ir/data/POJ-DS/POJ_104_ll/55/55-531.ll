; ModuleID = 'POJ-104-source/55/55-531.cpp'
source_filename = "POJ-104-source/55/55-531.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_531.cpp, i8* null }]
...
105:                                              ; preds = %102
  ...
  %116 = call i32 @_Z1fii(i32 %111, i32 %115)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_531.cpp() #0 section ".text.startup" {
