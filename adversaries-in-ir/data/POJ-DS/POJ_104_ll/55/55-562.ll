; ModuleID = 'POJ-104-source/55/55-562.cpp'
source_filename = "POJ-104-source/55/55-562.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_562.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i64 @_Z3funii(i32 %0, i32 %1) #0 {
...
9:                                                ; preds = %2
  ...
  %14 = sub nsw i32 %13, 1
  %15 = call i64 @_Z3funii(i32 %12, i32 %14)
...
36:                                               ; preds = %29
  ...
  %49 = call i64 @_Z3funii(i32 %44, i32 %48)
...
67:                                               ; preds = %60
  ...
  %81 = call i64 @_Z3funii(i32 %76, i32 %80)
...
99:                                               ; preds = %92
  ...
  %113 = call i64 @_Z3funii(i32 %108, i32 %112)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_562.cpp() #0 section ".text.startup" {
