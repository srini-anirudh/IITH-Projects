; ModuleID = 'POJ-104-source/55/55-572.cpp'
source_filename = "POJ-104-source/55/55-572.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_572.cpp, i8* null }]
...
define dso_local i32 @_Z5powerll(i64 %0, i64 %1) #4 {
...
define dso_local i32 @main() #5 {
  ...
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i64* %2, i8* %16, i64* %3)
...
42:                                               ; preds = %33
  ...
  %54 = call i32 @_Z5powerll(i64 %52, i64 %53)
...
77:                                               ; preds = %68
  ...
  %89 = call i32 @_Z5powerll(i64 %87, i64 %88)
...
112:                                              ; preds = %103
  ...
  %123 = call i32 @_Z5powerll(i64 %121, i64 %122)
...
133:                                              ; preds = %146, %132
  ...
  %136 = call i32 @_Z5powerll(i64 %134, i64 %135)
...
157:                                              ; preds = %154
  ...
  %160 = call i32 @_Z5powerll(i64 %158, i64 %159)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_572.cpp() #0 section ".text.startup" {
