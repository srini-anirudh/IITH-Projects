; ModuleID = 'POJ-104-source/55/55-576.cpp'
source_filename = "POJ-104-source/55/55-576.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_576.cpp, i8* null }]
...
40:                                               ; preds = %11
  ...
  call void @_Z9numchangeiiPc(i32 %41, i32 %42, i8* %43)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define dso_local void @_Z9numchangeiiPc(i32 %0, i32 %1, i8* %2) #0 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_576.cpp() #0 section ".text.startup" {
