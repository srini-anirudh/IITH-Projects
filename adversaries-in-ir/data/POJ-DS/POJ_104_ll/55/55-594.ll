; ModuleID = 'POJ-104-source/55/55-594.cpp'
source_filename = "POJ-104-source/55/55-594.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_594.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z2qrii(i32 %0, i32 %1) #0 {
...
9:                                                ; preds = %2
  ...
  %13 = sub nsw i32 %12, 1
  %14 = call i32 @_Z2qrii(i32 %11, i32 %13)
...
65:                                               ; preds = %58
  ...
  %71 = call i32 @_Z2qrii(i32 %66, i32 %70)
...
83:                                               ; preds = %58, %51
  ...
  %89 = call i32 @_Z2qrii(i32 %84, i32 %88)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_594.cpp() #0 section ".text.startup" {
