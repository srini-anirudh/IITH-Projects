; ModuleID = 'POJ-104-source/55/55-597.cpp'
source_filename = "POJ-104-source/55/55-597.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_597.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %13 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i64* %10, i8* getelementptr inbounds ([50 x i8], [50 x i8]* @str, i64 0, i64 0), i64* %9)
  %14 = call i64 @strlen(i8* getelementptr inbounds ([50 x i8], [50 x i8]* @str, i64 0, i64 0)) #6
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_597.cpp() #0 section ".text.startup" {
