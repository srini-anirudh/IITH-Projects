; ModuleID = 'POJ-104-source/55/55-60.cpp'
source_filename = "POJ-104-source/55/55-60.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_60.cpp, i8* null }]
...
define dso_local i32 @_Z3chfii(i32 %0, i32 %1) #4 {
...
416:                                              ; preds = %412
  ...
  %427 = call i32 @_Z3chfii(i32 %422, i32 %426)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_60.cpp() #0 section ".text.startup" {
