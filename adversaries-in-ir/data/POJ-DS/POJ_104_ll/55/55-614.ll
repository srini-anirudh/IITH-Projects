; ModuleID = 'POJ-104-source/55/55-614.cpp'
source_filename = "POJ-104-source/55/55-614.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_614.cpp, i8* null }]
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z7change2liPc(i64 %0, i32 %1, i8* %2) #4 {
...
define dso_local i32 @main() #6 {
  ...
  %15 = call i64 @_Z7change1Pci(i8* %13, i32 %14)
  store i64 %15, i64* %8, align 8
  %16 = load i64, i64* %8, align 8
  %17 = load i32, i32* %5, align 4
  %18 = getelementptr inbounds [50 x i8], [50 x i8]* %3, i64 0, i64 0
  call void @_Z7change2liPc(i64 %16, i32 %17, i8* %18)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_614.cpp() #0 section ".text.startup" {
