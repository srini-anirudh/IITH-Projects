; ModuleID = 'POJ-104-source/55/55-619.cpp'
source_filename = "POJ-104-source/55/55-619.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_619.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i32* %7)
...
189:                                              ; preds = %183
  ...
  %203 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i32 %202)
  br label %204
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_619.cpp() #0 section ".text.startup" {
