; ModuleID = 'POJ-104-source/55/55-820.cpp'
source_filename = "POJ-104-source/55/55-820.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_820.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %13 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i64* %3, i8* %12, i64* %4)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_820.cpp() #0 section ".text.startup" {
