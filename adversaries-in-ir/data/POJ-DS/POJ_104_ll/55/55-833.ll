; ModuleID = 'POJ-104-source/55/55-833.cpp'
source_filename = "POJ-104-source/55/55-833.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_833.cpp, i8* null }]
...
33:                                               ; preds = %14
  %34 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* %2)
  ...
  %37 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i32* %3)
  store i32 0, i32* %5, align 4
  br label %38
...
138:                                              ; preds = %135
  ...
  %148 = call i32 @_Z5powerii(i32 %146, i32 %147)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_833.cpp() #0 section ".text.startup" {
