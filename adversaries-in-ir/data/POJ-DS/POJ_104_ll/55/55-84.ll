; ModuleID = 'POJ-104-source/55/55-84.cpp'
source_filename = "POJ-104-source/55/55-84.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_84.cpp, i8* null }]
...
define dso_local i32 @_Z5zhuaniPc(i32 %0, i8* %1) #4 {
...
; Function Attrs: noinline uwtable
define dso_local void @_Z4huanil(i32 %0, i64 %1) #0 {
  %3 = alloca i32, align 4
...
define dso_local i32 @main() #5 {
  ...
  %7 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.3, i64 0, i64 0), i32* %2, i8* %6, i32* %3)
  %8 = load i32, i32* %2, align 4
  %9 = getelementptr inbounds [100 x i8], [100 x i8]* %5, i64 0, i64 0
  %10 = call i32 @_Z5zhuaniPc(i32 %8, i8* %9)
  %11 = sext i32 %10 to i64
  store i64 %11, i64* %4, align 8
  %12 = load i32, i32* %3, align 4
  %13 = load i64, i64* %4, align 8
  call void @_Z4huanil(i32 %12, i64 %13)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_84.cpp() #0 section ".text.startup" {
