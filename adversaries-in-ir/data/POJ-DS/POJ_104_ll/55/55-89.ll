; ModuleID = 'POJ-104-source/55/55-89.cpp'
source_filename = "POJ-104-source/55/55-89.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_89.cpp, i8* null }]
...
define dso_local i32 @main(i32 %0, i8** %1) #4 {
  ...
  %17 = bitcast i8* %16 to <{ i8, [254 x i8] }>*
  %18 = getelementptr inbounds <{ i8, [254 x i8] }>, <{ i8, [254 x i8] }>* %17, i32 0, i32 0
...
59:                                               ; preds = %46
  ...
  %61 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32* %11, i8* %60, i32* %12)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_89.cpp() #0 section ".text.startup" {
