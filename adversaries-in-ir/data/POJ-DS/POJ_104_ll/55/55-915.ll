; ModuleID = 'POJ-104-source/55/55-915.cpp'
source_filename = "POJ-104-source/55/55-915.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_55_915.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i64* %2, i8* %13, i64* %3)
...
140:                                              ; preds = %135
  ...
  %148 = getelementptr inbounds [100 x i64], [100 x i64]* %9, i64 0, i64 %147
  %149 = load i64, i64* %148, align 8
  %150 = load i64, i64* %5, align 8
  %151 = getelementptr inbounds [100 x i64], [100 x i64]* %9, i64 0, i64 %150
...
166:                                              ; preds = %162
  ...
  %168 = getelementptr inbounds [100 x i64], [100 x i64]* %9, i64 0, i64 %167
...
179:                                              ; preds = %166
  ...
  %181 = getelementptr inbounds [100 x i64], [100 x i64]* %9, i64 0, i64 %180
...
192:                                              ; preds = %162
  ...
  %194 = getelementptr inbounds [1000 x i8], [1000 x i8]* %12, i64 0, i64 %193
  store i8 0, i8* %194, align 1
  %195 = getelementptr inbounds [1000 x i8], [1000 x i8]* %12, i64 0, i64 0
...
define linkonce_odr dso_local double @_ZSt3powIdlEN9__gnu_cxx11__promote_2IT_T0_NS0_9__promoteIS2_Xsr3std12__is_integerIS2_EE7__valueEE6__typeENS4_IS3_Xsr3std12__is_integerIS3_EE7__valueEE6__typeEE6__typeES2_S3_(double %0, i64 %1) #6 comdat {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_55_915.cpp() #0 section ".text.startup" {
