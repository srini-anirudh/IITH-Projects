; ModuleID = 'POJ-104-source/56/56-1864.cpp'
source_filename = "POJ-104-source/56/56-1864.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_56_1864.cpp, i8* null }]
...
104:                                              ; preds = %100
  ...
  %108 = getelementptr inbounds [6 x i32], [6 x i32]* %2, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_56_1864.cpp() #0 section ".text.startup" {
