; ModuleID = 'POJ-104-source/56/56-1896.cpp'
source_filename = "POJ-104-source/56/56-1896.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_56_1896.cpp, i8* null }]
...
9:                                                ; preds = %26, %0
  %10 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i8* %2)
  %11 = icmp ne i32 %10, -1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_56_1896.cpp() #0 section ".text.startup" {
