; ModuleID = 'POJ-104-source/56/56-2281.cpp'
source_filename = "POJ-104-source/56/56-2281.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_56_2281.cpp, i8* null }]
...
8:                                                ; preds = %40, %0
  ...
  %13 = udiv i64 %12, 2
  %14 = call double @_ZSt5floorImEN9__gnu_cxx11__enable_ifIXsr12__is_integerIT_EE7__valueEdE6__typeES2_(i64 %13)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_56_2281.cpp() #0 section ".text.startup" {
