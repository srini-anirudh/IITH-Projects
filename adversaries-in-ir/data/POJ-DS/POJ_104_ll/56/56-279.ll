; ModuleID = 'POJ-104-source/56/56-279.cpp'
source_filename = "POJ-104-source/56/56-279.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_56_279.cpp, i8* null }]
...
44:                                               ; preds = %31
  ...
  %46 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i64* %3)
  br label %47
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_56_279.cpp() #0 section ".text.startup" {
