; ModuleID = 'POJ-104-source/56/56-2977.cpp'
source_filename = "POJ-104-source/56/56-2977.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_56_2977.cpp, i8* null }]
...
11:                                               ; preds = %8
  ...
  call void @_Z4moveii(i32 %12, i32 %13)
  br label %31
...
17:                                               ; preds = %14
  ...
  call void @_Z4moveii(i32 %18, i32 %19)
  br label %30
...
26:                                               ; preds = %20
  ...
  call void @_Z4moveii(i32 %27, i32 %28)
  br label %29
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_56_2977.cpp() #0 section ".text.startup" {
