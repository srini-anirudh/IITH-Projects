; ModuleID = 'POJ-104-source/56/56-611.cpp'
source_filename = "POJ-104-source/56/56-611.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_56_611.cpp, i8* null }]
...
14:                                               ; preds = %4
  ...
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i64 0, i64 0), i32* %15, i32* %16, i32* %17, i32* %18, i32* %19)
  store i32 0, i32* %3, align 4
  br label %21
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_56_611.cpp() #0 section ".text.startup" {
