; ModuleID = 'POJ-104-source/56/56-735.cpp'
source_filename = "POJ-104-source/56/56-735.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_56_735.cpp, i8* null }]
...
17:                                               ; preds = %11
  ...
  %67 = getelementptr inbounds [6 x i8], [6 x i8]* %2, i64 0, i64 %66
...
78:                                               ; preds = %11
  %79 = getelementptr inbounds [6 x i8], [6 x i8]* %2, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_56_735.cpp() #0 section ".text.startup" {
