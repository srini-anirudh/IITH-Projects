; ModuleID = 'POJ-104-source/56/56-868.cpp'
source_filename = "POJ-104-source/56/56-868.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_56_868.cpp, i8* null }]
...
47:                                               ; preds = %43
  ...
  %50 = getelementptr inbounds [5 x i8], [5 x i8]* %2, i64 0, i64 %49
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_56_868.cpp() #0 section ".text.startup" {
