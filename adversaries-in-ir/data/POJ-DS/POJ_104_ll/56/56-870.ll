; ModuleID = 'POJ-104-source/56/56-870.cpp'
source_filename = "POJ-104-source/56/56-870.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_56_870.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %11 = call double @_ZSt5log10IiEN9__gnu_cxx11__enable_ifIXsr12__is_integerIT_EE7__valueEdE6__typeES2_(i32 %10)
...
18:                                               ; preds = %15
  ...
  %27 = getelementptr inbounds [5 x i32], [5 x i32]* %7, i64 0, i64 %26
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_56_870.cpp() #0 section ".text.startup" {
