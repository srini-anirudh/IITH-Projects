; ModuleID = 'POJ-104-source/57/57-1087.cpp'
source_filename = "POJ-104-source/57/57-1087.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_1087.cpp, i8* null }]
...
49:                                               ; preds = %41, %25
  ...
  %57 = call i32 @strcmp(i8* %56, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0)) #6
  %58 = icmp eq i32 %57, 0
...
59:                                               ; preds = %49
  ...
  %67 = call i32 @strcmp(i8* %66, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.4, i64 0, i64 0)) #6
  %68 = icmp eq i32 %67, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_1087.cpp() #0 section ".text.startup" {
