; ModuleID = 'POJ-104-source/57/57-1276.cpp'
source_filename = "POJ-104-source/57/57-1276.cpp"
...
@__const._Z3delv.str1 = private unnamed_addr constant [3 x i8] c"er\00", align 1
@__const._Z3delv.str2 = private unnamed_addr constant [3 x i8] c"ly\00", align 1
@__const._Z3delv.str3 = private unnamed_addr constant [4 x i8] c"ing\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_1276.cpp, i8* null }]
...
7:                                                ; preds = %3
  ...
  %11 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), [33 x i8]* %10)
  call void @_Z3delv()
...
define dso_local void @_Z3delv() #5 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %6, i8* align 1 getelementptr inbounds ([3 x i8], [3 x i8]* @__const._Z3delv.str1, i32 0, i32 0), i64 3, i1 false)
  %7 = bitcast [3 x i8]* %2 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %7, i8* align 1 getelementptr inbounds ([3 x i8], [3 x i8]* @__const._Z3delv.str2, i32 0, i32 0), i64 3, i1 false)
  %8 = bitcast [4 x i8]* %3 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %8, i8* align 1 getelementptr inbounds ([4 x i8], [4 x i8]* @__const._Z3delv.str3, i32 0, i32 0), i64 4, i1 false)
...
29:                                               ; preds = %0
  ...
  %37 = call i8* @strncpy(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @src, i64 0, i64 0), i8* %33, i64 %36) #3
  br label %78
...
43:                                               ; preds = %38
  ...
  %51 = call i8* @strncpy(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @src, i64 0, i64 0), i8* %47, i64 %50) #3
  br label %77
...
52:                                               ; preds = %38
  ...
  %62 = call i8* @strcpy(i8* %53, i8* %61) #3
...
68:                                               ; preds = %67, %52
  ...
  %76 = call i8* @strncpy(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @src, i64 0, i64 0), i8* %72, i64 %75) #3
  br label %77
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_1276.cpp() #0 section ".text.startup" {
