; ModuleID = 'POJ-104-source/57/57-1330.cpp'
source_filename = "POJ-104-source/57/57-1330.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_1330.cpp, i8* null }]
...
101:                                              ; preds = %18
  %102 = getelementptr inbounds [50 x i8], [50 x i8]* %4, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_1330.cpp() #0 section ".text.startup" {
