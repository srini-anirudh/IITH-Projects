; ModuleID = 'POJ-104-source/57/57-1417.cpp'
source_filename = "POJ-104-source/57/57-1417.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_1417.cpp, i8* null }]
...
10:                                               ; preds = %6
  ...
  %13 = getelementptr inbounds [50 x [32 x i8]], [50 x [32 x i8]]* %4, i64 0, i64 %12
...
19:                                               ; preds = %6
  %20 = getelementptr inbounds [50 x [32 x i8]], [50 x [32 x i8]]* %4, i64 0, i64 0
  %21 = load i32, i32* %3, align 4
  call void @_Z3abcPA32_ci([32 x i8]* %20, i32 %21)
...
; Function Attrs: noinline uwtable
define dso_local void @_Z3abcPA32_ci([32 x i8]* %0, i32 %1) #0 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_1417.cpp() #0 section ".text.startup" {
