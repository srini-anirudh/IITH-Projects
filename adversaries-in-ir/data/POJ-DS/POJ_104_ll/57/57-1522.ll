; ModuleID = 'POJ-104-source/57/57-1522.cpp'
source_filename = "POJ-104-source/57/57-1522.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_1522.cpp, i8* null }]
...
15:                                               ; preds = %11
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), [50 x i8]* %6)
  ...
  %31 = call i32 @strcmp(i8* %30, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0)) #6
  %32 = icmp eq i32 %31, 0
...
56:                                               ; preds = %15
  ...
  %58 = call i32 @strcmp(i8* %57, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0)) #6
  %59 = icmp eq i32 %58, 0
...
83:                                               ; preds = %56
  ...
  %85 = call i32 @strcmp(i8* %84, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.4, i64 0, i64 0)) #6
  %86 = icmp eq i32 %85, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_1522.cpp() #0 section ".text.startup" {
