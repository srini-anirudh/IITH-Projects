; ModuleID = 'POJ-104-source/57/57-1597.cpp'
source_filename = "POJ-104-source/57/57-1597.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_1597.cpp, i8* null }]
...
13:                                               ; preds = %9
  ...
  %16 = getelementptr inbounds [50 x [15 x i8]], [50 x [15 x i8]]* %6, i64 0, i64 %15
  ...
  %21 = getelementptr inbounds [50 x [15 x i8]], [50 x [15 x i8]]* %6, i64 0, i64 %20
...
41:                                               ; preds = %37
  ...
  %43 = call i32 @strcmp(i8* %42, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i64 0, i64 0)) #6
  %44 = icmp eq i32 %43, 0
  br i1 %44, label %49, label %45

45:                                               ; preds = %41
  %46 = load i8*, i8** %7, align 8
  %47 = call i32 @strcmp(i8* %46, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.4, i64 0, i64 0)) #6
  %48 = icmp eq i32 %47, 0
  br label %49

49:                                               ; preds = %45, %41, %37
  %50 = phi i1 [ true, %41 ], [ true, %37 ], [ %48, %45 ]
...
66:                                               ; preds = %62
  ...
  %69 = getelementptr inbounds [50 x [15 x i8]], [50 x [15 x i8]]* %6, i64 0, i64 %68
  %70 = getelementptr inbounds [15 x i8], [15 x i8]* %69, i64 0, i64 0
  %71 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.5, i64 0, i64 0), i8* %70)
  br label %72
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_1597.cpp() #0 section ".text.startup" {
