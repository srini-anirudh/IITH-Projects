; ModuleID = 'POJ-104-source/57/57-1613.cpp'
source_filename = "POJ-104-source/57/57-1613.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_1613.cpp, i8* null }]
...
54:                                               ; preds = %43
  ...
  %66 = call i8* @strncpy(i8* %58, i8* %62, i64 %65) #3
  br label %80
...
67:                                               ; preds = %43, %26
  ...
  %79 = call i8* @strncpy(i8* %71, i8* %75, i64 %78) #3
  br label %80
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_1613.cpp() #0 section ".text.startup" {
