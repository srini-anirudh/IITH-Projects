; ModuleID = 'POJ-104-source/57/57-1646.cpp'
source_filename = "POJ-104-source/57/57-1646.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_1646.cpp, i8* null }]
...
21:                                               ; preds = %17
  ...
  %60 = call i32 @strcmp(i8* %59, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0)) #6
  %61 = icmp eq i32 %60, 0
...
86:                                               ; preds = %21
  ...
  %88 = call i32 @strcmp(i8* %87, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.4, i64 0, i64 0)) #6
  %89 = icmp eq i32 %88, 0
  br i1 %89, label %94, label %90

90:                                               ; preds = %86
  %91 = getelementptr inbounds [3 x i8], [3 x i8]* %11, i64 0, i64 0
  %92 = call i32 @strcmp(i8* %91, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.5, i64 0, i64 0)) #6
  %93 = icmp eq i32 %92, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_1646.cpp() #0 section ".text.startup" {
