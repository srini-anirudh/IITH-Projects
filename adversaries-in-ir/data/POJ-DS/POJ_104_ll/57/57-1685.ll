; ModuleID = 'POJ-104-source/57/57-1685.cpp'
source_filename = "POJ-104-source/57/57-1685.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_1685.cpp, i8* null }]
...
45:                                               ; preds = %27
  ...
  %47 = call i32 @strcmp(i8* %46, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0)) #7
  %48 = icmp eq i32 %47, 0
...
67:                                               ; preds = %65, %45
  ...
  %69 = call i32 @strcmp(i8* %68, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.5, i64 0, i64 0)) #7
  %70 = icmp eq i32 %69, 0
...
110:                                              ; preds = %92
  ...
  %112 = call i32 @strcmp(i8* %111, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.6, i64 0, i64 0)) #7
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_1685.cpp() #0 section ".text.startup" {
