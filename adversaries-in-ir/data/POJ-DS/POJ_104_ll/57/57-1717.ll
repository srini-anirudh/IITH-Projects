; ModuleID = 'POJ-104-source/57/57-1717.cpp'
source_filename = "POJ-104-source/57/57-1717.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_1717.cpp, i8* null }]
...
69:                                               ; preds = %55
  ...
  %84 = call i8* @strncpy(i8* %73, i8* %77, i64 %83) #3
  br label %175
...
113:                                              ; preds = %99
  ...
  %128 = call i8* @strncpy(i8* %117, i8* %121, i64 %127) #3
  br label %174
...
157:                                              ; preds = %143
  ...
  %172 = call i8* @strncpy(i8* %161, i8* %165, i64 %171) #3
  br label %173
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_1717.cpp() #0 section ".text.startup" {
