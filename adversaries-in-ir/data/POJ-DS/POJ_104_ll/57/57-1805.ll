; ModuleID = 'POJ-104-source/57/57-1805.cpp'
source_filename = "POJ-104-source/57/57-1805.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_1805.cpp, i8* null }]
...
12:                                               ; preds = %8
  ...
  %23 = call i32 @strcmp(i8* %22, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0)) #6
  %24 = icmp eq i32 %23, 0
  br i1 %24, label %29, label %25

25:                                               ; preds = %12
  %26 = load i8*, i8** %6, align 8
  %27 = call i32 @strcmp(i8* %26, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0)) #6
  %28 = icmp eq i32 %27, 0
...
34:                                               ; preds = %29, %25
  ...
  %40 = call i32 @strcmp(i8* %39, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.4, i64 0, i64 0)) #6
  %41 = icmp eq i32 %40, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_1805.cpp() #0 section ".text.startup" {
