; ModuleID = 'POJ-104-source/57/57-184.cpp'
source_filename = "POJ-104-source/57/57-184.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_184.cpp, i8* null }]
...
26:                                               ; preds = %22
  ...
  %29 = getelementptr inbounds [50 x [50 x i8]], [50 x [50 x i8]]* %6, i64 0, i64 %28
...
73:                                               ; preds = %26
  ...
  %80 = getelementptr inbounds [50 x i8], [50 x i8]* %76, i64 0, i64 %79
...
103:                                              ; preds = %85
  ...
  %106 = getelementptr inbounds [50 x [50 x i8]], [50 x [50 x i8]]* %6, i64 0, i64 %105
...
131:                                              ; preds = %126
  ...
  %134 = getelementptr inbounds [50 x [50 x i8]], [50 x [50 x i8]]* %6, i64 0, i64 %133
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_184.cpp() #0 section ".text.startup" {
