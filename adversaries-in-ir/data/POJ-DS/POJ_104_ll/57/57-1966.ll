; ModuleID = 'POJ-104-source/57/57-1966.cpp'
source_filename = "POJ-104-source/57/57-1966.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_1966.cpp, i8* null }]
...
44:                                               ; preds = %37, %30, %23
  ...
  %52 = call i32 @strcmp(i8* %51, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0)) #6
  %53 = icmp eq i32 %52, 0
  br i1 %53, label %62, label %54

54:                                               ; preds = %44
  %55 = getelementptr inbounds [20 x i8], [20 x i8]* %7, i64 0, i64 0
  %56 = call i32 @strcmp(i8* %55, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0)) #6
  %57 = icmp eq i32 %56, 0
  br i1 %57, label %62, label %58

58:                                               ; preds = %54
  %59 = getelementptr inbounds [20 x i8], [20 x i8]* %7, i64 0, i64 0
  %60 = call i32 @strcmp(i8* %59, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.4, i64 0, i64 0)) #6
  %61 = icmp eq i32 %60, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_1966.cpp() #0 section ".text.startup" {
