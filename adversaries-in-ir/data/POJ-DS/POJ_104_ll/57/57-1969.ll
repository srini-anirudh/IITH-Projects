; ModuleID = 'POJ-104-source/57/57-1969.cpp'
source_filename = "POJ-104-source/57/57-1969.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_1969.cpp, i8* null }]
...
158:                                              ; preds = %157, %53
  ...
  %161 = getelementptr inbounds [50 x [100 x i8]], [50 x [100 x i8]]* %5, i64 0, i64 %160
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_1969.cpp() #0 section ".text.startup" {
