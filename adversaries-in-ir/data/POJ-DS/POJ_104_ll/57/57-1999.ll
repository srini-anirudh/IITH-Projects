; ModuleID = 'POJ-104-source/57/57-1999.cpp'
source_filename = "POJ-104-source/57/57-1999.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_1999.cpp, i8* null }]
...
12:                                               ; preds = %8
  ...
  %22 = call i32 @strcmp(i8* %21, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0)) #6
  %23 = icmp eq i32 %22, 0
...
24:                                               ; preds = %12
  ...
  %29 = call i32 @strcmp(i8* %28, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0)) #6
  %30 = icmp eq i32 %29, 0
...
34:                                               ; preds = %24
  ...
  %39 = call i32 @strcmp(i8* %38, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.4, i64 0, i64 0)) #6
  %40 = icmp eq i32 %39, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_1999.cpp() #0 section ".text.startup" {
