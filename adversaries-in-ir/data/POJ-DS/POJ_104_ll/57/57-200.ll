; ModuleID = 'POJ-104-source/57/57-200.cpp'
source_filename = "POJ-104-source/57/57-200.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_200.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %6 = alloca [50 x %struct.string], align 16
...
12:                                               ; preds = %8
  ...
  %15 = getelementptr inbounds [50 x %struct.string], [50 x %struct.string]* %6, i64 0, i64 %14
  ...
  %21 = getelementptr inbounds [50 x %struct.string], [50 x %struct.string]* %6, i64 0, i64 %20
  ...
  %28 = getelementptr inbounds [50 x %struct.string], [50 x %struct.string]* %6, i64 0, i64 %27
...
38:                                               ; preds = %34
  ...
  %41 = getelementptr inbounds [50 x %struct.string], [50 x %struct.string]* %6, i64 0, i64 %40
  ...
  %47 = getelementptr inbounds [50 x %struct.string], [50 x %struct.string]* %6, i64 0, i64 %46
...
55:                                               ; preds = %38
  ...
  %58 = getelementptr inbounds [50 x %struct.string], [50 x %struct.string]* %6, i64 0, i64 %57
...
67:                                               ; preds = %55
  ...
  %70 = getelementptr inbounds [50 x %struct.string], [50 x %struct.string]* %6, i64 0, i64 %69
  ...
  %77 = getelementptr inbounds [50 x %struct.string], [50 x %struct.string]* %6, i64 0, i64 %76
...
83:                                               ; preds = %67, %55, %38
  ...
  %86 = getelementptr inbounds [50 x %struct.string], [50 x %struct.string]* %6, i64 0, i64 %85
...
94:                                               ; preds = %83
  ...
  %97 = getelementptr inbounds [50 x %struct.string], [50 x %struct.string]* %6, i64 0, i64 %96
...
106:                                              ; preds = %94
  ...
  %109 = getelementptr inbounds [50 x %struct.string], [50 x %struct.string]* %6, i64 0, i64 %108
  ...
  %116 = getelementptr inbounds [50 x %struct.string], [50 x %struct.string]* %6, i64 0, i64 %115
  %117 = getelementptr inbounds %struct.string, %struct.string* %116, i32 0, i32 0
...
122:                                              ; preds = %106, %94, %83
  ...
  %125 = getelementptr inbounds [50 x %struct.string], [50 x %struct.string]* %6, i64 0, i64 %124
...
133:                                              ; preds = %122
  ...
  %136 = getelementptr inbounds [50 x %struct.string], [50 x %struct.string]* %6, i64 0, i64 %135
  %137 = getelementptr inbounds %struct.string, %struct.string* %136, i32 0, i32 0
...
145:                                              ; preds = %133
  ...
  %148 = getelementptr inbounds [50 x %struct.string], [50 x %struct.string]* %6, i64 0, i64 %147
...
157:                                              ; preds = %145
  ...
  %160 = getelementptr inbounds [50 x %struct.string], [50 x %struct.string]* %6, i64 0, i64 %159
  %161 = getelementptr inbounds %struct.string, %struct.string* %160, i32 0, i32 0
  ...
  %167 = getelementptr inbounds [50 x %struct.string], [50 x %struct.string]* %6, i64 0, i64 %166
  %168 = getelementptr inbounds %struct.string, %struct.string* %167, i32 0, i32 0
  ...
  %175 = getelementptr inbounds [50 x %struct.string], [50 x %struct.string]* %6, i64 0, i64 %174
  %176 = getelementptr inbounds %struct.string, %struct.string* %175, i32 0, i32 0
...
190:                                              ; preds = %186
  ...
  %193 = getelementptr inbounds [50 x %struct.string], [50 x %struct.string]* %6, i64 0, i64 %192
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_200.cpp() #0 section ".text.startup" {
