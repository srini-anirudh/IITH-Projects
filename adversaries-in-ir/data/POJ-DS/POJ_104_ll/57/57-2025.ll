; ModuleID = 'POJ-104-source/57/57-2025.cpp'
source_filename = "POJ-104-source/57/57-2025.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_2025.cpp, i8* null }]
...
12:                                               ; preds = %8
  ...
  %15 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), [15 x i8]* %5)
...
26:                                               ; preds = %12
  ...
  %32 = call i8* @strncpy(i8* %27, i8* %28, i64 %31) #3
  br label %40
...
33:                                               ; preds = %12
  ...
  %39 = call i8* @strncpy(i8* %34, i8* %35, i64 %38) #3
  br label %40
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_2025.cpp() #0 section ".text.startup" {
