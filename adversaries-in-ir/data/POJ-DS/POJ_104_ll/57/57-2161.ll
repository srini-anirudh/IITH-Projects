; ModuleID = 'POJ-104-source/57/57-2161.cpp'
source_filename = "POJ-104-source/57/57-2161.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_2161.cpp, i8* null }]
...
103:                                              ; preds = %85
  ...
  %106 = getelementptr inbounds [100 x [20 x i8]], [100 x [20 x i8]]* %6, i64 0, i64 %105
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_2161.cpp() #0 section ".text.startup" {
