; ModuleID = 'POJ-104-source/57/57-2166.cpp'
source_filename = "POJ-104-source/57/57-2166.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_2166.cpp, i8* null }]
...
define dso_local void @_Z4doitPc(i8* %0) #4 {
  %2 = alloca i8*, align 8
...
24:                                               ; preds = %20
  ...
  call void @_Z4doitPc(i8* %28)
  %29 = load i32, i32* %2, align 4
  %30 = sext i32 %29 to i64
  %31 = getelementptr inbounds [50 x [10 x i8]], [50 x [10 x i8]]* %4, i64 0, i64 %30
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_2166.cpp() #0 section ".text.startup" {
