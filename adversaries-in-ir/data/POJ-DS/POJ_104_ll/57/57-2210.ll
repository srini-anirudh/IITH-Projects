; ModuleID = 'POJ-104-source/57/57-2210.cpp'
source_filename = "POJ-104-source/57/57-2210.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_2210.cpp, i8* null }]
...
73:                                               ; preds = %55
  ...
  %76 = getelementptr inbounds [50 x [20 x i8]], [50 x [20 x i8]]* %6, i64 0, i64 %75
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_2210.cpp() #0 section ".text.startup" {
