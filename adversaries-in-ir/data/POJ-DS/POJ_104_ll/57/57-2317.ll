; ModuleID = 'POJ-104-source/57/57-2317.cpp'
source_filename = "POJ-104-source/57/57-2317.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_2317.cpp, i8* null }]
...
146:                                              ; preds = %142
  %147 = getelementptr inbounds [1000 x i8], [1000 x i8]* %6, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_2317.cpp() #0 section ".text.startup" {
