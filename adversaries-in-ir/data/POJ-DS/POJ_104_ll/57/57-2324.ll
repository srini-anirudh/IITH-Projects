; ModuleID = 'POJ-104-source/57/57-2324.cpp'
source_filename = "POJ-104-source/57/57-2324.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_2324.cpp, i8* null }]
...
167:                                              ; preds = %156
  ...
  %172 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* %171)
  br label %173
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_2324.cpp() #0 section ".text.startup" {
