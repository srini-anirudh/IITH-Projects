; ModuleID = 'POJ-104-source/57/57-234.cpp'
source_filename = "POJ-104-source/57/57-234.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_234.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %8 = bitcast i8* %7 to <{ <{ i8, [99 x i8] }>, [99 x <{ i8, [99 x i8] }>] }>*
  %9 = getelementptr inbounds <{ <{ i8, [99 x i8] }>, [99 x <{ i8, [99 x i8] }>] }>, <{ <{ i8, [99 x i8] }>, [99 x <{ i8, [99 x i8] }>] }>* %8, i32 0, i32 0
...
45:                                               ; preds = %37
  ...
  %54 = call i8* @strncpy(i8* %49, i8* %50, i64 %53) #3
  br label %108
...
97:                                               ; preds = %89
  ...
  %106 = call i8* @strncpy(i8* %101, i8* %102, i64 %105) #3
  br label %107
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_234.cpp() #0 section ".text.startup" {
