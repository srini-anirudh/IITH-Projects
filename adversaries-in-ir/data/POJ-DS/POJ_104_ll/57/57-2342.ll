; ModuleID = 'POJ-104-source/57/57-2342.cpp'
source_filename = "POJ-104-source/57/57-2342.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_2342.cpp, i8* null }]
...
82:                                               ; preds = %77
  ...
  %85 = getelementptr inbounds [50 x [20 x i8]], [50 x [20 x i8]]* %2, i64 0, i64 %84
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_2342.cpp() #0 section ".text.startup" {
