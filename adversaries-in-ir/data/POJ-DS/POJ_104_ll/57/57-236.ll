; ModuleID = 'POJ-104-source/57/57-236.cpp'
source_filename = "POJ-104-source/57/57-236.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_236.cpp, i8* null }]
...
12:                                               ; preds = %8
  ...
  %15 = getelementptr inbounds [50 x [30 x i8]], [50 x [30 x i8]]* %2, i64 0, i64 %14
...
43:                                               ; preds = %26
  ...
  call void @_Z7delete3Pci(i8* %47, i32 %48)
  br label %55
...
49:                                               ; preds = %26
  ...
  call void @_Z7delete2Pci(i8* %53, i32 %54)
  br label %55

55:                                               ; preds = %49, %43
  %56 = load i32, i32* %4, align 4
  %57 = sext i32 %56 to i64
  %58 = getelementptr inbounds [50 x [30 x i8]], [50 x [30 x i8]]* %2, i64 0, i64 %57
...
define dso_local void @_Z7delete3Pci(i8* %0, i32 %1) #6 {
  %3 = alloca i8*, align 8
  %4 = alloca i32, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z7delete2Pci(i8* %0, i32 %1) #6 {
  %3 = alloca i8*, align 8
  %4 = alloca i32, align 4
  store i8* %0, i8** %3, align 8
  store i32 %1, i32* %4, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_236.cpp() #0 section ".text.startup" {
