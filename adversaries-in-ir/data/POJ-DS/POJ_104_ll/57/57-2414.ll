; ModuleID = 'POJ-104-source/57/57-2414.cpp'
source_filename = "POJ-104-source/57/57-2414.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_2414.cpp, i8* null }]
...
64:                                               ; preds = %44
  ...
  %69 = call i32 @strcmp(i8* %68, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0)) #6
  %70 = icmp eq i32 %69, 0
...
94:                                               ; preds = %88, %64
  ...
  %96 = call i32 @strcmp(i8* %95, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.4, i64 0, i64 0)) #6
  %97 = icmp eq i32 %96, 0
...
153:                                              ; preds = %133
  ...
  %158 = call i32 @strcmp(i8* %157, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.5, i64 0, i64 0)) #6
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_2414.cpp() #0 section ".text.startup" {
