; ModuleID = 'POJ-104-source/57/57-2424.cpp'
source_filename = "POJ-104-source/57/57-2424.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_2424.cpp, i8* null }]
...
24:                                               ; preds = %20
  ...
  %29 = call i8* @_Z3delPc(i8* %28)
  %30 = load i32, i32* %3, align 4
  %31 = sext i32 %30 to i64
  %32 = getelementptr inbounds [50 x [15 x i8]], [50 x [15 x i8]]* %4, i64 0, i64 %31
...
define dso_local i8* @_Z3delPc(i8* %0) #5 {
  %2 = alloca i8*, align 8
  %3 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_2424.cpp() #0 section ".text.startup" {
