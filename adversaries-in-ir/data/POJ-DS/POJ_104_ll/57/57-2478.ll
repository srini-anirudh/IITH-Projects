; ModuleID = 'POJ-104-source/57/57-2478.cpp'
source_filename = "POJ-104-source/57/57-2478.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_2478.cpp, i8* null }]
...
24:                                               ; preds = %16
  ...
  %32 = call i32 @strcmp(i8* %29, i8* %31) #7
  %33 = icmp eq i32 %32, 0
...
55:                                               ; preds = %52
  ...
  %63 = call i32 @strcmp(i8* %60, i8* %62) #7
  %64 = icmp eq i32 %63, 0
...
86:                                               ; preds = %83
  ...
  %94 = call i32 @strcmp(i8* %91, i8* %93) #7
  %95 = icmp eq i32 %94, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_2478.cpp() #0 section ".text.startup" {
