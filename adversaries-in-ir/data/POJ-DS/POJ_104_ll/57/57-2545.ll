; ModuleID = 'POJ-104-source/57/57-2545.cpp'
source_filename = "POJ-104-source/57/57-2545.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_2545.cpp, i8* null }]
...
28:                                               ; preds = %13
  ...
  %34 = call i8* @strncpy(i8* %29, i8* %30, i64 %33) #3
...
37:                                               ; preds = %13
  ...
  %43 = call i8* @strncpy(i8* %38, i8* %39, i64 %42) #3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_2545.cpp() #0 section ".text.startup" {
