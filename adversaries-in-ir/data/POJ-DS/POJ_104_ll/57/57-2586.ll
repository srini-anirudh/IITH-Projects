; ModuleID = 'POJ-104-source/57/57-2586.cpp'
source_filename = "POJ-104-source/57/57-2586.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_2586.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %8, i8* align 1 getelementptr inbounds ([1 x i8], [1 x i8]* @__const.main.p, i32 0, i32 0), i64 1, i1 false)
...
14:                                               ; preds = %10
  ...
  %25 = getelementptr inbounds [1 x i8], [1 x i8]* %7, i64 0, i64 0
  store i8 %24, i8* %25, align 1
  %26 = getelementptr inbounds [1 x i8], [1 x i8]* %7, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_2586.cpp() #0 section ".text.startup" {
