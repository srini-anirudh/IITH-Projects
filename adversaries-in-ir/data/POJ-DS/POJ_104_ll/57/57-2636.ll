; ModuleID = 'POJ-104-source/57/57-2636.cpp'
source_filename = "POJ-104-source/57/57-2636.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_2636.cpp, i8* null }]
...
67:                                               ; preds = %60
  ...
  %74 = getelementptr inbounds [100 x [20 x i8]], [100 x [20 x i8]]* %6, i64 0, i64 %73
...
118:                                              ; preds = %97
  ...
  %121 = getelementptr inbounds [100 x [20 x i8]], [100 x [20 x i8]]* %6, i64 0, i64 %120
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_2636.cpp() #0 section ".text.startup" {
