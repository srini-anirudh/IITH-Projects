; ModuleID = 'POJ-104-source/57/57-2669.cpp'
source_filename = "POJ-104-source/57/57-2669.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_2669.cpp, i8* null }]
...
27:                                               ; preds = %24, %11
  ...
  %33 = call i32 @strcmp(i8* %32, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0)) #6
  %34 = icmp eq i32 %33, 0
...
38:                                               ; preds = %35, %27
  ...
  %44 = call i32 @strcmp(i8* %43, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.4, i64 0, i64 0)) #6
  %45 = icmp eq i32 %44, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_2669.cpp() #0 section ".text.startup" {
