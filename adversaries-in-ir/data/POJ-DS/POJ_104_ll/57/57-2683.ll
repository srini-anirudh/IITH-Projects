; ModuleID = 'POJ-104-source/57/57-2683.cpp'
source_filename = "POJ-104-source/57/57-2683.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_2683.cpp, i8* null }]
...
42:                                               ; preds = %25
  ...
  %45 = getelementptr inbounds [50 x [100 x i8]], [50 x [100 x i8]]* %6, i64 0, i64 %44
...
61:                                               ; preds = %42, %25
  ...
  %64 = getelementptr inbounds [50 x [100 x i8]], [50 x [100 x i8]]* %6, i64 0, i64 %63
...
83:                                               ; preds = %72
  ...
  %86 = getelementptr inbounds [50 x [100 x i8]], [50 x [100 x i8]]* %6, i64 0, i64 %85
...
102:                                              ; preds = %91
  ...
  %105 = getelementptr inbounds [50 x [100 x i8]], [50 x [100 x i8]]* %6, i64 0, i64 %104
...
113:                                              ; preds = %102
  ...
  %116 = getelementptr inbounds [50 x [100 x i8]], [50 x [100 x i8]]* %6, i64 0, i64 %115
...
124:                                              ; preds = %113
  ...
  %127 = getelementptr inbounds [50 x [100 x i8]], [50 x [100 x i8]]* %6, i64 0, i64 %126
...
134:                                              ; preds = %133, %53
  ...
  %137 = getelementptr inbounds [50 x [100 x i8]], [50 x [100 x i8]]* %6, i64 0, i64 %136
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_2683.cpp() #0 section ".text.startup" {
