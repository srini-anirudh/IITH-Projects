; ModuleID = 'POJ-104-source/57/57-270.cpp'
source_filename = "POJ-104-source/57/57-270.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_270.cpp, i8* null }]
...
12:                                               ; preds = %8
  ...
  %26 = getelementptr inbounds [50 x [50 x i8]], [50 x [50 x i8]]* %5, i64 0, i64 %25
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_270.cpp() #0 section ".text.startup" {
