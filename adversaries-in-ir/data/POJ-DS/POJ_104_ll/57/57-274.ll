; ModuleID = 'POJ-104-source/57/57-274.cpp'
source_filename = "POJ-104-source/57/57-274.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_274.cpp, i8* null }]
...
27:                                               ; preds = %22
  ...
  call void @_Z2dePA50_ci([50 x i8]* %28, i32 %29)
  br label %30
...
define dso_local void @_Z2dePA50_ci([50 x i8]* %0, i32 %1) #6 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_274.cpp() #0 section ".text.startup" {
