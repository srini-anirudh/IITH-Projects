; ModuleID = 'POJ-104-source/57/57-309.cpp'
source_filename = "POJ-104-source/57/57-309.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_309.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z6changePc(i8* %0) #0 {
  %2 = alloca i8*, align 8
  ...
  %16 = call i8* @strncpy(i8* %11, i8* %12, i64 %15) #3
  %17 = getelementptr inbounds [15 x i8], [15 x i8]* %4, i64 0, i64 0
  %18 = call i8* @strcat(i8* %17, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0)) #3
...
23:                                               ; preds = %1
  ...
  %29 = call i8* @strncpy(i8* %24, i8* %25, i64 %28) #3
  br label %37
...
30:                                               ; preds = %1
  ...
  %36 = call i8* @strncpy(i8* %31, i8* %32, i64 %35) #3
  br label %37
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_309.cpp() #0 section ".text.startup" {
