; ModuleID = 'POJ-104-source/57/57-3103.cpp'
source_filename = "POJ-104-source/57/57-3103.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_3103.cpp, i8* null }]
...
13:                                               ; preds = %9
  ...
  %36 = getelementptr inbounds [3 x i8], [3 x i8]* %7, i64 0, i64 2
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_3103.cpp() #0 section ".text.startup" {
