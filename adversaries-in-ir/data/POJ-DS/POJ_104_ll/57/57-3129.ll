; ModuleID = 'POJ-104-source/57/57-3129.cpp'
source_filename = "POJ-104-source/57/57-3129.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_3129.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %8 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* %3)
...
80:                                               ; preds = %59
  ...
  %88 = call i8* @strncpy(i8* %82, i8* %84, i64 %87) #3
  ...
  %101 = call i32 @strcmp(i8* %98, i8* %100) #6
...
107:                                              ; preds = %80
  ...
  %115 = call i8* @strncpy(i8* %109, i8* %111, i64 %114) #3
  ...
  %123 = call i8* @strcat(i8* %122, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.5, i64 0, i64 0)) #3
  ...
  %128 = call i32 @strcmp(i8* %125, i8* %127) #6
...
134:                                              ; preds = %107
  ...
  %142 = call i8* @strncpy(i8* %136, i8* %138, i64 %141) #3
  ...
  %147 = call i8* @strcpy(i8* %144, i8* %146) #3
  ...
  %150 = call i8* @strcat(i8* %149, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.6, i64 0, i64 0)) #3
  ...
  %155 = call i32 @strcmp(i8* %152, i8* %154) #6
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_3129.cpp() #0 section ".text.startup" {
