; ModuleID = 'POJ-104-source/57/57-318.cpp'
source_filename = "POJ-104-source/57/57-318.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_318.cpp, i8* null }]
...
define dso_local i32 @_Z7cutsignPci(i8* %0, i32 %1) #4 {
...
12:                                               ; preds = %8
  ...
  %28 = call i32 @_Z7cutsignPci(i8* %21, i32 %27)
...
48:                                               ; preds = %41
  ...
  %51 = getelementptr inbounds [50 x [15 x i8]], [50 x [15 x i8]]* %6, i64 0, i64 %50
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_318.cpp() #0 section ".text.startup" {
