; ModuleID = 'POJ-104-source/57/57-3355.cpp'
source_filename = "POJ-104-source/57/57-3355.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_3355.cpp, i8* null }]
...
86:                                               ; preds = %78
  ...
  %91 = getelementptr inbounds [30 x i8], [30 x i8]* %2, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_3355.cpp() #0 section ".text.startup" {
