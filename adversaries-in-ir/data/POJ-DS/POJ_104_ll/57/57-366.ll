; ModuleID = 'POJ-104-source/57/57-366.cpp'
source_filename = "POJ-104-source/57/57-366.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_366.cpp, i8* null }]
...
163:                                              ; preds = %149, %113, %99
  %164 = load i32, i32* %3, align 4
  %165 = sext i32 %164 to i64
  %166 = getelementptr inbounds [50 x [50 x i8]], [50 x [50 x i8]]* %2, i64 0, i64 %165
...
177:                                              ; preds = %163
  ...
  %187 = getelementptr inbounds [50 x i8], [50 x i8]* %180, i64 0, i64 %186
...
191:                                              ; preds = %177
  ...
  %194 = getelementptr inbounds [50 x [50 x i8]], [50 x [50 x i8]]* %2, i64 0, i64 %193
  ...
  %201 = getelementptr inbounds [50 x i8], [50 x i8]* %194, i64 0, i64 %200
...
227:                                              ; preds = %206
  ...
  %230 = getelementptr inbounds [50 x [50 x i8]], [50 x [50 x i8]]* %2, i64 0, i64 %229
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_366.cpp() #0 section ".text.startup" {
