; ModuleID = 'POJ-104-source/57/57-403.cpp'
source_filename = "POJ-104-source/57/57-403.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_403.cpp, i8* null }]
...
36:                                               ; preds = %32
  ...
  %47 = getelementptr inbounds [100 x i8], [100 x i8]* %39, i64 0, i64 %46
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_403.cpp() #0 section ".text.startup" {
