; ModuleID = 'POJ-104-source/57/57-407.cpp'
source_filename = "POJ-104-source/57/57-407.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_407.cpp, i8* null }]
...
15:                                               ; preds = %11
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), [101 x i8]* %2)
...
64:                                               ; preds = %60
  ...
  %70 = call i8* @strncpy(i8* %65, i8* %66, i64 %69) #3
...
87:                                               ; preds = %83
  ...
  %93 = call i8* @strncpy(i8* %88, i8* %89, i64 %92) #3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_407.cpp() #0 section ".text.startup" {
