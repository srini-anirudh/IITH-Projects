; ModuleID = 'POJ-104-source/57/57-434.cpp'
source_filename = "POJ-104-source/57/57-434.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_434.cpp, i8* null }]
...
26:                                               ; preds = %22
  ...
  %38 = call i32 @_Z6changePci(i8* %36, i32 %37)
...
define dso_local i32 @_Z6changePci(i8* %0, i32 %1) #6 {
  %3 = alloca i8*, align 8
  %4 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_434.cpp() #0 section ".text.startup" {
