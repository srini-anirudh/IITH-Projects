; ModuleID = 'POJ-104-source/57/57-452.cpp'
source_filename = "POJ-104-source/57/57-452.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_452.cpp, i8* null }]
...
8:                                                ; preds = %4
  ...
  %11 = getelementptr inbounds [60 x [35 x i8]], [60 x [35 x i8]]* @eng, i64 0, i64 %10
  %12 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), [35 x i8]* %11)
  br label %13
...
define dso_local void @_Z6changei(i32 %0) #5 {
  %2 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_452.cpp() #0 section ".text.startup" {
