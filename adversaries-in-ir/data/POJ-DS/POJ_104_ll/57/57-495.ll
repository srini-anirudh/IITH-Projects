; ModuleID = 'POJ-104-source/57/57-495.cpp'
source_filename = "POJ-104-source/57/57-495.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_495.cpp, i8* null }]
...
37:                                               ; preds = %24
  ...
  call void @_Z4cut1Pci(i8* %38, i32 %39)
  br label %40
...
56:                                               ; preds = %48, %40
  ...
  call void @_Z4cut2Pci(i8* %57, i32 %58)
  br label %59
...
define dso_local void @_Z4cut1Pci(i8* %0, i32 %1) #6 {
  %3 = alloca i8*, align 8
  %4 = alloca i32, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z4cut2Pci(i8* %0, i32 %1) #6 {
  %3 = alloca i8*, align 8
  %4 = alloca i32, align 4
  store i8* %0, i8** %3, align 8
  store i32 %1, i32* %4, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_495.cpp() #0 section ".text.startup" {
