; ModuleID = 'POJ-104-source/57/57-507.cpp'
source_filename = "POJ-104-source/57/57-507.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_507.cpp, i8* null }]
...
14:                                               ; preds = %10
  ...
  %27 = call i8* @strncpy(i8* %22, i8* %23, i64 %26) #3
  %28 = getelementptr inbounds [32 x i8], [32 x i8]* %7, i64 0, i64 0
  %29 = call i8* @strcat(i8* %28, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0)) #3
...
34:                                               ; preds = %14
  ...
  %40 = call i8* @strncpy(i8* %35, i8* %36, i64 %39) #3
...
43:                                               ; preds = %14
  ...
  %49 = call i8* @strncpy(i8* %44, i8* %45, i64 %48) #3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_507.cpp() #0 section ".text.startup" {
