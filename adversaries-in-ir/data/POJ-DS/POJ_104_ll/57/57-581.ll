; ModuleID = 'POJ-104-source/57/57-581.cpp'
source_filename = "POJ-104-source/57/57-581.cpp"
...
@__const._Z3cutPc.word2 = private unnamed_addr constant <{ i8, [31 x i8] }> <{ i8 48, [31 x i8] zeroinitializer }>, align 16
@__const._Z3cutPc.word3 = private unnamed_addr constant <{ i8, [31 x i8] }> <{ i8 48, [31 x i8] zeroinitializer }>, align 16
@__const._Z3cutPc.word4 = private unnamed_addr constant <{ i8, [31 x i8] }> <{ i8 48, [31 x i8] zeroinitializer }>, align 16
@__const._Z3cutPc.word5 = private unnamed_addr constant <{ i8, [31 x i8] }> <{ i8 48, [31 x i8] zeroinitializer }>, align 16
@.str.3 = private unnamed_addr constant [3 x i8] c"er\00", align 1
@.str.4 = private unnamed_addr constant [3 x i8] c"ly\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_581.cpp, i8* null }]
...
define dso_local void @_Z3cutPc(i8* %0) #5 {
  %2 = alloca i8*, align 8
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %8, i8* align 16 getelementptr inbounds (<{ i8, [31 x i8] }>, <{ i8, [31 x i8] }>* @__const._Z3cutPc.word2, i32 0, i32 0), i64 32, i1 false)
  %9 = bitcast [32 x i8]* %4 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %9, i8* align 16 getelementptr inbounds (<{ i8, [31 x i8] }>, <{ i8, [31 x i8] }>* @__const._Z3cutPc.word3, i32 0, i32 0), i64 32, i1 false)
  %10 = bitcast [32 x i8]* %5 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %10, i8* align 16 getelementptr inbounds (<{ i8, [31 x i8] }>, <{ i8, [31 x i8] }>* @__const._Z3cutPc.word4, i32 0, i32 0), i64 32, i1 false)
  %11 = bitcast [32 x i8]* %6 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %11, i8* align 16 getelementptr inbounds (<{ i8, [31 x i8] }>, <{ i8, [31 x i8] }>* @__const._Z3cutPc.word5, i32 0, i32 0), i64 32, i1 false)
  ...
  %20 = call i8* @strncpy(i8* %15, i8* %16, i64 %19) #3
  ...
  %28 = call i8* @strcat(i8* %27, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0)) #3
...
32:                                               ; preds = %1
  ...
  %34 = call i8* @strcat(i8* %33, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.4, i64 0, i64 0)) #3
...
42:                                               ; preds = %32
  ...
  %48 = call i8* @strncpy(i8* %43, i8* %44, i64 %47) #3
  br label %49
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_581.cpp() #0 section ".text.startup" {
