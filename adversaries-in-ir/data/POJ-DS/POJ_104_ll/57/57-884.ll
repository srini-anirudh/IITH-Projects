; ModuleID = 'POJ-104-source/57/57-884.cpp'
source_filename = "POJ-104-source/57/57-884.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_57_884.cpp, i8* null }]
...
11:                                               ; preds = %7
  ...
  %15 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), [33 x i8]* %14)
  br label %16
...
24:                                               ; preds = %20
  ...
  %38 = call i32 @strcmp(i8* %37, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0)) #6
  %39 = icmp eq i32 %38, 0
...
51:                                               ; preds = %40, %24
  ...
  %59 = call i32 @strcmp(i8* %58, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0)) #6
  %60 = icmp eq i32 %59, 0
...
72:                                               ; preds = %61, %51
  ...
  %80 = call i32 @strcmp(i8* %79, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.4, i64 0, i64 0)) #6
  %81 = icmp eq i32 %80, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_57_884.cpp() #0 section ".text.startup" {
