; ModuleID = 'POJ-104-source/58/58-1278.cpp'
source_filename = "POJ-104-source/58/58-1278.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_58_1278.cpp, i8* null }]
...
59:                                               ; preds = %116, %58
  ...
  %62 = call i64 @strlen(i8* getelementptr inbounds ([100 x i8], [100 x i8]* @s, i64 0, i64 0)) #6
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_58_1278.cpp() #0 section ".text.startup" {
