; ModuleID = 'POJ-104-source/58/58-150.cpp'
source_filename = "POJ-104-source/58/58-150.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_58_150.cpp, i8* null }]
...
100:                                              ; preds = %95
  %101 = getelementptr inbounds [81 x i8], [81 x i8]* %2, i64 0, i64 0
...
135:                                              ; preds = %130, %125, %120, %115, %110, %105, %100, %95, %90, %85
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_58_150.cpp() #0 section ".text.startup" {
