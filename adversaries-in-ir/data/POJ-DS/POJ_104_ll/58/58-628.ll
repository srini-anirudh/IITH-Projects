; ModuleID = 'POJ-104-source/58/58-628.cpp'
source_filename = "POJ-104-source/58/58-628.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_58_628.cpp, i8* null }]
...
131:                                              ; preds = %125
  %132 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8 signext 49)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_58_628.cpp() #0 section ".text.startup" {
