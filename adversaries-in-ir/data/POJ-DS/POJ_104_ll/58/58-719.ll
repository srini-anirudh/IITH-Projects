; ModuleID = 'POJ-104-source/58/58-719.cpp'
source_filename = "POJ-104-source/58/58-719.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_58_719.cpp, i8* null }]
...
define dso_local i32 @_Z5checkv() #4 {
...
21:                                               ; preds = %11
  ...
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([100 x i8], [100 x i8]* @s, i64 0, i64 0))
  br label %23
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_58_719.cpp() #0 section ".text.startup" {
