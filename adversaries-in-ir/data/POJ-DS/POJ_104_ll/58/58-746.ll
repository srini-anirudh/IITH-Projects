; ModuleID = 'POJ-104-source/58/58-746.cpp'
source_filename = "POJ-104-source/58/58-746.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_58_746.cpp, i8* null }]
...
10:                                               ; preds = %6
  call void @llvm.memset.p0i8.i64(i8* align 16 getelementptr inbounds ([1000 x i8], [1000 x i8]* @a, i64 0, i64 0), i8 0, i64 1000, i1 false)
  %11 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSi7getlineEPcl(%"class.std::basic_istream"* @_ZSt3cin, i8* getelementptr inbounds ([1000 x i8], [1000 x i8]* @a, i64 0, i64 0), i64 1000)
...
define dso_local i32 @_Z5Judgev() #6 {
  %1 = alloca i32, align 4
  %2 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_58_746.cpp() #0 section ".text.startup" {
