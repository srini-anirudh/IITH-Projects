; ModuleID = 'POJ-104-source/59/59-1027.cpp'
source_filename = "POJ-104-source/59/59-1027.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_59_1027.cpp, i8* null }]
...
58:                                               ; preds = %42
  ...
  %66 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0))
  br label %67
...
70:                                               ; preds = %32
  %71 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i32* %3)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_59_1027.cpp() #0 section ".text.startup" {
