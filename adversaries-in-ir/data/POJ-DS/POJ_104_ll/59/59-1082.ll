; ModuleID = 'POJ-104-source/59/59-1082.cpp'
source_filename = "POJ-104-source/59/59-1082.cpp"
...
@day = dso_local global [100 x [100 x i32]] zeroinitializer, align 16
@n = dso_local global i32 0, align 4
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [3 x i8] c"%s\00", align 1
@.str.2 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_59_1082.cpp, i8* null }]
...
define dso_local i32 @_Z4Sickiii(i32 %0, i32 %1, i32 %2) #4 {
...
13:                                               ; preds = %9
  %14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), [100 x i8]* %2)
  store i32 0, i32* %4, align 4
  br label %15
...
57:                                               ; preds = %9
  %58 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %6)
  store i32 1, i32* %5, align 4
  br label %59
...
83:                                               ; preds = %73
  ...
  %87 = call i32 @_Z4Sickiii(i32 %84, i32 %85, i32 %86)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_59_1082.cpp() #0 section ".text.startup" {
