; ModuleID = 'POJ-104-source/59/59-1170.cpp'
source_filename = "POJ-104-source/59/59-1170.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_59_1170.cpp, i8* null }]
...
80:                                               ; preds = %70
  ...
  %87 = getelementptr inbounds [110 x i32], [110 x i32]* %83, i64 0, i64 %86
...
103:                                              ; preds = %93
  ...
  %110 = getelementptr inbounds [110 x i32], [110 x i32]* %106, i64 0, i64 %109
...
112:                                              ; preds = %111, %14
  ...
  %115 = getelementptr inbounds [110 x [110 x i32]], [110 x [110 x i32]]* @a, i64 0, i64 %114
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_59_1170.cpp() #0 section ".text.startup" {
