; ModuleID = 'POJ-104-source/59/59-1229.cpp'
source_filename = "POJ-104-source/59/59-1229.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_59_1229.cpp, i8* null }]
...
61:                                               ; preds = %57
  ...
  %66 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* %65)
  br label %67
...
70:                                               ; preds = %57
  %71 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %4)
  store i32 0, i32* %3, align 4
  br label %72
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_59_1229.cpp() #0 section ".text.startup" {
