; ModuleID = 'POJ-104-source/59/59-1242.cpp'
source_filename = "POJ-104-source/59/59-1242.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_59_1242.cpp, i8* null }]
...
16:                                               ; preds = %12
  ...
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), [101 x i8]* %19)
  br label %21
...
70:                                               ; preds = %25
  %71 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %6)
  store i32 0, i32* %3, align 4
  br label %72
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_59_1242.cpp() #0 section ".text.startup" {
