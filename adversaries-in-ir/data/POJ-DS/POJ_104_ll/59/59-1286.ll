; ModuleID = 'POJ-104-source/59/59-1286.cpp'
source_filename = "POJ-104-source/59/59-1286.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_59_1286.cpp, i8* null }]
...
277:                                              ; preds = %269, %258
  ...
  %280 = getelementptr inbounds [100 x [100 x i8]], [100 x [100 x i8]]* %8, i64 0, i64 %279
...
337:                                              ; preds = %333
  ...
  %346 = icmp eq i32 %345, 42
  br i1 %346, label %347, label %354

347:                                              ; preds = %337
  %348 = load i32, i32* %3, align 4
  %349 = sext i32 %348 to i64
  %350 = getelementptr inbounds [100 x [100 x i8]], [100 x [100 x i8]]* %8, i64 0, i64 %349
...
397:                                              ; preds = %367
  ...
  %399 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32 %398)
  br label %400
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_59_1286.cpp() #0 section ".text.startup" {
