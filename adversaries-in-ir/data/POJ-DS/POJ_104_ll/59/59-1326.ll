; ModuleID = 'POJ-104-source/59/59-1326.cpp'
source_filename = "POJ-104-source/59/59-1326.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_59_1326.cpp, i8* null }]
...
16:                                               ; preds = %3
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* @m)
  call void @_Z2crPA101_c([101 x i8]* getelementptr inbounds ([100 x [101 x i8]], [100 x [101 x i8]]* @a, i64 0, i64 0))
  store i32 0, i32* @i, align 4
  br label %18
...
; Function Attrs: noinline uwtable
define dso_local void @_Z2crPA101_c([101 x i8]* %0) #0 {
...
151:                                              ; preds = %146
  ...
  call void @_Z2crPA101_c([101 x i8]* %152)
  br label %153
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_59_1326.cpp() #0 section ".text.startup" {
