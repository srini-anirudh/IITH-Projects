; ModuleID = 'POJ-104-source/59/59-1419.cpp'
source_filename = "POJ-104-source/59/59-1419.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_59_1419.cpp, i8* null }]
...
56:                                               ; preds = %15
  %57 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %3)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_59_1419.cpp() #0 section ".text.startup" {
