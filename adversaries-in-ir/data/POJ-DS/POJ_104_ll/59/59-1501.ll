; ModuleID = 'POJ-104-source/59/59-1501.cpp'
source_filename = "POJ-104-source/59/59-1501.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_59_1501.cpp, i8* null }]
...
138:                                              ; preds = %127
  ...
  %142 = getelementptr inbounds [101 x [101 x i8]], [101 x [101 x i8]]* %5, i64 0, i64 %141
...
164:                                              ; preds = %153
  ...
  %167 = getelementptr inbounds [101 x [101 x i8]], [101 x [101 x i8]]* %5, i64 0, i64 %166
...
188:                                              ; preds = %47
  %189 = getelementptr inbounds [101 x [101 x i32]], [101 x [101 x i32]]* %4, i64 0, i64 0
  %190 = bitcast [101 x i32]* %189 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 16 %190, i8 0, i64 40804, i1 false)
  br label %191
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_59_1501.cpp() #0 section ".text.startup" {
