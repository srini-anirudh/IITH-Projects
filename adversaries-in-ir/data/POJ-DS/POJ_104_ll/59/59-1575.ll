; ModuleID = 'POJ-104-source/59/59-1575.cpp'
source_filename = "POJ-104-source/59/59-1575.cpp"
...
@a = dso_local global [210 x [210 x i8]] zeroinitializer, align 16
...
@_ZZ4mainE5temp1 = internal global [40010 x i32] zeroinitializer, align 16
@_ZZ4mainE5temp2 = internal global [40010 x i32] zeroinitializer, align 16
@_ZZ4mainE1r = internal global i32 0, align 4
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_59_1575.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local signext i8 @_Z8getACharv() #0 {
...
define dso_local i32 @main() #4 {
  ...
  %2 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* @_ZZ4mainE1n)
...
12:                                               ; preds = %8
  %13 = call signext i8 @_Z8getACharv()
  %14 = load i32, i32* @_ZZ4mainE1i, align 4
  %15 = sext i32 %14 to i64
  %16 = getelementptr inbounds [210 x [210 x i8]], [210 x [210 x i8]]* @a, i64 0, i64 %15
  %17 = load i32, i32* @_ZZ4mainE1j, align 4
...
27:                                               ; preds = %3
  %28 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* @_ZZ4mainE1m)
...
53:                                               ; preds = %43
  ...
  %57 = getelementptr inbounds [40010 x i32], [40010 x i32]* @_ZZ4mainE5temp1, i64 0, i64 %56
  store i32 %54, i32* %57, align 4
  %58 = load i32, i32* @_ZZ4mainE1j, align 4
  %59 = load i32, i32* @_ZZ4mainE1r, align 4
  %60 = sext i32 %59 to i64
  %61 = getelementptr inbounds [40010 x i32], [40010 x i32]* @_ZZ4mainE5temp2, i64 0, i64 %60
...
77:                                               ; preds = %73
  ...
  %80 = getelementptr inbounds [40010 x i32], [40010 x i32]* @_ZZ4mainE5temp1, i64 0, i64 %79
  %81 = load i32, i32* %80, align 4
  store i32 %81, i32* @_ZZ4mainE1i, align 4
  %82 = load i32, i32* @_ZZ4mainE1g, align 4
  %83 = sext i32 %82 to i64
  %84 = getelementptr inbounds [40010 x i32], [40010 x i32]* @_ZZ4mainE5temp2, i64 0, i64 %83
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_59_1575.cpp() #0 section ".text.startup" {
