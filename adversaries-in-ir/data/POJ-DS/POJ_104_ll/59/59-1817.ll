; ModuleID = 'POJ-104-source/59/59-1817.cpp'
source_filename = "POJ-104-source/59/59-1817.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_59_1817.cpp, i8* null }]
...
24:                                               ; preds = %20
  ...
  %31 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i8* %30)
...
52:                                               ; preds = %15
  %53 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* %7)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_59_1817.cpp() #0 section ".text.startup" {
