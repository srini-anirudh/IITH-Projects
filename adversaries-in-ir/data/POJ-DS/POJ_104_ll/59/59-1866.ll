; ModuleID = 'POJ-104-source/59/59-1866.cpp'
source_filename = "POJ-104-source/59/59-1866.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_59_1866.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %11 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0))
...
49:                                               ; preds = %17
  %50 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0))
  br label %51
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_59_1866.cpp() #0 section ".text.startup" {
