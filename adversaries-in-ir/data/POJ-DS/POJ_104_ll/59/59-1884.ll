; ModuleID = 'POJ-104-source/59/59-1884.cpp'
source_filename = "POJ-104-source/59/59-1884.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_59_1884.cpp, i8* null }]
...
106:                                              ; preds = %61
  %107 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i8* %3)
...
147:                                              ; preds = %55
  %148 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i32* %11)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_59_1884.cpp() #0 section ".text.startup" {
