; ModuleID = 'POJ-104-source/59/59-1893.cpp'
source_filename = "POJ-104-source/59/59-1893.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_59_1893.cpp, i8* null }]
...
67:                                               ; preds = %36
  %68 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i32* %6)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_59_1893.cpp() #0 section ".text.startup" {
