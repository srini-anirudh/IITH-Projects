; ModuleID = 'POJ-104-source/59/59-1935.cpp'
source_filename = "POJ-104-source/59/59-1935.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_59_1935.cpp, i8* null }]
...
31:                                               ; preds = %26
  %32 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0))
...
37:                                               ; preds = %33
  ...
  %45 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i8* %44)
  br label %46
...
53:                                               ; preds = %26
  %54 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %5)
  store i32 1, i32* %4, align 4
  br label %55
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_59_1935.cpp() #0 section ".text.startup" {
