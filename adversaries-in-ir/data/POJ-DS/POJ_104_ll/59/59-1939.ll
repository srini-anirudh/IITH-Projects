; ModuleID = 'POJ-104-source/59/59-1939.cpp'
source_filename = "POJ-104-source/59/59-1939.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_59_1939.cpp, i8* null }]
...
80:                                               ; preds = %75
  ...
  %87 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i8* %86)
  br label %88
...
95:                                               ; preds = %69
  %96 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %4)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_59_1939.cpp() #0 section ".text.startup" {
