; ModuleID = 'POJ-104-source/59/59-1940.cpp'
source_filename = "POJ-104-source/59/59-1940.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_59_1940.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %10 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* %8)
...
48:                                               ; preds = %16
  %49 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0))
  br label %50
...
53:                                               ; preds = %11
  %54 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i32* %7)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_59_1940.cpp() #0 section ".text.startup" {
