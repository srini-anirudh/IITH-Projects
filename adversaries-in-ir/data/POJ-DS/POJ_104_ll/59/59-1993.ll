; ModuleID = 'POJ-104-source/59/59-1993.cpp'
source_filename = "POJ-104-source/59/59-1993.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_59_1993.cpp, i8* null }]
...
45:                                               ; preds = %41
  ...
  %52 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i8* %51)
  br label %53
...
56:                                               ; preds = %41
  ...
  %63 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i8* %62)
  br label %64
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_59_1993.cpp() #0 section ".text.startup" {
