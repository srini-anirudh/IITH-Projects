; ModuleID = 'POJ-104-source/59/59-209.cpp'
source_filename = "POJ-104-source/59/59-209.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_59_209.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %13, i8* align 16 bitcast ([4 x i32]* @__const.main.x to i8*), i64 16, i1 false)
  %14 = bitcast [4 x i32]* %9 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %14, i8* align 16 bitcast ([4 x i32]* @__const.main.y to i8*), i64 16, i1 false)
...
64:                                               ; preds = %56
  ...
  %68 = getelementptr inbounds [4 x i32], [4 x i32]* %8, i64 0, i64 %67
...
164:                                              ; preds = %160
  ...
  %167 = getelementptr inbounds [100 x [100 x i8]], [100 x [100 x i8]]* %4, i64 0, i64 %166
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_59_209.cpp() #0 section ".text.startup" {
