; ModuleID = 'POJ-104-source/59/59-280.cpp'
source_filename = "POJ-104-source/59/59-280.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_59_280.cpp, i8* null }]
...
41:                                               ; preds = %36
  ...
  %52 = getelementptr inbounds [102 x i8], [102 x i8]* %48, i64 0, i64 %51
...
62:                                               ; preds = %57
  %63 = getelementptr inbounds [102 x [102 x i8]], [102 x [102 x i8]]* %2, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_59_280.cpp() #0 section ".text.startup" {
