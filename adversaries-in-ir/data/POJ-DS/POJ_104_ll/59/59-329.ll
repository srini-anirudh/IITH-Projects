; ModuleID = 'POJ-104-source/59/59-329.cpp'
source_filename = "POJ-104-source/59/59-329.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_59_329.cpp, i8* null }]
...
define dso_local i32 @_Z1pPA200_c([200 x i8]* %0) #4 {
...
50:                                               ; preds = %9
  ...
  %53 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* @m)
...
100:                                              ; preds = %96
  ...
  %102 = call i32 @_Z1pPA200_c([200 x i8]* %101)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_59_329.cpp() #0 section ".text.startup" {
