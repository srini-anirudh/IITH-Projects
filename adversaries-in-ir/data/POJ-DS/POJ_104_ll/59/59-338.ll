; ModuleID = 'POJ-104-source/59/59-338.cpp'
source_filename = "POJ-104-source/59/59-338.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_59_338.cpp, i8* null }]
...
24:                                               ; preds = %19
  ...
  %27 = getelementptr inbounds [101 x [101 x i8]], [101 x [101 x i8]]* %7, i64 0, i64 %26
...
32:                                               ; preds = %19
  ...
  %35 = getelementptr inbounds [101 x [101 x i8]], [101 x [101 x i8]]* %7, i64 0, i64 %34
...
54:                                               ; preds = %10
  %55 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i32* %3)
  br label %56
...
59:                                               ; preds = %56
  ...
  %61 = getelementptr inbounds [101 x [101 x i8]], [101 x [101 x i8]]* %7, i64 0, i64 0
  %62 = getelementptr inbounds [101 x [101 x i32]], [101 x [101 x i32]]* %8, i64 0, i64 0
  call void @_Z1fiPA101_cPA101_i(i32 %60, [101 x i8]* %61, [101 x i32]* %62)
...
define dso_local void @_Z1fiPA101_cPA101_i(i32 %0, [101 x i8]* %1, [101 x i32]* %2) #5 {
  %4 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_59_338.cpp() #0 section ".text.startup" {
