; ModuleID = 'POJ-104-source/59/59-342.cpp'
source_filename = "POJ-104-source/59/59-342.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_59_342.cpp, i8* null }]
...
23:                                               ; preds = %19
  ...
  %37 = call i32 @strcmp(i8* %32, i8* %36) #6
  br label %38
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_59_342.cpp() #0 section ".text.startup" {
