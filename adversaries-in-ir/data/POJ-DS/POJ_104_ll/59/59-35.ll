; ModuleID = 'POJ-104-source/59/59-35.cpp'
source_filename = "POJ-104-source/59/59-35.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_59_35.cpp, i8* null }]
...
276:                                              ; preds = %272
  ...
  %279 = getelementptr inbounds [100 x [100 x i8]], [100 x [100 x i8]]* %3, i64 0, i64 %278
...
332:                                              ; preds = %302
  ...
  %334 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32 %333)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_59_35.cpp() #0 section ".text.startup" {
