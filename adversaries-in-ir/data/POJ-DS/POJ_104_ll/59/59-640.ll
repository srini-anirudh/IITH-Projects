; ModuleID = 'POJ-104-source/59/59-640.cpp'
source_filename = "POJ-104-source/59/59-640.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_59_640.cpp, i8* null }]
...
49:                                               ; preds = %43
  ...
  %52 = getelementptr inbounds [110 x [110 x i32]], [110 x [110 x i32]]* %2, i64 0, i64 %51
...
106:                                              ; preds = %95
  ...
  %110 = getelementptr inbounds [110 x [110 x i32]], [110 x [110 x i32]]* %2, i64 0, i64 %109
...
142:                                              ; preds = %132
  ...
  %150 = getelementptr inbounds [110 x i32], [110 x i32]* %146, i64 0, i64 %149
...
213:                                              ; preds = %209
  ...
  %216 = getelementptr inbounds [110 x [110 x i32]], [110 x [110 x i32]]* %2, i64 0, i64 %215
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_59_640.cpp() #0 section ".text.startup" {
