; ModuleID = 'POJ-104-source/59/59-962.cpp'
source_filename = "POJ-104-source/59/59-962.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_59_962.cpp, i8* null }]
...
254:                                              ; preds = %250
  ...
  %257 = getelementptr inbounds [100 x [100 x i8]], [100 x [100 x i8]]* %5, i64 0, i64 %256
  ...
  %264 = getelementptr inbounds [100 x [100 x i8]], [100 x [100 x i8]]* %6, i64 0, i64 %263
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_59_962.cpp() #0 section ".text.startup" {
