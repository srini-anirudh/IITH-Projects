; ModuleID = 'POJ-104-source/6/6-1234.cpp'
source_filename = "POJ-104-source/6/6-1234.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_6_1234.cpp, i8* null }]
...
48:                                               ; preds = %44
  %49 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %5, i64 0, i64 1
...
123:                                              ; preds = %103
  ...
  %128 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %5, i64 0, i64 1
  ...
  %135 = getelementptr inbounds [100 x i32], [100 x i32]* %134, i64 0, i64 1
  %136 = load i32, i32* %135, align 4
  %137 = sub nsw i32 %131, %136
  %138 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %5, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_6_1234.cpp() #0 section ".text.startup" {
