; ModuleID = 'POJ-104-source/6/6-1302.cpp'
source_filename = "POJ-104-source/6/6-1302.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_6_1302.cpp, i8* null }]
...
76:                                               ; preds = %72
  %77 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %6, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_6_1302.cpp() #0 section ".text.startup" {
