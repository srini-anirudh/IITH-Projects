; ModuleID = 'POJ-104-source/6/6-140.cpp'
source_filename = "POJ-104-source/6/6-140.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_6_140.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %3 = alloca i32, align 4
  store i32 0, i32* %1, align 4
  %4 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %3)
  store i32 0, i32* %2, align 4
  br label %5
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_6_140.cpp() #0 section ".text.startup" {
