; ModuleID = 'POJ-104-source/6/6-18.cpp'
source_filename = "POJ-104-source/6/6-18.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_6_18.cpp, i8* null }]
...
49:                                               ; preds = %45
  ...
  %59 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %2, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_6_18.cpp() #0 section ".text.startup" {
