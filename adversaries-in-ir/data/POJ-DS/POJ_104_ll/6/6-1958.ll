; ModuleID = 'POJ-104-source/6/6-1958.cpp'
source_filename = "POJ-104-source/6/6-1958.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_6_1958.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %3, i32* %4)
...
54:                                               ; preds = %39
  %55 = getelementptr inbounds [10000 x i32], [10000 x i32]* %2, i64 0, i64 0
...
59:                                               ; preds = %74, %54
  ...
  %61 = getelementptr inbounds [10000 x i32], [10000 x i32]* %2, i64 0, i64 0
...
79:                                               ; preds = %59
  %80 = getelementptr inbounds [10000 x i32], [10000 x i32]* %2, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_6_1958.cpp() #0 section ".text.startup" {
