; ModuleID = 'POJ-104-source/6/6-2005.cpp'
source_filename = "POJ-104-source/6/6-2005.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_6_2005.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z6juzhenii(i32 %0, i32 %1) #0 {
...
11:                                               ; preds = %7
  %12 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), i32* %4, i32* %5)
  %13 = load i32, i32* %4, align 4
  %14 = load i32, i32* %5, align 4
  call void @_Z6juzhenii(i32 %13, i32 %14)
  br label %15
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_6_2005.cpp() #0 section ".text.startup" {
