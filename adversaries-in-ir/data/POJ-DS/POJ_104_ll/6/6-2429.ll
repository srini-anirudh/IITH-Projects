; ModuleID = 'POJ-104-source/6/6-2429.cpp'
source_filename = "POJ-104-source/6/6-2429.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_6_2429.cpp, i8* null }]
...
19:                                               ; preds = %15
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %7, i32* %8)
...
42:                                               ; preds = %30
  %43 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0))
  br label %44
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_6_2429.cpp() #0 section ".text.startup" {
