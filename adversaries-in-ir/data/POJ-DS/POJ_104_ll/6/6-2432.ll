; ModuleID = 'POJ-104-source/6/6-2432.cpp'
source_filename = "POJ-104-source/6/6-2432.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_6_2432.cpp, i8* null }]
...
18:                                               ; preds = %14
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %9, i32* %10)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_6_2432.cpp() #0 section ".text.startup" {
