; ModuleID = 'POJ-104-source/6/6-2436.cpp'
source_filename = "POJ-104-source/6/6-2436.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_6_2436.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z2mkv() #0 {
  ...
  %8 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %1, i32* %2)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_6_2436.cpp() #0 section ".text.startup" {
