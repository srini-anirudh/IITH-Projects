; ModuleID = 'POJ-104-source/6/6-2477.cpp'
source_filename = "POJ-104-source/6/6-2477.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_6_2477.cpp, i8* null }]
...
define dso_local i32 @_Z3sumPA100_iii([100 x i32]* %0, i32 %1, i32 %2) #6 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_6_2477.cpp() #0 section ".text.startup" {
