; ModuleID = 'POJ-104-source/6/6-2495.cpp'
source_filename = "POJ-104-source/6/6-2495.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_6_2495.cpp, i8* null }]
...
11:                                               ; preds = %7
  ...
  %15 = call i32 @_Z4bianii(i32 %13, i32 %14)
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z4bianii(i32 %0, i32 %1) #0 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_6_2495.cpp() #0 section ".text.startup" {
