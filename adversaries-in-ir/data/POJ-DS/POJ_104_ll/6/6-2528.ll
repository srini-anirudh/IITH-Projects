; ModuleID = 'POJ-104-source/6/6-2528.cpp'
source_filename = "POJ-104-source/6/6-2528.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_6_2528.cpp, i8* null }]
...
38:                                               ; preds = %17
  %39 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %5, i32* %6)
  store i32 0, i32* %2, align 4
  br label %40
...
49:                                               ; preds = %45
  ...
  %56 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i32* %55)
  br label %57
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_6_2528.cpp() #0 section ".text.startup" {
