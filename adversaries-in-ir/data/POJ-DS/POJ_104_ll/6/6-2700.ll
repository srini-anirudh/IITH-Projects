; ModuleID = 'POJ-104-source/6/6-2700.cpp'
source_filename = "POJ-104-source/6/6-2700.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_6_2700.cpp, i8* null }]
...
31:                                               ; preds = %24
  %32 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %9)
...
50:                                               ; preds = %46
  ...
  %58 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %57)
  br label %59
...
9:                                                ; preds = %6
  %10 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %2, i32* %3)
  %11 = load i32, i32* %2, align 4
  %12 = load i32, i32* %3, align 4
  %13 = call i32 @_Z3sumii(i32 %11, i32 %12)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_6_2700.cpp() #0 section ".text.startup" {
