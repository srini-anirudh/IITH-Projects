; ModuleID = 'POJ-104-source/6/6-276.cpp'
source_filename = "POJ-104-source/6/6-276.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_6_276.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z8bianyuanii(i32 %0, i32 %1) #0 {
...
12:                                               ; preds = %8
  %13 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %5, i32* %6)
  %14 = load i32, i32* %5, align 4
  %15 = load i32, i32* %6, align 4
  %16 = call i32 @_Z8bianyuanii(i32 %14, i32 %15)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_6_276.cpp() #0 section ".text.startup" {
