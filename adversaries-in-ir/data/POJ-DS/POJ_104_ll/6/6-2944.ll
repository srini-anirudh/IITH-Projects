; ModuleID = 'POJ-104-source/6/6-2944.cpp'
source_filename = "POJ-104-source/6/6-2944.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_6_2944.cpp, i8* null }]
...
48:                                               ; preds = %19
  ...
  %55 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %51, i32* %54)
  store i32 0, i32* %4, align 4
  br label %56
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_6_2944.cpp() #0 section ".text.startup" {
