; ModuleID = 'POJ-104-source/6/6-3018.cpp'
source_filename = "POJ-104-source/6/6-3018.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_6_3018.cpp, i8* null }]
...
20:                                               ; preds = %16
  ...
  store i32 0, i32* %11, align 4
  store i32 0, i32* %12, align 4
  %21 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %5, i32* %4)
...
73:                                               ; preds = %69
  ...
  %81 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %80)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_6_3018.cpp() #0 section ".text.startup" {
