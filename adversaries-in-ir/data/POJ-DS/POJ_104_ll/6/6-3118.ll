; ModuleID = 'POJ-104-source/6/6-3118.cpp'
source_filename = "POJ-104-source/6/6-3118.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_6_3118.cpp, i8* null }]
...
18:                                               ; preds = %14
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %5, i32* %6)
...
25:                                               ; preds = %22
  %26 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %7)
...
59:                                               ; preds = %42
  ...
  %68 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i32* %67)
  br label %69
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_6_3118.cpp() #0 section ".text.startup" {
