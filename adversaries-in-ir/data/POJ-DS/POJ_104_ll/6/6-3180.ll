; ModuleID = 'POJ-104-source/6/6-3180.cpp'
source_filename = "POJ-104-source/6/6-3180.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_6_3180.cpp, i8* null }]
...
31:                                               ; preds = %27
  ...
  %40 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i64 0, i64 0), i32* %39)
  br label %41
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_6_3180.cpp() #0 section ".text.startup" {
