; ModuleID = 'POJ-104-source/6/6-3474.cpp'
source_filename = "POJ-104-source/6/6-3474.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_6_3474.cpp, i8* null }]
...
17:                                               ; preds = %13
  store i32 0, i32* %11, align 4
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %3, i32* %4)
...
29:                                               ; preds = %25
  ...
  %32 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %30)
  br label %33
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_6_3474.cpp() #0 section ".text.startup" {
