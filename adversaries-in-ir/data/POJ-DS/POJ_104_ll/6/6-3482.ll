; ModuleID = 'POJ-104-source/6/6-3482.cpp'
source_filename = "POJ-104-source/6/6-3482.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_6_3482.cpp, i8* null }]
...
89:                                               ; preds = %65
  %90 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %8, i64 0, i64 0
  ...
  %103 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %8, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_6_3482.cpp() #0 section ".text.startup" {
