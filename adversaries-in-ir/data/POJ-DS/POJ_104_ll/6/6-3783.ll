; ModuleID = 'POJ-104-source/6/6-3783.cpp'
source_filename = "POJ-104-source/6/6-3783.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_6_3783.cpp, i8* null }]
...
24:                                               ; preds = %17
  ...
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %4, i32* %3)
...
31:                                               ; preds = %28
  %32 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %7, i64 0, i64 0
...
98:                                               ; preds = %94
  ...
  %105 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %104)
  br label %106
...
207:                                              ; preds = %203
  ...
  %212 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %211)
  br label %213
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_6_3783.cpp() #0 section ".text.startup" {
