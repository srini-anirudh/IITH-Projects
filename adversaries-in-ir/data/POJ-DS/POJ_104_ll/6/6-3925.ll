; ModuleID = 'POJ-104-source/6/6-3925.cpp'
source_filename = "POJ-104-source/6/6-3925.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_6_3925.cpp, i8* null }]
...
38:                                               ; preds = %17
  %39 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %5, i32* %7)
...
45:                                               ; preds = %42
  %46 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %9)
...
60:                                               ; preds = %56
  ...
  %65 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %64)
...
90:                                               ; preds = %86
  ...
  %95 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %94)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_6_3925.cpp() #0 section ".text.startup" {
