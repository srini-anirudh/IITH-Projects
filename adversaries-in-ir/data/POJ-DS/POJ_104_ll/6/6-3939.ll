; ModuleID = 'POJ-104-source/6/6-3939.cpp'
source_filename = "POJ-104-source/6/6-3939.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_6_3939.cpp, i8* null }]
...
102:                                              ; preds = %99
  %103 = getelementptr inbounds [101 x [101 x i32]], [101 x [101 x i32]]* %9, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_6_3939.cpp() #0 section ".text.startup" {
