; ModuleID = 'POJ-104-source/6/6-3971.cpp'
source_filename = "POJ-104-source/6/6-3971.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_6_3971.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %10 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i64* %6)
...
15:                                               ; preds = %11
  ...
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i64* %3, i64* %4)
...
105:                                              ; preds = %101
  ...
  %110 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %109)
  br label %111
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_6_3971.cpp() #0 section ".text.startup" {
