; ModuleID = 'POJ-104-source/6/6-4031.cpp'
source_filename = "POJ-104-source/6/6-4031.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_6_4031.cpp, i8* null }]
...
22:                                               ; preds = %18
  ...
  %25 = getelementptr inbounds [105 x [105 x i32]], [105 x [105 x i32]]* @arr, i64 0, i64 %24
...
45:                                               ; preds = %40, %37, %32, %22
  ...
  %48 = getelementptr inbounds [105 x [105 x i32]], [105 x [105 x i32]]* @arr, i64 0, i64 %47
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_6_4031.cpp() #0 section ".text.startup" {
