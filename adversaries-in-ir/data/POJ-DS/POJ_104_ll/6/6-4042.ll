; ModuleID = 'POJ-104-source/6/6-4042.cpp'
source_filename = "POJ-104-source/6/6-4042.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_6_4042.cpp, i8* null }]
...
25:                                               ; preds = %21
  ...
  store i32 0, i32* %12, align 4
  store i32 0, i32* %13, align 4
  %26 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %8, i32* %7)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_6_4042.cpp() #0 section ".text.startup" {
