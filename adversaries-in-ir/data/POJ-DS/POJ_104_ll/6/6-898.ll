; ModuleID = 'POJ-104-source/6/6-898.cpp'
source_filename = "POJ-104-source/6/6-898.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_6_898.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z6juzhenv() #0 {
  %1 = alloca i32, align 4
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  ...
  %7 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %1, i32* %2)
  store i32 0, i32* %3, align 4
  br label %8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_6_898.cpp() #0 section ".text.startup" {
