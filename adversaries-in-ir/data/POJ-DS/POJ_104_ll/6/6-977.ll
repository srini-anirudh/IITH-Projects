; ModuleID = 'POJ-104-source/6/6-977.cpp'
source_filename = "POJ-104-source/6/6-977.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_6_977.cpp, i8* null }]
...
14:                                               ; preds = %10
  %15 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %4, i32* %5)
...
40:                                               ; preds = %16
  ...
  call void @_Z6jisuanPA100_iii([100 x i32]* %41, i32 %42, i32 %43)
  br label %44
...
; Function Attrs: noinline uwtable
define dso_local void @_Z6jisuanPA100_iii([100 x i32]* %0, i32 %1, i32 %2) #0 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_6_977.cpp() #0 section ".text.startup" {
