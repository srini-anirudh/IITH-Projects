; ModuleID = 'POJ-104-source/60/60-1184.cpp'
source_filename = "POJ-104-source/60/60-1184.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_60_1184.cpp, i8* null }]
...
52:                                               ; preds = %9
  %53 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %4)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_60_1184.cpp() #0 section ".text.startup" {
