; ModuleID = 'POJ-104-source/60/60-183.cpp'
source_filename = "POJ-104-source/60/60-183.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_60_183.cpp, i8* null }]
...
17:                                               ; preds = %13
  ...
  %21 = getelementptr inbounds [1500 x i32], [1500 x i32]* %3, i64 0, i64 %20
...
63:                                               ; preds = %60
  %64 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0))
  br label %65
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_60_183.cpp() #0 section ".text.startup" {
