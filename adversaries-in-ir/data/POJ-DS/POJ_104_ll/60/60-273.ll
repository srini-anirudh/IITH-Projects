; ModuleID = 'POJ-104-source/60/60-273.cpp'
source_filename = "POJ-104-source/60/60-273.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_60_273.cpp, i8* null }]
...
57:                                               ; preds = %54
  ...
  %61 = add nsw i32 %60, 1
  %62 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0), i32 %59, i32 %61)
  br label %63
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_60_273.cpp() #0 section ".text.startup" {
