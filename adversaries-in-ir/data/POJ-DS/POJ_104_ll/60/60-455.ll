; ModuleID = 'POJ-104-source/60/60-455.cpp'
source_filename = "POJ-104-source/60/60-455.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_60_455.cpp, i8* null }]
...
82:                                               ; preds = %51
  %83 = getelementptr inbounds [10000 x i32], [10000 x i32]* %6, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_60_455.cpp() #0 section ".text.startup" {
