; ModuleID = 'POJ-104-source/60/60-463.cpp'
source_filename = "POJ-104-source/60/60-463.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_60_463.cpp, i8* null }]
...
22:                                               ; preds = %10
  %23 = getelementptr inbounds [100000 x i32], [100000 x i32]* %5, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_60_463.cpp() #0 section ".text.startup" {
