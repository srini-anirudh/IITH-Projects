; ModuleID = 'POJ-104-source/60/60-520.cpp'
source_filename = "POJ-104-source/60/60-520.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_60_520.cpp, i8* null }]
...
60:                                               ; preds = %48
  ...
  %70 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32 %64, i32 %69)
  store i32 0, i32* %7, align 4
  br label %71
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_60_520.cpp() #0 section ".text.startup" {
