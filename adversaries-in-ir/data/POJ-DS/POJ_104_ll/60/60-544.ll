; ModuleID = 'POJ-104-source/60/60-544.cpp'
source_filename = "POJ-104-source/60/60-544.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_60_544.cpp, i8* null }]
...
define dso_local i32 @main() #5 {
  ...
  %12 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i64* %11)
...
31:                                               ; preds = %23
  ...
  %34 = add nsw i64 %33, 2
  %35 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i64 0, i64 0), i64 %32, i64 %34)
  br label %36
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_60_544.cpp() #0 section ".text.startup" {
