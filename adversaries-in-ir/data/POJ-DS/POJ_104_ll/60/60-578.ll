; ModuleID = 'POJ-104-source/60/60-578.cpp'
source_filename = "POJ-104-source/60/60-578.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_60_578.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z4testi(i32 %0) #0 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_60_578.cpp() #0 section ".text.startup" {
