; ModuleID = 'POJ-104-source/60/60-60.cpp'
source_filename = "POJ-104-source/60/60-60.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_60_60.cpp, i8* null }]
...
90:                                               ; preds = %86
  %91 = getelementptr inbounds [1000 x i32], [1000 x i32]* %9, i64 0, i64 0
...
108:                                              ; preds = %86
  %109 = getelementptr inbounds [1000 x i32], [1000 x i32]* %9, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_60_60.cpp() #0 section ".text.startup" {
