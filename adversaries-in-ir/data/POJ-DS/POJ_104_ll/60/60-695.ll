; ModuleID = 'POJ-104-source/60/60-695.cpp'
source_filename = "POJ-104-source/60/60-695.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_60_695.cpp, i8* null }]
...
49:                                               ; preds = %46
  %50 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0))
  br label %85
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_60_695.cpp() #0 section ".text.startup" {
