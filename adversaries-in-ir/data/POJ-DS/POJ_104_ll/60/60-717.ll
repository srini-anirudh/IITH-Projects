; ModuleID = 'POJ-104-source/60/60-717.cpp'
source_filename = "POJ-104-source/60/60-717.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_60_717.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %10 = call i32 @_Z5sushuiPi(i32 %8, i32* %9)
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z5sushuiPi(i32 %0, i32* %1) #0 {
  %3 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_60_717.cpp() #0 section ".text.startup" {
