; ModuleID = 'POJ-104-source/60/60-89.cpp'
source_filename = "POJ-104-source/60/60-89.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_60_89.cpp, i8* null }]
...
74:                                               ; preds = %71
  %75 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0))
  br label %76
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_60_89.cpp() #0 section ".text.startup" {
