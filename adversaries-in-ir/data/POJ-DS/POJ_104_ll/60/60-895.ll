; ModuleID = 'POJ-104-source/60/60-895.cpp'
source_filename = "POJ-104-source/60/60-895.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_60_895.cpp, i8* null }]
...
define dso_local i32 @_Z3ssdi(i32 %0) #5 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_60_895.cpp() #0 section ".text.startup" {
