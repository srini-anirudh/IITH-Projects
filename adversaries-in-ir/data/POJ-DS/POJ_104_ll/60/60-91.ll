; ModuleID = 'POJ-104-source/60/60-91.cpp'
source_filename = "POJ-104-source/60/60-91.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_60_91.cpp, i8* null }]
...
29:                                               ; preds = %25
  ...
  %32 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0), i32 %30, i32 %31)
  br label %33

33:                                               ; preds = %29, %25, %21, %15
  br label %34
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_60_91.cpp() #0 section ".text.startup" {
