; ModuleID = 'POJ-104-source/61/61-1448.cpp'
source_filename = "POJ-104-source/61/61-1448.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_61_1448.cpp, i8* null }]
...
25:                                               ; preds = %21
  ...
  %31 = call i32 @_Z2slii(i32 %26, i32 %30)
...
define dso_local i32 @_Z2slii(i32 %0, i32 %1) #5 {
  %3 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_61_1448.cpp() #0 section ".text.startup" {
