; ModuleID = 'POJ-104-source/61/61-1567.cpp'
source_filename = "POJ-104-source/61/61-1567.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_61_1567.cpp, i8* null }]
...
define dso_local i32 @_Z1si(i32 %0) #0 {
  ...
  %7 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0), i32* %2)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_61_1567.cpp() #0 section ".text.startup" {
