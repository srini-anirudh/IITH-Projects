; ModuleID = 'POJ-104-source/61/61-235.cpp'
source_filename = "POJ-104-source/61/61-235.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_61_235.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z2FNi(i32 %0) #0 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  store i32 %0, i32* %3, align 4
...
13:                                               ; preds = %10
  ...
  %15 = sub nsw i32 %14, 1
  %16 = call i32 @_Z2FNi(i32 %15)
  %17 = load i32, i32* %3, align 4
  %18 = sub nsw i32 %17, 2
  %19 = call i32 @_Z2FNi(i32 %18)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_61_235.cpp() #0 section ".text.startup" {
