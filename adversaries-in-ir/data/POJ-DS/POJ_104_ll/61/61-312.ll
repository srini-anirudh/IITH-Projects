; ModuleID = 'POJ-104-source/61/61-312.cpp'
source_filename = "POJ-104-source/61/61-312.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_61_312.cpp, i8* null }]
...
24:                                               ; preds = %20
  ...
  %30 = call i32 @_Z9Fibonaccii(i32 %29)
...
11:                                               ; preds = %7
  ...
  %16 = sub nsw i32 %15, 2
  %17 = call i32 @_Z9Fibonaccii(i32 %16)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_61_312.cpp() #0 section ".text.startup" {
