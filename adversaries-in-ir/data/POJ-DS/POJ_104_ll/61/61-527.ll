; ModuleID = 'POJ-104-source/61/61-527.cpp'
source_filename = "POJ-104-source/61/61-527.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_61_527.cpp, i8* null }]
...
define dso_local i32 @_Z9feibonaqii(i32 %0) #4 {
...
11:                                               ; preds = %7
  ...
  %14 = call i32 @_Z9feibonaqii(i32 %13)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_61_527.cpp() #0 section ".text.startup" {
