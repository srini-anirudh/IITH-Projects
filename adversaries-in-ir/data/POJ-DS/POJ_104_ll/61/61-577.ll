; ModuleID = 'POJ-104-source/61/61-577.cpp'
source_filename = "POJ-104-source/61/61-577.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_61_577.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %8 = bitcast i8* %7 to <{ i32, i32, [99998 x i32] }>*
  %9 = getelementptr inbounds <{ i32, i32, [99998 x i32] }>, <{ i32, i32, [99998 x i32] }>* %8, i32 0, i32 0
  store i32 1, i32* %9, align 16
  %10 = getelementptr inbounds <{ i32, i32, [99998 x i32] }>, <{ i32, i32, [99998 x i32] }>* %8, i32 0, i32 1
...
59:                                               ; preds = %12
  %60 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %2)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_61_577.cpp() #0 section ".text.startup" {
