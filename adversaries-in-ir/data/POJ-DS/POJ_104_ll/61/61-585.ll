; ModuleID = 'POJ-104-source/61/61-585.cpp'
source_filename = "POJ-104-source/61/61-585.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_61_585.cpp, i8* null }]
...
11:                                               ; preds = %7
  ...
  %20 = call i32 @_Z9Fibonaccii(i32 %19)
...
12:                                               ; preds = %7
  ...
  %14 = sub nsw i32 %13, 1
  %15 = call i32 @_Z9Fibonaccii(i32 %14)
  %16 = load i32, i32* %3, align 4
  %17 = sub nsw i32 %16, 2
  %18 = call i32 @_Z9Fibonaccii(i32 %17)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_61_585.cpp() #0 section ".text.startup" {
