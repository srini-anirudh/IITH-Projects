; ModuleID = 'POJ-104-source/61/61-593.cpp'
source_filename = "POJ-104-source/61/61-593.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_61_593.cpp, i8* null }]
...
89:                                               ; preds = %76
  %90 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %4)
  store i32 0, i32* %1, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_61_593.cpp() #0 section ".text.startup" {
