; ModuleID = 'POJ-104-source/61/61-609.cpp'
source_filename = "POJ-104-source/61/61-609.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_61_609.cpp, i8* null }]
...
35:                                               ; preds = %28
  %36 = getelementptr inbounds [30 x i32], [30 x i32]* %7, i64 0, i64 0
  store i32 1, i32* %36, align 16
  %37 = getelementptr inbounds [30 x i32], [30 x i32]* %7, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_61_609.cpp() #0 section ".text.startup" {
