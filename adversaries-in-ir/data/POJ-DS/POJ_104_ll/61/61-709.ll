; ModuleID = 'POJ-104-source/61/61-709.cpp'
source_filename = "POJ-104-source/61/61-709.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_61_709.cpp, i8* null }]
...
42:                                               ; preds = %7
  %43 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %5)
  store i32 0, i32* %4, align 4
  br label %44
...
48:                                               ; preds = %44
  %49 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %6)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_61_709.cpp() #0 section ".text.startup" {
