; ModuleID = 'POJ-104-source/61/61-859.cpp'
source_filename = "POJ-104-source/61/61-859.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_61_859.cpp, i8* null }]
...
25:                                               ; preds = %22
  %26 = getelementptr inbounds [20 x i32], [20 x i32]* %7, i64 0, i64 1
  store i32 1, i32* %26, align 4
  %27 = getelementptr inbounds [20 x i32], [20 x i32]* %7, i64 0, i64 2
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_61_859.cpp() #0 section ".text.startup" {
