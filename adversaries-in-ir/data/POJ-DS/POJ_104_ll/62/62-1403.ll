; ModuleID = 'POJ-104-source/62/62-1403.cpp'
source_filename = "POJ-104-source/62/62-1403.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_62_1403.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %7 = alloca i8*, align 8
  %8 = alloca [100 x i8]*, align 8
  store i32 0, i32* %1, align 4
  store i32 0, i32* %4, align 4
  store i32 0, i32* %5, align 4
  %9 = call noalias i8* @malloc(i64 100) #3
  store i8* %9, i8** %7, align 8
  %10 = call noalias i8* @malloc(i64 10000) #3
  %11 = bitcast i8* %10 to [100 x i8]*
  store [100 x i8]* %11, [100 x i8]** %8, align 8
...
50:                                               ; preds = %41
  ...
  %56 = load [100 x i8]*, [100 x i8]** %8, align 8
...
83:                                               ; preds = %74
  %84 = load [100 x i8]*, [100 x i8]** %8, align 8
  ...
  %99 = load [100 x i8]*, [100 x i8]** %8, align 8
...
118:                                              ; preds = %114
  %119 = load [100 x i8]*, [100 x i8]** %8, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_62_1403.cpp() #0 section ".text.startup" {
