; ModuleID = 'POJ-104-source/62/62-1638.cpp'
source_filename = "POJ-104-source/62/62-1638.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_62_1638.cpp, i8* null }]
...
48:                                               ; preds = %43
  ...
  %53 = getelementptr inbounds [201 x i8], [201 x i8]* %4, i64 0, i64 %52
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_62_1638.cpp() #0 section ".text.startup" {
