; ModuleID = 'POJ-104-source/62/62-3348.cpp'
source_filename = "POJ-104-source/62/62-3348.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_62_3348.cpp, i8* null }]
...
34:                                               ; preds = %21
  ...
  %37 = getelementptr inbounds [50 x [20 x i8]], [50 x [20 x i8]]* %4, i64 0, i64 %36
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_62_3348.cpp() #0 section ".text.startup" {
