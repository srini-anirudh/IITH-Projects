; ModuleID = 'POJ-104-source/63/63-1022.cpp'
source_filename = "POJ-104-source/63/63-1022.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_63_1022.cpp, i8* null }]
...
33:                                               ; preds = %12
  %34 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %5, i32* %6)
  store i32 0, i32* %9, align 4
  br label %35
...
46:                                               ; preds = %41
  ...
  %53 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %52)
  br label %54
...
61:                                               ; preds = %35
  %62 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %7, i32* %8)
  store i32 0, i32* %9, align 4
  br label %63
...
74:                                               ; preds = %69
  ...
  %81 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %80)
  br label %82
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_63_1022.cpp() #0 section ".text.startup" {
