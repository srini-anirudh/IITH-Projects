; ModuleID = 'POJ-104-source/63/63-1124.cpp'
source_filename = "POJ-104-source/63/63-1124.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_63_1124.cpp, i8* null }]
...
define dso_local i32 @main(i32 %0, i8** %1) #4 {
  ...
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %11, i32* %12)
...
42:                                               ; preds = %18
  %43 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %13, i32* %14)
  store i32 0, i32* %9, align 4
  br label %44
...
53:                                               ; preds = %49
  ...
  %60 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %59)
  br label %61
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_63_1124.cpp() #0 section ".text.startup" {
