; ModuleID = 'POJ-104-source/63/63-1242.cpp'
source_filename = "POJ-104-source/63/63-1242.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_63_1242.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %2, i32* %3)
...
43:                                               ; preds = %19
  %44 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), i32* %4, i32* %5)
...
54:                                               ; preds = %50
  ...
  %61 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %60)
  br label %62
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_63_1242.cpp() #0 section ".text.startup" {
