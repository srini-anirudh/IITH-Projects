; ModuleID = 'POJ-104-source/63/63-1290.cpp'
source_filename = "POJ-104-source/63/63-1290.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_63_1290.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %11, i32* %12)
...
41:                                               ; preds = %17
  %42 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %13, i32* %14)
  store i32 0, i32* %2, align 4
  br label %43
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_63_1290.cpp() #0 section ".text.startup" {
