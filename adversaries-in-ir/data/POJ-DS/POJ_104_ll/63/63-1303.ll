; ModuleID = 'POJ-104-source/63/63-1303.cpp'
source_filename = "POJ-104-source/63/63-1303.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_63_1303.cpp, i8* null }]
...
38:                                               ; preds = %14
  ...
  %40 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %10)
  store i32 0, i32* %5, align 4
  br label %41
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_63_1303.cpp() #0 section ".text.startup" {
