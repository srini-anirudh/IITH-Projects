; ModuleID = 'POJ-104-source/63/63-1313.cpp'
source_filename = "POJ-104-source/63/63-1313.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_63_1313.cpp, i8* null }]
...
124:                                              ; preds = %120
  ...
  %137 = select i1 %135, i8 10, i8 32
  %138 = sext i8 %137 to i32
  %139 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), i32 %131, i32 %138)
  br label %140
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_63_1313.cpp() #0 section ".text.startup" {
