; ModuleID = 'POJ-104-source/63/63-1331.cpp'
source_filename = "POJ-104-source/63/63-1331.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_63_1331.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %2, i32* %3)
...
76:                                               ; preds = %48
  %77 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %8, i32* %9)
...
112:                                              ; preds = %107
  ...
  %121 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %120)
  br label %122
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_63_1331.cpp() #0 section ".text.startup" {
