; ModuleID = 'POJ-104-source/63/63-1373.cpp'
source_filename = "POJ-104-source/63/63-1373.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_63_1373.cpp, i8* null }]
...
46:                                               ; preds = %22
  %47 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %4, i32* %5)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_63_1373.cpp() #0 section ".text.startup" {
