; ModuleID = 'POJ-104-source/63/63-1381.cpp'
source_filename = "POJ-104-source/63/63-1381.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_63_1381.cpp, i8* null }]
...
37:                                               ; preds = %13
  %38 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %8, i32* %9)
  store i32 0, i32* %5, align 4
  br label %39
...
131:                                              ; preds = %95
  ...
  %133 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0), i32 %132)
  br label %134
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_63_1381.cpp() #0 section ".text.startup" {
