; ModuleID = 'POJ-104-source/63/63-1387.cpp'
source_filename = "POJ-104-source/63/63-1387.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_63_1387.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %11 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %5, i32* %7)
...
36:                                               ; preds = %12
  %37 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %7, i32* %6)
  store i32 1, i32* %8, align 4
  br label %38
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_63_1387.cpp() #0 section ".text.startup" {
