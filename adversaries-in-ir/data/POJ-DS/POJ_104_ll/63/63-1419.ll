; ModuleID = 'POJ-104-source/63/63-1419.cpp'
source_filename = "POJ-104-source/63/63-1419.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_63_1419.cpp, i8* null }]
...
25:                                               ; preds = %21
  %26 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %8)
...
41:                                               ; preds = %16
  %42 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %4, i32* %5)
  store i32 0, i32* %6, align 4
  br label %43
...
52:                                               ; preds = %48
  %53 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %9)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_63_1419.cpp() #0 section ".text.startup" {
