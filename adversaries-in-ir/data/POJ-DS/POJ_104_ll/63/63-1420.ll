; ModuleID = 'POJ-104-source/63/63-1420.cpp'
source_filename = "POJ-104-source/63/63-1420.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_63_1420.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %5, i32* %6)
...
36:                                               ; preds = %24
  %37 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0))
  br label %38
...
69:                                               ; preds = %57
  %70 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0))
  br label %71
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_63_1420.cpp() #0 section ".text.startup" {
