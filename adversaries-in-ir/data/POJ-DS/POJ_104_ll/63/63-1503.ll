; ModuleID = 'POJ-104-source/63/63-1503.cpp'
source_filename = "POJ-104-source/63/63-1503.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_63_1503.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %12 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %5, i32* %7)
...
46:                                               ; preds = %20
  %47 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %6, i32* %8)
...
64:                                               ; preds = %60
  ...
  %73 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %72)
  br label %74
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_63_1503.cpp() #0 section ".text.startup" {
