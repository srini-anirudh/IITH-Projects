; ModuleID = 'POJ-104-source/63/63-1513.cpp'
source_filename = "POJ-104-source/63/63-1513.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_63_1513.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %5, i32* %6)
...
41:                                               ; preds = %17
  %42 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %7, i32* %8)
  store i32 0, i32* %13, align 4
  br label %43
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_63_1513.cpp() #0 section ".text.startup" {
