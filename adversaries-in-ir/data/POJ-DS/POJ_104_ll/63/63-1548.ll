; ModuleID = 'POJ-104-source/63/63-1548.cpp'
source_filename = "POJ-104-source/63/63-1548.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_63_1548.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %11, i32* %13)
...
47:                                               ; preds = %21
  %48 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %12, i32* %14)
  store i32 0, i32* %2, align 4
  br label %49
...
60:                                               ; preds = %55
  ...
  %67 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %66)
  br label %68
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_63_1548.cpp() #0 section ".text.startup" {
