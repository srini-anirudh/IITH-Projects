; ModuleID = 'POJ-104-source/63/63-1555.cpp'
source_filename = "POJ-104-source/63/63-1555.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_63_1555.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %5, i32* %6)
  store i32 0, i32* %9, align 4
  br label %19
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_63_1555.cpp() #0 section ".text.startup" {
