; ModuleID = 'POJ-104-source/63/63-1587.cpp'
source_filename = "POJ-104-source/63/63-1587.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_63_1587.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %13 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %9, i32* %11)
...
39:                                               ; preds = %14
  %40 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %10, i32* %12)
  store i32 0, i32* %5, align 4
  br label %41
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_63_1587.cpp() #0 section ".text.startup" {
