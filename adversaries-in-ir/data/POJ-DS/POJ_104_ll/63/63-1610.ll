; ModuleID = 'POJ-104-source/63/63-1610.cpp'
source_filename = "POJ-104-source/63/63-1610.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_63_1610.cpp, i8* null }]
...
53:                                               ; preds = %27
  %54 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %6, i32* %8)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_63_1610.cpp() #0 section ".text.startup" {
