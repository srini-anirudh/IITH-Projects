; ModuleID = 'POJ-104-source/63/63-1638.cpp'
source_filename = "POJ-104-source/63/63-1638.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_63_1638.cpp, i8* null }]
...
118:                                              ; preds = %114
  ...
  %130 = getelementptr inbounds i32, i32* %64, i64 %129
  ...
  %148 = getelementptr inbounds i32, i32* %96, i64 %147
...
168:                                              ; preds = %164
  ...
  %172 = getelementptr inbounds i32, i32* %96, i64 %171
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_63_1638.cpp() #0 section ".text.startup" {
