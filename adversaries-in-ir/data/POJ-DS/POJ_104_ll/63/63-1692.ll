; ModuleID = 'POJ-104-source/63/63-1692.cpp'
source_filename = "POJ-104-source/63/63-1692.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_63_1692.cpp, i8* null }]
...
159:                                              ; preds = %146
  ...
  %169 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %160, i32 %168)
  br label %170
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_63_1692.cpp() #0 section ".text.startup" {
