; ModuleID = 'POJ-104-source/63/63-1717.cpp'
source_filename = "POJ-104-source/63/63-1717.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_63_1717.cpp, i8* null }]
...
50:                                               ; preds = %25
  ...
  %66 = mul nuw i64 %60, %62
  %67 = mul nuw i64 4, %66
  call void @llvm.memset.p0i8.i64(i8* align 16 %65, i8 0, i64 %67, i1 false)
  store i32 0, i32* %6, align 4
  br label %68
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_63_1717.cpp() #0 section ".text.startup" {
