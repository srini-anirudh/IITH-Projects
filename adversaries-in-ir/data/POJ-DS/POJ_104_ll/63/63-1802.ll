; ModuleID = 'POJ-104-source/63/63-1802.cpp'
source_filename = "POJ-104-source/63/63-1802.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_63_1802.cpp, i8* null }]
...
28:                                               ; preds = %24
  ...
  %35 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i32* %34)
  br label %36
...
43:                                               ; preds = %14
  %44 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %7, i32* %8)
  store i32 1, i32* %9, align 4
  br label %45
...
59:                                               ; preds = %55
  ...
  %66 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i32* %65)
  br label %67
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_63_1802.cpp() #0 section ".text.startup" {
