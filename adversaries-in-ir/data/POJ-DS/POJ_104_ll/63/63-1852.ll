; ModuleID = 'POJ-104-source/63/63-1852.cpp'
source_filename = "POJ-104-source/63/63-1852.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_63_1852.cpp, i8* null }]
...
187:                                              ; preds = %182
  ...
  %191 = getelementptr inbounds i32, i32* %98, i64 %190
...
201:                                              ; preds = %182
  ...
  %205 = getelementptr inbounds i32, i32* %98, i64 %204
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_63_1852.cpp() #0 section ".text.startup" {
