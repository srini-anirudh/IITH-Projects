; ModuleID = 'POJ-104-source/63/63-1871.cpp'
source_filename = "POJ-104-source/63/63-1871.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_63_1871.cpp, i8* null }]
...
102:                                              ; preds = %98
  ...
  %111 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %110)
  br label %112
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_63_1871.cpp() #0 section ".text.startup" {
