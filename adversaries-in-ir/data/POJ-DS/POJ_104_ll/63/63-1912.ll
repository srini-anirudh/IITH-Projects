; ModuleID = 'POJ-104-source/63/63-1912.cpp'
source_filename = "POJ-104-source/63/63-1912.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_63_1912.cpp, i8* null }]
...
31:                                               ; preds = %7
  %32 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* @_ZSt3cin, i32* dereferenceable(4) @c)
...
43:                                               ; preds = %39
  ...
  %46 = getelementptr inbounds [128 x [128 x i32]], [128 x [128 x i32]]* @m2, i64 0, i64 %45
...
73:                                               ; preds = %69
  ...
  %76 = getelementptr inbounds [128 x [128 x i32]], [128 x [128 x i32]]* @m1, i64 0, i64 %75
  ...
  %83 = getelementptr inbounds [128 x [128 x i32]], [128 x [128 x i32]]* @m2, i64 0, i64 %82
  %84 = load i32, i32* %4, align 4
  %85 = sext i32 %84 to i64
  %86 = getelementptr inbounds [128 x i32], [128 x i32]* %83, i64 0, i64 %85
  %87 = load i32, i32* %86, align 4
  %88 = mul nsw i32 %80, %87
  %89 = load i32, i32* %2, align 4
  %90 = sext i32 %89 to i64
  %91 = getelementptr inbounds [128 x [128 x i32]], [128 x [128 x i32]]* @m3, i64 0, i64 %90
...
119:                                              ; preds = %114
  ...
  %122 = getelementptr inbounds [128 x [128 x i32]], [128 x [128 x i32]]* @m3, i64 0, i64 %121
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_63_1912.cpp() #0 section ".text.startup" {
