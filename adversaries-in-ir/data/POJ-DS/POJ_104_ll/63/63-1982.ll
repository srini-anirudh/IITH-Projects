; ModuleID = 'POJ-104-source/63/63-1982.cpp'
source_filename = "POJ-104-source/63/63-1982.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_63_1982.cpp, i8* null }]
...
53:                                               ; preds = %18
  ...
  %55 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %4, i32* %5)
...
101:                                              ; preds = %97
  ...
  %110 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %109)
  br label %111
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_63_1982.cpp() #0 section ".text.startup" {
