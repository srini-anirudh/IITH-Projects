; ModuleID = 'POJ-104-source/63/63-1993.cpp'
source_filename = "POJ-104-source/63/63-1993.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_63_1993.cpp, i8* null }]
...
40:                                               ; preds = %16
  %41 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %4, i32* %5)
  store i32 0, i32* %6, align 4
  br label %42
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_63_1993.cpp() #0 section ".text.startup" {
