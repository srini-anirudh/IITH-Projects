; ModuleID = 'POJ-104-source/63/63-2048.cpp'
source_filename = "POJ-104-source/63/63-2048.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_63_2048.cpp, i8* null }]
...
44:                                               ; preds = %11
  %45 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %5, i32* %7)
  store i32 0, i32* %8, align 4
  br label %46
...
55:                                               ; preds = %51
  ...
  %62 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %61)
  br label %63
...
70:                                               ; preds = %46
  %71 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %7, i32* %6)
  store i32 0, i32* %8, align 4
  br label %72
...
81:                                               ; preds = %77
  ...
  %88 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %87)
  br label %89
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_63_2048.cpp() #0 section ".text.startup" {
