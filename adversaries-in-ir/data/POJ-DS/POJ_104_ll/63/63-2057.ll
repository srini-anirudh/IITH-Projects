; ModuleID = 'POJ-104-source/63/63-2057.cpp'
source_filename = "POJ-104-source/63/63-2057.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_63_2057.cpp, i8* null }]
...
56:                                               ; preds = %30
  %57 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %6, i32* %7)
...
82:                                               ; preds = %78
  ...
  %91 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %90)
  br label %92
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_63_2057.cpp() #0 section ".text.startup" {
