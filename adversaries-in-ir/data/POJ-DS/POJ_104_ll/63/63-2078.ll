; ModuleID = 'POJ-104-source/63/63-2078.cpp'
source_filename = "POJ-104-source/63/63-2078.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_63_2078.cpp, i8* null }]
...
26:                                               ; preds = %22
  ...
  %33 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i32* %32)
  br label %34
...
41:                                               ; preds = %12
  %42 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %3, i32* %4)
  store i32 0, i32* %5, align 4
  br label %43
...
47:                                               ; preds = %43
  ...
  %52 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i32* %51)
  store i32 1, i32* %6, align 4
  br label %53
...
57:                                               ; preds = %53
  ...
  %64 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i32* %63)
  br label %65
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_63_2078.cpp() #0 section ".text.startup" {
