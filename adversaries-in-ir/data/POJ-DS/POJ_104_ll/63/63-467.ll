; ModuleID = 'POJ-104-source/63/63-467.cpp'
source_filename = "POJ-104-source/63/63-467.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_63_467.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %15 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %5, i32* %6)
...
40:                                               ; preds = %16
  %41 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %7, i32* %8)
  store i32 1, i32* %9, align 4
  br label %42
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_63_467.cpp() #0 section ".text.startup" {
