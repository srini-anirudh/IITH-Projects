; ModuleID = 'POJ-104-source/63/63-577.cpp'
source_filename = "POJ-104-source/63/63-577.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_63_577.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %12 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %8, i32* %10)
...
37:                                               ; preds = %13
  %38 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %9, i32* %11)
  store i32 0, i32* %5, align 4
  br label %39
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_63_577.cpp() #0 section ".text.startup" {
