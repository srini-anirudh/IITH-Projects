; ModuleID = 'POJ-104-source/63/63-596.cpp'
source_filename = "POJ-104-source/63/63-596.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_63_596.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %17 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %11, i64 0, i64 0
  store [100 x i32]* %17, [100 x i32]** %14, align 8
...
45:                                               ; preds = %19
  %46 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %4, i32* %5)
  store i32 0, i32* %6, align 4
  br label %47
...
56:                                               ; preds = %52
  %57 = load [100 x i32]*, [100 x i32]** %13, align 8
...
83:                                               ; preds = %79
  %84 = load [100 x i32]*, [100 x i32]** %14, align 8
...
95:                                               ; preds = %91
  %96 = load [100 x i32]*, [100 x i32]** %14, align 8
  ...
  %113 = load [100 x i32]*, [100 x i32]** %13, align 8
  ...
  %124 = load [100 x i32]*, [100 x i32]** %14, align 8
...
167:                                              ; preds = %152
  %168 = load [100 x i32]*, [100 x i32]** %14, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_63_596.cpp() #0 section ".text.startup" {
