; ModuleID = 'POJ-104-source/63/63-631.cpp'
source_filename = "POJ-104-source/63/63-631.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_63_631.cpp, i8* null }]
...
62:                                               ; preds = %36
  %63 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %4, i32* %5)
...
96:                                               ; preds = %92
  ...
  %105 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %104)
  br label %106
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_63_631.cpp() #0 section ".text.startup" {
