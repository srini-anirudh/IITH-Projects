; ModuleID = 'POJ-104-source/63/63-663.cpp'
source_filename = "POJ-104-source/63/63-663.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_63_663.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %12 = getelementptr inbounds [120 x [120 x i32]], [120 x [120 x i32]]* %5, i64 0, i64 0
  %13 = bitcast [120 x i32]* %12 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 16 %13, i8 0, i64 57600, i1 false)
  %14 = getelementptr inbounds [120 x [120 x i32]], [120 x [120 x i32]]* %6, i64 0, i64 0
  %15 = bitcast [120 x i32]* %14 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 16 %15, i8 0, i64 57600, i1 false)
  %16 = getelementptr inbounds [120 x [120 x i32]], [120 x [120 x i32]]* %7, i64 0, i64 0
  %17 = bitcast [120 x i32]* %16 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 16 %17, i8 0, i64 57600, i1 false)
...
56:                                               ; preds = %52
  ...
  %59 = getelementptr inbounds [120 x [120 x i32]], [120 x [120 x i32]]* %6, i64 0, i64 %58
...
86:                                               ; preds = %82
  ...
  %96 = getelementptr inbounds [120 x [120 x i32]], [120 x [120 x i32]]* %5, i64 0, i64 %95
  ...
  %103 = getelementptr inbounds [120 x [120 x i32]], [120 x [120 x i32]]* %6, i64 0, i64 %102
  ...
  %112 = getelementptr inbounds [120 x [120 x i32]], [120 x [120 x i32]]* %7, i64 0, i64 %111
...
138:                                              ; preds = %133
  ...
  %141 = getelementptr inbounds [120 x [120 x i32]], [120 x [120 x i32]]* %7, i64 0, i64 %140
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_63_663.cpp() #0 section ".text.startup" {
