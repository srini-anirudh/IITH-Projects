; ModuleID = 'POJ-104-source/63/63-671.cpp'
source_filename = "POJ-104-source/63/63-671.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_63_671.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %12 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %6, i32* %7)
...
37:                                               ; preds = %13
  %38 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %7, i32* %5)
  store i32 0, i32* %8, align 4
  br label %39
...
48:                                               ; preds = %44
  ...
  %55 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %54)
  br label %56
...
112:                                              ; preds = %111, %110
  %113 = phi [4 x i8]* [ @.str.2, %110 ], [ @.str.3, %111 ]
  ...
  %122 = call i32 (i8*, ...) @printf(i8* %114, i32 %121)
  br label %123
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_63_671.cpp() #0 section ".text.startup" {
