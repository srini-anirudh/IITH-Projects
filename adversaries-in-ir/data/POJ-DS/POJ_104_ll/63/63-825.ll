; ModuleID = 'POJ-104-source/63/63-825.cpp'
source_filename = "POJ-104-source/63/63-825.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_63_825.cpp, i8* null }]
...
140:                                              ; preds = %127
  ...
  %143 = getelementptr inbounds [101 x [101 x i32]], [101 x [101 x i32]]* %12, i64 0, i64 %142
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_63_825.cpp() #0 section ".text.startup" {
