; ModuleID = 'POJ-104-source/63/63-860.cpp'
source_filename = "POJ-104-source/63/63-860.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_63_860.cpp, i8* null }]
...
132:                                              ; preds = %128
  ...
  %136 = getelementptr inbounds [101 x i32], [101 x i32]* %135, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_63_860.cpp() #0 section ".text.startup" {
