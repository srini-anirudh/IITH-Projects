; ModuleID = 'POJ-104-source/63/63-878.cpp'
source_filename = "POJ-104-source/63/63-878.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_63_878.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %15 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i64* %11, i64* %13)
...
25:                                               ; preds = %21
  ...
  %30 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i64* %29)
  br label %31
...
38:                                               ; preds = %16
  %39 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i64* %12, i64* %14)
  store i64 1, i64* %5, align 8
  br label %40
...
49:                                               ; preds = %45
  ...
  %54 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i64* %53)
  br label %55
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_63_878.cpp() #0 section ".text.startup" {
