; ModuleID = 'POJ-104-source/63/63-911.cpp'
source_filename = "POJ-104-source/63/63-911.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_63_911.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %14 = bitcast [200 x [200 x i32]]* %4 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 16 %14, i8 0, i64 160000, i1 false)
  store i32 0, i32* %7, align 4
  %15 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %8, i32* %10)
...
27:                                               ; preds = %22
  %28 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %7)
...
43:                                               ; preds = %16
  %44 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %9, i32* %11)
  store i32 0, i32* %5, align 4
  br label %45
...
56:                                               ; preds = %51
  %57 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %7)
...
111:                                              ; preds = %85
  ...
  %115 = getelementptr inbounds [200 x [200 x i32]], [200 x [200 x i32]]* %4, i64 0, i64 %114
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_63_911.cpp() #0 section ".text.startup" {
