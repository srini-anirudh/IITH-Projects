; ModuleID = 'POJ-104-source/63/63-933.cpp'
source_filename = "POJ-104-source/63/63-933.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_63_933.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i64 0, i64 0), i32* %2, i32* %3, i8* %12)
...
38:                                               ; preds = %25
  %39 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i8* %12)
  br label %40
...
48:                                               ; preds = %15
  %49 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i64 0, i64 0), i32* %9, i32* %10, i8* %12)
  store i32 0, i32* %7, align 4
  br label %50
...
65:                                               ; preds = %60
  ...
  %72 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %71)
  br label %75

73:                                               ; preds = %60
  %74 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i8* %12)
  br label %75
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_63_933.cpp() #0 section ".text.startup" {
