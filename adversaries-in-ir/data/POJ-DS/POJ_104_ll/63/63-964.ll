; ModuleID = 'POJ-104-source/63/63-964.cpp'
source_filename = "POJ-104-source/63/63-964.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_63_964.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %15 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %5, i32* %7)
...
42:                                               ; preds = %16
  %43 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %6, i32* %8)
  store i32 0, i32* %2, align 4
  br label %44
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_63_964.cpp() #0 section ".text.startup" {
