; ModuleID = 'POJ-104-source/64/64-1070.cpp'
source_filename = "POJ-104-source/64/64-1070.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_1070.cpp, i8* null }]
...
48:                                               ; preds = %44
  ...
  %85 = getelementptr inbounds [50 x double], [50 x double]* %10, i64 0, i64 %84
...
134:                                              ; preds = %123
  ...
  %154 = getelementptr inbounds [50 x i32], [50 x i32]* %8, i64 0, i64 %153
...
203:                                              ; preds = %195
  ...
  %234 = getelementptr inbounds [50 x i32], [50 x i32]* %9, i64 0, i64 %233
  ...
  %248 = getelementptr inbounds [50 x double], [50 x double]* %10, i64 0, i64 %247
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_1070.cpp() #0 section ".text.startup" {
