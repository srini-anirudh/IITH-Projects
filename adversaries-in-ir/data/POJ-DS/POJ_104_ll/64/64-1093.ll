; ModuleID = 'POJ-104-source/64/64-1093.cpp'
source_filename = "POJ-104-source/64/64-1093.cpp"
...
@sum = dso_local global [1000 x float] zeroinitializer, align 16
@dis = dso_local global [1000 x float] zeroinitializer, align 16
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_1093.cpp, i8* null }]
...
30:                                               ; preds = %26
  ...
  %40 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i64 0, i64 0), i32* %33, i32* %36, i32* %39)
  br label %41
...
57:                                               ; preds = %53
  ...
  %125 = call float @_ZSt4sqrtf(float %124)
  %126 = load i32, i32* %6, align 4
  %127 = sext i32 %126 to i64
  %128 = getelementptr inbounds [1000 x float], [1000 x float]* @dis, i64 0, i64 %127
  store float %125, float* %128, align 4
  %129 = load i32, i32* %4, align 4
  %130 = load i32, i32* %6, align 4
  %131 = sext i32 %130 to i64
  %132 = getelementptr inbounds [1000 x i32], [1000 x i32]* @x, i64 0, i64 %131
...
165:                                              ; preds = %156
  ...
  %168 = getelementptr inbounds [1000 x float], [1000 x float]* @dis, i64 0, i64 %167
  %169 = load float, float* %168, align 4
  %170 = load i32, i32* %3, align 4
  %171 = add nsw i32 %170, 1
  %172 = sext i32 %171 to i64
  %173 = getelementptr inbounds [1000 x float], [1000 x float]* @dis, i64 0, i64 %172
...
176:                                              ; preds = %165
  ...
  %179 = getelementptr inbounds [1000 x float], [1000 x float]* @dis, i64 0, i64 %178
  %180 = load float, float* %179, align 4
  store float %180, float* %9, align 4
  %181 = load i32, i32* %3, align 4
  %182 = add nsw i32 %181, 1
  %183 = sext i32 %182 to i64
  %184 = getelementptr inbounds [1000 x float], [1000 x float]* @dis, i64 0, i64 %183
  %185 = load float, float* %184, align 4
  %186 = load i32, i32* %3, align 4
  %187 = sext i32 %186 to i64
  %188 = getelementptr inbounds [1000 x float], [1000 x float]* @dis, i64 0, i64 %187
  store float %185, float* %188, align 4
  %189 = load float, float* %9, align 4
  %190 = load i32, i32* %3, align 4
  %191 = add nsw i32 %190, 1
  %192 = sext i32 %191 to i64
  %193 = getelementptr inbounds [1000 x float], [1000 x float]* @dis, i64 0, i64 %192
  ...
  %201 = getelementptr inbounds [1000 x i32], [1000 x i32]* @x, i64 0, i64 %200
  %202 = load i32, i32* %201, align 4
  %203 = load i32, i32* %3, align 4
  %204 = sext i32 %203 to i64
  %205 = getelementptr inbounds [1000 x i32], [1000 x i32]* @x, i64 0, i64 %204
  ...
  %218 = getelementptr inbounds [1000 x i32], [1000 x i32]* @y, i64 0, i64 %217
  %219 = load i32, i32* %218, align 4
  %220 = load i32, i32* %3, align 4
  %221 = sext i32 %220 to i64
  %222 = getelementptr inbounds [1000 x i32], [1000 x i32]* @y, i64 0, i64 %221
  store i32 %219, i32* %222, align 4
  %223 = load i32, i32* %8, align 4
  %224 = load i32, i32* %3, align 4
  %225 = add nsw i32 %224, 1
  %226 = sext i32 %225 to i64
  %227 = getelementptr inbounds [1000 x i32], [1000 x i32]* @y, i64 0, i64 %226
...
245:                                              ; preds = %237
  ...
  %248 = getelementptr inbounds [1000 x i32], [1000 x i32]* @x, i64 0, i64 %247
  ...
  %258 = getelementptr inbounds [1000 x i32], [1000 x i32]* @b, i64 0, i64 %257
  ...
  %265 = getelementptr inbounds [1000 x i32], [1000 x i32]* @c, i64 0, i64 %264
  %266 = load i32, i32* %265, align 4
  %267 = load i32, i32* %7, align 4
  %268 = sext i32 %267 to i64
  %269 = getelementptr inbounds [1000 x i32], [1000 x i32]* @y, i64 0, i64 %268
  ...
  %276 = getelementptr inbounds [1000 x i32], [1000 x i32]* @y, i64 0, i64 %275
  %277 = load i32, i32* %276, align 4
  %278 = sext i32 %277 to i64
  %279 = getelementptr inbounds [1000 x i32], [1000 x i32]* @b, i64 0, i64 %278
  ...
  %286 = getelementptr inbounds [1000 x i32], [1000 x i32]* @c, i64 0, i64 %285
  %287 = load i32, i32* %286, align 4
  %288 = load i32, i32* %7, align 4
  %289 = sext i32 %288 to i64
  %290 = getelementptr inbounds [1000 x float], [1000 x float]* @dis, i64 0, i64 %289
  %291 = load float, float* %290, align 4
  %292 = fpext float %291 to double
  %293 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.2, i64 0, i64 0), i32 %252, i32 %259, i32 %266, i32 %273, i32 %280, i32 %287, double %292)
  br label %294
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_1093.cpp() #0 section ".text.startup" {
