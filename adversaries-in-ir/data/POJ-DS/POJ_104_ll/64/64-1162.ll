; ModuleID = 'POJ-104-source/64/64-1162.cpp'
source_filename = "POJ-104-source/64/64-1162.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_1162.cpp, i8* null }]
...
57:                                               ; preds = %53
  ...
  %128 = getelementptr inbounds [50 x i32], [50 x i32]* %10, i64 0, i64 %127
...
168:                                              ; preds = %157
  ...
  %180 = getelementptr inbounds [50 x double], [50 x double]* %12, i64 0, i64 %179
  ...
  %219 = getelementptr inbounds [50 x i32], [50 x i32]* %10, i64 0, i64 %218
...
237:                                              ; preds = %229
  ...
  %240 = getelementptr inbounds [50 x i32], [50 x i32]* %9, i64 0, i64 %239
  ...
  %261 = getelementptr inbounds [50 x i32], [50 x i32]* %10, i64 0, i64 %260
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_1162.cpp() #0 section ".text.startup" {
