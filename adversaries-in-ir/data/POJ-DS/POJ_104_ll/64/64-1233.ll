; ModuleID = 'POJ-104-source/64/64-1233.cpp'
source_filename = "POJ-104-source/64/64-1233.cpp"
...
@t = dso_local global [100 x %struct.edge] zeroinitializer, align 16
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [7 x i8] c"%d%d%d\00", align 1
@.str.2 = private unnamed_addr constant [29 x i8] c"(%d,%d,%d)-(%d,%d,%d)=%.2lf\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_1233.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local double @_Z4distii(i32 %0, i32 %1) #0 {
...
42:                                               ; preds = %38
  ...
  %47 = call double @_Z4distii(i32 %45, i32 %46)
...
105:                                              ; preds = %93
  ...
  %108 = call i32 @_Z5judgeii(i32 %106, i32 %107)
...
110:                                              ; preds = %105, %81
  ...
  %122 = bitcast %struct.edge* %117 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_1233.cpp() #0 section ".text.startup" {
