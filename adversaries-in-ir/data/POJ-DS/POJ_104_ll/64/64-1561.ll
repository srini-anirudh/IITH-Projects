; ModuleID = 'POJ-104-source/64/64-1561.cpp'
source_filename = "POJ-104-source/64/64-1561.cpp"
...
@num = dso_local global [5010 x %struct.num] zeroinitializer, align 16
@k = dso_local global %struct.num zeroinitializer, align 4
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [9 x i8] c"%d %d %d\00", align 1
@.str.2 = private unnamed_addr constant [28 x i8] c"(%d,%d,%d)-(%d,%d,%d)=%.2f\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_1561.cpp, i8* null }]
...
214:                                              ; preds = %202
  ...
  %225 = bitcast %struct.num* %224 to i8*
  %226 = bitcast %struct.num* %221 to i8*
...
298:                                              ; preds = %286, %262
  ...
  %309 = bitcast %struct.num* %308 to i8*
  %310 = bitcast %struct.num* %305 to i8*
...
328:                                              ; preds = %324
  ...
  %364 = call float @_ZSt4sqrtf(float %363)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_1561.cpp() #0 section ".text.startup" {
