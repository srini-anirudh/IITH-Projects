; ModuleID = 'POJ-104-source/64/64-1564.cpp'
source_filename = "POJ-104-source/64/64-1564.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_1564.cpp, i8* null }]
...
56:                                               ; preds = %30
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([105 x i32], [105 x i32]* @dist, i64 0, i64 1), i32* %59)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_1564.cpp() #0 section ".text.startup" {
