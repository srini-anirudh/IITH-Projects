; ModuleID = 'POJ-104-source/64/64-1621.cpp'
source_filename = "POJ-104-source/64/64-1621.cpp"
...
@p = dso_local global [1100 x i32] zeroinitializer, align 16
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [7 x i8] c"%d%d%d\00", align 1
@.str.2 = private unnamed_addr constant [29 x i8] c"(%d,%d,%d)-(%d,%d,%d)=%.2lf\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_1621.cpp, i8* null }]
...
12:                                               ; preds = %9
  ...
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32* %15, i32* %18, i32* %21)
...
149:                                              ; preds = %115
  ...
  %206 = call double @_ZSt4sqrtIiEN9__gnu_cxx11__enable_ifIXsr12__is_integerIT_EE7__valueEdE6__typeES2_(i32 %205)
  %207 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.2, i64 0, i64 0), i32 %157, i32 %165, i32 %173, i32 %182, i32 %191, i32 %200, double %206)
  br label %208
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_1621.cpp() #0 section ".text.startup" {
