; ModuleID = 'POJ-104-source/64/64-1676.cpp'
source_filename = "POJ-104-source/64/64-1676.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_1676.cpp, i8* null }]
...
17:                                               ; preds = %13
  ...
  %30 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i64 0, i64 0), i32* %21, i32* %25, i32* %29)
  br label %31
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_1676.cpp() #0 section ".text.startup" {
