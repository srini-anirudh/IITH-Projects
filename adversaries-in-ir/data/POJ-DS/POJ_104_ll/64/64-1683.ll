; ModuleID = 'POJ-104-source/64/64-1683.cpp'
source_filename = "POJ-104-source/64/64-1683.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_1683.cpp, i8* null }]
...
22:                                               ; preds = %18
  ...
  %34 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), double* %33)
  br label %35
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_1683.cpp() #0 section ".text.startup" {
