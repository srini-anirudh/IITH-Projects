; ModuleID = 'POJ-104-source/64/64-1696.cpp'
source_filename = "POJ-104-source/64/64-1696.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_1696.cpp, i8* null }]
...
45:                                               ; preds = %41
  ...
  %108 = getelementptr inbounds [10 x [10 x double]], [10 x [10 x double]]* %5, i64 0, i64 %107
...
222:                                              ; preds = %218
  ...
  %225 = getelementptr inbounds [10 x [10 x double]], [10 x [10 x double]]* %5, i64 0, i64 %224
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_1696.cpp() #0 section ".text.startup" {
