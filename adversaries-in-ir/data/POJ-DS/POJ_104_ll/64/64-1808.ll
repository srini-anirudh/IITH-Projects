; ModuleID = 'POJ-104-source/64/64-1808.cpp'
source_filename = "POJ-104-source/64/64-1808.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_1808.cpp, i8* null }]
...
23:                                               ; preds = %19
  ...
  %36 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i64 0, i64 0), i32* %27, i32* %31, i32* %35)
  br label %37
...
52:                                               ; preds = %48
  ...
  %95 = getelementptr inbounds [10 x [3 x i32]], [10 x [3 x i32]]* %6, i64 0, i64 %94
  ...
  %105 = getelementptr inbounds [45 x float], [45 x float]* @dis, i64 0, i64 %104
...
126:                                              ; preds = %121
  ...
  %129 = getelementptr inbounds [45 x float], [45 x float]* @dis, i64 0, i64 %128
  %130 = load float, float* %129, align 4
  %131 = load i32, i32* %3, align 4
  %132 = add nsw i32 %131, 1
  %133 = sext i32 %132 to i64
  %134 = getelementptr inbounds [45 x float], [45 x float]* @dis, i64 0, i64 %133
...
137:                                              ; preds = %126
  ...
  call void @_Z4swapii(i32 %138, i32 %140)
  br label %141
...
154:                                              ; preds = %150
  ...
  %157 = getelementptr inbounds [45 x [2 x i32]], [45 x [2 x i32]]* @com, i64 0, i64 %156
  ...
  %166 = getelementptr inbounds [45 x [2 x i32]], [45 x [2 x i32]]* @com, i64 0, i64 %165
  ...
  %175 = getelementptr inbounds [45 x [2 x i32]], [45 x [2 x i32]]* @com, i64 0, i64 %174
  ...
  %184 = getelementptr inbounds [45 x [2 x i32]], [45 x [2 x i32]]* @com, i64 0, i64 %183
  ...
  %193 = getelementptr inbounds [45 x [2 x i32]], [45 x [2 x i32]]* @com, i64 0, i64 %192
  ...
  %202 = getelementptr inbounds [45 x [2 x i32]], [45 x [2 x i32]]* @com, i64 0, i64 %201
  %203 = getelementptr inbounds [2 x i32], [2 x i32]* %202, i64 0, i64 1
  %204 = load i32, i32* %203, align 4
  %205 = zext i32 %204 to i64
  %206 = getelementptr inbounds [10 x [3 x i32]], [10 x [3 x i32]]* %6, i64 0, i64 %205
  %207 = getelementptr inbounds [3 x i32], [3 x i32]* %206, i64 0, i64 2
  %208 = load i32, i32* %207, align 4
  %209 = load i32, i32* %2, align 4
  %210 = sext i32 %209 to i64
  %211 = getelementptr inbounds [45 x float], [45 x float]* @dis, i64 0, i64 %210
  %212 = load float, float* %211, align 4
  %213 = fpext float %212 to double
  %214 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.2, i64 0, i64 0), i32 %163, i32 %172, i32 %181, i32 %190, i32 %199, i32 %208, double %213)
  br label %215
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_1808.cpp() #0 section ".text.startup" {
