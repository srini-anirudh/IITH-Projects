; ModuleID = 'POJ-104-source/64/64-1822.cpp'
source_filename = "POJ-104-source/64/64-1822.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_1822.cpp, i8* null }]
...
define dso_local double @_Z8distanceiiiiii(i32 %0, i32 %1, i32 %2, i32 %3, i32 %4, i32 %5) #4 {
...
42:                                               ; preds = %37
  ...
  %133 = call double @_Z8distanceiiiiii(i32 %109, i32 %113, i32 %117, i32 %122, i32 %127, i32 %132)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_1822.cpp() #0 section ".text.startup" {
