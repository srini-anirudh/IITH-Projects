; ModuleID = 'POJ-104-source/64/64-1845.cpp'
source_filename = "POJ-104-source/64/64-1845.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_1845.cpp, i8* null }]
...
142:                                              ; preds = %136
  ...
  %145 = getelementptr inbounds [100 x double], [100 x double]* %15, i64 0, i64 %144
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_1845.cpp() #0 section ".text.startup" {
