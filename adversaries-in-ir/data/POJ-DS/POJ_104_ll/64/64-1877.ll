; ModuleID = 'POJ-104-source/64/64-1877.cpp'
source_filename = "POJ-104-source/64/64-1877.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_1877.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %11)
...
54:                                               ; preds = %50
  ...
  %79 = call double @_Z4juliiiiiii(i32 %58, i32 %62, i32 %66, i32 %70, i32 %74, i32 %78)
...
define dso_local double @_Z4juliiiiiii(i32 %0, i32 %1, i32 %2, i32 %3, i32 %4, i32 %5) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_1877.cpp() #0 section ".text.startup" {
