; ModuleID = 'POJ-104-source/64/64-1878.cpp'
source_filename = "POJ-104-source/64/64-1878.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_1878.cpp, i8* null }]
...
46:                                               ; preds = %42
  ...
  %109 = getelementptr inbounds [10000 x double], [10000 x double]* %13, i64 0, i64 %108
...
151:                                              ; preds = %147
  ...
  %154 = getelementptr inbounds [10000 x double], [10000 x double]* %13, i64 0, i64 %153
  %155 = load double, double* %154, align 8
  %156 = load i32, i32* %3, align 4
  %157 = sext i32 %156 to i64
  %158 = getelementptr inbounds [10000 x double], [10000 x double]* %13, i64 0, i64 %157
...
167:                                              ; preds = %162
  ...
  %173 = getelementptr inbounds [11 x i32], [11 x i32]* %8, i64 0, i64 %172
  ...
  %180 = getelementptr inbounds [11 x i32], [11 x i32]* %9, i64 0, i64 %179
  ...
  %194 = getelementptr inbounds [11 x i32], [11 x i32]* %8, i64 0, i64 %193
  ...
  %208 = getelementptr inbounds [11 x i32], [11 x i32]* %10, i64 0, i64 %207
  %209 = load i32, i32* %208, align 4
  %210 = load i32, i32* %5, align 4
  %211 = sext i32 %210 to i64
  %212 = getelementptr inbounds [10000 x double], [10000 x double]* %13, i64 0, i64 %211
  %213 = load double, double* %212, align 8
  %214 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.2, i64 0, i64 0), i32 %174, i32 %181, i32 %188, i32 %195, i32 %202, i32 %209, double %213)
  %215 = load i32, i32* %5, align 4
  %216 = sext i32 %215 to i64
  %217 = getelementptr inbounds [10000 x double], [10000 x double]* %13, i64 0, i64 %216
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_1878.cpp() #0 section ".text.startup" {
