; ModuleID = 'POJ-104-source/64/64-1879.cpp'
source_filename = "POJ-104-source/64/64-1879.cpp"
...
@s = dso_local global [10 x [10 x double]] zeroinitializer, align 16
@c = dso_local global [2 x i32] zeroinitializer, align 4
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [9 x i8] c"%d %d %d\00", align 1
@.str.2 = private unnamed_addr constant [29 x i8] c"(%d,%d,%d)-(%d,%d,%d)=%.2lf\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_1879.cpp, i8* null }]
...
define dso_local i32 @_Z3mini(i32 %0) #4 {
...
18:                                               ; preds = %14
  ...
  %21 = getelementptr inbounds [10 x [10 x double]], [10 x [10 x double]]* @s, i64 0, i64 %20
  %22 = load i32, i32* %4, align 4
  %23 = sext i32 %22 to i64
  %24 = getelementptr inbounds [10 x double], [10 x double]* %21, i64 0, i64 %23
...
28:                                               ; preds = %18
  ...
  store i32 %29, i32* getelementptr inbounds ([2 x i32], [2 x i32]* @c, i64 0, i64 0), align 4
  %30 = load i32, i32* %4, align 4
  store i32 %30, i32* getelementptr inbounds ([2 x i32], [2 x i32]* @c, i64 0, i64 1), align 4
  %31 = load i32, i32* %3, align 4
  %32 = sext i32 %31 to i64
  %33 = getelementptr inbounds [10 x [10 x double]], [10 x [10 x double]]* @s, i64 0, i64 %32
...
25:                                               ; preds = %21
  ...
  %35 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32* %28, i32* %31, i32* %34)
  br label %36
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_1879.cpp() #0 section ".text.startup" {
