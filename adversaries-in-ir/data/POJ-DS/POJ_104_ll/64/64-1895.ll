; ModuleID = 'POJ-104-source/64/64-1895.cpp'
source_filename = "POJ-104-source/64/64-1895.cpp"
...
@g = dso_local global [10000 x double] zeroinitializer, align 16
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [10 x i8] c"%lf%lf%lf\00", align 1
@.str.2 = private unnamed_addr constant [29 x i8] c"(%d,%d,%d)-(%d,%d,%d)=%.2lf\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_1895.cpp, i8* null }]
...
162:                                              ; preds = %36
  ...
  %167 = sdiv i32 %166, 2
  call void @_Z4mppxPdi(double* getelementptr inbounds ([10000 x double], [10000 x double]* @a, i64 0, i64 0), i32 %167)
...
define dso_local void @_Z4mppxPdi(double* %0, i32 %1) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_1895.cpp() #0 section ".text.startup" {
