; ModuleID = 'POJ-104-source/64/64-1909.cpp'
source_filename = "POJ-104-source/64/64-1909.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_1909.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local float @_Z2juPiS_(i32* %0, i32* %1) #0 {
...
45:                                               ; preds = %41
  ...
  %64 = call float @_Z2juPiS_(i32* %59, i32* %63)
...
102:                                              ; preds = %90
  ...
  %114 = bitcast %struct.s* %113 to i8*
  %115 = bitcast %struct.s* %110 to i8*
...
145:                                              ; preds = %133
  ...
  %157 = bitcast %struct.s* %156 to i8*
  %158 = bitcast %struct.s* %153 to i8*
...
188:                                              ; preds = %176
  ...
  %200 = bitcast %struct.s* %199 to i8*
  %201 = bitcast %struct.s* %196 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_1909.cpp() #0 section ".text.startup" {
