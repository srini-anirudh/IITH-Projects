; ModuleID = 'POJ-104-source/64/64-1912.cpp'
source_filename = "POJ-104-source/64/64-1912.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_1912.cpp, i8* null }]
...
28:                                               ; preds = %24
  ...
  %38 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32* %31, i32* %34, i32* %37)
  br label %39
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_1912.cpp() #0 section ".text.startup" {
