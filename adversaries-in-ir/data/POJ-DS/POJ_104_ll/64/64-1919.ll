; ModuleID = 'POJ-104-source/64/64-1919.cpp'
source_filename = "POJ-104-source/64/64-1919.cpp"
...
@b = dso_local global [45 x %struct.distants] zeroinitializer, align 16
@mid = dso_local global %struct.distants zeroinitializer, align 8
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [28 x i8] c"(%d,%d,%d)-(%d,%d,%d)=%.2f\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_1919.cpp, i8* null }]
...
237:                                              ; preds = %224, %184, %157
  ...
  %251 = bitcast %struct.distants* %250 to i8*
  %252 = bitcast %struct.distants* %246 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_1919.cpp() #0 section ".text.startup" {
