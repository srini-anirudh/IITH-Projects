; ModuleID = 'POJ-104-source/64/64-1922.cpp'
source_filename = "POJ-104-source/64/64-1922.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_1922.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local double @_Z4juliiiiiii(i32 %0, i32 %1, i32 %2, i32 %3, i32 %4, i32 %5) #0 {
...
47:                                               ; preds = %42
  ...
  %75 = call double @_Z4juliiiiiii(i32 %51, i32 %55, i32 %59, i32 %64, i32 %69, i32 %74)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_1922.cpp() #0 section ".text.startup" {
