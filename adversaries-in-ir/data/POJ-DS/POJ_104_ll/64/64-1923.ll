; ModuleID = 'POJ-104-source/64/64-1923.cpp'
source_filename = "POJ-104-source/64/64-1923.cpp"
...
@q = dso_local global %struct.point zeroinitializer, align 4
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_1923.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local float @_Z7distantiiiiii(i32 %0, i32 %1, i32 %2, i32 %3, i32 %4, i32 %5) #0 {
...
20:                                               ; preds = %16
  ...
  %30 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32* %23, i32* %26, i32* %29)
  br label %31
...
128:                                              ; preds = %120
  ...
  %165 = call float @_Z7distantiiiiii(i32 %134, i32 %140, i32 %146, i32 %152, i32 %158, i32 %164)
...
204:                                              ; preds = %191
  ...
  %212 = getelementptr inbounds [100 x %struct.point], [100 x %struct.point]* @p, i64 0, i64 %211
  ...
  %217 = bitcast %struct.point* %212 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_1923.cpp() #0 section ".text.startup" {
