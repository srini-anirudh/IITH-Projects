; ModuleID = 'POJ-104-source/64/64-1931.cpp'
source_filename = "POJ-104-source/64/64-1931.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_1931.cpp, i8* null }]
...
define dso_local i32 @_Z4distiiiiii(i32 %0, i32 %1, i32 %2, i32 %3, i32 %4, i32 %5) #4 {
...
define dso_local i32 @main() #5 {
  ...
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %8)
...
22:                                               ; preds = %18
  ...
  %32 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32* %25, i32* %28, i32* %31)
  br label %33
...
49:                                               ; preds = %45
  ...
  %74 = call i32 @_Z4distiiiiii(i32 %53, i32 %57, i32 %61, i32 %65, i32 %69, i32 %73)
...
287:                                              ; preds = %283
  ...
  %316 = call double @_ZSt4sqrtIiEN9__gnu_cxx11__enable_ifIXsr12__is_integerIT_EE7__valueEdE6__typeES2_(i32 %315)
  %317 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.2, i64 0, i64 0), i32 %291, i32 %295, i32 %299, i32 %303, i32 %307, i32 %311, double %316)
  br label %318
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_1931.cpp() #0 section ".text.startup" {
