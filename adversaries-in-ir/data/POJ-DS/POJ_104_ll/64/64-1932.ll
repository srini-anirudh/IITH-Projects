; ModuleID = 'POJ-104-source/64/64-1932.cpp'
source_filename = "POJ-104-source/64/64-1932.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_1932.cpp, i8* null }]
...
76:                                               ; preds = %72
  ...
  %85 = call double @_Z8distancePiS_(i32* %80, i32* %84)
...
; Function Attrs: noinline uwtable
define dso_local double @_Z8distancePiS_(i32* %0, i32* %1) #0 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_1932.cpp() #0 section ".text.startup" {
