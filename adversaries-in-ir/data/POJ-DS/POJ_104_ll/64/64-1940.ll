; ModuleID = 'POJ-104-source/64/64-1940.cpp'
source_filename = "POJ-104-source/64/64-1940.cpp"
...
@num = dso_local global [46 x [8 x double]] zeroinitializer, align 16
@arr = dso_local global [11 x %struct.node] zeroinitializer, align 16
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [9 x i8] c"%d %d %d\00", align 1
@.str.2 = private unnamed_addr constant [34 x i8] c"(%.f,%.f,%.f)-(%.f,%.f,%.f)=%.2f\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_1940.cpp, i8* null }]
...
25:                                               ; preds = %21
  ...
  %38 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32* %29, i32* %33, i32* %37)
  br label %39
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_1940.cpp() #0 section ".text.startup" {
