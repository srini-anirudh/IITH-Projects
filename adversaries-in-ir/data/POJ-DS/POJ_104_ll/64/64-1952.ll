; ModuleID = 'POJ-104-source/64/64-1952.cpp'
source_filename = "POJ-104-source/64/64-1952.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_1952.cpp, i8* null }]
...
16:                                               ; preds = %12
  ...
  %26 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32* %19, i32* %22, i32* %25)
  br label %27
...
42:                                               ; preds = %38
  ...
  %120 = call float @_Z1fiiiiii(i32 %99, i32 %103, i32 %107, i32 %111, i32 %115, i32 %119)
...
159:                                              ; preds = %146
  ...
  %168 = getelementptr inbounds [55 x %struct.POINT], [55 x %struct.POINT]* %10, i64 0, i64 %167
  ...
  %173 = bitcast %struct.POINT* %168 to i8*
...
226:                                              ; preds = %213
  ...
  %239 = bitcast %struct.POINT* %238 to i8*
  %240 = bitcast %struct.POINT* %235 to i8*
...
; Function Attrs: noinline uwtable
define dso_local float @_Z1fiiiiii(i32 %0, i32 %1, i32 %2, i32 %3, i32 %4, i32 %5) #0 {
  %7 = alloca i32, align 4
  %8 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_1952.cpp() #0 section ".text.startup" {
