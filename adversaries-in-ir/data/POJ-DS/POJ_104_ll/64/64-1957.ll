; ModuleID = 'POJ-104-source/64/64-1957.cpp'
source_filename = "POJ-104-source/64/64-1957.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_1957.cpp, i8* null }]
...
16:                                               ; preds = %12
  ...
  %27 = getelementptr inbounds [10 x [3 x i32]], [10 x [3 x i32]]* %6, i64 0, i64 %26
...
46:                                               ; preds = %42
  ...
  %49 = getelementptr inbounds [10 x [3 x i32]], [10 x [3 x i32]]* %6, i64 0, i64 %48
  ...
  %107 = getelementptr inbounds [10 x [3 x i32]], [10 x [3 x i32]]* %6, i64 0, i64 %106
...
164:                                              ; preds = %154
  ...
  %167 = getelementptr inbounds [10 x [10 x double]], [10 x [10 x double]]* %7, i64 0, i64 %166
...
182:                                              ; preds = %142
  ...
  %187 = getelementptr inbounds [10 x [3 x i32]], [10 x [3 x i32]]* %6, i64 0, i64 %186
  ...
  %216 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.2, i64 0, i64 0), i32 %189, i32 %194, i32 %199, i32 %204, i32 %209, i32 %214, double %215)
  %217 = load i32, i32* %9, align 4
  %218 = sext i32 %217 to i64
  %219 = getelementptr inbounds [10 x [10 x double]], [10 x [10 x double]]* %7, i64 0, i64 %218
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_1957.cpp() #0 section ".text.startup" {
