; ModuleID = 'POJ-104-source/64/64-2234.cpp'
source_filename = "POJ-104-source/64/64-2234.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_2234.cpp, i8* null }]
...
define dso_local i32 @main() #5 {
  ...
  %12 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %2)
...
21:                                               ; preds = %17
  ...
  %44 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %43)
  br label %45
...
73:                                               ; preds = %68
  ...
  %86 = call double @_Z8DistanceP5PointS0_(%struct.Point* %81, %struct.Point* %85)
...
89:                                               ; preds = %73
  ...
  %98 = call double @_Z8DistanceP5PointS0_(%struct.Point* %93, %struct.Point* %97)
...
117:                                              ; preds = %112
  ...
  %126 = call double @_Z8DistanceP5PointS0_(%struct.Point* %121, %struct.Point* %125)
...
204:                                              ; preds = %200
  ...
  %217 = call double @_Z8DistanceP5PointS0_(%struct.Point* %212, %struct.Point* %216)
...
235:                                              ; preds = %219
  ...
  %280 = call double @_Z8DistanceP5PointS0_(%struct.Point* %275, %struct.Point* %279)
...
283:                                              ; preds = %204
  ...
  %292 = call double @_Z8DistanceP5PointS0_(%struct.Point* %287, %struct.Point* %291)
...
299:                                              ; preds = %283
  ...
  call void @_Z6OutputP5PointS0_(%struct.Point* %303, %struct.Point* %307)
  br label %308
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_2234.cpp() #0 section ".text.startup" {
