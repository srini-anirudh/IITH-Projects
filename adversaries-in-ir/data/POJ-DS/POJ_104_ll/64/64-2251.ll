; ModuleID = 'POJ-104-source/64/64-2251.cpp'
source_filename = "POJ-104-source/64/64-2251.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_2251.cpp, i8* null }]
...
define dso_local double @_Z4juliddd(double %0, double %1, double %2) #4 {
...
24:                                               ; preds = %19
  ...
  %34 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i64 0, i64 0), double* %27, double* %30, double* %33)
  br label %35
...
52:                                               ; preds = %47
  ...
  %80 = call double @_Z4juliddd(double %61, double %70, double %79)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_2251.cpp() #0 section ".text.startup" {
