; ModuleID = 'POJ-104-source/64/64-2270.cpp'
source_filename = "POJ-104-source/64/64-2270.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_2270.cpp, i8* null }]
...
43:                                               ; preds = %39
  ...
  %106 = getelementptr inbounds [10 x [10 x double]], [10 x [10 x double]]* %11, i64 0, i64 %105
...
171:                                              ; preds = %167
  ...
  %197 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.2, i64 0, i64 0), i32 %175, i32 %179, i32 %183, i32 %187, i32 %191, i32 %195, double %196)
  %198 = load i32, i32* %6, align 4
  %199 = sext i32 %198 to i64
  %200 = getelementptr inbounds [10 x [10 x double]], [10 x [10 x double]]* %11, i64 0, i64 %199
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_2270.cpp() #0 section ".text.startup" {
