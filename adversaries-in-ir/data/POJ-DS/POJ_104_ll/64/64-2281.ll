; ModuleID = 'POJ-104-source/64/64-2281.cpp'
source_filename = "POJ-104-source/64/64-2281.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_2281.cpp, i8* null }]
...
43:                                               ; preds = %39
  ...
  %49 = getelementptr inbounds [45 x %struct.distant], [45 x %struct.distant]* %7, i64 0, i64 %48
  ...
  %55 = getelementptr inbounds [10 x %struct.point], [10 x %struct.point]* %6, i64 0, i64 %54
  %56 = load i32, i32* %5, align 4
  %57 = sext i32 %56 to i64
  %58 = getelementptr inbounds [45 x %struct.distant], [45 x %struct.distant]* %7, i64 0, i64 %57
  %59 = getelementptr inbounds %struct.distant, %struct.distant* %58, i32 0, i32 1
...
203:                                              ; preds = %190
  ...
  %212 = getelementptr inbounds [45 x %struct.distant], [45 x %struct.distant]* %7, i64 0, i64 %211
  %213 = load i32, i32* %4, align 4
  %214 = sext i32 %213 to i64
  %215 = getelementptr inbounds [45 x %struct.distant], [45 x %struct.distant]* %7, i64 0, i64 %214
  %216 = bitcast %struct.distant* %215 to i8*
  %217 = bitcast %struct.distant* %212 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_2281.cpp() #0 section ".text.startup" {
