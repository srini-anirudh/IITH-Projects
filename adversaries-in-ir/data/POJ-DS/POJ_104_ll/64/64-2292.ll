; ModuleID = 'POJ-104-source/64/64-2292.cpp'
source_filename = "POJ-104-source/64/64-2292.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_2292.cpp, i8* null }]
...
16:                                               ; preds = %11
  ...
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), double* %19)
  br label %21
...
247:                                              ; preds = %234
  ...
  %251 = getelementptr inbounds [46 x %struct.jl], [46 x %struct.jl]* %9, i64 0, i64 %250
  %252 = getelementptr inbounds [46 x %struct.jl], [46 x %struct.jl]* %9, i64 0, i64 45
  %253 = bitcast %struct.jl* %252 to i8*
  %254 = bitcast %struct.jl* %251 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %253, i8* align 8 %254, i64 56, i1 false)
  %255 = load i32, i32* %3, align 4
  %256 = sext i32 %255 to i64
  %257 = getelementptr inbounds [46 x %struct.jl], [46 x %struct.jl]* %9, i64 0, i64 %256
  %258 = load i32, i32* %3, align 4
  %259 = add nsw i32 %258, 1
  %260 = sext i32 %259 to i64
  %261 = getelementptr inbounds [46 x %struct.jl], [46 x %struct.jl]* %9, i64 0, i64 %260
  %262 = bitcast %struct.jl* %261 to i8*
  %263 = bitcast %struct.jl* %257 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %262, i8* align 8 %263, i64 56, i1 false)
  %264 = getelementptr inbounds [46 x %struct.jl], [46 x %struct.jl]* %9, i64 0, i64 45
  %265 = load i32, i32* %3, align 4
  %266 = sext i32 %265 to i64
  %267 = getelementptr inbounds [46 x %struct.jl], [46 x %struct.jl]* %9, i64 0, i64 %266
  %268 = bitcast %struct.jl* %267 to i8*
  %269 = bitcast %struct.jl* %264 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_2292.cpp() #0 section ".text.startup" {
