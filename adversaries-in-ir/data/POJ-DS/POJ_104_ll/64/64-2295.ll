; ModuleID = 'POJ-104-source/64/64-2295.cpp'
source_filename = "POJ-104-source/64/64-2295.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_2295.cpp, i8* null }]
...
264:                                              ; preds = %251
  ...
  %273 = getelementptr inbounds [50 x %struct.result], [50 x %struct.result]* %13, i64 0, i64 %272
  %274 = load i32, i32* %3, align 4
  %275 = add nsw i32 %274, 1
  %276 = sext i32 %275 to i64
  %277 = getelementptr inbounds [50 x %struct.result], [50 x %struct.result]* %13, i64 0, i64 %276
  %278 = bitcast %struct.result* %277 to i8*
  %279 = bitcast %struct.result* %273 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_2295.cpp() #0 section ".text.startup" {
