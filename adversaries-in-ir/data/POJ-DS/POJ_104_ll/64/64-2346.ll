; ModuleID = 'POJ-104-source/64/64-2346.cpp'
source_filename = "POJ-104-source/64/64-2346.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_2346.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %21 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* %2)
...
26:                                               ; preds = %22
  ...
  %36 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32* %29, i32* %32, i32* %35)
  br label %37
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_2346.cpp() #0 section ".text.startup" {
