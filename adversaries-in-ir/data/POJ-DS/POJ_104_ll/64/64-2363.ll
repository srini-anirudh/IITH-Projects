; ModuleID = 'POJ-104-source/64/64-2363.cpp'
source_filename = "POJ-104-source/64/64-2363.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_2363.cpp, i8* null }]
...
7:                                                ; preds = %3
  ...
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32* %10, i32* %13, i32* %16)
  br label %18
...
14:                                               ; preds = %10
  ...
  %75 = call double @_Z3sqrd(double %74)
...
define dso_local double @_Z3sqrd(double %0) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_2363.cpp() #0 section ".text.startup" {
