; ModuleID = 'POJ-104-source/64/64-2366.cpp'
source_filename = "POJ-104-source/64/64-2366.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_2366.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local double @_Z2idiii(i32 %0, i32 %1, i32 %2) #0 {
...
50:                                               ; preds = %46
  ...
  %78 = call double @_Z2idiii(i32 %59, i32 %68, i32 %77)
...
122:                                              ; preds = %111
  ...
  call void @_ZSt4swapIiENSt9enable_ifIXsr6__and_ISt6__not_ISt15__is_tuple_likeIT_EESt21is_move_constructibleIS3_ESt18is_move_assignableIS3_EEE5valueEvE4typeERS3_SC_(i32* dereferenceable(4) %125, i32* dereferenceable(4) %129) #3
  ...
  %136 = getelementptr inbounds [200 x i32], [200 x i32]* %11, i64 0, i64 %135
  call void @_ZSt4swapIiENSt9enable_ifIXsr6__and_ISt6__not_ISt15__is_tuple_likeIT_EESt21is_move_constructibleIS3_ESt18is_move_assignableIS3_EEE5valueEvE4typeERS3_SC_(i32* dereferenceable(4) %132, i32* dereferenceable(4) %136) #3
  ...
  %143 = getelementptr inbounds [200 x double], [200 x double]* %12, i64 0, i64 %142
  call void @_ZSt4swapIdENSt9enable_ifIXsr6__and_ISt6__not_ISt15__is_tuple_likeIT_EESt21is_move_constructibleIS3_ESt18is_move_assignableIS3_EEE5valueEvE4typeERS3_SC_(double* dereferenceable(8) %139, double* dereferenceable(8) %143) #3
  br label %144
...
157:                                              ; preds = %153
  ...
  %174 = getelementptr inbounds [200 x i32], [200 x i32]* %10, i64 0, i64 %173
  %175 = load i32, i32* %174, align 4
  %176 = sext i32 %175 to i64
  %177 = getelementptr inbounds [20 x i32], [20 x i32]* %9, i64 0, i64 %176
  %178 = load i32, i32* %177, align 4
  %179 = load i32, i32* %3, align 4
  %180 = sext i32 %179 to i64
  %181 = getelementptr inbounds [200 x i32], [200 x i32]* %11, i64 0, i64 %180
  ...
  %191 = getelementptr inbounds [20 x i32], [20 x i32]* %8, i64 0, i64 %190
  ...
  %198 = getelementptr inbounds [20 x i32], [20 x i32]* %9, i64 0, i64 %197
  %199 = load i32, i32* %198, align 4
  %200 = load i32, i32* %3, align 4
  %201 = sext i32 %200 to i64
  %202 = getelementptr inbounds [200 x double], [200 x double]* %12, i64 0, i64 %201
  %203 = load double, double* %202, align 8
  %204 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.2, i64 0, i64 0), i32 %164, i32 %171, i32 %178, i32 %185, i32 %192, i32 %199, double %203)
  br label %205
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_2366.cpp() #0 section ".text.startup" {
