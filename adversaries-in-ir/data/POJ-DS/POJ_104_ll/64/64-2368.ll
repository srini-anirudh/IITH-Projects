; ModuleID = 'POJ-104-source/64/64-2368.cpp'
source_filename = "POJ-104-source/64/64-2368.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_2368.cpp, i8* null }]
...
27:                                               ; preds = %23
  ...
  %37 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32* %30, i32* %33, i32* %36)
  br label %38
...
139:                                              ; preds = %135
  ...
  %142 = getelementptr inbounds [50 x double], [50 x double]* %13, i64 0, i64 %141
...
149:                                              ; preds = %139
  ...
  %160 = getelementptr inbounds [50 x double], [50 x double]* %13, i64 0, i64 %159
...
173:                                              ; preds = %127
  %174 = getelementptr inbounds [50 x double], [50 x double]* %13, i64 0, i64 0
  %175 = load double, double* %174, align 16
  %176 = getelementptr inbounds [50 x double], [50 x double]* %15, i64 0, i64 0
...
181:                                              ; preds = %177
  ...
  %185 = getelementptr inbounds [50 x double], [50 x double]* %15, i64 0, i64 %184
  %186 = load double, double* %185, align 8
  %187 = load i32, i32* %6, align 4
  %188 = sext i32 %187 to i64
  %189 = getelementptr inbounds [50 x double], [50 x double]* %13, i64 0, i64 %188
  %190 = load double, double* %189, align 8
  %191 = fcmp une double %186, %190
...
225:                                              ; preds = %221
  ...
  %228 = getelementptr inbounds [11 x i32], [11 x i32]* %9, i64 0, i64 %227
  ...
  %237 = getelementptr inbounds [11 x i32], [11 x i32]* %9, i64 0, i64 %236
  %238 = load i32, i32* %237, align 4
  %239 = load i32, i32* %7, align 4
  %240 = sext i32 %239 to i64
  %241 = getelementptr inbounds [11 x i32], [11 x i32]* %9, i64 0, i64 %240
  ...
  %251 = getelementptr inbounds [11 x i32], [11 x i32]* %10, i64 0, i64 %250
  %252 = load i32, i32* %251, align 4
  %253 = sub nsw i32 %248, %252
  %254 = load i32, i32* %4, align 4
  %255 = sext i32 %254 to i64
  %256 = getelementptr inbounds [11 x i32], [11 x i32]* %10, i64 0, i64 %255
  %257 = load i32, i32* %256, align 4
  %258 = load i32, i32* %7, align 4
  %259 = sext i32 %258 to i64
  %260 = getelementptr inbounds [11 x i32], [11 x i32]* %10, i64 0, i64 %259
  ...
  %267 = getelementptr inbounds [11 x i32], [11 x i32]* %11, i64 0, i64 %266
  %268 = load i32, i32* %267, align 4
  %269 = load i32, i32* %7, align 4
  %270 = sext i32 %269 to i64
  %271 = getelementptr inbounds [11 x i32], [11 x i32]* %11, i64 0, i64 %270
  %272 = load i32, i32* %271, align 4
  %273 = sub nsw i32 %268, %272
  %274 = load i32, i32* %4, align 4
  %275 = sext i32 %274 to i64
  %276 = getelementptr inbounds [11 x i32], [11 x i32]* %11, i64 0, i64 %275
  %277 = load i32, i32* %276, align 4
  %278 = load i32, i32* %7, align 4
  %279 = sext i32 %278 to i64
  %280 = getelementptr inbounds [11 x i32], [11 x i32]* %11, i64 0, i64 %279
  %281 = load i32, i32* %280, align 4
  %282 = sub nsw i32 %277, %281
  %283 = mul nsw i32 %273, %282
  %284 = add nsw i32 %264, %283
  %285 = call double @_ZSt4sqrtIiEN9__gnu_cxx11__enable_ifIXsr12__is_integerIT_EE7__valueEdE6__typeES2_(i32 %284)
  store double %285, double* %16, align 8
  %286 = load i32, i32* %8, align 4
  %287 = sext i32 %286 to i64
  %288 = getelementptr inbounds [50 x double], [50 x double]* %15, i64 0, i64 %287
...
292:                                              ; preds = %225
  ...
  %299 = getelementptr inbounds [11 x i32], [11 x i32]* %10, i64 0, i64 %298
  %300 = load i32, i32* %299, align 4
  %301 = load i32, i32* %4, align 4
  %302 = sext i32 %301 to i64
  %303 = getelementptr inbounds [11 x i32], [11 x i32]* %11, i64 0, i64 %302
  %304 = load i32, i32* %303, align 4
  %305 = load i32, i32* %7, align 4
  %306 = sext i32 %305 to i64
  %307 = getelementptr inbounds [11 x i32], [11 x i32]* %9, i64 0, i64 %306
  %308 = load i32, i32* %307, align 4
  %309 = load i32, i32* %7, align 4
  %310 = sext i32 %309 to i64
  %311 = getelementptr inbounds [11 x i32], [11 x i32]* %10, i64 0, i64 %310
  %312 = load i32, i32* %311, align 4
  %313 = load i32, i32* %7, align 4
  %314 = sext i32 %313 to i64
  %315 = getelementptr inbounds [11 x i32], [11 x i32]* %11, i64 0, i64 %314
  %316 = load i32, i32* %315, align 4
  %317 = load i32, i32* %8, align 4
  %318 = sext i32 %317 to i64
  %319 = getelementptr inbounds [50 x double], [50 x double]* %15, i64 0, i64 %318
  %320 = load double, double* %319, align 8
  %321 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.2, i64 0, i64 0), i32 %296, i32 %300, i32 %304, i32 %308, i32 %312, i32 %316, double %320)
  br label %322
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_2368.cpp() #0 section ".text.startup" {
