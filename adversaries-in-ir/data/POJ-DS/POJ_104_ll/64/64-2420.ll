; ModuleID = 'POJ-104-source/64/64-2420.cpp'
source_filename = "POJ-104-source/64/64-2420.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_2420.cpp, i8* null }]
...
29:                                               ; preds = %25
  ...
  %39 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32* %32, i32* %35, i32* %38)
  br label %40
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_2420.cpp() #0 section ".text.startup" {
