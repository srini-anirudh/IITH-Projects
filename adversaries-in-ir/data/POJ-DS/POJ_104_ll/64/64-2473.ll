; ModuleID = 'POJ-104-source/64/64-2473.cpp'
source_filename = "POJ-104-source/64/64-2473.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_2473.cpp, i8* null }]
...
50:                                               ; preds = %46
  ...
  %114 = getelementptr inbounds [46 x float], [46 x float]* %12, i64 0, i64 %113
  store float %111, float* %114, align 4
  %115 = load i32, i32* %10, align 4
  %116 = load i32, i32* %15, align 4
  %117 = sext i32 %116 to i64
  %118 = getelementptr inbounds [46 x i32], [46 x i32]* %13, i64 0, i64 %117
  store i32 %115, i32* %118, align 4
  %119 = load i32, i32* %11, align 4
  %120 = load i32, i32* %15, align 4
  %121 = sext i32 %120 to i64
  %122 = getelementptr inbounds [46 x i32], [46 x i32]* %14, i64 0, i64 %121
...
144:                                              ; preds = %140
  ...
  %151 = getelementptr inbounds [46 x float], [46 x float]* %12, i64 0, i64 %150
...
154:                                              ; preds = %144
  ...
  %165 = getelementptr inbounds [46 x float], [46 x float]* %12, i64 0, i64 %164
  store float %162, float* %165, align 4
  %166 = load float, float* %16, align 4
  %167 = load i32, i32* %10, align 4
  %168 = sext i32 %167 to i64
  %169 = getelementptr inbounds [46 x float], [46 x float]* %12, i64 0, i64 %168
  store float %166, float* %169, align 4
  %170 = load i32, i32* %11, align 4
  %171 = sext i32 %170 to i64
  %172 = getelementptr inbounds [46 x i32], [46 x i32]* %13, i64 0, i64 %171
  %173 = load i32, i32* %172, align 4
  store i32 %173, i32* %17, align 4
  %174 = load i32, i32* %10, align 4
  %175 = sext i32 %174 to i64
  %176 = getelementptr inbounds [46 x i32], [46 x i32]* %13, i64 0, i64 %175
  %177 = load i32, i32* %176, align 4
  %178 = load i32, i32* %11, align 4
  %179 = sext i32 %178 to i64
  %180 = getelementptr inbounds [46 x i32], [46 x i32]* %13, i64 0, i64 %179
  store i32 %177, i32* %180, align 4
  %181 = load i32, i32* %17, align 4
  %182 = load i32, i32* %10, align 4
  %183 = sext i32 %182 to i64
  %184 = getelementptr inbounds [46 x i32], [46 x i32]* %13, i64 0, i64 %183
  store i32 %181, i32* %184, align 4
  %185 = load i32, i32* %11, align 4
  %186 = sext i32 %185 to i64
  %187 = getelementptr inbounds [46 x i32], [46 x i32]* %14, i64 0, i64 %186
  %188 = load i32, i32* %187, align 4
  store i32 %188, i32* %17, align 4
  %189 = load i32, i32* %10, align 4
  %190 = sext i32 %189 to i64
  %191 = getelementptr inbounds [46 x i32], [46 x i32]* %14, i64 0, i64 %190
  %192 = load i32, i32* %191, align 4
  %193 = load i32, i32* %11, align 4
  %194 = sext i32 %193 to i64
  %195 = getelementptr inbounds [46 x i32], [46 x i32]* %14, i64 0, i64 %194
  store i32 %192, i32* %195, align 4
  %196 = load i32, i32* %17, align 4
  %197 = load i32, i32* %10, align 4
  %198 = sext i32 %197 to i64
  %199 = getelementptr inbounds [46 x i32], [46 x i32]* %14, i64 0, i64 %198
...
210:                                              ; preds = %200
  ...
  %213 = getelementptr inbounds [46 x i32], [46 x i32]* %13, i64 0, i64 %212
  %214 = load i32, i32* %213, align 4
  %215 = load i32, i32* %11, align 4
  %216 = sext i32 %215 to i64
  %217 = getelementptr inbounds [46 x i32], [46 x i32]* %13, i64 0, i64 %216
...
220:                                              ; preds = %210
  ...
  %223 = getelementptr inbounds [46 x i32], [46 x i32]* %13, i64 0, i64 %222
  %224 = load i32, i32* %223, align 4
  %225 = load i32, i32* %11, align 4
  %226 = sext i32 %225 to i64
  %227 = getelementptr inbounds [46 x i32], [46 x i32]* %13, i64 0, i64 %226
...
240:                                              ; preds = %230, %210
  ...
  %243 = getelementptr inbounds [46 x float], [46 x float]* %12, i64 0, i64 %242
  %244 = load float, float* %243, align 4
  store float %244, float* %16, align 4
  %245 = load i32, i32* %10, align 4
  %246 = sext i32 %245 to i64
  %247 = getelementptr inbounds [46 x float], [46 x float]* %12, i64 0, i64 %246
  %248 = load float, float* %247, align 4
  %249 = load i32, i32* %11, align 4
  %250 = sext i32 %249 to i64
  %251 = getelementptr inbounds [46 x float], [46 x float]* %12, i64 0, i64 %250
  store float %248, float* %251, align 4
  %252 = load float, float* %16, align 4
  %253 = load i32, i32* %10, align 4
  %254 = sext i32 %253 to i64
  %255 = getelementptr inbounds [46 x float], [46 x float]* %12, i64 0, i64 %254
  store float %252, float* %255, align 4
  %256 = load i32, i32* %11, align 4
  %257 = sext i32 %256 to i64
  %258 = getelementptr inbounds [46 x i32], [46 x i32]* %13, i64 0, i64 %257
  %259 = load i32, i32* %258, align 4
  store i32 %259, i32* %17, align 4
  %260 = load i32, i32* %10, align 4
  %261 = sext i32 %260 to i64
  %262 = getelementptr inbounds [46 x i32], [46 x i32]* %13, i64 0, i64 %261
  %263 = load i32, i32* %262, align 4
  %264 = load i32, i32* %11, align 4
  %265 = sext i32 %264 to i64
  %266 = getelementptr inbounds [46 x i32], [46 x i32]* %13, i64 0, i64 %265
  store i32 %263, i32* %266, align 4
  %267 = load i32, i32* %17, align 4
  %268 = load i32, i32* %10, align 4
  %269 = sext i32 %268 to i64
  %270 = getelementptr inbounds [46 x i32], [46 x i32]* %13, i64 0, i64 %269
  store i32 %267, i32* %270, align 4
  %271 = load i32, i32* %11, align 4
  %272 = sext i32 %271 to i64
  %273 = getelementptr inbounds [46 x i32], [46 x i32]* %14, i64 0, i64 %272
  %274 = load i32, i32* %273, align 4
  store i32 %274, i32* %17, align 4
  %275 = load i32, i32* %10, align 4
  %276 = sext i32 %275 to i64
  %277 = getelementptr inbounds [46 x i32], [46 x i32]* %14, i64 0, i64 %276
  %278 = load i32, i32* %277, align 4
  %279 = load i32, i32* %11, align 4
  %280 = sext i32 %279 to i64
  %281 = getelementptr inbounds [46 x i32], [46 x i32]* %14, i64 0, i64 %280
  store i32 %278, i32* %281, align 4
  %282 = load i32, i32* %17, align 4
  %283 = load i32, i32* %10, align 4
  %284 = sext i32 %283 to i64
  %285 = getelementptr inbounds [46 x i32], [46 x i32]* %14, i64 0, i64 %284
  store i32 %282, i32* %285, align 4
  br label %286

286:                                              ; preds = %240, %230, %220
  br label %287
...
291:                                              ; preds = %140
  ...
  %294 = getelementptr inbounds [46 x i32], [46 x i32]* %13, i64 0, i64 %293
  ...
  %301 = getelementptr inbounds [46 x i32], [46 x i32]* %13, i64 0, i64 %300
  ...
  %322 = getelementptr inbounds [46 x i32], [46 x i32]* %14, i64 0, i64 %321
  ...
  %329 = getelementptr inbounds [46 x i32], [46 x i32]* %14, i64 0, i64 %328
  ...
  %336 = getelementptr inbounds [46 x float], [46 x float]* %12, i64 0, i64 %335
  %337 = load float, float* %336, align 4
  %338 = fpext float %337 to double
  %339 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.2, i64 0, i64 0), i32 %298, i32 %305, i32 %312, i32 %319, i32 %326, i32 %333, double %338)
  br label %340
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_2473.cpp() #0 section ".text.startup" {
