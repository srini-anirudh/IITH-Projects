; ModuleID = 'POJ-104-source/64/64-2480.cpp'
source_filename = "POJ-104-source/64/64-2480.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_2480.cpp, i8* null }]
...
21:                                               ; preds = %17
  ...
  %34 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32* %25, i32* %29, i32* %33)
...
63:                                               ; preds = %59
  ...
  %66 = getelementptr inbounds %struct.coordinate, %struct.coordinate* %16, i64 %65
  %67 = load i32, i32* %9, align 4
  %68 = sext i32 %67 to i64
  %69 = getelementptr inbounds %struct.distance, %struct.distance* %51, i64 %68
  %70 = getelementptr inbounds %struct.distance, %struct.distance* %69, i32 0, i32 0
  %71 = bitcast %struct.coordinate* %70 to i8*
  %72 = bitcast %struct.coordinate* %66 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %71, i8* align 16 %72, i64 16, i1 false)
  %73 = load i32, i32* %6, align 4
  %74 = sext i32 %73 to i64
  %75 = getelementptr inbounds %struct.coordinate, %struct.coordinate* %16, i64 %74
  %76 = load i32, i32* %9, align 4
  %77 = sext i32 %76 to i64
  %78 = getelementptr inbounds %struct.distance, %struct.distance* %51, i64 %77
  %79 = getelementptr inbounds %struct.distance, %struct.distance* %78, i32 0, i32 1
  %80 = bitcast %struct.coordinate* %79 to i8*
  %81 = bitcast %struct.coordinate* %75 to i8*
...
169:                                              ; preds = %156
  ...
  %178 = getelementptr inbounds %struct.distance, %struct.distance* %51, i64 %177
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_2480.cpp() #0 section ".text.startup" {
