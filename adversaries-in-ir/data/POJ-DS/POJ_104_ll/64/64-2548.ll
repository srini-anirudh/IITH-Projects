; ModuleID = 'POJ-104-source/64/64-2548.cpp'
source_filename = "POJ-104-source/64/64-2548.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_2548.cpp, i8* null }]
...
49:                                               ; preds = %45
  ...
  %115 = getelementptr inbounds [100 x float], [100 x float]* %13, i64 0, i64 %114
...
146:                                              ; preds = %142
  ...
  %149 = getelementptr inbounds [100 x float], [100 x float]* %13, i64 0, i64 %148
...
156:                                              ; preds = %146
  ...
  store float %160, float* %14, align 4
  ...
  %171 = getelementptr inbounds [100 x float], [100 x float]* %13, i64 0, i64 %170
...
301:                                              ; preds = %297
  ...
  %314 = getelementptr inbounds [10 x i32], [10 x i32]* %11, i64 0, i64 %313
  ...
  %321 = getelementptr inbounds [10 x i32], [10 x i32]* %12, i64 0, i64 %320
  ...
  %335 = getelementptr inbounds [10 x i32], [10 x i32]* %11, i64 0, i64 %334
  ...
  %349 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.2, i64 0, i64 0), i32 %308, i32 %315, i32 %322, i32 %329, i32 %336, i32 %343, double %348)
  br label %350
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_2548.cpp() #0 section ".text.startup" {
