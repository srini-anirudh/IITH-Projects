; ModuleID = 'POJ-104-source/64/64-2554.cpp'
source_filename = "POJ-104-source/64/64-2554.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_2554.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local float @_Z4juliffffff(float %0, float %1, float %2, float %3, float %4, float %5) #0 {
...
19:                                               ; preds = %15
  ...
  %29 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), float* %22, float* %25, float* %28)
  br label %30
...
46:                                               ; preds = %42
  ...
  %71 = call float @_Z4juliffffff(float %50, float %54, float %58, float %62, float %66, float %70)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_2554.cpp() #0 section ".text.startup" {
