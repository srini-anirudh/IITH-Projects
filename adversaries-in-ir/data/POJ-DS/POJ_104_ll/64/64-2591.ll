; ModuleID = 'POJ-104-source/64/64-2591.cpp'
source_filename = "POJ-104-source/64/64-2591.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_2591.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local double @_Z8distanceiiiiii(i32 %0, i32 %1, i32 %2, i32 %3, i32 %4, i32 %5) #0 {
...
56:                                               ; preds = %52
  ...
  %97 = call double @_Z8distanceiiiiii(i32 %71, i32 %76, i32 %81, i32 %86, i32 %91, i32 %96)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_2591.cpp() #0 section ".text.startup" {
