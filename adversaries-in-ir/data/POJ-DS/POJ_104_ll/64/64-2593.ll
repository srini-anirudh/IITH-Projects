; ModuleID = 'POJ-104-source/64/64-2593.cpp'
source_filename = "POJ-104-source/64/64-2593.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_2593.cpp, i8* null }]
...
define dso_local float @_Z3sqrf(float %0) #4 {
...
; Function Attrs: noinline uwtable
define dso_local float @_Z4workPfS_(float* %0, float* %1) #0 {
  ...
  %12 = fsub float %8, %11
  %13 = call float @_Z3sqrf(float %12)
  ...
  %20 = fsub float %16, %19
  %21 = call float @_Z3sqrf(float %20)
  %22 = fadd float %13, %21
  ...
  %29 = fsub float %25, %28
  %30 = call float @_Z3sqrf(float %29)
  %31 = fadd float %22, %30
  %32 = call float @_ZSt4sqrtf(float %31)
...
22:                                               ; preds = %19
  ...
  %29 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), float* %28)
  br label %30
...
49:                                               ; preds = %45
  ...
  %58 = call float @_Z4workPfS_(float* %53, float* %57)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_2593.cpp() #0 section ".text.startup" {
