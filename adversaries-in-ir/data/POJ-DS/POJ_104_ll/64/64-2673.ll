; ModuleID = 'POJ-104-source/64/64-2673.cpp'
source_filename = "POJ-104-source/64/64-2673.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_2673.cpp, i8* null }]
...
45:                                               ; preds = %41
  ...
  %109 = getelementptr inbounds [10 x [10 x float]], [10 x [10 x float]]* %11, i64 0, i64 %108
...
142:                                              ; preds = %138
  ...
  %145 = getelementptr inbounds [10 x [10 x float]], [10 x [10 x float]]* %11, i64 0, i64 %144
  %146 = load i32, i32* %7, align 4
  %147 = sext i32 %146 to i64
  %148 = getelementptr inbounds [10 x float], [10 x float]* %145, i64 0, i64 %147
...
152:                                              ; preds = %142
  ...
  %155 = getelementptr inbounds [10 x [10 x float]], [10 x [10 x float]]* %11, i64 0, i64 %154
...
170:                                              ; preds = %130
  ...
  %197 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.2, i64 0, i64 0), i32 %174, i32 %178, i32 %182, i32 %186, i32 %190, i32 %194, double %196)
  %198 = load i32, i32* %9, align 4
  %199 = sext i32 %198 to i64
  %200 = getelementptr inbounds [10 x [10 x float]], [10 x [10 x float]]* %11, i64 0, i64 %199
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_2673.cpp() #0 section ".text.startup" {
