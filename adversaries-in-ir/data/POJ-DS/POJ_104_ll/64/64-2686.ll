; ModuleID = 'POJ-104-source/64/64-2686.cpp'
source_filename = "POJ-104-source/64/64-2686.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_2686.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), double* %2)
...
22:                                               ; preds = %17
  ...
  %32 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i64 0, i64 0), double* %25, double* %28, double* %31)
  br label %33
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_2686.cpp() #0 section ".text.startup" {
