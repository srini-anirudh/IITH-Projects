; ModuleID = 'POJ-104-source/64/64-2756.cpp'
source_filename = "POJ-104-source/64/64-2756.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_2756.cpp, i8* null }]
...
37:                                               ; preds = %33
  ...
  %47 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32* %40, i32* %43, i32* %46)
  br label %48
...
63:                                               ; preds = %59
  ...
  %128 = getelementptr inbounds double, double* %23, i64 %127
...
154:                                              ; preds = %150
  ...
  %159 = getelementptr inbounds double, double* %23, i64 %158
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_2756.cpp() #0 section ".text.startup" {
