; ModuleID = 'POJ-104-source/64/64-2762.cpp'
source_filename = "POJ-104-source/64/64-2762.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_2762.cpp, i8* null }]
...
49:                                               ; preds = %45
  ...
  %58 = call double @_Z1fPiS_(i32* %53, i32* %57)
...
143:                                              ; preds = %139
  ...
  %152 = call double @_Z1fPiS_(i32* %147, i32* %151)
...
232:                                              ; preds = %228
  ...
  %241 = call double @_Z1fPiS_(i32* %236, i32* %240)
...
306:                                              ; preds = %247
  ...
  %313 = call i32 @_Z1giiiPA2_iPdi(i32 %307, i32 %308, i32 %309, [2 x i32]* %310, double* %311, i32 %312)
...
; Function Attrs: noinline uwtable
define dso_local double @_Z1fPiS_(i32* %0, i32* %1) #0 {
...
define dso_local i32 @_Z1giiiPA2_iPdi(i32 %0, i32 %1, i32 %2, [2 x i32]* %3, double* %4, i32 %5) #5 {
  %7 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_2762.cpp() #0 section ".text.startup" {
