; ModuleID = 'POJ-104-source/64/64-2783.cpp'
source_filename = "POJ-104-source/64/64-2783.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_2783.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %4)
...
27:                                               ; preds = %23
  ...
  %37 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i64 0, i64 0), i32* %30, i32* %33, i32* %36)
  br label %38
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_2783.cpp() #0 section ".text.startup" {
