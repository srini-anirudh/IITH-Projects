; ModuleID = 'POJ-104-source/64/64-2818.cpp'
source_filename = "POJ-104-source/64/64-2818.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_2818.cpp, i8* null }]
...
18:                                               ; preds = %14
  ...
  %31 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32* %22, i32* %26, i32* %30)
  br label %32
...
189:                                              ; preds = %176
  ...
  %193 = getelementptr inbounds [1000 x %struct.jl], [1000 x %struct.jl]* %7, i64 0, i64 %192
  %194 = getelementptr inbounds [1000 x %struct.jl], [1000 x %struct.jl]* %7, i64 0, i64 1000
  %195 = bitcast %struct.jl* %194 to i8*
  %196 = bitcast %struct.jl* %193 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %195, i8* align 16 %196, i64 32, i1 false)
  %197 = load i32, i32* %3, align 4
  %198 = sext i32 %197 to i64
  %199 = getelementptr inbounds [1000 x %struct.jl], [1000 x %struct.jl]* %7, i64 0, i64 %198
  %200 = load i32, i32* %3, align 4
  %201 = add nsw i32 %200, 1
  %202 = sext i32 %201 to i64
  %203 = getelementptr inbounds [1000 x %struct.jl], [1000 x %struct.jl]* %7, i64 0, i64 %202
  %204 = bitcast %struct.jl* %203 to i8*
  %205 = bitcast %struct.jl* %199 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %204, i8* align 16 %205, i64 32, i1 false)
  %206 = getelementptr inbounds [1000 x %struct.jl], [1000 x %struct.jl]* %7, i64 0, i64 1000
  %207 = load i32, i32* %3, align 4
  %208 = sext i32 %207 to i64
  %209 = getelementptr inbounds [1000 x %struct.jl], [1000 x %struct.jl]* %7, i64 0, i64 %208
  %210 = bitcast %struct.jl* %209 to i8*
  %211 = bitcast %struct.jl* %206 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_2818.cpp() #0 section ".text.startup" {
