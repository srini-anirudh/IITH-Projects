; ModuleID = 'POJ-104-source/64/64-2860.cpp'
source_filename = "POJ-104-source/64/64-2860.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_2860.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %15 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* %3)
...
20:                                               ; preds = %16
  ...
  %30 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i64 0, i64 0), i32* %23, i32* %26, i32* %29)
  br label %31
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_2860.cpp() #0 section ".text.startup" {
