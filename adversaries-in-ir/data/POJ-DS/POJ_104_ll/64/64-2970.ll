; ModuleID = 'POJ-104-source/64/64-2970.cpp'
source_filename = "POJ-104-source/64/64-2970.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_2970.cpp, i8* null }]
...
162:                                              ; preds = %149
  ...
  %171 = getelementptr inbounds [50 x %struct.Distance], [50 x %struct.Distance]* %9, i64 0, i64 %170
  %172 = load i32, i32* %4, align 4
  %173 = sext i32 %172 to i64
  %174 = getelementptr inbounds [50 x %struct.Distance], [50 x %struct.Distance]* %9, i64 0, i64 %173
  %175 = bitcast %struct.Distance* %174 to i8*
  %176 = bitcast %struct.Distance* %171 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_2970.cpp() #0 section ".text.startup" {
