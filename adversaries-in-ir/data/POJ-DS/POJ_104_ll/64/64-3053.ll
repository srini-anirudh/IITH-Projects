; ModuleID = 'POJ-104-source/64/64-3053.cpp'
source_filename = "POJ-104-source/64/64-3053.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_3053.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local float @_Z4distPiS_(i32* %0, i32* %1) #0 {
...
45:                                               ; preds = %41
  ...
  %64 = call float @_Z4distPiS_(i32* %59, i32* %63)
...
103:                                              ; preds = %90
  ...
  %116 = bitcast %struct.distant* %115 to i8*
  %117 = bitcast %struct.distant* %112 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_3053.cpp() #0 section ".text.startup" {
