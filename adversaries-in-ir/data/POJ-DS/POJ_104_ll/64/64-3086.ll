; ModuleID = 'POJ-104-source/64/64-3086.cpp'
source_filename = "POJ-104-source/64/64-3086.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_3086.cpp, i8* null }]
...
define dso_local double @_Z8distancedddddd(double %0, double %1, double %2, double %3, double %4, double %5) #4 {
...
define dso_local i32 @main() #5 {
  ...
  %13 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* %8)
...
19:                                               ; preds = %14
  ...
  %32 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i64 0, i64 0), double* %23, double* %27, double* %31)
  br label %33
...
36:                                               ; preds = %14
  ...
  %52 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.2, i64 0, i64 0), double* %41, double* %46, double* %51)
...
65:                                               ; preds = %61
  ...
  %96 = call double @_Z8distancedddddd(double %70, double %75, double %80, double %85, double %90, double %95)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_3086.cpp() #0 section ".text.startup" {
