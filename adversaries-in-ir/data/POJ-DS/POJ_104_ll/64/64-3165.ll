; ModuleID = 'POJ-104-source/64/64-3165.cpp'
source_filename = "POJ-104-source/64/64-3165.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_3165.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local double @_Z2juPiS_(i32* %0, i32* %1) #0 {
...
43:                                               ; preds = %39
  ...
  %112 = call double @_Z2juPiS_(i32* %107, i32* %111)
...
158:                                              ; preds = %145
  ...
  %162 = getelementptr inbounds [50 x %struct.dian], [50 x %struct.dian]* %7, i64 0, i64 %161
  %163 = getelementptr inbounds [50 x %struct.dian], [50 x %struct.dian]* %7, i64 0, i64 49
  %164 = bitcast %struct.dian* %163 to i8*
  %165 = bitcast %struct.dian* %162 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %164, i8* align 16 %165, i64 32, i1 false)
  %166 = load i32, i32* %4, align 4
  %167 = sext i32 %166 to i64
  %168 = getelementptr inbounds [50 x %struct.dian], [50 x %struct.dian]* %7, i64 0, i64 %167
  %169 = load i32, i32* %4, align 4
  %170 = add nsw i32 %169, 1
  %171 = sext i32 %170 to i64
  %172 = getelementptr inbounds [50 x %struct.dian], [50 x %struct.dian]* %7, i64 0, i64 %171
  %173 = bitcast %struct.dian* %172 to i8*
  %174 = bitcast %struct.dian* %168 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %173, i8* align 16 %174, i64 32, i1 false)
  %175 = getelementptr inbounds [50 x %struct.dian], [50 x %struct.dian]* %7, i64 0, i64 49
  %176 = load i32, i32* %4, align 4
  %177 = sext i32 %176 to i64
  %178 = getelementptr inbounds [50 x %struct.dian], [50 x %struct.dian]* %7, i64 0, i64 %177
  %179 = bitcast %struct.dian* %178 to i8*
  %180 = bitcast %struct.dian* %175 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_3165.cpp() #0 section ".text.startup" {
