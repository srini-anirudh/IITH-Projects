; ModuleID = 'POJ-104-source/64/64-3179.cpp'
source_filename = "POJ-104-source/64/64-3179.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_3179.cpp, i8* null }]
...
48:                                               ; preds = %44
  ...
  %79 = call double @_Z8distancedddddd(double %53, double %58, double %63, double %68, double %73, double %78)
...
define dso_local double @_Z8distancedddddd(double %0, double %1, double %2, double %3, double %4, double %5) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_3179.cpp() #0 section ".text.startup" {
