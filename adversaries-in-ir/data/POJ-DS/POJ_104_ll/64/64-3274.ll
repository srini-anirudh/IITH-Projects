; ModuleID = 'POJ-104-source/64/64-3274.cpp'
source_filename = "POJ-104-source/64/64-3274.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_3274.cpp, i8* null }]
...
26:                                               ; preds = %22
  ...
  %36 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i64 0, i64 0), double* %29, double* %32, double* %35)
  br label %37
...
167:                                              ; preds = %156
  ...
  %175 = call double @_Z4swapPdS_(double* %170, double* %174)
  ...
  %183 = call double @_Z4swapPdS_(double* %178, double* %182)
  ...
  %191 = call double @_Z4swapPdS_(double* %186, double* %190)
  ...
  %199 = call double @_Z4swapPdS_(double* %194, double* %198)
  ...
  %207 = call double @_Z4swapPdS_(double* %202, double* %206)
  ...
  %215 = call double @_Z4swapPdS_(double* %210, double* %214)
  ...
  %223 = call double @_Z4swapPdS_(double* %218, double* %222)
  br label %224
...
; Function Attrs: noinline nounwind uwtable
define dso_local double @_Z4swapPdS_(double* %0, double* %1) #6 {
  %3 = alloca double*, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_3274.cpp() #0 section ".text.startup" {
