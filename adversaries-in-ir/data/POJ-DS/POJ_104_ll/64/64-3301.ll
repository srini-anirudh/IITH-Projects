; ModuleID = 'POJ-104-source/64/64-3301.cpp'
source_filename = "POJ-104-source/64/64-3301.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_3301.cpp, i8* null }]
...
60:                                               ; preds = %56
  ...
  %85 = call double @_Z7julishiiiiiii(i32 %64, i32 %68, i32 %72, i32 %76, i32 %80, i32 %84)
...
; Function Attrs: noinline uwtable
define dso_local double @_Z7julishiiiiiii(i32 %0, i32 %1, i32 %2, i32 %3, i32 %4, i32 %5) #0 {
  %7 = alloca i32, align 4
  %8 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_3301.cpp() #0 section ".text.startup" {
