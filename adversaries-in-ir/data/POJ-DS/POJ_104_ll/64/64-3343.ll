; ModuleID = 'POJ-104-source/64/64-3343.cpp'
source_filename = "POJ-104-source/64/64-3343.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_3343.cpp, i8* null }]
...
215:                                              ; preds = %211
  ...
  %255 = getelementptr inbounds [10 x i32], [10 x i32]* %8, i64 0, i64 %254
  ...
  %282 = getelementptr inbounds [10 x i32], [10 x i32]* %9, i64 0, i64 %281
  %283 = load i32, i32* %282, align 4
  %284 = sub nsw i32 %279, %283
  %285 = sitofp i32 %284 to double
  %286 = fmul double %275, %285
  %287 = fadd double %264, %286
  %288 = call double @sqrt(double %287) #3
  %289 = fcmp oeq double %219, %288
...
290:                                              ; preds = %215
  ...
  %297 = getelementptr inbounds [10 x i32], [10 x i32]* %8, i64 0, i64 %296
  %298 = load i32, i32* %297, align 4
  %299 = load i32, i32* %3, align 4
  %300 = sext i32 %299 to i64
  %301 = getelementptr inbounds [10 x i32], [10 x i32]* %9, i64 0, i64 %300
  ...
  %309 = getelementptr inbounds [10 x i32], [10 x i32]* %8, i64 0, i64 %308
  ...
  %319 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.2, i64 0, i64 0), i32 %294, i32 %298, i32 %302, i32 %306, i32 %310, i32 %314, double %318)
  br label %320
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_3343.cpp() #0 section ".text.startup" {
