; ModuleID = 'POJ-104-source/64/64-337.cpp'
source_filename = "POJ-104-source/64/64-337.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_337.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local double @_Z1hiiiiii(i32 %0, i32 %1, i32 %2, i32 %3, i32 %4, i32 %5) #0 {
...
42:                                               ; preds = %38
  ...
  %115 = call double @_Z1hiiiiii(i32 %94, i32 %98, i32 %102, i32 %106, i32 %110, i32 %114)
...
153:                                              ; preds = %140
  ...
  %162 = getelementptr inbounds [50 x %struct.shizi], [50 x %struct.shizi]* %9, i64 0, i64 %161
  %163 = load i32, i32* %8, align 4
  %164 = sext i32 %163 to i64
  %165 = getelementptr inbounds [50 x %struct.shizi], [50 x %struct.shizi]* %9, i64 0, i64 %164
  %166 = bitcast %struct.shizi* %165 to i8*
  %167 = bitcast %struct.shizi* %162 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_337.cpp() #0 section ".text.startup" {
