; ModuleID = 'POJ-104-source/64/64-3459.cpp'
source_filename = "POJ-104-source/64/64-3459.cpp"
...
@di = dso_local global [60 x %struct.dis] zeroinitializer, align 16
@x = dso_local global %struct.dis zeroinitializer, align 8
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [7 x i8] c"%d%d%d\00", align 1
@.str.2 = private unnamed_addr constant [28 x i8] c"(%d,%d,%d)-(%d,%d,%d)=%.2f\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_3459.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_3459.cpp() #0 section ".text.startup" {
