; ModuleID = 'POJ-104-source/64/64-3471.cpp'
source_filename = "POJ-104-source/64/64-3471.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_3471.cpp, i8* null }]
...
18:                                               ; preds = %14
  ...
  %31 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32* %22, i32* %26, i32* %30)
  br label %32
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_3471.cpp() #0 section ".text.startup" {
