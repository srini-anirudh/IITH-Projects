; ModuleID = 'POJ-104-source/64/64-3494.cpp'
source_filename = "POJ-104-source/64/64-3494.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_3494.cpp, i8* null }]
...
127:                                              ; preds = %116
  ...
  %135 = getelementptr inbounds [1000 x double], [1000 x double]* %15, i64 0, i64 %134
  %136 = load double, double* %135, align 8
  %137 = load i32, i32* %3, align 4
  %138 = sext i32 %137 to i64
  %139 = getelementptr inbounds [1000 x double], [1000 x double]* %15, i64 0, i64 %138
...
192:                                              ; preds = %188
  ...
  %239 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.2, i64 0, i64 0), i32 %199, i32 %206, i32 %213, i32 %220, i32 %227, i32 %234, double %238)
  br label %240
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_3494.cpp() #0 section ".text.startup" {
