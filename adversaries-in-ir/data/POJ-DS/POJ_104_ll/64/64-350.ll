; ModuleID = 'POJ-104-source/64/64-350.cpp'
source_filename = "POJ-104-source/64/64-350.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_350.cpp, i8* null }]
...
46:                                               ; preds = %42
  ...
  %126 = getelementptr inbounds [100 x [2 x i32]], [100 x [2 x i32]]* %6, i64 0, i64 %125
  %127 = getelementptr inbounds [2 x i32], [2 x i32]* %126, i64 0, i64 0
  store i32 %123, i32* %127, align 8
  %128 = load i32, i32* %5, align 4
  %129 = load i32, i32* %7, align 4
  %130 = sext i32 %129 to i64
  %131 = getelementptr inbounds [100 x [2 x i32]], [100 x [2 x i32]]* %6, i64 0, i64 %130
...
166:                                              ; preds = %155
  ...
  %197 = getelementptr inbounds [100 x [2 x i32]], [100 x [2 x i32]]* %6, i64 0, i64 %196
...
243:                                              ; preds = %235
  ...
  %302 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.2, i64 0, i64 0), i32 %252, i32 %261, i32 %270, i32 %279, i32 %288, i32 %297, double %301)
  br label %303
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_350.cpp() #0 section ".text.startup" {
