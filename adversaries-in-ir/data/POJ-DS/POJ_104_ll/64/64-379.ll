; ModuleID = 'POJ-104-source/64/64-379.cpp'
source_filename = "POJ-104-source/64/64-379.cpp"
...
@juli = dso_local global [100 x %struct.space] zeroinitializer, align 16
@cache = dso_local global %struct.space zeroinitializer, align 4
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_379.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32* %11, i32* %13, i32* %15)
...
21:                                               ; preds = %17
  ...
  %34 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.2, i64 0, i64 0), i32* %25, i32* %29, i32* %33)
  br label %35
...
39:                                               ; preds = %150, %38
  ...
  %125 = getelementptr inbounds [100 x %struct.space], [100 x %struct.space]* @juli, i64 0, i64 %124
  %126 = getelementptr inbounds %struct.space, %struct.space* %125, i32 0, i32 0
...
167:                                              ; preds = %159
  ...
  %170 = getelementptr inbounds [100 x %struct.space], [100 x %struct.space]* @juli, i64 0, i64 %169
  %171 = getelementptr inbounds %struct.space, %struct.space* %170, i32 0, i32 0
  %172 = load float, float* %171, align 4
  %173 = load i32, i32* %5, align 4
  %174 = add nsw i32 %173, 1
  %175 = sext i32 %174 to i64
  %176 = getelementptr inbounds [100 x %struct.space], [100 x %struct.space]* @juli, i64 0, i64 %175
  %177 = getelementptr inbounds %struct.space, %struct.space* %176, i32 0, i32 0
...
180:                                              ; preds = %167
  ...
  %184 = getelementptr inbounds [100 x %struct.space], [100 x %struct.space]* @juli, i64 0, i64 %183
  %185 = bitcast %struct.space* %184 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 bitcast (%struct.space* @cache to i8*), i8* align 4 %185, i64 12, i1 false)
  %186 = load i32, i32* %5, align 4
  %187 = sext i32 %186 to i64
  %188 = getelementptr inbounds [100 x %struct.space], [100 x %struct.space]* @juli, i64 0, i64 %187
  %189 = load i32, i32* %5, align 4
  %190 = add nsw i32 %189, 1
  %191 = sext i32 %190 to i64
  %192 = getelementptr inbounds [100 x %struct.space], [100 x %struct.space]* @juli, i64 0, i64 %191
  %193 = bitcast %struct.space* %192 to i8*
  %194 = bitcast %struct.space* %188 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %193, i8* align 4 %194, i64 12, i1 false)
  %195 = load i32, i32* %5, align 4
  %196 = sext i32 %195 to i64
  %197 = getelementptr inbounds [100 x %struct.space], [100 x %struct.space]* @juli, i64 0, i64 %196
  %198 = bitcast %struct.space* %197 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %198, i8* align 4 bitcast (%struct.space* @cache to i8*), i64 12, i1 false)
  br label %199
...
214:                                              ; preds = %208
  ...
  %217 = getelementptr inbounds [100 x %struct.space], [100 x %struct.space]* @juli, i64 0, i64 %216
  %218 = getelementptr inbounds %struct.space, %struct.space* %217, i32 0, i32 1
  %219 = load i32, i32* %218, align 4
  %220 = load i32, i32* %3, align 4
  %221 = sext i32 %220 to i64
  %222 = getelementptr inbounds [100 x %struct.space], [100 x %struct.space]* @juli, i64 0, i64 %221
  %223 = getelementptr inbounds %struct.space, %struct.space* %222, i32 0, i32 2
...
227:                                              ; preds = %214
  ...
  %270 = getelementptr inbounds [100 x %struct.space], [100 x %struct.space]* @juli, i64 0, i64 %269
  %271 = getelementptr inbounds %struct.space, %struct.space* %270, i32 0, i32 0
  %272 = load float, float* %271, align 4
  %273 = fpext float %272 to double
  %274 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.3, i64 0, i64 0), i32 %242, i32 %247, i32 %252, i32 %257, i32 %262, i32 %267, double %273)
  br label %275
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_379.cpp() #0 section ".text.startup" {
