; ModuleID = 'POJ-104-source/64/64-397.cpp'
source_filename = "POJ-104-source/64/64-397.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_397.cpp, i8* null }]
...
116:                                              ; preds = %48
  ...
  %123 = getelementptr inbounds [50 x %struct.juli], [50 x %struct.juli]* %10, i64 0, i64 %122
  %124 = getelementptr inbounds %struct.juli, %struct.juli* %123, i32 0, i32 2
...
145:                                              ; preds = %140
  ...
  %148 = getelementptr inbounds [50 x %struct.juli], [50 x %struct.juli]* %10, i64 0, i64 %147
  %149 = getelementptr inbounds %struct.juli, %struct.juli* %148, i32 0, i32 2
  %150 = load float, float* %149, align 4
  %151 = load i32, i32* %4, align 4
  %152 = add nsw i32 %151, 1
  %153 = sext i32 %152 to i64
  %154 = getelementptr inbounds [50 x %struct.juli], [50 x %struct.juli]* %10, i64 0, i64 %153
  %155 = getelementptr inbounds %struct.juli, %struct.juli* %154, i32 0, i32 2
  %156 = load float, float* %155, align 4
  %157 = fcmp olt float %150, %156
  br i1 %157, label %158, label %179

158:                                              ; preds = %145
  %159 = load i32, i32* %4, align 4
  %160 = sext i32 %159 to i64
  %161 = getelementptr inbounds [50 x %struct.juli], [50 x %struct.juli]* %10, i64 0, i64 %160
  %162 = bitcast %struct.juli* %11 to i8*
  %163 = bitcast %struct.juli* %161 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %162, i8* align 4 %163, i64 28, i1 false)
  ...
  %170 = getelementptr inbounds [50 x %struct.juli], [50 x %struct.juli]* %10, i64 0, i64 %169
  %171 = bitcast %struct.juli* %170 to i8*
  %172 = bitcast %struct.juli* %167 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %171, i8* align 4 %172, i64 28, i1 false)
  %173 = load i32, i32* %4, align 4
  %174 = add nsw i32 %173, 1
  %175 = sext i32 %174 to i64
  %176 = getelementptr inbounds [50 x %struct.juli], [50 x %struct.juli]* %10, i64 0, i64 %175
  %177 = bitcast %struct.juli* %176 to i8*
  %178 = bitcast %struct.juli* %11 to i8*
...
192:                                              ; preds = %188
  ...
  %195 = getelementptr inbounds [50 x %struct.juli], [50 x %struct.juli]* %10, i64 0, i64 %194
  %196 = getelementptr inbounds %struct.juli, %struct.juli* %195, i32 0, i32 0
  %197 = getelementptr inbounds [3 x i32], [3 x i32]* %196, i64 0, i64 0
  %198 = load i32, i32* %197, align 4
  %199 = load i32, i32* %4, align 4
  %200 = sext i32 %199 to i64
  %201 = getelementptr inbounds [50 x %struct.juli], [50 x %struct.juli]* %10, i64 0, i64 %200
  %202 = getelementptr inbounds %struct.juli, %struct.juli* %201, i32 0, i32 0
  ...
  %208 = getelementptr inbounds %struct.juli, %struct.juli* %207, i32 0, i32 0
  ...
  %225 = getelementptr inbounds [50 x %struct.juli], [50 x %struct.juli]* %10, i64 0, i64 %224
  ...
  %231 = getelementptr inbounds [50 x %struct.juli], [50 x %struct.juli]* %10, i64 0, i64 %230
  %232 = getelementptr inbounds %struct.juli, %struct.juli* %231, i32 0, i32 2
  %233 = load float, float* %232, align 4
  %234 = fpext float %233 to double
  %235 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.2, i64 0, i64 0), i32 %198, i32 %204, i32 %210, i32 %216, i32 %222, i32 %228, double %234)
  br label %236
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_397.cpp() #0 section ".text.startup" {
