; ModuleID = 'POJ-104-source/64/64-406.cpp'
source_filename = "POJ-104-source/64/64-406.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_406.cpp, i8* null }]
...
48:                                               ; preds = %44
  ...
  %57 = call double @_Z8distancePdS_(double* %52, double* %56)
...
define dso_local double @_Z8distancePdS_(double* %0, double* %1) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_406.cpp() #0 section ".text.startup" {
