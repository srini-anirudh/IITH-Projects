; ModuleID = 'POJ-104-source/64/64-428.cpp'
source_filename = "POJ-104-source/64/64-428.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_428.cpp, i8* null }]
...
56:                                               ; preds = %52
  ...
  %167 = call double @_Z4juliiiiiii(i32 %141, i32 %146, i32 %151, i32 %156, i32 %161, i32 %166)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_428.cpp() #0 section ".text.startup" {
