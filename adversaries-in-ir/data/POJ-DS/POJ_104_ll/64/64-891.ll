; ModuleID = 'POJ-104-source/64/64-891.cpp'
source_filename = "POJ-104-source/64/64-891.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_891.cpp, i8* null }]
...
46:                                               ; preds = %42
  ...
  %71 = call double @_Z4juliiiiiii(i32 %50, i32 %54, i32 %58, i32 %62, i32 %66, i32 %70)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_891.cpp() #0 section ".text.startup" {
