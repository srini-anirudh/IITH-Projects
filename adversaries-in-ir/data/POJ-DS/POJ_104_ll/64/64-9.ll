; ModuleID = 'POJ-104-source/64/64-9.cpp'
source_filename = "POJ-104-source/64/64-9.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_9.cpp, i8* null }]
...
define dso_local i32 @_Z2sqii(i32 %0, i32 %1) #4 {
...
10:                                               ; preds = %7
  ...
  %21 = call i32 @_Z2sqii(i32 %15, i32 %20)
...
define dso_local i32 @main() #5 {
  ...
  %9 = alloca [50 x [3 x float]], align 16
...
16:                                               ; preds = %12
  ...
  %18 = sext i32 %17 to i64
  %19 = getelementptr inbounds [10 x [3 x i32]], [10 x [3 x i32]]* %4, i64 0, i64 %18
...
46:                                               ; preds = %42
  ...
  %51 = getelementptr inbounds [50 x [3 x float]], [50 x [3 x float]]* %9, i64 0, i64 %50
  ...
  %57 = getelementptr inbounds [50 x [3 x float]], [50 x [3 x float]]* %9, i64 0, i64 %56
  ...
  %65 = getelementptr inbounds [10 x [3 x i32]], [10 x [3 x i32]]* %4, i64 0, i64 %64
  %66 = getelementptr inbounds [3 x i32], [3 x i32]* %65, i64 0, i64 0
  %67 = call float @_Z3disPiS_(i32* %62, i32* %66)
  %68 = load i32, i32* %5, align 4
  %69 = sext i32 %68 to i64
  %70 = getelementptr inbounds [50 x [3 x float]], [50 x [3 x float]]* %9, i64 0, i64 %69
...
94:                                               ; preds = %88
  ...
  %97 = getelementptr inbounds [50 x [3 x float]], [50 x [3 x float]]* %9, i64 0, i64 %96
  %98 = getelementptr inbounds [3 x float], [3 x float]* %97, i64 0, i64 2
  %99 = load float, float* %98, align 4
  %100 = load i32, i32* %3, align 4
  %101 = add nsw i32 %100, 1
  %102 = sext i32 %101 to i64
  %103 = getelementptr inbounds [50 x [3 x float]], [50 x [3 x float]]* %9, i64 0, i64 %102
...
111:                                              ; preds = %108
  ...
  %114 = getelementptr inbounds [50 x [3 x float]], [50 x [3 x float]]* %9, i64 0, i64 %113
  %115 = load i32, i32* %8, align 4
  %116 = sext i32 %115 to i64
  %117 = getelementptr inbounds [3 x float], [3 x float]* %114, i64 0, i64 %116
  %118 = load float, float* %117, align 4
  store float %118, float* %10, align 4
  %119 = load i32, i32* %3, align 4
  %120 = add nsw i32 %119, 1
  %121 = sext i32 %120 to i64
  %122 = getelementptr inbounds [50 x [3 x float]], [50 x [3 x float]]* %9, i64 0, i64 %121
  %123 = load i32, i32* %8, align 4
  %124 = sext i32 %123 to i64
  %125 = getelementptr inbounds [3 x float], [3 x float]* %122, i64 0, i64 %124
  %126 = load float, float* %125, align 4
  %127 = load i32, i32* %3, align 4
  %128 = sext i32 %127 to i64
  %129 = getelementptr inbounds [50 x [3 x float]], [50 x [3 x float]]* %9, i64 0, i64 %128
  ...
  %137 = getelementptr inbounds [50 x [3 x float]], [50 x [3 x float]]* %9, i64 0, i64 %136
  %138 = load i32, i32* %8, align 4
  %139 = sext i32 %138 to i64
  %140 = getelementptr inbounds [3 x float], [3 x float]* %137, i64 0, i64 %139
  store float %133, float* %140, align 4
  br label %141
...
158:                                              ; preds = %154
  ...
  %161 = getelementptr inbounds [50 x [3 x float]], [50 x [3 x float]]* %9, i64 0, i64 %160
  ...
  %167 = getelementptr inbounds [50 x [3 x float]], [50 x [3 x float]]* %9, i64 0, i64 %166
  ...
  %173 = getelementptr inbounds [10 x [3 x i32]], [10 x [3 x i32]]* %4, i64 0, i64 %172
  ...
  %183 = getelementptr inbounds [10 x [3 x i32]], [10 x [3 x i32]]* %4, i64 0, i64 %182
  %184 = getelementptr inbounds [3 x i32], [3 x i32]* %183, i64 0, i64 2
  %185 = load i32, i32* %184, align 4
  %186 = load i32, i32* %6, align 4
  %187 = sext i32 %186 to i64
  %188 = getelementptr inbounds [10 x [3 x i32]], [10 x [3 x i32]]* %4, i64 0, i64 %187
  %189 = getelementptr inbounds [3 x i32], [3 x i32]* %188, i64 0, i64 0
  %190 = load i32, i32* %189, align 4
  %191 = load i32, i32* %6, align 4
  %192 = sext i32 %191 to i64
  %193 = getelementptr inbounds [10 x [3 x i32]], [10 x [3 x i32]]* %4, i64 0, i64 %192
  %194 = getelementptr inbounds [3 x i32], [3 x i32]* %193, i64 0, i64 1
  %195 = load i32, i32* %194, align 4
  %196 = load i32, i32* %6, align 4
  %197 = sext i32 %196 to i64
  %198 = getelementptr inbounds [10 x [3 x i32]], [10 x [3 x i32]]* %4, i64 0, i64 %197
  %199 = getelementptr inbounds [3 x i32], [3 x i32]* %198, i64 0, i64 2
  %200 = load i32, i32* %199, align 4
  %201 = load i32, i32* %3, align 4
  %202 = sext i32 %201 to i64
  %203 = getelementptr inbounds [50 x [3 x float]], [50 x [3 x float]]* %9, i64 0, i64 %202
  %204 = getelementptr inbounds [3 x float], [3 x float]* %203, i64 0, i64 2
  %205 = load float, float* %204, align 4
  %206 = fpext float %205 to double
  %207 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.2, i64 0, i64 0), i32 %175, i32 %180, i32 %185, i32 %190, i32 %195, i32 %200, double %206)
  br label %208
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_9.cpp() #0 section ".text.startup" {
