; ModuleID = 'POJ-104-source/64/64-997.cpp'
source_filename = "POJ-104-source/64/64-997.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_64_997.cpp, i8* null }]
...
223:                                              ; preds = %219
  ...
  %237 = getelementptr inbounds [10 x [3 x i32]], [10 x [3 x i32]]* %7, i64 0, i64 %236
  ...
  %254 = getelementptr inbounds [10 x [3 x i32]], [10 x [3 x i32]]* %7, i64 0, i64 %253
  %255 = getelementptr inbounds [3 x i32], [3 x i32]* %254, i64 0, i64 1
  %256 = load i32, i32* %255, align 4
  %257 = sub nsw i32 %251, %256
  %258 = load i32, i32* %5, align 4
  %259 = sext i32 %258 to i64
  %260 = getelementptr inbounds [10 x [3 x i32]], [10 x [3 x i32]]* %7, i64 0, i64 %259
  ...
  %284 = getelementptr inbounds [10 x [3 x i32]], [10 x [3 x i32]]* %7, i64 0, i64 %283
  ...
  %294 = add nsw i32 %270, %293
  %295 = call double @_ZSt4sqrtIiEN9__gnu_cxx11__enable_ifIXsr12__is_integerIT_EE7__valueEdE6__typeES2_(i32 %294)
  %296 = fmul double 1.000000e+00, %295
  store double %296, double* %10, align 8
  %297 = load double, double* %10, align 8
  %298 = load i32, i32* %3, align 4
  %299 = sext i32 %298 to i64
  %300 = getelementptr inbounds [50 x double], [50 x double]* %8, i64 0, i64 %299
...
303:                                              ; preds = %223
  ...
  %311 = getelementptr inbounds [10 x [3 x i32]], [10 x [3 x i32]]* %7, i64 0, i64 %310
  %312 = getelementptr inbounds [3 x i32], [3 x i32]* %311, i64 0, i64 1
  %313 = load i32, i32* %312, align 4
  %314 = load i32, i32* %5, align 4
  %315 = sext i32 %314 to i64
  %316 = getelementptr inbounds [10 x [3 x i32]], [10 x [3 x i32]]* %7, i64 0, i64 %315
  ...
  %335 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.1, i64 0, i64 0), i32 %308, i32 %313, i32 %318, i32 %323, i32 %328, i32 %333, double %334)
  br label %336
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_64_997.cpp() #0 section ".text.startup" {
