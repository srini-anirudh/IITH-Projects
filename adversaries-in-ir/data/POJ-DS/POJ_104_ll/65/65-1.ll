; ModuleID = 'POJ-104-source/65/65-1.cpp'
source_filename = "POJ-104-source/65/65-1.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_65_1.cpp, i8* null }]
...
27:                                               ; preds = %23
  ...
  call void @_Z4fuckii(i32 %31, i32 %35)
  br label %36
...
define dso_local void @_Z4fuckii(i32 %0, i32 %1) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_65_1.cpp() #0 section ".text.startup" {
