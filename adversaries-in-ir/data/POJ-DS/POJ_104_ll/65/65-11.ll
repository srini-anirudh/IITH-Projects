; ModuleID = 'POJ-104-source/65/65-11.cpp'
source_filename = "POJ-104-source/65/65-11.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_65_11.cpp, i8* null }]
...
11:                                               ; preds = %7
  ...
  %15 = call i32 @_Z7panduanii(i32 %13, i32 %14)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_65_11.cpp() #0 section ".text.startup" {
