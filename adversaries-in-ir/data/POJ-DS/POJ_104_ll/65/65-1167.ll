; ModuleID = 'POJ-104-source/65/65-1167.cpp'
source_filename = "POJ-104-source/65/65-1167.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_65_1167.cpp, i8* null }]
...
18:                                               ; preds = %14
  ...
  %27 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %22, i32* %26)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_65_1167.cpp() #0 section ".text.startup" {
