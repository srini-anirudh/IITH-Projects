; ModuleID = 'POJ-104-source/65/65-186.cpp'
source_filename = "POJ-104-source/65/65-186.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_65_186.cpp, i8* null }]
...
25:                                               ; preds = %9
  ...
  %34 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), i32* %29, i32* %33)
  store i32 0, i32* %2, align 4
  br label %35
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_65_186.cpp() #0 section ".text.startup" {
