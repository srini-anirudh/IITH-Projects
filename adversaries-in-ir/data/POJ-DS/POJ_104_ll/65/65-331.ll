; ModuleID = 'POJ-104-source/65/65-331.cpp'
source_filename = "POJ-104-source/65/65-331.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_65_331.cpp, i8* null }]
...
define dso_local void @_Z3jzbii(i32 %0, i32 %1) #4 {
...
11:                                               ; preds = %7
  ...
  %14 = load i32, i32* %4, align 4
  call void @_Z3jzbii(i32 %13, i32 %14)
  br label %15
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_65_331.cpp() #0 section ".text.startup" {
