; ModuleID = 'POJ-104-source/65/65-401.cpp'
source_filename = "POJ-104-source/65/65-401.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_65_401.cpp, i8* null }]
...
29:                                               ; preds = %25
  ...
  %38 = call i32 @_Z5countii(i32 %33, i32 %37)
  %39 = icmp eq i32 %38, 1
...
43:                                               ; preds = %29
  ...
  %52 = call i32 @_Z5countii(i32 %47, i32 %51)
  %53 = icmp eq i32 %52, 0
...
define dso_local i32 @_Z5countii(i32 %0, i32 %1) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_65_401.cpp() #0 section ".text.startup" {
