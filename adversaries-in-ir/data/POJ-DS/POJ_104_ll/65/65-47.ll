; ModuleID = 'POJ-104-source/65/65-47.cpp'
source_filename = "POJ-104-source/65/65-47.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_65_47.cpp, i8* null }]
...
105:                                              ; preds = %67
  ...
  br i1 true, label %109, label %141
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_65_47.cpp() #0 section ".text.startup" {
