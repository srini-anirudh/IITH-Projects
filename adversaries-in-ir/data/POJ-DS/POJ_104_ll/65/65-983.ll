; ModuleID = 'POJ-104-source/65/65-983.cpp'
source_filename = "POJ-104-source/65/65-983.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_65_983.cpp, i8* null }]
...
11:                                               ; preds = %7
  ...
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %15, i32* %19)
  br label %21
...
29:                                               ; preds = %25
  ...
  %32 = getelementptr inbounds [200 x %struct.point], [200 x %struct.point]* %3, i64 0, i64 %31
...
36:                                               ; preds = %29
  ...
  %39 = getelementptr inbounds [200 x %struct.point], [200 x %struct.point]* %3, i64 0, i64 %38
...
46:                                               ; preds = %43, %36, %29
  ...
  %49 = getelementptr inbounds [200 x %struct.point], [200 x %struct.point]* %3, i64 0, i64 %48
...
53:                                               ; preds = %46
  ...
  %56 = getelementptr inbounds [200 x %struct.point], [200 x %struct.point]* %3, i64 0, i64 %55
...
63:                                               ; preds = %60, %53, %46
  ...
  %66 = getelementptr inbounds [200 x %struct.point], [200 x %struct.point]* %3, i64 0, i64 %65
...
70:                                               ; preds = %63
  ...
  %73 = getelementptr inbounds [200 x %struct.point], [200 x %struct.point]* %3, i64 0, i64 %72
...
80:                                               ; preds = %77, %70, %63
  ...
  %83 = getelementptr inbounds [200 x %struct.point], [200 x %struct.point]* %3, i64 0, i64 %82
...
87:                                               ; preds = %80
  ...
  %90 = getelementptr inbounds [200 x %struct.point], [200 x %struct.point]* %3, i64 0, i64 %89
...
97:                                               ; preds = %94, %87, %80
  ...
  %100 = getelementptr inbounds [200 x %struct.point], [200 x %struct.point]* %3, i64 0, i64 %99
...
104:                                              ; preds = %97
  ...
  %107 = getelementptr inbounds [200 x %struct.point], [200 x %struct.point]* %3, i64 0, i64 %106
...
114:                                              ; preds = %111, %104, %97
  %115 = load i32, i32* %4, align 4
  %116 = sext i32 %115 to i64
  %117 = getelementptr inbounds [200 x %struct.point], [200 x %struct.point]* %3, i64 0, i64 %116
...
121:                                              ; preds = %114
  ...
  %124 = getelementptr inbounds [200 x %struct.point], [200 x %struct.point]* %3, i64 0, i64 %123
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_65_983.cpp() #0 section ".text.startup" {
