; ModuleID = 'POJ-104-source/66/66-1018.cpp'
source_filename = "POJ-104-source/66/66-1018.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_66_1018.cpp, i8* null }]
...
define dso_local i32 @_Z4fun2i(i32 %0) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z4fun3ii(i32 %0, i32 %1) #4 {
  %3 = alloca i32, align 4
...
36:                                               ; preds = %32
  ...
  %39 = call i32 @_Z4fun3ii(i32 %37, i32 %38)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_66_1018.cpp() #0 section ".text.startup" {
