; ModuleID = 'POJ-104-source/66/66-102.cpp'
source_filename = "POJ-104-source/66/66-102.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_66_102.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z6xingqii(i32 %0) #0 {
  %2 = alloca i32, align 4
  store i32 %0, i32* %2, align 4
...
define dso_local i32 @main() #5 {
  ...
  %9 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.7, i64 0, i64 0), i32* %3, i32* %4, i32* %5)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_66_102.cpp() #0 section ".text.startup" {
