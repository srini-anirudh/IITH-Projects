; ModuleID = 'POJ-104-source/66/66-1046.cpp'
source_filename = "POJ-104-source/66/66-1046.cpp"
...
@week = dso_local global i32 0, align 4
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_66_1046.cpp, i8* null }]
...
define dso_local i32 @main() #5 {
  ...
  %3 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32* @year, i32* @month, i32* @day)
  br label %4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_66_1046.cpp() #0 section ".text.startup" {
