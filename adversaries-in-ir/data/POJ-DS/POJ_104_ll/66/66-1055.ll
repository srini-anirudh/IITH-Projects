; ModuleID = 'POJ-104-source/66/66-1055.cpp'
source_filename = "POJ-104-source/66/66-1055.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_66_1055.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %12 = call i32 @_Z8dijitianiii(i32 %9, i32 %10, i32 %11)
  %13 = add nsw i32 %8, %12
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_66_1055.cpp() #0 section ".text.startup" {
