; ModuleID = 'POJ-104-source/66/66-1056.cpp'
source_filename = "POJ-104-source/66/66-1056.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_66_1056.cpp, i8* null }]
...
36:                                               ; preds = %22
  ...
  %42 = call i32 @_Z9isrunniani(i32 %41)
  %43 = icmp ne i32 %42, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_66_1056.cpp() #0 section ".text.startup" {
