; ModuleID = 'POJ-104-source/66/66-1072.cpp'
source_filename = "POJ-104-source/66/66-1072.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_66_1072.cpp, i8* null }]
...
23:                                               ; preds = %19
  ...
  %25 = call i32 @_Z9isRunNiani(i32 %24)
  %26 = icmp ne i32 %25, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_66_1072.cpp() #0 section ".text.startup" {
