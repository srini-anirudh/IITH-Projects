; ModuleID = 'POJ-104-source/66/66-1073.cpp'
source_filename = "POJ-104-source/66/66-1073.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_66_1073.cpp, i8* null }]
...
19:                                               ; preds = %15
  ...
  %21 = call i32 @_Z7runniani(i32 %20)
  %22 = icmp ne i32 %21, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_66_1073.cpp() #0 section ".text.startup" {
