; ModuleID = 'POJ-104-source/66/66-11.cpp'
source_filename = "POJ-104-source/66/66-11.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_66_11.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %14, i8* align 16 bitcast ([13 x i32]* @__const.main.m to i8*), i64 52, i1 false)
  %15 = bitcast [13 x i32]* %3 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %15, i8* align 16 bitcast ([13 x i32]* @__const.main.m1 to i8*), i64 52, i1 false)
...
136:                                              ; preds = %114, %134, %132, %130, %128, %126, %124, %122
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_66_11.cpp() #0 section ".text.startup" {
