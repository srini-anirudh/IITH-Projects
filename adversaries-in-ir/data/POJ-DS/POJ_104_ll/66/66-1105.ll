; ModuleID = 'POJ-104-source/66/66-1105.cpp'
source_filename = "POJ-104-source/66/66-1105.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_66_1105.cpp, i8* null }]
...
15:                                               ; preds = %9
  ...
  %17 = call i32 @_Z9isRunNiani(i32 %16)
  %18 = icmp ne i32 %17, 0
...
29:                                               ; preds = %9
  ...
  %34 = call i32 @_Z8DiJiTianiii(i32 %31, i32 %32, i32 %33)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_66_1105.cpp() #0 section ".text.startup" {
