; ModuleID = 'POJ-104-source/66/66-1118.cpp'
source_filename = "POJ-104-source/66/66-1118.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_66_1118.cpp, i8* null }]
...
93:                                               ; preds = %89
  ...
  %95 = call i32 @_Z9isRunNiani(i32 %94)
  %96 = icmp ne i32 %95, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_66_1118.cpp() #0 section ".text.startup" {
