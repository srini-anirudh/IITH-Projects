; ModuleID = 'POJ-104-source/66/66-1128.cpp'
source_filename = "POJ-104-source/66/66-1128.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_66_1128.cpp, i8* null }]
...
172:                                              ; preds = %169
  ...
  %174 = call i32 @_Z9isRunNiani(i32 %173)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_66_1128.cpp() #0 section ".text.startup" {
