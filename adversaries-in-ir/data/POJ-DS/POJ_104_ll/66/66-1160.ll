; ModuleID = 'POJ-104-source/66/66-1160.cpp'
source_filename = "POJ-104-source/66/66-1160.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_66_1160.cpp, i8* null }]
...
56:                                               ; preds = %53
  ...
  %58 = call i32 @_Z9isRunNiani(i32 %57)
  %59 = icmp ne i32 %58, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_66_1160.cpp() #0 section ".text.startup" {
