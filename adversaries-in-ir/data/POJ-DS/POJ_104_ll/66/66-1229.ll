; ModuleID = 'POJ-104-source/66/66-1229.cpp'
source_filename = "POJ-104-source/66/66-1229.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_66_1229.cpp, i8* null }]
...
60:                                               ; preds = %57
  ...
  %62 = call i32 @_Z9isrunyeari(i32 %61)
  %63 = icmp ne i32 %62, 0
...
98:                                               ; preds = %95
  ...
  %100 = call i32 @_Z9isrunyeari(i32 %99)
...
define dso_local i32 @_Z9isrunyeari(i32 %0) #5 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_66_1229.cpp() #0 section ".text.startup" {
