; ModuleID = 'POJ-104-source/66/66-1270.cpp'
source_filename = "POJ-104-source/66/66-1270.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_66_1270.cpp, i8* null }]
...
define dso_local i32 @main() #5 {
  ...
  %12 = call i32 @_Z10isLeapYeari(i32 %11)
  %13 = icmp ne i32 %12, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_66_1270.cpp() #0 section ".text.startup" {
