; ModuleID = 'POJ-104-source/66/66-128.cpp'
source_filename = "POJ-104-source/66/66-128.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_66_128.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %7 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i64 0, i64 0), i64* %2, i64* %3, i64* %4)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_66_128.cpp() #0 section ".text.startup" {
