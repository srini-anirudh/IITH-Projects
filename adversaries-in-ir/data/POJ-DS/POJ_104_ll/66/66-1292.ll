; ModuleID = 'POJ-104-source/66/66-1292.cpp'
source_filename = "POJ-104-source/66/66-1292.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_66_1292.cpp, i8* null }]
...
40:                                               ; preds = %13
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %41, i8* align 16 bitcast ([12 x i32]* @__const.main.b1 to i8*), i64 48, i1 false)
  %42 = bitcast [12 x i32]* %10 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %42, i8* align 16 bitcast ([12 x i32]* @__const.main.b2 to i8*), i64 48, i1 false)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_66_1292.cpp() #0 section ".text.startup" {
