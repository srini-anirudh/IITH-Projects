; ModuleID = 'POJ-104-source/66/66-134.cpp'
source_filename = "POJ-104-source/66/66-134.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_66_134.cpp, i8* null }]
...
define dso_local i32 @_Z3daymii(i64 %0, i32 %1, i32 %2) #4 {
...
define dso_local i32 @main() #5 {
  ...
  %6 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i64 0, i64 0), i64* %2, i32* %3, i32* %4)
  %7 = load i64, i64* %2, align 8
  %8 = load i32, i32* %3, align 4
  %9 = load i32, i32* %4, align 4
  %10 = call i32 @_Z3daymii(i64 %7, i32 %8, i32 %9)
...
44:                                               ; preds = %0, %42, %40, %38, %36, %34, %32, %30
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_66_134.cpp() #0 section ".text.startup" {
