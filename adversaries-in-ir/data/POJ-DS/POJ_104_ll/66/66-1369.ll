; ModuleID = 'POJ-104-source/66/66-1369.cpp'
source_filename = "POJ-104-source/66/66-1369.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_66_1369.cpp, i8* null }]
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z5monthii(i32 %0, i32 %1) #4 {
  %3 = alloca i32, align 4
...
define dso_local i32 @main() #5 {
  ...
  %8 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32* %2, i32* %4, i32* %5)
...
29:                                               ; preds = %25
  ...
  %33 = call i32 @_Z5monthii(i32 %31, i32 %32)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_66_1369.cpp() #0 section ".text.startup" {
