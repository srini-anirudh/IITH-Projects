; ModuleID = 'POJ-104-source/66/66-1375.cpp'
source_filename = "POJ-104-source/66/66-1375.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_66_1375.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %9, i8* align 16 bitcast ([12 x i32]* @__const.main.md to i8*), i64 48, i1 false)
...
90:                                               ; preds = %86
  %91 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.4, i64 0, i64 0))
  br label %108
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_66_1375.cpp() #0 section ".text.startup" {
