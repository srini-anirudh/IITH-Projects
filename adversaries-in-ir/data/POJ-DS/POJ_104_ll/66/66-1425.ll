; ModuleID = 'POJ-104-source/66/66-1425.cpp'
source_filename = "POJ-104-source/66/66-1425.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_66_1425.cpp, i8* null }]
...
23:                                               ; preds = %19
  ...
  %31 = call i32 @_Z8DiJiTianiii(i32 %28, i32 %29, i32 %30)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_66_1425.cpp() #0 section ".text.startup" {
