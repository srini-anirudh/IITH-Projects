; ModuleID = 'POJ-104-source/66/66-1477.cpp'
source_filename = "POJ-104-source/66/66-1477.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_66_1477.cpp, i8* null }]
...
19:                                               ; preds = %0
  %20 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0))
...
122:                                              ; preds = %121, %92
  ...
  %125 = getelementptr inbounds [7 x [10 x i8]], [7 x [10 x i8]]* %10, i64 0, i64 %124
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_66_1477.cpp() #0 section ".text.startup" {
