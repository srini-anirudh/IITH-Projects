; ModuleID = 'POJ-104-source/66/66-173.cpp'
source_filename = "POJ-104-source/66/66-173.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_66_173.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z10printDigiti(i32 %0) #0 {
...
define dso_local i32 @main() #4 {
  ...
  %12 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.7, i64 0, i64 0), i32* %2, i32* %3, i32* %4)
...
33:                                               ; preds = %29
  ...
  %36 = getelementptr inbounds [13 x i32], [13 x i32]* %10, i64 0, i64 %35
...
49:                                               ; preds = %43
  ...
  %51 = call i32 @_Z10isleapyeari(i32 %50)
  %52 = icmp ne i32 %51, 0
...
56:                                               ; preds = %53, %49, %43
  ...
  call void @_Z10printDigiti(i32 %68)
...
define dso_local i32 @_Z10isleapyeari(i32 %0) #6 {
  %2 = alloca i32, align 4
  store i32 %0, i32* %2, align 4
  %3 = load i32, i32* %2, align 4
  %4 = srem i32 %3, 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_66_173.cpp() #0 section ".text.startup" {
