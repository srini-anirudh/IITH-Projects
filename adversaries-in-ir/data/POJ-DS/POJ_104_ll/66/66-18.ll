; ModuleID = 'POJ-104-source/66/66-18.cpp'
source_filename = "POJ-104-source/66/66-18.cpp"
...
@_ZZ4mainE1d = internal global [13 x i32] [i32 0, i32 31, i32 0, i32 31, i32 30, i32 31, i32 30, i32 31, i32 31, i32 30, i32 31, i32 30, i32 31], align 16
...
@_ZZ4mainE1d_0 = internal global [13 x i32] [i32 0, i32 31, i32 29, i32 31, i32 30, i32 31, i32 30, i32 31, i32 31, i32 30, i32 31, i32 30, i32 31], align 16
@_ZZ4mainE1d_1 = internal global [13 x i32] [i32 0, i32 31, i32 0, i32 31, i32 30, i32 31, i32 30, i32 31, i32 31, i32 30, i32 31, i32 30, i32 31], align 16
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_66_18.cpp, i8* null }]
...
52:                                               ; preds = %48, %44
  store i32 29, i32* getelementptr inbounds ([13 x i32], [13 x i32]* @_ZZ4mainE1d, i64 0, i64 2), align 8
  br label %54

53:                                               ; preds = %48
  store i32 28, i32* getelementptr inbounds ([13 x i32], [13 x i32]* @_ZZ4mainE1d, i64 0, i64 2), align 8
  br label %54
...
59:                                               ; preds = %55
  ...
  %62 = getelementptr inbounds [13 x i32], [13 x i32]* @_ZZ4mainE1d, i64 0, i64 %61
...
100:                                              ; preds = %96
  ...
  %103 = getelementptr inbounds [13 x i32], [13 x i32]* @_ZZ4mainE1d_0, i64 0, i64 %102
...
187:                                              ; preds = %183, %179
  store i32 29, i32* getelementptr inbounds ([13 x i32], [13 x i32]* @_ZZ4mainE1d_1, i64 0, i64 2), align 8
  br label %189

188:                                              ; preds = %183
  store i32 28, i32* getelementptr inbounds ([13 x i32], [13 x i32]* @_ZZ4mainE1d_1, i64 0, i64 2), align 8
  br label %189
...
194:                                              ; preds = %190
  ...
  %197 = getelementptr inbounds [13 x i32], [13 x i32]* @_ZZ4mainE1d_1, i64 0, i64 %196
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_66_18.cpp() #0 section ".text.startup" {
