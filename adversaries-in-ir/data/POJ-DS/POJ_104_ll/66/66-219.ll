; ModuleID = 'POJ-104-source/66/66-219.cpp'
source_filename = "POJ-104-source/66/66-219.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_66_219.cpp, i8* null }]
...
define dso_local i32 @_Z7runnianl(i64 %0) #4 {
...
define dso_local i32 @main() #5 {
  ...
  %7 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i64 0, i64 0), i64* %5, i32* %2, i32* %3)
...
67:                                               ; preds = %54, %41
  ...
  %69 = call i32 @_Z7runnianl(i64 %68)
  %70 = icmp ne i32 %69, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_66_219.cpp() #0 section ".text.startup" {
