; ModuleID = 'POJ-104-source/66/66-26.cpp'
source_filename = "POJ-104-source/66/66-26.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_66_26.cpp, i8* null }]
...
define dso_local i32 @main(i32 %0, i8** %1) #4 {
  ...
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i32* %6, i32* %7, i32* %8)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_66_26.cpp() #0 section ".text.startup" {
