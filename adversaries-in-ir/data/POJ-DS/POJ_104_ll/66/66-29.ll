; ModuleID = 'POJ-104-source/66/66-29.cpp'
source_filename = "POJ-104-source/66/66-29.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_66_29.cpp, i8* null }]
...
define dso_local i32 @_Z1fjii(i32 %0, i32 %1, i32 %2) #4 {
...
define dso_local i32 @main() #5 {
  ...
  %34 = call i32 @_Z1fjii(i32 %31, i32 %32, i32 %33)
  %35 = add i32 %30, %34
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_66_29.cpp() #0 section ".text.startup" {
