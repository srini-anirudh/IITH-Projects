; ModuleID = 'POJ-104-source/66/66-31.cpp'
source_filename = "POJ-104-source/66/66-31.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_66_31.cpp, i8* null }]
...
93:                                               ; preds = %76, %91, %89, %87, %85, %83, %81, %79
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_66_31.cpp() #0 section ".text.startup" {
