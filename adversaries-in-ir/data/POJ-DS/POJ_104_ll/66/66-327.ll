; ModuleID = 'POJ-104-source/66/66-327.cpp'
source_filename = "POJ-104-source/66/66-327.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_66_327.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %6 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i64 0, i64 0), i64* %3, i32* %1, i32* %2)
  %7 = load i64, i64* %3, align 8
  %8 = load i32, i32* %1, align 4
  %9 = load i32, i32* %2, align 4
  %10 = call i64 @_Z5countlii(i64 %7, i32 %8, i32 %9)
  store i64 %10, i64* %4, align 8
  %11 = load i64, i64* %4, align 8
  %12 = call i32 @_Z3dayl(i64 %11)
...
define dso_local i64 @_Z5countlii(i64 %0, i32 %1, i32 %2) #5 {
  %4 = alloca i64, align 8
  %5 = alloca i32, align 4
  ...
  %11 = call i32 @_Z1nl(i64 %10)
  %12 = sext i32 %11 to i64
  %13 = add nsw i64 %9, %12
  %14 = load i64, i64* %4, align 8
  %15 = load i32, i32* %5, align 4
  %16 = load i32, i32* %6, align 4
  %17 = call i32 @_Z3runlii(i64 %14, i32 %15, i32 %16)
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z3dayl(i64 %0) #5 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z1nl(i64 %0) #5 {
  %2 = alloca i64, align 8
  %3 = alloca i32, align 4
  store i64 %0, i64* %2, align 8
  %4 = load i64, i64* %2, align 8
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z3runlii(i64 %0, i32 %1, i32 %2) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_66_327.cpp() #0 section ".text.startup" {
