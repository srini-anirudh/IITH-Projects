; ModuleID = 'POJ-104-source/66/66-343.cpp'
source_filename = "POJ-104-source/66/66-343.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_66_343.cpp, i8* null }]
...
define dso_local i32 @_Z11Is_Runiniani(i32 %0) #4 {
...
17:                                               ; preds = %13
  ...
  %19 = add nsw i32 %18, 1
  %20 = call i32 @_Z11Is_Runiniani(i32 %19)
  %21 = icmp eq i32 %20, 1
...
79:                                               ; preds = %76
  ...
  %81 = call i32 @_Z11Is_Runiniani(i32 %80)
  %82 = icmp eq i32 %81, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_66_343.cpp() #0 section ".text.startup" {
