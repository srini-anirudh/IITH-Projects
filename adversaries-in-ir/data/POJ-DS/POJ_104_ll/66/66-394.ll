; ModuleID = 'POJ-104-source/66/66-394.cpp'
source_filename = "POJ-104-source/66/66-394.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_66_394.cpp, i8* null }]
...
45:                                               ; preds = %25
  ...
  %47 = call i32 @_Z10isLeapYeari(i32 %46)
  %48 = icmp ne i32 %47, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_66_394.cpp() #0 section ".text.startup" {
