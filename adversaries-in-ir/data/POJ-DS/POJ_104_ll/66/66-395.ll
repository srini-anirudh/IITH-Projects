; ModuleID = 'POJ-104-source/66/66-395.cpp'
source_filename = "POJ-104-source/66/66-395.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_66_395.cpp, i8* null }]
...
24:                                               ; preds = %20
  ...
  %26 = call i32 @_Z9isRunNiani(i32 %25)
  %27 = icmp ne i32 %26, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_66_395.cpp() #0 section ".text.startup" {
