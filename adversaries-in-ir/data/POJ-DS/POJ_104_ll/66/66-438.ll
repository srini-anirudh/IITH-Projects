; ModuleID = 'POJ-104-source/66/66-438.cpp'
source_filename = "POJ-104-source/66/66-438.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_66_438.cpp, i8* null }]
...
define dso_local i32 @_Z15leapYearBetweenii(i32 %0, i32 %1) #4 {
...
define dso_local i32 @main() #5 {
  ...
  %7 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.7, i64 0, i64 0), i32* %2, i32* %3, i32* %4)
  %8 = load i32, i32* %2, align 4
  %9 = sub nsw i32 %8, 1
  %10 = sdiv i32 %9, 7
  %11 = mul nsw i32 %10, 7
  %12 = call i32 @_Z15leapYearBetweenii(i32 1, i32 %11)
  ...
  %25 = sub nsw i32 %24, 1
  %26 = call i32 @_Z15leapYearBetweenii(i32 %23, i32 %25)
...
46:                                               ; preds = %43
  ...
  %49 = call i32 @_Z15leapYearBetweenii(i32 %47, i32 %48)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_66_438.cpp() #0 section ".text.startup" {
