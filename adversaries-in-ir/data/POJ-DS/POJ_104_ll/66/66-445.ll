; ModuleID = 'POJ-104-source/66/66-445.cpp'
source_filename = "POJ-104-source/66/66-445.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_66_445.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %10 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32* %4, i32* %3, i32* %2)
...
72:                                               ; preds = %69
  ...
  %74 = call i32 @_Z9isRunNiani(i32 %73)
  %75 = icmp ne i32 %74, 0
...
112:                                              ; preds = %89, %110, %108, %106, %104, %102, %100, %98, %96
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_66_445.cpp() #0 section ".text.startup" {
