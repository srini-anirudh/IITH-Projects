; ModuleID = 'POJ-104-source/66/66-45.cpp'
source_filename = "POJ-104-source/66/66-45.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_66_45.cpp, i8* null }]
...
define dso_local i64 @_Z3runi(i32 %0) #4 {
...
define dso_local i32 @main() #5 {
  ...
  %21 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i64* %4, i64* %5, i64* %6)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_66_45.cpp() #0 section ".text.startup" {
