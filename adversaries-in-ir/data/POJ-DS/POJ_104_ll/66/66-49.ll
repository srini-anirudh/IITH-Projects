; ModuleID = 'POJ-104-source/66/66-49.cpp'
source_filename = "POJ-104-source/66/66-49.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_66_49.cpp, i8* null }]
...
define dso_local i32 @main() #5 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %9, i8* align 16 bitcast ([12 x i32]* @__const.main.k to i8*), i64 48, i1 false)
...
56:                                               ; preds = %46
  %57 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0))
  br label %70
...
70:                                               ; preds = %46, %68, %66, %64, %62, %60, %58, %56
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_66_49.cpp() #0 section ".text.startup" {
