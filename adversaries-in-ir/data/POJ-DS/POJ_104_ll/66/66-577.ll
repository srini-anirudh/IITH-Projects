; ModuleID = 'POJ-104-source/66/66-577.cpp'
source_filename = "POJ-104-source/66/66-577.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_66_577.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z4weekiii(i32 %0, i32 %1, i32 %2) #0 {
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
  store i32 %0, i32* %4, align 4
  ...
  %10 = call i32 @_Z3dayiii(i32 %7, i32 %8, i32 %9)
  %11 = srem i32 %10, 7
  %12 = icmp eq i32 %11, 0
...
15:                                               ; preds = %3
  ...
  %19 = call i32 @_Z3dayiii(i32 %16, i32 %17, i32 %18)
  %20 = srem i32 %19, 7
  %21 = icmp eq i32 %20, 1
...
24:                                               ; preds = %15
  ...
  %28 = call i32 @_Z3dayiii(i32 %25, i32 %26, i32 %27)
  %29 = srem i32 %28, 7
  %30 = icmp eq i32 %29, 2
...
33:                                               ; preds = %24
  ...
  %37 = call i32 @_Z3dayiii(i32 %34, i32 %35, i32 %36)
  %38 = srem i32 %37, 7
  %39 = icmp eq i32 %38, 3
...
42:                                               ; preds = %33
  ...
  %46 = call i32 @_Z3dayiii(i32 %43, i32 %44, i32 %45)
  %47 = srem i32 %46, 7
  %48 = icmp eq i32 %47, 4
...
51:                                               ; preds = %42
  ...
  %55 = call i32 @_Z3dayiii(i32 %52, i32 %53, i32 %54)
  %56 = srem i32 %55, 7
  %57 = icmp eq i32 %56, 5
...
60:                                               ; preds = %51
  ...
  %63 = load i32, i32* %6, align 4
  %64 = call i32 @_Z3dayiii(i32 %61, i32 %62, i32 %63)
  %65 = srem i32 %64, 7
  %66 = icmp eq i32 %65, 6
...
define dso_local i32 @main() #5 {
  ...
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  %4 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.7, i64 0, i64 0), i32* %1, i32* %2, i32* %3)
  %5 = load i32, i32* %1, align 4
  %6 = load i32, i32* %2, align 4
  %7 = load i32, i32* %3, align 4
  call void @_Z4weekiii(i32 %5, i32 %6, i32 %7)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_66_577.cpp() #0 section ".text.startup" {
