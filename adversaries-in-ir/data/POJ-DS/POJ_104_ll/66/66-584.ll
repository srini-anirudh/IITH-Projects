; ModuleID = 'POJ-104-source/66/66-584.cpp'
source_filename = "POJ-104-source/66/66-584.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_66_584.cpp, i8* null }]
...
61:                                               ; preds = %49, %29
  ...
  %65 = call i32 @_Z8dijitianiii(i32 %62, i32 %63, i32 %64)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_66_584.cpp() #0 section ".text.startup" {
