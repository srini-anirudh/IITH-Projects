; ModuleID = 'POJ-104-source/66/66-595.cpp'
source_filename = "POJ-104-source/66/66-595.cpp"
...
@ny = dso_local global i64 0, align 8
@nm = dso_local global i64 0, align 8
@date = dso_local global i64 0, align 8
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_66_595.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %4 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i64* @y, i64* @m, i64* @d)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_66_595.cpp() #0 section ".text.startup" {
