; ModuleID = 'POJ-104-source/66/66-637.cpp'
source_filename = "POJ-104-source/66/66-637.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_66_637.cpp, i8* null }]
...
74:                                               ; preds = %71, %68
  ...
  %76 = add nsw i32 %75, 1
  %77 = call i32 @_Z9isRunniani(i32 %76)
  %78 = icmp ne i32 %77, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_66_637.cpp() #0 section ".text.startup" {
