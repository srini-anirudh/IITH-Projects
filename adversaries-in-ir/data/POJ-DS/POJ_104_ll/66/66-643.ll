; ModuleID = 'POJ-104-source/66/66-643.cpp'
source_filename = "POJ-104-source/66/66-643.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_66_643.cpp, i8* null }]
...
102:                                              ; preds = %87
  %103 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.5, i64 0, i64 0))
  br label %108
...
106:                                              ; preds = %87
  %107 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.7, i64 0, i64 0))
  br label %108

108:                                              ; preds = %87, %106, %104, %102, %100, %98, %96, %94
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_66_643.cpp() #0 section ".text.startup" {
