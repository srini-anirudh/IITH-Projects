; ModuleID = 'POJ-104-source/66/66-764.cpp'
source_filename = "POJ-104-source/66/66-764.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_66_764.cpp, i8* null }]
...
define dso_local i32 @_Z5afteri(i32 %0) #4 {
...
define dso_local i32 @main() #5 {
  ...
  %10 = call i32 @_Z5afteri(i32 %9)
  store i32 %10, i32* %5, align 4
  %11 = load i32, i32* %2, align 4
  %12 = load i32, i32* %3, align 4
  %13 = load i32, i32* %4, align 4
  %14 = call i32 @_Z4dateiii(i32 %11, i32 %12, i32 %13)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_66_764.cpp() #0 section ".text.startup" {
