; ModuleID = 'POJ-104-source/66/66-86.cpp'
source_filename = "POJ-104-source/66/66-86.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_66_86.cpp, i8* null }]
...
define dso_local i32 @_Z2lpii(i32 %0, i32 %1) #4 {
...
65:                                               ; preds = %50
  ...
  %68 = call i32 @_Z2lpii(i32 %66, i32 %67)
  %69 = icmp eq i32 %68, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_66_86.cpp() #0 section ".text.startup" {
