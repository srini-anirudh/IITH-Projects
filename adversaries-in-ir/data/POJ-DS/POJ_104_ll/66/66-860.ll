; ModuleID = 'POJ-104-source/66/66-860.cpp'
source_filename = "POJ-104-source/66/66-860.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_66_860.cpp, i8* null }]
...
17:                                               ; preds = %13
  ...
  %19 = call i32 @_Z9isRunniani(i32 %18)
  %20 = icmp ne i32 %19, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_66_860.cpp() #0 section ".text.startup" {
