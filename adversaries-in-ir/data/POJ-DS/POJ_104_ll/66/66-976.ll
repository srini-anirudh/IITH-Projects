; ModuleID = 'POJ-104-source/66/66-976.cpp'
source_filename = "POJ-104-source/66/66-976.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_66_976.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %9 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32* %2, i32* %4, i32* %5)
...
30:                                               ; preds = %26
  ...
  %32 = call i32 @_Z9isRunNiani(i32 %31)
  %33 = icmp ne i32 %32, 0
...
91:                                               ; preds = %88
  ...
  %93 = call i32 @_Z9isRunNiani(i32 %92)
  %94 = icmp ne i32 %93, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_66_976.cpp() #0 section ".text.startup" {
