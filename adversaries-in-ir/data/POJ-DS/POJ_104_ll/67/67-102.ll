; ModuleID = 'POJ-104-source/67/67-102.cpp'
source_filename = "POJ-104-source/67/67-102.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_67_102.cpp, i8* null }]
...
78:                                               ; preds = %72
  %79 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.2, i64 0, i64 0))
  br label %91
...
86:                                               ; preds = %80
  %87 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i64 0, i64 0))
  br label %90
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_67_102.cpp() #0 section ".text.startup" {
