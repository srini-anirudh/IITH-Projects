; ModuleID = 'POJ-104-source/67/67-1031.cpp'
source_filename = "POJ-104-source/67/67-1031.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_67_1031.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %9 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), double* %6)
...
16:                                               ; preds = %10
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i64 0, i64 0), double* %3, double* %4)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_67_1031.cpp() #0 section ".text.startup" {
