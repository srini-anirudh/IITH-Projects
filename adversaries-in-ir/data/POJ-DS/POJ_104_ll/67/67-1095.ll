; ModuleID = 'POJ-104-source/67/67-1095.cpp'
source_filename = "POJ-104-source/67/67-1095.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_67_1095.cpp, i8* null }]
...
25:                                               ; preds = %8
  %26 = getelementptr inbounds [100 x [2 x i32]], [100 x [2 x i32]]* %4, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_67_1095.cpp() #0 section ".text.startup" {
