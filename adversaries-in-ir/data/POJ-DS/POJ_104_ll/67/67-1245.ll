; ModuleID = 'POJ-104-source/67/67-1245.cpp'
source_filename = "POJ-104-source/67/67-1245.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_67_1245.cpp, i8* null }]
...
11:                                               ; preds = %7
  ...
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), float* %15)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_67_1245.cpp() #0 section ".text.startup" {
