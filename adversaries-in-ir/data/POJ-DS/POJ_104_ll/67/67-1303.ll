; ModuleID = 'POJ-104-source/67/67-1303.cpp'
source_filename = "POJ-104-source/67/67-1303.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_67_1303.cpp, i8* null }]
...
define dso_local i32 @main(i32 %0, i8** %1) #4 {
  ...
  %15 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i64 0, i64 0), double* %13, double* %14)
...
26:                                               ; preds = %21
  ...
  %33 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i64 0, i64 0), double* %29, double* %32)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_67_1303.cpp() #0 section ".text.startup" {
