; ModuleID = 'POJ-104-source/67/67-1604.cpp'
source_filename = "POJ-104-source/67/67-1604.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_67_1604.cpp, i8* null }]
...
12:                                               ; preds = %8
  %13 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), double* %4)
  %14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), double* %5)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_67_1604.cpp() #0 section ".text.startup" {
