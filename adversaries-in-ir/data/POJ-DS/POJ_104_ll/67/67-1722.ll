; ModuleID = 'POJ-104-source/67/67-1722.cpp'
source_filename = "POJ-104-source/67/67-1722.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_67_1722.cpp, i8* null }]
...
16:                                               ; preds = %13
  ...
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %17, i32* %18)
...
28:                                               ; preds = %13
  ...
  %35 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %31, i32* %34)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_67_1722.cpp() #0 section ".text.startup" {
