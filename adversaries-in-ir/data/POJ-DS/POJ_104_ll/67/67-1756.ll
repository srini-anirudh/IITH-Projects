; ModuleID = 'POJ-104-source/67/67-1756.cpp'
source_filename = "POJ-104-source/67/67-1756.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_67_1756.cpp, i8* null }]
...
25:                                               ; preds = %21
  ...
  %32 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %28, i32* %31)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_67_1756.cpp() #0 section ".text.startup" {
