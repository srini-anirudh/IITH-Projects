; ModuleID = 'POJ-104-source/67/67-1832.cpp'
source_filename = "POJ-104-source/67/67-1832.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_67_1832.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), float* %18, float* %21)
  br label %23
...
91:                                               ; preds = %85
  %92 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.2, i64 0, i64 0))
  br label %93
...
101:                                              ; preds = %99, %93
  ...
  %104 = getelementptr inbounds [999 x i32], [999 x i32]* %3, i64 0, i64 %103
  %105 = load i32, i32* %104, align 4
  %106 = icmp eq i32 %105, -1
  br i1 %106, label %107, label %109

107:                                              ; preds = %101
  %108 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.4, i64 0, i64 0))
  br label %109
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_67_1832.cpp() #0 section ".text.startup" {
