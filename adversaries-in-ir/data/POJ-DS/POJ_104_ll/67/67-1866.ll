; ModuleID = 'POJ-104-source/67/67-1866.cpp'
source_filename = "POJ-104-source/67/67-1866.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_67_1866.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %12 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i64 0, i64 0), double* %10, double* %11)
...
22:                                               ; preds = %18
  ...
  %29 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i64 0, i64 0), double* %25, double* %28)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_67_1866.cpp() #0 section ".text.startup" {
