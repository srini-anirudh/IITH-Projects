; ModuleID = 'POJ-104-source/67/67-1929.cpp'
source_filename = "POJ-104-source/67/67-1929.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_67_1929.cpp, i8* null }]
...
11:                                               ; preds = %7
  ...
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i64 0, i64 0), double* %14, double* %17)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_67_1929.cpp() #0 section ".text.startup" {
