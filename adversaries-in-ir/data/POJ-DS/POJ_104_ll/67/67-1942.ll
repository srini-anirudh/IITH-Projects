; ModuleID = 'POJ-104-source/67/67-1942.cpp'
source_filename = "POJ-104-source/67/67-1942.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_67_1942.cpp, i8* null }]
...
25:                                               ; preds = %0
  ...
  %34 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %29, i32* %33)
...
58:                                               ; preds = %54
  ...
  %67 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %62, i32* %66)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_67_1942.cpp() #0 section ".text.startup" {
