; ModuleID = 'POJ-104-source/67/67-2005.cpp'
source_filename = "POJ-104-source/67/67-2005.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_67_2005.cpp, i8* null }]
...
10:                                               ; preds = %6
  ...
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), double* %14, double* %18)
  br label %20
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_67_2005.cpp() #0 section ".text.startup" {
