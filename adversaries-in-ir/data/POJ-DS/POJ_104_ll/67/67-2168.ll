; ModuleID = 'POJ-104-source/67/67-2168.cpp'
source_filename = "POJ-104-source/67/67-2168.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_67_2168.cpp, i8* null }]
...
22:                                               ; preds = %18
  %23 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %5, i32* %6)
...
40:                                               ; preds = %36
  ...
  %43 = getelementptr inbounds [1000 x float], [1000 x float]* %10, i64 0, i64 %42
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_67_2168.cpp() #0 section ".text.startup" {
