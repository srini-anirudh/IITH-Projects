; ModuleID = 'POJ-104-source/67/67-2785.cpp'
source_filename = "POJ-104-source/67/67-2785.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_67_2785.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %10 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), float* %3, float* %4)
...
28:                                               ; preds = %23
  ...
  %37 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), float* %32, float* %36)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_67_2785.cpp() #0 section ".text.startup" {
