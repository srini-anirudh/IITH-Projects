; ModuleID = 'POJ-104-source/67/67-279.cpp'
source_filename = "POJ-104-source/67/67-279.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_67_279.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %9 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32* %2, float* %5, float* %6)
...
18:                                               ; preds = %13
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), float* %7, float* %8)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_67_279.cpp() #0 section ".text.startup" {
