; ModuleID = 'POJ-104-source/67/67-304.cpp'
source_filename = "POJ-104-source/67/67-304.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_67_304.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %14, i8* align 1 getelementptr inbounds ([7 x i8], [7 x i8]* @__const.main.jieguo1, i32 0, i32 0), i64 7, i1 false)
  %15 = bitcast [7 x i8]* %12 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %15, i8* align 1 getelementptr inbounds ([7 x i8], [7 x i8]* @__const.main.jieguo2, i32 0, i32 0), i64 7, i1 false)
  %16 = bitcast [7 x i8]* %13 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %16, i8* align 1 getelementptr inbounds ([7 x i8], [7 x i8]* @__const.main.jieguo3, i32 0, i32 0), i64 7, i1 false)
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %3)
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), double* %4, double* %5)
...
27:                                               ; preds = %22
  ...
  %34 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), double* %30, double* %33)
...
54:                                               ; preds = %27
  ...
  %57 = getelementptr inbounds [100 x [7 x i8]], [100 x [7 x i8]]* %10, i64 0, i64 %56
  %58 = getelementptr inbounds [7 x i8], [7 x i8]* %57, i64 0, i64 0
  %59 = getelementptr inbounds [7 x i8], [7 x i8]* %11, i64 0, i64 0
  %60 = call i8* @strcpy(i8* %58, i8* %59) #3
  br label %84
...
69:                                               ; preds = %61
  ...
  %72 = getelementptr inbounds [100 x [7 x i8]], [100 x [7 x i8]]* %10, i64 0, i64 %71
  %73 = getelementptr inbounds [7 x i8], [7 x i8]* %72, i64 0, i64 0
  %74 = getelementptr inbounds [7 x i8], [7 x i8]* %12, i64 0, i64 0
...
76:                                               ; preds = %61
  ...
  %81 = getelementptr inbounds [7 x i8], [7 x i8]* %13, i64 0, i64 0
...
94:                                               ; preds = %89
  ...
  %97 = getelementptr inbounds [100 x [7 x i8]], [100 x [7 x i8]]* %10, i64 0, i64 %96
...
103:                                              ; preds = %89
  ...
  %107 = getelementptr inbounds [100 x [7 x i8]], [100 x [7 x i8]]* %10, i64 0, i64 %106
  %108 = getelementptr inbounds [7 x i8], [7 x i8]* %107, i64 0, i64 0
  %109 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i8* %108)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_67_304.cpp() #0 section ".text.startup" {
