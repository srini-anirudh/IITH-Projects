; ModuleID = 'POJ-104-source/67/67-337.cpp'
source_filename = "POJ-104-source/67/67-337.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_67_337.cpp, i8* null }]
...
define dso_local i32 @main(i32 %0, i8** %1) #4 {
  ...
  %13 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %11, i32* %12)
...
18:                                               ; preds = %14
  ...
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %21, i32* %24)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_67_337.cpp() #0 section ".text.startup" {
