; ModuleID = 'POJ-104-source/67/67-354.cpp'
source_filename = "POJ-104-source/67/67-354.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_67_354.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %13 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), float* %7, float* %8)
...
22:                                               ; preds = %17
  ...
  %25 = getelementptr inbounds [100 x float], [100 x float]* %10, i64 0, i64 %24
  %26 = load i32, i32* %3, align 4
  %27 = sext i32 %26 to i64
  %28 = getelementptr inbounds [100 x float], [100 x float]* %11, i64 0, i64 %27
  %29 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), float* %25, float* %28)
  %30 = load i32, i32* %3, align 4
  %31 = sext i32 %30 to i64
  %32 = getelementptr inbounds [100 x float], [100 x float]* %11, i64 0, i64 %31
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_67_354.cpp() #0 section ".text.startup" {
