; ModuleID = 'POJ-104-source/67/67-405.cpp'
source_filename = "POJ-104-source/67/67-405.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_67_405.cpp, i8* null }]
...
20:                                               ; preds = %15
  ...
  %27 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i64 0, i64 0), double* %23, double* %26)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_67_405.cpp() #0 section ".text.startup" {
