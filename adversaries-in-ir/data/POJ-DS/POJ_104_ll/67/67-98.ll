; ModuleID = 'POJ-104-source/67/67-98.cpp'
source_filename = "POJ-104-source/67/67-98.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_67_98.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %12 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), float* %9, float* %10)
...
21:                                               ; preds = %16
  ...
  %28 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), float* %24, float* %27)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_67_98.cpp() #0 section ".text.startup" {
