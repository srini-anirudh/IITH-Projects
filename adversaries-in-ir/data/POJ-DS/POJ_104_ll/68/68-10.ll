; ModuleID = 'POJ-104-source/68/68-10.cpp'
source_filename = "POJ-104-source/68/68-10.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_68_10.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z8judgmenti(i32 %0) #0 {
...
15:                                               ; preds = %11
  ...
  %17 = call i32 @_Z8judgmenti(i32 %16)
  %18 = icmp eq i32 %17, 0
...
19:                                               ; preds = %15
  ...
  %23 = call i32 @_Z8judgmenti(i32 %22)
  %24 = icmp eq i32 %23, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_68_10.cpp() #0 section ".text.startup" {
