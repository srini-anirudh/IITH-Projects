; ModuleID = 'POJ-104-source/68/68-1020.cpp'
source_filename = "POJ-104-source/68/68-1020.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_68_1020.cpp, i8* null }]
...
69:                                               ; preds = %60
  ...
  %81 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i64 0, i64 0), i32 %70, i32 %74, i32 %80)
  br label %86
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_68_1020.cpp() #0 section ".text.startup" {
