; ModuleID = 'POJ-104-source/68/68-103.cpp'
source_filename = "POJ-104-source/68/68-103.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_68_103.cpp, i8* null }]
...
76:                                               ; preds = %73
  ...
  %80 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.2, i64 0, i64 0), i32 %77, i32 %78, i32 %79)
  br label %85
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_68_103.cpp() #0 section ".text.startup" {
