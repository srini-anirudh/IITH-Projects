; ModuleID = 'POJ-104-source/68/68-206.cpp'
source_filename = "POJ-104-source/68/68-206.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_68_206.cpp, i8* null }]
...
50:                                               ; preds = %44
  ...
  %54 = call double @_ZSt4ceilIiEN9__gnu_cxx11__enable_ifIXsr12__is_integerIT_EE7__valueEdE6__typeES2_(i32 %53)
...
74:                                               ; preds = %68
  ...
  %78 = call double @_ZSt4ceilIiEN9__gnu_cxx11__enable_ifIXsr12__is_integerIT_EE7__valueEdE6__typeES2_(i32 %77)
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local double @_ZSt4ceilIiEN9__gnu_cxx11__enable_ifIXsr12__is_integerIT_EE7__valueEdE6__typeES2_(i32 %0) #5 comdat {
  %2 = alloca i32, align 4
  store i32 %0, i32* %2, align 4
  %3 = load i32, i32* %2, align 4
  %4 = sitofp i32 %3 to double
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_68_206.cpp() #0 section ".text.startup" {
