; ModuleID = 'POJ-104-source/68/68-238.cpp'
source_filename = "POJ-104-source/68/68-238.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_68_238.cpp, i8* null }]
...
72:                                               ; preds = %64
  ...
  %80 = getelementptr inbounds [99999 x i32], [99999 x i32]* %7, i64 0, i64 %79
...
99:                                               ; preds = %95
  ...
  %102 = getelementptr inbounds [99999 x i32], [99999 x i32]* %7, i64 0, i64 %101
  ...
  %110 = getelementptr inbounds [99999 x i32], [99999 x i32]* %7, i64 0, i64 %109
  %111 = load i32, i32* %110, align 4
  %112 = load i32, i32* %8, align 4
  %113 = sext i32 %112 to i64
  %114 = getelementptr inbounds [99999 x i32], [99999 x i32]* %6, i64 0, i64 %113
  %115 = load i32, i32* %114, align 4
  %116 = sub nsw i32 %111, %115
  %117 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i64 0, i64 0), i32 %103, i32 %107, i32 %116)
  br label %118
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_68_238.cpp() #0 section ".text.startup" {
