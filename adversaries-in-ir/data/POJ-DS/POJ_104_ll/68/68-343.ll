; ModuleID = 'POJ-104-source/68/68-343.cpp'
source_filename = "POJ-104-source/68/68-343.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_68_343.cpp, i8* null }]
...
44:                                               ; preds = %10
  %45 = getelementptr inbounds [50000 x i32], [50000 x i32]* %7, i64 0, i64 2
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_68_343.cpp() #0 section ".text.startup" {
