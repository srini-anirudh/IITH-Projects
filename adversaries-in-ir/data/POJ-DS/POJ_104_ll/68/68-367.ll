; ModuleID = 'POJ-104-source/68/68-367.cpp'
source_filename = "POJ-104-source/68/68-367.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_68_367.cpp, i8* null }]
...
74:                                               ; preds = %71
  ...
  %79 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0), i32 %75, i32 %78)
  br label %80
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_68_367.cpp() #0 section ".text.startup" {
