; ModuleID = 'POJ-104-source/68/68-411.cpp'
source_filename = "POJ-104-source/68/68-411.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_68_411.cpp, i8* null }]
...
75:                                               ; preds = %16
  ...
  %79 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i64 0, i64 0), i64 %76, i64 %77, i64 %78)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_68_411.cpp() #0 section ".text.startup" {
