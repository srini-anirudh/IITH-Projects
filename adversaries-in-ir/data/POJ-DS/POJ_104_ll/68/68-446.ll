; ModuleID = 'POJ-104-source/68/68-446.cpp'
source_filename = "POJ-104-source/68/68-446.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_68_446.cpp, i8* null }]
...
39:                                               ; preds = %32
  ...
  %42 = sub nsw i32 %41, 3
  %43 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32 %40, i32 %42)
  br label %121
...
102:                                              ; preds = %94
  ...
  %110 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.2, i64 0, i64 0), i32 %105, i32 %106, i32 %109)
  br label %111
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_68_446.cpp() #0 section ".text.startup" {
