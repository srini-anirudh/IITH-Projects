; ModuleID = 'POJ-104-source/68/68-454.cpp'
source_filename = "POJ-104-source/68/68-454.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_68_454.cpp, i8* null }]
...
68:                                               ; preds = %62
  ...
  %72 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i64 0, i64 0), i64 %69, i64 %70, i64 %71)
  br label %77
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_68_454.cpp() #0 section ".text.startup" {
