; ModuleID = 'POJ-104-source/68/68-468.cpp'
source_filename = "POJ-104-source/68/68-468.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_68_468.cpp, i8* null }]
...
41:                                               ; preds = %32, %15
  ...
  %45 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i64 0, i64 0), i32 %42, i32 %43, i32 %44)
  br label %46
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_68_468.cpp() #0 section ".text.startup" {
