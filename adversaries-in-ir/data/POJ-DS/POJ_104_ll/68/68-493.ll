; ModuleID = 'POJ-104-source/68/68-493.cpp'
source_filename = "POJ-104-source/68/68-493.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_68_493.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z6checkNj(i32 %0) #0 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
...
10:                                               ; preds = %23, %9
  ...
  %14 = call double @_ZSt4sqrtIjEN9__gnu_cxx11__enable_ifIXsr12__is_integerIT_EE7__valueEdE6__typeES2_(i32 %13)
...
26:                                               ; preds = %10
  ...
  %30 = call double @_ZSt4sqrtIjEN9__gnu_cxx11__enable_ifIXsr12__is_integerIT_EE7__valueEdE6__typeES2_(i32 %29)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_68_493.cpp() #0 section ".text.startup" {
