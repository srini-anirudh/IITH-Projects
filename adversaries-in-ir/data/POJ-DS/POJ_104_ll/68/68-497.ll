; ModuleID = 'POJ-104-source/68/68-497.cpp'
source_filename = "POJ-104-source/68/68-497.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_68_497.cpp, i8* null }]
...
28:                                               ; preds = %24
  ...
  %30 = call i32 @_Z5provei(i32 %29)
  store i32 %30, i32* %4, align 4
  %31 = load i32, i32* %3, align 4
  %32 = call i32 @_Z5provei(i32 %31)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_68_497.cpp() #0 section ".text.startup" {
