; ModuleID = 'POJ-104-source/68/68-505.cpp'
source_filename = "POJ-104-source/68/68-505.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_68_505.cpp, i8* null }]
...
20:                                               ; preds = %15
  %21 = load i32, i32* %4, align 4
  %22 = call i32 @_Z11primenumberi(i32 %21)
  %23 = icmp ne i32 %22, 0
...
24:                                               ; preds = %20
  ...
  %28 = call i32 @_Z11primenumberi(i32 %27)
  %29 = icmp ne i32 %28, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_68_505.cpp() #0 section ".text.startup" {
