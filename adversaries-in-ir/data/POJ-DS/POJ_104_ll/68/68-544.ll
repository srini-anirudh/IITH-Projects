; ModuleID = 'POJ-104-source/68/68-544.cpp'
source_filename = "POJ-104-source/68/68-544.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_68_544.cpp, i8* null }]
...
86:                                               ; preds = %85, %43
  ...
  %92 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.2, i64 0, i64 0), i32 %87, i32 %88, i32 %91)
  br label %96
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_68_544.cpp() #0 section ".text.startup" {
