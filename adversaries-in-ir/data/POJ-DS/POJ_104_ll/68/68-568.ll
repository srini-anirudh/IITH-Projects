; ModuleID = 'POJ-104-source/68/68-568.cpp'
source_filename = "POJ-104-source/68/68-568.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_68_568.cpp, i8* null }]
...
70:                                               ; preds = %63
  ...
  %74 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i64 0, i64 0), i32 %71, i32 %72, i32 %73)
  br label %79
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_68_568.cpp() #0 section ".text.startup" {
