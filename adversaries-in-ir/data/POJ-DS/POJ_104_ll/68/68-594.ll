; ModuleID = 'POJ-104-source/68/68-594.cpp'
source_filename = "POJ-104-source/68/68-594.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_68_594.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z7panduani(i32 %0) #0 {
...
29:                                               ; preds = %21
  ...
  %31 = call i32 @_Z7panduani(i32 %30)
  %32 = icmp ne i32 %31, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_68_594.cpp() #0 section ".text.startup" {
