; ModuleID = 'POJ-104-source/68/68-613.cpp'
source_filename = "POJ-104-source/68/68-613.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_68_613.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z5zhisui(i32 %0) #0 {
...
18:                                               ; preds = %13
  ...
  %20 = call i32 @_Z5zhisui(i32 %19)
  store i32 %20, i32* %3, align 4
  %21 = load i32, i32* %6, align 4
  %22 = load i32, i32* %5, align 4
  %23 = sub nsw i32 %21, %22
  %24 = call i32 @_Z5zhisui(i32 %23)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_68_613.cpp() #0 section ".text.startup" {
