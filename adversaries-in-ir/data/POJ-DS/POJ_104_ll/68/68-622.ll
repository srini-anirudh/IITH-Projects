; ModuleID = 'POJ-104-source/68/68-622.cpp'
source_filename = "POJ-104-source/68/68-622.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_68_622.cpp, i8* null }]
...
25:                                               ; preds = %20
  ...
  %30 = call i32 @_Z7primeNoi(i32 %29)
  %31 = icmp ne i32 %30, 0
...
32:                                               ; preds = %25
  ...
  %36 = call i32 @_Z7primeNoi(i32 %35)
  %37 = icmp ne i32 %36, 0
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z7primeNoi(i32 %0) #0 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_68_622.cpp() #0 section ".text.startup" {
