; ModuleID = 'POJ-104-source/68/68-661.cpp'
source_filename = "POJ-104-source/68/68-661.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_68_661.cpp, i8* null }]
...
31:                                               ; preds = %24
  ...
  %35 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32 %32, i32 %33, i32 %34)
  br label %41
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_68_661.cpp() #0 section ".text.startup" {
