; ModuleID = 'POJ-104-source/68/68-739.cpp'
source_filename = "POJ-104-source/68/68-739.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_68_739.cpp, i8* null }]
...
14:                                               ; preds = %28, %13
  ...
  %19 = call float @_ZSt4sqrtf(float %18)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_68_739.cpp() #0 section ".text.startup" {
