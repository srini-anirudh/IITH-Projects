; ModuleID = 'POJ-104-source/68/68-750.cpp'
source_filename = "POJ-104-source/68/68-750.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_68_750.cpp, i8* null }]
...
79:                                               ; preds = %63
  ...
  %83 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.2, i64 0, i64 0), i32 %80, i32 %81, i32 %82)
  br label %88
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_68_750.cpp() #0 section ".text.startup" {
