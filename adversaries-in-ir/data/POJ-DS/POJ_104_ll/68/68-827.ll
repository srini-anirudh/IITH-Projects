; ModuleID = 'POJ-104-source/68/68-827.cpp'
source_filename = "POJ-104-source/68/68-827.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_68_827.cpp, i8* null }]
...
32:                                               ; preds = %27, %12
  ...
  %38 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32 %33, i32 %34, i32 %37)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_68_827.cpp() #0 section ".text.startup" {
