; ModuleID = 'POJ-104-source/68/68-932.cpp'
source_filename = "POJ-104-source/68/68-932.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_68_932.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z7issushui(i32 %0) #0 {
...
24:                                               ; preds = %19
  ...
  %26 = call i32 @_Z7issushui(i32 %25)
  %27 = icmp ne i32 %26, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_68_932.cpp() #0 section ".text.startup" {
