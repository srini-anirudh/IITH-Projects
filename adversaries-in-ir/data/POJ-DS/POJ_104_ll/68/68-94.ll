; ModuleID = 'POJ-104-source/68/68-94.cpp'
source_filename = "POJ-104-source/68/68-94.cpp"
...
@primes = dso_local global [20000 x i32] zeroinitializer, align 16
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [10 x i8] c"%d=%d+%d\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_68_94.cpp, i8* null }]
...
define dso_local i32 @_Z13isPrimeNumberi(i32 %0) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z9AllPrimesi(i32 %0) #4 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
...
21:                                               ; preds = %17
  ...
  %23 = call i32 @_Z13isPrimeNumberi(i32 %22)
  store i32 %23, i32* %6, align 4
  %24 = load i32, i32* %3, align 4
  %25 = load i32, i32* %5, align 4
  %26 = sub nsw i32 %24, %25
  %27 = call i32 @_Z13isPrimeNumberi(i32 %26)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_68_94.cpp() #0 section ".text.startup" {
