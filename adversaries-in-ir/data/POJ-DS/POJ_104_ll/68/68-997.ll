; ModuleID = 'POJ-104-source/68/68-997.cpp'
source_filename = "POJ-104-source/68/68-997.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_68_997.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z8is_sushui(i32 %0) #0 {
...
20:                                               ; preds = %15
  ...
  %22 = call i32 @_Z8is_sushui(i32 %21)
  %23 = load i32, i32* %7, align 4
  %24 = load i32, i32* %8, align 4
  %25 = sub nsw i32 %23, %24
  %26 = call i32 @_Z8is_sushui(i32 %25)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_68_997.cpp() #0 section ".text.startup" {
