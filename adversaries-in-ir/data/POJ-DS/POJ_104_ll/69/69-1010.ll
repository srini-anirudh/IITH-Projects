; ModuleID = 'POJ-104-source/69/69-1010.cpp'
source_filename = "POJ-104-source/69/69-1010.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_69_1010.cpp, i8* null }]
...
31:                                               ; preds = %24, %19, %14, %0
  ...
  %38 = call i32 @_Z7strplusPcS_S_(i8* %35, i8* %36, i8* %37)
...
define dso_local i32 @_Z7strplusPcS_S_(i8* %0, i8* %1, i8* %2) #5 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca i8*, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_69_1010.cpp() #0 section ".text.startup" {
