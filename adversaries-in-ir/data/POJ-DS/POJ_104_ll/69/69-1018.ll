; ModuleID = 'POJ-104-source/69/69-1018.cpp'
source_filename = "POJ-104-source/69/69-1018.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_69_1018.cpp, i8* null }]
...
61:                                               ; preds = %59, %57
  ...
  call void @_Z6createPP3numi(%struct.num** @phead1, i32 %62)
  %63 = load i32, i32* %6, align 4
  call void @_Z6createPP3numi(%struct.num** @phead2, i32 %63)
  %64 = load i32, i32* %6, align 4
  %65 = add nsw i32 %64, 1
  call void @_Z6createPP3numi(%struct.num** @phead3, i32 %65)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_69_1018.cpp() #0 section ".text.startup" {
