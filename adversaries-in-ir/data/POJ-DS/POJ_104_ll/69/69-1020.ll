; ModuleID = 'POJ-104-source/69/69-1020.cpp'
source_filename = "POJ-104-source/69/69-1020.cpp"
...
@p1 = dso_local global %struct.num* null, align 8
@p2 = dso_local global %struct.num* null, align 8
@.str = private unnamed_addr constant [3 x i8] c"%s\00", align 1
@.str.1 = private unnamed_addr constant [2 x i8] c"0\00", align 1
@.str.2 = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_69_1020.cpp, i8* null }]
...
define dso_local void @_Z6createPP3numi(%struct.num** %0, i32 %1) #4 {
...
51:                                               ; preds = %49, %47
  ...
  call void @_Z6createPP3numi(%struct.num** @phead1, i32 %52)
  %53 = load i32, i32* %6, align 4
  call void @_Z6createPP3numi(%struct.num** @phead2, i32 %53)
  %54 = load i32, i32* %6, align 4
  %55 = add nsw i32 %54, 1
  call void @_Z6createPP3numi(%struct.num** @phead3, i32 %55)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_69_1020.cpp() #0 section ".text.startup" {
