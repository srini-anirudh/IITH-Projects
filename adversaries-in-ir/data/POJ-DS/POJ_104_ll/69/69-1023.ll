; ModuleID = 'POJ-104-source/69/69-1023.cpp'
source_filename = "POJ-104-source/69/69-1023.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_69_1023.cpp, i8* null }]
...
define dso_local i32 @main(i32 %0, i8** %1) #4 {
  ...
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i8* %18, i8* %19)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_69_1023.cpp() #0 section ".text.startup" {
