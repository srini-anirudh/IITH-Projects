; ModuleID = 'POJ-104-source/69/69-1130.cpp'
source_filename = "POJ-104-source/69/69-1130.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_69_1130.cpp, i8* null }]
...
97:                                               ; preds = %153, %96
  ...
  %105 = call i32 @_Z3maxii(i32 %101, i32 %104)
...
156:                                              ; preds = %97
  ...
  %163 = call i32 @_Z3maxii(i32 %159, i32 %162)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_69_1130.cpp() #0 section ".text.startup" {
