; ModuleID = 'POJ-104-source/69/69-1280.cpp'
source_filename = "POJ-104-source/69/69-1280.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_69_1280.cpp, i8* null }]
...
24:                                               ; preds = %14
  ...
  %27 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i8* %25, i8* %26)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_69_1280.cpp() #0 section ".text.startup" {
