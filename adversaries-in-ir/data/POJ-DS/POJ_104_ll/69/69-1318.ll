; ModuleID = 'POJ-104-source/69/69-1318.cpp'
source_filename = "POJ-104-source/69/69-1318.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_69_1318.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %5 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([300 x i8], [300 x i8]* @s, i64 0, i64 0))
  %6 = call i64 @strlen(i8* getelementptr inbounds ([300 x i8], [300 x i8]* @s, i64 0, i64 0)) #7
...
28:                                               ; preds = %10
  %29 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([300 x i8], [300 x i8]* @s, i64 0, i64 0))
  %30 = call i64 @strlen(i8* getelementptr inbounds ([300 x i8], [300 x i8]* @s, i64 0, i64 0)) #7
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_69_1318.cpp() #0 section ".text.startup" {
