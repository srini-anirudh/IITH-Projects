; ModuleID = 'POJ-104-source/69/69-1341.cpp'
source_filename = "POJ-104-source/69/69-1341.cpp"
...
@c = dso_local global [260 x i32] zeroinitializer, align 16
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_69_1341.cpp, i8* null }]
...
9:                                                ; preds = %158, %0
  %10 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([260 x i8], [260 x i8]* @s, i64 0, i64 0), i8* getelementptr inbounds ([260 x i8], [260 x i8]* @t, i64 0, i64 0))
  %11 = icmp ne i32 %10, -1
  br i1 %11, label %12, label %160

12:                                               ; preds = %9
  %13 = call i64 @strlen(i8* getelementptr inbounds ([260 x i8], [260 x i8]* @s, i64 0, i64 0)) #7
  %14 = trunc i64 %13 to i32
  store i32 %14, i32* %2, align 4
  %15 = call i64 @strlen(i8* getelementptr inbounds ([260 x i8], [260 x i8]* @t, i64 0, i64 0)) #7
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_69_1341.cpp() #0 section ".text.startup" {
