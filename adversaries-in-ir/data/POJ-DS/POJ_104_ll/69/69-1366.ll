; ModuleID = 'POJ-104-source/69/69-1366.cpp'
source_filename = "POJ-104-source/69/69-1366.cpp"
...
@__const._Z5transc.s = private unnamed_addr constant [10 x i32] [i32 48, i32 49, i32 50, i32 51, i32 52, i32 53, i32 54, i32 55, i32 56, i32 57], align 16
@.str = private unnamed_addr constant [6 x i8] c"%s %s\00", align 1
@.str.1 = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.2 = private unnamed_addr constant [2 x i8] c"0\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_69_1366.cpp, i8* null }]
...
define dso_local i32 @_Z5transc(i8 signext %0) #4 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %6, i8* align 16 bitcast ([10 x i32]* @__const._Z5transc.s to i8*), i64 40, i1 false)
...
define dso_local i32 @main() #6 {
  ...
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i8* %18, i8* %19)
...
62:                                               ; preds = %59
  ...
  %67 = call i32 @_Z5transc(i8 signext %66)
...
81:                                               ; preds = %78
  ...
  %86 = call i32 @_Z5transc(i8 signext %85)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_69_1366.cpp() #0 section ".text.startup" {
