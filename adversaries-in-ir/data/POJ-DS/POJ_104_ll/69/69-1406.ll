; ModuleID = 'POJ-104-source/69/69-1406.cpp'
source_filename = "POJ-104-source/69/69-1406.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_69_1406.cpp, i8* null }]
...
define dso_local %struct.Node* @_Z14CreateNullListv() #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z10InsertNodeP4Nodec(%struct.Node* %0, i8 signext %1) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z7CompareP4NodeS0_(%struct.Node* %0, %struct.Node* %1) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z3AddP4NodeS0_(%struct.Node* %0, %struct.Node* %1) #4 {
  %3 = alloca %struct.Node*, align 8
  %4 = alloca %struct.Node*, align 8
  ...
  %12 = call i32 @_Z7CompareP4NodeS0_(%struct.Node* %10, %struct.Node* %11)
...
define dso_local i32 @main() #5 {
  ...
  %8 = call %struct.Node* @_Z14CreateNullListv()
  store %struct.Node* %8, %struct.Node** %3, align 8
  %9 = call %struct.Node* @_Z14CreateNullListv()
...
18:                                               ; preds = %14
  ...
  call void @_Z10InsertNodeP4Nodec(%struct.Node* %19, i8 signext %20)
  %21 = call i32 @getchar()
...
30:                                               ; preds = %26
  ...
  call void @_Z10InsertNodeP4Nodec(%struct.Node* %31, i8 signext %32)
  %33 = call i32 @getchar()
...
35:                                               ; preds = %26
  ...
  %38 = call i32 @_Z3AddP4NodeS0_(%struct.Node* %36, %struct.Node* %37)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_69_1406.cpp() #0 section ".text.startup" {
