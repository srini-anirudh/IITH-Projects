; ModuleID = 'POJ-104-source/69/69-178.cpp'
source_filename = "POJ-104-source/69/69-178.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_69_178.cpp, i8* null }]
...
define dso_local void @_Z3addPcS_S_(i8* %0, i8* %1, i8* %2) #4 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca i8*, align 8
...
31:                                               ; preds = %29, %24, %19, %14, %0
  ...
  call void @_Z3addPcS_S_(i8* %32, i8* %33, i8* %34)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_69_178.cpp() #0 section ".text.startup" {
