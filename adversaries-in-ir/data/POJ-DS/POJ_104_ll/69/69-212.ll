; ModuleID = 'POJ-104-source/69/69-212.cpp'
source_filename = "POJ-104-source/69/69-212.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_69_212.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z12print_bigintPii(i32* %0, i32 %1) #0 {
...
define dso_local i32 @main() #6 {
  ...
  %12 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i8* %10, i8* %11)
  %13 = getelementptr inbounds [256 x i8], [256 x i8]* %2, i64 0, i64 0
  %14 = getelementptr inbounds [256 x i32], [256 x i32]* %4, i64 0, i64 0
  %15 = call i32 @_Z10str2bigintPcPi(i8* %13, i32* %14)
  ...
  %18 = call i32 @_Z10str2bigintPcPi(i8* %16, i32* %17)
  ...
  %24 = call i32 @_Z10add_bigintPiiS_iS_(i32* %19, i32 %20, i32* %21, i32 %22, i32* %23)
  store i32 %24, i32* %9, align 4
  %25 = getelementptr inbounds [256 x i32], [256 x i32]* %6, i64 0, i64 0
  %26 = load i32, i32* %9, align 4
  call void @_Z12print_bigintPii(i32* %25, i32 %26)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_69_212.cpp() #0 section ".text.startup" {
