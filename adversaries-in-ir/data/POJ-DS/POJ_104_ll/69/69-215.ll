; ModuleID = 'POJ-104-source/69/69-215.cpp'
source_filename = "POJ-104-source/69/69-215.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_69_215.cpp, i8* null }]
...
define dso_local i32 @_Z2zhc(i8 signext %0) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local signext i8 @_Z3fzhi(i32 %0) #4 {
  %2 = alloca i8, align 1
...
28:                                               ; preds = %15
  ...
  %33 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i8* %31, i8* %32)
...
84:                                               ; preds = %81
  ...
  %89 = call i32 @_Z2zhc(i8 signext %88)
  %90 = load i32, i32* %8, align 4
  %91 = sext i32 %90 to i64
  %92 = getelementptr inbounds [10000 x i8], [10000 x i8]* %5, i64 0, i64 %91
  %93 = load i8, i8* %92, align 1
  %94 = call i32 @_Z2zhc(i8 signext %93)
  %95 = add nsw i32 %89, %94
  %96 = call signext i8 @_Z3fzhi(i32 %95)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_69_215.cpp() #0 section ".text.startup" {
