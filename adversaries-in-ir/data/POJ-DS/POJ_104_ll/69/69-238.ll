; ModuleID = 'POJ-104-source/69/69-238.cpp'
source_filename = "POJ-104-source/69/69-238.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_69_238.cpp, i8* null }]
...
118:                                              ; preds = %113
  ...
  %127 = call i32 @_Z3addcc(i8 signext %122, i8 signext %126)
  ...
  %141 = call i32 @_Z4overcc(i8 signext %136, i8 signext %140)
...
150:                                              ; preds = %145
  ...
  %159 = call i32 @_Z3addcc(i8 signext %154, i8 signext %158)
...
167:                                              ; preds = %150
  ...
  %176 = call i32 @_Z3addcc(i8 signext %171, i8 signext %175)
  ...
  %192 = call i32 @_Z4overcc(i8 signext %187, i8 signext %191)
...
define dso_local i32 @_Z3addcc(i8 signext %0, i8 signext %1) #6 {
  %3 = alloca i8, align 1
  %4 = alloca i8, align 1
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z4overcc(i8 signext %0, i8 signext %1) #6 {
  %3 = alloca i8, align 1
  %4 = alloca i8, align 1
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_69_238.cpp() #0 section ".text.startup" {
