; ModuleID = 'POJ-104-source/69/69-29.cpp'
source_filename = "POJ-104-source/69/69-29.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_69_29.cpp, i8* null }]
...
define dso_local i8* @_Z6strrevPc(i8* %0) #4 {
  %2 = alloca i8*, align 8
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
  %5 = alloca i8, align 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_69_29.cpp() #0 section ".text.startup" {
