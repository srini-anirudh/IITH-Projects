; ModuleID = 'POJ-104-source/69/69-436.cpp'
source_filename = "POJ-104-source/69/69-436.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_69_436.cpp, i8* null }]
...
define dso_local i32 @_Z8countnumPc(i8* %0) #4 {
  %2 = alloca i8*, align 8
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z5cleanPc(i8* %0) #4 {
  %2 = alloca i8*, align 8
  %3 = alloca i32, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z4sortPcii(i8* %0, i32 %1, i32 %2) #4 {
  %4 = alloca i8*, align 8
  %5 = alloca i32, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z6entirePci(i8* %0, i32 %1) #4 {
  %3 = alloca i8*, align 8
  %4 = alloca i32, align 4
...
98:                                               ; preds = %62
  ...
  call void @_Z6entirePci(i8* %104, i32 %105)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_69_436.cpp() #0 section ".text.startup" {
