; ModuleID = 'POJ-104-source/69/69-470.cpp'
source_filename = "POJ-104-source/69/69-470.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_69_470.cpp, i8* null }]
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z4num1ii(i32 %0, i32 %1) #4 {
  %3 = alloca i32, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z5num10ii(i32 %0, i32 %1) #4 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  store i32 %0, i32* %4, align 4
...
define dso_local i32 @main() #5 {
  ...
  %25 = call i32 @_Z3maxii(i32 %23, i32 %24)
...
40:                                               ; preds = %37
  ...
  %45 = call i32 @_Z1fc(i8 signext %44)
  ...
  %53 = call i32 @_Z4num1ii(i32 %45, i32 %52)
  ...
  %62 = call i32 @_Z1fc(i8 signext %61)
  %63 = load i32, i32* %9, align 4
  %64 = sext i32 %63 to i64
  %65 = getelementptr inbounds [251 x i8], [251 x i8]* %3, i64 0, i64 %64
  %66 = load i8, i8* %65, align 1
  %67 = call i32 @_Z1fc(i8 signext %66)
  %68 = load i32, i32* %11, align 4
  %69 = add nsw i32 %67, %68
  %70 = call i32 @_Z5num10ii(i32 %62, i32 %69)
...
77:                                               ; preds = %74
  ...
  %82 = call i32 @_Z1fc(i8 signext %81)
  %83 = load i32, i32* %11, align 4
  %84 = call i32 @_Z4num1ii(i32 %82, i32 %83)
  ...
  %93 = call i32 @_Z1fc(i8 signext %92)
  %94 = load i32, i32* %11, align 4
  %95 = call i32 @_Z5num10ii(i32 %93, i32 %94)
...
96:                                               ; preds = %74, %71
  ...
  %101 = call i32 @_Z1fc(i8 signext %100)
  %102 = load i32, i32* %11, align 4
  %103 = call i32 @_Z4num1ii(i32 %101, i32 %102)
  ...
  %112 = call i32 @_Z1fc(i8 signext %111)
  %113 = load i32, i32* %11, align 4
  %114 = call i32 @_Z5num10ii(i32 %112, i32 %113)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_69_470.cpp() #0 section ".text.startup" {
