; ModuleID = 'POJ-104-source/69/69-567.cpp'
source_filename = "POJ-104-source/69/69-567.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_69_567.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %26 = getelementptr inbounds [255 x i8], [255 x i8]* %3, i64 0, i64 0
...
84:                                               ; preds = %79
  ...
  %87 = getelementptr inbounds [255 x i32], [255 x i32]* %4, i64 0, i64 %86
  ...
  %104 = getelementptr inbounds [255 x i32], [255 x i32]* %4, i64 0, i64 %103
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_69_567.cpp() #0 section ".text.startup" {
