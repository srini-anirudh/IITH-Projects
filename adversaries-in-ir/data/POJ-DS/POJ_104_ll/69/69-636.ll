; ModuleID = 'POJ-104-source/69/69-636.cpp'
source_filename = "POJ-104-source/69/69-636.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_69_636.cpp, i8* null }]
...
define dso_local i32 @_Z4sdw1PcPi(i8* %0, i32* %1) #4 {
  %3 = alloca i8*, align 8
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z3addPiS_S_ii(i32* %0, i32* %1, i32* %2, i32 %3, i32 %4) #4 {
...
define dso_local i32 @main() #6 {
  ...
  %20 = call i32 @_Z4sdw1PcPi(i8* %18, i32* %19)
  ...
  %23 = call i32 @_Z4sdw1PcPi(i8* %21, i32* %22)
  ...
  %29 = call i32 @_Z3addPiS_S_ii(i32* %24, i32* %25, i32* %26, i32 %27, i32 %28)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_69_636.cpp() #0 section ".text.startup" {
