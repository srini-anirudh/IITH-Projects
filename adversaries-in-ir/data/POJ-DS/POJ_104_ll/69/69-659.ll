; ModuleID = 'POJ-104-source/69/69-659.cpp'
source_filename = "POJ-104-source/69/69-659.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_69_659.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %14 = bitcast i8* %13 to <{ i8, [200 x i8] }>*
  %15 = getelementptr inbounds <{ i8, [200 x i8] }>, <{ i8, [200 x i8] }>* %14, i32 0, i32 0
  store i8 48, i8* %15, align 16
  %16 = bitcast [201 x i8]* %3 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 16 %16, i8 0, i64 201, i1 false)
  %17 = bitcast i8* %16 to <{ i8, [200 x i8] }>*
  %18 = getelementptr inbounds <{ i8, [200 x i8] }>, <{ i8, [200 x i8] }>* %17, i32 0, i32 0
  ...
  %21 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i8* %19, i8* %20)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_69_659.cpp() #0 section ".text.startup" {
