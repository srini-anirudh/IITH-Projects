; ModuleID = 'POJ-104-source/69/69-834.cpp'
source_filename = "POJ-104-source/69/69-834.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_69_834.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %8 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), i8* %6, i8* %7)
...
18:                                               ; preds = %0
  ...
  call void @_Z1cPciS_i(i8* %19, i32 %20, i8* %21, i32 %22)
  br label %33
...
27:                                               ; preds = %23
  ...
  call void @_Z1cPciS_i(i8* %28, i32 %29, i8* %30, i32 %31)
  br label %32
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_69_834.cpp() #0 section ".text.startup" {
