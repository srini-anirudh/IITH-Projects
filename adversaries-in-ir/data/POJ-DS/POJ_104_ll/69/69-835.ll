; ModuleID = 'POJ-104-source/69/69-835.cpp'
source_filename = "POJ-104-source/69/69-835.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_69_835.cpp, i8* null }]
...
175:                                              ; preds = %102
  ...
  %178 = call i32 @_Z3maxii(i32 %176, i32 %177)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_69_835.cpp() #0 section ".text.startup" {
