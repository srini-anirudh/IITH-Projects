; ModuleID = 'POJ-104-source/69/69-841.cpp'
source_filename = "POJ-104-source/69/69-841.cpp"
...
@pHeader = dso_local global %struct.num* null, align 8
@.str = private unnamed_addr constant [3 x i8] c"%s\00", align 1
@.str.1 = private unnamed_addr constant [2 x i8] c"-\00", align 1
@.str.2 = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_69_841.cpp, i8* null }]
...
define dso_local void @_Z6Createv() #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z5StoreP3numi(%struct.num* %0, i32 %1) #4 {
...
125:                                              ; preds = %121
  ...
  %147 = srem i32 %146, 10
  call void @_Z5StoreP3numi(%struct.num* %145, i32 %147)
...
153:                                              ; preds = %121
  ...
  call void @_Z5StoreP3numi(%struct.num* %166, i32 %170)
  br label %258
...
176:                                              ; preds = %172
  ...
  %198 = srem i32 %197, 10
  call void @_Z5StoreP3numi(%struct.num* %196, i32 %198)
...
229:                                              ; preds = %226
  ...
  %240 = srem i32 %239, 10
  call void @_Z5StoreP3numi(%struct.num* %238, i32 %240)
...
246:                                              ; preds = %226
  ...
  call void @_Z5StoreP3numi(%struct.num* %253, i32 %257)
  br label %258
...
264:                                              ; preds = %260
  ...
  %286 = srem i32 %285, 10
  call void @_Z5StoreP3numi(%struct.num* %284, i32 %286)
...
317:                                              ; preds = %314
  ...
  %328 = srem i32 %327, 10
  call void @_Z5StoreP3numi(%struct.num* %326, i32 %328)
...
334:                                              ; preds = %314
  ...
  call void @_Z5StoreP3numi(%struct.num* %341, i32 %345)
  br label %346
...
447:                                              ; preds = %436, %416
  ...
  call void @_Z5StoreP3numi(%struct.num* %448, i32 %449)
  br label %450
...
480:                                              ; preds = %471, %461
  ...
  call void @_Z5StoreP3numi(%struct.num* %481, i32 %482)
  br label %483
...
486:                                              ; preds = %458
  ...
  call void @_Z5StoreP3numi(%struct.num* %487, i32 %491)
...
537:                                              ; preds = %526, %506
  ...
  call void @_Z5StoreP3numi(%struct.num* %538, i32 %539)
  br label %540
...
570:                                              ; preds = %561, %551
  ...
  call void @_Z5StoreP3numi(%struct.num* %571, i32 %572)
  br label %573
...
576:                                              ; preds = %548
  ...
  call void @_Z5StoreP3numi(%struct.num* %577, i32 %581)
...
627:                                              ; preds = %616, %596
  ...
  call void @_Z5StoreP3numi(%struct.num* %628, i32 %629)
  br label %630
...
645:                                              ; preds = %633
  ...
  call void @_Z5StoreP3numi(%struct.num* %648, i32 %649)
...
658:                                              ; preds = %655
  ...
  call void @_Z5StoreP3numi(%struct.num* %659, i32 %660)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_69_841.cpp() #0 section ".text.startup" {
