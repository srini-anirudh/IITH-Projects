; ModuleID = 'POJ-104-source/69/69-909.cpp'
source_filename = "POJ-104-source/69/69-909.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_69_909.cpp, i8* null }]
...
114:                                              ; preds = %74
  ...
  %117 = call i32 @_Z3maxii(i32 %115, i32 %116)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_69_909.cpp() #0 section ".text.startup" {
