; ModuleID = 'POJ-104-source/69/69-931.cpp'
source_filename = "POJ-104-source/69/69-931.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_69_931.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z6jianliP4nodePiS1_PS0_(%struct.node* %0, i32* %1, i32* %2, %struct.node** %3) #0 {
...
define dso_local void @_Z7shanchuP4node(%struct.node* %0) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z3jiaP4nodeS0_S0_(%struct.node* %0, %struct.node* %1, %struct.node* %2) #4 {
  %4 = alloca %struct.node*, align 8
  %5 = alloca %struct.node*, align 8
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z4jianP4nodeS0_S0_(%struct.node* %0, %struct.node* %1, %struct.node* %2) #4 {
  %4 = alloca %struct.node*, align 8
  %5 = alloca %struct.node*, align 8
  %6 = alloca %struct.node*, align 8
  %7 = alloca %struct.node*, align 8
...
; Function Attrs: noinline uwtable
define dso_local void @_Z6shuchuP4nodei(%struct.node* %0, i32 %1) #0 {
  %3 = alloca %struct.node*, align 8
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z6bijiaoP4nodeS0_ii(%struct.node* %0, %struct.node* %1, i32 %2, i32 %3) #4 {
...
define dso_local i32 @main() #5 {
  ...
  call void @_Z6jianliP4nodePiS1_PS0_(%struct.node* %31, i32* %2, i32* %4, %struct.node** %10)
  %32 = load %struct.node*, %struct.node** %8, align 8
  call void @_Z6jianliP4nodePiS1_PS0_(%struct.node* %32, i32* %3, i32* %5, %struct.node** %11)
...
37:                                               ; preds = %0
  ...
  call void @_Z3jiaP4nodeS0_S0_(%struct.node* %38, %struct.node* %39, %struct.node* %40)
  %41 = load %struct.node*, %struct.node** %9, align 8
  %42 = load i32, i32* %2, align 4
  call void @_Z6shuchuP4nodei(%struct.node* %41, i32 %42)
  br label %76
...
43:                                               ; preds = %0
  ...
  %48 = call i32 @_Z6bijiaoP4nodeS0_ii(%struct.node* %44, %struct.node* %45, i32 %46, i32 %47)
  %49 = icmp eq i32 %48, 0
...
52:                                               ; preds = %43
  ...
  %57 = call i32 @_Z6bijiaoP4nodeS0_ii(%struct.node* %53, %struct.node* %54, i32 %55, i32 %56)
...
69:                                               ; preds = %59, %52
  ...
  call void @_Z4jianP4nodeS0_S0_(%struct.node* %70, %struct.node* %71, %struct.node* %72)
  %73 = load %struct.node*, %struct.node** %9, align 8
  %74 = load i32, i32* %2, align 4
  call void @_Z6shuchuP4nodei(%struct.node* %73, i32 %74)
  br label %75
...
76:                                               ; preds = %75, %37
  ...
  call void @_Z7shanchuP4node(%struct.node* %77)
  %78 = load %struct.node*, %struct.node** %8, align 8
  call void @_Z7shanchuP4node(%struct.node* %78)
  %79 = load %struct.node*, %struct.node** %9, align 8
  call void @_Z7shanchuP4node(%struct.node* %79)
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_69_931.cpp() #0 section ".text.startup" {
