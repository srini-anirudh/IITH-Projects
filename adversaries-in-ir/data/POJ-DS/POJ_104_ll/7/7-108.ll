; ModuleID = 'POJ-104-source/7/7-108.cpp'
source_filename = "POJ-104-source/7/7-108.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_7_108.cpp, i8* null }]
...
88:                                               ; preds = %76
  ...
  %91 = getelementptr inbounds [256 x i32], [256 x i32]* %11, i64 0, i64 %90
...
133:                                              ; preds = %129
  ...
  %136 = getelementptr inbounds [256 x i32], [256 x i32]* %11, i64 0, i64 %135
...
139:                                              ; preds = %133
  ...
  %142 = getelementptr inbounds [256 x i32], [256 x i32]* %10, i64 0, i64 %141
...
172:                                              ; preds = %150
  %173 = getelementptr inbounds [256 x i8], [256 x i8]* %2, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_7_108.cpp() #0 section ".text.startup" {
