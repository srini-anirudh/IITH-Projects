; ModuleID = 'POJ-104-source/7/7-1082.cpp'
source_filename = "POJ-104-source/7/7-1082.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_7_1082.cpp, i8* null }]
...
define dso_local i32 @_Z8IssubstrPcS_(i8* %0, i8* %1) #4 {
...
define dso_local i32 @main() #6 {
  ...
  %13 = call i32 @_Z8IssubstrPcS_(i8* %11, i8* %12)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_7_1082.cpp() #0 section ".text.startup" {
