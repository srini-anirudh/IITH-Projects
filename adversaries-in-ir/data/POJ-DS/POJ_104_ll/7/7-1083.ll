; ModuleID = 'POJ-104-source/7/7-1083.cpp'
source_filename = "POJ-104-source/7/7-1083.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_7_1083.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %12 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i8* %9, i8* %10, i8* %11)
  %13 = getelementptr inbounds [600 x i8], [600 x i8]* %2, i64 0, i64 0
  %14 = getelementptr inbounds [260 x i8], [260 x i8]* %3, i64 0, i64 0
  %15 = call i8* @_ZSt6strstrPcPKc(i8* %13, i8* %14)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_7_1083.cpp() #0 section ".text.startup" {
