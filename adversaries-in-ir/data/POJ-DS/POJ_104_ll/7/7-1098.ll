; ModuleID = 'POJ-104-source/7/7-1098.cpp'
source_filename = "POJ-104-source/7/7-1098.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_7_1098.cpp, i8* null }]
...
define dso_local i32 @main(i32 %0, i8** %1) #4 {
  ...
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i8* %15, i8* %16, i8* %17)
...
32:                                               ; preds = %22
  ...
  %36 = call i32 @_Z5rightPcS_i(i8* %33, i8* %34, i32 %35)
  %37 = icmp ne i32 %36, 0
...
define dso_local i32 @_Z5rightPcS_i(i8* %0, i8* %1, i32 %2) #5 {
  %4 = alloca i32, align 4
  %5 = alloca i8*, align 8
  %6 = alloca i8*, align 8
  %7 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_7_1098.cpp() #0 section ".text.startup" {
