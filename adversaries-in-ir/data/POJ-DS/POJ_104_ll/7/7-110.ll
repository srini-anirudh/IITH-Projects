; ModuleID = 'POJ-104-source/7/7-110.cpp'
source_filename = "POJ-104-source/7/7-110.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_7_110.cpp, i8* null }]
...
89:                                               ; preds = %84, %22
  %90 = getelementptr inbounds [500 x i8], [500 x i8]* %2, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_7_110.cpp() #0 section ".text.startup" {
