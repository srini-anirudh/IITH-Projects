; ModuleID = 'POJ-104-source/7/7-1133.cpp'
source_filename = "POJ-104-source/7/7-1133.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_7_1133.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %9 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i8* %6, i8* %7, i8* %8)
  %10 = getelementptr inbounds [256 x i8], [256 x i8]* %2, i64 0, i64 0
  %11 = getelementptr inbounds [256 x i8], [256 x i8]* %3, i64 0, i64 0
  %12 = call i32 @_Z5strnlPcS_(i8* %10, i8* %11)
...
15:                                               ; preds = %0
  ...
  call void @_Z7replacePciiS_(i8* %16, i32 %19, i32 %20, i8* %21)
  br label %25
...
define dso_local i32 @_Z5strnlPcS_(i8* %0, i8* %1) #5 {
...
16:                                               ; preds = %7
  ...
  %20 = call i32 @_Z7isstartiPcS_(i32 %17, i8* %18, i8* %19)
  %21 = icmp ne i32 %20, 0
...
; Function Attrs: noinline uwtable
define dso_local void @_Z7replacePciiS_(i8* %0, i32 %1, i32 %2, i8* %3) #0 {
  %5 = alloca i8*, align 8
  %6 = alloca i32, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z7isstartiPcS_(i32 %0, i8* %1, i8* %2) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_7_1133.cpp() #0 section ".text.startup" {
