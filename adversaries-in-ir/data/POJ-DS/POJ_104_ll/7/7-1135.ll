; ModuleID = 'POJ-104-source/7/7-1135.cpp'
source_filename = "POJ-104-source/7/7-1135.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_7_1135.cpp, i8* null }]
...
77:                                               ; preds = %70
  ...
  %83 = call i32 @strcmp(i8* %81, i8* %82) #7
  %84 = icmp eq i32 %83, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_7_1135.cpp() #0 section ".text.startup" {
