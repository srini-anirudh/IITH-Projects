; ModuleID = 'POJ-104-source/7/7-1146.cpp'
source_filename = "POJ-104-source/7/7-1146.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_7_1146.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %7 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i8* %4, i8* %5, i8* %6)
  ...
  %11 = call signext i8 @_Z1fPcS_S_(i8* %8, i8* %9, i8* %10)
...
define dso_local signext i8 @_Z1fPcS_S_(i8* %0, i8* %1, i8* %2) #5 {
  %4 = alloca i8, align 1
  %5 = alloca i8*, align 8
  %6 = alloca i8*, align 8
  %7 = alloca i8*, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_7_1146.cpp() #0 section ".text.startup" {
