; ModuleID = 'POJ-104-source/7/7-1157.cpp'
source_filename = "POJ-104-source/7/7-1157.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_7_1157.cpp, i8* null }]
...
26:                                               ; preds = %22
  ...
  %32 = getelementptr inbounds [260 x i8], [260 x i8]* %3, i64 0, i64 0
...
111:                                              ; preds = %107
  ...
  %114 = getelementptr inbounds [260 x i8], [260 x i8]* %2, i64 0, i64 %113
...
123:                                              ; preds = %70
  %124 = getelementptr inbounds [260 x i8], [260 x i8]* %2, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_7_1157.cpp() #0 section ".text.startup" {
