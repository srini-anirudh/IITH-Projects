; ModuleID = 'POJ-104-source/7/7-1173.cpp'
source_filename = "POJ-104-source/7/7-1173.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_7_1173.cpp, i8* null }]
...
20:                                               ; preds = %0
  ...
  %23 = call i8* @_ZSt6strstrPcPKc(i8* %21, i8* %22)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_7_1173.cpp() #0 section ".text.startup" {
