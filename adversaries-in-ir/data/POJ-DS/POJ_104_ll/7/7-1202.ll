; ModuleID = 'POJ-104-source/7/7-1202.cpp'
source_filename = "POJ-104-source/7/7-1202.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_7_1202.cpp, i8* null }]
...
16:                                               ; preds = %0
  ...
  %19 = call i8* @_ZSt6strstrPcPKc(i8* %17, i8* %18)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_7_1202.cpp() #0 section ".text.startup" {
