; ModuleID = 'POJ-104-source/7/7-1207.cpp'
source_filename = "POJ-104-source/7/7-1207.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_7_1207.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %16 = call i8* @_ZSt6strstrPcPKc(i8* %14, i8* %15)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_7_1207.cpp() #0 section ".text.startup" {
