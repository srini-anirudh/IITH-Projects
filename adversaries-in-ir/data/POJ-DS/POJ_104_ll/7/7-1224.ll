; ModuleID = 'POJ-104-source/7/7-1224.cpp'
source_filename = "POJ-104-source/7/7-1224.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_7_1224.cpp, i8* null }]
...
18:                                               ; preds = %0
  ...
  %25 = call i8* @strcat(i8* %23, i8* %24) #3
  ...
  %29 = call i8* @strcat(i8* %27, i8* %28) #3
  br label %30
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_7_1224.cpp() #0 section ".text.startup" {
