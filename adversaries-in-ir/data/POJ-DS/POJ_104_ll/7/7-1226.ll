; ModuleID = 'POJ-104-source/7/7-1226.cpp'
source_filename = "POJ-104-source/7/7-1226.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_7_1226.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %10 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i8* %7, i8* %8, i8* %9)
  %11 = getelementptr inbounds [300 x i8], [300 x i8]* %2, i64 0, i64 0
  %12 = getelementptr inbounds [300 x i8], [300 x i8]* %3, i64 0, i64 0
  %13 = call i8* @_ZSt6strstrPcPKc(i8* %11, i8* %12)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_7_1226.cpp() #0 section ".text.startup" {
