; ModuleID = 'POJ-104-source/7/7-1252.cpp'
source_filename = "POJ-104-source/7/7-1252.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_7_1252.cpp, i8* null }]
...
define dso_local i32 @_Z4compPcS_i(i8* %0, i8* %1, i32 %2) #4 {
...
define dso_local i32 @main(i32 %0, i8** %1) #6 {
  ...
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i8* %15, i8* %16, i8* %17)
...
41:                                               ; preds = %31
  ...
  %45 = call i32 @_Z4compPcS_i(i8* %42, i8* %43, i32 %44)
  %46 = icmp ne i32 %45, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_7_1252.cpp() #0 section ".text.startup" {
