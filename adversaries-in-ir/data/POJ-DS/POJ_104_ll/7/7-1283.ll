; ModuleID = 'POJ-104-source/7/7-1283.cpp'
source_filename = "POJ-104-source/7/7-1283.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_7_1283.cpp, i8* null }]
...
define dso_local i32 @_Z6searchPcS_(i8* %0, i8* %1) #4 {
...
define dso_local i32 @main() #6 {
  ...
  %7 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), [300 x i8]* %2, [300 x i8]* %3, [300 x i8]* %4)
  %8 = getelementptr inbounds [300 x i8], [300 x i8]* %3, i64 0, i64 0
  %9 = getelementptr inbounds [300 x i8], [300 x i8]* %2, i64 0, i64 0
  %10 = call i32 @_Z6searchPcS_(i8* %8, i8* %9)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_7_1283.cpp() #0 section ".text.startup" {
