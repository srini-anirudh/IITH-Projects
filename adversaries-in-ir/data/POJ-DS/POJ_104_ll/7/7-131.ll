; ModuleID = 'POJ-104-source/7/7-131.cpp'
source_filename = "POJ-104-source/7/7-131.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_7_131.cpp, i8* null }]
...
103:                                              ; preds = %83
  ...
  %112 = call i8* @strcat(i8* %109, i8* %111) #3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_7_131.cpp() #0 section ".text.startup" {
