; ModuleID = 'POJ-104-source/7/7-135.cpp'
source_filename = "POJ-104-source/7/7-135.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_7_135.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i8* %11, i8* %12, i8* %13)
  %15 = getelementptr inbounds [256 x i8], [256 x i8]* %2, i64 0, i64 0
  %16 = getelementptr inbounds [256 x i8], [256 x i8]* %3, i64 0, i64 0
  %17 = call i8* @_ZSt6strstrPcPKc(i8* %15, i8* %16)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_7_135.cpp() #0 section ".text.startup" {
