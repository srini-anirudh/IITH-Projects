; ModuleID = 'POJ-104-source/7/7-14.cpp'
source_filename = "POJ-104-source/7/7-14.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_7_14.cpp, i8* null }]
...
94:                                               ; preds = %93, %71
  %95 = getelementptr inbounds [300 x i8], [300 x i8]* %2, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_7_14.cpp() #0 section ".text.startup" {
