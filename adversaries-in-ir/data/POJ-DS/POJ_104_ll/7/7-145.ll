; ModuleID = 'POJ-104-source/7/7-145.cpp'
source_filename = "POJ-104-source/7/7-145.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_7_145.cpp, i8* null }]
...
104:                                              ; preds = %101
  ...
  %106 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i8* %105)
  br label %107
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_7_145.cpp() #0 section ".text.startup" {
