; ModuleID = 'POJ-104-source/7/7-162.cpp'
source_filename = "POJ-104-source/7/7-162.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_7_162.cpp, i8* null }]
...
99:                                               ; preds = %72, %26
  %100 = getelementptr inbounds [256 x i8], [256 x i8]* %2, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_7_162.cpp() #0 section ".text.startup" {
