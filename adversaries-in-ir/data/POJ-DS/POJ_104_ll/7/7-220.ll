; ModuleID = 'POJ-104-source/7/7-220.cpp'
source_filename = "POJ-104-source/7/7-220.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_7_220.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %13 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i64 0, i64 0), i8* %10, i8* %11, i8* %12)
...
36:                                               ; preds = %24
  ...
  %44 = call i32 @memcmp(i8* %37, i8* %41, i64 %43) #6
  %45 = icmp eq i32 %44, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_7_220.cpp() #0 section ".text.startup" {
