; ModuleID = 'POJ-104-source/7/7-266.cpp'
source_filename = "POJ-104-source/7/7-266.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_7_266.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %13 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i8* %10, i8* %11, i8* %12)
...
116:                                              ; preds = %130, %112
  ...
  %121 = call i32 @_Z4funcc(i8 signext %120)
...
define dso_local i32 @_Z4funcc(i8 signext %0) #6 {
  %2 = alloca i32, align 4
  %3 = alloca i8, align 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_7_266.cpp() #0 section ".text.startup" {
