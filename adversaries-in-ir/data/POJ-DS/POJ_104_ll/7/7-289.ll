; ModuleID = 'POJ-104-source/7/7-289.cpp'
source_filename = "POJ-104-source/7/7-289.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_7_289.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %15 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i8* %12, i8* %13, i8* %14)
...
41:                                               ; preds = %28
  ...
  %46 = call i8* @strncpy(i8* %42, i8* %43, i64 %45) #3
  ...
  %58 = call i8* @strcat(i8* %50, i8* %57) #3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_7_289.cpp() #0 section ".text.startup" {
