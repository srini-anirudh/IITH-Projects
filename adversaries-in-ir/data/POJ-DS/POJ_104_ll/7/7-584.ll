; ModuleID = 'POJ-104-source/7/7-584.cpp'
source_filename = "POJ-104-source/7/7-584.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_7_584.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %15 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i8* %12, i8* %13, i8* %14)
...
83:                                               ; preds = %69
  ...
  %85 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i8* %84)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_7_584.cpp() #0 section ".text.startup" {
