; ModuleID = 'POJ-104-source/7/7-671.cpp'
source_filename = "POJ-104-source/7/7-671.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_7_671.cpp, i8* null }]
...
66:                                               ; preds = %62
  ...
  %72 = call i32 @strcmp(i8* %67, i8* %71) #6
  %73 = icmp eq i32 %72, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_7_671.cpp() #0 section ".text.startup" {
