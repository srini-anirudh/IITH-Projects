; ModuleID = 'POJ-104-source/7/7-906.cpp'
source_filename = "POJ-104-source/7/7-906.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_7_906.cpp, i8* null }]
...
58:                                               ; preds = %55
  %59 = getelementptr inbounds [300 x i8], [300 x i8]* %4, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_7_906.cpp() #0 section ".text.startup" {
