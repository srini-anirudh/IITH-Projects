; ModuleID = 'POJ-104-source/7/7-925.cpp'
source_filename = "POJ-104-source/7/7-925.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_7_925.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %12 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i8* %9, i8* %10, i8* %11)
...
39:                                               ; preds = %20
  ...
  %43 = getelementptr inbounds [256 x i8], [256 x i8]* %5, i64 0, i64 0
  %44 = getelementptr inbounds [256 x i8], [256 x i8]* %3, i64 0, i64 0
  %45 = call i32 @strcmp(i8* %43, i8* %44) #6
  %46 = icmp eq i32 %45, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_7_925.cpp() #0 section ".text.startup" {
