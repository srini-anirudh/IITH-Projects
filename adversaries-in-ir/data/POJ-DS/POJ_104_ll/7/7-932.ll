; ModuleID = 'POJ-104-source/7/7-932.cpp'
source_filename = "POJ-104-source/7/7-932.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_7_932.cpp, i8* null }]
...
49:                                               ; preds = %46
  ...
  %66 = call i8* @strcat(i8* %59, i8* %65) #3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_7_932.cpp() #0 section ".text.startup" {
