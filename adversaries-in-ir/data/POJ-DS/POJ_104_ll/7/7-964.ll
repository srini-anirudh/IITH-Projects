; ModuleID = 'POJ-104-source/7/7-964.cpp'
source_filename = "POJ-104-source/7/7-964.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_7_964.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %27 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i8* %24, i8* %25, i8* %26)
...
57:                                               ; preds = %40
  ...
  %61 = call i32 @strcmp(i8* %59, i8* %60) #7
  %62 = icmp eq i32 %61, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_7_964.cpp() #0 section ".text.startup" {
