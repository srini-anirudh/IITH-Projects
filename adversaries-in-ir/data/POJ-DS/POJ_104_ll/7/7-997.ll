; ModuleID = 'POJ-104-source/7/7-997.cpp'
source_filename = "POJ-104-source/7/7-997.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_7_997.cpp, i8* null }]
...
define dso_local void @_Z5rightPcii(i8* %0, i32 %1, i32 %2) #4 {
  %4 = alloca i8*, align 8
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z4leftPcii(i8* %0, i32 %1, i32 %2) #4 {
  %4 = alloca i8*, align 8
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
  %7 = alloca i32, align 4
...
103:                                              ; preds = %100
  ...
  call void @_Z4leftPcii(i8* %104, i32 %105, i32 %108)
  br label %109
...
112:                                              ; preds = %109
  ...
  call void @_Z5rightPcii(i8* %113, i32 %114, i32 %115)
  br label %116
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_7_997.cpp() #0 section ".text.startup" {
