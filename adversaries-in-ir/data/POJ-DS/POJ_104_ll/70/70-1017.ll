; ModuleID = 'POJ-104-source/70/70-1017.cpp'
source_filename = "POJ-104-source/70/70-1017.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_1017.cpp, i8* null }]
...
50:                                               ; preds = %46
  ...
  %71 = call double @_Z3disdddd(double %55, double %60, double %65, double %70)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_1017.cpp() #0 section ".text.startup" {
