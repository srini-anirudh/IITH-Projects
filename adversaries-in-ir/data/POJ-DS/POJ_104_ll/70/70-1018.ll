; ModuleID = 'POJ-104-source/70/70-1018.cpp'
source_filename = "POJ-104-source/70/70-1018.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_1018.cpp, i8* null }]
...
19:                                               ; preds = %15
  ...
  %30 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i64 0, i64 0), double* %24, double* %29)
  br label %31
...
47:                                               ; preds = %43
  ...
  %72 = call double @_Z3disdddd(double %53, double %59, double %65, double %71)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_1018.cpp() #0 section ".text.startup" {
