; ModuleID = 'POJ-104-source/70/70-1071.cpp'
source_filename = "POJ-104-source/70/70-1071.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_1071.cpp, i8* null }]
...
33:                                               ; preds = %29
  ...
  %42 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i64 0, i64 0), double* %37, double* %41)
  br label %43
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_1071.cpp() #0 section ".text.startup" {
