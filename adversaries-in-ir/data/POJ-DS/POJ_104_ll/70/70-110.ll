; ModuleID = 'POJ-104-source/70/70-110.cpp'
source_filename = "POJ-104-source/70/70-110.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_110.cpp, i8* null }]
...
32:                                               ; preds = %28
  %33 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), double* %13, double* %14)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_110.cpp() #0 section ".text.startup" {
