; ModuleID = 'POJ-104-source/70/70-1107.cpp'
source_filename = "POJ-104-source/70/70-1107.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_1107.cpp, i8* null }]
...
18:                                               ; preds = %14
  ...
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), float* %21, float* %24)
  br label %26
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_1107.cpp() #0 section ".text.startup" {
