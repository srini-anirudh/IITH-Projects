; ModuleID = 'POJ-104-source/70/70-1137.cpp'
source_filename = "POJ-104-source/70/70-1137.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_1137.cpp, i8* null }]
...
11:                                               ; preds = %7
  ...
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i64 0, i64 0), double* %15, double* %19)
  br label %21
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_1137.cpp() #0 section ".text.startup" {
