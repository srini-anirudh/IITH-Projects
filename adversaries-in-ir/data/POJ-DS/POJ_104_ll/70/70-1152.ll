; ModuleID = 'POJ-104-source/70/70-1152.cpp'
source_filename = "POJ-104-source/70/70-1152.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_1152.cpp, i8* null }]
...
define dso_local double @_Z1ddddd(double %0, double %1, double %2, double %3) #4 {
...
26:                                               ; preds = %10
  ...
  %29 = getelementptr inbounds [100 x double], [100 x double]* %4, i64 0, i64 1
  %30 = load double, double* %29, align 8
  %31 = getelementptr inbounds [100 x double], [100 x double]* %3, i64 0, i64 2
  %32 = load double, double* %31, align 16
  %33 = getelementptr inbounds [100 x double], [100 x double]* %4, i64 0, i64 2
  %34 = load double, double* %33, align 16
  %35 = call double @_Z1ddddd(double %28, double %30, double %32, double %34)
...
47:                                               ; preds = %43
  ...
  %64 = call double @_Z1ddddd(double %51, double %55, double %59, double %63)
...
67:                                               ; preds = %47
  ...
  %84 = call double @_Z1ddddd(double %71, double %75, double %79, double %83)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_1152.cpp() #0 section ".text.startup" {
