; ModuleID = 'POJ-104-source/70/70-118.cpp'
source_filename = "POJ-104-source/70/70-118.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_118.cpp, i8* null }]
...
37:                                               ; preds = %33
  ...
  %58 = call double @_Z8distancedddd(double %42, double %47, double %52, double %57)
  %59 = load double, double* %3, align 8
  %60 = call double @_Z3maxdd(double %58, double %59)
...
; Function Attrs: noinline nounwind uwtable
define dso_local double @_Z8distancedddd(double %0, double %1, double %2, double %3) #5 {
  %5 = alloca double, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_118.cpp() #0 section ".text.startup" {
