; ModuleID = 'POJ-104-source/70/70-1188.cpp'
source_filename = "POJ-104-source/70/70-1188.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_1188.cpp, i8* null }]
...
43:                                               ; preds = %39
  ...
  %87 = getelementptr inbounds [500 x double], [500 x double]* %6, i64 0, i64 %86
...
118:                                              ; preds = %107
  ...
  call void @_ZSt4swapIdENSt9enable_ifIXsr6__and_ISt6__not_ISt15__is_tuple_likeIT_EESt21is_move_constructibleIS3_ESt18is_move_assignableIS3_EEE5valueEvE4typeERS3_SC_(double* dereferenceable(8) %121, double* dereferenceable(8) %125) #3
  br label %126
...
134:                                              ; preds = %96
  ...
  %136 = call i32 @_ZSt12setprecisioni(i32 4)
  ...
  %141 = getelementptr inbounds [500 x double], [500 x double]* %6, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_1188.cpp() #0 section ".text.startup" {
