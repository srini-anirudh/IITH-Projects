; ModuleID = 'POJ-104-source/70/70-1200.cpp'
source_filename = "POJ-104-source/70/70-1200.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_1200.cpp, i8* null }]
...
24:                                               ; preds = %20
  ...
  %33 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i64 0, i64 0), double* %28, double* %32)
  br label %34
...
110:                                              ; preds = %38
  ...
  %113 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), double %112)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_1200.cpp() #0 section ".text.startup" {
