; ModuleID = 'POJ-104-source/70/70-1222.cpp'
source_filename = "POJ-104-source/70/70-1222.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_1222.cpp, i8* null }]
...
36:                                               ; preds = %32
  ...
  %53 = call double @_Z3disdddd(double %40, double %44, double %48, double %52)
...
56:                                               ; preds = %36
  ...
  %73 = call double @_Z3disdddd(double %60, double %64, double %68, double %72)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_1222.cpp() #0 section ".text.startup" {
