; ModuleID = 'POJ-104-source/70/70-139.cpp'
source_filename = "POJ-104-source/70/70-139.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_139.cpp, i8* null }]
...
13:                                               ; preds = %9
  ...
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), float* %17, float* %21)
  br label %23
...
192:                                              ; preds = %148
  ...
  %202 = call float @_ZSt4sqrtf(float %201)
  store float %202, float* %5, align 4
  %203 = load float, float* %5, align 4
  %204 = fpext float %203 to double
  %205 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), double %204)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_139.cpp() #0 section ".text.startup" {
