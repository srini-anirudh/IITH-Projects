; ModuleID = 'POJ-104-source/70/70-141.cpp'
source_filename = "POJ-104-source/70/70-141.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_141.cpp, i8* null }]
...
29:                                               ; preds = %26
  ...
  %38 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), double* %33, double* %37)
  br label %39
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_141.cpp() #0 section ".text.startup" {
