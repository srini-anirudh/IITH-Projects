; ModuleID = 'POJ-104-source/70/70-17.cpp'
source_filename = "POJ-104-source/70/70-17.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_17.cpp, i8* null }]
...
15:                                               ; preds = %11
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), float* %5, float* %6)
...
40:                                               ; preds = %36
  ...
  %86 = fmul float %74, %85
  %87 = fadd float %63, %86
  %88 = call float @_ZSt4sqrtf(float %87)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_17.cpp() #0 section ".text.startup" {
