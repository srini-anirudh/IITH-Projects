; ModuleID = 'POJ-104-source/70/70-173.cpp'
source_filename = "POJ-104-source/70/70-173.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_173.cpp, i8* null }]
...
15:                                               ; preds = %11
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), float* %8, float* %9)
  %17 = load float, float* %8, align 4
  %18 = fpext float %17 to double
  %19 = load i32, i32* %4, align 4
  %20 = sext i32 %19 to i64
  %21 = getelementptr inbounds [10 x %struct.anon], [10 x %struct.anon]* %3, i64 0, i64 %20
  ...
  %27 = getelementptr inbounds [10 x %struct.anon], [10 x %struct.anon]* %3, i64 0, i64 %26
...
44:                                               ; preds = %39
  ...
  %47 = getelementptr inbounds [10 x %struct.anon], [10 x %struct.anon]* %3, i64 0, i64 %46
  %48 = getelementptr inbounds %struct.anon, %struct.anon* %47, i32 0, i32 0
  %49 = load double, double* %48, align 16
  %50 = load i32, i32* %5, align 4
  %51 = sext i32 %50 to i64
  %52 = getelementptr inbounds [10 x %struct.anon], [10 x %struct.anon]* %3, i64 0, i64 %51
  %53 = getelementptr inbounds %struct.anon, %struct.anon* %52, i32 0, i32 0
  %54 = load double, double* %53, align 16
  %55 = fsub double %49, %54
  %56 = load i32, i32* %4, align 4
  %57 = sext i32 %56 to i64
  %58 = getelementptr inbounds [10 x %struct.anon], [10 x %struct.anon]* %3, i64 0, i64 %57
  %59 = getelementptr inbounds %struct.anon, %struct.anon* %58, i32 0, i32 0
  %60 = load double, double* %59, align 16
  %61 = load i32, i32* %5, align 4
  %62 = sext i32 %61 to i64
  %63 = getelementptr inbounds [10 x %struct.anon], [10 x %struct.anon]* %3, i64 0, i64 %62
  ...
  %70 = getelementptr inbounds [10 x %struct.anon], [10 x %struct.anon]* %3, i64 0, i64 %69
  %71 = getelementptr inbounds %struct.anon, %struct.anon* %70, i32 0, i32 1
  %72 = load double, double* %71, align 8
  %73 = load i32, i32* %5, align 4
  %74 = sext i32 %73 to i64
  %75 = getelementptr inbounds [10 x %struct.anon], [10 x %struct.anon]* %3, i64 0, i64 %74
  %76 = getelementptr inbounds %struct.anon, %struct.anon* %75, i32 0, i32 1
  %77 = load double, double* %76, align 8
  %78 = fsub double %72, %77
  %79 = load i32, i32* %4, align 4
  %80 = sext i32 %79 to i64
  %81 = getelementptr inbounds [10 x %struct.anon], [10 x %struct.anon]* %3, i64 0, i64 %80
  %82 = getelementptr inbounds %struct.anon, %struct.anon* %81, i32 0, i32 1
  %83 = load double, double* %82, align 8
  %84 = load i32, i32* %5, align 4
  %85 = sext i32 %84 to i64
  %86 = getelementptr inbounds [10 x %struct.anon], [10 x %struct.anon]* %3, i64 0, i64 %85
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_173.cpp() #0 section ".text.startup" {
