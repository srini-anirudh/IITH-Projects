; ModuleID = 'POJ-104-source/70/70-189.cpp'
source_filename = "POJ-104-source/70/70-189.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_189.cpp, i8* null }]
...
28:                                               ; preds = %24
  ...
  %37 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), double* %32, double* %36)
  br label %38
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_189.cpp() #0 section ".text.startup" {
