; ModuleID = 'POJ-104-source/70/70-195.cpp'
source_filename = "POJ-104-source/70/70-195.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_195.cpp, i8* null }]
...
17:                                               ; preds = %13
  ...
  %26 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), float* %21, float* %25)
  br label %27
...
40:                                               ; preds = %36
  ...
  %51 = fsub float %45, %50
  %52 = call double @_ZSt3powIfiEN9__gnu_cxx11__promote_2IT_T0_NS0_9__promoteIS2_Xsr3std12__is_integerIS2_EE7__valueEE6__typeENS4_IS3_Xsr3std12__is_integerIS3_EE7__valueEE6__typeEE6__typeES2_S3_(float %51, i32 2)
  ...
  %60 = getelementptr inbounds [100 x %struct.point], [100 x %struct.point]* %11, i64 0, i64 %59
  %61 = getelementptr inbounds %struct.point, %struct.point* %60, i32 0, i32 1
  %62 = load float, float* %61, align 4
  %63 = fsub float %57, %62
  %64 = call double @_ZSt3powIfiEN9__gnu_cxx11__promote_2IT_T0_NS0_9__promoteIS2_Xsr3std12__is_integerIS2_EE7__valueEE6__typeENS4_IS3_Xsr3std12__is_integerIS3_EE7__valueEE6__typeEE6__typeES2_S3_(float %63, i32 2)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_195.cpp() #0 section ".text.startup" {
