; ModuleID = 'POJ-104-source/70/70-198.cpp'
source_filename = "POJ-104-source/70/70-198.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_198.cpp, i8* null }]
...
define dso_local i32 @main(i32 %0, i8** %1) #4 {
  ...
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* %8)
...
31:                                               ; preds = %27
  %32 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), float* %10, float* %11)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_198.cpp() #0 section ".text.startup" {
