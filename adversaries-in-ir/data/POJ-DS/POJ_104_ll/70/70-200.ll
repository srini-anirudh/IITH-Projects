; ModuleID = 'POJ-104-source/70/70-200.cpp'
source_filename = "POJ-104-source/70/70-200.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_200.cpp, i8* null }]
...
20:                                               ; preds = %17
  %21 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %6)
  br label %22
...
22:                                               ; preds = %34, %20
  ...
  %31 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), double* %26, double* %30)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_200.cpp() #0 section ".text.startup" {
