; ModuleID = 'POJ-104-source/70/70-220.cpp'
source_filename = "POJ-104-source/70/70-220.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_220.cpp, i8* null }]
...
24:                                               ; preds = %20
  ...
  %35 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), double* %29, double* %34)
  br label %36
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_220.cpp() #0 section ".text.startup" {
