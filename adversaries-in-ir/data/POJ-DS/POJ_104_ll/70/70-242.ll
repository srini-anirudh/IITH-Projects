; ModuleID = 'POJ-104-source/70/70-242.cpp'
source_filename = "POJ-104-source/70/70-242.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_242.cpp, i8* null }]
...
16:                                               ; preds = %12
  ...
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i64 0, i64 0), double* %20, double* %24)
  br label %26
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_242.cpp() #0 section ".text.startup" {
