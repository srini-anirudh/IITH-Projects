; ModuleID = 'POJ-104-source/70/70-247.cpp'
source_filename = "POJ-104-source/70/70-247.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_247.cpp, i8* null }]
...
24:                                               ; preds = %20
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), float* %12, float* %13)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_247.cpp() #0 section ".text.startup" {
