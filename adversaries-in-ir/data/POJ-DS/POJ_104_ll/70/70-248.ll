; ModuleID = 'POJ-104-source/70/70-248.cpp'
source_filename = "POJ-104-source/70/70-248.cpp"
...
@p = dso_local global %struct.dot* null, align 8
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [8 x i8] c"%lf %lf\00", align 1
@.str.2 = private unnamed_addr constant [7 x i8] c"%.4lf\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_248.cpp, i8* null }]
...
define dso_local double @_Z8distanceii(i32 %0, i32 %1) #4 {
...
16:                                               ; preds = %12
  ...
  %27 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i64 0, i64 0), double* %21, double* %26)
  br label %28
...
43:                                               ; preds = %39
  ...
  %46 = call double @_Z8distanceii(i32 %44, i32 %45)
...
49:                                               ; preds = %43
  ...
  %52 = call double @_Z8distanceii(i32 %50, i32 %51)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_248.cpp() #0 section ".text.startup" {
