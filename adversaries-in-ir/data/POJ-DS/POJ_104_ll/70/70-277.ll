; ModuleID = 'POJ-104-source/70/70-277.cpp'
source_filename = "POJ-104-source/70/70-277.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_277.cpp, i8* null }]
...
27:                                               ; preds = %23
  ...
  %36 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), double* %31, double* %35)
  br label %37
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_277.cpp() #0 section ".text.startup" {
