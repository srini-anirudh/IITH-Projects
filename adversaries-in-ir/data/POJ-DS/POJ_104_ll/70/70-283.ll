; ModuleID = 'POJ-104-source/70/70-283.cpp'
source_filename = "POJ-104-source/70/70-283.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_283.cpp, i8* null }]
...
define dso_local double @_Z1fdd(double %0, double %1) #4 {
...
37:                                               ; preds = %33
  ...
  %56 = call double @_Z1fdd(double %46, double %55)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_283.cpp() #0 section ".text.startup" {
