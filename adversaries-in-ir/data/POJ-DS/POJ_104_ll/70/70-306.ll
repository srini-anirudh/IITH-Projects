; ModuleID = 'POJ-104-source/70/70-306.cpp'
source_filename = "POJ-104-source/70/70-306.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_306.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local double @_Z1fdddd(double %0, double %1, double %2, double %3) #0 {
...
24:                                               ; preds = %9
  ...
  %27 = getelementptr inbounds [100 x double], [100 x double]* %7, i64 0, i64 0
  %28 = load double, double* %27, align 16
  %29 = getelementptr inbounds [100 x double], [100 x double]* %6, i64 0, i64 1
  %30 = load double, double* %29, align 8
  %31 = getelementptr inbounds [100 x double], [100 x double]* %7, i64 0, i64 1
  %32 = load double, double* %31, align 8
  %33 = call double @_Z1fdddd(double %26, double %28, double %30, double %32)
...
46:                                               ; preds = %41
  ...
  %63 = call double @_Z1fdddd(double %50, double %54, double %58, double %62)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_306.cpp() #0 section ".text.startup" {
