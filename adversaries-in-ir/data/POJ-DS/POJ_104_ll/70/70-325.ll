; ModuleID = 'POJ-104-source/70/70-325.cpp'
source_filename = "POJ-104-source/70/70-325.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_325.cpp, i8* null }]
...
define dso_local double @_Z3disPdS_(double* %0, double* %1) #4 {
...
40:                                               ; preds = %36
  ...
  %49 = call double @_Z3disPdS_(double* %44, double* %48)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_325.cpp() #0 section ".text.startup" {
