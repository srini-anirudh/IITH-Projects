; ModuleID = 'POJ-104-source/70/70-331.cpp'
source_filename = "POJ-104-source/70/70-331.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_331.cpp, i8* null }]
...
17:                                               ; preds = %12
  ...
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), float* %20, float* %23)
  br label %25
...
94:                                               ; preds = %29
  %95 = getelementptr inbounds [100 x float], [100 x float]* %9, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_331.cpp() #0 section ".text.startup" {
