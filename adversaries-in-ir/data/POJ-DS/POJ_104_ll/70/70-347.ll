; ModuleID = 'POJ-104-source/70/70-347.cpp'
source_filename = "POJ-104-source/70/70-347.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_347.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %21 = getelementptr inbounds [10 x float], [10 x float]* %3, i64 0, i64 %20
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), float* %18, float* %21)
  br label %23
...
39:                                               ; preds = %33
  ...
  %42 = getelementptr inbounds [10 x float], [10 x float]* %2, i64 0, i64 %41
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_347.cpp() #0 section ".text.startup" {
