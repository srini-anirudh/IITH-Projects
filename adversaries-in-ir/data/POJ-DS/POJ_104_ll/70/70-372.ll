; ModuleID = 'POJ-104-source/70/70-372.cpp'
source_filename = "POJ-104-source/70/70-372.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_372.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %18 = getelementptr inbounds [10 x double], [10 x double]* %6, i64 0, i64 %17
  %19 = load i32, i32* %3, align 4
  %20 = sext i32 %19 to i64
  %21 = getelementptr inbounds [10 x double], [10 x double]* %7, i64 0, i64 %20
...
102:                                              ; preds = %38
  %103 = getelementptr inbounds [50 x double], [50 x double]* %8, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_372.cpp() #0 section ".text.startup" {
