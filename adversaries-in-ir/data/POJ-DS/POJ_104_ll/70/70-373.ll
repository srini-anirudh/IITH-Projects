; ModuleID = 'POJ-104-source/70/70-373.cpp'
source_filename = "POJ-104-source/70/70-373.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_373.cpp, i8* null }]
...
define dso_local double @_Z3maxPdi(double* %0, i32 %1) #4 {
...
15:                                               ; preds = %10
  ...
  %18 = getelementptr inbounds [10 x double], [10 x double]* %3, i64 0, i64 %17
  %19 = load i32, i32* %6, align 4
  %20 = sext i32 %19 to i64
  %21 = getelementptr inbounds [10 x double], [10 x double]* %4, i64 0, i64 %20
...
76:                                               ; preds = %27
  ...
  %79 = call double @_Z3maxPdi(double* %77, i32 %78)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_373.cpp() #0 section ".text.startup" {
