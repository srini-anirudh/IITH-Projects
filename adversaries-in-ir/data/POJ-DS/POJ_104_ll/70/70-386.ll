; ModuleID = 'POJ-104-source/70/70-386.cpp'
source_filename = "POJ-104-source/70/70-386.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_386.cpp, i8* null }]
...
15:                                               ; preds = %10
  ...
  %18 = getelementptr inbounds [10 x double], [10 x double]* %5, i64 0, i64 %17
...
26:                                               ; preds = %10
  ...
  %29 = getelementptr inbounds [10 x double], [10 x double]* %6, i64 0, i64 0
  %30 = load double, double* %29, align 16
  %31 = getelementptr inbounds [10 x double], [10 x double]* %5, i64 0, i64 1
  %32 = load double, double* %31, align 8
  %33 = getelementptr inbounds [10 x double], [10 x double]* %6, i64 0, i64 1
  %34 = load double, double* %33, align 8
  %35 = call double @_Z8distancedddd(double %28, double %30, double %32, double %34)
...
47:                                               ; preds = %42
  ...
  %64 = call double @_Z8distancedddd(double %51, double %55, double %59, double %63)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_386.cpp() #0 section ".text.startup" {
