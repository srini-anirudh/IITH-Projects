; ModuleID = 'POJ-104-source/70/70-389.cpp'
source_filename = "POJ-104-source/70/70-389.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_389.cpp, i8* null }]
...
140:                                              ; preds = %91
  %141 = getelementptr inbounds [1000 x double], [1000 x double]* %6, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_389.cpp() #0 section ".text.startup" {
