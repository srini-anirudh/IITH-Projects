; ModuleID = 'POJ-104-source/70/70-416.cpp'
source_filename = "POJ-104-source/70/70-416.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_416.cpp, i8* null }]
...
100:                                              ; preds = %27
  %101 = getelementptr inbounds [10000 x double], [10000 x double]* %7, i64 0, i64 0
  %102 = load i32, i32* %5, align 4
  %103 = call double @_Z3maxPdi(double* %101, i32 %102)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_416.cpp() #0 section ".text.startup" {
