; ModuleID = 'POJ-104-source/70/70-426.cpp'
source_filename = "POJ-104-source/70/70-426.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_426.cpp, i8* null }]
...
34:                                               ; preds = %30
  ...
  %52 = call double @_Z8distancedddd(double %39, double %43, double %47, double %51)
...
54:                                               ; preds = %34
  ...
  %71 = call double @_Z8distancedddd(double %58, double %62, double %66, double %70)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_426.cpp() #0 section ".text.startup" {
