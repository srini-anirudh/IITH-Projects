; ModuleID = 'POJ-104-source/70/70-429.cpp'
source_filename = "POJ-104-source/70/70-429.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_429.cpp, i8* null }]
...
12:                                               ; preds = %8
  ...
  %15 = getelementptr inbounds [100 x %struct.dian], [100 x %struct.dian]* @dian, i64 0, i64 %14
...
38:                                               ; preds = %34
  ...
  %46 = getelementptr inbounds [100 x %struct.dian], [100 x %struct.dian]* @dian, i64 0, i64 %45
  ...
  %57 = getelementptr inbounds [100 x %struct.dian], [100 x %struct.dian]* @dian, i64 0, i64 %56
  ...
  %64 = getelementptr inbounds [100 x %struct.dian], [100 x %struct.dian]* @dian, i64 0, i64 %63
  %65 = getelementptr inbounds %struct.dian, %struct.dian* %64, i32 0, i32 1
  %66 = load double, double* %65, align 8
  %67 = load i32, i32* %4, align 4
  %68 = sext i32 %67 to i64
  %69 = getelementptr inbounds [100 x %struct.dian], [100 x %struct.dian]* @dian, i64 0, i64 %68
  ...
  %80 = getelementptr inbounds [100 x %struct.dian], [100 x %struct.dian]* @dian, i64 0, i64 %79
...
98:                                               ; preds = %26
  %99 = getelementptr inbounds [1000 x double], [1000 x double]* %6, i64 0, i64 0
  %100 = load i32, i32* %5, align 4
  %101 = call double @_Z3maxPdi(double* %99, i32 %100)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_429.cpp() #0 section ".text.startup" {
