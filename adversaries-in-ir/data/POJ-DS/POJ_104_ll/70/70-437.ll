; ModuleID = 'POJ-104-source/70/70-437.cpp'
source_filename = "POJ-104-source/70/70-437.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_437.cpp, i8* null }]
...
35:                                               ; preds = %31
  ...
  %42 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), double* %38, double* %41)
...
49:                                               ; preds = %45
  ...
  %56 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), double* %52, double* %55)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_437.cpp() #0 section ".text.startup" {
