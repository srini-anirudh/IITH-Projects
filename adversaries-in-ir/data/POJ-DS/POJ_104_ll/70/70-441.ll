; ModuleID = 'POJ-104-source/70/70-441.cpp'
source_filename = "POJ-104-source/70/70-441.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_441.cpp, i8* null }]
...
12:                                               ; preds = %8
  ...
  %15 = getelementptr inbounds [20 x %struct.dian], [20 x %struct.dian]* @dia, i64 0, i64 %14
  ...
  %21 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i64 0, i64 0), double* %16, double* %20)
  br label %22
...
38:                                               ; preds = %34
  ...
  %41 = getelementptr inbounds [20 x %struct.dian], [20 x %struct.dian]* @dia, i64 0, i64 %40
  %42 = getelementptr inbounds %struct.dian, %struct.dian* %41, i32 0, i32 0
  %43 = load double, double* %42, align 16
  %44 = load i32, i32* %4, align 4
  %45 = sext i32 %44 to i64
  %46 = getelementptr inbounds [20 x %struct.dian], [20 x %struct.dian]* @dia, i64 0, i64 %45
  %47 = getelementptr inbounds %struct.dian, %struct.dian* %46, i32 0, i32 0
  ...
  %57 = getelementptr inbounds [20 x %struct.dian], [20 x %struct.dian]* @dia, i64 0, i64 %56
  ...
  %64 = getelementptr inbounds [20 x %struct.dian], [20 x %struct.dian]* @dia, i64 0, i64 %63
  %65 = getelementptr inbounds %struct.dian, %struct.dian* %64, i32 0, i32 1
  ...
  %80 = getelementptr inbounds [20 x %struct.dian], [20 x %struct.dian]* @dia, i64 0, i64 %79
...
88:                                               ; preds = %38
  ...
  %91 = getelementptr inbounds [20 x %struct.dian], [20 x %struct.dian]* @dia, i64 0, i64 %90
  %92 = getelementptr inbounds %struct.dian, %struct.dian* %91, i32 0, i32 0
  %93 = load double, double* %92, align 16
  %94 = load i32, i32* %4, align 4
  %95 = sext i32 %94 to i64
  %96 = getelementptr inbounds [20 x %struct.dian], [20 x %struct.dian]* @dia, i64 0, i64 %95
  %97 = getelementptr inbounds %struct.dian, %struct.dian* %96, i32 0, i32 0
  %98 = load double, double* %97, align 16
  %99 = fsub double %93, %98
  %100 = load i32, i32* %3, align 4
  %101 = sext i32 %100 to i64
  %102 = getelementptr inbounds [20 x %struct.dian], [20 x %struct.dian]* @dia, i64 0, i64 %101
  %103 = getelementptr inbounds %struct.dian, %struct.dian* %102, i32 0, i32 0
  %104 = load double, double* %103, align 16
  %105 = load i32, i32* %4, align 4
  %106 = sext i32 %105 to i64
  %107 = getelementptr inbounds [20 x %struct.dian], [20 x %struct.dian]* @dia, i64 0, i64 %106
  ...
  %120 = getelementptr inbounds %struct.dian, %struct.dian* %119, i32 0, i32 1
  %121 = load double, double* %120, align 8
  %122 = fsub double %116, %121
  %123 = load i32, i32* %3, align 4
  %124 = sext i32 %123 to i64
  %125 = getelementptr inbounds [20 x %struct.dian], [20 x %struct.dian]* @dia, i64 0, i64 %124
  %126 = getelementptr inbounds %struct.dian, %struct.dian* %125, i32 0, i32 1
  %127 = load double, double* %126, align 8
  %128 = load i32, i32* %4, align 4
  %129 = sext i32 %128 to i64
  %130 = getelementptr inbounds [20 x %struct.dian], [20 x %struct.dian]* @dia, i64 0, i64 %129
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_441.cpp() #0 section ".text.startup" {
