; ModuleID = 'POJ-104-source/70/70-49.cpp'
source_filename = "POJ-104-source/70/70-49.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_49.cpp, i8* null }]
...
60:                                               ; preds = %56
  ...
  %81 = call float @_Z8distanceffff(float %65, float %70, float %75, float %80)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_49.cpp() #0 section ".text.startup" {
