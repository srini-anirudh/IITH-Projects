; ModuleID = 'POJ-104-source/70/70-496.cpp'
source_filename = "POJ-104-source/70/70-496.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_496.cpp, i8* null }]
...
22:                                               ; preds = %18
  ...
  %33 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), double* %27, double* %32)
  br label %34
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_496.cpp() #0 section ".text.startup" {
