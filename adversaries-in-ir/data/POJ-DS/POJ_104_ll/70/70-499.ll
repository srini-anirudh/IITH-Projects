; ModuleID = 'POJ-104-source/70/70-499.cpp'
source_filename = "POJ-104-source/70/70-499.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_499.cpp, i8* null }]
...
13:                                               ; preds = %9
  ...
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), float* %16, float* %19)
  br label %21
...
37:                                               ; preds = %33
  ...
  %54 = call double @_Z1fffff(float %41, float %45, float %49, float %53)
...
57:                                               ; preds = %37
  ...
  %74 = call double @_Z1fffff(float %61, float %65, float %69, float %73)
...
; Function Attrs: noinline uwtable
define dso_local double @_Z1fffff(float %0, float %1, float %2, float %3) #0 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_499.cpp() #0 section ".text.startup" {
