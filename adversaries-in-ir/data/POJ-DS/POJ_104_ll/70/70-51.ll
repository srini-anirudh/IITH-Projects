; ModuleID = 'POJ-104-source/70/70-51.cpp'
source_filename = "POJ-104-source/70/70-51.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_51.cpp, i8* null }]
...
41:                                               ; preds = %37
  ...
  %62 = call float @_Z8distanceffff(float %46, float %51, float %56, float %61)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_51.cpp() #0 section ".text.startup" {
