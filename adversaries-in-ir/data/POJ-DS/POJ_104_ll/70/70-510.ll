; ModuleID = 'POJ-104-source/70/70-510.cpp'
source_filename = "POJ-104-source/70/70-510.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_510.cpp, i8* null }]
...
41:                                               ; preds = %37
  ...
  %60 = call double @_Z1fdd(double %50, double %59)
...
66:                                               ; preds = %41
  ...
  %85 = call double @_Z1fdd(double %75, double %84)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_510.cpp() #0 section ".text.startup" {
