; ModuleID = 'POJ-104-source/70/70-540.cpp'
source_filename = "POJ-104-source/70/70-540.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_540.cpp, i8* null }]
...
define dso_local double @_Z3maxPdS_i(double* %0, double* %1, i32 %2) #4 {
...
24:                                               ; preds = %9
  ...
  %30 = call double @_Z3maxPdS_i(double* %27, double* %28, i32 %29)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_540.cpp() #0 section ".text.startup" {
