; ModuleID = 'POJ-104-source/70/70-56.cpp'
source_filename = "POJ-104-source/70/70-56.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_56.cpp, i8* null }]
...
27:                                               ; preds = %23
  ...
  %48 = call float @_Z8distanceffff(float %32, float %37, float %42, float %47)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_56.cpp() #0 section ".text.startup" {
