; ModuleID = 'POJ-104-source/70/70-591.cpp'
source_filename = "POJ-104-source/70/70-591.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_591.cpp, i8* null }]
...
24:                                               ; preds = %9
  ...
  %29 = getelementptr inbounds [100 x double], [100 x double]* %5, i64 0, i64 1
  %30 = load double, double* %29, align 8
  %31 = getelementptr inbounds [100 x double], [100 x double]* %6, i64 0, i64 1
  %32 = load double, double* %31, align 8
  %33 = call double @_Z3disdddd(double %26, double %28, double %30, double %32)
...
46:                                               ; preds = %42
  ...
  %63 = call double @_Z3disdddd(double %50, double %54, double %58, double %62)
...
66:                                               ; preds = %46
  ...
  %83 = call double @_Z3disdddd(double %70, double %74, double %78, double %82)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_591.cpp() #0 section ".text.startup" {
