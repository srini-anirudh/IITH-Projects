; ModuleID = 'POJ-104-source/70/70-601.cpp'
source_filename = "POJ-104-source/70/70-601.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_601.cpp, i8* null }]
...
17:                                               ; preds = %13
  ...
  %26 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), double* %21, double* %25)
  br label %27
...
42:                                               ; preds = %38
  ...
  %45 = getelementptr inbounds [100 x [2 x double]], [100 x [2 x double]]* %9, i64 0, i64 %44
  ...
  %56 = getelementptr inbounds [100 x [2 x double]], [100 x [2 x double]]* %9, i64 0, i64 %55
  ...
  %79 = getelementptr inbounds [100 x [2 x double]], [100 x [2 x double]]* %9, i64 0, i64 %78
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_601.cpp() #0 section ".text.startup" {
