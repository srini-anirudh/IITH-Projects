; ModuleID = 'POJ-104-source/70/70-640.cpp'
source_filename = "POJ-104-source/70/70-640.cpp"
...
@s = dso_local global [1000 x [1000 x double]] zeroinitializer, align 16
@m = dso_local global [1000 x double] zeroinitializer, align 16
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [7 x i8] c"%lf%lf\00", align 1
@.str.2 = private unnamed_addr constant [6 x i8] c"%.4f\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_640.cpp, i8* null }]
...
11:                                               ; preds = %7
  ...
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), double* %14, double* %17)
  br label %19
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_640.cpp() #0 section ".text.startup" {
