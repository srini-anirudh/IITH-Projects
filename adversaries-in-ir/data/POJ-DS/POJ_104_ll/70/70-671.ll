; ModuleID = 'POJ-104-source/70/70-671.cpp'
source_filename = "POJ-104-source/70/70-671.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_671.cpp, i8* null }]
...
39:                                               ; preds = %35
  ...
  %58 = call double @_Z1fdd(double %48, double %57)
...
define dso_local double @_Z1fdd(double %0, double %1) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_671.cpp() #0 section ".text.startup" {
