; ModuleID = 'POJ-104-source/70/70-687.cpp'
source_filename = "POJ-104-source/70/70-687.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_687.cpp, i8* null }]
...
90:                                               ; preds = %60
  ...
  %105 = getelementptr inbounds [100 x [2 x double]], [100 x [2 x double]]* %5, i64 0, i64 %104
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_687.cpp() #0 section ".text.startup" {
