; ModuleID = 'POJ-104-source/70/70-715.cpp'
source_filename = "POJ-104-source/70/70-715.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_715.cpp, i8* null }]
...
21:                                               ; preds = %17
  ...
  %30 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), float* %25, float* %29)
  br label %31
...
47:                                               ; preds = %43
  ...
  %60 = call double @_ZSt3powIfiEN9__gnu_cxx11__promote_2IT_T0_NS0_9__promoteIS2_Xsr3std12__is_integerIS2_EE7__valueEE6__typeENS4_IS3_Xsr3std12__is_integerIS3_EE7__valueEE6__typeEE6__typeES2_S3_(float %59, i32 2)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_715.cpp() #0 section ".text.startup" {
