; ModuleID = 'POJ-104-source/70/70-718.cpp'
source_filename = "POJ-104-source/70/70-718.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_718.cpp, i8* null }]
...
16:                                               ; preds = %12
  ...
  %23 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i64 0, i64 0), double* %19, double* %22)
  br label %24
...
92:                                               ; preds = %28
  %93 = getelementptr inbounds [100 x double], [100 x double]* %9, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_718.cpp() #0 section ".text.startup" {
