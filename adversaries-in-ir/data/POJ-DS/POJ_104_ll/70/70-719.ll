; ModuleID = 'POJ-104-source/70/70-719.cpp'
source_filename = "POJ-104-source/70/70-719.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_719.cpp, i8* null }]
...
45:                                               ; preds = %41
  ...
  %97 = getelementptr inbounds [5000 x double], [5000 x double]* %7, i64 0, i64 %96
...
105:                                              ; preds = %34
  %106 = getelementptr inbounds [5000 x double], [5000 x double]* %7, i64 0, i64 0
...
119:                                              ; preds = %112
  ...
  %122 = getelementptr inbounds [5000 x double], [5000 x double]* %7, i64 0, i64 %121
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_719.cpp() #0 section ".text.startup" {
