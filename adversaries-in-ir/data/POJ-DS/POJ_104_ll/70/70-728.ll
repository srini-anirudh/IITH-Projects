; ModuleID = 'POJ-104-source/70/70-728.cpp'
source_filename = "POJ-104-source/70/70-728.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_728.cpp, i8* null }]
...
36:                                               ; preds = %32
  ...
  %45 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i64 0, i64 0), double* %40, double* %44)
  br label %46
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_728.cpp() #0 section ".text.startup" {
