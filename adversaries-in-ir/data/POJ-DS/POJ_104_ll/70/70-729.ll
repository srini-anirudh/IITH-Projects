; ModuleID = 'POJ-104-source/70/70-729.cpp'
source_filename = "POJ-104-source/70/70-729.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_729.cpp, i8* null }]
...
38:                                               ; preds = %34
  ...
  %55 = call double @_Z4julidddd(double %42, double %46, double %50, double %54)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_729.cpp() #0 section ".text.startup" {
