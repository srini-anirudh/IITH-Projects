; ModuleID = 'POJ-104-source/70/70-731.cpp'
source_filename = "POJ-104-source/70/70-731.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_731.cpp, i8* null }]
...
26:                                               ; preds = %9
  %27 = getelementptr inbounds [100 x [2 x double]], [100 x [2 x double]]* %2, i64 0, i64 0
  %28 = getelementptr inbounds [2 x double], [2 x double]* %27, i64 0, i64 0
  %29 = load double, double* %28, align 16
  %30 = getelementptr inbounds [100 x [2 x double]], [100 x [2 x double]]* %2, i64 0, i64 1
  ...
  %36 = getelementptr inbounds [100 x [2 x double]], [100 x [2 x double]]* %2, i64 0, i64 1
  %37 = getelementptr inbounds [2 x double], [2 x double]* %36, i64 0, i64 1
  %38 = load double, double* %37, align 8
  %39 = call double @_Z6lengthdddd(double %29, double %32, double %35, double %38)
...
51:                                               ; preds = %47
  ...
  %73 = call double @_Z6lengthdddd(double %57, double %62, double %67, double %72)
  store double %73, double* %4, align 8
  %74 = fcmp olt double %52, %73
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_731.cpp() #0 section ".text.startup" {
