; ModuleID = 'POJ-104-source/70/70-745.cpp'
source_filename = "POJ-104-source/70/70-745.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_745.cpp, i8* null }]
...
21:                                               ; preds = %17
  ...
  %32 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), float* %26, float* %31)
  br label %33
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_745.cpp() #0 section ".text.startup" {
