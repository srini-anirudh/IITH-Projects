; ModuleID = 'POJ-104-source/70/70-746.cpp'
source_filename = "POJ-104-source/70/70-746.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_746.cpp, i8* null }]
...
123:                                              ; preds = %113
  ...
  %126 = getelementptr inbounds [100 x [100 x double]], [100 x [100 x double]]* %6, i64 0, i64 %125
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_746.cpp() #0 section ".text.startup" {
