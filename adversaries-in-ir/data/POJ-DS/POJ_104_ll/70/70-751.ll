; ModuleID = 'POJ-104-source/70/70-751.cpp'
source_filename = "POJ-104-source/70/70-751.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_751.cpp, i8* null }]
...
49:                                               ; preds = %45
  ...
  %68 = getelementptr inbounds [100 x [2 x double]], [100 x [2 x double]]* %6, i64 0, i64 %67
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_751.cpp() #0 section ".text.startup" {
