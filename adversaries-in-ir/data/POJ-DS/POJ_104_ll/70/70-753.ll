; ModuleID = 'POJ-104-source/70/70-753.cpp'
source_filename = "POJ-104-source/70/70-753.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_753.cpp, i8* null }]
...
10:                                               ; preds = %6
  ...
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i64 0, i64 0), double* %14, double* %18)
  br label %20
...
28:                                               ; preds = %24
  ...
  %30 = call double @_Z9getMaxDisi(i32 %29)
...
define dso_local double @_Z9getMaxDisi(i32 %0) #5 {
  %2 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_753.cpp() #0 section ".text.startup" {
