; ModuleID = 'POJ-104-source/70/70-772.cpp'
source_filename = "POJ-104-source/70/70-772.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_772.cpp, i8* null }]
...
41:                                               ; preds = %36
  ...
  %63 = call double @_Z3disdddd(double %47, double %52, double %57, double %62)
  %64 = fcmp olt double %42, %63
...
65:                                               ; preds = %41
  ...
  %86 = call double @_Z3disdddd(double %70, double %75, double %80, double %85)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_772.cpp() #0 section ".text.startup" {
