; ModuleID = 'POJ-104-source/70/70-94.cpp'
source_filename = "POJ-104-source/70/70-94.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_94.cpp, i8* null }]
...
14:                                               ; preds = %10
  ...
  %23 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), float* %18, float* %22)
  br label %24
...
37:                                               ; preds = %33
  ...
  %83 = fmul float %71, %82
  %84 = fadd float %60, %83
  %85 = call float @_ZSt4sqrtf(float %84)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_94.cpp() #0 section ".text.startup" {
