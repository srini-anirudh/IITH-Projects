; ModuleID = 'POJ-104-source/70/70-95.cpp'
source_filename = "POJ-104-source/70/70-95.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_95.cpp, i8* null }]
...
99:                                               ; preds = %29
  ...
  %101 = call double @pow(double %100, double 5.000000e-01) #3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_95.cpp() #0 section ".text.startup" {
