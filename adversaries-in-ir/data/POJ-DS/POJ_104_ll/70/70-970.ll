; ModuleID = 'POJ-104-source/70/70-970.cpp'
source_filename = "POJ-104-source/70/70-970.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_970.cpp, i8* null }]
...
79:                                               ; preds = %36
  ...
  %91 = getelementptr inbounds [1000 x float], [1000 x float]* %5, i64 0, i64 %90
  %92 = load float, float* %91, align 4
  %93 = load i32, i32* %4, align 4
  %94 = sext i32 %93 to i64
  %95 = getelementptr inbounds [1000 x float], [1000 x float]* %5, i64 0, i64 %94
  ...
  %105 = getelementptr inbounds [1000 x float], [1000 x float]* %6, i64 0, i64 %104
  %106 = load float, float* %105, align 4
  %107 = fsub float %102, %106
  %108 = load i32, i32* %3, align 4
  %109 = sext i32 %108 to i64
  %110 = getelementptr inbounds [1000 x float], [1000 x float]* %6, i64 0, i64 %109
  ...
  %119 = call float @_ZSt4sqrtf(float %118)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_970.cpp() #0 section ".text.startup" {
