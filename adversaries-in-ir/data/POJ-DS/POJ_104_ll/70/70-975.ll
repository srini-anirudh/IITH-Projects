; ModuleID = 'POJ-104-source/70/70-975.cpp'
source_filename = "POJ-104-source/70/70-975.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_975.cpp, i8* null }]
...
14:                                               ; preds = %10
  ...
  %21 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), float* %17, float* %20)
  br label %22
...
36:                                               ; preds = %32
  ...
  %82 = getelementptr inbounds [10000 x float], [10000 x float]* %8, i64 0, i64 %81
  %83 = load float, float* %82, align 4
  %84 = getelementptr inbounds [10000 x float], [10000 x float]* %8, i64 0, i64 0
...
87:                                               ; preds = %36
  ...
  %92 = getelementptr inbounds [10000 x float], [10000 x float]* %8, i64 0, i64 0
...
103:                                              ; preds = %27
  %104 = getelementptr inbounds [10000 x float], [10000 x float]* %8, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_975.cpp() #0 section ".text.startup" {
