; ModuleID = 'POJ-104-source/70/70-985.cpp'
source_filename = "POJ-104-source/70/70-985.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_985.cpp, i8* null }]
...
13:                                               ; preds = %9
  ...
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i64 0, i64 0), double* %16, double* %19)
  br label %21
...
24:                                               ; preds = %9
  ...
  %33 = call double @_Z2sqdddd(double %26, double %28, double %30, double %32)
...
43:                                               ; preds = %39
  ...
  %60 = call double @_Z2sqdddd(double %47, double %51, double %55, double %59)
...
63:                                               ; preds = %43
  ...
  %80 = call double @_Z2sqdddd(double %67, double %71, double %75, double %79)
...
define dso_local double @_Z2sqdddd(double %0, double %1, double %2, double %3) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_985.cpp() #0 section ".text.startup" {
