; ModuleID = 'POJ-104-source/70/70-996.cpp'
source_filename = "POJ-104-source/70/70-996.cpp"
...
@point = dso_local global %struct.point* null, align 8
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [7 x i8] c"%lf%lf\00", align 1
@.str.2 = private unnamed_addr constant [7 x i8] c"%.4lf\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_70_996.cpp, i8* null }]
...
19:                                               ; preds = %15
  ...
  %30 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), double* %24, double* %29)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_70_996.cpp() #0 section ".text.startup" {
