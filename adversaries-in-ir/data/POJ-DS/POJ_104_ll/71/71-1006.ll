; ModuleID = 'POJ-104-source/71/71-1006.cpp'
source_filename = "POJ-104-source/71/71-1006.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_1006.cpp, i8* null }]
...
62:                                               ; preds = %61, %60
  ...
  %69 = call i32 @_Z3dayii(i32 %67, i32 %68)
  ...
  %76 = call i32 @_Z3dayii(i32 %74, i32 %75)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_1006.cpp() #0 section ".text.startup" {
