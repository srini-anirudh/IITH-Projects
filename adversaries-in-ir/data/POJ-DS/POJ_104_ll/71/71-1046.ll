; ModuleID = 'POJ-104-source/71/71-1046.cpp'
source_filename = "POJ-104-source/71/71-1046.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_1046.cpp, i8* null }]
...
12:                                               ; preds = %8
  ...
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i64 0, i64 0), i32* %15, i32* %18, i32* %21)
  br label %23
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_1046.cpp() #0 section ".text.startup" {
