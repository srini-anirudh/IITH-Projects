; ModuleID = 'POJ-104-source/71/71-11.cpp'
source_filename = "POJ-104-source/71/71-11.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_11.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %15, i8* align 16 bitcast ([12 x i32]* @__const.main.m1 to i8*), i64 48, i1 false)
  %16 = bitcast [12 x i32]* %5 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %16, i8* align 16 bitcast ([12 x i32]* @__const.main.m2 to i8*), i64 48, i1 false)
...
21:                                               ; preds = %17
  store i32 0, i32* %10, align 4
  store i32 0, i32* %9, align 4
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i64 0, i64 0), i64* %6, i32* %11, i32* %13)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_11.cpp() #0 section ".text.startup" {
