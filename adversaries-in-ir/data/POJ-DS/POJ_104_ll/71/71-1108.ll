; ModuleID = 'POJ-104-source/71/71-1108.cpp'
source_filename = "POJ-104-source/71/71-1108.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_1108.cpp, i8* null }]
...
19:                                               ; preds = %15
  ...
  %29 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i64 0, i64 0), i32* %22, i32* %25, i32* %28)
  br label %30
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_1108.cpp() #0 section ".text.startup" {
