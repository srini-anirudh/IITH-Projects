; ModuleID = 'POJ-104-source/71/71-1112.cpp'
source_filename = "POJ-104-source/71/71-1112.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_1112.cpp, i8* null }]
...
define dso_local i32 @main(i32 %0, i8** %1) #4 {
  ...
  %26 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %6)
...
31:                                               ; preds = %27
  ...
  %41 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32* %34, i32* %37, i32* %40)
  br label %42
...
113:                                              ; preds = %106
  ...
  %117 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %116)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_1112.cpp() #0 section ".text.startup" {
