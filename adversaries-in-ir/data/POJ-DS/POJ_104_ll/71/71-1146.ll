; ModuleID = 'POJ-104-source/71/71-1146.cpp'
source_filename = "POJ-104-source/71/71-1146.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_1146.cpp, i8* null }]
...
33:                                               ; preds = %29
  ...
  %43 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32* %36, i32* %39, i32* %42)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_1146.cpp() #0 section ".text.startup" {
