; ModuleID = 'POJ-104-source/71/71-1184.cpp'
source_filename = "POJ-104-source/71/71-1184.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_1184.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %11, i8* align 16 bitcast ([2 x [12 x i32]]* @__const.main.y to i8*), i64 96, i1 false)
...
103:                                              ; preds = %93
  ...
  %106 = getelementptr inbounds [2 x [12 x i32]], [2 x [12 x i32]]* %2, i64 0, i64 %105
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_1184.cpp() #0 section ".text.startup" {
