; ModuleID = 'POJ-104-source/71/71-1210.cpp'
source_filename = "POJ-104-source/71/71-1210.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_1210.cpp, i8* null }]
...
define dso_local i32 @_Z10shirunniani(i32 %0) #4 {
...
17:                                               ; preds = %14
  store i32 0, i32* %10, align 4
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32* %6, i32* %7, i32* %8)
...
26:                                               ; preds = %22, %17
  ...
  %28 = call i32 @_Z10shirunniani(i32 %27)
  %29 = icmp eq i32 %28, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_1210.cpp() #0 section ".text.startup" {
