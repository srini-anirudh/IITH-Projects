; ModuleID = 'POJ-104-source/71/71-1240.cpp'
source_filename = "POJ-104-source/71/71-1240.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_1240.cpp, i8* null }]
...
32:                                               ; preds = %28
  ...
  %41 = call i32 @_Z8dijitianiii(i32 %36, i32 %40, i32 1)
  ...
  %50 = call i32 @_Z8dijitianiii(i32 %45, i32 %49, i32 1)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_1240.cpp() #0 section ".text.startup" {
