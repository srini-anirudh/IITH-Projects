; ModuleID = 'POJ-104-source/71/71-1251.cpp'
source_filename = "POJ-104-source/71/71-1251.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_1251.cpp, i8* null }]
...
24:                                               ; preds = %20
  ...
  %34 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32* %27, i32* %30, i32* %33)
  br label %35
...
69:                                               ; preds = %53, %43
  ...
  %78 = call i32 @_Z1fii(i32 %73, i32 %77)
  ...
  %87 = call i32 @_Z1fii(i32 %82, i32 %86)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_1251.cpp() #0 section ".text.startup" {
