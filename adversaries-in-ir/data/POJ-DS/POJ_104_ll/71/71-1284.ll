; ModuleID = 'POJ-104-source/71/71-1284.cpp'
source_filename = "POJ-104-source/71/71-1284.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_1284.cpp, i8* null }]
...
18:                                               ; preds = %14
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32* %2, i32* %3, i32* %5)
...
66:                                               ; preds = %63
  ...
  %68 = call i32 @_Z9isRunNiani(i32 %67)
  %69 = icmp ne i32 %68, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_1284.cpp() #0 section ".text.startup" {
