; ModuleID = 'POJ-104-source/71/71-1287.cpp'
source_filename = "POJ-104-source/71/71-1287.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_1287.cpp, i8* null }]
...
16:                                               ; preds = %12
  ...
  %40 = call i32 @_Z8DiJiTianiii(i32 %34, i32 %39, i32 1)
  ...
  %51 = call i32 @_Z8DiJiTianiii(i32 %45, i32 %50, i32 1)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_1287.cpp() #0 section ".text.startup" {
