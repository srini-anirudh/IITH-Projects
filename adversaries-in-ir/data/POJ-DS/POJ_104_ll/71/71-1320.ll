; ModuleID = 'POJ-104-source/71/71-1320.cpp'
source_filename = "POJ-104-source/71/71-1320.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_1320.cpp, i8* null }]
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z5checkiii(i32 %0, i32 %1, i32 %2) #4 {
...
35:                                               ; preds = %31
  ...
  %51 = call i32 @_Z5checkiii(i32 %40, i32 %45, i32 %50)
  %52 = icmp ne i32 %51, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_1320.cpp() #0 section ".text.startup" {
