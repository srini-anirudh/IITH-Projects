; ModuleID = 'POJ-104-source/71/71-1345.cpp'
source_filename = "POJ-104-source/71/71-1345.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_1345.cpp, i8* null }]
...
13:                                               ; preds = %9
  ...
  %23 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32* %16, i32* %19, i32* %22)
  br label %24
...
32:                                               ; preds = %28
  ...
  %41 = call i32 @_Z8DiJiTianii(i32 %36, i32 %40)
  ...
  %50 = call i32 @_Z8DiJiTianii(i32 %45, i32 %49)
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z8DiJiTianii(i32 %0, i32 %1) #0 {
  %3 = alloca i32, align 4
...
54:                                               ; preds = %51
  %55 = load i32, i32* %3, align 4
  %56 = call i32 @_Z9isRunNiani(i32 %55)
  %57 = icmp ne i32 %56, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_1345.cpp() #0 section ".text.startup" {
