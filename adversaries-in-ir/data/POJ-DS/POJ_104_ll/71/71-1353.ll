; ModuleID = 'POJ-104-source/71/71-1353.cpp'
source_filename = "POJ-104-source/71/71-1353.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_1353.cpp, i8* null }]
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z8daycountii(i32 %0, i32 %1) #4 {
  %3 = alloca i32, align 4
...
53:                                               ; preds = %50
  ...
  %55 = call i32 @_Z8leapyeari(i32 %54)
  %56 = icmp ne i32 %55, 0
...
31:                                               ; preds = %27
  ...
  %40 = call i32 @_Z8daycountii(i32 %35, i32 %39)
  ...
  %49 = call i32 @_Z8daycountii(i32 %44, i32 %48)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_1353.cpp() #0 section ".text.startup" {
