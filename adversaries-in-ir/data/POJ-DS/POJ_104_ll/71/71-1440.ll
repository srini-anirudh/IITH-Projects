; ModuleID = 'POJ-104-source/71/71-1440.cpp'
source_filename = "POJ-104-source/71/71-1440.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_1440.cpp, i8* null }]
...
define dso_local i32 @_Z3djtii(i32 %0, i32 %1) #4 {
...
31:                                               ; preds = %27
  ...
  %40 = call i32 @_Z3djtii(i32 %35, i32 %39)
  ...
  %49 = call i32 @_Z3djtii(i32 %44, i32 %48)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_1440.cpp() #0 section ".text.startup" {
