; ModuleID = 'POJ-104-source/71/71-1449.cpp'
source_filename = "POJ-104-source/71/71-1449.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_1449.cpp, i8* null }]
...
define dso_local i32 @_Z4daysii(i32 %0, i32 %1) #4 {
...
15:                                               ; preds = %11
  ...
  %34 = call i32 @_Z4daysii(i32 %29, i32 %33)
  ...
  %46 = call i32 @_Z4daysii(i32 %41, i32 %45)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_1449.cpp() #0 section ".text.startup" {
