; ModuleID = 'POJ-104-source/71/71-1463.cpp'
source_filename = "POJ-104-source/71/71-1463.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_1463.cpp, i8* null }]
...
define dso_local i32 @_Z3xgyiii(i32 %0, i32 %1, i32 %2) #4 {
...
12:                                               ; preds = %8
  ...
  %17 = call i32 @_Z3xgyiii(i32 %14, i32 %15, i32 %16)
  %18 = icmp ne i32 %17, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_1463.cpp() #0 section ".text.startup" {
