; ModuleID = 'POJ-104-source/71/71-1502.cpp'
source_filename = "POJ-104-source/71/71-1502.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_1502.cpp, i8* null }]
...
15:                                               ; preds = %11
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32* %5, i32* %6, i32* %7)
...
84:                                               ; preds = %83, %24
  ...
  %86 = call i32 @_Z7runniani(i32 %85)
  %87 = icmp eq i32 %86, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_1502.cpp() #0 section ".text.startup" {
