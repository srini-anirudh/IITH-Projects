; ModuleID = 'POJ-104-source/71/71-152.cpp'
source_filename = "POJ-104-source/71/71-152.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_152.cpp, i8* null }]
...
22:                                               ; preds = %18
  ...
  store i32 0, i32* %13, align 4
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32* %8, i32* %9, i32* %10)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_152.cpp() #0 section ".text.startup" {
