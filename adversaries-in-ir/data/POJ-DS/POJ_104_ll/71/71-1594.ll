; ModuleID = 'POJ-104-source/71/71-1594.cpp'
source_filename = "POJ-104-source/71/71-1594.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_1594.cpp, i8* null }]
...
57:                                               ; preds = %54
  ...
  %59 = call i32 @_Z9isRunNiani(i32 %58)
  %60 = icmp ne i32 %59, 0
...
41:                                               ; preds = %31
  ...
  %54 = call i32 @_Z8DiJiTianiii(i32 %45, i32 %49, i32 %53)
  %55 = icmp ne i32 %54, 0
...
61:                                               ; preds = %31
  ...
  %74 = call i32 @_Z8DiJiTianiii(i32 %65, i32 %69, i32 %73)
  %75 = icmp ne i32 %74, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_1594.cpp() #0 section ".text.startup" {
