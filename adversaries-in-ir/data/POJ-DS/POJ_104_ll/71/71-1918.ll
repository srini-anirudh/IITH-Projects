; ModuleID = 'POJ-104-source/71/71-1918.cpp'
source_filename = "POJ-104-source/71/71-1918.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_1918.cpp, i8* null }]
...
13:                                               ; preds = %9
  ...
  %32 = call i32 @_Z3djtii(i32 %27, i32 %31)
  ...
  %41 = call i32 @_Z3djtii(i32 %36, i32 %40)
...
define dso_local i32 @_Z3djtii(i32 %0, i32 %1) #5 {
  %3 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_1918.cpp() #0 section ".text.startup" {
