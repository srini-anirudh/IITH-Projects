; ModuleID = 'POJ-104-source/71/71-1922.cpp'
source_filename = "POJ-104-source/71/71-1922.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_1922.cpp, i8* null }]
...
define dso_local i32 @_Z6is_runi(i32 %0) #4 {
...
32:                                               ; preds = %27
  ...
  %35 = getelementptr inbounds [13 x i32], [13 x i32]* @_ZL1a, i64 0, i64 %34
...
123:                                              ; preds = %118
  ...
  %126 = getelementptr inbounds [13 x i32], [13 x i32]* @_ZL1b, i64 0, i64 %125
...
197:                                              ; preds = %167
  %198 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %7)
  store i32 1, i32* %4, align 4
  br label %199
...
203:                                              ; preds = %199
  %204 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32* %8, i32* %9, i32* %10)
  %205 = load i32, i32* %8, align 4
  %206 = call i32 @_Z6is_runi(i32 %205)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_1922.cpp() #0 section ".text.startup" {
