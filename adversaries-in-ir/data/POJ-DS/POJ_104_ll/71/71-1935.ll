; ModuleID = 'POJ-104-source/71/71-1935.cpp'
source_filename = "POJ-104-source/71/71-1935.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_1935.cpp, i8* null }]
...
17:                                               ; preds = %13
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32* %5, i32* %6, i32* %7)
  store i32 0, i32* %9, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_1935.cpp() #0 section ".text.startup" {
