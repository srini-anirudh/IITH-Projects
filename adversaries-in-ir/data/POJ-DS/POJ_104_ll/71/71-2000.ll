; ModuleID = 'POJ-104-source/71/71-2000.cpp'
source_filename = "POJ-104-source/71/71-2000.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_2000.cpp, i8* null }]
...
52:                                               ; preds = %18
  %53 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %5)
  store i32 0, i32* %2, align 4
  br label %54
...
58:                                               ; preds = %54
  %59 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32* %4, i32* %6, i32* %7)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_2000.cpp() #0 section ".text.startup" {
