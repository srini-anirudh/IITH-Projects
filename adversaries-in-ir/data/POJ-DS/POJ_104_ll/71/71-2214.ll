; ModuleID = 'POJ-104-source/71/71-2214.cpp'
source_filename = "POJ-104-source/71/71-2214.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_2214.cpp, i8* null }]
...
19:                                               ; preds = %15
  ...
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32* %6, i32* %7, i32* %8)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_2214.cpp() #0 section ".text.startup" {
