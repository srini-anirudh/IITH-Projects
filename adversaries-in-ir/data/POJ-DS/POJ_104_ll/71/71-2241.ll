; ModuleID = 'POJ-104-source/71/71-2241.cpp'
source_filename = "POJ-104-source/71/71-2241.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_2241.cpp, i8* null }]
...
13:                                               ; preds = %9
  ...
  %35 = call i32 @_Z2DIii(i32 %29, i32 %34)
  ...
  %45 = call i32 @_Z2DIii(i32 %39, i32 %44)
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z2DIii(i32 %0, i32 %1) #0 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_2241.cpp() #0 section ".text.startup" {
