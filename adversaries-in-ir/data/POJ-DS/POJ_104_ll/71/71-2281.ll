; ModuleID = 'POJ-104-source/71/71-2281.cpp'
source_filename = "POJ-104-source/71/71-2281.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_2281.cpp, i8* null }]
...
define dso_local i32 @_Z1fiii(i32 %0, i32 %1, i32 %2) #4 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %11, i8* align 16 bitcast ([13 x i32]* @__const._Z1fiii.a to i8*), i64 52, i1 false)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_2281.cpp() #0 section ".text.startup" {
