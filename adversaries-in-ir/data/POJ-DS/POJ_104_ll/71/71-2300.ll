; ModuleID = 'POJ-104-source/71/71-2300.cpp'
source_filename = "POJ-104-source/71/71-2300.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_2300.cpp, i8* null }]
...
21:                                               ; preds = %17
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32* %10, i32* %11, i32* %12)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_2300.cpp() #0 section ".text.startup" {
