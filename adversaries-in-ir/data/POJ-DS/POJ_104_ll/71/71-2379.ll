; ModuleID = 'POJ-104-source/71/71-2379.cpp'
source_filename = "POJ-104-source/71/71-2379.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_2379.cpp, i8* null }]
...
173:                                              ; preds = %150, %127, %106, %87, %70, %55, %42, %31, %22, %15, %10, %6
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_2379.cpp() #0 section ".text.startup" {
