; ModuleID = 'POJ-104-source/71/71-2399.cpp'
source_filename = "POJ-104-source/71/71-2399.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_2399.cpp, i8* null }]
...
16:                                               ; preds = %12
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32* %8, i32* %9, i32* %10)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_2399.cpp() #0 section ".text.startup" {
