; ModuleID = 'POJ-104-source/71/71-2408.cpp'
source_filename = "POJ-104-source/71/71-2408.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_2408.cpp, i8* null }]
...
define dso_local i32 @_Z3dayii(i32 %0, i32 %1) #4 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %8, i8* align 16 bitcast ([12 x i32]* @__const._Z3dayii.mon to i8*), i64 48, i1 false)
...
15:                                               ; preds = %11
  ...
  %22 = call i32 @_Z3dayii(i32 %20, i32 %21)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_2408.cpp() #0 section ".text.startup" {
