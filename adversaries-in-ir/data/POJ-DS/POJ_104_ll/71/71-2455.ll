; ModuleID = 'POJ-104-source/71/71-2455.cpp'
source_filename = "POJ-104-source/71/71-2455.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_2455.cpp, i8* null }]
...
17:                                               ; preds = %13
  ...
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32* %7, i32* %8, i32* %9)
...
60:                                               ; preds = %73, %56
  ...
  %64 = call i32 @_Z3maxii(i32 %62, i32 %63)
...
92:                                               ; preds = %86
  ...
  %95 = call i32 @_Z3minii(i32 %93, i32 %94)
...
96:                                               ; preds = %109, %92
  ...
  %100 = call i32 @_Z3maxii(i32 %98, i32 %99)
...
124:                                              ; preds = %120
  ...
  %127 = call i32 @_Z3minii(i32 %125, i32 %126)
...
128:                                              ; preds = %141, %124
  ...
  %132 = call i32 @_Z3maxii(i32 %130, i32 %131)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_2455.cpp() #0 section ".text.startup" {
