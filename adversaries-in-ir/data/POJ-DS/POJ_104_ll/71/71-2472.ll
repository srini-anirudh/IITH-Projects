; ModuleID = 'POJ-104-source/71/71-2472.cpp'
source_filename = "POJ-104-source/71/71-2472.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_2472.cpp, i8* null }]
...
31:                                               ; preds = %27
  ...
  %40 = call i32 @_Z8dijitianiii(i32 %35, i32 %39, i32 1)
  ...
  %49 = call i32 @_Z8dijitianiii(i32 %44, i32 %48, i32 1)
...
define dso_local i32 @_Z3runi(i32 %0) #5 {
  %2 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_2472.cpp() #0 section ".text.startup" {
