; ModuleID = 'POJ-104-source/71/71-25.cpp'
source_filename = "POJ-104-source/71/71-25.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_25.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %12 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* %4)
...
17:                                               ; preds = %13
  ...
  %30 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i64 0, i64 0), i32* %21, i32* %25, i32* %29)
  br label %31
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_25.cpp() #0 section ".text.startup" {
