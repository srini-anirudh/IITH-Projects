; ModuleID = 'POJ-104-source/71/71-2551.cpp'
source_filename = "POJ-104-source/71/71-2551.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_2551.cpp, i8* null }]
...
define dso_local i32 @_Z3dayii(i32 %0, i32 %1) #5 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %8, i8* align 16 bitcast ([13 x i32]* @__const._Z3dayii.days to i8*), i64 52, i1 false)
  %9 = load i32, i32* %3, align 4
  %10 = srem i32 %9, 4
  %11 = icmp eq i32 %10, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_2551.cpp() #0 section ".text.startup" {
