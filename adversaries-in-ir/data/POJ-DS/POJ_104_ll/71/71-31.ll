; ModuleID = 'POJ-104-source/71/71-31.cpp'
source_filename = "POJ-104-source/71/71-31.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_31.cpp, i8* null }]
...
20:                                               ; preds = %16
  %21 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32* %2, i32* %3, i32* %5)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_31.cpp() #0 section ".text.startup" {
