; ModuleID = 'POJ-104-source/71/71-310.cpp'
source_filename = "POJ-104-source/71/71-310.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_310.cpp, i8* null }]
...
26:                                               ; preds = %22
  ...
  %30 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32* %27, i32* %28, i32* %29)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_310.cpp() #0 section ".text.startup" {
