; ModuleID = 'POJ-104-source/71/71-45.cpp'
source_filename = "POJ-104-source/71/71-45.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_45.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %14, i8* align 16 bitcast ([13 x i32]* @__const.main.ping to i8*), i64 52, i1 false)
  %15 = bitcast [13 x i32]* %13 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %15, i8* align 16 bitcast ([13 x i32]* @__const.main.leap to i8*), i64 52, i1 false)
...
150:                                              ; preds = %143
  ...
  %153 = getelementptr inbounds [13 x i32], [13 x i32]* %13, i64 0, i64 %152
...
185:                                              ; preds = %178
  %186 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0))
  br label %189
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_45.cpp() #0 section ".text.startup" {
