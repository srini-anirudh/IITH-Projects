; ModuleID = 'POJ-104-source/71/71-508.cpp'
source_filename = "POJ-104-source/71/71-508.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_508.cpp, i8* null }]
...
31:                                               ; preds = %25, %21
  %32 = getelementptr inbounds [13 x i32], [13 x i32]* %9, i64 0, i64 2
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_508.cpp() #0 section ".text.startup" {
