; ModuleID = 'POJ-104-source/71/71-515.cpp'
source_filename = "POJ-104-source/71/71-515.cpp"
...
@__const._Z1fiii.a = private unnamed_addr constant [13 x i32] [i32 1, i32 32, i32 60, i32 91, i32 121, i32 152, i32 182, i32 213, i32 244, i32 274, i32 305, i32 335, i32 0], align 16
@.str.2 = private unnamed_addr constant [5 x i8] c"YES\0A\00", align 1
@.str.3 = private unnamed_addr constant [4 x i8] c"NO\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_515.cpp, i8* null }]
...
73:                                               ; preds = %70, %63, %48
  ...
  %85 = call i32 @_Z1fiii(i32 %74, i32 %79, i32 %84)
  store i32 0, i32* %3, align 4
  br label %86
...
define dso_local i32 @_Z1fiii(i32 %0, i32 %1, i32 %2) #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %8, i8* align 16 bitcast ([13 x i32]* @__const._Z1fiii.a to i8*), i64 52, i1 false)
  %9 = load i32, i32* %5, align 4
  %10 = sub nsw i32 %9, 1
  %11 = sext i32 %10 to i64
  %12 = getelementptr inbounds [13 x i32], [13 x i32]* %7, i64 0, i64 %11
  %13 = load i32, i32* %12, align 4
  %14 = load i32, i32* %6, align 4
  %15 = sub nsw i32 %14, 1
  %16 = sext i32 %15 to i64
  %17 = getelementptr inbounds [13 x i32], [13 x i32]* %7, i64 0, i64 %16
  %18 = load i32, i32* %17, align 4
  %19 = sub nsw i32 %13, %18
  %20 = call i32 @abs(i32 %19) #8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_515.cpp() #0 section ".text.startup" {
