; ModuleID = 'POJ-104-source/71/71-531.cpp'
source_filename = "POJ-104-source/71/71-531.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_531.cpp, i8* null }]
...
83:                                               ; preds = %76, %62
  %84 = getelementptr inbounds [13 x i32], [13 x i32]* %8, i64 0, i64 1
...
110:                                              ; preds = %92
  %111 = getelementptr inbounds [13 x i32], [13 x i32]* %8, i64 0, i64 1
  %112 = load i32, i32* %111, align 4
  %113 = sub nsw i32 %112, 1
  %114 = getelementptr inbounds [13 x i32], [13 x i32]* %8, i64 0, i64 1
...
152:                                              ; preds = %146
  %153 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0))
  br label %154
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_531.cpp() #0 section ".text.startup" {
