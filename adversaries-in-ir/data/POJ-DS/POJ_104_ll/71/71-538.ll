; ModuleID = 'POJ-104-source/71/71-538.cpp'
source_filename = "POJ-104-source/71/71-538.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_538.cpp, i8* null }]
...
18:                                               ; preds = %14
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32* %8, i32* %3, i32* %4)
...
define dso_local i32 @_Z4yeari(i32 %0) #6 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_538.cpp() #0 section ".text.startup" {
