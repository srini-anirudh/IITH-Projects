; ModuleID = 'POJ-104-source/71/71-556.cpp'
source_filename = "POJ-104-source/71/71-556.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_556.cpp, i8* null }]
...
define dso_local i32 @_Z9checkyeari(i32 %0) #4 {
...
15:                                               ; preds = %11
  ...
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32* %18, i32* %21, i32* %24)
  br label %26
...
34:                                               ; preds = %30
  ...
  %39 = call i32 @_Z9checkyeari(i32 %38)
  %40 = icmp ne i32 %39, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_556.cpp() #0 section ".text.startup" {
