; ModuleID = 'POJ-104-source/71/71-68.cpp'
source_filename = "POJ-104-source/71/71-68.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_68.cpp, i8* null }]
...
define dso_local i32 @_Z5DATE0i(i32 %0) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z5DATE1i(i32 %0) #4 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  store i32 %0, i32* %2, align 4
  %4 = load i32, i32* %2, align 4
...
122:                                              ; preds = %79
  ...
  %127 = call i32 @_Z5DATE1i(i32 %126)
  ...
  %135 = call i32 @_Z5DATE1i(i32 %134)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_68.cpp() #0 section ".text.startup" {
