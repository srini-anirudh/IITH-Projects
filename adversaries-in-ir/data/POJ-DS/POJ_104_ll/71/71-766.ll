; ModuleID = 'POJ-104-source/71/71-766.cpp'
source_filename = "POJ-104-source/71/71-766.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_766.cpp, i8* null }]
...
define dso_local i32 @_Z3reni(i32 %0) #4 {
...
36:                                               ; preds = %32
  ...
  %47 = call i32 @_Z8dijitianiii(i32 %41, i32 %46, i32 1)
  ...
  %58 = call i32 @_Z8dijitianiii(i32 %52, i32 %57, i32 1)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_766.cpp() #0 section ".text.startup" {
