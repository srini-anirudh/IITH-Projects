; ModuleID = 'POJ-104-source/71/71-773.cpp'
source_filename = "POJ-104-source/71/71-773.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_773.cpp, i8* null }]
...
12:                                               ; preds = %8
  %13 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32* %2, i32* %3, i32* %4)
  %14 = load i32, i32* %2, align 4
  %15 = load i32, i32* %3, align 4
  %16 = load i32, i32* %4, align 4
  call void @_Z1fiii(i32 %14, i32 %15, i32 %16)
  br label %17
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_773.cpp() #0 section ".text.startup" {
