; ModuleID = 'POJ-104-source/71/71-84.cpp'
source_filename = "POJ-104-source/71/71-84.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_84.cpp, i8* null }]
...
17:                                               ; preds = %13
  ...
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32* %4, i32* %5, i32* %6)
...
38:                                               ; preds = %34, %30
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %39, i8* align 16 bitcast ([13 x i32]* @__const.main.mon to i8*), i64 52, i1 false)
...
77:                                               ; preds = %73, %65
  %78 = bitcast [13 x i32]* %11 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %78, i8* align 16 bitcast ([13 x i32]* @__const.main.mon.4 to i8*), i64 52, i1 false)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_84.cpp() #0 section ".text.startup" {
