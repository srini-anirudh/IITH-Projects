; ModuleID = 'POJ-104-source/71/71-872.cpp'
source_filename = "POJ-104-source/71/71-872.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_872.cpp, i8* null }]
...
116:                                              ; preds = %114, %112
  %117 = getelementptr inbounds [13 x i32], [13 x i32]* %2, i64 0, i64 2
  store i32 28, i32* %117, align 8
  br label %118
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_872.cpp() #0 section ".text.startup" {
