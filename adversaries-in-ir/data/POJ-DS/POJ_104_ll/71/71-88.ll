; ModuleID = 'POJ-104-source/71/71-88.cpp'
source_filename = "POJ-104-source/71/71-88.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_88.cpp, i8* null }]
...
65:                                               ; preds = %58, %44
  ...
  %74 = call i32 @_Z3minii(i32 %69, i32 %73)
...
75:                                               ; preds = %122, %65
  ...
  %85 = call i32 @_Z3maxii(i32 %80, i32 %84)
...
145:                                              ; preds = %192, %135
  ...
  %155 = call i32 @_Z3maxii(i32 %150, i32 %154)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_88.cpp() #0 section ".text.startup" {
