; ModuleID = 'POJ-104-source/71/71-91.cpp'
source_filename = "POJ-104-source/71/71-91.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_71_91.cpp, i8* null }]
...
48:                                               ; preds = %46, %43
  ...
  call void @_Z5judgeiii(i32 %53, i32 %58, i32 %63)
  br label %64
...
21:                                               ; preds = %17, %13
  ...
  %25 = call i32 @_Z1ri(i32 %24)
  store i32 %25, i32* %8, align 4
  br label %31

26:                                               ; preds = %17
  %27 = load i32, i32* %5, align 4
  %28 = call i32 @_Z1pi(i32 %27)
...
define dso_local i32 @_Z1ri(i32 %0) #5 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  store i32 %0, i32* %2, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z1pi(i32 %0) #5 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  store i32 %0, i32* %2, align 4
  %4 = load i32, i32* %2, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_71_91.cpp() #0 section ".text.startup" {
