; ModuleID = 'POJ-104-source/72/72-114.cpp'
source_filename = "POJ-104-source/72/72-114.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_72_114.cpp, i8* null }]
...
146:                                              ; preds = %142, %137, %120
  br label %147

147:                                              ; preds = %146, %112, %95
  br label %148
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_72_114.cpp() #0 section ".text.startup" {
