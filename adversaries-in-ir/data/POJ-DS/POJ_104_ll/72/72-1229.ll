; ModuleID = 'POJ-104-source/72/72-1229.cpp'
source_filename = "POJ-104-source/72/72-1229.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_72_1229.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @_Z2srPA20_i([20 x i32]* %6)
...
16:                                               ; preds = %12
  ...
  %20 = call i32 @_Z2sdiiPA20_i(i32 %17, i32 %18, [20 x i32]* %19)
  %21 = icmp eq i32 %20, 0
...
; Function Attrs: noinline uwtable
define dso_local void @_Z2srPA20_i([20 x i32]* %0) #0 {
...
define dso_local i32 @_Z2sdiiPA20_i(i32 %0, i32 %1, [20 x i32]* %2) #5 {
  %4 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_72_1229.cpp() #0 section ".text.startup" {
