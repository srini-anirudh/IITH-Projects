; ModuleID = 'POJ-104-source/72/72-1231.cpp'
source_filename = "POJ-104-source/72/72-1231.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_72_1231.cpp, i8* null }]
...
44:                                               ; preds = %40
  ...
  %48 = call i32 @_Z3comPA100_iii([100 x i32]* %45, i32 %46, i32 %47)
...
define dso_local i32 @_Z3comPA100_iii([100 x i32]* %0, i32 %1, i32 %2) #6 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_72_1231.cpp() #0 section ".text.startup" {
