; ModuleID = 'POJ-104-source/72/72-1463.cpp'
source_filename = "POJ-104-source/72/72-1463.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_72_1463.cpp, i8* null }]
...
define dso_local i32 @_Z3duePA22_iii([22 x i32]* %0, i32 %1, i32 %2) #4 {
...
define dso_local i32 @main() #5 {
  ...
  %7 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %5, i32* %4)
...
104:                                              ; preds = %100
  ...
  %108 = call i32 @_Z3duePA22_iii([22 x i32]* %105, i32 %106, i32 %107)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_72_1463.cpp() #0 section ".text.startup" {
