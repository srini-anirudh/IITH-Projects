; ModuleID = 'POJ-104-source/72/72-1478.cpp'
source_filename = "POJ-104-source/72/72-1478.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_72_1478.cpp, i8* null }]
...
88:                                               ; preds = %83
  ...
  %128 = call signext i8 @_Z4compiiiii(i32 %95, i32 %103, i32 %111, i32 %119, i32 %127)
...
define dso_local signext i8 @_Z4compiiiii(i32 %0, i32 %1, i32 %2, i32 %3, i32 %4) #5 {
  %6 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_72_1478.cpp() #0 section ".text.startup" {
