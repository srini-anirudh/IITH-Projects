; ModuleID = 'POJ-104-source/72/72-1534.cpp'
source_filename = "POJ-104-source/72/72-1534.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_72_1534.cpp, i8* null }]
...
63:                                               ; preds = %59
  ...
  %70 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %69)
  br label %71
...
88:                                               ; preds = %84
  ...
  %91 = getelementptr inbounds [21 x [21 x i32]], [21 x [21 x i32]]* @a, i64 0, i64 %90
  ...
  %98 = getelementptr inbounds [21 x [21 x i32]], [21 x [21 x i32]]* @a, i64 0, i64 %97
...
105:                                              ; preds = %88
  ...
  %108 = getelementptr inbounds [21 x [21 x i32]], [21 x [21 x i32]]* @a, i64 0, i64 %107
  ...
  %115 = getelementptr inbounds [21 x [21 x i32]], [21 x [21 x i32]]* @a, i64 0, i64 %114
...
122:                                              ; preds = %105
  ...
  %125 = getelementptr inbounds [21 x [21 x i32]], [21 x [21 x i32]]* @a, i64 0, i64 %124
  ...
  %133 = getelementptr inbounds [21 x [21 x i32]], [21 x [21 x i32]]* @a, i64 0, i64 %132
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_72_1534.cpp() #0 section ".text.startup" {
