; ModuleID = 'POJ-104-source/72/72-1581.cpp'
source_filename = "POJ-104-source/72/72-1581.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_72_1581.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %7 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* @m, i32* @n)
...
251:                                              ; preds = %241, %229, %224
  ...
  %263 = fcmp olt double %262, 0x3EB0C6F7A0B5ED8D
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_72_1581.cpp() #0 section ".text.startup" {
