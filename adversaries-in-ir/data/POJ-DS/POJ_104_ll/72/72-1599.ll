; ModuleID = 'POJ-104-source/72/72-1599.cpp'
source_filename = "POJ-104-source/72/72-1599.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_72_1599.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %10 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %6, i32* %7)
...
48:                                               ; preds = %43
  %49 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %5)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_72_1599.cpp() #0 section ".text.startup" {
