; ModuleID = 'POJ-104-source/72/72-1755.cpp'
source_filename = "POJ-104-source/72/72-1755.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_72_1755.cpp, i8* null }]
...
194:                                              ; preds = %89
  ...
  call void @_Z4sortPii(i32* %195, i32 %196)
  store i32 0, i32* %7, align 4
  br label %197
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_72_1755.cpp() #0 section ".text.startup" {
