; ModuleID = 'POJ-104-source/72/72-1760.cpp'
source_filename = "POJ-104-source/72/72-1760.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_72_1760.cpp, i8* null }]
...
50:                                               ; preds = %45
  ...
  %57 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i32* %56)
  br label %58
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_72_1760.cpp() #0 section ".text.startup" {
