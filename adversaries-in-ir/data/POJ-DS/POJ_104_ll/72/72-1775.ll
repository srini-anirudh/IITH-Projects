; ModuleID = 'POJ-104-source/72/72-1775.cpp'
source_filename = "POJ-104-source/72/72-1775.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_72_1775.cpp, i8* null }]
...
346:                                              ; preds = %329
  ...
  %349 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0), i32 %347, i32 %348)
  br label %350

350:                                              ; preds = %346, %329, %312, %295
  br label %548
...
541:                                              ; preds = %524
  ...
  %544 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0), i32 %542, i32 %543)
  br label %545

545:                                              ; preds = %541, %524, %507, %490, %473
  br label %546
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_72_1775.cpp() #0 section ".text.startup" {
