; ModuleID = 'POJ-104-source/72/72-1786.cpp'
source_filename = "POJ-104-source/72/72-1786.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_72_1786.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z3topiiiiPA20_i(i32 %0, i32 %1, i32 %2, i32 %3, [20 x i32]* %4) #0 {
...
define dso_local i32 @main() #4 {
  ...
  %7 = bitcast [20 x [20 x i32]]* %6 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 16 %7, i8 0, i64 1600, i1 false)
  %8 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %2, i32* %3)
...
18:                                               ; preds = %14
  ...
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i32* %24)
  br label %26
...
43:                                               ; preds = %39
  ...
  call void @_Z3topiiiiPA20_i(i32 %44, i32 %45, i32 %46, i32 %47, [20 x i32]* %48)
  br label %49
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_72_1786.cpp() #0 section ".text.startup" {
