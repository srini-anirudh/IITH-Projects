; ModuleID = 'POJ-104-source/72/72-1929.cpp'
source_filename = "POJ-104-source/72/72-1929.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_72_1929.cpp, i8* null }]
...
130:                                              ; preds = %125
  ...
  %175 = call i32 @_Z7panduaniiiii(i32 %139, i32 %148, i32 %157, i32 %166, i32 %174)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_72_1929.cpp() #0 section ".text.startup" {
