; ModuleID = 'POJ-104-source/72/72-2167.cpp'
source_filename = "POJ-104-source/72/72-2167.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_72_2167.cpp, i8* null }]
...
define dso_local void @_Z4scanv() #0 {
  ...
  %5 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* @n, i32* @m)
  store i32 0, i32* %1, align 4
  br label %6
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_72_2167.cpp() #0 section ".text.startup" {
