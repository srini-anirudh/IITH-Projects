; ModuleID = 'POJ-104-source/72/72-2178.cpp'
source_filename = "POJ-104-source/72/72-2178.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_72_2178.cpp, i8* null }]
...
128:                                              ; preds = %111, %106
  ...
  %138 = getelementptr inbounds [2 x i32], [2 x i32]* %137, i64 0, i64 2
...
154:                                              ; preds = %150
  ...
  %165 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0), i32 %159, i32 %164)
  br label %166
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_72_2178.cpp() #0 section ".text.startup" {
