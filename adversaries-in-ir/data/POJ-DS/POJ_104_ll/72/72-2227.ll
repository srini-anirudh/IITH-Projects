; ModuleID = 'POJ-104-source/72/72-2227.cpp'
source_filename = "POJ-104-source/72/72-2227.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_72_2227.cpp, i8* null }]
...
38:                                               ; preds = %13
  %39 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %7, i32* %8)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_72_2227.cpp() #0 section ".text.startup" {
