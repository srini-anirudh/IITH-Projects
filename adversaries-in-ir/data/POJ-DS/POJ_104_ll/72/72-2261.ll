; ModuleID = 'POJ-104-source/72/72-2261.cpp'
source_filename = "POJ-104-source/72/72-2261.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_72_2261.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %7 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %3, i32* %2)
...
190:                                              ; preds = %173
  ...
  %193 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0), i32 %191, i32 %192)
  br label %560

194:                                              ; preds = %173, %156, %139, %134, %131
  br label %195
...
281:                                              ; preds = %264
  ...
  %284 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0), i32 %282, i32 %283)
  br label %560
...
361:                                              ; preds = %358
  ...
  %364 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %6, i64 0, i64 %363
...
378:                                              ; preds = %361
  ...
  %389 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %6, i64 0, i64 %388
...
416:                                              ; preds = %395, %378, %361
  br label %417

417:                                              ; preds = %416, %358, %353, %350
...
430:                                              ; preds = %425
  ...
  %433 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %6, i64 0, i64 %432
  ...
  %441 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %6, i64 0, i64 %440
...
464:                                              ; preds = %447
  ...
  %467 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %6, i64 0, i64 %466
...
481:                                              ; preds = %464
  ...
  %484 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0), i32 %482, i32 %483)
  br label %560

485:                                              ; preds = %464, %447, %430
  br label %559

486:                                              ; preds = %425, %420, %417
...
503:                                              ; preds = %486
  ...
  %506 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %6, i64 0, i64 %505
...
537:                                              ; preds = %520
  ...
  %547 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %6, i64 0, i64 %546
...
558:                                              ; preds = %537, %520, %503, %486
  br label %559

559:                                              ; preds = %558, %485
  br label %560

560:                                              ; preds = %559, %554, %481, %412, %345, %281, %237, %190, %126, %82
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_72_2261.cpp() #0 section ".text.startup" {
