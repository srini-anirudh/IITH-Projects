; ModuleID = 'POJ-104-source/72/72-228.cpp'
source_filename = "POJ-104-source/72/72-228.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_72_228.cpp, i8* null }]
...
129:                                              ; preds = %35
  %130 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* @_ZSt3cin, i32* dereferenceable(4) %5)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_72_228.cpp() #0 section ".text.startup" {
