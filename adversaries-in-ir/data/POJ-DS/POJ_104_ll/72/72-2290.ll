; ModuleID = 'POJ-104-source/72/72-2290.cpp'
source_filename = "POJ-104-source/72/72-2290.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_72_2290.cpp, i8* null }]
...
56:                                               ; preds = %41
  ...
  %63 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i32* %62)
  br label %64
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_72_2290.cpp() #0 section ".text.startup" {
