; ModuleID = 'POJ-104-source/72/72-2533.cpp'
source_filename = "POJ-104-source/72/72-2533.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_72_2533.cpp, i8* null }]
...
define dso_local i32 @_Z4compiiiii(i32 %0, i32 %1, i32 %2, i32 %3, i32 %4) #4 {
...
88:                                               ; preds = %83
  ...
  %128 = call i32 @_Z4compiiiii(i32 %95, i32 %103, i32 %111, i32 %119, i32 %127)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_72_2533.cpp() #0 section ".text.startup" {
