; ModuleID = 'POJ-104-source/72/72-2673.cpp'
source_filename = "POJ-104-source/72/72-2673.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_72_2673.cpp, i8* null }]
...
define dso_local i32 @_Z8topjudgePA20_iiiii([20 x i32]* %0, i32 %1, i32 %2, i32 %3, i32 %4) #4 {
...
44:                                               ; preds = %40
  ...
  %50 = call i32 @_Z8topjudgePA20_iiiii([20 x i32]* %45, i32 %46, i32 %47, i32 %48, i32 %49)
  %51 = icmp eq i32 %50, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_72_2673.cpp() #0 section ".text.startup" {
