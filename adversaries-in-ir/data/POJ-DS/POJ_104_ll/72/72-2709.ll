; ModuleID = 'POJ-104-source/72/72-2709.cpp'
source_filename = "POJ-104-source/72/72-2709.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_72_2709.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %13 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %7, i32* %8)
...
35:                                               ; preds = %19
  %36 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0))
  br label %37
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_72_2709.cpp() #0 section ".text.startup" {
