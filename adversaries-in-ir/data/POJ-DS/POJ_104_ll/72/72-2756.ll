; ModuleID = 'POJ-104-source/72/72-2756.cpp'
source_filename = "POJ-104-source/72/72-2756.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_72_2756.cpp, i8* null }]
...
90:                                               ; preds = %85
  ...
  %130 = call i32 @_Z4compiiiii(i32 %97, i32 %105, i32 %113, i32 %121, i32 %129)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_72_2756.cpp() #0 section ".text.startup" {
