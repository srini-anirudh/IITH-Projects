; ModuleID = 'POJ-104-source/72/72-2798.cpp'
source_filename = "POJ-104-source/72/72-2798.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_72_2798.cpp, i8* null }]
...
470:                                              ; preds = %450
  ...
  %475 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32 %472, i32 %474)
  br label %476
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_72_2798.cpp() #0 section ".text.startup" {
