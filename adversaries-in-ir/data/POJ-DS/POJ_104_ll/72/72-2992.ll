; ModuleID = 'POJ-104-source/72/72-2992.cpp'
source_filename = "POJ-104-source/72/72-2992.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_72_2992.cpp, i8* null }]
...
define dso_local i32 @_Z4sortii(i32 %0, i32 %1) #4 {
...
41:                                               ; preds = %37
  ...
  %44 = call i32 @_Z4sortii(i32 %42, i32 %43)
  %45 = icmp eq i32 %44, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_72_2992.cpp() #0 section ".text.startup" {
