; ModuleID = 'POJ-104-source/72/72-455.cpp'
source_filename = "POJ-104-source/72/72-455.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_72_455.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %10 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %9, i64 0, i64 0
...
116:                                              ; preds = %99
  ...
  %122 = getelementptr inbounds [20000 x i32], [20000 x i32]* %5, i64 0, i64 %121
...
140:                                              ; preds = %136
  ...
  %143 = getelementptr inbounds [20000 x i32], [20000 x i32]* %5, i64 0, i64 %142
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_72_455.cpp() #0 section ".text.startup" {
