; ModuleID = 'POJ-104-source/72/72-571.cpp'
source_filename = "POJ-104-source/72/72-571.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_72_571.cpp, i8* null }]
...
75:                                               ; preds = %70
  ...
  %83 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %82)
  br label %84
...
193:                                              ; preds = %92
  %194 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %3)
  store i32 0, i32* %1, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_72_571.cpp() #0 section ".text.startup" {
