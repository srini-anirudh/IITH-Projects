; ModuleID = 'POJ-104-source/72/72-84.cpp'
source_filename = "POJ-104-source/72/72-84.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_72_84.cpp, i8* null }]
...
define dso_local i32 @main(i32 %0, i8** %1) #4 {
  ...
  %11 = call noalias i8* @calloc(i64 22, i64 88) #3
  %12 = bitcast i8* %11 to [22 x i32]*
  store [22 x i32]* %12, [22 x i32]** %6, align 8
  %13 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %9, i32* %10)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_72_84.cpp() #0 section ".text.startup" {
