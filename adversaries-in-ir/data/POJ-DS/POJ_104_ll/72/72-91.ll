; ModuleID = 'POJ-104-source/72/72-91.cpp'
source_filename = "POJ-104-source/72/72-91.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_72_91.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5judgePA20_iii([20 x i32]* %0, i32 %1, i32 %2) #0 {
...
32:                                               ; preds = %8
  ...
  call void @_Z5judgePA20_iii([20 x i32]* %33, i32 %34, i32 %35)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_72_91.cpp() #0 section ".text.startup" {
