; ModuleID = 'POJ-104-source/73/73-1009.cpp'
source_filename = "POJ-104-source/73/73-1009.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_73_1009.cpp, i8* null }]
...
150:                                              ; preds = %136
  ...
  %156 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32 %152, i32 %154, i32 %155)
  store i32 1, i32* %6, align 4
  br label %157

157:                                              ; preds = %150, %136, %122, %108, %94, %86
  br label %158
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_73_1009.cpp() #0 section ".text.startup" {
