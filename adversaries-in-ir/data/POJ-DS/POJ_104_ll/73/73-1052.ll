; ModuleID = 'POJ-104-source/73/73-1052.cpp'
source_filename = "POJ-104-source/73/73-1052.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_73_1052.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %10 = getelementptr inbounds [5 x [5 x i32]], [5 x [5 x i32]]* %4, i64 0, i64 0
...
27:                                               ; preds = %24
  %28 = getelementptr inbounds [5 x [5 x i32]], [5 x [5 x i32]]* %4, i64 0, i64 0
  ...
  %37 = getelementptr inbounds [5 x [5 x i32]], [5 x [5 x i32]]* %4, i64 0, i64 0
...
116:                                              ; preds = %90
  %117 = getelementptr inbounds [5 x i32*], [5 x i32*]* %3, i64 0, i64 0
...
128:                                              ; preds = %116
  ...
  %143 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %136, i32 %142)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_73_1052.cpp() #0 section ".text.startup" {
