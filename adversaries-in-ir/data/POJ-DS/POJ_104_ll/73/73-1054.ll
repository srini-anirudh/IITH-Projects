; ModuleID = 'POJ-104-source/73/73-1054.cpp'
source_filename = "POJ-104-source/73/73-1054.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_73_1054.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %11 = getelementptr inbounds [5 x [5 x i32]], [5 x [5 x i32]]* %3, i64 0, i64 0
...
44:                                               ; preds = %41
  %45 = load [5 x i32]*, [5 x i32]** %2, align 8
...
75:                                               ; preds = %72
  %76 = load [5 x i32]*, [5 x i32]** %2, align 8
  ...
  %85 = load [5 x i32]*, [5 x i32]** %2, align 8
...
103:                                              ; preds = %100
  ...
  %112 = load [5 x i32]*, [5 x i32]** %2, align 8
  ...
  %121 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %111, i32 %120)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_73_1054.cpp() #0 section ".text.startup" {
