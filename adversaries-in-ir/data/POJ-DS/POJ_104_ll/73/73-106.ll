; ModuleID = 'POJ-104-source/73/73-106.cpp'
source_filename = "POJ-104-source/73/73-106.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_73_106.cpp, i8* null }]
...
define dso_local i32 @_Z7findminPi(i32* %0) #4 {
...
50:                                               ; preds = %47
  ...
  %55 = call i32 @_Z7findmaxPi(i32* %54)
  ...
  %63 = call i32 @_Z7findminPi(i32* %62)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_73_106.cpp() #0 section ".text.startup" {
