; ModuleID = 'POJ-104-source/73/73-1153.cpp'
source_filename = "POJ-104-source/73/73-1153.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_73_1153.cpp, i8* null }]
...
181:                                              ; preds = %171
  ...
  %192 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32 %186, i32 %187, i32 %191)
  br label %193
...
204:                                              ; preds = %201
  %205 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.2, i64 0, i64 0))
  br label %206
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_73_1153.cpp() #0 section ".text.startup" {
