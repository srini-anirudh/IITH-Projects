; ModuleID = 'POJ-104-source/73/73-1340.cpp'
source_filename = "POJ-104-source/73/73-1340.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_73_1340.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i64 0, i64 0), i32* %7, i32* %9, i32* %11, i32* %13, i32* %15)
  ...
  %27 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i64 0, i64 0), i32* %18, i32* %20, i32* %22, i32* %24, i32* %26)
  ...
  %38 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i64 0, i64 0), i32* %29, i32* %31, i32* %33, i32* %35, i32* %37)
  ...
  %49 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i64 0, i64 0), i32* %40, i32* %42, i32* %44, i32* %46, i32* %48)
  ...
  %60 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i64 0, i64 0), i32* %51, i32* %53, i32* %55, i32* %57, i32* %59)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_73_1340.cpp() #0 section ".text.startup" {
