; ModuleID = 'POJ-104-source/73/73-1381.cpp'
source_filename = "POJ-104-source/73/73-1381.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_73_1381.cpp, i8* null }]
...
13:                                               ; preds = %10
  ...
  %34 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str, i64 0, i64 0), i32* %17, i32* %21, i32* %25, i32* %29, i32* %33)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_73_1381.cpp() #0 section ".text.startup" {
