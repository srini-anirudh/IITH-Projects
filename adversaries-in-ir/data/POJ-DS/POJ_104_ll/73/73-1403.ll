; ModuleID = 'POJ-104-source/73/73-1403.cpp'
source_filename = "POJ-104-source/73/73-1403.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_73_1403.cpp, i8* null }]
...
101:                                              ; preds = %98
  ...
  %113 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32 %103, i32 %105, i32 %112)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_73_1403.cpp() #0 section ".text.startup" {
