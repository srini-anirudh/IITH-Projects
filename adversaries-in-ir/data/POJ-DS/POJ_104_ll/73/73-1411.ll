; ModuleID = 'POJ-104-source/73/73-1411.cpp'
source_filename = "POJ-104-source/73/73-1411.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_73_1411.cpp, i8* null }]
...
95:                                               ; preds = %92
  ...
  %99 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32 %96, i32 %97, i32 %98)
  %100 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32 1)
  store i32 0, i32* %1, align 4
  br label %108
...
105:                                              ; preds = %36
  ...
  %107 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32 1)
  store i32 0, i32* %1, align 4
  br label %108
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_73_1411.cpp() #0 section ".text.startup" {
