; ModuleID = 'POJ-104-source/73/73-1424.cpp'
source_filename = "POJ-104-source/73/73-1424.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_73_1424.cpp, i8* null }]
...
39:                                               ; preds = %29
  ...
  %46 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), double* %45)
  br label %47
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_73_1424.cpp() #0 section ".text.startup" {
