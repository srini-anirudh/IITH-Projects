; ModuleID = 'POJ-104-source/73/73-1564.cpp'
source_filename = "POJ-104-source/73/73-1564.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_73_1564.cpp, i8* null }]
...
109:                                              ; preds = %106
  %110 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i64 0, i64 0))
  br label %118
...
111:                                              ; preds = %106
  ...
  %117 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i64 0, i64 0), i32 %113, i32 %115, i32 %116)
  br label %118
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_73_1564.cpp() #0 section ".text.startup" {
