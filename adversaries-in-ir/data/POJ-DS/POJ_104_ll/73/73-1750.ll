; ModuleID = 'POJ-104-source/73/73-1750.cpp'
source_filename = "POJ-104-source/73/73-1750.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_73_1750.cpp, i8* null }]
...
define dso_local i32 @_Z7row_maxPA5_iii([5 x i32]* %0, i32 %1, i32 %2) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z7col_minPA5_iii([5 x i32]* %0, i32 %1, i32 %2) #4 {
  %4 = alloca [5 x i32]*, align 8
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
  %7 = alloca i32, align 4
...
38:                                               ; preds = %35
  ...
  %42 = call i32 @_Z7row_maxPA5_iii([5 x i32]* %39, i32 %40, i32 %41)
  %43 = icmp ne i32 %42, 0
...
44:                                               ; preds = %38
  ...
  %48 = call i32 @_Z7col_minPA5_iii([5 x i32]* %45, i32 %46, i32 %47)
  %49 = icmp ne i32 %48, 0
...
50:                                               ; preds = %44
  ...
  %64 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i64 0, i64 0), i32 %52, i32 %54, i32 %63)
  br label %65
...
76:                                               ; preds = %73
  %77 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.2, i64 0, i64 0))
  br label %78
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_73_1750.cpp() #0 section ".text.startup" {
