; ModuleID = 'POJ-104-source/73/73-1756.cpp'
source_filename = "POJ-104-source/73/73-1756.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_73_1756.cpp, i8* null }]
...
54:                                               ; preds = %37
  ...
  call void @_Z6bubblePii(i32* %55, i32 5)
  store i32 0, i32* %6, align 4
  br label %56
...
94:                                               ; preds = %77
  ...
  call void @_Z6bubblePii(i32* %95, i32 5)
  store i32 0, i32* %6, align 4
  br label %96
...
139:                                              ; preds = %137, %134
  ...
  %146 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %145)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_73_1756.cpp() #0 section ".text.startup" {
