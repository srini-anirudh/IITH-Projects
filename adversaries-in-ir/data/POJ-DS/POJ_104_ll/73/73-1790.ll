; ModuleID = 'POJ-104-source/73/73-1790.cpp'
source_filename = "POJ-104-source/73/73-1790.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_73_1790.cpp, i8* null }]
...
77:                                               ; preds = %74
  %78 = load [5 x i32]*, [5 x i32]** %8, align 8
  ...
  %87 = load [5 x i32]*, [5 x i32]** %8, align 8
...
107:                                              ; preds = %104
  ...
  %119 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32 %109, i32 %111, i32 %118)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_73_1790.cpp() #0 section ".text.startup" {
