; ModuleID = 'POJ-104-source/73/73-18.cpp'
source_filename = "POJ-104-source/73/73-18.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_73_18.cpp, i8* null }]
...
112:                                              ; preds = %109
  %113 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i64 0, i64 0))
  br label %133
...
114:                                              ; preds = %109
  ...
  %132 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i64 0, i64 0), i32 %116, i32 %121, i32 %131)
  br label %133
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_73_18.cpp() #0 section ".text.startup" {
