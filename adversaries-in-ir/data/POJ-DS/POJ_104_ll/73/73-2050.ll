; ModuleID = 'POJ-104-source/73/73-2050.cpp'
source_filename = "POJ-104-source/73/73-2050.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_73_2050.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @llvm.memset.p0i8.i64(i8* align 16 %10, i8 1, i64 24, i1 false)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_73_2050.cpp() #0 section ".text.startup" {
