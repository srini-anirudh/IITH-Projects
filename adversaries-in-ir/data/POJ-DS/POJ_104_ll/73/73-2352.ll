; ModuleID = 'POJ-104-source/73/73-2352.cpp'
source_filename = "POJ-104-source/73/73-2352.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_73_2352.cpp, i8* null }]
...
50:                                               ; preds = %47
  %51 = getelementptr inbounds [5 x [5 x i32]], [5 x [5 x i32]]* %5, i64 0, i64 0
...
134:                                              ; preds = %131
  ...
  %141 = getelementptr inbounds [5 x i32], [5 x i32]* %7, i64 0, i64 %140
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_73_2352.cpp() #0 section ".text.startup" {
