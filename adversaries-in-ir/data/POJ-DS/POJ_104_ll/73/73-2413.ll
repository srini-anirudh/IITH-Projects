; ModuleID = 'POJ-104-source/73/73-2413.cpp'
source_filename = "POJ-104-source/73/73-2413.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_73_2413.cpp, i8* null }]
...
88:                                               ; preds = %85
  ...
  %104 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %96, i32 %103)
...
127:                                              ; preds = %124
  %128 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i64 0, i64 0))
  br label %129
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_73_2413.cpp() #0 section ".text.startup" {
