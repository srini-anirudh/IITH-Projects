; ModuleID = 'POJ-104-source/73/73-2436.cpp'
source_filename = "POJ-104-source/73/73-2436.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_73_2436.cpp, i8* null }]
...
55:                                               ; preds = %52
  ...
  %67 = call i32 @_Z9max_valueii(i32 %62, i32 %66)
  ...
  %82 = call i32 @_Z11least_valueii(i32 %77, i32 %81)
...
define dso_local i32 @_Z9max_valueii(i32 %0, i32 %1) #6 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z11least_valueii(i32 %0, i32 %1) #6 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  store i32 %0, i32* %4, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_73_2436.cpp() #0 section ".text.startup" {
