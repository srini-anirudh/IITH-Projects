; ModuleID = 'POJ-104-source/73/73-254.cpp'
source_filename = "POJ-104-source/73/73-254.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_73_254.cpp, i8* null }]
...
26:                                               ; preds = %12
  %27 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0))
  br label %28
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_73_254.cpp() #0 section ".text.startup" {
