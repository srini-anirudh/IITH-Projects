; ModuleID = 'POJ-104-source/73/73-270.cpp'
source_filename = "POJ-104-source/73/73-270.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_73_270.cpp, i8* null }]
...
124:                                              ; preds = %121
  ...
  %134 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i64 0, i64 0), i32 %125, i32 %126, i32 %133)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_73_270.cpp() #0 section ".text.startup" {
