; ModuleID = 'POJ-104-source/73/73-276.cpp'
source_filename = "POJ-104-source/73/73-276.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_73_276.cpp, i8* null }]
...
define dso_local i32 @_Z7findmaxPi(i32* %0) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z4dminPA5_iii([5 x i32]* %0, i32 %1, i32 %2) #4 {
  %4 = alloca i32, align 4
...
33:                                               ; preds = %30
  ...
  %39 = call i32 @_Z7findmaxPi(i32* %38)
  %40 = load i32, i32* %2, align 4
  %41 = sext i32 %40 to i64
  %42 = getelementptr inbounds [5 x i32], [5 x i32]* %5, i64 0, i64 %41
  store i32 %39, i32* %42, align 4
  %43 = load i32, i32* %2, align 4
  %44 = call i32 @_Z4dminPA5_iii([5 x i32]* %34, i32 %39, i32 %43)
  %45 = icmp ne i32 %44, 0
...
46:                                               ; preds = %33
  ...
  %62 = getelementptr inbounds [5 x i32], [5 x i32]* %56, i64 0, i64 %61
  %63 = load i32, i32* %62, align 4
  %64 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32 %48, i32 %53, i32 %63)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_73_276.cpp() #0 section ".text.startup" {
