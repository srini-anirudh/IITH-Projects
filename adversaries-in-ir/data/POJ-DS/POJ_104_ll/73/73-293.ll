; ModuleID = 'POJ-104-source/73/73-293.cpp'
source_filename = "POJ-104-source/73/73-293.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_73_293.cpp, i8* null }]
...
41:                                               ; preds = %38
  ...
  %44 = getelementptr inbounds [6 x [6 x i32]], [6 x [6 x i32]]* %10, i64 0, i64 %43
...
68:                                               ; preds = %65
  ...
  %71 = getelementptr inbounds [6 x [6 x i32]], [6 x [6 x i32]]* %10, i64 0, i64 %70
...
86:                                               ; preds = %83
  ...
  %95 = getelementptr inbounds [6 x [6 x i32]], [6 x [6 x i32]]* %10, i64 0, i64 %94
...
118:                                              ; preds = %115
  %119 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i64 0, i64 0))
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_73_293.cpp() #0 section ".text.startup" {
