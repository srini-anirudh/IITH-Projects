; ModuleID = 'POJ-104-source/73/73-298.cpp'
source_filename = "POJ-104-source/73/73-298.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_73_298.cpp, i8* null }]
...
36:                                               ; preds = %14
  %37 = bitcast [6 x i32]* %5 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 16 %37, i8 0, i64 24, i1 false)
  %38 = bitcast [6 x i32]* %6 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 16 %38, i8 0, i64 24, i1 false)
  %39 = bitcast [6 x i32]* %7 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 16 %39, i8 0, i64 24, i1 false)
  %40 = bitcast [6 x i32]* %8 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %40, i8* align 16 bitcast ([6 x i32]* @__const.main.line_column to i8*), i64 24, i1 false)
...
44:                                               ; preds = %41
  %45 = getelementptr inbounds [6 x [6 x i32]], [6 x [6 x i32]]* %2, i64 0, i64 1
...
77:                                               ; preds = %64
  ...
  %87 = getelementptr inbounds [6 x i32], [6 x i32]* %5, i64 0, i64 %86
...
92:                                               ; preds = %77, %64
  ...
  %102 = getelementptr inbounds [6 x i32], [6 x i32]* %6, i64 0, i64 %101
...
105:                                              ; preds = %92
  ...
  %115 = getelementptr inbounds [6 x i32], [6 x i32]* %6, i64 0, i64 %114
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_73_298.cpp() #0 section ".text.startup" {
