; ModuleID = 'POJ-104-source/73/73-345.cpp'
source_filename = "POJ-104-source/73/73-345.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_73_345.cpp, i8* null }]
...
96:                                               ; preds = %93
  %97 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* %2, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_73_345.cpp() #0 section ".text.startup" {
