; ModuleID = 'POJ-104-source/73/73-461.cpp'
source_filename = "POJ-104-source/73/73-461.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_73_461.cpp, i8* null }]
...
67:                                               ; preds = %64
  %68 = getelementptr inbounds [6 x [6 x i32]], [6 x [6 x i32]]* %2, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_73_461.cpp() #0 section ".text.startup" {
