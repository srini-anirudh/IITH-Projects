; ModuleID = 'POJ-104-source/73/73-544.cpp'
source_filename = "POJ-104-source/73/73-544.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_73_544.cpp, i8* null }]
...
73:                                               ; preds = %70
  ...
  store i32 2147483647, i32* %76, align 4
  store i32 0, i32* %9, align 4
  br label %77
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_73_544.cpp() #0 section ".text.startup" {
