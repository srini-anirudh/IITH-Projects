; ModuleID = 'POJ-104-source/73/73-573.cpp'
source_filename = "POJ-104-source/73/73-573.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_73_573.cpp, i8* null }]
...
32:                                               ; preds = %29
  ...
  store i32 -2147483648, i32* %36, align 8
  store i32 1, i32* %4, align 4
  br label %37
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_73_573.cpp() #0 section ".text.startup" {
