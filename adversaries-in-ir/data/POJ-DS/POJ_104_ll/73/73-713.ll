; ModuleID = 'POJ-104-source/73/73-713.cpp'
source_filename = "POJ-104-source/73/73-713.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_73_713.cpp, i8* null }]
...
39:                                               ; preds = %36
  ...
  %42 = load i32, i32* %8, align 4
  %43 = call i32 @_Z5checkPA5_iii([5 x i32]* %40, i32 %41, i32 %42)
  %44 = icmp ne i32 %43, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_73_713.cpp() #0 section ".text.startup" {
