; ModuleID = 'POJ-104-source/73/73-739.cpp'
source_filename = "POJ-104-source/73/73-739.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_73_739.cpp, i8* null }]
...
10:                                               ; preds = %7
  %11 = load [5 x i32]*, [5 x i32]** %3, align 8
  %12 = load i32, i32* %4, align 4
  %13 = sext i32 %12 to i64
  %14 = getelementptr inbounds [5 x i32], [5 x i32]* %11, i64 %13
...
21:                                               ; preds = %10
  %22 = load [5 x i32]*, [5 x i32]** %3, align 8
...
37:                                               ; preds = %34
  %38 = load [5 x i32]*, [5 x i32]** %3, align 8
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z5judgePA5_iii([5 x i32]* %0, i32 %1, i32 %2) #4 {
  %4 = alloca i32, align 4
...
34:                                               ; preds = %31
  ...
  %37 = call i32 @_Z3maxPA5_ii([5 x i32]* %35, i32 %36)
  store i32 %37, i32* %4, align 4
  %38 = getelementptr inbounds [5 x [5 x i32]], [5 x [5 x i32]]* %2, i64 0, i64 0
  %39 = load i32, i32* %4, align 4
  %40 = load i32, i32* %7, align 4
  %41 = call i32 @_Z5judgePA5_iii([5 x i32]* %38, i32 %39, i32 %40)
  %42 = icmp ne i32 %41, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_73_739.cpp() #0 section ".text.startup" {
