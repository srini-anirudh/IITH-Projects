; ModuleID = 'POJ-104-source/73/73-757.cpp'
source_filename = "POJ-104-source/73/73-757.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_73_757.cpp, i8* null }]
...
38:                                               ; preds = %35
  ...
  %64 = call i32 @_Z3miniiiii(i32 %43, i32 %48, i32 %53, i32 %58, i32 %63)
...
75:                                               ; preds = %72
  ...
  %101 = call i32 @_Z3maxiiiii(i32 %80, i32 %85, i32 %90, i32 %95, i32 %100)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_73_757.cpp() #0 section ".text.startup" {
