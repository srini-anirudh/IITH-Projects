; ModuleID = 'POJ-104-source/73/73-784.cpp'
source_filename = "POJ-104-source/73/73-784.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_73_784.cpp, i8* null }]
...
91:                                               ; preds = %87
  ...
  %101 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32 %92, i32 %93, i32 %100)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_73_784.cpp() #0 section ".text.startup" {
