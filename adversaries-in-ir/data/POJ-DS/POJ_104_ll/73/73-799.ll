; ModuleID = 'POJ-104-source/73/73-799.cpp'
source_filename = "POJ-104-source/73/73-799.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_73_799.cpp, i8* null }]
...
160:                                              ; preds = %146
  ...
  %168 = getelementptr inbounds [5 x [5 x i32]], [5 x [5 x i32]]* %2, i64 0, i64 2
...
174:                                              ; preds = %160
  ...
  %186 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32 %176, i32 %178, i32 %185)
  %187 = load i32, i32* %5, align 4
  %188 = add nsw i32 %187, 1
  store i32 %188, i32* %5, align 4
  br label %189

189:                                              ; preds = %174, %160, %146, %132, %118, %104
  br label %190

190:                                              ; preds = %189, %90, %76, %62, %48, %34
  br label %191
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_73_799.cpp() #0 section ".text.startup" {
