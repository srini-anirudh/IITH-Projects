; ModuleID = 'POJ-104-source/73/73-872.cpp'
source_filename = "POJ-104-source/73/73-872.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_73_872.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str, i64 0, i64 0), i32* %8, i32* %10, i32* %12, i32* %14, i32* %16)
  ...
  %28 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str, i64 0, i64 0), i32* %19, i32* %21, i32* %23, i32* %25, i32* %27)
  ...
  %39 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str, i64 0, i64 0), i32* %30, i32* %32, i32* %34, i32* %36, i32* %38)
  ...
  %50 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str, i64 0, i64 0), i32* %41, i32* %43, i32* %45, i32* %47, i32* %49)
  ...
  %61 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str, i64 0, i64 0), i32* %52, i32* %54, i32* %56, i32* %58, i32* %60)
  br label %62
...
65:                                               ; preds = %62
  ...
  %91 = call i32 @_Z3maxiiiii(i32 %70, i32 %75, i32 %80, i32 %85, i32 %90)
...
95:                                               ; preds = %92
  ...
  %121 = call i32 @_Z3miniiiii(i32 %100, i32 %105, i32 %110, i32 %115, i32 %120)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_73_872.cpp() #0 section ".text.startup" {
