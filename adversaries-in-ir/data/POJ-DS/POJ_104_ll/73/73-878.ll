; ModuleID = 'POJ-104-source/73/73-878.cpp'
source_filename = "POJ-104-source/73/73-878.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_73_878.cpp, i8* null }]
...
130:                                              ; preds = %123
  ...
  %142 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i64 0, i64 0), i32 %132, i32 %134, i32 %141)
  store i32 0, i32* %9, align 4
  br label %143

143:                                              ; preds = %130, %123, %116
  br label %144
...
154:                                              ; preds = %151
  %155 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.2, i64 0, i64 0))
  br label %156
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_73_878.cpp() #0 section ".text.startup" {
