; ModuleID = 'POJ-104-source/73/73-920.cpp'
source_filename = "POJ-104-source/73/73-920.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_73_920.cpp, i8* null }]
...
11:                                               ; preds = %8
  ...
  %32 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i64 0, i64 0), i32* %15, i32* %19, i32* %23, i32* %27, i32* %31)
  br label %33
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_73_920.cpp() #0 section ".text.startup" {
