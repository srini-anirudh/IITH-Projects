; ModuleID = 'POJ-104-source/73/73-956.cpp'
source_filename = "POJ-104-source/73/73-956.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_73_956.cpp, i8* null }]
...
define dso_local i32 @_Z3maxPA5_ii([5 x i32]* %0, i32 %1) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z3minPA5_ii([5 x i32]* %0, i32 %1) #4 {
  %3 = alloca [5 x i32]*, align 8
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
35:                                               ; preds = %32
  ...
  %38 = call i32 @_Z3maxPA5_ii([5 x i32]* %36, i32 %37)
...
42:                                               ; preds = %39
  ...
  %46 = call i32 @_Z3minPA5_ii([5 x i32]* %44, i32 %45)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_73_956.cpp() #0 section ".text.startup" {
