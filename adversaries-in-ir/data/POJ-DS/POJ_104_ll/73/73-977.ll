; ModuleID = 'POJ-104-source/73/73-977.cpp'
source_filename = "POJ-104-source/73/73-977.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_73_977.cpp, i8* null }]
...
12:                                               ; preds = %9
  ...
  %33 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i64 0, i64 0), i32* %16, i32* %20, i32* %24, i32* %28, i32* %32)
  br label %34
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_73_977.cpp() #0 section ".text.startup" {
