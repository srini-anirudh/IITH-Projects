; ModuleID = 'POJ-104-source/74/74-1034.cpp'
source_filename = "POJ-104-source/74/74-1034.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_1034.cpp, i8* null }]
...
38:                                               ; preds = %33
  %39 = getelementptr inbounds [300 x i32], [300 x i32]* %5, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_1034.cpp() #0 section ".text.startup" {
