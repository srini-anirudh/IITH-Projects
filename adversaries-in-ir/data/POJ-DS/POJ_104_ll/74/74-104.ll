; ModuleID = 'POJ-104-source/74/74-104.cpp'
source_filename = "POJ-104-source/74/74-104.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_104.cpp, i8* null }]
...
16:                                               ; preds = %12
  ...
  %18 = call i32 @_Z9huiwenshui(i32 %17)
  %19 = icmp eq i32 %18, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_104.cpp() #0 section ".text.startup" {
