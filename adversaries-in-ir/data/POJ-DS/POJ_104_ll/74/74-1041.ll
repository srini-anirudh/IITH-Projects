; ModuleID = 'POJ-104-source/74/74-1041.cpp'
source_filename = "POJ-104-source/74/74-1041.cpp"
...
@m = dso_local global [100000 x i64] zeroinitializer, align 16
@.str = private unnamed_addr constant [8 x i8] c"%ld %ld\00", align 1
@.str.1 = private unnamed_addr constant [3 x i8] c"no\00", align 1
@.str.2 = private unnamed_addr constant [4 x i8] c"%ld\00", align 1
@.str.3 = private unnamed_addr constant [5 x i8] c",%ld\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_1041.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i64 @_Z4comell(i64 %0, i64 %1) #0 {
...
55:                                               ; preds = %45
  ...
  %65 = sub nsw i64 %64, 2
  %66 = call i64 @_Z4comell(i64 %63, i64 %65)
...
define dso_local i64 @_Z2goll(i64 %0, i64 %1) #4 {
  %3 = alloca i64, align 8
  %4 = alloca i64, align 8
  %5 = alloca i64, align 8
  %6 = alloca i64, align 8
...
define dso_local i32 @main() #5 {
  ...
  %14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i64 0, i64 0), i64* %2, i64* %3)
...
24:                                               ; preds = %20
  ...
  %31 = call i64 @_Z2goll(i64 %29, i64 %30)
...
46:                                               ; preds = %37
  ...
  %49 = call i64 @_Z4comell(i64 %47, i64 %48)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_1041.cpp() #0 section ".text.startup" {
