; ModuleID = 'POJ-104-source/74/74-1046.cpp'
source_filename = "POJ-104-source/74/74-1046.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_1046.cpp, i8* null }]
...
35:                                               ; preds = %32
  %36 = getelementptr inbounds [400 x i32], [400 x i32]* %5, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_1046.cpp() #0 section ".text.startup" {
