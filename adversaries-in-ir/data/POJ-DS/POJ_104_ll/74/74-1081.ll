; ModuleID = 'POJ-104-source/74/74-1081.cpp'
source_filename = "POJ-104-source/74/74-1081.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_1081.cpp, i8* null }]
...
36:                                               ; preds = %32
  ...
  %38 = call i32 @_Z5sushui(i32 %37)
  %39 = icmp ne i32 %38, 0
  br i1 %39, label %40, label %49

40:                                               ; preds = %36
  %41 = load i32, i32* %2, align 4
  %42 = call i32 @_Z6huiweni(i32 %41)
  %43 = icmp ne i32 %42, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_1081.cpp() #0 section ".text.startup" {
