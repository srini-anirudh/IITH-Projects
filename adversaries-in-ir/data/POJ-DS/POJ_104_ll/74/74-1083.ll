; ModuleID = 'POJ-104-source/74/74-1083.cpp'
source_filename = "POJ-104-source/74/74-1083.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_1083.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z2sul(i64 %0) #0 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z3huil(i64 %0) #4 {
  %2 = alloca i32, align 4
  %3 = alloca i64, align 8
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
...
define dso_local i32 @main() #6 {
  ...
  %9 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i64* %2, i64* %3)
...
57:                                               ; preds = %44
  ...
  %62 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0), i32 %61)
  br label %63
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_1083.cpp() #0 section ".text.startup" {
