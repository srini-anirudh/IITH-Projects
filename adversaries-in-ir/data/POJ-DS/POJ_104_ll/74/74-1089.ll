; ModuleID = 'POJ-104-source/74/74-1089.cpp'
source_filename = "POJ-104-source/74/74-1089.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_1089.cpp, i8* null }]
...
10:                                               ; preds = %2
  ...
  %18 = call i32 @_Z1fii(i32 %12, i32 %17)
...
12:                                               ; preds = %8
  ...
  %14 = call i32 @_Z1fii(i32 %13, i32 0)
  %15 = load i32, i32* %4, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_1089.cpp() #0 section ".text.startup" {
