; ModuleID = 'POJ-104-source/74/74-1103.cpp'
source_filename = "POJ-104-source/74/74-1103.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_1103.cpp, i8* null }]
...
define dso_local i32 @_Z5lenthi(i32 %0) #4 {
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z4nixuii(i32 %0, i32 %1) #0 {
  %3 = alloca i32, align 4
...
25:                                               ; preds = %15
  ...
  %30 = sub nsw i32 %29, 1
  %31 = call i32 @_Z4nixuii(i32 %28, i32 %30)
...
define dso_local i32 @_Z6huiweni(i32 %0) #0 {
  ...
  %7 = call i32 @_Z5lenthi(i32 %6)
  %8 = call i32 @_Z4nixuii(i32 %5, i32 %7)
...
93:                                               ; preds = %89
  ...
  %95 = call i32 @_Z6huiweni(i32 %94)
  %96 = icmp ne i32 %95, 0
  br i1 %96, label %97, label %106

97:                                               ; preds = %93
  %98 = load i32, i32* %4, align 4
  %99 = call i32 @_Z5sushui(i32 %98)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_1103.cpp() #0 section ".text.startup" {
