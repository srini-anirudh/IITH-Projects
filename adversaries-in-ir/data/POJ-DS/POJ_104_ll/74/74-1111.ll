; ModuleID = 'POJ-104-source/74/74-1111.cpp'
source_filename = "POJ-104-source/74/74-1111.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_1111.cpp, i8* null }]
...
13:                                               ; preds = %9
  ...
  %15 = call i32 @_Z1qi(i32 %14)
  %16 = icmp ne i32 %15, 0
  br i1 %16, label %17, label %28

17:                                               ; preds = %13
  %18 = load i32, i32* %4, align 4
  %19 = call i32 @_Z1pi(i32 %18)
  %20 = icmp ne i32 %19, 0
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z1qi(i32 %0) #0 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_1111.cpp() #0 section ".text.startup" {
