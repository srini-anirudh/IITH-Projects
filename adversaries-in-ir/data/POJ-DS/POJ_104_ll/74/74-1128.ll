; ModuleID = 'POJ-104-source/74/74-1128.cpp'
source_filename = "POJ-104-source/74/74-1128.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_1128.cpp, i8* null }]
...
72:                                               ; preds = %69
  %73 = getelementptr inbounds [1000 x i32], [1000 x i32]* %10, i64 0, i64 1
  %74 = load i32, i32* %73, align 4
  %75 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i32 %74)
  br label %94

76:                                               ; preds = %69
  %77 = getelementptr inbounds [1000 x i32], [1000 x i32]* %10, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_1128.cpp() #0 section ".text.startup" {
