; ModuleID = 'POJ-104-source/74/74-1131.cpp'
source_filename = "POJ-104-source/74/74-1131.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_1131.cpp, i8* null }]
...
24:                                               ; preds = %20
  ...
  %26 = call i32 @_Z2suii(i32 %25, i32 2)
  %27 = icmp eq i32 %26, 1
...
28:                                               ; preds = %24
  ...
  %31 = call i32 @_Z3huiii(i32 %30, i32 0)
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z2suii(i32 %0, i32 %1) #0 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  store i32 %0, i32* %4, align 4
...
16:                                               ; preds = %10
  ...
  %19 = add nsw i32 %18, 1
  %20 = call i32 @_Z2suii(i32 %17, i32 %19)
...
10:                                               ; preds = %2
  ...
  %18 = call i32 @_Z3huiii(i32 %12, i32 %17)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_1131.cpp() #0 section ".text.startup" {
