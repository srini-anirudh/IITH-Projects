; ModuleID = 'POJ-104-source/74/74-114.cpp'
source_filename = "POJ-104-source/74/74-114.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_114.cpp, i8* null }]
...
14:                                               ; preds = %10
  ...
  %16 = call i32 @_Z2sui(i32 %15)
  %17 = icmp eq i32 %16, 1
  br i1 %17, label %18, label %28

18:                                               ; preds = %14
  %19 = load i32, i32* %5, align 4
  %20 = call i32 @_Z3huii(i32 %19)
  %21 = icmp eq i32 %20, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_114.cpp() #0 section ".text.startup" {
