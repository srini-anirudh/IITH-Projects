; ModuleID = 'POJ-104-source/74/74-1160.cpp'
source_filename = "POJ-104-source/74/74-1160.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_1160.cpp, i8* null }]
...
13:                                               ; preds = %9
  ...
  %15 = call i32 @_Z5checki(i32 %14)
  %16 = icmp eq i32 %15, 1
  br i1 %16, label %17, label %26

17:                                               ; preds = %13
  %18 = load i32, i32* %4, align 4
  %19 = call i32 @_Z6checkai(i32 %18)
  %20 = icmp eq i32 %19, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_1160.cpp() #0 section ".text.startup" {
