; ModuleID = 'POJ-104-source/74/74-119.cpp'
source_filename = "POJ-104-source/74/74-119.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_119.cpp, i8* null }]
...
24:                                               ; preds = %20
  ...
  %31 = getelementptr inbounds [80 x i32], [80 x i32]* %2, i64 0, i64 %30
...
47:                                               ; preds = %44
  %48 = getelementptr inbounds [80 x i32], [80 x i32]* %2, i64 0, i64 0
...
54:                                               ; preds = %51
  %55 = getelementptr inbounds [80 x i32], [80 x i32]* %2, i64 0, i64 0
  %56 = load i32, i32* %55, align 16
  %57 = getelementptr inbounds [80 x i32], [80 x i32]* %2, i64 0, i64 1
  %58 = load i32, i32* %57, align 4
  %59 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.3, i64 0, i64 0), i32 %56, i32 %58)
...
64:                                               ; preds = %60
  ...
  %67 = getelementptr inbounds [80 x i32], [80 x i32]* %2, i64 0, i64 %66
...
define dso_local i32 @_Z6huiweni(i32 %0) #6 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_119.cpp() #0 section ".text.startup" {
