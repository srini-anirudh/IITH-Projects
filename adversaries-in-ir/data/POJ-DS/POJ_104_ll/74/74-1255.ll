; ModuleID = 'POJ-104-source/74/74-1255.cpp'
source_filename = "POJ-104-source/74/74-1255.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_1255.cpp, i8* null }]
...
19:                                               ; preds = %15
  ...
  %21 = call i32 @_Z6check1i(i32 %20)
  %22 = icmp ne i32 %21, 0
  br i1 %22, label %23, label %34

23:                                               ; preds = %19
  %24 = load i32, i32* @i, align 4
  %25 = call i32 @_Z6check2i(i32 %24)
  %26 = icmp ne i32 %25, 0
...
define dso_local i32 @_Z6check2i(i32 %0) #5 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_1255.cpp() #0 section ".text.startup" {
