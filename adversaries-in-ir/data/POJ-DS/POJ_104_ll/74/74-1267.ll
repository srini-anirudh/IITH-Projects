; ModuleID = 'POJ-104-source/74/74-1267.cpp'
source_filename = "POJ-104-source/74/74-1267.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_1267.cpp, i8* null }]
...
define dso_local i32 @_Z9chengfangi(i32 %0) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z2wsi(i32 %0) #4 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  store i32 %0, i32* %2, align 4
  store i32 1, i32* %3, align 4
...
7:                                                ; preds = %4
  ...
  %10 = call i32 @_Z9chengfangi(i32 %9)
  %11 = sdiv i32 %8, %10
  %12 = icmp eq i32 %11, 0
...
13:                                               ; preds = %8
  ...
  %16 = sub nsw i32 %15, 1
  %17 = call i32 @_Z9chengfangi(i32 %16)
  %18 = sdiv i32 %14, %17
  %19 = srem i32 %18, 10
  ...
  %24 = call i32 @_Z9chengfangi(i32 %23)
  %25 = sdiv i32 %20, %24
  %26 = srem i32 %25, 10
...
41:                                               ; preds = %37
  ...
  %43 = call i32 @_Z5sushui(i32 %42)
  %44 = icmp eq i32 %43, 1
  br i1 %44, label %45, label %53

45:                                               ; preds = %41
  %46 = load i32, i32* %4, align 4
  %47 = call i32 @_Z6huiweni(i32 %46)
  %48 = icmp eq i32 %47, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_1267.cpp() #0 section ".text.startup" {
