; ModuleID = 'POJ-104-source/74/74-1268.cpp'
source_filename = "POJ-104-source/74/74-1268.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_1268.cpp, i8* null }]
...
14:                                               ; preds = %10
  ...
  %16 = call i32 @_Z4ifhwi(i32 %15)
  %17 = icmp ne i32 %16, 0
  br i1 %17, label %18, label %30

18:                                               ; preds = %14
  %19 = load i32, i32* %5, align 4
  %20 = call i32 @_Z3ifsi(i32 %19)
  %21 = icmp ne i32 %20, 0
...
define dso_local i32 @_Z4ifhwi(i32 %0) #6 {
  %2 = alloca i32, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z3ifsi(i32 %0) #6 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  store i32 %0, i32* %2, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_1268.cpp() #0 section ".text.startup" {
