; ModuleID = 'POJ-104-source/74/74-1326.cpp'
source_filename = "POJ-104-source/74/74-1326.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_1326.cpp, i8* null }]
...
43:                                               ; preds = %38
  ...
  %45 = call i32 @_Z6huiweni(i32 %44)
  %46 = icmp eq i32 %45, 1
  br i1 %46, label %47, label %56

47:                                               ; preds = %43
  %48 = load i32, i32* %2, align 4
  %49 = call i32 @_Z5sushui(i32 %48)
  %50 = icmp eq i32 %49, 1
...
65:                                               ; preds = %61
  ...
  %67 = call i32 @_Z6huiweni(i32 %66)
  %68 = icmp eq i32 %67, 1
  br i1 %68, label %69, label %76

69:                                               ; preds = %65
  %70 = load i32, i32* %2, align 4
  %71 = call i32 @_Z5sushui(i32 %70)
  %72 = icmp eq i32 %71, 1
...
87:                                               ; preds = %83
  ...
  %89 = call i32 @_Z6huiweni(i32 %88)
  %90 = icmp eq i32 %89, 1
  br i1 %90, label %91, label %98

91:                                               ; preds = %87
  %92 = load i32, i32* %2, align 4
  %93 = call i32 @_Z5sushui(i32 %92)
  %94 = icmp eq i32 %93, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_1326.cpp() #0 section ".text.startup" {
