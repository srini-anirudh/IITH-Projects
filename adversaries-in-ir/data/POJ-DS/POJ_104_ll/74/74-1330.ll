; ModuleID = 'POJ-104-source/74/74-1330.cpp'
source_filename = "POJ-104-source/74/74-1330.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_1330.cpp, i8* null }]
...
10:                                               ; preds = %2
  ...
  %18 = call i32 @_Z6huiwenii(i32 %12, i32 %17)
...
12:                                               ; preds = %8
  ...
  %15 = call i32 @_Z6huiwenii(i32 %14, i32 0)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_1330.cpp() #0 section ".text.startup" {
