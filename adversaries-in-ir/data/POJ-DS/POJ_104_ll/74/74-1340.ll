; ModuleID = 'POJ-104-source/74/74-1340.cpp'
source_filename = "POJ-104-source/74/74-1340.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_1340.cpp, i8* null }]
...
55:                                               ; preds = %50
  ...
  %60 = call i32 @_Z6huiwenii(i32 %59, i32 0)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_1340.cpp() #0 section ".text.startup" {
