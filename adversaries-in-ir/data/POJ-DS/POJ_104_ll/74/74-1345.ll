; ModuleID = 'POJ-104-source/74/74-1345.cpp'
source_filename = "POJ-104-source/74/74-1345.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_1345.cpp, i8* null }]
...
33:                                               ; preds = %29
  ...
  %35 = call i32 @_Z3huii(i32 %34)
  %36 = icmp eq i32 %35, 1
  br i1 %36, label %37, label %44

37:                                               ; preds = %33
  %38 = load i32, i32* %5, align 4
  %39 = call i32 @_Z2sui(i32 %38)
  %40 = icmp eq i32 %39, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_1345.cpp() #0 section ".text.startup" {
