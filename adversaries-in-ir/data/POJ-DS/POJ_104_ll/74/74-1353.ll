; ModuleID = 'POJ-104-source/74/74-1353.cpp'
source_filename = "POJ-104-source/74/74-1353.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_1353.cpp, i8* null }]
...
77:                                               ; preds = %71
  ...
  %82 = call i32 @_Z7panduani(i32 %81)
  %83 = icmp eq i32 %82, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_1353.cpp() #0 section ".text.startup" {
