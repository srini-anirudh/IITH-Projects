; ModuleID = 'POJ-104-source/74/74-1373.cpp'
source_filename = "POJ-104-source/74/74-1373.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_1373.cpp, i8* null }]
...
13:                                               ; preds = %9
  ...
  %15 = call i32 @_Z2p1i(i32 %14)
  %16 = icmp eq i32 %15, 1
  br i1 %16, label %17, label %24

17:                                               ; preds = %13
  %18 = load i32, i32* %4, align 4
  %19 = call i32 @_Z2p2i(i32 %18)
  %20 = icmp eq i32 %19, 0
...
40:                                               ; preds = %36
  ...
  %42 = call i32 @_Z2p1i(i32 %41)
  %43 = icmp eq i32 %42, 1
  br i1 %43, label %44, label %51

44:                                               ; preds = %40
  %45 = load i32, i32* %5, align 4
  %46 = call i32 @_Z2p2i(i32 %45)
  %47 = icmp eq i32 %46, 0
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z2p1i(i32 %0) #0 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
...
define dso_local i32 @_Z2p2i(i32 %0) #5 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_1373.cpp() #0 section ".text.startup" {
