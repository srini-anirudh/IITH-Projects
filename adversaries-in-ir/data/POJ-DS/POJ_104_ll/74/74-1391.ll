; ModuleID = 'POJ-104-source/74/74-1391.cpp'
source_filename = "POJ-104-source/74/74-1391.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_1391.cpp, i8* null }]
...
14:                                               ; preds = %10
  ...
  %16 = call i32 @_Z4funbi(i32 %15)
  %17 = icmp eq i32 %16, 1
  br i1 %17, label %18, label %30

18:                                               ; preds = %14
  %19 = load i32, i32* %4, align 4
  %20 = call i32 @_Z4funai(i32 %19)
  %21 = icmp eq i32 %20, 1
...
define dso_local i32 @_Z4funbi(i32 %0) #6 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z4funai(i32 %0) #6 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  store i32 %0, i32* %3, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_1391.cpp() #0 section ".text.startup" {
