; ModuleID = 'POJ-104-source/74/74-1427.cpp'
source_filename = "POJ-104-source/74/74-1427.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_1427.cpp, i8* null }]
...
37:                                               ; preds = %33
  ...
  %39 = call i32 @_Z6judge1i(i32 %38)
  %40 = icmp eq i32 %39, 1
  br i1 %40, label %41, label %48

41:                                               ; preds = %37
  %42 = load i32, i32* %4, align 4
  %43 = call i32 @_Z6judge2i(i32 %42)
  %44 = icmp eq i32 %43, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_1427.cpp() #0 section ".text.startup" {
