; ModuleID = 'POJ-104-source/74/74-1457.cpp'
source_filename = "POJ-104-source/74/74-1457.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_1457.cpp, i8* null }]
...
32:                                               ; preds = %10
  %33 = getelementptr inbounds [1001 x i32], [1001 x i32]* %6, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_1457.cpp() #0 section ".text.startup" {
