; ModuleID = 'POJ-104-source/74/74-1459.cpp'
source_filename = "POJ-104-source/74/74-1459.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_1459.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z3runi(i32 %0) #0 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z5transi(i32 %0) #4 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  store i32 %0, i32* %2, align 4
  store i32 0, i32* %3, align 4
...
12:                                               ; preds = %8
  ...
  %14 = call i32 @_Z3runi(i32 %13)
  %15 = icmp eq i32 %14, 1
  br i1 %15, label %16, label %33

16:                                               ; preds = %12
  %17 = load i32, i32* %4, align 4
  %18 = call i32 @_Z5transi(i32 %17)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_1459.cpp() #0 section ".text.startup" {
