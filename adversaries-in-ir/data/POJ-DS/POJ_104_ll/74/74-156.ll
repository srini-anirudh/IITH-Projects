; ModuleID = 'POJ-104-source/74/74-156.cpp'
source_filename = "POJ-104-source/74/74-156.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_156.cpp, i8* null }]
...
define dso_local i32 @_Z8primejudi(i32 %0) #4 {
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z9huiwenjudi(i32 %0) #0 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
...
14:                                               ; preds = %10
  ...
  %16 = call i32 @_Z8primejudi(i32 %15)
  %17 = icmp ne i32 %16, 0
  br i1 %17, label %18, label %28

18:                                               ; preds = %14
  %19 = load i32, i32* %4, align 4
  %20 = call i32 @_Z9huiwenjudi(i32 %19)
  %21 = icmp ne i32 %20, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_156.cpp() #0 section ".text.startup" {
