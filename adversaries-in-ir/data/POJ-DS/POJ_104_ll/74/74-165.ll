; ModuleID = 'POJ-104-source/74/74-165.cpp'
source_filename = "POJ-104-source/74/74-165.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_165.cpp, i8* null }]
...
define dso_local i32 @_Z4conti(i32 %0) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z3daoii(i32 %0, i32 %1) #4 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
...
19:                                               ; preds = %15
  ...
  %21 = call i32 @_Z4conti(i32 %20)
  store i32 %21, i32* %9, align 4
  %22 = load i32, i32* %4, align 4
  %23 = load i32, i32* %9, align 4
  %24 = call i32 @_Z3daoii(i32 %22, i32 %23)
  store i32 %24, i32* %12, align 4
  %25 = load i32, i32* %4, align 4
  %26 = call i32 @_Z2sui(i32 %25)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_165.cpp() #0 section ".text.startup" {
