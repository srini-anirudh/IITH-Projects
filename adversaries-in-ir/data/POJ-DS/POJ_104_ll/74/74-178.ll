; ModuleID = 'POJ-104-source/74/74-178.cpp'
source_filename = "POJ-104-source/74/74-178.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_178.cpp, i8* null }]
...
define dso_local i32 @_Z12panduansushui(i32 %0) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z10suanweishui(i32 %0) #4 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  store i32 %0, i32* %2, align 4
  store i32 0, i32* %3, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z13panduanfanwenii(i32 %0, i32 %1) #4 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
...
17:                                               ; preds = %11
  ...
  %22 = call i32 @_Z12panduansushui(i32 %21)
  %23 = icmp eq i32 %22, 0
  br i1 %23, label %24, label %39

24:                                               ; preds = %17
  %25 = load i32, i32* %5, align 4
  %26 = call i32 @_Z10suanweishui(i32 %25)
  store i32 %26, i32* %6, align 4
  %27 = load i32, i32* %5, align 4
  %28 = load i32, i32* %6, align 4
  %29 = call i32 @_Z13panduanfanwenii(i32 %27, i32 %28)
  %30 = icmp eq i32 %29, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_178.cpp() #0 section ".text.startup" {
