; ModuleID = 'POJ-104-source/74/74-196.cpp'
source_filename = "POJ-104-source/74/74-196.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_196.cpp, i8* null }]
...
16:                                               ; preds = %9
  ...
  %19 = call i32 @_Z1tii(i32 %17, i32 %18)
  %20 = load i32, i32* %3, align 4
  %21 = load i32, i32* %4, align 4
  %22 = add nsw i32 %21, 2
  %23 = load i32, i32* %5, align 4
  %24 = sub nsw i32 %22, %23
  %25 = call i32 @_Z1tii(i32 %20, i32 %24)
...
define dso_local i32 @main() #5 {
  ...
  %10 = call i32 @_Z1pi(i32 2)
  store i32 %10, i32* %6, align 4
  %11 = call i32 @_Z1tii(i32 12345, i32 4)
  store i32 %11, i32* %7, align 4
  %12 = call i32 @_Z6huiweni(i32 101)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_196.cpp() #0 section ".text.startup" {
