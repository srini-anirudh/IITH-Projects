; ModuleID = 'POJ-104-source/74/74-212.cpp'
source_filename = "POJ-104-source/74/74-212.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_212.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z5sushuii(i32 %0, i32 %1) #0 {
...
17:                                               ; preds = %11
  ...
  %21 = call i32 @_Z5sushuii(i32 %19, i32 %20)
...
12:                                               ; preds = %8
  %13 = load i32, i32* %4, align 4
  %14 = call i32 @_Z6huiweni(i32 %13)
  %15 = icmp eq i32 %14, 1
  br i1 %15, label %16, label %26

16:                                               ; preds = %12
  %17 = load i32, i32* %4, align 4
  %18 = call i32 @_Z5sushuii(i32 2, i32 %17)
  %19 = icmp eq i32 %18, 1
...
26:                                               ; preds = %20, %16, %12
  ...
  %28 = call i32 @_Z6huiweni(i32 %27)
  %29 = icmp eq i32 %28, 1
  br i1 %29, label %30, label %40

30:                                               ; preds = %26
  %31 = load i32, i32* %4, align 4
  %32 = call i32 @_Z5sushuii(i32 2, i32 %31)
  %33 = icmp eq i32 %32, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_212.cpp() #0 section ".text.startup" {
