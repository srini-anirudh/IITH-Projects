; ModuleID = 'POJ-104-source/74/74-218.cpp'
source_filename = "POJ-104-source/74/74-218.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_218.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z6revchki(i32 %0) #0 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  ...
  %9 = call double @_ZSt3logIiEN9__gnu_cxx11__enable_ifIXsr12__is_integerIT_EE7__valueEdE6__typeES2_(i32 %8)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_218.cpp() #0 section ".text.startup" {
