; ModuleID = 'POJ-104-source/74/74-228.cpp'
source_filename = "POJ-104-source/74/74-228.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_228.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %17 = call i32 @_Z3susi(i32 %16)
  %18 = icmp eq i32 %17, 1
  br i1 %18, label %19, label %26

19:                                               ; preds = %15
  %20 = load i32, i32* %3, align 4
  %21 = call i32 @_Z3huii(i32 %20)
  %22 = icmp eq i32 %21, 1
...
define dso_local i32 @_Z3susi(i32 %0) #5 {
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z3huii(i32 %0) #0 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
...
72:                                               ; preds = %66
  ...
  %81 = call double @_ZSt3powIiiEN9__gnu_cxx11__promote_2IT_T0_NS0_9__promoteIS2_Xsr3std12__is_integerIS2_EE7__valueEE6__typeENS4_IS3_Xsr3std12__is_integerIS3_EE7__valueEE6__typeEE6__typeES2_S3_(i32 10, i32 %80)
...
; Function Attrs: noinline uwtable
define dso_local void @_Z3seli(i32 %0) #0 {
  %2 = alloca i32, align 4
  store i32 %0, i32* %2, align 4
  %3 = load i32, i32* %2, align 4
  %4 = call i32 @_Z3susi(i32 %3)
  %5 = icmp eq i32 %4, 1
  br i1 %5, label %6, label %13

6:                                                ; preds = %1
  %7 = load i32, i32* %2, align 4
  %8 = call i32 @_Z3huii(i32 %7)
  %9 = icmp eq i32 %8, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_228.cpp() #0 section ".text.startup" {
