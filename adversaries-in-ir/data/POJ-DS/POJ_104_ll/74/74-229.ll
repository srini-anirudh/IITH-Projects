; ModuleID = 'POJ-104-source/74/74-229.cpp'
source_filename = "POJ-104-source/74/74-229.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_229.cpp, i8* null }]
...
28:                                               ; preds = %20, %16, %12
  ...
  %30 = call i32 @_Z2f1i(i32 %29)
  %31 = icmp eq i32 %30, 1
  br i1 %31, label %32, label %42

32:                                               ; preds = %28
  %33 = load i32, i32* %4, align 4
  %34 = call i32 @_Z2f2i(i32 %33)
  %35 = icmp eq i32 %34, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_229.cpp() #0 section ".text.startup" {
