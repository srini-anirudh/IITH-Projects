; ModuleID = 'POJ-104-source/74/74-293.cpp'
source_filename = "POJ-104-source/74/74-293.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_293.cpp, i8* null }]
...
20:                                               ; preds = %16
  ...
  %23 = call double @_ZSt5log10IiEN9__gnu_cxx11__enable_ifIXsr12__is_integerIT_EE7__valueEdE6__typeES2_(i32 %22)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_293.cpp() #0 section ".text.startup" {
