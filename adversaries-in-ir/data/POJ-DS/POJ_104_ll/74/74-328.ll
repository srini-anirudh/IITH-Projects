; ModuleID = 'POJ-104-source/74/74-328.cpp'
source_filename = "POJ-104-source/74/74-328.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_328.cpp, i8* null }]
...
91:                                               ; preds = %88
  ...
  %95 = getelementptr inbounds [10000 x i32], [10000 x i32]* %12, i64 0, i64 %94
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_328.cpp() #0 section ".text.startup" {
