; ModuleID = 'POJ-104-source/74/74-334.cpp'
source_filename = "POJ-104-source/74/74-334.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_334.cpp, i8* null }]
...
39:                                               ; preds = %34
  %40 = getelementptr inbounds [305 x i32], [305 x i32]* %5, i64 0, i64 0
...
47:                                               ; preds = %43
  ...
  %50 = getelementptr inbounds [305 x i32], [305 x i32]* %5, i64 0, i64 %49
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_334.cpp() #0 section ".text.startup" {
