; ModuleID = 'POJ-104-source/74/74-351.cpp'
source_filename = "POJ-104-source/74/74-351.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_351.cpp, i8* null }]
...
12:                                               ; preds = %8
  ...
  %14 = call i32 @_Z3revi(i32 %13)
  %15 = icmp ne i32 %14, 0
  br i1 %15, label %16, label %28

16:                                               ; preds = %12
  %17 = load i32, i32* %4, align 4
  %18 = call i32 @_Z3shui(i32 %17)
  %19 = icmp ne i32 %18, 0
...
define dso_local i32 @_Z3revi(i32 %0) #5 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z3shui(i32 %0) #0 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  store i32 %0, i32* %3, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_351.cpp() #0 section ".text.startup" {
