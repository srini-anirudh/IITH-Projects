; ModuleID = 'POJ-104-source/74/74-428.cpp'
source_filename = "POJ-104-source/74/74-428.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_428.cpp, i8* null }]
...
26:                                               ; preds = %22
  ...
  %29 = call i32 @_Z3huiii(i32 %27, i32 %28)
  %30 = icmp ne i32 %29, 0
...
define dso_local i32 @_Z3huiii(i32 %0, i32 %1) #5 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_428.cpp() #0 section ".text.startup" {
