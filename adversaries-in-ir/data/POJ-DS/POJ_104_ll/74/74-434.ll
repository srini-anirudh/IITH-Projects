; ModuleID = 'POJ-104-source/74/74-434.cpp'
source_filename = "POJ-104-source/74/74-434.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_434.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z6isPrimi(i32 %0) #0 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z5isHuii(i32 %0) #4 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  store i32 %0, i32* %2, align 4
...
10:                                               ; preds = %6
  ...
  %12 = call i32 @_Z6isPrimi(i32 %11)
  %13 = icmp ne i32 %12, 0
  br i1 %13, label %14, label %27

14:                                               ; preds = %10
  %15 = load i32, i32* %2, align 4
  %16 = call i32 @_Z5isHuii(i32 %15)
  %17 = icmp ne i32 %16, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_434.cpp() #0 section ".text.startup" {
