; ModuleID = 'POJ-104-source/74/74-454.cpp'
source_filename = "POJ-104-source/74/74-454.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_454.cpp, i8* null }]
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z6shushui(i32 %0) #4 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  store i32 %0, i32* %3, align 4
...
38:                                               ; preds = %34
  ...
  %40 = call i32 @_Z6huiweni(i32 %39)
  %41 = icmp ne i32 %40, 0
  br i1 %41, label %42, label %52

42:                                               ; preds = %38
  %43 = load i32, i32* %5, align 4
  %44 = call i32 @_Z6shushui(i32 %43)
  %45 = icmp ne i32 %44, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_454.cpp() #0 section ".text.startup" {
