; ModuleID = 'POJ-104-source/74/74-455.cpp'
source_filename = "POJ-104-source/74/74-455.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_455.cpp, i8* null }]
...
define dso_local i32 @_Z12IsPalindromei(i32 %0) #4 {
...
13:                                               ; preds = %9
  ...
  %16 = call i32 @_Z12IsPalindromei(i32 %15)
...
33:                                               ; preds = %29
  ...
  %36 = call i32 @_Z12IsPalindromei(i32 %35)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_455.cpp() #0 section ".text.startup" {
