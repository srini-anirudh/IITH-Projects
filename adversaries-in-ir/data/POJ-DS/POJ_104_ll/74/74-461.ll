; ModuleID = 'POJ-104-source/74/74-461.cpp'
source_filename = "POJ-104-source/74/74-461.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_461.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local signext i16 @_Z9IsPremiumi(i32 %0) #0 {
...
; Function Attrs: noinline uwtable
define dso_local signext i16 @_Z11IsHuiWenShui(i32 %0) #0 {
  %2 = alloca i16, align 2
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  ...
  %7 = call double @_ZSt3logIiEN9__gnu_cxx11__enable_ifIXsr12__is_integerIT_EE7__valueEdE6__typeES2_(i32 %6)
  %8 = call double @_ZSt3logIiEN9__gnu_cxx11__enable_ifIXsr12__is_integerIT_EE7__valueEdE6__typeES2_(i32 10)
  %9 = fdiv double %7, %8
...
10:                                               ; preds = %6
  ...
  %12 = call signext i16 @_Z9IsPremiumi(i32 %11)
  %13 = icmp ne i16 %12, 0
  br i1 %13, label %14, label %26

14:                                               ; preds = %10
  %15 = load i32, i32* %2, align 4
  %16 = call signext i16 @_Z11IsHuiWenShui(i32 %15)
  %17 = icmp ne i16 %16, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_461.cpp() #0 section ".text.startup" {
