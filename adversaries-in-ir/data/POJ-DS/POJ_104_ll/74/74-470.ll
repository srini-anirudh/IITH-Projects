; ModuleID = 'POJ-104-source/74/74-470.cpp'
source_filename = "POJ-104-source/74/74-470.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_470.cpp, i8* null }]
...
27:                                               ; preds = %24
  ...
  %29 = call i32 @_Z3huii(i32 %28)
  %30 = icmp eq i32 %29, 1
  br i1 %30, label %31, label %40

31:                                               ; preds = %27
  %32 = load i32, i32* %2, align 4
  %33 = call i32 @_Z2sui(i32 %32)
  %34 = icmp eq i32 %33, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_470.cpp() #0 section ".text.startup" {
