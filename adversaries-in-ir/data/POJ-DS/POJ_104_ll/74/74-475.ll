; ModuleID = 'POJ-104-source/74/74-475.cpp'
source_filename = "POJ-104-source/74/74-475.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_475.cpp, i8* null }]
...
17:                                               ; preds = %13
  ...
  %19 = call i32 @_Z8Ishuiweni(i32 %18)
  %20 = icmp ne i32 %19, 0
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z8Ishuiweni(i32 %0) #0 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_475.cpp() #0 section ".text.startup" {
