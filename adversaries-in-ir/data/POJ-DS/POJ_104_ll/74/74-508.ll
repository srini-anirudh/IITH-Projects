; ModuleID = 'POJ-104-source/74/74-508.cpp'
source_filename = "POJ-104-source/74/74-508.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_508.cpp, i8* null }]
...
90:                                               ; preds = %87
  ...
  %94 = getelementptr inbounds [9999 x i32], [9999 x i32]* %11, i64 0, i64 %93
...
122:                                              ; preds = %108
  ...
  %126 = getelementptr inbounds [9999 x i32], [9999 x i32]* %11, i64 0, i64 %125
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_508.cpp() #0 section ".text.startup" {
