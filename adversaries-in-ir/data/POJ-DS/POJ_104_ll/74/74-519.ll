; ModuleID = 'POJ-104-source/74/74-519.cpp'
source_filename = "POJ-104-source/74/74-519.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_519.cpp, i8* null }]
...
24:                                               ; preds = %20
  %25 = getelementptr inbounds [30 x i8], [30 x i8]* %11, i64 0, i64 0
  %26 = call i8* @strcpy(i8* %25, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0)) #3
...
75:                                               ; preds = %71
  ...
  %79 = getelementptr inbounds [30 x i32], [30 x i32]* %10, i64 0, i64 %78
...
define dso_local i32 @_Z1fi(i32 %0) #6 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_519.cpp() #0 section ".text.startup" {
