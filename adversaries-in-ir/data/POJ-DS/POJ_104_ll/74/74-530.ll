; ModuleID = 'POJ-104-source/74/74-530.cpp'
source_filename = "POJ-104-source/74/74-530.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_530.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z1Pii(i32 %0, i32 %1) #0 {
...
define dso_local void @_Z5sushuv() #4 {
...
define dso_local i32 @main() #5 {
  ...
  %3 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0), i32* %1, i32* %2)
  %4 = load i32, i32* %1, align 4
  %5 = load i32, i32* %2, align 4
  call void @_Z1Pii(i32 %4, i32 %5)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_530.cpp() #0 section ".text.startup" {
