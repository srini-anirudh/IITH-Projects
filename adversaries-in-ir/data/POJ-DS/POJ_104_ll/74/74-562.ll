; ModuleID = 'POJ-104-source/74/74-562.cpp'
source_filename = "POJ-104-source/74/74-562.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_562.cpp, i8* null }]
...
13:                                               ; preds = %9
  ...
  %15 = load i32, i32* %4, align 4
  %16 = call i32 @_Z1fii(i32 %15, i32 0)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_562.cpp() #0 section ".text.startup" {
