; ModuleID = 'POJ-104-source/74/74-569.cpp'
source_filename = "POJ-104-source/74/74-569.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_569.cpp, i8* null }]
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z8ishuiweni(i32 %0) #4 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  ...
  %9 = call i32 (i8*, i8*, ...) @sprintf(i8* %7, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32 %8) #3
...
define dso_local i32 @main() #6 {
  ...
  store i32 0, i32* %2, align 4
  %6 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %4, i32* %5)
...
12:                                               ; preds = %8
  ...
  %14 = call i32 @_Z7isprimei(i32 %13)
  %15 = icmp ne i32 %14, 0
  br i1 %15, label %16, label %32

16:                                               ; preds = %12
  %17 = load i32, i32* %3, align 4
  %18 = call i32 @_Z8ishuiweni(i32 %17)
  %19 = icmp ne i32 %18, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_569.cpp() #0 section ".text.startup" {
