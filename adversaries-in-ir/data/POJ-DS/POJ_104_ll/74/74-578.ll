; ModuleID = 'POJ-104-source/74/74-578.cpp'
source_filename = "POJ-104-source/74/74-578.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_578.cpp, i8* null }]
...
54:                                               ; preds = %75, %53
  ...
  %59 = getelementptr inbounds [500 x i32], [500 x i32]* %11, i64 0, i64 %58
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_578.cpp() #0 section ".text.startup" {
