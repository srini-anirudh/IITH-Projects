; ModuleID = 'POJ-104-source/74/74-606.cpp'
source_filename = "POJ-104-source/74/74-606.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_606.cpp, i8* null }]
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z7nDigitsi(i32 %0) #4 {
  %2 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define dso_local signext i8 @_Z12isPalindromei(i32 %0) #0 {
  %2 = alloca i32, align 4
  %3 = alloca i8, align 1
  %4 = alloca i32, align 4
...
13:                                               ; preds = %9
  ...
  %24 = call double @_ZSt3powIiiEN9__gnu_cxx11__promote_2IT_T0_NS0_9__promoteIS2_Xsr3std12__is_integerIS2_EE7__valueEE6__typeENS4_IS3_Xsr3std12__is_integerIS3_EE7__valueEE6__typeEE6__typeES2_S3_(i32 10, i32 %23)
...
12:                                               ; preds = %8
  %13 = load i32, i32* %4, align 4
  %14 = call signext i8 @_Z7isPrimei(i32 %13)
  %15 = icmp ne i8 %14, 0
  br i1 %15, label %16, label %31

16:                                               ; preds = %12
  %17 = load i32, i32* %4, align 4
  %18 = call signext i8 @_Z12isPalindromei(i32 %17)
  %19 = icmp ne i8 %18, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_606.cpp() #0 section ".text.startup" {
