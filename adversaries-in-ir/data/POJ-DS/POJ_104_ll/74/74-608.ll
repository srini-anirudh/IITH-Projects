; ModuleID = 'POJ-104-source/74/74-608.cpp'
source_filename = "POJ-104-source/74/74-608.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_608.cpp, i8* null }]
...
define dso_local i32 @main(i32 %0, i8** %1) #4 {
  ...
  %14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %8, i32* %6)
...
79:                                               ; preds = %94, %76
  ...
  %85 = getelementptr inbounds [1000 x i32], [1000 x i32]* @group, i64 0, i64 %84
...
88:                                               ; preds = %79
  ...
  %91 = getelementptr inbounds [1000 x i32], [1000 x i32]* @group, i64 0, i64 %90
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_608.cpp() #0 section ".text.startup" {
