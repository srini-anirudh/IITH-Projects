; ModuleID = 'POJ-104-source/74/74-622.cpp'
source_filename = "POJ-104-source/74/74-622.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_622.cpp, i8* null }]
...
17:                                               ; preds = %13
  ...
  %20 = call i32 (i8*, i8*, ...) @sprintf(i8* %18, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32 %19) #3
...
28:                                               ; preds = %24
  ...
  %39 = getelementptr inbounds [20 x i8], [20 x i8]* %9, i64 0, i64 %38
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_622.cpp() #0 section ".text.startup" {
