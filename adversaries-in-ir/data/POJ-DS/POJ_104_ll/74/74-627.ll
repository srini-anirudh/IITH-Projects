; ModuleID = 'POJ-104-source/74/74-627.cpp'
source_filename = "POJ-104-source/74/74-627.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_627.cpp, i8* null }]
...
42:                                               ; preds = %36
  ...
  %45 = call i32 (i8*, i8*, ...) @sprintf(i8* %43, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32 %44) #3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_627.cpp() #0 section ".text.startup" {
