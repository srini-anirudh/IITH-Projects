; ModuleID = 'POJ-104-source/74/74-66.cpp'
source_filename = "POJ-104-source/74/74-66.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_66.cpp, i8* null }]
...
99:                                               ; preds = %85
  ...
  %104 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i32 %103)
  br label %105
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_66.cpp() #0 section ".text.startup" {
