; ModuleID = 'POJ-104-source/74/74-820.cpp'
source_filename = "POJ-104-source/74/74-820.cpp"
...
@_ZL3num = internal constant [9 x i32] [i32 1, i32 10, i32 100, i32 1000, i32 10000, i32 100000, i32 1000000, i32 10000000, i32 100000000], align 16
@.str.1 = private unnamed_addr constant [4 x i8] c"%d,\00", align 1
@.str.2 = private unnamed_addr constant [4 x i8] c"no\0A\00", align 1
@.str.3 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_820.cpp, i8* null }]
...
39:                                               ; preds = %35
  ...
  %41 = call double @_ZSt5log10IiEN9__gnu_cxx11__enable_ifIXsr12__is_integerIT_EE7__valueEdE6__typeES2_(i32 %40)
...
49:                                               ; preds = %44
  ...
  %53 = getelementptr inbounds [9 x i32], [9 x i32]* @_ZL3num, i64 0, i64 %52
  %54 = load i32, i32* %53, align 4
  %55 = srem i32 %50, %54
  %56 = load i32, i32* %5, align 4
  %57 = sub nsw i32 %56, 1
  %58 = sext i32 %57 to i64
  %59 = getelementptr inbounds [9 x i32], [9 x i32]* @_ZL3num, i64 0, i64 %58
  ...
  %68 = getelementptr inbounds [9 x i32], [9 x i32]* @_ZL3num, i64 0, i64 %67
  ...
  %77 = getelementptr inbounds [9 x i32], [9 x i32]* @_ZL3num, i64 0, i64 %76
  %78 = load i32, i32* %77, align 4
  %79 = sdiv i32 %70, %78
  %80 = icmp ne i32 %61, %79
...
103:                                              ; preds = %115, %102
  ...
  %105 = getelementptr inbounds [1000 x i32], [1000 x i32]* %8, i64 0, i64 0
...
124:                                              ; preds = %118
  %125 = getelementptr inbounds [1000 x i32], [1000 x i32]* %8, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_820.cpp() #0 section ".text.startup" {
