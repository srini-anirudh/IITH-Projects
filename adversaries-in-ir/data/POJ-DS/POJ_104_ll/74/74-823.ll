; ModuleID = 'POJ-104-source/74/74-823.cpp'
source_filename = "POJ-104-source/74/74-823.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_823.cpp, i8* null }]
...
12:                                               ; preds = %8
  ...
  %14 = call i32 @_Z8isHuiWeni(i32 %13)
  %15 = icmp ne i32 %14, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_823.cpp() #0 section ".text.startup" {
