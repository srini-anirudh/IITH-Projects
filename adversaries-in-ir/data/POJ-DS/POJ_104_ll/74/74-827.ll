; ModuleID = 'POJ-104-source/74/74-827.cpp'
source_filename = "POJ-104-source/74/74-827.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_827.cpp, i8* null }]
...
93:                                               ; preds = %90, %80
  ...
  %96 = getelementptr inbounds [20 x i32], [20 x i32]* %9, i64 0, i64 %95
...
131:                                              ; preds = %126
  %132 = getelementptr inbounds [100 x i32], [100 x i32]* %10, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_827.cpp() #0 section ".text.startup" {
