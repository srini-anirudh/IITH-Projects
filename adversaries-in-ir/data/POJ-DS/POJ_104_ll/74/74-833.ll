; ModuleID = 'POJ-104-source/74/74-833.cpp'
source_filename = "POJ-104-source/74/74-833.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_833.cpp, i8* null }]
...
define dso_local i32 @_Z3naxi(i32 %0) #4 {
...
12:                                               ; preds = %8
  %13 = load i32, i32* %4, align 4
  %14 = call i32 @_Z3maxi(i32 %13)
  %15 = icmp eq i32 %14, 1
  br i1 %15, label %16, label %25

16:                                               ; preds = %12
  %17 = load i32, i32* %4, align 4
  %18 = call i32 @_Z3naxi(i32 %17)
  %19 = icmp eq i32 %18, 1
...
36:                                               ; preds = %32
  %37 = load i32, i32* %4, align 4
  %38 = call i32 @_Z3maxi(i32 %37)
  %39 = icmp eq i32 %38, 1
  br i1 %39, label %40, label %49

40:                                               ; preds = %36
  %41 = load i32, i32* %4, align 4
  %42 = call i32 @_Z3naxi(i32 %41)
  %43 = icmp eq i32 %42, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_833.cpp() #0 section ".text.startup" {
