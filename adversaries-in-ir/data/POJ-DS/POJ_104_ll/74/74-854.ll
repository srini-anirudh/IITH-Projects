; ModuleID = 'POJ-104-source/74/74-854.cpp'
source_filename = "POJ-104-source/74/74-854.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_854.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %8 = bitcast [100 x i64]* %7 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 16 %8, i8 0, i64 800, i1 false)
  %9 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i64* %2, i64* %3)
...
19:                                               ; preds = %15
  ...
  %21 = call i64 @_Z2ssl(i64 %20)
  %22 = icmp eq i64 %21, 1
  br i1 %22, label %23, label %33

23:                                               ; preds = %19
  %24 = load i64, i64* %4, align 8
  %25 = call i64 @_Z2hwl(i64 %24)
  %26 = icmp eq i64 %25, 1
...
39:                                               ; preds = %11
  %40 = getelementptr inbounds [100 x i64], [100 x i64]* %7, i64 0, i64 0
...
44:                                               ; preds = %55, %43
  ...
  %46 = add nsw i64 %45, 1
  %47 = getelementptr inbounds [100 x i64], [100 x i64]* %7, i64 0, i64 %46
...
58:                                               ; preds = %44
  ...
  %62 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i64 %61)
  br label %65
...
define dso_local i64 @_Z2ssl(i64 %0) #6 {
  %2 = alloca i64, align 8
  %3 = alloca i64, align 8
  %4 = alloca i64, align 8
...
; Function Attrs: noinline nounwind uwtable
define dso_local i64 @_Z2hwl(i64 %0) #6 {
  %2 = alloca i64, align 8
  %3 = alloca i64, align 8
  %4 = alloca i64, align 8
  %5 = alloca i64, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_854.cpp() #0 section ".text.startup" {
