; ModuleID = 'POJ-104-source/74/74-91.cpp'
source_filename = "POJ-104-source/74/74-91.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_91.cpp, i8* null }]
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z3huii(i32 %0) #4 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
...
17:                                               ; preds = %13
  ...
  %19 = call i32 @_Z2sui(i32 %18)
  %20 = icmp eq i32 %19, 1
  br i1 %20, label %21, label %32

21:                                               ; preds = %17
  %22 = load i32, i32* %4, align 4
  %23 = call i32 @_Z3huii(i32 %22)
  %24 = icmp eq i32 %23, 1
...
79:                                               ; preds = %76
  %80 = getelementptr inbounds [100000 x i32], [100000 x i32]* %5, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_91.cpp() #0 section ".text.startup" {
