; ModuleID = 'POJ-104-source/74/74-946.cpp'
source_filename = "POJ-104-source/74/74-946.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_946.cpp, i8* null }]
...
133:                                              ; preds = %128
  ...
  %136 = getelementptr inbounds [2000 x i32], [2000 x i32]* %12, i64 0, i64 %135
...
142:                                              ; preds = %139
  ...
  %145 = getelementptr inbounds [2000 x i32], [2000 x i32]* %12, i64 0, i64 %144
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_946.cpp() #0 section ".text.startup" {
