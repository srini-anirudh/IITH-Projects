; ModuleID = 'POJ-104-source/74/74-977.cpp'
source_filename = "POJ-104-source/74/74-977.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_977.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z6huiwenii(i32 %0, i32 %1) #0 {
...
10:                                               ; preds = %2
  ...
  %19 = call i32 @_Z6huiwenii(i32 %17, i32 %18)
...
14:                                               ; preds = %10
  ...
  %16 = call i32 @_Z6huiwenii(i32 %15, i32 0)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_977.cpp() #0 section ".text.startup" {
