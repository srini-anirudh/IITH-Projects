; ModuleID = 'POJ-104-source/74/74-98.cpp'
source_filename = "POJ-104-source/74/74-98.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_98.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z12judge_huiweniPiii(i32 %0, i32* %1, i32 %2, i32 %3) #0 {
...
20:                                               ; preds = %4
  ...
  call void @_Z12judge_huiweniPiii(i32 %28, i32* %29, i32 %30, i32 %31)
  br label %32
...
15:                                               ; preds = %11
  ...
  call void @_Z12judge_huiweniPiii(i32 %17, i32* %18, i32 %19, i32 0)
  %20 = load i32, i32* %4, align 4
  %21 = getelementptr inbounds [2 x i32], [2 x i32]* %5, i64 0, i64 0
  call void @_Z11judge_sushuiPi(i32 %20, i32* %21)
...
46:                                               ; preds = %42
  ...
  call void @_Z12judge_huiweniPiii(i32 %48, i32* %49, i32 %50, i32 0)
  %51 = load i32, i32* %4, align 4
  %52 = getelementptr inbounds [2 x i32], [2 x i32]* %5, i64 0, i64 0
  call void @_Z11judge_sushuiPi(i32 %51, i32* %52)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_98.cpp() #0 section ".text.startup" {
