; ModuleID = 'POJ-104-source/74/74-984.cpp'
source_filename = "POJ-104-source/74/74-984.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_984.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i64 @_Z6huiwenll(i64 %0, i64 %1) #0 {
...
10:                                               ; preds = %2
  ...
  %18 = call i64 @_Z6huiwenll(i64 %12, i64 %17)
...
13:                                               ; preds = %9
  ...
  %15 = load i64, i64* %4, align 8
  %16 = call i64 @_Z6huiwenll(i64 %15, i64 0)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_984.cpp() #0 section ".text.startup" {
