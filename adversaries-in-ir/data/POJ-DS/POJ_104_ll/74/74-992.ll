; ModuleID = 'POJ-104-source/74/74-992.cpp'
source_filename = "POJ-104-source/74/74-992.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_74_992.cpp, i8* null }]
...
define dso_local i32 @_Z7reversel(i64 %0) #4 {
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z5primel(i64 %0) #0 {
  %2 = alloca i32, align 4
  %3 = alloca i64, align 8
  %4 = alloca i64, align 8
  store i64 %0, i64* %3, align 8
...
12:                                               ; preds = %8
  %13 = load i64, i64* %4, align 8
  %14 = call i32 @_Z7reversel(i64 %13)
  %15 = icmp ne i32 %14, 0
  br i1 %15, label %16, label %29

16:                                               ; preds = %12
  %17 = load i64, i64* %4, align 8
  %18 = call i32 @_Z5primel(i64 %17)
  %19 = icmp ne i32 %18, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_74_992.cpp() #0 section ".text.startup" {
