; ModuleID = 'POJ-104-source/75/75-1046.cpp'
source_filename = "POJ-104-source/75/75-1046.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_75_1046.cpp, i8* null }]
...
147:                                              ; preds = %101
  ...
  %151 = getelementptr inbounds [1001 x i32], [1001 x i32]* %4, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_75_1046.cpp() #0 section ".text.startup" {
