; ModuleID = 'POJ-104-source/75/75-156.cpp'
source_filename = "POJ-104-source/75/75-156.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_75_156.cpp, i8* null }]
...
97:                                               ; preds = %90
  ...
  %100 = getelementptr inbounds i32, i32* %68, i64 %99
...
122:                                              ; preds = %115
  ...
  %125 = getelementptr inbounds i32, i32* %68, i64 %124
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_75_156.cpp() #0 section ".text.startup" {
