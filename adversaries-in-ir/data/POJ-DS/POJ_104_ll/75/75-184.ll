; ModuleID = 'POJ-104-source/75/75-184.cpp'
source_filename = "POJ-104-source/75/75-184.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_75_184.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %19, i8* %9)
  br label %11
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_75_184.cpp() #0 section ".text.startup" {
