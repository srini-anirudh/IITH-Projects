; ModuleID = 'POJ-104-source/75/75-185.cpp'
source_filename = "POJ-104-source/75/75-185.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_75_185.cpp, i8* null }]
...
63:                                               ; preds = %50
  %64 = getelementptr inbounds [3 x [1001 x i32]], [3 x [1001 x i32]]* %3, i64 0, i64 2
...
74:                                               ; preds = %46
  ...
  %80 = getelementptr inbounds [3 x [1001 x i32]], [3 x [1001 x i32]]* %3, i64 0, i64 2
...
107:                                              ; preds = %103
  ...
  %109 = getelementptr inbounds [3 x [1001 x i32]], [3 x [1001 x i32]]* %3, i64 0, i64 1
...
115:                                              ; preds = %107
  ...
  %117 = getelementptr inbounds [3 x [1001 x i32]], [3 x [1001 x i32]]* %3, i64 0, i64 2
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_75_185.cpp() #0 section ".text.startup" {
