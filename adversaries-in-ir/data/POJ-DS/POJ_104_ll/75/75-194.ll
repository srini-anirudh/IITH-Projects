; ModuleID = 'POJ-104-source/75/75-194.cpp'
source_filename = "POJ-104-source/75/75-194.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_75_194.cpp, i8* null }]
...
26:                                               ; preds = %34, %22
  ...
  %32 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* %31)
  %33 = icmp ne i32 %32, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_75_194.cpp() #0 section ".text.startup" {
