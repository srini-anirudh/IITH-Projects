; ModuleID = 'POJ-104-source/75/75-201.cpp'
source_filename = "POJ-104-source/75/75-201.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_75_201.cpp, i8* null }]
...
26:                                               ; preds = %32, %23
  ...
  %30 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* %29)
  %31 = icmp ne i32 %30, 0
...
43:                                               ; preds = %49, %35
  ...
  %47 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* %46)
  %48 = icmp ne i32 %47, 0
...
98:                                               ; preds = %53
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* %99, i32* %101)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_75_201.cpp() #0 section ".text.startup" {
