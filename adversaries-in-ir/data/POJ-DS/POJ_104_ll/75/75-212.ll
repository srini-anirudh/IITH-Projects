; ModuleID = 'POJ-104-source/75/75-212.cpp'
source_filename = "POJ-104-source/75/75-212.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_75_212.cpp, i8* null }]
...
12:                                               ; preds = %30, %0
  ...
  %18 = getelementptr inbounds [10000 x i8], [10000 x i8]* %10, i64 0, i64 %17
...
34:                                               ; preds = %52, %33
  ...
  %41 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %37, i8* %40)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_75_212.cpp() #0 section ".text.startup" {
