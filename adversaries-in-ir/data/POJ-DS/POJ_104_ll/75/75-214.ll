; ModuleID = 'POJ-104-source/75/75-214.cpp'
source_filename = "POJ-104-source/75/75-214.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_75_214.cpp, i8* null }]
...
24:                                               ; preds = %20
  ...
  %27 = getelementptr inbounds [1000 x i32], [1000 x i32]* %12, i64 0, i64 %26
...
31:                                               ; preds = %20
  store i32 1, i32* %3, align 4
  %32 = getelementptr inbounds [1000 x i32], [1000 x i32]* %13, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_75_214.cpp() #0 section ".text.startup" {
