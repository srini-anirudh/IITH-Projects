; ModuleID = 'POJ-104-source/75/75-215.cpp'
source_filename = "POJ-104-source/75/75-215.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_75_215.cpp, i8* null }]
...
20:                                               ; preds = %31, %0
  ...
  %26 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* %16)
...
33:                                               ; preds = %44, %32
  ...
  %39 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* %16)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_75_215.cpp() #0 section ".text.startup" {
