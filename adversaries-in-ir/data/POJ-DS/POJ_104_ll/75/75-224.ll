; ModuleID = 'POJ-104-source/75/75-224.cpp'
source_filename = "POJ-104-source/75/75-224.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_75_224.cpp, i8* null }]
...
11:                                               ; preds = %17, %0
  ...
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %15, i8* %9)
  br label %17
...
22:                                               ; preds = %28, %21
  ...
  %27 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %26, i8* %9)
  br label %28
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_75_224.cpp() #0 section ".text.startup" {
