; ModuleID = 'POJ-104-source/75/75-226.cpp'
source_filename = "POJ-104-source/75/75-226.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_75_226.cpp, i8* null }]
...
10:                                               ; preds = %18, %0
  ...
  %15 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %14, i8* %2)
...
25:                                               ; preds = %33, %22
  ...
  %30 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %29, i8* %2)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_75_226.cpp() #0 section ".text.startup" {
