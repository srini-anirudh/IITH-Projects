; ModuleID = 'POJ-104-source/75/75-234.cpp'
source_filename = "POJ-104-source/75/75-234.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_75_234.cpp, i8* null }]
...
12:                                               ; preds = %25, %0
  ...
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %15, i8* %11)
...
29:                                               ; preds = %41, %26
  ...
  %33 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %32, i8* %11)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_75_234.cpp() #0 section ".text.startup" {
