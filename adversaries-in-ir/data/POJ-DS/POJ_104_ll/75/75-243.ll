; ModuleID = 'POJ-104-source/75/75-243.cpp'
source_filename = "POJ-104-source/75/75-243.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_75_243.cpp, i8* null }]
...
13:                                               ; preds = %10
  ...
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %16, i8* %7)
...
31:                                               ; preds = %27
  ...
  %35 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %34, i8* %7)
  br label %36
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_75_243.cpp() #0 section ".text.startup" {
