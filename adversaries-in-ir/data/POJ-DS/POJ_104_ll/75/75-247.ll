; ModuleID = 'POJ-104-source/75/75-247.cpp'
source_filename = "POJ-104-source/75/75-247.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_75_247.cpp, i8* null }]
...
111:                                              ; preds = %57
  ...
  %120 = call i32 @_Z3maxii(i32 %118, i32 %119)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_75_247.cpp() #0 section ".text.startup" {
