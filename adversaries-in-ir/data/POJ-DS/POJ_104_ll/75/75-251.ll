; ModuleID = 'POJ-104-source/75/75-251.cpp'
source_filename = "POJ-104-source/75/75-251.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_75_251.cpp, i8* null }]
...
16:                                               ; preds = %12
  ...
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %19, i8* %10)
  br label %21
...
29:                                               ; preds = %25
  ...
  %33 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %32, i8* %10)
  br label %34
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_75_251.cpp() #0 section ".text.startup" {
