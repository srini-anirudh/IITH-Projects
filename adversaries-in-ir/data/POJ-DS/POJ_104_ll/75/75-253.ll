; ModuleID = 'POJ-104-source/75/75-253.cpp'
source_filename = "POJ-104-source/75/75-253.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_75_253.cpp, i8* null }]
...
define dso_local void @_Z4scanv() #0 {
  %1 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* getelementptr inbounds ([1001 x i32], [1001 x i32]* @a, i64 0, i64 0))
  br label %2

2:                                                ; preds = %0, %15
  %3 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* @c)
...
16:                                               ; preds = %14
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* getelementptr inbounds ([1001 x i32], [1001 x i32]* @b, i64 0, i64 0))
  br label %18

18:                                               ; preds = %16, %31
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* @c)
...
26:                                               ; preds = %19
  ...
  %29 = getelementptr inbounds [1001 x i32], [1001 x i32]* @k, i64 0, i64 %28
...
40:                                               ; preds = %4
  %41 = load i32, i32* getelementptr inbounds ([1001 x i32], [1001 x i32]* @k, i64 0, i64 0), align 16
...
45:                                               ; preds = %42
  ...
  %49 = getelementptr inbounds [1001 x i32], [1001 x i32]* @k, i64 0, i64 %48
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_75_253.cpp() #0 section ".text.startup" {
