; ModuleID = 'POJ-104-source/75/75-261.cpp'
source_filename = "POJ-104-source/75/75-261.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_75_261.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %11 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %10, i8* %9)
  br label %12
...
16:                                               ; preds = %12
  ...
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %21, i8* %9)
  br label %12
...
23:                                               ; preds = %12
  ...
  %28 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %27, i8* %9)
  br label %29
...
33:                                               ; preds = %29
  ...
  %39 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %38, i8* %9)
  br label %29
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_75_261.cpp() #0 section ".text.startup" {
