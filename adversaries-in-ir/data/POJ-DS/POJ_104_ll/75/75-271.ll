; ModuleID = 'POJ-104-source/75/75-271.cpp'
source_filename = "POJ-104-source/75/75-271.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_75_271.cpp, i8* null }]
...
23:                                               ; preds = %9
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0))
  store i8 44, i8* %8, align 1
  store i32 0, i32* %3, align 4
  br label %25
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_75_271.cpp() #0 section ".text.startup" {
