; ModuleID = 'POJ-104-source/75/75-278.cpp'
source_filename = "POJ-104-source/75/75-278.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_75_278.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %10 = getelementptr inbounds [2000 x i32], [2000 x i32]* %2, i64 0, i64 1
...
21:                                               ; preds = %12
  %22 = getelementptr inbounds [2000 x i32], [2000 x i32]* %3, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_75_278.cpp() #0 section ".text.startup" {
