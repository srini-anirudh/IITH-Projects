; ModuleID = 'POJ-104-source/75/75-280.cpp'
source_filename = "POJ-104-source/75/75-280.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_75_280.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %12 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i8* %8)
  br label %13
...
37:                                               ; preds = %34, %21
  %38 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i8* %8)
  br label %13

39:                                               ; preds = %13
  %40 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i8* %8)
  store i32 0, i32* %2, align 4
  br label %41
...
65:                                               ; preds = %62, %49
  %66 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i8* %8)
  br label %41
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_75_280.cpp() #0 section ".text.startup" {
