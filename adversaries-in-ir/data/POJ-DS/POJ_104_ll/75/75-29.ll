; ModuleID = 'POJ-104-source/75/75-29.cpp'
source_filename = "POJ-104-source/75/75-29.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_75_29.cpp, i8* null }]
...
29:                                               ; preds = %37, %28
  ...
  %34 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* %8)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_75_29.cpp() #0 section ".text.startup" {
