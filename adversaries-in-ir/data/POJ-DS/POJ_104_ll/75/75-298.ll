; ModuleID = 'POJ-104-source/75/75-298.cpp'
source_filename = "POJ-104-source/75/75-298.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_75_298.cpp, i8* null }]
...
16:                                               ; preds = %13
  ...
  %23 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %19, i8* %22)
...
39:                                               ; preds = %36
  ...
  %46 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %42, i8* %45)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_75_298.cpp() #0 section ".text.startup" {
