; ModuleID = 'POJ-104-source/75/75-301.cpp'
source_filename = "POJ-104-source/75/75-301.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_75_301.cpp, i8* null }]
...
27:                                               ; preds = %24
  ...
  %31 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %30, i8* %10)
...
47:                                               ; preds = %43
  ...
  %51 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %50, i8* %10)
  br label %52
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_75_301.cpp() #0 section ".text.startup" {
