; ModuleID = 'POJ-104-source/75/75-306.cpp'
source_filename = "POJ-104-source/75/75-306.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_75_306.cpp, i8* null }]
...
13:                                               ; preds = %24, %0
  %14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %5, i8* %10)
...
30:                                               ; preds = %41, %27
  %31 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %5, i8* %10)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_75_306.cpp() #0 section ".text.startup" {
