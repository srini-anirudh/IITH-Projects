; ModuleID = 'POJ-104-source/75/75-307.cpp'
source_filename = "POJ-104-source/75/75-307.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_75_307.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %15 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %14, i8* %7)
...
24:                                               ; preds = %20
  ...
  %30 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %29, i8* %7)
...
52:                                               ; preds = %48
  ...
  %56 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i32* %55)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_75_307.cpp() #0 section ".text.startup" {
