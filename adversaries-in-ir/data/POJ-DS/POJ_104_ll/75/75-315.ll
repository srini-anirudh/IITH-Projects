; ModuleID = 'POJ-104-source/75/75-315.cpp'
source_filename = "POJ-104-source/75/75-315.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_75_315.cpp, i8* null }]
...
42:                                               ; preds = %28
  ...
  %46 = call i32 @_Z6qiumaxPii(i32* %44, i32 %45)
...
76:                                               ; preds = %47
  ...
  %79 = sub nsw i32 %78, 1
  %80 = call i32 @_Z6qiumaxPii(i32* %77, i32 %79)
...
define dso_local i32 @_Z6qiumaxPii(i32* %0, i32 %1) #6 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_75_315.cpp() #0 section ".text.startup" {
