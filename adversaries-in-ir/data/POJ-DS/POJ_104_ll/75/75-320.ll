; ModuleID = 'POJ-104-source/75/75-320.cpp'
source_filename = "POJ-104-source/75/75-320.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_75_320.cpp, i8* null }]
...
14:                                               ; preds = %21, %0
  ...
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %19, i8* %13)
  br label %21
...
27:                                               ; preds = %34, %25
  ...
  %33 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %32, i8* %13)
  br label %34
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_75_320.cpp() #0 section ".text.startup" {
