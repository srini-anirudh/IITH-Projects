; ModuleID = 'POJ-104-source/75/75-36.cpp'
source_filename = "POJ-104-source/75/75-36.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_75_36.cpp, i8* null }]
...
12:                                               ; preds = %21, %0
  %13 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %4, i8* %9)
  %14 = icmp ne i32 %13, 0
...
35:                                               ; preds = %44, %28
  %36 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %4, i8* %9)
  %37 = icmp ne i32 %36, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_75_36.cpp() #0 section ".text.startup" {
