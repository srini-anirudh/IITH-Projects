; ModuleID = 'POJ-104-source/75/75-376.cpp'
source_filename = "POJ-104-source/75/75-376.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_75_376.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %13 = getelementptr inbounds [1000 x i32], [1000 x i32]* %11, i64 0, i64 0
  %14 = bitcast i32* %13 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 16 %14, i8 0, i64 4000, i1 false)
  %15 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSi7getlineEPcl(%"class.std::basic_istream"* @_ZSt3cin, i8* getelementptr inbounds ([100000 x i8], [100000 x i8]* @a, i64 0, i64 0), i64 100000)
  %16 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSi7getlineEPcl(%"class.std::basic_istream"* @_ZSt3cin, i8* getelementptr inbounds ([100000 x i8], [100000 x i8]* @b, i64 0, i64 0), i64 100000)
...
75:                                               ; preds = %71
  ...
  %79 = getelementptr inbounds [100000 x i8], [100000 x i8]* @a, i64 0, i64 %78
  ...
  %85 = call i32 @_Z5powerii(i32 10, i32 %83)
...
108:                                              ; preds = %191, %107
  ...
  %111 = getelementptr inbounds [100000 x i8], [100000 x i8]* @b, i64 0, i64 %110
...
125:                                              ; preds = %121
  ...
  %129 = getelementptr inbounds [100000 x i8], [100000 x i8]* @b, i64 0, i64 %128
  ...
  %135 = call i32 @_Z5powerii(i32 10, i32 %133)
...
147:                                              ; preds = %108
  ...
  %150 = getelementptr inbounds [100000 x i8], [100000 x i8]* @b, i64 0, i64 %149
...
164:                                              ; preds = %160
  ...
  %168 = getelementptr inbounds [100000 x i8], [100000 x i8]* @b, i64 0, i64 %167
  ...
  %174 = call i32 @_Z5powerii(i32 10, i32 %172)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_75_376.cpp() #0 section ".text.startup" {
