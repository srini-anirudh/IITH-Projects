; ModuleID = 'POJ-104-source/75/75-40.cpp'
source_filename = "POJ-104-source/75/75-40.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_75_40.cpp, i8* null }]
...
22:                                               ; preds = %19
  ...
  %26 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %25, i8* %8)
...
64:                                               ; preds = %61
  ...
  %68 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %67, i8* %8)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_75_40.cpp() #0 section ".text.startup" {
