; ModuleID = 'POJ-104-source/75/75-43.cpp'
source_filename = "POJ-104-source/75/75-43.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_75_43.cpp, i8* null }]
...
13:                                               ; preds = %16, %0
  %14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i32* %6)
  %15 = icmp ne i32 %14, 0
...
23:                                               ; preds = %13
  %24 = getelementptr inbounds [5000 x i32], [5000 x i32]* %4, i64 0, i64 0
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %24)
  store i32 1, i32* %5, align 4
  br label %26

26:                                               ; preds = %29, %23
  %27 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i32* %6)
  %28 = icmp ne i32 %27, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_75_43.cpp() #0 section ".text.startup" {
