; ModuleID = 'POJ-104-source/75/75-45.cpp'
source_filename = "POJ-104-source/75/75-45.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_75_45.cpp, i8* null }]
...
31:                                               ; preds = %27
  ...
  %35 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %34, i8* %11)
  br label %36
...
39:                                               ; preds = %27
  %40 = getelementptr inbounds [2000 x i32], [2000 x i32]* %2, i64 0, i64 0
  %41 = load i32, i32* %40, align 16
  store i32 %41, i32* %5, align 4
  %42 = getelementptr inbounds [2000 x i32], [2000 x i32]* %3, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_75_45.cpp() #0 section ".text.startup" {
