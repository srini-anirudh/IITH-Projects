; ModuleID = 'POJ-104-source/75/75-452.cpp'
source_filename = "POJ-104-source/75/75-452.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_75_452.cpp, i8* null }]
...
77:                                               ; preds = %41
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([1004 x i32], [1004 x i32]* @tot, i64 0, i64 0), i32* getelementptr inbounds ([1004 x i32], [1004 x i32]* @tot, i64 0, i64 1001))
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_75_452.cpp() #0 section ".text.startup" {
