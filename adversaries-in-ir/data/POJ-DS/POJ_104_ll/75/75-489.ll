; ModuleID = 'POJ-104-source/75/75-489.cpp'
source_filename = "POJ-104-source/75/75-489.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_75_489.cpp, i8* null }]
...
30:                                               ; preds = %26
  ...
  %35 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %34, i8* %6)
  br label %36
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_75_489.cpp() #0 section ".text.startup" {
