; ModuleID = 'POJ-104-source/75/75-49.cpp'
source_filename = "POJ-104-source/75/75-49.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_75_49.cpp, i8* null }]
...
37:                                               ; preds = %61, %34
  ...
  %41 = getelementptr inbounds [4 x i8], [4 x i8]* %8, i64 0, i64 %40
...
52:                                               ; preds = %37
  ...
  %56 = getelementptr inbounds [4 x i8], [4 x i8]* %8, i64 0, i64 %55
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_75_49.cpp() #0 section ".text.startup" {
