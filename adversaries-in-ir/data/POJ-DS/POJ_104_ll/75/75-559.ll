; ModuleID = 'POJ-104-source/75/75-559.cpp'
source_filename = "POJ-104-source/75/75-559.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_75_559.cpp, i8* null }]
...
define dso_local void @_Z8char2intPiPcS_(i32* %0, i8* %1, i32* %2) #4 {
...
21:                                               ; preds = %44, %0
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i8* %2)
  %23 = icmp ne i32 %22, -1
...
46:                                               ; preds = %55, %45
  %47 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i8* %2)
  %48 = icmp ne i32 %47, -1
...
55:                                               ; preds = %53
  ...
  %60 = getelementptr inbounds [4000 x i8], [4000 x i8]* %4, i64 0, i64 %59
...
63:                                               ; preds = %53
  %64 = getelementptr inbounds [4000 x i8], [4000 x i8]* %3, i64 0, i64 0
  %65 = getelementptr inbounds [1000 x i32], [1000 x i32]* %5, i64 0, i64 0
  call void @_Z8char2intPiPcS_(i32* %10, i8* %64, i32* %65)
  %66 = getelementptr inbounds [4000 x i8], [4000 x i8]* %4, i64 0, i64 0
  %67 = getelementptr inbounds [1000 x i32], [1000 x i32]* %6, i64 0, i64 0
  call void @_Z8char2intPiPcS_(i32* %11, i8* %66, i32* %67)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_75_559.cpp() #0 section ".text.startup" {
