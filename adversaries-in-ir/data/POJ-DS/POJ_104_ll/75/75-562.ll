; ModuleID = 'POJ-104-source/75/75-562.cpp'
source_filename = "POJ-104-source/75/75-562.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_75_562.cpp, i8* null }]
...
28:                                               ; preds = %31, %25
  %29 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* %6)
...
43:                                               ; preds = %46, %40
  %44 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* %6)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_75_562.cpp() #0 section ".text.startup" {
