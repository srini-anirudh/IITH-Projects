; ModuleID = 'POJ-104-source/75/75-573.cpp'
source_filename = "POJ-104-source/75/75-573.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_75_573.cpp, i8* null }]
...
35:                                               ; preds = %33, %11
  %36 = bitcast [1000 x i32]* %8 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 16 %36, i8 0, i64 4000, i1 false)
  store i32 0, i32* %3, align 4
  br label %37
...
59:                                               ; preds = %57, %37
  %60 = bitcast [1000 x i32]* %9 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 16 %60, i8 0, i64 4000, i1 false)
  store i32 0, i32* %3, align 4
  br label %61
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_75_573.cpp() #0 section ".text.startup" {
