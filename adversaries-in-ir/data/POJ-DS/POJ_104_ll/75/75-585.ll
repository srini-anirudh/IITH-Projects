; ModuleID = 'POJ-104-source/75/75-585.cpp'
source_filename = "POJ-104-source/75/75-585.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_75_585.cpp, i8* null }]
...
38:                                               ; preds = %24
  %39 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSi3getERc(%"class.std::basic_istream"* @_ZSt3cin, i8* dereferenceable(1) %7)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_75_585.cpp() #0 section ".text.startup" {
