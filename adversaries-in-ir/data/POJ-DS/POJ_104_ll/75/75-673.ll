; ModuleID = 'POJ-104-source/75/75-673.cpp'
source_filename = "POJ-104-source/75/75-673.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_75_673.cpp, i8* null }]
...
41:                                               ; preds = %36
  ...
  %46 = call dereferenceable(280) %"class.std::basic_istream"* @_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_RS3_(%"class.std::basic_istream"* dereferenceable(280) %45, i8* dereferenceable(1) %9)
  br label %47
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_75_673.cpp() #0 section ".text.startup" {
