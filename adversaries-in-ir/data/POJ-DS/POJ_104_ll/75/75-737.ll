; ModuleID = 'POJ-104-source/75/75-737.cpp'
source_filename = "POJ-104-source/75/75-737.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_75_737.cpp, i8* null }]
...
16:                                               ; preds = %13
  ...
  %21 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %20, i8* %10)
...
37:                                               ; preds = %33
  ...
  %42 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %41, i8* %10)
  br label %43
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_75_737.cpp() #0 section ".text.startup" {
