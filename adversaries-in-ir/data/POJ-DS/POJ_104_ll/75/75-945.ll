; ModuleID = 'POJ-104-source/75/75-945.cpp'
source_filename = "POJ-104-source/75/75-945.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_75_945.cpp, i8* null }]
...
90:                                               ; preds = %53
  ...
  %91 = getelementptr inbounds [10000 x i32], [10000 x i32]* %4, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_75_945.cpp() #0 section ".text.startup" {
