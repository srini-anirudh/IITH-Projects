; ModuleID = 'POJ-104-source/75/75-994.cpp'
source_filename = "POJ-104-source/75/75-994.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_75_994.cpp, i8* null }]
...
13:                                               ; preds = %18, %0
  %14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* %8)
...
41:                                               ; preds = %37
  %42 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %6)
  %43 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* %8)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_75_994.cpp() #0 section ".text.startup" {
