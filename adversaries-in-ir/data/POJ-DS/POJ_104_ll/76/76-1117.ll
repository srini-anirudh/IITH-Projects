; ModuleID = 'POJ-104-source/76/76-1117.cpp'
source_filename = "POJ-104-source/76/76-1117.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_76_1117.cpp, i8* null }]
...
49:                                               ; preds = %36
  ...
  %57 = bitcast %struct.z* %56 to i8*
  %58 = bitcast %struct.z* %52 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %57, i8* align 8 %58, i64 8, i1 false)
  %59 = load i32, i32* %5, align 4
  %60 = add nsw i32 %59, 1
  %61 = sext i32 %60 to i64
  %62 = getelementptr inbounds [10000 x %struct.z], [10000 x %struct.z]* %3, i64 0, i64 %61
  %63 = load i32, i32* %5, align 4
  %64 = sext i32 %63 to i64
  %65 = getelementptr inbounds [10000 x %struct.z], [10000 x %struct.z]* %3, i64 0, i64 %64
  %66 = bitcast %struct.z* %65 to i8*
  %67 = bitcast %struct.z* %62 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_76_1117.cpp() #0 section ".text.startup" {
