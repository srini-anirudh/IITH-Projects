; ModuleID = 'POJ-104-source/76/76-1154.cpp'
source_filename = "POJ-104-source/76/76-1154.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_76_1154.cpp, i8* null }]
...
64:                                               ; preds = %60
  ...
  %77 = call i32 @_Z5judgeiii(i32 %68, i32 %72, i32 %76)
  %78 = icmp ne i32 %77, 0
...
115:                                              ; preds = %111
  ...
  %128 = call i32 @_Z5judgeiii(i32 %119, i32 %123, i32 %127)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_76_1154.cpp() #0 section ".text.startup" {
