; ModuleID = 'POJ-104-source/76/76-1184.cpp'
source_filename = "POJ-104-source/76/76-1184.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_76_1184.cpp, i8* null }]
...
172:                                              ; preds = %152
  %173 = getelementptr inbounds [50000 x i32], [50000 x i32]* %2, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_76_1184.cpp() #0 section ".text.startup" {
