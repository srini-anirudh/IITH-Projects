; ModuleID = 'POJ-104-source/76/76-1229.cpp'
source_filename = "POJ-104-source/76/76-1229.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_76_1229.cpp, i8* null }]
...
22:                                               ; preds = %18
  ...
  %44 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %37, i32* %43)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_76_1229.cpp() #0 section ".text.startup" {
