; ModuleID = 'POJ-104-source/76/76-1284.cpp'
source_filename = "POJ-104-source/76/76-1284.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_76_1284.cpp, i8* null }]
...
13:                                               ; preds = %9
  ...
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %16, i32* %19)
  br label %21
...
90:                                               ; preds = %25
  %91 = getelementptr inbounds [50000 x i32], [50000 x i32]* %7, i64 0, i64 0
...
132:                                              ; preds = %127
  %133 = getelementptr inbounds [50000 x i32], [50000 x i32]* %6, i64 0, i64 0
  %134 = load i32, i32* %133, align 16
  %135 = load i32, i32* %5, align 4
  %136 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 %134, i32 %135)
  br label %137
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_76_1284.cpp() #0 section ".text.startup" {
