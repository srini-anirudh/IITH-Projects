; ModuleID = 'POJ-104-source/76/76-1353.cpp'
source_filename = "POJ-104-source/76/76-1353.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_76_1353.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* %4)
...
40:                                               ; preds = %36
  ...
  %49 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32* %44, i32* %48)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_76_1353.cpp() #0 section ".text.startup" {
