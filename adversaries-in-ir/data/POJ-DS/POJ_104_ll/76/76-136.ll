; ModuleID = 'POJ-104-source/76/76-136.cpp'
source_filename = "POJ-104-source/76/76-136.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_76_136.cpp, i8* null }]
...
156:                                              ; preds = %151, %148
  %157 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %2)
  store i32 0, i32* %1, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_76_136.cpp() #0 section ".text.startup" {
