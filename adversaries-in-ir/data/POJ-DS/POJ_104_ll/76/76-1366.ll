; ModuleID = 'POJ-104-source/76/76-1366.cpp'
source_filename = "POJ-104-source/76/76-1366.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_76_1366.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %18, i32* %19)
...
29:                                               ; preds = %25
  ...
  %36 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %32, i32* %35)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_76_1366.cpp() #0 section ".text.startup" {
