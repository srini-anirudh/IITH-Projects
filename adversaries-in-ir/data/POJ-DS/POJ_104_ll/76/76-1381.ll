; ModuleID = 'POJ-104-source/76/76-1381.cpp'
source_filename = "POJ-104-source/76/76-1381.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_76_1381.cpp, i8* null }]
...
30:                                               ; preds = %26
  ...
  %37 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %33, i32* %36)
  br label %38
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_76_1381.cpp() #0 section ".text.startup" {
