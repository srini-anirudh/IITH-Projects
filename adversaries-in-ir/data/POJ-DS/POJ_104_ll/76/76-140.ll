; ModuleID = 'POJ-104-source/76/76-140.cpp'
source_filename = "POJ-104-source/76/76-140.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_76_140.cpp, i8* null }]
...
19:                                               ; preds = %15
  ...
  %26 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %22, i32* %25)
  br label %27
...
157:                                              ; preds = %148, %143
  %158 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %9)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_76_140.cpp() #0 section ".text.startup" {
