; ModuleID = 'POJ-104-source/76/76-1431.cpp'
source_filename = "POJ-104-source/76/76-1431.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_76_1431.cpp, i8* null }]
...
22:                                               ; preds = %12
  %23 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* %3)
  store i32 0, i32* %2, align 4
  br label %24
...
28:                                               ; preds = %24
  ...
  %35 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32* %31, i32* %34)
  br label %36
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_76_1431.cpp() #0 section ".text.startup" {
