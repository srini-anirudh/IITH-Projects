; ModuleID = 'POJ-104-source/76/76-1588.cpp'
source_filename = "POJ-104-source/76/76-1588.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_76_1588.cpp, i8* null }]
...
21:                                               ; preds = %17
  ...
  %28 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %24, i32* %27)
  br label %29
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_76_1588.cpp() #0 section ".text.startup" {
