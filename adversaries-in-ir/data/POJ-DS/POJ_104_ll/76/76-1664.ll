; ModuleID = 'POJ-104-source/76/76-1664.cpp'
source_filename = "POJ-104-source/76/76-1664.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_76_1664.cpp, i8* null }]
...
14:                                               ; preds = %10
  ...
  %23 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %18, i32* %22)
  br label %24
...
52:                                               ; preds = %39
  ...
  %61 = getelementptr inbounds [5000 x %struct.point], [5000 x %struct.point]* %7, i64 0, i64 %60
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_76_1664.cpp() #0 section ".text.startup" {
