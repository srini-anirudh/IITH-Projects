; ModuleID = 'POJ-104-source/76/76-1774.cpp'
source_filename = "POJ-104-source/76/76-1774.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_76_1774.cpp, i8* null }]
...
51:                                               ; preds = %38
  ...
  %60 = getelementptr inbounds [50001 x %struct.point], [50001 x %struct.point]* %2, i64 0, i64 %59
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_76_1774.cpp() #0 section ".text.startup" {
