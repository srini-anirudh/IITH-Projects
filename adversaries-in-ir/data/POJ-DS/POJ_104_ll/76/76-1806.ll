; ModuleID = 'POJ-104-source/76/76-1806.cpp'
source_filename = "POJ-104-source/76/76-1806.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_76_1806.cpp, i8* null }]
...
15:                                               ; preds = %11
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %7, i32* %8)
...
54:                                               ; preds = %41
  ...
  %63 = getelementptr inbounds [50002 x %struct.point], [50002 x %struct.point]* %2, i64 0, i64 %62
  ...
  %69 = bitcast %struct.point* %63 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_76_1806.cpp() #0 section ".text.startup" {
