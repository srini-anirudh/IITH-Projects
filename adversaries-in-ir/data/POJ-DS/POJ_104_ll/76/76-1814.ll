; ModuleID = 'POJ-104-source/76/76-1814.cpp'
source_filename = "POJ-104-source/76/76-1814.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_76_1814.cpp, i8* null }]
...
20:                                               ; preds = %15
  ...
  %27 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %23, i32* %26)
  br label %28
...
31:                                               ; preds = %15
  ...
  %40 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), i32* %35, i32* %39)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_76_1814.cpp() #0 section ".text.startup" {
