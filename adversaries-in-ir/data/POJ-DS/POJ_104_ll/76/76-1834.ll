; ModuleID = 'POJ-104-source/76/76-1834.cpp'
source_filename = "POJ-104-source/76/76-1834.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_76_1834.cpp, i8* null }]
...
27:                                               ; preds = %12
  store i32 1, i32* %2, align 4
  %28 = getelementptr inbounds [10000 x i32], [10000 x i32]* %8, i64 0, i64 1
...
50:                                               ; preds = %30
  %51 = getelementptr inbounds [10000 x i32], [10000 x i32]* %9, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_76_1834.cpp() #0 section ".text.startup" {
