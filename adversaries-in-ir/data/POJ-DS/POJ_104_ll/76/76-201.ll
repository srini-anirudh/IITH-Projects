; ModuleID = 'POJ-104-source/76/76-201.cpp'
source_filename = "POJ-104-source/76/76-201.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_76_201.cpp, i8* null }]
...
20:                                               ; preds = %16
  ...
  %29 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %24, i32* %28)
  br label %30
...
60:                                               ; preds = %47
  ...
  %69 = getelementptr inbounds %struct.Space, %struct.Space* %15, i64 %68
  %70 = load i32, i32* %4, align 4
  %71 = sext i32 %70 to i64
  %72 = getelementptr inbounds %struct.Space, %struct.Space* %15, i64 %71
  %73 = bitcast %struct.Space* %72 to i8*
  %74 = bitcast %struct.Space* %69 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_76_201.cpp() #0 section ".text.startup" {
