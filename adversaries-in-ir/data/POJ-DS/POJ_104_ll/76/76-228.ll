; ModuleID = 'POJ-104-source/76/76-228.cpp'
source_filename = "POJ-104-source/76/76-228.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_76_228.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %2 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* @e)
...
7:                                                ; preds = %3
  ...
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %11, i32* %15)
  br label %17
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_76_228.cpp() #0 section ".text.startup" {
