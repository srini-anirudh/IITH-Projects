; ModuleID = 'POJ-104-source/76/76-26.cpp'
source_filename = "POJ-104-source/76/76-26.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_76_26.cpp, i8* null }]
...
50:                                               ; preds = %37
  ...
  %63 = bitcast %struct.qujian* %62 to i8*
  %64 = bitcast %struct.qujian* %59 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_76_26.cpp() #0 section ".text.startup" {
