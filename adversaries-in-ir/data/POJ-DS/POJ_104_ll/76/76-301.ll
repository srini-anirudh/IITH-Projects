; ModuleID = 'POJ-104-source/76/76-301.cpp'
source_filename = "POJ-104-source/76/76-301.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_76_301.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %18, i32* %21)
  br label %23
...
169:                                              ; preds = %164
  ...
  %173 = getelementptr inbounds [50000 x i32], [50000 x i32]* %2, i64 0, i64 %172
  ...
  %180 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 %174, i32 %179)
  br label %181
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_76_301.cpp() #0 section ".text.startup" {
