; ModuleID = 'POJ-104-source/76/76-335.cpp'
source_filename = "POJ-104-source/76/76-335.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_76_335.cpp, i8* null }]
...
20:                                               ; preds = %16
  ...
  %27 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %23, i32* %26)
  br label %28
...
157:                                              ; preds = %152, %149
  ...
  %165 = getelementptr inbounds [10001 x i32], [10001 x i32]* %3, i64 0, i64 %164
...
168:                                              ; preds = %157
  ...
  %171 = getelementptr inbounds [10001 x i32], [10001 x i32]* %4, i64 0, i64 %170
...
190:                                              ; preds = %182
  ...
  %194 = getelementptr inbounds [10001 x i32], [10001 x i32]* %4, i64 0, i64 %193
...
200:                                              ; preds = %145
  ...
  %203 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.3, i64 0, i64 0), i32 %201, i32 %202)
  br label %204
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_76_335.cpp() #0 section ".text.startup" {
