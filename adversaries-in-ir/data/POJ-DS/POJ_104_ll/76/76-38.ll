; ModuleID = 'POJ-104-source/76/76-38.cpp'
source_filename = "POJ-104-source/76/76-38.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_76_38.cpp, i8* null }]
...
96:                                               ; preds = %93
  ...
  %99 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i64 0, i64 0), i32 %97, i32 %98)
  br label %100
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_76_38.cpp() #0 section ".text.startup" {
