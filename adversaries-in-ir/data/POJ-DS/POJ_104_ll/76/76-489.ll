; ModuleID = 'POJ-104-source/76/76-489.cpp'
source_filename = "POJ-104-source/76/76-489.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_76_489.cpp, i8* null }]
...
51:                                               ; preds = %38
  ...
  %65 = bitcast %struct.qj* %64 to i8*
  %66 = bitcast %struct.qj* %60 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_76_489.cpp() #0 section ".text.startup" {
