; ModuleID = 'POJ-104-source/76/76-505.cpp'
source_filename = "POJ-104-source/76/76-505.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_76_505.cpp, i8* null }]
...
18:                                               ; preds = %14
  ...
  %27 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %22, i32* %26)
  br label %28
...
82:                                               ; preds = %69
  ...
  %91 = getelementptr inbounds %struct.qj, %struct.qj* %13, i64 %90
  %92 = load i32, i32* %3, align 4
  %93 = sext i32 %92 to i64
  %94 = getelementptr inbounds %struct.qj, %struct.qj* %13, i64 %93
  %95 = bitcast %struct.qj* %94 to i8*
  %96 = bitcast %struct.qj* %91 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_76_505.cpp() #0 section ".text.startup" {
