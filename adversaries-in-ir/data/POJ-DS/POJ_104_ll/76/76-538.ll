; ModuleID = 'POJ-104-source/76/76-538.cpp'
source_filename = "POJ-104-source/76/76-538.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_76_538.cpp, i8* null }]
...
14:                                               ; preds = %10
  ...
  %23 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32* %18, i32* %22)
  br label %24
...
98:                                               ; preds = %85
  ...
  %107 = getelementptr inbounds [500 x %struct.piece], [500 x %struct.piece]* %7, i64 0, i64 %106
  %108 = load i32, i32* %3, align 4
  %109 = add nsw i32 %108, 1
  %110 = sext i32 %109 to i64
  %111 = getelementptr inbounds [500 x %struct.piece], [500 x %struct.piece]* %7, i64 0, i64 %110
  %112 = bitcast %struct.piece* %111 to i8*
  %113 = bitcast %struct.piece* %107 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_76_538.cpp() #0 section ".text.startup" {
