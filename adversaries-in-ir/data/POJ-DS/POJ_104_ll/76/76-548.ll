; ModuleID = 'POJ-104-source/76/76-548.cpp'
source_filename = "POJ-104-source/76/76-548.cpp"
...
@minleft = dso_local global i32 0, align 4
@maxright = dso_local global i32 0, align 4
@b = dso_local global [20000 x i32] zeroinitializer, align 16
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [4 x i8] c"no\0A\00", align 1
@.str.2 = private unnamed_addr constant [7 x i8] c"%d %d\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_76_548.cpp, i8* null }]
...
7:                                                ; preds = %3
  %8 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* @l)
  %9 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* @r)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_76_548.cpp() #0 section ".text.startup" {
