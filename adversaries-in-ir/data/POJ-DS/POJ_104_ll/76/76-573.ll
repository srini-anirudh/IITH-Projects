; ModuleID = 'POJ-104-source/76/76-573.cpp'
source_filename = "POJ-104-source/76/76-573.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_76_573.cpp, i8* null }]
...
define dso_local i32 @_Z4_insii(i32 %0, i32 %1) #4 {
...
100:                                              ; preds = %95
  ...
  %103 = call i32 @_Z4_insii(i32 %101, i32 %102)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_76_573.cpp() #0 section ".text.startup" {
