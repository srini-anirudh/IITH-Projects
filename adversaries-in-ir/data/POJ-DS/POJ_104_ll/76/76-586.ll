; ModuleID = 'POJ-104-source/76/76-586.cpp'
source_filename = "POJ-104-source/76/76-586.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_76_586.cpp, i8* null }]
...
27:                                               ; preds = %23
  ...
  %35 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* %34)
  br label %36
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_76_586.cpp() #0 section ".text.startup" {
