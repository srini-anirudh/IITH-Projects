; ModuleID = 'POJ-104-source/76/76-596.cpp'
source_filename = "POJ-104-source/76/76-596.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_76_596.cpp, i8* null }]
...
22:                                               ; preds = %18
  ...
  %31 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %26, i32* %30)
  br label %32
...
60:                                               ; preds = %47
  ...
  %69 = getelementptr inbounds %struct.l, %struct.l* %17, i64 %68
  %70 = load i32, i32* %3, align 4
  %71 = sext i32 %70 to i64
  %72 = getelementptr inbounds %struct.l, %struct.l* %17, i64 %71
  %73 = bitcast %struct.l* %72 to i8*
  %74 = bitcast %struct.l* %69 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_76_596.cpp() #0 section ".text.startup" {
