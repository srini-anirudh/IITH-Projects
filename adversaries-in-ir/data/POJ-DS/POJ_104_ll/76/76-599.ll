; ModuleID = 'POJ-104-source/76/76-599.cpp'
source_filename = "POJ-104-source/76/76-599.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_76_599.cpp, i8* null }]
...
20:                                               ; preds = %16
  ...
  %29 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %24, i32* %28)
  br label %30
...
58:                                               ; preds = %45
  ...
  %67 = getelementptr inbounds %struct.l, %struct.l* %15, i64 %66
  %68 = load i32, i32* %3, align 4
  %69 = sext i32 %68 to i64
  %70 = getelementptr inbounds %struct.l, %struct.l* %15, i64 %69
  %71 = bitcast %struct.l* %70 to i8*
  %72 = bitcast %struct.l* %67 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_76_599.cpp() #0 section ".text.startup" {
