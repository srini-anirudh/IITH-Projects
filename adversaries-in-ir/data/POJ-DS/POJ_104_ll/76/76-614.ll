; ModuleID = 'POJ-104-source/76/76-614.cpp'
source_filename = "POJ-104-source/76/76-614.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_76_614.cpp, i8* null }]
...
16:                                               ; preds = %12
  ...
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %20, i32* %24)
  br label %26
...
54:                                               ; preds = %41
  ...
  %58 = getelementptr inbounds [50000 x %struct.qj], [50000 x %struct.qj]* %10, i64 0, i64 %57
  %59 = load i32, i32* %2, align 4
  %60 = sext i32 %59 to i64
  %61 = getelementptr inbounds [50000 x %struct.qj], [50000 x %struct.qj]* %10, i64 0, i64 %60
  %62 = bitcast %struct.qj* %61 to i8*
  %63 = bitcast %struct.qj* %58 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_76_614.cpp() #0 section ".text.startup" {
