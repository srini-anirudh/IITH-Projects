; ModuleID = 'POJ-104-source/76/76-631.cpp'
source_filename = "POJ-104-source/76/76-631.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_76_631.cpp, i8* null }]
...
22:                                               ; preds = %18
  ...
  %29 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %25, i32* %28)
  br label %30
...
137:                                              ; preds = %134
  %138 = getelementptr inbounds i32, i32* %14, i64 0
  ...
  %145 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 %139, i32 %144)
  br label %146
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_76_631.cpp() #0 section ".text.startup" {
