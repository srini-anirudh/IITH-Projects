; ModuleID = 'POJ-104-source/76/76-721.cpp'
source_filename = "POJ-104-source/76/76-721.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_76_721.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32* %19, i32* %23)
  br label %25
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_76_721.cpp() #0 section ".text.startup" {
