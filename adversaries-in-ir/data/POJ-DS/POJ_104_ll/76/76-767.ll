; ModuleID = 'POJ-104-source/76/76-767.cpp'
source_filename = "POJ-104-source/76/76-767.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_76_767.cpp, i8* null }]
...
17:                                               ; preds = %13
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %5, i32* %6)
...
53:                                               ; preds = %37
  ...
  %56 = getelementptr inbounds [10000 x %struct.qujian], [10000 x %struct.qujian]* %2, i64 0, i64 %55
...
67:                                               ; preds = %63
  ...
  %70 = getelementptr inbounds [10000 x %struct.qujian], [10000 x %struct.qujian]* %2, i64 0, i64 %69
...
74:                                               ; preds = %67
  ...
  %77 = getelementptr inbounds [10000 x %struct.qujian], [10000 x %struct.qujian]* %2, i64 0, i64 %76
...
90:                                               ; preds = %87
  ...
  %93 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i64 0, i64 0), i32 %91, i32 %92)
  br label %94
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_76_767.cpp() #0 section ".text.startup" {
