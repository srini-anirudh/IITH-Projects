; ModuleID = 'POJ-104-source/76/76-770.cpp'
source_filename = "POJ-104-source/76/76-770.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_76_770.cpp, i8* null }]
...
67:                                               ; preds = %53
  ...
  %76 = bitcast %struct.ab* %75 to i8*
  %77 = bitcast %struct.ab* %71 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_76_770.cpp() #0 section ".text.startup" {
