; ModuleID = 'POJ-104-source/76/76-85.cpp'
source_filename = "POJ-104-source/76/76-85.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_76_85.cpp, i8* null }]
...
123:                                              ; preds = %121, %117
  %124 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i64 0, i64 0))
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_76_85.cpp() #0 section ".text.startup" {
