; ModuleID = 'POJ-104-source/76/76-931.cpp'
source_filename = "POJ-104-source/76/76-931.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_76_931.cpp, i8* null }]
...
19:                                               ; preds = %15
  ...
  %30 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %24, i32* %29)
  br label %31
...
61:                                               ; preds = %46
  ...
  %72 = getelementptr inbounds %struct.qj, %struct.qj* %68, i64 %71
  %73 = load %struct.qj*, %struct.qj** %4, align 8
  %74 = load i32, i32* %3, align 4
  %75 = sext i32 %74 to i64
  %76 = getelementptr inbounds %struct.qj, %struct.qj* %73, i64 %75
  %77 = bitcast %struct.qj* %76 to i8*
  %78 = bitcast %struct.qj* %72 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_76_931.cpp() #0 section ".text.startup" {
