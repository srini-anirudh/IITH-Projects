; ModuleID = 'POJ-104-source/76/76-992.cpp'
source_filename = "POJ-104-source/76/76-992.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_76_992.cpp, i8* null }]
...
13:                                               ; preds = %9
  ...
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %17, i32* %21)
  br label %23
...
51:                                               ; preds = %38
  ...
  %56 = getelementptr inbounds [50000 x %struct.qujian], [50000 x %struct.qujian]* %2, i64 0, i64 500
  %57 = bitcast %struct.qujian* %56 to i8*
  %58 = bitcast %struct.qujian* %55 to i8*
  ...
  %66 = bitcast %struct.qujian* %65 to i8*
  %67 = bitcast %struct.qujian* %61 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %66, i8* align 8 %67, i64 8, i1 false)
  %68 = getelementptr inbounds [50000 x %struct.qujian], [50000 x %struct.qujian]* %2, i64 0, i64 500
  ...
  %73 = bitcast %struct.qujian* %68 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_76_992.cpp() #0 section ".text.startup" {
