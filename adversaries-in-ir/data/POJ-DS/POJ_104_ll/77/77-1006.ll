; ModuleID = 'POJ-104-source/77/77-1006.cpp'
source_filename = "POJ-104-source/77/77-1006.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_77_1006.cpp, i8* null }]
...
32:                                               ; preds = %27
  ...
  %33 = bitcast [50 x i32]* %6 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 16 %33, i8 0, i64 200, i1 false)
  store i32 0, i32* %3, align 4
  br label %34
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_77_1006.cpp() #0 section ".text.startup" {
