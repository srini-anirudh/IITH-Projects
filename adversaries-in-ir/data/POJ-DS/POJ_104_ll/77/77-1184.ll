; ModuleID = 'POJ-104-source/77/77-1184.cpp'
source_filename = "POJ-104-source/77/77-1184.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_77_1184.cpp, i8* null }]
...
22:                                               ; preds = %12
  ...
  %24 = call dereferenceable(280) %"class.std::basic_istream"* @_ZNSi7getlineEPclc(%"class.std::basic_istream"* @_ZSt3cin, i8* %23, i64 110, i8 signext 10)
  store i32 0, i32* %4, align 4
  br label %25
...
88:                                               ; preds = %74
  ...
  %92 = getelementptr inbounds [60 x i32], [60 x i32]* %6, i64 0, i64 %91
...
143:                                              ; preds = %132
  ...
  %151 = getelementptr inbounds [60 x i32], [60 x i32]* %7, i64 0, i64 %150
  ...
  %160 = getelementptr inbounds [60 x i32], [60 x i32]* %7, i64 0, i64 %159
  ...
  %168 = getelementptr inbounds [60 x i32], [60 x i32]* %6, i64 0, i64 %167
  ...
  %177 = getelementptr inbounds [60 x i32], [60 x i32]* %6, i64 0, i64 %176
...
191:                                              ; preds = %187
  ...
  %194 = getelementptr inbounds [60 x i32], [60 x i32]* %6, i64 0, i64 %193
  ...
  %200 = getelementptr inbounds [60 x i32], [60 x i32]* %7, i64 0, i64 %199
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_77_1184.cpp() #0 section ".text.startup" {
