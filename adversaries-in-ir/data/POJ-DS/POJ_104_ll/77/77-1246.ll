; ModuleID = 'POJ-104-source/77/77-1246.cpp'
source_filename = "POJ-104-source/77/77-1246.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_77_1246.cpp, i8* null }]
...
66:                                               ; preds = %60
  ...
  %70 = getelementptr inbounds [50 x [2 x i32]], [50 x [2 x i32]]* %7, i64 0, i64 %69
...
107:                                              ; preds = %103
  ...
  %110 = getelementptr inbounds [50 x [2 x i32]], [50 x [2 x i32]]* %7, i64 0, i64 %109
  ...
  %117 = getelementptr inbounds [50 x [2 x i32]], [50 x [2 x i32]]* %7, i64 0, i64 %116
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_77_1246.cpp() #0 section ".text.startup" {
