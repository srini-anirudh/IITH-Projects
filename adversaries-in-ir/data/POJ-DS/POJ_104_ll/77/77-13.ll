; ModuleID = 'POJ-104-source/77/77-13.cpp'
source_filename = "POJ-104-source/77/77-13.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_77_13.cpp, i8* null }]
...
118:                                              ; preds = %109
  ...
  %122 = getelementptr inbounds [100 x %struct.anon], [100 x %struct.anon]* %8, i64 0, i64 %121
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_77_13.cpp() #0 section ".text.startup" {
