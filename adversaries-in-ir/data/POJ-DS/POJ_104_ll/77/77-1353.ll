; ModuleID = 'POJ-104-source/77/77-1353.cpp'
source_filename = "POJ-104-source/77/77-1353.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_77_1353.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z5matchii(i32 %0, i32 %1) #0 {
...
47:                                               ; preds = %46, %11
  ...
  %51 = call i32 @_Z5matchii(i32 %49, i32 %50)
  store i32 0, i32* %3, align 4
  br label %52
...
define dso_local i32 @main() #4 {
  ...
  %4 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([110 x i8], [110 x i8]* @line, i64 0, i64 0))
  %5 = call i64 @strlen(i8* getelementptr inbounds ([110 x i8], [110 x i8]* @line, i64 0, i64 0)) #6
...
30:                                               ; preds = %21, %8
  ...
  %32 = call i32 @_Z5matchii(i32 0, i32 %31)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_77_1353.cpp() #0 section ".text.startup" {
