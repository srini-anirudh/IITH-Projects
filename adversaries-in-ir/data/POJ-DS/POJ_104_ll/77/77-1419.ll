; ModuleID = 'POJ-104-source/77/77-1419.cpp'
source_filename = "POJ-104-source/77/77-1419.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_77_1419.cpp, i8* null }]
...
define dso_local i32 @_Z5solvev() #0 {
  ...
  %2 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i8* @c)
...
define dso_local i32 @main() #5 {
  %1 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i8* @c)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_77_1419.cpp() #0 section ".text.startup" {
