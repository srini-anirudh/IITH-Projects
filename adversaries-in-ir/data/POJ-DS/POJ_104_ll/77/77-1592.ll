; ModuleID = 'POJ-104-source/77/77-1592.cpp'
source_filename = "POJ-104-source/77/77-1592.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_77_1592.cpp, i8* null }]
...
define dso_local void @_Z6bubblePA2_ii([2 x i32]* %0, i32 %1) #4 {
...
131:                                              ; preds = %130, %39
  ...
  call void @_Z6bubblePA2_ii([2 x i32]* %132, i32 %133)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_77_1592.cpp() #0 section ".text.startup" {
