; ModuleID = 'POJ-104-source/77/77-165.cpp'
source_filename = "POJ-104-source/77/77-165.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_77_165.cpp, i8* null }]
...
define dso_local i32 @_Z3sumPiii(i32* %0, i32 %1, i32 %2) #4 {
...
77:                                               ; preds = %74
  ...
  %81 = call i32 @_Z3sumPiii(i32* %78, i32 %79, i32 %80)
  %82 = icmp eq i32 %81, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_77_165.cpp() #0 section ".text.startup" {
