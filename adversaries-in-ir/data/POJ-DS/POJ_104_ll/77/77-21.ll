; ModuleID = 'POJ-104-source/77/77-21.cpp'
source_filename = "POJ-104-source/77/77-21.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_77_21.cpp, i8* null }]
...
58:                                               ; preds = %47
  ...
  call void @_Z2prPciccPi(i8* %59, i32 %61, i8 signext %62, i8 signext %63, i32* %64)
...
; Function Attrs: noinline uwtable
define dso_local void @_Z2prPciccPi(i8* %0, i32 %1, i8 signext %2, i8 signext %3, i32* %4) #0 {
  %6 = alloca i8*, align 8
  %7 = alloca i32, align 4
  %8 = alloca i8, align 1
  %9 = alloca i8, align 1
...
78:                                               ; preds = %75
  ...
  call void @_Z2prPciccPi(i8* %79, i32 %81, i8 signext %82, i8 signext %83, i32* %84)
  br label %85
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_77_21.cpp() #0 section ".text.startup" {
