; ModuleID = 'POJ-104-source/77/77-306.cpp'
source_filename = "POJ-104-source/77/77-306.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_77_306.cpp, i8* null }]
...
112:                                              ; preds = %132, %98
  ...
  %116 = getelementptr inbounds [100 x %struct.children], [100 x %struct.children]* %8, i64 0, i64 %115
  %117 = getelementptr inbounds %struct.children, %struct.children* %116, i32 0, i32 1
...
122:                                              ; preds = %112
  ...
  %130 = bitcast %struct.children* %129 to i8*
...
146:                                              ; preds = %70
  ...
  %149 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32 0, i32 %148)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_77_306.cpp() #0 section ".text.startup" {
