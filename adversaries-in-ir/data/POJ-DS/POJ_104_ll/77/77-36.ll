; ModuleID = 'POJ-104-source/77/77-36.cpp'
source_filename = "POJ-104-source/77/77-36.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_77_36.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z2ouPcicc(i8* %0, i32 %1, i8 signext %2, i8 signext %3) #0 {
  %5 = alloca i8*, align 8
...
75:                                               ; preds = %67
  ...
  call void @_Z2ouPcicc(i8* %76, i32 %77, i8 signext %78, i8 signext %79)
  br label %80
...
define dso_local i32 @main() #4 {
  ...
  %8 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* %7)
...
37:                                               ; preds = %14
  ...
  call void @_Z2ouPcicc(i8* %38, i32 %39, i8 signext %40, i8 signext %41)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_77_36.cpp() #0 section ".text.startup" {
