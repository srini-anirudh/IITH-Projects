; ModuleID = 'POJ-104-source/77/77-39.cpp'
source_filename = "POJ-104-source/77/77-39.cpp"
...
@ida = dso_local global [10000 x i32] zeroinitializer, align 16
@idb = dso_local global [10000 x i32] zeroinitializer, align 16
@.str = private unnamed_addr constant [3 x i8] c"%c\00", align 1
@.str.1 = private unnamed_addr constant [7 x i8] c"%d %d\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_77_39.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %3 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i8* @a)
...
; Function Attrs: noinline uwtable
define dso_local void @_Z4testi(i32 %0) #0 {
  %2 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_77_39.cpp() #0 section ".text.startup" {
