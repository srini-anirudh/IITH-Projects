; ModuleID = 'POJ-104-source/77/77-409.cpp'
source_filename = "POJ-104-source/77/77-409.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_77_409.cpp, i8* null }]
...
89:                                               ; preds = %81
  ...
  %95 = mul nsw i32 -1, %94
  %96 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32 %92, i32 %95)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_77_409.cpp() #0 section ".text.startup" {
