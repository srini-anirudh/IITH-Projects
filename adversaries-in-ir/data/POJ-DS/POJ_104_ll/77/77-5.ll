; ModuleID = 'POJ-104-source/77/77-5.cpp'
source_filename = "POJ-104-source/77/77-5.cpp"
...
@ch = internal global [100 x %struct.anon] zeroinitializer, align 16
@.str = private unnamed_addr constant [7 x i8] c"%d %d\0A\00", align 1
@.str.1 = private unnamed_addr constant [3 x i8] c"%s\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_77_5.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z6chuliei(i32 %0) #0 {
...
define dso_local i32 @main() #4 {
  ...
  %9 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([100 x i8], [100 x i8]* @chr, i64 0, i64 0))
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_77_5.cpp() #0 section ".text.startup" {
