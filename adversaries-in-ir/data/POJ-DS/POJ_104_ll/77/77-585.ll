; ModuleID = 'POJ-104-source/77/77-585.cpp'
source_filename = "POJ-104-source/77/77-585.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_77_585.cpp, i8* null }]
...
61:                                               ; preds = %58
  ...
  call void @_Z5MatchPci(i8* %62, i32 %63)
  br label %64
...
65:                                               ; preds = %18
  ...
  call void @_Z5MatchPci(i8* %66, i32 %67)
  br label %68
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_77_585.cpp() #0 section ".text.startup" {
