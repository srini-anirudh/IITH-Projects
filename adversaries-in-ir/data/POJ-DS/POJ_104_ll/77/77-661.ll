; ModuleID = 'POJ-104-source/77/77-661.cpp'
source_filename = "POJ-104-source/77/77-661.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_77_661.cpp, i8* null }]
...
22:                                               ; preds = %11
  ...
  call void @_Z10handinhandPciicc(i8* %28, i32 %29, i32 %30, i8 signext %31, i8 signext %32)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define dso_local void @_Z10handinhandPciicc(i8* %0, i32 %1, i32 %2, i8 signext %3, i8 signext %4) #0 {
  %6 = alloca i8*, align 8
...
54:                                               ; preds = %48
  ...
  call void @_Z10handinhandPciicc(i8* %71, i32 %72, i32 %73, i8 signext %74, i8 signext %75)
  br label %76
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_77_661.cpp() #0 section ".text.startup" {
