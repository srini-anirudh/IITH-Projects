; ModuleID = 'POJ-104-source/77/77-77.cpp'
source_filename = "POJ-104-source/77/77-77.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_77_77.cpp, i8* null }]
...
130:                                              ; preds = %126
  ...
  %139 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32 %134, i32 %138)
  br label %140
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_77_77.cpp() #0 section ".text.startup" {
