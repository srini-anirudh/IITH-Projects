; ModuleID = 'POJ-104-source/77/77-848.cpp'
source_filename = "POJ-104-source/77/77-848.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_77_848.cpp, i8* null }]
...
103:                                              ; preds = %85, %76
  ...
  %106 = getelementptr inbounds [100000 x i8], [100000 x i8]* %2, i64 0, i64 %105
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_77_848.cpp() #0 section ".text.startup" {
