; ModuleID = 'POJ-104-source/78/78-1184.cpp'
source_filename = "POJ-104-source/78/78-1184.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_78_1184.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %10, i8* align 1 getelementptr inbounds ([4 x i8], [4 x i8]* @__const.main.n, i32 0, i32 0), i64 4, i1 false)
...
72:                                               ; preds = %66
  ...
  %78 = getelementptr inbounds [4 x i32], [4 x i32]* %8, i64 0, i64 2
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_78_1184.cpp() #0 section ".text.startup" {
