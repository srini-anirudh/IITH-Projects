; ModuleID = 'POJ-104-source/78/78-1681.cpp'
source_filename = "POJ-104-source/78/78-1681.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_78_1681.cpp, i8* null }]
...
73:                                               ; preds = %67
  ...
  %83 = getelementptr inbounds [4 x i8], [4 x i8]* %3, i64 0, i64 1
  store i8 113, i8* %83, align 1
  %84 = getelementptr inbounds [4 x i8], [4 x i8]* %3, i64 0, i64 2
  store i8 115, i8* %84, align 1
  %85 = getelementptr inbounds [4 x i8], [4 x i8]* %3, i64 0, i64 3
...
143:                                              ; preds = %86
  %144 = getelementptr inbounds [4 x i8], [4 x i8]* %3, i64 0, i64 0
  ...
  %153 = getelementptr inbounds [4 x i8], [4 x i8]* %3, i64 0, i64 1
  ...
  %162 = getelementptr inbounds [4 x i8], [4 x i8]* %3, i64 0, i64 2
  ...
  %171 = getelementptr inbounds [4 x i8], [4 x i8]* %3, i64 0, i64 3
  ...
  %178 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* %174, i32 %177)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_78_1681.cpp() #0 section ".text.startup" {
