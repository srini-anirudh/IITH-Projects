; ModuleID = 'POJ-104-source/78/78-429.cpp'
source_filename = "POJ-104-source/78/78-429.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_78_429.cpp, i8* null }]
...
111:                                              ; preds = %97
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* %112, i32* %114)
  store i32 0, i32* %9, align 4
  br label %115
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_78_429.cpp() #0 section ".text.startup" {
