; ModuleID = 'POJ-104-source/78/78-5.cpp'
source_filename = "POJ-104-source/78/78-5.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_78_5.cpp, i8* null }]
...
113:                                              ; preds = %106
  ...
  %115 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32 %114)
  br label %116
...
123:                                              ; preds = %116
  ...
  %125 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 %124)
  br label %126
...
133:                                              ; preds = %126
  ...
  %135 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), i32 %134)
  br label %136
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_78_5.cpp() #0 section ".text.startup" {
