; ModuleID = 'POJ-104-source/78/78-744.cpp'
source_filename = "POJ-104-source/78/78-744.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_78_744.cpp, i8* null }]
...
73:                                               ; preds = %47
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* %95, i32* %97)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_78_744.cpp() #0 section ".text.startup" {
