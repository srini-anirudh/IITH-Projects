; ModuleID = 'POJ-104-source/79/79-1004.cpp'
source_filename = "POJ-104-source/79/79-1004.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_1004.cpp, i8* null }]
...
17:                                               ; preds = %14
  ...
  %20 = call i32 @_Z4kingii(i32 %18, i32 %19)
...
define dso_local i32 @_Z4kingii(i32 %0, i32 %1) #6 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_1004.cpp() #0 section ".text.startup" {
