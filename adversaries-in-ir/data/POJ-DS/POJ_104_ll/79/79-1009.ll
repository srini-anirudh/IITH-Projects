; ModuleID = 'POJ-104-source/79/79-1009.cpp'
source_filename = "POJ-104-source/79/79-1009.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_1009.cpp, i8* null }]
...
12:                                               ; preds = %28, %0
  ...
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %15, i32* %18)
...
36:                                               ; preds = %32
  ...
  %37 = bitcast [300 x i32]* %9 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 16 %37, i8 0, i64 1200, i1 false)
  store i32 0, i32* %6, align 4
  br label %38
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_1009.cpp() #0 section ".text.startup" {
