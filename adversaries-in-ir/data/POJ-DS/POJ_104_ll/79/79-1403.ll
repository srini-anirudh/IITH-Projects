; ModuleID = 'POJ-104-source/79/79-1403.cpp'
source_filename = "POJ-104-source/79/79-1403.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_1403.cpp, i8* null }]
...
40:                                               ; preds = %35
  ...
  %49 = call i32 @_Z4remaii(i32 %44, i32 %48)
...
define dso_local i32 @_Z4remaii(i32 %0, i32 %1) #5 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_1403.cpp() #0 section ".text.startup" {
