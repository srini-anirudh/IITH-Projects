; ModuleID = 'POJ-104-source/79/79-152.cpp'
source_filename = "POJ-104-source/79/79-152.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_152.cpp, i8* null }]
...
15:                                               ; preds = %9
  ...
  %17 = call %struct.monckycircle* @_Z5creati(i32 %16)
...
23:                                               ; preds = %18
  ...
  call void @_Z7cry_123P12monckycirclei(%struct.monckycircle* %24, i32 %25)
  br label %18
...
33:                                               ; preds = %26, %12
  %34 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %2, i32* %3)
  br label %6
...
define dso_local %struct.monckycircle* @_Z5creati(i32 %0) #5 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  %4 = alloca %struct.monckycircle*, align 8
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z7cry_123P12monckycirclei(%struct.monckycircle* %0, i32 %1) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_152.cpp() #0 section ".text.startup" {
