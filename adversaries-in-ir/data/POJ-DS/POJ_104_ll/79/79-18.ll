; ModuleID = 'POJ-104-source/79/79-18.cpp'
source_filename = "POJ-104-source/79/79-18.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_18.cpp, i8* null }]
...
define dso_local i32 @_Z4heziPi(i32* %0) #4 {
...
16:                                               ; preds = %6
  ...
  %19 = call i32 @_Z3panii(i32 %17, i32 %18)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_18.cpp() #0 section ".text.startup" {
