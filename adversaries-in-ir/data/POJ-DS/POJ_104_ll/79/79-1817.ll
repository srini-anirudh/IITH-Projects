; ModuleID = 'POJ-104-source/79/79-1817.cpp'
source_filename = "POJ-104-source/79/79-1817.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_1817.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %9 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %4, i32* %2)
  br label %10
...
89:                                               ; preds = %24
  ...
  %93 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %4, i32* %2)
  br label %94
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_1817.cpp() #0 section ".text.startup" {
