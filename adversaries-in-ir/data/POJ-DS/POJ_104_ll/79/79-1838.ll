; ModuleID = 'POJ-104-source/79/79-1838.cpp'
source_filename = "POJ-104-source/79/79-1838.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_1838.cpp, i8* null }]
...
18:                                               ; preds = %111, %0
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %16, i32* %13)
  store i32 0, i32* %4, align 4
  store i32 1, i32* %12, align 4
  store i32 0, i32* %17, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_1838.cpp() #0 section ".text.startup" {
