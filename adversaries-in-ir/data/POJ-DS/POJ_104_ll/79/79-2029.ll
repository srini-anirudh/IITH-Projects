; ModuleID = 'POJ-104-source/79/79-2029.cpp'
source_filename = "POJ-104-source/79/79-2029.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_2029.cpp, i8* null }]
...
50:                                               ; preds = %43, %37
  ...
  %59 = call i32 @_Z8findkingii(i32 %54, i32 %58)
...
define dso_local i32 @_Z8findkingii(i32 %0, i32 %1) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_2029.cpp() #0 section ".text.startup" {
