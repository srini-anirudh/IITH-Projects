; ModuleID = 'POJ-104-source/79/79-2136.cpp'
source_filename = "POJ-104-source/79/79-2136.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_2136.cpp, i8* null }]
...
27:                                               ; preds = %25
  %28 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %5, i32* %6)
...
125:                                              ; preds = %120
  ...
  %128 = getelementptr inbounds [300 x i32], [300 x i32]* %13, i64 0, i64 %127
...
142:                                              ; preds = %67
  %143 = getelementptr inbounds [300 x i32], [300 x i32]* %12, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_2136.cpp() #0 section ".text.startup" {
