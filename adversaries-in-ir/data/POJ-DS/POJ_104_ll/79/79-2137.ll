; ModuleID = 'POJ-104-source/79/79-2137.cpp'
source_filename = "POJ-104-source/79/79-2137.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_2137.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %9, i32* %8)
...
27:                                               ; preds = %25
  %28 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %9, i32* %8)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_2137.cpp() #0 section ".text.startup" {
