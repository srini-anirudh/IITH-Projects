; ModuleID = 'POJ-104-source/79/79-2268.cpp'
source_filename = "POJ-104-source/79/79-2268.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_2268.cpp, i8* null }]
...
14:                                               ; preds = %10, %7
  ...
  %17 = call i32 @_Z3numii(i32 %15, i32 %16)
...
define dso_local i32 @_Z3numii(i32 %0, i32 %1) #5 {
  %3 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_2268.cpp() #0 section ".text.startup" {
