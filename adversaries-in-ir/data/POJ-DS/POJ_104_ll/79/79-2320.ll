; ModuleID = 'POJ-104-source/79/79-2320.cpp'
source_filename = "POJ-104-source/79/79-2320.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_2320.cpp, i8* null }]
...
25:                                               ; preds = %15
  %26 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %8, i32* %9)
  store i32 0, i32* %5, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_2320.cpp() #0 section ".text.startup" {
