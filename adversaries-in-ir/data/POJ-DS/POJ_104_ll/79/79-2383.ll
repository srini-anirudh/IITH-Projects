; ModuleID = 'POJ-104-source/79/79-2383.cpp'
source_filename = "POJ-104-source/79/79-2383.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_2383.cpp, i8* null }]
...
16:                                               ; preds = %12, %8
  ...
  %19 = call i32 @_Z3yueii(i32 %17, i32 %18)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_2383.cpp() #0 section ".text.startup" {
