; ModuleID = 'POJ-104-source/79/79-2696.cpp'
source_filename = "POJ-104-source/79/79-2696.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_2696.cpp, i8* null }]
...
define dso_local i32 @_Z7yuesefuPiii(i32* %0, i32 %1, i32 %2) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z6ascanfPii(i32* %0, i32 %1) #4 {
...
10:                                               ; preds = %7
  ...
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %14, i32* %18)
...
45:                                               ; preds = %41
  ...
  call void @_Z6ascanfPii(i32* %49, i32 %54)
  br label %55
...
64:                                               ; preds = %59
  ...
  %79 = call i32 @_Z7yuesefuPiii(i32* %68, i32 %73, i32 %78)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_2696.cpp() #0 section ".text.startup" {
