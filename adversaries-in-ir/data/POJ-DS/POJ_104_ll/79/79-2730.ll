; ModuleID = 'POJ-104-source/79/79-2730.cpp'
source_filename = "POJ-104-source/79/79-2730.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_2730.cpp, i8* null }]
...
13:                                               ; preds = %10
  ...
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %16, i32* %19)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_2730.cpp() #0 section ".text.startup" {
