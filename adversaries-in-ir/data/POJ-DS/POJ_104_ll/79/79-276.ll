; ModuleID = 'POJ-104-source/79/79-276.cpp'
source_filename = "POJ-104-source/79/79-276.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_276.cpp, i8* null }]
...
11:                                               ; preds = %6
  ...
  %14 = call i32 @_Z7houwangii(i32 %12, i32 %13)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_276.cpp() #0 section ".text.startup" {
