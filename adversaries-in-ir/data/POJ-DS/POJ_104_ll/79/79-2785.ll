; ModuleID = 'POJ-104-source/79/79-2785.cpp'
source_filename = "POJ-104-source/79/79-2785.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_2785.cpp, i8* null }]
...
define dso_local i32 @_Z4readv() #0 {
  ...
  %7 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %3, i32* %6)
  br label %8
...
17:                                               ; preds = %15
  ...
  %26 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %22, i32* %25)
  br label %8
...
; Function Attrs: noinline uwtable
define dso_local void @_Z6circlei(i32 %0) #0 {
...
18:                                               ; preds = %4
  ...
  call void @_Z6baoshuii(i32 %22, i32 1)
  ret void
}
...
; Function Attrs: noinline uwtable
define dso_local void @_Z6baoshuii(i32 %0, i32 %1) #0 {
  %3 = alloca i32, align 4
...
149:                                              ; preds = %148, %127
  ...
  call void @_Z6baoshuii(i32 %151, i32 %152)
  br label %153
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_2785.cpp() #0 section ".text.startup" {
