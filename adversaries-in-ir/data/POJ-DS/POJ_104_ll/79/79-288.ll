; ModuleID = 'POJ-104-source/79/79-288.cpp'
source_filename = "POJ-104-source/79/79-288.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_288.cpp, i8* null }]
...
12:                                               ; preds = %8, %4
  ...
  %15 = call i32 @_Z6Josephii(i32 %13, i32 %14)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_288.cpp() #0 section ".text.startup" {
