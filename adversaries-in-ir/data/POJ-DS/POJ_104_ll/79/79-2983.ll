; ModuleID = 'POJ-104-source/79/79-2983.cpp'
source_filename = "POJ-104-source/79/79-2983.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_2983.cpp, i8* null }]
...
15:                                               ; preds = %12
  ...
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32* %18, i32* %21)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_2983.cpp() #0 section ".text.startup" {
