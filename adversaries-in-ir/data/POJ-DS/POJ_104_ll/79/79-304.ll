; ModuleID = 'POJ-104-source/79/79-304.cpp'
source_filename = "POJ-104-source/79/79-304.cpp"
...
@link = dso_local global [300 x %struct.person] zeroinitializer, align 16
@.str = private unnamed_addr constant [5 x i8] c"%d%d\00", align 1
@.str.1 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_304.cpp, i8* null }]
...
16:                                               ; preds = %12
  ...
  %19 = getelementptr inbounds [300 x %struct.person], [300 x %struct.person]* @link, i64 0, i64 %18
...
28:                                               ; preds = %21, %16
  ...
  %32 = getelementptr inbounds [300 x %struct.person], [300 x %struct.person]* @link, i64 0, i64 %31
...
49:                                               ; preds = %45
  ...
  %52 = getelementptr inbounds [300 x %struct.person], [300 x %struct.person]* @link, i64 0, i64 %51
  %53 = getelementptr inbounds %struct.person, %struct.person* %52, i32 0, i32 1
  %54 = load i32, i32* %53, align 4
  store i32 %54, i32* %7, align 4
  %55 = load i32, i32* %7, align 4
  %56 = sext i32 %55 to i64
  %57 = getelementptr inbounds [300 x %struct.person], [300 x %struct.person]* @link, i64 0, i64 %56
...
65:                                               ; preds = %45
  ...
  %68 = getelementptr inbounds [300 x %struct.person], [300 x %struct.person]* @link, i64 0, i64 %67
...
7:                                                ; preds = %22, %0
  ...
  %14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %10, i32* %13)
...
31:                                               ; preds = %27
  ...
  %40 = call i32 @_Z4kingii(i32 %35, i32 %39)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_304.cpp() #0 section ".text.startup" {
