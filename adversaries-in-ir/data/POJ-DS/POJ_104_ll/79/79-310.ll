; ModuleID = 'POJ-104-source/79/79-310.cpp'
source_filename = "POJ-104-source/79/79-310.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_310.cpp, i8* null }]
...
40:                                               ; preds = %34
  ...
  %49 = call i32 @_Z1aii(i32 %44, i32 %48)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_310.cpp() #0 section ".text.startup" {
