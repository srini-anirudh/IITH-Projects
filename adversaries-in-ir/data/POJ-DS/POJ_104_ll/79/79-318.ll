; ModuleID = 'POJ-104-source/79/79-318.cpp'
source_filename = "POJ-104-source/79/79-318.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_318.cpp, i8* null }]
...
define dso_local i32 @_Z9calculateii(i32 %0, i32 %1) #4 {
...
12:                                               ; preds = %9
  ...
  %15 = call i32 @_Z9calculateii(i32 %13, i32 %14)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_318.cpp() #0 section ".text.startup" {
