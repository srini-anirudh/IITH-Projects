; ModuleID = 'POJ-104-source/79/79-3221.cpp'
source_filename = "POJ-104-source/79/79-3221.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_3221.cpp, i8* null }]
...
16:                                               ; preds = %13
  ...
  %23 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %19, i32* %22)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_3221.cpp() #0 section ".text.startup" {
