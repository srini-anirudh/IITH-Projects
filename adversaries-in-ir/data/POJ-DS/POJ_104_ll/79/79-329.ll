; ModuleID = 'POJ-104-source/79/79-329.cpp'
source_filename = "POJ-104-source/79/79-329.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_329.cpp, i8* null }]
...
define dso_local void @_Z1Pii(i32 %0, i32 %1) #4 {
...
13:                                               ; preds = %9, %5
  ...
  call void @_Z1Pii(i32 %14, i32 %15)
  br label %16
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_329.cpp() #0 section ".text.startup" {
