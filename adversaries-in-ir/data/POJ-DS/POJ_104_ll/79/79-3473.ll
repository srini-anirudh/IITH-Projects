; ModuleID = 'POJ-104-source/79/79-3473.cpp'
source_filename = "POJ-104-source/79/79-3473.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_3473.cpp, i8* null }]
...
13:                                               ; preds = %9, %5
  ...
  %16 = call i32 @_Z3funii(i32 %14, i32 %15)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_3473.cpp() #0 section ".text.startup" {
