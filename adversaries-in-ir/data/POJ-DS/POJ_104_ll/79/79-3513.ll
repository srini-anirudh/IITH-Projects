; ModuleID = 'POJ-104-source/79/79-3513.cpp'
source_filename = "POJ-104-source/79/79-3513.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_3513.cpp, i8* null }]
...
19:                                               ; preds = %10
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i64* %3, i64* %4)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_3513.cpp() #0 section ".text.startup" {
