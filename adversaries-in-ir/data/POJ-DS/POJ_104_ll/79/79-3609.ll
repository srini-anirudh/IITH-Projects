; ModuleID = 'POJ-104-source/79/79-3609.cpp'
source_filename = "POJ-104-source/79/79-3609.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_3609.cpp, i8* null }]
...
18:                                               ; preds = %145, %0
  ...
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %21, i32* %24)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_3609.cpp() #0 section ".text.startup" {
