; ModuleID = 'POJ-104-source/79/79-3755.cpp'
source_filename = "POJ-104-source/79/79-3755.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_3755.cpp, i8* null }]
...
39:                                               ; preds = %35
  ...
  call void @_Z6monkeyii(i32 %43, i32 %47)
  br label %48
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_3755.cpp() #0 section ".text.startup" {
