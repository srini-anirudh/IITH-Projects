; ModuleID = 'POJ-104-source/79/79-3756.cpp'
source_filename = "POJ-104-source/79/79-3756.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_3756.cpp, i8* null }]
...
98:                                               ; preds = %97, %21
  %99 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %2, i32* %3)
  br label %10
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_3756.cpp() #0 section ".text.startup" {
