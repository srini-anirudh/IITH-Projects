; ModuleID = 'POJ-104-source/79/79-3781.cpp'
source_filename = "POJ-104-source/79/79-3781.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_3781.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z6p_kingii(i32 %0, i32 %1) #0 {
...
5:                                                ; preds = %26, %0
  ...
  %7 = sext i32 %6 to i64
  %8 = getelementptr inbounds [20 x i32], [20 x i32]* %4, i64 0, i64 %7
...
43:                                               ; preds = %36, %30
  ...
  call void @_Z6p_kingii(i32 %47, i32 %51)
  br label %52
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_3781.cpp() #0 section ".text.startup" {
