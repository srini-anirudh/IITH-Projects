; ModuleID = 'POJ-104-source/79/79-3806.cpp'
source_filename = "POJ-104-source/79/79-3806.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_3806.cpp, i8* null }]
...
35:                                               ; preds = %31
  ...
  %44 = call i32 @_Z4exinii(i32 %39, i32 %43)
...
define dso_local i32 @_Z4exinii(i32 %0, i32 %1) #6 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_3806.cpp() #0 section ".text.startup" {
