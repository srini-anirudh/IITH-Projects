; ModuleID = 'POJ-104-source/79/79-3822.cpp'
source_filename = "POJ-104-source/79/79-3822.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_3822.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z4kingii(i32 %0, i32 %1) #0 {
...
6:                                                ; preds = %30, %0
  ...
  %8 = sext i32 %7 to i64
  %9 = getelementptr inbounds [30 x i32], [30 x i32]* %2, i64 0, i64 %8
  %10 = load i32, i32* %5, align 4
  %11 = sext i32 %10 to i64
  %12 = getelementptr inbounds [30 x i32], [30 x i32]* %3, i64 0, i64 %11
  %13 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %9, i32* %12)
  %14 = load i32, i32* %5, align 4
  %15 = add nsw i32 %14, 1
...
38:                                               ; preds = %33
  ...
  call void @_Z4kingii(i32 %42, i32 %46)
  br label %47
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_3822.cpp() #0 section ".text.startup" {
