; ModuleID = 'POJ-104-source/79/79-3884.cpp'
source_filename = "POJ-104-source/79/79-3884.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_3884.cpp, i8* null }]
...
16:                                               ; preds = %12, %8
  %17 = bitcast [301 x i32]* %6 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 16 %17, i8 0, i64 1204, i1 false)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_3884.cpp() #0 section ".text.startup" {
