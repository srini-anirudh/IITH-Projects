; ModuleID = 'POJ-104-source/79/79-3885.cpp'
source_filename = "POJ-104-source/79/79-3885.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_3885.cpp, i8* null }]
...
7:                                                ; preds = %4
  ...
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %11, i32* %15)
...
24:                                               ; preds = %7
  ...
  %35 = call i32 @_Z1fii(i32 %29, i32 %34)
  %36 = add nsw i32 %35, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_3885.cpp() #0 section ".text.startup" {
