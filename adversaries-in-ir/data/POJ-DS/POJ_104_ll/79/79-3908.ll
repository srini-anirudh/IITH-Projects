; ModuleID = 'POJ-104-source/79/79-3908.cpp'
source_filename = "POJ-104-source/79/79-3908.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_3908.cpp, i8* null }]
...
define dso_local i32 @_Z9init_linkP4link(%struct.link* %0) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z11insert_linkP4linki(%struct.link* %0, i32 %1) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z11delete_linkP4linkP4node(%struct.link* %0, %struct.node* %1) #4 {
  %3 = alloca %struct.link*, align 8
  %4 = alloca %struct.node*, align 8
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z12destroy_linkP4link(%struct.link* %0) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z5solveii(i32 %0, i32 %1) #4 {
  %3 = alloca i32, align 4
  ...
  %10 = call i32 @_Z9init_linkP4link(%struct.link* %8)
  store i32 1, i32* %5, align 4
  br label %11
...
15:                                               ; preds = %11
  ...
  %17 = call i32 @_Z11insert_linkP4linki(%struct.link* %8, i32 %16)
  br label %18
...
51:                                               ; preds = %29
  ...
  %53 = call i32 @_Z11delete_linkP4linkP4node(%struct.link* %8, %struct.node* %52)
  br label %54
...
57:                                               ; preds = %24
  ...
  %64 = call i32 @_Z12destroy_linkP4link(%struct.link* %8)
...
define dso_local i32 @main() #5 {
  ...
  %7 = call i32 @_Z9init_linkP4link(%struct.link* %5)
...
17:                                               ; preds = %15
  ...
  %20 = call i32 @_Z5solveii(i32 %18, i32 %19)
  store i32 %20, i32* %4, align 4
  %21 = load i32, i32* %4, align 4
  %22 = call i32 @_Z11insert_linkP4linki(%struct.link* %5, i32 %21)
  %23 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %2, i32* %3)
  br label %9
...
42:                                               ; preds = %27
  %43 = call i32 @_Z12destroy_linkP4link(%struct.link* %5)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_3908.cpp() #0 section ".text.startup" {
