; ModuleID = 'POJ-104-source/79/79-4027.cpp'
source_filename = "POJ-104-source/79/79-4027.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_4027.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z6josephii(i32 %0, i32 %1) #0 {
...
34:                                               ; preds = %32
  ...
  %43 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %39, i32* %42)
  br label %20
...
50:                                               ; preds = %46
  ...
  call void @_Z6josephii(i32 %54, i32 %58)
  br label %59
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_4027.cpp() #0 section ".text.startup" {
