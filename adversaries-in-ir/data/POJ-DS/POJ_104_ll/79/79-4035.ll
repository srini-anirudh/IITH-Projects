; ModuleID = 'POJ-104-source/79/79-4035.cpp'
source_filename = "POJ-104-source/79/79-4035.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_4035.cpp, i8* null }]
...
34:                                               ; preds = %30
  ...
  %43 = call i32 @_Z6monkeyii(i32 %38, i32 %42)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_4035.cpp() #0 section ".text.startup" {
