; ModuleID = 'POJ-104-source/79/79-4045.cpp'
source_filename = "POJ-104-source/79/79-4045.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_4045.cpp, i8* null }]
...
9:                                                ; preds = %6
  ...
  %12 = call i32 @_Z6dawangii(i32 %10, i32 %11)
...
define dso_local i32 @_Z6dawangii(i32 %0, i32 %1) #5 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_4045.cpp() #0 section ".text.startup" {
