; ModuleID = 'POJ-104-source/79/79-4096.cpp'
source_filename = "POJ-104-source/79/79-4096.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_4096.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %23 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %18, i32* %22)
  br label %24
...
38:                                               ; preds = %36
  ...
  %49 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %44, i32* %48)
  br label %24
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_4096.cpp() #0 section ".text.startup" {
