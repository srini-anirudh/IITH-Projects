; ModuleID = 'POJ-104-source/79/79-4192.cpp'
source_filename = "POJ-104-source/79/79-4192.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_4192.cpp, i8* null }]
...
39:                                               ; preds = %35
  ...
  %48 = call i32 @_Z2haii(i32 %43, i32 %47)
...
define dso_local i32 @_Z2haii(i32 %0, i32 %1) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_4192.cpp() #0 section ".text.startup" {
