; ModuleID = 'POJ-104-source/79/79-437.cpp'
source_filename = "POJ-104-source/79/79-437.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_437.cpp, i8* null }]
...
90:                                               ; preds = %71
  %91 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %6, i32* %7)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_437.cpp() #0 section ".text.startup" {
