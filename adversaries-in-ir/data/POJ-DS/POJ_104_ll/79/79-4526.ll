; ModuleID = 'POJ-104-source/79/79-4526.cpp'
source_filename = "POJ-104-source/79/79-4526.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_4526.cpp, i8* null }]
...
48:                                               ; preds = %41, %35
  %49 = getelementptr inbounds [301 x i32], [301 x i32]* %7, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_4526.cpp() #0 section ".text.startup" {
