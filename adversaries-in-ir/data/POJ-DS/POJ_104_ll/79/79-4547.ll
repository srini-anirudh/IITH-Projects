; ModuleID = 'POJ-104-source/79/79-4547.cpp'
source_filename = "POJ-104-source/79/79-4547.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_4547.cpp, i8* null }]
...
28:                                               ; preds = %25
  ...
  %35 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32* %18, i32* %19)
...
85:                                               ; preds = %75
  ...
  %88 = call i32 @_Z1sii(i32 %86, i32 %87)
  %89 = sub nsw i32 %88, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_4547.cpp() #0 section ".text.startup" {
