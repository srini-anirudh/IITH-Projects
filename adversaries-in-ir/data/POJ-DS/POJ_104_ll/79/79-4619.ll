; ModuleID = 'POJ-104-source/79/79-4619.cpp'
source_filename = "POJ-104-source/79/79-4619.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_4619.cpp, i8* null }]
...
107:                                              ; preds = %36
  %108 = getelementptr inbounds [300 x i32], [300 x i32]* %6, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_4619.cpp() #0 section ".text.startup" {
