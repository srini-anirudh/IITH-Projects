; ModuleID = 'POJ-104-source/79/79-4654.cpp'
source_filename = "POJ-104-source/79/79-4654.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_4654.cpp, i8* null }]
...
18:                                               ; preds = %14, %10
  ...
  %21 = call i32 @_Z7houwangii(i32 %19, i32 %20)
...
define dso_local i32 @_Z7houwangii(i32 %0, i32 %1) #5 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_4654.cpp() #0 section ".text.startup" {
