; ModuleID = 'POJ-104-source/79/79-4837.cpp'
source_filename = "POJ-104-source/79/79-4837.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_4837.cpp, i8* null }]
...
define dso_local i32 @_Z6josafeii(i32 %0, i32 %1) #4 {
...
7:                                                ; preds = %41, %0
  ...
  %14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %10, i32* %13)
...
27:                                               ; preds = %20, %7
  ...
  %36 = call i32 @_Z6josafeii(i32 %31, i32 %35)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_4837.cpp() #0 section ".text.startup" {
