; ModuleID = 'POJ-104-source/79/79-4897.cpp'
source_filename = "POJ-104-source/79/79-4897.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_4897.cpp, i8* null }]
...
153:                                              ; preds = %147
  %154 = getelementptr inbounds [300 x i32], [300 x i32]* %4, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_4897.cpp() #0 section ".text.startup" {
