; ModuleID = 'POJ-104-source/79/79-5245.cpp'
source_filename = "POJ-104-source/79/79-5245.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_5245.cpp, i8* null }]
...
11:                                               ; preds = %8
  ...
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %14, i32* %17)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_5245.cpp() #0 section ".text.startup" {
