; ModuleID = 'POJ-104-source/79/79-5305.cpp'
source_filename = "POJ-104-source/79/79-5305.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_5305.cpp, i8* null }]
...
10:                                               ; preds = %7
  ...
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %13, i32* %16)
...
39:                                               ; preds = %35
  ...
  %48 = call i32 @_Z7bianhaoii(i32 %43, i32 %47)
...
define dso_local i32 @_Z7bianhaoii(i32 %0, i32 %1) #5 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_5305.cpp() #0 section ".text.startup" {
