; ModuleID = 'POJ-104-source/79/79-5380.cpp'
source_filename = "POJ-104-source/79/79-5380.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_5380.cpp, i8* null }]
...
define dso_local i32 @_Z6remainPiii(i32* %0, i32 %1, i32 %2) #4 {
...
define dso_local i32 @main() #5 {
  ...
  %10 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %8, i32* %9)
...
27:                                               ; preds = %25
  ...
  %34 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %30, i32* %33)
  br label %35
...
72:                                               ; preds = %67
  ...
  %85 = call i32 @_Z6remainPiii(i32* %76, i32 %80, i32 %84)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_5380.cpp() #0 section ".text.startup" {
