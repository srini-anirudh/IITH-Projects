; ModuleID = 'POJ-104-source/79/79-5449.cpp'
source_filename = "POJ-104-source/79/79-5449.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_5449.cpp, i8* null }]
...
24:                                               ; preds = %20
  ...
  %28 = getelementptr inbounds [1000 x i32], [1000 x i32]* @mon, i64 0, i64 %27
...
32:                                               ; preds = %20
  ...
  call void @_Z5fkingPiii(i32* getelementptr inbounds ([1000 x i32], [1000 x i32]* @mon, i64 0, i64 0), i32 %33, i32 %34)
  br label %35
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5fkingPiii(i32* %0, i32 %1, i32 %2) #0 {
...
59:                                               ; preds = %38
  ...
  call void @_Z5fkingPiii(i32* %60, i32 %62, i32 %63)
  br label %140
...
129:                                              ; preds = %126
  ...
  call void @_Z5fkingPiii(i32* %130, i32 %132, i32 %133)
  br label %138
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_5449.cpp() #0 section ".text.startup" {
