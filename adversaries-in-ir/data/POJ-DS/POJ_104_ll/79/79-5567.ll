; ModuleID = 'POJ-104-source/79/79-5567.cpp'
source_filename = "POJ-104-source/79/79-5567.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_5567.cpp, i8* null }]
...
12:                                               ; preds = %8, %4
  ...
  call void @_Z6monkeyii(i32 %13, i32 %14)
  br label %4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_5567.cpp() #0 section ".text.startup" {
