; ModuleID = 'POJ-104-source/79/79-5711.cpp'
source_filename = "POJ-104-source/79/79-5711.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_5711.cpp, i8* null }]
...
16:                                               ; preds = %0, %38
  ...
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %20, i32* %24)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_5711.cpp() #0 section ".text.startup" {
