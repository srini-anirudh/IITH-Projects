; ModuleID = 'POJ-104-source/79/79-5935.cpp'
source_filename = "POJ-104-source/79/79-5935.cpp"
...
@king = dso_local global i32 0, align 4
@.str = private unnamed_addr constant [6 x i8] c"%d %d\00", align 1
@.str.1 = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.2 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_5935.cpp, i8* null }]
...
61:                                               ; preds = %97, %60
  ...
  %67 = call i32 @_Z9monkeynumPii(i32* %62, i32 %66)
  %68 = icmp ne i32 %67, 1
...
define dso_local i32 @_Z9monkeynumPii(i32* %0, i32 %1) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_5935.cpp() #0 section ".text.startup" {
