; ModuleID = 'POJ-104-source/79/79-6041.cpp'
source_filename = "POJ-104-source/79/79-6041.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_6041.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z4heheii(i32 %0, i32 %1) #0 {
...
9:                                                ; preds = %6
  ...
  %15 = getelementptr inbounds [15 x i32], [15 x i32]* %3, i64 0, i64 %14
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %12, i32* %15)
...
29:                                               ; preds = %22, %9
  %30 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0))
  br label %31
...
40:                                               ; preds = %36
  ...
  call void @_Z4heheii(i32 %44, i32 %48)
  br label %49
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_6041.cpp() #0 section ".text.startup" {
