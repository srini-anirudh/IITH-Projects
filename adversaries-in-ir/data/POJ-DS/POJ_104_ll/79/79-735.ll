; ModuleID = 'POJ-104-source/79/79-735.cpp'
source_filename = "POJ-104-source/79/79-735.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_735.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z4jianii(i32 %0, i32 %1) #0 {
...
8:                                                ; preds = %23, %0
  ...
  %15 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %11, i32* %14)
...
31:                                               ; preds = %27
  ...
  %40 = call i32 @_Z4jianii(i32 %35, i32 %39)
  br label %41
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_735.cpp() #0 section ".text.startup" {
