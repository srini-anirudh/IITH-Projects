; ModuleID = 'POJ-104-source/79/79-804.cpp'
source_filename = "POJ-104-source/79/79-804.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_804.cpp, i8* null }]
...
define dso_local i32 @_Z7guowangii(i32 %0, i32 %1) #4 {
...
27:                                               ; preds = %20, %7
  ...
  %36 = call i32 @_Z7guowangii(i32 %31, i32 %35)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_804.cpp() #0 section ".text.startup" {
