; ModuleID = 'POJ-104-source/79/79-827.cpp'
source_filename = "POJ-104-source/79/79-827.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_827.cpp, i8* null }]
...
define dso_local i32 @_Z6josephii(i32 %0, i32 %1) #4 {
...
31:                                               ; preds = %27
  ...
  %40 = call i32 @_Z6josephii(i32 %35, i32 %39)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_827.cpp() #0 section ".text.startup" {
