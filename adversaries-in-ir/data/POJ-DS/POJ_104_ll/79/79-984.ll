; ModuleID = 'POJ-104-source/79/79-984.cpp'
source_filename = "POJ-104-source/79/79-984.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_79_984.cpp, i8* null }]
...
define dso_local %struct.mon* @_Z3appi(i32 %0) #4 {
...
define dso_local void @_Z6shuchuii(i32 %0, i32 %1) #0 {
  ...
  %8 = call %struct.mon* @_Z3appi(i32 %7)
...
8:                                                ; preds = %5
  %9 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %2, i32* %3)
...
18:                                               ; preds = %15
  ...
  call void @_Z6shuchuii(i32 %19, i32 %20)
  br label %22
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_79_984.cpp() #0 section ".text.startup" {
