; ModuleID = 'POJ-104-source/8/8-1009.cpp'
source_filename = "POJ-104-source/8/8-1009.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_1009.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z4scanv(%struct.HaHa* noalias sret %0) #0 {
  ...
  %6 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %4, i32* %5)
...
define dso_local void @_Z4line4HaHa(%struct.HaHa* noalias sret %0, %struct.HaHa* byval(%struct.HaHa) align 8 %1) #4 {
  %3 = alloca i32, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z7combine4HaHa(%struct.HaHa* noalias sret %0, %struct.HaHa* byval(%struct.HaHa) align 8 %1) #4 {
  %3 = alloca i32, align 4
  store i32 0, i32* %3, align 4
  br label %4
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5print4HaHa(%struct.HaHa* byval(%struct.HaHa) align 8 %0) #0 {
  %2 = alloca i32, align 4
  store i32 0, i32* %2, align 4
  br label %3
...
define dso_local i32 @main() #6 {
  ...
  call void @_Z4scanv(%struct.HaHa* sret %3)
  call void @_Z4line4HaHa(%struct.HaHa* sret %2, %struct.HaHa* byval(%struct.HaHa) align 8 %3)
  call void @_Z7combine4HaHa(%struct.HaHa* sret %1, %struct.HaHa* byval(%struct.HaHa) align 8 %2)
  call void @_Z5print4HaHa(%struct.HaHa* byval(%struct.HaHa) align 8 %1)
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_1009.cpp() #0 section ".text.startup" {
