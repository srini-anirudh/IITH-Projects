; ModuleID = 'POJ-104-source/8/8-1020.cpp'
source_filename = "POJ-104-source/8/8-1020.cpp"
...
@f = dso_local global [200 x i32] zeroinitializer, align 16
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [4 x i8] c"%d \00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_1020.cpp, i8* null }]
...
30:                                               ; preds = %18
  %31 = call i32 @_Z4paibv()
  %32 = call i32 @_Z4paicv()
  %33 = call i32 @_Z3addv()
  %34 = call i32 @_Z4showv()
  ret i32 0
}

; Function Attrs: noinline uwtable
define dso_local i32 @_Z2duv() #0 {
  %1 = alloca i32, align 4
...
define dso_local i32 @_Z4paibv() #5 {
  %1 = alloca i32, align 4
  %2 = alloca i32, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z4paicv() #5 {
  %1 = alloca i32, align 4
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  store i32 0, i32* %1, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z3addv() #5 {
  %1 = alloca i32, align 4
  store i32 0, i32* %1, align 4
  br label %2
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z4showv() #0 {
  %1 = alloca i32, align 4
  store i32 0, i32* %1, align 4
  br label %2
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_1020.cpp() #0 section ".text.startup" {
