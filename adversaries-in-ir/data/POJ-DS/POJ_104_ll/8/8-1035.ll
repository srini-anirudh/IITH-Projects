; ModuleID = 'POJ-104-source/8/8-1035.cpp'
source_filename = "POJ-104-source/8/8-1035.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_1035.cpp, i8* null }]
...
define dso_local i32 @main() #5 {
  ...
  call void @_Z5paixuPii(i32* getelementptr inbounds ([100 x i32], [100 x i32]* @shuzu1, i64 0, i64 0), i32 %1)
  %2 = load i32, i32* @n2, align 4
  call void @_Z5paixuPii(i32* getelementptr inbounds ([100 x i32], [100 x i32]* @shuzu2, i64 0, i64 0), i32 %2)
  %3 = load i32, i32* @n1, align 4
  %4 = load i32, i32* @n2, align 4
  call void @_Z6hebingPiS_ii(i32* getelementptr inbounds ([100 x i32], [100 x i32]* @shuzu1, i64 0, i64 0), i32* getelementptr inbounds ([100 x i32], [100 x i32]* @shuzu2, i64 0, i64 0), i32 %3, i32 %4)
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_1035.cpp() #0 section ".text.startup" {
