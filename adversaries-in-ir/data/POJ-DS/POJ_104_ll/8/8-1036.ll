; ModuleID = 'POJ-104-source/8/8-1036.cpp'
source_filename = "POJ-104-source/8/8-1036.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_1036.cpp, i8* null }]
...
37:                                               ; preds = %33
  ...
  %42 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %41)
  br label %43
...
define dso_local void @_Z5orderiiPiS_(i32 %0, i32 %1, i32* %2, i32* %3) #4 {
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z4combiiPiS_S_(i32 %0, i32 %1, i32* %2, i32* %3, i32* %4) #4 {
  %6 = alloca i32, align 4
  %7 = alloca i32, align 4
  %8 = alloca i32*, align 8
...
define dso_local i32 @main() #5 {
  ...
  call void @_Z5inputPiS_(i32* %4, i32* %5)
  ...
  call void @_Z5orderiiPiS_(i32 %7, i32 %9, i32* %10, i32* %11)
  ...
  call void @_Z4combiiPiS_S_(i32 %13, i32 %15, i32* %16, i32* %17, i32* %18)
  ...
  call void @_Z5printiiPi(i32 %20, i32 %22, i32* %23)
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_1036.cpp() #0 section ".text.startup" {
