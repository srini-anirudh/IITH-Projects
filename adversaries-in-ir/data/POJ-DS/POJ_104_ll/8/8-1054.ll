; ModuleID = 'POJ-104-source/8/8-1054.cpp'
source_filename = "POJ-104-source/8/8-1054.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_1054.cpp, i8* null }]
...
define dso_local void @_Z4sortv() #0 {
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([100 x i32], [100 x i32]* @a, i64 0, i64 0), i32* %3)
  %4 = load i32, i32* @n, align 4
  %5 = sext i32 %4 to i64
  %6 = getelementptr inbounds i32, i32* getelementptr inbounds ([100 x i32], [100 x i32]* @b, i64 0, i64 0), i64 %5
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([100 x i32], [100 x i32]* @b, i64 0, i64 0), i32* %6)
  ret void
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_1054.cpp() #0 section ".text.startup" {
