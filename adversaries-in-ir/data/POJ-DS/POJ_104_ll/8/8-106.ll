; ModuleID = 'POJ-104-source/8/8-106.cpp'
source_filename = "POJ-104-source/8/8-106.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_106.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z8loaddatav() #0 {
...
define dso_local void @_Z7arrsortv() #4 {
  %1 = alloca i32, align 4
...
define dso_local i32 @main() #5 {
  %1 = alloca i32, align 4
  store i32 0, i32* %1, align 4
  call void @_Z8loaddatav()
  call void @_Z7arrsortv()
  call void @_Z3addv()
  call void @_Z5printv()
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_106.cpp() #0 section ".text.startup" {
