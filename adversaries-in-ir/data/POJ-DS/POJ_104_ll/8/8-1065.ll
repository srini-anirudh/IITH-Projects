; ModuleID = 'POJ-104-source/8/8-1065.cpp'
source_filename = "POJ-104-source/8/8-1065.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_1065.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z6passedii(i32 %0, i32 %1) #0 {
...
define dso_local i32 @main() #4 {
  ...
  %2 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), i32* @n, i32* @m)
  store i32 0, i32* @i, align 4
  br label %3
...
28:                                               ; preds = %16
  ...
  call void @_Z6passedii(i32 %29, i32 %30)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_1065.cpp() #0 section ".text.startup" {
