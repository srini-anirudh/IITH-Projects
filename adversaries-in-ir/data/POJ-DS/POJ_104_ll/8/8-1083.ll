; ModuleID = 'POJ-104-source/8/8-1083.cpp'
source_filename = "POJ-104-source/8/8-1083.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_1083.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z4shitPii(i32* %0, i32 %1) #0 {
...
; Function Attrs: noinline uwtable
define dso_local void @_Z4damnPii(i32* %0, i32 %1) #0 {
  %3 = alloca i32*, align 8
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
define dso_local i32 @main() #4 {
  ...
  %5 = call i32 @_Z5inputv()
  store i32 %5, i32* %1, align 4
  %6 = call i32 @_Z5inputv()
  store i32 %6, i32* %2, align 4
  %7 = getelementptr inbounds [1000 x i32], [1000 x i32]* %3, i64 0, i64 0
  %8 = load i32, i32* %1, align 4
  call void @_Z4shitPii(i32* %7, i32 %8)
  %9 = getelementptr inbounds [1000 x i32], [1000 x i32]* %4, i64 0, i64 0
  %10 = load i32, i32* %2, align 4
  call void @_Z4damnPii(i32* %9, i32 %10)
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_1083.cpp() #0 section ".text.startup" {
