; ModuleID = 'POJ-104-source/8/8-1099.cpp'
source_filename = "POJ-104-source/8/8-1099.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_1099.cpp, i8* null }]
...
43:                                               ; preds = %31
  ...
  call void @qsort(i8* %44, i64 %46, i64 4, i32 (i8*, i8*)* @_Z4compPKvS0_)
  %47 = bitcast i32* %17 to i8*
  %48 = load i32, i32* %3, align 4
  %49 = sext i32 %48 to i64
  call void @qsort(i8* %47, i64 %49, i64 4, i32 (i8*, i8*)* @_Z4compPKvS0_)
  store i32 0, i32* %4, align 4
  br label %50
...
define dso_local i32 @_Z4compPKvS0_(i8* %0, i8* %1) #5 {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_1099.cpp() #0 section ".text.startup" {
