; ModuleID = 'POJ-104-source/8/8-11.cpp'
source_filename = "POJ-104-source/8/8-11.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_11.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z4readPiiS_i(i32* %0, i32 %1, i32* %2, i32 %3) #0 {
...
; Function Attrs: noinline uwtable
define dso_local void @_Z7combinePiiS_i(i32* %0, i32 %1, i32* %2, i32 %3) #0 {
  %5 = alloca i32*, align 8
  %6 = alloca i32, align 4
  %7 = alloca i32*, align 8
  %8 = alloca i32, align 4
...
define dso_local i32 @main() #5 {
  ...
  %4 = alloca i32, align 4
  %5 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), i32* %3, i32* %4)
  ...
  call void @_Z4readPiiS_i(i32* %6, i32 %7, i32* %8, i32 %9)
  ...
  call void @_Z7combinePiiS_i(i32* %14, i32 %15, i32* %16, i32 %17)
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_11.cpp() #0 section ".text.startup" {
