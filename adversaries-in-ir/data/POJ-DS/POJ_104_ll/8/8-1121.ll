; ModuleID = 'POJ-104-source/8/8-1121.cpp'
source_filename = "POJ-104-source/8/8-1121.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_1121.cpp, i8* null }]
...
define dso_local i32 @main() #6 {
  ...
  %28 = call i32 @_Z7combinePiS_iiS_(i32* %23, i32* %24, i32 %25, i32 %26, i32* %27)
  %29 = getelementptr inbounds [2000 x i32], [2000 x i32]* %6, i64 0, i64 0
  %30 = load i32, i32* %2, align 4
  %31 = load i32, i32* %3, align 4
  %32 = add nsw i32 %30, %31
  %33 = call i32 @_Z6outputPii(i32* %29, i32 %32)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_1121.cpp() #0 section ".text.startup" {
