; ModuleID = 'POJ-104-source/8/8-1150.cpp'
source_filename = "POJ-104-source/8/8-1150.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_1150.cpp, i8* null }]
...
37:                                               ; preds = %33
  ...
  %41 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i32* %40)
  br label %42
...
143:                                              ; preds = %95
  %144 = getelementptr inbounds i32, i32* %15, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_1150.cpp() #0 section ".text.startup" {
