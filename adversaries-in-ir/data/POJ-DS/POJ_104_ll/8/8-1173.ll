; ModuleID = 'POJ-104-source/8/8-1173.cpp'
source_filename = "POJ-104-source/8/8-1173.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_1173.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @_Z3scaii(i32 %4, i32 1)
  %5 = load i32, i32* %2, align 4
  call void @_Z3scaii(i32 %5, i32 2)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define dso_local void @_Z3scaii(i32 %0, i32 %1) #0 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_1173.cpp() #0 section ".text.startup" {
