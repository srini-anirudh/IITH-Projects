; ModuleID = 'POJ-104-source/8/8-1190.cpp'
source_filename = "POJ-104-source/8/8-1190.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_1190.cpp, i8* null }]
...
define dso_local void @_Z1GPi(i32* %0) #4 {
...
; Function Attrs: noinline uwtable
define dso_local void @_Z1FPiS_(i32* %0, i32* %1) #0 {
  ...
  call void @_Z1GPi(i32* %7)
  %8 = load i32*, i32** %4, align 8
  call void @_Z1gPi(i32* %8)
...
define dso_local i32 @main() #5 {
  ...
  %6 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), i32* @j, i32* @k)
...
32:                                               ; preds = %20
  ...
  call void @_Z1FPiS_(i32* %33, i32* %34)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_1190.cpp() #0 section ".text.startup" {
