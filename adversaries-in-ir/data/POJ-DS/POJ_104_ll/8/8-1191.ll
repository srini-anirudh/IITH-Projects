; ModuleID = 'POJ-104-source/8/8-1191.cpp'
source_filename = "POJ-104-source/8/8-1191.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_1191.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @_Z8getarrayv()
  %2 = load i32, i32* @m, align 4
  call void @_Z5paixuPii(i32* getelementptr inbounds ([200 x i32], [200 x i32]* @a, i64 0, i64 0), i32 %2)
  %3 = load i32, i32* @n, align 4
  call void @_Z5paixuPii(i32* getelementptr inbounds ([100 x i32], [100 x i32]* @b, i64 0, i64 0), i32 %3)
  call void @_Z5hebinv()
  call void @_Z5printv()
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define dso_local void @_Z8getarrayv() #0 {
  %1 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_1191.cpp() #0 section ".text.startup" {
