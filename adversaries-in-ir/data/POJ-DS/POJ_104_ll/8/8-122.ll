; ModuleID = 'POJ-104-source/8/8-122.cpp'
source_filename = "POJ-104-source/8/8-122.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_122.cpp, i8* null }]
...
22:                                               ; preds = %10
  %23 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0))
  store i32 0, i32* %4, align 4
  br label %24
...
36:                                               ; preds = %24
  ...
  %38 = getelementptr inbounds [1000 x i32], [1000 x i32]* %8, i64 0, i64 0
  %39 = load i32, i32* %2, align 4
  %40 = load i32, i32* %3, align 4
  call void @_Z4linePiS_ii(i32* %37, i32* %38, i32 %39, i32 %40)
...
; Function Attrs: noinline uwtable
define dso_local void @_Z4linePiS_ii(i32* %0, i32* %1, i32 %2, i32 %3) #0 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_122.cpp() #0 section ".text.startup" {
