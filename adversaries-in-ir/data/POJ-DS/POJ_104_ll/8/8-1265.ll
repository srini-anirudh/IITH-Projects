; ModuleID = 'POJ-104-source/8/8-1265.cpp'
source_filename = "POJ-104-source/8/8-1265.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_1265.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %2 = call i32 @_Z3getPiS_(i32* getelementptr inbounds ([50 x i32], [50 x i32]* @a, i64 0, i64 0), i32* getelementptr inbounds ([50 x i32], [50 x i32]* @b, i64 0, i64 0))
  %3 = call i32 @_Z6repickPiS_(i32* getelementptr inbounds ([50 x i32], [50 x i32]* @a, i64 0, i64 0), i32* getelementptr inbounds ([50 x i32], [50 x i32]* @b, i64 0, i64 0))
  %4 = call i32 @_Z4handPiS_S_(i32* getelementptr inbounds ([50 x i32], [50 x i32]* @a, i64 0, i64 0), i32* getelementptr inbounds ([50 x i32], [50 x i32]* @b, i64 0, i64 0), i32* getelementptr inbounds ([100 x i32], [100 x i32]* @c, i64 0, i64 0))
  %5 = call i32 @_Z3outPi(i32* getelementptr inbounds ([100 x i32], [100 x i32]* @c, i64 0, i64 0))
  ret i32 0
}

; Function Attrs: noinline uwtable
define dso_local i32 @_Z3getPiS_(i32* %0, i32* %1) #0 {
  %3 = alloca i32*, align 8
  %4 = alloca i32*, align 8
  store i32* %0, i32** %3, align 8
  store i32* %1, i32** %4, align 8
  %5 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* @f, i32* @g)
...
define dso_local i32 @_Z6repickPiS_(i32* %0, i32* %1) #5 {
  %3 = alloca i32*, align 8
  %4 = alloca i32*, align 8
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z4handPiS_S_(i32* %0, i32* %1, i32* %2) #5 {
  %4 = alloca i32*, align 8
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z3outPi(i32* %0) #0 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_1265.cpp() #0 section ".text.startup" {
