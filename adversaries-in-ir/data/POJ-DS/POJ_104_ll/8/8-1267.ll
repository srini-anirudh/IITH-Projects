; ModuleID = 'POJ-104-source/8/8-1267.cpp'
source_filename = "POJ-104-source/8/8-1267.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_1267.cpp, i8* null }]
...
define dso_local i32 @main() #5 {
  ...
  %4 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), i32* %2, i32* %3)
  %5 = load i32, i32* %2, align 4
  %6 = load i32, i32* %3, align 4
  call void @_Z1fii(i32 %5, i32 %6)
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_1267.cpp() #0 section ".text.startup" {
