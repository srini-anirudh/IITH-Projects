; ModuleID = 'POJ-104-source/8/8-1299.cpp'
source_filename = "POJ-104-source/8/8-1299.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_1299.cpp, i8* null }]
...
define dso_local void @_Z2f2v() #0 {
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([10000 x i32], [10000 x i32]* @a, i64 0, i64 0), i32* %3)
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([10000 x i32], [10000 x i32]* @b, i64 0, i64 0), i32* %6)
  ret void
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_1299.cpp() #0 section ".text.startup" {
