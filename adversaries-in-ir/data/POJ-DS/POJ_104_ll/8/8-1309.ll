; ModuleID = 'POJ-104-source/8/8-1309.cpp'
source_filename = "POJ-104-source/8/8-1309.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_1309.cpp, i8* null }]
...
define dso_local void @_Z8scanfingv() #0 {
  %1 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* @n1, i32* @n2)
  %2 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* getelementptr inbounds ([100 x i32], [100 x i32]* @a, i64 0, i64 0))
...
7:                                                ; preds = %3
  ...
  %11 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i32* %10)
  br label %12
...
15:                                               ; preds = %3
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* getelementptr inbounds ([100 x i32], [100 x i32]* @b, i64 0, i64 0))
  store i32 1, i32* @i, align 4
  br label %17
...
21:                                               ; preds = %17
  ...
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i32* %24)
  br label %26
...
define dso_local void @_Z8qsortingv() #0 {
  ...
  %2 = sext i32 %1 to i64
  call void @qsort(i8* bitcast ([100 x i32]* @a to i8*), i64 %2, i64 4, i32 (i8*, i8*)* @_Z7comparePKvS0_)
  %3 = load i32, i32* @n2, align 4
  %4 = sext i32 %3 to i64
  call void @qsort(i8* bitcast ([100 x i32]* @b to i8*), i64 %4, i64 4, i32 (i8*, i8*)* @_Z7comparePKvS0_)
  ret void
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_1309.cpp() #0 section ".text.startup" {
