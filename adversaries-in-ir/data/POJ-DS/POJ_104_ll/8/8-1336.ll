; ModuleID = 'POJ-104-source/8/8-1336.cpp'
source_filename = "POJ-104-source/8/8-1336.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_1336.cpp, i8* null }]
...
define dso_local i32 @_Z6outputPii(i32* %0, i32 %1) #0 {
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* %6, i32* %10)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_1336.cpp() #0 section ".text.startup" {
