; ModuleID = 'POJ-104-source/8/8-134.cpp'
source_filename = "POJ-104-source/8/8-134.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_134.cpp, i8* null }]
...
define dso_local void @_Z4scanv() #0 {
  ...
  %2 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32* @n1, i32* @n2)
...
define dso_local void @_Z4rankv() #5 {
  %1 = alloca i32, align 4
...
28:                                               ; preds = %17
  ...
  %36 = getelementptr inbounds [100 x i32], [100 x i32]* @a1, i64 0, i64 %35
...
68:                                               ; preds = %61
  ...
  %76 = getelementptr inbounds [100 x i32], [100 x i32]* @a2, i64 0, i64 %75
...
79:                                               ; preds = %68
  ...
  %87 = getelementptr inbounds [100 x i32], [100 x i32]* @a2, i64 0, i64 %86
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z7combinev() #5 {
  %1 = alloca i32, align 4
...
9:                                                ; preds = %3
  ...
  %14 = getelementptr inbounds [100 x i32], [100 x i32]* @a2, i64 0, i64 %13
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_134.cpp() #0 section ".text.startup" {
