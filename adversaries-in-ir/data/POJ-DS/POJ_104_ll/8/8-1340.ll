; ModuleID = 'POJ-104-source/8/8-1340.cpp'
source_filename = "POJ-104-source/8/8-1340.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_1340.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z4scanPiS_S_(i32* %0, i32* %1, i32* %2) #0 {
  ...
  %12 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %9, i32* %11)
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z3comPiS_S_ii(i32* %0, i32* %1, i32* %2, i32 %3, i32 %4) #4 {
  %6 = alloca i32*, align 8
...
; Function Attrs: noinline uwtable
define dso_local void @_Z3prtPiii(i32* %0, i32 %1, i32 %2) #0 {
  %4 = alloca i32*, align 8
...
define dso_local i32 @main() #5 {
  ...
  call void @_Z4scanPiS_S_(i32* %6, i32* %7, i32* %8)
  ...
  call void @_Z4sortPiS_ii(i32* %9, i32* %10, i32 %12, i32 %14)
  ...
  %21 = load i32, i32* %20, align 4
  call void @_Z3comPiS_S_ii(i32* %15, i32* %16, i32* %17, i32 %19, i32 %21)
  ...
  call void @_Z3prtPiii(i32* %22, i32 %24, i32 %26)
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_1340.cpp() #0 section ".text.startup" {
