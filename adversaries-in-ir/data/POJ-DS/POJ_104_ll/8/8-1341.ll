; ModuleID = 'POJ-104-source/8/8-1341.cpp'
source_filename = "POJ-104-source/8/8-1341.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_1341.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z2ohv() #0 {
  %1 = alloca i32, align 4
  %2 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* @x, i32* @y)
...
8:                                                ; preds = %3
  ...
  %12 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i32* %11)
  br label %13
...
35:                                               ; preds = %22
  ...
  %40 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i32* %39)
  ret void
}
...
define dso_local void @_Z2bav() #4 {
  %1 = alloca i32, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z3zhav() #4 {
  %1 = alloca i32, align 4
  store i32 0, i32* %1, align 4
  br label %2
...
; Function Attrs: noinline uwtable
define dso_local void @_Z3heiv() #0 {
  %1 = alloca i32, align 4
  store i32 0, i32* %1, align 4
  br label %2
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_1341.cpp() #0 section ".text.startup" {
