; ModuleID = 'POJ-104-source/8/8-1414.cpp'
source_filename = "POJ-104-source/8/8-1414.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_1414.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %6 = call i32 @_Z2auii(i32 %4, i32 %5)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z2auii(i32 %0, i32 %1) #0 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_1414.cpp() #0 section ".text.startup" {
