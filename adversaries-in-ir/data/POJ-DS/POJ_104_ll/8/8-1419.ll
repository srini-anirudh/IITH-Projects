; ModuleID = 'POJ-104-source/8/8-1419.cpp'
source_filename = "POJ-104-source/8/8-1419.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_1419.cpp, i8* null }]
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z3cmpPiiS_i(i32* %0, i32 %1, i32* %2, i32 %3) #4 {
...
33:                                               ; preds = %21
  ...
  call void @_Z1fPii(i32* %34, i32 %35)
  ...
  call void @_Z3cmpPiiS_i(i32* %38, i32 %39, i32* %40, i32 %41)
  store i32 0, i32* %4, align 4
  br label %42
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_1419.cpp() #0 section ".text.startup" {
