; ModuleID = 'POJ-104-source/8/8-1433.cpp'
source_filename = "POJ-104-source/8/8-1433.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_1433.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z6insertv() #0 {
...
; Function Attrs: noinline uwtable
define dso_local void @_Z2pxPi(i32* %0) #0 {
...
define dso_local i32 @main() #4 {
  call void @_Z6insertv()
  call void @_Z2pxPi(i32* getelementptr inbounds ([100 x i32], [100 x i32]* @a, i64 0, i64 0))
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_1433.cpp() #0 section ".text.startup" {
