; ModuleID = 'POJ-104-source/8/8-1434.cpp'
source_filename = "POJ-104-source/8/8-1434.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_1434.cpp, i8* null }]
...
define dso_local i32 @main() #5 {
  ...
  %9 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), i32* %4, i32* %5)
  ...
  call void @_Z5shuruPiS_ii(i32* %10, i32* %11, i32 %12, i32 %13)
  ...
  call void @_Z5paixuPii(i32* %16, i32 %17)
  ...
  %22 = load i32, i32* %5, align 4
  call void @_Z6hebingPiS_S_ii(i32* %18, i32* %19, i32* %20, i32 %21, i32 %22)
  %23 = getelementptr inbounds [2000 x i32], [2000 x i32]* %3, i64 0, i64 0
  %24 = load i32, i32* %4, align 4
  %25 = load i32, i32* %5, align 4
  %26 = add nsw i32 %24, %25
  call void @_Z6shuchuPii(i32* %23, i32 %26)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_1434.cpp() #0 section ".text.startup" {
