; ModuleID = 'POJ-104-source/8/8-1446.cpp'
source_filename = "POJ-104-source/8/8-1446.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_1446.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z3paiiPi(i32 %0, i32* %1) #0 {
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z4linkii(i32 %0, i32 %1) #0 {
  %3 = alloca i32, align 4
...
define dso_local i32 @main() #6 {
  ...
  %6 = call i32 @_Z4linkii(i32 %4, i32 %5)
  %7 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0))
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_1446.cpp() #0 section ".text.startup" {
