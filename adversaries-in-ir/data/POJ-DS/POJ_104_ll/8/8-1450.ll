; ModuleID = 'POJ-104-source/8/8-1450.cpp'
source_filename = "POJ-104-source/8/8-1450.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_1450.cpp, i8* null }]
...
33:                                               ; preds = %21
  ...
  call void @qsort(i8* %39, i64 %41, i64 4, i32 (i8*, i8*)* @_Z7ComparePKvS0_)
  store i32 0, i32* %6, align 4
  br label %42
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_1450.cpp() #0 section ".text.startup" {
