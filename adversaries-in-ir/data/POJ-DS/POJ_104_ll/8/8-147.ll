; ModuleID = 'POJ-104-source/8/8-147.cpp'
source_filename = "POJ-104-source/8/8-147.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_147.cpp, i8* null }]
...
33:                                               ; preds = %21
  ...
  call void @_Z5orderPiS_ii(i32* %34, i32* %35, i32 %36, i32 %37)
  store i32 0, i32* %6, align 4
  br label %38
...
define dso_local void @_Z5orderPiS_ii(i32* %0, i32* %1, i32 %2, i32 %3) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_147.cpp() #0 section ".text.startup" {
