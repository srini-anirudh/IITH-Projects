; ModuleID = 'POJ-104-source/8/8-1480.cpp'
source_filename = "POJ-104-source/8/8-1480.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_1480.cpp, i8* null }]
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z2hePiS_(i32* %0, i32* %1) #4 {
  %3 = alloca i32*, align 8
  %4 = alloca i32*, align 8
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
define dso_local i32 @main() #5 {
  ...
  call void @_Z2hePiS_(i32* getelementptr inbounds ([100 x i32], [100 x i32]* @a, i64 0, i64 0), i32* getelementptr inbounds ([100 x i32], [100 x i32]* @b, i64 0, i64 0))
  call void @_Z6outputPi(i32* getelementptr inbounds ([100 x i32], [100 x i32]* @c, i64 0, i64 0))
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_1480.cpp() #0 section ".text.startup" {
