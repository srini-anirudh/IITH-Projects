; ModuleID = 'POJ-104-source/8/8-1482.cpp'
source_filename = "POJ-104-source/8/8-1482.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_1482.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5inputPiS_(i32* %0, i32* %1) #0 {
  %3 = alloca i32*, align 8
  %4 = alloca i32*, align 8
  %5 = alloca i32, align 4
  store i32* %0, i32** %3, align 8
  store i32* %1, i32** %4, align 8
  %6 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* @n, i32* @m)
...
; Function Attrs: noinline uwtable
define dso_local void @_Z4sortPiS_(i32* %0, i32* %1) #0 {
  %3 = alloca i32*, align 8
  %4 = alloca i32*, align 8
  store i32* %0, i32** %3, align 8
  store i32* %1, i32** %4, align 8
  ...
  %8 = sext i32 %7 to i64
  call void @qsort(i8* %6, i64 %8, i64 4, i32 (i8*, i8*)* @_Z3cmpPKvS0_)
  %9 = load i32*, i32** %4, align 8
  %10 = bitcast i32* %9 to i8*
  %11 = load i32, i32* @m, align 4
  %12 = sext i32 %11 to i64
  call void @qsort(i8* %10, i64 %12, i64 4, i32 (i8*, i8*)* @_Z3cmpPKvS0_)
  ret void
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z5mergePiS_S_(i32* %0, i32* %1, i32* %2) #4 {
  %4 = alloca i32*, align 8
...
24:                                               ; preds = %23, %22
  %25 = phi [2 x i8]* [ @.str.3, %22 ], [ @.str.4, %23 ]
  %26 = getelementptr inbounds [2 x i8], [2 x i8]* %25, i64 0, i64 0
  %27 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), i32 %15, i8* %26)
  br label %28
...
define dso_local i32 @main() #5 {
  ...
  call void @_Z5inputPiS_(i32* %8, i32* %9)
  ...
  call void @_Z4sortPiS_(i32* %10, i32* %11)
  ...
  call void @_Z5mergePiS_S_(i32* %12, i32* %13, i32* %14)
  %15 = getelementptr inbounds [10000 x i32], [10000 x i32]* %4, i64 0, i64 0
  call void @_Z6outputPi(i32* %15)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_1482.cpp() #0 section ".text.startup" {
