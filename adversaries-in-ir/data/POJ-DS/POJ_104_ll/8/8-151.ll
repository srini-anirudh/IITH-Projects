; ModuleID = 'POJ-104-source/8/8-151.cpp'
source_filename = "POJ-104-source/8/8-151.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_151.cpp, i8* null }]
...
define dso_local void @_Z5inputiiPiS_(i32 %0, i32 %1, i32* %2, i32* %3) #0 {
  ...
  %11 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* %5, i32* %6)
  store i32 0, i32* %9, align 4
  br label %12
...
define dso_local void @_Z3rowPi(i32* %0) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z3comPiS_(i32* %0, i32* %1) #4 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_151.cpp() #0 section ".text.startup" {
