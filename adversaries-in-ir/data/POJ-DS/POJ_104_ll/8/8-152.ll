; ModuleID = 'POJ-104-source/8/8-152.cpp'
source_filename = "POJ-104-source/8/8-152.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_152.cpp, i8* null }]
...
define dso_local i32 @main() #5 {
  %1 = alloca i32, align 4
  store i32 0, i32* %1, align 4
  %2 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.3, i64 0, i64 0), i32* @m, i32* @n)
  call void @_Z2duv()
  call void @_Z3paiv()
  call void @_Z2hev()
  call void @_Z3shuv()
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_152.cpp() #0 section ".text.startup" {
