; ModuleID = 'POJ-104-source/8/8-168.cpp'
source_filename = "POJ-104-source/8/8-168.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_168.cpp, i8* null }]
...
define dso_local void @_Z2a1v() #0 {
  %1 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* @num_a, i32* @num_b)
...
define dso_local void @_Z2a2v() #5 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z2a3v() #5 {
  store i32 0, i32* @i, align 4
  br label %1
...
; Function Attrs: noinline uwtable
define dso_local void @_Z2a4v() #0 {
  store i32 0, i32* @i, align 4
  br label %1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_168.cpp() #0 section ".text.startup" {
