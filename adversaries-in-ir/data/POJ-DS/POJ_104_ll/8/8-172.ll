; ModuleID = 'POJ-104-source/8/8-172.cpp'
source_filename = "POJ-104-source/8/8-172.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_172.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z3onev() #0 {
...
define dso_local void @_Z3twov() #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z5threev() #4 {
  store i32 0, i32* @i, align 4
  br label %1
...
; Function Attrs: noinline uwtable
define dso_local void @_Z4fourv() #0 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_172.cpp() #0 section ".text.startup" {
