; ModuleID = 'POJ-104-source/8/8-178.cpp'
source_filename = "POJ-104-source/8/8-178.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_178.cpp, i8* null }]
...
define dso_local void @_Z4readPiS_(i32* %0, i32* %1) #0 {
  ...
  %6 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* @la, i32* @lb)
