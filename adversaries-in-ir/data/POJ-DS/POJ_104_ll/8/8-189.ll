; ModuleID = 'POJ-104-source/8/8-189.cpp'
source_filename = "POJ-104-source/8/8-189.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_189.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z4duquiiPiS_(i32 %0, i32 %1, i32* %2, i32* %3) #0 {
...
; Function Attrs: noinline uwtable
define dso_local void @_Z4xianPiii(i32* %0, i32 %1, i32 %2) #0 {
...
define dso_local i32 @main() #5 {
  ...
  %5 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), i32* %1, i32* %2)
  ...
  call void @_Z4duquiiPiS_(i32 %6, i32 %7, i32* %8, i32* %9)
  ...
  call void @_Z4sortPiiS_i(i32* %10, i32 %11, i32* %12, i32 %13)
  ...
  call void @_Z6hebingPiS_ii(i32* %14, i32* %15, i32 %16, i32 %17)
  %18 = getelementptr inbounds [1000 x i32], [1000 x i32]* %3, i64 0, i64 0
  %19 = load i32, i32* %1, align 4
  %20 = load i32, i32* %2, align 4
  call void @_Z4xianPiii(i32* %18, i32 %19, i32 %20)
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_189.cpp() #0 section ".text.startup" {
