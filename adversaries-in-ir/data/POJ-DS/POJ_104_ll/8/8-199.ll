; ModuleID = 'POJ-104-source/8/8-199.cpp'
source_filename = "POJ-104-source/8/8-199.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_199.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @_Z4scanPiiS_i(i32* %8, i32 %9, i32* %10, i32 %11)
  ...
  call void @_Z4sortPii(i32* %14, i32 %15)
  ...
  call void @_Z7combinePiiS_iS_(i32* %16, i32 %17, i32* %18, i32 %19, i32* %20)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define dso_local void @_Z4scanPiiS_i(i32* %0, i32 %1, i32* %2, i32 %3) #0 {
...
; Function Attrs: noinline uwtable
define dso_local void @_Z7combinePiiS_iS_(i32* %0, i32 %1, i32* %2, i32 %3, i32* %4) #0 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_199.cpp() #0 section ".text.startup" {
