; ModuleID = 'POJ-104-source/8/8-2.cpp'
source_filename = "POJ-104-source/8/8-2.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_2.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %7 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0), i32* %3, i32* %4)
...
33:                                               ; preds = %21
  ...
  call void @_Z1fPiS_ii(i32* %34, i32* %35, i32 %36, i32 %37)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_2.cpp() #0 section ".text.startup" {
