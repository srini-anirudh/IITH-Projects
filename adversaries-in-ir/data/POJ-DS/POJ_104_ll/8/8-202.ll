; ModuleID = 'POJ-104-source/8/8-202.cpp'
source_filename = "POJ-104-source/8/8-202.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_202.cpp, i8* null }]
...
35:                                               ; preds = %23
  ...
  call void @_Z1giiPiS_S_(i32 %40, i32 %41, i32* %42, i32* %43, i32* %44)
  store i32 0, i32* %7, align 4
  br label %45
...
define dso_local void @_Z1fiPi(i32 %0, i32* %1) #5 {
  %3 = alloca i32, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z1giiPiS_S_(i32 %0, i32 %1, i32* %2, i32* %3, i32* %4) #5 {
  %6 = alloca i32, align 4
  %7 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_202.cpp() #0 section ".text.startup" {
