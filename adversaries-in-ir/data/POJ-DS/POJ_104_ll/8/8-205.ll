; ModuleID = 'POJ-104-source/8/8-205.cpp'
source_filename = "POJ-104-source/8/8-205.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_205.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %3 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.4, i64 0, i64 0), i32* %1, i32* %2)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_205.cpp() #0 section ".text.startup" {
