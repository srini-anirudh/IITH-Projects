; ModuleID = 'POJ-104-source/8/8-24.cpp'
source_filename = "POJ-104-source/8/8-24.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_24.cpp, i8* null }]
...
define dso_local void @_Z5shuruv() #0 {
  ...
  %2 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* @n1, i32* @n2)
...
define dso_local void @_Z5paixuPiS_ii(i32* %0, i32* %1, i32 %2, i32 %3) #4 {
...
define dso_local i32 @main() #5 {
  ...
  call void @_Z5paixuPiS_ii(i32* getelementptr inbounds ([100 x i32], [100 x i32]* @a1, i64 0, i64 0), i32* getelementptr inbounds ([100 x i32], [100 x i32]* @a2, i64 0, i64 0), i32 %1, i32 %2)
  %3 = load i32, i32* @n1, align 4
  %4 = load i32, i32* @n2, align 4
  call void @_Z6hebingPiS_ii(i32* getelementptr inbounds ([100 x i32], [100 x i32]* @a1, i64 0, i64 0), i32* getelementptr inbounds ([100 x i32], [100 x i32]* @a2, i64 0, i64 0), i32 %3, i32 %4)
  %5 = load i32, i32* @n1, align 4
  %6 = load i32, i32* @n2, align 4
  call void @_Z6shuchuPiii(i32* getelementptr inbounds ([200 x i32], [200 x i32]* @a, i64 0, i64 0), i32 %5, i32 %6)
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_24.cpp() #0 section ".text.startup" {
