; ModuleID = 'POJ-104-source/8/8-252.cpp'
source_filename = "POJ-104-source/8/8-252.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_252.cpp, i8* null }]
...
define dso_local void @_Z5inputv() #0 {
  ...
  %3 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* @n1, i32* @n2)
...
define dso_local void @_Z7arrangev() #5 {
  %1 = alloca i32, align 4
  %2 = alloca i32, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z3addv() #5 {
  %1 = alloca i32, align 4
  store i32 0, i32* %1, align 4
  br label %2
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_252.cpp() #0 section ".text.startup" {
