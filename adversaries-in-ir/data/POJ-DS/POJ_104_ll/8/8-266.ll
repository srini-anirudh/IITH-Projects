; ModuleID = 'POJ-104-source/8/8-266.cpp'
source_filename = "POJ-104-source/8/8-266.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_266.cpp, i8* null }]
...
define dso_local void @_Z4scanv() #0 {
  ...
  %2 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* @n, i32* @m)
...
define dso_local i32 @main() #5 {
  ...
  call void @_Z4sortiPi(i32 %1, i32* getelementptr inbounds ([100 x i32], [100 x i32]* @N, i64 0, i64 0))
  %2 = load i32, i32* @m, align 4
  call void @_Z4sortiPi(i32 %2, i32* getelementptr inbounds ([100 x i32], [100 x i32]* @M, i64 0, i64 0))
  call void @_Z5printv()
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_266.cpp() #0 section ".text.startup" {
