; ModuleID = 'POJ-104-source/8/8-292.cpp'
source_filename = "POJ-104-source/8/8-292.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_292.cpp, i8* null }]
...
define dso_local void @_Z4scanv() #0 {
  ...
  %2 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* @anum, i32* @bnum)
...
define dso_local void @_Z6mysortv() #4 {
  %1 = alloca i32, align 4
...
20:                                               ; preds = %16
  ...
  %30 = select i1 %28, i8 10, i8 32
  %31 = sext i8 %30 to i32
  %32 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0), i32 %24, i32 %31)
  br label %33
...
define dso_local i32 @main() #5 {
  call void @_Z4scanv()
  call void @_Z6mysortv()
  call void @_Z5printv()
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_292.cpp() #0 section ".text.startup" {
