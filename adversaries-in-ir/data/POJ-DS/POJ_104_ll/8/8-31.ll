; ModuleID = 'POJ-104-source/8/8-31.cpp'
source_filename = "POJ-104-source/8/8-31.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_31.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z3lenv() #0 {
...
define dso_local void @_Z6changeiPi(i32 %0, i32* %1) #4 {
...
; Function Attrs: noinline uwtable
define dso_local void @_Z4prinv() #0 {
  %1 = alloca i32, align 4
  store i32 0, i32* %1, align 4
  br label %2
...
define dso_local i32 @main() #5 {
  ...
  call void @_Z6changeiPi(i32 %1, i32* getelementptr inbounds ([20 x i32], [20 x i32]* @a, i64 0, i64 0))
  %2 = load i32, i32* @n, align 4
  call void @_Z6changeiPi(i32 %2, i32* getelementptr inbounds ([20 x i32], [20 x i32]* @b, i64 0, i64 0))
  call void @_Z4prinv()
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_31.cpp() #0 section ".text.startup" {
