; ModuleID = 'POJ-104-source/8/8-310.cpp'
source_filename = "POJ-104-source/8/8-310.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_310.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z4turnPii(i32* %0, i32 %1) #0 {
...
33:                                               ; preds = %21
  ...
  call void @_Z4turnPii(i32* %34, i32 %35)
  ...
  call void @_Z4turnPii(i32* %37, i32 %38)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_310.cpp() #0 section ".text.startup" {
