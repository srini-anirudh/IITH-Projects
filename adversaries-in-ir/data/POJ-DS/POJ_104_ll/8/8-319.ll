; ModuleID = 'POJ-104-source/8/8-319.cpp'
source_filename = "POJ-104-source/8/8-319.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_319.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5orderPii(i32* %0, i32 %1) #0 {
...
33:                                               ; preds = %21
  ...
  call void @_Z5orderPii(i32* %34, i32 %35)
  %36 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0))
  %37 = getelementptr inbounds [50 x i32], [50 x i32]* %6, i64 0, i64 0
  %38 = load i32, i32* %3, align 4
  call void @_Z5orderPii(i32* %37, i32 %38)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_319.cpp() #0 section ".text.startup" {
