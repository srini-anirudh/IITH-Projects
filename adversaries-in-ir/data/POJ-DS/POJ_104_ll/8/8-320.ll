; ModuleID = 'POJ-104-source/8/8-320.cpp'
source_filename = "POJ-104-source/8/8-320.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_320.cpp, i8* null }]
...
33:                                               ; preds = %21
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* %39, i32* %43)
  store i32 0, i32* %3, align 4
  br label %44
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_320.cpp() #0 section ".text.startup" {
