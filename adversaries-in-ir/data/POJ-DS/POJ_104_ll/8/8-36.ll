; ModuleID = 'POJ-104-source/8/8-36.cpp'
source_filename = "POJ-104-source/8/8-36.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_36.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @_Z5shuruPiS_ii(i32* %6, i32* %7, i32 %8, i32 %9)
  ret i32 0
}
...
37:                                               ; preds = %24
  ...
  call void @_Z3paiPii(i32* %39, i32 %40)
  %41 = load i32*, i32** %6, align 8
  %42 = load i32, i32* %8, align 4
  call void @_Z3paiPii(i32* %41, i32 %42)
  store i32 0, i32* %9, align 4
  br label %43
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_36.cpp() #0 section ".text.startup" {
