; ModuleID = 'POJ-104-source/8/8-39.cpp'
source_filename = "POJ-104-source/8/8-39.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_39.cpp, i8* null }]
...
define dso_local void @_Z2azv() #4 {
  %1 = alloca i32, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z3jchv() #4 {
  %1 = alloca i32, align 4
  store i32 0, i32* %1, align 4
  br label %2
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_39.cpp() #0 section ".text.startup" {
