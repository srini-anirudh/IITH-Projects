; ModuleID = 'POJ-104-source/8/8-41.cpp'
source_filename = "POJ-104-source/8/8-41.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_41.cpp, i8* null }]
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z6gatherPiS_(i32* %0, i32* %1) #4 {
  %3 = alloca i32*, align 8
...
34:                                               ; preds = %22
  ...
  call void @_Z6gatherPiS_(i32* %39, i32* %40)
  store i32 0, i32* %2, align 4
  br label %41
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_41.cpp() #0 section ".text.startup" {
