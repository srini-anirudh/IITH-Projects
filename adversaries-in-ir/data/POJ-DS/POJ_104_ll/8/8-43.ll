; ModuleID = 'POJ-104-source/8/8-43.cpp'
source_filename = "POJ-104-source/8/8-43.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_43.cpp, i8* null }]
...
35:                                               ; preds = %23
  ...
  call void @_Z3strPii(i32* %36, i32 %37)
  %38 = getelementptr inbounds [50 x i32], [50 x i32]* %6, i64 0, i64 0
  %39 = load i32, i32* %3, align 4
  call void @_Z3strPii(i32* %38, i32 %39)
  store i32 0, i32* %4, align 4
  br label %40
...
define dso_local void @_Z3strPii(i32* %0, i32 %1) #6 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_43.cpp() #0 section ".text.startup" {
