; ModuleID = 'POJ-104-source/8/8-46.cpp'
source_filename = "POJ-104-source/8/8-46.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_46.cpp, i8* null }]
...
34:                                               ; preds = %22
  ...
  call void @_Z4sortPii(i32* %37, i32 %38)
  store i32 0, i32* %4, align 4
  br label %39
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_46.cpp() #0 section ".text.startup" {
