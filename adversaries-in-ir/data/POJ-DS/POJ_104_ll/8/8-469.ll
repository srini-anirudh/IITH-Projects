; ModuleID = 'POJ-104-source/8/8-469.cpp'
source_filename = "POJ-104-source/8/8-469.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_469.cpp, i8* null }]
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z4copyPiS_S_ii(i32* %0, i32* %1, i32* %2, i32 %3, i32 %4) #4 {
  %6 = alloca i32*, align 8
  %7 = alloca i32*, align 8
  %8 = alloca i32*, align 8
...
define dso_local i32 @main() #5 {
  ...
  call void @_Z5inputPiS_S_S_(i32* %9, i32* %10, i32* %11, i32* %12)
  ...
  call void @_Z4copyPiS_S_ii(i32* %17, i32* %18, i32* %19, i32 %20, i32 %21)
  %22 = getelementptr inbounds [200 x i32], [200 x i32]* %4, i64 0, i64 0
  %23 = load i32, i32* %5, align 4
  %24 = load i32, i32* %6, align 4
  %25 = add nsw i32 %23, %24
  call void @_Z6outputPii(i32* %22, i32 %25)
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_469.cpp() #0 section ".text.startup" {
