; ModuleID = 'POJ-104-source/8/8-475.cpp'
source_filename = "POJ-104-source/8/8-475.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_475.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z2c1v() #0 {
  %1 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* @a, i32* @b)
...
define dso_local void @_Z2c2v() #4 {
  store i32 0, i32* @i, align 4
  br label %1
...
; Function Attrs: noinline uwtable
define dso_local void @_Z2c3v() #0 {
  store i32 0, i32* @i, align 4
  br label %1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_475.cpp() #0 section ".text.startup" {
