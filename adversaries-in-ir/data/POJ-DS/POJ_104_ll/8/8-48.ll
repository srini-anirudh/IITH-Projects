; ModuleID = 'POJ-104-source/8/8-48.cpp'
source_filename = "POJ-104-source/8/8-48.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_48.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %7 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), i32* %4, i32* %5)
...
33:                                               ; preds = %21
  ...
  %35 = getelementptr inbounds [15 x i32], [15 x i32]* %3, i64 0, i64 0
  %36 = load i32, i32* %4, align 4
  %37 = load i32, i32* %5, align 4
  call void @_Z2f1PiS_ii(i32* %34, i32* %35, i32 %36, i32 %37)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_48.cpp() #0 section ".text.startup" {
