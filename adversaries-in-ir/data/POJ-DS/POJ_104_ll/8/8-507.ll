; ModuleID = 'POJ-104-source/8/8-507.cpp'
source_filename = "POJ-104-source/8/8-507.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_507.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z1oi(i32 %0) #0 {
...
16:                                               ; preds = %12
  ...
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* %19)
...
define dso_local i32 @main() #4 {
  ...
  %2 = alloca i32, align 4
  %3 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.3, i64 0, i64 0), i32* %1, i32* %2)
  %4 = load i32, i32* %1, align 4
  call void @_Z1oi(i32 %4)
  %5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0))
  %6 = load i32, i32* %2, align 4
  call void @_Z1oi(i32 %6)
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_507.cpp() #0 section ".text.startup" {
