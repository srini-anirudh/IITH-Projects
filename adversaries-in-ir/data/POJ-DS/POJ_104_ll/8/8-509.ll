; ModuleID = 'POJ-104-source/8/8-509.cpp'
source_filename = "POJ-104-source/8/8-509.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_509.cpp, i8* null }]
...
34:                                               ; preds = %22
  ...
  %37 = call i32 @_Z1fPii(i32* %35, i32 %36)
  %38 = getelementptr inbounds [10 x i32], [10 x i32]* %7, i64 0, i64 0
  %39 = load i32, i32* %3, align 4
  %40 = call i32 @_Z1fPii(i32* %38, i32 %39)
  store i32 0, i32* %4, align 4
  br label %41
...
define dso_local i32 @_Z1fPii(i32* %0, i32 %1) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_509.cpp() #0 section ".text.startup" {
