; ModuleID = 'POJ-104-source/8/8-514.cpp'
source_filename = "POJ-104-source/8/8-514.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_514.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z4run1v() #0 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z4run2v() #4 {
  %1 = load i32, i32* @n, align 4
  call void @_Z4sortPii(i32* getelementptr inbounds ([400 x i32], [400 x i32]* @a, i64 0, i64 0), i32 %1)
  %2 = load i32, i32* @m, align 4
  call void @_Z4sortPii(i32* getelementptr inbounds ([200 x i32], [200 x i32]* @b, i64 0, i64 0), i32 %2)
  ret void
}

; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z4run3v() #4 {
  %1 = alloca i32, align 4
  store i32 1, i32* %1, align 4
  br label %2
...
; Function Attrs: noinline uwtable
define dso_local void @_Z4run4v() #0 {
  %1 = alloca i32, align 4
  store i32 1, i32* %1, align 4
  br label %2
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_514.cpp() #0 section ".text.startup" {
