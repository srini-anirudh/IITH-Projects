; ModuleID = 'POJ-104-source/8/8-518.cpp'
source_filename = "POJ-104-source/8/8-518.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_518.cpp, i8* null }]
...
34:                                               ; preds = %22
  ...
  call void @_Z3toyPii(i32* %35, i32 %36)
  %37 = getelementptr inbounds [1000 x i32], [1000 x i32]* %6, i64 0, i64 0
  %38 = load i32, i32* %3, align 4
  call void @_Z3toyPii(i32* %37, i32 %38)
  ...
  call void @_Z2txPiS_ii(i32* %39, i32* %40, i32 %41, i32 %42)
...
define dso_local void @_Z3toyPii(i32* %0, i32 %1) #5 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z2txPiS_ii(i32* %0, i32* %1, i32 %2, i32 %3) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_518.cpp() #0 section ".text.startup" {
