; ModuleID = 'POJ-104-source/8/8-525.cpp'
source_filename = "POJ-104-source/8/8-525.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_525.cpp, i8* null }]
...
36:                                               ; preds = %24
  ...
  %43 = call i32 @_Z3sumiiPiiS_i(i32 %37, i32 %38, i32* %39, i32 %40, i32* %41, i32 %42)
...
define dso_local i32 @_Z3sumiiPiiS_i(i32 %0, i32 %1, i32* %2, i32 %3, i32* %4, i32 %5) #5 {
  %7 = alloca i32, align 4
  %8 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_525.cpp() #0 section ".text.startup" {
