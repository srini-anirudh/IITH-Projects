; ModuleID = 'POJ-104-source/8/8-530.cpp'
source_filename = "POJ-104-source/8/8-530.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_530.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z4duquPiS_ii(i32* %0, i32* %1, i32 %2, i32 %3) #0 {
...
define dso_local i32 @main() #5 {
  ...
  %8 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), i32* %2, i32* %3)
  ...
  call void @_Z4duquPiS_ii(i32* %9, i32* %10, i32 %11, i32 %12)
  ...
  call void @_Z5paixuPiS_ii(i32* %13, i32* %14, i32 %15, i32 %16)
  ...
  call void @_Z6hebingPiS_S_ii(i32* %17, i32* %18, i32* %19, i32 %20, i32 %21)
  %22 = getelementptr inbounds [100 x i32], [100 x i32]* %6, i64 0, i64 0
  %23 = load i32, i32* %2, align 4
  %24 = load i32, i32* %3, align 4
  call void @_Z6shuchuPiii(i32* %22, i32 %23, i32 %24)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_530.cpp() #0 section ".text.startup" {
