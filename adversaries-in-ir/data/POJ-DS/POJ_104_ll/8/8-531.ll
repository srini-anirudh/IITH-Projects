; ModuleID = 'POJ-104-source/8/8-531.cpp'
source_filename = "POJ-104-source/8/8-531.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_531.cpp, i8* null }]
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z3expPiS_ii(i32* %0, i32* %1, i32 %2, i32 %3) #4 {
  %5 = alloca i32*, align 8
  %6 = alloca i32*, align 8
  %7 = alloca i32, align 4
...
define dso_local i32 @main() #5 {
  ...
  call void @_Z4scanPiS_S_S_(i32* %5, i32* %2, i32* %6, i32* %4)
  ...
  call void @_Z3expPiS_ii(i32* %11, i32* %12, i32 %13, i32 %14)
  %15 = getelementptr inbounds [100 x i32], [100 x i32]* %1, i64 0, i64 0
  %16 = load i32, i32* %2, align 4
  %17 = load i32, i32* %4, align 4
  call void @_Z5printPiii(i32* %15, i32 %16, i32 %17)
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_531.cpp() #0 section ".text.startup" {
