; ModuleID = 'POJ-104-source/8/8-538.cpp'
source_filename = "POJ-104-source/8/8-538.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_538.cpp, i8* null }]
...
22:                                               ; preds = %10
  ...
  %25 = call i32* @_Z6changePii(i32* %23, i32 %24)
...
38:                                               ; preds = %26
  ...
  %41 = call i32* @_Z6changePii(i32* %39, i32 %40)
...
define dso_local i32* @_Z6changePii(i32* %0, i32 %1) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_538.cpp() #0 section ".text.startup" {
