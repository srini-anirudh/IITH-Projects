; ModuleID = 'POJ-104-source/8/8-542.cpp'
source_filename = "POJ-104-source/8/8-542.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_542.cpp, i8* null }]
...
define dso_local void @_Z2f3v() #4 {
  ...
  call void @_Z2f2Pii(i32* getelementptr inbounds ([100 x i32], [100 x i32]* @a, i64 0, i64 0), i32 %2)
  %3 = load i32, i32* @n, align 4
  call void @_Z2f2Pii(i32* getelementptr inbounds ([100 x i32], [100 x i32]* @b, i64 0, i64 0), i32 %3)
  store i32 0, i32* %1, align 4
  br label %4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_542.cpp() #0 section ".text.startup" {
