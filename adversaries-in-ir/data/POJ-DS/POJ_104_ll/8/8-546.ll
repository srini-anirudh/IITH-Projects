; ModuleID = 'POJ-104-source/8/8-546.cpp'
source_filename = "POJ-104-source/8/8-546.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_546.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z1wv() #0 {
  %1 = alloca i32, align 4
  %2 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* @A, i32* @B)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_546.cpp() #0 section ".text.startup" {
