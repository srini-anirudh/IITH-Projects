; ModuleID = 'POJ-104-source/8/8-552.cpp'
source_filename = "POJ-104-source/8/8-552.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_552.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @_Z6bubblePii(i32* %11, i32 %12)
  %13 = getelementptr inbounds [100 x i32], [100 x i32]* %5, i64 0, i64 0
  %14 = load i32, i32* %3, align 4
  call void @_Z6bubblePii(i32* %13, i32 %14)
  ...
  call void @_Z5printPiS_ii(i32* %15, i32* %16, i32 %17, i32 %18)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_552.cpp() #0 section ".text.startup" {
