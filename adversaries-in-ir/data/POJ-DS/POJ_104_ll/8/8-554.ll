; ModuleID = 'POJ-104-source/8/8-554.cpp'
source_filename = "POJ-104-source/8/8-554.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_554.cpp, i8* null }]
...
define dso_local void @_Z4readv() #0 {
  ...
  call void @_Z3shuii(i32 %4, i32 %5)
  ret void
}
...
; Function Attrs: noinline uwtable
define dso_local void @_Z3shuii(i32 %0, i32 %1) #0 {
...
33:                                               ; preds = %21
  ...
  call void @_Z3paiPiiS_i(i32* %34, i32 %35, i32* %36, i32 %37)
  ret void
}

; Function Attrs: noinline uwtable
define dso_local void @_Z3paiPiiS_i(i32* %0, i32 %1, i32* %2, i32 %3) #0 {
...
125:                                              ; preds = %69
  ...
  call void @_Z2prPiiS_i(i32* %126, i32 %127, i32* %128, i32 %129)
  ret void
}

; Function Attrs: noinline uwtable
define dso_local void @_Z2prPiiS_i(i32* %0, i32 %1, i32* %2, i32 %3) #0 {
  %5 = alloca i32*, align 8
  %6 = alloca i32, align 4
  %7 = alloca i32*, align 8
  %8 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_554.cpp() #0 section ".text.startup" {
