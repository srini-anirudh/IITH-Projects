; ModuleID = 'POJ-104-source/8/8-57.cpp'
source_filename = "POJ-104-source/8/8-57.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_57.cpp, i8* null }]
...
define dso_local void @_Z4readv() #0 {
  ...
  %2 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* @num1, i32* @num2)
...
define dso_local void @_Z5queuev() #5 {
  %1 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_57.cpp() #0 section ".text.startup" {
