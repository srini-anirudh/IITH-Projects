; ModuleID = 'POJ-104-source/8/8-572.cpp'
source_filename = "POJ-104-source/8/8-572.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_572.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @_Z5shuruPii(i32* %8, i32 %9)
  %10 = getelementptr inbounds [100 x i32], [100 x i32]* %6, i64 0, i64 0
  %11 = load i32, i32* %4, align 4
  call void @_Z5shuruPii(i32* %10, i32 %11)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_572.cpp() #0 section ".text.startup" {
