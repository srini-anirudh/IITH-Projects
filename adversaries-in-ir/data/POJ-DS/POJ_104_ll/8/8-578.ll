; ModuleID = 'POJ-104-source/8/8-578.cpp'
source_filename = "POJ-104-source/8/8-578.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_578.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z4coutv() #0 {
  %1 = alloca i32, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z3comv() #5 {
  %1 = alloca i32, align 4
  store i32 0, i32* %1, align 4
  br label %2
...
; Function Attrs: noinline uwtable
define dso_local void @_Z4playv() #0 {
  %1 = alloca i32, align 4
  store i32 0, i32* %1, align 4
  br label %2
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_578.cpp() #0 section ".text.startup" {
