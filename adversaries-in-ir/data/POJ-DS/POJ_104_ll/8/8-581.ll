; ModuleID = 'POJ-104-source/8/8-581.cpp'
source_filename = "POJ-104-source/8/8-581.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_581.cpp, i8* null }]
...
153:                                              ; preds = %140
  %154 = getelementptr inbounds [50 x i32], [50 x i32]* %3, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_581.cpp() #0 section ".text.startup" {
