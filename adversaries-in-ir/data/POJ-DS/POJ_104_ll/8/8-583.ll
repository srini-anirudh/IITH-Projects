; ModuleID = 'POJ-104-source/8/8-583.cpp'
source_filename = "POJ-104-source/8/8-583.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_583.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z7readNumv() #0 {
...
define dso_local void @_Z6Bubblev() #4 {
  %1 = alloca i32, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z6getherv() #4 {
  %1 = alloca i32, align 4
  store i32 0, i32* %1, align 4
  br label %2
...
; Function Attrs: noinline uwtable
define dso_local void @_Z8printNumv() #0 {
  %1 = alloca i32, align 4
  store i32 0, i32* %1, align 4
  br label %2
...
define dso_local i32 @main() #5 {
  call void @_Z7readNumv()
  call void @_Z6Bubblev()
  call void @_Z6getherv()
  call void @_Z8printNumv()
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_583.cpp() #0 section ".text.startup" {
