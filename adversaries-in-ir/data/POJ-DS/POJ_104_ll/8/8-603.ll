; ModuleID = 'POJ-104-source/8/8-603.cpp'
source_filename = "POJ-104-source/8/8-603.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_603.cpp, i8* null }]
...
define dso_local void @_Z5inputv() #0 {
  ...
  %2 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* @n_a, i32* @n_b)
...
8:                                                ; preds = %2
  ...
  %20 = select i1 %18, i8 10, i8 32
  %21 = sext i8 %20 to i32
  %22 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), i32 %12, i32 %21)
  br label %23
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_603.cpp() #0 section ".text.startup" {
