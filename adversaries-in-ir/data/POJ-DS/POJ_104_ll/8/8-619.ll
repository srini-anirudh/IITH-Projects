; ModuleID = 'POJ-104-source/8/8-619.cpp'
source_filename = "POJ-104-source/8/8-619.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_619.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @_Z4copyPiiS_i(i32* %16, i32 %17, i32* %18, i32 %19)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define dso_local void @_Z6originPii(i32* %0, i32 %1) #0 {
...
define dso_local void @_Z6bubblePii(i32* %0, i32 %1) #5 {
  %3 = alloca i32*, align 8
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define dso_local void @_Z4copyPiiS_i(i32* %0, i32 %1, i32* %2, i32 %3) #0 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_619.cpp() #0 section ".text.startup" {
