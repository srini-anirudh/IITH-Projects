; ModuleID = 'POJ-104-source/8/8-621.cpp'
source_filename = "POJ-104-source/8/8-621.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_621.cpp, i8* null }]
...
define dso_local void @_Z6adjustv() #4 {
...
59:                                               ; preds = %55
  ...
  %62 = getelementptr inbounds [100 x i32], [100 x i32]* @a2, i64 0, i64 %61
  %63 = load i32, i32* %62, align 4
  %64 = load i32, i32* @j, align 4
  %65 = sext i32 %64 to i64
  %66 = getelementptr inbounds [100 x i32], [100 x i32]* @a2, i64 0, i64 %65
...
69:                                               ; preds = %59
  ...
  %72 = getelementptr inbounds [100 x i32], [100 x i32]* @a2, i64 0, i64 %71
...
8:                                                ; preds = %2
  ...
  %13 = getelementptr inbounds [100 x i32], [100 x i32]* @a2, i64 0, i64 %12
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_621.cpp() #0 section ".text.startup" {
