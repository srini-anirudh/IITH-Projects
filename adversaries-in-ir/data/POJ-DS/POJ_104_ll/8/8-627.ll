; ModuleID = 'POJ-104-source/8/8-627.cpp'
source_filename = "POJ-104-source/8/8-627.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_627.cpp, i8* null }]
...
98:                                               ; preds = %42
  %99 = getelementptr inbounds [200 x i32], [200 x i32]* %6, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_627.cpp() #0 section ".text.startup" {
