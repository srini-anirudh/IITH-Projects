; ModuleID = 'POJ-104-source/8/8-632.cpp'
source_filename = "POJ-104-source/8/8-632.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_632.cpp, i8* null }]
...
8:                                                ; preds = %16, %0
  ...
  %15 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* %7)
  br label %16
...
50:                                               ; preds = %23
  ...
  call void @_Z1fPii(i32* %52, i32 %54)
...
59:                                               ; preds = %55
  ...
  call void @_Z1fPii(i32* %64, i32 %68)
  br label %69
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_632.cpp() #0 section ".text.startup" {
