; ModuleID = 'POJ-104-source/8/8-645.cpp'
source_filename = "POJ-104-source/8/8-645.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_645.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @_Z4shitii(i32 %5, i32 %6)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define dso_local void @_Z4shitii(i32 %0, i32 %1) #0 {
  %3 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_645.cpp() #0 section ".text.startup" {
