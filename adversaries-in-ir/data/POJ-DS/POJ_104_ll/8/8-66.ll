; ModuleID = 'POJ-104-source/8/8-66.cpp'
source_filename = "POJ-104-source/8/8-66.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_66.cpp, i8* null }]
...
33:                                               ; preds = %21
  ...
  call void @_Z2toPiS_ii(i32* %34, i32* %35, i32 %36, i32 %37)
  ...
  call void @_Z6hebingPiS_ii(i32* %38, i32* %39, i32 %40, i32 %41)
  %42 = load i32, i32* %2, align 4
  %43 = load i32, i32* %3, align 4
  call void @_Z5printPiii(i32* getelementptr inbounds ([200 x i32], [200 x i32]* @c, i64 0, i64 0), i32 %42, i32 %43)
...
define dso_local void @_Z2toPiS_ii(i32* %0, i32* %1, i32 %2, i32 %3) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_66.cpp() #0 section ".text.startup" {
