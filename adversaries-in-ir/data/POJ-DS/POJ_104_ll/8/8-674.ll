; ModuleID = 'POJ-104-source/8/8-674.cpp'
source_filename = "POJ-104-source/8/8-674.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_674.cpp, i8* null }]
...
define dso_local void @_Z1sv() #0 {
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([1000 x i32], [1000 x i32]* @a, i64 0, i64 0), i32* %4)
  %5 = load i32, i32* @n, align 4
  %6 = sext i32 %5 to i64
  %7 = getelementptr inbounds i32, i32* getelementptr inbounds ([1000 x i32], [1000 x i32]* @b, i64 0, i64 0), i64 %6
  %8 = getelementptr inbounds i32, i32* %7, i64 1
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([1000 x i32], [1000 x i32]* @b, i64 0, i64 0), i32* %8)
  ret void
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_674.cpp() #0 section ".text.startup" {
