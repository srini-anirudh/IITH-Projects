; ModuleID = 'POJ-104-source/8/8-705.cpp'
source_filename = "POJ-104-source/8/8-705.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_705.cpp, i8* null }]
...
define dso_local void @_Z5rangev() #4 {
  %1 = alloca i32, align 4
  %2 = alloca i32, align 4
...
82:                                               ; preds = %71
  ...
  %94 = getelementptr inbounds [1000 x i32], [1000 x i32]* @num2, i64 0, i64 %93
  store i32 %91, i32* %94, align 4
  %95 = load i32, i32* %6, align 4
  %96 = load i32, i32* %5, align 4
  %97 = add nsw i32 %96, 1
  %98 = sext i32 %97 to i64
  %99 = getelementptr inbounds [1000 x i32], [1000 x i32]* @num2, i64 0, i64 %98
...
23:                                               ; preds = %19
  ...
  %32 = getelementptr inbounds [2000 x i32], [2000 x i32]* @num, i64 0, i64 %31
...
9:                                                ; preds = %2
  %10 = load i32, i32* %1, align 4
  %11 = sext i32 %10 to i64
  %12 = getelementptr inbounds [2000 x i32], [2000 x i32]* @num, i64 0, i64 %11
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_705.cpp() #0 section ".text.startup" {
