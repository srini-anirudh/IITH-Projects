; ModuleID = 'POJ-104-source/8/8-71.cpp'
source_filename = "POJ-104-source/8/8-71.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_71.cpp, i8* null }]
...
define dso_local void @_Z5inputPiS_(i32* %0, i32* %1) #0 {
  ...
  %6 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* @m, i32* @n)
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z3paiPiS_(i32* %0, i32* %1) #5 {
  %3 = alloca i32*, align 8
  %4 = alloca i32*, align 8
  %5 = alloca i32, align 4
  store i32* %0, i32** %3, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_71.cpp() #0 section ".text.startup" {
