; ModuleID = 'POJ-104-source/8/8-739.cpp'
source_filename = "POJ-104-source/8/8-739.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_739.cpp, i8* null }]
...
14:                                               ; preds = %2
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([100 x i32], [100 x i32]* @A, i64 0, i64 0), i32* %17)
  ret void
}
...
14:                                               ; preds = %2
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([100 x i32], [100 x i32]* @B, i64 0, i64 0), i32* %17)
  ret void
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_739.cpp() #0 section ".text.startup" {
