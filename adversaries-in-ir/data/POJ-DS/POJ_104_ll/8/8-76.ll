; ModuleID = 'POJ-104-source/8/8-76.cpp'
source_filename = "POJ-104-source/8/8-76.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_76.cpp, i8* null }]
...
define dso_local void @_Z4rankPiS_(i32* %0, i32* %1) #5 {
  %3 = alloca i32*, align 8
  %4 = alloca i32*, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_76.cpp() #0 section ".text.startup" {
