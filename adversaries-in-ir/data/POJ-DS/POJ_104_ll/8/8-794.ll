; ModuleID = 'POJ-104-source/8/8-794.cpp'
source_filename = "POJ-104-source/8/8-794.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_794.cpp, i8* null }]
...
127:                                              ; preds = %75
  %128 = getelementptr inbounds [1000 x i32], [1000 x i32]* %5, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_794.cpp() #0 section ".text.startup" {
