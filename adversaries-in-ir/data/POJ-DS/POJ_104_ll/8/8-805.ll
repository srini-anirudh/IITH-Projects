; ModuleID = 'POJ-104-source/8/8-805.cpp'
source_filename = "POJ-104-source/8/8-805.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_805.cpp, i8* null }]
...
42:                                               ; preds = %38
  ...
  %46 = call i32 @_Z1piiPi(i32 %43, i32 %44, i32* %45)
...
58:                                               ; preds = %54
  ...
  %62 = call i32 @_Z1piiPi(i32 %59, i32 %60, i32* %61)
...
76:                                               ; preds = %70
  ...
  call void @_Z1eiPiS_ii(i32 %77, i32* %78, i32* %79, i32 %80, i32 %81)
  br label %82
...
define dso_local i32 @_Z1si(i32 %0) #0 {
  ...
  %7 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %6)
...
define dso_local i32 @_Z1piiPi(i32 %0, i32 %1, i32* %2) #5 {
  %4 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define dso_local void @_Z1eiPiS_ii(i32 %0, i32* %1, i32* %2, i32 %3, i32 %4) #0 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_805.cpp() #0 section ".text.startup" {
