; ModuleID = 'POJ-104-source/8/8-813.cpp'
source_filename = "POJ-104-source/8/8-813.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_813.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @_Z1fii(i32 1, i32 %6)
  %7 = load i32, i32* %4, align 4
  call void @_Z1fii(i32 0, i32 %7)
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_813.cpp() #0 section ".text.startup" {
