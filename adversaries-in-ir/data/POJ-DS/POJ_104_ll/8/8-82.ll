; ModuleID = 'POJ-104-source/8/8-82.cpp'
source_filename = "POJ-104-source/8/8-82.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_82.cpp, i8* null }]
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z7zhenghev() #4 {
  %1 = alloca i32, align 4
...
define dso_local i32 @main() #5 {
  call void @_Z5shuruv()
  call void @_Z5paixuv()
  call void @_Z7zhenghev()
  call void @_Z6shuchuv()
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_82.cpp() #0 section ".text.startup" {
