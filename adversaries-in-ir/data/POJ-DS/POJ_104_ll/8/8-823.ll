; ModuleID = 'POJ-104-source/8/8-823.cpp'
source_filename = "POJ-104-source/8/8-823.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_823.cpp, i8* null }]
...
27:                                               ; preds = %23
  ...
  %32 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i32* %31)
  br label %33
...
36:                                               ; preds = %23
  ...
  %40 = call i32 @_Z6bubblePii(i32* %38, i32 %39)
  ...
  %44 = call i32 @_Z6bubblePii(i32* %42, i32 %43)
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z6bubblePii(i32* %0, i32 %1) #0 {
...
67:                                               ; preds = %63
  ...
  %74 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.4, i64 0, i64 0), i32 %73)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_823.cpp() #0 section ".text.startup" {
