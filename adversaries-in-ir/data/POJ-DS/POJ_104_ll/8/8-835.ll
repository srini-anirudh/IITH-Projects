; ModuleID = 'POJ-104-source/8/8-835.cpp'
source_filename = "POJ-104-source/8/8-835.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_835.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @_Z2ppPiS_ii(i32* %17, i32* %18, i32 %19, i32 %20)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define dso_local void @_Z2stPii(i32* %0, i32 %1) #0 {
...
define dso_local void @_Z3chaPii(i32* %0, i32 %1) #6 {
  %3 = alloca i32*, align 8
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define dso_local void @_Z2ppPiS_ii(i32* %0, i32* %1, i32 %2, i32 %3) #0 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_835.cpp() #0 section ".text.startup" {
