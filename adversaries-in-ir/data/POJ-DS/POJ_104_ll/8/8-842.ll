; ModuleID = 'POJ-104-source/8/8-842.cpp'
source_filename = "POJ-104-source/8/8-842.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_842.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z3nemPiS_(i32* %0, i32* %1) #0 {
  %3 = alloca i32*, align 8
  %4 = alloca i32*, align 8
  %5 = alloca i32, align 4
  store i32* %0, i32** %3, align 8
  store i32* %1, i32** %4, align 8
  %6 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* @m, i32* @n)
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z2hePiS_S_(i32* %0, i32* %1, i32* %2) #4 {
  %4 = alloca i32*, align 8
...
define dso_local i32 @main() #5 {
  ...
  call void @_Z2hePiS_S_(i32* %11, i32* %12, i32* %13)
  %14 = getelementptr inbounds [100 x i32], [100 x i32]* %2, i64 0, i64 0
  call void @_Z8printnumPi(i32* %14)
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_842.cpp() #0 section ".text.startup" {
