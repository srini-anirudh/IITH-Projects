; ModuleID = 'POJ-104-source/8/8-843.cpp'
source_filename = "POJ-104-source/8/8-843.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_843.cpp, i8* null }]
...
39:                                               ; preds = %25
  ...
  call void @_Z6maopaoPii(i32* %40, i32 %41)
  ...
  call void @_Z6maopaoPii(i32* %43, i32 %44)
...
; Function Attrs: noinline uwtable
define dso_local void @_Z6maopaoPii(i32* %0, i32 %1) #0 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_843.cpp() #0 section ".text.startup" {
