; ModuleID = 'POJ-104-source/8/8-845.cpp'
source_filename = "POJ-104-source/8/8-845.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_845.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @_Z5printPiS_(i32* %4, i32* %5)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_845.cpp() #0 section ".text.startup" {
