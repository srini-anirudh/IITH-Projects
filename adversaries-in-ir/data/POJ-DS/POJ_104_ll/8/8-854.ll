; ModuleID = 'POJ-104-source/8/8-854.cpp'
source_filename = "POJ-104-source/8/8-854.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_854.cpp, i8* null }]
...
34:                                               ; preds = %22
  ...
  call void @_Z6bubblePii(i32* %35, i32 %36)
  %37 = getelementptr inbounds [10000 x i32], [10000 x i32]* %7, i64 0, i64 0
  %38 = load i32, i32* %3, align 4
  call void @_Z6bubblePii(i32* %37, i32 %38)
  store i32 0, i32* %4, align 4
  br label %39
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_854.cpp() #0 section ".text.startup" {
