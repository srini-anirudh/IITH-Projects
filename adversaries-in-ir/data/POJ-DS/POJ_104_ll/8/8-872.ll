; ModuleID = 'POJ-104-source/8/8-872.cpp'
source_filename = "POJ-104-source/8/8-872.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_872.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @_Z3getii(i32 %4, i32 %5)
  %6 = load i32, i32* %1, align 4
  %7 = load i32, i32* %2, align 4
  call void @_Z4swapii(i32 %6, i32 %7)
  %8 = load i32, i32* %1, align 4
  %9 = load i32, i32* %2, align 4
  call void @_Z3putii(i32 %8, i32 %9)
  ret i32 0
}
...
define dso_local void @_Z4swapii(i32 %0, i32 %1) #5 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_872.cpp() #0 section ".text.startup" {
