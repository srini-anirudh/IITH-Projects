; ModuleID = 'POJ-104-source/8/8-874.cpp'
source_filename = "POJ-104-source/8/8-874.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_874.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @_Z4readPii(i32* %10, i32 %11)
  ...
  call void @_Z3addPiS_S_ii(i32* %16, i32* %17, i32* %18, i32 %19, i32 %20)
  %21 = getelementptr inbounds [200 x i32], [200 x i32]* %6, i64 0, i64 0
  %22 = load i32, i32* %2, align 4
  %23 = load i32, i32* %3, align 4
  %24 = add nsw i32 %22, %23
  call void @_Z3outPii(i32* %21, i32 %24)
  ret i32 0
}
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z3addPiS_S_ii(i32* %0, i32* %1, i32* %2, i32 %3, i32 %4) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_874.cpp() #0 section ".text.startup" {
