; ModuleID = 'POJ-104-source/8/8-880.cpp'
source_filename = "POJ-104-source/8/8-880.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_880.cpp, i8* null }]
...
define dso_local void @_Z5paixuPi(i32* %0) #6 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z6hebingPiS_(i32* %0, i32* %1) #6 {
  %3 = alloca i32*, align 8
  %4 = alloca i32*, align 8
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_880.cpp() #0 section ".text.startup" {
