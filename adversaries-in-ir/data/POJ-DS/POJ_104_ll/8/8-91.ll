; ModuleID = 'POJ-104-source/8/8-91.cpp'
source_filename = "POJ-104-source/8/8-91.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_91.cpp, i8* null }]
...
33:                                               ; preds = %21
  ...
  %35 = getelementptr inbounds [25 x i32], [25 x i32]* %3, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_91.cpp() #0 section ".text.startup" {
