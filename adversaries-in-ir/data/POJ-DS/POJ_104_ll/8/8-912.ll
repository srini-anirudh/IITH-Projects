; ModuleID = 'POJ-104-source/8/8-912.cpp'
source_filename = "POJ-104-source/8/8-912.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_912.cpp, i8* null }]
...
define dso_local void @_Z2inv() #0 {
  %1 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* @a, i32* @b)
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z5stickv() #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_912.cpp() #0 section ".text.startup" {
