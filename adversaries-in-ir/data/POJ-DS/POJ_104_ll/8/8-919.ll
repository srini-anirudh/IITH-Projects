; ModuleID = 'POJ-104-source/8/8-919.cpp'
source_filename = "POJ-104-source/8/8-919.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_919.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z3getv(%struct.nums* noalias sret %0) #0 {
  ...
  %5 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %3, i32* %4)
  %6 = call i32 @getchar()
...
define dso_local void @_Z6bubble4nums(%struct.nums* noalias sret %0, %struct.nums* byval(%struct.nums) align 8 %1) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z7combine4nums(%struct.nums* noalias sret %0, %struct.nums* byval(%struct.nums) align 8 %1) #4 {
  %3 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define dso_local void @_Z3put4nums(%struct.nums* byval(%struct.nums) align 8 %0) #0 {
  %2 = alloca i32, align 4
...
define dso_local i32 @main() #6 {
  %1 = alloca %struct.nums, align 4
  %2 = alloca %struct.nums, align 4
  %3 = alloca %struct.nums, align 8
  %4 = alloca %struct.nums, align 4
  %5 = alloca %struct.nums, align 8
  %6 = alloca %struct.nums, align 8
  call void @_Z3getv(%struct.nums* sret %1)
  %7 = bitcast %struct.nums* %3 to i8*
  %8 = bitcast %struct.nums* %1 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %7, i8* align 4 %8, i64 808, i1 false)
  call void @_Z6bubble4nums(%struct.nums* sret %2, %struct.nums* byval(%struct.nums) align 8 %3)
  %9 = bitcast %struct.nums* %5 to i8*
  %10 = bitcast %struct.nums* %2 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %9, i8* align 4 %10, i64 808, i1 false)
  call void @_Z7combine4nums(%struct.nums* sret %4, %struct.nums* byval(%struct.nums) align 8 %5)
  %11 = bitcast %struct.nums* %6 to i8*
  %12 = bitcast %struct.nums* %4 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %11, i8* align 4 %12, i64 808, i1 false)
  call void @_Z3put4nums(%struct.nums* byval(%struct.nums) align 8 %6)
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_919.cpp() #0 section ".text.startup" {
