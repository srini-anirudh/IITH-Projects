; ModuleID = 'POJ-104-source/8/8-962.cpp'
source_filename = "POJ-104-source/8/8-962.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_962.cpp, i8* null }]
...
40:                                               ; preds = %36
  ...
  %44 = call i32 @_Z2pxPiii(i32* %41, i32 %42, i32 %43)
...
56:                                               ; preds = %52
  ...
  %60 = call i32 @_Z2pxPiii(i32* %57, i32 %58, i32 %59)
...
67:                                               ; preds = %52
  ...
  call void @_Z2hbPiS_ii(i32* %68, i32* %69, i32 %70, i32 %71)
  ret i32 0
}

; Function Attrs: noinline uwtable
define dso_local i32 @_Z2srv() #0 {
  %1 = alloca i32, align 4
...
define dso_local i32 @_Z2pxPiii(i32* %0, i32 %1, i32 %2) #5 {
...
; Function Attrs: noinline uwtable
define dso_local void @_Z2hbPiS_ii(i32* %0, i32* %1, i32 %2, i32 %3) #0 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_962.cpp() #0 section ".text.startup" {
