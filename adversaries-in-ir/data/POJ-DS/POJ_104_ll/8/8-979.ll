; ModuleID = 'POJ-104-source/8/8-979.cpp'
source_filename = "POJ-104-source/8/8-979.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_979.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @_Z6get_inv()
  call void @_Z4sortPiS_(i32* getelementptr inbounds ([100 x i32], [100 x i32]* @s1, i64 0, i64 0), i32* getelementptr inbounds ([100 x i32], [100 x i32]* @s2, i64 0, i64 0))
  call void @_Z6putoutv()
  ret i32 0
}

; Function Attrs: noinline uwtable
define dso_local void @_Z6get_inv() #0 {
  %1 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* @n, i32* @m)
...
; Function Attrs: noinline uwtable
define dso_local void @_Z6putoutv() #0 {
  store i32 0, i32* @i, align 4
  br label %1
...
30:                                               ; preds = %26
  ...
  %34 = getelementptr inbounds [100 x i32], [100 x i32]* @s2, i64 0, i64 %33
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_979.cpp() #0 section ".text.startup" {
