; ModuleID = 'POJ-104-source/8/8-981.cpp'
source_filename = "POJ-104-source/8/8-981.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_981.cpp, i8* null }]
...
33:                                               ; preds = %21
  ...
  call void @_Z2xuPii(i32* %34, i32 %35)
  %36 = getelementptr inbounds [100 x i32], [100 x i32]* %5, i64 0, i64 0
  %37 = load i32, i32* %3, align 4
  call void @_Z2xuPii(i32* %36, i32 %37)
  store i32 0, i32* %6, align 4
  br label %38
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_981.cpp() #0 section ".text.startup" {
