; ModuleID = 'POJ-104-source/8/8-992.cpp'
source_filename = "POJ-104-source/8/8-992.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_8_992.cpp, i8* null }]
...
51:                                               ; preds = %31
  ...
  call void @_Z6outputPiii(i32* %52, i32 %53, i32 %54)
  ret void
}
...
121:                                              ; preds = %67
  ...
  call void @_Z7combinePiS_ii(i32* %122, i32* %123, i32 %124, i32 %125)
  ret void
}
...
define dso_local void @_Z5inputv() #0 {
  ...
  %5 = alloca i32, align 4
  %6 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), i32* %4, i32* %5)
...
32:                                               ; preds = %20
  ...
  call void @_Z5orderPiS_ii(i32* %33, i32* %34, i32 %35, i32 %36)
  ret void
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_8_992.cpp() #0 section ".text.startup" {
