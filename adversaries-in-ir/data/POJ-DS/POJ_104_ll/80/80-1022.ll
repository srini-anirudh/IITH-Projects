; ModuleID = 'POJ-104-source/80/80-1022.cpp'
source_filename = "POJ-104-source/80/80-1022.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_80_1022.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %14, i8* align 16 bitcast ([2 x [13 x i32]]* @__const.main.month to i8*), i64 104, i1 false)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_80_1022.cpp() #0 section ".text.startup" {
