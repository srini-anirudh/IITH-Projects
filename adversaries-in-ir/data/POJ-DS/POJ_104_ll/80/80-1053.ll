; ModuleID = 'POJ-104-source/80/80-1053.cpp'
source_filename = "POJ-104-source/80/80-1053.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_80_1053.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %21 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i64 0, i64 0), i32* %10, i32* %12, i32* %14, i32* %16, i32* %18, i32* %20)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_80_1053.cpp() #0 section ".text.startup" {
