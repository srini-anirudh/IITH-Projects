; ModuleID = 'POJ-104-source/80/80-1054.cpp'
source_filename = "POJ-104-source/80/80-1054.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_80_1054.cpp, i8* null }]
...
define dso_local i32 @main() #5 {
  ...
  %11 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i32* %4, i32* %6, i32* %8)
...
17:                                               ; preds = %13
  ...
  %19 = call i32 @_Z7runniani(i32 %18)
...
135:                                              ; preds = %132
  ...
  %137 = call i32 @_Z7runniani(i32 %136)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_80_1054.cpp() #0 section ".text.startup" {
