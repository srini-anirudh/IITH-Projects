; ModuleID = 'POJ-104-source/80/80-1079.cpp'
source_filename = "POJ-104-source/80/80-1079.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_80_1079.cpp, i8* null }]
...
define dso_local i32 @main(i32 %0, i8** %1) #4 {
  ...
  %19 = call i32 @_Z1giii(i32 %16, i32 %17, i32 %18)
  %20 = load i32, i32* %6, align 4
  %21 = load i32, i32* %8, align 4
  %22 = load i32, i32* %10, align 4
  %23 = call i32 @_Z1giii(i32 %20, i32 %21, i32 %22)
...
define dso_local i32 @_Z1giii(i32 %0, i32 %1, i32 %2) #5 {
  %4 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_80_1079.cpp() #0 section ".text.startup" {
