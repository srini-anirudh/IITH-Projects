; ModuleID = 'POJ-104-source/80/80-1127.cpp'
source_filename = "POJ-104-source/80/80-1127.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_80_1127.cpp, i8* null }]
...
define dso_local i32 @main() #5 {
  ...
  %14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32* %2, i32* %3, i32* %4)
  %15 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32* %5, i32* %6, i32* %7)
...
19:                                               ; preds = %0
  ...
  %21 = call i32 @_Z10IsLeapYeari(i32 %20)
  %22 = icmp eq i32 %21, 1
...
123:                                              ; preds = %117
  ...
  %127 = call i32 @_Z10IsLeapYeari(i32 %126)
...
136:                                              ; preds = %117
  ...
  %138 = call i32 @_Z10IsLeapYeari(i32 %137)
...
165:                                              ; preds = %164, %136
  ...
  %167 = call i32 @_Z10IsLeapYeari(i32 %166)
...
194:                                              ; preds = %193, %165
  ...
  %196 = call i32 @_Z10IsLeapYeari(i32 %195)
...
218:                                              ; preds = %217, %194
  ...
  %220 = call i32 @_Z10IsLeapYeari(i32 %219)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_80_1127.cpp() #0 section ".text.startup" {
