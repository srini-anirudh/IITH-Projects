; ModuleID = 'POJ-104-source/80/80-1144.cpp'
source_filename = "POJ-104-source/80/80-1144.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_80_1144.cpp, i8* null }]
...
define dso_local i32 @main(i32 %0, i8** %1) #5 {
  ...
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32* %6, i32* %7, i32* %8)
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32* %9, i32* %10, i32* %11)
  %20 = load i32, i32* %6, align 4
  %21 = call i32 @_Z5isRuni(i32 %20)
  %22 = icmp ne i32 %21, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_80_1144.cpp() #0 section ".text.startup" {
