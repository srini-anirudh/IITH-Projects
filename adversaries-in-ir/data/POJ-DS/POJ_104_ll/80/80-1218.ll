; ModuleID = 'POJ-104-source/80/80-1218.cpp'
source_filename = "POJ-104-source/80/80-1218.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_80_1218.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %15 = call i32 @_Z6caldayiii(i32 %12, i32 %13, i32 %14)
  store i32 %15, i32* %8, align 4
  %16 = load i32, i32* %5, align 4
  %17 = load i32, i32* %6, align 4
  %18 = load i32, i32* %7, align 4
  %19 = call i32 @_Z6caldayiii(i32 %16, i32 %17, i32 %18)
...
define dso_local i32 @_Z6caldayiii(i32 %0, i32 %1, i32 %2) #5 {
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
  %7 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_80_1218.cpp() #0 section ".text.startup" {
