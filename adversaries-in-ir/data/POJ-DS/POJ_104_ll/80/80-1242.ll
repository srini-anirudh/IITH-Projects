; ModuleID = 'POJ-104-source/80/80-1242.cpp'
source_filename = "POJ-104-source/80/80-1242.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_80_1242.cpp, i8* null }]
...
define dso_local i32 @main() #5 {
  ...
  %13 = call i32 @_Z3numiii(i32 %10, i32 %11, i32 %12)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_80_1242.cpp() #0 section ".text.startup" {
