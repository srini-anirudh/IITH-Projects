; ModuleID = 'POJ-104-source/80/80-1265.cpp'
source_filename = "POJ-104-source/80/80-1265.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_80_1265.cpp, i8* null }]
...
define dso_local i32 @_Z1yi(i32 %0) #4 {
...
18:                                               ; preds = %15
  ...
  %22 = call i32 @_Z1mii(i32 %20, i32 %21)
...
35:                                               ; preds = %31
  ...
  %39 = call i32 @_Z1mii(i32 %37, i32 %38)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_80_1265.cpp() #0 section ".text.startup" {
