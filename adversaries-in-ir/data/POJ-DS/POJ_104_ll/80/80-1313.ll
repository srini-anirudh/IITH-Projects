; ModuleID = 'POJ-104-source/80/80-1313.cpp'
source_filename = "POJ-104-source/80/80-1313.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_80_1313.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %7 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i64 0, i64 0), i32* %1, i32* %3, i32* %5, i32* %2, i32* %4, i32* %6)
  ...
  call void @_Z2f1iiiiii(i32 %8, i32 %9, i32 %10, i32 %11, i32 %12, i32 %13)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define dso_local void @_Z2f1iiiiii(i32 %0, i32 %1, i32 %2, i32 %3, i32 %4, i32 %5) #0 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_80_1313.cpp() #0 section ".text.startup" {
