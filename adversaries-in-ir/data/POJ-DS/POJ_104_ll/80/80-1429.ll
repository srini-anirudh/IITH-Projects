; ModuleID = 'POJ-104-source/80/80-1429.cpp'
source_filename = "POJ-104-source/80/80-1429.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_80_1429.cpp, i8* null }]
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z6judge2iiiiii(i32 %0, i32 %1, i32 %2, i32 %3, i32 %4, i32 %5) #4 {
...
133:                                              ; preds = %118
  ...
  %135 = call i32 @_Z6judge1i(i32 %134)
  %136 = icmp eq i32 %135, 1
  br i1 %136, label %137, label %142

137:                                              ; preds = %133
  %138 = load i32, i32* %6, align 4
  %139 = sub nsw i32 29, %138
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_80_1429.cpp() #0 section ".text.startup" {
