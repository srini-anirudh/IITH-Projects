; ModuleID = 'POJ-104-source/80/80-145.cpp'
source_filename = "POJ-104-source/80/80-145.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_80_145.cpp, i8* null }]
...
define dso_local i32 @main() #5 {
  ...
  %10 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32* %3, i32* %5, i32* %7)
  %11 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32* %4, i32* %6, i32* %8)
  %12 = load i32, i32* %3, align 4
...
29:                                               ; preds = %21
  ...
  %31 = call i32 @_Z8leapYeari(i32 %30)
  %32 = icmp ne i32 %31, 0
...
57:                                               ; preds = %49
  ...
  %59 = call i32 @_Z8leapYeari(i32 %58)
  %60 = icmp ne i32 %59, 0
...
80:                                               ; preds = %72
  ...
  %82 = call i32 @_Z8leapYeari(i32 %81)
  %83 = icmp ne i32 %82, 0
...
112:                                              ; preds = %104
  ...
  %114 = call i32 @_Z8leapYeari(i32 %113)
...
139:                                              ; preds = %131
  ...
  %141 = call i32 @_Z8leapYeari(i32 %140)
...
164:                                              ; preds = %160
  ...
  %166 = call i32 @_Z8leapYeari(i32 %165)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_80_145.cpp() #0 section ".text.startup" {
