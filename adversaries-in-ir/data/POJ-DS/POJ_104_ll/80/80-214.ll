; ModuleID = 'POJ-104-source/80/80-214.cpp'
source_filename = "POJ-104-source/80/80-214.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_80_214.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %20, i8* align 16 bitcast ([13 x i32]* @__const.main.mon to i8*), i64 52, i1 false)
...
64:                                               ; preds = %60, %56
  %65 = getelementptr inbounds [13 x i32], [13 x i32]* %9, i64 0, i64 2
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_80_214.cpp() #0 section ".text.startup" {
