; ModuleID = 'POJ-104-source/80/80-227.cpp'
source_filename = "POJ-104-source/80/80-227.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_80_227.cpp, i8* null }]
...
11:                                               ; preds = %8
  ...
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i64* %15, i64* %19, i64* %23)
...
276:                                              ; preds = %8
  ...
  %284 = call i64 @_ZSt3absl(i64 %283)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_80_227.cpp() #0 section ".text.startup" {
