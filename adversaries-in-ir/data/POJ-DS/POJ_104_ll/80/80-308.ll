; ModuleID = 'POJ-104-source/80/80-308.cpp'
source_filename = "POJ-104-source/80/80-308.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_80_308.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i64 0, i64 0), i32* %4, i32* %5, i32* %6, i32* %7, i32* %8, i32* %9)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_80_308.cpp() #0 section ".text.startup" {
