; ModuleID = 'POJ-104-source/80/80-378.cpp'
source_filename = "POJ-104-source/80/80-378.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_80_378.cpp, i8* null }]
...
65:                                               ; preds = %61
  ...
  %67 = call i32 @_Z4Yeari(i32 %66)
  %68 = icmp eq i32 %67, 366
...
86:                                               ; preds = %61
  ...
  %88 = call i32 @_Z4Yeari(i32 %87)
  %89 = icmp eq i32 %88, 366
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_80_378.cpp() #0 section ".text.startup" {
