; ModuleID = 'POJ-104-source/80/80-386.cpp'
source_filename = "POJ-104-source/80/80-386.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_80_386.cpp, i8* null }]
...
define dso_local i32 @_Z8ntianshui(i32 %0) #4 {
...
18:                                               ; preds = %13
  ...
  %21 = call i32 @_Z8ntianshui(i32 %20)
  %22 = add nsw i32 %19, %21
  store i32 %22, i32* @d2, align 4
  br label %23
...
26:                                               ; preds = %13
  ...
  %31 = call i32 @_Z7tianshuiii(i32 %28, i32 %29, i32 %30)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_80_386.cpp() #0 section ".text.startup" {
