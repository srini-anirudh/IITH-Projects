; ModuleID = 'POJ-104-source/80/80-45.cpp'
source_filename = "POJ-104-source/80/80-45.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_80_45.cpp, i8* null }]
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z15sumFromFirstDayiii(i32 %0, i32 %1, i32 %2) #4 {
...
20:                                               ; preds = %16
  ...
  %22 = call i32 @_Z10isLeapYeari(i32 %21)
  %23 = icmp ne i32 %22, 0
...
31:                                               ; preds = %16
  ...
  %35 = call i32 @_Z15sumFromFirstDayiii(i32 %32, i32 %33, i32 %34)
  store i32 %35, i32* %10, align 4
  %36 = load i32, i32* %5, align 4
  %37 = load i32, i32* %6, align 4
  %38 = load i32, i32* %7, align 4
  %39 = call i32 @_Z15sumFromFirstDayiii(i32 %36, i32 %37, i32 %38)
...
49:                                               ; preds = %31
  ...
  %57 = call i32 @_Z10isLeapYeari(i32 %56)
  %58 = icmp ne i32 %57, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_80_45.cpp() #0 section ".text.startup" {
