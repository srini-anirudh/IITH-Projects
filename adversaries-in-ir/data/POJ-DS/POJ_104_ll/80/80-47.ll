; ModuleID = 'POJ-104-source/80/80-47.cpp'
source_filename = "POJ-104-source/80/80-47.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_80_47.cpp, i8* null }]
...
define dso_local i32 @main() #5 {
  ...
  %10 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str, i64 0, i64 0), i32* %2, i32* %3, i32* %4, i32* %5, i32* %6, i32* %7)
...
38:                                               ; preds = %12
  ...
  %42 = load i32, i32* %7, align 4
  %43 = call i32 @_Z4sum1iii(i32 %40, i32 %41, i32 %42)
  %44 = add nsw i32 %39, %43
  %45 = load i32, i32* %2, align 4
  %46 = load i32, i32* %3, align 4
  %47 = load i32, i32* %4, align 4
  %48 = call i32 @_Z4sum1iii(i32 %45, i32 %46, i32 %47)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_80_47.cpp() #0 section ".text.startup" {
