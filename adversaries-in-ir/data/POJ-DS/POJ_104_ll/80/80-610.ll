; ModuleID = 'POJ-104-source/80/80-610.cpp'
source_filename = "POJ-104-source/80/80-610.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_80_610.cpp, i8* null }]
...
11:                                               ; preds = %135, %130, %125, %117, %112, %89, %84, %64, %59, %51, %0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_80_610.cpp() #0 section ".text.startup" {
