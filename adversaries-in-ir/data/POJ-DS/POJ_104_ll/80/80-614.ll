; ModuleID = 'POJ-104-source/80/80-614.cpp'
source_filename = "POJ-104-source/80/80-614.cpp"
...
@__const._Z4Daysiii.day = private unnamed_addr constant [13 x i32] [i32 0, i32 31, i32 28, i32 31, i32 30, i32 31, i32 30, i32 31, i32 31, i32 30, i32 31, i32 30, i32 31], align 16
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_80_614.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %7 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32* %4, i32* %5, i32* %6)
  %8 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0))
  ...
  %12 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32* %9, i32* %10, i32* %11)
  ...
  %19 = call i32 @_Z4Daysiii(i32 %14, i32 %16, i32 %18)
  ...
  %26 = call i32 @_Z4Daysiii(i32 %21, i32 %23, i32 %25)
...
define dso_local i32 @_Z4Daysiii(i32 %0, i32 %1, i32 %2) #5 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %11, i8* align 16 bitcast ([13 x i32]* @__const._Z4Daysiii.day to i8*), i64 52, i1 false)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_80_614.cpp() #0 section ".text.startup" {
