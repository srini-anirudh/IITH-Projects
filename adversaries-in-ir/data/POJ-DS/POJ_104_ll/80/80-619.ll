; ModuleID = 'POJ-104-source/80/80-619.cpp'
source_filename = "POJ-104-source/80/80-619.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_80_619.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %2 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i64 0, i64 0), i32* @year1, i32* @month1, i32* @day1, i32* @year2, i32* @month2, i32* @day2)
  %3 = call i32 @_Z10count_yearv()
  %4 = call i32 @_Z11count_monthv()
  %5 = add nsw i32 %3, %4
  %6 = call i32 @_Z9count_dayv()
  %7 = add nsw i32 %5, %6
...
define dso_local i32 @_Z10count_yearv() #5 {
  %1 = alloca i32, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z11count_monthv() #5 {
  %1 = alloca i32, align 4
  %2 = alloca i32, align 4
  store i32 0, i32* %2, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z9count_dayv() #5 {
  %1 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_80_619.cpp() #0 section ".text.startup" {
