; ModuleID = 'POJ-104-source/80/80-629.cpp'
source_filename = "POJ-104-source/80/80-629.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_80_629.cpp, i8* null }]
...
define dso_local i32 @main() #5 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %12, i8* align 16 bitcast ([13 x i32]* @__const.main.pin to i8*), i64 52, i1 false)
  %13 = bitcast [13 x i32]* %11 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %13, i8* align 16 bitcast ([13 x i32]* @__const.main.run to i8*), i64 52, i1 false)
...
152:                                              ; preds = %148
  ...
  %154 = call i32 @_Z5judgei(i32 %153)
...
166:                                              ; preds = %148
  ...
  %168 = call i32 @_Z5judgei(i32 %167)
...
194:                                              ; preds = %190
  ...
  %198 = getelementptr inbounds [13 x i32], [13 x i32]* %10, i64 0, i64 %197
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_80_629.cpp() #0 section ".text.startup" {
