; ModuleID = 'POJ-104-source/80/80-659.cpp'
source_filename = "POJ-104-source/80/80-659.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_80_659.cpp, i8* null }]
...
35:                                               ; preds = %31, %27
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %36, i8* align 16 bitcast ([13 x i32]* @__const.main.month to i8*), i64 52, i1 false)
...
53:                                               ; preds = %31
  %54 = bitcast [13 x i32]* %15 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %54, i8* align 16 bitcast ([13 x i32]* @__const.main.month.1 to i8*), i64 52, i1 false)
...
60:                                               ; preds = %56
  ...
  %64 = getelementptr inbounds [13 x i32], [13 x i32]* %15, i64 0, i64 %63
...
83:                                               ; preds = %79, %75
  %84 = bitcast [13 x i32]* %16 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %84, i8* align 16 bitcast ([13 x i32]* @__const.main.month.2 to i8*), i64 52, i1 false)
...
101:                                              ; preds = %79
  %102 = bitcast [13 x i32]* %17 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %102, i8* align 16 bitcast ([13 x i32]* @__const.main.month.3 to i8*), i64 52, i1 false)
...
147:                                              ; preds = %121
  ...
  %152 = mul nsw i32 %151, 366
  %153 = add nsw i32 %150, %152
  %154 = load i32, i32* %13, align 4
  %155 = mul nsw i32 %154, 365
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_80_659.cpp() #0 section ".text.startup" {
