; ModuleID = 'POJ-104-source/80/80-728.cpp'
source_filename = "POJ-104-source/80/80-728.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_80_728.cpp, i8* null }]
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z6count1iiii(i32 %0, i32 %1, i32 %2, i32 %3) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z6count2iiii(i32 %0, i32 %1, i32 %2, i32 %3) #4 {
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
  %7 = alloca i32, align 4
  %8 = alloca i32, align 4
...
16:                                               ; preds = %0
  ...
  %18 = call i32 @_Z7runniani(i32 %17)
  %19 = icmp ne i32 %18, 0
...
20:                                               ; preds = %16
  ...
  %25 = call i32 @_Z6count1iiii(i32 %21, i32 %22, i32 %23, i32 %24)
...
26:                                               ; preds = %16
  ...
  %31 = call i32 @_Z6count2iiii(i32 %27, i32 %28, i32 %29, i32 %30)
...
58:                                               ; preds = %54
  ...
  %60 = call i32 @_Z7runniani(i32 %59)
  %61 = icmp ne i32 %60, 0
...
76:                                               ; preds = %72
  ...
  %82 = call i32 @_Z6count1iiii(i32 %78, i32 %79, i32 %80, i32 %81)
...
84:                                               ; preds = %72
  ...
  %90 = call i32 @_Z6count2iiii(i32 %86, i32 %87, i32 %88, i32 %89)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_80_728.cpp() #0 section ".text.startup" {
