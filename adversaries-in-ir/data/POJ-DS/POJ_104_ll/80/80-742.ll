; ModuleID = 'POJ-104-source/80/80-742.cpp'
source_filename = "POJ-104-source/80/80-742.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_80_742.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32* %14, i32* %15, i32* %16)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_80_742.cpp() #0 section ".text.startup" {
