; ModuleID = 'POJ-104-source/80/80-744.cpp'
source_filename = "POJ-104-source/80/80-744.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_80_744.cpp, i8* null }]
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z3addPiiii(i32* %0, i32 %1, i32 %2, i32 %3) #4 {
...
define dso_local i32 @main() #5 {
  ...
  %14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i32* %4, i32* %5, i32* %6)
...
19:                                               ; preds = %0
  ...
  %24 = call i32 @_Z3addPiiii(i32* %20, i32 %21, i32 %22, i32 %23)
  %25 = getelementptr inbounds [15 x i32], [15 x i32]* %10, i64 0, i64 0
  %26 = load i32, i32* %4, align 4
  %27 = load i32, i32* %5, align 4
  %28 = load i32, i32* %6, align 4
  %29 = call i32 @_Z3addPiiii(i32* %25, i32 %26, i32 %27, i32 %28)
...
37:                                               ; preds = %33
  ...
  %42 = call i32 @_Z3addPiiii(i32* %38, i32 %39, i32 %40, i32 %41)
...
46:                                               ; preds = %33
  ...
  %51 = call i32 @_Z3addPiiii(i32* %47, i32 %48, i32 %49, i32 %50)
...
77:                                               ; preds = %58
  ...
  %82 = call i32 @_Z3addPiiii(i32* %78, i32 %79, i32 %80, i32 %81)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_80_744.cpp() #0 section ".text.startup" {
