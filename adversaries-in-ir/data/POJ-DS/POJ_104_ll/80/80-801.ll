; ModuleID = 'POJ-104-source/80/80-801.cpp'
source_filename = "POJ-104-source/80/80-801.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_80_801.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %16, i8* align 16 bitcast ([13 x i32]* @__const.main.nmonth to i8*), i64 52, i1 false)
  %17 = bitcast [13 x i32]* %9 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %17, i8* align 16 bitcast ([13 x i32]* @__const.main.rmonth to i8*), i64 52, i1 false)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_80_801.cpp() #0 section ".text.startup" {
