; ModuleID = 'POJ-104-source/80/80-832.cpp'
source_filename = "POJ-104-source/80/80-832.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_80_832.cpp, i8* null }]
...
14:                                               ; preds = %9
  ...
  %17 = getelementptr inbounds [12 x i32], [12 x i32]* @md, i64 0, i64 %16
...
20:                                               ; preds = %15
  ...
  %22 = call i32 @_Z7runniani(i32 %21)
...
29:                                               ; preds = %15
  ...
  %34 = call i32 @_Z4tianiii(i32 %31, i32 %32, i32 %33)
  %35 = load i32, i32* %2, align 4
  %36 = load i32, i32* %4, align 4
  %37 = load i32, i32* %6, align 4
  %38 = call i32 @_Z4tianiii(i32 %35, i32 %36, i32 %37)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_80_832.cpp() #0 section ".text.startup" {
