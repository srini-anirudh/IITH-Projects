; ModuleID = 'POJ-104-source/80/80-836.cpp'
source_filename = "POJ-104-source/80/80-836.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_80_836.cpp, i8* null }]
...
define dso_local i32 @_Z10judge_yeari(i32 %0) #4 {
...
define dso_local i32 @main() #5 {
  ...
  %13 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i32* %8, i32* %9, i32* %10)
  %14 = load i32, i32* %5, align 4
  %15 = call i32 @_Z10judge_yeari(i32 %14)
  %16 = icmp ne i32 %15, 0
...
71:                                               ; preds = %67
  ...
  %73 = call i32 @_Z10judge_yeari(i32 %72)
...
96:                                               ; preds = %83
  ...
  %106 = call i32 @_Z10judge_yeari(i32 %105)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_80_836.cpp() #0 section ".text.startup" {
