; ModuleID = 'POJ-104-source/80/80-908.cpp'
source_filename = "POJ-104-source/80/80-908.cpp"
...
@__const._Z3djtiii.days = private unnamed_addr constant [13 x i32] [i32 0, i32 31, i32 28, i32 31, i32 30, i32 31, i32 30, i32 31, i32 31, i32 30, i32 31, i32 30, i32 31], align 16
@__const.main.days = private unnamed_addr constant [13 x i32] [i32 0, i32 31, i32 28, i32 31, i32 30, i32 31, i32 30, i32 31, i32 31, i32 30, i32 31, i32 30, i32 31], align 16
@.str = private unnamed_addr constant [13 x i8] c"%d%d%d%d%d%d\00", align 1
@.str.1 = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_80_908.cpp, i8* null }]
...
define dso_local i32 @_Z2iri(i32 %0) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z3djtiii(i32 %0, i32 %1, i32 %2) #4 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %10, i8* align 16 bitcast ([13 x i32]* @__const._Z3djtiii.days to i8*), i64 52, i1 false)
...
define dso_local i32 @main() #6 {
  ...
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i64 0, i64 0), i32* %11, i32* %12, i32* %13, i32* %14, i32* %15, i32* %16)
...
60:                                               ; preds = %53, %47, %41, %35
  ...
  %67 = call i32 @_Z3djtiii(i32 %62, i32 %64, i32 %66)
  ...
  %74 = call i32 @_Z3djtiii(i32 %69, i32 %71, i32 %73)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_80_908.cpp() #0 section ".text.startup" {
