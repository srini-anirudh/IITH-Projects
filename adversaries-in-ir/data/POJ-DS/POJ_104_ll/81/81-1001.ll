; ModuleID = 'POJ-104-source/81/81-1001.cpp'
source_filename = "POJ-104-source/81/81-1001.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1001.cpp, i8* null }]
...
93:                                               ; preds = %90
  ...
  %124 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.2, i64 0, i64 0), i32 %99, i32 %105, i32 %111, i32 %117, i32 %123)
  br label %125
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1001.cpp() #0 section ".text.startup" {
