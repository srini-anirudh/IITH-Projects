; ModuleID = 'POJ-104-source/81/81-1012.cpp'
source_filename = "POJ-104-source/81/81-1012.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1012.cpp, i8* null }]
...
19:                                               ; preds = %6
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %3, i32* %4)
  %21 = getelementptr inbounds [5 x [5 x i32]], [5 x [5 x i32]]* %2, i64 0, i64 0
  %22 = load i32, i32* %3, align 4
  %23 = load i32, i32* %4, align 4
  %24 = call i32 @_Z8exchangePA5_iii([5 x i32]* %21, i32 %22, i32 %23)
  %25 = icmp ne i32 %24, 0
...
30:                                               ; preds = %27
  ...
  %42 = select i1 %40, i8 32, i8 10
  %43 = sext i8 %42 to i32
  %44 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), i32 %36, i32 %43)
  br label %45
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1012.cpp() #0 section ".text.startup" {
