; ModuleID = 'POJ-104-source/81/81-1033.cpp'
source_filename = "POJ-104-source/81/81-1033.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1033.cpp, i8* null }]
...
30:                                               ; preds = %14
  ...
  %37 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i32* %36)
  br label %38
...
41:                                               ; preds = %10
  %42 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), i32* %7, i32* %8)
  ...
  %48 = call i32 @_Z6changePiii(i32* %45, i32 %46, i32 %47)
  %49 = icmp ne i32 %48, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1033.cpp() #0 section ".text.startup" {
