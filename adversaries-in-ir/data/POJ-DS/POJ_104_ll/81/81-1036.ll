; ModuleID = 'POJ-104-source/81/81-1036.cpp'
source_filename = "POJ-104-source/81/81-1036.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1036.cpp, i8* null }]
...
define dso_local i32 @_Z3judii(i32 %0, i32 %1) #4 {
...
38:                                               ; preds = %9
  %39 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %5, i32* %6)
  %40 = load i32, i32* %5, align 4
  %41 = load i32, i32* %6, align 4
  %42 = call i32 @_Z3judii(i32 %40, i32 %41)
  %43 = icmp eq i32 %42, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1036.cpp() #0 section ".text.startup" {
