; ModuleID = 'POJ-104-source/81/81-1037.cpp'
source_filename = "POJ-104-source/81/81-1037.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1037.cpp, i8* null }]
...
31:                                               ; preds = %9
  %32 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %6, i32* %7)
  ...
  %38 = call i32 @_Z7convertPiii(i32* %35, i32 %36, i32 %37)
...
define dso_local i32 @_Z7convertPiii(i32* %0, i32 %1, i32 %2) #5 {
  %4 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1037.cpp() #0 section ".text.startup" {
