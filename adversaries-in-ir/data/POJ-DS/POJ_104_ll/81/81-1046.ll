; ModuleID = 'POJ-104-source/81/81-1046.cpp'
source_filename = "POJ-104-source/81/81-1046.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1046.cpp, i8* null }]
...
34:                                               ; preds = %10
  %35 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %6, i32* %7)
...
102:                                              ; preds = %99
  ...
  %115 = select i1 %113, i8 10, i8 32
  %116 = sext i8 %115 to i32
  %117 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0), i32 %111, i32 %116)
  br label %118
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1046.cpp() #0 section ".text.startup" {
