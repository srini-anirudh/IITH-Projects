; ModuleID = 'POJ-104-source/81/81-1053.cpp'
source_filename = "POJ-104-source/81/81-1053.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1053.cpp, i8* null }]
...
90:                                               ; preds = %87
  ...
  %116 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.2, i64 0, i64 0), i32 %95, i32 %100, i32 %105, i32 %110, i32 %115)
  br label %117
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1053.cpp() #0 section ".text.startup" {
