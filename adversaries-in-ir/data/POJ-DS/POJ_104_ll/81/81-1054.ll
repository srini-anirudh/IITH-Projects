; ModuleID = 'POJ-104-source/81/81-1054.cpp'
source_filename = "POJ-104-source/81/81-1054.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1054.cpp, i8* null }]
...
32:                                               ; preds = %10
  %33 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %6, i32* %7)
...
49:                                               ; preds = %46
  ...
  %62 = load [5 x i32]*, [5 x i32]** %3, align 8
  ...
  %83 = load [5 x i32]*, [5 x i32]** %3, align 8
...
98:                                               ; preds = %95
  ...
  %124 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.2, i64 0, i64 0), i32 %103, i32 %108, i32 %113, i32 %118, i32 %123)
  br label %125
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1054.cpp() #0 section ".text.startup" {
