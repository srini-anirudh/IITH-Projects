; ModuleID = 'POJ-104-source/81/81-1057.cpp'
source_filename = "POJ-104-source/81/81-1057.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1057.cpp, i8* null }]
...
48:                                               ; preds = %13
  %49 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %9, i32* %8)
  %50 = load i32, i32* %9, align 4
  %51 = load i32, i32* %8, align 4
  %52 = call i32 @_Z7panduanii(i32 %50, i32 %51)
...
103:                                              ; preds = %100
  ...
  %129 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.2, i64 0, i64 0), i32 %108, i32 %113, i32 %118, i32 %123, i32 %128)
  br label %130
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1057.cpp() #0 section ".text.startup" {
