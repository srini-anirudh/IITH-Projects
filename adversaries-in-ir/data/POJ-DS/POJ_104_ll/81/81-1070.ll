; ModuleID = 'POJ-104-source/81/81-1070.cpp'
source_filename = "POJ-104-source/81/81-1070.cpp"
...
@p = dso_local global [5 x i32*] zeroinitializer, align 16
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [5 x i8] c"%d%d\00", align 1
@.str.2 = private unnamed_addr constant [7 x i8] c"error\0A\00", align 1
@.str.3 = private unnamed_addr constant [4 x i8] c" %d\00", align 1
@.str.4 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1070.cpp, i8* null }]
...
36:                                               ; preds = %7
  %37 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %5, i32* %6)
  %38 = load i32, i32* %5, align 4
  %39 = load i32, i32* %6, align 4
  %40 = call i32 @_Z8exchangeii(i32 %38, i32 %39)
  %41 = icmp eq i32 %40, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1070.cpp() #0 section ".text.startup" {
