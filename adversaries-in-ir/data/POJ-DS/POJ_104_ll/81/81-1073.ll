; ModuleID = 'POJ-104-source/81/81-1073.cpp'
source_filename = "POJ-104-source/81/81-1073.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1073.cpp, i8* null }]
...
define dso_local i32 @_Z1fiiPA5_i(i32 %0, i32 %1, [5 x i32]* %2) #4 {
...
32:                                               ; preds = %8
  %33 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %6, i32* %7)
  %34 = load i32, i32* %6, align 4
  %35 = load i32, i32* %7, align 4
  %36 = getelementptr inbounds [5 x [5 x i32]], [5 x [5 x i32]]* %2, i64 0, i64 0
  %37 = call i32 @_Z1fiiPA5_i(i32 %34, i32 %35, [5 x i32]* %36)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1073.cpp() #0 section ".text.startup" {
