; ModuleID = 'POJ-104-source/81/81-1079.cpp'
source_filename = "POJ-104-source/81/81-1079.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1079.cpp, i8* null }]
...
define dso_local i32 @_Z7processPA5_iii([5 x i32]* %0, i32 %1, i32 %2) #4 {
...
30:                                               ; preds = %8
  %31 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %3, i32* %4)
  %32 = getelementptr inbounds [5 x [5 x i32]], [5 x [5 x i32]]* %5, i64 0, i64 0
  %33 = load i32, i32* %3, align 4
  %34 = load i32, i32* %4, align 4
  %35 = call i32 @_Z7processPA5_iii([5 x i32]* %32, i32 %33, i32 %34)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1079.cpp() #0 section ".text.startup" {
