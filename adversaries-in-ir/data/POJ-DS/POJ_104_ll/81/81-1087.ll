; ModuleID = 'POJ-104-source/81/81-1087.cpp'
source_filename = "POJ-104-source/81/81-1087.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1087.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %7 = bitcast [6 x [6 x i32]]* %2 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 16 %7, i8 0, i64 144, i1 false)
...
47:                                               ; preds = %44
  ...
  %55 = getelementptr inbounds [6 x [6 x i32]], [6 x [6 x i32]]* %2, i64 0, i64 5
  ...
  %72 = getelementptr inbounds [6 x [6 x i32]], [6 x [6 x i32]]* %2, i64 0, i64 5
...
118:                                              ; preds = %40, %37, %34, %30
  %119 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.4, i64 0, i64 0))
  br label %120
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1087.cpp() #0 section ".text.startup" {
