; ModuleID = 'POJ-104-source/81/81-1089.cpp'
source_filename = "POJ-104-source/81/81-1089.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1089.cpp, i8* null }]
...
27:                                               ; preds = %5
  %28 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* @m, i32* @n)
...
44:                                               ; preds = %41
  ...
  %55 = select i1 %53, i8 10, i8 32
  %56 = sext i8 %55 to i32
  %57 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0), i32 %51, i32 %56)
  br label %58
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1089.cpp() #0 section ".text.startup" {
