; ModuleID = 'POJ-104-source/81/81-1093.cpp'
source_filename = "POJ-104-source/81/81-1093.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1093.cpp, i8* null }]
...
define dso_local i32 @_Z3panii(i32 %0, i32 %1) #4 {
...
27:                                               ; preds = %5
  ...
  %31 = call i32 @_Z3panii(i32 %29, i32 %30)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1093.cpp() #0 section ".text.startup" {
