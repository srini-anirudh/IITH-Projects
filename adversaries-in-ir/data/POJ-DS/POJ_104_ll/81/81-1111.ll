; ModuleID = 'POJ-104-source/81/81-1111.cpp'
source_filename = "POJ-104-source/81/81-1111.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1111.cpp, i8* null }]
...
define dso_local i32 @_Z4matfPA5_iii([5 x i32]* %0, i32 %1, i32 %2) #4 {
...
32:                                               ; preds = %8
  %33 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %5, i32* %6)
  %34 = getelementptr inbounds [5 x [5 x i32]], [5 x [5 x i32]]* %4, i64 0, i64 0
  %35 = load i32, i32* %5, align 4
  %36 = load i32, i32* %6, align 4
  %37 = call i32 @_Z4matfPA5_iii([5 x i32]* %34, i32 %35, i32 %36)
...
50:                                               ; preds = %47
  ...
  %63 = select i1 %61, i8 32, i8 10
  %64 = sext i8 %63 to i32
  %65 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0), i32 %59, i32 %64)
  br label %66
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1111.cpp() #0 section ".text.startup" {
