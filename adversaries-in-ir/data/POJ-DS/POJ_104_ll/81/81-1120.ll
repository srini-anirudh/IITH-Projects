; ModuleID = 'POJ-104-source/81/81-1120.cpp'
source_filename = "POJ-104-source/81/81-1120.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1120.cpp, i8* null }]
...
32:                                               ; preds = %8
  %33 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %7, i32* %6)
...
44:                                               ; preds = %41
  ...
  call void @_Z5transPA5_iii([5 x i32]* %45, i32 %46, i32 %47)
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z5transPA5_iii([5 x i32]* %0, i32 %1, i32 %2) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1120.cpp() #0 section ".text.startup" {
