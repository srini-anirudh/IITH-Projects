; ModuleID = 'POJ-104-source/81/81-1122.cpp'
source_filename = "POJ-104-source/81/81-1122.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1122.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z6changePA5_iii([5 x i32]* %0, i32 %1, i32 %2) #0 {
...
15:                                               ; preds = %12
  ...
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i32* %21)
  br label %23
...
30:                                               ; preds = %8
  %31 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.4, i64 0, i64 0), i32* %3, i32* %4)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1122.cpp() #0 section ".text.startup" {
