; ModuleID = 'POJ-104-source/81/81-1124.cpp'
source_filename = "POJ-104-source/81/81-1124.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1124.cpp, i8* null }]
...
define dso_local i32 @_Z3stuPA5_iii([5 x i32]* %0, i32 %1, i32 %2) #4 {
...
36:                                               ; preds = %14
  %37 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %3, i32* %4)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1124.cpp() #0 section ".text.startup" {
