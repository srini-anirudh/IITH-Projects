; ModuleID = 'POJ-104-source/81/81-1127.cpp'
source_filename = "POJ-104-source/81/81-1127.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1127.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z3prtPi(i32* %0) #0 {
...
7:                                                ; preds = %4
  ...
  %16 = select i1 %14, i8 32, i8 10
  %17 = sext i8 %16 to i32
  %18 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32 %12, i32 %17)
  br label %19
...
29:                                               ; preds = %7
  %30 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), i32* %4, i32* %3)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1127.cpp() #0 section ".text.startup" {
