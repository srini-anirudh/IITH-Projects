; ModuleID = 'POJ-104-source/81/81-1147.cpp'
source_filename = "POJ-104-source/81/81-1147.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1147.cpp, i8* null }]
...
define dso_local i32 @_Z8exchangeii(i32 %0, i32 %1) #4 {
...
32:                                               ; preds = %10
  ...
  %36 = call i32 @_Z8exchangeii(i32 %34, i32 %35)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1147.cpp() #0 section ".text.startup" {
