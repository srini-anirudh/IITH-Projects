; ModuleID = 'POJ-104-source/81/81-1163.cpp'
source_filename = "POJ-104-source/81/81-1163.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1163.cpp, i8* null }]
...
define dso_local i32 @_Z2jhii(i32 %0, i32 %1) #4 {
...
32:                                               ; preds = %10
  %33 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %7)
  %34 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %8)
  %35 = load i32, i32* %7, align 4
  %36 = load i32, i32* %8, align 4
  %37 = call i32 @_Z2jhii(i32 %35, i32 %36)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1163.cpp() #0 section ".text.startup" {
