; ModuleID = 'POJ-104-source/81/81-1164.cpp'
source_filename = "POJ-104-source/81/81-1164.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1164.cpp, i8* null }]
...
41:                                               ; preds = %38
  ...
  %49 = getelementptr inbounds [1 x [5 x i32]], [1 x [5 x i32]]* %5, i64 0, i64 0
...
81:                                               ; preds = %78
  %82 = getelementptr inbounds [1 x [5 x i32]], [1 x [5 x i32]]* %5, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1164.cpp() #0 section ".text.startup" {
