; ModuleID = 'POJ-104-source/81/81-1176.cpp'
source_filename = "POJ-104-source/81/81-1176.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1176.cpp, i8* null }]
...
31:                                               ; preds = %9
  ...
  %34 = call i32 @_Z2swPA5_iPiS1_([5 x i32]* %33, i32* %3, i32* %4)
  %35 = icmp eq i32 %34, 1
...
define dso_local i32 @_Z2swPA5_iPiS1_([5 x i32]* %0, i32* %1, i32* %2) #5 {
  %4 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1176.cpp() #0 section ".text.startup" {
