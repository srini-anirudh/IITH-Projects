; ModuleID = 'POJ-104-source/81/81-1182.cpp'
source_filename = "POJ-104-source/81/81-1182.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1182.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z2jhPA5_iii([5 x i32]* %0, i32 %1, i32 %2) #0 {
...
12:                                               ; preds = %9
  ...
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i32* %18)
  br label %20
...
27:                                               ; preds = %5
  %28 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.4, i64 0, i64 0), i32* @m, i32* @n)
  %29 = load i32, i32* @m, align 4
  %30 = load i32, i32* @n, align 4
  %31 = call i32 @_Z2jhPA5_iii([5 x i32]* getelementptr inbounds ([5 x [5 x i32]], [5 x [5 x i32]]* @a, i64 0, i64 0), i32 %29, i32 %30)
  %32 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i32* %4)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1182.cpp() #0 section ".text.startup" {
