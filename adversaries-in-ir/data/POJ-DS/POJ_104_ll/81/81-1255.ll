; ModuleID = 'POJ-104-source/81/81-1255.cpp'
source_filename = "POJ-104-source/81/81-1255.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1255.cpp, i8* null }]
...
24:                                               ; preds = %2
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* @n, i32* @m)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1255.cpp() #0 section ".text.startup" {
