; ModuleID = 'POJ-104-source/81/81-1269.cpp'
source_filename = "POJ-104-source/81/81-1269.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1269.cpp, i8* null }]
...
32:                                               ; preds = %10
  %33 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %2, i32* %3)
  %34 = load i32, i32* %2, align 4
  %35 = load i32, i32* %3, align 4
  %36 = call i32 @_Z6changeii(i32 %34, i32 %35)
  %37 = icmp eq i32 %36, 0
...
40:                                               ; preds = %32
  ...
  %43 = call i32 @_Z6changeii(i32 %41, i32 %42)
  %44 = icmp eq i32 %43, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1269.cpp() #0 section ".text.startup" {
