; ModuleID = 'POJ-104-source/81/81-1303.cpp'
source_filename = "POJ-104-source/81/81-1303.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1303.cpp, i8* null }]
...
30:                                               ; preds = %8
  %31 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %3, i32* %4)
  %32 = getelementptr inbounds [5 x [5 x i32]], [5 x [5 x i32]]* %2, i64 0, i64 0
  %33 = call i32 @_Z3revPA5_iPiS1_([5 x i32]* %32, i32* %3, i32* %4)
...
define dso_local i32 @_Z3revPA5_iPiS1_([5 x i32]* %0, i32* %1, i32* %2) #5 {
  %4 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1303.cpp() #0 section ".text.startup" {
