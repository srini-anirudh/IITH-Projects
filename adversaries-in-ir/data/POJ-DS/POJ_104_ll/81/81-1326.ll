; ModuleID = 'POJ-104-source/81/81-1326.cpp'
source_filename = "POJ-104-source/81/81-1326.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1326.cpp, i8* null }]
...
define dso_local i32 @_Z7panduanPA5_iii([5 x i32]* %0, i32 %1, i32 %2) #4 {
...
; Function Attrs: noinline uwtable
define dso_local void @_Z8diaohuanPA5_iii([5 x i32]* %0, i32 %1, i32 %2) #0 {
  ...
  %13 = call i32 @_Z7panduanPA5_iii([5 x i32]* %10, i32 %11, i32 %12)
  %14 = icmp eq i32 %13, 1
...
29:                                               ; preds = %7
  %30 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.3, i64 0, i64 0), i32* %3, i32* %4)
  %31 = getelementptr inbounds [5 x [5 x i32]], [5 x [5 x i32]]* %2, i64 0, i64 0
  %32 = load i32, i32* %3, align 4
  %33 = load i32, i32* %4, align 4
  %34 = call i32 @_Z7panduanPA5_iii([5 x i32]* %31, i32 %32, i32 %33)
  %35 = icmp eq i32 %34, 0
...
38:                                               ; preds = %29
  ...
  %42 = call i32 @_Z7panduanPA5_iii([5 x i32]* %39, i32 %40, i32 %41)
  %43 = icmp eq i32 %42, 1
...
44:                                               ; preds = %38
  ...
  call void @_Z8diaohuanPA5_iii([5 x i32]* %45, i32 %46, i32 %47)
  br label %48
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1326.cpp() #0 section ".text.startup" {
