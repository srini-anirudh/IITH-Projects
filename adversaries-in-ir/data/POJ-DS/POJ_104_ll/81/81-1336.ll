; ModuleID = 'POJ-104-source/81/81-1336.cpp'
source_filename = "POJ-104-source/81/81-1336.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1336.cpp, i8* null }]
...
34:                                               ; preds = %12
  %35 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %8, i32* %7)
  %36 = load i32, i32* %7, align 4
  %37 = load i32, i32* %8, align 4
  %38 = call i32 @_Z7reverseii(i32 %36, i32 %37)
  %39 = icmp eq i32 %38, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1336.cpp() #0 section ".text.startup" {
