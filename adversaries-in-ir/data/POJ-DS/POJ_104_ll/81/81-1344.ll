; ModuleID = 'POJ-104-source/81/81-1344.cpp'
source_filename = "POJ-104-source/81/81-1344.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1344.cpp, i8* null }]
...
define dso_local void @_Z8jiaohuanii(i32 %0, i32 %1) #4 {
...
43:                                               ; preds = %38
  ...
  call void @_Z8jiaohuanii(i32 %44, i32 %45)
  store i32 0, i32* %2, align 4
  br label %46
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1344.cpp() #0 section ".text.startup" {
