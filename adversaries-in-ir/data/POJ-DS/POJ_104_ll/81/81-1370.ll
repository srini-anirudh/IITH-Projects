; ModuleID = 'POJ-104-source/81/81-1370.cpp'
source_filename = "POJ-104-source/81/81-1370.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1370.cpp, i8* null }]
...
28:                                               ; preds = %6
  %29 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %4, i32* %5)
  %30 = load i32, i32* %4, align 4
  %31 = load i32, i32* %5, align 4
  %32 = call i32 @_Z4swapPA5_iii([5 x i32]* getelementptr inbounds ([5 x [5 x i32]], [5 x [5 x i32]]* @a, i64 0, i64 0), i32 %30, i32 %31)
  %33 = icmp eq i32 %32, 1
...
65:                                               ; preds = %28
  ...
  %68 = call i32 @_Z4swapPA5_iii([5 x i32]* getelementptr inbounds ([5 x [5 x i32]], [5 x [5 x i32]]* @a, i64 0, i64 0), i32 %66, i32 %67)
  %69 = icmp eq i32 %68, 0
...
define dso_local i32 @_Z4swapPA5_iii([5 x i32]* %0, i32 %1, i32 %2) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1370.cpp() #0 section ".text.startup" {
