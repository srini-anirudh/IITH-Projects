; ModuleID = 'POJ-104-source/81/81-1381.cpp'
source_filename = "POJ-104-source/81/81-1381.cpp"
...
@e = dso_local global [5 x i32] zeroinitializer, align 16
@after = dso_local global [5 x [5 x i32]] zeroinitializer, align 16
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1381.cpp, i8* null }]
...
28:                                               ; preds = %6
  %29 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* @m, i32* @n)
  %30 = load i32, i32* @m, align 4
  %31 = load i32, i32* @n, align 4
  %32 = call i32 @_Z8exchangeii(i32 %30, i32 %31)
  %33 = icmp eq i32 %32, 0
...
define dso_local i32 @_Z8exchangeii(i32 %0, i32 %1) #5 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1381.cpp() #0 section ".text.startup" {
