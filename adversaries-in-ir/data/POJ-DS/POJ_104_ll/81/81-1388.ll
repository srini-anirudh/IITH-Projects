; ModuleID = 'POJ-104-source/81/81-1388.cpp'
source_filename = "POJ-104-source/81/81-1388.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1388.cpp, i8* null }]
...
29:                                               ; preds = %7
  ...
  call void @_Z8exchangePA5_iii([5 x i32]* %31, i32 %32, i32 %33)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define dso_local void @_Z8exchangePA5_iii([5 x i32]* %0, i32 %1, i32 %2) #0 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1388.cpp() #0 section ".text.startup" {
