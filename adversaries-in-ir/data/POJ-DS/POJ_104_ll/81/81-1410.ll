; ModuleID = 'POJ-104-source/81/81-1410.cpp'
source_filename = "POJ-104-source/81/81-1410.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1410.cpp, i8* null }]
...
27:                                               ; preds = %5
  %28 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %3, i32* %4)
  %29 = getelementptr inbounds [5 x [5 x i32]], [5 x [5 x i32]]* %2, i64 0, i64 0
  %30 = load i32, i32* %3, align 4
  %31 = load i32, i32* %4, align 4
  %32 = call i32 @_Z8exchangePA5_iii([5 x i32]* %29, i32 %30, i32 %31)
  %33 = icmp eq i32 %32, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1410.cpp() #0 section ".text.startup" {
