; ModuleID = 'POJ-104-source/81/81-1418.cpp'
source_filename = "POJ-104-source/81/81-1418.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1418.cpp, i8* null }]
...
29:                                               ; preds = %7
  ...
  %38 = call i32 @_Z6changePA5_iii([5 x i32]* %35, i32 %36, i32 %37)
  %39 = icmp eq i32 %38, 0
...
42:                                               ; preds = %40, %29
  ...
  %46 = call i32 @_Z6changePA5_iii([5 x i32]* %43, i32 %44, i32 %45)
  %47 = icmp eq i32 %46, 1
...
define dso_local i32 @_Z6changePA5_iii([5 x i32]* %0, i32 %1, i32 %2) #5 {
  %4 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1418.cpp() #0 section ".text.startup" {
