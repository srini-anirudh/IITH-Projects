; ModuleID = 'POJ-104-source/81/81-1420.cpp'
source_filename = "POJ-104-source/81/81-1420.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1420.cpp, i8* null }]
...
define dso_local i32 @_Z6matrixii(i32 %0, i32 %1) #4 {
...
29:                                               ; preds = %7
  ...
  %33 = call i32 @_Z6matrixii(i32 %31, i32 %32)
  %34 = icmp eq i32 %33, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1420.cpp() #0 section ".text.startup" {
