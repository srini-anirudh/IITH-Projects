; ModuleID = 'POJ-104-source/81/81-1421.cpp'
source_filename = "POJ-104-source/81/81-1421.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1421.cpp, i8* null }]
...
48:                                               ; preds = %45
  ...
  call void @_Z7replacePiS_(i32* %65, i32* %66)
  br label %67
...
define dso_local void @_Z7replacePiS_(i32* %0, i32* %1) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1421.cpp() #0 section ".text.startup" {
