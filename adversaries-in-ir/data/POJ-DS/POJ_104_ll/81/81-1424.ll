; ModuleID = 'POJ-104-source/81/81-1424.cpp'
source_filename = "POJ-104-source/81/81-1424.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1424.cpp, i8* null }]
...
define dso_local i32 @_Z8exchangePA5_iii([5 x i32]* %0, i32 %1, i32 %2) #4 {
...
34:                                               ; preds = %12
  %35 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %7, i32* %8)
  %36 = getelementptr inbounds [5 x [5 x i32]], [5 x [5 x i32]]* %6, i64 0, i64 0
  %37 = load i32, i32* %7, align 4
  %38 = load i32, i32* %8, align 4
  %39 = call i32 @_Z8exchangePA5_iii([5 x i32]* %36, i32 %37, i32 %38)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1424.cpp() #0 section ".text.startup" {
