; ModuleID = 'POJ-104-source/81/81-1434.cpp'
source_filename = "POJ-104-source/81/81-1434.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1434.cpp, i8* null }]
...
define dso_local i32 @_Z7SwapRowPA5_iii([5 x i32]* %0, i32 %1, i32 %2) #4 {
...
33:                                               ; preds = %11
  ...
  %38 = call i32 @_Z7SwapRowPA5_iii([5 x i32]* %35, i32 %36, i32 %37)
  %39 = icmp eq i32 0, %38
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1434.cpp() #0 section ".text.startup" {
