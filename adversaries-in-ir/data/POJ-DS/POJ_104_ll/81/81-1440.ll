; ModuleID = 'POJ-104-source/81/81-1440.cpp'
source_filename = "POJ-104-source/81/81-1440.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1440.cpp, i8* null }]
...
50:                                               ; preds = %47
  ...
  call void @_Z4swapPiS_(i32* %56, i32* %62)
  br label %63
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1440.cpp() #0 section ".text.startup" {
