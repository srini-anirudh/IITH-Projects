; ModuleID = 'POJ-104-source/81/81-1459.cpp'
source_filename = "POJ-104-source/81/81-1459.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1459.cpp, i8* null }]
...
33:                                               ; preds = %9
  %34 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %4, i32* %5)
  %35 = load [5 x i32]*, [5 x i32]** %7, align 8
  %36 = load i32, i32* %4, align 4
  %37 = load i32, i32* %5, align 4
  %38 = call i32 @_Z8jiaohuanPA5_iii([5 x i32]* %35, i32 %36, i32 %37)
  %39 = icmp eq i32 %38, 0
...
define dso_local i32 @_Z8jiaohuanPA5_iii([5 x i32]* %0, i32 %1, i32 %2) #5 {
  %4 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1459.cpp() #0 section ".text.startup" {
