; ModuleID = 'POJ-104-source/81/81-1461.cpp'
source_filename = "POJ-104-source/81/81-1461.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1461.cpp, i8* null }]
...
31:                                               ; preds = %9
  ...
  %35 = call i32 @_Z8converseii(i32 %33, i32 %34)
  %36 = icmp ne i32 %35, 0
...
define dso_local i32 @_Z8converseii(i32 %0, i32 %1) #6 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1461.cpp() #0 section ".text.startup" {
