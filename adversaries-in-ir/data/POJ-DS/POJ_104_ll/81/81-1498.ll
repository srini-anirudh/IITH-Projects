; ModuleID = 'POJ-104-source/81/81-1498.cpp'
source_filename = "POJ-104-source/81/81-1498.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1498.cpp, i8* null }]
...
103:                                              ; preds = %30
  %104 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.4, i64 0, i64 0))
  br label %105
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1498.cpp() #0 section ".text.startup" {
