; ModuleID = 'POJ-104-source/81/81-1533.cpp'
source_filename = "POJ-104-source/81/81-1533.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1533.cpp, i8* null }]
...
29:                                               ; preds = %7
  %30 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %6, i32* %5)
  %31 = getelementptr inbounds [5 x [5 x i32]], [5 x [5 x i32]]* %2, i64 0, i64 0
  %32 = load i32, i32* %6, align 4
  %33 = load i32, i32* %5, align 4
  %34 = call i32 @_Z6changePA5_iii([5 x i32]* %31, i32 %32, i32 %33)
  %35 = icmp eq i32 %34, 0
...
42:                                               ; preds = %39
  ...
  %69 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.4, i64 0, i64 0), i32 %48, i32 %53, i32 %58, i32 %63, i32 %68)
  br label %70
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1533.cpp() #0 section ".text.startup" {
