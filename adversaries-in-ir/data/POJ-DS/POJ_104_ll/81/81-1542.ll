; ModuleID = 'POJ-104-source/81/81-1542.cpp'
source_filename = "POJ-104-source/81/81-1542.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1542.cpp, i8* null }]
...
30:                                               ; preds = %8
  ...
  %35 = call i32 @_Z6hanshuPA5_iii([5 x i32]* %32, i32 %33, i32 %34)
  %36 = icmp eq i32 %35, 0
...
39:                                               ; preds = %37, %30
  ...
  %43 = call i32 @_Z6hanshuPA5_iii([5 x i32]* %40, i32 %41, i32 %42)
  %44 = icmp eq i32 %43, 1
...
49:                                               ; preds = %46
  ...
  %57 = getelementptr inbounds [1 x [5 x i32]], [1 x [5 x i32]]* %3, i64 0, i64 0
  ...
  %74 = getelementptr inbounds [1 x [5 x i32]], [1 x [5 x i32]]* %3, i64 0, i64 0
...
92:                                               ; preds = %89
  ...
  %118 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.3, i64 0, i64 0), i32 %97, i32 %102, i32 %107, i32 %112, i32 %117)
  br label %119
...
define dso_local i32 @_Z6hanshuPA5_iii([5 x i32]* %0, i32 %1, i32 %2) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1542.cpp() #0 section ".text.startup" {
