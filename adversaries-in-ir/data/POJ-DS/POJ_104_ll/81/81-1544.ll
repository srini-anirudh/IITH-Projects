; ModuleID = 'POJ-104-source/81/81-1544.cpp'
source_filename = "POJ-104-source/81/81-1544.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1544.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %10 = bitcast [5 x [5 x i32]]* %8 to i8*
...
33:                                               ; preds = %11
  ...
  %37 = call i32 @_Z6changeii(i32 %35, i32 %36)
...
67:                                               ; preds = %64
  ...
  %70 = getelementptr inbounds [5 x [5 x i32]], [5 x [5 x i32]]* %8, i64 0, i64 %69
  ...
  %77 = getelementptr inbounds [5 x [5 x i32]], [5 x [5 x i32]]* %8, i64 0, i64 %76
...
106:                                              ; preds = %103
  ...
  %119 = getelementptr inbounds [5 x [5 x i32]], [5 x [5 x i32]]* %8, i64 0, i64 %118
  ...
  %132 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.3, i64 0, i64 0), i32 %111, i32 %116, i32 %121, i32 %126, i32 %131)
  br label %133
...
define dso_local i32 @_Z6changeii(i32 %0, i32 %1) #6 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1544.cpp() #0 section ".text.startup" {
