; ModuleID = 'POJ-104-source/81/81-1550.cpp'
source_filename = "POJ-104-source/81/81-1550.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1550.cpp, i8* null }]
...
95:                                               ; preds = %80
  ...
  %101 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.4, i64 0, i64 0), i32 %100)
  br label %102
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1550.cpp() #0 section ".text.startup" {
