; ModuleID = 'POJ-104-source/81/81-1563.cpp'
source_filename = "POJ-104-source/81/81-1563.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1563.cpp, i8* null }]
...
100:                                              ; preds = %85
  ...
  %106 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.4, i64 0, i64 0), i32 %105)
  br label %107
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1563.cpp() #0 section ".text.startup" {
