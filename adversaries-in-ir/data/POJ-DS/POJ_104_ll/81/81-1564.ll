; ModuleID = 'POJ-104-source/81/81-1564.cpp'
source_filename = "POJ-104-source/81/81-1564.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1564.cpp, i8* null }]
...
42:                                               ; preds = %39
  ...
  %45 = getelementptr inbounds [5 x [5 x i32]], [5 x [5 x i32]]* %5, i64 0, i64 0
  call void @_Z6changeiiPA5_i(i32 %43, i32 %44, [5 x i32]* %45)
  br label %46
...
; Function Attrs: noinline uwtable
define dso_local void @_Z6changeiiPA5_i(i32 %0, i32 %1, [5 x i32]* %2) #0 {
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1564.cpp() #0 section ".text.startup" {
