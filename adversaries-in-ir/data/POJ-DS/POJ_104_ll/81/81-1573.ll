; ModuleID = 'POJ-104-source/81/81-1573.cpp'
source_filename = "POJ-104-source/81/81-1573.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1573.cpp, i8* null }]
...
30:                                               ; preds = %8
  ...
  %34 = call i32 @_Z2arii(i32 %32, i32 %33)
  %35 = icmp eq i32 %34, 1
...
define dso_local i32 @_Z2arii(i32 %0, i32 %1) #5 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1573.cpp() #0 section ".text.startup" {
