; ModuleID = 'POJ-104-source/81/81-1575.cpp'
source_filename = "POJ-104-source/81/81-1575.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1575.cpp, i8* null }]
...
89:                                               ; preds = %86
  ...
  %115 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.3, i64 0, i64 0), i32 %94, i32 %99, i32 %104, i32 %109, i32 %114)
  br label %116
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1575.cpp() #0 section ".text.startup" {
