; ModuleID = 'POJ-104-source/81/81-1581.cpp'
source_filename = "POJ-104-source/81/81-1581.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1581.cpp, i8* null }]
...
define dso_local i32 @_Z4swapPA5_iii([5 x i32]* %0, i32 %1, i32 %2) #4 {
...
29:                                               ; preds = %7
  ...
  %34 = call i32 @_Z4swapPA5_iii([5 x i32]* %31, i32 %32, i32 %33)
  %35 = icmp eq i32 %34, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1581.cpp() #0 section ".text.startup" {
