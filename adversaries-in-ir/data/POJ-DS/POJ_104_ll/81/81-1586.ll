; ModuleID = 'POJ-104-source/81/81-1586.cpp'
source_filename = "POJ-104-source/81/81-1586.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1586.cpp, i8* null }]
...
define dso_local i32 @_Z2chPA5_iii([5 x i32]* %0, i32 %1, i32 %2) #4 {
...
32:                                               ; preds = %10
  %33 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %6, i32* %5)
  %34 = getelementptr inbounds [5 x [5 x i32]], [5 x [5 x i32]]* %2, i64 0, i64 0
  %35 = load i32, i32* %6, align 4
  %36 = load i32, i32* %5, align 4
  %37 = call i32 @_Z2chPA5_iii([5 x i32]* %34, i32 %35, i32 %36)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1586.cpp() #0 section ".text.startup" {
