; ModuleID = 'POJ-104-source/81/81-1594.cpp'
source_filename = "POJ-104-source/81/81-1594.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1594.cpp, i8* null }]
...
30:                                               ; preds = %8
  %31 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %5, i32* %6)
...
39:                                               ; preds = %30
  ...
  %43 = call i32 @_Z6changePA5_iii([5 x i32]* %40, i32 %41, i32 %42)
  %44 = icmp eq i32 %43, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1594.cpp() #0 section ".text.startup" {
