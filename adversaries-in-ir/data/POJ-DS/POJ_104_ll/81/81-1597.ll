; ModuleID = 'POJ-104-source/81/81-1597.cpp'
source_filename = "POJ-104-source/81/81-1597.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1597.cpp, i8* null }]
...
24:                                               ; preds = %2
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* @n1, i32* @m1)
  %26 = load i32, i32* @n1, align 4
  %27 = load i32, i32* @m1, align 4
  %28 = call i32 @_Z2chii(i32 %26, i32 %27)
  %29 = icmp eq i32 %28, 0
...
32:                                               ; preds = %30, %24
  ...
  %35 = call i32 @_Z2chii(i32 %33, i32 %34)
  %36 = icmp eq i32 %35, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1597.cpp() #0 section ".text.startup" {
