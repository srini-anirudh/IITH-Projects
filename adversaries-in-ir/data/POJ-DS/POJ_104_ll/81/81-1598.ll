; ModuleID = 'POJ-104-source/81/81-1598.cpp'
source_filename = "POJ-104-source/81/81-1598.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1598.cpp, i8* null }]
...
define dso_local void @_Z1qPA5_iii([5 x i32]* %0, i32 %1, i32 %2) #4 {
...
41:                                               ; preds = %36
  ...
  call void @_Z1qPA5_iii([5 x i32]* %42, i32 %43, i32 %44)
  store i32 0, i32* %3, align 4
  br label %45
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1598.cpp() #0 section ".text.startup" {
