; ModuleID = 'POJ-104-source/81/81-1644.cpp'
source_filename = "POJ-104-source/81/81-1644.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1644.cpp, i8* null }]
...
define dso_local i32 @_Z3matPA5_iii([5 x i32]* %0, i32 %1, i32 %2) #4 {
...
35:                                               ; preds = %13
  %36 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %10, i32* %11)
  %37 = getelementptr inbounds [5 x [5 x i32]], [5 x [5 x i32]]* %6, i64 0, i64 0
  %38 = load i32, i32* %10, align 4
  %39 = load i32, i32* %11, align 4
  %40 = call i32 @_Z3matPA5_iii([5 x i32]* %37, i32 %38, i32 %39)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1644.cpp() #0 section ".text.startup" {
