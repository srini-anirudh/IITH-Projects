; ModuleID = 'POJ-104-source/81/81-1654.cpp'
source_filename = "POJ-104-source/81/81-1654.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1654.cpp, i8* null }]
...
define dso_local void @_Z6jisuanii(i32 %0, i32 %1) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z8huanhangii(i32 %0, i32 %1) #4 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
...
26:                                               ; preds = %4
  %27 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* @n, i32* @m)
  %28 = load i32, i32* @n, align 4
  %29 = load i32, i32* @m, align 4
  %30 = call i32 @_Z8huanhangii(i32 %28, i32 %29)
  %31 = icmp eq i32 %30, 0
...
34:                                               ; preds = %32, %26
  ...
  %37 = call i32 @_Z8huanhangii(i32 %35, i32 %36)
  %38 = icmp eq i32 %37, 1
...
39:                                               ; preds = %34
  ...
  call void @_Z6jisuanii(i32 %40, i32 %41)
  store i32 0, i32* %2, align 4
  br label %42
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1654.cpp() #0 section ".text.startup" {
