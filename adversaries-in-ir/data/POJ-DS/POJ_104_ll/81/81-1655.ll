; ModuleID = 'POJ-104-source/81/81-1655.cpp'
source_filename = "POJ-104-source/81/81-1655.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1655.cpp, i8* null }]
...
27:                                               ; preds = %5
  ...
  %31 = call i32 @_Z8jiaohuanPA5_iii([5 x i32]* getelementptr inbounds ([5 x [5 x i32]], [5 x [5 x i32]]* @a, i64 0, i64 0), i32 %29, i32 %30)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1655.cpp() #0 section ".text.startup" {
