; ModuleID = 'POJ-104-source/81/81-1700.cpp'
source_filename = "POJ-104-source/81/81-1700.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1700.cpp, i8* null }]
...
34:                                               ; preds = %7
  %35 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), i32* %5, i32* %4)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1700.cpp() #0 section ".text.startup" {
