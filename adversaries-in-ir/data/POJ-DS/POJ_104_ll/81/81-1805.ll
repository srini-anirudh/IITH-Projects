; ModuleID = 'POJ-104-source/81/81-1805.cpp'
source_filename = "POJ-104-source/81/81-1805.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1805.cpp, i8* null }]
...
define dso_local i32 @_Z1xii(i32 %0, i32 %1) #4 {
...
31:                                               ; preds = %9
  ...
  %35 = call i32 @_Z1xii(i32 %33, i32 %34)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1805.cpp() #0 section ".text.startup" {
