; ModuleID = 'POJ-104-source/81/81-1817.cpp'
source_filename = "POJ-104-source/81/81-1817.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1817.cpp, i8* null }]
...
define dso_local i32 @_Z3gmmii(i32 %0, i32 %1) #4 {
...
28:                                               ; preds = %6
  ...
  %32 = call i32 @_Z3gmmii(i32 %30, i32 %31)
  %33 = icmp eq i32 %32, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1817.cpp() #0 section ".text.startup" {
