; ModuleID = 'POJ-104-source/81/81-1832.cpp'
source_filename = "POJ-104-source/81/81-1832.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1832.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %12 = call i32 @_Z2swPA5_iii([5 x i32]* %9, i32 %10, i32 %11)
  %13 = icmp eq i32 %12, 0
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z2swPA5_iii([5 x i32]* %0, i32 %1, i32 %2) #0 {
  %4 = alloca i32, align 4
...
37:                                               ; preds = %14
  %38 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.4, i64 0, i64 0), i32* %6, i32* %7)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1832.cpp() #0 section ".text.startup" {
