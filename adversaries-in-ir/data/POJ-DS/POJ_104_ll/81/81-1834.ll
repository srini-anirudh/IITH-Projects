; ModuleID = 'POJ-104-source/81/81-1834.cpp'
source_filename = "POJ-104-source/81/81-1834.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1834.cpp, i8* null }]
...
define dso_local i32 @_Z2suiiPi(i32 %0, i32 %1, i32* %2) #4 {
...
33:                                               ; preds = %11
  %34 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %10, i32* %9)
  ...
  %39 = call i32 @_Z2suiiPi(i32 %35, i32 %36, i32* %38)
  %40 = icmp ne i32 %39, 0
...
72:                                               ; preds = %71, %33
  ...
  %77 = call i32 @_Z2suiiPi(i32 %73, i32 %74, i32* %76)
  %78 = icmp eq i32 %77, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1834.cpp() #0 section ".text.startup" {
