; ModuleID = 'POJ-104-source/81/81-1849.cpp'
source_filename = "POJ-104-source/81/81-1849.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1849.cpp, i8* null }]
...
define dso_local i32 @_Z6hanshuii(i32 %0, i32 %1) #4 {
...
31:                                               ; preds = %9
  %32 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %7, i32* %6)
  %33 = load i32, i32* %7, align 4
  %34 = load i32, i32* %6, align 4
  %35 = call i32 @_Z6hanshuii(i32 %33, i32 %34)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1849.cpp() #0 section ".text.startup" {
