; ModuleID = 'POJ-104-source/81/81-1851.cpp'
source_filename = "POJ-104-source/81/81-1851.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1851.cpp, i8* null }]
...
28:                                               ; preds = %6
  %29 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %5, i32* %4)
  %30 = load i32, i32* %5, align 4
  %31 = load i32, i32* %4, align 4
  %32 = call i32 @_Z7processii(i32 %30, i32 %31)
  %33 = icmp ne i32 %32, 0
...
define dso_local i32 @_Z7processii(i32 %0, i32 %1) #5 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1851.cpp() #0 section ".text.startup" {
