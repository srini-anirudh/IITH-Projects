; ModuleID = 'POJ-104-source/81/81-1852.cpp'
source_filename = "POJ-104-source/81/81-1852.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1852.cpp, i8* null }]
...
30:                                               ; preds = %8
  ...
  %33 = call i32 @_Z1ai(i32 %32)
  %34 = icmp eq i32 %33, 0
  br i1 %34, label %39, label %35

35:                                               ; preds = %30
  %36 = load i32, i32* %7, align 4
  %37 = call i32 @_Z1ai(i32 %36)
  %38 = icmp eq i32 %37, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1852.cpp() #0 section ".text.startup" {
