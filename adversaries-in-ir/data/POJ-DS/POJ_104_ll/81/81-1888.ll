; ModuleID = 'POJ-104-source/81/81-1888.cpp'
source_filename = "POJ-104-source/81/81-1888.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1888.cpp, i8* null }]
...
30:                                               ; preds = %8
  ...
  %35 = call i32 @_Z1fiiPA5_i(i32 %32, i32 %33, [5 x i32]* %34)
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z1fiiPA5_i(i32 %0, i32 %1, [5 x i32]* %2) #0 {
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1888.cpp() #0 section ".text.startup" {
