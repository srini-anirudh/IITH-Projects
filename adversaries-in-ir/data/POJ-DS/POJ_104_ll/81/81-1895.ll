; ModuleID = 'POJ-104-source/81/81-1895.cpp'
source_filename = "POJ-104-source/81/81-1895.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1895.cpp, i8* null }]
...
define dso_local i32 @_Z2qqii(i32 %0, i32 %1) #4 {
...
11:                                               ; preds = %8
  ...
  %32 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i64 0, i64 0), i32* %15, i32* %19, i32* %23, i32* %27, i32* %31)
  br label %33
...
36:                                               ; preds = %8
  %37 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %2, i32* %3)
  %38 = load i32, i32* %2, align 4
  %39 = load i32, i32* %3, align 4
  %40 = call i32 @_Z2qqii(i32 %38, i32 %39)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1895.cpp() #0 section ".text.startup" {
