; ModuleID = 'POJ-104-source/81/81-1912.cpp'
source_filename = "POJ-104-source/81/81-1912.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1912.cpp, i8* null }]
...
68:                                               ; preds = %67, %29
  ...
  %72 = call i32 @_Z1fPA5_iii([5 x i32]* %69, i32 %70, i32 %71)
  %73 = icmp eq i32 %72, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1912.cpp() #0 section ".text.startup" {
