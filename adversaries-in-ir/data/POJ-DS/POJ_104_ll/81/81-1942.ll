; ModuleID = 'POJ-104-source/81/81-1942.cpp'
source_filename = "POJ-104-source/81/81-1942.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1942.cpp, i8* null }]
...
define dso_local i32 @_Z2pdii(i32 %0, i32 %1) #4 {
...
34:                                               ; preds = %12
  %35 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %11, i32* %10)
  %36 = load i32, i32* %11, align 4
  %37 = load i32, i32* %10, align 4
  %38 = call i32 @_Z2pdii(i32 %36, i32 %37)
  %39 = icmp eq i32 %38, 0
...
42:                                               ; preds = %40, %34
  ...
  %45 = call i32 @_Z2pdii(i32 %43, i32 %44)
  %46 = icmp eq i32 %45, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1942.cpp() #0 section ".text.startup" {
