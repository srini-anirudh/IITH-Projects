; ModuleID = 'POJ-104-source/81/81-1952.cpp'
source_filename = "POJ-104-source/81/81-1952.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1952.cpp, i8* null }]
...
120:                                              ; preds = %105
  ...
  %124 = getelementptr inbounds [10 x i32], [10 x i32]* %123, i64 0, i64 4
...
134:                                              ; preds = %131
  %135 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* %2, i64 0, i64 4
...
144:                                              ; preds = %131
  %145 = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* %2, i64 0, i64 4
...
149:                                              ; preds = %41, %38, %35, %31
  %150 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.4, i64 0, i64 0))
  br label %151
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1952.cpp() #0 section ".text.startup" {
