; ModuleID = 'POJ-104-source/81/81-1978.cpp'
source_filename = "POJ-104-source/81/81-1978.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1978.cpp, i8* null }]
...
30:                                               ; preds = %8
  ...
  %35 = call i32 @_Z3fucPA5_iii([5 x i32]* %32, i32 %33, i32 %34)
  %36 = icmp ne i32 %35, 0
...
define dso_local i32 @_Z3fucPA5_iii([5 x i32]* %0, i32 %1, i32 %2) #5 {
  %4 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1978.cpp() #0 section ".text.startup" {
