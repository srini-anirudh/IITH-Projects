; ModuleID = 'POJ-104-source/81/81-1985.cpp'
source_filename = "POJ-104-source/81/81-1985.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1985.cpp, i8* null }]
...
16:                                               ; preds = %13
  %17 = getelementptr inbounds [5 x [5 x i32]], [5 x [5 x i32]]* %4, i64 0, i64 0
...
33:                                               ; preds = %9
  ...
  %35 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), i32* %2, i32* %3)
  %36 = load i32, i32* %2, align 4
  %37 = load i32, i32* %3, align 4
  %38 = getelementptr inbounds [5 x [5 x i32]], [5 x [5 x i32]]* %4, i64 0, i64 0
  %39 = call i32 @_Z1fiiPA5_i(i32 %36, i32 %37, [5 x i32]* %38)
...
64:                                               ; preds = %49
  ...
  %70 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.5, i64 0, i64 0), i32 %69)
  br label %71
...
define dso_local i32 @_Z1fiiPA5_i(i32 %0, i32 %1, [5 x i32]* %2) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1985.cpp() #0 section ".text.startup" {
