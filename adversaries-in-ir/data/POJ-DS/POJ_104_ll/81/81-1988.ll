; ModuleID = 'POJ-104-source/81/81-1988.cpp'
source_filename = "POJ-104-source/81/81-1988.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1988.cpp, i8* null }]
...
48:                                               ; preds = %25
  %49 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %5, i32* %4)
  %50 = getelementptr inbounds [5 x i32*], [5 x i32*]* %3, i64 0, i64 0
  %51 = load i32, i32* %5, align 4
  %52 = load i32, i32* %4, align 4
  %53 = call i32 @_Z1fPPiii(i32** %50, i32 %51, i32 %52)
...
define dso_local i32 @_Z1fPPiii(i32** %0, i32 %1, i32 %2) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1988.cpp() #0 section ".text.startup" {
