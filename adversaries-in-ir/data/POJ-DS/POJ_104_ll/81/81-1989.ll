; ModuleID = 'POJ-104-source/81/81-1989.cpp'
source_filename = "POJ-104-source/81/81-1989.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1989.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %9 = bitcast i8* %8 to [5 x i32]*
  store [5 x i32]* %9, [5 x i32]** %2, align 8
...
17:                                               ; preds = %14
  %18 = load [5 x i32]*, [5 x i32]** %2, align 8
...
34:                                               ; preds = %10
  %35 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %7, i32* %6)
  %36 = load [5 x i32]*, [5 x i32]** %2, align 8
  %37 = load i32, i32* %7, align 4
  %38 = load i32, i32* %6, align 4
  %39 = call i32 @_Z1fPA5_iii([5 x i32]* %36, i32 %37, i32 %38)
...
66:                                               ; preds = %49
  %67 = load [5 x i32]*, [5 x i32]** %2, align 8
...
define dso_local i32 @_Z1fPA5_iii([5 x i32]* %0, i32 %1, i32 %2) #5 {
  %4 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1989.cpp() #0 section ".text.startup" {
