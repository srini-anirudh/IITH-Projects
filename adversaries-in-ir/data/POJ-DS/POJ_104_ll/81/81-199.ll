; ModuleID = 'POJ-104-source/81/81-199.cpp'
source_filename = "POJ-104-source/81/81-199.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_199.cpp, i8* null }]
...
define dso_local i32 @_Z3haniiPA5_i(i32 %0, i32 %1, [5 x i32]* %2) #4 {
...
26:                                               ; preds = %4
  %27 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* @m, i32* @n)
  %28 = load i32, i32* @m, align 4
  %29 = load i32, i32* @n, align 4
  %30 = getelementptr inbounds [5 x [5 x i32]], [5 x [5 x i32]]* %2, i64 0, i64 0
  %31 = call i32 @_Z3haniiPA5_i(i32 %28, i32 %29, [5 x i32]* %30)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_199.cpp() #0 section ".text.startup" {
