; ModuleID = 'POJ-104-source/81/81-1999.cpp'
source_filename = "POJ-104-source/81/81-1999.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_1999.cpp, i8* null }]
...
30:                                               ; preds = %8
  ...
  %36 = call i32 @_Z1fiiPi(i32 %32, i32 %33, i32* %35)
...
define dso_local i32 @_Z1fiiPi(i32 %0, i32 %1, i32* %2) #5 {
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_1999.cpp() #0 section ".text.startup" {
