; ModuleID = 'POJ-104-source/81/81-2005.cpp'
source_filename = "POJ-104-source/81/81-2005.cpp"
...
@b = dso_local global [5 x [5 x i32]] zeroinitializer, align 16
@m = dso_local global i32 0, align 4
@n = dso_local global i32 0, align 4
@c = dso_local global [5 x i32] zeroinitializer, align 16
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [6 x i8] c"error\00", align 1
@.str.2 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
@.str.3 = private unnamed_addr constant [4 x i8] c"%d \00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_2005.cpp, i8* null }]
...
define dso_local i32 @_Z9zhuanhuanPA5_iii([5 x i32]* %0, i32 %1, i32 %2) #4 {
...
28:                                               ; preds = %5
  %29 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* @m)
  %30 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* @n)
  %31 = load i32, i32* @m, align 4
  %32 = load i32, i32* @n, align 4
  %33 = call i32 @_Z9zhuanhuanPA5_iii([5 x i32]* getelementptr inbounds ([5 x [5 x i32]], [5 x [5 x i32]]* @a, i64 0, i64 0), i32 %31, i32 %32)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_2005.cpp() #0 section ".text.startup" {
