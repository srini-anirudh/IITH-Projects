; ModuleID = 'POJ-104-source/81/81-2020.cpp'
source_filename = "POJ-104-source/81/81-2020.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_2020.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %8 = call noalias i8* @calloc(i64 25, i64 4) #3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_2020.cpp() #0 section ".text.startup" {
