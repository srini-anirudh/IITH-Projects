; ModuleID = 'POJ-104-source/81/81-2023.cpp'
source_filename = "POJ-104-source/81/81-2023.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_2023.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5transPA5_iii([5 x i32]* %0, i32 %1, i32 %2) #0 {
...
16:                                               ; preds = %13
  ...
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i32* %24)
  br label %26
...
33:                                               ; preds = %9
  %34 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.4, i64 0, i64 0), i32* %4, i32* %6)
  %35 = load [5 x i32]*, [5 x i32]** %7, align 8
  %36 = load i32, i32* %4, align 4
  %37 = load i32, i32* %6, align 4
  call void @_Z5transPA5_iii([5 x i32]* %35, i32 %36, i32 %37)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_2023.cpp() #0 section ".text.startup" {
