; ModuleID = 'POJ-104-source/81/81-2029.cpp'
source_filename = "POJ-104-source/81/81-2029.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_2029.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  store [5 x i32]* %8, [5 x i32]** %3, align 8
...
33:                                               ; preds = %9
  ...
  %38 = call i32 @_Z5transPA5_iii([5 x i32]* %35, i32 %36, i32 %37)
  %39 = icmp ne i32 %38, 0
...
48:                                               ; preds = %45
  %49 = load [5 x i32]*, [5 x i32]** %3, align 8
...
define dso_local i32 @_Z5transPA5_iii([5 x i32]* %0, i32 %1, i32 %2) #5 {
  %4 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_2029.cpp() #0 section ".text.startup" {
