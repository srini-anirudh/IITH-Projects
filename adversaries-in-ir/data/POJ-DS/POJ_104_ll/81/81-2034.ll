; ModuleID = 'POJ-104-source/81/81-2034.cpp'
source_filename = "POJ-104-source/81/81-2034.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_2034.cpp, i8* null }]
...
33:                                               ; preds = %11
  %34 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %3, i32* %6)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_2034.cpp() #0 section ".text.startup" {
