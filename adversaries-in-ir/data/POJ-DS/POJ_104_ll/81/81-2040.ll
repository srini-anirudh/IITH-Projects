; ModuleID = 'POJ-104-source/81/81-2040.cpp'
source_filename = "POJ-104-source/81/81-2040.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_2040.cpp, i8* null }]
...
define dso_local void @_Z4chanPiS_(i32* %0, i32* %1) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z4exchPA5_iii([5 x i32]* %0, i32 %1, i32 %2) #4 {
...
19:                                               ; preds = %16
  ...
  call void @_Z4chanPiS_(i32* %27, i32* %35)
  br label %36
...
32:                                               ; preds = %8
  ...
  %37 = call i32 @_Z4exchPA5_iii([5 x i32]* %34, i32 %35, i32 %36)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_2040.cpp() #0 section ".text.startup" {
