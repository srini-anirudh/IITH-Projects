; ModuleID = 'POJ-104-source/81/81-2047.cpp'
source_filename = "POJ-104-source/81/81-2047.cpp"
...
@p = dso_local global [5 x i32]* null, align 8
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_2047.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z5transv() #0 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_2047.cpp() #0 section ".text.startup" {
