; ModuleID = 'POJ-104-source/81/81-2052.cpp'
source_filename = "POJ-104-source/81/81-2052.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_2052.cpp, i8* null }]
...
define dso_local i32 @_Z8survivalPA6_iii([6 x i32]* %0, i32 %1, i32 %2) #4 {
...
31:                                               ; preds = %8
  %32 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %3, i32* %4)
  %33 = getelementptr inbounds [6 x [6 x i32]], [6 x [6 x i32]]* %2, i64 0, i64 0
  %34 = load i32, i32* %3, align 4
  %35 = load i32, i32* %4, align 4
  %36 = call i32 @_Z8survivalPA6_iii([6 x i32]* %33, i32 %34, i32 %35)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_2052.cpp() #0 section ".text.startup" {
