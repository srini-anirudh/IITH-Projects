; ModuleID = 'POJ-104-source/81/81-214.cpp'
source_filename = "POJ-104-source/81/81-214.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_214.cpp, i8* null }]
...
define dso_local i32 @_Z3excii(i32 %0, i32 %1) #4 {
...
31:                                               ; preds = %9
  ...
  %35 = call i32 @_Z3excii(i32 %33, i32 %34)
  %36 = load i32, i32* %3, align 4
  %37 = load i32, i32* %4, align 4
  %38 = call i32 @_Z3excii(i32 %36, i32 %37)
  %39 = icmp eq i32 %38, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_214.cpp() #0 section ".text.startup" {
