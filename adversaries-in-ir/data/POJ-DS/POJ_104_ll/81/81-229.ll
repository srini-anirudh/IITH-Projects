; ModuleID = 'POJ-104-source/81/81-229.cpp'
source_filename = "POJ-104-source/81/81-229.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_229.cpp, i8* null }]
...
29:                                               ; preds = %7
  %30 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %2, i32* %3)
  %31 = load i32, i32* %2, align 4
  %32 = load i32, i32* %3, align 4
  %33 = getelementptr inbounds [5 x [5 x i32]], [5 x [5 x i32]]* %6, i64 0, i64 0
  %34 = call i32 @_Z1xiiPA5_i(i32 %31, i32 %32, [5 x i32]* %33)
  %35 = icmp eq i32 %34, 1
...
74:                                               ; preds = %29
  ...
  %77 = getelementptr inbounds [5 x [5 x i32]], [5 x [5 x i32]]* %6, i64 0, i64 0
  %78 = call i32 @_Z1xiiPA5_i(i32 %75, i32 %76, [5 x i32]* %77)
  %79 = icmp eq i32 %78, 0
...
define dso_local i32 @_Z1xiiPA5_i(i32 %0, i32 %1, [5 x i32]* %2) #5 {
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_229.cpp() #0 section ".text.startup" {
