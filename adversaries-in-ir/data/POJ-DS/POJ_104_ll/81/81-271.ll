; ModuleID = 'POJ-104-source/81/81-271.cpp'
source_filename = "POJ-104-source/81/81-271.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_271.cpp, i8* null }]
...
define dso_local i32 @_Z4cubePA5_iii([5 x i32]* %0, i32 %1, i32 %2) #4 {
...
29:                                               ; preds = %7
  %30 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %3, i32* %4)
  %31 = getelementptr inbounds [5 x [5 x i32]], [5 x [5 x i32]]* %2, i64 0, i64 0
  %32 = load i32, i32* %3, align 4
  %33 = load i32, i32* %4, align 4
  %34 = call i32 @_Z4cubePA5_iii([5 x i32]* %31, i32 %32, i32 %33)
  %35 = icmp eq i32 %34, 0
...
46:                                               ; preds = %43
  ...
  %59 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0), i32 %53, i32 %58)
  br label %60
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_271.cpp() #0 section ".text.startup" {
