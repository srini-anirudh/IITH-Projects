; ModuleID = 'POJ-104-source/81/81-276.cpp'
source_filename = "POJ-104-source/81/81-276.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_276.cpp, i8* null }]
...
30:                                               ; preds = %8
  ...
  %35 = call i32 @_Z6matrixPA5_iii([5 x i32]* %32, i32 %33, i32 %34)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_276.cpp() #0 section ".text.startup" {
