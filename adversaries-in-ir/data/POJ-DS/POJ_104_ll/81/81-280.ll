; ModuleID = 'POJ-104-source/81/81-280.cpp'
source_filename = "POJ-104-source/81/81-280.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_280.cpp, i8* null }]
...
30:                                               ; preds = %8
  ...
  %34 = call i32 @_Z1cii(i32 %32, i32 %33)
  %35 = icmp ne i32 %34, 0
...
define dso_local i32 @_Z1cii(i32 %0, i32 %1) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_280.cpp() #0 section ".text.startup" {
