; ModuleID = 'POJ-104-source/81/81-293.cpp'
source_filename = "POJ-104-source/81/81-293.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_293.cpp, i8* null }]
...
30:                                               ; preds = %8
  %31 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %4, i32* %5)
  %32 = load i32, i32* %4, align 4
  %33 = load i32, i32* %5, align 4
  %34 = call i32 @_Z6changeii(i32 %32, i32 %33)
  %35 = icmp eq i32 %34, 0
...
38:                                               ; preds = %36, %30
  ...
  %41 = call i32 @_Z6changeii(i32 %39, i32 %40)
  %42 = icmp eq i32 %41, 1
...
86:                                               ; preds = %83
  ...
  %97 = select i1 %95, i8 32, i8 10
  %98 = sext i8 %97 to i32
  %99 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0), i32 %93, i32 %98)
  br label %100
...
define dso_local i32 @_Z6changeii(i32 %0, i32 %1) #5 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_293.cpp() #0 section ".text.startup" {
