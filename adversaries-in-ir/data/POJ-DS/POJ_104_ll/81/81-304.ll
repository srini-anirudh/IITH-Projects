; ModuleID = 'POJ-104-source/81/81-304.cpp'
source_filename = "POJ-104-source/81/81-304.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_304.cpp, i8* null }]
...
11:                                               ; preds = %8
  ...
  %32 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str, i64 0, i64 0), i32* %15, i32* %19, i32* %23, i32* %27, i32* %31)
  br label %33
...
36:                                               ; preds = %8
  %37 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32* %3, i32* %4)
  %38 = load i32, i32* %3, align 4
  %39 = load i32, i32* %4, align 4
  %40 = call i32 @_Z4pandii(i32 %38, i32 %39)
...
84:                                               ; preds = %81
  ...
  %110 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str, i64 0, i64 0), i32 %89, i32 %94, i32 %99, i32 %104, i32 %109)
  br label %111
...
define dso_local i32 @_Z4pandii(i32 %0, i32 %1) #5 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_304.cpp() #0 section ".text.startup" {
