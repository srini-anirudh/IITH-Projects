; ModuleID = 'POJ-104-source/81/81-326.cpp'
source_filename = "POJ-104-source/81/81-326.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_326.cpp, i8* null }]
...
define dso_local i32 @_Z4funcPA5_iii([5 x i32]* %0, i32 %1, i32 %2) #4 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_326.cpp() #0 section ".text.startup" {
