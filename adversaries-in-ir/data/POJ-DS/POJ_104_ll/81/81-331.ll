; ModuleID = 'POJ-104-source/81/81-331.cpp'
source_filename = "POJ-104-source/81/81-331.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_331.cpp, i8* null }]
...
29:                                               ; preds = %7
  ...
  %33 = call i32 @_Z3canii(i32 %31, i32 %32)
  %34 = icmp ne i32 %33, 0
...
35:                                               ; preds = %29
  ...
  call void @_Z6changePA5_iii([5 x i32]* %36, i32 %37, i32 %38)
  store i32 0, i32* %2, align 4
  br label %39
...
70:                                               ; preds = %69, %29
  ...
  %73 = call i32 @_Z3canii(i32 %71, i32 %72)
  %74 = icmp eq i32 %73, 0
...
define dso_local i32 @_Z3canii(i32 %0, i32 %1) #5 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z6changePA5_iii([5 x i32]* %0, i32 %1, i32 %2) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_331.cpp() #0 section ".text.startup" {
