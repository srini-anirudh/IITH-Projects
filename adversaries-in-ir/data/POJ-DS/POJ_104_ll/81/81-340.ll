; ModuleID = 'POJ-104-source/81/81-340.cpp'
source_filename = "POJ-104-source/81/81-340.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_340.cpp, i8* null }]
...
14:                                               ; preds = %11
  ...
  %21 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* %20)
  br label %22
...
34:                                               ; preds = %7
  %35 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), i32* %5, i32* %6)
  %36 = getelementptr inbounds [5 x [5 x i32]], [5 x [5 x i32]]* %2, i64 0, i64 0
  %37 = load i32, i32* %5, align 4
  %38 = load i32, i32* %6, align 4
  %39 = call i32 @_Z6changePA5_iii([5 x i32]* %36, i32 %37, i32 %38)
  %40 = icmp eq i32 %39, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_340.cpp() #0 section ".text.startup" {
