; ModuleID = 'POJ-104-source/81/81-35.cpp'
source_filename = "POJ-104-source/81/81-35.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_35.cpp, i8* null }]
...
48:                                               ; preds = %24
  %49 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %4, i32* %3)
  %50 = load i32**, i32*** %2, align 8
  %51 = load i32, i32* %4, align 4
  %52 = load i32, i32* %3, align 4
  %53 = call i32 @_Z4sortPPiii(i32** %50, i32 %51, i32 %52)
...
define dso_local i32 @_Z4sortPPiii(i32** %0, i32 %1, i32 %2) #5 {
  %4 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_35.cpp() #0 section ".text.startup" {
