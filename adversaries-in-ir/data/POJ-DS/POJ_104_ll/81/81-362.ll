; ModuleID = 'POJ-104-source/81/81-362.cpp'
source_filename = "POJ-104-source/81/81-362.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_362.cpp, i8* null }]
...
29:                                               ; preds = %7
  ...
  %34 = call i32 @_Z5huanhPA5_iii([5 x i32]* %31, i32 %32, i32 %33)
...
50:                                               ; preds = %47
  ...
  %61 = select i1 %59, i8 32, i8 10
  %62 = sext i8 %61 to i32
  %63 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0), i32 %57, i32 %62)
  br label %64
...
define dso_local i32 @_Z5huanhPA5_iii([5 x i32]* %0, i32 %1, i32 %2) #5 {
  %4 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_362.cpp() #0 section ".text.startup" {
