; ModuleID = 'POJ-104-source/81/81-365.cpp'
source_filename = "POJ-104-source/81/81-365.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_365.cpp, i8* null }]
...
10:                                               ; preds = %7
  ...
  %31 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i64 0, i64 0), i32* %14, i32* %18, i32* %22, i32* %26, i32* %30)
  br label %32
...
35:                                               ; preds = %7
  ...
  %39 = call i32 @_Z5judgeii(i32 %37, i32 %38)
...
47:                                               ; preds = %44
  ...
  call void @_Z4movePA5_iii([5 x i32]* %48, i32 %49, i32 %50)
  store i32 0, i32* %3, align 4
  br label %51
...
54:                                               ; preds = %51
  ...
  %80 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.3, i64 0, i64 0), i32 %59, i32 %64, i32 %69, i32 %74, i32 %79)
  br label %81
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z4movePA5_iii([5 x i32]* %0, i32 %1, i32 %2) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_365.cpp() #0 section ".text.startup" {
