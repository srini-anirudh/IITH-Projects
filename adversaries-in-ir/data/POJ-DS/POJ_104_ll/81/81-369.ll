; ModuleID = 'POJ-104-source/81/81-369.cpp'
source_filename = "POJ-104-source/81/81-369.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_369.cpp, i8* null }]
...
31:                                               ; preds = %9
  ...
  %35 = call i32 @_Z1sii(i32 %33, i32 %34)
...
47:                                               ; preds = %44
  %48 = getelementptr inbounds [5 x [5 x i32]], [5 x [5 x i32]]* %5, i64 0, i64 0
  ...
  %66 = getelementptr inbounds [5 x [5 x i32]], [5 x [5 x i32]]* %5, i64 0, i64 0
  ...
  %75 = getelementptr inbounds [5 x [5 x i32]], [5 x [5 x i32]]* %5, i64 0, i64 0
...
define dso_local i32 @_Z1sii(i32 %0, i32 %1) #5 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_369.cpp() #0 section ".text.startup" {
