; ModuleID = 'POJ-104-source/81/81-377.cpp'
source_filename = "POJ-104-source/81/81-377.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_377.cpp, i8* null }]
...
21:                                               ; preds = %10
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %3, i32* %4)
  ...
  %28 = call i32 @_Z8jiaohuanPiii(i32* %25, i32 %26, i32 %27)
...
define dso_local i32 @_Z8jiaohuanPiii(i32* %0, i32 %1, i32 %2) #5 {
  %4 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_377.cpp() #0 section ".text.startup" {
