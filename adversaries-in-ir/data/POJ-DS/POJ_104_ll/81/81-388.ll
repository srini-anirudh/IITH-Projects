; ModuleID = 'POJ-104-source/81/81-388.cpp'
source_filename = "POJ-104-source/81/81-388.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_388.cpp, i8* null }]
...
define dso_local i32 @_Z3chaii(i32 %0, i32 %1) #4 {
...
28:                                               ; preds = %6
  ...
  %32 = call i32 @_Z3chaii(i32 %30, i32 %31)
  %33 = icmp eq i32 %32, 1
...
38:                                               ; preds = %35
  ...
  %64 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.2, i64 0, i64 0), i32 %43, i32 %48, i32 %53, i32 %58, i32 %63)
...
70:                                               ; preds = %69, %28
  ...
  %73 = call i32 @_Z3chaii(i32 %71, i32 %72)
  %74 = icmp eq i32 %73, 0
  br i1 %74, label %75, label %77

75:                                               ; preds = %70
  %76 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.4, i64 0, i64 0))
  br label %77
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_388.cpp() #0 section ".text.startup" {
