; ModuleID = 'POJ-104-source/81/81-391.cpp'
source_filename = "POJ-104-source/81/81-391.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_391.cpp, i8* null }]
...
define dso_local i32 @_Z2tfii(i32 %0, i32 %1) #4 {
...
33:                                               ; preds = %11
  ...
  %37 = call i32 @_Z2tfii(i32 %35, i32 %36)
  %38 = icmp ne i32 %37, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_391.cpp() #0 section ".text.startup" {
