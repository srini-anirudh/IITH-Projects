; ModuleID = 'POJ-104-source/81/81-405.cpp'
source_filename = "POJ-104-source/81/81-405.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_405.cpp, i8* null }]
...
19:                                               ; preds = %16
  ...
  %28 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* %27)
  br label %39
...
47:                                               ; preds = %9
  %48 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), i32* %2, i32* %3)
  %49 = load [5 x i32]*, [5 x i32]** %7, align 8
  %50 = load i32, i32* %2, align 4
  %51 = load i32, i32* %3, align 4
  %52 = call i32 @_Z1fPA5_iii([5 x i32]* %49, i32 %50, i32 %51)
  %53 = icmp eq i32 %52, 1
...
96:                                               ; preds = %95, %47
  ...
  %100 = call i32 @_Z1fPA5_iii([5 x i32]* %97, i32 %98, i32 %99)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_405.cpp() #0 section ".text.startup" {
