; ModuleID = 'POJ-104-source/81/81-406.cpp'
source_filename = "POJ-104-source/81/81-406.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_406.cpp, i8* null }]
...
39:                                               ; preds = %30
  ...
  call void @_Z8changingPA5_iii([5 x i32]* %40, i32 %41, i32 %42)
  store i32 0, i32* %5, align 4
  br label %43
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z8changingPA5_iii([5 x i32]* %0, i32 %1, i32 %2) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_406.cpp() #0 section ".text.startup" {
