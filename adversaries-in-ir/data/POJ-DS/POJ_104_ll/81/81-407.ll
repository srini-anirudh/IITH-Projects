; ModuleID = 'POJ-104-source/81/81-407.cpp'
source_filename = "POJ-104-source/81/81-407.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_407.cpp, i8* null }]
...
define dso_local i32 @_Z2mnii(i32 %0, i32 %1) #4 {
...
31:                                               ; preds = %9
  ...
  %35 = call i32 @_Z2mnii(i32 %33, i32 %34)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_407.cpp() #0 section ".text.startup" {
