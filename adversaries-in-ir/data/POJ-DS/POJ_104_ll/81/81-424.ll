; ModuleID = 'POJ-104-source/81/81-424.cpp'
source_filename = "POJ-104-source/81/81-424.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_424.cpp, i8* null }]
...
21:                                               ; preds = %9
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %5, i32* %6)
  %23 = load i32, i32* %5, align 4
  %24 = load i32, i32* %6, align 4
  %25 = getelementptr inbounds [5 x [5 x i32]], [5 x [5 x i32]]* %2, i64 0, i64 0
  %26 = call i32 @_Z3reviiPA5_i(i32 %23, i32 %24, [5 x i32]* %25)
  %27 = icmp eq i32 %26, 1
...
define dso_local i32 @_Z3reviiPA5_i(i32 %0, i32 %1, [5 x i32]* %2) #5 {
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_424.cpp() #0 section ".text.startup" {
