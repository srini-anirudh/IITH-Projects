; ModuleID = 'POJ-104-source/81/81-429.cpp'
source_filename = "POJ-104-source/81/81-429.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_429.cpp, i8* null }]
...
64:                                               ; preds = %56
  ...
  %78 = select i1 %76, i8 10, i8 32
  %79 = sext i8 %78 to i32
  %80 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), i32 %66, i32 %79)
  br label %81
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z3funPPi(i32** %0) #0 {
  ...
  %7 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.4, i64 0, i64 0), i32* %4, i32* %5)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_429.cpp() #0 section ".text.startup" {
