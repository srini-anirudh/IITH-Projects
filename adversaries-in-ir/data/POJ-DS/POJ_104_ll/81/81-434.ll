; ModuleID = 'POJ-104-source/81/81-434.cpp'
source_filename = "POJ-104-source/81/81-434.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_434.cpp, i8* null }]
...
define dso_local i32 @_Z1fiiPi(i32 %0, i32 %1, i32* %2) #4 {
...
32:                                               ; preds = %10
  %33 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %3, i32* %2)
  %34 = load i32, i32* %3, align 4
  %35 = load i32, i32* %2, align 4
  %36 = load i32*, i32** %7, align 8
  %37 = call i32 @_Z1fiiPi(i32 %34, i32 %35, i32* %36)
  %38 = icmp eq i32 %37, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_434.cpp() #0 section ".text.startup" {
