; ModuleID = 'POJ-104-source/81/81-438.cpp'
source_filename = "POJ-104-source/81/81-438.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_438.cpp, i8* null }]
...
define dso_local i32 @_Z6hanshuPA5_iiiPi([5 x i32]* %0, i32 %1, i32 %2, i32* %3) #4 {
...
31:                                               ; preds = %9
  ...
  %34 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %5, i32* %6)
  %35 = getelementptr inbounds [5 x [5 x i32]], [5 x [5 x i32]]* %2, i64 0, i64 0
  %36 = load i32, i32* %5, align 4
  %37 = load i32, i32* %6, align 4
  %38 = load i32*, i32** %8, align 8
  %39 = call i32 @_Z6hanshuPA5_iiiPi([5 x i32]* %35, i32 %36, i32 %37, i32* %38)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_438.cpp() #0 section ".text.startup" {
