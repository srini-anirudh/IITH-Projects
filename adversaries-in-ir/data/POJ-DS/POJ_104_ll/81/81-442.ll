; ModuleID = 'POJ-104-source/81/81-442.cpp'
source_filename = "POJ-104-source/81/81-442.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_442.cpp, i8* null }]
...
30:                                               ; preds = %8
  %31 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %5, i32* %4)
  ...
  %37 = call i32 @_Z6changePiii(i32* %34, i32 %35, i32 %36)
  %38 = icmp eq i32 %37, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_442.cpp() #0 section ".text.startup" {
