; ModuleID = 'POJ-104-source/81/81-45.cpp'
source_filename = "POJ-104-source/81/81-45.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_45.cpp, i8* null }]
...
28:                                               ; preds = %6
  %29 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* @n, i32* @m)
  %30 = call i32 @_Z8exchangev()
  %31 = icmp ne i32 %30, 0
...
define dso_local i32 @_Z8exchangev() #5 {
  %1 = alloca i32, align 4
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_45.cpp() #0 section ".text.startup" {
