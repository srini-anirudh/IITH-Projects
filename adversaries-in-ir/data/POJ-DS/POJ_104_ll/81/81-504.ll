; ModuleID = 'POJ-104-source/81/81-504.cpp'
source_filename = "POJ-104-source/81/81-504.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_504.cpp, i8* null }]
...
define dso_local i32 @_Z5checkPA5_iii([5 x i32]* %0, i32 %1, i32 %2) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_504.cpp() #0 section ".text.startup" {
