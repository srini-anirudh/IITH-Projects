; ModuleID = 'POJ-104-source/81/81-507.cpp'
source_filename = "POJ-104-source/81/81-507.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_507.cpp, i8* null }]
...
29:                                               ; preds = %7
  ...
  %34 = call i32 @_Z8jiaohuanPA5_iii([5 x i32]* %31, i32 %32, i32 %33)
  %35 = icmp ne i32 %34, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_507.cpp() #0 section ".text.startup" {
