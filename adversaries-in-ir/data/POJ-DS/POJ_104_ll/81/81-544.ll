; ModuleID = 'POJ-104-source/81/81-544.cpp'
source_filename = "POJ-104-source/81/81-544.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_544.cpp, i8* null }]
...
16:                                               ; preds = %13
  ...
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %17)
  br label %20
...
23:                                               ; preds = %13
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %4, i32* %5)
  %25 = load i32, i32* %4, align 4
  %26 = load i32, i32* %5, align 4
  %27 = call i32 @_Z6putoutii(i32 %25, i32 %26)
...
define dso_local i32 @_Z6putoutii(i32 %0, i32 %1) #6 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  store i32 %0, i32* %3, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_544.cpp() #0 section ".text.startup" {
