; ModuleID = 'POJ-104-source/81/81-595.cpp'
source_filename = "POJ-104-source/81/81-595.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_595.cpp, i8* null }]
...
41:                                               ; preds = %38
  ...
  call void @_Z2zzii(i32 %42, i32 %43)
  store i32 0, i32* %4, align 4
  br label %44
...
define dso_local void @_Z2zzii(i32 %0, i32 %1) #5 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_595.cpp() #0 section ".text.startup" {
