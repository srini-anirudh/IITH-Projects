; ModuleID = 'POJ-104-source/81/81-606.cpp'
source_filename = "POJ-104-source/81/81-606.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_606.cpp, i8* null }]
...
define dso_local i32 @_Z8jiaohuanPA5_i([5 x i32]* %0) #4 {
...
27:                                               ; preds = %5
  %28 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* @n, i32* @m)
  %29 = getelementptr inbounds [5 x [5 x i32]], [5 x [5 x i32]]* %2, i64 0, i64 0
  %30 = call i32 @_Z8jiaohuanPA5_i([5 x i32]* %29)
  %31 = icmp eq i32 %30, 1
...
71:                                               ; preds = %70, %27
  ...
  %73 = call i32 @_Z8jiaohuanPA5_i([5 x i32]* %72)
  %74 = icmp eq i32 %73, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_606.cpp() #0 section ".text.startup" {
