; ModuleID = 'POJ-104-source/81/81-614.cpp'
source_filename = "POJ-104-source/81/81-614.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_614.cpp, i8* null }]
...
define dso_local i32 @_Z3hasii(i32 %0, i32 %1) #4 {
...
45:                                               ; preds = %8
  %46 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), i32* %4, i32* %5)
  %47 = load i32, i32* %4, align 4
  %48 = load i32, i32* %5, align 4
  %49 = call i32 @_Z3hasii(i32 %47, i32 %48)
  %50 = icmp ne i32 %49, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_614.cpp() #0 section ".text.startup" {
