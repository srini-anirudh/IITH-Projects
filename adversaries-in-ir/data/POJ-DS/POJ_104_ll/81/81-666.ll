; ModuleID = 'POJ-104-source/81/81-666.cpp'
source_filename = "POJ-104-source/81/81-666.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_666.cpp, i8* null }]
...
30:                                               ; preds = %8
  %31 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %2, i32* %3)
  %32 = load i32, i32* %2, align 4
  %33 = load i32, i32* %3, align 4
  %34 = call i32 @_Z5judgeii(i32 %32, i32 %33)
  %35 = icmp ne i32 %34, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_666.cpp() #0 section ".text.startup" {
