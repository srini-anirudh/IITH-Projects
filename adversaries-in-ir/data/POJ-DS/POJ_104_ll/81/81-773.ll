; ModuleID = 'POJ-104-source/81/81-773.cpp'
source_filename = "POJ-104-source/81/81-773.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_773.cpp, i8* null }]
...
define dso_local i32 @_Z1yii(i32 %0, i32 %1) #4 {
...
30:                                               ; preds = %8
  %31 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %7, i32* %6)
  %32 = load i32, i32* %7, align 4
  %33 = load i32, i32* %6, align 4
  %34 = call i32 @_Z1yii(i32 %32, i32 %33)
  %35 = icmp eq i32 %34, 0
...
38:                                               ; preds = %30
  ...
  %41 = call i32 @_Z1yii(i32 %39, i32 %40)
  %42 = icmp eq i32 %41, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_773.cpp() #0 section ".text.startup" {
