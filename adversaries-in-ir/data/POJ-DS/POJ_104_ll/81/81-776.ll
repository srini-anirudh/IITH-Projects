; ModuleID = 'POJ-104-source/81/81-776.cpp'
source_filename = "POJ-104-source/81/81-776.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_776.cpp, i8* null }]
...
define dso_local void @_Z4swapv() #4 {
...
28:                                               ; preds = %4
  %29 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* @n, i32* @m)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_776.cpp() #0 section ".text.startup" {
