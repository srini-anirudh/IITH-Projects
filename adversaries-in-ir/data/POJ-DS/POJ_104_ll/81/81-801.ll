; ModuleID = 'POJ-104-source/81/81-801.cpp'
source_filename = "POJ-104-source/81/81-801.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_801.cpp, i8* null }]
...
36:                                               ; preds = %8
  %37 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %6, i32* %7)
  %38 = load i32, i32* %6, align 4
  %39 = load i32, i32* %7, align 4
  %40 = call i32 @_Z5judgeii(i32 %38, i32 %39)
  %41 = icmp eq i32 %40, 0
...
44:                                               ; preds = %42, %36
  ...
  %47 = call i32 @_Z5judgeii(i32 %45, i32 %46)
  %48 = icmp ne i32 %47, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_801.cpp() #0 section ".text.startup" {
