; ModuleID = 'POJ-104-source/81/81-804.cpp'
source_filename = "POJ-104-source/81/81-804.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_804.cpp, i8* null }]
...
31:                                               ; preds = %9
  %32 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %6, i32* %7)
  %33 = load i32, i32* %6, align 4
  %34 = load i32, i32* %7, align 4
  %35 = call i32 @_Z5shuzuii(i32 %33, i32 %34)
...
define dso_local i32 @_Z5shuzuii(i32 %0, i32 %1) #5 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  store i32 %0, i32* %4, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_804.cpp() #0 section ".text.startup" {
