; ModuleID = 'POJ-104-source/81/81-827.cpp'
source_filename = "POJ-104-source/81/81-827.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_827.cpp, i8* null }]
...
30:                                               ; preds = %8
  ...
  %34 = call i32 @_Z6fanweiii(i32 %32, i32 %33)
  %35 = icmp eq i32 %34, 0
...
38:                                               ; preds = %30
  ...
  %41 = call i32 @_Z6fanweiii(i32 %39, i32 %40)
  %42 = icmp eq i32 %41, 1
...
define dso_local i32 @_Z6fanweiii(i32 %0, i32 %1) #5 {
  %3 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_827.cpp() #0 section ".text.startup" {
