; ModuleID = 'POJ-104-source/81/81-86.cpp'
source_filename = "POJ-104-source/81/81-86.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_86.cpp, i8* null }]
...
13:                                               ; preds = %10
  ...
  %34 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i64 0, i64 0), i32* %17, i32* %21, i32* %25, i32* %29, i32* %33)
  br label %35
...
38:                                               ; preds = %10
  %39 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %5, i32* %4)
  %40 = load i32, i32* %5, align 4
  %41 = load i32, i32* %4, align 4
  %42 = call i32 @_Z1hii(i32 %40, i32 %41)
...
define dso_local i32 @_Z1hii(i32 %0, i32 %1) #5 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  store i32 %0, i32* %3, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_86.cpp() #0 section ".text.startup" {
