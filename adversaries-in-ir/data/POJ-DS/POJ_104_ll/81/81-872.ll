; ModuleID = 'POJ-104-source/81/81-872.cpp'
source_filename = "POJ-104-source/81/81-872.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_872.cpp, i8* null }]
...
107:                                              ; preds = %104
  ...
  %115 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), i32 %114)
  br label %125
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_872.cpp() #0 section ".text.startup" {
