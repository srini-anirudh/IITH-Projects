; ModuleID = 'POJ-104-source/81/81-878.cpp'
source_filename = "POJ-104-source/81/81-878.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_878.cpp, i8* null }]
...
28:                                               ; preds = %6
  %29 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %2, i32* %3)
  %30 = load i32, i32* %2, align 4
  %31 = load i32, i32* %3, align 4
  call void @_Z8exchangeii(i32 %30, i32 %31)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define dso_local void @_Z8exchangeii(i32 %0, i32 %1) #0 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_878.cpp() #0 section ".text.startup" {
