; ModuleID = 'POJ-104-source/81/81-879.cpp'
source_filename = "POJ-104-source/81/81-879.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_879.cpp, i8* null }]
...
31:                                               ; preds = %9
  ...
  %35 = call i32 @_Z9in_or_notii(i32 %33, i32 %34)
...
define dso_local i32 @_Z9in_or_notii(i32 %0, i32 %1) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_879.cpp() #0 section ".text.startup" {
