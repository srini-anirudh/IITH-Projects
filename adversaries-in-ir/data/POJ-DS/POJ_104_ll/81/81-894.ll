; ModuleID = 'POJ-104-source/81/81-894.cpp'
source_filename = "POJ-104-source/81/81-894.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_894.cpp, i8* null }]
...
31:                                               ; preds = %9
  %32 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %3, i32* %2)
  %33 = load i32, i32* %3, align 4
  %34 = load i32, i32* %2, align 4
  %35 = call i32 @_Z7panduanii(i32 %33, i32 %34)
  %36 = icmp eq i32 %35, 1
...
104:                                              ; preds = %31
  ...
  %107 = call i32 @_Z7panduanii(i32 %105, i32 %106)
...
define dso_local i32 @_Z7panduanii(i32 %0, i32 %1) #6 {
  %3 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_894.cpp() #0 section ".text.startup" {
