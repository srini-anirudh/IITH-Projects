; ModuleID = 'POJ-104-source/81/81-908.cpp'
source_filename = "POJ-104-source/81/81-908.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_908.cpp, i8* null }]
...
27:                                               ; preds = %13
  %28 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0))
  br label %29
...
32:                                               ; preds = %9
  %33 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0))
  %34 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), i32* %2, i32* %3)
  %35 = load i32, i32* %2, align 4
  %36 = load i32, i32* %3, align 4
  %37 = call i32 @_Z5judgeii(i32 %35, i32 %36)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_908.cpp() #0 section ".text.startup" {
