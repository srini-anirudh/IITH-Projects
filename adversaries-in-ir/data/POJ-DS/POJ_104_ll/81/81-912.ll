; ModuleID = 'POJ-104-source/81/81-912.cpp'
source_filename = "POJ-104-source/81/81-912.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_912.cpp, i8* null }]
...
45:                                               ; preds = %42
  ...
  call void @_Z4swapPiS_(i32* %58, i32* %59)
  br label %60
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_912.cpp() #0 section ".text.startup" {
