; ModuleID = 'POJ-104-source/81/81-915.cpp'
source_filename = "POJ-104-source/81/81-915.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_915.cpp, i8* null }]
...
9:                                                ; preds = %6
  ...
  %12 = getelementptr inbounds [5 x [5 x i32]], [5 x [5 x i32]]* @c, i64 0, i64 %11
...
24:                                               ; preds = %2
  ...
  %28 = call i32 @_Z6changeii(i32 %26, i32 %27)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_915.cpp() #0 section ".text.startup" {
