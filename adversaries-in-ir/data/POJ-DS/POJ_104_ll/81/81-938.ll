; ModuleID = 'POJ-104-source/81/81-938.cpp'
source_filename = "POJ-104-source/81/81-938.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_938.cpp, i8* null }]
...
35:                                               ; preds = %7
  ...
  %40 = call i32 @_Z4huanPA5_iii([5 x i32]* %37, i32 %38, i32 %39)
...
49:                                               ; preds = %46
  ...
  %75 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.3, i64 0, i64 0), i32 %54, i32 %59, i32 %64, i32 %69, i32 %74)
  br label %76
...
define dso_local i32 @_Z4huanPA5_iii([5 x i32]* %0, i32 %1, i32 %2) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_938.cpp() #0 section ".text.startup" {
