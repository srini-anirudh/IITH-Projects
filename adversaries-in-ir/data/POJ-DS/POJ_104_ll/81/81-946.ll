; ModuleID = 'POJ-104-source/81/81-946.cpp'
source_filename = "POJ-104-source/81/81-946.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_946.cpp, i8* null }]
...
87:                                               ; preds = %84
  ...
  %98 = select i1 %96, i8 32, i8 10
  %99 = sext i8 %98 to i32
  %100 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), i32 %94, i32 %99)
  br label %101
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_946.cpp() #0 section ".text.startup" {
