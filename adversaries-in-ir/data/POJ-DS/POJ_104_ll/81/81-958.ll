; ModuleID = 'POJ-104-source/81/81-958.cpp'
source_filename = "POJ-104-source/81/81-958.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_958.cpp, i8* null }]
...
29:                                               ; preds = %7
  ...
  %34 = call i32 @_Z2huPA5_iii([5 x i32]* %31, i32 %32, i32 %33)
  %35 = icmp ne i32 %34, 0
...
40:                                               ; preds = %37
  ...
  %66 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.2, i64 0, i64 0), i32 %45, i32 %50, i32 %55, i32 %60, i32 %65)
  br label %67
...
define dso_local i32 @_Z2huPA5_iii([5 x i32]* %0, i32 %1, i32 %2) #5 {
  %4 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_958.cpp() #0 section ".text.startup" {
