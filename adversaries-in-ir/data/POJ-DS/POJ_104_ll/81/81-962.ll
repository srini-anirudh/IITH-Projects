; ModuleID = 'POJ-104-source/81/81-962.cpp'
source_filename = "POJ-104-source/81/81-962.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_962.cpp, i8* null }]
...
define dso_local i32 @_Z6defineii(i32 %0, i32 %1) #4 {
...
31:                                               ; preds = %9
  ...
  %35 = call i32 @_Z6defineii(i32 %33, i32 %34)
  %36 = icmp eq i32 %35, 1
...
112:                                              ; preds = %79
  %113 = getelementptr inbounds [5 x [5 x i32]], [5 x [5 x i32]]* %6, i64 0, i64 4
  %114 = getelementptr inbounds [5 x i32], [5 x i32]* %113, i64 0, i64 0
  %115 = load i32, i32* %114, align 16
  %116 = getelementptr inbounds [5 x [5 x i32]], [5 x [5 x i32]]* %6, i64 0, i64 4
  ...
  %122 = getelementptr inbounds [5 x [5 x i32]], [5 x [5 x i32]]* %6, i64 0, i64 4
  %123 = getelementptr inbounds [5 x i32], [5 x i32]* %122, i64 0, i64 3
  %124 = load i32, i32* %123, align 4
  %125 = getelementptr inbounds [5 x [5 x i32]], [5 x [5 x i32]]* %6, i64 0, i64 4
  %126 = getelementptr inbounds [5 x i32], [5 x i32]* %125, i64 0, i64 4
  %127 = load i32, i32* %126, align 16
  %128 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.3, i64 0, i64 0), i32 %115, i32 %118, i32 %121, i32 %124, i32 %127)
  br label %131
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_962.cpp() #0 section ".text.startup" {
