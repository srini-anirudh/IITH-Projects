; ModuleID = 'POJ-104-source/81/81-970.cpp'
source_filename = "POJ-104-source/81/81-970.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_970.cpp, i8* null }]
...
define dso_local i32 @_Z1piiPA5_i(i32 %0, i32 %1, [5 x i32]* %2) #4 {
...
31:                                               ; preds = %9
  ...
  %35 = getelementptr inbounds [5 x [5 x i32]], [5 x [5 x i32]]* %4, i64 0, i64 0
  %36 = call i32 @_Z1piiPA5_i(i32 %33, i32 %34, [5 x i32]* %35)
  %37 = icmp eq i32 %36, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_970.cpp() #0 section ".text.startup" {
