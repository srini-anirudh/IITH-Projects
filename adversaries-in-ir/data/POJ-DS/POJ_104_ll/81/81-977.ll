; ModuleID = 'POJ-104-source/81/81-977.cpp'
source_filename = "POJ-104-source/81/81-977.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_977.cpp, i8* null }]
...
109:                                              ; preds = %30
  ...
  %112 = call i32 @_Z7panduanii(i32 %110, i32 %111)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_977.cpp() #0 section ".text.startup" {
