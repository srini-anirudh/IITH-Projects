; ModuleID = 'POJ-104-source/81/81-991.cpp'
source_filename = "POJ-104-source/81/81-991.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_81_991.cpp, i8* null }]
...
29:                                               ; preds = %7
  ...
  %33 = call i32 @_Z8jiaohuanii(i32 %31, i32 %32)
...
define dso_local i32 @_Z8jiaohuanii(i32 %0, i32 %1) #5 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_81_991.cpp() #0 section ".text.startup" {
