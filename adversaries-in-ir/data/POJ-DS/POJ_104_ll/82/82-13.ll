; ModuleID = 'POJ-104-source/82/82-13.cpp'
source_filename = "POJ-104-source/82/82-13.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_82_13.cpp, i8* null }]
...
25:                                               ; preds = %21
  ...
  %34 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32* %29, i32* %33)
  br label %35
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_82_13.cpp() #0 section ".text.startup" {
