; ModuleID = 'POJ-104-source/82/82-1426.cpp'
source_filename = "POJ-104-source/82/82-1426.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_82_1426.cpp, i8* null }]
...
define dso_local i32 @_Z2zhii(i32 %0, i32 %1) #5 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_82_1426.cpp() #0 section ".text.startup" {
