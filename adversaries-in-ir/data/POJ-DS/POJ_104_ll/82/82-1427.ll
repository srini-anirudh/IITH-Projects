; ModuleID = 'POJ-104-source/82/82-1427.cpp'
source_filename = "POJ-104-source/82/82-1427.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_82_1427.cpp, i8* null }]
...
define dso_local i32 @_Z2zhii(i32 %0, i32 %1) #4 {
...
29:                                               ; preds = %25
  ...
  %34 = call i32 @_Z2zhii(i32 %31, i32 %33)
  %35 = icmp eq i32 %34, 1
...
36:                                               ; preds = %29
  ...
  %45 = call i32 @_Z2zhii(i32 %40, i32 %44)
  %46 = icmp eq i32 %45, 1
...
47:                                               ; preds = %36
  ...
  %58 = call i32 @_Z2zhii(i32 %52, i32 %57)
  %59 = icmp ne i32 %58, 1
...
62:                                               ; preds = %73, %60
  ...
  %71 = call i32 @_Z2zhii(i32 %66, i32 %70)
  %72 = icmp ne i32 %71, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_82_1427.cpp() #0 section ".text.startup" {
