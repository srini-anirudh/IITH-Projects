; ModuleID = 'POJ-104-source/82/82-1735.cpp'
source_filename = "POJ-104-source/82/82-1735.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_82_1735.cpp, i8* null }]
...
77:                                               ; preds = %55
  ...
  call void @_Z11bubble_sortPii(i32* %78, i32 99)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_82_1735.cpp() #0 section ".text.startup" {
