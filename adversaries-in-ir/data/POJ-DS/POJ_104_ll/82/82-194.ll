; ModuleID = 'POJ-104-source/82/82-194.cpp'
source_filename = "POJ-104-source/82/82-194.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_82_194.cpp, i8* null }]
...
28:                                               ; preds = %24
  %29 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %3, i32* %4)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_82_194.cpp() #0 section ".text.startup" {
