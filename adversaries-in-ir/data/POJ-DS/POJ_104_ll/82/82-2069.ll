; ModuleID = 'POJ-104-source/82/82-2069.cpp'
source_filename = "POJ-104-source/82/82-2069.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_82_2069.cpp, i8* null }]
...
27:                                               ; preds = %23
  ...
  %34 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32* %30, i32* %33)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_82_2069.cpp() #0 section ".text.startup" {
