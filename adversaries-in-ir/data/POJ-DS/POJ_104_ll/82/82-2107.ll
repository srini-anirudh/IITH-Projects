; ModuleID = 'POJ-104-source/82/82-2107.cpp'
source_filename = "POJ-104-source/82/82-2107.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_82_2107.cpp, i8* null }]
...
36:                                               ; preds = %32
  ...
  %45 = call i32 @_Z2Okii(i32 %40, i32 %44)
  %46 = icmp eq i32 %45, 1
...
47:                                               ; preds = %36
  ...
  %58 = call i32 @_Z2Okii(i32 %52, i32 %57)
...
77:                                               ; preds = %32
  ...
  %79 = call i32 @_Z3maxPii(i32* getelementptr inbounds ([100 x i32], [100 x i32]* @length, i64 0, i64 0), i32 %78)
...
define dso_local i32 @_Z2Okii(i32 %0, i32 %1) #5 {
  %3 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_82_2107.cpp() #0 section ".text.startup" {
