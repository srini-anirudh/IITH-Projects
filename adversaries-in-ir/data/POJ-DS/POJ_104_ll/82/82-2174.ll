; ModuleID = 'POJ-104-source/82/82-2174.cpp'
source_filename = "POJ-104-source/82/82-2174.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_82_2174.cpp, i8* null }]
...
14:                                               ; preds = %9
  ...
  %30 = call i32 @_Z6normalii(i32 %25, i32 %29)
  %31 = icmp eq i32 %30, 1
...
41:                                               ; preds = %40, %14
  ...
  %50 = call i32 @_Z6normalii(i32 %45, i32 %49)
  %51 = icmp eq i32 %50, 0
...
define dso_local i32 @_Z6normalii(i32 %0, i32 %1) #5 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  store i32 %0, i32* %3, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_82_2174.cpp() #0 section ".text.startup" {
