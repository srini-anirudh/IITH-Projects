; ModuleID = 'POJ-104-source/82/82-2220.cpp'
source_filename = "POJ-104-source/82/82-2220.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_82_2220.cpp, i8* null }]
...
65:                                               ; preds = %59, %53, %47, %41
  %66 = phi i1 [ false, %53 ], [ false, %47 ], [ false, %41 ], [ %64, %59 ]
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_82_2220.cpp() #0 section ".text.startup" {
