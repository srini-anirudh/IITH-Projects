; ModuleID = 'POJ-104-source/82/82-2272.cpp'
source_filename = "POJ-104-source/82/82-2272.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_82_2272.cpp, i8* null }]
...
define dso_local i32 @_Z10zhengchangii(i32 %0, i32 %1) #4 {
...
17:                                               ; preds = %13
  ...
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %20, i32* %23)
  br label %25
...
33:                                               ; preds = %29
  ...
  %42 = call i32 @_Z10zhengchangii(i32 %37, i32 %41)
  %43 = icmp ne i32 %42, 0
...
46:                                               ; preds = %63, %44
  ...
  %55 = call i32 @_Z10zhengchangii(i32 %50, i32 %54)
  %56 = icmp ne i32 %55, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_82_2272.cpp() #0 section ".text.startup" {
