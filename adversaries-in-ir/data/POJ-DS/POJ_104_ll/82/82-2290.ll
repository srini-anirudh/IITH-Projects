; ModuleID = 'POJ-104-source/82/82-2290.cpp'
source_filename = "POJ-104-source/82/82-2290.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_82_2290.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %19 = call i32 @_Z6normalii(i32 %17, i32 %18)
  %20 = icmp ne i32 %19, 0
...
define dso_local i32 @_Z6normalii(i32 %0, i32 %1) #6 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  store i32 %0, i32* %4, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_82_2290.cpp() #0 section ".text.startup" {
