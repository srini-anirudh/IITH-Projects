; ModuleID = 'POJ-104-source/82/82-2300.cpp'
source_filename = "POJ-104-source/82/82-2300.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_82_2300.cpp, i8* null }]
...
118:                                              ; preds = %109, %102, %95, %88, %82, %76, %70, %64
  br label %123
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_82_2300.cpp() #0 section ".text.startup" {
