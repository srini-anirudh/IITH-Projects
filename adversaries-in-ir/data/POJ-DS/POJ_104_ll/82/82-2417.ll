; ModuleID = 'POJ-104-source/82/82-2417.cpp'
source_filename = "POJ-104-source/82/82-2417.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_82_2417.cpp, i8* null }]
...
19:                                               ; preds = %15
  ...
  %26 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %22, i32* %25)
  br label %27
...
102:                                              ; preds = %99
  ...
  %105 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %103, i32* %104)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_82_2417.cpp() #0 section ".text.startup" {
