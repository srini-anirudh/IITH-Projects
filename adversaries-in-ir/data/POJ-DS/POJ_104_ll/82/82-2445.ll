; ModuleID = 'POJ-104-source/82/82-2445.cpp'
source_filename = "POJ-104-source/82/82-2445.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_82_2445.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i8* %9, i32* %18, i32* %21)
  br label %23
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_82_2445.cpp() #0 section ".text.startup" {
