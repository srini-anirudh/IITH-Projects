; ModuleID = 'POJ-104-source/82/82-2455.cpp'
source_filename = "POJ-104-source/82/82-2455.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_82_2455.cpp, i8* null }]
...
12:                                               ; preds = %8
  ...
  %15 = getelementptr inbounds [100 x [2 x i32]], [100 x [2 x i32]]* %2, i64 0, i64 %14
...
30:                                               ; preds = %26
  ...
  %33 = getelementptr inbounds [100 x [2 x i32]], [100 x [2 x i32]]* %2, i64 0, i64 %32
...
107:                                              ; preds = %105, %101, %94, %87, %80, %73, %68
  br label %108
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_82_2455.cpp() #0 section ".text.startup" {
