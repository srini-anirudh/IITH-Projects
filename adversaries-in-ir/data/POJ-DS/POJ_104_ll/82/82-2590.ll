; ModuleID = 'POJ-104-source/82/82-2590.cpp'
source_filename = "POJ-104-source/82/82-2590.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_82_2590.cpp, i8* null }]
...
149:                                              ; preds = %101
  %150 = getelementptr inbounds [100 x i32], [100 x i32]* %7, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_82_2590.cpp() #0 section ".text.startup" {
