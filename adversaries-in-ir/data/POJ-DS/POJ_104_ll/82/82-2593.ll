; ModuleID = 'POJ-104-source/82/82-2593.cpp'
source_filename = "POJ-104-source/82/82-2593.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_82_2593.cpp, i8* null }]
...
15:                                               ; preds = %10
  ...
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32* %18, i32* %21)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_82_2593.cpp() #0 section ".text.startup" {
