; ModuleID = 'POJ-104-source/82/82-30.cpp'
source_filename = "POJ-104-source/82/82-30.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_82_30.cpp, i8* null }]
...
16:                                               ; preds = %12
  ...
  %26 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %20, i32* %25)
  br label %27
...
76:                                               ; preds = %31
  ...
  %79 = call i32 @_Z3maxii(i32 %77, i32 %78)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_82_30.cpp() #0 section ".text.startup" {
