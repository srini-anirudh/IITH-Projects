; ModuleID = 'POJ-104-source/82/82-525.cpp'
source_filename = "POJ-104-source/82/82-525.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_82_525.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %12 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %10, i32* %11)
...
34:                                               ; preds = %30
  ...
  %41 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %37, i32* %40)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_82_525.cpp() #0 section ".text.startup" {
