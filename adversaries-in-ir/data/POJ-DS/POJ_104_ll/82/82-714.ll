; ModuleID = 'POJ-104-source/82/82-714.cpp'
source_filename = "POJ-104-source/82/82-714.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_82_714.cpp, i8* null }]
...
24:                                               ; preds = %20
  ...
  %43 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %36, i32* %42)
  br label %44
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_82_714.cpp() #0 section ".text.startup" {
