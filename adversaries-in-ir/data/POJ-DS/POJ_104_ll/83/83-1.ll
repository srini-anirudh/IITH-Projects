; ModuleID = 'POJ-104-source/83/83-1.cpp'
source_filename = "POJ-104-source/83/83-1.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_1.cpp, i8* null }]
...
define dso_local double @_Z5judgei(i32 %0) #4 {
...
47:                                               ; preds = %43
  ...
  %60 = call double @_Z5judgei(i32 %59)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_1.cpp() #0 section ".text.startup" {
