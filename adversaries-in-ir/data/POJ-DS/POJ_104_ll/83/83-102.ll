; ModuleID = 'POJ-104-source/83/83-102.cpp'
source_filename = "POJ-104-source/83/83-102.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_102.cpp, i8* null }]
...
32:                                               ; preds = %28
  ...
  %36 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* %35)
  br label %37
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_102.cpp() #0 section ".text.startup" {
