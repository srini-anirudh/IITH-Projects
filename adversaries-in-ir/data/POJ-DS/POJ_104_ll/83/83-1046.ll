; ModuleID = 'POJ-104-source/83/83-1046.cpp'
source_filename = "POJ-104-source/83/83-1046.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_1046.cpp, i8* null }]
...
define dso_local float @_Z5scoref(float %0) #4 {
...
36:                                               ; preds = %32
  ...
  %40 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), float* %39)
  %41 = load i32, i32* %3, align 4
  %42 = sext i32 %41 to i64
  %43 = getelementptr inbounds [10 x float], [10 x float]* %7, i64 0, i64 %42
  %44 = load float, float* %43, align 4
  %45 = call float @_Z5scoref(float %44)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_1046.cpp() #0 section ".text.startup" {
