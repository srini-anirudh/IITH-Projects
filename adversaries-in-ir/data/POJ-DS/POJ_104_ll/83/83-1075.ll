; ModuleID = 'POJ-104-source/83/83-1075.cpp'
source_filename = "POJ-104-source/83/83-1075.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_1075.cpp, i8* null }]
...
133:                                              ; preds = %127
  ...
  %136 = getelementptr inbounds [100 x float], [100 x float]* %4, i64 0, i64 %135
...
201:                                              ; preds = %191, %185
  %202 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0))
  br label %203
...
221:                                              ; preds = %217
  ...
  %230 = getelementptr inbounds [100 x float], [100 x float]* %4, i64 0, i64 %229
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_1075.cpp() #0 section ".text.startup" {
