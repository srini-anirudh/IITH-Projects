; ModuleID = 'POJ-104-source/83/83-1224.cpp'
source_filename = "POJ-104-source/83/83-1224.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_1224.cpp, i8* null }]
...
99:                                               ; preds = %93
  ...
  %105 = fmul double %104, 3.300000e+00
...
168:                                              ; preds = %162
  ...
  %174 = fmul double %173, 2.300000e+00
...
214:                                              ; preds = %208
  ...
  %220 = fmul double %219, 1.500000e+00
...
237:                                              ; preds = %231
  ...
  %247 = getelementptr inbounds [10 x float], [10 x float]* %7, i64 0, i64 %246
...
267:                                              ; preds = %263
  ...
  %270 = getelementptr inbounds [10 x float], [10 x float]* %7, i64 0, i64 %269
...
283:                                              ; preds = %263
  ...
  %290 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), double %289)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_1224.cpp() #0 section ".text.startup" {
