; ModuleID = 'POJ-104-source/83/83-128.cpp'
source_filename = "POJ-104-source/83/83-128.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_128.cpp, i8* null }]
...
define dso_local double @_Z1bd(double %0) #4 {
...
74:                                               ; preds = %72, %65, %58, %51, %44, %37, %30, %23, %16, %9
...
46:                                               ; preds = %42
  ...
  %51 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), double* %50)
  br label %52
...
60:                                               ; preds = %56
  ...
  %66 = call double @_Z1bd(double %65)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_128.cpp() #0 section ".text.startup" {
