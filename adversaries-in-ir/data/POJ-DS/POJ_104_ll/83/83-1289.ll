; ModuleID = 'POJ-104-source/83/83-1289.cpp'
source_filename = "POJ-104-source/83/83-1289.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_1289.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %10 = alloca [3 x [9 x float]], align 16
...
22:                                               ; preds = %17
  ...
  %25 = getelementptr inbounds [3 x [9 x float]], [3 x [9 x float]]* %10, i64 0, i64 %24
  %26 = load i32, i32* %4, align 4
  %27 = sext i32 %26 to i64
  %28 = getelementptr inbounds [9 x float], [9 x float]* %25, i64 0, i64 %27
  %29 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), float* %28)
  br label %30
...
43:                                               ; preds = %38
  %44 = getelementptr inbounds [3 x [9 x float]], [3 x [9 x float]]* %10, i64 0, i64 1
...
50:                                               ; preds = %43
  %51 = getelementptr inbounds [3 x [9 x float]], [3 x [9 x float]]* %10, i64 0, i64 2
...
55:                                               ; preds = %43
  %56 = getelementptr inbounds [3 x [9 x float]], [3 x [9 x float]]* %10, i64 0, i64 1
...
62:                                               ; preds = %55
  %63 = getelementptr inbounds [3 x [9 x float]], [3 x [9 x float]]* %10, i64 0, i64 2
...
67:                                               ; preds = %55
  %68 = getelementptr inbounds [3 x [9 x float]], [3 x [9 x float]]* %10, i64 0, i64 1
...
74:                                               ; preds = %67
  %75 = getelementptr inbounds [3 x [9 x float]], [3 x [9 x float]]* %10, i64 0, i64 2
...
79:                                               ; preds = %67
  %80 = getelementptr inbounds [3 x [9 x float]], [3 x [9 x float]]* %10, i64 0, i64 1
...
86:                                               ; preds = %79
  %87 = getelementptr inbounds [3 x [9 x float]], [3 x [9 x float]]* %10, i64 0, i64 2
...
91:                                               ; preds = %79
  %92 = getelementptr inbounds [3 x [9 x float]], [3 x [9 x float]]* %10, i64 0, i64 1
...
98:                                               ; preds = %91
  %99 = getelementptr inbounds [3 x [9 x float]], [3 x [9 x float]]* %10, i64 0, i64 2
...
103:                                              ; preds = %91
  %104 = getelementptr inbounds [3 x [9 x float]], [3 x [9 x float]]* %10, i64 0, i64 1
...
110:                                              ; preds = %103
  %111 = getelementptr inbounds [3 x [9 x float]], [3 x [9 x float]]* %10, i64 0, i64 2
...
115:                                              ; preds = %103
  %116 = getelementptr inbounds [3 x [9 x float]], [3 x [9 x float]]* %10, i64 0, i64 1
...
122:                                              ; preds = %115
  %123 = getelementptr inbounds [3 x [9 x float]], [3 x [9 x float]]* %10, i64 0, i64 2
...
127:                                              ; preds = %115
  %128 = getelementptr inbounds [3 x [9 x float]], [3 x [9 x float]]* %10, i64 0, i64 1
...
134:                                              ; preds = %127
  %135 = getelementptr inbounds [3 x [9 x float]], [3 x [9 x float]]* %10, i64 0, i64 2
...
139:                                              ; preds = %127
  %140 = getelementptr inbounds [3 x [9 x float]], [3 x [9 x float]]* %10, i64 0, i64 1
...
146:                                              ; preds = %139
  %147 = getelementptr inbounds [3 x [9 x float]], [3 x [9 x float]]* %10, i64 0, i64 2
...
151:                                              ; preds = %139
  %152 = getelementptr inbounds [3 x [9 x float]], [3 x [9 x float]]* %10, i64 0, i64 2
...
174:                                              ; preds = %169
  %175 = getelementptr inbounds [3 x [9 x float]], [3 x [9 x float]]* %10, i64 0, i64 0
  %176 = load i32, i32* %4, align 4
  %177 = sext i32 %176 to i64
  %178 = getelementptr inbounds [9 x float], [9 x float]* %175, i64 0, i64 %177
  %179 = load float, float* %178, align 4
  %180 = getelementptr inbounds [3 x [9 x float]], [3 x [9 x float]]* %10, i64 0, i64 2
  ...
  %188 = getelementptr inbounds [9 x float], [9 x float]* %11, i64 0, i64 %187
  store float %185, float* %188, align 4
  %189 = load float, float* %8, align 4
  %190 = load i32, i32* %4, align 4
  %191 = sext i32 %190 to i64
  %192 = getelementptr inbounds [9 x float], [9 x float]* %11, i64 0, i64 %191
  %193 = load float, float* %192, align 4
  %194 = fadd float %189, %193
  store float %194, float* %8, align 4
  %195 = load float, float* %9, align 4
  %196 = getelementptr inbounds [3 x [9 x float]], [3 x [9 x float]]* %10, i64 0, i64 0
...
205:                                              ; preds = %169
  ...
  %211 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), double %210)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_1289.cpp() #0 section ".text.startup" {
