; ModuleID = 'POJ-104-source/83/83-1353.cpp'
source_filename = "POJ-104-source/83/83-1353.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_1353.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %18 = getelementptr inbounds [200 x float], [200 x float]* %5, i64 0, i64 %17
...
102:                                              ; preds = %101, %98
  ...
  %107 = getelementptr inbounds [200 x float], [200 x float]* %5, i64 0, i64 %106
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_1353.cpp() #0 section ".text.startup" {
