; ModuleID = 'POJ-104-source/83/83-1375.cpp'
source_filename = "POJ-104-source/83/83-1375.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_1375.cpp, i8* null }]
...
58:                                               ; preds = %52
  ...
  %61 = getelementptr inbounds [11 x float], [11 x float]* %8, i64 0, i64 %60
...
68:                                               ; preds = %62
  ...
  %71 = getelementptr inbounds [11 x float], [11 x float]* %8, i64 0, i64 %70
...
88:                                               ; preds = %82
  ...
  %91 = getelementptr inbounds [11 x float], [11 x float]* %8, i64 0, i64 %90
...
108:                                              ; preds = %102
  ...
  %111 = getelementptr inbounds [11 x float], [11 x float]* %8, i64 0, i64 %110
...
132:                                              ; preds = %122
  ...
  %135 = getelementptr inbounds [11 x float], [11 x float]* %8, i64 0, i64 %134
...
182:                                              ; preds = %149
  ...
  %189 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), double %188)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_1375.cpp() #0 section ".text.startup" {
