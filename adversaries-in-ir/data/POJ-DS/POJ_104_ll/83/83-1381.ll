; ModuleID = 'POJ-104-source/83/83-1381.cpp'
source_filename = "POJ-104-source/83/83-1381.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_1381.cpp, i8* null }]
...
120:                                              ; preds = %114
  ...
  %123 = getelementptr inbounds [100 x float], [100 x float]* %8, i64 0, i64 %122
...
134:                                              ; preds = %124
  ...
  %137 = getelementptr inbounds [100 x float], [100 x float]* %8, i64 0, i64 %136
...
156:                                              ; preds = %151
  ...
  %165 = getelementptr inbounds [100 x float], [100 x float]* %8, i64 0, i64 %164
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_1381.cpp() #0 section ".text.startup" {
