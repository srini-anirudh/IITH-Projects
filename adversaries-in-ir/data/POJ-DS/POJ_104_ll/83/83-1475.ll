; ModuleID = 'POJ-104-source/83/83-1475.cpp'
source_filename = "POJ-104-source/83/83-1475.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_1475.cpp, i8* null }]
...
26:                                               ; preds = %22
  ...
  %35 = call float @_Z3pntf(float %34)
...
define dso_local float @_Z3pntf(float %0) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_1475.cpp() #0 section ".text.startup" {
