; ModuleID = 'POJ-104-source/83/83-1507.cpp'
source_filename = "POJ-104-source/83/83-1507.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_1507.cpp, i8* null }]
...
24:                                               ; preds = %12
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0))
  store i32 0, i32* %5, align 4
  br label %26
...
221:                                              ; preds = %39
  ...
  store float %228, float* %10, align 4
  %229 = load float, float* %10, align 4
  %230 = fpext float %229 to double
  %231 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0), double %230)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_1507.cpp() #0 section ".text.startup" {
