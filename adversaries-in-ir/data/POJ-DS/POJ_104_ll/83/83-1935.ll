; ModuleID = 'POJ-104-source/83/83-1935.cpp'
source_filename = "POJ-104-source/83/83-1935.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_1935.cpp, i8* null }]
...
define dso_local i32 @main(i32 %0, i8** %1) #4 {
  ...
  %15 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* %6)
...
20:                                               ; preds = %16
  ...
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), float* %23)
...
39:                                               ; preds = %35
  ...
  %43 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), float* %42)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_1935.cpp() #0 section ".text.startup" {
