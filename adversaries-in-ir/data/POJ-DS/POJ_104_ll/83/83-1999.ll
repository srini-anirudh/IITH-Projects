; ModuleID = 'POJ-104-source/83/83-1999.cpp'
source_filename = "POJ-104-source/83/83-1999.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_1999.cpp, i8* null }]
...
215:                                              ; preds = %195
  ...
  %222 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), double %221)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_1999.cpp() #0 section ".text.startup" {
