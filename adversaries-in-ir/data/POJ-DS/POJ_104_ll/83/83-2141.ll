; ModuleID = 'POJ-104-source/83/83-2141.cpp'
source_filename = "POJ-104-source/83/83-2141.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_2141.cpp, i8* null }]
...
55:                                               ; preds = %51
  ...
  %59 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), double* %58)
  br label %60
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_2141.cpp() #0 section ".text.startup" {
