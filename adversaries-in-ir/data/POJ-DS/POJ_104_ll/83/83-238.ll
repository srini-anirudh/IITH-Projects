; ModuleID = 'POJ-104-source/83/83-238.cpp'
source_filename = "POJ-104-source/83/83-238.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_238.cpp, i8* null }]
...
237:                                              ; preds = %210
  ...
  %240 = fmul float %239, 1.000000e+01
  %241 = fdiv float %238, %240
  store float %241, float* %8, align 4
  %242 = load float, float* %8, align 4
  %243 = fpext float %242 to double
  %244 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), double %243)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_238.cpp() #0 section ".text.startup" {
