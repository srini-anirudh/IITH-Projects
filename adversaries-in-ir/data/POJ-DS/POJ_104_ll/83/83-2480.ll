; ModuleID = 'POJ-104-source/83/83-2480.cpp'
source_filename = "POJ-104-source/83/83-2480.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_2480.cpp, i8* null }]
...
75:                                               ; preds = %69
  ...
  %78 = getelementptr inbounds [11 x float], [11 x float]* %8, i64 0, i64 %77
...
95:                                               ; preds = %89
  ...
  %98 = getelementptr inbounds [11 x float], [11 x float]* %8, i64 0, i64 %97
...
105:                                              ; preds = %99
  ...
  %108 = getelementptr inbounds [11 x float], [11 x float]* %8, i64 0, i64 %107
...
141:                                              ; preds = %140, %45
  ...
  %145 = getelementptr inbounds [11 x float], [11 x float]* %8, i64 0, i64 %144
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_2480.cpp() #0 section ".text.startup" {
