; ModuleID = 'POJ-104-source/83/83-2684.cpp'
source_filename = "POJ-104-source/83/83-2684.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_2684.cpp, i8* null }]
...
define dso_local float @_Z6jidiani(i32 %0) #4 {
...
40:                                               ; preds = %36
  ...
  %57 = call float @_Z6jidiani(i32 %56)
  %58 = fmul float %52, %57
  %59 = fadd float %47, %58
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_2684.cpp() #0 section ".text.startup" {
