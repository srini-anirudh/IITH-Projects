; ModuleID = 'POJ-104-source/83/83-2720.cpp'
source_filename = "POJ-104-source/83/83-2720.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_2720.cpp, i8* null }]
...
220:                                              ; preds = %216
  ...
  %228 = getelementptr inbounds [10 x float], [10 x float]* %6, i64 0, i64 %227
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_2720.cpp() #0 section ".text.startup" {
