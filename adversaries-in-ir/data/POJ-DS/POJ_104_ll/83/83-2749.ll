; ModuleID = 'POJ-104-source/83/83-2749.cpp'
source_filename = "POJ-104-source/83/83-2749.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_2749.cpp, i8* null }]
...
33:                                               ; preds = %29
  %34 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), float* %6)
  %35 = load float, float* %8, align 4
  %36 = load float, float* %6, align 4
  %37 = fptosi float %36 to i32
  %38 = call float @_Z2jdi(i32 %37)
  %39 = load i32, i32* %3, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_2749.cpp() #0 section ".text.startup" {
