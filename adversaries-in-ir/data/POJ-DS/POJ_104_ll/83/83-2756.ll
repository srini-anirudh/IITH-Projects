; ModuleID = 'POJ-104-source/83/83-2756.cpp'
source_filename = "POJ-104-source/83/83-2756.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_2756.cpp, i8* null }]
...
27:                                               ; preds = %23
  ...
  %31 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), float* %30)
  %32 = load i32, i32* %8, align 4
  %33 = sext i32 %32 to i64
  %34 = getelementptr inbounds [10 x float], [10 x float]* %4, i64 0, i64 %33
  %35 = load float, float* %34, align 4
  %36 = fptosi float %35 to i32
  %37 = call float @_Z1ji(i32 %36)
...
define dso_local float @_Z1ji(i32 %0) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_2756.cpp() #0 section ".text.startup" {
