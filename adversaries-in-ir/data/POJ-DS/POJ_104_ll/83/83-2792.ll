; ModuleID = 'POJ-104-source/83/83-2792.cpp'
source_filename = "POJ-104-source/83/83-2792.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_2792.cpp, i8* null }]
...
178:                                              ; preds = %43
  ...
  %183 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), double %182)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_2792.cpp() #0 section ".text.startup" {
