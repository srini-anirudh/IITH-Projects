; ModuleID = 'POJ-104-source/83/83-2929.cpp'
source_filename = "POJ-104-source/83/83-2929.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_2929.cpp, i8* null }]
...
180:                                              ; preds = %170, %164
  ...
  store double 4.000000e+00, double* %183, align 8
  br label %184
...
224:                                              ; preds = %197
  ...
  %229 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0), double %228)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_2929.cpp() #0 section ".text.startup" {
