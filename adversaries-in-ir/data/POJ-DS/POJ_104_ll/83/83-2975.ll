; ModuleID = 'POJ-104-source/83/83-2975.cpp'
source_filename = "POJ-104-source/83/83-2975.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_2975.cpp, i8* null }]
...
define dso_local double @_Z7score2gi(i32 %0) #4 {
...
33:                                               ; preds = %29
  ...
  %42 = call double @_Z7score2gi(i32 %41)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_2975.cpp() #0 section ".text.startup" {
