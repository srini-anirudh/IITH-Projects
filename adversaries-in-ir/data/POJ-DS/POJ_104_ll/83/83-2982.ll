; ModuleID = 'POJ-104-source/83/83-2982.cpp'
source_filename = "POJ-104-source/83/83-2982.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_2982.cpp, i8* null }]
...
define dso_local double @_Z4getPi(i32 %0) #4 {
...
42:                                               ; preds = %38
  ...
  %49 = call double @_Z4getPi(i32 %48)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_2982.cpp() #0 section ".text.startup" {
