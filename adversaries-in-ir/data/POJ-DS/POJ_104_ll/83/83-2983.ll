; ModuleID = 'POJ-104-source/83/83-2983.cpp'
source_filename = "POJ-104-source/83/83-2983.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_2983.cpp, i8* null }]
...
define dso_local double @_Z2cki(i32 %0) #4 {
...
34:                                               ; preds = %30
  %35 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %6)
  %36 = load i32, i32* %6, align 4
  %37 = call double @_Z2cki(i32 %36)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_2983.cpp() #0 section ".text.startup" {
