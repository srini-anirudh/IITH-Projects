; ModuleID = 'POJ-104-source/83/83-3018.cpp'
source_filename = "POJ-104-source/83/83-3018.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_3018.cpp, i8* null }]
...
define dso_local double @_Z8whatmarki(i32 %0) #4 {
...
54:                                               ; preds = %50
  ...
  %59 = call double @_Z8whatmarki(i32 %58)
  %60 = load i32, i32* %3, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_3018.cpp() #0 section ".text.startup" {
