; ModuleID = 'POJ-104-source/83/83-3028.cpp'
source_filename = "POJ-104-source/83/83-3028.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_3028.cpp, i8* null }]
...
define dso_local float @_Z6gpointi(i32 %0) #4 {
...
34:                                               ; preds = %30
  ...
  %44 = call float @_Z6gpointi(i32 %43)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_3028.cpp() #0 section ".text.startup" {
