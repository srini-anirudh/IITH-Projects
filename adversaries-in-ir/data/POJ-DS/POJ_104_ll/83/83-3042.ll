; ModuleID = 'POJ-104-source/83/83-3042.cpp'
source_filename = "POJ-104-source/83/83-3042.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_3042.cpp, i8* null }]
...
205:                                              ; preds = %201
  ...
  %209 = getelementptr inbounds [15 x float], [15 x float]* %7, i64 0, i64 %208
  %210 = load float, float* %209, align 4
  %211 = load i32, i32* %3, align 4
  %212 = sext i32 %211 to i64
  %213 = getelementptr inbounds [15 x i32], [15 x i32]* %4, i64 0, i64 %212
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_3042.cpp() #0 section ".text.startup" {
