; ModuleID = 'POJ-104-source/83/83-3058.cpp'
source_filename = "POJ-104-source/83/83-3058.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_3058.cpp, i8* null }]
...
define dso_local float @_Z10GradePointi(i32 %0) #4 {
...
51:                                               ; preds = %47
  ...
  %64 = call float @_Z10GradePointi(i32 %63)
  %65 = fmul float %58, %64
  %66 = fadd float %52, %65
...
77:                                               ; preds = %47
  ...
  %83 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), double %82)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_3058.cpp() #0 section ".text.startup" {
