; ModuleID = 'POJ-104-source/83/83-310.cpp'
source_filename = "POJ-104-source/83/83-310.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_310.cpp, i8* null }]
...
187:                                              ; preds = %181
  ...
  %190 = getelementptr inbounds [100 x float], [100 x float]* %4, i64 0, i64 %189
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_310.cpp() #0 section ".text.startup" {
