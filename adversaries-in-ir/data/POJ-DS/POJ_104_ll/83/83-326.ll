; ModuleID = 'POJ-104-source/83/83-326.cpp'
source_filename = "POJ-104-source/83/83-326.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_326.cpp, i8* null }]
...
197:                                              ; preds = %196, %53
  ...
  %206 = getelementptr inbounds [10 x float], [10 x float]* %9, i64 0, i64 %205
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_326.cpp() #0 section ".text.startup" {
