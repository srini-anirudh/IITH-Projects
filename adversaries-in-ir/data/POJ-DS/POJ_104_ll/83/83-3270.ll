; ModuleID = 'POJ-104-source/83/83-3270.cpp'
source_filename = "POJ-104-source/83/83-3270.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_3270.cpp, i8* null }]
...
223:                                              ; preds = %218
  ...
  %232 = getelementptr inbounds [10 x float], [10 x float]* %8, i64 0, i64 %231
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_3270.cpp() #0 section ".text.startup" {
