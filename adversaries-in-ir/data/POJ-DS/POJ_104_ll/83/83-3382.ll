; ModuleID = 'POJ-104-source/83/83-3382.cpp'
source_filename = "POJ-104-source/83/83-3382.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_3382.cpp, i8* null }]
...
45:                                               ; preds = %40
  ...
  %49 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i32* %48)
  br label %55
...
50:                                               ; preds = %40
  ...
  %54 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %53)
  br label %55
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_3382.cpp() #0 section ".text.startup" {
