; ModuleID = 'POJ-104-source/83/83-340.cpp'
source_filename = "POJ-104-source/83/83-340.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_340.cpp, i8* null }]
...
18:                                               ; preds = %13
  ...
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i32* %21)
  br label %23
...
34:                                               ; preds = %29
  ...
  %38 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i32* %37)
  br label %39
...
48:                                               ; preds = %43
  ...
  %53 = call float @_Z6changei(i32 %52)
...
define dso_local float @_Z6changei(i32 %0) #5 {
  %2 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_340.cpp() #0 section ".text.startup" {
