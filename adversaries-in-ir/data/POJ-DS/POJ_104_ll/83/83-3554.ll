; ModuleID = 'POJ-104-source/83/83-3554.cpp'
source_filename = "POJ-104-source/83/83-3554.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_3554.cpp, i8* null }]
...
46:                                               ; preds = %38
  ...
  %50 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i32* %49)
  br label %51
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_3554.cpp() #0 section ".text.startup" {
