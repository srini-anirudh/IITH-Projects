; ModuleID = 'POJ-104-source/83/83-3576.cpp'
source_filename = "POJ-104-source/83/83-3576.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_3576.cpp, i8* null }]
...
55:                                               ; preds = %50
  ...
  %59 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), float* %58)
...
169:                                              ; preds = %165
  ...
  %173 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), float* %172)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_3576.cpp() #0 section ".text.startup" {
