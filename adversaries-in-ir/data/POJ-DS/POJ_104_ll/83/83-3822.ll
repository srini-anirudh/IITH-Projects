; ModuleID = 'POJ-104-source/83/83-3822.cpp'
source_filename = "POJ-104-source/83/83-3822.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_3822.cpp, i8* null }]
...
30:                                               ; preds = %26
  ...
  %34 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), double* %33)
  br label %35
...
43:                                               ; preds = %39
  ...
  %47 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i32* %46)
  br label %48
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_3822.cpp() #0 section ".text.startup" {
