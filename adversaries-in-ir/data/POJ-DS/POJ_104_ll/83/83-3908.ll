; ModuleID = 'POJ-104-source/83/83-3908.cpp'
source_filename = "POJ-104-source/83/83-3908.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_3908.cpp, i8* null }]
...
define dso_local double @_Z2gci(i32 %0) #5 {
...
63:                                               ; preds = %61, %60, %59, %58, %57, %56, %55, %54, %53, %52
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_3908.cpp() #0 section ".text.startup" {
