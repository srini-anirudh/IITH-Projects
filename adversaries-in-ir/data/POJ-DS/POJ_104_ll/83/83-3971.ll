; ModuleID = 'POJ-104-source/83/83-3971.cpp'
source_filename = "POJ-104-source/83/83-3971.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_3971.cpp, i8* null }]
...
44:                                               ; preds = %39
  ...
  %48 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i32* %47)
  br label %49
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_3971.cpp() #0 section ".text.startup" {
