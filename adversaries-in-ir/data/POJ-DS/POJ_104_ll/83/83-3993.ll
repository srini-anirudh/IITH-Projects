; ModuleID = 'POJ-104-source/83/83-3993.cpp'
source_filename = "POJ-104-source/83/83-3993.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_3993.cpp, i8* null }]
...
173:                                              ; preds = %148
  ...
  %179 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0))
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_3993.cpp() #0 section ".text.startup" {
