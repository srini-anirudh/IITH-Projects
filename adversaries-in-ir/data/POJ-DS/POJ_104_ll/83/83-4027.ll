; ModuleID = 'POJ-104-source/83/83-4027.cpp'
source_filename = "POJ-104-source/83/83-4027.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_4027.cpp, i8* null }]
...
165:                                              ; preds = %164, %151, %141, %131, %121, %111, %101, %91, %81, %71, %61
...
207:                                              ; preds = %181
  ...
  %214 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), double %213)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_4027.cpp() #0 section ".text.startup" {
