; ModuleID = 'POJ-104-source/83/83-4196.cpp'
source_filename = "POJ-104-source/83/83-4196.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_4196.cpp, i8* null }]
...
127:                                              ; preds = %121
  ...
  %133 = fmul double 2.700000e+00, %132
...
146:                                              ; preds = %140
  ...
  %152 = fmul double 2.300000e+00, %151
...
226:                                              ; preds = %31
  ...
  %232 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), double %231)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_4196.cpp() #0 section ".text.startup" {
