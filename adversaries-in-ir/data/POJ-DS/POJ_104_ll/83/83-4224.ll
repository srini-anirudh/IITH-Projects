; ModuleID = 'POJ-104-source/83/83-4224.cpp'
source_filename = "POJ-104-source/83/83-4224.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_4224.cpp, i8* null }]
...
47:                                               ; preds = %41
  ...
  %50 = getelementptr inbounds [10 x float], [10 x float]* %8, i64 0, i64 %49
...
67:                                               ; preds = %61
  ...
  %70 = getelementptr inbounds [10 x float], [10 x float]* %8, i64 0, i64 %69
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_4224.cpp() #0 section ".text.startup" {
