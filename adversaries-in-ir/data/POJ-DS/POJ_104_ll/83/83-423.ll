; ModuleID = 'POJ-104-source/83/83-423.cpp'
source_filename = "POJ-104-source/83/83-423.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_423.cpp, i8* null }]
...
253:                                              ; preds = %247
  ...
  %256 = getelementptr inbounds [10 x float], [10 x float]* %6, i64 0, i64 %255
...
274:                                              ; preds = %36
  ...
  %280 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), double %279)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_423.cpp() #0 section ".text.startup" {
