; ModuleID = 'POJ-104-source/83/83-4307.cpp'
source_filename = "POJ-104-source/83/83-4307.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_4307.cpp, i8* null }]
...
define dso_local double @_Z5scorei(i32 %0) #4 {
...
41:                                               ; preds = %37
  ...
  %46 = call double @_Z5scorei(i32 %45)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_4307.cpp() #0 section ".text.startup" {
