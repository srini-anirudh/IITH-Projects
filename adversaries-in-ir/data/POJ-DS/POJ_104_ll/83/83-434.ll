; ModuleID = 'POJ-104-source/83/83-434.cpp'
source_filename = "POJ-104-source/83/83-434.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_434.cpp, i8* null }]
...
92:                                               ; preds = %82
  ...
  %95 = getelementptr inbounds [11 x i32], [11 x i32]* %4, i64 0, i64 %94
...
153:                                              ; preds = %149
  ...
  %161 = getelementptr inbounds [11 x float], [11 x float]* %7, i64 0, i64 %160
  %162 = load float, float* %161, align 4
  %163 = fmul float %158, %162
  %164 = load i32, i32* %5, align 4
  %165 = sext i32 %164 to i64
  %166 = getelementptr inbounds [11 x float], [11 x float]* %8, i64 0, i64 %165
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_434.cpp() #0 section ".text.startup" {
