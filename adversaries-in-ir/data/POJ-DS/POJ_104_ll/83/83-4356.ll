; ModuleID = 'POJ-104-source/83/83-4356.cpp'
source_filename = "POJ-104-source/83/83-4356.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_4356.cpp, i8* null }]
...
40:                                               ; preds = %36
  ...
  %44 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i64 0, i64 0), float* %43)
  br label %45
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_4356.cpp() #0 section ".text.startup" {
