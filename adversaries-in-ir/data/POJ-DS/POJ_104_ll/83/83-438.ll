; ModuleID = 'POJ-104-source/83/83-438.cpp'
source_filename = "POJ-104-source/83/83-438.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_438.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %11 = alloca [111 x float], align 16
...
132:                                              ; preds = %131, %66
  ...
  %142 = getelementptr inbounds [111 x float], [111 x float]* %11, i64 0, i64 %141
...
151:                                              ; preds = %147
  ...
  %155 = getelementptr inbounds [111 x float], [111 x float]* %11, i64 0, i64 %154
...
161:                                              ; preds = %147
  ...
  %168 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0), double %167)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_438.cpp() #0 section ".text.startup" {
