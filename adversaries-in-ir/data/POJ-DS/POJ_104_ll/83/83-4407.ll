; ModuleID = 'POJ-104-source/83/83-4407.cpp'
source_filename = "POJ-104-source/83/83-4407.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_4407.cpp, i8* null }]
...
define dso_local double @_Z3GPAi(i32 %0) #5 {
...
; Function Attrs: noinline uwtable
define dso_local void @_Z7averagei(i32 %0) #0 {
  %2 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_4407.cpp() #0 section ".text.startup" {
