; ModuleID = 'POJ-104-source/83/83-4511.cpp'
source_filename = "POJ-104-source/83/83-4511.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_4511.cpp, i8* null }]
...
define dso_local float @_Z4suanPiS_if(i32* %0, i32* %1, i32 %2, float %3) #4 {
...
33:                                               ; preds = %21
  ...
  %38 = call float @_Z4suanPiS_if(i32* %34, i32* %35, i32 %36, float %37)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_4511.cpp() #0 section ".text.startup" {
