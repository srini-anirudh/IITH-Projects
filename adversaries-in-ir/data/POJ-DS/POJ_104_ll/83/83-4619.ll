; ModuleID = 'POJ-104-source/83/83-4619.cpp'
source_filename = "POJ-104-source/83/83-4619.cpp"
...
@credit = dso_local global i32 0, align 4
@GPA = dso_local global float 0.000000e+00, align 4
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [6 x i8] c"%.2f\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_4619.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_4619.cpp() #0 section ".text.startup" {
