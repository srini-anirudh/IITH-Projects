; ModuleID = 'POJ-104-source/83/83-466.cpp'
source_filename = "POJ-104-source/83/83-466.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_466.cpp, i8* null }]
...
251:                                              ; preds = %230
  ...
  store float %254, float* %11, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_466.cpp() #0 section ".text.startup" {
