; ModuleID = 'POJ-104-source/83/83-4667.cpp'
source_filename = "POJ-104-source/83/83-4667.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_4667.cpp, i8* null }]
...
27:                                               ; preds = %23
  ...
  %31 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), double* %30)
  br label %32
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_4667.cpp() #0 section ".text.startup" {
