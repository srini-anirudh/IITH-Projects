; ModuleID = 'POJ-104-source/83/83-4700.cpp'
source_filename = "POJ-104-source/83/83-4700.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_4700.cpp, i8* null }]
...
29:                                               ; preds = %24
  ...
  %33 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), float* %32)
  br label %34
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_4700.cpp() #0 section ".text.startup" {
