; ModuleID = 'POJ-104-source/83/83-4835.cpp'
source_filename = "POJ-104-source/83/83-4835.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_4835.cpp, i8* null }]
...
47:                                               ; preds = %43
  ...
  %51 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i32* %50)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_4835.cpp() #0 section ".text.startup" {
