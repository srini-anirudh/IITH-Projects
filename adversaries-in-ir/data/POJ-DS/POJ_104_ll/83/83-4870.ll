; ModuleID = 'POJ-104-source/83/83-4870.cpp'
source_filename = "POJ-104-source/83/83-4870.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_4870.cpp, i8* null }]
...
231:                                              ; preds = %227
  ...
  %235 = getelementptr inbounds [10 x float], [10 x float]* %7, i64 0, i64 %234
...
257:                                              ; preds = %242
  ...
  %263 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), double %262)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_4870.cpp() #0 section ".text.startup" {
