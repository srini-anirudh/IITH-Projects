; ModuleID = 'POJ-104-source/83/83-4942.cpp'
source_filename = "POJ-104-source/83/83-4942.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_4942.cpp, i8* null }]
...
119:                                              ; preds = %109
  %120 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* %3)
...
125:                                              ; preds = %121
  ...
  %129 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %128)
  br label %130
...
133:                                              ; preds = %121
  %134 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0))
  store i32 1, i32* %2, align 4
  br label %135
...
139:                                              ; preds = %135
  %140 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %5)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_4942.cpp() #0 section ".text.startup" {
