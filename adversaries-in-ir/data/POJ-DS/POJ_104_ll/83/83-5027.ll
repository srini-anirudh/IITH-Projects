; ModuleID = 'POJ-104-source/83/83-5027.cpp'
source_filename = "POJ-104-source/83/83-5027.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_5027.cpp, i8* null }]
...
71:                                               ; preds = %51
  ...
  %77 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), double %76)
...
define dso_local float @_Z4tranf(float %0) #6 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_5027.cpp() #0 section ".text.startup" {
