; ModuleID = 'POJ-104-source/83/83-5154.cpp'
source_filename = "POJ-104-source/83/83-5154.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_5154.cpp, i8* null }]
...
38:                                               ; preds = %33
  ...
  %42 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* %41)
  br label %48
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_5154.cpp() #0 section ".text.startup" {
