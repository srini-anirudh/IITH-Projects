; ModuleID = 'POJ-104-source/83/83-5167.cpp'
source_filename = "POJ-104-source/83/83-5167.cpp"
...
@b = dso_local global [10 x double] zeroinitializer, align 16
@.str = private unnamed_addr constant [4 x i8] c"%lf\00", align 1
@.str.1 = private unnamed_addr constant [6 x i8] c"%lf  \00", align 1
@.str.2 = private unnamed_addr constant [6 x i8] c"%.2lf\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_5167.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local double @_Z5InputPdd(double* %0, double %1) #0 {
...
11:                                               ; preds = %6
  ...
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), double* %15)
  br label %17
...
define dso_local double @_Z3SumPddd(double* %0, double %1, double %2) #4 {
  %4 = alloca double*, align 8
...
; Function Attrs: noinline nounwind uwtable
define dso_local double @_Z4GPAIPdd(double* %0, double %1) #4 {
  %3 = alloca double*, align 8
  %4 = alloca double, align 8
  %5 = alloca i32, align 4
  store double* %0, double** %3, align 8
...
; Function Attrs: noinline nounwind uwtable
define dso_local double @_Z5GPAIIPdS_d(double* %0, double* %1, double %2) #4 {
  %4 = alloca double*, align 8
  %5 = alloca double*, align 8
  %6 = alloca double, align 8
  %7 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5checkPdd(double* %0, double %1) #0 {
  %3 = alloca double*, align 8
  %4 = alloca double, align 8
  %5 = alloca i32, align 4
  store double* %0, double** %3, align 8
...
define dso_local i32 @main() #5 {
  ...
  %8 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), double* %2)
  %9 = getelementptr inbounds [10 x double], [10 x double]* %3, i64 0, i64 0
  %10 = load double, double* %2, align 8
  %11 = call double @_Z5InputPdd(double* %9, double %10)
  %12 = getelementptr inbounds [10 x double], [10 x double]* %4, i64 0, i64 0
  %13 = load double, double* %2, align 8
  %14 = call double @_Z5InputPdd(double* %12, double %13)
  %15 = getelementptr inbounds [10 x double], [10 x double]* %4, i64 0, i64 0
  %16 = load double, double* %2, align 8
  %17 = call double @_Z4GPAIPdd(double* %15, double %16)
  ...
  %21 = call double @_Z5GPAIIPdS_d(double* %18, double* %19, double %20)
  ...
  %25 = call double @_Z3SumPddd(double* %22, double %23, double %24)
  store double %25, double* %5, align 8
  %26 = getelementptr inbounds [10 x double], [10 x double]* %4, i64 0, i64 0
  %27 = load double, double* %2, align 8
  %28 = load double, double* %6, align 8
  %29 = call double @_Z3SumPddd(double* %26, double %27, double %28)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_5167.cpp() #0 section ".text.startup" {
