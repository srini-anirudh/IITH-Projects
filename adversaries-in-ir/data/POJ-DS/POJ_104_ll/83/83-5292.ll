; ModuleID = 'POJ-104-source/83/83-5292.cpp'
source_filename = "POJ-104-source/83/83-5292.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_5292.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %10 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %2)
...
34:                                               ; preds = %30
  ...
  %38 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), double* %37)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_5292.cpp() #0 section ".text.startup" {
