; ModuleID = 'POJ-104-source/83/83-5353.cpp'
source_filename = "POJ-104-source/83/83-5353.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_5353.cpp, i8* null }]
...
39:                                               ; preds = %25
  %40 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0))
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_5353.cpp() #0 section ".text.startup" {
