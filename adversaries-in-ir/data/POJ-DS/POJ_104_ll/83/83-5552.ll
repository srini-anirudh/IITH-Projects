; ModuleID = 'POJ-104-source/83/83-5552.cpp'
source_filename = "POJ-104-source/83/83-5552.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_5552.cpp, i8* null }]
...
define dso_local i32 @_Z6XuefenPii(i32* %0, i32 %1) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local double @_Z6JidianPiS_i(i32* %0, i32* %1, i32 %2) #4 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_5552.cpp() #0 section ".text.startup" {
