; ModuleID = 'POJ-104-source/83/83-5569.cpp'
source_filename = "POJ-104-source/83/83-5569.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_5569.cpp, i8* null }]
...
define dso_local float @_Z7GPAlizei(i32 %0) #4 {
...
47:                                               ; preds = %43
  ...
  %52 = call float @_Z7GPAlizei(i32 %51)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_5569.cpp() #0 section ".text.startup" {
