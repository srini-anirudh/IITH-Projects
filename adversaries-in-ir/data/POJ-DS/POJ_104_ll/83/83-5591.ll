; ModuleID = 'POJ-104-source/83/83-5591.cpp'
source_filename = "POJ-104-source/83/83-5591.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_5591.cpp, i8* null }]
...
18:                                               ; preds = %13
  ...
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i32* %21)
  br label %23
...
26:                                               ; preds = %13
  ...
  %31 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* %30)
  %32 = getelementptr inbounds [10 x i32], [10 x i32]* %7, i64 0, i64 0
  %33 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i32* %32)
...
38:                                               ; preds = %34
  ...
  %42 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i64 0, i64 0), i32* %41)
  br label %43
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_5591.cpp() #0 section ".text.startup" {
