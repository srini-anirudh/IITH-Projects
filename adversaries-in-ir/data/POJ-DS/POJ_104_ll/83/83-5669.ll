; ModuleID = 'POJ-104-source/83/83-5669.cpp'
source_filename = "POJ-104-source/83/83-5669.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_5669.cpp, i8* null }]
...
33:                                               ; preds = %21
  ...
  %37 = call double @_Z4zpjdiPiS_(i32 %34, i32* %35, i32* %36)
...
define dso_local double @_Z4zpjdiPiS_(i32 %0, i32* %1, i32* %2) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_5669.cpp() #0 section ".text.startup" {
