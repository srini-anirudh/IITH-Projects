; ModuleID = 'POJ-104-source/83/83-600.cpp'
source_filename = "POJ-104-source/83/83-600.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_600.cpp, i8* null }]
...
143:                                              ; preds = %137
  ...
  %151 = getelementptr inbounds [10 x double], [10 x double]* %6, i64 0, i64 %150
...
219:                                              ; preds = %199
  ...
  %224 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.2, i64 0, i64 0), double %223)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_600.cpp() #0 section ".text.startup" {
