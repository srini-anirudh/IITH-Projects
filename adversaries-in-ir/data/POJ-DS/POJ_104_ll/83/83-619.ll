; ModuleID = 'POJ-104-source/83/83-619.cpp'
source_filename = "POJ-104-source/83/83-619.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_619.cpp, i8* null }]
...
define dso_local i32 @main(i32 %0, i8** %1) #4 {
  ...
  %14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* %6)
...
28:                                               ; preds = %15
  ...
  %33 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* %32)
  store i32 0, i32* %8, align 4
  br label %34
...
47:                                               ; preds = %34
  ...
  %52 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i32* %51)
  store i32 0, i32* %8, align 4
  br label %53
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_619.cpp() #0 section ".text.startup" {
