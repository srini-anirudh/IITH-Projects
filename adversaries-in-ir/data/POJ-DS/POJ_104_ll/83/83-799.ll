; ModuleID = 'POJ-104-source/83/83-799.cpp'
source_filename = "POJ-104-source/83/83-799.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_799.cpp, i8* null }]
...
23:                                               ; preds = %18
  ...
  %27 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* %26)
  br label %33
...
52:                                               ; preds = %47
  ...
  %56 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* %55)
  br label %62
...
57:                                               ; preds = %47
  ...
  %61 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* %60)
  br label %62
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_799.cpp() #0 section ".text.startup" {
