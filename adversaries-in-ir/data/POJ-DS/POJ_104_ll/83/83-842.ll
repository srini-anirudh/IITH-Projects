; ModuleID = 'POJ-104-source/83/83-842.cpp'
source_filename = "POJ-104-source/83/83-842.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_83_842.cpp, i8* null }]
...
24:                                               ; preds = %11
  ...
  %29 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* %28)
  store i32 0, i32* %4, align 4
  br label %30
...
35:                                               ; preds = %30
  ...
  %39 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i32* %38)
  br label %40
...
43:                                               ; preds = %30
  ...
  %48 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i32* %47)
  store i32 0, i32* %4, align 4
  br label %49
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_83_842.cpp() #0 section ".text.startup" {
