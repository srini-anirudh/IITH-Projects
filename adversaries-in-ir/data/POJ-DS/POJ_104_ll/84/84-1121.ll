; ModuleID = 'POJ-104-source/84/84-1121.cpp'
source_filename = "POJ-104-source/84/84-1121.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_84_1121.cpp, i8* null }]
...
19:                                               ; preds = %7
  ...
  %22 = call i32 @_Z3maxiPi(i32 %20, i32* %21)
...
44:                                               ; preds = %25
  ...
  %47 = call i32 @_Z3maxiPi(i32 %45, i32* %46)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_84_1121.cpp() #0 section ".text.startup" {
