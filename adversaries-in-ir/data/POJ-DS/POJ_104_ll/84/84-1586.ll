; ModuleID = 'POJ-104-source/84/84-1586.cpp'
source_filename = "POJ-104-source/84/84-1586.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_84_1586.cpp, i8* null }]
...
109:                                              ; preds = %91, %86
  ...
  %120 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32 %114, i32 %119)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_84_1586.cpp() #0 section ".text.startup" {
