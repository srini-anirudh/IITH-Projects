; ModuleID = 'POJ-104-source/84/84-217.cpp'
source_filename = "POJ-104-source/84/84-217.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_84_217.cpp, i8* null }]
...
71:                                               ; preds = %23
  ...
  %76 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i64 0, i64 0), i32 %73, i32 %75)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_84_217.cpp() #0 section ".text.startup" {
