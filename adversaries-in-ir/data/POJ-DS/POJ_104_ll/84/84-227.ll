; ModuleID = 'POJ-104-source/84/84-227.cpp'
source_filename = "POJ-104-source/84/84-227.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_84_227.cpp, i8* null }]
...
71:                                               ; preds = %85, %67
  ...
  %76 = getelementptr inbounds [102 x i32], [102 x i32]* %3, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_84_227.cpp() #0 section ".text.startup" {
