; ModuleID = 'POJ-104-source/84/84-2707.cpp'
source_filename = "POJ-104-source/84/84-2707.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_84_2707.cpp, i8* null }]
...
define dso_local i32 @_Z3maxPiii(i32* %0, i32 %1, i32 %2) #4 {
...
19:                                               ; preds = %7
  ...
  %22 = call i32 @_Z3maxPiii(i32* %20, i32 %21, i32 0)
  ...
  %28 = call i32 @_Z3maxPiii(i32* %25, i32 %26, i32 %27)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_84_2707.cpp() #0 section ".text.startup" {
