; ModuleID = 'POJ-104-source/84/84-2906.cpp'
source_filename = "POJ-104-source/84/84-2906.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_84_2906.cpp, i8* null }]
...
54:                                               ; preds = %40
  %55 = getelementptr inbounds [50 x i32], [50 x i32]* %3, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_84_2906.cpp() #0 section ".text.startup" {
