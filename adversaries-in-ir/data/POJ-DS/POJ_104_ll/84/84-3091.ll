; ModuleID = 'POJ-104-source/84/84-3091.cpp'
source_filename = "POJ-104-source/84/84-3091.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_84_3091.cpp, i8* null }]
...
20:                                               ; preds = %15
  ...
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* %23)
  br label %25
...
78:                                               ; preds = %29
  ...
  %89 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32 %83, i32 %88)
  store i32 0, i32* %1, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_84_3091.cpp() #0 section ".text.startup" {
