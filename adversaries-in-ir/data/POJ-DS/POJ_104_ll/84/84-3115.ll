; ModuleID = 'POJ-104-source/84/84-3115.cpp'
source_filename = "POJ-104-source/84/84-3115.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_84_3115.cpp, i8* null }]
...
81:                                               ; preds = %29
  ...
  %92 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0), i32 %86, i32 %91)
  br label %93
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_84_3115.cpp() #0 section ".text.startup" {
