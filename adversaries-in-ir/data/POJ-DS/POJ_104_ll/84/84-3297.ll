; ModuleID = 'POJ-104-source/84/84-3297.cpp'
source_filename = "POJ-104-source/84/84-3297.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_84_3297.cpp, i8* null }]
...
19:                                               ; preds = %7
  ...
  %27 = sub nsw i32 %26, 1
  %28 = call i32 @_Z3maxPii(i32* %25, i32 %27)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_84_3297.cpp() #0 section ".text.startup" {
