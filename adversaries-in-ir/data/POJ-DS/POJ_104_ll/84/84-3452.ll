; ModuleID = 'POJ-104-source/84/84-3452.cpp'
source_filename = "POJ-104-source/84/84-3452.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_84_3452.cpp, i8* null }]
...
105:                                              ; preds = %85
  ...
  %108 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32 %106, i32 %107)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_84_3452.cpp() #0 section ".text.startup" {
