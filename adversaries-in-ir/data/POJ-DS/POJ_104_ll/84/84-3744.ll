; ModuleID = 'POJ-104-source/84/84-3744.cpp'
source_filename = "POJ-104-source/84/84-3744.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_84_3744.cpp, i8* null }]
...
18:                                               ; preds = %6
  ...
  %21 = call i32 @_Z3maxPii(i32* %19, i32 %20)
  ...
  %25 = call i32 @_Z3maxPii(i32* %23, i32 %24)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_84_3744.cpp() #0 section ".text.startup" {
