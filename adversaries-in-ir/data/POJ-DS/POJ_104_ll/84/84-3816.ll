; ModuleID = 'POJ-104-source/84/84-3816.cpp'
source_filename = "POJ-104-source/84/84-3816.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_84_3816.cpp, i8* null }]
...
18:                                               ; preds = %6
  ...
  call void @qsort(i8* %20, i64 %22, i64 4, i32 (i8*, i8*)* @_Z3cmpPKvS0_)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_84_3816.cpp() #0 section ".text.startup" {
