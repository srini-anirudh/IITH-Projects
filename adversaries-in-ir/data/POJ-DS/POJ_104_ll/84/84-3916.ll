; ModuleID = 'POJ-104-source/84/84-3916.cpp'
source_filename = "POJ-104-source/84/84-3916.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_84_3916.cpp, i8* null }]
...
27:                                               ; preds = %23
  ...
  %33 = call i32 @_Z3maxii(i32 %28, i32 %32)
...
64:                                               ; preds = %60
  ...
  %70 = call i32 @_Z3maxii(i32 %65, i32 %69)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_84_3916.cpp() #0 section ".text.startup" {
