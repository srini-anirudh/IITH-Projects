; ModuleID = 'POJ-104-source/84/84-3999.cpp'
source_filename = "POJ-104-source/84/84-3999.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_84_3999.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %8 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %5)
...
17:                                               ; preds = %12
  ...
  %21 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32* %20)
  br label %23
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_84_3999.cpp() #0 section ".text.startup" {
