; ModuleID = 'POJ-104-source/84/84-4096.cpp'
source_filename = "POJ-104-source/84/84-4096.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_84_4096.cpp, i8* null }]
...
73:                                               ; preds = %23
  ...
  %78 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32 %75, i32 %77)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_84_4096.cpp() #0 section ".text.startup" {
