; ModuleID = 'POJ-104-source/84/84-4136.cpp'
source_filename = "POJ-104-source/84/84-4136.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_84_4136.cpp, i8* null }]
...
71:                                               ; preds = %21
  ...
  %82 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32 %76, i32 %81)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_84_4136.cpp() #0 section ".text.startup" {
