; ModuleID = 'POJ-104-source/84/84-4212.cpp'
source_filename = "POJ-104-source/84/84-4212.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_84_4212.cpp, i8* null }]
...
13:                                               ; preds = %9
  ...
  %16 = getelementptr inbounds [30 x i32], [30 x i32]* %7, i64 0, i64 %15
...
45:                                               ; preds = %24
  store i32 0, i32* %4, align 4
  br i1 false, label %46, label %70

46:                                               ; preds = %45
  %47 = getelementptr inbounds [30 x i32], [30 x i32]* %7, i64 0, i64 1
...
70:                                               ; preds = %45
  %71 = getelementptr inbounds [30 x i32], [30 x i32]* %7, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_84_4212.cpp() #0 section ".text.startup" {
