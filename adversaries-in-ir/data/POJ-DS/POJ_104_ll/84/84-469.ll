; ModuleID = 'POJ-104-source/84/84-469.cpp'
source_filename = "POJ-104-source/84/84-469.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_84_469.cpp, i8* null }]
...
30:                                               ; preds = %26
  ...
  %36 = call i32 @_Z3maxii(i32 %31, i32 %35)
...
65:                                               ; preds = %61
  ...
  %71 = call i32 @_Z3maxii(i32 %66, i32 %70)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_84_469.cpp() #0 section ".text.startup" {
