; ModuleID = 'POJ-104-source/84/84-86.cpp'
source_filename = "POJ-104-source/84/84-86.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_84_86.cpp, i8* null }]
...
19:                                               ; preds = %7
  ...
  call void @_Z6changePii(i32* %20, i32 %21)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_84_86.cpp() #0 section ".text.startup" {
