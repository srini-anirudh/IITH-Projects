; ModuleID = 'POJ-104-source/85/85-1.cpp'
source_filename = "POJ-104-source/85/85-1.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_85_1.cpp, i8* null }]
...
define dso_local i32 @_Z11isidentiforPKc(i8* %0) #4 {
...
9:                                                ; preds = %5
  ...
  %13 = call i32 @_Z11isidentiforPKc(i8* %12)
  %14 = icmp ne i32 %13, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_85_1.cpp() #0 section ".text.startup" {
