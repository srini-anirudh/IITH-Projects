; ModuleID = 'POJ-104-source/85/85-1069.cpp'
source_filename = "POJ-104-source/85/85-1069.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_85_1069.cpp, i8* null }]
...
28:                                               ; preds = %23, %13
  %29 = getelementptr inbounds [30 x i8], [30 x i8]* %7, i64 0, i64 0
...
38:                                               ; preds = %33, %28
  %39 = getelementptr inbounds [30 x i8], [30 x i8]* %7, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_85_1069.cpp() #0 section ".text.startup" {
