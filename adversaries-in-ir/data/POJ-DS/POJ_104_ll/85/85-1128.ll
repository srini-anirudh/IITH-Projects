; ModuleID = 'POJ-104-source/85/85-1128.cpp'
source_filename = "POJ-104-source/85/85-1128.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_85_1128.cpp, i8* null }]
...
define dso_local i32 @_Z4biaoc(i8 signext %0) #4 {
...
38:                                               ; preds = %34
  ...
  %46 = call i32 @_Z4biaoc(i8 signext %45)
  %47 = icmp ne i32 %46, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_85_1128.cpp() #0 section ".text.startup" {
