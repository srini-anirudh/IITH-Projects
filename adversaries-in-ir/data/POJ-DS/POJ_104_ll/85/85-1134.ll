; ModuleID = 'POJ-104-source/85/85-1134.cpp'
source_filename = "POJ-104-source/85/85-1134.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_85_1134.cpp, i8* null }]
...
define dso_local i32 @_Z9judgecharc(i8 signext %0) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z10judgebeginc(i8 signext %0) #4 {
  %2 = alloca i32, align 4
  %3 = alloca i8, align 1
  store i8 %0, i8* %3, align 1
  %4 = load i8, i8* %3, align 1
...
13:                                               ; preds = %9
  ...
  %21 = call i32 @_Z10judgebeginc(i8 signext %20)
  %22 = icmp ne i32 %21, 0
...
29:                                               ; preds = %25
  ...
  %34 = call i32 @_Z9judgecharc(i8 signext %33)
  %35 = icmp ne i32 %34, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_85_1134.cpp() #0 section ".text.startup" {
