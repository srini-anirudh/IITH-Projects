; ModuleID = 'POJ-104-source/85/85-1256.cpp'
source_filename = "POJ-104-source/85/85-1256.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_85_1256.cpp, i8* null }]
...
define dso_local i32 @_Z2dxc(i8 signext %0) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z2xxc(i8 signext %0) #4 {
  %2 = alloca i32, align 4
  %3 = alloca i8, align 1
  store i8 %0, i8* %3, align 1
  %4 = load i8, i8* %3, align 1
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z3xhxc(i8 signext %0) #4 {
  %2 = alloca i32, align 4
  %3 = alloca i8, align 1
  store i8 %0, i8* %3, align 1
  %4 = load i8, i8* %3, align 1
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z4headc(i8 signext %0) #4 {
  %2 = alloca i8, align 1
  store i8 %0, i8* %2, align 1
  %3 = load i8, i8* %2, align 1
  %4 = call i32 @_Z2dxc(i8 signext %3)
  %5 = load i8, i8* %2, align 1
  %6 = call i32 @_Z2xxc(i8 signext %5)
  %7 = add nsw i32 %4, %6
  %8 = load i8, i8* %2, align 1
  %9 = call i32 @_Z3xhxc(i8 signext %8)
  %10 = add nsw i32 %7, %9
  ret i32 %10
}

; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z4bodyc(i8 signext %0) #4 {
  %2 = alloca i8, align 1
  store i8 %0, i8* %2, align 1
  %3 = load i8, i8* %2, align 1
  %4 = call i32 @_Z2dxc(i8 signext %3)
  ...
  %12 = call i32 @_Z3numc(i8 signext %11)
...
16:                                               ; preds = %12
  ...
  %21 = call i32 @_Z4headc(i8 signext %20)
  %22 = icmp eq i32 %21, 0
...
33:                                               ; preds = %30
  ...
  %38 = call i32 @_Z4bodyc(i8 signext %37)
  %39 = icmp eq i32 %38, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_85_1256.cpp() #0 section ".text.startup" {
