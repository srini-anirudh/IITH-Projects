; ModuleID = 'POJ-104-source/85/85-1286.cpp'
source_filename = "POJ-104-source/85/85-1286.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_85_1286.cpp, i8* null }]
...
16:                                               ; preds = %12
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), [21 x i8]* %6)
...
82:                                               ; preds = %77, %18
  ...
  %89 = select i1 %87, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_85_1286.cpp() #0 section ".text.startup" {
