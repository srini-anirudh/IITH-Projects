; ModuleID = 'POJ-104-source/85/85-13.cpp'
source_filename = "POJ-104-source/85/85-13.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_85_13.cpp, i8* null }]
...
13:                                               ; preds = %9
  %14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), [25 x i8]* %3)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_85_13.cpp() #0 section ".text.startup" {
