; ModuleID = 'POJ-104-source/85/85-1308.cpp'
source_filename = "POJ-104-source/85/85-1308.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_85_1308.cpp, i8* null }]
...
48:                                               ; preds = %38
  ...
  %51 = getelementptr inbounds [100 x [20 x i8]], [100 x [20 x i8]]* %3, i64 0, i64 %50
...
58:                                               ; preds = %48, %38
  ...
  %61 = getelementptr inbounds [100 x [20 x i8]], [100 x [20 x i8]]* %3, i64 0, i64 %60
...
119:                                              ; preds = %111
  ...
  %122 = getelementptr inbounds [100 x [20 x i8]], [100 x [20 x i8]]* %3, i64 0, i64 %121
...
154:                                              ; preds = %147
  %155 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0))
  br label %156
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_85_1308.cpp() #0 section ".text.startup" {
