; ModuleID = 'POJ-104-source/85/85-1376.cpp'
source_filename = "POJ-104-source/85/85-1376.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_85_1376.cpp, i8* null }]
...
122:                                              ; preds = %117, %27
  ...
  %133 = select i1 %131, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_85_1376.cpp() #0 section ".text.startup" {
