; ModuleID = 'POJ-104-source/85/85-1750.cpp'
source_filename = "POJ-104-source/85/85-1750.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_85_1750.cpp, i8* null }]
...
define dso_local i32 @_Z7panduanPc(i8* %0) #4 {
...
11:                                               ; preds = %7
  ...
  %15 = call i32 @_Z7panduanPc(i8* %14)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_85_1750.cpp() #0 section ".text.startup" {
