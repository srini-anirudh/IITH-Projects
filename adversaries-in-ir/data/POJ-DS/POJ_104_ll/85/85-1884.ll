; ModuleID = 'POJ-104-source/85/85-1884.cpp'
source_filename = "POJ-104-source/85/85-1884.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_85_1884.cpp, i8* null }]
...
define dso_local i32 @_Z5isminc(i8 signext %0) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z5ismaxc(i8 signext %0) #4 {
  %2 = alloca i32, align 4
  %3 = alloca i8, align 1
  store i8 %0, i8* %3, align 1
  %4 = load i8, i8* %3, align 1
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z7isalphac(i8 signext %0) #4 {
  %2 = alloca i32, align 4
  %3 = alloca i8, align 1
  store i8 %0, i8* %3, align 1
  %4 = load i8, i8* %3, align 1
  %5 = call i32 @_Z5isminc(i8 signext %4)
  %6 = icmp ne i32 %5, 0
  br i1 %6, label %11, label %7

7:                                                ; preds = %1
  %8 = load i8, i8* %3, align 1
  %9 = call i32 @_Z5ismaxc(i8 signext %8)
  %10 = icmp ne i32 %9, 0
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z7isalnumc(i8 signext %0) #4 {
  %2 = alloca i32, align 4
  %3 = alloca i8, align 1
  store i8 %0, i8* %3, align 1
  %4 = load i8, i8* %3, align 1
...
43:                                               ; preds = %39
  %44 = load i8, i8* %3, align 1
  %45 = call i32 @_Z7isalphac(i8 signext %44)
  %46 = icmp ne i32 %45, 0
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z6istruePc(i8* %0) #4 {
  %2 = alloca i32, align 4
  %3 = alloca i8*, align 8
  ...
  %8 = call i32 @_Z7isalphac(i8 signext %7)
  %9 = icmp ne i32 %8, 0
...
25:                                               ; preds = %17
  ...
  %31 = call i32 @_Z7isalnumc(i8 signext %30)
  %32 = icmp ne i32 %31, 0
...
define dso_local i32 @main() #5 {
  ...
  %5 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* %4)
...
10:                                               ; preds = %6
  %11 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), [30 x i8]* %2)
  %12 = getelementptr inbounds [30 x i8], [30 x i8]* %2, i64 0, i64 0
  %13 = call i32 @_Z6istruePc(i8* %12)
  %14 = icmp eq i32 %13, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_85_1884.cpp() #0 section ".text.startup" {
