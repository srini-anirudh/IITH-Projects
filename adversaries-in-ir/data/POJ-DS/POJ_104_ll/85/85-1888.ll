; ModuleID = 'POJ-104-source/85/85-1888.cpp'
source_filename = "POJ-104-source/85/85-1888.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_85_1888.cpp, i8* null }]
...
define dso_local i32 @_Z7panduanc(i8 signext %0) #4 {
  %2 = alloca i8, align 1
...
38:                                               ; preds = %34
  ...
  %47 = call i32 @_Z7panduanc(i8 signext %46)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_85_1888.cpp() #0 section ".text.startup" {
