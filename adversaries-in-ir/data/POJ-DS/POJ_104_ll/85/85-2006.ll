; ModuleID = 'POJ-104-source/85/85-2006.cpp'
source_filename = "POJ-104-source/85/85-2006.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_85_2006.cpp, i8* null }]
...
18:                                               ; preds = %14
  ...
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), [21 x i8]* %21)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_85_2006.cpp() #0 section ".text.startup" {
