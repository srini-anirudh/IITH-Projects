; ModuleID = 'POJ-104-source/85/85-2065.cpp'
source_filename = "POJ-104-source/85/85-2065.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_85_2065.cpp, i8* null }]
...
; Function Attrs: nounwind readonly
declare dso_local i32 @isalnum(i32) #6

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_85_2065.cpp() #0 section ".text.startup" {
