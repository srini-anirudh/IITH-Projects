; ModuleID = 'POJ-104-source/85/85-2123.cpp'
source_filename = "POJ-104-source/85/85-2123.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_85_2123.cpp, i8* null }]
...
define dso_local i32 @_Z1sc(i8 signext %0) #4 {
...
13:                                               ; preds = %9
  ...
  %18 = call i32 @_Z1sc(i8 signext %17)
  %19 = icmp ne i32 %18, 0
...
28:                                               ; preds = %22
  ...
  %33 = call i32 @_Z1fc(i8 signext %32)
  %34 = icmp ne i32 %33, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_85_2123.cpp() #0 section ".text.startup" {
