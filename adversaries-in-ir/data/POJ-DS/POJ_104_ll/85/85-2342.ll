; ModuleID = 'POJ-104-source/85/85-2342.cpp'
source_filename = "POJ-104-source/85/85-2342.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_85_2342.cpp, i8* null }]
...
12:                                               ; preds = %8
  ...
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), [100 x i8]* %15)
  br label %17
...
198:                                              ; preds = %192
  %199 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0))
  br label %202

200:                                              ; preds = %192
  %201 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0))
  br label %202
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_85_2342.cpp() #0 section ".text.startup" {
