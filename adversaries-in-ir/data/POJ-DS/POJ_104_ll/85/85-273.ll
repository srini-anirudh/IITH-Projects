; ModuleID = 'POJ-104-source/85/85-273.cpp'
source_filename = "POJ-104-source/85/85-273.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_85_273.cpp, i8* null }]
...
define dso_local i32 @main() #5 {
  ...
  call void @llvm.memset.p0i8.i64(i8* align 16 %5, i8 0, i64 21, i1 false)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_85_273.cpp() #0 section ".text.startup" {
