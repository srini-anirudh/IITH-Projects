; ModuleID = 'POJ-104-source/85/85-276.cpp'
source_filename = "POJ-104-source/85/85-276.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_85_276.cpp, i8* null }]
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z4termc(i8 signext %0) #4 {
  %2 = alloca i32, align 4
  %3 = alloca i8, align 1
  store i8 %0, i8* %3, align 1
  %4 = load i8, i8* %3, align 1
...
12:                                               ; preds = %8
  ...
  %17 = call i32 @_Z5firstc(i8 signext %16)
  %18 = icmp eq i32 %17, 0
...
28:                                               ; preds = %22
  ...
  %33 = call i32 @_Z4termc(i8 signext %32)
  %34 = icmp eq i32 %33, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_85_276.cpp() #0 section ".text.startup" {
