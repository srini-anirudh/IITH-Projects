; ModuleID = 'POJ-104-source/85/85-326.cpp'
source_filename = "POJ-104-source/85/85-326.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_85_326.cpp, i8* null }]
...
180:                                              ; preds = %177
  %181 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0))
  br label %184
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_85_326.cpp() #0 section ".text.startup" {
