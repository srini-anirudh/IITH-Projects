; ModuleID = 'POJ-104-source/85/85-340.cpp'
source_filename = "POJ-104-source/85/85-340.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_85_340.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %3 = alloca [100 x [31 x i8]], align 16
...
9:                                                ; preds = %5
  ...
  %12 = getelementptr inbounds [100 x [31 x i8]], [100 x [31 x i8]]* %3, i64 0, i64 %11
...
18:                                               ; preds = %5
  %19 = getelementptr inbounds [100 x [31 x i8]], [100 x [31 x i8]]* %3, i64 0, i64 0
  %20 = load i32, i32* %2, align 4
  call void @_Z3funPA31_ci([31 x i8]* %19, i32 %20)
...
; Function Attrs: noinline uwtable
define dso_local void @_Z3funPA31_ci([31 x i8]* %0, i32 %1) #0 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_85_340.cpp() #0 section ".text.startup" {
