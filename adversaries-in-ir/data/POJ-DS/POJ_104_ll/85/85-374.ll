; ModuleID = 'POJ-104-source/85/85-374.cpp'
source_filename = "POJ-104-source/85/85-374.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_85_374.cpp, i8* null }]
...
11:                                               ; preds = %7
  ...
  %19 = call i32 @_Z7panduanPci(i8* %17, i32 %18)
...
define dso_local i32 @_Z7panduanPci(i8* %0, i32 %1) #6 {
  %3 = alloca i32, align 4
  %4 = alloca i8*, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_85_374.cpp() #0 section ".text.startup" {
