; ModuleID = 'POJ-104-source/85/85-38.cpp'
source_filename = "POJ-104-source/85/85-38.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_85_38.cpp, i8* null }]
...
define dso_local i32 @_Z5firstc(i8 signext %0) #4 {
  %2 = alloca i8, align 1
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z6behindc(i8 signext %0) #4 {
  %2 = alloca i8, align 1
  %3 = alloca i32, align 4
  store i8 %0, i8* %2, align 1
  store i32 0, i32* %3, align 4
...
19:                                               ; preds = %15
  ...
  %32 = call i32 @_Z5firstc(i8 signext %31)
  %33 = icmp eq i32 %32, 0
...
44:                                               ; preds = %40
  ...
  %50 = call i32 @_Z6behindc(i8 signext %49)
  %51 = icmp eq i32 %50, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_85_38.cpp() #0 section ".text.startup" {
