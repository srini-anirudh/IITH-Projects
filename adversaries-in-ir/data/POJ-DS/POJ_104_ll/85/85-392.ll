; ModuleID = 'POJ-104-source/85/85-392.cpp'
source_filename = "POJ-104-source/85/85-392.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_85_392.cpp, i8* null }]
...
111:                                              ; preds = %101
  ...
  %114 = getelementptr inbounds [100 x [20 x i8]], [100 x [20 x i8]]* %2, i64 0, i64 %113
...
131:                                              ; preds = %121
  ...
  %134 = getelementptr inbounds [100 x [20 x i8]], [100 x [20 x i8]]* %2, i64 0, i64 %133
...
181:                                              ; preds = %171
  %182 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0))
  br label %183
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_85_392.cpp() #0 section ".text.startup" {
