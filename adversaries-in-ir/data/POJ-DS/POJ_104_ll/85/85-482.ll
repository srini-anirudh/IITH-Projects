; ModuleID = 'POJ-104-source/85/85-482.cpp'
source_filename = "POJ-104-source/85/85-482.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_85_482.cpp, i8* null }]
...
128:                                              ; preds = %118
  ...
  %131 = getelementptr inbounds [100 x [21 x i8]], [100 x [21 x i8]]* %6, i64 0, i64 %130
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_85_482.cpp() #0 section ".text.startup" {
