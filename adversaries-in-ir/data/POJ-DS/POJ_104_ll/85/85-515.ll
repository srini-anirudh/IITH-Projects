; ModuleID = 'POJ-104-source/85/85-515.cpp'
source_filename = "POJ-104-source/85/85-515.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_85_515.cpp, i8* null }]
...
14:                                               ; preds = %9
  ...
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), [20 x i8]* %17)
  br label %19
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_85_515.cpp() #0 section ".text.startup" {
