; ModuleID = 'POJ-104-source/85/85-825.cpp'
source_filename = "POJ-104-source/85/85-825.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_85_825.cpp, i8* null }]
...
104:                                              ; preds = %42
  ...
  %107 = getelementptr inbounds [21 x i8], [21 x i8]* %6, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_85_825.cpp() #0 section ".text.startup" {
