; ModuleID = 'POJ-104-source/86/86-1349.cpp'
source_filename = "POJ-104-source/86/86-1349.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_86_1349.cpp, i8* null }]
...
63:                                               ; preds = %56
  ...
  %66 = getelementptr inbounds [50 x [50 x i32]], [50 x [50 x i32]]* %6, i64 0, i64 %65
...
87:                                               ; preds = %75
  ...
  %90 = getelementptr inbounds [50 x [50 x i32]], [50 x [50 x i32]]* %6, i64 0, i64 %89
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_86_1349.cpp() #0 section ".text.startup" {
