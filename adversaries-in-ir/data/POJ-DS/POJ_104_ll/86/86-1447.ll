; ModuleID = 'POJ-104-source/86/86-1447.cpp'
source_filename = "POJ-104-source/86/86-1447.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_86_1447.cpp, i8* null }]
...
107:                                              ; preds = %11
  %108 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32 1)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_86_1447.cpp() #0 section ".text.startup" {
