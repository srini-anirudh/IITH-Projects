; ModuleID = 'POJ-104-source/86/86-1526.cpp'
source_filename = "POJ-104-source/86/86-1526.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_86_1526.cpp, i8* null }]
...
52:                                               ; preds = %7
  %53 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %2)
  store i32 0, i32* %3, align 4
  br label %54
...
80:                                               ; preds = %72
  ...
  %88 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %87)
  br label %89
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_86_1526.cpp() #0 section ".text.startup" {
