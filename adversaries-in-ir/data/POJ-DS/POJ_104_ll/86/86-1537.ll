; ModuleID = 'POJ-104-source/86/86-1537.cpp'
source_filename = "POJ-104-source/86/86-1537.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_86_1537.cpp, i8* null }]
...
14:                                               ; preds = %10
  store i32 0, i32* %7, align 4
  store i32 0, i32* %6, align 4
  %15 = getelementptr inbounds [20 x i32], [20 x i32]* %8, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_86_1537.cpp() #0 section ".text.startup" {
