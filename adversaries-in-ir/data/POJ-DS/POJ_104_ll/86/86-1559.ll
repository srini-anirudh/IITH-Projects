; ModuleID = 'POJ-104-source/86/86-1559.cpp'
source_filename = "POJ-104-source/86/86-1559.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_86_1559.cpp, i8* null }]
...
44:                                               ; preds = %40
  %45 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %9)
  br label %46
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_86_1559.cpp() #0 section ".text.startup" {
