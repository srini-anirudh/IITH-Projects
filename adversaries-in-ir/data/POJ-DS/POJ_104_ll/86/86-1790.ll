; ModuleID = 'POJ-104-source/86/86-1790.cpp'
source_filename = "POJ-104-source/86/86-1790.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_86_1790.cpp, i8* null }]
...
87:                                               ; preds = %84
  %88 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* @_ZSt4cout, i32 60)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_86_1790.cpp() #0 section ".text.startup" {
