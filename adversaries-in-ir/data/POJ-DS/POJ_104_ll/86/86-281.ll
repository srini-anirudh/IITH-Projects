; ModuleID = 'POJ-104-source/86/86-281.cpp'
source_filename = "POJ-104-source/86/86-281.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_86_281.cpp, i8* null }]
...
36:                                               ; preds = %26
  %37 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %3)
...
42:                                               ; preds = %38
  ...
  %46 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %4)
  store i32 0, i32* %2, align 4
  br label %47
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_86_281.cpp() #0 section ".text.startup" {
