; ModuleID = 'POJ-104-source/86/86-41.cpp'
source_filename = "POJ-104-source/86/86-41.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_86_41.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z3abciPi(i32 %0, i32* %1) #0 {
...
define dso_local i32 @main(i32 %0, i8** %1) #5 {
  ...
  %12 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i32* %7)
...
17:                                               ; preds = %13
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i32* %8)
...
28:                                               ; preds = %24
  ...
  %33 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i32* %32)
  br label %34
...
37:                                               ; preds = %24
  ...
  %44 = call i32 @_Z3abciPi(i32 %43, i32* %8)
...
48:                                               ; preds = %45
  ...
  %55 = call i32 @_Z3abciPi(i32 %54, i32* %8)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_86_41.cpp() #0 section ".text.startup" {
