; ModuleID = 'POJ-104-source/86/86-753.cpp'
source_filename = "POJ-104-source/86/86-753.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_86_753.cpp, i8* null }]
...
33:                                               ; preds = %21
  ...
  %36 = call i32 @_Z3alliPi(i32 %34, i32* %35)
...
define dso_local i32 @_Z3alliPi(i32 %0, i32* %1) #6 {
  %3 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_86_753.cpp() #0 section ".text.startup" {
