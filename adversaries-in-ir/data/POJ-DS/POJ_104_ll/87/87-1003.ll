; ModuleID = 'POJ-104-source/87/87-1003.cpp'
source_filename = "POJ-104-source/87/87-1003.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_87_1003.cpp, i8* null }]
...
10:                                               ; preds = %0, %74
  ...
  %29 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i64 0, i64 0), i32* %13, i32* %16, i32* %19, i32* %22, i32* %25, i32* %28)
...
81:                                               ; preds = %76
  ...
  %106 = call i32 @_Z4timeiiiiii(i32 %85, i32 %89, i32 %93, i32 %97, i32 %101, i32 %105)
...
define dso_local i32 @_Z4timeiiiiii(i32 %0, i32 %1, i32 %2, i32 %3, i32 %4, i32 %5) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_87_1003.cpp() #0 section ".text.startup" {
