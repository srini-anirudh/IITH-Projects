; ModuleID = 'POJ-104-source/87/87-1103.cpp'
source_filename = "POJ-104-source/87/87-1103.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_87_1103.cpp, i8* null }]
...
11:                                               ; preds = %7
  ...
  %36 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i64 0, i64 0), i32* %15, i32* %19, i32* %23, i32* %27, i32* %31, i32* %35)
  br label %37
...
63:                                               ; preds = %59
  ...
  %93 = getelementptr inbounds [6 x i32], [6 x i32]* %92, i64 0, i64 6
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_87_1103.cpp() #0 section ".text.startup" {
