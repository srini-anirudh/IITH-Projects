; ModuleID = 'POJ-104-source/87/87-1150.cpp'
source_filename = "POJ-104-source/87/87-1150.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_87_1150.cpp, i8* null }]
...
40:                                               ; preds = %35, %31, %27, %23, %19, %15
  ...
  %69 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i64 0, i64 0), i32* %63, i32* %64, i32* %65, i32* %66, i32* %67, i32* %68)
  br label %15
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_87_1150.cpp() #0 section ".text.startup" {
