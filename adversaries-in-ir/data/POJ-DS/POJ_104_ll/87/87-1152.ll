; ModuleID = 'POJ-104-source/87/87-1152.cpp'
source_filename = "POJ-104-source/87/87-1152.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_87_1152.cpp, i8* null }]
...
16:                                               ; preds = %13
  ...
  %35 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i64 0, i64 0), i32* %19, i32* %22, i32* %25, i32* %28, i32* %31, i32* %34)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_87_1152.cpp() #0 section ".text.startup" {
