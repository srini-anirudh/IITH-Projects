; ModuleID = 'POJ-104-source/87/87-183.cpp'
source_filename = "POJ-104-source/87/87-183.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_87_183.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i64 0, i64 0), i32* %9, i32* %10, i32* %11, i32* %12, i32* %13, i32* %14)
  br label %18
...
38:                                               ; preds = %36
  ...
  %104 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i64 0, i64 0), i32* %9, i32* %10, i32* %11, i32* %12, i32* %13, i32* %14)
  br label %18
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_87_183.cpp() #0 section ".text.startup" {
