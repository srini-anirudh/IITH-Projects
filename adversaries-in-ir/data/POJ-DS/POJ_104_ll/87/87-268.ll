; ModuleID = 'POJ-104-source/87/87-268.cpp'
source_filename = "POJ-104-source/87/87-268.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_87_268.cpp, i8* null }]
...
9:                                                ; preds = %6
  ...
  %13 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* %12)
  br label %14
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_87_268.cpp() #0 section ".text.startup" {
