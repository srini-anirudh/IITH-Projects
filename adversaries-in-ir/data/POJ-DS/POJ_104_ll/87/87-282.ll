; ModuleID = 'POJ-104-source/87/87-282.cpp'
source_filename = "POJ-104-source/87/87-282.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_87_282.cpp, i8* null }]
...
21:                                               ; preds = %18
  ...
  %46 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i64 0, i64 0), i32* %25, i32* %29, i32* %33, i32* %37, i32* %41, i32* %45)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_87_282.cpp() #0 section ".text.startup" {
