; ModuleID = 'POJ-104-source/87/87-289.cpp'
source_filename = "POJ-104-source/87/87-289.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_87_289.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i64 0, i64 0), i32* %14, i32* %15, i32* %16, i32* %17, i32* %18, i32* %19)
...
65:                                               ; preds = %62
  ...
  %86 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i64 0, i64 0), i32* %70, i32* %73, i32* %76, i32* %79, i32* %82, i32* %85)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_87_289.cpp() #0 section ".text.startup" {
