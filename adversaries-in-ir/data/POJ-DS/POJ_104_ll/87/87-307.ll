; ModuleID = 'POJ-104-source/87/87-307.cpp'
source_filename = "POJ-104-source/87/87-307.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_87_307.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i64 0, i64 0), i32* %11, i32* %12, i32* %13, i32* %14, i32* %15, i32* %16)
...
24:                                               ; preds = %18
  ...
  %49 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i64 0, i64 0), i32* %28, i32* %32, i32* %36, i32* %40, i32* %44, i32* %48)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_87_307.cpp() #0 section ".text.startup" {
