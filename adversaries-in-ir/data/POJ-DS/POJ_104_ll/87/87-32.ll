; ModuleID = 'POJ-104-source/87/87-32.cpp'
source_filename = "POJ-104-source/87/87-32.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_87_32.cpp, i8* null }]
...
20:                                               ; preds = %17
  ...
  %39 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i64 0, i64 0), i32* %23, i32* %26, i32* %29, i32* %32, i32* %35, i32* %38)
...
127:                                              ; preds = %82
  %128 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i32* %2)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_87_32.cpp() #0 section ".text.startup" {
