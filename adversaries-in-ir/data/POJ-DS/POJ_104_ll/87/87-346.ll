; ModuleID = 'POJ-104-source/87/87-346.cpp'
source_filename = "POJ-104-source/87/87-346.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_87_346.cpp, i8* null }]
...
12:                                               ; preds = %11
  ...
  %31 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i64 0, i64 0), i32* %15, i32* %18, i32* %21, i32* %24, i32* %27, i32* %30)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_87_346.cpp() #0 section ".text.startup" {
