; ModuleID = 'POJ-104-source/87/87-348.cpp'
source_filename = "POJ-104-source/87/87-348.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_87_348.cpp, i8* null }]
...
54:                                               ; preds = %52
  ...
  %75 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i64 0, i64 0), i32* %59, i32* %62, i32* %65, i32* %68, i32* %71, i32* %74)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_87_348.cpp() #0 section ".text.startup" {
