; ModuleID = 'POJ-104-source/87/87-358.cpp'
source_filename = "POJ-104-source/87/87-358.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_87_358.cpp, i8* null }]
...
15:                                               ; preds = %12
  ...
  %34 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str, i64 0, i64 0), i32* %18, i32* %21, i32* %24, i32* %27, i32* %30, i32* %33)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_87_358.cpp() #0 section ".text.startup" {
