; ModuleID = 'POJ-104-source/87/87-390.cpp'
source_filename = "POJ-104-source/87/87-390.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_87_390.cpp, i8* null }]
...
24:                                               ; preds = %18
  ...
  %80 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i64 0, i64 0), i32* %64, i32* %67, i32* %70, i32* %73, i32* %76, i32* %79)
  br label %18
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_87_390.cpp() #0 section ".text.startup" {
