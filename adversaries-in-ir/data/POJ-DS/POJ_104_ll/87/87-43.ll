; ModuleID = 'POJ-104-source/87/87-43.cpp'
source_filename = "POJ-104-source/87/87-43.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_87_43.cpp, i8* null }]
...
25:                                               ; preds = %22
  ...
  %44 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i64 0, i64 0), i32* %28, i32* %31, i32* %34, i32* %37, i32* %40, i32* %43)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_87_43.cpp() #0 section ".text.startup" {
