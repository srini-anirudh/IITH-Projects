; ModuleID = 'POJ-104-source/87/87-449.cpp'
source_filename = "POJ-104-source/87/87-449.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_87_449.cpp, i8* null }]
...
6:                                                ; preds = %59, %0
  ...
  %13 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i64 0, i64 0), i32* %7, i32* %8, i32* %9, i32* %10, i32* %11, i32* %12)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_87_449.cpp() #0 section ".text.startup" {
