; ModuleID = 'POJ-104-source/87/87-477.cpp'
source_filename = "POJ-104-source/87/87-477.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_87_477.cpp, i8* null }]
...
31:                                               ; preds = %23
  %32 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0))
  br label %33
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_87_477.cpp() #0 section ".text.startup" {
