; ModuleID = 'POJ-104-source/87/87-534.cpp'
source_filename = "POJ-104-source/87/87-534.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_87_534.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %29 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i64 0, i64 0), i32* %8, i32* %12, i32* %16, i32* %20, i32* %24, i32* %28)
  br label %30
...
75:                                               ; preds = %72
  ...
  %184 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i64 0, i64 0), i32* %163, i32* %167, i32* %171, i32* %175, i32* %179, i32* %183)
  br label %30
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_87_534.cpp() #0 section ".text.startup" {
