; ModuleID = 'POJ-104-source/87/87-558.cpp'
source_filename = "POJ-104-source/87/87-558.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_87_558.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %34 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i64 0, i64 0), i32* %28, i32* %29, i32* %30, i32* %31, i32* %32, i32* %33)
...
65:                                               ; preds = %59
  ...
  %86 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i64 0, i64 0), i32* %70, i32* %73, i32* %76, i32* %79, i32* %82, i32* %85)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_87_558.cpp() #0 section ".text.startup" {
