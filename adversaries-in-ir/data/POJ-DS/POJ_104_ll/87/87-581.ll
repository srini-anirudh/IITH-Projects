; ModuleID = 'POJ-104-source/87/87-581.cpp'
source_filename = "POJ-104-source/87/87-581.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_87_581.cpp, i8* null }]
...
23:                                               ; preds = %17
  ...
  %80 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i64 0, i64 0), i32* %64, i32* %67, i32* %70, i32* %73, i32* %76, i32* %79)
  br label %17
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_87_581.cpp() #0 section ".text.startup" {
