; ModuleID = 'POJ-104-source/87/87-626.cpp'
source_filename = "POJ-104-source/87/87-626.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_87_626.cpp, i8* null }]
...
40:                                               ; preds = %37
  ...
  %59 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i64 0, i64 0), i32* %43, i32* %46, i32* %49, i32* %52, i32* %55, i32* %58)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_87_626.cpp() #0 section ".text.startup" {
