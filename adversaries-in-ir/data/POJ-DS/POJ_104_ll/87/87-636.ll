; ModuleID = 'POJ-104-source/87/87-636.cpp'
source_filename = "POJ-104-source/87/87-636.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_87_636.cpp, i8* null }]
...
23:                                               ; preds = %16
  ...
  %42 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i64 0, i64 0), i32* %26, i32* %29, i32* %32, i32* %35, i32* %38, i32* %41)
  br label %43
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_87_636.cpp() #0 section ".text.startup" {
