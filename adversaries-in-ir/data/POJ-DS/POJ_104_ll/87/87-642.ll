; ModuleID = 'POJ-104-source/87/87-642.cpp'
source_filename = "POJ-104-source/87/87-642.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_87_642.cpp, i8* null }]
...
24:                                               ; preds = %14
  ...
  %40 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i64 0, i64 0), i32* %27, i32* %30, i32* %33, i32* %36, i32* %39)
  br label %58
...
41:                                               ; preds = %14
  ...
  %57 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i64 0, i64 0), i32* %44, i32* %47, i32* %50, i32* %53, i32* %56)
  br label %62
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_87_642.cpp() #0 section ".text.startup" {
