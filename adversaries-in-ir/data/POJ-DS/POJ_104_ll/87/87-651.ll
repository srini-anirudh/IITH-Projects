; ModuleID = 'POJ-104-source/87/87-651.cpp'
source_filename = "POJ-104-source/87/87-651.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_87_651.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i64 0, i64 0), i32* %10, i32* %11, i32* %12, i32* %13, i32* %14, i32* %15)
  br label %17
...
43:                                               ; preds = %41
  ...
  %64 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i64 0, i64 0), i32* %48, i32* %51, i32* %54, i32* %57, i32* %60, i32* %63)
  br label %17
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_87_651.cpp() #0 section ".text.startup" {
