; ModuleID = 'POJ-104-source/87/87-665.cpp'
source_filename = "POJ-104-source/87/87-665.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_87_665.cpp, i8* null }]
...
5:                                                ; preds = %109, %0
  ...
  %30 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str, i64 0, i64 0), i32* %9, i32* %13, i32* %17, i32* %21, i32* %25, i32* %29)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_87_665.cpp() #0 section ".text.startup" {
