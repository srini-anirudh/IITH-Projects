; ModuleID = 'POJ-104-source/87/87-674.cpp'
source_filename = "POJ-104-source/87/87-674.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_87_674.cpp, i8* null }]
...
6:                                                ; preds = %40, %0
  ...
  %31 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i64 0, i64 0), i32* %10, i32* %14, i32* %18, i32* %22, i32* %26, i32* %30)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_87_674.cpp() #0 section ".text.startup" {
