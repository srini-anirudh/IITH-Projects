; ModuleID = 'POJ-104-source/87/87-705.cpp'
source_filename = "POJ-104-source/87/87-705.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_87_705.cpp, i8* null }]
...
19:                                               ; preds = %16
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i64 0, i64 0), i32* %8, i32* %9, i32* %10, i32* %11, i32* %12, i32* %13)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_87_705.cpp() #0 section ".text.startup" {
