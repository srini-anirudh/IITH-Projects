; ModuleID = 'POJ-104-source/87/87-743.cpp'
source_filename = "POJ-104-source/87/87-743.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_87_743.cpp, i8* null }]
...
20:                                               ; preds = %16
  ...
  %39 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i64 0, i64 0), i32* %23, i32* %26, i32* %29, i32* %32, i32* %35, i32* %38)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_87_743.cpp() #0 section ".text.startup" {
