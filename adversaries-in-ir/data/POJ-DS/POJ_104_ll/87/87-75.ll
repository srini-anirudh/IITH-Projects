; ModuleID = 'POJ-104-source/87/87-75.cpp'
source_filename = "POJ-104-source/87/87-75.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_87_75.cpp, i8* null }]
...
10:                                               ; preds = %7
  ...
  %35 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i64 0, i64 0), i32* %14, i32* %18, i32* %22, i32* %26, i32* %30, i32* %34)
...
107:                                              ; preds = %50
  ...
  %120 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i64 0, i64 0), i32* %109, i32* %111, i32* %113, i32* %115, i32* %117, i32* %119)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_87_75.cpp() #0 section ".text.startup" {
