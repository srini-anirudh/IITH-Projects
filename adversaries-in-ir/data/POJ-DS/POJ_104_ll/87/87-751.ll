; ModuleID = 'POJ-104-source/87/87-751.cpp'
source_filename = "POJ-104-source/87/87-751.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_87_751.cpp, i8* null }]
...
68:                                               ; preds = %66
  ...
  %93 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i64 0, i64 0), i32* %72, i32* %76, i32* %80, i32* %84, i32* %88, i32* %92)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_87_751.cpp() #0 section ".text.startup" {
