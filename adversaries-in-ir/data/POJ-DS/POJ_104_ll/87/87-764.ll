; ModuleID = 'POJ-104-source/87/87-764.cpp'
source_filename = "POJ-104-source/87/87-764.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_87_764.cpp, i8* null }]
...
16:                                               ; preds = %13
  ...
  %35 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str, i64 0, i64 0), i32* %19, i32* %22, i32* %25, i32* %28, i32* %31, i32* %34)
...
83:                                               ; preds = %79
  ...
  %89 = fadd double 1.200000e+01, %88
  %90 = fmul double %89, 3.600000e+03
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_87_764.cpp() #0 section ".text.startup" {
