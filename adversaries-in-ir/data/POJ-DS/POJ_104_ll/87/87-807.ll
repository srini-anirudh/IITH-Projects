; ModuleID = 'POJ-104-source/87/87-807.cpp'
source_filename = "POJ-104-source/87/87-807.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_87_807.cpp, i8* null }]
...
15:                                               ; preds = %12
  ...
  %21 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i32* %7)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_87_807.cpp() #0 section ".text.startup" {
