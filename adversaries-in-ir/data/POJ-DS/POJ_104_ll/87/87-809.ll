; ModuleID = 'POJ-104-source/87/87-809.cpp'
source_filename = "POJ-104-source/87/87-809.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_87_809.cpp, i8* null }]
...
60:                                               ; preds = %53, %46, %39, %32, %25, %18
  %61 = phi i1 [ true, %46 ], [ true, %39 ], [ true, %32 ], [ true, %25 ], [ true, %18 ], [ %59, %53 ]
...
62:                                               ; preds = %60
  ...
  %81 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i64 0, i64 0), i32* %65, i32* %68, i32* %71, i32* %74, i32* %77, i32* %80)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_87_809.cpp() #0 section ".text.startup" {
