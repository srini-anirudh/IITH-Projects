; ModuleID = 'POJ-104-source/87/87-820.cpp'
source_filename = "POJ-104-source/87/87-820.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_87_820.cpp, i8* null }]
...
43:                                               ; preds = %40, %37, %34, %31, %28, %25
  %44 = phi i1 [ true, %37 ], [ true, %34 ], [ true, %31 ], [ true, %28 ], [ true, %25 ], [ %42, %40 ]
  br label %45

45:                                               ; preds = %43, %9
  %46 = phi i1 [ false, %9 ], [ %44, %43 ]
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_87_820.cpp() #0 section ".text.startup" {
