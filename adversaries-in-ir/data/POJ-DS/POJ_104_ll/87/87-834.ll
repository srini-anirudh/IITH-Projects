; ModuleID = 'POJ-104-source/87/87-834.cpp'
source_filename = "POJ-104-source/87/87-834.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_87_834.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i64 0, i64 0), i32* %13, i32* %14, i32* %15, i32* %16, i32* %17, i32* %18)
...
57:                                               ; preds = %50, %44, %38, %32, %26, %20
  ...
  %129 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i64 0, i64 0), i32* %113, i32* %116, i32* %119, i32* %122, i32* %125, i32* %128)
  br label %130
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_87_834.cpp() #0 section ".text.startup" {
