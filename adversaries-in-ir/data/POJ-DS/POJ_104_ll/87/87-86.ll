; ModuleID = 'POJ-104-source/87/87-86.cpp'
source_filename = "POJ-104-source/87/87-86.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_87_86.cpp, i8* null }]
...
130:                                              ; preds = %76
  %131 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %11)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_87_86.cpp() #0 section ".text.startup" {
