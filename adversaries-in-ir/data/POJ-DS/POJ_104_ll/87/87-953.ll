; ModuleID = 'POJ-104-source/87/87-953.cpp'
source_filename = "POJ-104-source/87/87-953.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_87_953.cpp, i8* null }]
...
18:                                               ; preds = %15
  ...
  %37 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i64 0, i64 0), i32* %21, i32* %24, i32* %27, i32* %30, i32* %33, i32* %36)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_87_953.cpp() #0 section ".text.startup" {
