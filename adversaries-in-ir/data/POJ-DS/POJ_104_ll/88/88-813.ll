; ModuleID = 'POJ-104-source/88/88-813.cpp'
source_filename = "POJ-104-source/88/88-813.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_88_813.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %8 = call noalias i8* @malloc(i64 120) #3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_88_813.cpp() #0 section ".text.startup" {
