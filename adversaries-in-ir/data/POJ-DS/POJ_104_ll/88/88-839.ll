; ModuleID = 'POJ-104-source/88/88-839.cpp'
source_filename = "POJ-104-source/88/88-839.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_88_839.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %4 = call noalias i8* @malloc(i64 31) #3
...
103:                                              ; preds = %93, %85, %77, %69, %61, %53, %45, %37, %29, %21
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_88_839.cpp() #0 section ".text.startup" {
