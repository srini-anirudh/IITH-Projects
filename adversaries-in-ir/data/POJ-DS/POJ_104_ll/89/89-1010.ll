; ModuleID = 'POJ-104-source/89/89-1010.cpp'
source_filename = "POJ-104-source/89/89-1010.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_89_1010.cpp, i8* null }]
...
37:                                               ; preds = %35
  ...
  %41 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %3, i32* %5)
  br label %29
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_89_1010.cpp() #0 section ".text.startup" {
