; ModuleID = 'POJ-104-source/89/89-1044.cpp'
source_filename = "POJ-104-source/89/89-1044.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_89_1044.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %13 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i64* %5)
...
33:                                               ; preds = %31
  ...
  %38 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %35, i32* %37)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_89_1044.cpp() #0 section ".text.startup" {
