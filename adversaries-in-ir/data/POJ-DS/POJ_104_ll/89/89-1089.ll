; ModuleID = 'POJ-104-source/89/89-1089.cpp'
source_filename = "POJ-104-source/89/89-1089.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_89_1089.cpp, i8* null }]
...
27:                                               ; preds = %47, %26
  %28 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %4, i32* %6)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_89_1089.cpp() #0 section ".text.startup" {
