; ModuleID = 'POJ-104-source/89/89-1194.cpp'
source_filename = "POJ-104-source/89/89-1194.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_89_1194.cpp, i8* null }]
...
34:                                               ; preds = %32
  %35 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %2, i32* %3)
...
46:                                               ; preds = %32
  ...
  %50 = getelementptr inbounds [10000 x i32], [10000 x i32]* %7, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_89_1194.cpp() #0 section ".text.startup" {
