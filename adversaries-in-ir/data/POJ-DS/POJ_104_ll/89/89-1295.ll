; ModuleID = 'POJ-104-source/89/89-1295.cpp'
source_filename = "POJ-104-source/89/89-1295.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_89_1295.cpp, i8* null }]
...
70:                                               ; preds = %80, %69
  %71 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %3, i32* %4)
  %72 = icmp ne i32 %71, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_89_1295.cpp() #0 section ".text.startup" {
