; ModuleID = 'POJ-104-source/89/89-1363.cpp'
source_filename = "POJ-104-source/89/89-1363.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_89_1363.cpp, i8* null }]
...
104:                                              ; preds = %101
  %105 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.3, i64 0, i64 0))
  br label %106
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_89_1363.cpp() #0 section ".text.startup" {
