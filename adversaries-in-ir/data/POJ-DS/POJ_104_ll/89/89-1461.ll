; ModuleID = 'POJ-104-source/89/89-1461.cpp'
source_filename = "POJ-104-source/89/89-1461.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_89_1461.cpp, i8* null }]
...
12:                                               ; preds = %46, %0
  ...
  %23 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %17, i32* %22)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_89_1461.cpp() #0 section ".text.startup" {
