; ModuleID = 'POJ-104-source/89/89-1592.cpp'
source_filename = "POJ-104-source/89/89-1592.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_89_1592.cpp, i8* null }]
...
26:                                               ; preds = %21
  %27 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %12, i32* %13)
  %28 = load i32, i32* %12, align 4
  %29 = sext i32 %28 to i64
  %30 = getelementptr inbounds [10000 x i32], [10000 x i32]* %14, i64 0, i64 %29
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_89_1592.cpp() #0 section ".text.startup" {
