; ModuleID = 'POJ-104-source/89/89-1725.cpp'
source_filename = "POJ-104-source/89/89-1725.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_89_1725.cpp, i8* null }]
...
61:                                               ; preds = %23
  ...
  %80 = sub nsw i32 %79, 1
  call void @_Z5QsortPiii(i32* %77, i32 %78, i32 %80)
  %81 = load i32*, i32** %4, align 8
  %82 = load i32, i32* %8, align 4
  %83 = add nsw i32 %82, 1
  %84 = load i32, i32* %6, align 4
  call void @_Z5QsortPiii(i32* %81, i32 %83, i32 %84)
  br label %85
...
20:                                               ; preds = %15
  %21 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %6, i32* %7)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_89_1725.cpp() #0 section ".text.startup" {
