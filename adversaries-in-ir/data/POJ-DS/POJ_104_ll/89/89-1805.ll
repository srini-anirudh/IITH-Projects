; ModuleID = 'POJ-104-source/89/89-1805.cpp'
source_filename = "POJ-104-source/89/89-1805.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_89_1805.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %11 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %9, i32* %10)
  br label %12
...
26:                                               ; preds = %24
  ...
  %49 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %45, i32* %48)
  br label %12
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_89_1805.cpp() #0 section ".text.startup" {
