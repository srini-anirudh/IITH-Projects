; ModuleID = 'POJ-104-source/89/89-1806.cpp'
source_filename = "POJ-104-source/89/89-1806.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_89_1806.cpp, i8* null }]
...
21:                                               ; preds = %10
  ...
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %22, i32* %23)
...
25:                                               ; preds = %61, %21
  ...
  %48 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %44, i32* %47)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_89_1806.cpp() #0 section ".text.startup" {
