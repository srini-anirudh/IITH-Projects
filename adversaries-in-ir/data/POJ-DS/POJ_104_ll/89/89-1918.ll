; ModuleID = 'POJ-104-source/89/89-1918.cpp'
source_filename = "POJ-104-source/89/89-1918.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_89_1918.cpp, i8* null }]
...
24:                                               ; preds = %34, %23
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %4, i32* %5)
  %26 = icmp ne i32 %25, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_89_1918.cpp() #0 section ".text.startup" {
