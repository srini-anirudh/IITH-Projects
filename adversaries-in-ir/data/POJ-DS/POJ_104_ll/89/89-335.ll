; ModuleID = 'POJ-104-source/89/89-335.cpp'
source_filename = "POJ-104-source/89/89-335.cpp"
...
@a = dso_local global [5000000 x i32] zeroinitializer, align 16
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_89_335.cpp, i8* null }]
...
20:                                               ; preds = %6
  %21 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* @l, i32* @r)
  br label %22
...
31:                                               ; preds = %28
  ...
  %44 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* @l, i32* @r)
  br label %22
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_89_335.cpp() #0 section ".text.startup" {
