; ModuleID = 'POJ-104-source/89/89-486.cpp'
source_filename = "POJ-104-source/89/89-486.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_89_486.cpp, i8* null }]
...
98:                                               ; preds = %95
  %99 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.3, i64 0, i64 0))
  br label %100
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_89_486.cpp() #0 section ".text.startup" {
