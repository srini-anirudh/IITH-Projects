; ModuleID = 'POJ-104-source/89/89-771.cpp'
source_filename = "POJ-104-source/89/89-771.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_89_771.cpp, i8* null }]
...
define dso_local i32 @main(i32 %0, i8** %1) #4 {
  ...
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %16, i32* %18)
  br label %20
...
36:                                               ; preds = %34
  ...
  %47 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %42, i32* %46)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_89_771.cpp() #0 section ".text.startup" {
