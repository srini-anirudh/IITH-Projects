; ModuleID = 'POJ-104-source/9/9-1.cpp'
source_filename = "POJ-104-source/9/9-1.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1.cpp, i8* null }]
...
76:                                               ; preds = %72
  ...
  %80 = getelementptr inbounds [100 x %struct.patient], [100 x %struct.patient]* %6, i64 0, i64 %79
  ...
  %85 = bitcast %struct.patient* %80 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1.cpp() #0 section ".text.startup" {
