; ModuleID = 'POJ-104-source/9/9-1031.cpp'
source_filename = "POJ-104-source/9/9-1031.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1031.cpp, i8* null }]
...
define dso_local void @_Z3runP3illiiPc(%struct.ill* %0, i32 %1, i32 %2, i8* %3) #4 {
...
define dso_local i32 @main() #5 {
  ...
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %8)
...
24:                                               ; preds = %20
  ...
  %26 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %25, i32* %5)
  ...
  call void @_Z3runP3illiiPc(%struct.ill* %28, i32 %29, i32 %30, i8* %31)
  br label %32
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1031.cpp() #0 section ".text.startup" {
