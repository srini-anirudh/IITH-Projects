; ModuleID = 'POJ-104-source/9/9-1051.cpp'
source_filename = "POJ-104-source/9/9-1051.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1051.cpp, i8* null }]
...
20:                                               ; preds = %16
  ...
  %32 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %26, i32* %31)
  br label %33
...
49:                                               ; preds = %41
  %50 = load %struct.v*, %struct.v** %7, align 8
  %51 = load i32, i32* %3, align 4
  %52 = sext i32 %51 to i64
  %53 = getelementptr inbounds %struct.v, %struct.v* %50, i64 %52
  %54 = load i32, i32* %4, align 4
  %55 = sext i32 %54 to i64
  %56 = getelementptr inbounds [100 x %struct.v], [100 x %struct.v]* %8, i64 0, i64 %55
  %57 = bitcast %struct.v* %56 to i8*
  %58 = bitcast %struct.v* %53 to i8*
...
91:                                               ; preds = %78
  ...
  %100 = getelementptr inbounds [100 x %struct.v], [100 x %struct.v]* %8, i64 0, i64 %99
  %101 = load i32, i32* %4, align 4
  %102 = sext i32 %101 to i64
  %103 = getelementptr inbounds [100 x %struct.v], [100 x %struct.v]* %8, i64 0, i64 %102
  %104 = bitcast %struct.v* %103 to i8*
  %105 = bitcast %struct.v* %100 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1051.cpp() #0 section ".text.startup" {
