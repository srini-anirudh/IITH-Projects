; ModuleID = 'POJ-104-source/9/9-108.cpp'
source_filename = "POJ-104-source/9/9-108.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_108.cpp, i8* null }]
...
31:                                               ; preds = %14
  ...
  %39 = bitcast %struct.patient* %34 to i8*
...
70:                                               ; preds = %57
  ...
  %73 = getelementptr inbounds [100 x %struct.patient], [100 x %struct.patient]* %3, i64 0, i64 %72
  %74 = bitcast %struct.patient* %4 to i8*
  ...
  %89 = bitcast %struct.patient* %88 to i8*
  %90 = bitcast %struct.patient* %4 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_108.cpp() #0 section ".text.startup" {
