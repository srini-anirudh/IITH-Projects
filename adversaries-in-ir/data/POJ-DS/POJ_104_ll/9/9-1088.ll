; ModuleID = 'POJ-104-source/9/9-1088.cpp'
source_filename = "POJ-104-source/9/9-1088.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1088.cpp, i8* null }]
...
35:                                               ; preds = %31
  ...
  %38 = getelementptr inbounds [100 x [20 x i8]], [100 x [20 x i8]]* %10, i64 0, i64 %37
  %39 = getelementptr inbounds [20 x i8], [20 x i8]* %38, i64 0, i64 0
  %40 = call i32 @atoi(i8* %39) #6
...
121:                                              ; preds = %117
  ...
  %127 = getelementptr inbounds [100 x [20 x i8]], [100 x [20 x i8]]* %9, i64 0, i64 %126
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1088.cpp() #0 section ".text.startup" {
