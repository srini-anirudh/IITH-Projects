; ModuleID = 'POJ-104-source/9/9-1142.cpp'
source_filename = "POJ-104-source/9/9-1142.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1142.cpp, i8* null }]
...
39:                                               ; preds = %32
  ...
  %42 = getelementptr inbounds [1000 x %struct.bingren], [1000 x %struct.bingren]* %3, i64 0, i64 %41
  %43 = load i32, i32* %6, align 4
  %44 = sext i32 %43 to i64
  %45 = getelementptr inbounds [1000 x %struct.bingren], [1000 x %struct.bingren]* %5, i64 0, i64 %44
  %46 = bitcast %struct.bingren* %45 to i8*
  %47 = bitcast %struct.bingren* %42 to i8*
...
79:                                               ; preds = %66
  ...
  %88 = getelementptr inbounds [1000 x %struct.bingren], [1000 x %struct.bingren]* %5, i64 0, i64 %87
  ...
  %94 = bitcast %struct.bingren* %88 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1142.cpp() #0 section ".text.startup" {
