; ModuleID = 'POJ-104-source/9/9-1146.cpp'
source_filename = "POJ-104-source/9/9-1146.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1146.cpp, i8* null }]
...
26:                                               ; preds = %15
  %27 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %2)
  store i32 0, i32* %3, align 4
  br label %28
...
32:                                               ; preds = %28
  ...
  %39 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), [100 x i8]* %35, i32* %38)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1146.cpp() #0 section ".text.startup" {
