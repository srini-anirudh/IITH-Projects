; ModuleID = 'POJ-104-source/9/9-116.cpp'
source_filename = "POJ-104-source/9/9-116.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_116.cpp, i8* null }]
...
81:                                               ; preds = %74
  ...
  %90 = getelementptr inbounds [100 x %struct.patient], [100 x %struct.patient]* %8, i64 0, i64 %89
...
94:                                               ; preds = %81
  ...
  %103 = getelementptr inbounds [100 x %struct.patient], [100 x %struct.patient]* %8, i64 0, i64 %102
...
143:                                              ; preds = %139
  ...
  %146 = getelementptr inbounds [100 x %struct.patient], [100 x %struct.patient]* %7, i64 0, i64 %145
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_116.cpp() #0 section ".text.startup" {
