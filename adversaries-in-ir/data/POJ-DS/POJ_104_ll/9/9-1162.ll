; ModuleID = 'POJ-104-source/9/9-1162.cpp'
source_filename = "POJ-104-source/9/9-1162.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1162.cpp, i8* null }]
...
26:                                               ; preds = %22
  %27 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), [100 x i8]* %15, i32* %12)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1162.cpp() #0 section ".text.startup" {
