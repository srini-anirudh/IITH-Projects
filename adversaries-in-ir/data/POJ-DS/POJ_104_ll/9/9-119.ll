; ModuleID = 'POJ-104-source/9/9-119.cpp'
source_filename = "POJ-104-source/9/9-119.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_119.cpp, i8* null }]
...
17:                                               ; preds = %13
  ...
  %20 = getelementptr inbounds [100 x %struct.patient], [100 x %struct.patient]* %8, i64 0, i64 %19
  ...
  %25 = getelementptr inbounds [100 x %struct.patient], [100 x %struct.patient]* %8, i64 0, i64 %24
...
43:                                               ; preds = %36
  ...
  %50 = getelementptr inbounds [100 x %struct.patient], [100 x %struct.patient]* %9, i64 0, i64 %49
...
53:                                               ; preds = %36
  ...
  %56 = getelementptr inbounds [100 x %struct.patient], [100 x %struct.patient]* %8, i64 0, i64 %55
  ...
  %62 = bitcast %struct.patient* %56 to i8*
...
81:                                               ; preds = %75
  ...
  %90 = getelementptr inbounds [100 x %struct.patient], [100 x %struct.patient]* %9, i64 0, i64 %89
...
94:                                               ; preds = %81
  ...
  %97 = getelementptr inbounds [100 x %struct.patient], [100 x %struct.patient]* %9, i64 0, i64 %96
  %98 = bitcast %struct.patient* %11 to i8*
  ...
  %106 = getelementptr inbounds [100 x %struct.patient], [100 x %struct.patient]* %9, i64 0, i64 %105
  ...
  %112 = getelementptr inbounds [100 x %struct.patient], [100 x %struct.patient]* %9, i64 0, i64 %111
  %113 = bitcast %struct.patient* %112 to i8*
  %114 = bitcast %struct.patient* %11 to i8*
...
128:                                              ; preds = %124
  ...
  %131 = getelementptr inbounds [100 x %struct.patient], [100 x %struct.patient]* %9, i64 0, i64 %130
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_119.cpp() #0 section ".text.startup" {
