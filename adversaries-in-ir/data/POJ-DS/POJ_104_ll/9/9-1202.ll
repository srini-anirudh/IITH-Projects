; ModuleID = 'POJ-104-source/9/9-1202.cpp'
source_filename = "POJ-104-source/9/9-1202.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1202.cpp, i8* null }]
...
46:                                               ; preds = %38
  ...
  %51 = call i32 @strcmp(i8* %50, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0)) #6
...
135:                                              ; preds = %131
  ...
  %145 = call i32 @strcmp(i8* %139, i8* %144) #6
...
213:                                              ; preds = %209
  ...
  %223 = call i32 @strcmp(i8* %217, i8* %222) #6
...
225:                                              ; preds = %213
  ...
  %241 = call i8* @strcpy(i8* %235, i8* %240) #3
  ...
  %254 = call i8* @strcpy(i8* %249, i8* %253) #3
  ...
  %271 = call i8* @strcpy(i8* %269, i8* %270) #3
  br label %272
...
321:                                              ; preds = %313
  ...
  %326 = call i32 @strcmp(i8* %325, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0)) #6
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1202.cpp() #0 section ".text.startup" {
