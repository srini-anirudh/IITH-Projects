; ModuleID = 'POJ-104-source/9/9-1204.cpp'
source_filename = "POJ-104-source/9/9-1204.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1204.cpp, i8* null }]
...
20:                                               ; preds = %16
  ...
  %26 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), [11 x i8]* %25)
...
81:                                               ; preds = %73
  ...
  %91 = bitcast %struct.patient* %85 to i8*
...
111:                                              ; preds = %103
  %112 = load %struct.patient*, %struct.patient** %2, align 8
  ...
  %121 = bitcast %struct.patient* %115 to i8*
...
155:                                              ; preds = %140
  ...
  %171 = getelementptr inbounds %struct.patient, %struct.patient* %167, i64 %170
  %172 = bitcast %struct.patient* %171 to i8*
  %173 = bitcast %struct.patient* %166 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1204.cpp() #0 section ".text.startup" {
