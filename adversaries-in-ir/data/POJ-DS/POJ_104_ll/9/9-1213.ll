; ModuleID = 'POJ-104-source/9/9-1213.cpp'
source_filename = "POJ-104-source/9/9-1213.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1213.cpp, i8* null }]
...
42:                                               ; preds = %35
  ...
  %51 = bitcast %struct.patient* %50 to i8*
  %52 = bitcast %struct.patient* %47 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1213.cpp() #0 section ".text.startup" {
