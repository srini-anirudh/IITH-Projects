; ModuleID = 'POJ-104-source/9/9-1224.cpp'
source_filename = "POJ-104-source/9/9-1224.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1224.cpp, i8* null }]
...
20:                                               ; preds = %16
  ...
  %32 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i8* %26, i32* %31)
  br label %33
...
49:                                               ; preds = %41
  %50 = load %struct.br*, %struct.br** %7, align 8
  %51 = load i32, i32* %2, align 4
  %52 = sext i32 %51 to i64
  %53 = getelementptr inbounds %struct.br, %struct.br* %50, i64 %52
  %54 = load i32, i32* %4, align 4
  %55 = sext i32 %54 to i64
  %56 = getelementptr inbounds [100 x %struct.br], [100 x %struct.br]* %8, i64 0, i64 %55
  %57 = bitcast %struct.br* %56 to i8*
  %58 = bitcast %struct.br* %53 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1224.cpp() #0 section ".text.startup" {
