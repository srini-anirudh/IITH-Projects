; ModuleID = 'POJ-104-source/9/9-1226.cpp'
source_filename = "POJ-104-source/9/9-1226.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1226.cpp, i8* null }]
...
16:                                               ; preds = %12
  ...
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i8* %17, i32* %5)
...
21:                                               ; preds = %16
  ...
  %28 = call i8* @strcat(i8* %26, i8* %27) #3
...
41:                                               ; preds = %16
  ...
  %48 = call i8* @strcat(i8* %46, i8* %47) #3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1226.cpp() #0 section ".text.startup" {
