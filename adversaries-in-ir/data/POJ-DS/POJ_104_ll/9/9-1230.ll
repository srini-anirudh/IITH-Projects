; ModuleID = 'POJ-104-source/9/9-1230.cpp'
source_filename = "POJ-104-source/9/9-1230.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1230.cpp, i8* null }]
...
32:                                               ; preds = %14
  ...
  %35 = getelementptr inbounds [100 x %struct.patients], [100 x %struct.patients]* %3, i64 0, i64 %34
  %36 = load i32, i32* %8, align 4
  %37 = sext i32 %36 to i64
  %38 = getelementptr inbounds [100 x %struct.patients], [100 x %struct.patients]* %4, i64 0, i64 %37
  %39 = bitcast %struct.patients* %38 to i8*
  %40 = bitcast %struct.patients* %35 to i8*
...
73:                                               ; preds = %60
  ...
  %82 = getelementptr inbounds [100 x %struct.patients], [100 x %struct.patients]* %4, i64 0, i64 %81
  %83 = load i32, i32* %6, align 4
  %84 = sext i32 %83 to i64
  %85 = getelementptr inbounds [100 x %struct.patients], [100 x %struct.patients]* %4, i64 0, i64 %84
  %86 = bitcast %struct.patients* %85 to i8*
  %87 = bitcast %struct.patients* %82 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1230.cpp() #0 section ".text.startup" {
