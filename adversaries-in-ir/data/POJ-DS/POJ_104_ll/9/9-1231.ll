; ModuleID = 'POJ-104-source/9/9-1231.cpp'
source_filename = "POJ-104-source/9/9-1231.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1231.cpp, i8* null }]
...
12:                                               ; preds = %8
  ...
  %21 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), [11 x i8]* %16, i32* %20)
  br label %22
...
74:                                               ; preds = %61, %46
  ...
  %88 = bitcast %struct.patient* %83 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1231.cpp() #0 section ".text.startup" {
