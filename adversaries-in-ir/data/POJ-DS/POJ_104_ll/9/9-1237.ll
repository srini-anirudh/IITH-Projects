; ModuleID = 'POJ-104-source/9/9-1237.cpp'
source_filename = "POJ-104-source/9/9-1237.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1237.cpp, i8* null }]
...
16:                                               ; preds = %12
  ...
  %31 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %26, i32* %30)
  br label %32
...
47:                                               ; preds = %40
  ...
  %50 = getelementptr inbounds [100 x %struct.patients], [100 x %struct.patients]* %7, i64 0, i64 %49
  %51 = load i32, i32* %6, align 4
  %52 = sext i32 %51 to i64
  %53 = getelementptr inbounds [100 x %struct.patients], [100 x %struct.patients]* %9, i64 0, i64 %52
  %54 = bitcast %struct.patients* %53 to i8*
  %55 = bitcast %struct.patients* %50 to i8*
...
58:                                               ; preds = %40
  ...
  %61 = getelementptr inbounds [100 x %struct.patients], [100 x %struct.patients]* %7, i64 0, i64 %60
  %62 = load i32, i32* %5, align 4
  %63 = sext i32 %62 to i64
  %64 = getelementptr inbounds [100 x %struct.patients], [100 x %struct.patients]* %8, i64 0, i64 %63
  %65 = bitcast %struct.patients* %64 to i8*
  %66 = bitcast %struct.patients* %61 to i8*
...
98:                                               ; preds = %85
  ...
  %107 = getelementptr inbounds [100 x %struct.patients], [100 x %struct.patients]* %9, i64 0, i64 %106
  ...
  %112 = bitcast %struct.patients* %107 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1237.cpp() #0 section ".text.startup" {
