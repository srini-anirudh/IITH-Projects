; ModuleID = 'POJ-104-source/9/9-1241.cpp'
source_filename = "POJ-104-source/9/9-1241.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1241.cpp, i8* null }]
...
32:                                               ; preds = %25
  ...
  %38 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %35, i32* %37)
  %39 = load %struct.guahao*, %struct.guahao** %6, align 8
  %40 = load %struct.guahao*, %struct.guahao** %8, align 8
  %41 = bitcast %struct.guahao* %40 to i8*
  %42 = bitcast %struct.guahao* %39 to i8*
...
81:                                               ; preds = %72
  ...
  %86 = getelementptr inbounds %struct.guahao, %struct.guahao* %85, i64 1
  %87 = load %struct.guahao*, %struct.guahao** %7, align 8
  %88 = bitcast %struct.guahao* %87 to i8*
  %89 = bitcast %struct.guahao* %86 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1241.cpp() #0 section ".text.startup" {
