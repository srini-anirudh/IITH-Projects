; ModuleID = 'POJ-104-source/9/9-1269.cpp'
source_filename = "POJ-104-source/9/9-1269.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1269.cpp, i8* null }]
...
16:                                               ; preds = %12
  ...
  %26 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %21, i32* %25)
  br label %27
...
42:                                               ; preds = %35
  ...
  %45 = getelementptr inbounds [100 x %struct.xinxi], [100 x %struct.xinxi]* %3, i64 0, i64 %44
  %46 = load i32, i32* %9, align 4
  %47 = sext i32 %46 to i64
  %48 = getelementptr inbounds [100 x %struct.xinxi], [100 x %struct.xinxi]* %4, i64 0, i64 %47
  %49 = bitcast %struct.xinxi* %48 to i8*
  %50 = bitcast %struct.xinxi* %45 to i8*
...
82:                                               ; preds = %69
  ...
  %91 = getelementptr inbounds [100 x %struct.xinxi], [100 x %struct.xinxi]* %4, i64 0, i64 %90
  %92 = load i32, i32* %7, align 4
  %93 = add nsw i32 %92, 1
  %94 = sext i32 %93 to i64
  %95 = getelementptr inbounds [100 x %struct.xinxi], [100 x %struct.xinxi]* %4, i64 0, i64 %94
  %96 = bitcast %struct.xinxi* %95 to i8*
  %97 = bitcast %struct.xinxi* %91 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1269.cpp() #0 section ".text.startup" {
