; ModuleID = 'POJ-104-source/9/9-127.cpp'
source_filename = "POJ-104-source/9/9-127.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_127.cpp, i8* null }]
...
define dso_local void @_Z11bubble_sortPiPA10_ci(i32* %0, [10 x i8]* %1, i32 %2) #4 {
...
20:                                               ; preds = %16
  ...
  %28 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i8* %24, i32* %27)
  br label %29
...
81:                                               ; preds = %33
  ...
  call void @_Z11bubble_sortPiPA10_ci(i32* %82, [10 x i8]* %83, i32 %84)
  store i32 0, i32* %6, align 4
  br label %85
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_127.cpp() #0 section ".text.startup" {
