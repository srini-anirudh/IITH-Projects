; ModuleID = 'POJ-104-source/9/9-1270.cpp'
source_filename = "POJ-104-source/9/9-1270.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1270.cpp, i8* null }]
...
define dso_local void @_Z5paixuP7patienti(%struct.patient* %0, i32 %1) #4 {
...
14:                                               ; preds = %10
  ...
  %18 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %16, i32* %17)
...
42:                                               ; preds = %10
  ...
  call void @_Z5paixuP7patienti(%struct.patient* %43, i32 %44)
  store i32 0, i32* %6, align 4
  br label %45
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1270.cpp() #0 section ".text.startup" {
