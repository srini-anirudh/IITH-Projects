; ModuleID = 'POJ-104-source/9/9-1280.cpp'
source_filename = "POJ-104-source/9/9-1280.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1280.cpp, i8* null }]
...
18:                                               ; preds = %13
  ...
  %33 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %28, i32* %32)
...
241:                                              ; preds = %228
  ...
  %270 = call i8* @strcpy(i8* %263, i8* %269) #3
  ...
  %304 = call i8* @strcpy(i8* %302, i8* %303) #3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1280.cpp() #0 section ".text.startup" {
