; ModuleID = 'POJ-104-source/9/9-1308.cpp'
source_filename = "POJ-104-source/9/9-1308.cpp"
...
@below60 = dso_local global [100 x i32] zeroinitializer, align 16
@m = dso_local global i32 0, align 4
@k = dso_local global i32 0, align 4
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [5 x i8] c"%s%d\00", align 1
@.str.2 = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1308.cpp, i8* null }]
...
28:                                               ; preds = %10
  ...
  call void @_Z6chooseP7patienti(%struct.patient* getelementptr inbounds ([100 x %struct.patient], [100 x %struct.patient]* @pat, i64 0, i64 0), i32 %29)
...
; Function Attrs: noinline uwtable
define dso_local void @_Z6chooseP7patienti(%struct.patient* %0, i32 %1) #0 {
...
34:                                               ; preds = %6
  %35 = load i32, i32* @m, align 4
  call void @_Z5paixuPii(i32* getelementptr inbounds ([100 x i32], [100 x i32]* @over60, i64 0, i64 0), i32 %35)
  ret void
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1308.cpp() #0 section ".text.startup" {
