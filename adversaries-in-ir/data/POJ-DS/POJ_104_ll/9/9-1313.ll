; ModuleID = 'POJ-104-source/9/9-1313.cpp'
source_filename = "POJ-104-source/9/9-1313.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1313.cpp, i8* null }]
...
61:                                               ; preds = %48
  ...
  %70 = getelementptr inbounds [100 x %struct.s], [100 x %struct.s]* %5, i64 0, i64 %69
  %71 = load i32, i32* %4, align 4
  %72 = sext i32 %71 to i64
  %73 = getelementptr inbounds [100 x %struct.s], [100 x %struct.s]* %5, i64 0, i64 %72
  %74 = bitcast %struct.s* %73 to i8*
  %75 = bitcast %struct.s* %70 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1313.cpp() #0 section ".text.startup" {
