; ModuleID = 'POJ-104-source/9/9-1326.cpp'
source_filename = "POJ-104-source/9/9-1326.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1326.cpp, i8* null }]
...
define dso_local void @_Z4sorti(i32 %0) #4 {
...
29:                                               ; preds = %20
  ...
  %33 = getelementptr inbounds %struct.a60, %struct.a60* %32, i64 1
  %34 = load %struct.a60*, %struct.a60** %4, align 8
  %35 = bitcast %struct.a60* %34 to i8*
  %36 = bitcast %struct.a60* %33 to i8*
...
15:                                               ; preds = %11
  ...
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %16, i32* %6)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1326.cpp() #0 section ".text.startup" {
