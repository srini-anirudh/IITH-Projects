; ModuleID = 'POJ-104-source/9/9-1335.cpp'
source_filename = "POJ-104-source/9/9-1335.cpp"
...
@P = dso_local global [100 x %struct.pat] zeroinitializer, align 16
@s = dso_local global %struct.pat zeroinitializer, align 4
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [6 x i8] c"%s %d\00", align 1
@.str.2 = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1335.cpp, i8* null }]
...
91:                                               ; preds = %87
  ...
  %98 = call i32 @strcmp(i8* %96, i8* %97) #7
  %99 = icmp eq i32 %98, 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1335.cpp() #0 section ".text.startup" {
