; ModuleID = 'POJ-104-source/9/9-1336.cpp'
source_filename = "POJ-104-source/9/9-1336.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1336.cpp, i8* null }]
...
19:                                               ; preds = %12
  ...
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), [10 x i8]* %21, i32* %23)
  br label %25
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1336.cpp() #0 section ".text.startup" {
