; ModuleID = 'POJ-104-source/9/9-1341.cpp'
source_filename = "POJ-104-source/9/9-1341.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1341.cpp, i8* null }]
...
14:                                               ; preds = %9
  ...
  %23 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), [20 x i8]* %18, i32* %22)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1341.cpp() #0 section ".text.startup" {
