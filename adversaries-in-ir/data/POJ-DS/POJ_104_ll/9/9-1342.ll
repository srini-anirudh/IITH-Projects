; ModuleID = 'POJ-104-source/9/9-1342.cpp'
source_filename = "POJ-104-source/9/9-1342.cpp"
...
@bing = internal global [100 x %struct.anon] zeroinitializer, align 16
@.str.2 = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1342.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1342.cpp() #0 section ".text.startup" {
