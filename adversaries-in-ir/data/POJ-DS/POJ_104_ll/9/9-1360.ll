; ModuleID = 'POJ-104-source/9/9-1360.cpp'
source_filename = "POJ-104-source/9/9-1360.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1360.cpp, i8* null }]
...
26:                                               ; preds = %22
  ...
  %38 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %32, i32* %37)
  br label %39
...
56:                                               ; preds = %48
  ...
  %63 = bitcast %struct.patient* %60 to i8*
...
85:                                               ; preds = %77
  ...
  %90 = load %struct.patient*, %struct.patient** %8, align 8
  %91 = bitcast %struct.patient* %90 to i8*
  %92 = bitcast %struct.patient* %89 to i8*
...
126:                                              ; preds = %111
  ...
  %137 = getelementptr inbounds %struct.patient, %struct.patient* %134, i64 %136
  %138 = load %struct.patient*, %struct.patient** %10, align 8
  %139 = load i32, i32* %4, align 4
  %140 = add nsw i32 %139, 1
  %141 = sext i32 %140 to i64
  %142 = getelementptr inbounds %struct.patient, %struct.patient* %138, i64 %141
  %143 = bitcast %struct.patient* %142 to i8*
  %144 = bitcast %struct.patient* %137 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1360.cpp() #0 section ".text.startup" {
