; ModuleID = 'POJ-104-source/9/9-1362.cpp'
source_filename = "POJ-104-source/9/9-1362.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1362.cpp, i8* null }]
...
define dso_local void @_Z4swapP7patientS0_(%struct.patient* %0, %struct.patient* %1) #4 {
  ...
  %12 = bitcast %struct.patient* %9 to i8*
...
68:                                               ; preds = %55
  ...
  call void @_Z4swapP7patientS0_(%struct.patient* %71, %struct.patient* %75)
  br label %76
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1362.cpp() #0 section ".text.startup" {
