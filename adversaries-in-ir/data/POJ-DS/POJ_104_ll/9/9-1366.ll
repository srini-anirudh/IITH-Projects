; ModuleID = 'POJ-104-source/9/9-1366.cpp'
source_filename = "POJ-104-source/9/9-1366.cpp"
...
@e = dso_local global %struct.Patient zeroinitializer, align 4
@b = dso_local global [100 x %struct.Patient] zeroinitializer, align 16
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [6 x i8] c"%s %d\00", align 1
@.str.2 = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1366.cpp, i8* null }]
...
50:                                               ; preds = %37
  ...
  %58 = getelementptr inbounds [100 x %struct.Patient], [100 x %struct.Patient]* @a, i64 0, i64 %57
  ...
  %63 = bitcast %struct.Patient* %58 to i8*
...
89:                                               ; preds = %82
  ...
  %92 = getelementptr inbounds [100 x %struct.Patient], [100 x %struct.Patient]* @a, i64 0, i64 %91
  %93 = load i32, i32* %5, align 4
  %94 = sext i32 %93 to i64
  %95 = getelementptr inbounds [100 x %struct.Patient], [100 x %struct.Patient]* @b, i64 0, i64 %94
...
130:                                              ; preds = %117
  ...
  %142 = bitcast %struct.Patient* %141 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1366.cpp() #0 section ".text.startup" {
