; ModuleID = 'POJ-104-source/9/9-1381.cpp'
source_filename = "POJ-104-source/9/9-1381.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1381.cpp, i8* null }]
...
39:                                               ; preds = %32
  ...
  %46 = getelementptr inbounds [100 x %struct.patient], [100 x %struct.patient]* %3, i64 0, i64 %45
  %47 = bitcast %struct.patient* %46 to i8*
  %48 = bitcast %struct.patient* %42 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1381.cpp() #0 section ".text.startup" {
