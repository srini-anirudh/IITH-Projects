; ModuleID = 'POJ-104-source/9/9-1384.cpp'
source_filename = "POJ-104-source/9/9-1384.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1384.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %8 = alloca [100 x %struct.Info], align 16
...
14:                                               ; preds = %10
  ...
  %17 = getelementptr inbounds [100 x %struct.Info], [100 x %struct.Info]* %7, i64 0, i64 %16
  ...
  %22 = getelementptr inbounds [100 x %struct.Info], [100 x %struct.Info]* %7, i64 0, i64 %21
  ...
  %27 = getelementptr inbounds [100 x %struct.Info], [100 x %struct.Info]* %7, i64 0, i64 %26
...
31:                                               ; preds = %14
  ...
  %34 = getelementptr inbounds [100 x %struct.Info], [100 x %struct.Info]* %7, i64 0, i64 %33
  %35 = load i32, i32* %5, align 4
  %36 = sext i32 %35 to i64
  %37 = getelementptr inbounds [100 x %struct.Info], [100 x %struct.Info]* %8, i64 0, i64 %36
  %38 = bitcast %struct.Info* %37 to i8*
  %39 = bitcast %struct.Info* %34 to i8*
...
59:                                               ; preds = %53
  ...
  %63 = getelementptr inbounds [100 x %struct.Info], [100 x %struct.Info]* %8, i64 0, i64 %62
  %64 = getelementptr inbounds %struct.Info, %struct.Info* %63, i32 0, i32 1
  %65 = load i32, i32* %64, align 4
  %66 = load i32, i32* %4, align 4
  %67 = sext i32 %66 to i64
  %68 = getelementptr inbounds [100 x %struct.Info], [100 x %struct.Info]* %8, i64 0, i64 %67
...
72:                                               ; preds = %59
  ...
  %76 = getelementptr inbounds [100 x %struct.Info], [100 x %struct.Info]* %8, i64 0, i64 %75
  %77 = bitcast %struct.Info* %6 to i8*
  %78 = bitcast %struct.Info* %76 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %77, i8* align 16 %78, i64 16, i1 false)
  %79 = load i32, i32* %4, align 4
  %80 = sext i32 %79 to i64
  %81 = getelementptr inbounds [100 x %struct.Info], [100 x %struct.Info]* %8, i64 0, i64 %80
  %82 = load i32, i32* %4, align 4
  %83 = sub nsw i32 %82, 1
  %84 = sext i32 %83 to i64
  %85 = getelementptr inbounds [100 x %struct.Info], [100 x %struct.Info]* %8, i64 0, i64 %84
  %86 = bitcast %struct.Info* %85 to i8*
  %87 = bitcast %struct.Info* %81 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %86, i8* align 16 %87, i64 16, i1 false)
  %88 = load i32, i32* %4, align 4
  %89 = sext i32 %88 to i64
  %90 = getelementptr inbounds [100 x %struct.Info], [100 x %struct.Info]* %8, i64 0, i64 %89
  %91 = bitcast %struct.Info* %90 to i8*
  %92 = bitcast %struct.Info* %6 to i8*
...
106:                                              ; preds = %102
  ...
  %109 = getelementptr inbounds [100 x %struct.Info], [100 x %struct.Info]* %8, i64 0, i64 %108
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1384.cpp() #0 section ".text.startup" {
