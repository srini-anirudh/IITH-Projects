; ModuleID = 'POJ-104-source/9/9-1388.cpp'
source_filename = "POJ-104-source/9/9-1388.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1388.cpp, i8* null }]
...
69:                                               ; preds = %62
  ...
  %75 = getelementptr inbounds [100 x %struct.Patient], [100 x %struct.Patient]* %3, i64 0, i64 %74
...
109:                                              ; preds = %96
  ...
  %124 = bitcast %struct.Patient* %118 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1388.cpp() #0 section ".text.startup" {
