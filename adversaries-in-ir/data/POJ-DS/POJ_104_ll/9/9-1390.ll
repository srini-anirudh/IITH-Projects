; ModuleID = 'POJ-104-source/9/9-1390.cpp'
source_filename = "POJ-104-source/9/9-1390.cpp"
...
@ln = dso_local global %struct.kb zeroinitializer, align 4
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [5 x i8] c"%s%d\00", align 1
@.str.2 = private unnamed_addr constant [10 x i8] c"000000000\00", align 1
@.str.3 = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1390.cpp, i8* null }]
...
11:                                               ; preds = %7
  ...
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), [10 x i8]* %15, i32* %19)
  br label %21
...
36:                                               ; preds = %29
  ...
  %64 = call i8* @strcpy(i8* %63, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.2, i64 0, i64 0)) #3
  br label %65
...
94:                                               ; preds = %81
  ...
  %102 = getelementptr inbounds [100 x %struct.kb], [100 x %struct.kb]* @lnr, i64 0, i64 %101
  %103 = load i32, i32* %5, align 4
  %104 = add nsw i32 %103, 1
  %105 = sext i32 %104 to i64
  %106 = getelementptr inbounds [100 x %struct.kb], [100 x %struct.kb]* @lnr, i64 0, i64 %105
  %107 = bitcast %struct.kb* %106 to i8*
  %108 = bitcast %struct.kb* %102 to i8*
...
141:                                              ; preds = %137
  ...
  %147 = call i32 @strcmp(i8* %146, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.2, i64 0, i64 0)) #7
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1390.cpp() #0 section ".text.startup" {
