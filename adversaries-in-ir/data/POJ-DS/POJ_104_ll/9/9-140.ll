; ModuleID = 'POJ-104-source/9/9-140.cpp'
source_filename = "POJ-104-source/9/9-140.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_140.cpp, i8* null }]
...
18:                                               ; preds = %14
  ...
  %28 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %23, i32* %27)
...
110:                                              ; preds = %97
  ...
  %119 = getelementptr inbounds [100 x %struct.ID], [100 x %struct.ID]* %2, i64 0, i64 %118
  %120 = load i32, i32* %7, align 4
  %121 = add nsw i32 %120, 1
  %122 = sext i32 %121 to i64
  %123 = getelementptr inbounds [100 x %struct.ID], [100 x %struct.ID]* %2, i64 0, i64 %122
  %124 = bitcast %struct.ID* %123 to i8*
  %125 = bitcast %struct.ID* %119 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_140.cpp() #0 section ".text.startup" {
