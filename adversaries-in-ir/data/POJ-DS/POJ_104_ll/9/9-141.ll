; ModuleID = 'POJ-104-source/9/9-141.cpp'
source_filename = "POJ-104-source/9/9-141.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_141.cpp, i8* null }]
...
11:                                               ; preds = %7
  ...
  %20 = getelementptr inbounds [100 x %struct.patient], [100 x %struct.patient]* @p, i64 0, i64 %19
  ...
  %25 = getelementptr inbounds [100 x %struct.patient], [100 x %struct.patient]* @p, i64 0, i64 %24
...
29:                                               ; preds = %11
  ...
  %35 = getelementptr inbounds [100 x %struct.patient], [100 x %struct.patient]* @old, i64 0, i64 %34
  %36 = bitcast %struct.patient* %35 to i8*
  %37 = bitcast %struct.patient* %32 to i8*
...
56:                                               ; preds = %50
  ...
  %65 = getelementptr inbounds [100 x %struct.patient], [100 x %struct.patient]* @old, i64 0, i64 %64
...
69:                                               ; preds = %56
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 getelementptr inbounds (%struct.patient, %struct.patient* @temp, i32 0, i32 0, i32 0), i8* align 16 %73, i64 16, i1 false)
  %74 = load i32, i32* %3, align 4
  %75 = add nsw i32 %74, 1
  %76 = sext i32 %75 to i64
  %77 = getelementptr inbounds [100 x %struct.patient], [100 x %struct.patient]* @old, i64 0, i64 %76
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %87, i8* align 4 getelementptr inbounds (%struct.patient, %struct.patient* @temp, i32 0, i32 0, i32 0), i64 16, i1 false)
  br label %88
...
101:                                              ; preds = %97
  ...
  %104 = getelementptr inbounds [100 x %struct.patient], [100 x %struct.patient]* @old, i64 0, i64 %103
...
116:                                              ; preds = %112
  ...
  %119 = getelementptr inbounds [100 x %struct.patient], [100 x %struct.patient]* @p, i64 0, i64 %118
...
123:                                              ; preds = %116
  ...
  %126 = getelementptr inbounds [100 x %struct.patient], [100 x %struct.patient]* @p, i64 0, i64 %125
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_141.cpp() #0 section ".text.startup" {
