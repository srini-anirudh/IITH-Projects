; ModuleID = 'POJ-104-source/9/9-1447.cpp'
source_filename = "POJ-104-source/9/9-1447.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1447.cpp, i8* null }]
...
47:                                               ; preds = %40
  ...
  %50 = getelementptr inbounds [100 x %struct.people], [100 x %struct.people]* %2, i64 0, i64 %49
  %51 = load i32, i32* %8, align 4
  %52 = sext i32 %51 to i64
  %53 = getelementptr inbounds [100 x %struct.people], [100 x %struct.people]* %3, i64 0, i64 %52
  %54 = bitcast %struct.people* %53 to i8*
  %55 = bitcast %struct.people* %50 to i8*
...
65:                                               ; preds = %58
  ...
  %71 = getelementptr inbounds [100 x %struct.people], [100 x %struct.people]* %4, i64 0, i64 %70
  %72 = bitcast %struct.people* %71 to i8*
  %73 = bitcast %struct.people* %68 to i8*
...
106:                                              ; preds = %93
  ...
  %115 = getelementptr inbounds [100 x %struct.people], [100 x %struct.people]* %3, i64 0, i64 %114
  %116 = load i32, i32* %7, align 4
  %117 = add nsw i32 %116, 1
  %118 = sext i32 %117 to i64
  %119 = getelementptr inbounds [100 x %struct.people], [100 x %struct.people]* %3, i64 0, i64 %118
  %120 = bitcast %struct.people* %119 to i8*
  %121 = bitcast %struct.people* %115 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1447.cpp() #0 section ".text.startup" {
