; ModuleID = 'POJ-104-source/9/9-147.cpp'
source_filename = "POJ-104-source/9/9-147.cpp"
...
@t = dso_local global %struct.pat zeroinitializer, align 4
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [6 x i8] c"%s %d\00", align 1
@.str.2 = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_147.cpp, i8* null }]
...
81:                                               ; preds = %68
  ...
  %89 = getelementptr inbounds [100 x %struct.pat], [100 x %struct.pat]* @str, i64 0, i64 %88
  %90 = load i32, i32* %4, align 4
  %91 = sext i32 %90 to i64
  %92 = getelementptr inbounds [100 x %struct.pat], [100 x %struct.pat]* @str, i64 0, i64 %91
  %93 = bitcast %struct.pat* %92 to i8*
  %94 = bitcast %struct.pat* %89 to i8*
...
120:                                              ; preds = %113
  ...
  %125 = getelementptr inbounds [100 x %struct.pat], [100 x %struct.pat]* @pat, i64 0, i64 %124
  %126 = load i32, i32* %5, align 4
  %127 = sext i32 %126 to i64
  %128 = getelementptr inbounds [100 x %struct.pat], [100 x %struct.pat]* @str, i64 0, i64 %127
  %129 = bitcast %struct.pat* %128 to i8*
  %130 = bitcast %struct.pat* %125 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_147.cpp() #0 section ".text.startup" {
