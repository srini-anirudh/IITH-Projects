; ModuleID = 'POJ-104-source/9/9-1511.cpp'
source_filename = "POJ-104-source/9/9-1511.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1511.cpp, i8* null }]
...
19:                                               ; preds = %15
  ...
  %26 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), [10 x i8]* %22, i32* %25)
  br label %27
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1511.cpp() #0 section ".text.startup" {
