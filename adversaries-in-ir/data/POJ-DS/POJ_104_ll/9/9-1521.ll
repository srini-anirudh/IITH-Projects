; ModuleID = 'POJ-104-source/9/9-1521.cpp'
source_filename = "POJ-104-source/9/9-1521.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1521.cpp, i8* null }]
...
55:                                               ; preds = %42
  ...
  %64 = getelementptr inbounds [101 x %struct.patient], [101 x %struct.patient]* @p, i64 0, i64 %63
  ...
  %70 = bitcast %struct.patient* %64 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1521.cpp() #0 section ".text.startup" {
