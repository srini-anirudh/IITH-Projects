; ModuleID = 'POJ-104-source/9/9-1522.cpp'
source_filename = "POJ-104-source/9/9-1522.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1522.cpp, i8* null }]
...
29:                                               ; preds = %6
  ...
  call void @qsort(i8* %31, i64 %33, i64 20, i32 (i8*, i8*)* @_Z3cmpPKvS0_)
  store i32 0, i32* %2, align 4
  br label %34
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1522.cpp() #0 section ".text.startup" {
