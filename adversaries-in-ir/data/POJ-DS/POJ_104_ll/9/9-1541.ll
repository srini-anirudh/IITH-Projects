; ModuleID = 'POJ-104-source/9/9-1541.cpp'
source_filename = "POJ-104-source/9/9-1541.cpp"
...
@b = dso_local global %struct.node zeroinitializer, align 4
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [6 x i8] c"%s %d\00", align 1
@.str.2 = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1541.cpp, i8* null }]
...
10:                                               ; preds = %6
  ...
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), [100 x i8]* %14, i32* %18)
...
40:                                               ; preds = %36
  ...
  %43 = call i32 @_Z5checkii(i32 %41, i32 %42)
  %44 = icmp eq i32 %43, 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1541.cpp() #0 section ".text.startup" {
