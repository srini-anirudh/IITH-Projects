; ModuleID = 'POJ-104-source/9/9-1550.cpp'
source_filename = "POJ-104-source/9/9-1550.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1550.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), [20 x i8]* %19, i32* %23)
...
120:                                              ; preds = %108
  ...
  %133 = bitcast %struct.patient* %128 to i8*
...
178:                                              ; preds = %166
  ...
  %190 = bitcast %struct.patient* %189 to i8*
  %191 = bitcast %struct.patient* %186 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1550.cpp() #0 section ".text.startup" {
