; ModuleID = 'POJ-104-source/9/9-1555.cpp'
source_filename = "POJ-104-source/9/9-1555.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1555.cpp, i8* null }]
...
61:                                               ; preds = %48
  ...
  %111 = call i8* @strcpy(i8* %104, i8* %110) #3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1555.cpp() #0 section ".text.startup" {
