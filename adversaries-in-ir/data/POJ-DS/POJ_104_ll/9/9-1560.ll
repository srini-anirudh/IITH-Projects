; ModuleID = 'POJ-104-source/9/9-1560.cpp'
source_filename = "POJ-104-source/9/9-1560.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1560.cpp, i8* null }]
...
46:                                               ; preds = %39
  ...
  %49 = getelementptr inbounds [100 x %struct.a], [100 x %struct.a]* @p, i64 0, i64 %48
  %50 = load i32, i32* %6, align 4
  %51 = sext i32 %50 to i64
  %52 = getelementptr inbounds [100 x %struct.a], [100 x %struct.a]* %9, i64 0, i64 %51
...
104:                                              ; preds = %96
  ...
  %107 = getelementptr inbounds [100 x %struct.a], [100 x %struct.a]* %9, i64 0, i64 %106
  %108 = load i32, i32* %7, align 4
  %109 = sext i32 %108 to i64
  %110 = getelementptr inbounds [100 x %struct.a], [100 x %struct.a]* %10, i64 0, i64 %109
  %111 = bitcast %struct.a* %110 to i8*
  %112 = bitcast %struct.a* %107 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1560.cpp() #0 section ".text.startup" {
