; ModuleID = 'POJ-104-source/9/9-1568.cpp'
source_filename = "POJ-104-source/9/9-1568.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1568.cpp, i8* null }]
...
33:                                               ; preds = %16
  ...
  %39 = getelementptr inbounds [100 x %struct.person], [100 x %struct.person]* %3, i64 0, i64 %38
  %40 = bitcast %struct.person* %39 to i8*
  %41 = bitcast %struct.person* %36 to i8*
...
75:                                               ; preds = %62
  ...
  %84 = getelementptr inbounds [100 x %struct.person], [100 x %struct.person]* %3, i64 0, i64 %83
  %85 = load i32, i32* %7, align 4
  %86 = sext i32 %85 to i64
  %87 = getelementptr inbounds [100 x %struct.person], [100 x %struct.person]* %3, i64 0, i64 %86
  %88 = bitcast %struct.person* %87 to i8*
  %89 = bitcast %struct.person* %84 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1568.cpp() #0 section ".text.startup" {
