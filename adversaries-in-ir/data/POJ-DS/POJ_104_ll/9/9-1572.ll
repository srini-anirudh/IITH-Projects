; ModuleID = 'POJ-104-source/9/9-1572.cpp'
source_filename = "POJ-104-source/9/9-1572.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1572.cpp, i8* null }]
...
define dso_local void @_Z6bubblei(i32 %0) #4 {
...
10:                                               ; preds = %6
  ...
  %13 = getelementptr inbounds [110 x %struct.patient], [110 x %struct.patient]* @pat, i64 0, i64 %12
  ...
  %18 = getelementptr inbounds [110 x %struct.patient], [110 x %struct.patient]* @pat, i64 0, i64 %17
  ...
  %23 = getelementptr inbounds [110 x %struct.patient], [110 x %struct.patient]* @pat, i64 0, i64 %22
...
27:                                               ; preds = %10
  ...
  %30 = getelementptr inbounds [110 x %struct.patient], [110 x %struct.patient]* @pat, i64 0, i64 %29
  %31 = load i32, i32* %4, align 4
  %32 = add nsw i32 %31, 1
  store i32 %32, i32* %4, align 4
  %33 = sext i32 %31 to i64
  %34 = getelementptr inbounds [110 x %struct.patient], [110 x %struct.patient]* @pat1, i64 0, i64 %33
  %35 = bitcast %struct.patient* %34 to i8*
  %36 = bitcast %struct.patient* %30 to i8*
...
47:                                               ; preds = %43
  ...
  %50 = getelementptr inbounds [110 x %struct.patient], [110 x %struct.patient]* @pat1, i64 0, i64 %49
...
62:                                               ; preds = %58
  ...
  %65 = getelementptr inbounds [110 x %struct.patient], [110 x %struct.patient]* @pat, i64 0, i64 %64
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1572.cpp() #0 section ".text.startup" {
