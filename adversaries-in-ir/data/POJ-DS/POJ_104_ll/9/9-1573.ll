; ModuleID = 'POJ-104-source/9/9-1573.cpp'
source_filename = "POJ-104-source/9/9-1573.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1573.cpp, i8* null }]
...
40:                                               ; preds = %33
  ...
  %46 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %3, i64 0, i64 %45
  %47 = bitcast %struct.student* %46 to i8*
  %48 = bitcast %struct.student* %43 to i8*
...
84:                                               ; preds = %71
  ...
  %93 = getelementptr inbounds [100 x %struct.student], [100 x %struct.student]* %3, i64 0, i64 %92
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1573.cpp() #0 section ".text.startup" {
