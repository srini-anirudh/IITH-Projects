; ModuleID = 'POJ-104-source/9/9-1580.cpp'
source_filename = "POJ-104-source/9/9-1580.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1580.cpp, i8* null }]
...
19:                                               ; preds = %15
  ...
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %23, i32* %6)
...
62:                                               ; preds = %15
  ...
  call void @_Z6bubbleP7patienti(%struct.patient* %63, i32 %64)
...
define dso_local void @_Z6bubbleP7patienti(%struct.patient* %0, i32 %1) #6 {
...
34:                                               ; preds = %19
  ...
  %45 = getelementptr inbounds %struct.patient, %struct.patient* %41, i64 %44
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1580.cpp() #0 section ".text.startup" {
