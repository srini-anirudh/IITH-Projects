; ModuleID = 'POJ-104-source/9/9-1618.cpp'
source_filename = "POJ-104-source/9/9-1618.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1618.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @_Z5paixuiP7Patient(i32 %8, %struct.Patient* %9)
...
14:                                               ; preds = %11
  ...
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), i8* %19, i32* %21)
...
25:                                               ; preds = %11
  ...
  %33 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), i8* %30, i32* %32)
...
define dso_local void @_Z5paixuiP7Patient(i32 %0, %struct.Patient* %1) #5 {
  %3 = alloca i32, align 4
  %4 = alloca %struct.Patient*, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1618.cpp() #0 section ".text.startup" {
