; ModuleID = 'POJ-104-source/9/9-162.cpp'
source_filename = "POJ-104-source/9/9-162.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_162.cpp, i8* null }]
...
56:                                               ; preds = %48
  ...
  %70 = bitcast %struct.anon* %65 to i8*
  ...
  %75 = bitcast %struct.anon* %74 to i8*
  %76 = bitcast %struct.anon* %7 to i8*
...
127:                                              ; preds = %114
  ...
  %131 = bitcast %struct.anon* %8 to i8*
  %132 = bitcast %struct.anon* %130 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %131, i8* align 4 %132, i64 20, i1 false)
  ...
  %141 = bitcast %struct.anon* %136 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %140, i8* align 4 %141, i64 20, i1 false)
...
156:                                              ; preds = %86
  %157 = getelementptr inbounds [100 x %struct.anon], [100 x %struct.anon]* %6, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_162.cpp() #0 section ".text.startup" {
