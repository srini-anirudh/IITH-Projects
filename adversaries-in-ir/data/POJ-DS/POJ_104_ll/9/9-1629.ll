; ModuleID = 'POJ-104-source/9/9-1629.cpp'
source_filename = "POJ-104-source/9/9-1629.cpp"
...
@temp = dso_local global %struct.f zeroinitializer, align 4
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [9 x i8] c"%s%c%d%c\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1629.cpp, i8* null }]
...
17:                                               ; preds = %13
  ...
  %27 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i8* %22, i8* %9, i32* %26, i8* %8)
  br label %28
...
43:                                               ; preds = %36
  ...
  %48 = getelementptr inbounds [1000 x %struct.f], [1000 x %struct.f]* @st, i64 0, i64 %47
  %49 = load i32, i32* %5, align 4
  %50 = sext i32 %49 to i64
  %51 = getelementptr inbounds [1000 x %struct.f], [1000 x %struct.f]* @stu, i64 0, i64 %50
  %52 = bitcast %struct.f* %51 to i8*
  %53 = bitcast %struct.f* %48 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1629.cpp() #0 section ".text.startup" {
