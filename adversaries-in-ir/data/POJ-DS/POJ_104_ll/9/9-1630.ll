; ModuleID = 'POJ-104-source/9/9-1630.cpp'
source_filename = "POJ-104-source/9/9-1630.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1630.cpp, i8* null }]
...
85:                                               ; preds = %72
  ...
  %94 = getelementptr inbounds [100 x %struct.patient], [100 x %struct.patient]* %5, i64 0, i64 %93
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1630.cpp() #0 section ".text.startup" {
