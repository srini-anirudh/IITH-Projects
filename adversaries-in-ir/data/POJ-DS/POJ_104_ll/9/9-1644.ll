; ModuleID = 'POJ-104-source/9/9-1644.cpp'
source_filename = "POJ-104-source/9/9-1644.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1644.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local %struct.example* @_Z5creati(i32 %0) #0 {
...
10:                                               ; preds = %6
  ...
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), [10 x i8]* %14, i32* %16)
...
define dso_local %struct.example* @_Z5paixuP7example(%struct.example* %0) #4 {
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5printP7example(%struct.example* %0) #0 {
  %2 = alloca %struct.example*, align 8
  %3 = alloca %struct.example*, align 8
  store %struct.example* %0, %struct.example** %2, align 8
...
define dso_local i32 @main() #6 {
  ...
  %2 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i32* @n)
  %3 = load i32, i32* @n, align 4
  %4 = call %struct.example* @_Z5creati(i32 %3)
  store %struct.example* %4, %struct.example** %1, align 8
  %5 = load %struct.example*, %struct.example** %1, align 8
  %6 = call %struct.example* @_Z5paixuP7example(%struct.example* %5)
  store %struct.example* %6, %struct.example** %1, align 8
  %7 = load %struct.example*, %struct.example** %1, align 8
  call void @_Z5printP7example(%struct.example* %7)
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1644.cpp() #0 section ".text.startup" {
