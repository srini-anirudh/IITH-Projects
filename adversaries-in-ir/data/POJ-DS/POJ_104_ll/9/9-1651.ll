; ModuleID = 'POJ-104-source/9/9-1651.cpp'
source_filename = "POJ-104-source/9/9-1651.cpp"
...
@agetemp = dso_local global i32 0, align 4
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [3 x i8] c"%s\00", align 1
@.str.2 = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1651.cpp, i8* null }]
...
9:                                                ; preds = %5
  ...
  %14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), [11 x i8]* %13)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1651.cpp() #0 section ".text.startup" {
