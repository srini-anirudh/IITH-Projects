; ModuleID = 'POJ-104-source/9/9-1655.cpp'
source_filename = "POJ-104-source/9/9-1655.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1655.cpp, i8* null }]
...
84:                                               ; preds = %69
  ...
  %95 = getelementptr inbounds %struct.patient, %struct.patient* %94, i64 1
  ...
  %101 = bitcast %struct.patient* %95 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1655.cpp() #0 section ".text.startup" {
