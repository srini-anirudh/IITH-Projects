; ModuleID = 'POJ-104-source/9/9-1657.cpp'
source_filename = "POJ-104-source/9/9-1657.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_1657.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local %struct.patient* @_Z4liani(i32 %0) #0 {
  ...
  %14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i8* %11, i32* %13)
...
22:                                               ; preds = %18
  ...
  %30 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i8* %27, i32* %29)
...
define dso_local i32 @main() #4 {
  ...
  %11 = call %struct.patient* @_Z4liani(i32 %10)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_1657.cpp() #0 section ".text.startup" {
