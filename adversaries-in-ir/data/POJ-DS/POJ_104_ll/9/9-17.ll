; ModuleID = 'POJ-104-source/9/9-17.cpp'
source_filename = "POJ-104-source/9/9-17.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_17.cpp, i8* null }]
...
68:                                               ; preds = %53
  ...
  %79 = getelementptr inbounds %struct.pe, %struct.pe* %76, i64 %78
  %80 = load %struct.pe*, %struct.pe** %3, align 8
  %81 = load i32, i32* %5, align 4
  %82 = add nsw i32 %81, 1
  %83 = sext i32 %82 to i64
  %84 = getelementptr inbounds %struct.pe, %struct.pe* %80, i64 %83
  %85 = bitcast %struct.pe* %84 to i8*
  %86 = bitcast %struct.pe* %79 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_17.cpp() #0 section ".text.startup" {
