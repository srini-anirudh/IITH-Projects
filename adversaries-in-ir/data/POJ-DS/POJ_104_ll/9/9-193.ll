; ModuleID = 'POJ-104-source/9/9-193.cpp'
source_filename = "POJ-104-source/9/9-193.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_193.cpp, i8* null }]
...
24:                                               ; preds = %5
  ...
  call void @qsort(i8* getelementptr inbounds ([100 x %struct.patient], [100 x %struct.patient]* @pat, i32 0, i32 0, i32 0, i32 0), i64 %26, i64 16, i32 (i8*, i8*)* @_Z3cmpPKvS0_)
  store i32 0, i32* %3, align 4
  br label %27
...
define dso_local i32 @_Z3cmpPKvS0_(i8* %0, i8* %1) #5 {
  %3 = alloca i32, align 4
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_193.cpp() #0 section ".text.startup" {
