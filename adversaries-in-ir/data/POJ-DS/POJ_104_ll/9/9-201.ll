; ModuleID = 'POJ-104-source/9/9-201.cpp'
source_filename = "POJ-104-source/9/9-201.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_201.cpp, i8* null }]
...
21:                                               ; preds = %17
  ...
  %33 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i8* %27, i32* %32)
...
73:                                               ; preds = %69
  ...
  %78 = getelementptr inbounds %struct.pa, %struct.pa* %74, i64 %77
  %79 = load %struct.pa*, %struct.pa** %2, align 8
  %80 = load i32, i32* %5, align 4
  %81 = sext i32 %80 to i64
  %82 = getelementptr inbounds %struct.pa, %struct.pa* %79, i64 %81
  %83 = bitcast %struct.pa* %82 to i8*
  %84 = bitcast %struct.pa* %78 to i8*
...
127:                                              ; preds = %112
  ...
  %138 = getelementptr inbounds %struct.pa, %struct.pa* %134, i64 %137
  %139 = load %struct.pa*, %struct.pa** %2, align 8
  %140 = load i32, i32* %5, align 4
  %141 = sext i32 %140 to i64
  %142 = getelementptr inbounds %struct.pa, %struct.pa* %139, i64 %141
  %143 = bitcast %struct.pa* %142 to i8*
  %144 = bitcast %struct.pa* %138 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_201.cpp() #0 section ".text.startup" {
