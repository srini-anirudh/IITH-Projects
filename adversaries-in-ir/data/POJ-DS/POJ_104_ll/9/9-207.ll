; ModuleID = 'POJ-104-source/9/9-207.cpp'
source_filename = "POJ-104-source/9/9-207.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_207.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5printP4info(%struct.info* %0) #0 {
...
define dso_local i32 @main() #4 {
  ...
  call void @_Z5printP4info(%struct.info* %6)
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_207.cpp() #0 section ".text.startup" {
