; ModuleID = 'POJ-104-source/9/9-213.cpp'
source_filename = "POJ-104-source/9/9-213.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_213.cpp, i8* null }]
...
define dso_local %struct.student* @_Z5creati(i32 %0) #0 {
  ...
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i8* %14, i32* %16)
...
27:                                               ; preds = %22
  ...
  %35 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i8* %32, i32* %34)
...
define dso_local i32 @main() #4 {
  ...
  %2 = alloca %struct.student*, align 8
  %3 = alloca i32, align 4
  %4 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i32* %3)
  %5 = load i32, i32* %3, align 4
  %6 = call %struct.student* @_Z5creati(i32 %5)
  store %struct.student* %6, %struct.student** %1, align 8
  %7 = load %struct.student*, %struct.student** %1, align 8
  call void @_Z5printP7student(%struct.student* %7)
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_213.cpp() #0 section ".text.startup" {
