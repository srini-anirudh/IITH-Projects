; ModuleID = 'POJ-104-source/9/9-218.cpp'
source_filename = "POJ-104-source/9/9-218.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_218.cpp, i8* null }]
...
define dso_local void @_Z4findP3patS0_(%struct.pat* %0, %struct.pat* %1) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z4sortP3patiPc(%struct.pat* %0, i32 %1, i8* %2) #4 {
  %4 = alloca %struct.pat*, align 8
...
28:                                               ; preds = %3
  ...
  call void @_Z4findP3patS0_(%struct.pat* %29, %struct.pat* %30)
  br label %47
...
17:                                               ; preds = %13
  ...
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i8* %18, i32* %5)
  %20 = load %struct.pat*, %struct.pat** %2, align 8
  %21 = load i32, i32* %5, align 4
  %22 = getelementptr inbounds [11 x i8], [11 x i8]* %7, i64 0, i64 0
  call void @_Z4sortP3patiPc(%struct.pat* %20, i32 %21, i8* %22)
  br label %23
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_218.cpp() #0 section ".text.startup" {
