; ModuleID = 'POJ-104-source/9/9-228.cpp'
source_filename = "POJ-104-source/9/9-228.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_228.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z4sortP1s(%struct.s* %0) #0 {
...
define dso_local i32 @main() #4 {
  ...
  %8 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %4)
...
15:                                               ; preds = %11
  ...
  call void @_Z4sortP1s(%struct.s* %16)
  br label %17
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_228.cpp() #0 section ".text.startup" {
