; ModuleID = 'POJ-104-source/9/9-247.cpp'
source_filename = "POJ-104-source/9/9-247.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_247.cpp, i8* null }]
...
10:                                               ; preds = %6
  ...
  %15 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), [20 x i8]* %14)
...
55:                                               ; preds = %42
  ...
  %63 = getelementptr inbounds [202 x %struct.patient], [202 x %struct.patient]* @line, i64 0, i64 %62
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_247.cpp() #0 section ".text.startup" {
