; ModuleID = 'POJ-104-source/9/9-253.cpp'
source_filename = "POJ-104-source/9/9-253.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_253.cpp, i8* null }]
...
80:                                               ; preds = %76
  ...
  %86 = getelementptr inbounds [100 x [10 x i8]], [100 x [10 x i8]]* %10, i64 0, i64 %85
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_253.cpp() #0 section ".text.startup" {
