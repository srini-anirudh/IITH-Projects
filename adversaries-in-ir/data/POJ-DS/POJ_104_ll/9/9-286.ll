; ModuleID = 'POJ-104-source/9/9-286.cpp'
source_filename = "POJ-104-source/9/9-286.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_286.cpp, i8* null }]
...
16:                                               ; preds = %12
  ...
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), [10 x i8]* %20, i32* %24)
  br label %26
...
41:                                               ; preds = %34
  ...
  %50 = bitcast %struct.anon* %44 to i8*
...
58:                                               ; preds = %51
  ...
  %65 = getelementptr inbounds [100 x %struct.anon], [100 x %struct.anon]* %9, i64 0, i64 %64
  %66 = bitcast %struct.anon* %65 to i8*
  %67 = bitcast %struct.anon* %61 to i8*
...
96:                                               ; preds = %83
  ...
  %105 = getelementptr inbounds [100 x %struct.anon], [100 x %struct.anon]* %8, i64 0, i64 %104
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_286.cpp() #0 section ".text.startup" {
