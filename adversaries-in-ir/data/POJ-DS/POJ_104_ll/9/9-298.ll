; ModuleID = 'POJ-104-source/9/9-298.cpp'
source_filename = "POJ-104-source/9/9-298.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_298.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local %struct.patient* @_Z5creati(i32 %0) #0 {
  ...
  %13 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i8* %10, i32* %12)
...
30:                                               ; preds = %26, %24
  ...
  %39 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i8* %36, i32* %38)
  br label %14
...
define dso_local %struct.patient* @_Z3oldP7patient(%struct.patient* %0) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local %struct.patient* @_Z4sortP7patient(%struct.patient* %0) #4 {
  %2 = alloca %struct.patient*, align 8
  %3 = alloca %struct.patient, align 8
  %4 = alloca %struct.patient, align 8
  %5 = alloca %struct.patient*, align 8
...
; Function Attrs: noinline uwtable
define dso_local void @_Z6print2P7patient(%struct.patient* %0) #0 {
  %2 = alloca %struct.patient*, align 8
  %3 = alloca %struct.patient*, align 8
  store %struct.patient* %0, %struct.patient** %2, align 8
...
; Function Attrs: noinline uwtable
define dso_local void @_Z6print1P7patient(%struct.patient* %0) #0 {
  %2 = alloca %struct.patient*, align 8
  %3 = alloca %struct.patient*, align 8
  store %struct.patient* %0, %struct.patient** %2, align 8
  %4 = load %struct.patient*, %struct.patient** %2, align 8
...
define dso_local i32 @main() #5 {
  ...
  %5 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i32* %4)
  %6 = load i32, i32* %4, align 4
  %7 = call %struct.patient* @_Z5creati(i32 %6)
  store %struct.patient* %7, %struct.patient** %1, align 8
  %8 = load %struct.patient*, %struct.patient** %1, align 8
  %9 = call %struct.patient* @_Z3oldP7patient(%struct.patient* %8)
  store %struct.patient* %9, %struct.patient** %2, align 8
  %10 = load %struct.patient*, %struct.patient** %2, align 8
  %11 = call %struct.patient* @_Z4sortP7patient(%struct.patient* %10)
  store %struct.patient* %11, %struct.patient** %3, align 8
  %12 = load %struct.patient*, %struct.patient** %3, align 8
  call void @_Z6print1P7patient(%struct.patient* %12)
  %13 = load %struct.patient*, %struct.patient** %1, align 8
  call void @_Z6print2P7patient(%struct.patient* %13)
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_298.cpp() #0 section ".text.startup" {
