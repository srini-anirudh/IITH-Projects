; ModuleID = 'POJ-104-source/9/9-30.cpp'
source_filename = "POJ-104-source/9/9-30.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_30.cpp, i8* null }]
...
70:                                               ; preds = %58
  ...
  %83 = bitcast %struct.anon* %78 to i8*
...
147:                                              ; preds = %135
  ...
  %160 = bitcast %struct.anon* %155 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_30.cpp() #0 section ".text.startup" {
