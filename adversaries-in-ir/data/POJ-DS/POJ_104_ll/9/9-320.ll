; ModuleID = 'POJ-104-source/9/9-320.cpp'
source_filename = "POJ-104-source/9/9-320.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_320.cpp, i8* null }]
...
16:                                               ; preds = %12
  ...
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %18, i32* %7)
...
82:                                               ; preds = %68
  ...
  %114 = call i8* @strcpy(i8* %106, i8* %113) #3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_320.cpp() #0 section ".text.startup" {
