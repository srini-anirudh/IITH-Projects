; ModuleID = 'POJ-104-source/9/9-36.cpp'
source_filename = "POJ-104-source/9/9-36.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_36.cpp, i8* null }]
...
define dso_local void @_Z4sortP3MANi(%struct.MAN* %0, i32 %1) #4 {
...
42:                                               ; preds = %27
  ...
  %53 = getelementptr inbounds %struct.MAN, %struct.MAN* %49, i64 %52
  %54 = load %struct.MAN*, %struct.MAN** %3, align 8
  %55 = load i32, i32* %6, align 4
  %56 = sext i32 %55 to i64
  %57 = getelementptr inbounds %struct.MAN, %struct.MAN* %54, i64 %56
  %58 = bitcast %struct.MAN* %57 to i8*
  %59 = bitcast %struct.MAN* %53 to i8*
...
17:                                               ; preds = %13
  ...
  %29 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %23, i32* %28)
  br label %30
...
33:                                               ; preds = %13
  ...
  call void @_Z4sortP3MANi(%struct.MAN* %34, i32 %35)
  store i32 0, i32* %2, align 4
  br label %36
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_36.cpp() #0 section ".text.startup" {
