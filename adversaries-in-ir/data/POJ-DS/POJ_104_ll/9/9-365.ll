; ModuleID = 'POJ-104-source/9/9-365.cpp'
source_filename = "POJ-104-source/9/9-365.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_365.cpp, i8* null }]
...
57:                                               ; preds = %44
  ...
  %66 = getelementptr inbounds [100 x %struct.patient_t], [100 x %struct.patient_t]* %2, i64 0, i64 %65
  %67 = load i32, i32* %5, align 4
  %68 = sext i32 %67 to i64
  %69 = getelementptr inbounds [100 x %struct.patient_t], [100 x %struct.patient_t]* %2, i64 0, i64 %68
  %70 = bitcast %struct.patient_t* %69 to i8*
  %71 = bitcast %struct.patient_t* %66 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_365.cpp() #0 section ".text.startup" {
