; ModuleID = 'POJ-104-source/9/9-369.cpp'
source_filename = "POJ-104-source/9/9-369.cpp"
...
@t = dso_local global %struct.person zeroinitializer, align 4
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [6 x i8] c"%s %d\00", align 1
@.str.2 = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_369.cpp, i8* null }]
...
59:                                               ; preds = %46
  ...
  %67 = getelementptr inbounds [100 x %struct.person], [100 x %struct.person]* @pe, i64 0, i64 %66
  %68 = load i32, i32* %3, align 4
  %69 = sext i32 %68 to i64
  %70 = getelementptr inbounds [100 x %struct.person], [100 x %struct.person]* @pe, i64 0, i64 %69
  %71 = bitcast %struct.person* %70 to i8*
  %72 = bitcast %struct.person* %67 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_369.cpp() #0 section ".text.startup" {
