; ModuleID = 'POJ-104-source/9/9-423.cpp'
source_filename = "POJ-104-source/9/9-423.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_423.cpp, i8* null }]
...
17:                                               ; preds = %13
  ...
  %29 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i8* %23, i32* %28)
  br label %30
...
68:                                               ; preds = %53
  ...
  %79 = getelementptr inbounds %struct.br, %struct.br* %75, i64 %78
  %80 = load %struct.br*, %struct.br** %2, align 8
  %81 = load i32, i32* %6, align 4
  %82 = sext i32 %81 to i64
  %83 = getelementptr inbounds %struct.br, %struct.br* %80, i64 %82
  %84 = bitcast %struct.br* %83 to i8*
  %85 = bitcast %struct.br* %79 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_423.cpp() #0 section ".text.startup" {
