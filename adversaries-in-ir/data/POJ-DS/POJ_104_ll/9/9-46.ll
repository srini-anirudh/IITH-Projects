; ModuleID = 'POJ-104-source/9/9-46.cpp'
source_filename = "POJ-104-source/9/9-46.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_46.cpp, i8* null }]
...
34:                                               ; preds = %19
  ...
  %47 = getelementptr inbounds [100 x [10 x i8]], [100 x [10 x i8]]* %11, i64 0, i64 %46
...
83:                                               ; preds = %72
  ...
  %122 = getelementptr inbounds [10 x i8], [10 x i8]* %12, i64 0, i64 0
...
157:                                              ; preds = %151
  ...
  %160 = getelementptr inbounds [100 x [10 x i8]], [100 x [10 x i8]]* %10, i64 0, i64 %159
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_46.cpp() #0 section ".text.startup" {
