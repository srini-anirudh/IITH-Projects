; ModuleID = 'POJ-104-source/9/9-548.cpp'
source_filename = "POJ-104-source/9/9-548.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_548.cpp, i8* null }]
...
7:                                                ; preds = %3
  ...
  %15 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %11, i32* %14)
  br label %16
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_548.cpp() #0 section ".text.startup" {
