; ModuleID = 'POJ-104-source/9/9-553.cpp'
source_filename = "POJ-104-source/9/9-553.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_553.cpp, i8* null }]
...
38:                                               ; preds = %33
  ...
  %46 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %42, i32* %45)
  br label %47
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_553.cpp() #0 section ".text.startup" {
