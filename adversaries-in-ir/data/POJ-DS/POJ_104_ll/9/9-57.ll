; ModuleID = 'POJ-104-source/9/9-57.cpp'
source_filename = "POJ-104-source/9/9-57.cpp"
...
@temp = dso_local global %struct.pat zeroinitializer, align 4
@temp2 = dso_local global %struct.pat zeroinitializer, align 4
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [6 x i8] c"%s %d\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_57.cpp, i8* null }]
...
60:                                               ; preds = %48
  ...
  %71 = bitcast %struct.pat* %70 to i8*
  %72 = bitcast %struct.pat* %67 to i8*
...
79:                                               ; preds = %75
  ...
  %82 = getelementptr inbounds [100 x %struct.pat], [100 x %struct.pat]* @pa, i64 0, i64 %81
  %83 = load i32, i32* %4, align 4
  %84 = add nsw i32 %83, 1
  %85 = sext i32 %84 to i64
  %86 = getelementptr inbounds [100 x %struct.pat], [100 x %struct.pat]* @pa, i64 0, i64 %85
  %87 = bitcast %struct.pat* %86 to i8*
  %88 = bitcast %struct.pat* %82 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_57.cpp() #0 section ".text.startup" {
