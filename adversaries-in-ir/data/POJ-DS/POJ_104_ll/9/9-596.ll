; ModuleID = 'POJ-104-source/9/9-596.cpp'
source_filename = "POJ-104-source/9/9-596.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_596.cpp, i8* null }]
...
18:                                               ; preds = %13
  ...
  %21 = getelementptr inbounds [100 x [11 x i8]], [100 x [11 x i8]]* %10, i64 0, i64 %20
  ...
  %26 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %22, i32* %25)
  br label %27
...
92:                                               ; preds = %70
  ...
  %98 = getelementptr inbounds [100 x [11 x i8]], [100 x [11 x i8]]* %10, i64 0, i64 %97
  %99 = getelementptr inbounds [11 x i8], [11 x i8]* %98, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_596.cpp() #0 section ".text.startup" {
