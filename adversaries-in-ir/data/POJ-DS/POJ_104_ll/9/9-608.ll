; ModuleID = 'POJ-104-source/9/9-608.cpp'
source_filename = "POJ-104-source/9/9-608.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_608.cpp, i8* null }]
...
34:                                               ; preds = %30
  ...
  %42 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %38, i32* %41)
  br label %43
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_608.cpp() #0 section ".text.startup" {
