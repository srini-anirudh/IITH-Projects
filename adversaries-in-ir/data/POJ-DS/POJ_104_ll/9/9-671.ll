; ModuleID = 'POJ-104-source/9/9-671.cpp'
source_filename = "POJ-104-source/9/9-671.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_671.cpp, i8* null }]
...
10:                                               ; preds = %6
  ...
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), [11 x i8]* %14, i32* %18)
  br label %20
...
23:                                               ; preds = %6
  ...
  call void @_Z4sortiP1p(i32 %24, %struct.p* %25)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define dso_local void @_Z4sortiP1p(i32 %0, %struct.p* %1) #0 {
  %3 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_671.cpp() #0 section ".text.startup" {
