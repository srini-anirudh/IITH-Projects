; ModuleID = 'POJ-104-source/9/9-712.cpp'
source_filename = "POJ-104-source/9/9-712.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_712.cpp, i8* null }]
...
42:                                               ; preds = %26
  ...
  %45 = call i32 @_Z3maxPii(i32* %43, i32 %44)
...
61:                                               ; preds = %54
  ...
  %64 = getelementptr inbounds [100 x %struct.patient], [100 x %struct.patient]* @a, i64 0, i64 %63
...
75:                                               ; preds = %50
  ...
  %78 = call i32 @_Z3maxPii(i32* %76, i32 %77)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_712.cpp() #0 section ".text.startup" {
