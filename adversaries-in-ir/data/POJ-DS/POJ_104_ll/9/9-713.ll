; ModuleID = 'POJ-104-source/9/9-713.cpp'
source_filename = "POJ-104-source/9/9-713.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_713.cpp, i8* null }]
...
53:                                               ; preds = %35
  ...
  %59 = getelementptr inbounds [100 x %struct.patient], [100 x %struct.patient]* %4, i64 0, i64 %58
  %60 = bitcast %struct.patient* %59 to i8*
  %61 = bitcast %struct.patient* %56 to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_713.cpp() #0 section ".text.startup" {
