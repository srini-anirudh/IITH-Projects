; ModuleID = 'POJ-104-source/9/9-717.cpp'
source_filename = "POJ-104-source/9/9-717.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_717.cpp, i8* null }]
...
18:                                               ; preds = %14
  ...
  %27 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), [10 x i8]* %22, i32* %26)
...
99:                                               ; preds = %88
  ...
  %139 = getelementptr inbounds [100 x %struct.patient], [100 x %struct.patient]* %2, i64 0, i64 %138
  ...
  %142 = getelementptr inbounds [10 x i8], [10 x i8]* %8, i64 0, i64 0
...
163:                                              ; preds = %157
  ...
  %166 = getelementptr inbounds [100 x %struct.patient], [100 x %struct.patient]* %2, i64 0, i64 %165
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_717.cpp() #0 section ".text.startup" {
