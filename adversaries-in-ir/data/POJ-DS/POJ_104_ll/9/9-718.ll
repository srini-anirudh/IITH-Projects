; ModuleID = 'POJ-104-source/9/9-718.cpp'
source_filename = "POJ-104-source/9/9-718.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_718.cpp, i8* null }]
...
70:                                               ; preds = %63
  ...
  %74 = getelementptr inbounds [100 x %struct.patient], [100 x %struct.patient]* %7, i64 0, i64 %73
...
83:                                               ; preds = %70
  ...
  %87 = bitcast %struct.patient* %8 to i8*
  ...
  %103 = bitcast %struct.patient* %8 to i8*
...
139:                                              ; preds = %132
  ...
  %142 = getelementptr inbounds [100 x %struct.patient], [100 x %struct.patient]* %6, i64 0, i64 %141
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_718.cpp() #0 section ".text.startup" {
