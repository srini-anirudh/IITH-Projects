; ModuleID = 'POJ-104-source/9/9-721.cpp'
source_filename = "POJ-104-source/9/9-721.cpp"
...
@temp = dso_local global %struct.hospital zeroinitializer, align 4
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [6 x i8] c"%s %d\00", align 1
@.str.2 = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_721.cpp, i8* null }]
...
define dso_local void @_Z8sequenceP8hospitali(%struct.hospital* %0, i32 %1) #4 {
...
35:                                               ; preds = %20
  ...
  %45 = getelementptr inbounds %struct.hospital, %struct.hospital* %41, i64 %44
  ...
  %51 = bitcast %struct.hospital* %45 to i8*
...
37:                                               ; preds = %30
  ...
  %40 = getelementptr inbounds [100 x %struct.hospital], [100 x %struct.hospital]* @all, i64 0, i64 %39
  %41 = load i32, i32* %4, align 4
  %42 = sext i32 %41 to i64
  %43 = getelementptr inbounds [100 x %struct.hospital], [100 x %struct.hospital]* @old, i64 0, i64 %42
  %44 = bitcast %struct.hospital* %43 to i8*
  %45 = bitcast %struct.hospital* %40 to i8*
...
48:                                               ; preds = %30
  ...
  %51 = getelementptr inbounds [100 x %struct.hospital], [100 x %struct.hospital]* @all, i64 0, i64 %50
  %52 = load i32, i32* %5, align 4
  %53 = sext i32 %52 to i64
  %54 = getelementptr inbounds [100 x %struct.hospital], [100 x %struct.hospital]* @young, i64 0, i64 %53
  %55 = bitcast %struct.hospital* %54 to i8*
  %56 = bitcast %struct.hospital* %51 to i8*
...
63:                                               ; preds = %26
  ...
  call void @_Z8sequenceP8hospitali(%struct.hospital* getelementptr inbounds ([100 x %struct.hospital], [100 x %struct.hospital]* @old, i64 0, i64 0), i32 %64)
  store i32 0, i32* %3, align 4
  br label %65
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_721.cpp() #0 section ".text.startup" {
