; ModuleID = 'POJ-104-source/9/9-722.cpp'
source_filename = "POJ-104-source/9/9-722.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_722.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %16 = alloca %struct.p, i64 %14, align 16
  store i64 %14, i64* %8, align 8
  %17 = load i32, i32* %2, align 4
  %18 = zext i32 %17 to i64
  %19 = alloca %struct.p, i64 %18, align 16
  store i64 %18, i64* %9, align 8
  %20 = load i32, i32* %2, align 4
  %21 = zext i32 %20 to i64
  %22 = alloca %struct.p, i64 %21, align 16
...
27:                                               ; preds = %23
  ...
  %30 = getelementptr inbounds %struct.p, %struct.p* %16, i64 %29
  %31 = getelementptr inbounds %struct.p, %struct.p* %30, i32 0, i32 0
  %32 = load i32, i32* %3, align 4
  %33 = sext i32 %32 to i64
  %34 = getelementptr inbounds %struct.p, %struct.p* %16, i64 %33
  %35 = getelementptr inbounds %struct.p, %struct.p* %34, i32 0, i32 1
  %36 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), [10 x i8]* %31, i32* %35)
  %37 = load i32, i32* %3, align 4
  %38 = sext i32 %37 to i64
  %39 = getelementptr inbounds %struct.p, %struct.p* %16, i64 %38
...
43:                                               ; preds = %27
  ...
  %46 = getelementptr inbounds %struct.p, %struct.p* %16, i64 %45
  %47 = load i32, i32* %4, align 4
  %48 = sext i32 %47 to i64
  %49 = getelementptr inbounds %struct.p, %struct.p* %19, i64 %48
  %50 = bitcast %struct.p* %49 to i8*
  %51 = bitcast %struct.p* %46 to i8*
...
54:                                               ; preds = %27
  ...
  %57 = getelementptr inbounds %struct.p, %struct.p* %16, i64 %56
  %58 = load i32, i32* %5, align 4
  %59 = sext i32 %58 to i64
  %60 = getelementptr inbounds %struct.p, %struct.p* %22, i64 %59
...
83:                                               ; preds = %76
  ...
  %86 = getelementptr inbounds %struct.p, %struct.p* %19, i64 %85
  %87 = getelementptr inbounds %struct.p, %struct.p* %86, i32 0, i32 1
  %88 = load i32, i32* %87, align 4
  %89 = load i32, i32* %6, align 4
  %90 = add nsw i32 %89, 1
  %91 = sext i32 %90 to i64
  %92 = getelementptr inbounds %struct.p, %struct.p* %19, i64 %91
...
96:                                               ; preds = %83
  ...
  %99 = getelementptr inbounds %struct.p, %struct.p* %19, i64 %98
  %100 = bitcast %struct.p* %11 to i8*
  ...
  %105 = getelementptr inbounds %struct.p, %struct.p* %19, i64 %104
  %106 = load i32, i32* %6, align 4
  %107 = sext i32 %106 to i64
  %108 = getelementptr inbounds %struct.p, %struct.p* %19, i64 %107
  %109 = bitcast %struct.p* %108 to i8*
  %110 = bitcast %struct.p* %105 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %109, i8* align 16 %110, i64 16, i1 false)
  %111 = load i32, i32* %6, align 4
  %112 = add nsw i32 %111, 1
  %113 = sext i32 %112 to i64
  %114 = getelementptr inbounds %struct.p, %struct.p* %19, i64 %113
  %115 = bitcast %struct.p* %114 to i8*
  %116 = bitcast %struct.p* %11 to i8*
...
130:                                              ; preds = %126
  ...
  %133 = getelementptr inbounds %struct.p, %struct.p* %19, i64 %132
...
145:                                              ; preds = %141
  ...
  %148 = getelementptr inbounds %struct.p, %struct.p* %22, i64 %147
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_722.cpp() #0 section ".text.startup" {
