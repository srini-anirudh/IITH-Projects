; ModuleID = 'POJ-104-source/9/9-741.cpp'
source_filename = "POJ-104-source/9/9-741.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_741.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %18 = getelementptr inbounds [100 x %struct.patient], [100 x %struct.patient]* %8, i64 0, i64 %17
  ...
  %23 = getelementptr inbounds [100 x %struct.patient], [100 x %struct.patient]* %8, i64 0, i64 %22
  %24 = getelementptr inbounds %struct.patient, %struct.patient* %23, i32 0, i32 1
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i8* %20, i32* %24)
...
160:                                              ; preds = %156
  ...
  %163 = getelementptr inbounds [100 x %struct.patient], [100 x %struct.patient]* %8, i64 0, i64 %162
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_741.cpp() #0 section ".text.startup" {
