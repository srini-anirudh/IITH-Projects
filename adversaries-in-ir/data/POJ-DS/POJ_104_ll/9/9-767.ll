; ModuleID = 'POJ-104-source/9/9-767.cpp'
source_filename = "POJ-104-source/9/9-767.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_767.cpp, i8* null }]
...
13:                                               ; preds = %9
  ...
  %16 = getelementptr inbounds [100 x %struct.patient], [100 x %struct.patient]* %2, i64 0, i64 %15
...
57:                                               ; preds = %44
  ...
  %79 = getelementptr inbounds [10 x i8], [10 x i8]* %7, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_767.cpp() #0 section ".text.startup" {
