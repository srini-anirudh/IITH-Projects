; ModuleID = 'POJ-104-source/9/9-777.cpp'
source_filename = "POJ-104-source/9/9-777.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_777.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), [1000 x i8]* %18, i32* %21)
  br label %23
...
133:                                              ; preds = %129
  ...
  %139 = getelementptr inbounds [1000 x [1000 x i8]], [1000 x [1000 x i8]]* %9, i64 0, i64 %138
  %140 = getelementptr inbounds [1000 x i8], [1000 x i8]* %139, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_777.cpp() #0 section ".text.startup" {
