; ModuleID = 'POJ-104-source/9/9-804.cpp'
source_filename = "POJ-104-source/9/9-804.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_804.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local %struct.data* @_Z4sorti(i32 %0) #0 {
...
define dso_local i32 @main() #4 {
  ...
  %8 = call %struct.data* @_Z4sorti(i32 %7)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_804.cpp() #0 section ".text.startup" {
