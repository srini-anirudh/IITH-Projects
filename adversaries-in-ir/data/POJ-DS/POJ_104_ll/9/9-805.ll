; ModuleID = 'POJ-104-source/9/9-805.cpp'
source_filename = "POJ-104-source/9/9-805.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_805.cpp, i8* null }]
...
13:                                               ; preds = %9
  ...
  %22 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), [20 x i8]* %19, i32* %21)
...
define dso_local i32 @main() #5 {
  ...
  %4 = call %struct.Node* @_Z6createv()
  store %struct.Node* %4, %struct.Node** %2, align 8
  %5 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i32* %3)
  %6 = load %struct.Node*, %struct.Node** %2, align 8
  %7 = load i32, i32* %3, align 4
  call void @_Z4sortP4Nodei(%struct.Node* %6, i32 %7)
  %8 = load %struct.Node*, %struct.Node** %2, align 8
  call void @_Z10outputdataP4Node(%struct.Node* %8)
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_805.cpp() #0 section ".text.startup" {
