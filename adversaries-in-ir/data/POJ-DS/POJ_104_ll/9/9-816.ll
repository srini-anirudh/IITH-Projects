; ModuleID = 'POJ-104-source/9/9-816.cpp'
source_filename = "POJ-104-source/9/9-816.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_816.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @_Z4sortP1fi(%struct.f* %19, i32 %20)
  br label %21
...
; Function Attrs: noinline uwtable
define dso_local %struct.in* @_Z2cri(i32 %0) #0 {
  %2 = alloca i32, align 4
...
31:                                               ; preds = %27
  ...
  %39 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), i8* %36, i32* %38)
...
define dso_local void @_Z4sortP1fi(%struct.f* %0, i32 %1) #5 {
  %3 = alloca %struct.f*, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_816.cpp() #0 section ".text.startup" {
