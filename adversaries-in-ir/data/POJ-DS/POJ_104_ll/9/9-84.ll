; ModuleID = 'POJ-104-source/9/9-84.cpp'
source_filename = "POJ-104-source/9/9-84.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_84.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %18 = getelementptr inbounds [100 x %struct.patient], [100 x %struct.patient]* @pa, i64 0, i64 %17
  ...
  %23 = getelementptr inbounds [100 x %struct.patient], [100 x %struct.patient]* @pa, i64 0, i64 %22
...
34:                                               ; preds = %30
  ...
  %37 = getelementptr inbounds [100 x %struct.patient], [100 x %struct.patient]* @pa, i64 0, i64 %36
...
41:                                               ; preds = %34
  ...
  %49 = bitcast %struct.patient* %44 to i8*
...
52:                                               ; preds = %34
  ...
  %55 = getelementptr inbounds [100 x %struct.patient], [100 x %struct.patient]* @pa, i64 0, i64 %54
...
94:                                               ; preds = %81
  ...
  %98 = bitcast %struct.patient* %9 to i8*
  ...
  %108 = bitcast %struct.patient* %103 to i8*
  ...
  %114 = bitcast %struct.patient* %9 to i8*
...
123:                                              ; preds = %68
  %124 = getelementptr inbounds [100 x %struct.patient], [100 x %struct.patient]* %7, i64 0, i64 0
...
132:                                              ; preds = %128
  ...
  %135 = getelementptr inbounds [100 x %struct.patient], [100 x %struct.patient]* %7, i64 0, i64 %134
...
142:                                              ; preds = %128
  %143 = getelementptr inbounds [100 x %struct.patient], [100 x %struct.patient]* %8, i64 0, i64 0
...
151:                                              ; preds = %147
  ...
  %154 = getelementptr inbounds [100 x %struct.patient], [100 x %struct.patient]* %8, i64 0, i64 %153
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_84.cpp() #0 section ".text.startup" {
