; ModuleID = 'POJ-104-source/9/9-867.cpp'
source_filename = "POJ-104-source/9/9-867.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_867.cpp, i8* null }]
...
18:                                               ; preds = %14
  ...
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i8* %19, i32* %5)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_867.cpp() #0 section ".text.startup" {
