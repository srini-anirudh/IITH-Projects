; ModuleID = 'POJ-104-source/9/9-880.cpp'
source_filename = "POJ-104-source/9/9-880.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_880.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %23 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %19, i32* %22)
  br label %24
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_880.cpp() #0 section ".text.startup" {
