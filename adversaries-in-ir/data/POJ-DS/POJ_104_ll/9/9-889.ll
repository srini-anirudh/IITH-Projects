; ModuleID = 'POJ-104-source/9/9-889.cpp'
source_filename = "POJ-104-source/9/9-889.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_889.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %10 = load %struct.pat*, %struct.pat** %3, align 8
  ...
  %13 = getelementptr inbounds %struct.pat, %struct.pat* %12, i32 0, i32 0
...
22:                                               ; preds = %18
  ...
  %31 = getelementptr inbounds %struct.pat, %struct.pat* %30, i32 0, i32 0
  ...
  %35 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %32, i32* %34)
  %36 = load %struct.pat*, %struct.pat** %3, align 8
  %37 = getelementptr inbounds %struct.pat, %struct.pat* %36, i32 0, i32 2
  store %struct.pat* null, %struct.pat** %37, align 8
  br label %38
...
41:                                               ; preds = %18
  %42 = load %struct.pat*, %struct.pat** %2, align 8
  %43 = load i32, i32* %5, align 4
  call void @_Z6searchP3pati(%struct.pat* %42, i32 %43)
...
; Function Attrs: noinline uwtable
define dso_local void @_Z6searchP3pati(%struct.pat* %0, i32 %1) #0 {
  %3 = alloca %struct.pat*, align 8
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
...
92:                                               ; preds = %18
  ...
  %95 = call %struct.pat* @_Z4sortP3pati(%struct.pat* %93, i32 %94)
  %96 = load %struct.pat*, %struct.pat** %11, align 8
  %97 = load %struct.pat*, %struct.pat** %12, align 8
  %98 = load i32, i32* %6, align 4
  %99 = load i32, i32* %7, align 4
  call void @_Z5printP3patS0_ii(%struct.pat* %96, %struct.pat* %97, i32 %98, i32 %99)
  ret void
}
...
define dso_local %struct.pat* @_Z4sortP3pati(%struct.pat* %0, i32 %1) #5 {
  %3 = alloca %struct.pat*, align 8
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5printP3patS0_ii(%struct.pat* %0, %struct.pat* %1, i32 %2, i32 %3) #0 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_889.cpp() #0 section ".text.startup" {
