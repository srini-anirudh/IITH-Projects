; ModuleID = 'POJ-104-source/9/9-951.cpp'
source_filename = "POJ-104-source/9/9-951.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_951.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %15 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32* %9)
...
20:                                               ; preds = %16
  ...
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), [10 x i8]* %22, i32* %24)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_951.cpp() #0 section ".text.startup" {
