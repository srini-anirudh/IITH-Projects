; ModuleID = 'POJ-104-source/9/9-969.cpp'
source_filename = "POJ-104-source/9/9-969.cpp"
...
@head = dso_local global %struct.pa* null, align 8
@p = dso_local global %struct.pa* null, align 8
@p2 = dso_local global %struct.pa* null, align 8
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [6 x i8] c"%s %d\00", align 1
@.str.2 = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_969.cpp, i8* null }]
...
28:                                               ; preds = %24
  ...
  %36 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i8* %33, i32* %35)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_969.cpp() #0 section ".text.startup" {
