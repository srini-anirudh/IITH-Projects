; ModuleID = 'POJ-104-source/9/9-998.cpp'
source_filename = "POJ-104-source/9/9-998.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_9_998.cpp, i8* null }]
...
64:                                               ; preds = %57
  ...
  call void @_Z6changeP8hospital(%struct.hospital* %65)
  br label %66
...
88:                                               ; preds = %78
  ...
  call void @_Z6changeP8hospital(%struct.hospital* %89)
  br label %90
...
define dso_local void @_Z6changeP8hospital(%struct.hospital* %0) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_9_998.cpp() #0 section ".text.startup" {
