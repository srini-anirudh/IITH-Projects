; ModuleID = 'POJ-104-source/90/90-128.cpp'
source_filename = "POJ-104-source/90/90-128.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_90_128.cpp, i8* null }]
...
13:                                               ; preds = %9
  ...
  %16 = getelementptr inbounds [1000 x [2 x i32]], [1000 x [2 x i32]]* %3, i64 0, i64 %15
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_90_128.cpp() #0 section ".text.startup" {
