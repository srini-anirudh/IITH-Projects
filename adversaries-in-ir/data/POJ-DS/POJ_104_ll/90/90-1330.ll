; ModuleID = 'POJ-104-source/90/90-1330.cpp'
source_filename = "POJ-104-source/90/90-1330.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_90_1330.cpp, i8* null }]
...
30:                                               ; preds = %26
  ...
  %46 = call i32 @_Z1fiii(i32 %35, i32 %40, i32 %45)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_90_1330.cpp() #0 section ".text.startup" {
