; ModuleID = 'POJ-104-source/90/90-1700.cpp'
source_filename = "POJ-104-source/90/90-1700.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_90_1700.cpp, i8* null }]
...
12:                                               ; preds = %8
  ...
  %28 = call i32 @_Z3wayii(i32 %23, i32 %27)
...
define dso_local i32 @_Z3wayii(i32 %0, i32 %1) #5 {
  %3 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_90_1700.cpp() #0 section ".text.startup" {
