; ModuleID = 'POJ-104-source/90/90-18.cpp'
source_filename = "POJ-104-source/90/90-18.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_90_18.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z5dstbtii(i32 %0, i32 %1) #0 {
...
25:                                               ; preds = %21
  ...
  %28 = sub nsw i32 %27, 1
  %29 = call i32 @_Z5dstbtii(i32 %26, i32 %28)
  %30 = load i32, i32* %3, align 4
  %31 = load i32, i32* %4, align 4
  %32 = sub nsw i32 %30, %31
  %33 = load i32, i32* %4, align 4
  %34 = call i32 @_Z5dstbtii(i32 %32, i32 %33)
...
14:                                               ; preds = %10
  ...
  %21 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %17, i32* %20)
...
37:                                               ; preds = %27, %14
  ...
  %46 = call i32 @_Z5dstbtii(i32 %41, i32 %45)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_90_18.cpp() #0 section ".text.startup" {
