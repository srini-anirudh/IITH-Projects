; ModuleID = 'POJ-104-source/90/90-1805.cpp'
source_filename = "POJ-104-source/90/90-1805.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_90_1805.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z3allii(i32 %0, i32 %1) #0 {
  ...
  %8 = call i32 @_Z5emptyii(i32 %6, i32 %7)
  %9 = load i32, i32* %3, align 4
  %10 = load i32, i32* %4, align 4
  %11 = call i32 @_Z7noemptyii(i32 %9, i32 %10)
  %12 = add nsw i32 %8, %11
...
9:                                                ; preds = %2
  ...
  %12 = sub nsw i32 %11, 1
  %13 = call i32 @_Z3allii(i32 %10, i32 %12)
...
17:                                               ; preds = %11
  ...
  %22 = call i32 @_Z3allii(i32 %20, i32 %21)
...
29:                                               ; preds = %25
  ...
  %38 = call i32 @_Z3allii(i32 %33, i32 %37)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_90_1805.cpp() #0 section ".text.startup" {
