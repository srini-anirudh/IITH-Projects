; ModuleID = 'POJ-104-source/90/90-1874.cpp'
source_filename = "POJ-104-source/90/90-1874.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_90_1874.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z6layoutii(i32 %0, i32 %1) #0 {
...
22:                                               ; preds = %18
  ...
  %25 = call i32 @_Z6layoutii(i32 %23, i32 %24)
...
13:                                               ; preds = %9
  ...
  %34 = call i32 @_Z6layoutii(i32 %29, i32 %33)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_90_1874.cpp() #0 section ".text.startup" {
