; ModuleID = 'POJ-104-source/90/90-2658.cpp'
source_filename = "POJ-104-source/90/90-2658.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_90_2658.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z2ssii(i32 %0, i32 %1) #0 {
...
34:                                               ; preds = %25
  ...
  %44 = call i32 @_Z2ssii(i32 %40, i32 %43)
  br label %45
...
10:                                               ; preds = %7
  %11 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %3, i32* %2)
  store i32 1, i32* %5, align 4
  br label %12
...
23:                                               ; preds = %12
  ...
  %30 = call i32 @_Z2ssii(i32 %28, i32 %29)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_90_2658.cpp() #0 section ".text.startup" {
