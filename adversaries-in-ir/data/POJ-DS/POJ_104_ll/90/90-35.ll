; ModuleID = 'POJ-104-source/90/90-35.cpp'
source_filename = "POJ-104-source/90/90-35.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_90_35.cpp, i8* null }]
...
20:                                               ; preds = %16
  %21 = getelementptr inbounds [100 x [100 x i32]], [100 x [100 x i32]]* %2, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_90_35.cpp() #0 section ".text.startup" {
