; ModuleID = 'POJ-104-source/90/90-356.cpp'
source_filename = "POJ-104-source/90/90-356.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_90_356.cpp, i8* null }]
...
11:                                               ; preds = %6
  ...
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32* %15, i32* %19)
  br label %21
...
30:                                               ; preds = %25
  ...
  %41 = call i32 @_Z3putii(i32 %35, i32 %40)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_90_356.cpp() #0 section ".text.startup" {
