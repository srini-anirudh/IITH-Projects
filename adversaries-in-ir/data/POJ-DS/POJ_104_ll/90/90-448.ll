; ModuleID = 'POJ-104-source/90/90-448.cpp'
source_filename = "POJ-104-source/90/90-448.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_90_448.cpp, i8* null }]
...
15:                                               ; preds = %11
  ...
  %31 = call i32 @_Z5appleii(i32 %26, i32 %30)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_90_448.cpp() #0 section ".text.startup" {
