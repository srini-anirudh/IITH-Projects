; ModuleID = 'POJ-104-source/90/90-493.cpp'
source_filename = "POJ-104-source/90/90-493.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_90_493.cpp, i8* null }]
...
11:                                               ; preds = %7
  ...
  %14 = getelementptr inbounds [100 x [2 x i32]], [100 x [2 x i32]]* %5, i64 0, i64 %13
...
30:                                               ; preds = %26
  ...
  %33 = getelementptr inbounds [100 x [2 x i32]], [100 x [2 x i32]]* %5, i64 0, i64 %32
  ...
  %41 = call i32 @_Z1fii(i32 %35, i32 %40)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_90_493.cpp() #0 section ".text.startup" {
