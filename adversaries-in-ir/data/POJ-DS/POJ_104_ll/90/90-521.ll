; ModuleID = 'POJ-104-source/90/90-521.cpp'
source_filename = "POJ-104-source/90/90-521.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_90_521.cpp, i8* null }]
...
13:                                               ; preds = %8
  ...
  %17 = call signext i16 @_Z5appleii(i32 %15, i32 %16)
...
; Function Attrs: noinline uwtable
define dso_local signext i16 @_Z5appleii(i32 %0, i32 %1) #0 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
...
16:                                               ; preds = %12
  ...
  %21 = call signext i16 @_Z5appleii(i32 %19, i32 %20)
...
22:                                               ; preds = %16, %12
  ...
  %27 = sub nsw i32 %26, 1
  %28 = call signext i16 @_Z5appleii(i32 %25, i32 %27)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_90_521.cpp() #0 section ".text.startup" {
