; ModuleID = 'POJ-104-source/90/90-584.cpp'
source_filename = "POJ-104-source/90/90-584.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_90_584.cpp, i8* null }]
...
12:                                               ; preds = %7
  ...
  %32 = call i32 @_Z4fullii(i32 %26, i32 %31)
  ...
  %43 = call i32 @_Z5emptyii(i32 %37, i32 %42)
...
9:                                                ; preds = %2
  ...
  %14 = call i32 @_Z4fullii(i32 %10, i32 %13)
  %15 = load i32, i32* %3, align 4
  %16 = load i32, i32* %4, align 4
  %17 = load i32, i32* %3, align 4
  %18 = sub nsw i32 %16, %17
  %19 = call i32 @_Z5emptyii(i32 %15, i32 %18)
...
9:                                                ; preds = %2
  ...
  %13 = call i32 @_Z4fullii(i32 %11, i32 %12)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_90_584.cpp() #0 section ".text.startup" {
