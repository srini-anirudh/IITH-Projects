; ModuleID = 'POJ-104-source/90/90-593.cpp'
source_filename = "POJ-104-source/90/90-593.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_90_593.cpp, i8* null }]
...
74:                                               ; preds = %68
  ...
  %84 = call i32 @_Z1fiii(i32 %78, i32 %80, i32 %83)
...
86:                                               ; preds = %68
  ...
  %94 = call i32 @_Z1fiii(i32 %90, i32 %92, i32 %93)
...
115:                                              ; preds = %109
  ...
  %125 = call i32 @_Z1fiii(i32 %119, i32 %121, i32 %124)
...
127:                                              ; preds = %109
  ...
  %135 = call i32 @_Z1fiii(i32 %131, i32 %133, i32 %134)
...
29:                                               ; preds = %25
  ...
  %42 = call i32 @_Z1fiii(i32 %33, i32 %37, i32 %41)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_90_593.cpp() #0 section ".text.startup" {
