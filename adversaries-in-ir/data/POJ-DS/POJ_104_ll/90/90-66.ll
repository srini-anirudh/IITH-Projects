; ModuleID = 'POJ-104-source/90/90-66.cpp'
source_filename = "POJ-104-source/90/90-66.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_90_66.cpp, i8* null }]
...
9:                                                ; preds = %2
  ...
  %12 = call i32 @_Z5diguiii(i32 %10, i32 %11)
...
20:                                               ; preds = %16
  ...
  %23 = sub nsw i32 %22, 1
  %24 = call i32 @_Z5diguiii(i32 %21, i32 %23)
  %25 = load i32, i32* %4, align 4
  %26 = load i32, i32* %5, align 4
  %27 = sub nsw i32 %25, %26
  %28 = load i32, i32* %5, align 4
  %29 = call i32 @_Z5diguiii(i32 %27, i32 %28)
...
16:                                               ; preds = %12
  ...
  %23 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32* %19, i32* %22)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_90_66.cpp() #0 section ".text.startup" {
