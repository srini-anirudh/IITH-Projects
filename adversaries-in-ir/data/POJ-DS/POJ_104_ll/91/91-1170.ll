; ModuleID = 'POJ-104-source/91/91-1170.cpp'
source_filename = "POJ-104-source/91/91-1170.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_91_1170.cpp, i8* null }]
...
20:                                               ; preds = %8
  ...
  %23 = call i8* @strcat(i8* %21, i8* %22) #3
  br label %25
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_91_1170.cpp() #0 section ".text.startup" {
