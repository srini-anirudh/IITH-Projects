; ModuleID = 'POJ-104-source/92/92-1004.cpp'
source_filename = "POJ-104-source/92/92-1004.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_1004.cpp, i8* null }]
...
38:                                               ; preds = %26
  ...
  call void @qsort(i8* bitcast ([1000 x i32]* @x to i8*), i64 %40, i64 4, i32 (i8*, i8*)* @_Z5myCmpPKvS0_)
  %41 = load i32, i32* @n, align 4
  %42 = sext i32 %41 to i64
  call void @qsort(i8* bitcast ([1000 x i32]* @y to i8*), i64 %42, i64 4, i32 (i8*, i8*)* @_Z5myCmpPKvS0_)
...
125:                                              ; preds = %51
  ...
  %129 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* @n)
  br label %9
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_1004.cpp() #0 section ".text.startup" {
