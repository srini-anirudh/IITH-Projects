; ModuleID = 'POJ-104-source/92/92-1063.cpp'
source_filename = "POJ-104-source/92/92-1063.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_1063.cpp, i8* null }]
...
16:                                               ; preds = %0, %257
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %12)
...
246:                                              ; preds = %239
  ...
  %248 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i64 %247)
  store i32 1, i32* %8, align 4
  br label %252

249:                                              ; preds = %239
  %250 = load i64, i64* %15, align 8
  %251 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i64 %250)
  br label %252
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_1063.cpp() #0 section ".text.startup" {
