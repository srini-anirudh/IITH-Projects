; ModuleID = 'POJ-104-source/92/92-1078.cpp'
source_filename = "POJ-104-source/92/92-1078.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_1078.cpp, i8* null }]
...
define dso_local i32 @_Z5counti(i32 %0) #4 {
...
36:                                               ; preds = %24
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([1100 x i32], [1100 x i32]* @a, i64 0, i64 0), i32* %39)
  %40 = load i32, i32* @n, align 4
  %41 = sext i32 %40 to i64
  %42 = getelementptr inbounds i32, i32* getelementptr inbounds ([1100 x i32], [1100 x i32]* @b, i64 0, i64 0), i64 %41
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([1100 x i32], [1100 x i32]* @b, i64 0, i64 0), i32* %42)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_1078.cpp() #0 section ".text.startup" {
