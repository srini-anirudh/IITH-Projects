; ModuleID = 'POJ-104-source/92/92-1080.cpp'
source_filename = "POJ-104-source/92/92-1080.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_1080.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z2mai(i32 %0) #0 {
  %2 = alloca i32, align 4
...
41:                                               ; preds = %29
  ...
  %45 = call i32 @_Z5paixuPiS_i(i32* %42, i32* %43, i32 %44)
  br label %46
...
define dso_local i32 @_Z5paixuPiS_i(i32* %0, i32* %1, i32 %2) #5 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z6changePiS_(i32* %0, i32* %1) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_1080.cpp() #0 section ".text.startup" {
