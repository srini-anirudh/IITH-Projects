; ModuleID = 'POJ-104-source/92/92-1084.cpp'
source_filename = "POJ-104-source/92/92-1084.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_1084.cpp, i8* null }]
...
5:                                                ; preds = %0, %36
  %6 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* @horseNum)
...
36:                                               ; preds = %24
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([1000 x i32], [1000 x i32]* @speedT, i64 0, i64 0), i32* %39)
  %40 = load i32, i32* @horseNum, align 4
  %41 = sext i32 %40 to i64
  %42 = getelementptr inbounds i32, i32* getelementptr inbounds ([1000 x i32], [1000 x i32]* @speedK, i64 0, i64 0), i64 %41
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([1000 x i32], [1000 x i32]* @speedK, i64 0, i64 0), i32* %42)
...
define dso_local i32 @_Z6searchv() #5 {
  %1 = alloca i32, align 4
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_1084.cpp() #0 section ".text.startup" {
