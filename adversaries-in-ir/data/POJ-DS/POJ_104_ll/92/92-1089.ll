; ModuleID = 'POJ-104-source/92/92-1089.cpp'
source_filename = "POJ-104-source/92/92-1089.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_1089.cpp, i8* null }]
...
63:                                               ; preds = %53
  ...
  call void @_Z4swapPiS_(i32* %66, i32* %69)
  br label %70
...
80:                                               ; preds = %70
  ...
  call void @_Z4swapPiS_(i32* %83, i32* %86)
  br label %87
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_1089.cpp() #0 section ".text.startup" {
