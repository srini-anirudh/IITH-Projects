; ModuleID = 'POJ-104-source/92/92-1105.cpp'
source_filename = "POJ-104-source/92/92-1105.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_1105.cpp, i8* null }]
...
51:                                               ; preds = %39
  ...
  call void @qsort(i8* %53, i64 %55, i64 4, i32 (i8*, i8*)* @_ZL3cmpPKvS0_)
  %56 = getelementptr inbounds [1000 x i32], [1000 x i32]* %4, i64 0, i64 0
  %57 = bitcast i32* %56 to i8*
  %58 = load i32, i32* %2, align 4
  %59 = sext i32 %58 to i64
  call void @qsort(i8* %57, i64 %59, i64 4, i32 (i8*, i8*)* @_ZL3cmpPKvS0_)
...
define internal i32 @_ZL3cmpPKvS0_(i8* %0, i8* %1) #6 {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_1105.cpp() #0 section ".text.startup" {
