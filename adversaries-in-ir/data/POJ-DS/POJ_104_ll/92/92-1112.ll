; ModuleID = 'POJ-104-source/92/92-1112.cpp'
source_filename = "POJ-104-source/92/92-1112.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_1112.cpp, i8* null }]
...
47:                                               ; preds = %35
  ...
  call void @qsort(i8* %53, i64 %55, i64 4, i32 (i8*, i8*)* @_Z7comparePKvS0_)
...
116:                                              ; preds = %66
  ...
  %127 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %2)
  br label %16
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_1112.cpp() #0 section ".text.startup" {
