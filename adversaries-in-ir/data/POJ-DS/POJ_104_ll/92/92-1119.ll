; ModuleID = 'POJ-104-source/92/92-1119.cpp'
source_filename = "POJ-104-source/92/92-1119.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_1119.cpp, i8* null }]
...
define dso_local i32 @_Z4findPiii(i32* %0, i32 %1, i32 %2) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z9partitionPiiii(i32* %0, i32 %1, i32 %2, i32 %3) #4 {
  %5 = alloca i32*, align 8
  %6 = alloca i32, align 4
  %7 = alloca i32, align 4
  %8 = alloca i32, align 4
...
define dso_local void @_Z9quicksortPiii(i32* %0, i32 %1, i32 %2) #0 {
  ...
  %12 = load i32, i32* %6, align 4
  %13 = call i32 @_Z4findPiii(i32* %10, i32 %11, i32 %12)
...
16:                                               ; preds = %3
  ...
  %26 = call i32 @_Z9partitionPiiii(i32* %22, i32 %23, i32 %24, i32 %25)
  ...
  call void @_Z9quicksortPiii(i32* %31, i32 %32, i32 %33)
  br label %34
...
43:                                               ; preds = %31
  ...
  %46 = sub nsw i32 %45, 1
  call void @_Z9quicksortPiii(i32* %44, i32 0, i32 %46)
  %47 = getelementptr inbounds [1000 x i32], [1000 x i32]* %8, i64 0, i64 0
  %48 = load i32, i32* %2, align 4
  %49 = sub nsw i32 %48, 1
  call void @_Z9quicksortPiii(i32* %47, i32 0, i32 %49)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_1119.cpp() #0 section ".text.startup" {
