; ModuleID = 'POJ-104-source/92/92-1131.cpp'
source_filename = "POJ-104-source/92/92-1131.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_1131.cpp, i8* null }]
...
define dso_local i32 @_Z6getcmpii(i32 %0, i32 %1) #4 {
...
63:                                               ; preds = %59
  ...
  %75 = call i32 @_Z6getcmpii(i32 %70, i32 %74)
...
89:                                               ; preds = %83
  ...
  %100 = call i32 @_Z6getcmpii(i32 %93, i32 %99)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_1131.cpp() #0 section ".text.startup" {
