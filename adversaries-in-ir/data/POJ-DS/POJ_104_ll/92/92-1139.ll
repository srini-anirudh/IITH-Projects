; ModuleID = 'POJ-104-source/92/92-1139.cpp'
source_filename = "POJ-104-source/92/92-1139.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_1139.cpp, i8* null }]
...
28:                                               ; preds = %16
  ...
  call void @_Z4sortPii(i32* getelementptr inbounds ([1001 x i32], [1001 x i32]* @a, i64 0, i64 0), i32 %29)
  store i32 0, i32* %3, align 4
  br label %30
...
42:                                               ; preds = %30
  ...
  call void @_Z4sortPii(i32* getelementptr inbounds ([1001 x i32], [1001 x i32]* @b, i64 0, i64 0), i32 %43)
...
123:                                              ; preds = %46
  ...
  %130 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %2)
  br label %12
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_1139.cpp() #0 section ".text.startup" {
