; ModuleID = 'POJ-104-source/92/92-1156.cpp'
source_filename = "POJ-104-source/92/92-1156.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_1156.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z5moneyi(i32 %0) #0 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_1156.cpp() #0 section ".text.startup" {
