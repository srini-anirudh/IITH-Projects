; ModuleID = 'POJ-104-source/92/92-1159.cpp'
source_filename = "POJ-104-source/92/92-1159.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_1159.cpp, i8* null }]
...
define dso_local i32 @_Z5fightii(i32 %0, i32 %1) #4 {
...
44:                                               ; preds = %32
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([1024 x i32], [1024 x i32]* @speed, i64 0, i64 0), i32* %47)
  %48 = load i32, i32* %2, align 4
  %49 = sext i32 %48 to i64
  %50 = getelementptr inbounds i32, i32* getelementptr inbounds ([1024 x i32], [1024 x i32]* @ano, i64 0, i64 0), i64 %49
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([1024 x i32], [1024 x i32]* @ano, i64 0, i64 0), i32* %50)
...
59:                                               ; preds = %55
  ...
  %62 = getelementptr inbounds [1024 x i32], [1024 x i32]* @speed, i64 0, i64 %61
  %63 = load i32, i32* %62, align 4
  %64 = load i32, i32* %8, align 4
  %65 = sext i32 %64 to i64
  %66 = getelementptr inbounds [1024 x i32], [1024 x i32]* @ano, i64 0, i64 %65
...
69:                                               ; preds = %59
  ...
  %72 = call i32 @_Z5fightii(i32 %70, i32 %71)
...
79:                                               ; preds = %59
  ...
  %82 = getelementptr inbounds [1024 x i32], [1024 x i32]* @speed, i64 0, i64 %81
  %83 = load i32, i32* %82, align 4
  %84 = load i32, i32* %8, align 4
  %85 = sext i32 %84 to i64
  %86 = getelementptr inbounds [1024 x i32], [1024 x i32]* @ano, i64 0, i64 %85
...
89:                                               ; preds = %79
  ...
  %92 = call i32 @_Z5fightii(i32 %90, i32 %91)
...
99:                                               ; preds = %79
  ...
  %102 = getelementptr inbounds [1024 x i32], [1024 x i32]* @speed, i64 0, i64 %101
  %103 = load i32, i32* %102, align 4
  %104 = load i32, i32* %9, align 4
  %105 = sext i32 %104 to i64
  %106 = getelementptr inbounds [1024 x i32], [1024 x i32]* @ano, i64 0, i64 %105
...
109:                                              ; preds = %99
  ...
  %112 = call i32 @_Z5fightii(i32 %110, i32 %111)
...
119:                                              ; preds = %99
  ...
  %122 = getelementptr inbounds [1024 x i32], [1024 x i32]* @speed, i64 0, i64 %121
  %123 = load i32, i32* %122, align 4
  %124 = load i32, i32* %9, align 4
  %125 = sext i32 %124 to i64
  %126 = getelementptr inbounds [1024 x i32], [1024 x i32]* @ano, i64 0, i64 %125
...
129:                                              ; preds = %119
  ...
  %132 = call i32 @_Z5fightii(i32 %130, i32 %131)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_1159.cpp() #0 section ".text.startup" {
