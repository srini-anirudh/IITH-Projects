; ModuleID = 'POJ-104-source/92/92-1191.cpp'
source_filename = "POJ-104-source/92/92-1191.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_1191.cpp, i8* null }]
...
define dso_local i32 @_Z6cmpIntPKvS0_(i8* %0, i8* %1) #4 {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
...
38:                                               ; preds = %26
  ...
  call void @qsort(i8* bitcast ([1000 x i32]* @t to i8*), i64 %40, i64 4, i32 (i8*, i8*)* @_Z6cmpIntPKvS0_)
  %41 = load i32, i32* @n, align 4
  %42 = sext i32 %41 to i64
  call void @qsort(i8* bitcast ([1000 x i32]* @w to i8*), i64 %42, i64 4, i32 (i8*, i8*)* @_Z6cmpIntPKvS0_)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_1191.cpp() #0 section ".text.startup" {
