; ModuleID = 'POJ-104-source/92/92-1200.cpp'
source_filename = "POJ-104-source/92/92-1200.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_1200.cpp, i8* null }]
...
45:                                               ; preds = %33
  ...
  call void @_Z4sortPii(i32* %48, i32 %49)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_1200.cpp() #0 section ".text.startup" {
