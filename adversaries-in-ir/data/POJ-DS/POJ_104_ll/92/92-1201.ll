; ModuleID = 'POJ-104-source/92/92-1201.cpp'
source_filename = "POJ-104-source/92/92-1201.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_1201.cpp, i8* null }]
...
52:                                               ; preds = %40
  ...
  call void @_Z4sortPii(i32* %23, i32 %53)
  %54 = load i32, i32* %2, align 4
  call void @_Z4sortPii(i32* %26, i32 %54)
...
137:                                              ; preds = %59
  ...
  %144 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %2)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_1201.cpp() #0 section ".text.startup" {
