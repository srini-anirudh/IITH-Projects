; ModuleID = 'POJ-104-source/92/92-1203.cpp'
source_filename = "POJ-104-source/92/92-1203.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_1203.cpp, i8* null }]
...
50:                                               ; preds = %38
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([1000 x i32], [1000 x i32]* @tianji, i64 0, i64 0), i32* %53)
  %54 = load i32, i32* %2, align 4
  %55 = sext i32 %54 to i64
  %56 = getelementptr inbounds i32, i32* getelementptr inbounds ([1000 x i32], [1000 x i32]* @qiwang, i64 0, i64 0), i64 %55
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([1000 x i32], [1000 x i32]* @qiwang, i64 0, i64 0), i32* %56)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_1203.cpp() #0 section ".text.startup" {
