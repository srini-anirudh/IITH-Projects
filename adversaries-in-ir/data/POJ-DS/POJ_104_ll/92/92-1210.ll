; ModuleID = 'POJ-104-source/92/92-1210.cpp'
source_filename = "POJ-104-source/92/92-1210.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_1210.cpp, i8* null }]
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z4findii(i32 %0, i32 %1) #4 {
...
39:                                               ; preds = %27
  ...
  call void @qsort(i8* bitcast ([1001 x i32]* @a to i8*), i64 %41, i64 4, i32 (i8*, i8*)* @_Z3cmpPKvS0_)
  %42 = load i32, i32* %2, align 4
  %43 = sext i32 %42 to i64
  call void @qsort(i8* bitcast ([1001 x i32]* @b to i8*), i64 %43, i64 4, i32 (i8*, i8*)* @_Z3cmpPKvS0_)
  store i32 0, i32* %3, align 4
  br label %44
...
48:                                               ; preds = %44
  ...
  %50 = call i32 @_Z4findii(i32 0, i32 %49)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_1210.cpp() #0 section ".text.startup" {
