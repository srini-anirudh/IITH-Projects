; ModuleID = 'POJ-104-source/92/92-1220.cpp'
source_filename = "POJ-104-source/92/92-1220.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_1220.cpp, i8* null }]
...
110:                                              ; preds = %106
  ...
  %115 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %114)
  br label %116
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_1220.cpp() #0 section ".text.startup" {
