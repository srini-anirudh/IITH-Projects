; ModuleID = 'POJ-104-source/92/92-1260.cpp'
source_filename = "POJ-104-source/92/92-1260.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_1260.cpp, i8* null }]
...
define dso_local void @_Z4listPii(i32* %0, i32 %1) #4 {
...
44:                                               ; preds = %32
  ...
  call void @_Z4listPii(i32* %45, i32 %46)
  %47 = getelementptr inbounds [1010 x i32], [1010 x i32]* %5, i64 0, i64 0
  %48 = load i32, i32* %2, align 4
  call void @_Z4listPii(i32* %47, i32 %48)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_1260.cpp() #0 section ".text.startup" {
