; ModuleID = 'POJ-104-source/92/92-1302.cpp'
source_filename = "POJ-104-source/92/92-1302.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_1302.cpp, i8* null }]
...
57:                                               ; preds = %44
  ...
  call void @_Z4sortPii(i32* %58, i32 %59)
  %60 = load i32*, i32** %6, align 8
  %61 = load i32, i32* %2, align 4
  call void @_Z4sortPii(i32* %60, i32 %61)
  store i32 0, i32* %7, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_1302.cpp() #0 section ".text.startup" {
