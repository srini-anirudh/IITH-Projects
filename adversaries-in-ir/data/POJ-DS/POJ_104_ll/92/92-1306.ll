; ModuleID = 'POJ-104-source/92/92-1306.cpp'
source_filename = "POJ-104-source/92/92-1306.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_1306.cpp, i8* null }]
...
define dso_local i32 @_Z5paixuPKvS0_(i8* %0, i8* %1) #4 {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
...
53:                                               ; preds = %41
  ...
  call void @qsort(i8* %54, i64 %56, i64 4, i32 (i8*, i8*)* @_Z5paixuPKvS0_)
  %57 = bitcast i32* %27 to i8*
  %58 = load i32, i32* %2, align 4
  %59 = sext i32 %58 to i64
  call void @qsort(i8* %57, i64 %59, i64 4, i32 (i8*, i8*)* @_Z5paixuPKvS0_)
  store i32 0, i32* %3, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_1306.cpp() #0 section ".text.startup" {
