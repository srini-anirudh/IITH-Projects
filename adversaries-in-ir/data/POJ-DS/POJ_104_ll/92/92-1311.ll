; ModuleID = 'POJ-104-source/92/92-1311.cpp'
source_filename = "POJ-104-source/92/92-1311.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_1311.cpp, i8* null }]
...
37:                                               ; preds = %25
  ...
  %40 = getelementptr inbounds i32, i32* getelementptr inbounds ([1001 x i32], [1001 x i32]* @a, i64 0, i64 0), i64 %39
  %41 = getelementptr inbounds i32, i32* %40, i64 1
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([1001 x i32], [1001 x i32]* @a, i64 0, i64 1), i32* %41)
  %42 = load i32, i32* @N, align 4
  %43 = sext i32 %42 to i64
  %44 = getelementptr inbounds i32, i32* getelementptr inbounds ([1001 x i32], [1001 x i32]* @b, i64 0, i64 0), i64 %43
  %45 = getelementptr inbounds i32, i32* %44, i64 1
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([1001 x i32], [1001 x i32]* @b, i64 0, i64 1), i32* %45)
...
65:                                               ; preds = %55
  ...
  %78 = getelementptr inbounds [1001 x [1001 x i32]], [1001 x [1001 x i32]]* @f, i64 0, i64 %77
...
82:                                               ; preds = %55
  ...
  %85 = getelementptr inbounds [1001 x i32], [1001 x i32]* @a, i64 0, i64 %84
...
92:                                               ; preds = %82
  ...
  %104 = getelementptr inbounds [1001 x [1001 x i32]], [1001 x [1001 x i32]]* @f, i64 0, i64 %103
...
108:                                              ; preds = %82
  ...
  %119 = getelementptr inbounds [1001 x [1001 x i32]], [1001 x [1001 x i32]]* @f, i64 0, i64 %118
  %120 = load i32, i32* %5, align 4
  %121 = sub nsw i32 %120, 1
  %122 = sext i32 %121 to i64
  %123 = getelementptr inbounds [1001 x i32], [1001 x i32]* %119, i64 0, i64 %122
  %124 = load i32, i32* %123, align 4
  %125 = sub nsw i32 %124, 1
  store i32 %125, i32* %6, align 4
  %126 = call dereferenceable(4) i32* @_ZSt3maxIiERKT_S2_S2_(i32* dereferenceable(4) %116, i32* dereferenceable(4) %6)
  %127 = load i32, i32* %126, align 4
  %128 = load i32, i32* %4, align 4
  %129 = sext i32 %128 to i64
  %130 = getelementptr inbounds [1001 x [1001 x i32]], [1001 x [1001 x i32]]* @f, i64 0, i64 %129
...
143:                                              ; preds = %46
  ...
  %153 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* @N)
  br label %8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_1311.cpp() #0 section ".text.startup" {
