; ModuleID = 'POJ-104-source/92/92-1323.cpp'
source_filename = "POJ-104-source/92/92-1323.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_1323.cpp, i8* null }]
...
39:                                               ; preds = %27
  ...
  call void @qsort(i8* bitcast ([1000 x i32]* @TianJi to i8*), i64 %41, i64 4, i32 (i8*, i8*)* @_Z3cmpPKvS0_)
  %42 = load i32, i32* %2, align 4
  %43 = sext i32 %42 to i64
  call void @qsort(i8* bitcast ([1000 x i32]* @QiWang to i8*), i64 %43, i64 4, i32 (i8*, i8*)* @_Z3cmpPKvS0_)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_1323.cpp() #0 section ".text.startup" {
