; ModuleID = 'POJ-104-source/92/92-1334.cpp'
source_filename = "POJ-104-source/92/92-1334.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_1334.cpp, i8* null }]
...
47:                                               ; preds = %35
  ...
  %50 = call i32 @_Z4sortPii(i32* %48, i32 %49)
  %51 = getelementptr inbounds [1000 x i32], [1000 x i32]* %4, i64 0, i64 0
  %52 = load i32, i32* %2, align 4
  %53 = call i32 @_Z4sortPii(i32* %51, i32 %52)
  store i32 0, i32* %5, align 4
  br label %54
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_1334.cpp() #0 section ".text.startup" {
