; ModuleID = 'POJ-104-source/92/92-1340.cpp'
source_filename = "POJ-104-source/92/92-1340.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_1340.cpp, i8* null }]
...
39:                                               ; preds = %27
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([1010 x i32], [1010 x i32]* @a, i64 0, i64 1), i32* %42)
  %43 = load i32, i32* %2, align 4
  %44 = sext i32 %43 to i64
  %45 = getelementptr inbounds i32, i32* getelementptr inbounds ([1010 x i32], [1010 x i32]* @b, i64 0, i64 1), i64 %44
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([1010 x i32], [1010 x i32]* @b, i64 0, i64 1), i32* %45)
...
69:                                               ; preds = %52
  ...
  %72 = getelementptr inbounds [1010 x i32], [1010 x i32]* @a, i64 0, i64 %71
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_1340.cpp() #0 section ".text.startup" {
