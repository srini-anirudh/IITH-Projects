; ModuleID = 'POJ-104-source/92/92-1341.cpp'
source_filename = "POJ-104-source/92/92-1341.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_1341.cpp, i8* null }]
...
define dso_local i32 @_Z3funPiS_(i32* %0, i32* %1) #4 {
...
39:                                               ; preds = %27
  ...
  %45 = getelementptr inbounds [1005 x i32], [1005 x i32]* %4, i64 0, i64 0
  %46 = getelementptr inbounds [1005 x i32], [1005 x i32]* %4, i64 0, i64 0
  %47 = load i32, i32* @n, align 4
  %48 = sext i32 %47 to i64
  %49 = getelementptr inbounds i32, i32* %46, i64 %48
  call void @_ZSt4sortIPiEvT_S1_(i32* %45, i32* %49)
  %50 = getelementptr inbounds [1005 x i32], [1005 x i32]* %3, i64 0, i64 0
  %51 = getelementptr inbounds [1005 x i32], [1005 x i32]* %4, i64 0, i64 0
  %52 = call i32 @_Z3funPiS_(i32* %50, i32* %51)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_1341.cpp() #0 section ".text.startup" {
