; ModuleID = 'POJ-104-source/92/92-1343.cpp'
source_filename = "POJ-104-source/92/92-1343.cpp"
...
@l = dso_local global [1000 x [1000 x i32]] zeroinitializer, align 16
@.str = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
@.str.1 = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_1343.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z8readdatav() #0 {
  %1 = alloca i32, align 4
...
define dso_local void @_Z4initv() #5 {
  ...
  call void @_Z4sortPii(i32* getelementptr inbounds ([1000 x i32], [1000 x i32]* @a, i64 0, i64 0), i32 %2)
  %3 = load i32, i32* @n, align 4
  call void @_Z4sortPii(i32* getelementptr inbounds ([1000 x i32], [1000 x i32]* @b, i64 0, i64 0), i32 %3)
  store i32 0, i32* %1, align 4
  br label %4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_1343.cpp() #0 section ".text.startup" {
