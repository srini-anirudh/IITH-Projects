; ModuleID = 'POJ-104-source/92/92-135.cpp'
source_filename = "POJ-104-source/92/92-135.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_135.cpp, i8* null }]
...
27:                                               ; preds = %15
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([1001 x i32], [1001 x i32]* @tian, i64 0, i64 0), i32* %30)
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([1001 x i32], [1001 x i32]* @king, i64 0, i64 0), i32* %33)
  ret void
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_135.cpp() #0 section ".text.startup" {
