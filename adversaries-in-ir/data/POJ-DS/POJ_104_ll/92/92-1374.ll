; ModuleID = 'POJ-104-source/92/92-1374.cpp'
source_filename = "POJ-104-source/92/92-1374.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_1374.cpp, i8* null }]
...
53:                                               ; preds = %41
  %54 = getelementptr inbounds [1000 x i32], [1000 x i32]* %9, i64 0, i64 0
  %55 = bitcast i32* %54 to i8*
  %56 = load i32, i32* %2, align 4
  %57 = sext i32 %56 to i64
  call void @qsort(i8* %55, i64 %57, i64 4, i32 (i8*, i8*)* @_Z7comparePKvS0_)
  %58 = getelementptr inbounds [1000 x i32], [1000 x i32]* %10, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_1374.cpp() #0 section ".text.startup" {
