; ModuleID = 'POJ-104-source/92/92-1376.cpp'
source_filename = "POJ-104-source/92/92-1376.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_1376.cpp, i8* null }]
...
define dso_local i32 @_Z4sortPii(i32* %0, i32 %1) #4 {
...
43:                                               ; preds = %31
  ...
  %46 = call i32 @_Z4sortPii(i32* %44, i32 %45)
  %47 = getelementptr inbounds [1001 x i32], [1001 x i32]* %10, i64 0, i64 0
  %48 = load i32, i32* %5, align 4
  %49 = call i32 @_Z4sortPii(i32* %47, i32 %48)
  store i32 0, i32* %6, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_1376.cpp() #0 section ".text.startup" {
