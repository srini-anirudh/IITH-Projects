; ModuleID = 'POJ-104-source/92/92-1383.cpp'
source_filename = "POJ-104-source/92/92-1383.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_1383.cpp, i8* null }]
...
269:                                              ; preds = %154
  ...
  %273 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i32 %272)
  %274 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %2)
  br label %20
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_1383.cpp() #0 section ".text.startup" {
