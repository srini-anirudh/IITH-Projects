; ModuleID = 'POJ-104-source/92/92-139.cpp'
source_filename = "POJ-104-source/92/92-139.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_139.cpp, i8* null }]
...
40:                                               ; preds = %28
  ...
  call void @qsort(i8* %46, i64 %48, i64 4, i32 (i8*, i8*)* @_Z7comparePKvS0_)
  store i32 0, i32* %2, align 4
  br label %49
...
126:                                              ; preds = %70
  ...
  %130 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %7)
  br label %11
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_139.cpp() #0 section ".text.startup" {
