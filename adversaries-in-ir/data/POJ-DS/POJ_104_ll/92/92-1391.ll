; ModuleID = 'POJ-104-source/92/92-1391.cpp'
source_filename = "POJ-104-source/92/92-1391.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_1391.cpp, i8* null }]
...
45:                                               ; preds = %32
  ...
  call void @qsort(i8* %47, i64 %49, i64 4, i32 (i8*, i8*)* @_ZL3cmpPKvS0_)
  %50 = getelementptr inbounds [1000 x i32], [1000 x i32]* %11, i64 0, i64 0
  %51 = bitcast i32* %50 to i8*
  %52 = load i32, i32* %2, align 4
  %53 = sext i32 %52 to i64
  call void @qsort(i8* %51, i64 %53, i64 4, i32 (i8*, i8*)* @_ZL3cmpPKvS0_)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_1391.cpp() #0 section ".text.startup" {
