; ModuleID = 'POJ-104-source/92/92-1394.cpp'
source_filename = "POJ-104-source/92/92-1394.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_1394.cpp, i8* null }]
...
49:                                               ; preds = %37
  ...
  call void @qsort(i8* %55, i64 %57, i64 4, i32 (i8*, i8*)* @_ZL3cmpPKvS0_)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_1394.cpp() #0 section ".text.startup" {
