; ModuleID = 'POJ-104-source/92/92-1396.cpp'
source_filename = "POJ-104-source/92/92-1396.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_1396.cpp, i8* null }]
...
65:                                               ; preds = %61
  ...
  %70 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %69)
  br label %71
...
74:                                               ; preds = %61
  ...
  call void @qsort(i8* %76, i64 %78, i64 4, i32 (i8*, i8*)* @_ZL3cmpPKvS0_)
  %79 = load i32*, i32** %4, align 8
  %80 = bitcast i32* %79 to i8*
  %81 = load i32, i32* %2, align 4
  %82 = sext i32 %81 to i64
  call void @qsort(i8* %80, i64 %82, i64 4, i32 (i8*, i8*)* @_ZL3cmpPKvS0_)
...
define internal i32 @_ZL3cmpPKvS0_(i8* %0, i8* %1) #5 {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_1396.cpp() #0 section ".text.startup" {
