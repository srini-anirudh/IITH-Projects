; ModuleID = 'POJ-104-source/92/92-1398.cpp'
source_filename = "POJ-104-source/92/92-1398.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_1398.cpp, i8* null }]
...
24:                                               ; preds = %21
  ...
  store i64 0, i64* %13, align 8
  store i64 0, i64* %14, align 8
  %29 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i64* %2)
...
38:                                               ; preds = %34
  ...
  %41 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i64* %40)
  br label %42
...
50:                                               ; preds = %46
  ...
  %53 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i64* %52)
  br label %54
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_1398.cpp() #0 section ".text.startup" {
