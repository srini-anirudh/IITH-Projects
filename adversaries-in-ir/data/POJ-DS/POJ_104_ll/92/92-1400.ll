; ModuleID = 'POJ-104-source/92/92-1400.cpp'
source_filename = "POJ-104-source/92/92-1400.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_1400.cpp, i8* null }]
...
define dso_local i32 @_Z5comp1PKvS0_(i8* %0, i8* %1) #4 {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z5comp2PKvS0_(i8* %0, i8* %1) #4 {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
  store i8* %0, i8** %3, align 8
  store i8* %1, i8** %4, align 8
...
12:                                               ; preds = %0, %136
  ...
  store i64 0, i64* %7, align 8
  store i64 0, i64* %8, align 8
  %15 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i64* %2)
...
24:                                               ; preds = %20
  ...
  %27 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i64* %26)
  br label %28
...
36:                                               ; preds = %32
  ...
  %39 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i64* %38)
  br label %40
...
43:                                               ; preds = %32
  ...
  call void @qsort(i8* %46, i64 %47, i64 4, i32 (i8*, i8*)* @_Z5comp2PKvS0_)
  %48 = getelementptr inbounds [1002 x i64], [1002 x i64]* %4, i64 0, i64 0
  %49 = getelementptr inbounds i64, i64* %48, i64 1
  %50 = bitcast i64* %49 to i8*
  %51 = load i64, i64* %2, align 8
  call void @qsort(i8* %50, i64 %51, i64 4, i32 (i8*, i8*)* @_Z5comp2PKvS0_)
  store i64 1, i64* %5, align 8
  br label %52
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_1400.cpp() #0 section ".text.startup" {
