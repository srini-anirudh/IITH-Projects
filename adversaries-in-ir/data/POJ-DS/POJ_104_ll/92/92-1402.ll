; ModuleID = 'POJ-104-source/92/92-1402.cpp'
source_filename = "POJ-104-source/92/92-1402.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_1402.cpp, i8* null }]
...
45:                                               ; preds = %33
  ...
  call void @_Z5orderPii(i32* %46, i32 %47)
  %48 = getelementptr inbounds [1000 x i32], [1000 x i32]* %8, i64 0, i64 0
  %49 = load i32, i32* %6, align 4
  call void @_Z5orderPii(i32* %48, i32 %49)
  store i32 0, i32* %9, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_1402.cpp() #0 section ".text.startup" {
