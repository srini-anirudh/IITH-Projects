; ModuleID = 'POJ-104-source/92/92-1405.cpp'
source_filename = "POJ-104-source/92/92-1405.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_1405.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5matchPiS_i(i32* %0, i32* %1, i32 %2) #0 {
...
24:                                               ; preds = %12
  ...
  call void @_Z5paixuPii(i32* %25, i32 %26)
  store i32 0, i32* %3, align 4
  br label %27
...
39:                                               ; preds = %27
  ...
  call void @_Z5paixuPii(i32* %40, i32 %41)
  ...
  call void @_Z5matchPiS_i(i32* %42, i32* %43, i32 %44)
  br label %45
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_1405.cpp() #0 section ".text.startup" {
