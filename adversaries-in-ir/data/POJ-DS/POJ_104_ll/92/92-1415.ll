; ModuleID = 'POJ-104-source/92/92-1415.cpp'
source_filename = "POJ-104-source/92/92-1415.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_1415.cpp, i8* null }]
...
define dso_local i32 @_Z6myfuncPKvS0_(i8* %0, i8* %1) #4 {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
...
42:                                               ; preds = %29
  ...
  call void @qsort(i8* %44, i64 %46, i64 4, i32 (i8*, i8*)* @_Z6myfuncPKvS0_)
  %47 = getelementptr inbounds [1000 x i32], [1000 x i32]* %3, i64 0, i64 0
  %48 = bitcast i32* %47 to i8*
  %49 = load i32, i32* %4, align 4
  %50 = sext i32 %49 to i64
  call void @qsort(i8* %48, i64 %50, i64 4, i32 (i8*, i8*)* @_Z6myfuncPKvS0_)
...
103:                                              ; preds = %65
  ...
  %106 = call i32 @_Z3maxii(i32 %104, i32 %105)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_1415.cpp() #0 section ".text.startup" {
