; ModuleID = 'POJ-104-source/92/92-1425.cpp'
source_filename = "POJ-104-source/92/92-1425.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_1425.cpp, i8* null }]
...
51:                                               ; preds = %39
  ...
  call void @qsort(i8* bitcast ([1000 x i32]* @t to i8*), i64 %53, i64 4, i32 (i8*, i8*)* @_Z5mycmpPKvS0_)
  %54 = load i32, i32* @n, align 4
  %55 = sext i32 %54 to i64
  call void @qsort(i8* bitcast ([1000 x i32]* @q to i8*), i64 %55, i64 4, i32 (i8*, i8*)* @_Z5mycmpPKvS0_)
...
108:                                              ; preds = %91
  ...
  %115 = getelementptr inbounds [1000 x i32], [1000 x i32]* @q, i64 0, i64 %114
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_1425.cpp() #0 section ".text.startup" {
