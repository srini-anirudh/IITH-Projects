; ModuleID = 'POJ-104-source/92/92-1462.cpp'
source_filename = "POJ-104-source/92/92-1462.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_1462.cpp, i8* null }]
...
44:                                               ; preds = %31
  ...
  call void @_Z5saimaPiS_i(i32* %45, i32* %46, i32 %47)
  br label %48
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5saimaPiS_i(i32* %0, i32* %1, i32 %2) #0 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_1462.cpp() #0 section ".text.startup" {
