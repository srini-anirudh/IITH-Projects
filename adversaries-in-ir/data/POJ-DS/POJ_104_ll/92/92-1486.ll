; ModuleID = 'POJ-104-source/92/92-1486.cpp'
source_filename = "POJ-104-source/92/92-1486.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_1486.cpp, i8* null }]
...
45:                                               ; preds = %33
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([2000 x i32], [2000 x i32]* @sa, i64 0, i64 1), i32* %49)
  %50 = load i32, i32* %2, align 4
  %51 = add nsw i32 %50, 1
  %52 = sext i32 %51 to i64
  %53 = getelementptr inbounds [2000 x i32], [2000 x i32]* @sb, i64 0, i64 %52
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([2000 x i32], [2000 x i32]* @sb, i64 0, i64 1), i32* %53)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_1486.cpp() #0 section ".text.startup" {
