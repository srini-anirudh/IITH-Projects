; ModuleID = 'POJ-104-source/92/92-1493.cpp'
source_filename = "POJ-104-source/92/92-1493.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_1493.cpp, i8* null }]
...
43:                                               ; preds = %31
  ...
  %49 = call i32 @_Z5paixuPii(i32* %47, i32 %48)
  store i32 0, i32* %6, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_1493.cpp() #0 section ".text.startup" {
