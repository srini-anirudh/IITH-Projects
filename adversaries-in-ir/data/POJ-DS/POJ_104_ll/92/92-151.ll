; ModuleID = 'POJ-104-source/92/92-151.cpp'
source_filename = "POJ-104-source/92/92-151.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_151.cpp, i8* null }]
...
27:                                               ; preds = %15
  ...
  call void @qsort(i8* bitcast ([1001 x i32]* @x to i8*), i64 %29, i64 4, i32 (i8*, i8*)* @_Z6mycompPKvS0_)
...
42:                                               ; preds = %30
  ...
  call void @qsort(i8* bitcast ([1001 x i32]* @y to i8*), i64 %44, i64 4, i32 (i8*, i8*)* @_Z6mycompPKvS0_)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_151.cpp() #0 section ".text.startup" {
