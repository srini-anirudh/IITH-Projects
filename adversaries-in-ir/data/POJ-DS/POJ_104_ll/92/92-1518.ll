; ModuleID = 'POJ-104-source/92/92-1518.cpp'
source_filename = "POJ-104-source/92/92-1518.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_1518.cpp, i8* null }]
...
218:                                              ; preds = %212
  ...
  %226 = getelementptr inbounds [1001 x i32], [1001 x i32]* %10, i64 0, i64 %225
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_1518.cpp() #0 section ".text.startup" {
