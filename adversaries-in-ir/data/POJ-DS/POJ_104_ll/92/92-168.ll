; ModuleID = 'POJ-104-source/92/92-168.cpp'
source_filename = "POJ-104-source/92/92-168.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_168.cpp, i8* null }]
...
46:                                               ; preds = %34
  %47 = getelementptr inbounds [1010 x i32], [1010 x i32]* %2, i64 0, i64 0
  %48 = bitcast i32* %47 to i8*
  %49 = load i32, i32* %4, align 4
  %50 = sext i32 %49 to i64
  call void @qsort(i8* %48, i64 %50, i64 4, i32 (i8*, i8*)* @_Z3cmpPKvS0_)
  %51 = getelementptr inbounds [1010 x i32], [1010 x i32]* %3, i64 0, i64 0
...
74:                                               ; preds = %59
  ...
  %77 = getelementptr inbounds [1010 x i32], [1010 x i32]* %2, i64 0, i64 %76
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_168.cpp() #0 section ".text.startup" {
