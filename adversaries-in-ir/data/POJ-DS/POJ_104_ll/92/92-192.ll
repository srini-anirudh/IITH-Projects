; ModuleID = 'POJ-104-source/92/92-192.cpp'
source_filename = "POJ-104-source/92/92-192.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_192.cpp, i8* null }]
...
175:                                              ; preds = %173, %169
  %176 = getelementptr inbounds [1010 x i32], [1010 x i32]* %2, i64 0, i64 0
  %177 = load i32, i32* %11, align 4
  call void @_Z4sortPii(i32* %176, i32 %177)
  br label %178
...
181:                                              ; preds = %130
  ...
  %184 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %11)
  br label %14
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_192.cpp() #0 section ".text.startup" {
