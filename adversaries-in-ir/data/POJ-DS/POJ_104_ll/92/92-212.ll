; ModuleID = 'POJ-104-source/92/92-212.cpp'
source_filename = "POJ-104-source/92/92-212.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_212.cpp, i8* null }]
...
53:                                               ; preds = %41
  ...
  call void @qsort(i8* %59, i64 %61, i64 4, i32 (i8*, i8*)* @_Z9mycomparePKvS0_)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_212.cpp() #0 section ".text.startup" {
