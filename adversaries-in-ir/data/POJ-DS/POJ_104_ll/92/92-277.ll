; ModuleID = 'POJ-104-source/92/92-277.cpp'
source_filename = "POJ-104-source/92/92-277.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_277.cpp, i8* null }]
...
define dso_local void @_Z5siftaii(i32 %0, i32 %1) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z5siftbii(i32 %0, i32 %1) #4 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z3hsav() #4 {
...
8:                                                ; preds = %5
  ...
  call void @_Z5siftaii(i32 %9, i32 %10)
  br label %11
...
19:                                               ; preds = %16
  ...
  %30 = sub nsw i32 %29, 1
  call void @_Z5siftaii(i32 1, i32 %30)
  br label %31
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z3hsbv() #4 {
  %1 = alloca i32, align 4
  %2 = alloca i32, align 4
  %3 = load i32, i32* @n, align 4
  %4 = sdiv i32 %3, 2
...
8:                                                ; preds = %5
  %9 = load i32, i32* %1, align 4
  %10 = load i32, i32* @n, align 4
  call void @_Z5siftbii(i32 %9, i32 %10)
  br label %11
...
19:                                               ; preds = %16
  ...
  %29 = load i32, i32* %1, align 4
  %30 = sub nsw i32 %29, 1
  call void @_Z5siftbii(i32 1, i32 %30)
  br label %31
...
11:                                               ; preds = %0, %104
  %12 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* @n)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_277.cpp() #0 section ".text.startup" {
