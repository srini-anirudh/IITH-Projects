; ModuleID = 'POJ-104-source/92/92-287.cpp'
source_filename = "POJ-104-source/92/92-287.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_287.cpp, i8* null }]
...
define dso_local i32 @_Z6mycompPKvS0_(i8* %0, i8* %1) #4 {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
...
40:                                               ; preds = %28
  ...
  call void @qsort(i8* %42, i64 %44, i64 4, i32 (i8*, i8*)* @_Z6mycompPKvS0_)
  %45 = getelementptr inbounds [1001 x i32], [1001 x i32]* %3, i64 0, i64 0
  %46 = bitcast i32* %45 to i8*
  %47 = load i32, i32* %4, align 4
  %48 = sext i32 %47 to i64
  call void @qsort(i8* %46, i64 %48, i64 4, i32 (i8*, i8*)* @_Z6mycompPKvS0_)
  store i32 0, i32* %6, align 4
  store i32 0, i32* %5, align 4
...
174:                                              ; preds = %51
  ...
  %177 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %4)
  br label %11
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_287.cpp() #0 section ".text.startup" {
