; ModuleID = 'POJ-104-source/92/92-292.cpp'
source_filename = "POJ-104-source/92/92-292.cpp"
...
@visit = dso_local global [2000 x [2000 x i32]] zeroinitializer, align 16
@dp = dso_local global [2000 x [2000 x i32]] zeroinitializer, align 16
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_292.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5qsortiiPi(i32 %0, i32 %1, i32* %2) #0 {
...
82:                                               ; preds = %78
  ...
  call void @_Z5qsortiiPi(i32 %83, i32 %84, i32* %85)
  br label %86
...
90:                                               ; preds = %86
  ...
  call void @_Z5qsortiiPi(i32 %91, i32 %92, i32* %93)
  br label %94
...
60:                                               ; preds = %59, %46
  ...
  %64 = add nsw i32 %63, 1
  %65 = call i32 @_Z1fii(i32 %62, i32 %64)
...
99:                                               ; preds = %98, %81
  ...
  %103 = call i32 @_Z1fii(i32 %100, i32 %102)
...
35:                                               ; preds = %23
  ...
  call void @_Z5qsortiiPi(i32 1, i32 %36, i32* getelementptr inbounds ([2000 x i32], [2000 x i32]* @a, i64 0, i64 0))
  %37 = load i32, i32* @n, align 4
  call void @_Z5qsortiiPi(i32 1, i32 %37, i32* getelementptr inbounds ([2000 x i32], [2000 x i32]* @b, i64 0, i64 0))
  %38 = load i32, i32* @cnt, align 4
  %39 = add nsw i32 %38, 1
  store i32 %39, i32* @cnt, align 4
  %40 = call i32 @_Z1fii(i32 1, i32 1)
  store i32 %40, i32* %4, align 4
  %41 = load i32, i32* %4, align 4
  %42 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i32 %41)
  %43 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* @n)
  br label %6
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_292.cpp() #0 section ".text.startup" {
