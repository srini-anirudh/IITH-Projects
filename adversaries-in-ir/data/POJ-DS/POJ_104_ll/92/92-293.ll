; ModuleID = 'POJ-104-source/92/92-293.cpp'
source_filename = "POJ-104-source/92/92-293.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_293.cpp, i8* null }]
...
32:                                               ; preds = %20
  ...
  call void @qsort(i8* %34, i64 %36, i64 4, i32 (i8*, i8*)* @_Z3cmpPKvS0_)
  store i32 0, i32* %5, align 4
  br label %37
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_293.cpp() #0 section ".text.startup" {
