; ModuleID = 'POJ-104-source/92/92-338.cpp'
source_filename = "POJ-104-source/92/92-338.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_338.cpp, i8* null }]
...
91:                                               ; preds = %84
  ...
  call void @_Z4sortPii(i32* %92, i32 %93)
  %94 = getelementptr inbounds [1000 x i32], [1000 x i32]* %9, i64 0, i64 0
  %95 = load i32, i32* %2, align 4
  call void @_Z4sortPii(i32* %94, i32 %95)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_338.cpp() #0 section ".text.startup" {
