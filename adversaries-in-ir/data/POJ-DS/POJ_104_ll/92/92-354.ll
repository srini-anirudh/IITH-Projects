; ModuleID = 'POJ-104-source/92/92-354.cpp'
source_filename = "POJ-104-source/92/92-354.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_354.cpp, i8* null }]
...
146:                                              ; preds = %97
  ...
  %150 = call i32 @_Z4dumaiPiS_(i32 %147, i32* %148, i32* %149)
...
define dso_local i32 @_Z4dumaiPiS_(i32 %0, i32* %1, i32* %2) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_354.cpp() #0 section ".text.startup" {
