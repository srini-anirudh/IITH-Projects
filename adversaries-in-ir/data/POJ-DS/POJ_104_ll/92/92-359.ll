; ModuleID = 'POJ-104-source/92/92-359.cpp'
source_filename = "POJ-104-source/92/92-359.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_359.cpp, i8* null }]
...
16:                                               ; preds = %13
  ...
  store i64 0, i64* %8, align 8
  store i64 0, i64* %9, align 8
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i64* %2)
...
28:                                               ; preds = %24
  ...
  %31 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i64* %30)
  br label %32
...
40:                                               ; preds = %36
  ...
  %43 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i64* %42)
  br label %44
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_359.cpp() #0 section ".text.startup" {
