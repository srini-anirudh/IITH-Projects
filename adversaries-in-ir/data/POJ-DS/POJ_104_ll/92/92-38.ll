; ModuleID = 'POJ-104-source/92/92-38.cpp'
source_filename = "POJ-104-source/92/92-38.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_38.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5gamesi(i32 %0) #0 {
...
28:                                               ; preds = %24
  ...
  %31 = getelementptr inbounds [1000 x i32], [1000 x i32]* @qw, i64 0, i64 %30
...
47:                                               ; preds = %43
  ...
  %50 = getelementptr inbounds [1000 x i32], [1000 x i32]* @tj, i64 0, i64 %49
...
57:                                               ; preds = %47
  ...
  %60 = getelementptr inbounds [1000 x i32], [1000 x i32]* @tj, i64 0, i64 %59
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_38.cpp() #0 section ".text.startup" {
