; ModuleID = 'POJ-104-source/92/92-392.cpp'
source_filename = "POJ-104-source/92/92-392.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_392.cpp, i8* null }]
...
26:                                               ; preds = %14
  ...
  call void @qsort(i8* bitcast ([1000 x i32]* @th to i8*), i64 %28, i64 4, i32 (i8*, i8*)* @_Z3cmpPKvS0_)
  store i32 0, i32* %3, align 4
  br label %29
...
41:                                               ; preds = %29
  ...
  call void @qsort(i8* bitcast ([1000 x i32]* @kh to i8*), i64 %43, i64 4, i32 (i8*, i8*)* @_Z3cmpPKvS0_)
...
50:                                               ; preds = %46
  ...
  %57 = getelementptr inbounds [1000 x i32], [1000 x i32]* @kh, i64 0, i64 %56
...
67:                                               ; preds = %50
  ...
  %70 = getelementptr inbounds [1000 x i32], [1000 x i32]* @th, i64 0, i64 %69
  %71 = load i32, i32* %70, align 4
  %72 = load i32, i32* %7, align 4
  %73 = sext i32 %72 to i64
  %74 = getelementptr inbounds [1000 x i32], [1000 x i32]* @kh, i64 0, i64 %73
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_392.cpp() #0 section ".text.startup" {
