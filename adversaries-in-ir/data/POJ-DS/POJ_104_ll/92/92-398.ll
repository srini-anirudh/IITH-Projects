; ModuleID = 'POJ-104-source/92/92-398.cpp'
source_filename = "POJ-104-source/92/92-398.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_398.cpp, i8* null }]
...
38:                                               ; preds = %34
  ...
  call void @_Z5paixuPii(i32* %39, i32 %40)
  %41 = getelementptr inbounds [1500 x i32], [1500 x i32]* %3, i64 0, i64 0
  %42 = load i32, i32* %4, align 4
  call void @_Z5paixuPii(i32* %41, i32 %42)
  ...
  call void @_Z5saimaiPiS_(i32 %43, i32* %44, i32* %45)
  br label %46
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5saimaiPiS_(i32 %0, i32* %1, i32* %2) #0 {
  %4 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_398.cpp() #0 section ".text.startup" {
