; ModuleID = 'POJ-104-source/92/92-401.cpp'
source_filename = "POJ-104-source/92/92-401.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_401.cpp, i8* null }]
...
define dso_local i32 @_Z6resultiPiS_(i32 %0, i32* %1, i32* %2) #4 {
...
39:                                               ; preds = %27
  ...
  %43 = call i32 @_Z6resultiPiS_(i32 %40, i32* %41, i32* %42)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_401.cpp() #0 section ".text.startup" {
