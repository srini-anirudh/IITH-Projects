; ModuleID = 'POJ-104-source/92/92-403.cpp'
source_filename = "POJ-104-source/92/92-403.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_403.cpp, i8* null }]
...
47:                                               ; preds = %34
  ...
  %50 = call i32 @_Z5paixuPii(i32* %48, i32 %49)
  %51 = load i32*, i32** %6, align 8
  %52 = load i32, i32* %2, align 4
  %53 = call i32 @_Z5paixuPii(i32* %51, i32 %52)
...
167:                                              ; preds = %58
  ...
  %172 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %2)
  br label %16
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_403.cpp() #0 section ".text.startup" {
