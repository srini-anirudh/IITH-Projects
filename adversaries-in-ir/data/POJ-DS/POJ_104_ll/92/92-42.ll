; ModuleID = 'POJ-104-source/92/92-42.cpp'
source_filename = "POJ-104-source/92/92-42.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_42.cpp, i8* null }]
...
44:                                               ; preds = %32
  ...
  call void @qsort(i8* bitcast ([1001 x i32]* @T to i8*), i64 %46, i64 4, i32 (i8*, i8*)* @_Z3cmpPKvS0_)
  %47 = load i32, i32* %2, align 4
  %48 = sext i32 %47 to i64
  call void @qsort(i8* bitcast ([1001 x i32]* @K to i8*), i64 %48, i64 4, i32 (i8*, i8*)* @_Z3cmpPKvS0_)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_42.cpp() #0 section ".text.startup" {
