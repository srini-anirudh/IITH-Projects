; ModuleID = 'POJ-104-source/92/92-422.cpp'
source_filename = "POJ-104-source/92/92-422.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_422.cpp, i8* null }]
...
define dso_local i32 @_Z1xiPiS_(i32 %0, i32* %1, i32* %2) #4 {
...
149:                                              ; preds = %99
  ...
  %153 = call i32 @_Z1xiPiS_(i32 %150, i32* %151, i32* %152)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_422.cpp() #0 section ".text.startup" {
