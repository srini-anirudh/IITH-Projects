; ModuleID = 'POJ-104-source/92/92-45.cpp'
source_filename = "POJ-104-source/92/92-45.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_45.cpp, i8* null }]
...
45:                                               ; preds = %33
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([10001 x i32], [10001 x i32]* @a, i64 0, i64 1), i32* %49)
  %50 = load i32, i32* @n, align 4
  %51 = sext i32 %50 to i64
  %52 = getelementptr inbounds i32, i32* getelementptr inbounds ([10001 x i32], [10001 x i32]* @b, i64 0, i64 0), i64 %51
  %53 = getelementptr inbounds i32, i32* %52, i64 1
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([10001 x i32], [10001 x i32]* @b, i64 0, i64 1), i32* %53)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_45.cpp() #0 section ".text.startup" {
