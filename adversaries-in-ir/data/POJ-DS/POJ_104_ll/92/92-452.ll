; ModuleID = 'POJ-104-source/92/92-452.cpp'
source_filename = "POJ-104-source/92/92-452.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_452.cpp, i8* null }]
...
38:                                               ; preds = %26
  ...
  call void @_Z4sortPii(i32* %39, i32 %40)
  store i32 0, i32* %4, align 4
  br label %41
...
53:                                               ; preds = %41
  ...
  call void @_Z4sortPii(i32* %54, i32 %55)
  store i32 0, i32* %5, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_452.cpp() #0 section ".text.startup" {
