; ModuleID = 'POJ-104-source/92/92-454.cpp'
source_filename = "POJ-104-source/92/92-454.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_454.cpp, i8* null }]
...
141:                                              ; preds = %137
  ...
  %161 = call i32 @_Z2ssii(i32 %156, i32 %160)
  ...
  %185 = call i32 @_Z2ssii(i32 %180, i32 %184)
...
198:                                              ; preds = %194
  ...
  %216 = call i32 @_Z2ssii(i32 %211, i32 %215)
  ...
  %240 = call i32 @_Z2ssii(i32 %235, i32 %239)
...
244:                                              ; preds = %198
  ...
  %262 = call i32 @_Z2ssii(i32 %257, i32 %261)
...
271:                                              ; preds = %198
  ...
  %293 = call i32 @_Z2ssii(i32 %288, i32 %292)
...
342:                                              ; preds = %316
  ...
  %345 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %2)
  br label %11
...
define dso_local i32 @_Z2ssii(i32 %0, i32 %1) #5 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_454.cpp() #0 section ".text.startup" {
