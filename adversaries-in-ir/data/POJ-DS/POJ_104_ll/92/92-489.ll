; ModuleID = 'POJ-104-source/92/92-489.cpp'
source_filename = "POJ-104-source/92/92-489.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_489.cpp, i8* null }]
...
40:                                               ; preds = %28
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([1010 x i32], [1010 x i32]* @a, i64 0, i64 1), i32* %43)
  %44 = load i32, i32* %2, align 4
  %45 = sext i32 %44 to i64
  %46 = getelementptr inbounds i32, i32* getelementptr inbounds ([1010 x i32], [1010 x i32]* @b, i64 0, i64 1), i64 %45
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([1010 x i32], [1010 x i32]* @b, i64 0, i64 1), i32* %46)
...
53:                                               ; preds = %49
  ...
  %56 = getelementptr inbounds [1010 x i32], [1010 x i32]* @a, i64 0, i64 %55
...
108:                                              ; preds = %91
  ...
  %111 = getelementptr inbounds [1010 x i32], [1010 x i32]* @a, i64 0, i64 %110
  %112 = load i32, i32* %111, align 4
  %113 = load i32, i32* %8, align 4
  %114 = sext i32 %113 to i64
  %115 = getelementptr inbounds [1010 x i32], [1010 x i32]* @b, i64 0, i64 %114
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_489.cpp() #0 section ".text.startup" {
