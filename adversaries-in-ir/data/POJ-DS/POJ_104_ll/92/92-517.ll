; ModuleID = 'POJ-104-source/92/92-517.cpp'
source_filename = "POJ-104-source/92/92-517.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_517.cpp, i8* null }]
...
42:                                               ; preds = %30
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* %43, i32* %47)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_517.cpp() #0 section ".text.startup" {
