; ModuleID = 'POJ-104-source/92/92-53.cpp'
source_filename = "POJ-104-source/92/92-53.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_53.cpp, i8* null }]
...
23:                                               ; preds = %11
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([10000 x i32], [10000 x i32]* @a, i64 0, i64 0), i32* %26)
  store i32 0, i32* @i, align 4
  br label %27
...
39:                                               ; preds = %27
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([10000 x i32], [10000 x i32]* @b, i64 0, i64 0), i32* %42)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_53.cpp() #0 section ".text.startup" {
