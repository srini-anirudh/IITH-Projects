; ModuleID = 'POJ-104-source/92/92-604.cpp'
source_filename = "POJ-104-source/92/92-604.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_604.cpp, i8* null }]
...
define dso_local void @_Z7arrangePii(i32* %0, i32 %1) #4 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z3funPii(i32* %0, i32 %1) #4 {
  %3 = alloca i32*, align 8
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  store i32* %0, i32** %3, align 8
...
39:                                               ; preds = %35
  ...
  %43 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %42)
  br label %44
...
47:                                               ; preds = %35
  ...
  call void @_Z7arrangePii(i32* %18, i32 %48)
  %49 = load i32, i32* %2, align 4
  call void @_Z7arrangePii(i32* %21, i32 %49)
  br label %50
...
59:                                               ; preds = %53
  ...
  call void @_Z3funPii(i32* %18, i32 %62)
  br label %143
...
69:                                               ; preds = %63
  ...
  call void @_Z3funPii(i32* %18, i32 %72)
  %73 = load i32, i32* %4, align 4
  call void @_Z3funPii(i32* %21, i32 %73)
  br label %142
...
107:                                              ; preds = %95
  ...
  call void @_Z3funPii(i32* %18, i32 %110)
  br label %139
...
132:                                              ; preds = %123
  ...
  call void @_Z3funPii(i32* %18, i32 %135)
  br label %137
...
146:                                              ; preds = %136, %50
  ...
  %150 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %2)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_604.cpp() #0 section ".text.startup" {
