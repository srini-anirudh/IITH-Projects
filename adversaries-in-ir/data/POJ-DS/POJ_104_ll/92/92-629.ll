; ModuleID = 'POJ-104-source/92/92-629.cpp'
source_filename = "POJ-104-source/92/92-629.cpp"
...
@S3 = dso_local global i32 0, align 4
@t = dso_local global i32 0, align 4
@m = dso_local global i32 0, align 4
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_629.cpp, i8* null }]
...
128:                                              ; preds = %37
  ...
  %135 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* @n)
  br label %3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_629.cpp() #0 section ".text.startup" {
