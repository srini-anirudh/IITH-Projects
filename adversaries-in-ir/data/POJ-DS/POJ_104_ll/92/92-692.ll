; ModuleID = 'POJ-104-source/92/92-692.cpp'
source_filename = "POJ-104-source/92/92-692.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_692.cpp, i8* null }]
...
300:                                              ; preds = %295, %197
  ...
  %303 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %2)
  br label %17
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_692.cpp() #0 section ".text.startup" {
