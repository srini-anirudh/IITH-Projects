; ModuleID = 'POJ-104-source/92/92-709.cpp'
source_filename = "POJ-104-source/92/92-709.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_709.cpp, i8* null }]
...
149:                                              ; preds = %145
  ...
  %162 = call i32 @_Z3funii(i32 %157, i32 %161)
...
214:                                              ; preds = %139
  ...
  %218 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %2)
  br label %219
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_709.cpp() #0 section ".text.startup" {
