; ModuleID = 'POJ-104-source/92/92-710.cpp'
source_filename = "POJ-104-source/92/92-710.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_710.cpp, i8* null }]
...
define dso_local void @_Z8exchangePiS_(i32* %0, i32* %1) #4 {
...
20:                                               ; preds = %13
  ...
  call void @_Z8exchangePiS_(i32* %24, i32* %29)
  br label %30
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z4racePiS_i(i32* %0, i32* %1, i32 %2) #4 {
  %4 = alloca i32*, align 8
...
37:                                               ; preds = %25
  ...
  call void @_Z4sortPii(i32* %40, i32 %41)
  ...
  %45 = call i32 @_Z4racePiS_i(i32* %42, i32* %43, i32 %44)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_710.cpp() #0 section ".text.startup" {
