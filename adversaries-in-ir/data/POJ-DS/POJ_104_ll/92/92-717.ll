; ModuleID = 'POJ-104-source/92/92-717.cpp'
source_filename = "POJ-104-source/92/92-717.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_717.cpp, i8* null }]
...
201:                                              ; preds = %179
  ...
  %203 = getelementptr inbounds [1000 x i32], [1000 x i32]* %3, i64 0, i64 0
...
246:                                              ; preds = %168
  %247 = getelementptr inbounds [1000 x i32], [1000 x i32]* %8, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_717.cpp() #0 section ".text.startup" {
