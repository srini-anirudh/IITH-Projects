; ModuleID = 'POJ-104-source/92/92-735.cpp'
source_filename = "POJ-104-source/92/92-735.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_735.cpp, i8* null }]
...
41:                                               ; preds = %29
  ...
  call void @qsort(i8* bitcast ([1004 x i32]* @tian to i8*), i64 %43, i64 4, i32 (i8*, i8*)* @_Z3cmpPKvS0_)
  %44 = load i32, i32* %2, align 4
  %45 = sext i32 %44 to i64
  call void @qsort(i8* bitcast ([1004 x i32]* @qi to i8*), i64 %45, i64 4, i32 (i8*, i8*)* @_Z3cmpPKvS0_)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_735.cpp() #0 section ".text.startup" {
