; ModuleID = 'POJ-104-source/92/92-776.cpp'
source_filename = "POJ-104-source/92/92-776.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_776.cpp, i8* null }]
...
define dso_local void @_Z9quicksortPii(i32* %0, i32 %1) #4 {
...
43:                                               ; preds = %31
  ...
  call void @_Z9quicksortPii(i32* %44, i32 %45)
  %46 = getelementptr inbounds [1001 x i32], [1001 x i32]* %6, i64 0, i64 0
  %47 = load i32, i32* %2, align 4
  call void @_Z9quicksortPii(i32* %46, i32 %47)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_776.cpp() #0 section ".text.startup" {
