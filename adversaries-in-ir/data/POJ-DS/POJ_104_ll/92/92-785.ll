; ModuleID = 'POJ-104-source/92/92-785.cpp'
source_filename = "POJ-104-source/92/92-785.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_785.cpp, i8* null }]
...
40:                                               ; preds = %28
  ...
  call void @qsort(i8* %42, i64 %44, i64 4, i32 (i8*, i8*)* @_Z4compPKvS0_)
  %45 = getelementptr inbounds [1500 x i32], [1500 x i32]* %3, i64 0, i64 0
  %46 = bitcast i32* %45 to i8*
  %47 = load i32, i32* %6, align 4
  %48 = sext i32 %47 to i64
  call void @qsort(i8* %46, i64 %48, i64 4, i32 (i8*, i8*)* @_Z4compPKvS0_)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_785.cpp() #0 section ".text.startup" {
