; ModuleID = 'POJ-104-source/92/92-801.cpp'
source_filename = "POJ-104-source/92/92-801.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_801.cpp, i8* null }]
...
38:                                               ; preds = %26
  call void @_Z4sortPi(i32* getelementptr inbounds ([1001 x i32], [1001 x i32]* @tj, i64 0, i64 0))
  call void @_Z4sortPi(i32* getelementptr inbounds ([1001 x i32], [1001 x i32]* @qw, i64 0, i64 0))
...
121:                                              ; preds = %118
  %122 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* @n)
  br label %9
...
define dso_local void @_Z4sortPi(i32* %0) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_801.cpp() #0 section ".text.startup" {
