; ModuleID = 'POJ-104-source/92/92-822.cpp'
source_filename = "POJ-104-source/92/92-822.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_822.cpp, i8* null }]
...
53:                                               ; preds = %41
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* %54, i32* %57)
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* %58, i32* %61)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_822.cpp() #0 section ".text.startup" {
