; ModuleID = 'POJ-104-source/92/92-828.cpp'
source_filename = "POJ-104-source/92/92-828.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_828.cpp, i8* null }]
...
define dso_local i32 @_Z1fiPiS_(i32 %0, i32* %1, i32* %2) #4 {
...
150:                                              ; preds = %147
  ...
  %154 = call i32 @_Z1fiPiS_(i32 %151, i32* %152, i32* %153)
...
156:                                              ; preds = %147
  ...
  %160 = call i32 @_Z1fiPiS_(i32 %157, i32* %158, i32* %159)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_828.cpp() #0 section ".text.startup" {
