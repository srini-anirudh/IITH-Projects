; ModuleID = 'POJ-104-source/92/92-843.cpp'
source_filename = "POJ-104-source/92/92-843.cpp"
...
@l = dso_local global [1010 x [1010 x i32]] zeroinitializer, align 16
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_843.cpp, i8* null }]
...
35:                                               ; preds = %23
  ...
  call void @qsort(i8* bitcast ([1010 x i32]* @a to i8*), i64 %37, i64 4, i32 (i8*, i8*)* @_Z3cmpPKvS0_)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_843.cpp() #0 section ".text.startup" {
