; ModuleID = 'POJ-104-source/92/92-846.cpp'
source_filename = "POJ-104-source/92/92-846.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_846.cpp, i8* null }]
...
39:                                               ; preds = %27
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([1002 x i32], [1002 x i32]* @a, i64 0, i64 0), i32* %42)
  %43 = load i32, i32* @n, align 4
  %44 = sext i32 %43 to i64
  %45 = getelementptr inbounds i32, i32* getelementptr inbounds ([1002 x i32], [1002 x i32]* @b, i64 0, i64 0), i64 %44
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([1002 x i32], [1002 x i32]* @b, i64 0, i64 0), i32* %45)
...
define dso_local i32 @_Z5solvei(i32 %0) #5 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  store i32 %0, i32* %2, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_846.cpp() #0 section ".text.startup" {
