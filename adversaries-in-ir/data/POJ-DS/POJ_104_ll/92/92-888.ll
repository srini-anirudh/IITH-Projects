; ModuleID = 'POJ-104-source/92/92-888.cpp'
source_filename = "POJ-104-source/92/92-888.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_888.cpp, i8* null }]
...
54:                                               ; preds = %46
  ...
  %58 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i32* %57)
  br label %59
...
63:                                               ; preds = %41
  ...
  %66 = call i32* @_Z7arrangePii(i32* %64, i32 %65)
  %67 = getelementptr inbounds [1000 x i32], [1000 x i32]* %4, i64 0, i64 0
  %68 = load i32, i32* %3, align 4
  %69 = call i32* @_Z7arrangePii(i32* %67, i32 %68)
...
define dso_local i32* @_Z7arrangePii(i32* %0, i32 %1) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_888.cpp() #0 section ".text.startup" {
