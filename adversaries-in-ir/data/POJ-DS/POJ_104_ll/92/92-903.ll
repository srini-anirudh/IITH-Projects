; ModuleID = 'POJ-104-source/92/92-903.cpp'
source_filename = "POJ-104-source/92/92-903.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_903.cpp, i8* null }]
...
43:                                               ; preds = %31
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([1000 x i32], [1000 x i32]* @e, i64 0, i64 0), i32* %46)
  %47 = load i32, i32* %2, align 4
  %48 = sext i32 %47 to i64
  %49 = getelementptr inbounds i32, i32* getelementptr inbounds ([1000 x i32], [1000 x i32]* @f, i64 0, i64 0), i64 %48
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([1000 x i32], [1000 x i32]* @f, i64 0, i64 0), i32* %49)
...
73:                                               ; preds = %60
  ...
  %76 = getelementptr inbounds [1000 x i32], [1000 x i32]* @e, i64 0, i64 %75
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_903.cpp() #0 section ".text.startup" {
