; ModuleID = 'POJ-104-source/92/92-906.cpp'
source_filename = "POJ-104-source/92/92-906.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_906.cpp, i8* null }]
...
19:                                               ; preds = %16
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %2)
...
31:                                               ; preds = %27
  ...
  %35 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i32* %34)
  br label %36
...
96:                                               ; preds = %92
  ...
  %100 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i32* %99)
  br label %101
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_906.cpp() #0 section ".text.startup" {
