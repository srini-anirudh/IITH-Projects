; ModuleID = 'POJ-104-source/92/92-907.cpp'
source_filename = "POJ-104-source/92/92-907.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_907.cpp, i8* null }]
...
define dso_local i32 @_Z2pkii(i32 %0, i32 %1) #4 {
...
140:                                              ; preds = %133
  ...
  %152 = call i32 @_Z2pkii(i32 %145, i32 %151)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_907.cpp() #0 section ".text.startup" {
