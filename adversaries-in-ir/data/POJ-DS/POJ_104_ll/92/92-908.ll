; ModuleID = 'POJ-104-source/92/92-908.cpp'
source_filename = "POJ-104-source/92/92-908.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_908.cpp, i8* null }]
...
44:                                               ; preds = %32
  ...
  call void @_Z4sortPii(i32* %47, i32 %48)
  %49 = getelementptr inbounds [1000 x i32], [1000 x i32]* %10, i64 0, i64 0
  %50 = load i32, i32* %4, align 4
  call void @_Z4sortPii(i32* %49, i32 %50)
  br label %51
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_908.cpp() #0 section ".text.startup" {
