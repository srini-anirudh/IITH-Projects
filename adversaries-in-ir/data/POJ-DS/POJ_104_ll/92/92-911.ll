; ModuleID = 'POJ-104-source/92/92-911.cpp'
source_filename = "POJ-104-source/92/92-911.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_911.cpp, i8* null }]
...
57:                                               ; preds = %45
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* %58, i32* %62)
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* %63, i32* %67)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_911.cpp() #0 section ".text.startup" {
