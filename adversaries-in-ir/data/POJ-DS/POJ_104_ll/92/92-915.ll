; ModuleID = 'POJ-104-source/92/92-915.cpp'
source_filename = "POJ-104-source/92/92-915.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_915.cpp, i8* null }]
...
43:                                               ; preds = %31
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([1000 x i32], [1000 x i32]* @tj, i64 0, i64 0), i32* %46)
  %47 = load i32, i32* %2, align 4
  %48 = sext i32 %47 to i64
  %49 = getelementptr inbounds i32, i32* getelementptr inbounds ([1000 x i32], [1000 x i32]* @qw, i64 0, i64 0), i64 %48
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([1000 x i32], [1000 x i32]* @qw, i64 0, i64 0), i32* %49)
...
64:                                               ; preds = %60
  ...
  %71 = getelementptr inbounds [1000 x i32], [1000 x i32]* @qw, i64 0, i64 %70
...
76:                                               ; preds = %74
  ...
  %79 = getelementptr inbounds [1000 x i32], [1000 x i32]* @tj, i64 0, i64 %78
  %80 = load i32, i32* %79, align 4
  %81 = load i32, i32* %5, align 4
  %82 = sext i32 %81 to i64
  %83 = getelementptr inbounds [1000 x i32], [1000 x i32]* @qw, i64 0, i64 %82
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_915.cpp() #0 section ".text.startup" {
