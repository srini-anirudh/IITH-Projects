; ModuleID = 'POJ-104-source/92/92-93.cpp'
source_filename = "POJ-104-source/92/92-93.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_93.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z2dpv() #0 {
...
60:                                               ; preds = %48
  ...
  %77 = add nsw i32 %76, 1
  %78 = call i32 @_Z3Maxii(i32 %69, i32 %77)
...
99:                                               ; preds = %87
  ...
  %116 = call i32 @_Z3Maxii(i32 %107, i32 %115)
...
136:                                              ; preds = %124
  ...
  %153 = call i32 @_Z3Maxii(i32 %145, i32 %152)
...
176:                                              ; preds = %136
  ...
  %193 = call i32 @_Z3Maxii(i32 %184, i32 %192)
...
216:                                              ; preds = %201
  ...
  %232 = call i32 @_Z3Maxii(i32 %224, i32 %231)
...
258:                                              ; preds = %254
  ...
  %267 = call i32 @_Z3Maxii(i32 %259, i32 %266)
...
; Function Attrs: noinline nounwind uwtable
define linkonce_odr dso_local i32 @_Z3Maxii(i32 %0, i32 %1) #4 comdat {
  %3 = alloca i32, align 4
...
33:                                               ; preds = %21
  ...
  call void @qsort(i8* bitcast (i32* getelementptr inbounds ([1010 x i32], [1010 x i32]* @a, i64 0, i64 1) to i8*), i64 %35, i64 4, i32 (i8*, i8*)* @_Z3cmpPKvS0_)
  %36 = load i32, i32* @n, align 4
  %37 = sext i32 %36 to i64
  call void @qsort(i8* bitcast (i32* getelementptr inbounds ([1010 x i32], [1010 x i32]* @b, i64 0, i64 1) to i8*), i64 %37, i64 4, i32 (i8*, i8*)* @_Z3cmpPKvS0_)
  call void @_Z2dpv()
  br label %3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_93.cpp() #0 section ".text.startup" {
