; ModuleID = 'POJ-104-source/92/92-930.cpp'
source_filename = "POJ-104-source/92/92-930.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_930.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z5matchiPiS_(i32 %0, i32* %1, i32* %2) #0 {
...
94:                                               ; preds = %69
  ...
  %99 = call i32 @_Z5matchiPiS_(i32 %96, i32* %97, i32* %98)
...
115:                                              ; preds = %101
  ...
  %120 = call i32 @_Z5matchiPiS_(i32 %117, i32* %118, i32* %119)
...
151:                                              ; preds = %140
  ...
  %156 = call i32 @_Z5matchiPiS_(i32 %153, i32* %154, i32* %155)
...
158:                                              ; preds = %140
  ...
  %163 = call i32 @_Z5matchiPiS_(i32 %160, i32* %161, i32* %162)
...
166:                                              ; preds = %158, %151, %115, %94, %56, %55, %46
...
113:                                              ; preds = %42
  ...
  %116 = getelementptr inbounds [1000 x i32], [1000 x i32]* %3, i64 0, i64 0
  %117 = call i32 @_Z5matchiPiS_(i32 %114, i32* %115, i32* %116)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_930.cpp() #0 section ".text.startup" {
