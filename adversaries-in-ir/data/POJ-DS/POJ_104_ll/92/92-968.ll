; ModuleID = 'POJ-104-source/92/92-968.cpp'
source_filename = "POJ-104-source/92/92-968.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_968.cpp, i8* null }]
...
61:                                               ; preds = %46
  ...
  %67 = sub nsw i32 %66, 1
  call void @_Z5QsortPiii(i32* %62, i32 0, i32 %67)
  ...
  %73 = sub nsw i32 %72, 1
  call void @_Z5QsortPiii(i32* %68, i32 0, i32 %73)
  br label %74
...
223:                                              ; preds = %74
  ...
  %235 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %234)
  br label %23
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_968.cpp() #0 section ".text.startup" {
