; ModuleID = 'POJ-104-source/92/92-972.cpp'
source_filename = "POJ-104-source/92/92-972.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_972.cpp, i8* null }]
...
47:                                               ; preds = %35
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([2000 x i32], [2000 x i32]* @a, i64 0, i64 0), i32* %50)
  %51 = load i32, i32* @n, align 4
  %52 = sext i32 %51 to i64
  %53 = getelementptr inbounds i32, i32* getelementptr inbounds ([2000 x i32], [2000 x i32]* @b, i64 0, i64 0), i64 %52
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([2000 x i32], [2000 x i32]* @b, i64 0, i64 0), i32* %53)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_972.cpp() #0 section ".text.startup" {
