; ModuleID = 'POJ-104-source/92/92-974.cpp'
source_filename = "POJ-104-source/92/92-974.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_974.cpp, i8* null }]
...
68:                                               ; preds = %50
  ...
  call void @qsort(i8* %73, i64 %78, i64 4, i32 (i8*, i8*)* @_Z4compPKvS0_)
  ...
  call void @qsort(i8* %83, i64 %88, i64 4, i32 (i8*, i8*)* @_Z4compPKvS0_)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_974.cpp() #0 section ".text.startup" {
