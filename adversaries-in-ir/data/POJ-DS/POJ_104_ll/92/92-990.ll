; ModuleID = 'POJ-104-source/92/92-990.cpp'
source_filename = "POJ-104-source/92/92-990.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_990.cpp, i8* null }]
...
37:                                               ; preds = %25
  ...
  call void @qsort(i8* bitcast ([1000 x i32]* @a to i8*), i64 %39, i64 4, i32 (i8*, i8*)* @_Z3cmpPKvS0_)
  %40 = load i32, i32* @n, align 4
  %41 = sext i32 %40 to i64
  call void @qsort(i8* bitcast ([1000 x i32]* @b to i8*), i64 %41, i64 4, i32 (i8*, i8*)* @_Z3cmpPKvS0_)
...
144:                                              ; preds = %52
  ...
  store i32 0, i32* %6, align 4
  %148 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* @n)
  br label %8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_990.cpp() #0 section ".text.startup" {
