; ModuleID = 'POJ-104-source/92/92-998.cpp'
source_filename = "POJ-104-source/92/92-998.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_998.cpp, i8* null }]
...
define dso_local void @_Z11bubble_sortPii(i32* %0, i32 %1) #4 {
...
47:                                               ; preds = %35
  ...
  call void @_Z11bubble_sortPii(i32* %48, i32 %49)
  %50 = getelementptr inbounds [1000 x i32], [1000 x i32]* %3, i64 0, i64 0
  %51 = load i32, i32* %5, align 4
  call void @_Z11bubble_sortPii(i32* %50, i32 %51)
  store i32 0, i32* %6, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_998.cpp() #0 section ".text.startup" {
