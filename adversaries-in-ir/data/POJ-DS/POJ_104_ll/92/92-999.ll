; ModuleID = 'POJ-104-source/92/92-999.cpp'
source_filename = "POJ-104-source/92/92-999.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_92_999.cpp, i8* null }]
...
57:                                               ; preds = %44
  ...
  call void @qsort(i8* %59, i64 %61, i64 4, i32 (i8*, i8*)* @_Z6bijiaoPKvS0_)
  %62 = load i32*, i32** %5, align 8
  %63 = bitcast i32* %62 to i8*
  %64 = load i32, i32* %2, align 4
  %65 = sext i32 %64 to i64
  call void @qsort(i8* %63, i64 %65, i64 4, i32 (i8*, i8*)* @_Z6bijiaoPKvS0_)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_92_999.cpp() #0 section ".text.startup" {
