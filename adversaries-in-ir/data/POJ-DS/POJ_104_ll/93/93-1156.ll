; ModuleID = 'POJ-104-source/93/93-1156.cpp'
source_filename = "POJ-104-source/93/93-1156.cpp"
...
@.str.8 = private unnamed_addr constant [3 x i8] c"7\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_93_1156.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_93_1156.cpp() #0 section ".text.startup" {
