; ModuleID = 'POJ-104-source/93/93-13.cpp'
source_filename = "POJ-104-source/93/93-13.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_93_13.cpp, i8* null }]
...
85:                                               ; preds = %81
  %86 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.7, i64 0, i64 0))
  br label %87
...
95:                                               ; preds = %91
  %96 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.8, i64 0, i64 0))
  br label %97
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_93_13.cpp() #0 section ".text.startup" {
