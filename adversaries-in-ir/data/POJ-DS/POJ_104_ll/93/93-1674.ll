; ModuleID = 'POJ-104-source/93/93-1674.cpp'
source_filename = "POJ-104-source/93/93-1674.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_93_1674.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %6, i8* align 4 bitcast ([3 x i32]* @__const.main.s to i8*), i64 12, i1 false)
...
81:                                               ; preds = %77
  %82 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.5, i64 0, i64 0))
  br label %83
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_93_1674.cpp() #0 section ".text.startup" {
