; ModuleID = 'POJ-104-source/93/93-17.cpp'
source_filename = "POJ-104-source/93/93-17.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_93_17.cpp, i8* null }]
...
78:                                               ; preds = %75
  %79 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.6, i64 0, i64 0))
  br label %94
...
89:                                               ; preds = %86
  %90 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.7, i64 0, i64 0))
  br label %93
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_93_17.cpp() #0 section ".text.startup" {
