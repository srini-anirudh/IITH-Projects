; ModuleID = 'POJ-104-source/93/93-1708.cpp'
source_filename = "POJ-104-source/93/93-1708.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_93_1708.cpp, i8* null }]
...
68:                                               ; preds = %64
  ...
  %71 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.3, i64 0, i64 0), i32 %69, i32 %70)
  br label %113
...
84:                                               ; preds = %80
  ...
  %87 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.3, i64 0, i64 0), i32 %85, i32 %86)
  br label %112
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_93_1708.cpp() #0 section ".text.startup" {
