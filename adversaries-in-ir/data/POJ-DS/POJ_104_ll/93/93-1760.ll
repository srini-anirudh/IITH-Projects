; ModuleID = 'POJ-104-source/93/93-1760.cpp'
source_filename = "POJ-104-source/93/93-1760.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_93_1760.cpp, i8* null }]
...
59:                                               ; preds = %52
  %60 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.5, i64 0, i64 0))
  br label %83
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_93_1760.cpp() #0 section ".text.startup" {
