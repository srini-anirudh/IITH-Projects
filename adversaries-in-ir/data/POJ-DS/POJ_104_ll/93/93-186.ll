; ModuleID = 'POJ-104-source/93/93-186.cpp'
source_filename = "POJ-104-source/93/93-186.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_93_186.cpp, i8* null }]
...
71:                                               ; preds = %66
  %72 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.8, i64 0, i64 0))
  br label %73
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_93_186.cpp() #0 section ".text.startup" {
