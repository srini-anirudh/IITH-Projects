; ModuleID = 'POJ-104-source/93/93-1935.cpp'
source_filename = "POJ-104-source/93/93-1935.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_93_1935.cpp, i8* null }]
...
108:                                              ; preds = %104
  %109 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.7, i64 0, i64 0))
  br label %110

110:                                              ; preds = %108, %104, %100, %96
  br label %111
...
128:                                              ; preds = %124
  %129 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.8, i64 0, i64 0))
  br label %130
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_93_1935.cpp() #0 section ".text.startup" {
