; ModuleID = 'POJ-104-source/93/93-2213.cpp'
source_filename = "POJ-104-source/93/93-2213.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_93_2213.cpp, i8* null }]
...
58:                                               ; preds = %55
  ...
  %68 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.5, i64 0, i64 0), i32 %67)
  br label %71
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_93_2213.cpp() #0 section ".text.startup" {
