; ModuleID = 'POJ-104-source/93/93-95.cpp'
source_filename = "POJ-104-source/93/93-95.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_93_95.cpp, i8* null }]
...
67:                                               ; preds = %63
  %68 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.7, i64 0, i64 0))
  br label %71

69:                                               ; preds = %63, %59
  %70 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.8, i64 0, i64 0))
  br label %71
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_93_95.cpp() #0 section ".text.startup" {
