; ModuleID = 'POJ-104-source/93/93-98.cpp'
source_filename = "POJ-104-source/93/93-98.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_93_98.cpp, i8* null }]
...
81:                                               ; preds = %77
  %82 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32 7)
  br label %83
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_93_98.cpp() #0 section ".text.startup" {
