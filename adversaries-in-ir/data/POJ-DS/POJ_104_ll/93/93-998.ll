; ModuleID = 'POJ-104-source/93/93-998.cpp'
source_filename = "POJ-104-source/93/93-998.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_93_998.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %9, i8* align 1 getelementptr inbounds ([3 x i8], [3 x i8]* @__const.main.b, i32 0, i32 0), i64 3, i1 false)
...
39:                                               ; preds = %28
  %40 = call dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_c(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8 signext 110)
  br label %87
...
56:                                               ; preds = %51
  ...
  %59 = getelementptr inbounds [3 x i8], [3 x i8]* %6, i64 0, i64 %58
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_93_998.cpp() #0 section ".text.startup" {
