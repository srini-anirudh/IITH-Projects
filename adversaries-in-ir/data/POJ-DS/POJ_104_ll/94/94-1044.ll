; ModuleID = 'POJ-104-source/94/94-1044.cpp'
source_filename = "POJ-104-source/94/94-1044.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_94_1044.cpp, i8* null }]
...
36:                                               ; preds = %8
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* %37, i32* %41)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_94_1044.cpp() #0 section ".text.startup" {
