; ModuleID = 'POJ-104-source/94/94-1233.cpp'
source_filename = "POJ-104-source/94/94-1233.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_94_1233.cpp, i8* null }]
...
37:                                               ; preds = %8
  ...
  call void @_Z5paixuiPi(i32 %38, i32* %39)
  store i32 0, i32* %3, align 4
  br label %40
...
define dso_local void @_Z5paixuiPi(i32 %0, i32* %1) #5 {
  %3 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_94_1233.cpp() #0 section ".text.startup" {
