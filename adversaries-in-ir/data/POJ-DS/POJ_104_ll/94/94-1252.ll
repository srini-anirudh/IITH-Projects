; ModuleID = 'POJ-104-source/94/94-1252.cpp'
source_filename = "POJ-104-source/94/94-1252.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_94_1252.cpp, i8* null }]
...
46:                                               ; preds = %21
  ...
  call void @_Z6maopaoiPi(i32 %47, i32* %48)
  store i32 0, i32* %5, align 4
  br label %49
...
define dso_local void @_Z6maopaoiPi(i32 %0, i32* %1) #5 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_94_1252.cpp() #0 section ".text.startup" {
