; ModuleID = 'POJ-104-source/94/94-1387.cpp'
source_filename = "POJ-104-source/94/94-1387.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_94_1387.cpp, i8* null }]
...
26:                                               ; preds = %7
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([510 x i32], [510 x i32]* @s, i64 0, i64 0), i32* %29)
  %30 = load i32, i32* getelementptr inbounds ([510 x i32], [510 x i32]* @s, i64 0, i64 0), align 16
...
36:                                               ; preds = %32
  ...
  %39 = getelementptr inbounds [510 x i32], [510 x i32]* @s, i64 0, i64 %38
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_94_1387.cpp() #0 section ".text.startup" {
