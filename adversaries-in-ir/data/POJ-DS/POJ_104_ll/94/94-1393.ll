; ModuleID = 'POJ-104-source/94/94-1393.cpp'
source_filename = "POJ-104-source/94/94-1393.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_94_1393.cpp, i8* null }]
...
65:                                               ; preds = %40
  ...
  call void @_Z11bubble_sortPii(i32* %39, i32 %66)
  store i32 0, i32* %5, align 4
  br label %67
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_94_1393.cpp() #0 section ".text.startup" {
