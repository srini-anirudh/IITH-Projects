; ModuleID = 'POJ-104-source/94/94-1833.cpp'
source_filename = "POJ-104-source/94/94-1833.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_94_1833.cpp, i8* null }]
...
47:                                               ; preds = %22
  ...
  call void @_Z6bubblePii(i32* %48, i32 %49)
  %50 = getelementptr inbounds [500 x i32], [500 x i32]* %6, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_94_1833.cpp() #0 section ".text.startup" {
