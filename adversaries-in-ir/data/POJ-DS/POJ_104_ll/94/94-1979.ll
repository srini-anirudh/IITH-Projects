; ModuleID = 'POJ-104-source/94/94-1979.cpp'
source_filename = "POJ-104-source/94/94-1979.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_94_1979.cpp, i8* null }]
...
24:                                               ; preds = %12
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* %25, i32* %28)
  store i32 0, i32* %3, align 4
  br label %29
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_94_1979.cpp() #0 section ".text.startup" {
