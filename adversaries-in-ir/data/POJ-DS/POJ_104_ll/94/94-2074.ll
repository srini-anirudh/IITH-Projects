; ModuleID = 'POJ-104-source/94/94-2074.cpp'
source_filename = "POJ-104-source/94/94-2074.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_94_2074.cpp, i8* null }]
...
23:                                               ; preds = %11
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* %10, i32* %26)
  store i32 0, i32* %3, align 4
  br label %27
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_94_2074.cpp() #0 section ".text.startup" {
