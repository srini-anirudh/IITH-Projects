; ModuleID = 'POJ-104-source/94/94-2084.cpp'
source_filename = "POJ-104-source/94/94-2084.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_94_2084.cpp, i8* null }]
...
26:                                               ; preds = %7
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([600 x i32], [600 x i32]* @a, i64 0, i64 1), i32* %30)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_94_2084.cpp() #0 section ".text.startup" {
