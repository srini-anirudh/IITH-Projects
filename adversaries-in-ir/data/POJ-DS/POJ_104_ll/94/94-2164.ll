; ModuleID = 'POJ-104-source/94/94-2164.cpp'
source_filename = "POJ-104-source/94/94-2164.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_94_2164.cpp, i8* null }]
...
22:                                               ; preds = %10
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* getelementptr inbounds ([1000 x i32], [1000 x i32]* @data, i64 0, i64 0), i32* %25)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_94_2164.cpp() #0 section ".text.startup" {
