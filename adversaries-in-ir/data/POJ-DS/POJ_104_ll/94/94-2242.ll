; ModuleID = 'POJ-104-source/94/94-2242.cpp'
source_filename = "POJ-104-source/94/94-2242.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_94_2242.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local void @_Z9PrintDataPii(i32* %0, i32 %1) #0 {
  %3 = alloca i32*, align 8
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  store i32* %0, i32** %3, align 8
...
18:                                               ; preds = %6
  ...
  call void @_Z4SortPii(i32* %19, i32 %20)
  ...
  call void @_Z9PrintDataPii(i32* %24, i32 %25)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_94_2242.cpp() #0 section ".text.startup" {
