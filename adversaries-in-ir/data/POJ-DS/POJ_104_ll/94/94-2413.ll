; ModuleID = 'POJ-104-source/94/94-2413.cpp'
source_filename = "POJ-104-source/94/94-2413.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_94_2413.cpp, i8* null }]
...
51:                                               ; preds = %44
  ...
  %58 = getelementptr inbounds [501 x i32], [501 x i32]* %8, i64 0, i64 %57
...
90:                                               ; preds = %79
  ...
  %107 = getelementptr inbounds [501 x i32], [501 x i32]* %8, i64 0, i64 %106
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_94_2413.cpp() #0 section ".text.startup" {
