; ModuleID = 'POJ-104-source/94/94-2487.cpp'
source_filename = "POJ-104-source/94/94-2487.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_94_2487.cpp, i8* null }]
...
53:                                               ; preds = %48
  ...
  %58 = call i32 @_Z3maxPiii(i32* %54, i32 %56, i32 %57)
  br label %59
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_94_2487.cpp() #0 section ".text.startup" {
