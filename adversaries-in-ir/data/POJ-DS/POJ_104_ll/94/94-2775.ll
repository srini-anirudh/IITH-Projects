; ModuleID = 'POJ-104-source/94/94-2775.cpp'
source_filename = "POJ-104-source/94/94-2775.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_94_2775.cpp, i8* null }]
...
82:                                               ; preds = %38
  %83 = getelementptr inbounds [100 x i32], [100 x i32]* %13, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_94_2775.cpp() #0 section ".text.startup" {
