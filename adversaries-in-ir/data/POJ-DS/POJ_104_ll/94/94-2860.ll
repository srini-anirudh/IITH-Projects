; ModuleID = 'POJ-104-source/94/94-2860.cpp'
source_filename = "POJ-104-source/94/94-2860.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_94_2860.cpp, i8* null }]
...
82:                                               ; preds = %77
  ...
  call void @_Z4sortPii(i32* %83, i32 %84)
  store i32 0, i32* %2, align 4
  br label %85
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_94_2860.cpp() #0 section ".text.startup" {
