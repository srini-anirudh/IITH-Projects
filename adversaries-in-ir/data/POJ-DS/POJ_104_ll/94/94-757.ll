; ModuleID = 'POJ-104-source/94/94-757.cpp'
source_filename = "POJ-104-source/94/94-757.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_94_757.cpp, i8* null }]
...
37:                                               ; preds = %8
  ...
  call void @_Z6BubblePii(i32* %38, i32 %39)
  store i32 0, i32* %2, align 4
  br label %40
...
44:                                               ; preds = %40
  ...
  %54 = select i1 %52, i8 10, i8 44
  %55 = sext i8 %54 to i32
  %56 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32 %48, i32 %55)
  br label %57
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_94_757.cpp() #0 section ".text.startup" {
