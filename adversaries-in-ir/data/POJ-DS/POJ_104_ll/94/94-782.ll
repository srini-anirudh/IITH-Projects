; ModuleID = 'POJ-104-source/94/94-782.cpp'
source_filename = "POJ-104-source/94/94-782.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_94_782.cpp, i8* null }]
...
22:                                               ; preds = %10
  ...
  call void @_Z6bubblePii(i32* %23, i32 %24)
  store i32 0, i32* %3, align 4
...
define dso_local void @_Z6bubblePii(i32* %0, i32 %1) #6 {
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_94_782.cpp() #0 section ".text.startup" {
