; ModuleID = 'POJ-104-source/94/94-917.cpp'
source_filename = "POJ-104-source/94/94-917.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_94_917.cpp, i8* null }]
...
29:                                               ; preds = %9
  ...
  call void @_ZSt4sortIPiEvT_S1_(i32* %30, i32* %35)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_94_917.cpp() #0 section ".text.startup" {
