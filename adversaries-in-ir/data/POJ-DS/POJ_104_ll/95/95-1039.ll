; ModuleID = 'POJ-104-source/95/95-1039.cpp'
source_filename = "POJ-104-source/95/95-1039.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_95_1039.cpp, i8* null }]
...
70:                                               ; preds = %44
  ...
  %72 = getelementptr inbounds [81 x i8], [81 x i8]* %3, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_95_1039.cpp() #0 section ".text.startup" {
