; ModuleID = 'POJ-104-source/96/96-1023.cpp'
source_filename = "POJ-104-source/96/96-1023.cpp"
...
@shang = dso_local global [200 x i32] zeroinitializer, align 16
@.str = private unnamed_addr constant [3 x i8] c"%s\00", align 1
@.str.1 = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.2 = private unnamed_addr constant [2 x i8] c"0\00", align 1
@.str.3 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_96_1023.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %10 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([150 x i8], [150 x i8]* @beichushu, i64 0, i64 0))
  ...
  %11 = call i64 @strlen(i8* getelementptr inbounds ([150 x i8], [150 x i8]* @beichushu, i64 0, i64 0)) #9
  %12 = sub i64 %11, 1
...
31:                                               ; preds = %14
  ...
  %32 = call i32 @_Z3weiPi(i32* getelementptr inbounds ([150 x i32], [150 x i32]* @beichu, i64 0, i64 0))
  %33 = call i32 @_Z3weiPi(i32* getelementptr inbounds ([150 x i32], [150 x i32]* @chu, i64 0, i64 0))
  %34 = sub nsw i32 %32, %33
  store i32 %34, i32* %4, align 4
  %35 = load i32, i32* %4, align 4
  store i32 %35, i32* %6, align 4
  %36 = call i32 @_Z7comparePiS_(i32* getelementptr inbounds ([150 x i32], [150 x i32]* @beichu, i64 0, i64 0), i32* getelementptr inbounds ([150 x i32], [150 x i32]* @chu, i64 0, i64 0))
  store i32 %36, i32* %9, align 4
  %37 = load i32, i32* %4, align 4
  call void @_Z6fangdaPii(i32* getelementptr inbounds ([250 x i32], [250 x i32]* @chu1, i64 0, i64 0), i32 %37)
  br label %38

38:                                               ; preds = %61, %31
  %39 = call i32 @_Z7comparePiS_(i32* getelementptr inbounds ([150 x i32], [150 x i32]* @beichu, i64 0, i64 0), i32* getelementptr inbounds ([150 x i32], [150 x i32]* @chu, i64 0, i64 0))
  %40 = icmp ne i32 %39, 0
...
42:                                               ; preds = %45, %41
  %43 = call i32 @_Z7comparePiS_(i32* getelementptr inbounds ([150 x i32], [150 x i32]* @beichu, i64 0, i64 0), i32* getelementptr inbounds ([250 x i32], [250 x i32]* @chu1, i64 0, i64 0))
  %44 = icmp ne i32 %43, 0
  br i1 %44, label %45, label %48

45:                                               ; preds = %42
  call void @_Z8subtractPiS_(i32* getelementptr inbounds ([150 x i32], [150 x i32]* @beichu, i64 0, i64 0), i32* getelementptr inbounds ([250 x i32], [250 x i32]* @chu1, i64 0, i64 0))
...
59:                                               ; preds = %48
  ...
  call void @_Z6fangdaPii(i32* getelementptr inbounds ([250 x i32], [250 x i32]* @chu1, i64 0, i64 0), i32 %60)
  br label %61
...
define dso_local i32 @_Z3weiPi(i32* %0) #7 {
...
; Function Attrs: noinline uwtable
define dso_local i32 @_Z7comparePiS_(i32* %0, i32* %1) #0 {
  %3 = alloca i32, align 4
  ...
  %8 = call i32 @_Z3weiPi(i32* %7)
  %9 = load i32*, i32** %5, align 8
  %10 = call i32 @_Z3weiPi(i32* %9)
...
13:                                               ; preds = %2
  ...
  %15 = call i32 @_Z3weiPi(i32* %14)
  %16 = load i32*, i32** %5, align 8
  %17 = call i32 @_Z3weiPi(i32* %16)
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z6fangdaPii(i32* %0, i32 %1) #7 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @_Z8subtractPiS_(i32* %0, i32* %1) #7 {
  %3 = alloca i32*, align 8
  %4 = alloca i32*, align 8
  %5 = alloca i32, align 4
  store i32* %0, i32** %3, align 8
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_96_1023.cpp() #0 section ".text.startup" {
