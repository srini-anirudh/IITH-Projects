; ModuleID = 'POJ-104-source/96/96-1033.cpp'
source_filename = "POJ-104-source/96/96-1033.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_96_1033.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %13 = call i32 @_Z3numc(i8 signext %12)
...
22:                                               ; preds = %108, %21
  ...
  %29 = call i32 @_Z3numc(i8 signext %28)
...
73:                                               ; preds = %60
  ...
  %80 = call i32 @_Z3numc(i8 signext %79)
  ...
  %88 = call i32 @_Z3numc(i8 signext %87)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_96_1033.cpp() #0 section ".text.startup" {
