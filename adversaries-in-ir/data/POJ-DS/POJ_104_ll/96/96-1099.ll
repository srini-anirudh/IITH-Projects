; ModuleID = 'POJ-104-source/96/96-1099.cpp'
source_filename = "POJ-104-source/96/96-1099.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_96_1099.cpp, i8* null }]
...
24:                                               ; preds = %19
  ...
  %26 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 48, i32 %25)
  br label %141
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_96_1099.cpp() #0 section ".text.startup" {
