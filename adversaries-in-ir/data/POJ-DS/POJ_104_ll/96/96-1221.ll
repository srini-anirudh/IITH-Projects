; ModuleID = 'POJ-104-source/96/96-1221.cpp'
source_filename = "POJ-104-source/96/96-1221.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_96_1221.cpp, i8* null }]
...
define dso_local i32 @_Z4posiPcii(i8* %0, i32 %1, i32 %2) #4 {
  %4 = alloca i8*, align 8
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z7convertPc(i8* %0) #4 {
  %2 = alloca i8*, align 8
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @_Z3outPcS_i(i8* %0, i8* %1, i32 %2) #4 {
  %4 = alloca i8*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca i32, align 4
  %7 = alloca i32, align 4
...
37:                                               ; preds = %12
  ...
  %41 = call i32 @_Z4posiPcii(i8* %38, i32 %39, i32 %40)
  ret i32 0
}
...
define dso_local i32 @main() #6 {
  ...
  %16 = bitcast i8* %15 to <{ i8, i8, [448 x i8] }>*
  %17 = getelementptr inbounds <{ i8, i8, [448 x i8] }>, <{ i8, i8, [448 x i8] }>* %16, i32 0, i32 0
  store i8 49, i8* %17, align 16
  %18 = getelementptr inbounds <{ i8, i8, [448 x i8] }>, <{ i8, i8, [448 x i8] }>* %16, i32 0, i32 1
  ...
  %28 = call i32 @_Z7convertPc(i8* %27)
  %29 = getelementptr inbounds [450 x i8], [450 x i8]* %4, i64 0, i64 0
  %30 = call i32 @_Z7convertPc(i8* %29)
...
31:                                               ; preds = %73, %0
  ...
  %35 = call i32 @_Z7comparePcS_i(i8* %32, i8* %33, i32 %34)
  %36 = icmp eq i32 %35, 3
...
39:                                               ; preds = %52, %38
  ...
  %43 = call i32 @_Z7comparePcS_i(i8* %40, i8* %41, i32 %42)
  %44 = icmp eq i32 %43, 1
...
45:                                               ; preds = %39
  ...
  %49 = call i32 @_Z3outPcS_i(i8* %46, i8* %47, i32 %48)
  br label %51
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_96_1221.cpp() #0 section ".text.startup" {
