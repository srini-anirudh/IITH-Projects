; ModuleID = 'POJ-104-source/96/96-1226.cpp'
source_filename = "POJ-104-source/96/96-1226.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_96_1226.cpp, i8* null }]
...
67:                                               ; preds = %64
  ...
  %70 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32 %69)
...
82:                                               ; preds = %74
  ...
  %89 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32 %88)
  store i32 1, i32* %8, align 4
  br label %90
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_96_1226.cpp() #0 section ".text.startup" {
