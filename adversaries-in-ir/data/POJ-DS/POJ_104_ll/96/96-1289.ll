; ModuleID = 'POJ-104-source/96/96-1289.cpp'
source_filename = "POJ-104-source/96/96-1289.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_96_1289.cpp, i8* null }]
...
13:                                               ; preds = %9
  ...
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i8* %4)
  br label %9
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_96_1289.cpp() #0 section ".text.startup" {
