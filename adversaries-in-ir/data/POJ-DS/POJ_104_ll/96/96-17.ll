; ModuleID = 'POJ-104-source/96/96-17.cpp'
source_filename = "POJ-104-source/96/96-17.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_96_17.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %9 = call noalias i8* @malloc(i64 404) #3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_96_17.cpp() #0 section ".text.startup" {
