; ModuleID = 'POJ-104-source/96/96-41.cpp'
source_filename = "POJ-104-source/96/96-41.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_96_41.cpp, i8* null }]
...
19:                                               ; preds = %0
  ...
  %33 = srem i32 %32, 13
  %34 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 %31, i32 %33)
  br label %137
...
38:                                               ; preds = %35
  ...
  %44 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 0, i32 %43)
  br label %136
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_96_41.cpp() #0 section ".text.startup" {
