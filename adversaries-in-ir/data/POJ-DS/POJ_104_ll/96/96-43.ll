; ModuleID = 'POJ-104-source/96/96-43.cpp'
source_filename = "POJ-104-source/96/96-43.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_96_43.cpp, i8* null }]
...
55:                                               ; preds = %47
  ...
  %59 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i32 48, i32 %58)
  br label %103
...
63:                                               ; preds = %60
  ...
  %69 = getelementptr inbounds [101 x i8], [101 x i8]* %3, i64 0, i64 1
...
75:                                               ; preds = %63
  ...
  %77 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0), i32 48, i8* %76)
  br label %102
...
98:                                               ; preds = %90, %79
  ...
  %101 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i64 0, i64 0), i8* %99, i32 %100)
  br label %102
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_96_43.cpp() #0 section ".text.startup" {
