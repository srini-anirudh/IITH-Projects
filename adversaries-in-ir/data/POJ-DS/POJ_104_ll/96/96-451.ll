; ModuleID = 'POJ-104-source/96/96-451.cpp'
source_filename = "POJ-104-source/96/96-451.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_96_451.cpp, i8* null }]
...
26:                                               ; preds = %23
  ...
  %30 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32 %29)
  br label %145
...
34:                                               ; preds = %31
  %35 = getelementptr inbounds [101 x i8], [101 x i8]* %6, i64 0, i64 1
...
45:                                               ; preds = %40
  ...
  %49 = getelementptr inbounds [101 x i8], [101 x i8]* %6, i64 0, i64 1
...
141:                                              ; preds = %138, %137
  ...
  %143 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.4, i64 0, i64 0), i32 %142)
  br label %144
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_96_451.cpp() #0 section ".text.startup" {
