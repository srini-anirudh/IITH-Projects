; ModuleID = 'POJ-104-source/96/96-48.cpp'
source_filename = "POJ-104-source/96/96-48.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_96_48.cpp, i8* null }]
...
89:                                               ; preds = %84
  %90 = getelementptr inbounds [100 x i8], [100 x i8]* %3, i64 0, i64 2
...
96:                                               ; preds = %89, %84, %79
  %97 = getelementptr inbounds [100 x i8], [100 x i8]* %3, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_96_48.cpp() #0 section ".text.startup" {
