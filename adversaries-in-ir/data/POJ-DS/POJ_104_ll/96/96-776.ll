; ModuleID = 'POJ-104-source/96/96-776.cpp'
source_filename = "POJ-104-source/96/96-776.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_96_776.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %10 = call i32 @_Z3numc(i8 signext %9)
...
15:                                               ; preds = %0
  ...
  %18 = call i32 @_Z3numc(i8 signext %17)
  %19 = mul nsw i32 %18, 10
  %20 = getelementptr inbounds [105 x i8], [105 x i8]* %2, i64 0, i64 1
  %21 = load i8, i8* %20, align 1
  %22 = call i32 @_Z3numc(i8 signext %21)
...
25:                                               ; preds = %15
  ...
  %28 = call i32 @_Z3numc(i8 signext %27)
  %29 = mul nsw i32 %28, 10
  %30 = getelementptr inbounds [105 x i8], [105 x i8]* %2, i64 0, i64 1
  %31 = load i8, i8* %30, align 1
  %32 = call i32 @_Z3numc(i8 signext %31)
...
40:                                               ; preds = %35
  ...
  %43 = call i32 @_Z3numc(i8 signext %42)
...
53:                                               ; preds = %46
  ...
  %60 = call i32 @_Z3numc(i8 signext %59)
...
define dso_local i32 @_Z3numc(i8 signext %0) #5 {
  %2 = alloca i8, align 1
  %3 = alloca i32, align 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_96_776.cpp() #0 section ".text.startup" {
