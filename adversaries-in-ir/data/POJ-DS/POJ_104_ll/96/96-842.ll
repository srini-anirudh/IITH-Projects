; ModuleID = 'POJ-104-source/96/96-842.cpp'
source_filename = "POJ-104-source/96/96-842.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_96_842.cpp, i8* null }]
...
99:                                               ; preds = %68
  ...
  %102 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i32* %9)
  store i32 0, i32* %1, align 4
  br label %103
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_96_842.cpp() #0 section ".text.startup" {
