; ModuleID = 'POJ-104-source/96/96-984.cpp'
source_filename = "POJ-104-source/96/96-984.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_96_984.cpp, i8* null }]
...
50:                                               ; preds = %45
  %51 = getelementptr inbounds [105 x i8], [105 x i8]* %2, i64 0, i64 1
...
57:                                               ; preds = %50, %45, %42
  %58 = getelementptr inbounds [105 x i8], [105 x i8]* %3, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_96_984.cpp() #0 section ".text.startup" {
