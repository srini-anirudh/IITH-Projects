; ModuleID = 'POJ-104-source/98/98-1035.cpp'
source_filename = "POJ-104-source/98/98-1035.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_98_1035.cpp, i8* null }]
...
33:                                               ; preds = %24
  ...
  %37 = getelementptr inbounds [50 x i8], [50 x i8]* %5, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_98_1035.cpp() #0 section ".text.startup" {
