; ModuleID = 'POJ-104-source/98/98-1197.cpp'
source_filename = "POJ-104-source/98/98-1197.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_98_1197.cpp, i8* null }]
...
12:                                               ; preds = %8
  ...
  call void @llvm.memset.p0i8.i64(i8* align 16 %13, i8 48, i64 40, i1 false)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_98_1197.cpp() #0 section ".text.startup" {
