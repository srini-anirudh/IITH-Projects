; ModuleID = 'POJ-104-source/98/98-1887.cpp'
source_filename = "POJ-104-source/98/98-1887.cpp"
...
@nowlen = dso_local global i32 0, align 4
@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [3 x i8] c"%s\00", align 1
@.str.2 = private unnamed_addr constant [4 x i8] c"\0A%s\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_98_1887.cpp, i8* null }]
...
8:                                                ; preds = %4
  %9 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([50 x i8], [50 x i8]* @st, i64 0, i64 0))
  %10 = call i64 @strlen(i8* getelementptr inbounds ([50 x i8], [50 x i8]* @st, i64 0, i64 0)) #6
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_98_1887.cpp() #0 section ".text.startup" {
