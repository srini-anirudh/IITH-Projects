; ModuleID = 'POJ-104-source/98/98-2099.cpp'
source_filename = "POJ-104-source/98/98-2099.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_98_2099.cpp, i8* null }]
...
; Function Attrs: noinline uwtable
define dso_local %struct.word* @_Z6createi(i32 %0) #0 {
...
11:                                               ; preds = %7
  ...
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), [40 x i8]* %15)
...
; Function Attrs: noinline uwtable
define dso_local void @_Z5printP4wordi(%struct.word* %0, i32 %1) #0 {
  %3 = alloca %struct.word*, align 8
...
define dso_local i32 @main() #5 {
  ...
  %4 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i32* %2)
  %5 = load i32, i32* %2, align 4
  %6 = call %struct.word* @_Z6createi(i32 %5)
  store %struct.word* %6, %struct.word** %3, align 8
  %7 = load %struct.word*, %struct.word** %3, align 8
  %8 = load i32, i32* %2, align 4
  call void @_Z5printP4wordi(%struct.word* %7, i32 %8)
  ret i32 0
}

; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_98_2099.cpp() #0 section ".text.startup" {
