; ModuleID = 'POJ-104-source/98/98-2127.cpp'
source_filename = "POJ-104-source/98/98-2127.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_98_2127.cpp, i8* null }]
...
12:                                               ; preds = %8
  ...
  %16 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), [40 x i8]* %15)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_98_2127.cpp() #0 section ".text.startup" {
