; ModuleID = 'POJ-104-source/98/98-2346.cpp'
source_filename = "POJ-104-source/98/98-2346.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_98_2346.cpp, i8* null }]
...
27:                                               ; preds = %23
  ...
  %31 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), [20 x i8]* %30)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_98_2346.cpp() #0 section ".text.startup" {
