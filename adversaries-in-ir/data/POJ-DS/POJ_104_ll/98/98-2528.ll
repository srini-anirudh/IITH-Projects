; ModuleID = 'POJ-104-source/98/98-2528.cpp'
source_filename = "POJ-104-source/98/98-2528.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_98_2528.cpp, i8* null }]
...
47:                                               ; preds = %43
  ...
  %51 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* %50)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_98_2528.cpp() #0 section ".text.startup" {
