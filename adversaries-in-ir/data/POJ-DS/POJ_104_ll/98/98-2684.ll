; ModuleID = 'POJ-104-source/98/98-2684.cpp'
source_filename = "POJ-104-source/98/98-2684.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_98_2684.cpp, i8* null }]
...
37:                                               ; preds = %22
  %38 = getelementptr inbounds [40 x i8], [40 x i8]* %7, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_98_2684.cpp() #0 section ".text.startup" {
