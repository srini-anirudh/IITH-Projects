; ModuleID = 'POJ-104-source/98/98-2872.cpp'
source_filename = "POJ-104-source/98/98-2872.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_98_2872.cpp, i8* null }]
...
18:                                               ; preds = %14
  %19 = call noalias i8* @malloc(i64 41) #3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_98_2872.cpp() #0 section ".text.startup" {
