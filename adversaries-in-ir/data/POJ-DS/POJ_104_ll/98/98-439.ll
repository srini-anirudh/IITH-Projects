; ModuleID = 'POJ-104-source/98/98-439.cpp'
source_filename = "POJ-104-source/98/98-439.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_98_439.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %10 = call i8* @strcpy(i8* %9, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.1, i64 0, i64 0)) #3
...
15:                                               ; preds = %11
  ...
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i8* %18)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_98_439.cpp() #0 section ".text.startup" {
