; ModuleID = 'POJ-104-source/98/98-48.cpp'
source_filename = "POJ-104-source/98/98-48.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_98_48.cpp, i8* null }]
...
24:                                               ; preds = %11
  ...
  %31 = call i8* @strcat(i8* %28, i8* %30) #3
...
50:                                               ; preds = %36
  ...
  %55 = call i8* @strcat(i8* %54, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0)) #3
  ...
  %64 = call i8* @strcat(i8* %59, i8* %63) #3
  br label %77
...
65:                                               ; preds = %36
  ...
  %76 = call i8* @strcat(i8* %71, i8* %75) #3
  br label %77
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_98_48.cpp() #0 section ".text.startup" {
