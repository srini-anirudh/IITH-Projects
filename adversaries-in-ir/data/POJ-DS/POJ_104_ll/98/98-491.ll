; ModuleID = 'POJ-104-source/98/98-491.cpp'
source_filename = "POJ-104-source/98/98-491.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_98_491.cpp, i8* null }]
...
22:                                               ; preds = %18
  %23 = call noalias i8* @malloc(i64 40) #3
...
41:                                               ; preds = %38
  ...
  %43 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i64 0, i64 0), i8* %42)
  %44 = load i8*, i8** %5, align 8
  call void @free(i8* %44) #3
  %45 = call noalias i8* @malloc(i64 40) #3
  store i8* %45, i8** %5, align 8
  %46 = load i8*, i8** %5, align 8
  %47 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* %46)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_98_491.cpp() #0 section ".text.startup" {
