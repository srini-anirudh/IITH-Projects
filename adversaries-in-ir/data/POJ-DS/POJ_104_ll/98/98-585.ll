; ModuleID = 'POJ-104-source/98/98-585.cpp'
source_filename = "POJ-104-source/98/98-585.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_98_585.cpp, i8* null }]
...
28:                                               ; preds = %24
  ...
  %32 = getelementptr inbounds [500 x [40 x i8]], [500 x [40 x i8]]* %6, i64 0, i64 %31
  %33 = getelementptr inbounds [40 x i8], [40 x i8]* %32, i64 0, i64 0
  %34 = call i8* @strcat(i8* %29, i8* %33) #3
  ...
  %43 = getelementptr inbounds [500 x [40 x i8]], [500 x [40 x i8]]* %6, i64 0, i64 %42
...
54:                                               ; preds = %51
  ...
  %57 = getelementptr inbounds [80 x i8], [80 x i8]* %7, i64 0, i64 0
  %58 = call i8* @strcpy(i8* %57, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0)) #3
  br label %71
...
67:                                               ; preds = %59
  ...
  %69 = call i8* @strcat(i8* %68, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i64 0, i64 0)) #3
  br label %70
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_98_585.cpp() #0 section ".text.startup" {
