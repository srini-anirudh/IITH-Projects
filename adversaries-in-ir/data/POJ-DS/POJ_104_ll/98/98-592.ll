; ModuleID = 'POJ-104-source/98/98-592.cpp'
source_filename = "POJ-104-source/98/98-592.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_98_592.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %20 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* %19)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_98_592.cpp() #0 section ".text.startup" {
