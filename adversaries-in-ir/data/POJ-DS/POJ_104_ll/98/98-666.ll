; ModuleID = 'POJ-104-source/98/98-666.cpp'
source_filename = "POJ-104-source/98/98-666.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_98_666.cpp, i8* null }]
...
49:                                               ; preds = %40
  ...
  %53 = getelementptr inbounds [500 x [50 x i8]], [500 x [50 x i8]]* %2, i64 0, i64 %52
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_98_666.cpp() #0 section ".text.startup" {
