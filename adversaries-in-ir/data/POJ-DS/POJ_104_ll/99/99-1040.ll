; ModuleID = 'POJ-104-source/99/99-1040.cpp'
source_filename = "POJ-104-source/99/99-1040.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_99_1040.cpp, i8* null }]
...
16:                                               ; preds = %11
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i32* %9)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_99_1040.cpp() #0 section ".text.startup" {
