; ModuleID = 'POJ-104-source/99/99-1163.cpp'
source_filename = "POJ-104-source/99/99-1163.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_99_1163.cpp, i8* null }]
...
18:                                               ; preds = %14
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), double* %2)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_99_1163.cpp() #0 section ".text.startup" {
