; ModuleID = 'POJ-104-source/99/99-1166.cpp'
source_filename = "POJ-104-source/99/99-1166.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_99_1166.cpp, i8* null }]
...
14:                                               ; preds = %10
  ...
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), double* %8)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_99_1166.cpp() #0 section ".text.startup" {
