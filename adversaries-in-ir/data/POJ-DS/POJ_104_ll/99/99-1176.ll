; ModuleID = 'POJ-104-source/99/99-1176.cpp'
source_filename = "POJ-104-source/99/99-1176.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_99_1176.cpp, i8* null }]
...
define dso_local void @_Z6tongjiv() #5 {
  %1 = alloca i32, align 4
  store i32 1, i32* %1, align 4
  br label %2
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_99_1176.cpp() #0 section ".text.startup" {
