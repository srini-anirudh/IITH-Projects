; ModuleID = 'POJ-104-source/99/99-1250.cpp'
source_filename = "POJ-104-source/99/99-1250.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_99_1250.cpp, i8* null }]
...
80:                                               ; preds = %24
  ...
  %108 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.4, i64 0, i64 0), double %107)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_99_1250.cpp() #0 section ".text.startup" {
