; ModuleID = 'POJ-104-source/99/99-1276.cpp'
source_filename = "POJ-104-source/99/99-1276.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_99_1276.cpp, i8* null }]
...
85:                                               ; preds = %82
  ...
  %88 = getelementptr inbounds [4 x i32], [4 x i32]* %4, i64 0, i64 %87
  ...
  %98 = getelementptr inbounds [4 x double], [4 x double]* %5, i64 0, i64 %97
...
102:                                              ; preds = %82
  %103 = getelementptr inbounds [4 x double], [4 x double]* %5, i64 0, i64 0
  ...
  %106 = getelementptr inbounds [4 x double], [4 x double]* %5, i64 0, i64 1
  ...
  %112 = getelementptr inbounds [4 x double], [4 x double]* %5, i64 0, i64 3
  %113 = load double, double* %112, align 8
  %114 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.4, i64 0, i64 0), double %113)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_99_1276.cpp() #0 section ".text.startup" {
