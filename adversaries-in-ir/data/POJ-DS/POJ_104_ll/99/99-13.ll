; ModuleID = 'POJ-104-source/99/99-13.cpp'
source_filename = "POJ-104-source/99/99-13.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_99_13.cpp, i8* null }]
...
61:                                               ; preds = %55
  %62 = getelementptr inbounds [4 x double], [4 x double]* %5, i64 0, i64 2
  %63 = load double, double* %62, align 16
  %64 = fadd double %63, 1.000000e+00
  store double %64, double* %62, align 16
  br label %65
...
71:                                               ; preds = %65
  %72 = getelementptr inbounds [4 x double], [4 x double]* %5, i64 0, i64 3
...
79:                                               ; preds = %8
  %80 = getelementptr inbounds [4 x double], [4 x double]* %5, i64 0, i64 0
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_99_13.cpp() #0 section ".text.startup" {
