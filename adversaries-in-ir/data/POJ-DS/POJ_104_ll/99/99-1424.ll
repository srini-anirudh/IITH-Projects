; ModuleID = 'POJ-104-source/99/99-1424.cpp'
source_filename = "POJ-104-source/99/99-1424.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_99_1424.cpp, i8* null }]
...
define dso_local i32 @main(i32 %0, i8** %1) #4 {
  ...
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), double* %16)
...
23:                                               ; preds = %18
  ...
  %27 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), double* %26)
  br label %28
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_99_1424.cpp() #0 section ".text.startup" {
