; ModuleID = 'POJ-104-source/99/99-1552.cpp'
source_filename = "POJ-104-source/99/99-1552.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_99_1552.cpp, i8* null }]
...
74:                                               ; preds = %14
  ...
  %103 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([58 x i8], [58 x i8]* @.str.2, i64 0, i64 0), double %99, double %100, double %101, double %102)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_99_1552.cpp() #0 section ".text.startup" {
