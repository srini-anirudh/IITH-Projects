; ModuleID = 'POJ-104-source/99/99-1589.cpp'
source_filename = "POJ-104-source/99/99-1589.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_99_1589.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %12 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), double* %2)
  br label %13
...
16:                                               ; preds = %13
  %17 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), double* %7)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_99_1589.cpp() #0 section ".text.startup" {
