; ModuleID = 'POJ-104-source/99/99-1961.cpp'
source_filename = "POJ-104-source/99/99-1961.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_99_1961.cpp, i8* null }]
...
18:                                               ; preds = %14
  ...
  %25 = getelementptr inbounds [101 x i32], [101 x i32]* %12, i64 0, i64 %24
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_99_1961.cpp() #0 section ".text.startup" {
