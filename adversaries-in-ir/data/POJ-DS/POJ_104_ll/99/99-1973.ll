; ModuleID = 'POJ-104-source/99/99-1973.cpp'
source_filename = "POJ-104-source/99/99-1973.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_99_1973.cpp, i8* null }]
...
80:                                               ; preds = %14
  ...
  %109 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.2, i64 0, i64 0), double %102, double %104, double %106, double %108)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_99_1973.cpp() #0 section ".text.startup" {
