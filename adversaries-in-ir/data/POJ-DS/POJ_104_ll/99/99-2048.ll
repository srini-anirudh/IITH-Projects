; ModuleID = 'POJ-104-source/99/99-2048.cpp'
source_filename = "POJ-104-source/99/99-2048.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_99_2048.cpp, i8* null }]
...
87:                                               ; preds = %31
  ...
  %120 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.1, i64 0, i64 0), double %116, double %117, double %118, double %119)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_99_2048.cpp() #0 section ".text.startup" {
