; ModuleID = 'POJ-104-source/99/99-2052.cpp'
source_filename = "POJ-104-source/99/99-2052.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_99_2052.cpp, i8* null }]
...
55:                                               ; preds = %10
  ...
  %80 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([58 x i8], [58 x i8]* @.str.2, i64 0, i64 0), double %76, double %77, double %78, double %79)
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_99_2052.cpp() #0 section ".text.startup" {
