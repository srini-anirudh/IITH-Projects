; ModuleID = 'POJ-104-source/99/99-2072.cpp'
source_filename = "POJ-104-source/99/99-2072.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_99_2072.cpp, i8* null }]
...
19:                                               ; preds = %14
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), float* %3)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_99_2072.cpp() #0 section ".text.startup" {
