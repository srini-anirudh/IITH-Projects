; ModuleID = 'POJ-104-source/99/99-2200.cpp'
source_filename = "POJ-104-source/99/99-2200.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_99_2200.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %9, i8* align 16 bitcast ([5 x i32]* @__const.main.age to i8*), i64 20, i1 false)
...
75:                                               ; preds = %72
  ...
  %87 = getelementptr inbounds [4 x double], [4 x double]* %8, i64 0, i64 %86
...
91:                                               ; preds = %72
  %92 = getelementptr inbounds [4 x double], [4 x double]* %8, i64 0, i64 0
  ...
  %95 = getelementptr inbounds [4 x double], [4 x double]* %8, i64 0, i64 1
  %96 = load double, double* %95, align 8
  %97 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.2, i64 0, i64 0), double %96)
  %98 = getelementptr inbounds [4 x double], [4 x double]* %8, i64 0, i64 2
  ...
  %101 = getelementptr inbounds [4 x double], [4 x double]* %8, i64 0, i64 3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_99_2200.cpp() #0 section ".text.startup" {
