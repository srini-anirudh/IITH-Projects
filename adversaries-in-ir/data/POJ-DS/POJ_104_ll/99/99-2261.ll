; ModuleID = 'POJ-104-source/99/99-2261.cpp'
source_filename = "POJ-104-source/99/99-2261.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_99_2261.cpp, i8* null }]
...
19:                                               ; preds = %14
  ...
  %23 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), double* %22)
  br label %24
...
33:                                               ; preds = %28
  ...
  %38 = fcmp olt double %37, 1.900000e+01
...
72:                                               ; preds = %69, %63, %57
  ...
  %77 = fcmp ogt double %76, 6.000000e+01
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_99_2261.cpp() #0 section ".text.startup" {
