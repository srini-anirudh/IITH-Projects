; ModuleID = 'POJ-104-source/99/99-2475.cpp'
source_filename = "POJ-104-source/99/99-2475.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_99_2475.cpp, i8* null }]
...
19:                                               ; preds = %14
  ...
  %22 = getelementptr inbounds [100 x i32], [100 x i32]* %12, i64 0, i64 %21
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_99_2475.cpp() #0 section ".text.startup" {
