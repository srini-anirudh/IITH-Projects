; ModuleID = 'POJ-104-source/99/99-25.cpp'
source_filename = "POJ-104-source/99/99-25.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_99_25.cpp, i8* null }]
...
33:                                               ; preds = %27
  %34 = getelementptr inbounds [4 x double], [4 x double]* %5, i64 0, i64 1
...
43:                                               ; preds = %37
  %44 = getelementptr inbounds [4 x double], [4 x double]* %5, i64 0, i64 2
...
47:                                               ; preds = %37
  %48 = getelementptr inbounds [4 x double], [4 x double]* %5, i64 0, i64 3
...
57:                                               ; preds = %9
  %58 = getelementptr inbounds [4 x double], [4 x double]* %5, i64 0, i64 0
  %59 = load double, double* %58, align 16
  %60 = load i32, i32* %2, align 4
  %61 = sitofp i32 %60 to double
  %62 = fdiv double %59, %61
  %63 = fmul double %62, 1.000000e+02
  %64 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.2, i64 0, i64 0), double %63)
  %65 = getelementptr inbounds [4 x double], [4 x double]* %5, i64 0, i64 1
  ...
  %79 = getelementptr inbounds [4 x double], [4 x double]* %5, i64 0, i64 3
  %80 = load double, double* %79, align 8
  %81 = load i32, i32* %2, align 4
  %82 = sitofp i32 %81 to double
  %83 = fdiv double %80, %82
  %84 = fmul double %83, 1.000000e+02
  %85 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.5, i64 0, i64 0), double %84)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_99_25.cpp() #0 section ".text.startup" {
