; ModuleID = 'POJ-104-source/99/99-2684.cpp'
source_filename = "POJ-104-source/99/99-2684.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_99_2684.cpp, i8* null }]
...
75:                                               ; preds = %23
  ...
  %83 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i64 0, i64 0), double %82)
  ...
  %99 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.3, i64 0, i64 0), double %98)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_99_2684.cpp() #0 section ".text.startup" {
