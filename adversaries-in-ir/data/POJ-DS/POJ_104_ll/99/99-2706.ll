; ModuleID = 'POJ-104-source/99/99-2706.cpp'
source_filename = "POJ-104-source/99/99-2706.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_99_2706.cpp, i8* null }]
...
19:                                               ; preds = %15
  ...
  %22 = getelementptr inbounds [1000 x i32], [1000 x i32]* %12, i64 0, i64 %21
...
111:                                              ; preds = %94
  ...
  %141 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.3, i64 0, i64 0), double %140)
  %142 = load double, double* %9, align 8
  %143 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.4, i64 0, i64 0), double %142)
  %144 = load double, double* %10, align 8
  %145 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.5, i64 0, i64 0), double %144)
  %146 = load double, double* %11, align 8
  %147 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.6, i64 0, i64 0), double %146)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_99_2706.cpp() #0 section ".text.startup" {
