; ModuleID = 'POJ-104-source/99/99-2785.cpp'
source_filename = "POJ-104-source/99/99-2785.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_99_2785.cpp, i8* null }]
...
63:                                               ; preds = %23
  ...
  %88 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.1, i64 0, i64 0), double %84, double %85, double %86, double %87)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_99_2785.cpp() #0 section ".text.startup" {
