; ModuleID = 'POJ-104-source/99/99-2809.cpp'
source_filename = "POJ-104-source/99/99-2809.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_99_2809.cpp, i8* null }]
...
54:                                               ; preds = %10
  ...
  %61 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.1, i64 0, i64 0), double %60)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_99_2809.cpp() #0 section ".text.startup" {
