; ModuleID = 'POJ-104-source/99/99-287.cpp'
source_filename = "POJ-104-source/99/99-287.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_99_287.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %3 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), double* @n)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_99_287.cpp() #0 section ".text.startup" {
