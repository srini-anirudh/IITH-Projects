; ModuleID = 'POJ-104-source/99/99-36.cpp'
source_filename = "POJ-104-source/99/99-36.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_99_36.cpp, i8* null }]
...
77:                                               ; preds = %24
  ...
  %92 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.4, i64 0, i64 0), double %91)
  %93 = load double, double* %7, align 8
  %94 = load double, double* %8, align 8
  %95 = fdiv double %93, %94
  %96 = fmul double %95, 1.000000e+02
  %97 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.5, i64 0, i64 0), double %96)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_99_36.cpp() #0 section ".text.startup" {
