; ModuleID = 'POJ-104-source/99/99-40.cpp'
source_filename = "POJ-104-source/99/99-40.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_99_40.cpp, i8* null }]
...
40:                                               ; preds = %34
  %41 = getelementptr inbounds [4 x double], [4 x double]* %6, i64 0, i64 1
...
56:                                               ; preds = %50
  %57 = getelementptr inbounds [4 x double], [4 x double]* %6, i64 0, i64 2
...
60:                                               ; preds = %50, %44
  %61 = getelementptr inbounds [4 x double], [4 x double]* %6, i64 0, i64 3
...
91:                                               ; preds = %73
  ...
  %95 = getelementptr inbounds [4 x double], [4 x double]* %5, i64 0, i64 1
  %96 = load double, double* %95, align 8
  %97 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.2, i64 0, i64 0), double %96)
  %98 = getelementptr inbounds [4 x double], [4 x double]* %5, i64 0, i64 2
  ...
  %101 = getelementptr inbounds [4 x double], [4 x double]* %5, i64 0, i64 3
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_99_40.cpp() #0 section ".text.startup" {
