; ModuleID = 'POJ-104-source/99/99-47.cpp'
source_filename = "POJ-104-source/99/99-47.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_99_47.cpp, i8* null }]
...
81:                                               ; preds = %15
  ...
  %108 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.3, i64 0, i64 0), double %107)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_99_47.cpp() #0 section ".text.startup" {
