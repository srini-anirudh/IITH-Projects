; ModuleID = 'POJ-104-source/99/99-542.cpp'
source_filename = "POJ-104-source/99/99-542.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_99_542.cpp, i8* null }]
...
49:                                               ; preds = %10
  ...
  %63 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.2, i64 0, i64 0), double %62)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_99_542.cpp() #0 section ".text.startup" {
