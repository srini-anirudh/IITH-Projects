; ModuleID = 'POJ-104-source/99/99-544.cpp'
source_filename = "POJ-104-source/99/99-544.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_99_544.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), double* %12)
...
20:                                               ; preds = %15
  ...
  %23 = getelementptr inbounds [10000 x i32], [10000 x i32]* %13, i64 0, i64 %22
  %24 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* %23)
  %25 = load i32, i32* %2, align 4
  %26 = sext i32 %25 to i64
  %27 = getelementptr inbounds [10000 x i32], [10000 x i32]* %13, i64 0, i64 %26
...
42:                                               ; preds = %33
  ...
  %45 = getelementptr inbounds [10000 x i32], [10000 x i32]* %13, i64 0, i64 %44
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_99_544.cpp() #0 section ".text.startup" {
