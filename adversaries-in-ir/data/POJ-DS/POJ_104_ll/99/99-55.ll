; ModuleID = 'POJ-104-source/99/99-55.cpp'
source_filename = "POJ-104-source/99/99-55.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_99_55.cpp, i8* null }]
...
84:                                               ; preds = %21
  %85 = getelementptr inbounds [4 x i32], [4 x i32]* %5, i64 0, i64 0
  %86 = load i32, i32* %85, align 16
  %87 = sitofp i32 %86 to float
  %88 = fmul float 1.000000e+02, %87
  %89 = load i32, i32* %3, align 4
  %90 = sitofp i32 %89 to float
  %91 = fdiv float %88, %90
  %92 = fpext float %91 to double
  %93 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.1, i64 0, i64 0), double %92)
  %94 = getelementptr inbounds [4 x i32], [4 x i32]* %5, i64 0, i64 1
  ...
  %106 = fmul float 1.000000e+02, %105
  ...
  %115 = fmul float 1.000000e+02, %114
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_99_55.cpp() #0 section ".text.startup" {
