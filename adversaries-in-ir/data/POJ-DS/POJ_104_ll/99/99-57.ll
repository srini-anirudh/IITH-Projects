; ModuleID = 'POJ-104-source/99/99-57.cpp'
source_filename = "POJ-104-source/99/99-57.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_99_57.cpp, i8* null }]
...
define dso_local i32 @main() #4 {
  ...
  %14 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* %9)
...
84:                                               ; preds = %28
  ...
  %109 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([55 x i8], [55 x i8]* @.str.1, i64 0, i64 0), double %105, double %106, double %107, double %108)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_99_57.cpp() #0 section ".text.startup" {
