; ModuleID = 'POJ-104-source/99/99-68.cpp'
source_filename = "POJ-104-source/99/99-68.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_99_68.cpp, i8* null }]
...
82:                                               ; preds = %79
  ...
  %94 = getelementptr inbounds [4 x double], [4 x double]* %4, i64 0, i64 %93
...
98:                                               ; preds = %79
  ...
  %102 = getelementptr inbounds [4 x double], [4 x double]* %4, i64 0, i64 1
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_99_68.cpp() #0 section ".text.startup" {
