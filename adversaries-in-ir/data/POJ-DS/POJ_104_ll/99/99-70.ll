; ModuleID = 'POJ-104-source/99/99-70.cpp'
source_filename = "POJ-104-source/99/99-70.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_99_70.cpp, i8* null }]
...
77:                                               ; preds = %30
  ...
  %98 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.3, i64 0, i64 0), double %97)
  ...
  %105 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.4, i64 0, i64 0), double %104)
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_99_70.cpp() #0 section ".text.startup" {
