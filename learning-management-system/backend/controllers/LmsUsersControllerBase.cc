...
void LmsUsersControllerBase::getOne(const HttpRequestPtr &req,
...
void LmsUsersControllerBase::updateOne(const HttpRequestPtr &req,
                                       std::function<void(const HttpResponsePtr &)> &&callback,
                                       Users::PrimaryKeyType &&id)
{
...
void LmsUsersControllerBase::deleteOne(const HttpRequestPtr &req,
                                       std::function<void(const HttpResponsePtr &)> &&callback,
                                       Users::PrimaryKeyType &&id)
{
...
void LmsUsersControllerBase::get(const HttpRequestPtr &req,
                                 std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto dbClientPtr = getDbClient();
    drogon::orm::Mapper<Users> mapper(dbClientPtr);
...
void LmsUsersControllerBase::create(const HttpRequestPtr &req,
                                    std::function<void(const HttpResponsePtr &)> &&callback)
{
    auto jsonPtr=req->jsonObject();
    if(!jsonPtr)
...
/*
void LmsUsersControllerBase::update(const HttpRequestPtr &req,
                                    std::function<void(const HttpResponsePtr &)> &&callback)
{

}*/

LmsUsersControllerBase::LmsUsersControllerBase()
    : RestfulController({
          "id",
          "login_name",
          "password",
      ...
      })
{
    ...
    */
    enableMasquerading({
        ...
        "login_name", // the alias for the login_name column.
        ...
        "department_id", // the alias for the department_id column.
