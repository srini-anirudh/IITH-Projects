...
class Users
{
  public:
    ...
    const uint32_t &getValueOfDepartmentId() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<uint32_t> &getDepartmentId() const noexcept;

    ///Set the value of the column department_id
    void setDepartmentId(const uint32_t &pDepartmentId) noexcept;
  ...
  private:
    ...
    std::shared_ptr<uint32_t> departmentId_;
