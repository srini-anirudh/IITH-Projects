...
const std::string Department::Cols::_code = "code";
...
{"code","std::string","char(2)",0,0,0,1}
};
...
const uint32_t &Department::getValueOfId() const noexcept
{
...
const std::shared_ptr<uint32_t> &Department::getId() const noexcept
{
    return id_;
}
void Department::setId(const uint32_t &pId) noexcept
{
...
const std::string &Department::getValueOfCode() const noexcept
{
    const static std::string defaultValue = std::string();
    if(code_)
        return *code_;
...
const std::shared_ptr<std::string> &Department::getCode() const noexcept
{
    return code_;
}
void Department::setCode(const std::string &pCode) noexcept
{
    code_ = std::make_shared<std::string>(pCode);
    dirtyFlag_[2] = true;
}
void Department::setCode(std::string &&pCode) noexcept
{
